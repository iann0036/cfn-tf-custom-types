...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-projectgroup.json`
2. Implement your resource handlers in `tf_octopusdeploy_projectgroup/handlers.py`
