...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-azureservicefabricclusterdeploymenttarget.json`
2. Implement your resource handlers in `tf_octopusdeploy_azureservicefabricclusterdeploymenttarget/handlers.py`
