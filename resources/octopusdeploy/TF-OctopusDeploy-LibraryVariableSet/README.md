...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-libraryvariableset.json`
2. Implement your resource handlers in `tf_octopusdeploy_libraryvariableset/handlers.py`
