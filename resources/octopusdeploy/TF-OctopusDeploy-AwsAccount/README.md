...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-awsaccount.json`
2. Implement your resource handlers in `tf_octopusdeploy_awsaccount/handlers.py`
