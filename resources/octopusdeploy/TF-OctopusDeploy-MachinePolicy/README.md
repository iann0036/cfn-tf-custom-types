...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-machinepolicy.json`
2. Implement your resource handlers in `tf_octopusdeploy_machinepolicy/handlers.py`
