...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-certificate.json`
2. Implement your resource handlers in `tf_octopusdeploy_certificate/handlers.py`
