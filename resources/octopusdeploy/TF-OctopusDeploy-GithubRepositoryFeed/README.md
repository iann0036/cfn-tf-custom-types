...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-githubrepositoryfeed.json`
2. Implement your resource handlers in `tf_octopusdeploy_githubrepositoryfeed/handlers.py`
