...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-listeningtentacledeploymenttarget.json`
2. Implement your resource handlers in `tf_octopusdeploy_listeningtentacledeploymenttarget/handlers.py`
