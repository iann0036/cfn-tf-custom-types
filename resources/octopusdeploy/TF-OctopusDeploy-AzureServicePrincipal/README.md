...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-azureserviceprincipal.json`
2. Implement your resource handlers in `tf_octopusdeploy_azureserviceprincipal/handlers.py`
