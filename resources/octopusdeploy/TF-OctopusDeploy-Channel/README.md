...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-channel.json`
2. Implement your resource handlers in `tf_octopusdeploy_channel/handlers.py`
