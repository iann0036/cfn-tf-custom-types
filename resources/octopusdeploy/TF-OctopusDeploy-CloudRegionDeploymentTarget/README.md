...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-cloudregiondeploymenttarget.json`
2. Implement your resource handlers in `tf_octopusdeploy_cloudregiondeploymenttarget/handlers.py`
