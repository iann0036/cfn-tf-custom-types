...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-azuresubscriptionaccount.json`
2. Implement your resource handlers in `tf_octopusdeploy_azuresubscriptionaccount/handlers.py`
