...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-deploymentprocess.json`
2. Implement your resource handlers in `tf_octopusdeploy_deploymentprocess/handlers.py`
