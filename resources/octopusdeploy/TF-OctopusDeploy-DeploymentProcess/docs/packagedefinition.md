# TF::OctopusDeploy::DeploymentProcess PackageDefinition
...
<pre>
{
    ...
    "<a href="#extractduringdeployment" title="ExtractDuringDeployment">ExtractDuringDeployment</a>" : <i>Boolean</i>,
