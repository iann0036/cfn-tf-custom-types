...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-azurecloudservicedeploymenttarget.json`
2. Implement your resource handlers in `tf_octopusdeploy_azurecloudservicedeploymenttarget/handlers.py`
