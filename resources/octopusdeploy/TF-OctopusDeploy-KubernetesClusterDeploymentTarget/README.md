...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-kubernetesclusterdeploymenttarget.json`
2. Implement your resource handlers in `tf_octopusdeploy_kubernetesclusterdeploymenttarget/handlers.py`
