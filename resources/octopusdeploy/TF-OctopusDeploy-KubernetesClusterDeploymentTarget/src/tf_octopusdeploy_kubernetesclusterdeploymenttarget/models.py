...
class ResourceModel(BaseModel):
    ...
    AwsAccountAuthentication: Optional[Sequence["_AwsAccountAuthenticationDefinition"]]
    AzureServicePrincipalAuthentication: Optional[Sequence["_AzureServicePrincipalAuthenticationDefinition"]]
    CertificateAuthentication: Optional[Sequence["_CertificateAuthenticationDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AwsAccountAuthentication=deserialize_list(json_data.get("AwsAccountAuthentication"), AwsAccountAuthenticationDefinition),
            AzureServicePrincipalAuthentication=deserialize_list(json_data.get("AzureServicePrincipalAuthentication"), AzureServicePrincipalAuthenticationDefinition),
            CertificateAuthentication=deserialize_list(json_data.get("CertificateAuthentication"), CertificateAuthenticationDefinition),
...
@dataclass
class AwsAccountAuthenticationDefinition(BaseModel):
    AccountId: Optional[str]
    AssumeRole: Optional[bool]
    AssumeRoleExternalId: Optional[str]
    AssumeRoleSessionDuration: Optional[float]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsAccountAuthenticationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsAccountAuthenticationDefinition"]:
        if not json_data:
            return None
        return cls(
            AccountId=json_data.get("AccountId"),
...
# work around possible type aliasing issues when variable has same name as a model
_AwsAccountAuthenticationDefinition = AwsAccountAuthenticationDefinition


@dataclass
class AzureServicePrincipalAuthenticationDefinition(BaseModel):
    AccountId: Optional[str]
    ClusterName: Optional[str]
    ClusterResourceGroup: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AzureServicePrincipalAuthenticationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AzureServicePrincipalAuthenticationDefinition"]:
        if not json_data:
            return None
        return cls(
            AccountId=json_data.get("AccountId"),
...
# work around possible type aliasing issues when variable has same name as a model
_AzureServicePrincipalAuthenticationDefinition = AzureServicePrincipalAuthenticationDefinition


@dataclass
class CertificateAuthenticationDefinition(BaseModel):
    ClientCertificate: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_CertificateAuthenticationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificateAuthenticationDefinition"]:
        if not json_data:
            return None
        return cls(
            ClientCertificate=json_data.get("ClientCertificate"),
...
# work around possible type aliasing issues when variable has same name as a model
_CertificateAuthenticationDefinition = CertificateAuthenticationDefinition
