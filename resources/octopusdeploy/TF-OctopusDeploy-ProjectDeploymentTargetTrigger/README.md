...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-projectdeploymenttargettrigger.json`
2. Implement your resource handlers in `tf_octopusdeploy_projectdeploymenttargettrigger/handlers.py`
