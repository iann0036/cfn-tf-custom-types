...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-tenant.json`
2. Implement your resource handlers in `tf_octopusdeploy_tenant/handlers.py`
