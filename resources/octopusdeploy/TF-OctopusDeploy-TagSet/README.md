...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-tagset.json`
2. Implement your resource handlers in `tf_octopusdeploy_tagset/handlers.py`
