...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-usernamepasswordaccount.json`
2. Implement your resource handlers in `tf_octopusdeploy_usernamepasswordaccount/handlers.py`
