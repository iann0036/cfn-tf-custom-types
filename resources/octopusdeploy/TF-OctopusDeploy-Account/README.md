...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-account.json`
2. Implement your resource handlers in `tf_octopusdeploy_account/handlers.py`
