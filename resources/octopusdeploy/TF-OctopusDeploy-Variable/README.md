...
1. Write the JSON schema describing your resource, `tf-octopusdeploy-variable.json`
2. Implement your resource handlers in `tf_octopusdeploy_variable/handlers.py`
