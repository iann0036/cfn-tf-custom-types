...
1. Write the JSON schema describing your resource, `tf-akamai-appsecpenaltybox.json`
2. Implement your resource handlers in `tf_akamai_appsecpenaltybox/handlers.py`
