...
1. Write the JSON schema describing your resource, `tf-akamai-appsecsecuritypolicyprotections.json`
2. Implement your resource handlers in `tf_akamai_appsecsecuritypolicyprotections/handlers.py`
