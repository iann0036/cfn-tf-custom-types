# TF::Akamai::AppsecRuleConditionException

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecruleconditionexception.json`
2. Implement your resource handlers in `tf_akamai_appsecruleconditionexception/handlers.py`
