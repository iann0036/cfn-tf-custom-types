...
1. Write the JSON schema describing your resource, `tf-akamai-networklistnetworklist.json`
2. Implement your resource handlers in `tf_akamai_networklistnetworklist/handlers.py`
