...
1. Write the JSON schema describing your resource, `tf-akamai-appseccustomruleaction.json`
2. Implement your resource handlers in `tf_akamai_appseccustomruleaction/handlers.py`
