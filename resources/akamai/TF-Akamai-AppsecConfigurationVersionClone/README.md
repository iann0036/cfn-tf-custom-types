...
1. Write the JSON schema describing your resource, `tf-akamai-appsecconfigurationversionclone.json`
2. Implement your resource handlers in `tf_akamai_appsecconfigurationversionclone/handlers.py`
