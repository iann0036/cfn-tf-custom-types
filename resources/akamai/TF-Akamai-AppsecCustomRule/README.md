...
1. Write the JSON schema describing your resource, `tf-akamai-appseccustomrule.json`
2. Implement your resource handlers in `tf_akamai_appseccustomrule/handlers.py`
