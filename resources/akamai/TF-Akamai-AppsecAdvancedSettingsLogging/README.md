# TF::Akamai::AppsecAdvancedSettingsLogging

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecadvancedsettingslogging.json`
2. Implement your resource handlers in `tf_akamai_appsecadvancedsettingslogging/handlers.py`
