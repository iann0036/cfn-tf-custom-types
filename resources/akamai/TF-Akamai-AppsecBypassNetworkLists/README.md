...
1. Write the JSON schema describing your resource, `tf-akamai-appsecbypassnetworklists.json`
2. Implement your resource handlers in `tf_akamai_appsecbypassnetworklists/handlers.py`
