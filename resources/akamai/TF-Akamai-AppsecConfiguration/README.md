# TF::Akamai::AppsecConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecconfiguration.json`
2. Implement your resource handlers in `tf_akamai_appsecconfiguration/handlers.py`
