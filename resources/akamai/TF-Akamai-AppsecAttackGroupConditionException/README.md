...
1. Write the JSON schema describing your resource, `tf-akamai-appsecattackgroupconditionexception.json`
2. Implement your resource handlers in `tf_akamai_appsecattackgroupconditionexception/handlers.py`
