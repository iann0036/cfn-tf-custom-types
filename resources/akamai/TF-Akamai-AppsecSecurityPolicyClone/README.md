...
1. Write the JSON schema describing your resource, `tf-akamai-appsecsecuritypolicyclone.json`
2. Implement your resource handlers in `tf_akamai_appsecsecuritypolicyclone/handlers.py`
