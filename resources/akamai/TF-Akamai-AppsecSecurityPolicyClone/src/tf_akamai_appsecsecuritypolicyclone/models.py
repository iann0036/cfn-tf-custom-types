...
class ResourceModel(BaseModel):
    ...
    CreateFromSecurityPolicyId: Optional[str]
    Id: Optional[str]
    SecurityPolicyId: Optional[str]
    SecurityPolicyName: Optional[str]
    SecurityPolicyPrefix: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CreateFromSecurityPolicyId=json_data.get("CreateFromSecurityPolicyId"),
            Id=json_data.get("Id"),
            SecurityPolicyId=json_data.get("SecurityPolicyId"),
            SecurityPolicyName=json_data.get("SecurityPolicyName"),
            SecurityPolicyPrefix=json_data.get("SecurityPolicyPrefix"),
