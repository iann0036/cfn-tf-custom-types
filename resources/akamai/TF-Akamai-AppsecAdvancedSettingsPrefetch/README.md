...
1. Write the JSON schema describing your resource, `tf-akamai-appsecadvancedsettingsprefetch.json`
2. Implement your resource handlers in `tf_akamai_appsecadvancedsettingsprefetch/handlers.py`
