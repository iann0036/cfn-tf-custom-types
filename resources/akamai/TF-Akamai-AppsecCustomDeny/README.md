...
1. Write the JSON schema describing your resource, `tf-akamai-appseccustomdeny.json`
2. Implement your resource handlers in `tf_akamai_appseccustomdeny/handlers.py`
