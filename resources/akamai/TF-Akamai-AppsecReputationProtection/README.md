# TF::Akamai::AppsecReputationProtection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecreputationprotection.json`
2. Implement your resource handlers in `tf_akamai_appsecreputationprotection/handlers.py`
