# TF::Akamai::NetworklistDescription

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-networklistdescription.json`
2. Implement your resource handlers in `tf_akamai_networklistdescription/handlers.py`
