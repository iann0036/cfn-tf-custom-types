# TF::Akamai::AppsecRateProtection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecrateprotection.json`
2. Implement your resource handlers in `tf_akamai_appsecrateprotection/handlers.py`
