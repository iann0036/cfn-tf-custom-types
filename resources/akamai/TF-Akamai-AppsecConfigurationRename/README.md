# TF::Akamai::AppsecConfigurationRename

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecconfigurationrename.json`
2. Implement your resource handlers in `tf_akamai_appsecconfigurationrename/handlers.py`
