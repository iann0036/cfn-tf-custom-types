# TF::Akamai::AppsecRatePolicyAction

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecratepolicyaction.json`
2. Implement your resource handlers in `tf_akamai_appsecratepolicyaction/handlers.py`
