...
1. Write the JSON schema describing your resource, `tf-akamai-appsecapirequestconstraints.json`
2. Implement your resource handlers in `tf_akamai_appsecapirequestconstraints/handlers.py`
