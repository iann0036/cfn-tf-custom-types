# TF::Akamai::AppsecRuleAction

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecruleaction.json`
2. Implement your resource handlers in `tf_akamai_appsecruleaction/handlers.py`
