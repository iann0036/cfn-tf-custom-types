...
1. Write the JSON schema describing your resource, `tf-akamai-appsecruleupgrade.json`
2. Implement your resource handlers in `tf_akamai_appsecruleupgrade/handlers.py`
