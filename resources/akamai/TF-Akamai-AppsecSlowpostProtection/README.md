# TF::Akamai::AppsecSlowpostProtection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecslowpostprotection.json`
2. Implement your resource handlers in `tf_akamai_appsecslowpostprotection/handlers.py`
