...
1. Write the JSON schema describing your resource, `tf-akamai-networklistactivations.json`
2. Implement your resource handlers in `tf_akamai_networklistactivations/handlers.py`
