...
1. Write the JSON schema describing your resource, `tf-akamai-appsecsecuritypolicyrename.json`
2. Implement your resource handlers in `tf_akamai_appsecsecuritypolicyrename/handlers.py`
