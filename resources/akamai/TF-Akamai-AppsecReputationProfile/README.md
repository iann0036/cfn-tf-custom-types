...
1. Write the JSON schema describing your resource, `tf-akamai-appsecreputationprofile.json`
2. Implement your resource handlers in `tf_akamai_appsecreputationprofile/handlers.py`
