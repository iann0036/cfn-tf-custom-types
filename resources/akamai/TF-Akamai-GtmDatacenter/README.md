...
1. Write the JSON schema describing your resource, `tf-akamai-gtmdatacenter.json`
2. Implement your resource handlers in `tf_akamai_gtmdatacenter/handlers.py`
