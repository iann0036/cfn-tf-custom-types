...
1. Write the JSON schema describing your resource, `tf-akamai-appsecselectedhostnames.json`
2. Implement your resource handlers in `tf_akamai_appsecselectedhostnames/handlers.py`
