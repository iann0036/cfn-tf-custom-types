...
1. Write the JSON schema describing your resource, `tf-akamai-propertyactivation.json`
2. Implement your resource handlers in `tf_akamai_propertyactivation/handlers.py`
