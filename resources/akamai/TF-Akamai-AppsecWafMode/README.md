...
1. Write the JSON schema describing your resource, `tf-akamai-appsecwafmode.json`
2. Implement your resource handlers in `tf_akamai_appsecwafmode/handlers.py`
