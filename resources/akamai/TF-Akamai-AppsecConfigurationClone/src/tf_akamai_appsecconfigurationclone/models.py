...
class ResourceModel(BaseModel):
    ...
    CreateFromConfigId: Optional[float]
    CreateFromVersion: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CreateFromConfigId=json_data.get("CreateFromConfigId"),
            CreateFromVersion=json_data.get("CreateFromVersion"),
