# TF::Akamai::AppsecConfigurationClone

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecconfigurationclone.json`
2. Implement your resource handlers in `tf_akamai_appsecconfigurationclone/handlers.py`
