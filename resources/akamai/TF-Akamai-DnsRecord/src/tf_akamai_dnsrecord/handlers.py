...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/akamai_dns_record/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'akamai_dns_record',
                'returnValues': ["AnswerType", "DnsName", "Id", "RecordSha", "Serial"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/akamai_dns_record/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/akamai_dns_record/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Active=None, Algorithm=None, AnswerType=None, Certificate=None, Digest=None, DigestType=None, DnsName=None, EmailAddress=None, Expiration=None, Expiry=None, Fingerprint=None, FingerprintType=None, Flags=None, Flagsnaptr=None, Hardware=None, Id=None, Inception=None, Iterations=None, Key=None, Keytag=None, Labels=None, Mailbox=None, MatchType=None, Name=None, NameServer=None, NextHashedOwnerName=None, NxdomainTtl=None, Order=None, OriginalTtl=None, Port=None, Preference=None, Priority=None, PriorityIncrement=None, Protocol=None, RecordSha=None, Recordtype=None, Refresh=None, Regexp=None, Replacement=None, Retry=None, Salt=None, Selector=None, Serial=None, Service=None, Signature=None, Signer=None, Software=None, Subtype=None, SvcParams=None, SvcPriority=None, Target=None, TargetName=None, Ttl=None, Txt=None, TypeBitmaps=None, TypeCovered=None, TypeMnemonic=None, TypeValue=None, Usage=None, Weight=None, Zone=None)
