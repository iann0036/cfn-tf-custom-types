...
1. Write the JSON schema describing your resource, `tf-akamai-appsecactivations.json`
2. Implement your resource handlers in `tf_akamai_appsecactivations/handlers.py`
