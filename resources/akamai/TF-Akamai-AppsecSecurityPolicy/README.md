...
1. Write the JSON schema describing your resource, `tf-akamai-appsecsecuritypolicy.json`
2. Implement your resource handlers in `tf_akamai_appsecsecuritypolicy/handlers.py`
