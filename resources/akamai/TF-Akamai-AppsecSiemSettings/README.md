...
1. Write the JSON schema describing your resource, `tf-akamai-appsecsiemsettings.json`
2. Implement your resource handlers in `tf_akamai_appsecsiemsettings/handlers.py`
