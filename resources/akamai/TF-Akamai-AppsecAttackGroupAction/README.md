...
1. Write the JSON schema describing your resource, `tf-akamai-appsecattackgroupaction.json`
2. Implement your resource handlers in `tf_akamai_appsecattackgroupaction/handlers.py`
