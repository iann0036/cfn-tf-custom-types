...
1. Write the JSON schema describing your resource, `tf-akamai-networklistsubscription.json`
2. Implement your resource handlers in `tf_akamai_networklistsubscription/handlers.py`
