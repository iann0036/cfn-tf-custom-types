...
1. Write the JSON schema describing your resource, `tf-akamai-appsecmatchtarget.json`
2. Implement your resource handlers in `tf_akamai_appsecmatchtarget/handlers.py`
