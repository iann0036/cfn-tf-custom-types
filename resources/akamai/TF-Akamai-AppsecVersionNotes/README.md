# TF::Akamai::AppsecVersionNotes

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-akamai-appsecversionnotes.json`
2. Implement your resource handlers in `tf_akamai_appsecversionnotes/handlers.py`
