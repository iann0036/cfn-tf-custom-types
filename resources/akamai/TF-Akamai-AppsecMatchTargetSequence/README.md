...
1. Write the JSON schema describing your resource, `tf-akamai-appsecmatchtargetsequence.json`
2. Implement your resource handlers in `tf_akamai_appsecmatchtargetsequence/handlers.py`
