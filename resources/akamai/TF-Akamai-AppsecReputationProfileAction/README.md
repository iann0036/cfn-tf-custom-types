...
1. Write the JSON schema describing your resource, `tf-akamai-appsecreputationprofileaction.json`
2. Implement your resource handlers in `tf_akamai_appsecreputationprofileaction/handlers.py`
