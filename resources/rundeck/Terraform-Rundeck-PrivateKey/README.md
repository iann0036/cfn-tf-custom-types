...
1. Write the JSON schema describing your resource, `terraform-rundeck-privatekey.json`
2. Implement your resource handlers in `terraform_rundeck_privatekey/handlers.py`
