...
1. Write the JSON schema describing your resource, `terraform-rundeck-publickey.json`
2. Implement your resource handlers in `terraform_rundeck_publickey/handlers.py`
