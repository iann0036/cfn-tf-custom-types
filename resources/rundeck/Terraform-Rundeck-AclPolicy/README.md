...
1. Write the JSON schema describing your resource, `terraform-rundeck-aclpolicy.json`
2. Implement your resource handlers in `terraform_rundeck_aclpolicy/handlers.py`
