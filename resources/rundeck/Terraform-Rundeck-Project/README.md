...
1. Write the JSON schema describing your resource, `terraform-rundeck-project.json`
2. Implement your resource handlers in `terraform_rundeck_project/handlers.py`
