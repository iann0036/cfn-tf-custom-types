...
1. Write the JSON schema describing your resource, `terraform-docker-volume.json`
2. Implement your resource handlers in `terraform_docker_volume/handlers.py`
