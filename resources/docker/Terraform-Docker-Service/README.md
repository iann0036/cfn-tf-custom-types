...
1. Write the JSON schema describing your resource, `terraform-docker-service.json`
2. Implement your resource handlers in `terraform_docker_service/handlers.py`
