...
1. Write the JSON schema describing your resource, `terraform-docker-container.json`
2. Implement your resource handlers in `terraform_docker_container/handlers.py`
