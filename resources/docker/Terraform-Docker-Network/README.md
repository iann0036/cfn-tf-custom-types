...
1. Write the JSON schema describing your resource, `terraform-docker-network.json`
2. Implement your resource handlers in `terraform_docker_network/handlers.py`
