...
1. Write the JSON schema describing your resource, `terraform-docker-config.json`
2. Implement your resource handlers in `terraform_docker_config/handlers.py`
