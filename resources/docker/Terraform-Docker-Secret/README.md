...
1. Write the JSON schema describing your resource, `terraform-docker-secret.json`
2. Implement your resource handlers in `terraform_docker_secret/handlers.py`
