# TF::DigitalOcean::FloatingIpAssignment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-digitalocean-floatingipassignment.json`
2. Implement your resource handlers in `tf_digitalocean_floatingipassignment/handlers.py`
