...
1. Write the JSON schema describing your resource, `tf-digitalocean-kubernetesnodepool.json`
2. Implement your resource handlers in `tf_digitalocean_kubernetesnodepool/handlers.py`
