...
1. Write the JSON schema describing your resource, `tf-digitalocean-droplet.json`
2. Implement your resource handlers in `tf_digitalocean_droplet/handlers.py`
