...
1. Write the JSON schema describing your resource, `terraform-digitalocean-kubernetesnodepool.json`
2. Implement your resource handlers in `terraform_digitalocean_kubernetesnodepool/handlers.py`
