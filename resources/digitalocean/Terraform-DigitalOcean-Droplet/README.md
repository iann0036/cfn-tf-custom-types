...
1. Write the JSON schema describing your resource, `terraform-digitalocean-droplet.json`
2. Implement your resource handlers in `terraform_digitalocean_droplet/handlers.py`
