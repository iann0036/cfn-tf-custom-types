...
1. Write the JSON schema describing your resource, `tf-digitalocean-firewall.json`
2. Implement your resource handlers in `tf_digitalocean_firewall/handlers.py`
