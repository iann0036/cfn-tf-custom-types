...
1. Write the JSON schema describing your resource, `tf-digitalocean-spacesbucketobject.json`
2. Implement your resource handlers in `tf_digitalocean_spacesbucketobject/handlers.py`
