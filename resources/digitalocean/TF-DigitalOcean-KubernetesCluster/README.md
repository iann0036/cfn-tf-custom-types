...
1. Write the JSON schema describing your resource, `tf-digitalocean-kubernetescluster.json`
2. Implement your resource handlers in `tf_digitalocean_kubernetescluster/handlers.py`
