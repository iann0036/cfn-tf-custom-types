...
1. Write the JSON schema describing your resource, `terraform-digitalocean-domain.json`
2. Implement your resource handlers in `terraform_digitalocean_domain/handlers.py`
