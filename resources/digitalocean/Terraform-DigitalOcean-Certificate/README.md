...
1. Write the JSON schema describing your resource, `terraform-digitalocean-certificate.json`
2. Implement your resource handlers in `terraform_digitalocean_certificate/handlers.py`
