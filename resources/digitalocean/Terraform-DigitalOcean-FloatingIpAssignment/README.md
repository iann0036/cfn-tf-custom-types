...
1. Write the JSON schema describing your resource, `terraform-digitalocean-floatingipassignment.json`
2. Implement your resource handlers in `terraform_digitalocean_floatingipassignment/handlers.py`
