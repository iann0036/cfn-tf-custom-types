...
1. Write the JSON schema describing your resource, `tf-digitalocean-certificate.json`
2. Implement your resource handlers in `tf_digitalocean_certificate/handlers.py`
