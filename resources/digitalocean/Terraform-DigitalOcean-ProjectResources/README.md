...
1. Write the JSON schema describing your resource, `terraform-digitalocean-projectresources.json`
2. Implement your resource handlers in `terraform_digitalocean_projectresources/handlers.py`
