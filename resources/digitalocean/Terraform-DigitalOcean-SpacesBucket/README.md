...
1. Write the JSON schema describing your resource, `terraform-digitalocean-spacesbucket.json`
2. Implement your resource handlers in `terraform_digitalocean_spacesbucket/handlers.py`
