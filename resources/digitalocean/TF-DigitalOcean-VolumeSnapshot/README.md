...
1. Write the JSON schema describing your resource, `tf-digitalocean-volumesnapshot.json`
2. Implement your resource handlers in `tf_digitalocean_volumesnapshot/handlers.py`
