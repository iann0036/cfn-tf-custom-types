...
1. Write the JSON schema describing your resource, `terraform-digitalocean-sshkey.json`
2. Implement your resource handlers in `terraform_digitalocean_sshkey/handlers.py`
