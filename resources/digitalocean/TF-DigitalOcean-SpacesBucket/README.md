...
1. Write the JSON schema describing your resource, `tf-digitalocean-spacesbucket.json`
2. Implement your resource handlers in `tf_digitalocean_spacesbucket/handlers.py`
