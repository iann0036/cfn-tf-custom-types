...
1. Write the JSON schema describing your resource, `tf-digitalocean-projectresources.json`
2. Implement your resource handlers in `tf_digitalocean_projectresources/handlers.py`
