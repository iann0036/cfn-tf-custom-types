...
1. Write the JSON schema describing your resource, `terraform-digitalocean-project.json`
2. Implement your resource handlers in `terraform_digitalocean_project/handlers.py`
