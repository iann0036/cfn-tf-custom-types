...
1. Write the JSON schema describing your resource, `terraform-digitalocean-databaseuser.json`
2. Implement your resource handlers in `terraform_digitalocean_databaseuser/handlers.py`
