...
1. Write the JSON schema describing your resource, `terraform-digitalocean-kubernetescluster.json`
2. Implement your resource handlers in `terraform_digitalocean_kubernetescluster/handlers.py`
