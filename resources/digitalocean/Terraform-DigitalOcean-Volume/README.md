...
1. Write the JSON schema describing your resource, `terraform-digitalocean-volume.json`
2. Implement your resource handlers in `terraform_digitalocean_volume/handlers.py`
