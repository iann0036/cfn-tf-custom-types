...
1. Write the JSON schema describing your resource, `terraform-digitalocean-databasecluster.json`
2. Implement your resource handlers in `terraform_digitalocean_databasecluster/handlers.py`
