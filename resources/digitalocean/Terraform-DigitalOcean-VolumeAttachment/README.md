...
1. Write the JSON schema describing your resource, `terraform-digitalocean-volumeattachment.json`
2. Implement your resource handlers in `terraform_digitalocean_volumeattachment/handlers.py`
