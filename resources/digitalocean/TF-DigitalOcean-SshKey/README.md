# TF::DigitalOcean::SshKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-digitalocean-sshkey.json`
2. Implement your resource handlers in `tf_digitalocean_sshkey/handlers.py`
