...
1. Write the JSON schema describing your resource, `terraform-digitalocean-databasefirewall.json`
2. Implement your resource handlers in `terraform_digitalocean_databasefirewall/handlers.py`
