...
1. Write the JSON schema describing your resource, `terraform-digitalocean-databasereplica.json`
2. Implement your resource handlers in `terraform_digitalocean_databasereplica/handlers.py`
