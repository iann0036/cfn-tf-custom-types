...
1. Write the JSON schema describing your resource, `tf-digitalocean-databasecluster.json`
2. Implement your resource handlers in `tf_digitalocean_databasecluster/handlers.py`
