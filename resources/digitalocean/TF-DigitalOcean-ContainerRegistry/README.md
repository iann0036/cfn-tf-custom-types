...
1. Write the JSON schema describing your resource, `tf-digitalocean-containerregistry.json`
2. Implement your resource handlers in `tf_digitalocean_containerregistry/handlers.py`
