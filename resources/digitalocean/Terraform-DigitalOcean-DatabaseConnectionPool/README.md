...
1. Write the JSON schema describing your resource, `terraform-digitalocean-databaseconnectionpool.json`
2. Implement your resource handlers in `terraform_digitalocean_databaseconnectionpool/handlers.py`
