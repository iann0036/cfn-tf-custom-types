...
1. Write the JSON schema describing your resource, `terraform-digitalocean-volumesnapshot.json`
2. Implement your resource handlers in `terraform_digitalocean_volumesnapshot/handlers.py`
