...
1. Write the JSON schema describing your resource, `terraform-digitalocean-tag.json`
2. Implement your resource handlers in `terraform_digitalocean_tag/handlers.py`
