...
1. Write the JSON schema describing your resource, `terraform-digitalocean-floatingip.json`
2. Implement your resource handlers in `terraform_digitalocean_floatingip/handlers.py`
