...
1. Write the JSON schema describing your resource, `terraform-digitalocean-record.json`
2. Implement your resource handlers in `terraform_digitalocean_record/handlers.py`
