...
1. Write the JSON schema describing your resource, `terraform-digitalocean-loadbalancer.json`
2. Implement your resource handlers in `terraform_digitalocean_loadbalancer/handlers.py`
