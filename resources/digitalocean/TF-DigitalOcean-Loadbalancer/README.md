...
1. Write the JSON schema describing your resource, `tf-digitalocean-loadbalancer.json`
2. Implement your resource handlers in `tf_digitalocean_loadbalancer/handlers.py`
