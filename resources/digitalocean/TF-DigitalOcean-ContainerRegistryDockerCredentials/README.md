...
1. Write the JSON schema describing your resource, `tf-digitalocean-containerregistrydockercredentials.json`
2. Implement your resource handlers in `tf_digitalocean_containerregistrydockercredentials/handlers.py`
