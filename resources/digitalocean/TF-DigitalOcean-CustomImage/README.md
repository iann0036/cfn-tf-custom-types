...
1. Write the JSON schema describing your resource, `tf-digitalocean-customimage.json`
2. Implement your resource handlers in `tf_digitalocean_customimage/handlers.py`
