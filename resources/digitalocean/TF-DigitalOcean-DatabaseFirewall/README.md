# TF::DigitalOcean::DatabaseFirewall

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-digitalocean-databasefirewall.json`
2. Implement your resource handlers in `tf_digitalocean_databasefirewall/handlers.py`
