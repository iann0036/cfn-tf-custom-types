...
1. Write the JSON schema describing your resource, `terraform-digitalocean-cdn.json`
2. Implement your resource handlers in `terraform_digitalocean_cdn/handlers.py`
