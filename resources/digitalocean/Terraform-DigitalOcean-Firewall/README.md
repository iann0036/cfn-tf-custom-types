...
1. Write the JSON schema describing your resource, `terraform-digitalocean-firewall.json`
2. Implement your resource handlers in `terraform_digitalocean_firewall/handlers.py`
