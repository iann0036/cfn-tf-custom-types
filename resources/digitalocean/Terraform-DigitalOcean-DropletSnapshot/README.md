...
1. Write the JSON schema describing your resource, `terraform-digitalocean-dropletsnapshot.json`
2. Implement your resource handlers in `terraform_digitalocean_dropletsnapshot/handlers.py`
