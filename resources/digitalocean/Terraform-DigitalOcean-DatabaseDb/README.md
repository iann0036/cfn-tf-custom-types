...
1. Write the JSON schema describing your resource, `terraform-digitalocean-databasedb.json`
2. Implement your resource handlers in `terraform_digitalocean_databasedb/handlers.py`
