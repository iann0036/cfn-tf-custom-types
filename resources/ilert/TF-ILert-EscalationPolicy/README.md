...
1. Write the JSON schema describing your resource, `tf-ilert-escalationpolicy.json`
2. Implement your resource handlers in `tf_ilert_escalationpolicy/handlers.py`
