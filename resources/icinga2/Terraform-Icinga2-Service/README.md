...
1. Write the JSON schema describing your resource, `terraform-icinga2-service.json`
2. Implement your resource handlers in `terraform_icinga2_service/handlers.py`
