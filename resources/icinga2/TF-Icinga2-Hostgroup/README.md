# TF::Icinga2::Hostgroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-icinga2-hostgroup.json`
2. Implement your resource handlers in `tf_icinga2_hostgroup/handlers.py`
