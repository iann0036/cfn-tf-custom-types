# TF::Icinga2::Checkcommand

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-icinga2-checkcommand.json`
2. Implement your resource handlers in `tf_icinga2_checkcommand/handlers.py`
