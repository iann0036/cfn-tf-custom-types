...
1. Write the JSON schema describing your resource, `terraform-icinga2-hostgroup.json`
2. Implement your resource handlers in `terraform_icinga2_hostgroup/handlers.py`
