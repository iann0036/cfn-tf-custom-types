# TF::Icinga2::Notification

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-icinga2-notification.json`
2. Implement your resource handlers in `tf_icinga2_notification/handlers.py`
