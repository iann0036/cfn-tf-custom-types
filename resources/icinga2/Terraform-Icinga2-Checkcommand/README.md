...
1. Write the JSON schema describing your resource, `terraform-icinga2-checkcommand.json`
2. Implement your resource handlers in `terraform_icinga2_checkcommand/handlers.py`
