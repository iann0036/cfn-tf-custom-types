...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbserversslprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbserversslprofile/handlers.py`
