...
1. Write the JSON schema describing your resource, `tf-nsxt-policypredefinedsecuritypolicy.json`
2. Implement your resource handlers in `tf_nsxt_policypredefinedsecuritypolicy/handlers.py`
