...
1. Write the JSON schema describing your resource, `terraform-nsxt-igmptypensservice.json`
2. Implement your resource handlers in `terraform_nsxt_igmptypensservice/handlers.py`
