...
1. Write the JSON schema describing your resource, `tf-nsxt-policystaticroutebfdpeer.json`
2. Implement your resource handlers in `tf_nsxt_policystaticroutebfdpeer/handlers.py`
