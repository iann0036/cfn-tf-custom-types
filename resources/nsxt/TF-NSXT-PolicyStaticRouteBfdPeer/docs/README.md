# TF::NSXT::PolicyStaticRouteBfdPeer
...
<pre>
{
    "Type" : "TF::NSXT::PolicyStaticRouteBfdPeer",
    "Properties" : {
...
Policy path of relevant BFD Profile.
...
A fkag to enable/disable this Peer, default is `true`.
...
List of relevant IPv4 Tier0 external interface addresses.
