...
1. Write the JSON schema describing your resource, `tf-nsxt-policyqosprofile.json`
2. Implement your resource handlers in `tf_nsxt_policyqosprofile/handlers.py`
