...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicaldhcpserver.json`
2. Implement your resource handlers in `terraform_nsxt_logicaldhcpserver/handlers.py`
