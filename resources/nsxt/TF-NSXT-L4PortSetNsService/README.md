# TF::NSXT::L4PortSetNsService

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-l4portsetnsservice.json`
2. Implement your resource handlers in `tf_nsxt_l4portsetnsservice/handlers.py`
