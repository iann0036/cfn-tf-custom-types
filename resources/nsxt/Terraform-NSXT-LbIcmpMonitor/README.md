...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbicmpmonitor.json`
2. Implement your resource handlers in `terraform_nsxt_lbicmpmonitor/handlers.py`
