...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttpforwardingrule.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttpforwardingrule/handlers.py`
