# TF::NSXT::PolicyIpAddressAllocation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-policyipaddressallocation.json`
2. Implement your resource handlers in `tf_nsxt_policyipaddressallocation/handlers.py`
