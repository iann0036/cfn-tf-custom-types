...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicaldhcpport.json`
2. Implement your resource handlers in `terraform_nsxt_logicaldhcpport/handlers.py`
