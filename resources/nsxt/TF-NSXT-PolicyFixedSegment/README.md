...
1. Write the JSON schema describing your resource, `tf-nsxt-policyfixedsegment.json`
2. Implement your resource handlers in `tf_nsxt_policyfixedsegment/handlers.py`
