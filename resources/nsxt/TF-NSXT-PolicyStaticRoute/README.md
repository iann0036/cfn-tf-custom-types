# TF::NSXT::PolicyStaticRoute

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-policystaticroute.json`
2. Implement your resource handlers in `tf_nsxt_policystaticroute/handlers.py`
