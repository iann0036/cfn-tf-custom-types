...
1. Write the JSON schema describing your resource, `terraform-nsxt-dhcpserverprofile.json`
2. Implement your resource handlers in `terraform_nsxt_dhcpserverprofile/handlers.py`
