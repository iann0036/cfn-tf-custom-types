...
1. Write the JSON schema describing your resource, `tf-nsxt-policyevpntunnelendpoint.json`
2. Implement your resource handlers in `tf_nsxt_policyevpntunnelendpoint/handlers.py`
