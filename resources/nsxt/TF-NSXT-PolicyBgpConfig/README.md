...
1. Write the JSON schema describing your resource, `tf-nsxt-policybgpconfig.json`
2. Implement your resource handlers in `tf_nsxt_policybgpconfig/handlers.py`
