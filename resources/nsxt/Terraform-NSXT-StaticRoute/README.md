...
1. Write the JSON schema describing your resource, `terraform-nsxt-staticroute.json`
2. Implement your resource handlers in `terraform_nsxt_staticroute/handlers.py`
