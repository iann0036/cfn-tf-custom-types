...
1. Write the JSON schema describing your resource, `tf-nsxt-policypredefinedgatewaypolicy.json`
2. Implement your resource handlers in `tf_nsxt_policypredefinedgatewaypolicy/handlers.py`
