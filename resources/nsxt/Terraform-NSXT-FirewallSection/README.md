...
1. Write the JSON schema describing your resource, `terraform-nsxt-firewallsection.json`
2. Implement your resource handlers in `terraform_nsxt_firewallsection/handlers.py`
