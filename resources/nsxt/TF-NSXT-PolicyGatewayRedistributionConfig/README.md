...
1. Write the JSON schema describing your resource, `tf-nsxt-policygatewayredistributionconfig.json`
2. Implement your resource handlers in `tf_nsxt_policygatewayredistributionconfig/handlers.py`
