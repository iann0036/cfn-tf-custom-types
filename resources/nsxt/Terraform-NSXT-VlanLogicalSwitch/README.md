...
1. Write the JSON schema describing your resource, `terraform-nsxt-vlanlogicalswitch.json`
2. Implement your resource handlers in `terraform_nsxt_vlanlogicalswitch/handlers.py`
