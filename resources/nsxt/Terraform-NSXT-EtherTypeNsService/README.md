...
1. Write the JSON schema describing your resource, `terraform-nsxt-ethertypensservice.json`
2. Implement your resource handlers in `terraform_nsxt_ethertypensservice/handlers.py`
