...
1. Write the JSON schema describing your resource, `tf-nsxt-policygatewayprefixlist.json`
2. Implement your resource handlers in `tf_nsxt_policygatewayprefixlist/handlers.py`
