# TF::NSXT::LogicalRouterLinkPortOnTier0

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-logicalrouterlinkportontier0.json`
2. Implement your resource handlers in `tf_nsxt_logicalrouterlinkportontier0/handlers.py`
