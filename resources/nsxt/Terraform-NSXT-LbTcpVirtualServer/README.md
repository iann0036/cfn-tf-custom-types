...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbtcpvirtualserver.json`
2. Implement your resource handlers in `terraform_nsxt_lbtcpvirtualserver/handlers.py`
