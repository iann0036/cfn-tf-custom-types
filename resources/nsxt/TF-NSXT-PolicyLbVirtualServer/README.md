...
1. Write the JSON schema describing your resource, `tf-nsxt-policylbvirtualserver.json`
2. Implement your resource handlers in `tf_nsxt_policylbvirtualserver/handlers.py`
