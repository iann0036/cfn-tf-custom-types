...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbfasttcpapplicationprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbfasttcpapplicationprofile/handlers.py`
