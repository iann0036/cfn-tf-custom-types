...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicalrouterlinkportontier0.json`
2. Implement your resource handlers in `terraform_nsxt_logicalrouterlinkportontier0/handlers.py`
