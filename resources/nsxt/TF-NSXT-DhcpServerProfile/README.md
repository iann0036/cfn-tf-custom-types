# TF::NSXT::DhcpServerProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-dhcpserverprofile.json`
2. Implement your resource handlers in `tf_nsxt_dhcpserverprofile/handlers.py`
