...
1. Write the JSON schema describing your resource, `terraform-nsxt-switchsecurityswitchingprofile.json`
2. Implement your resource handlers in `terraform_nsxt_switchsecurityswitchingprofile/handlers.py`
