...
1. Write the JSON schema describing your resource, `tf-nsxt-policygatewaydnsforwarder.json`
2. Implement your resource handlers in `tf_nsxt_policygatewaydnsforwarder/handlers.py`
