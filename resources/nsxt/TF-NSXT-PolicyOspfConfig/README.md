...
1. Write the JSON schema describing your resource, `tf-nsxt-policyospfconfig.json`
2. Implement your resource handlers in `tf_nsxt_policyospfconfig/handlers.py`
