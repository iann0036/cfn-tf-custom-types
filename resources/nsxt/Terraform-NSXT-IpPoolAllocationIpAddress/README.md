...
1. Write the JSON schema describing your resource, `terraform-nsxt-ippoolallocationipaddress.json`
2. Implement your resource handlers in `terraform_nsxt_ippoolallocationipaddress/handlers.py`
