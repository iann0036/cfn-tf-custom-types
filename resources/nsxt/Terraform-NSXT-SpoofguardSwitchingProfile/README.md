...
1. Write the JSON schema describing your resource, `terraform-nsxt-spoofguardswitchingprofile.json`
2. Implement your resource handlers in `terraform_nsxt_spoofguardswitchingprofile/handlers.py`
