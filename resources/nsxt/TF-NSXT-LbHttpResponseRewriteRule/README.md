...
1. Write the JSON schema describing your resource, `tf-nsxt-lbhttpresponserewriterule.json`
2. Implement your resource handlers in `tf_nsxt_lbhttpresponserewriterule/handlers.py`
