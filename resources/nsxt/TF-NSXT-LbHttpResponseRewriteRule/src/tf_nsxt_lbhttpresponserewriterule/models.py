...
class ResourceModel(BaseModel):
    ...
    ResponseHeaderCondition: Optional[Sequence["_ResponseHeaderConditionDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ResponseHeaderCondition=deserialize_list(json_data.get("ResponseHeaderCondition"), ResponseHeaderConditionDefinition),
...
@dataclass
class ResponseHeaderConditionDefinition(BaseModel):
    CaseSensitive: Optional[bool]
    Inverse: Optional[bool]
    MatchType: Optional[str]
    Name: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ResponseHeaderConditionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ResponseHeaderConditionDefinition"]:
        if not json_data:
            return None
        return cls(
            CaseSensitive=json_data.get("CaseSensitive"),
...
# work around possible type aliasing issues when variable has same name as a model
_ResponseHeaderConditionDefinition = ResponseHeaderConditionDefinition
