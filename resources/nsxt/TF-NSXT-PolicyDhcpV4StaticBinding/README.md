...
1. Write the JSON schema describing your resource, `tf-nsxt-policydhcpv4staticbinding.json`
2. Implement your resource handlers in `tf_nsxt_policydhcpv4staticbinding/handlers.py`
