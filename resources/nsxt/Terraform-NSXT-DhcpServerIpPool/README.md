...
1. Write the JSON schema describing your resource, `terraform-nsxt-dhcpserverippool.json`
2. Implement your resource handlers in `terraform_nsxt_dhcpserverippool/handlers.py`
