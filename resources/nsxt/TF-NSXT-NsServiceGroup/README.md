# TF::NSXT::NsServiceGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-nsservicegroup.json`
2. Implement your resource handlers in `tf_nsxt_nsservicegroup/handlers.py`
