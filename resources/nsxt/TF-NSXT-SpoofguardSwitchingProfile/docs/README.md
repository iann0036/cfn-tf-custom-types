...
<pre>
{
    "Type" : "TF::NSXT::SpoofguardSwitchingProfile",
    "Properties" : {
        "<a href="#addressbindingwhitelistenabled" title="AddressBindingWhitelistEnabled">AddressBindingWhitelistEnabled</a>" : <i>Boolean</i>,
