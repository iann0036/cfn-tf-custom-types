# TF::NSXT::SpoofguardSwitchingProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-spoofguardswitchingprofile.json`
2. Implement your resource handlers in `tf_nsxt_spoofguardswitchingprofile/handlers.py`
