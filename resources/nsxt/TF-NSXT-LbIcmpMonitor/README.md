# TF::NSXT::LbIcmpMonitor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-lbicmpmonitor.json`
2. Implement your resource handlers in `tf_nsxt_lbicmpmonitor/handlers.py`
