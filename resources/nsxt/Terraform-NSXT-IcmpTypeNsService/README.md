...
1. Write the JSON schema describing your resource, `terraform-nsxt-icmptypensservice.json`
2. Implement your resource handlers in `terraform_nsxt_icmptypensservice/handlers.py`
