...
1. Write the JSON schema describing your resource, `tf-nsxt-policytier1gateway.json`
2. Implement your resource handlers in `tf_nsxt_policytier1gateway/handlers.py`
