# TF::NSXT::LbHttpsMonitor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-lbhttpsmonitor.json`
2. Implement your resource handlers in `tf_nsxt_lbhttpsmonitor/handlers.py`
