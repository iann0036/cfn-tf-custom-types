...
1. Write the JSON schema describing your resource, `terraform-nsxt-dhcprelayprofile.json`
2. Implement your resource handlers in `terraform_nsxt_dhcprelayprofile/handlers.py`
