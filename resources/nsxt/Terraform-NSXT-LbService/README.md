...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbservice.json`
2. Implement your resource handlers in `terraform_nsxt_lbservice/handlers.py`
