...
1. Write the JSON schema describing your resource, `tf-nsxt-logicaltier0router.json`
2. Implement your resource handlers in `tf_nsxt_logicaltier0router/handlers.py`
