...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbfastudpapplicationprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbfastudpapplicationprofile/handlers.py`
