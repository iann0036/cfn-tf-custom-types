...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttpsmonitor.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttpsmonitor/handlers.py`
