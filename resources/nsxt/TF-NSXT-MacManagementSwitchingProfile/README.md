...
1. Write the JSON schema describing your resource, `tf-nsxt-macmanagementswitchingprofile.json`
2. Implement your resource handlers in `tf_nsxt_macmanagementswitchingprofile/handlers.py`
