...
1. Write the JSON schema describing your resource, `terraform-nsxt-dhcprelayservice.json`
2. Implement your resource handlers in `terraform_nsxt_dhcprelayservice/handlers.py`
