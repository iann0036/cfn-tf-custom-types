...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbsourceippersistenceprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbsourceippersistenceprofile/handlers.py`
