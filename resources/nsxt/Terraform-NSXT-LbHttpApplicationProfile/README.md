...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttpapplicationprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttpapplicationprofile/handlers.py`
