...
1. Write the JSON schema describing your resource, `terraform-nsxt-l4portsetnsservice.json`
2. Implement your resource handlers in `terraform_nsxt_l4portsetnsservice/handlers.py`
