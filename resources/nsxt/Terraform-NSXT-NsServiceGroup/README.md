...
1. Write the JSON schema describing your resource, `terraform-nsxt-nsservicegroup.json`
2. Implement your resource handlers in `terraform_nsxt_nsservicegroup/handlers.py`
