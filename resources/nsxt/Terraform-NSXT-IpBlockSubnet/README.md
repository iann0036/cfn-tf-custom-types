...
1. Write the JSON schema describing your resource, `terraform-nsxt-ipblocksubnet.json`
2. Implement your resource handlers in `terraform_nsxt_ipblocksubnet/handlers.py`
