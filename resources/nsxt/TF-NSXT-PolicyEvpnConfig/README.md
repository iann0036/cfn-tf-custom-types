...
1. Write the JSON schema describing your resource, `tf-nsxt-policyevpnconfig.json`
2. Implement your resource handlers in `tf_nsxt_policyevpnconfig/handlers.py`
