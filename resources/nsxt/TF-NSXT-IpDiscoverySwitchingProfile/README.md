...
1. Write the JSON schema describing your resource, `tf-nsxt-ipdiscoveryswitchingprofile.json`
2. Implement your resource handlers in `tf_nsxt_ipdiscoveryswitchingprofile/handlers.py`
