...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttpmonitor.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttpmonitor/handlers.py`
