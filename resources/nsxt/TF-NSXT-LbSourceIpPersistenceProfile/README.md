# TF::NSXT::LbSourceIpPersistenceProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-lbsourceippersistenceprofile.json`
2. Implement your resource handlers in `tf_nsxt_lbsourceippersistenceprofile/handlers.py`
