...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbudpmonitor.json`
2. Implement your resource handlers in `terraform_nsxt_lbudpmonitor/handlers.py`
