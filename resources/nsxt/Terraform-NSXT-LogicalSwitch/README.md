...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicalswitch.json`
2. Implement your resource handlers in `terraform_nsxt_logicalswitch/handlers.py`
