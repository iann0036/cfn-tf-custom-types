...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbudpvirtualserver.json`
2. Implement your resource handlers in `terraform_nsxt_lbudpvirtualserver/handlers.py`
