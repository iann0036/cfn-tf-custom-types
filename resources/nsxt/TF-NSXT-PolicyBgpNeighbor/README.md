...
1. Write the JSON schema describing your resource, `tf-nsxt-policybgpneighbor.json`
2. Implement your resource handlers in `tf_nsxt_policybgpneighbor/handlers.py`
