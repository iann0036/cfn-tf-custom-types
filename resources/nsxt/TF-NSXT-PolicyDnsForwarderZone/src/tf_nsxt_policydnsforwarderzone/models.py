...
class ResourceModel(BaseModel):
    ...
    DnsDomainNames: Optional[Sequence[str]]
    Id: Optional[str]
    NsxId: Optional[str]
    Path: Optional[str]
    Revision: Optional[float]
    SourceIp: Optional[str]
    UpstreamServers: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DnsDomainNames=json_data.get("DnsDomainNames"),
            Id=json_data.get("Id"),
            NsxId=json_data.get("NsxId"),
            Path=json_data.get("Path"),
            Revision=json_data.get("Revision"),
            SourceIp=json_data.get("SourceIp"),
            UpstreamServers=json_data.get("UpstreamServers"),
