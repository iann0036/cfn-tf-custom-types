...
1. Write the JSON schema describing your resource, `tf-nsxt-policydnsforwarderzone.json`
2. Implement your resource handlers in `tf_nsxt_policydnsforwarderzone/handlers.py`
