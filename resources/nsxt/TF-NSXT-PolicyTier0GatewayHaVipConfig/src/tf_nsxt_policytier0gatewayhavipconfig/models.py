...
class ConfigDefinition(BaseModel):
    ...
    ExternalInterfacePaths: Optional[Sequence[str]]
    VipSubnets: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ExternalInterfacePaths=json_data.get("ExternalInterfacePaths"),
            VipSubnets=json_data.get("VipSubnets"),
        )
