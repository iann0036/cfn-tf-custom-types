...
1. Write the JSON schema describing your resource, `tf-nsxt-policytier0gatewayhavipconfig.json`
2. Implement your resource handlers in `tf_nsxt_policytier0gatewayhavipconfig/handlers.py`
