...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbpassivemonitor.json`
2. Implement your resource handlers in `terraform_nsxt_lbpassivemonitor/handlers.py`
