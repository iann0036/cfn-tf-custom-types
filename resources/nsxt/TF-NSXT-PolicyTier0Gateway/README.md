...
1. Write the JSON schema describing your resource, `tf-nsxt-policytier0gateway.json`
2. Implement your resource handlers in `tf_nsxt_policytier0gateway/handlers.py`
