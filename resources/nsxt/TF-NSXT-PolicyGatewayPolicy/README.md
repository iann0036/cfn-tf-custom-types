...
1. Write the JSON schema describing your resource, `tf-nsxt-policygatewaypolicy.json`
2. Implement your resource handlers in `tf_nsxt_policygatewaypolicy/handlers.py`
