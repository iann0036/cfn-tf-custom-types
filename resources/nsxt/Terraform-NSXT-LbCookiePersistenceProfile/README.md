...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbcookiepersistenceprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbcookiepersistenceprofile/handlers.py`
