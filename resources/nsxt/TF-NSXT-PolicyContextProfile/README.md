...
1. Write the JSON schema describing your resource, `tf-nsxt-policycontextprofile.json`
2. Implement your resource handlers in `tf_nsxt_policycontextprofile/handlers.py`
