...
1. Write the JSON schema describing your resource, `tf-nsxt-policyintrusionservicepolicy.json`
2. Implement your resource handlers in `tf_nsxt_policyintrusionservicepolicy/handlers.py`
