...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicalrouterdownlinkport.json`
2. Implement your resource handlers in `terraform_nsxt_logicalrouterdownlinkport/handlers.py`
