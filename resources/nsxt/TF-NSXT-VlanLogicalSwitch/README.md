...
1. Write the JSON schema describing your resource, `tf-nsxt-vlanlogicalswitch.json`
2. Implement your resource handlers in `tf_nsxt_vlanlogicalswitch/handlers.py`
