...
1. Write the JSON schema describing your resource, `tf-nsxt-logicalroutercentralizedserviceport.json`
2. Implement your resource handlers in `tf_nsxt_logicalroutercentralizedserviceport/handlers.py`
