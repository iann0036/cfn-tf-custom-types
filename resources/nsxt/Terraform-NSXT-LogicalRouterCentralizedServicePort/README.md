...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicalroutercentralizedserviceport.json`
2. Implement your resource handlers in `terraform_nsxt_logicalroutercentralizedserviceport/handlers.py`
