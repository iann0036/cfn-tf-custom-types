# TF::NSXT::LbServerSslProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-lbserversslprofile.json`
2. Implement your resource handlers in `tf_nsxt_lbserversslprofile/handlers.py`
