...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicaltier0router.json`
2. Implement your resource handlers in `terraform_nsxt_logicaltier0router/handlers.py`
