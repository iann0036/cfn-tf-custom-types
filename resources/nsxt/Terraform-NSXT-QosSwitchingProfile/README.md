...
1. Write the JSON schema describing your resource, `terraform-nsxt-qosswitchingprofile.json`
2. Implement your resource handlers in `terraform_nsxt_qosswitchingprofile/handlers.py`
