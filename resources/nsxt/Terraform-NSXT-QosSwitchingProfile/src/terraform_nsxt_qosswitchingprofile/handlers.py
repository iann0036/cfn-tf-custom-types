...
def create_handler(
    ...
    try:
        ...
        tf['resource']['nsxt_qos_switching_profile'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['nsxt_qos_switching_profile'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
