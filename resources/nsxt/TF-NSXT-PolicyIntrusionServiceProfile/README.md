...
1. Write the JSON schema describing your resource, `tf-nsxt-policyintrusionserviceprofile.json`
2. Implement your resource handlers in `tf_nsxt_policyintrusionserviceprofile/handlers.py`
