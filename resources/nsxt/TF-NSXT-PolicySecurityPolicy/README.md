...
1. Write the JSON schema describing your resource, `tf-nsxt-policysecuritypolicy.json`
2. Implement your resource handlers in `tf_nsxt_policysecuritypolicy/handlers.py`
