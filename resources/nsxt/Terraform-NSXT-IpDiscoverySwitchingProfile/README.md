...
1. Write the JSON schema describing your resource, `terraform-nsxt-ipdiscoveryswitchingprofile.json`
2. Implement your resource handlers in `terraform_nsxt_ipdiscoveryswitchingprofile/handlers.py`
