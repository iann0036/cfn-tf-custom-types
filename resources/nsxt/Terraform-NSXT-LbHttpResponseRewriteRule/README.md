...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttpresponserewriterule.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttpresponserewriterule/handlers.py`
