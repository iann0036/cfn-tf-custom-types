# TF::NSXT::PolicyDomain

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-policydomain.json`
2. Implement your resource handlers in `tf_nsxt_policydomain/handlers.py`
