# TF::NSXT::LogicalRouterLinkPortOnTier1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-logicalrouterlinkportontier1.json`
2. Implement your resource handlers in `tf_nsxt_logicalrouterlinkportontier1/handlers.py`
