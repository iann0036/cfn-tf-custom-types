# TF::NSXT::IpPoolAllocationIpAddress

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-ippoolallocationipaddress.json`
2. Implement your resource handlers in `tf_nsxt_ippoolallocationipaddress/handlers.py`
