# TF::NSXT::PolicyDhcpV6StaticBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-policydhcpv6staticbinding.json`
2. Implement your resource handlers in `tf_nsxt_policydhcpv6staticbinding/handlers.py`
