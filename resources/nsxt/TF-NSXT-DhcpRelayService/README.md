...
1. Write the JSON schema describing your resource, `tf-nsxt-dhcprelayservice.json`
2. Implement your resource handlers in `tf_nsxt_dhcprelayservice/handlers.py`
