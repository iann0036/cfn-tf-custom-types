# TF::NSXT::LogicalTier1Router

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nsxt-logicaltier1router.json`
2. Implement your resource handlers in `tf_nsxt_logicaltier1router/handlers.py`
