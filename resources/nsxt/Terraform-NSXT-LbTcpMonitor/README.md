...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbtcpmonitor.json`
2. Implement your resource handlers in `terraform_nsxt_lbtcpmonitor/handlers.py`
