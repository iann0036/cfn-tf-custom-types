...
1. Write the JSON schema describing your resource, `tf-nsxt-lbhttpforwardingrule.json`
2. Implement your resource handlers in `tf_nsxt_lbhttpforwardingrule/handlers.py`
