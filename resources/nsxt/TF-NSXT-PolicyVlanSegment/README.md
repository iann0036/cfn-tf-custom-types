...
1. Write the JSON schema describing your resource, `tf-nsxt-policyvlansegment.json`
2. Implement your resource handlers in `tf_nsxt_policyvlansegment/handlers.py`
