...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicalrouterlinkportontier1.json`
2. Implement your resource handlers in `terraform_nsxt_logicalrouterlinkportontier1/handlers.py`
