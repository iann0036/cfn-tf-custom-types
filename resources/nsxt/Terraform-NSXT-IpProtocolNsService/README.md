...
1. Write the JSON schema describing your resource, `terraform-nsxt-ipprotocolnsservice.json`
2. Implement your resource handlers in `terraform_nsxt_ipprotocolnsservice/handlers.py`
