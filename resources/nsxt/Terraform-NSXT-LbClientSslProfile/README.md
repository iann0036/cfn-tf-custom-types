...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbclientsslprofile.json`
2. Implement your resource handlers in `terraform_nsxt_lbclientsslprofile/handlers.py`
