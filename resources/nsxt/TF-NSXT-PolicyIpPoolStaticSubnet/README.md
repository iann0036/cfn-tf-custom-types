...
1. Write the JSON schema describing your resource, `tf-nsxt-policyippoolstaticsubnet.json`
2. Implement your resource handlers in `tf_nsxt_policyippoolstaticsubnet/handlers.py`
