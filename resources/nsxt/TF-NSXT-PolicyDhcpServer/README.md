...
1. Write the JSON schema describing your resource, `tf-nsxt-policydhcpserver.json`
2. Implement your resource handlers in `tf_nsxt_policydhcpserver/handlers.py`
