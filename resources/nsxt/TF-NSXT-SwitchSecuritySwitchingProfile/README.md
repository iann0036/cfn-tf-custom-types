...
1. Write the JSON schema describing your resource, `tf-nsxt-switchsecurityswitchingprofile.json`
2. Implement your resource handlers in `tf_nsxt_switchsecurityswitchingprofile/handlers.py`
