...
1. Write the JSON schema describing your resource, `terraform-nsxt-logicalport.json`
2. Implement your resource handlers in `terraform_nsxt_logicalport/handlers.py`
