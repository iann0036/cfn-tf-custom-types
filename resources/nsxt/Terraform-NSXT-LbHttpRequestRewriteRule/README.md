...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttprequestrewriterule.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttprequestrewriterule/handlers.py`
