...
1. Write the JSON schema describing your resource, `terraform-nsxt-lbhttpvirtualserver.json`
2. Implement your resource handlers in `terraform_nsxt_lbhttpvirtualserver/handlers.py`
