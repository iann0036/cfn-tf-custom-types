...
1. Write the JSON schema describing your resource, `terraform-nsxt-algorithmtypensservice.json`
2. Implement your resource handlers in `terraform_nsxt_algorithmtypensservice/handlers.py`
