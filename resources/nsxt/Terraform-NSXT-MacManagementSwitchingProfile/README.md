...
1. Write the JSON schema describing your resource, `terraform-nsxt-macmanagementswitchingprofile.json`
2. Implement your resource handlers in `terraform_nsxt_macmanagementswitchingprofile/handlers.py`
