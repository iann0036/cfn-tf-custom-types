...
1. Write the JSON schema describing your resource, `tf-azuread-applicationapprole.json`
2. Implement your resource handlers in `tf_azuread_applicationapprole/handlers.py`
