...
1. Write the JSON schema describing your resource, `terraform-azuread-groupmember.json`
2. Implement your resource handlers in `terraform_azuread_groupmember/handlers.py`
