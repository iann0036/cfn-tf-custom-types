...
1. Write the JSON schema describing your resource, `terraform-azuread-serviceprincipalpassword.json`
2. Implement your resource handlers in `terraform_azuread_serviceprincipalpassword/handlers.py`
