...
1. Write the JSON schema describing your resource, `terraform-azuread-application.json`
2. Implement your resource handlers in `terraform_azuread_application/handlers.py`
