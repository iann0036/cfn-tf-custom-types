...
1. Write the JSON schema describing your resource, `tf-azuread-applicationoauth2permission.json`
2. Implement your resource handlers in `tf_azuread_applicationoauth2permission/handlers.py`
