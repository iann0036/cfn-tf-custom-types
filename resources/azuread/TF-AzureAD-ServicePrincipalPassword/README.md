# TF::AzureAD::ServicePrincipalPassword

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azuread-serviceprincipalpassword.json`
2. Implement your resource handlers in `tf_azuread_serviceprincipalpassword/handlers.py`
