# TF::AzureAD::ServicePrincipalCertificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azuread-serviceprincipalcertificate.json`
2. Implement your resource handlers in `tf_azuread_serviceprincipalcertificate/handlers.py`
