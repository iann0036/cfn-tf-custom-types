...
1. Write the JSON schema describing your resource, `tf-azuread-applicationcertificate.json`
2. Implement your resource handlers in `tf_azuread_applicationcertificate/handlers.py`
