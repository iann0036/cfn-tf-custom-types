# Terraform::AzureAD::ApplicationPassword

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azuread-applicationpassword.json`
2. Implement your resource handlers in `terraform_azuread_applicationpassword/handlers.py`
