...
1. Write the JSON schema describing your resource, `terraform-azuread-serviceprincipal.json`
2. Implement your resource handlers in `terraform_azuread_serviceprincipal/handlers.py`
