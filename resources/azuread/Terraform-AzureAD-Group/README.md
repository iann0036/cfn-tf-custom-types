...
1. Write the JSON schema describing your resource, `terraform-azuread-group.json`
2. Implement your resource handlers in `terraform_azuread_group/handlers.py`
