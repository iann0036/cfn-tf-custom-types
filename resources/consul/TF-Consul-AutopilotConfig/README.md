...
1. Write the JSON schema describing your resource, `tf-consul-autopilotconfig.json`
2. Implement your resource handlers in `tf_consul_autopilotconfig/handlers.py`
