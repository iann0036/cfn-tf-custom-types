...
1. Write the JSON schema describing your resource, `terraform-consul-acltoken.json`
2. Implement your resource handlers in `terraform_consul_acltoken/handlers.py`
