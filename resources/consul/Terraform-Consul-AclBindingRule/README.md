...
1. Write the JSON schema describing your resource, `terraform-consul-aclbindingrule.json`
2. Implement your resource handlers in `terraform_consul_aclbindingrule/handlers.py`
