...
1. Write the JSON schema describing your resource, `terraform-consul-configentry.json`
2. Implement your resource handlers in `terraform_consul_configentry/handlers.py`
