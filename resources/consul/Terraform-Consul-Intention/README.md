...
1. Write the JSON schema describing your resource, `terraform-consul-intention.json`
2. Implement your resource handlers in `terraform_consul_intention/handlers.py`
