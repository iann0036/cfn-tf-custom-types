...
1. Write the JSON schema describing your resource, `terraform-consul-acltokenpolicyattachment.json`
2. Implement your resource handlers in `terraform_consul_acltokenpolicyattachment/handlers.py`
