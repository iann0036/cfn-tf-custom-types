...
1. Write the JSON schema describing your resource, `terraform-consul-aclrole.json`
2. Implement your resource handlers in `terraform_consul_aclrole/handlers.py`
