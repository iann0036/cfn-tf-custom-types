...
1. Write the JSON schema describing your resource, `terraform-consul-catalogentry.json`
2. Implement your resource handlers in `terraform_consul_catalogentry/handlers.py`
