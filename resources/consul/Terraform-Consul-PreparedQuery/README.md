...
1. Write the JSON schema describing your resource, `terraform-consul-preparedquery.json`
2. Implement your resource handlers in `terraform_consul_preparedquery/handlers.py`
