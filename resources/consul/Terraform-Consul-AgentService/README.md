...
1. Write the JSON schema describing your resource, `terraform-consul-agentservice.json`
2. Implement your resource handlers in `terraform_consul_agentservice/handlers.py`
