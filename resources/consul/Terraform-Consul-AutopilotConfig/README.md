...
1. Write the JSON schema describing your resource, `terraform-consul-autopilotconfig.json`
2. Implement your resource handlers in `terraform_consul_autopilotconfig/handlers.py`
