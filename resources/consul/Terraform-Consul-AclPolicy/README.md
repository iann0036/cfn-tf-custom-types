...
1. Write the JSON schema describing your resource, `terraform-consul-aclpolicy.json`
2. Implement your resource handlers in `terraform_consul_aclpolicy/handlers.py`
