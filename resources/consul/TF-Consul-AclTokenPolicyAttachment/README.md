...
1. Write the JSON schema describing your resource, `tf-consul-acltokenpolicyattachment.json`
2. Implement your resource handlers in `tf_consul_acltokenpolicyattachment/handlers.py`
