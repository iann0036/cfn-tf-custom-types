...
1. Write the JSON schema describing your resource, `terraform-consul-aclauthmethod.json`
2. Implement your resource handlers in `terraform_consul_aclauthmethod/handlers.py`
