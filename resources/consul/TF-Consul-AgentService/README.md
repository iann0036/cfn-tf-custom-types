# TF::Consul::AgentService

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-consul-agentservice.json`
2. Implement your resource handlers in `tf_consul_agentservice/handlers.py`
