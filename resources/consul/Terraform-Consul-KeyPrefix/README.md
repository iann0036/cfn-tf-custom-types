...
1. Write the JSON schema describing your resource, `terraform-consul-keyprefix.json`
2. Implement your resource handlers in `terraform_consul_keyprefix/handlers.py`
