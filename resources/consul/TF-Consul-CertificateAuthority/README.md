# TF::Consul::CertificateAuthority

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-consul-certificateauthority.json`
2. Implement your resource handlers in `tf_consul_certificateauthority/handlers.py`
