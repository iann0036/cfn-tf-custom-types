...
1. Write the JSON schema describing your resource, `terraform-consul-service.json`
2. Implement your resource handlers in `terraform_consul_service/handlers.py`
