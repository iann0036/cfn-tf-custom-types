...
1. Write the JSON schema describing your resource, `tf-consul-preparedquery.json`
2. Implement your resource handlers in `tf_consul_preparedquery/handlers.py`
