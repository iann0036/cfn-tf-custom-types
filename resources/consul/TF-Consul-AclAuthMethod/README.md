...
1. Write the JSON schema describing your resource, `tf-consul-aclauthmethod.json`
2. Implement your resource handlers in `tf_consul_aclauthmethod/handlers.py`
