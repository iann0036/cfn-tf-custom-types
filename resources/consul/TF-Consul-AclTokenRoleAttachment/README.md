# TF::Consul::AclTokenRoleAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-consul-acltokenroleattachment.json`
2. Implement your resource handlers in `tf_consul_acltokenroleattachment/handlers.py`
