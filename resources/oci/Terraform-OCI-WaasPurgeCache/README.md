...
1. Write the JSON schema describing your resource, `terraform-oci-waaspurgecache.json`
2. Implement your resource handlers in `terraform_oci_waaspurgecache/handlers.py`
