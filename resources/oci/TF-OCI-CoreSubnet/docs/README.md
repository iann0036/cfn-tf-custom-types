...
[Overview of the IAM Service](https://docs.cloud.or...
...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#prohibitinternetingress" title="ProhibitInternetIngress">ProhibitInternetIngress</a>" : <i>Boolean</i>,
