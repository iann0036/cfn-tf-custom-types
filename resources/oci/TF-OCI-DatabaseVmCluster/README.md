...
1. Write the JSON schema describing your resource, `tf-oci-databasevmcluster.json`
2. Implement your resource handlers in `tf_oci_databasevmcluster/handlers.py`
