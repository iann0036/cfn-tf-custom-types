...
<pre>
{
    "Type" : "TF::OCI::DatacatalogCatalog",
    "Properties" : {
        "<a href="#attachedcatalogprivateendpoints" title="AttachedCatalogPrivateEndpoints">AttachedCatalogPrivateEndpoints</a>" : <i>[ String, ... ]</i>,
...
Type: TF::OCI::DatacatalogCatalog
Properties:
    <a href="#attachedcatalogprivateendpoints" title="AttachedCatalogPrivateEndpoints">AttachedCatalogPrivateEndpoints</a>: <i>
      - String</i>
    <a href="#compartmentid" title="CompartmentId">CompartmentId</a>: <i>String</i>
...
Returns the <code>NumberOfObjects</code> value.

#### ServiceApiUrl

Returns the <code>ServiceApiUrl</code> value.
