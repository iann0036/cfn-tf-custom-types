...
1. Write the JSON schema describing your resource, `tf-oci-datacatalogcatalog.json`
2. Implement your resource handlers in `tf_oci_datacatalogcatalog/handlers.py`
