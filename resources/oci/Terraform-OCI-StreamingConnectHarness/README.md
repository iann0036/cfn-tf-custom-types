...
1. Write the JSON schema describing your resource, `terraform-oci-streamingconnectharness.json`
2. Implement your resource handlers in `terraform_oci_streamingconnectharness/handlers.py`
