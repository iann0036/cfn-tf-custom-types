...
1. Write the JSON schema describing your resource, `tf-oci-datacatalogconnection.json`
2. Implement your resource handlers in `tf_oci_datacatalogconnection/handlers.py`
