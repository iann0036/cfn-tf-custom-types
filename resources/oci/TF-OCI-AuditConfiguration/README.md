...
1. Write the JSON schema describing your resource, `tf-oci-auditconfiguration.json`
2. Implement your resource handlers in `tf_oci_auditconfiguration/handlers.py`
