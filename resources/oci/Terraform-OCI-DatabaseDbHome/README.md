...
1. Write the JSON schema describing your resource, `terraform-oci-databasedbhome.json`
2. Implement your resource handlers in `terraform_oci_databasedbhome/handlers.py`
