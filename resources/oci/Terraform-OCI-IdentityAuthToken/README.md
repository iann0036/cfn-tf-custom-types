...
1. Write the JSON schema describing your resource, `terraform-oci-identityauthtoken.json`
2. Implement your resource handlers in `terraform_oci_identityauthtoken/handlers.py`
