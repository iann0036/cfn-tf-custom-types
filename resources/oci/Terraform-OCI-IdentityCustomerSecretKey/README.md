...
1. Write the JSON schema describing your resource, `terraform-oci-identitycustomersecretkey.json`
2. Implement your resource handlers in `terraform_oci_identitycustomersecretkey/handlers.py`
