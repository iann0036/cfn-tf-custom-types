...
1. Write the JSON schema describing your resource, `tf-oci-dnsresolverendpoint.json`
2. Implement your resource handlers in `tf_oci_dnsresolverendpoint/handlers.py`
