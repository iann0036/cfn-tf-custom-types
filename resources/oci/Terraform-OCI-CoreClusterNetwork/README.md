...
1. Write the JSON schema describing your resource, `terraform-oci-coreclusternetwork.json`
2. Implement your resource handlers in `terraform_oci_coreclusternetwork/handlers.py`
