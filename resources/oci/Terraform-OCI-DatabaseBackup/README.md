...
1. Write the JSON schema describing your resource, `terraform-oci-databasebackup.json`
2. Implement your resource handlers in `terraform_oci_databasebackup/handlers.py`
