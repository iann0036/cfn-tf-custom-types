...
1. Write the JSON schema describing your resource, `tf-oci-healthcheckshttpprobe.json`
2. Implement your resource handlers in `tf_oci_healthcheckshttpprobe/handlers.py`
