# TF::OCI::CoreDrgRouteTable

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-coredrgroutetable.json`
2. Implement your resource handlers in `tf_oci_coredrgroutetable/handlers.py`
