# Terraform::OCI::FunctionsFunction

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-oci-functionsfunction.json`
2. Implement your resource handlers in `terraform_oci_functionsfunction/handlers.py`
