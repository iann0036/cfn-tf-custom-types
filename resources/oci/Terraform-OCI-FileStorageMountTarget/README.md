...
1. Write the JSON schema describing your resource, `terraform-oci-filestoragemounttarget.json`
2. Implement your resource handlers in `terraform_oci_filestoragemounttarget/handlers.py`
