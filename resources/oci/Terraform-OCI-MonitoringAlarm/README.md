...
1. Write the JSON schema describing your resource, `terraform-oci-monitoringalarm.json`
2. Implement your resource handlers in `terraform_oci_monitoringalarm/handlers.py`
