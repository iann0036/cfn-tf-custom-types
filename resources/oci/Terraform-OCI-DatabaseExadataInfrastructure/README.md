...
1. Write the JSON schema describing your resource, `terraform-oci-databaseexadatainfrastructure.json`
2. Implement your resource handlers in `terraform_oci_databaseexadatainfrastructure/handlers.py`
