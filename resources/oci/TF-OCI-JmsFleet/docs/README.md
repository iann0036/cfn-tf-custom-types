...
Returns the <code>ApproximateApplicationCount</code> value.

#### ApproximateInstallationCount

Returns the <code>ApproximateInstallationCount</code> value.

#### ApproximateJreCount

Returns the <code>ApproximateJreCount</code> value.

#### ApproximateManagedInstanceCount

Returns the <code>ApproximateManagedInstanceCount</code> value.
