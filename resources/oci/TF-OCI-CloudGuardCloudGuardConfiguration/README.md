...
1. Write the JSON schema describing your resource, `tf-oci-cloudguardcloudguardconfiguration.json`
2. Implement your resource handlers in `tf_oci_cloudguardcloudguardconfiguration/handlers.py`
