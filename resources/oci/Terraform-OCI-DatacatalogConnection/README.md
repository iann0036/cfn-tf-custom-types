...
1. Write the JSON schema describing your resource, `terraform-oci-datacatalogconnection.json`
2. Implement your resource handlers in `terraform_oci_datacatalogconnection/handlers.py`
