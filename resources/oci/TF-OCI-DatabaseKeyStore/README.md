...
1. Write the JSON schema describing your resource, `tf-oci-databasekeystore.json`
2. Implement your resource handlers in `tf_oci_databasekeystore/handlers.py`
