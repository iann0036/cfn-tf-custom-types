...
1. Write the JSON schema describing your resource, `tf-oci-bdsautoscalingconfiguration.json`
2. Implement your resource handlers in `tf_oci_bdsautoscalingconfiguration/handlers.py`
