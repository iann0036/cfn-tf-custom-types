...
1. Write the JSON schema describing your resource, `terraform-oci-osmanagementmanagedinstancegroup.json`
2. Implement your resource handlers in `terraform_oci_osmanagementmanagedinstancegroup/handlers.py`
