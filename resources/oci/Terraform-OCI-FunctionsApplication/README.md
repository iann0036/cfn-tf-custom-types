...
1. Write the JSON schema describing your resource, `terraform-oci-functionsapplication.json`
2. Implement your resource handlers in `terraform_oci_functionsapplication/handlers.py`
