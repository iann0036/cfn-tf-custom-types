...
1. Write the JSON schema describing your resource, `terraform-oci-objectstorageobject.json`
2. Implement your resource handlers in `terraform_oci_objectstorageobject/handlers.py`
