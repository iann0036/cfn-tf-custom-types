# TF::OCI::HealthChecksPingProbe

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-healthcheckspingprobe.json`
2. Implement your resource handlers in `tf_oci_healthcheckspingprobe/handlers.py`
