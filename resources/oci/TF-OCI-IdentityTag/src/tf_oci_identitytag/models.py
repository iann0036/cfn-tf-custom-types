...
class ResourceModel(BaseModel):
    ...
    Validator: Optional[Sequence["_ValidatorDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Validator=deserialize_list(json_data.get("Validator"), ValidatorDefinition),
        )
...
class ValidatorDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ValidatorDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ValidatorDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ValidatorDefinition = ValidatorDefinition
