...
1. Write the JSON schema describing your resource, `tf-oci-apigatewaygateway.json`
2. Implement your resource handlers in `tf_oci_apigatewaygateway/handlers.py`
