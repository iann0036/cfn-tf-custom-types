...
1. Write the JSON schema describing your resource, `terraform-oci-coreinstancepool.json`
2. Implement your resource handlers in `terraform_oci_coreinstancepool/handlers.py`
