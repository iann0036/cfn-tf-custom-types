...
1. Write the JSON schema describing your resource, `terraform-oci-databasedbsystem.json`
2. Implement your resource handlers in `terraform_oci_databasedbsystem/handlers.py`
