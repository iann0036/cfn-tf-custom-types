...
1. Write the JSON schema describing your resource, `tf-oci-databasedatabaseupgrade.json`
2. Implement your resource handlers in `tf_oci_databasedatabaseupgrade/handlers.py`
