...
1. Write the JSON schema describing your resource, `terraform-oci-objectstoragebucket.json`
2. Implement your resource handlers in `terraform_oci_objectstoragebucket/handlers.py`
