...
1. Write the JSON schema describing your resource, `tf-oci-managementagentmanagementagent.json`
2. Implement your resource handlers in `tf_oci_managementagentmanagementagent/handlers.py`
