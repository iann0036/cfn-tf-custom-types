...
1. Write the JSON schema describing your resource, `tf-oci-networkloadbalancerlistener.json`
2. Implement your resource handlers in `tf_oci_networkloadbalancerlistener/handlers.py`
