...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousdatabaseinstancewalletmanagement.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousdatabaseinstancewalletmanagement/handlers.py`
