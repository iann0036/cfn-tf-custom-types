...
1. Write the JSON schema describing your resource, `terraform-oci-coreshapemanagement.json`
2. Implement your resource handlers in `terraform_oci_coreshapemanagement/handlers.py`
