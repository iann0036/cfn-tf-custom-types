...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancercertificate.json`
2. Implement your resource handlers in `terraform_oci_loadbalancercertificate/handlers.py`
