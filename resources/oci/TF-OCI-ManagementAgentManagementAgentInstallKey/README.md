...
1. Write the JSON schema describing your resource, `tf-oci-managementagentmanagementagentinstallkey.json`
2. Implement your resource handlers in `tf_oci_managementagentmanagementagentinstallkey/handlers.py`
