...
1. Write the JSON schema describing your resource, `tf-oci-identityauthtoken.json`
2. Implement your resource handlers in `tf_oci_identityauthtoken/handlers.py`
