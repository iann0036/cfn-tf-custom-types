...
1. Write the JSON schema describing your resource, `terraform-oci-coreappcatalogsubscription.json`
2. Implement your resource handlers in `terraform_oci_coreappcatalogsubscription/handlers.py`
