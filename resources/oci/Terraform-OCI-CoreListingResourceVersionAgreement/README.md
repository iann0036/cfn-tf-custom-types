...
1. Write the JSON schema describing your resource, `terraform-oci-corelistingresourceversionagreement.json`
2. Implement your resource handlers in `terraform_oci_corelistingresourceversionagreement/handlers.py`
