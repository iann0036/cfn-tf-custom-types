...
1. Write the JSON schema describing your resource, `terraform-oci-coresecuritylist.json`
2. Implement your resource handlers in `terraform_oci_coresecuritylist/handlers.py`
