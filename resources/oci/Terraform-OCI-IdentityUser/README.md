...
1. Write the JSON schema describing your resource, `terraform-oci-identityuser.json`
2. Implement your resource handlers in `terraform_oci_identityuser/handlers.py`
