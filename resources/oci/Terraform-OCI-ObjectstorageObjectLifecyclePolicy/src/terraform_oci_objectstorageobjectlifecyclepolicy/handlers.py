...
def create_handler(
    ...
    try:
        ...
        tf['resource']['oci_objectstorage_object_lifecycle_policy'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['oci_objectstorage_object_lifecycle_policy'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
