...
1. Write the JSON schema describing your resource, `terraform-oci-objectstorageobjectlifecyclepolicy.json`
2. Implement your resource handlers in `terraform_oci_objectstorageobjectlifecyclepolicy/handlers.py`
