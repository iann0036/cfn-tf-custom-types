...
TYPE_NAME = "TF::OCI::DatabaseDbSystem"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/oci_database_db_system/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Id", "IormConfigCache", "LastMaintenanceRunId", "LastPatchHistoryEntryId", "LifecycleDetails", "ListenerPort", "MaintenanceWindow", "NextMaintenanceRunId", "PointInTimeDataDiskCloneTimestamp", "RecoStorageSizeInGb", "ScanDnsName", "ScanDnsRecordId", "ScanIpIds", "State", "TimeCreated", "Version", "VipIds", "ZoneId"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/oci_database_db_system/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/oci_database_db_system/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AvailabilityDomain=None, BackupNetworkNsgIds=None, BackupSubnetId=None, ClusterName=None, CompartmentId=None, CpuCoreCount=None, DataStoragePercentage=None, DataStorageSizeInGb=None, DatabaseEdition=None, DefinedTags=None, DiskRedundancy=None, DisplayName=None, Domain=None, FaultDomains=None, FreeformTags=None, Hostname=None, Id=None, IormConfigCache=None, KmsKeyId=None, KmsKeyVersionId=None, LastMaintenanceRunId=None, LastPatchHistoryEntryId=None, LicenseModel=None, LifecycleDetails=None, ListenerPort=None, MaintenanceWindow=None, NextMaintenanceRunId=None, NodeCount=None, NsgIds=None, PointInTimeDataDiskCloneTimestamp=None, PrivateIp=None, RecoStorageSizeInGb=None, ScanDnsName=None, ScanDnsRecordId=None, ScanIpIds=None, Shape=None, Source=None, SourceDbSystemId=None, SparseDiskgroup=None, SshPublicKeys=None, State=None, SubnetId=None, TimeCreated=None, TimeZone=None, Version=None, VipIds=None, ZoneId=None, DbHome=None, DbSystemOptions=None, MaintenanceWindowDetails=None, Timeouts=None)
