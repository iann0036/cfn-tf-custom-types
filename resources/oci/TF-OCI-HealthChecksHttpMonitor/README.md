# TF::OCI::HealthChecksHttpMonitor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-healthcheckshttpmonitor.json`
2. Implement your resource handlers in `tf_oci_healthcheckshttpmonitor/handlers.py`
