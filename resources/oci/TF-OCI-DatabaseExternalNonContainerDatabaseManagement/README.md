...
1. Write the JSON schema describing your resource, `tf-oci-databaseexternalnoncontainerdatabasemanagement.json`
2. Implement your resource handlers in `tf_oci_databaseexternalnoncontainerdatabasemanagement/handlers.py`
