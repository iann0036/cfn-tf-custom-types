# TF::OCI::ServiceCatalogPrivateApplication

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-servicecatalogprivateapplication.json`
2. Implement your resource handlers in `tf_oci_servicecatalogprivateapplication/handlers.py`
