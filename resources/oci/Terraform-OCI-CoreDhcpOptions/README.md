...
1. Write the JSON schema describing your resource, `terraform-oci-coredhcpoptions.json`
2. Implement your resource handlers in `terraform_oci_coredhcpoptions/handlers.py`
