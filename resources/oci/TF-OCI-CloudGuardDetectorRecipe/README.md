...
1. Write the JSON schema describing your resource, `tf-oci-cloudguarddetectorrecipe.json`
2. Implement your resource handlers in `tf_oci_cloudguarddetectorrecipe/handlers.py`
