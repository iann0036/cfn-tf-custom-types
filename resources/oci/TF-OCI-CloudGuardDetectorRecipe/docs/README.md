# TF::OCI::CloudGuardDetectorRecipe
...
<pre>
{
    "Type" : "TF::OCI::CloudGuardDetectorRecipe",
    "Properties" : {
        ...
        "<a href="#sourcedetectorrecipeid" title="SourceDetectorRecipeId">SourceDetectorRecipeId</a>" : <i>String</i>,
...
Returns the <code>Detector</code> value.

#### EffectiveDetectorRules

Returns the <code>EffectiveDetectorRules</code> value.
