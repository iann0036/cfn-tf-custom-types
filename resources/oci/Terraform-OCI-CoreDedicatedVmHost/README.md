...
1. Write the JSON schema describing your resource, `terraform-oci-corededicatedvmhost.json`
2. Implement your resource handlers in `terraform_oci_corededicatedvmhost/handlers.py`
