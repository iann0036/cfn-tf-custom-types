...
1. Write the JSON schema describing your resource, `terraform-oci-corevnicattachment.json`
2. Implement your resource handlers in `terraform_oci_corevnicattachment/handlers.py`
