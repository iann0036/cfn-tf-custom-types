...
1. Write the JSON schema describing your resource, `terraform-oci-streamingstreamarchiver.json`
2. Implement your resource handlers in `terraform_oci_streamingstreamarchiver/handlers.py`
