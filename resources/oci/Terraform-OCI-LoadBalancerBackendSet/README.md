...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerbackendset.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerbackendset/handlers.py`
