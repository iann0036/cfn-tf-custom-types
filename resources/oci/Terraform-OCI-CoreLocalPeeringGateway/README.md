...
1. Write the JSON schema describing your resource, `terraform-oci-corelocalpeeringgateway.json`
2. Implement your resource handlers in `terraform_oci_corelocalpeeringgateway/handlers.py`
