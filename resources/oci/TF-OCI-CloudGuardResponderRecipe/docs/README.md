...
<pre>
{
    "Type" : "TF::OCI::CloudGuardResponderRecipe",
    "Properties" : {
        ...
        "<a href="#sourceresponderrecipeid" title="SourceResponderRecipeId">SourceResponderRecipeId</a>" : <i>String</i>,
...
Returns the <code>EffectiveResponderRules</code> value.
