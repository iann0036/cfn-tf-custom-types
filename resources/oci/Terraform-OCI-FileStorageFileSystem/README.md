...
1. Write the JSON schema describing your resource, `terraform-oci-filestoragefilesystem.json`
2. Implement your resource handlers in `terraform_oci_filestoragefilesystem/handlers.py`
