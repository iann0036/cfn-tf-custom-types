...
1. Write the JSON schema describing your resource, `terraform-oci-emailsuppression.json`
2. Implement your resource handlers in `terraform_oci_emailsuppression/handlers.py`
