...
1. Write the JSON schema describing your resource, `tf-oci-databasebackupdestination.json`
2. Implement your resource handlers in `tf_oci_databasebackupdestination/handlers.py`
