...
1. Write the JSON schema describing your resource, `tf-oci-databasemanagementmanageddatabasesresetdatabaseparameter.json`
2. Implement your resource handlers in `tf_oci_databasemanagementmanageddatabasesresetdatabaseparameter/handlers.py`
