...
1. Write the JSON schema describing your resource, `terraform-oci-identitypolicy.json`
2. Implement your resource handlers in `terraform_oci_identitypolicy/handlers.py`
