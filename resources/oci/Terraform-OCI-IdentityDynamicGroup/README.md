...
1. Write the JSON schema describing your resource, `terraform-oci-identitydynamicgroup.json`
2. Implement your resource handlers in `terraform_oci_identitydynamicgroup/handlers.py`
