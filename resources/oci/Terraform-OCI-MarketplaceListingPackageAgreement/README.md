...
1. Write the JSON schema describing your resource, `terraform-oci-marketplacelistingpackageagreement.json`
2. Implement your resource handlers in `terraform_oci_marketplacelistingpackageagreement/handlers.py`
