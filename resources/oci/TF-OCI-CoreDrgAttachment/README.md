...
1. Write the JSON schema describing your resource, `tf-oci-coredrgattachment.json`
2. Implement your resource handlers in `tf_oci_coredrgattachment/handlers.py`
