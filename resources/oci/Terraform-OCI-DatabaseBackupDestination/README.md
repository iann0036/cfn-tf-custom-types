...
1. Write the JSON schema describing your resource, `terraform-oci-databasebackupdestination.json`
2. Implement your resource handlers in `terraform_oci_databasebackupdestination/handlers.py`
