...
1. Write the JSON schema describing your resource, `tf-oci-databaseautonomousdatabase.json`
2. Implement your resource handlers in `tf_oci_databaseautonomousdatabase/handlers.py`
