...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousdatawarehouse.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousdatawarehouse/handlers.py`
