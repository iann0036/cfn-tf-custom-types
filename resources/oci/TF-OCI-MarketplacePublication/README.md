...
1. Write the JSON schema describing your resource, `tf-oci-marketplacepublication.json`
2. Implement your resource handlers in `tf_oci_marketplacepublication/handlers.py`
