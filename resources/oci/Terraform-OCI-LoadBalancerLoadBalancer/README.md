...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerloadbalancer.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerloadbalancer/handlers.py`
