...
1. Write the JSON schema describing your resource, `terraform-oci-healthcheckshttpprobe.json`
2. Implement your resource handlers in `terraform_oci_healthcheckshttpprobe/handlers.py`
