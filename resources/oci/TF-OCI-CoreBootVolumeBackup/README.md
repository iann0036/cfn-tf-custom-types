...
1. Write the JSON schema describing your resource, `tf-oci-corebootvolumebackup.json`
2. Implement your resource handlers in `tf_oci_corebootvolumebackup/handlers.py`
