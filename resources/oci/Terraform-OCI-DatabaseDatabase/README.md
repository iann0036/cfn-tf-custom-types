...
1. Write the JSON schema describing your resource, `terraform-oci-databasedatabase.json`
2. Implement your resource handlers in `terraform_oci_databasedatabase/handlers.py`
