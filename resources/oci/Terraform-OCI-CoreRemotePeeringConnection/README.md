...
1. Write the JSON schema describing your resource, `terraform-oci-coreremotepeeringconnection.json`
2. Implement your resource handlers in `terraform_oci_coreremotepeeringconnection/handlers.py`
