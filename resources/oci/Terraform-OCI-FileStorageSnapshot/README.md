...
1. Write the JSON schema describing your resource, `terraform-oci-filestoragesnapshot.json`
2. Implement your resource handlers in `terraform_oci_filestoragesnapshot/handlers.py`
