...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerruleset.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerruleset/handlers.py`
