...
1. Write the JSON schema describing your resource, `terraform-oci-kmsencrypteddata.json`
2. Implement your resource handlers in `terraform_oci_kmsencrypteddata/handlers.py`
