...
class ResourceModel(BaseModel):
    ...
    AvailableCpus: Optional[float]
    AvailableDataStorageSizeInTbs: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AvailableCpus=json_data.get("AvailableCpus"),
            AvailableDataStorageSizeInTbs=json_data.get("AvailableDataStorageSizeInTbs"),
