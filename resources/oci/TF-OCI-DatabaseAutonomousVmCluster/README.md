...
1. Write the JSON schema describing your resource, `tf-oci-databaseautonomousvmcluster.json`
2. Implement your resource handlers in `tf_oci_databaseautonomousvmcluster/handlers.py`
