# TF::OCI::WaasAddressList

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-waasaddresslist.json`
2. Implement your resource handlers in `tf_oci_waasaddresslist/handlers.py`
