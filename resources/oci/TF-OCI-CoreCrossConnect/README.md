...
1. Write the JSON schema describing your resource, `tf-oci-corecrossconnect.json`
2. Implement your resource handlers in `tf_oci_corecrossconnect/handlers.py`
