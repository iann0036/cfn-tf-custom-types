# TF::OCI::CoreInstanceConsoleConnection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-coreinstanceconsoleconnection.json`
2. Implement your resource handlers in `tf_oci_coreinstanceconsoleconnection/handlers.py`
