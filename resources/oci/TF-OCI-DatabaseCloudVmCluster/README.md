...
1. Write the JSON schema describing your resource, `tf-oci-databasecloudvmcluster.json`
2. Implement your resource handlers in `tf_oci_databasecloudvmcluster/handlers.py`
