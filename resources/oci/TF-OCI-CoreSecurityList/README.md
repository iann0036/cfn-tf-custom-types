...
1. Write the JSON schema describing your resource, `tf-oci-coresecuritylist.json`
2. Implement your resource handlers in `tf_oci_coresecuritylist/handlers.py`
