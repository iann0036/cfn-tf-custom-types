...
1. Write the JSON schema describing your resource, `tf-oci-databasedatabase.json`
2. Implement your resource handlers in `tf_oci_databasedatabase/handlers.py`
