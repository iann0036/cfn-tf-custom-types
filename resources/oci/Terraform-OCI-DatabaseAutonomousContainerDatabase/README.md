...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomouscontainerdatabase.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomouscontainerdatabase/handlers.py`
