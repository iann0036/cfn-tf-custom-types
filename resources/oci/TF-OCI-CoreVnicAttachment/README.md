...
1. Write the JSON schema describing your resource, `tf-oci-corevnicattachment.json`
2. Implement your resource handlers in `tf_oci_corevnicattachment/handlers.py`
