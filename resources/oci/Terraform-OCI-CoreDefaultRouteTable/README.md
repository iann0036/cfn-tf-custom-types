# Terraform::OCI::CoreDefaultRouteTable

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-oci-coredefaultroutetable.json`
2. Implement your resource handlers in `terraform_oci_coredefaultroutetable/handlers.py`
