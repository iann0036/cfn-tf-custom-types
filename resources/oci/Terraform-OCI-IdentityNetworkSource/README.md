...
1. Write the JSON schema describing your resource, `terraform-oci-identitynetworksource.json`
2. Implement your resource handlers in `terraform_oci_identitynetworksource/handlers.py`
