...
1. Write the JSON schema describing your resource, `tf-oci-dnssteeringpolicy.json`
2. Implement your resource handlers in `tf_oci_dnssteeringpolicy/handlers.py`
