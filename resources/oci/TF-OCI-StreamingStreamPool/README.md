...
1. Write the JSON schema describing your resource, `tf-oci-streamingstreampool.json`
2. Implement your resource handlers in `tf_oci_streamingstreampool/handlers.py`
