...
1. Write the JSON schema describing your resource, `tf-oci-databaseexadatainfrastructure.json`
2. Implement your resource handlers in `tf_oci_databaseexadatainfrastructure/handlers.py`
