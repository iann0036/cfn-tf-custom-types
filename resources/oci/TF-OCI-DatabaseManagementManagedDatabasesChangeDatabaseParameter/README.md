...
1. Write the JSON schema describing your resource, `tf-oci-databasemanagementmanageddatabaseschangedatabaseparameter.json`
2. Implement your resource handlers in `tf_oci_databasemanagementmanageddatabaseschangedatabaseparameter/handlers.py`
