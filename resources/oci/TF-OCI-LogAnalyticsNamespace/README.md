...
1. Write the JSON schema describing your resource, `tf-oci-loganalyticsnamespace.json`
2. Implement your resource handlers in `tf_oci_loganalyticsnamespace/handlers.py`
