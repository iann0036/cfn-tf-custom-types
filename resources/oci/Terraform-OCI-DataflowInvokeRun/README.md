...
1. Write the JSON schema describing your resource, `terraform-oci-dataflowinvokerun.json`
2. Implement your resource handlers in `terraform_oci_dataflowinvokerun/handlers.py`
