...
1. Write the JSON schema describing your resource, `terraform-oci-limitsquota.json`
2. Implement your resource handlers in `terraform_oci_limitsquota/handlers.py`
