...
1. Write the JSON schema describing your resource, `terraform-oci-identitycompartment.json`
2. Implement your resource handlers in `terraform_oci_identitycompartment/handlers.py`
