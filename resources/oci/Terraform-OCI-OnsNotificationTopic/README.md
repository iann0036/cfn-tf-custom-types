...
1. Write the JSON schema describing your resource, `terraform-oci-onsnotificationtopic.json`
2. Implement your resource handlers in `terraform_oci_onsnotificationtopic/handlers.py`
