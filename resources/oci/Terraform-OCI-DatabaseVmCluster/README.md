...
1. Write the JSON schema describing your resource, `terraform-oci-databasevmcluster.json`
2. Implement your resource handlers in `terraform_oci_databasevmcluster/handlers.py`
