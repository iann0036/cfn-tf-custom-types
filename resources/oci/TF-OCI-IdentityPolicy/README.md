# TF::OCI::IdentityPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-identitypolicy.json`
2. Implement your resource handlers in `tf_oci_identitypolicy/handlers.py`
