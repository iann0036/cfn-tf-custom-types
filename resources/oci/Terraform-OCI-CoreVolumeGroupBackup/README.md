...
1. Write the JSON schema describing your resource, `terraform-oci-corevolumegroupbackup.json`
2. Implement your resource handlers in `terraform_oci_corevolumegroupbackup/handlers.py`
