...
1. Write the JSON schema describing your resource, `tf-oci-containerenginecluster.json`
2. Implement your resource handlers in `tf_oci_containerenginecluster/handlers.py`
