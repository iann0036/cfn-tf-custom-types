...
1. Write the JSON schema describing your resource, `tf-oci-autoscalingautoscalingconfiguration.json`
2. Implement your resource handlers in `tf_oci_autoscalingautoscalingconfiguration/handlers.py`
