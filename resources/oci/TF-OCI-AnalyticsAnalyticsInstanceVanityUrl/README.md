...
1. Write the JSON schema describing your resource, `tf-oci-analyticsanalyticsinstancevanityurl.json`
2. Implement your resource handlers in `tf_oci_analyticsanalyticsinstancevanityurl/handlers.py`
