...
1. Write the JSON schema describing your resource, `terraform-oci-nosqltable.json`
2. Implement your resource handlers in `terraform_oci_nosqltable/handlers.py`
