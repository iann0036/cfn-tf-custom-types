...
1. Write the JSON schema describing your resource, `terraform-oci-budgetalertrule.json`
2. Implement your resource handlers in `terraform_oci_budgetalertrule/handlers.py`
