...
1. Write the JSON schema describing your resource, `tf-oci-functionsapplication.json`
2. Implement your resource handlers in `tf_oci_functionsapplication/handlers.py`
