# TF::OCI::CoreClusterNetwork

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-coreclusternetwork.json`
2. Implement your resource handlers in `tf_oci_coreclusternetwork/handlers.py`
