...
class ResourceModel(BaseModel):
    ...
    InstancePools: Optional[Sequence["_InstancePoolsDefinition"]]
    PlacementConfiguration: Optional[Sequence["_PlacementConfigurationDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            InstancePools=deserialize_list(json_data.get("InstancePools"), InstancePoolsDefinition),
            PlacementConfiguration=deserialize_list(json_data.get("PlacementConfiguration"), PlacementConfigurationDefinition),
...
@dataclass
class InstancePoolsDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_InstancePoolsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InstancePoolsDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_InstancePoolsDefinition = InstancePoolsDefinition
...
@dataclass
class PlacementConfigurationDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_PlacementConfigurationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PlacementConfigurationDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_PlacementConfigurationDefinition = PlacementConfigurationDefinition
