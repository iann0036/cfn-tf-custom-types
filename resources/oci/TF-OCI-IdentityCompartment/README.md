...
1. Write the JSON schema describing your resource, `tf-oci-identitycompartment.json`
2. Implement your resource handlers in `tf_oci_identitycompartment/handlers.py`
