...
1. Write the JSON schema describing your resource, `terraform-oci-coreimage.json`
2. Implement your resource handlers in `terraform_oci_coreimage/handlers.py`
