...
1. Write the JSON schema describing your resource, `terraform-oci-nosqlindex.json`
2. Implement your resource handlers in `terraform_oci_nosqlindex/handlers.py`
