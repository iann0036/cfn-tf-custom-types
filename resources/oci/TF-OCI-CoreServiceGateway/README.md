...
1. Write the JSON schema describing your resource, `tf-oci-coreservicegateway.json`
2. Implement your resource handlers in `tf_oci_coreservicegateway/handlers.py`
