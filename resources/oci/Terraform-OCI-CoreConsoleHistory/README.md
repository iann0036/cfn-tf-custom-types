...
1. Write the JSON schema describing your resource, `terraform-oci-coreconsolehistory.json`
2. Implement your resource handlers in `terraform_oci_coreconsolehistory/handlers.py`
