...
1. Write the JSON schema describing your resource, `terraform-oci-oceoceinstance.json`
2. Implement your resource handlers in `terraform_oci_oceoceinstance/handlers.py`
