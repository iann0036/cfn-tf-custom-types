...
1. Write the JSON schema describing your resource, `terraform-oci-kmskeyversion.json`
2. Implement your resource handlers in `terraform_oci_kmskeyversion/handlers.py`
