...
1. Write the JSON schema describing your resource, `terraform-oci-corevolumebackuppolicyassignment.json`
2. Implement your resource handlers in `terraform_oci_corevolumebackuppolicyassignment/handlers.py`
