...
1. Write the JSON schema describing your resource, `terraform-oci-filestorageexportset.json`
2. Implement your resource handlers in `terraform_oci_filestorageexportset/handlers.py`
