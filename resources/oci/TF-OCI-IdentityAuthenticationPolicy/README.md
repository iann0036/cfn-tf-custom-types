...
1. Write the JSON schema describing your resource, `tf-oci-identityauthenticationpolicy.json`
2. Implement your resource handlers in `tf_oci_identityauthenticationpolicy/handlers.py`
