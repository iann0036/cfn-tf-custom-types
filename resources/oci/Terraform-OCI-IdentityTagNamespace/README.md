...
1. Write the JSON schema describing your resource, `terraform-oci-identitytagnamespace.json`
2. Implement your resource handlers in `terraform_oci_identitytagnamespace/handlers.py`
