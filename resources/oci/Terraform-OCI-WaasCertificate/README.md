...
1. Write the JSON schema describing your resource, `terraform-oci-waascertificate.json`
2. Implement your resource handlers in `terraform_oci_waascertificate/handlers.py`
