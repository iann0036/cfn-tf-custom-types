...
1. Write the JSON schema describing your resource, `terraform-oci-marketplaceacceptedagreement.json`
2. Implement your resource handlers in `terraform_oci_marketplaceacceptedagreement/handlers.py`
