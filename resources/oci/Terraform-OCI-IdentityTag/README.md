...
1. Write the JSON schema describing your resource, `terraform-oci-identitytag.json`
2. Implement your resource handlers in `terraform_oci_identitytag/handlers.py`
