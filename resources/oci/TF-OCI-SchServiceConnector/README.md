...
1. Write the JSON schema describing your resource, `tf-oci-schserviceconnector.json`
2. Implement your resource handlers in `tf_oci_schserviceconnector/handlers.py`
