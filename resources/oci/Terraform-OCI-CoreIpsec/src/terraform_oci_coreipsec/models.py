...
class ResourceModel(BaseResourceModel):
    ...
    CpeId: Optional[str]
    CpeLocalIdentifier: Optional[str]
    CpeLocalIdentifierType: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CpeId=json_data.get("CpeId"),
            CpeLocalIdentifier=json_data.get("CpeLocalIdentifier"),
            CpeLocalIdentifierType=json_data.get("CpeLocalIdentifierType"),
