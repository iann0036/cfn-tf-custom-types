...
1. Write the JSON schema describing your resource, `terraform-oci-coreipsec.json`
2. Implement your resource handlers in `terraform_oci_coreipsec/handlers.py`
