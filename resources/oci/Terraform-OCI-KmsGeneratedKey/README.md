...
1. Write the JSON schema describing your resource, `terraform-oci-kmsgeneratedkey.json`
2. Implement your resource handlers in `terraform_oci_kmsgeneratedkey/handlers.py`
