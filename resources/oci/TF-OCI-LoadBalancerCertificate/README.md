...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancercertificate.json`
2. Implement your resource handlers in `tf_oci_loadbalancercertificate/handlers.py`
