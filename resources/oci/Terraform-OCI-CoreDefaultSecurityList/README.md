...
1. Write the JSON schema describing your resource, `terraform-oci-coredefaultsecuritylist.json`
2. Implement your resource handlers in `terraform_oci_coredefaultsecuritylist/handlers.py`
