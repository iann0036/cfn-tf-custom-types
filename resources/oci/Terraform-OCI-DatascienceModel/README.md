...
1. Write the JSON schema describing your resource, `terraform-oci-datasciencemodel.json`
2. Implement your resource handlers in `terraform_oci_datasciencemodel/handlers.py`
