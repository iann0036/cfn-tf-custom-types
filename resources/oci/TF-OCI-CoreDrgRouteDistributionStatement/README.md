...
1. Write the JSON schema describing your resource, `tf-oci-coredrgroutedistributionstatement.json`
2. Implement your resource handlers in `tf_oci_coredrgroutedistributionstatement/handlers.py`
