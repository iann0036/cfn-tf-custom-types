...
1. Write the JSON schema describing your resource, `tf-oci-artifactscontainerrepository.json`
2. Implement your resource handlers in `tf_oci_artifactscontainerrepository/handlers.py`
