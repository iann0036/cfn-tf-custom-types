...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousexadatainfrastructure.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousexadatainfrastructure/handlers.py`
