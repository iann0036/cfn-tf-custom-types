...
1. Write the JSON schema describing your resource, `tf-oci-identitycustomersecretkey.json`
2. Implement your resource handlers in `tf_oci_identitycustomersecretkey/handlers.py`
