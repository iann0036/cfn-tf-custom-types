# TF::OCI::LoggingLogSavedSearch

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-logginglogsavedsearch.json`
2. Implement your resource handlers in `tf_oci_logginglogsavedsearch/handlers.py`
