...
1. Write the JSON schema describing your resource, `terraform-oci-filestorageexport.json`
2. Implement your resource handlers in `terraform_oci_filestorageexport/handlers.py`
