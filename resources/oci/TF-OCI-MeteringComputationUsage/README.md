...
1. Write the JSON schema describing your resource, `tf-oci-meteringcomputationusage.json`
2. Implement your resource handlers in `tf_oci_meteringcomputationusage/handlers.py`
