...
1. Write the JSON schema describing your resource, `tf-oci-databaseautonomouscontainerdatabase.json`
2. Implement your resource handlers in `tf_oci_databaseautonomouscontainerdatabase/handlers.py`
