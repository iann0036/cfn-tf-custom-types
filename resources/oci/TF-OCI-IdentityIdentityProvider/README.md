...
1. Write the JSON schema describing your resource, `tf-oci-identityidentityprovider.json`
2. Implement your resource handlers in `tf_oci_identityidentityprovider/handlers.py`
