...
1. Write the JSON schema describing your resource, `tf-oci-opsienterprisemanagerbridge.json`
2. Implement your resource handlers in `tf_oci_opsienterprisemanagerbridge/handlers.py`
