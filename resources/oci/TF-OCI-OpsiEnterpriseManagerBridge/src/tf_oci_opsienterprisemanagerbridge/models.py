...
class ResourceModel(BaseModel):
    ...
    ObjectStorageBucketName: Optional[str]
    ObjectStorageNamespaceName: Optional[str]
    State: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ObjectStorageBucketName=json_data.get("ObjectStorageBucketName"),
            ObjectStorageNamespaceName=json_data.get("ObjectStorageNamespaceName"),
