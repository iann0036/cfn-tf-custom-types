# TF::OCI::OpsiEnterpriseManagerBridge
...
<pre>
{
    "Type" : "TF::OCI::OpsiEnterpriseManagerBridge",
    "Properties" : {
        ...
        "<a href="#objectstoragebucketname" title="ObjectStorageBucketName">ObjectStorageBucketName</a>" : <i>String</i>,
...
Returns the <code>ObjectStorageNamespaceName</code> value.
