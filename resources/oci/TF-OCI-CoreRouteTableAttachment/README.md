...
1. Write the JSON schema describing your resource, `tf-oci-coreroutetableattachment.json`
2. Implement your resource handlers in `tf_oci_coreroutetableattachment/handlers.py`
