...
1. Write the JSON schema describing your resource, `terraform-oci-corepublicip.json`
2. Implement your resource handlers in `terraform_oci_corepublicip/handlers.py`
