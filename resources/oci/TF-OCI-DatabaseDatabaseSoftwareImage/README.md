...
1. Write the JSON schema describing your resource, `tf-oci-databasedatabasesoftwareimage.json`
2. Implement your resource handlers in `tf_oci_databasedatabasesoftwareimage/handlers.py`
