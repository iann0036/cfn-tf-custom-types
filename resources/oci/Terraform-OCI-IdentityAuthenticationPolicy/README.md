...
1. Write the JSON schema describing your resource, `terraform-oci-identityauthenticationpolicy.json`
2. Implement your resource handlers in `terraform_oci_identityauthenticationpolicy/handlers.py`
