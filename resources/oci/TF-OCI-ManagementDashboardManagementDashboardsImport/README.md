...
1. Write the JSON schema describing your resource, `tf-oci-managementdashboardmanagementdashboardsimport.json`
2. Implement your resource handlers in `tf_oci_managementdashboardmanagementdashboardsimport/handlers.py`
