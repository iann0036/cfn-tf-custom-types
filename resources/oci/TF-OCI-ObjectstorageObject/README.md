...
1. Write the JSON schema describing your resource, `tf-oci-objectstorageobject.json`
2. Implement your resource handlers in `tf_oci_objectstorageobject/handlers.py`
