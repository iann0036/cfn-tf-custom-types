# TF::OCI::StreamingStream

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-streamingstream.json`
2. Implement your resource handlers in `tf_oci_streamingstream/handlers.py`
