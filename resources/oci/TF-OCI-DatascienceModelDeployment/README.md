...
1. Write the JSON schema describing your resource, `tf-oci-datasciencemodeldeployment.json`
2. Implement your resource handlers in `tf_oci_datasciencemodeldeployment/handlers.py`
