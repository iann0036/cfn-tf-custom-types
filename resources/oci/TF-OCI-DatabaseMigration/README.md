...
1. Write the JSON schema describing your resource, `tf-oci-databasemigration.json`
2. Implement your resource handlers in `tf_oci_databasemigration/handlers.py`
