...
1. Write the JSON schema describing your resource, `terraform-oci-identityswiftpassword.json`
2. Implement your resource handlers in `terraform_oci_identityswiftpassword/handlers.py`
