...
1. Write the JSON schema describing your resource, `terraform-oci-objectstoragenamespacemetadata.json`
2. Implement your resource handlers in `terraform_oci_objectstoragenamespacemetadata/handlers.py`
