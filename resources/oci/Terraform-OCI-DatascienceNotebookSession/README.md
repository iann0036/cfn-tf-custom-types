...
1. Write the JSON schema describing your resource, `terraform-oci-datasciencenotebooksession.json`
2. Implement your resource handlers in `terraform_oci_datasciencenotebooksession/handlers.py`
