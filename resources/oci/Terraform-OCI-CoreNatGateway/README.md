...
1. Write the JSON schema describing your resource, `terraform-oci-corenatgateway.json`
2. Implement your resource handlers in `terraform_oci_corenatgateway/handlers.py`
