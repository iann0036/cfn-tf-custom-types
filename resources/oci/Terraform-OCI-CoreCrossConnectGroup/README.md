...
1. Write the JSON schema describing your resource, `terraform-oci-corecrossconnectgroup.json`
2. Implement your resource handlers in `terraform_oci_corecrossconnectgroup/handlers.py`
