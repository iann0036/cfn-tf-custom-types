...
1. Write the JSON schema describing your resource, `tf-oci-coredrgattachmentslist.json`
2. Implement your resource handlers in `tf_oci_coredrgattachmentslist/handlers.py`
