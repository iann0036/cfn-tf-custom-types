...
1. Write the JSON schema describing your resource, `terraform-oci-coreipsecconnectiontunnelmanagement.json`
2. Implement your resource handlers in `terraform_oci_coreipsecconnectiontunnelmanagement/handlers.py`
