...
1. Write the JSON schema describing your resource, `terraform-oci-identityuipassword.json`
2. Implement your resource handlers in `terraform_oci_identityuipassword/handlers.py`
