...
1. Write the JSON schema describing your resource, `tf-oci-filestorageexport.json`
2. Implement your resource handlers in `tf_oci_filestorageexport/handlers.py`
