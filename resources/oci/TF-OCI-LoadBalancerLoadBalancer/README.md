...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerloadbalancer.json`
2. Implement your resource handlers in `tf_oci_loadbalancerloadbalancer/handlers.py`
