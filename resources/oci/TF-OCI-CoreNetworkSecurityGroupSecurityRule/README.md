...
1. Write the JSON schema describing your resource, `tf-oci-corenetworksecuritygroupsecurityrule.json`
2. Implement your resource handlers in `tf_oci_corenetworksecuritygroupsecurityrule/handlers.py`
