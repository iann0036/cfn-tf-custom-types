...
1. Write the JSON schema describing your resource, `terraform-oci-streamingstream.json`
2. Implement your resource handlers in `terraform_oci_streamingstream/handlers.py`
