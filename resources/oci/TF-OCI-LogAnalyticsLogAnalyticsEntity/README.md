...
1. Write the JSON schema describing your resource, `tf-oci-loganalyticsloganalyticsentity.json`
2. Implement your resource handlers in `tf_oci_loganalyticsloganalyticsentity/handlers.py`
