...
1. Write the JSON schema describing your resource, `terraform-oci-coreinstanceconfiguration.json`
2. Implement your resource handlers in `terraform_oci_coreinstanceconfiguration/handlers.py`
