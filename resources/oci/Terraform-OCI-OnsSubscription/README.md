# Terraform::OCI::OnsSubscription

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-oci-onssubscription.json`
2. Implement your resource handlers in `terraform_oci_onssubscription/handlers.py`
