...
1. Write the JSON schema describing your resource, `terraform-oci-coreinternetgateway.json`
2. Implement your resource handlers in `terraform_oci_coreinternetgateway/handlers.py`
