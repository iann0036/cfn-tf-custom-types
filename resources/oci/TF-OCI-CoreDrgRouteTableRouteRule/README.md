...
1. Write the JSON schema describing your resource, `tf-oci-coredrgroutetablerouterule.json`
2. Implement your resource handlers in `tf_oci_coredrgroutetablerouterule/handlers.py`
