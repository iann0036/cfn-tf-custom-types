...
1. Write the JSON schema describing your resource, `terraform-oci-corevolumebackuppolicy.json`
2. Implement your resource handlers in `terraform_oci_corevolumebackuppolicy/handlers.py`
