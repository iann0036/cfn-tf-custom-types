...
<pre>
{
    "Type" : "TF::OCI::DataflowInvokeRun",
    "Properties" : {
        "<a href="#applicationid" title="ApplicationId">ApplicationId</a>" : <i>String</i>,
        "<a href="#archiveuri" title="ArchiveUri">ArchiveUri</a>" : <i>String</i>,
        ...
        "<a href="#execute" title="Execute">Execute</a>" : <i>String</i>,
...
Returns the <code>PrivateEndpointDnsZones</code> value.

#### PrivateEndpointId

Returns the <code>PrivateEndpointId</code> value.

#### PrivateEndpointMaxHostCount

Returns the <code>PrivateEndpointMaxHostCount</code> value.

#### PrivateEndpointNsgIds

Returns the <code>PrivateEndpointNsgIds</code> value.

#### PrivateEndpointSubnetId

Returns the <code>PrivateEndpointSubnetId</code> value.
