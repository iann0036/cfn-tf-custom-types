...
1. Write the JSON schema describing your resource, `tf-oci-dataflowinvokerun.json`
2. Implement your resource handlers in `tf_oci_dataflowinvokerun/handlers.py`
