...
TYPE_NAME = "TF::OCI::DataflowInvokeRun"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/oci_dataflow_invoke_run/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["ClassName", "DataReadInBytes", "DataWrittenInBytes", "FileUri", "Id", "Language", "LifecycleDetails", "OpcRequestId", "OwnerPrincipalId", "OwnerUserName", "PrivateEndpointDnsZones", "PrivateEndpointId", "PrivateEndpointMaxHostCount", "PrivateEndpointNsgIds", "PrivateEndpointSubnetId", "RunDurationInMilliseconds", "State", "TimeCreated", "TimeUpdated", "TotalOcpu"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/oci_dataflow_invoke_run/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/oci_dataflow_invoke_run/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), ApplicationId=None, ArchiveUri=None, Arguments=None, Asynchronous=None, ClassName=None, CompartmentId=None, Configuration=None, DataReadInBytes=None, DataWrittenInBytes=None, DefinedTags=None, DisplayName=None, DriverShape=None, Execute=None, ExecutorShape=None, FileUri=None, FreeformTags=None, Id=None, Language=None, LifecycleDetails=None, LogsBucketUri=None, NumExecutors=None, OpcRequestId=None, OwnerPrincipalId=None, OwnerUserName=None, PrivateEndpointDnsZones=None, PrivateEndpointId=None, PrivateEndpointMaxHostCount=None, PrivateEndpointNsgIds=None, PrivateEndpointSubnetId=None, RunDurationInMilliseconds=None, SparkVersion=None, State=None, TimeCreated=None, TimeUpdated=None, TotalOcpu=None, WarehouseBucketUri=None, Parameters=None, Timeouts=None)
