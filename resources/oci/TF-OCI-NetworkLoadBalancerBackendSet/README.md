...
1. Write the JSON schema describing your resource, `tf-oci-networkloadbalancerbackendset.json`
2. Implement your resource handlers in `tf_oci_networkloadbalancerbackendset/handlers.py`
