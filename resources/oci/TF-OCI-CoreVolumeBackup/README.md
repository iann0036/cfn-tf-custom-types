...
1. Write the JSON schema describing your resource, `tf-oci-corevolumebackup.json`
2. Implement your resource handlers in `tf_oci_corevolumebackup/handlers.py`
