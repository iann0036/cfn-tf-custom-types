...
1. Write the JSON schema describing your resource, `tf-oci-osmanagementmanagedinstancemanagement.json`
2. Implement your resource handlers in `tf_oci_osmanagementmanagedinstancemanagement/handlers.py`
