...
1. Write the JSON schema describing your resource, `tf-oci-mysqlmysqlbackup.json`
2. Implement your resource handlers in `tf_oci_mysqlmysqlbackup/handlers.py`
