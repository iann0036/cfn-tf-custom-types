...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousdatawarehousebackup.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousdatawarehousebackup/handlers.py`
