...
1. Write the JSON schema describing your resource, `terraform-oci-identitytagdefault.json`
2. Implement your resource handlers in `terraform_oci_identitytagdefault/handlers.py`
