...
1. Write the JSON schema describing your resource, `tf-oci-loggingunifiedagentconfiguration.json`
2. Implement your resource handlers in `tf_oci_loggingunifiedagentconfiguration/handlers.py`
