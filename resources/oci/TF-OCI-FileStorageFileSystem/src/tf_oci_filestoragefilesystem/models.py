...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    IsCloneParent: Optional[bool]
    IsHydrated: Optional[bool]
    KmsKeyId: Optional[str]
    LifecycleDetails: Optional[str]
    MeteredBytes: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            IsCloneParent=json_data.get("IsCloneParent"),
            IsHydrated=json_data.get("IsHydrated"),
            KmsKeyId=json_data.get("KmsKeyId"),
            LifecycleDetails=json_data.get("LifecycleDetails"),
            MeteredBytes=json_data.get("MeteredBytes"),
...
class SourceDetailsDefinition(BaseModel):
    ParentFileSystemId: Optional[str]
    SourceSnapshotId: Optional[str]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            ParentFileSystemId=json_data.get("ParentFileSystemId"),
            SourceSnapshotId=json_data.get("SourceSnapshotId"),
        )
