...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousdatabase.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousdatabase/handlers.py`
