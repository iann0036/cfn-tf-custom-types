...
1. Write the JSON schema describing your resource, `tf-oci-objectstoragebucket.json`
2. Implement your resource handlers in `tf_oci_objectstoragebucket/handlers.py`
