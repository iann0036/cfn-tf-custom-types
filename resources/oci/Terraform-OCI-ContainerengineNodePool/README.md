...
1. Write the JSON schema describing your resource, `terraform-oci-containerenginenodepool.json`
2. Implement your resource handlers in `terraform_oci_containerenginenodepool/handlers.py`
