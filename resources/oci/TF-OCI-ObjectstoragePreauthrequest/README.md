...
1. Write the JSON schema describing your resource, `tf-oci-objectstoragepreauthrequest.json`
2. Implement your resource handlers in `tf_oci_objectstoragepreauthrequest/handlers.py`
