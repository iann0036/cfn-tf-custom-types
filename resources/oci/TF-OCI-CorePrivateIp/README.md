# TF::OCI::CorePrivateIp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-coreprivateip.json`
2. Implement your resource handlers in `tf_oci_coreprivateip/handlers.py`
