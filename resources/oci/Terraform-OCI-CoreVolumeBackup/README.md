...
1. Write the JSON schema describing your resource, `terraform-oci-corevolumebackup.json`
2. Implement your resource handlers in `terraform_oci_corevolumebackup/handlers.py`
