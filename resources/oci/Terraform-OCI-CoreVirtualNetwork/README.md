...
1. Write the JSON schema describing your resource, `terraform-oci-corevirtualnetwork.json`
2. Implement your resource handlers in `terraform_oci_corevirtualnetwork/handlers.py`
