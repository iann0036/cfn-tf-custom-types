...
1. Write the JSON schema describing your resource, `terraform-oci-identityusergroupmembership.json`
2. Implement your resource handlers in `terraform_oci_identityusergroupmembership/handlers.py`
