...
1. Write the JSON schema describing your resource, `tf-oci-genericartifactscontentartifactbypath.json`
2. Implement your resource handlers in `tf_oci_genericartifactscontentartifactbypath/handlers.py`
