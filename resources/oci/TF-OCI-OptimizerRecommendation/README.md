...
1. Write the JSON schema describing your resource, `tf-oci-optimizerrecommendation.json`
2. Implement your resource handlers in `tf_oci_optimizerrecommendation/handlers.py`
