...
1. Write the JSON schema describing your resource, `terraform-oci-identitygroup.json`
2. Implement your resource handlers in `terraform_oci_identitygroup/handlers.py`
