...
1. Write the JSON schema describing your resource, `tf-oci-databaseautonomouscontainerdatabasedataguardassociationoperation.json`
2. Implement your resource handlers in `tf_oci_databaseautonomouscontainerdatabasedataguardassociationoperation/handlers.py`
