...
1. Write the JSON schema describing your resource, `terraform-oci-databaseexadataiormconfig.json`
2. Implement your resource handlers in `terraform_oci_databaseexadataiormconfig/handlers.py`
