# TF::OCI::DatabaseCloudExadataInfrastructure

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-databasecloudexadatainfrastructure.json`
2. Implement your resource handlers in `tf_oci_databasecloudexadatainfrastructure/handlers.py`
