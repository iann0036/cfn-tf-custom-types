...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerpathrouteset.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerpathrouteset/handlers.py`
