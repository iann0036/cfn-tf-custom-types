...
class OptionsDefinition(BaseModel):
    CustomDnsServers: Optional[Sequence[str]]
    SearchDomainNames: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            CustomDnsServers=json_data.get("CustomDnsServers"),
            SearchDomainNames=json_data.get("SearchDomainNames"),
