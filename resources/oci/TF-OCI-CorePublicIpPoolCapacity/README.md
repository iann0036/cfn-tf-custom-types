...
1. Write the JSON schema describing your resource, `tf-oci-corepublicippoolcapacity.json`
2. Implement your resource handlers in `tf_oci_corepublicippoolcapacity/handlers.py`
