...
1. Write the JSON schema describing your resource, `tf-oci-filestorageexportset.json`
2. Implement your resource handlers in `tf_oci_filestorageexportset/handlers.py`
