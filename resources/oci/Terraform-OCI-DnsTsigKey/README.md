...
1. Write the JSON schema describing your resource, `terraform-oci-dnstsigkey.json`
2. Implement your resource handlers in `terraform_oci_dnstsigkey/handlers.py`
