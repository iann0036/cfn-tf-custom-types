...
class ResourceModel(BaseModel):
    ...
    FeedProvider: Optional[str]
    FreeformTags: Optional[Sequence["_FreeformTagsDefinition"]]
    Id: Optional[str]
    IsEditable: Optional[bool]
    LifecyleDetails: Optional[str]
    ListItems: Optional[Sequence[str]]
    ListType: Optional[str]
    SourceManagedListId: Optional[str]
    State: Optional[str]
