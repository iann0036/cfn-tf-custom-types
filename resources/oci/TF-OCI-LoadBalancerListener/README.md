...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerlistener.json`
2. Implement your resource handlers in `tf_oci_loadbalancerlistener/handlers.py`
