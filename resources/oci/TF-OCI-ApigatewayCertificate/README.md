...
1. Write the JSON schema describing your resource, `tf-oci-apigatewaycertificate.json`
2. Implement your resource handlers in `tf_oci_apigatewaycertificate/handlers.py`
