...
1. Write the JSON schema describing your resource, `tf-oci-identitynetworksource.json`
2. Implement your resource handlers in `tf_oci_identitynetworksource/handlers.py`
