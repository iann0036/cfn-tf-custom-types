...
1. Write the JSON schema describing your resource, `terraform-oci-dnssteeringpolicy.json`
2. Implement your resource handlers in `terraform_oci_dnssteeringpolicy/handlers.py`
