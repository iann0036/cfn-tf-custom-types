...
1. Write the JSON schema describing your resource, `terraform-oci-streamingstreampool.json`
2. Implement your resource handlers in `terraform_oci_streamingstreampool/handlers.py`
