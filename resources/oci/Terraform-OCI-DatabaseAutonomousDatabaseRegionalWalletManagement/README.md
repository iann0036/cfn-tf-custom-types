...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousdatabaseregionalwalletmanagement.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousdatabaseregionalwalletmanagement/handlers.py`
