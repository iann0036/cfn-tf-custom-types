...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancer.json`
2. Implement your resource handlers in `terraform_oci_loadbalancer/handlers.py`
