...
1. Write the JSON schema describing your resource, `tf-oci-optimizerresourceaction.json`
2. Implement your resource handlers in `tf_oci_optimizerresourceaction/handlers.py`
