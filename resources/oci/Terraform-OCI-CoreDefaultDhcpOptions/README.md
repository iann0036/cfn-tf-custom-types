# Terraform::OCI::CoreDefaultDhcpOptions

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-oci-coredefaultdhcpoptions.json`
2. Implement your resource handlers in `terraform_oci_coredefaultdhcpoptions/handlers.py`
