...
1. Write the JSON schema describing your resource, `tf-oci-osmanagementmanagedinstancegroup.json`
2. Implement your resource handlers in `tf_oci_osmanagementmanagedinstancegroup/handlers.py`
