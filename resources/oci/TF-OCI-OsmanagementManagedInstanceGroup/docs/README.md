# TF::OCI::OsmanagementManagedInstanceGroup
...
<pre>
{
    "Type" : "TF::OCI::OsmanagementManagedInstanceGroup",
    "Properties" : {
        ...
        "<a href="#osfamily" title="OsFamily">OsFamily</a>" : <i>String</i>,
...
Returns the <code>ManagedInstanceCount</code> value.

#### ManagedInstances

Returns the <code>ManagedInstances</code> value.
