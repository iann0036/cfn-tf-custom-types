...
1. Write the JSON schema describing your resource, `terraform-oci-coreroutetableattachment.json`
2. Implement your resource handlers in `terraform_oci_coreroutetableattachment/handlers.py`
