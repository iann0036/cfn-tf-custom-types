...
1. Write the JSON schema describing your resource, `terraform-oci-corebootvolume.json`
2. Implement your resource handlers in `terraform_oci_corebootvolume/handlers.py`
