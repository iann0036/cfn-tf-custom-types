...
1. Write the JSON schema describing your resource, `terraform-oci-corebootvolumebackup.json`
2. Implement your resource handlers in `terraform_oci_corebootvolumebackup/handlers.py`
