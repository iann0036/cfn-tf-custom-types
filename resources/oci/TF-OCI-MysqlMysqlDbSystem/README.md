...
1. Write the JSON schema describing your resource, `tf-oci-mysqlmysqldbsystem.json`
2. Implement your resource handlers in `tf_oci_mysqlmysqldbsystem/handlers.py`
