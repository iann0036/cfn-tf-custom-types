...
1. Write the JSON schema describing your resource, `terraform-oci-identityusercapabilitiesmanagement.json`
2. Implement your resource handlers in `terraform_oci_identityusercapabilitiesmanagement/handlers.py`
