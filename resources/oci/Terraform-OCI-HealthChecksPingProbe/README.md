...
1. Write the JSON schema describing your resource, `terraform-oci-healthcheckspingprobe.json`
2. Implement your resource handlers in `terraform_oci_healthcheckspingprobe/handlers.py`
