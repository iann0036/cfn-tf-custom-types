...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerruleset.json`
2. Implement your resource handlers in `tf_oci_loadbalancerruleset/handlers.py`
