...
1. Write the JSON schema describing your resource, `tf-oci-goldengatedatabaseregistration.json`
2. Implement your resource handlers in `tf_oci_goldengatedatabaseregistration/handlers.py`
