...
1. Write the JSON schema describing your resource, `tf-oci-waasprotectionrule.json`
2. Implement your resource handlers in `tf_oci_waasprotectionrule/handlers.py`
