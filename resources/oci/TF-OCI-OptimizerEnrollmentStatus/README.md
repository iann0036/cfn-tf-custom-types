...
1. Write the JSON schema describing your resource, `tf-oci-optimizerenrollmentstatus.json`
2. Implement your resource handlers in `tf_oci_optimizerenrollmentstatus/handlers.py`
