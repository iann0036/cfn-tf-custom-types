...
1. Write the JSON schema describing your resource, `terraform-oci-healthcheckshttpmonitor.json`
2. Implement your resource handlers in `terraform_oci_healthcheckshttpmonitor/handlers.py`
