...
1. Write the JSON schema describing your resource, `terraform-oci-datascienceproject.json`
2. Implement your resource handlers in `terraform_oci_datascienceproject/handlers.py`
