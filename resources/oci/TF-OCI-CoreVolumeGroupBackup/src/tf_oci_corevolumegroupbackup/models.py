...
class ResourceModel(BaseModel):
    ...
    SourceVolumeGroupBackupId: Optional[str]
    State: Optional[str]
    ...
    VolumeBackupIds: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SourceVolumeGroupBackupId=json_data.get("SourceVolumeGroupBackupId"),
            ...
            VolumeBackupIds=json_data.get("VolumeBackupIds"),
