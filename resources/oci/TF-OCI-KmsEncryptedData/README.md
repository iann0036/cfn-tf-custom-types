...
1. Write the JSON schema describing your resource, `tf-oci-kmsencrypteddata.json`
2. Implement your resource handlers in `tf_oci_kmsencrypteddata/handlers.py`
