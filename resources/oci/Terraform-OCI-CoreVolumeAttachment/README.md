...
1. Write the JSON schema describing your resource, `terraform-oci-corevolumeattachment.json`
2. Implement your resource handlers in `terraform_oci_corevolumeattachment/handlers.py`
