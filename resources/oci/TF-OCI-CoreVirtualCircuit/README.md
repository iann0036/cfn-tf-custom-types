...
1. Write the JSON schema describing your resource, `tf-oci-corevirtualcircuit.json`
2. Implement your resource handlers in `tf_oci_corevirtualcircuit/handlers.py`
