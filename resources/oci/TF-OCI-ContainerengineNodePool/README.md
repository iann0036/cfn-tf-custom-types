...
1. Write the JSON schema describing your resource, `tf-oci-containerenginenodepool.json`
2. Implement your resource handlers in `tf_oci_containerenginenodepool/handlers.py`
