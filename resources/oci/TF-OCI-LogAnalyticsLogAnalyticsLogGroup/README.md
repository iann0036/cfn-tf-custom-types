...
1. Write the JSON schema describing your resource, `tf-oci-loganalyticsloganalyticsloggroup.json`
2. Implement your resource handlers in `tf_oci_loganalyticsloganalyticsloggroup/handlers.py`
