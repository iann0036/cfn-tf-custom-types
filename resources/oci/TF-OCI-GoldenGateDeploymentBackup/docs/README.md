...
<pre>
{
    "Type" : "TF::OCI::GoldenGateDeploymentBackup",
    "Properties" : {
...
Returns the <code>BackupType</code> value.
...
Returns the <code>OggVersion</code> value.
...
Returns the <code>TimeOfBackup</code> value.
