...
1. Write the JSON schema describing your resource, `tf-oci-databasevmclusternetwork.json`
2. Implement your resource handlers in `tf_oci_databasevmclusternetwork/handlers.py`
