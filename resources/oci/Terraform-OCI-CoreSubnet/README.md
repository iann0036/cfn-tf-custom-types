...
1. Write the JSON schema describing your resource, `terraform-oci-coresubnet.json`
2. Implement your resource handlers in `terraform_oci_coresubnet/handlers.py`
