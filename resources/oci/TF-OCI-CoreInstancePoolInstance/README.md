...
1. Write the JSON schema describing your resource, `tf-oci-coreinstancepoolinstance.json`
2. Implement your resource handlers in `tf_oci_coreinstancepoolinstance/handlers.py`
