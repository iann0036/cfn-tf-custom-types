...
1. Write the JSON schema describing your resource, `terraform-oci-apigatewaygateway.json`
2. Implement your resource handlers in `terraform_oci_apigatewaygateway/handlers.py`
