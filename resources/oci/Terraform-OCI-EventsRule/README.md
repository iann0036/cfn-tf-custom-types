...
1. Write the JSON schema describing your resource, `terraform-oci-eventsrule.json`
2. Implement your resource handlers in `terraform_oci_eventsrule/handlers.py`
