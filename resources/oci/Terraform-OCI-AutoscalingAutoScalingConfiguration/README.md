...
1. Write the JSON schema describing your resource, `terraform-oci-autoscalingautoscalingconfiguration.json`
2. Implement your resource handlers in `terraform_oci_autoscalingautoscalingconfiguration/handlers.py`
