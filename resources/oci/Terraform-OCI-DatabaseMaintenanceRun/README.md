...
1. Write the JSON schema describing your resource, `terraform-oci-databasemaintenancerun.json`
2. Implement your resource handlers in `terraform_oci_databasemaintenancerun/handlers.py`
