...
1. Write the JSON schema describing your resource, `tf-oci-databasemanagementmanageddatabasegroup.json`
2. Implement your resource handlers in `tf_oci_databasemanagementmanageddatabasegroup/handlers.py`
