...
1. Write the JSON schema describing your resource, `terraform-oci-waascustomprotectionrule.json`
2. Implement your resource handlers in `terraform_oci_waascustomprotectionrule/handlers.py`
