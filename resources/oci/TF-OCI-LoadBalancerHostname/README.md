...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerhostname.json`
2. Implement your resource handlers in `tf_oci_loadbalancerhostname/handlers.py`
