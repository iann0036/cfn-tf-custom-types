...
1. Write the JSON schema describing your resource, `terraform-oci-waaswaaspolicy.json`
2. Implement your resource handlers in `terraform_oci_waaswaaspolicy/handlers.py`
