...
1. Write the JSON schema describing your resource, `terraform-oci-dnsrecord.json`
2. Implement your resource handlers in `terraform_oci_dnsrecord/handlers.py`
