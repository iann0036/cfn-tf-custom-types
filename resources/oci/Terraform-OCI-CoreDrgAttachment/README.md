...
1. Write the JSON schema describing your resource, `terraform-oci-coredrgattachment.json`
2. Implement your resource handlers in `terraform_oci_coredrgattachment/handlers.py`
