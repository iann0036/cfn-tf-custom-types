...
1. Write the JSON schema describing your resource, `terraform-oci-odaodainstance.json`
2. Implement your resource handlers in `terraform_oci_odaodainstance/handlers.py`
