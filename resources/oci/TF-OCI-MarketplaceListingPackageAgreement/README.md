...
1. Write the JSON schema describing your resource, `tf-oci-marketplacelistingpackageagreement.json`
2. Implement your resource handlers in `tf_oci_marketplacelistingpackageagreement/handlers.py`
