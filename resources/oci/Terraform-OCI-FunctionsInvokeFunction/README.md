...
1. Write the JSON schema describing your resource, `terraform-oci-functionsinvokefunction.json`
2. Implement your resource handlers in `terraform_oci_functionsinvokefunction/handlers.py`
