# TF::OCI::IdentityApiKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-identityapikey.json`
2. Implement your resource handlers in `tf_oci_identityapikey/handlers.py`
