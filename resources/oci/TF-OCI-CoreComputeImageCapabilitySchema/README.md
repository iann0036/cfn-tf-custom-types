...
1. Write the JSON schema describing your resource, `tf-oci-corecomputeimagecapabilityschema.json`
2. Implement your resource handlers in `tf_oci_corecomputeimagecapabilityschema/handlers.py`
