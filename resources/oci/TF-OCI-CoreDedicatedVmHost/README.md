...
1. Write the JSON schema describing your resource, `tf-oci-corededicatedvmhost.json`
2. Implement your resource handlers in `tf_oci_corededicatedvmhost/handlers.py`
