...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    RemainingMemoryInGbs: Optional[float]
    RemainingOcpus: Optional[float]
    State: Optional[str]
    TimeCreated: Optional[str]
    TotalMemoryInGbs: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            RemainingMemoryInGbs=json_data.get("RemainingMemoryInGbs"),
            RemainingOcpus=json_data.get("RemainingOcpus"),
            State=json_data.get("State"),
            TimeCreated=json_data.get("TimeCreated"),
            TotalMemoryInGbs=json_data.get("TotalMemoryInGbs"),
