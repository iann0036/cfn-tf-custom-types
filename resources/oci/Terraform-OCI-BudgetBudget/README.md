...
1. Write the JSON schema describing your resource, `terraform-oci-budgetbudget.json`
2. Implement your resource handlers in `terraform_oci_budgetbudget/handlers.py`
