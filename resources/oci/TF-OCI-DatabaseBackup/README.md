# TF::OCI::DatabaseBackup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-databasebackup.json`
2. Implement your resource handlers in `tf_oci_databasebackup/handlers.py`
