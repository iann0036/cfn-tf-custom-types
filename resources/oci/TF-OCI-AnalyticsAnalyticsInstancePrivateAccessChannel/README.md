...
1. Write the JSON schema describing your resource, `tf-oci-analyticsanalyticsinstanceprivateaccesschannel.json`
2. Implement your resource handlers in `tf_oci_analyticsanalyticsinstanceprivateaccesschannel/handlers.py`
