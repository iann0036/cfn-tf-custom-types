...
1. Write the JSON schema describing your resource, `terraform-oci-datasciencemodelprovenance.json`
2. Implement your resource handlers in `terraform_oci_datasciencemodelprovenance/handlers.py`
