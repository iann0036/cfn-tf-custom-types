...
1. Write the JSON schema describing your resource, `terraform-oci-healthcheckspingmonitor.json`
2. Implement your resource handlers in `terraform_oci_healthcheckspingmonitor/handlers.py`
