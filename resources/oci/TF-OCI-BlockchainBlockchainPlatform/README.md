...
1. Write the JSON schema describing your resource, `tf-oci-blockchainblockchainplatform.json`
2. Implement your resource handlers in `tf_oci_blockchainblockchainplatform/handlers.py`
