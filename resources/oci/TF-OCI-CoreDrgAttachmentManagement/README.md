...
1. Write the JSON schema describing your resource, `tf-oci-coredrgattachmentmanagement.json`
2. Implement your resource handlers in `tf_oci_coredrgattachmentmanagement/handlers.py`
