...
1. Write the JSON schema describing your resource, `terraform-oci-identitysmtpcredential.json`
2. Implement your resource handlers in `terraform_oci_identitysmtpcredential/handlers.py`
