...
1. Write the JSON schema describing your resource, `terraform-oci-auditconfiguration.json`
2. Implement your resource handlers in `terraform_oci_auditconfiguration/handlers.py`
