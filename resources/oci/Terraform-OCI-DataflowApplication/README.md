...
1. Write the JSON schema describing your resource, `terraform-oci-dataflowapplication.json`
2. Implement your resource handlers in `terraform_oci_dataflowapplication/handlers.py`
