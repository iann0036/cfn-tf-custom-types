...
1. Write the JSON schema describing your resource, `terraform-oci-coreroutetable.json`
2. Implement your resource handlers in `terraform_oci_coreroutetable/handlers.py`
