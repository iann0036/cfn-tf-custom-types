# TF::OCI::DatacatalogCatalogPrivateEndpoint

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-datacatalogcatalogprivateendpoint.json`
2. Implement your resource handlers in `tf_oci_datacatalogcatalogprivateendpoint/handlers.py`
