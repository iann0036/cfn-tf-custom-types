...
class ResourceModel(BaseModel):
    ...
    ExternalContainerDatabaseId: Optional[str]
    FreeformTags: Optional[Sequence["_FreeformTagsDefinition"]]
    Id: Optional[str]
    LifecycleDetails: Optional[str]
    NcharacterSet: Optional[str]
    OperationsInsightsConfig: Optional[Sequence["_OperationsInsightsConfigDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ExternalContainerDatabaseId=json_data.get("ExternalContainerDatabaseId"),
            FreeformTags=deserialize_list(json_data.get("FreeformTags"), FreeformTagsDefinition),
            Id=json_data.get("Id"),
            LifecycleDetails=json_data.get("LifecycleDetails"),
            NcharacterSet=json_data.get("NcharacterSet"),
            OperationsInsightsConfig=deserialize_list(json_data.get("OperationsInsightsConfig"), OperationsInsightsConfigDefinition),
...
@dataclass
class OperationsInsightsConfigDefinition(BaseModel):
    OperationsInsightsConnectorId: Optional[str]
    OperationsInsightsStatus: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_OperationsInsightsConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_OperationsInsightsConfigDefinition"]:
        if not json_data:
            return None
        return cls(
            OperationsInsightsConnectorId=json_data.get("OperationsInsightsConnectorId"),
            OperationsInsightsStatus=json_data.get("OperationsInsightsStatus"),
        )


# work around possible type aliasing issues when variable has same name as a model
_OperationsInsightsConfigDefinition = OperationsInsightsConfigDefinition
