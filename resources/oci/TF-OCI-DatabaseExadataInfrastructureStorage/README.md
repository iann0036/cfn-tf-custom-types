...
1. Write the JSON schema describing your resource, `tf-oci-databaseexadatainfrastructurestorage.json`
2. Implement your resource handlers in `tf_oci_databaseexadatainfrastructurestorage/handlers.py`
