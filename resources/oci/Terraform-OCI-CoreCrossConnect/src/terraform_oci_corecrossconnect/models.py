...
class ResourceModel(BaseResourceModel):
    ...
    CrossConnectGroupId: Optional[str]
    CustomerReferenceName: Optional[str]
    ...
    PortSpeedShapeName: Optional[str]
    State: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CrossConnectGroupId=json_data.get("CrossConnectGroupId"),
            CustomerReferenceName=json_data.get("CustomerReferenceName"),
            ...
            PortSpeedShapeName=json_data.get("PortSpeedShapeName"),
