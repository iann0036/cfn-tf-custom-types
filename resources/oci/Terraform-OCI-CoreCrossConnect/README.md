...
1. Write the JSON schema describing your resource, `terraform-oci-corecrossconnect.json`
2. Implement your resource handlers in `terraform_oci_corecrossconnect/handlers.py`
