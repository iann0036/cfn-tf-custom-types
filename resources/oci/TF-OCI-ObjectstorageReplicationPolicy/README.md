...
1. Write the JSON schema describing your resource, `tf-oci-objectstoragereplicationpolicy.json`
2. Implement your resource handlers in `tf_oci_objectstoragereplicationpolicy/handlers.py`
