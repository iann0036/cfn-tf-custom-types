...
1. Write the JSON schema describing your resource, `terraform-oci-objectstoragepreauthrequest.json`
2. Implement your resource handlers in `terraform_oci_objectstoragepreauthrequest/handlers.py`
