...
1. Write the JSON schema describing your resource, `terraform-oci-coreinstance.json`
2. Implement your resource handlers in `terraform_oci_coreinstance/handlers.py`
