...
1. Write the JSON schema describing your resource, `tf-oci-coreinstanceconfiguration.json`
2. Implement your resource handlers in `tf_oci_coreinstanceconfiguration/handlers.py`
