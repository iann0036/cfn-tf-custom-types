...
1. Write the JSON schema describing your resource, `terraform-oci-corenetworksecuritygroupsecurityrule.json`
2. Implement your resource handlers in `terraform_oci_corenetworksecuritygroupsecurityrule/handlers.py`
