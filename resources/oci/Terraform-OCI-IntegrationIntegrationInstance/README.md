...
1. Write the JSON schema describing your resource, `terraform-oci-integrationintegrationinstance.json`
2. Implement your resource handlers in `terraform_oci_integrationintegrationinstance/handlers.py`
