...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerlistener.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerlistener/handlers.py`
