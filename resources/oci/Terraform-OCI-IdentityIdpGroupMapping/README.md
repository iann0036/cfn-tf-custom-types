...
1. Write the JSON schema describing your resource, `terraform-oci-identityidpgroupmapping.json`
2. Implement your resource handlers in `terraform_oci_identityidpgroupmapping/handlers.py`
