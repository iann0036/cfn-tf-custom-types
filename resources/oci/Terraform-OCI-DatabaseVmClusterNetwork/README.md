...
1. Write the JSON schema describing your resource, `terraform-oci-databasevmclusternetwork.json`
2. Implement your resource handlers in `terraform_oci_databasevmclusternetwork/handlers.py`
