...
1. Write the JSON schema describing your resource, `tf-oci-networkloadbalancerbackend.json`
2. Implement your resource handlers in `tf_oci_networkloadbalancerbackend/handlers.py`
