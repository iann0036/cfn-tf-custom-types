...
1. Write the JSON schema describing your resource, `terraform-oci-coreprivateip.json`
2. Implement your resource handlers in `terraform_oci_coreprivateip/handlers.py`
