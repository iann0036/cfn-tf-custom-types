...
1. Write the JSON schema describing your resource, `terraform-oci-osmanagementmanagedinstancemanagement.json`
2. Implement your resource handlers in `terraform_oci_osmanagementmanagedinstancemanagement/handlers.py`
