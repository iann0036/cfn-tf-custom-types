...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancersslciphersuite.json`
2. Implement your resource handlers in `tf_oci_loadbalancersslciphersuite/handlers.py`
