...
1. Write the JSON schema describing your resource, `tf-oci-artifactscontainerimagesignature.json`
2. Implement your resource handlers in `tf_oci_artifactscontainerimagesignature/handlers.py`
