...
1. Write the JSON schema describing your resource, `tf-oci-apigatewaydeployment.json`
2. Implement your resource handlers in `tf_oci_apigatewaydeployment/handlers.py`
