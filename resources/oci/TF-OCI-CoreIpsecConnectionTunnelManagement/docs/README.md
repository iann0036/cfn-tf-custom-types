# TF::OCI::CoreIpsecConnectionTunnelManagement
...
** IMPORTANT **
Destroying `the oci_core_ipsec_connection_tunnel_management` leaves the resource in its existing state. It will not destroy the tunnel and it will not return the tunnel to its...
...
<pre>
{
    "Type" : "TF::OCI::CoreIpsecConnectionTunnelManagement",
    "Properties" : {
        ...
        "<a href="#bgpsessioninfo" title="BgpSessionInfo">BgpSessionInfo</a>" : <i>[ <a href="bgpsessioninfodefinition.md">BgpSessionInfoDefinition</a>, ... ]</i>,
        "<a href="#encryptiondomainconfig" title="EncryptionDomainConfig">EncryptionDomainConfig</a>" : <i>[ <a href="encryptiondomainconfigdefinition.md">EncryptionDomainConfigDefinition</a>, ... ]</i>,
...
Properties:
    ...
    <a href="#bgpsessioninfo" title="BgpSessionInfo">BgpSessionInfo</a>: <i>
      - <a href="bgpsessioninfodefinition.md">BgpSessionInfoDefinition</a></i>
    <a href="#encryptiondomainconfig" title="EncryptionDomainConfig">EncryptionDomainConfig</a>: <i>
      - <a href="encryptiondomainconfigdefinition.md">EncryptionDomainConfigDefinition</a></i>
    <a href="#timeouts" title="Timeouts">Timeouts</a>: <i><a href="timeoutsdefinition.md">TimeoutsDefinition</a></i>
</pre>
...
_Type_: List of <a href="bgpsessioninfodefinition.md">BgpSessionInfoDefinition</a>
...
_Type_: List of <a href="encryptiondomainconfigdefinition.md">EncryptionDomainConfigDefinition</a>
