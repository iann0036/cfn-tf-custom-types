...
1. Write the JSON schema describing your resource, `tf-oci-coreipsecconnectiontunnelmanagement.json`
2. Implement your resource handlers in `tf_oci_coreipsecconnectiontunnelmanagement/handlers.py`
