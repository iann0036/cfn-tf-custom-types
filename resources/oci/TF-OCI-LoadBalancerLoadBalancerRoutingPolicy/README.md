...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerloadbalancerroutingpolicy.json`
2. Implement your resource handlers in `tf_oci_loadbalancerloadbalancerroutingpolicy/handlers.py`
