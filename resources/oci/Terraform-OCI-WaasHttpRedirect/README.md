...
1. Write the JSON schema describing your resource, `terraform-oci-waashttpredirect.json`
2. Implement your resource handlers in `terraform_oci_waashttpredirect/handlers.py`
