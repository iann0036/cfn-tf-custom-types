...
1. Write the JSON schema describing your resource, `terraform-oci-databasedbnodeconsoleconnection.json`
2. Implement your resource handlers in `terraform_oci_databasedbnodeconsoleconnection/handlers.py`
