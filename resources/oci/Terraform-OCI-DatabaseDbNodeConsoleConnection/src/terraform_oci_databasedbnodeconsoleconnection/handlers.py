...
def create_handler(
    ...
    try:
        ...
        tf['resource']['oci_database_db_node_console_connection'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['oci_database_db_node_console_connection'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
