...
1. Write the JSON schema describing your resource, `terraform-oci-dnssteeringpolicyattachment.json`
2. Implement your resource handlers in `terraform_oci_dnssteeringpolicyattachment/handlers.py`
