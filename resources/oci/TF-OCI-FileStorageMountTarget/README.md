...
1. Write the JSON schema describing your resource, `tf-oci-filestoragemounttarget.json`
2. Implement your resource handlers in `tf_oci_filestoragemounttarget/handlers.py`
