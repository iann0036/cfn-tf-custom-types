...
1. Write the JSON schema describing your resource, `terraform-oci-containerenginecluster.json`
2. Implement your resource handlers in `terraform_oci_containerenginecluster/handlers.py`
