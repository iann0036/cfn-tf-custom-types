...
1. Write the JSON schema describing your resource, `tf-oci-integrationintegrationinstance.json`
2. Implement your resource handlers in `tf_oci_integrationintegrationinstance/handlers.py`
