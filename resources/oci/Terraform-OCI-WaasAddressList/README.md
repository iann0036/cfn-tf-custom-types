...
1. Write the JSON schema describing your resource, `terraform-oci-waasaddresslist.json`
2. Implement your resource handlers in `terraform_oci_waasaddresslist/handlers.py`
