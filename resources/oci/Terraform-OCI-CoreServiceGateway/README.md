...
1. Write the JSON schema describing your resource, `terraform-oci-coreservicegateway.json`
2. Implement your resource handlers in `terraform_oci_coreservicegateway/handlers.py`
