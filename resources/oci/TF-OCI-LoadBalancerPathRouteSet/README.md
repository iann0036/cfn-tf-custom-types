...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerpathrouteset.json`
2. Implement your resource handlers in `tf_oci_loadbalancerpathrouteset/handlers.py`
