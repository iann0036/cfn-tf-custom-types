...
1. Write the JSON schema describing your resource, `tf-oci-meteringcomputationquery.json`
2. Implement your resource handlers in `tf_oci_meteringcomputationquery/handlers.py`
