...
class ResourceModel(BaseModel):
    ...
    BootVolumeReplicasDeletion: Optional[bool]
    ...
    BootVolumeReplicas: Optional[Sequence["_BootVolumeReplicasDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BootVolumeReplicasDeletion=json_data.get("BootVolumeReplicasDeletion"),
            ...
            BootVolumeReplicas=deserialize_list(json_data.get("BootVolumeReplicas"), BootVolumeReplicasDefinition),
...
@dataclass
class BootVolumeReplicasDefinition(BaseModel):
    AvailabilityDomain: Optional[str]
    DisplayName: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_BootVolumeReplicasDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BootVolumeReplicasDefinition"]:
        if not json_data:
            return None
        return cls(
            AvailabilityDomain=json_data.get("AvailabilityDomain"),
...
# work around possible type aliasing issues when variable has same name as a model
_BootVolumeReplicasDefinition = BootVolumeReplicasDefinition
