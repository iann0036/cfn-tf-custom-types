# TF::OCI::CoreVolumeBackupPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-corevolumebackuppolicy.json`
2. Implement your resource handlers in `tf_oci_corevolumebackuppolicy/handlers.py`
