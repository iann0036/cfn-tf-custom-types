...
1. Write the JSON schema describing your resource, `terraform-oci-osmanagementsoftwaresource.json`
2. Implement your resource handlers in `terraform_oci_osmanagementsoftwaresource/handlers.py`
