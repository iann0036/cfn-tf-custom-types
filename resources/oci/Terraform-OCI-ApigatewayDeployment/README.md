...
1. Write the JSON schema describing your resource, `terraform-oci-apigatewaydeployment.json`
2. Implement your resource handlers in `terraform_oci_apigatewaydeployment/handlers.py`
