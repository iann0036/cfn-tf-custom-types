# TF::OCI::CoreNetworkSecurityGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-corenetworksecuritygroup.json`
2. Implement your resource handlers in `tf_oci_corenetworksecuritygroup/handlers.py`
