...
1. Write the JSON schema describing your resource, `tf-oci-databaseexternaldatabaseconnector.json`
2. Implement your resource handlers in `tf_oci_databaseexternaldatabaseconnector/handlers.py`
