...
1. Write the JSON schema describing your resource, `tf-oci-datasafedatasafeconfiguration.json`
2. Implement your resource handlers in `tf_oci_datasafedatasafeconfiguration/handlers.py`
