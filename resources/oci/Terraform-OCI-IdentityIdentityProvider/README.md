...
1. Write the JSON schema describing your resource, `terraform-oci-identityidentityprovider.json`
2. Implement your resource handlers in `terraform_oci_identityidentityprovider/handlers.py`
