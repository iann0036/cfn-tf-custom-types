# TF::OCI::ServiceCatalogServiceCatalogAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-servicecatalogservicecatalogassociation.json`
2. Implement your resource handlers in `tf_oci_servicecatalogservicecatalogassociation/handlers.py`
