...
1. Write the JSON schema describing your resource, `terraform-oci-analyticsanalyticsinstance.json`
2. Implement your resource handlers in `terraform_oci_analyticsanalyticsinstance/handlers.py`
