...
1. Write the JSON schema describing your resource, `terraform-oci-coreappcataloglistingresourceversionagreement.json`
2. Implement your resource handlers in `terraform_oci_coreappcataloglistingresourceversionagreement/handlers.py`
