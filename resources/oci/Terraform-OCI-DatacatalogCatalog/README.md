...
1. Write the JSON schema describing your resource, `terraform-oci-datacatalogcatalog.json`
2. Implement your resource handlers in `terraform_oci_datacatalogcatalog/handlers.py`
