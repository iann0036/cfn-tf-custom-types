...
<pre>
{
    "Type" : "Terraform::OCI::DatacatalogCatalog",
    "Properties" : {
        ...
        "<a href="#numberofobjects" title="NumberOfObjects">NumberOfObjects</a>" : <i>Double</i>,
        "<a href="#serviceapiurl" title="ServiceApiUrl">ServiceApiUrl</a>" : <i>String</i>,
