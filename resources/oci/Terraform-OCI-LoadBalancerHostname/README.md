...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerhostname.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerhostname/handlers.py`
