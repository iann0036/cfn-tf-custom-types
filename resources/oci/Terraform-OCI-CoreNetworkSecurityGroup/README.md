# Terraform::OCI::CoreNetworkSecurityGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-oci-corenetworksecuritygroup.json`
2. Implement your resource handlers in `terraform_oci_corenetworksecuritygroup/handlers.py`
