...
1. Write the JSON schema describing your resource, `terraform-oci-loadbalancerbackend.json`
2. Implement your resource handlers in `terraform_oci_loadbalancerbackend/handlers.py`
