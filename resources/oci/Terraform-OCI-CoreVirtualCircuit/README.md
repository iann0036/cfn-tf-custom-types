...
1. Write the JSON schema describing your resource, `terraform-oci-corevirtualcircuit.json`
2. Implement your resource handlers in `terraform_oci_corevirtualcircuit/handlers.py`
