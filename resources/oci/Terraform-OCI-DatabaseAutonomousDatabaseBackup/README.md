...
1. Write the JSON schema describing your resource, `terraform-oci-databaseautonomousdatabasebackup.json`
2. Implement your resource handlers in `terraform_oci_databaseautonomousdatabasebackup/handlers.py`
