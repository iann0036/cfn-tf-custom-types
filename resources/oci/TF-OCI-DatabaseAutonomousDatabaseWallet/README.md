...
1. Write the JSON schema describing your resource, `tf-oci-databaseautonomousdatabasewallet.json`
2. Implement your resource handlers in `tf_oci_databaseautonomousdatabasewallet/handlers.py`
