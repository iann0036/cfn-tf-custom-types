# TF::OCI::IdentityUserCapabilitiesManagement

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-identityusercapabilitiesmanagement.json`
2. Implement your resource handlers in `tf_oci_identityusercapabilitiesmanagement/handlers.py`
