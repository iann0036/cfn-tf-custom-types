...
1. Write the JSON schema describing your resource, `terraform-oci-emailsender.json`
2. Implement your resource handlers in `terraform_oci_emailsender/handlers.py`
