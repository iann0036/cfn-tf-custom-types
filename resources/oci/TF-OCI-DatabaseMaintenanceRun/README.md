...
1. Write the JSON schema describing your resource, `tf-oci-databasemaintenancerun.json`
2. Implement your resource handlers in `tf_oci_databasemaintenancerun/handlers.py`
