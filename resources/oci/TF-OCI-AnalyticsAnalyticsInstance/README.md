...
1. Write the JSON schema describing your resource, `tf-oci-analyticsanalyticsinstance.json`
2. Implement your resource handlers in `tf_oci_analyticsanalyticsinstance/handlers.py`
