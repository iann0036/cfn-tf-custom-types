...
1. Write the JSON schema describing your resource, `terraform-oci-identityapikey.json`
2. Implement your resource handlers in `terraform_oci_identityapikey/handlers.py`
