...
1. Write the JSON schema describing your resource, `tf-oci-databaseexternalpluggabledatabaseoperationsinsightsmanagement.json`
2. Implement your resource handlers in `tf_oci_databaseexternalpluggabledatabaseoperationsinsightsmanagement/handlers.py`
