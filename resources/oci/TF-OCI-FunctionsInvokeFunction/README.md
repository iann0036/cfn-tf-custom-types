# TF::OCI::FunctionsInvokeFunction

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-functionsinvokefunction.json`
2. Implement your resource handlers in `tf_oci_functionsinvokefunction/handlers.py`
