...
1. Write the JSON schema describing your resource, `terraform-oci-corevolume.json`
2. Implement your resource handlers in `terraform_oci_corevolume/handlers.py`
