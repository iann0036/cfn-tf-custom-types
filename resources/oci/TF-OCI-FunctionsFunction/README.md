...
1. Write the JSON schema describing your resource, `tf-oci-functionsfunction.json`
2. Implement your resource handlers in `tf_oci_functionsfunction/handlers.py`
