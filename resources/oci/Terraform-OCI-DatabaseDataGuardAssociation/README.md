...
1. Write the JSON schema describing your resource, `terraform-oci-databasedataguardassociation.json`
2. Implement your resource handlers in `terraform_oci_databasedataguardassociation/handlers.py`
