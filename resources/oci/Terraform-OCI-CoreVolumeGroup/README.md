...
1. Write the JSON schema describing your resource, `terraform-oci-corevolumegroup.json`
2. Implement your resource handlers in `terraform_oci_corevolumegroup/handlers.py`
