...
1. Write the JSON schema describing your resource, `tf-oci-opsidatabaseinsight.json`
2. Implement your resource handlers in `tf_oci_opsidatabaseinsight/handlers.py`
