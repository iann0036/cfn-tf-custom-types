...
1. Write the JSON schema describing your resource, `tf-oci-goldengatedeployment.json`
2. Implement your resource handlers in `tf_oci_goldengatedeployment/handlers.py`
