...
1. Write the JSON schema describing your resource, `tf-oci-loadbalancerbackendset.json`
2. Implement your resource handlers in `tf_oci_loadbalancerbackendset/handlers.py`
