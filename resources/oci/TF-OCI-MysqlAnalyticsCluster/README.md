...
1. Write the JSON schema describing your resource, `tf-oci-mysqlanalyticscluster.json`
2. Implement your resource handlers in `tf_oci_mysqlanalyticscluster/handlers.py`
