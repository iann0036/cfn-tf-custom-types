...
1. Write the JSON schema describing your resource, `terraform-oci-datacatalogdataasset.json`
2. Implement your resource handlers in `terraform_oci_datacatalogdataasset/handlers.py`
