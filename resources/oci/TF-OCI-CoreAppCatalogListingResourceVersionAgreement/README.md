...
1. Write the JSON schema describing your resource, `tf-oci-coreappcataloglistingresourceversionagreement.json`
2. Implement your resource handlers in `tf_oci_coreappcataloglistingresourceversionagreement/handlers.py`
