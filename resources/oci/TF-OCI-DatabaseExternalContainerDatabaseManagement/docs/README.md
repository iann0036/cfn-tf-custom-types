...
<pre>
{
    "Type" : "TF::OCI::DatabaseExternalContainerDatabaseManagement",
    "Properties" : {
        "<a href="#enablemanagement" title="EnableManagement">EnableManagement</a>" : <i>Boolean</i>,
        "<a href="#externalcontainerdatabaseid" title="ExternalContainerDatabaseId">ExternalContainerDatabaseId</a>" : <i>String</i>,
