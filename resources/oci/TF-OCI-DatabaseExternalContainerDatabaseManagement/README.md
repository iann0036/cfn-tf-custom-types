# TF::OCI::DatabaseExternalContainerDatabaseManagement

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oci-databaseexternalcontainerdatabasemanagement.json`
2. Implement your resource handlers in `tf_oci_databaseexternalcontainerdatabasemanagement/handlers.py`
