...
1. Write the JSON schema describing your resource, `terraform-oci-coreinstanceconsoleconnection.json`
2. Implement your resource handlers in `terraform_oci_coreinstanceconsoleconnection/handlers.py`
