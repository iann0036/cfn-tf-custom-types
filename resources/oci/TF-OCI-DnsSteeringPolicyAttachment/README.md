...
1. Write the JSON schema describing your resource, `tf-oci-dnssteeringpolicyattachment.json`
2. Implement your resource handlers in `tf_oci_dnssteeringpolicyattachment/handlers.py`
