...
1. Write the JSON schema describing your resource, `tf-stackpath-computeworkload.json`
2. Implement your resource handlers in `tf_stackpath_computeworkload/handlers.py`
