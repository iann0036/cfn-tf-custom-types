# TF::StackPath::ComputeNetworkPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-stackpath-computenetworkpolicy.json`
2. Implement your resource handlers in `tf_stackpath_computenetworkpolicy/handlers.py`
