...
1. Write the JSON schema describing your resource, `tf-stackpath-objectstoragebucket.json`
2. Implement your resource handlers in `tf_stackpath_objectstoragebucket/handlers.py`
