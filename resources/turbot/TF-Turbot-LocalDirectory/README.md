...
1. Write the JSON schema describing your resource, `tf-turbot-localdirectory.json`
2. Implement your resource handlers in `tf_turbot_localdirectory/handlers.py`
