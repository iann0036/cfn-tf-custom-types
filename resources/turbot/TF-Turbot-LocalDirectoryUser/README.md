...
1. Write the JSON schema describing your resource, `tf-turbot-localdirectoryuser.json`
2. Implement your resource handlers in `tf_turbot_localdirectoryuser/handlers.py`
