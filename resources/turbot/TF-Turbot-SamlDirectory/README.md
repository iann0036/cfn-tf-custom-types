...
1. Write the JSON schema describing your resource, `tf-turbot-samldirectory.json`
2. Implement your resource handlers in `tf_turbot_samldirectory/handlers.py`
