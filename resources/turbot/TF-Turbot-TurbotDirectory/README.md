# TF::Turbot::TurbotDirectory

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-turbot-turbotdirectory.json`
2. Implement your resource handlers in `tf_turbot_turbotdirectory/handlers.py`
