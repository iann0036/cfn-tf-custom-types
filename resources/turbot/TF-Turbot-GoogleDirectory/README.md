...
1. Write the JSON schema describing your resource, `tf-turbot-googledirectory.json`
2. Implement your resource handlers in `tf_turbot_googledirectory/handlers.py`
