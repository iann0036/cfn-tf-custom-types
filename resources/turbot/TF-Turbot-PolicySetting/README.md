...
1. Write the JSON schema describing your resource, `tf-turbot-policysetting.json`
2. Implement your resource handlers in `tf_turbot_policysetting/handlers.py`
