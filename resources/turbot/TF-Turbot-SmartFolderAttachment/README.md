# TF::Turbot::SmartFolderAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-turbot-smartfolderattachment.json`
2. Implement your resource handlers in `tf_turbot_smartfolderattachment/handlers.py`
