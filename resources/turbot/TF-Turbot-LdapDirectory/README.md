...
1. Write the JSON schema describing your resource, `tf-turbot-ldapdirectory.json`
2. Implement your resource handlers in `tf_turbot_ldapdirectory/handlers.py`
