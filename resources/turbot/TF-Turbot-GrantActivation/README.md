...
1. Write the JSON schema describing your resource, `tf-turbot-grantactivation.json`
2. Implement your resource handlers in `tf_turbot_grantactivation/handlers.py`
