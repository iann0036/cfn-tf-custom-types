...
1. Write the JSON schema describing your resource, `tf-turbot-shadowresource.json`
2. Implement your resource handlers in `tf_turbot_shadowresource/handlers.py`
