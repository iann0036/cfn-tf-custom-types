# TF::Sematext::MonitorHadoopmrv1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorhadoopmrv1.json`
2. Implement your resource handlers in `tf_sematext_monitorhadoopmrv1/handlers.py`
