# TF::Sematext::MonitorAwsec2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorawsec2.json`
2. Implement your resource handlers in `tf_sematext_monitorawsec2/handlers.py`
