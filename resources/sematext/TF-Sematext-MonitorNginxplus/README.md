...
1. Write the JSON schema describing your resource, `tf-sematext-monitornginxplus.json`
2. Implement your resource handlers in `tf_sematext_monitornginxplus/handlers.py`
