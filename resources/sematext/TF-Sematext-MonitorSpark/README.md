# TF::Sematext::MonitorSpark

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorspark.json`
2. Implement your resource handlers in `tf_sematext_monitorspark/handlers.py`
