# TF::Sematext::MonitorHaproxy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorhaproxy.json`
2. Implement your resource handlers in `tf_sematext_monitorhaproxy/handlers.py`
