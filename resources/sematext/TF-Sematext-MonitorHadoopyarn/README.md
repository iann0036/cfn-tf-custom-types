# TF::Sematext::MonitorHadoopyarn

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorhadoopyarn.json`
2. Implement your resource handlers in `tf_sematext_monitorhadoopyarn/handlers.py`
