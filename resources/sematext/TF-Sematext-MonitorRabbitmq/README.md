# TF::Sematext::MonitorRabbitmq

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorrabbitmq.json`
2. Implement your resource handlers in `tf_sematext_monitorrabbitmq/handlers.py`
