# TF::Sematext::MonitorStorm

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorstorm.json`
2. Implement your resource handlers in `tf_sematext_monitorstorm/handlers.py`
