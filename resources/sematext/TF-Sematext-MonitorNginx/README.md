# TF::Sematext::MonitorNginx

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitornginx.json`
2. Implement your resource handlers in `tf_sematext_monitornginx/handlers.py`
