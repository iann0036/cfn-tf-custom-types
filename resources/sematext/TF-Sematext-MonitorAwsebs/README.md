# TF::Sematext::MonitorAwsebs

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorawsebs.json`
2. Implement your resource handlers in `tf_sematext_monitorawsebs/handlers.py`
