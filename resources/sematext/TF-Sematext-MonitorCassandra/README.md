# TF::Sematext::MonitorCassandra

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorcassandra.json`
2. Implement your resource handlers in `tf_sematext_monitorcassandra/handlers.py`
