# TF::Sematext::MonitorElasticsearch

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sematext-monitorelasticsearch.json`
2. Implement your resource handlers in `tf_sematext_monitorelasticsearch/handlers.py`
