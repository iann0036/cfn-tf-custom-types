...
1. Write the JSON schema describing your resource, `tf-aiven-kafkaconnector.json`
2. Implement your resource handlers in `tf_aiven_kafkaconnector/handlers.py`
