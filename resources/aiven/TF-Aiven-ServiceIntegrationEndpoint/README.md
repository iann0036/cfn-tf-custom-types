...
1. Write the JSON schema describing your resource, `tf-aiven-serviceintegrationendpoint.json`
2. Implement your resource handlers in `tf_aiven_serviceintegrationendpoint/handlers.py`
