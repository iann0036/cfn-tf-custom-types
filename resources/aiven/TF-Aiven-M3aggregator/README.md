# TF::Aiven::M3aggregator

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aiven-m3aggregator.json`
2. Implement your resource handlers in `tf_aiven_m3aggregator/handlers.py`
