...
1. Write the JSON schema describing your resource, `tf-aiven-transitgatewayvpcattachment.json`
2. Implement your resource handlers in `tf_aiven_transitgatewayvpcattachment/handlers.py`
