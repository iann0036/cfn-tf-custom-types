...
1. Write the JSON schema describing your resource, `tf-aiven-accountauthentication.json`
2. Implement your resource handlers in `tf_aiven_accountauthentication/handlers.py`
