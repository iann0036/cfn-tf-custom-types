# TF::Aiven::KafkaSchemaConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aiven-kafkaschemaconfiguration.json`
2. Implement your resource handlers in `tf_aiven_kafkaschemaconfiguration/handlers.py`
