...
1. Write the JSON schema describing your resource, `tf-aiven-awsprivatelink.json`
2. Implement your resource handlers in `tf_aiven_awsprivatelink/handlers.py`
