...
1. Write the JSON schema describing your resource, `tf-aiven-connectionpool.json`
2. Implement your resource handlers in `tf_aiven_connectionpool/handlers.py`
