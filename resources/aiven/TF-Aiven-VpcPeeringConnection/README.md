...
1. Write the JSON schema describing your resource, `tf-aiven-vpcpeeringconnection.json`
2. Implement your resource handlers in `tf_aiven_vpcpeeringconnection/handlers.py`
