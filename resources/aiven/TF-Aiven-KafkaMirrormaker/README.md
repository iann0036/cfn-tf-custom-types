# TF::Aiven::KafkaMirrormaker

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aiven-kafkamirrormaker.json`
2. Implement your resource handlers in `tf_aiven_kafkamirrormaker/handlers.py`
