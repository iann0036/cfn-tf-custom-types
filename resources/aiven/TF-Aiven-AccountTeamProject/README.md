...
1. Write the JSON schema describing your resource, `tf-aiven-accountteamproject.json`
2. Implement your resource handlers in `tf_aiven_accountteamproject/handlers.py`
