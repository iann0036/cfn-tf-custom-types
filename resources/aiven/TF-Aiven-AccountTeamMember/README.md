# TF::Aiven::AccountTeamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aiven-accountteammember.json`
2. Implement your resource handlers in `tf_aiven_accountteammember/handlers.py`
