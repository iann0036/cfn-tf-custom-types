# TF::AH::PrivateNetwork

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ah-privatenetwork.json`
2. Implement your resource handlers in `tf_ah_privatenetwork/handlers.py`
