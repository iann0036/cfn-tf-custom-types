...
1. Write the JSON schema describing your resource, `tf-mso-schemasiteanpepgdomain.json`
2. Implement your resource handlers in `tf_mso_schemasiteanpepgdomain/handlers.py`
