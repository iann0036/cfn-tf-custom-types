# TF::MSO::SchemaSiteExternalEpgSelector

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schemasiteexternalepgselector.json`
2. Implement your resource handlers in `tf_mso_schemasiteexternalepgselector/handlers.py`
