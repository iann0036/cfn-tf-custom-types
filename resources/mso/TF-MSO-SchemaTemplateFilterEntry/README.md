...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatefilterentry.json`
2. Implement your resource handlers in `tf_mso_schematemplatefilterentry/handlers.py`
