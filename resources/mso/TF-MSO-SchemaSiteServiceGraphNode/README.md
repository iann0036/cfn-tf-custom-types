...
1. Write the JSON schema describing your resource, `tf-mso-schemasiteservicegraphnode.json`
2. Implement your resource handlers in `tf_mso_schemasiteservicegraphnode/handlers.py`
