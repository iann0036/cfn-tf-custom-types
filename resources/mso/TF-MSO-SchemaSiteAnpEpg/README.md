# TF::MSO::SchemaSiteAnpEpg

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schemasiteanpepg.json`
2. Implement your resource handlers in `tf_mso_schemasiteanpepg/handlers.py`
