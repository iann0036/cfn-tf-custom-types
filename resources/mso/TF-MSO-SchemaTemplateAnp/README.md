...
1. Write the JSON schema describing your resource, `tf-mso-schematemplateanp.json`
2. Implement your resource handlers in `tf_mso_schematemplateanp/handlers.py`
