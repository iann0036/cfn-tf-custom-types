...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatebd.json`
2. Implement your resource handlers in `tf_mso_schematemplatebd/handlers.py`
