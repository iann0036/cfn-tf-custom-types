...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatel3out.json`
2. Implement your resource handlers in `tf_mso_schematemplatel3out/handlers.py`
