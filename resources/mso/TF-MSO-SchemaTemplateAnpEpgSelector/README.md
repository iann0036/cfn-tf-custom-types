...
1. Write the JSON schema describing your resource, `tf-mso-schematemplateanpepgselector.json`
2. Implement your resource handlers in `tf_mso_schematemplateanpepgselector/handlers.py`
