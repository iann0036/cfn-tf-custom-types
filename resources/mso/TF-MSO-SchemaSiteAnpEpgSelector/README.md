# TF::MSO::SchemaSiteAnpEpgSelector

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schemasiteanpepgselector.json`
2. Implement your resource handlers in `tf_mso_schemasiteanpepgselector/handlers.py`
