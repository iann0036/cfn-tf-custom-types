...
1. Write the JSON schema describing your resource, `tf-mso-schemasitevrfregion.json`
2. Implement your resource handlers in `tf_mso_schemasitevrfregion/handlers.py`
