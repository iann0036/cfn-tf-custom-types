...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatecontractservicegraph.json`
2. Implement your resource handlers in `tf_mso_schematemplatecontractservicegraph/handlers.py`
