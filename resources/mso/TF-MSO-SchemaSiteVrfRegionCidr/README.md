# TF::MSO::SchemaSiteVrfRegionCidr

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schemasitevrfregioncidr.json`
2. Implement your resource handlers in `tf_mso_schemasitevrfregioncidr/handlers.py`
