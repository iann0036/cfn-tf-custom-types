# TF::MSO::SchemaTemplateVrfContract

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schematemplatevrfcontract.json`
2. Implement your resource handlers in `tf_mso_schematemplatevrfcontract/handlers.py`
