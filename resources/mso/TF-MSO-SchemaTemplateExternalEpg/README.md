...
1. Write the JSON schema describing your resource, `tf-mso-schematemplateexternalepg.json`
2. Implement your resource handlers in `tf_mso_schematemplateexternalepg/handlers.py`
