...
class ResourceModel(BaseModel):
    ...
    ApicSiteId: Optional[str]
    CloudProviders: Optional[Sequence[str]]
    Id: Optional[str]
    Labels: Optional[Sequence[str]]
    Location: Optional[Sequence["_LocationDefinition"]]
    LoginDomain: Optional[str]
