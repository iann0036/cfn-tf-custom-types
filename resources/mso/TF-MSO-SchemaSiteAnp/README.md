# TF::MSO::SchemaSiteAnp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schemasiteanp.json`
2. Implement your resource handlers in `tf_mso_schemasiteanp/handlers.py`
