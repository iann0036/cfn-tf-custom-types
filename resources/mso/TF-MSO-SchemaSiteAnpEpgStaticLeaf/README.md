...
1. Write the JSON schema describing your resource, `tf-mso-schemasiteanpepgstaticleaf.json`
2. Implement your resource handlers in `tf_mso_schemasiteanpepgstaticleaf/handlers.py`
