...
1. Write the JSON schema describing your resource, `tf-mso-schemasitebdsubnet.json`
2. Implement your resource handlers in `tf_mso_schemasitebdsubnet/handlers.py`
