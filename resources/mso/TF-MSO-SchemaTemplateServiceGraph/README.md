...
1. Write the JSON schema describing your resource, `tf-mso-schematemplateservicegraph.json`
2. Implement your resource handlers in `tf_mso_schematemplateservicegraph/handlers.py`
