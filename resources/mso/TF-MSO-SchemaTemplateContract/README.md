...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatecontract.json`
2. Implement your resource handlers in `tf_mso_schematemplatecontract/handlers.py`
