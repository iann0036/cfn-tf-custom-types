...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatedeploy.json`
2. Implement your resource handlers in `tf_mso_schematemplatedeploy/handlers.py`
