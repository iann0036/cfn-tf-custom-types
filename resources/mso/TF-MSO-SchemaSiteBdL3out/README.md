...
1. Write the JSON schema describing your resource, `tf-mso-schemasitebdl3out.json`
2. Implement your resource handlers in `tf_mso_schemasitebdl3out/handlers.py`
