...
1. Write the JSON schema describing your resource, `tf-mso-schematemplateanpepg.json`
2. Implement your resource handlers in `tf_mso_schematemplateanpepg/handlers.py`
