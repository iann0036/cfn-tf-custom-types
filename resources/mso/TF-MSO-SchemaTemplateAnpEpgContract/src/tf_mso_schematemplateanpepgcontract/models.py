...
class ResourceModel(BaseModel):
    ...
    ContractSchemaId: Optional[str]
    ContractTemplateName: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ContractSchemaId=json_data.get("ContractSchemaId"),
            ContractTemplateName=json_data.get("ContractTemplateName"),
