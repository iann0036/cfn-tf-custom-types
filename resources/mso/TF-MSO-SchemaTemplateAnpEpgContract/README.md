# TF::MSO::SchemaTemplateAnpEpgContract

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schematemplateanpepgcontract.json`
2. Implement your resource handlers in `tf_mso_schematemplateanpepgcontract/handlers.py`
