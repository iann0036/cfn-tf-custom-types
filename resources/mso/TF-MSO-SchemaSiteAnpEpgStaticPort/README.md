...
1. Write the JSON schema describing your resource, `tf-mso-schemasiteanpepgstaticport.json`
2. Implement your resource handlers in `tf_mso_schemasiteanpepgstaticport/handlers.py`
