# TF::MSO::SchemaTemplateExternalEpgContract

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schematemplateexternalepgcontract.json`
2. Implement your resource handlers in `tf_mso_schematemplateexternalepgcontract/handlers.py`
