...
1. Write the JSON schema describing your resource, `tf-mso-schematemplatevrf.json`
2. Implement your resource handlers in `tf_mso_schematemplatevrf/handlers.py`
