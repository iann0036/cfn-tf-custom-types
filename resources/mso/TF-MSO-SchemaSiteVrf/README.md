# TF::MSO::SchemaSiteVrf

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mso-schemasitevrf.json`
2. Implement your resource handlers in `tf_mso_schemasitevrf/handlers.py`
