...
1. Write the JSON schema describing your resource, `tf-mso-schematemplateanpepgusegattr.json`
2. Implement your resource handlers in `tf_mso_schematemplateanpepgusegattr/handlers.py`
