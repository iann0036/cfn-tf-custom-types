...
1. Write the JSON schema describing your resource, `terraform-packet-device.json`
2. Implement your resource handlers in `terraform_packet_device/handlers.py`
