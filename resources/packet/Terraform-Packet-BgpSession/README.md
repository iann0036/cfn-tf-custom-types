...
1. Write the JSON schema describing your resource, `terraform-packet-bgpsession.json`
2. Implement your resource handlers in `terraform_packet_bgpsession/handlers.py`
