...
1. Write the JSON schema describing your resource, `terraform-packet-organization.json`
2. Implement your resource handlers in `terraform_packet_organization/handlers.py`
