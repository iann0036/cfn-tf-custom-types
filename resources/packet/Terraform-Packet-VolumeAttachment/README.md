...
1. Write the JSON schema describing your resource, `terraform-packet-volumeattachment.json`
2. Implement your resource handlers in `terraform_packet_volumeattachment/handlers.py`
