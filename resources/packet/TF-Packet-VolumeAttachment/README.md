# TF::Packet::VolumeAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-packet-volumeattachment.json`
2. Implement your resource handlers in `tf_packet_volumeattachment/handlers.py`
