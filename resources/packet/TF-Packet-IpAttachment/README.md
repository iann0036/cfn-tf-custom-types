# TF::Packet::IpAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-packet-ipattachment.json`
2. Implement your resource handlers in `tf_packet_ipattachment/handlers.py`
