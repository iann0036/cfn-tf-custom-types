...
1. Write the JSON schema describing your resource, `terraform-packet-volume.json`
2. Implement your resource handlers in `terraform_packet_volume/handlers.py`
