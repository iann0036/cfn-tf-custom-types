# TF::Packet::PortVlanAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-packet-portvlanattachment.json`
2. Implement your resource handlers in `tf_packet_portvlanattachment/handlers.py`
