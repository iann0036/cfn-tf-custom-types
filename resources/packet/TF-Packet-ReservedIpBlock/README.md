...
1. Write the JSON schema describing your resource, `tf-packet-reservedipblock.json`
2. Implement your resource handlers in `tf_packet_reservedipblock/handlers.py`
