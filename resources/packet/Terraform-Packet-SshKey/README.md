...
1. Write the JSON schema describing your resource, `terraform-packet-sshkey.json`
2. Implement your resource handlers in `terraform_packet_sshkey/handlers.py`
