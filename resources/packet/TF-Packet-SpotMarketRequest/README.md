...
1. Write the JSON schema describing your resource, `tf-packet-spotmarketrequest.json`
2. Implement your resource handlers in `tf_packet_spotmarketrequest/handlers.py`
