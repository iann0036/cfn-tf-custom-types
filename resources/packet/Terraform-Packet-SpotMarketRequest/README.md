...
1. Write the JSON schema describing your resource, `terraform-packet-spotmarketrequest.json`
2. Implement your resource handlers in `terraform_packet_spotmarketrequest/handlers.py`
