...
1. Write the JSON schema describing your resource, `tf-packet-projectsshkey.json`
2. Implement your resource handlers in `tf_packet_projectsshkey/handlers.py`
