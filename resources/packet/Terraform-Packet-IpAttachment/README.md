...
1. Write the JSON schema describing your resource, `terraform-packet-ipattachment.json`
2. Implement your resource handlers in `terraform_packet_ipattachment/handlers.py`
