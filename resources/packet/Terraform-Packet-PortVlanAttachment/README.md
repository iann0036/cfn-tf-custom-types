...
1. Write the JSON schema describing your resource, `terraform-packet-portvlanattachment.json`
2. Implement your resource handlers in `terraform_packet_portvlanattachment/handlers.py`
