...
1. Write the JSON schema describing your resource, `tf-packet-devicenetworktype.json`
2. Implement your resource handlers in `tf_packet_devicenetworktype/handlers.py`
