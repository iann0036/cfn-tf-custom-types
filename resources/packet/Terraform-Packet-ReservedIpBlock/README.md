...
1. Write the JSON schema describing your resource, `terraform-packet-reservedipblock.json`
2. Implement your resource handlers in `terraform_packet_reservedipblock/handlers.py`
