...
1. Write the JSON schema describing your resource, `terraform-packet-project.json`
2. Implement your resource handlers in `terraform_packet_project/handlers.py`
