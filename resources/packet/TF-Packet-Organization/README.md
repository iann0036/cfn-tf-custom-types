# TF::Packet::Organization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-packet-organization.json`
2. Implement your resource handlers in `tf_packet_organization/handlers.py`
