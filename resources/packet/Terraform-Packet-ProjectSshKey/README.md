...
1. Write the JSON schema describing your resource, `terraform-packet-projectsshkey.json`
2. Implement your resource handlers in `terraform_packet_projectsshkey/handlers.py`
