# TF::Packet::BgpSession

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-packet-bgpsession.json`
2. Implement your resource handlers in `tf_packet_bgpsession/handlers.py`
