...
1. Write the JSON schema describing your resource, `tf-aci-cloudavailabilityzone.json`
2. Implement your resource handlers in `tf_aci_cloudavailabilityzone/handlers.py`
