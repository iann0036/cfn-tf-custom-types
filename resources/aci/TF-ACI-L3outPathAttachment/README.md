...
1. Write the JSON schema describing your resource, `tf-aci-l3outpathattachment.json`
2. Implement your resource handlers in `tf_aci_l3outpathattachment/handlers.py`
