...
1. Write the JSON schema describing your resource, `tf-aci-accesssubportblock.json`
2. Implement your resource handlers in `tf_aci_accesssubportblock/handlers.py`
