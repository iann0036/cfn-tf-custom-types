...
1. Write the JSON schema describing your resource, `tf-aci-cloudcontextprofile.json`
2. Implement your resource handlers in `tf_aci_cloudcontextprofile/handlers.py`
