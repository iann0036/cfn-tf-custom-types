...
1. Write the JSON schema describing your resource, `tf-aci-endpointsecuritygroupselector.json`
2. Implement your resource handlers in `tf_aci_endpointsecuritygroupselector/handlers.py`
