...
1. Write the JSON schema describing your resource, `tf-aci-cloudawsprovider.json`
2. Implement your resource handlers in `tf_aci_cloudawsprovider/handlers.py`
