...
1. Write the JSON schema describing your resource, `tf-aci-triggerscheduler.json`
2. Implement your resource handlers in `tf_aci_triggerscheduler/handlers.py`
