# TF::ACI::NodeBlockFirmware

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-nodeblockfirmware.json`
2. Implement your resource handlers in `tf_aci_nodeblockfirmware/handlers.py`
