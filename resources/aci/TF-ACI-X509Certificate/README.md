# TF::ACI::X509Certificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-x509certificate.json`
2. Implement your resource handlers in `tf_aci_x509certificate/handlers.py`
