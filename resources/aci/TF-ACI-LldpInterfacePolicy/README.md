...
1. Write the JSON schema describing your resource, `tf-aci-lldpinterfacepolicy.json`
2. Implement your resource handlers in `tf_aci_lldpinterfacepolicy/handlers.py`
