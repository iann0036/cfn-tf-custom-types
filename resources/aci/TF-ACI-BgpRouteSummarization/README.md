# TF::ACI::BgpRouteSummarization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-bgproutesummarization.json`
2. Implement your resource handlers in `tf_aci_bgproutesummarization/handlers.py`
