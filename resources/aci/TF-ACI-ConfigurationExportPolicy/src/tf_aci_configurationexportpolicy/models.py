...
class ResourceModel(BaseModel):
    ...
    Format: Optional[str]
    Id: Optional[str]
    IncludeSecureFields: Optional[str]
    MaxSnapshotCount: Optional[str]
    Name: Optional[str]
    NameAlias: Optional[str]
    RelationConfigRsExportDestination: Optional[str]
    RelationConfigRsExportScheduler: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            IncludeSecureFields=json_data.get("IncludeSecureFields"),
            MaxSnapshotCount=json_data.get("MaxSnapshotCount"),
            Name=json_data.get("Name"),
            NameAlias=json_data.get("NameAlias"),
            RelationConfigRsExportDestination=json_data.get("RelationConfigRsExportDestination"),
            RelationConfigRsExportScheduler=json_data.get("RelationConfigRsExportScheduler"),
