...
1. Write the JSON schema describing your resource, `tf-aci-configurationexportpolicy.json`
2. Implement your resource handlers in `tf_aci_configurationexportpolicy/handlers.py`
