...
1. Write the JSON schema describing your resource, `tf-aci-l3outhsrpinterfacegroup.json`
2. Implement your resource handlers in `tf_aci_l3outhsrpinterfacegroup/handlers.py`
