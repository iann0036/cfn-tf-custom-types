# TF::ACI::CdpInterfacePolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-cdpinterfacepolicy.json`
2. Implement your resource handlers in `tf_aci_cdpinterfacepolicy/handlers.py`
