...
1. Write the JSON schema describing your resource, `tf-aci-applicationprofile.json`
2. Implement your resource handlers in `tf_aci_applicationprofile/handlers.py`
