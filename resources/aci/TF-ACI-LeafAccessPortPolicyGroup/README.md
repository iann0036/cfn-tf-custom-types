...
1. Write the JSON schema describing your resource, `tf-aci-leafaccessportpolicygroup.json`
2. Implement your resource handlers in `tf_aci_leafaccessportpolicygroup/handlers.py`
