...
class ResourceModel(BaseModel):
    ...
    RelationL2extRsL2InstPToDomP: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            L2OutsideDn=json_data.get("L2OutsideDn"),
            ...
            RelationL2extRsL2InstPToDomP=json_data.get("RelationL2extRsL2InstPToDomP"),
