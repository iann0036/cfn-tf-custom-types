# TF::ACI::CloudApplicationcontainer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-cloudapplicationcontainer.json`
2. Implement your resource handlers in `tf_aci_cloudapplicationcontainer/handlers.py`
