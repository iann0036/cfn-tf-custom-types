# TF::ACI::PortSecurityPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-portsecuritypolicy.json`
2. Implement your resource handlers in `tf_aci_portsecuritypolicy/handlers.py`
