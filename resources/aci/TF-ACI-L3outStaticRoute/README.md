...
1. Write the JSON schema describing your resource, `tf-aci-l3outstaticroute.json`
2. Implement your resource handlers in `tf_aci_l3outstaticroute/handlers.py`
