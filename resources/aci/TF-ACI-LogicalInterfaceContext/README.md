...
1. Write the JSON schema describing your resource, `tf-aci-logicalinterfacecontext.json`
2. Implement your resource handlers in `tf_aci_logicalinterfacecontext/handlers.py`
