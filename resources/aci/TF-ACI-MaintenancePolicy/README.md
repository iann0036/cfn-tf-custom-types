...
1. Write the JSON schema describing your resource, `tf-aci-maintenancepolicy.json`
2. Implement your resource handlers in `tf_aci_maintenancepolicy/handlers.py`
