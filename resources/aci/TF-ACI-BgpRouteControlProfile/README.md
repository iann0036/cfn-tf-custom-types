# TF::ACI::BgpRouteControlProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-bgproutecontrolprofile.json`
2. Implement your resource handlers in `tf_aci_bgproutecontrolprofile/handlers.py`
