...
1. Write the JSON schema describing your resource, `tf-aci-staticnodemgmtaddress.json`
2. Implement your resource handlers in `tf_aci_staticnodemgmtaddress/handlers.py`
