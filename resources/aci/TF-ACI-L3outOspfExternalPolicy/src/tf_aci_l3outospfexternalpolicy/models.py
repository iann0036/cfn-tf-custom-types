...
class ResourceModel(BaseModel):
    ...
    AreaCost: Optional[str]
    AreaCtrl: Optional[str]
    AreaId: Optional[str]
    AreaType: Optional[str]
    Description: Optional[str]
    Id: Optional[str]
    L3OutsideDn: Optional[str]
    MultipodInternal: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AreaCost=json_data.get("AreaCost"),
            AreaCtrl=json_data.get("AreaCtrl"),
            AreaId=json_data.get("AreaId"),
            AreaType=json_data.get("AreaType"),
            Description=json_data.get("Description"),
            Id=json_data.get("Id"),
            L3OutsideDn=json_data.get("L3OutsideDn"),
            MultipodInternal=json_data.get("MultipodInternal"),
