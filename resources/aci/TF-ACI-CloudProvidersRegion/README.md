...
1. Write the JSON schema describing your resource, `tf-aci-cloudprovidersregion.json`
2. Implement your resource handlers in `tf_aci_cloudprovidersregion/handlers.py`
