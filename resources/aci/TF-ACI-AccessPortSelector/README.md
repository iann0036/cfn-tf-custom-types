...
1. Write the JSON schema describing your resource, `tf-aci-accessportselector.json`
2. Implement your resource handlers in `tf_aci_accessportselector/handlers.py`
