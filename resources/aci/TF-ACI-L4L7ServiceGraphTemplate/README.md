...
1. Write the JSON schema describing your resource, `tf-aci-l4l7servicegraphtemplate.json`
2. Implement your resource handlers in `tf_aci_l4l7servicegraphtemplate/handlers.py`
