...
1. Write the JSON schema describing your resource, `tf-aci-firmwaredownloadtask.json`
2. Implement your resource handlers in `tf_aci_firmwaredownloadtask/handlers.py`
