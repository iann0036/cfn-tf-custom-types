# TF::ACI::ActionRuleProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-actionruleprofile.json`
2. Implement your resource handlers in `tf_aci_actionruleprofile/handlers.py`
