...
1. Write the JSON schema describing your resource, `tf-aci-l2interfacepolicy.json`
2. Implement your resource handlers in `tf_aci_l2interfacepolicy/handlers.py`
