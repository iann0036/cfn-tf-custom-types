...
1. Write the JSON schema describing your resource, `tf-aci-endpointretentionpolicy.json`
2. Implement your resource handlers in `tf_aci_endpointretentionpolicy/handlers.py`
