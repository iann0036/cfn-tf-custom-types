...
1. Write the JSON schema describing your resource, `tf-aci-destinationofredirectedtraffic.json`
2. Implement your resource handlers in `tf_aci_destinationofredirectedtraffic/handlers.py`
