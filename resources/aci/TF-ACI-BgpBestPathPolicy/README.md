...
1. Write the JSON schema describing your resource, `tf-aci-bgpbestpathpolicy.json`
2. Implement your resource handlers in `tf_aci_bgpbestpathpolicy/handlers.py`
