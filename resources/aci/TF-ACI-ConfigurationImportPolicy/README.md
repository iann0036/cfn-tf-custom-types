...
1. Write the JSON schema describing your resource, `tf-aci-configurationimportpolicy.json`
2. Implement your resource handlers in `tf_aci_configurationimportpolicy/handlers.py`
