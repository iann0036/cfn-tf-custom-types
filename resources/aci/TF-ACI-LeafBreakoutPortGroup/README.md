...
1. Write the JSON schema describing your resource, `tf-aci-leafbreakoutportgroup.json`
2. Implement your resource handlers in `tf_aci_leafbreakoutportgroup/handlers.py`
