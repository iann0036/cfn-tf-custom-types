# TF::ACI::TabooContract

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-taboocontract.json`
2. Implement your resource handlers in `tf_aci_taboocontract/handlers.py`
