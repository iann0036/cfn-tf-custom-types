# TF::ACI::VlanEncapsulationforVxlanTraffic

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-vlanencapsulationforvxlantraffic.json`
2. Implement your resource handlers in `tf_aci_vlanencapsulationforvxlantraffic/handlers.py`
