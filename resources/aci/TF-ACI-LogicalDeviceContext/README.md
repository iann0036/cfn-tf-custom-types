...
1. Write the JSON schema describing your resource, `tf-aci-logicaldevicecontext.json`
2. Implement your resource handlers in `tf_aci_logicaldevicecontext/handlers.py`
