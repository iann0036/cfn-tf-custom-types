# TF::ACI::L3outOspfInterfaceProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-l3outospfinterfaceprofile.json`
2. Implement your resource handlers in `tf_aci_l3outospfinterfaceprofile/handlers.py`
