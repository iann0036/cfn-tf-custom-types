...
1. Write the JSON schema describing your resource, `tf-aci-attachableaccessentityprofile.json`
2. Implement your resource handlers in `tf_aci_attachableaccessentityprofile/handlers.py`
