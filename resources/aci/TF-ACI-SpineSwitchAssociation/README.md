...
1. Write the JSON schema describing your resource, `tf-aci-spineswitchassociation.json`
2. Implement your resource handlers in `tf_aci_spineswitchassociation/handlers.py`
