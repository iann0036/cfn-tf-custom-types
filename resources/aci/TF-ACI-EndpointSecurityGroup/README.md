...
1. Write the JSON schema describing your resource, `tf-aci-endpointsecuritygroup.json`
2. Implement your resource handlers in `tf_aci_endpointsecuritygroup/handlers.py`
