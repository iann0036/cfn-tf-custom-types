...
1. Write the JSON schema describing your resource, `tf-aci-logicalinterfaceprofile.json`
2. Implement your resource handlers in `tf_aci_logicalinterfaceprofile/handlers.py`
