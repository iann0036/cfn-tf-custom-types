...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    InterfaceProfileType: Optional[str]
    Key: Optional[str]
    KeyId: Optional[str]
    LogicalInterfaceProfileDn: Optional[str]
    NameAlias: Optional[str]
    RelationBfdRsIfPol: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            InterfaceProfileType=json_data.get("InterfaceProfileType"),
            ...
            RelationBfdRsIfPol=json_data.get("RelationBfdRsIfPol"),
        )
