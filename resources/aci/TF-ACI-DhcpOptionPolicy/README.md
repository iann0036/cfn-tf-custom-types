...
1. Write the JSON schema describing your resource, `tf-aci-dhcpoptionpolicy.json`
2. Implement your resource handlers in `tf_aci_dhcpoptionpolicy/handlers.py`
