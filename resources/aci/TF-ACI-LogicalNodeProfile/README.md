...
1. Write the JSON schema describing your resource, `tf-aci-logicalnodeprofile.json`
2. Implement your resource handlers in `tf_aci_logicalnodeprofile/handlers.py`
