...
class ResourceModel(BaseModel):
    ...
    RelationL2extRsEBd: Optional[str]
    RelationL2extRsL2DomAtt: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RelationL2extRsEBd=json_data.get("RelationL2extRsEBd"),
            RelationL2extRsL2DomAtt=json_data.get("RelationL2extRsL2DomAtt"),
