...
1. Write the JSON schema describing your resource, `tf-aci-bgpaddressfamilycontext.json`
2. Implement your resource handlers in `tf_aci_bgpaddressfamilycontext/handlers.py`
