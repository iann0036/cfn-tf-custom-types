...
1. Write the JSON schema describing your resource, `tf-aci-spansourcedestinationgroupmatchlabel.json`
2. Implement your resource handlers in `tf_aci_spansourcedestinationgroupmatchlabel/handlers.py`
