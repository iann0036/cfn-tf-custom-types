...
1. Write the JSON schema describing your resource, `tf-aci-ospfroutesummarization.json`
2. Implement your resource handlers in `tf_aci_ospfroutesummarization/handlers.py`
