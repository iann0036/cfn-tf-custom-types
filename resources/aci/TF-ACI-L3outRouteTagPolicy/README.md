...
1. Write the JSON schema describing your resource, `tf-aci-l3outroutetagpolicy.json`
2. Implement your resource handlers in `tf_aci_l3outroutetagpolicy/handlers.py`
