...
1. Write the JSON schema describing your resource, `tf-aci-podmaintenancegroup.json`
2. Implement your resource handlers in `tf_aci_podmaintenancegroup/handlers.py`
