...
1. Write the JSON schema describing your resource, `tf-aci-serviceredirectpolicy.json`
2. Implement your resource handlers in `tf_aci_serviceredirectpolicy/handlers.py`
