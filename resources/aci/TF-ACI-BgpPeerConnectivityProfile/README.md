...
1. Write the JSON schema describing your resource, `tf-aci-bgppeerconnectivityprofile.json`
2. Implement your resource handlers in `tf_aci_bgppeerconnectivityprofile/handlers.py`
