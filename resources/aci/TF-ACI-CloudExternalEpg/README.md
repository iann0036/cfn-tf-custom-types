...
1. Write the JSON schema describing your resource, `tf-aci-cloudexternalepg.json`
2. Implement your resource handlers in `tf_aci_cloudexternalepg/handlers.py`
