...
1. Write the JSON schema describing your resource, `tf-aci-spineportpolicygroup.json`
2. Implement your resource handlers in `tf_aci_spineportpolicygroup/handlers.py`
