# TF::ACI::L3outLoopbackInterfaceProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-l3outloopbackinterfaceprofile.json`
2. Implement your resource handlers in `tf_aci_l3outloopbackinterfaceprofile/handlers.py`
