...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    KaIntvl: Optional[str]
    MaxAsLimit: Optional[str]
    Name: Optional[str]
    NameAlias: Optional[str]
    StaleIntvl: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            KaIntvl=json_data.get("KaIntvl"),
            MaxAsLimit=json_data.get("MaxAsLimit"),
            Name=json_data.get("Name"),
            NameAlias=json_data.get("NameAlias"),
            StaleIntvl=json_data.get("StaleIntvl"),
