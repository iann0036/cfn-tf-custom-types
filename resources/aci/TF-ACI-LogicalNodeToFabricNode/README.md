...
1. Write the JSON schema describing your resource, `tf-aci-logicalnodetofabricnode.json`
2. Implement your resource handlers in `tf_aci_logicalnodetofabricnode/handlers.py`
