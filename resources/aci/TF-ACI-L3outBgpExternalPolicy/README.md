# TF::ACI::L3outBgpExternalPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-l3outbgpexternalpolicy.json`
2. Implement your resource handlers in `tf_aci_l3outbgpexternalpolicy/handlers.py`
