# TF::ACI::MonitoringPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-monitoringpolicy.json`
2. Implement your resource handlers in `tf_aci_monitoringpolicy/handlers.py`
