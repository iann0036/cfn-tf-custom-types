# TF::ACI::VpcExplicitProtectionGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aci-vpcexplicitprotectiongroup.json`
2. Implement your resource handlers in `tf_aci_vpcexplicitprotectiongroup/handlers.py`
