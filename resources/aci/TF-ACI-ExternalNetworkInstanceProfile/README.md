...
1. Write the JSON schema describing your resource, `tf-aci-externalnetworkinstanceprofile.json`
2. Implement your resource handlers in `tf_aci_externalnetworkinstanceprofile/handlers.py`
