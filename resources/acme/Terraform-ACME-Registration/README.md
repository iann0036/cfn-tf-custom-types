...
1. Write the JSON schema describing your resource, `terraform-acme-registration.json`
2. Implement your resource handlers in `terraform_acme_registration/handlers.py`
