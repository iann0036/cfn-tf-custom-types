...
1. Write the JSON schema describing your resource, `terraform-acme-certificate.json`
2. Implement your resource handlers in `terraform_acme_certificate/handlers.py`
