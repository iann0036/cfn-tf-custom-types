# TF::Grafana::BuiltinRoleAssignment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-grafana-builtinroleassignment.json`
2. Implement your resource handlers in `tf_grafana_builtinroleassignment/handlers.py`
