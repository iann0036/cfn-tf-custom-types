...
1. Write the JSON schema describing your resource, `terraform-grafana-organization.json`
2. Implement your resource handlers in `terraform_grafana_organization/handlers.py`
