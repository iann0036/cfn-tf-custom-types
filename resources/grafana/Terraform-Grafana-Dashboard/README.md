...
1. Write the JSON schema describing your resource, `terraform-grafana-dashboard.json`
2. Implement your resource handlers in `terraform_grafana_dashboard/handlers.py`
