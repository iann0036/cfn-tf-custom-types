...
1. Write the JSON schema describing your resource, `tf-grafana-alertnotification.json`
2. Implement your resource handlers in `tf_grafana_alertnotification/handlers.py`
