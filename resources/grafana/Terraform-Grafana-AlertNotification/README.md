...
1. Write the JSON schema describing your resource, `terraform-grafana-alertnotification.json`
2. Implement your resource handlers in `terraform_grafana_alertnotification/handlers.py`
