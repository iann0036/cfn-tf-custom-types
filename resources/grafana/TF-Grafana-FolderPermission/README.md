...
1. Write the JSON schema describing your resource, `tf-grafana-folderpermission.json`
2. Implement your resource handlers in `tf_grafana_folderpermission/handlers.py`
