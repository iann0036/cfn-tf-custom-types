...
1. Write the JSON schema describing your resource, `tf-grafana-organization.json`
2. Implement your resource handlers in `tf_grafana_organization/handlers.py`
