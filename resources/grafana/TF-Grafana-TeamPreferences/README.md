# TF::Grafana::TeamPreferences

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-grafana-teampreferences.json`
2. Implement your resource handlers in `tf_grafana_teampreferences/handlers.py`
