...
1. Write the JSON schema describing your resource, `terraform-grafana-datasource.json`
2. Implement your resource handlers in `terraform_grafana_datasource/handlers.py`
