...
1. Write the JSON schema describing your resource, `terraform-grafana-folder.json`
2. Implement your resource handlers in `terraform_grafana_folder/handlers.py`
