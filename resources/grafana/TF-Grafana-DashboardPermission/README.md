# TF::Grafana::DashboardPermission

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-grafana-dashboardpermission.json`
2. Implement your resource handlers in `tf_grafana_dashboardpermission/handlers.py`
