# TF::Skytap::LabelCategory

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-skytap-labelcategory.json`
2. Implement your resource handlers in `tf_skytap_labelcategory/handlers.py`
