...
1. Write the JSON schema describing your resource, `terraform-skytap-project.json`
2. Implement your resource handlers in `terraform_skytap_project/handlers.py`
