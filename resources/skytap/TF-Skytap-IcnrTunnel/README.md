# TF::Skytap::IcnrTunnel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-skytap-icnrtunnel.json`
2. Implement your resource handlers in `tf_skytap_icnrtunnel/handlers.py`
