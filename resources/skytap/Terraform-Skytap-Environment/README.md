...
1. Write the JSON schema describing your resource, `terraform-skytap-environment.json`
2. Implement your resource handlers in `terraform_skytap_environment/handlers.py`
