...
1. Write the JSON schema describing your resource, `terraform-skytap-network.json`
2. Implement your resource handlers in `terraform_skytap_network/handlers.py`
