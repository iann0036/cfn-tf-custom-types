...
1. Write the JSON schema describing your resource, `terraform-skytap-icnrtunnel.json`
2. Implement your resource handlers in `terraform_skytap_icnrtunnel/handlers.py`
