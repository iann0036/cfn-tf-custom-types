...
1. Write the JSON schema describing your resource, `terraform-skytap-labelcategory.json`
2. Implement your resource handlers in `terraform_skytap_labelcategory/handlers.py`
