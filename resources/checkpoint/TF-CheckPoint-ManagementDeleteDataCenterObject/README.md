# TF::CheckPoint::ManagementDeleteDataCenterObject

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementdeletedatacenterobject.json`
2. Implement your resource handlers in `tf_checkpoint_managementdeletedatacenterobject/handlers.py`
