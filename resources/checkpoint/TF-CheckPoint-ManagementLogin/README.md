...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementlogin.json`
2. Implement your resource handlers in `tf_checkpoint_managementlogin/handlers.py`
