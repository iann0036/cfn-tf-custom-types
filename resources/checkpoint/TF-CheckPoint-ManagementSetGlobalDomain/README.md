# TF::CheckPoint::ManagementSetGlobalDomain

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementsetglobaldomain.json`
2. Implement your resource handlers in `tf_checkpoint_managementsetglobaldomain/handlers.py`
