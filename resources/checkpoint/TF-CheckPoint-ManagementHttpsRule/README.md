...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementhttpsrule.json`
2. Implement your resource handlers in `tf_checkpoint_managementhttpsrule/handlers.py`
