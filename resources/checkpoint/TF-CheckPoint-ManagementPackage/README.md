...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementpackage.json`
2. Implement your resource handlers in `tf_checkpoint_managementpackage/handlers.py`
