...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementadddatacenterobject.json`
2. Implement your resource handlers in `tf_checkpoint_managementadddatacenterobject/handlers.py`
