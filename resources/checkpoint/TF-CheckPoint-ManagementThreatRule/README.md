...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementthreatrule.json`
2. Implement your resource handlers in `tf_checkpoint_managementthreatrule/handlers.py`
