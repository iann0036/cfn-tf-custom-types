...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementvpncommunitystar.json`
2. Implement your resource handlers in `tf_checkpoint_managementvpncommunitystar/handlers.py`
