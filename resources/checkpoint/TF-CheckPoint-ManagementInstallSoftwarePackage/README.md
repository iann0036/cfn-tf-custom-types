...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementinstallsoftwarepackage.json`
2. Implement your resource handlers in `tf_checkpoint_managementinstallsoftwarepackage/handlers.py`
