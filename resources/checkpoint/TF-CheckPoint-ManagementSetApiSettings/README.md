...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementsetapisettings.json`
2. Implement your resource handlers in `tf_checkpoint_managementsetapisettings/handlers.py`
