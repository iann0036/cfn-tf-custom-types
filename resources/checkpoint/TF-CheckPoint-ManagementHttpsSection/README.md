# TF::CheckPoint::ManagementHttpsSection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementhttpssection.json`
2. Implement your resource handlers in `tf_checkpoint_managementhttpssection/handlers.py`
