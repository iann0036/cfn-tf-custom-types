...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementbackupdomain.json`
2. Implement your resource handlers in `tf_checkpoint_managementbackupdomain/handlers.py`
