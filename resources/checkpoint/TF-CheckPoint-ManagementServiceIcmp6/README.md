...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementserviceicmp6.json`
2. Implement your resource handlers in `tf_checkpoint_managementserviceicmp6/handlers.py`
