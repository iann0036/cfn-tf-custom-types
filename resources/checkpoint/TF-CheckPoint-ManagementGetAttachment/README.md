# TF::CheckPoint::ManagementGetAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementgetattachment.json`
2. Implement your resource handlers in `tf_checkpoint_managementgetattachment/handlers.py`
