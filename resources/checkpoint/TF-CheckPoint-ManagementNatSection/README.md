...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementnatsection.json`
2. Implement your resource handlers in `tf_checkpoint_managementnatsection/handlers.py`
