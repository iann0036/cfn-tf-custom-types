...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementthreatindicator.json`
2. Implement your resource handlers in `tf_checkpoint_managementthreatindicator/handlers.py`
