# TF::CheckPoint::ManagementVpnCommunityMeshed

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementvpncommunitymeshed.json`
2. Implement your resource handlers in `tf_checkpoint_managementvpncommunitymeshed/handlers.py`
