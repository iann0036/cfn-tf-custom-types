...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementmigrateexportdomain.json`
2. Implement your resource handlers in `tf_checkpoint_managementmigrateexportdomain/handlers.py`
