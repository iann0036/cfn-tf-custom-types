# TF::CheckPoint::ManagementGroupWithExclusion

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementgroupwithexclusion.json`
2. Implement your resource handlers in `tf_checkpoint_managementgroupwithexclusion/handlers.py`
