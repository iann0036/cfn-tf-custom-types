# TF::CheckPoint::ManagementVerifyRevert

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementverifyrevert.json`
2. Implement your resource handlers in `tf_checkpoint_managementverifyrevert/handlers.py`
