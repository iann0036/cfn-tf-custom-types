...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementgsnhandovergroup.json`
2. Implement your resource handlers in `tf_checkpoint_managementgsnhandovergroup/handlers.py`
