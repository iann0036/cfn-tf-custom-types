# TF::CheckPoint::ManagementIdentityTag

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementidentitytag.json`
2. Implement your resource handlers in `tf_checkpoint_managementidentitytag/handlers.py`
