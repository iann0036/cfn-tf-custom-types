...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementhttpslayer.json`
2. Implement your resource handlers in `tf_checkpoint_managementhttpslayer/handlers.py`
