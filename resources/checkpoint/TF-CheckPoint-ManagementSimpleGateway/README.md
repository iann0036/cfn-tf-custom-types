...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementsimplegateway.json`
2. Implement your resource handlers in `tf_checkpoint_managementsimplegateway/handlers.py`
