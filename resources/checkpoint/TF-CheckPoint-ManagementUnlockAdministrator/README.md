# TF::CheckPoint::ManagementUnlockAdministrator

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementunlockadministrator.json`
2. Implement your resource handlers in `tf_checkpoint_managementunlockadministrator/handlers.py`
