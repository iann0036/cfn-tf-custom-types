# TF::CheckPoint::ManagementDisconnect

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementdisconnect.json`
2. Implement your resource handlers in `tf_checkpoint_managementdisconnect/handlers.py`
