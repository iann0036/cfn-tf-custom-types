...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementaddapikey.json`
2. Implement your resource handlers in `tf_checkpoint_managementaddapikey/handlers.py`
