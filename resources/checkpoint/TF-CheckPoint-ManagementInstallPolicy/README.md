...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementinstallpolicy.json`
2. Implement your resource handlers in `tf_checkpoint_managementinstallpolicy/handlers.py`
