...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementexceptiongroup.json`
2. Implement your resource handlers in `tf_checkpoint_managementexceptiongroup/handlers.py`
