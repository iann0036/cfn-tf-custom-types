# TF::CheckPoint::ManagementThreatException

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementthreatexception.json`
2. Implement your resource handlers in `tf_checkpoint_managementthreatexception/handlers.py`
