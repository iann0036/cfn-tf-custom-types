...
class ResourceModel(BaseModel):
    ...
    ExceptionGroupName: Optional[str]
    ExceptionGroupUid: Optional[str]
    Id: Optional[str]
    ...
    ProtectionOrSite: Optional[Sequence[str]]
    RuleName: Optional[str]
    RuleUid: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ExceptionGroupName=json_data.get("ExceptionGroupName"),
            ExceptionGroupUid=json_data.get("ExceptionGroupUid"),
            Id=json_data.get("Id"),
            ...
            ProtectionOrSite=json_data.get("ProtectionOrSite"),
            RuleName=json_data.get("RuleName"),
            RuleUid=json_data.get("RuleUid"),
