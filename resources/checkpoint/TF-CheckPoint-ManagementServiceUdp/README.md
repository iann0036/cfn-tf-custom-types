...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementserviceudp.json`
2. Implement your resource handlers in `tf_checkpoint_managementserviceudp/handlers.py`
