...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementaccessrole.json`
2. Implement your resource handlers in `tf_checkpoint_managementaccessrole/handlers.py`
