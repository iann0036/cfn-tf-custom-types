...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementthreatprofile.json`
2. Implement your resource handlers in `tf_checkpoint_managementthreatprofile/handlers.py`
