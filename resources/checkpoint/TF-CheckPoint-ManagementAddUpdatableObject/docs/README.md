...
<pre>
{
    "Type" : "TF::CheckPoint::ManagementAddUpdatableObject",
    "Properties" : {
        ...
        "<a href="#uidinupdatableobjectsrepository" title="UidInUpdatableObjectsRepository">UidInUpdatableObjectsRepository</a>" : <i>String</i>,
