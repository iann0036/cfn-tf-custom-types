# TF::CheckPoint::ManagementAddUpdatableObject

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementaddupdatableobject.json`
2. Implement your resource handlers in `tf_checkpoint_managementaddupdatableobject/handlers.py`
