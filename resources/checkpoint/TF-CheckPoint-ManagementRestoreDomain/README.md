...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementrestoredomain.json`
2. Implement your resource handlers in `tf_checkpoint_managementrestoredomain/handlers.py`
