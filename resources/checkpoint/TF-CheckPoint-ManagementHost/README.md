...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementhost.json`
2. Implement your resource handlers in `tf_checkpoint_managementhost/handlers.py`
