# TF::CheckPoint::ManagementApplicationSite

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementapplicationsite.json`
2. Implement your resource handlers in `tf_checkpoint_managementapplicationsite/handlers.py`
