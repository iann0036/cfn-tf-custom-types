...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementwhereused.json`
2. Implement your resource handlers in `tf_checkpoint_managementwhereused/handlers.py`
