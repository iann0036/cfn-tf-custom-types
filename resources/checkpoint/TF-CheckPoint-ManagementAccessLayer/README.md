...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementaccesslayer.json`
2. Implement your resource handlers in `tf_checkpoint_managementaccesslayer/handlers.py`
