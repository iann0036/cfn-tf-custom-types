...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementnatrule.json`
2. Implement your resource handlers in `tf_checkpoint_managementnatrule/handlers.py`
