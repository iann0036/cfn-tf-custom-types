...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementaccessrule.json`
2. Implement your resource handlers in `tf_checkpoint_managementaccessrule/handlers.py`
