...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementcheckpointhost.json`
2. Implement your resource handlers in `tf_checkpoint_managementcheckpointhost/handlers.py`
