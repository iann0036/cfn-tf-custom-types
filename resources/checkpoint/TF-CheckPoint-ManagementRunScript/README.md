...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementrunscript.json`
2. Implement your resource handlers in `tf_checkpoint_managementrunscript/handlers.py`
