...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementservicesctp.json`
2. Implement your resource handlers in `tf_checkpoint_managementservicesctp/handlers.py`
