# TF::CheckPoint::ManagementUpdateUpdatableObjectsRepositoryContent

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementupdateupdatableobjectsrepositorycontent.json`
2. Implement your resource handlers in `tf_checkpoint_managementupdateupdatableobjectsrepositorycontent/handlers.py`
