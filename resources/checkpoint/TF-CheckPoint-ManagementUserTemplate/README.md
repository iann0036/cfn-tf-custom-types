# TF::CheckPoint::ManagementUserTemplate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementusertemplate.json`
2. Implement your resource handlers in `tf_checkpoint_managementusertemplate/handlers.py`
