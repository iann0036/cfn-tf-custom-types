# TF::CheckPoint::ManagementDeleteUpdatableObject

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementdeleteupdatableobject.json`
2. Implement your resource handlers in `tf_checkpoint_managementdeleteupdatableobject/handlers.py`
