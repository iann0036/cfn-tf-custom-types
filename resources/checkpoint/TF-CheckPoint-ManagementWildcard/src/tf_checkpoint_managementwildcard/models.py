...
class ResourceModel(BaseModel):
    ...
    Ipv4MaskWildcard: Optional[str]
    Ipv6Address: Optional[str]
    Ipv6MaskWildcard: Optional[str]
    Name: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Ipv4MaskWildcard=json_data.get("Ipv4MaskWildcard"),
            Ipv6Address=json_data.get("Ipv6Address"),
            Ipv6MaskWildcard=json_data.get("Ipv6MaskWildcard"),
