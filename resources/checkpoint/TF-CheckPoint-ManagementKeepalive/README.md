# TF::CheckPoint::ManagementKeepalive

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementkeepalive.json`
2. Implement your resource handlers in `tf_checkpoint_managementkeepalive/handlers.py`
