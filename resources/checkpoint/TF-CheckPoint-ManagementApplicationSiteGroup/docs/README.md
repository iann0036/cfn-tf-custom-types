...
<pre>
{
    "Type" : "TF::CheckPoint::ManagementApplicationSiteGroup",
    "Properties" : {
...
Collection of application and URL filtering objects identified by the name or UID.members blocks are documented below.
