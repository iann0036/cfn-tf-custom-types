# TF::CheckPoint::ManagementGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementgroup.json`
2. Implement your resource handlers in `tf_checkpoint_managementgroup/handlers.py`
