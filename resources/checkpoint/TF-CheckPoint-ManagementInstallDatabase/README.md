...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementinstalldatabase.json`
2. Implement your resource handlers in `tf_checkpoint_managementinstalldatabase/handlers.py`
