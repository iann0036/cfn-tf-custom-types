...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementsetautomaticpurge.json`
2. Implement your resource handlers in `tf_checkpoint_managementsetautomaticpurge/handlers.py`
