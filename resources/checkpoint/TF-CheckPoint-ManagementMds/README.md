...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementmds.json`
2. Implement your resource handlers in `tf_checkpoint_managementmds/handlers.py`
