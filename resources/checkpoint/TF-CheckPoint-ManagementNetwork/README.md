...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementnetwork.json`
2. Implement your resource handlers in `tf_checkpoint_managementnetwork/handlers.py`
