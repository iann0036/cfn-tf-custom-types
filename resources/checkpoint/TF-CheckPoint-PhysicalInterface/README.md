...
1. Write the JSON schema describing your resource, `tf-checkpoint-physicalinterface.json`
2. Implement your resource handlers in `tf_checkpoint_physicalinterface/handlers.py`
