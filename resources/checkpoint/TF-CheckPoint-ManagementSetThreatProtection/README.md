...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementsetthreatprotection.json`
2. Implement your resource handlers in `tf_checkpoint_managementsetthreatprotection/handlers.py`
