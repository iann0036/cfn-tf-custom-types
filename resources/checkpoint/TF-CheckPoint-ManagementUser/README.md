...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementuser.json`
2. Implement your resource handlers in `tf_checkpoint_managementuser/handlers.py`
