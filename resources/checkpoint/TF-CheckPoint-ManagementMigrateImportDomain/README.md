...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementmigrateimportdomain.json`
2. Implement your resource handlers in `tf_checkpoint_managementmigrateimportdomain/handlers.py`
