...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementexport.json`
2. Implement your resource handlers in `tf_checkpoint_managementexport/handlers.py`
