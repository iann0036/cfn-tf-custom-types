# TF::CheckPoint::ManagementLogout

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementlogout.json`
2. Implement your resource handlers in `tf_checkpoint_managementlogout/handlers.py`
