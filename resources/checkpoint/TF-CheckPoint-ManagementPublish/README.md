...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementpublish.json`
2. Implement your resource handlers in `tf_checkpoint_managementpublish/handlers.py`
