# TF::CheckPoint::ManagementMulticastAddressRange

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-checkpoint-managementmulticastaddressrange.json`
2. Implement your resource handlers in `tf_checkpoint_managementmulticastaddressrange/handlers.py`
