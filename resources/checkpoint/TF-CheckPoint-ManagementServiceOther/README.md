...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementserviceother.json`
2. Implement your resource handlers in `tf_checkpoint_managementserviceother/handlers.py`
