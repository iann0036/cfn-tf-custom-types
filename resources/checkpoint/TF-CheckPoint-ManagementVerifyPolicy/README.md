...
1. Write the JSON schema describing your resource, `tf-checkpoint-managementverifypolicy.json`
2. Implement your resource handlers in `tf_checkpoint_managementverifypolicy/handlers.py`
