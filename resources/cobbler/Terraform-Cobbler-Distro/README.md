...
1. Write the JSON schema describing your resource, `terraform-cobbler-distro.json`
2. Implement your resource handlers in `terraform_cobbler_distro/handlers.py`
