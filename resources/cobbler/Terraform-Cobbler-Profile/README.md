...
1. Write the JSON schema describing your resource, `terraform-cobbler-profile.json`
2. Implement your resource handlers in `terraform_cobbler_profile/handlers.py`
