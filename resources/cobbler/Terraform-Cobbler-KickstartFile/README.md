...
1. Write the JSON schema describing your resource, `terraform-cobbler-kickstartfile.json`
2. Implement your resource handlers in `terraform_cobbler_kickstartfile/handlers.py`
