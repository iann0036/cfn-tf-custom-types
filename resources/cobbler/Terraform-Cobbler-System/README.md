...
1. Write the JSON schema describing your resource, `terraform-cobbler-system.json`
2. Implement your resource handlers in `terraform_cobbler_system/handlers.py`
