...
1. Write the JSON schema describing your resource, `tf-prismacloud-rqlsearch.json`
2. Implement your resource handlers in `tf_prismacloud_rqlsearch/handlers.py`
