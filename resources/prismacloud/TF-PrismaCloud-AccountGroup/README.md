# TF::PrismaCloud::AccountGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-prismacloud-accountgroup.json`
2. Implement your resource handlers in `tf_prismacloud_accountgroup/handlers.py`
