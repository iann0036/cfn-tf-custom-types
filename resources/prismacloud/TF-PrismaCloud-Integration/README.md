...
1. Write the JSON schema describing your resource, `tf-prismacloud-integration.json`
2. Implement your resource handlers in `tf_prismacloud_integration/handlers.py`
