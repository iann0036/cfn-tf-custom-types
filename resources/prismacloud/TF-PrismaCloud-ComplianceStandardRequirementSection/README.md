...
1. Write the JSON schema describing your resource, `tf-prismacloud-compliancestandardrequirementsection.json`
2. Implement your resource handlers in `tf_prismacloud_compliancestandardrequirementsection/handlers.py`
