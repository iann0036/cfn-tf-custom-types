...
1. Write the JSON schema describing your resource, `tf-prismacloud-compliancestandard.json`
2. Implement your resource handlers in `tf_prismacloud_compliancestandard/handlers.py`
