...
1. Write the JSON schema describing your resource, `tf-prismacloud-alertrule.json`
2. Implement your resource handlers in `tf_prismacloud_alertrule/handlers.py`
