...
1. Write the JSON schema describing your resource, `tf-prismacloud-userrole.json`
2. Implement your resource handlers in `tf_prismacloud_userrole/handlers.py`
