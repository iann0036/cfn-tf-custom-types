...
1. Write the JSON schema describing your resource, `tf-prismacloud-compliancestandardrequirement.json`
2. Implement your resource handlers in `tf_prismacloud_compliancestandardrequirement/handlers.py`
