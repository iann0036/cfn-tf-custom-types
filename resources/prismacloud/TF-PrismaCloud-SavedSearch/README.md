...
1. Write the JSON schema describing your resource, `tf-prismacloud-savedsearch.json`
2. Implement your resource handlers in `tf_prismacloud_savedsearch/handlers.py`
