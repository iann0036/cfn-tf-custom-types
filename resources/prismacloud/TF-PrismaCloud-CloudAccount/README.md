...
1. Write the JSON schema describing your resource, `tf-prismacloud-cloudaccount.json`
2. Implement your resource handlers in `tf_prismacloud_cloudaccount/handlers.py`
