...
1. Write the JSON schema describing your resource, `tf-prismacloud-enterprisesettings.json`
2. Implement your resource handlers in `tf_prismacloud_enterprisesettings/handlers.py`
