# TF::HCS::ClusterRootToken

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-hcs-clusterroottoken.json`
2. Implement your resource handlers in `tf_hcs_clusterroottoken/handlers.py`
