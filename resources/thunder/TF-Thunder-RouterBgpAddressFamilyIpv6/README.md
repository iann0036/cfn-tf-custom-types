...
1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6/handlers.py`
