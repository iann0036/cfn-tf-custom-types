...
1. Write the JSON schema describing your resource, `tf-thunder-slbcommonconnratelimitsrcip.json`
2. Implement your resource handlers in `tf_thunder_slbcommonconnratelimitsrcip/handlers.py`
