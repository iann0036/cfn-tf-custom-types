# TF::Thunder::SnmpServerEnableTrapsRoutingBgp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsroutingbgp.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsroutingbgp/handlers.py`
