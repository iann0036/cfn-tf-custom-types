...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapssystem.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapssystem/handlers.py`
