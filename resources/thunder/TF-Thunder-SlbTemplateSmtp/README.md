...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatesmtp.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatesmtp/handlers.py`
