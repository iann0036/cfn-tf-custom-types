...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatesmpp.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatesmpp/handlers.py`
