# TF::Thunder::RouterBgpAddressFamilyIpv6NeighborTrunkNeighborIpv6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6neighbortrunkneighboripv6.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6neighbortrunkneighboripv6/handlers.py`
