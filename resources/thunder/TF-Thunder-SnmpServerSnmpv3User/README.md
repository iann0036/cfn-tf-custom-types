...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserversnmpv3user.json`
2. Implement your resource handlers in `tf_thunder_snmpserversnmpv3user/handlers.py`
