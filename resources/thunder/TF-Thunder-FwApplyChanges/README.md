# TF::Thunder::FwApplyChanges

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-fwapplychanges.json`
2. Implement your resource handlers in `tf_thunder_fwapplychanges/handlers.py`
