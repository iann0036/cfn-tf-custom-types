...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsroutingisis.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsroutingisis/handlers.py`
