...
1. Write the JSON schema describing your resource, `tf-thunder-interfacemanagement.json`
2. Implement your resource handlers in `tf_thunder_interfacemanagement/handlers.py`
