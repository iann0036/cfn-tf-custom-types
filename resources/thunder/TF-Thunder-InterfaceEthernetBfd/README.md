...
1. Write the JSON schema describing your resource, `tf-thunder-interfaceethernetbfd.json`
2. Implement your resource handlers in `tf_thunder_interfaceethernetbfd/handlers.py`
