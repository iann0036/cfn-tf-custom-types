...
1. Write the JSON schema describing your resource, `tf-thunder-interfaceveipv6.json`
2. Implement your resource handlers in `tf_thunder_interfaceveipv6/handlers.py`
