...
1. Write the JSON schema describing your resource, `tf-thunder-ipprefixlist.json`
2. Implement your resource handlers in `tf_thunder_ipprefixlist/handlers.py`
