...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverslbdatacachetimeout.json`
2. Implement your resource handlers in `tf_thunder_snmpserverslbdatacachetimeout/handlers.py`
