...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsroutingospf.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsroutingospf/handlers.py`
