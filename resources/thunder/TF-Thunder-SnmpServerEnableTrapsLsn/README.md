...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapslsn.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapslsn/handlers.py`
