...
1. Write the JSON schema describing your resource, `tf-thunder-interfaceveip.json`
2. Implement your resource handlers in `tf_thunder_interfaceveip/handlers.py`
