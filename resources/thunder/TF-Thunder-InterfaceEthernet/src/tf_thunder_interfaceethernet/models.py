...
class ResourceModel(BaseModel):
    ...
    Action: Optional[str]
    AutoNegEnable: Optional[float]
    CpuProcess: Optional[float]
    CpuProcessDir: Optional[str]
    Duplexity: Optional[str]
    FecForcedOff: Optional[float]
    FecForcedOn: Optional[float]
    FlowControl: Optional[float]
    Id: Optional[str]
    Ifnum: Optional[float]
    L3VlanFwdDisable: Optional[float]
    LoadInterval: Optional[float]
    MediaTypeCopper: Optional[float]
    Mtu: Optional[float]
    Name: Optional[str]
    RemoveVlanTag: Optional[float]
    Speed: Optional[str]
    SpeedForced40g: Optional[float]
    TrafficDistributionMode: Optional[str]
    ...
    MonitorList: Optional[Sequence["_MonitorListDefinition"]]
    Nptv6: Optional[Sequence["_Nptv6Definition"]]
    SamplingEnable: Optional[Sequence["_SamplingEnableDefinition"]]
    TrunkGroupList: Optional[Sequence["_TrunkGroupListDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AutoNegEnable=json_data.get("AutoNegEnable"),
            CpuProcess=json_data.get("CpuProcess"),
            CpuProcessDir=json_data.get("CpuProcessDir"),
            Duplexity=json_data.get("Duplexity"),
            FecForcedOff=json_data.get("FecForcedOff"),
            FecForcedOn=json_data.get("FecForcedOn"),
            ...
            MediaTypeCopper=json_data.get("MediaTypeCopper"),
            Mtu=json_data.get("Mtu"),
            Name=json_data.get("Name"),
            RemoveVlanTag=json_data.get("RemoveVlanTag"),
            Speed=json_data.get("Speed"),
            SpeedForced40g=json_data.get("SpeedForced40g"),
            TrafficDistributionMode=json_data.get("TrafficDistributionMode"),
            ...
            MonitorList=deserialize_list(json_data.get("MonitorList"), MonitorListDefinition),
            ...
            TrunkGroupList=deserialize_list(json_data.get("TrunkGroupList"), TrunkGroupListDefinition),
        )
...
class IpDefinition(BaseModel):
    ...
    CacheSpoofingPort: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CacheSpoofingPort=json_data.get("CacheSpoofingPort"),
...
class Ipv6Definition(BaseModel):
    ...
    TtlIgnore: Optional[float]
    Uuid: Optional[str]
    AccessListCfg: Optional[Sequence["_AccessListCfgDefinition"]]
    AddressList: Optional[Sequence["_AddressListDefinition"]]
    Ospf: Optional[Sequence["_OspfDefinition"]]
    Rip: Optional[Sequence["_RipDefinition"]]
    Router: Optional[Sequence["_RouterDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            TtlIgnore=json_data.get("TtlIgnore"),
            Uuid=json_data.get("Uuid"),
            AccessListCfg=deserialize_list(json_data.get("AccessListCfg"), AccessListCfgDefinition),
            AddressList=deserialize_list(json_data.get("AddressList"), AddressListDefinition),
            Ospf=deserialize_list(json_data.get("Ospf"), OspfDefinition),
            Rip=deserialize_list(json_data.get("Rip"), RipDefinition),
            Router=deserialize_list(json_data.get("Router"), RouterDefinition),
...
@dataclass
class AccessListCfgDefinition(BaseModel):
    Inbound: Optional[float]
    V6AclName: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AccessListCfgDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AccessListCfgDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AccessListCfgDefinition = AccessListCfgDefinition
...
@dataclass
class MonitorListDefinition(BaseModel):
    MirrorIndex: Optional[float]
    Monitor: Optional[str]
    MonitorVlan: Optional[float]

    @classmethod
    def _deserialize(
        cls: Type["_MonitorListDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MonitorListDefinition"]:
        if not json_data:
            return None
        return cls(
            MirrorIndex=json_data.get("MirrorIndex"),
            Monitor=json_data.get("Monitor"),
            MonitorVlan=json_data.get("MonitorVlan"),
        )


# work around possible type aliasing issues when variable has same name as a model
_MonitorListDefinition = MonitorListDefinition
...
@dataclass
class TrunkGroupListDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_TrunkGroupListDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_TrunkGroupListDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_TrunkGroupListDefinition = TrunkGroupListDefinition
