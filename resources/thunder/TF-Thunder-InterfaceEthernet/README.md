...
1. Write the JSON schema describing your resource, `tf-thunder-interfaceethernet.json`
2. Implement your resource handlers in `tf_thunder_interfaceethernet/handlers.py`
