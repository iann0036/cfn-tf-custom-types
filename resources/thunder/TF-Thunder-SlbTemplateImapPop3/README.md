...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateimappop3.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateimappop3/handlers.py`
