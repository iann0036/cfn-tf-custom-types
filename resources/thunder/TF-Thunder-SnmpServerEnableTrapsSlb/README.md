...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsslb.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsslb/handlers.py`
