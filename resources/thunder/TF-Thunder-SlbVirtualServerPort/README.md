...
1. Write the JSON schema describing your resource, `tf-thunder-slbvirtualserverport.json`
2. Implement your resource handlers in `tf_thunder_slbvirtualserverport/handlers.py`
