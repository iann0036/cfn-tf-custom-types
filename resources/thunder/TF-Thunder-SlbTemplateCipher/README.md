# TF::Thunder::SlbTemplateCipher

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatecipher.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatecipher/handlers.py`
