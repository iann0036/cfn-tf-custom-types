# TF::Thunder::SlbIcapHttp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbicaphttp.json`
2. Implement your resource handlers in `tf_thunder_slbicaphttp/handlers.py`
