...
1. Write the JSON schema describing your resource, `tf-thunder-snmpservercommunityread.json`
2. Implement your resource handlers in `tf_thunder_snmpservercommunityread/handlers.py`
