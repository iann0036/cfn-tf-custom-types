# TF::Thunder::IpDnsPrimary

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-ipdnsprimary.json`
2. Implement your resource handlers in `tf_thunder_ipdnsprimary/handlers.py`
