...
1. Write the JSON schema describing your resource, `tf-thunder-overlaytunneloptions.json`
2. Implement your resource handlers in `tf_thunder_overlaytunneloptions/handlers.py`
