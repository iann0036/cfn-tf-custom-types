...
1. Write the JSON schema describing your resource, `tf-thunder-routerospfredistribute.json`
2. Implement your resource handlers in `tf_thunder_routerospfredistribute/handlers.py`
