# TF::Thunder::RouterBgpAddressFamilyIpv6NeighborPeerGroupNeighbor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6neighborpeergroupneighbor.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6neighborpeergroupneighbor/handlers.py`
