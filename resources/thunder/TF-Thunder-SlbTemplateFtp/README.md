...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateftp.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateftp/handlers.py`
