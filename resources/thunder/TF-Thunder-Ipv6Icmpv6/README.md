# TF::Thunder::Ipv6Icmpv6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-ipv6icmpv6.json`
2. Implement your resource handlers in `tf_thunder_ipv6icmpv6/handlers.py`
