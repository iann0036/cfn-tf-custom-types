...
1. Write the JSON schema describing your resource, `tf-thunder-slbplayeridglobal.json`
2. Implement your resource handlers in `tf_thunder_slbplayeridglobal/handlers.py`
