...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateclientssh.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateclientssh/handlers.py`
