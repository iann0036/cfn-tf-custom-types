...
1. Write the JSON schema describing your resource, `tf-thunder-interfaceethernetlldp.json`
2. Implement your resource handlers in `tf_thunder_interfaceethernetlldp/handlers.py`
