# TF::Thunder::SlbSportRateLimit

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbsportratelimit.json`
2. Implement your resource handlers in `tf_thunder_slbsportratelimit/handlers.py`
