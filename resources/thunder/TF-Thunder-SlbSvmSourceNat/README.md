...
1. Write the JSON schema describing your resource, `tf-thunder-slbsvmsourcenat.json`
2. Implement your resource handlers in `tf_thunder_slbsvmsourcenat/handlers.py`
