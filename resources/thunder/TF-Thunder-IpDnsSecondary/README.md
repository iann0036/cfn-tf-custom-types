...
1. Write the JSON schema describing your resource, `tf-thunder-ipdnssecondary.json`
2. Implement your resource handlers in `tf_thunder_ipdnssecondary/handlers.py`
