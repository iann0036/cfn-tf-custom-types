# TF::Thunder::SlbFastHttpProxy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbfasthttpproxy.json`
2. Implement your resource handlers in `tf_thunder_slbfasthttpproxy/handlers.py`
