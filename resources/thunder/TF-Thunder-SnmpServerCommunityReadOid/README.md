...
1. Write the JSON schema describing your resource, `tf-thunder-snmpservercommunityreadoid.json`
2. Implement your resource handlers in `tf_thunder_snmpservercommunityreadoid/handlers.py`
