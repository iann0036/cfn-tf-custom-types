# TF::Thunder::RouterBgpAddressFamilyIpv6NetworkIpv6Network

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6networkipv6network.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6networkipv6network/handlers.py`
