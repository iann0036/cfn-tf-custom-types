...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletraps.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletraps/handlers.py`
