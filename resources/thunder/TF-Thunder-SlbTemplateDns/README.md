...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatedns.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatedns/handlers.py`
