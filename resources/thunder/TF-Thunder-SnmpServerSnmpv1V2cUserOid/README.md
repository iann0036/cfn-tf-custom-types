...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserversnmpv1v2cuseroid.json`
2. Implement your resource handlers in `tf_thunder_snmpserversnmpv1v2cuseroid/handlers.py`
