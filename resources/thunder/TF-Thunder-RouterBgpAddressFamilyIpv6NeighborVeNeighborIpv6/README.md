# TF::Thunder::RouterBgpAddressFamilyIpv6NeighborVeNeighborIpv6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6neighborveneighboripv6.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6neighborveneighboripv6/handlers.py`
