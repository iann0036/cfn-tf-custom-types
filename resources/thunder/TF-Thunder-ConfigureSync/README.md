...
1. Write the JSON schema describing your resource, `tf-thunder-configuresync.json`
2. Implement your resource handlers in `tf_thunder_configuresync/handlers.py`
