...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatefix.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatefix/handlers.py`
