# TF::Thunder::SlbTemplateHttpPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatehttppolicy.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatehttppolicy/handlers.py`
