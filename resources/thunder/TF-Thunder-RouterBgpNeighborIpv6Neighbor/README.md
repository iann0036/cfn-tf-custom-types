# TF::Thunder::RouterBgpNeighborIpv6Neighbor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpneighboripv6neighbor.json`
2. Implement your resource handlers in `tf_thunder_routerbgpneighboripv6neighbor/handlers.py`
