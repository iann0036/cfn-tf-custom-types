...
1. Write the JSON schema describing your resource, `tf-thunder-harmonycontrollerprofile.json`
2. Implement your resource handlers in `tf_thunder_harmonycontrollerprofile/handlers.py`
