# TF::Thunder::RouterBgpAddressFamilyIpv6NeighborIpv6Neighbor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6neighboripv6neighbor.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6neighboripv6neighbor/handlers.py`
