...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsgslb.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsgslb/handlers.py`
