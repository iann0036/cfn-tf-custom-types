...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateexternalservice.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateexternalservice/handlers.py`
