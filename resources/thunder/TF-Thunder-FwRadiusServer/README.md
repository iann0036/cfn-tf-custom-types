...
1. Write the JSON schema describing your resource, `tf-thunder-fwradiusserver.json`
2. Implement your resource handlers in `tf_thunder_fwradiusserver/handlers.py`
