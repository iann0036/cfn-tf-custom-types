...
1. Write the JSON schema describing your resource, `tf-thunder-routerbgpnetworkipcidr.json`
2. Implement your resource handlers in `tf_thunder_routerbgpnetworkipcidr/handlers.py`
