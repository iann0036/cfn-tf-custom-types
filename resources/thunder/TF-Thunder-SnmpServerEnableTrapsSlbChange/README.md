...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsslbchange.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsslbchange/handlers.py`
