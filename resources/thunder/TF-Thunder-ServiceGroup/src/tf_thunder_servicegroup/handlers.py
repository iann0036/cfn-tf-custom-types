...
TYPE_NAME = "TF::Thunder::ServiceGroup"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_service_group/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'thunder_service_group',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_service_group/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/thunder_service_group/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), BackupServerEventLog=None, ConnRate=None, ConnRateDuration=None, ConnRateGracePeriod=None, ConnRateLog=None, ConnRateRevertDuration=None, ConnRevertRate=None, ExtendedStats=None, HealthCheck=None, HealthCheckDisable=None, Id=None, L4SessionRevertDuration=None, L4SessionUsage=None, L4SessionUsageDuration=None, L4SessionUsageGracePeriod=None, L4SessionUsageLog=None, L4SessionUsageRevertRate=None, LbMethod=None, LcMethod=None, MinActiveMember=None, MinActiveMemberAction=None, Name=None, PriorityAffinity=None, Protocol=None, PseudoRoundRobin=None, ReportDelay=None, ResetOnServerSelectionFail=None, ResetPriorityAffinity=None, RptExtServer=None, SampleRspTime=None, SharedPartitionPolicyTemplate=None, SharedPartitionSvcgrpHealthCheck=None, StatelessAutoSwitch=None, StatelessLbMethod=None, StatelessLbMethod2=None, StatsDataAction=None, StrictSelect=None, SvcgrpHealthCheckShared=None, TemplatePolicy=None, TemplatePolicyShared=None, TemplatePort=None, TemplateServer=None, TopFastest=None, TopSlowest=None, TrafficReplicationMirror=None, TrafficReplicationMirrorDaRepl=None, TrafficReplicationMirrorIpRepl=None, TrafficReplicationMirrorSaDaRepl=None, TrafficReplicationMirrorSaRepl=None, UserTag=None, Uuid=None, MemberList=None, Priorities=None, SamplingEnable=None)
