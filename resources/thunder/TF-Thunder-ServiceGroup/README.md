...
1. Write the JSON schema describing your resource, `tf-thunder-servicegroup.json`
2. Implement your resource handlers in `tf_thunder_servicegroup/handlers.py`
