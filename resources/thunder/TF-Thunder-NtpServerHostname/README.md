...
1. Write the JSON schema describing your resource, `tf-thunder-ntpserverhostname.json`
2. Implement your resource handlers in `tf_thunder_ntpserverhostname/handlers.py`
