...
1. Write the JSON schema describing your resource, `tf-thunder-routerospfarea.json`
2. Implement your resource handlers in `tf_thunder_routerospfarea/handlers.py`
