# TF::Thunder::SlbHealthGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbhealthgateway.json`
2. Implement your resource handlers in `tf_thunder_slbhealthgateway/handlers.py`
