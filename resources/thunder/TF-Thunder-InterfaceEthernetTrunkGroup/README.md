...
1. Write the JSON schema describing your resource, `tf-thunder-interfaceethernettrunkgroup.json`
2. Implement your resource handlers in `tf_thunder_interfaceethernettrunkgroup/handlers.py`
