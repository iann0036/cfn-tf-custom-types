...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserveruser.json`
2. Implement your resource handlers in `tf_thunder_snmpserveruser/handlers.py`
