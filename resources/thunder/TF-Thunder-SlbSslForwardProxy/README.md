# TF::Thunder::SlbSslForwardProxy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbsslforwardproxy.json`
2. Implement your resource handlers in `tf_thunder_slbsslforwardproxy/handlers.py`
