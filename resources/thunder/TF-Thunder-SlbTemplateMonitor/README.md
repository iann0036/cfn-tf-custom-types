...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatemonitor.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatemonitor/handlers.py`
