...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverview.json`
2. Implement your resource handlers in `tf_thunder_snmpserverview/handlers.py`
