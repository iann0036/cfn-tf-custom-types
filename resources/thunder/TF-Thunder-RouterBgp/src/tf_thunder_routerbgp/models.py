...
class ResourceModel(BaseModel):
    ...
    Uuid: Optional[str]
    AddressFamily: Optional[Sequence["_AddressFamilyDefinition"]]
    AggregateAddressList: Optional[Sequence["_AggregateAddressListDefinition"]]
    Bgp: Optional[Sequence["_BgpDefinition"]]
    DistanceList: Optional[Sequence["_DistanceListDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AddressFamily=deserialize_list(json_data.get("AddressFamily"), AddressFamilyDefinition),
            ...
            DistanceList=deserialize_list(json_data.get("DistanceList"), DistanceListDefinition),
...
@dataclass
class AddressFamilyDefinition(BaseModel):
    Ipv6: Optional[Sequence["_Ipv6Definition"]]

    @classmethod
    def _deserialize(
        cls: Type["_AddressFamilyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddressFamilyDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AddressFamilyDefinition = AddressFamilyDefinition
...
@dataclass
class DistanceListDefinition(BaseModel):
    AclStr: Optional[str]
    AdminDistance: Optional[float]
    ExtRoutesDist: Optional[float]
    IntRoutesDist: Optional[float]
    LocalRoutesDist: Optional[float]
    SrcPrefix: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_DistanceListDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DistanceListDefinition"]:
        if not json_data:
            return None
        return cls(
            AclStr=json_data.get("AclStr"),
            AdminDistance=json_data.get("AdminDistance"),
            ExtRoutesDist=json_data.get("ExtRoutesDist"),
            IntRoutesDist=json_data.get("IntRoutesDist"),
            LocalRoutesDist=json_data.get("LocalRoutesDist"),
            SrcPrefix=json_data.get("SrcPrefix"),
        )


# work around possible type aliasing issues when variable has same name as a model
_DistanceListDefinition = DistanceListDefinition


@dataclass
class TimersDefinition(BaseModel):
    BgpHoldtime: Optional[float]
    BgpKeepalive: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BgpKeepalive=json_data.get("BgpKeepalive"),
        )
