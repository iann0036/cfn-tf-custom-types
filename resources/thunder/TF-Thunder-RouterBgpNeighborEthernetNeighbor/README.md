# TF::Thunder::RouterBgpNeighborEthernetNeighbor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpneighborethernetneighbor.json`
2. Implement your resource handlers in `tf_thunder_routerbgpneighborethernetneighbor/handlers.py`
