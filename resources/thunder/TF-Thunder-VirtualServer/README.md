...
1. Write the JSON schema describing your resource, `tf-thunder-virtualserver.json`
2. Implement your resource handlers in `tf_thunder_virtualserver/handlers.py`
