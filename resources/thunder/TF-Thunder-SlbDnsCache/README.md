# TF::Thunder::SlbDnsCache

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbdnscache.json`
2. Implement your resource handlers in `tf_thunder_slbdnscache/handlers.py`
