...
TYPE_NAME = "TF::Thunder::SlbTemplateTcpProxy"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_slb_template_tcp_proxy/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'thunder_slb_template_tcp_proxy',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_slb_template_tcp_proxy/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/thunder_slb_template_tcp_proxy/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AckAggressiveness=None, AliveIfActive=None, BackendWscale=None, DelSessionOnServerDown=None, Disable=None, DisableAbc=None, DisableSack=None, DisableTcpTimestamps=None, DisableWindowScale=None, Down=None, DynamicBufferAllocation=None, EarlyRetransmit=None, FinTimeout=None, ForceDeleteTimeout=None, ForceDeleteTimeout100ms=None, HalfCloseIdleTimeout=None, HalfOpenIdleTimeout=None, Id=None, IdleTimeout=None, InitCwnd=None, InitialWindowSize=None, InsertClientIp=None, InvalidRateLimit=None, KeepaliveInterval=None, KeepaliveProbes=None, LimitedSlowstart=None, Maxburst=None, MinRto=None, Mss=None, Nagle=None, Name=None, PshFlagOptimization=None, Qos=None, ReassemblyLimit=None, ReassemblyTimeout=None, ReceiveBuffer=None, Reno=None, ResetFwd=None, ResetRev=None, RetransmitRetries=None, ServerDownAction=None, SynRetries=None, Timewait=None, TransmitBuffer=None, UserTag=None, Uuid=None)
