...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatesnmp.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatesnmp/handlers.py`
