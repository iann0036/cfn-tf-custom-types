# TF::Thunder::FwFullConeSession

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-fwfullconesession.json`
2. Implement your resource handlers in `tf_thunder_fwfullconesession/handlers.py`
