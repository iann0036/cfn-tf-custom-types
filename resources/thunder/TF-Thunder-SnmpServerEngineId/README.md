...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverengineid.json`
2. Implement your resource handlers in `tf_thunder_snmpserverengineid/handlers.py`
