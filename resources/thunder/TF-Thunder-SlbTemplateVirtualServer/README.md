...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatevirtualserver.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatevirtualserver/handlers.py`
