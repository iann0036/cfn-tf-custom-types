# TF::Thunder::FwAlgPptp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-fwalgpptp.json`
2. Implement your resource handlers in `tf_thunder_fwalgpptp/handlers.py`
