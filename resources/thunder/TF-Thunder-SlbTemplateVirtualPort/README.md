...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatevirtualport.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatevirtualport/handlers.py`
