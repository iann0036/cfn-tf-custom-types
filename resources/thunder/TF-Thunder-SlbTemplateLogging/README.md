...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatelogging.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatelogging/handlers.py`
