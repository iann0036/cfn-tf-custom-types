# TF::Thunder::InterfaceEthernetIpv6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-interfaceethernetipv6.json`
2. Implement your resource handlers in `tf_thunder_interfaceethernetipv6/handlers.py`
