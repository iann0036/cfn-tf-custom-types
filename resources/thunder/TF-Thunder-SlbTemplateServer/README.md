...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateserver.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateserver/handlers.py`
