...
1. Write the JSON schema describing your resource, `tf-thunder-slbsslexpirecheck.json`
2. Implement your resource handlers in `tf_thunder_slbsslexpirecheck/handlers.py`
