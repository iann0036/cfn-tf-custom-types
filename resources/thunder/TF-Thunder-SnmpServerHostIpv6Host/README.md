...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverhostipv6host.json`
2. Implement your resource handlers in `tf_thunder_snmpserverhostipv6host/handlers.py`
