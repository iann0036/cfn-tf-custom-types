...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatepersistcookie.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatepersistcookie/handlers.py`
