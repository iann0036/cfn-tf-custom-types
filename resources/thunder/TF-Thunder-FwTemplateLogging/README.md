...
1. Write the JSON schema describing your resource, `tf-thunder-fwtemplatelogging.json`
2. Implement your resource handlers in `tf_thunder_fwtemplatelogging/handlers.py`
