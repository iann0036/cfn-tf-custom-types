...
1. Write the JSON schema describing your resource, `tf-thunder-routerbgpneighborpeergroupneighbor.json`
2. Implement your resource handlers in `tf_thunder_routerbgpneighborpeergroupneighbor/handlers.py`
