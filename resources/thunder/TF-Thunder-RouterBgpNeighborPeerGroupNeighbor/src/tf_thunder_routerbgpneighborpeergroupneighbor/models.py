...
class ResourceModel(BaseModel):
    ...
    ExtendedNexthop: Optional[float]
    Id: Optional[str]
    ...
    PeerGroupKey: Optional[float]
    PeerGroupRemoteAs: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ExtendedNexthop=json_data.get("ExtendedNexthop"),
            Id=json_data.get("Id"),
            ...
            PeerGroupKey=json_data.get("PeerGroupKey"),
            PeerGroupRemoteAs=json_data.get("PeerGroupRemoteAs"),
