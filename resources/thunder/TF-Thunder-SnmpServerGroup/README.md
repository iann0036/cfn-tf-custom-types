...
1. Write the JSON schema describing your resource, `tf-thunder-snmpservergroup.json`
2. Implement your resource handlers in `tf_thunder_snmpservergroup/handlers.py`
