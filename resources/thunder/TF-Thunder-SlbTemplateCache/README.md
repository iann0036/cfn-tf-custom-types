...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatecache.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatecache/handlers.py`
