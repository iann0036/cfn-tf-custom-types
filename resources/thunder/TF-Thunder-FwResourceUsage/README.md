# TF::Thunder::FwResourceUsage

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-fwresourceusage.json`
2. Implement your resource handlers in `tf_thunder_fwresourceusage/handlers.py`
