...
class ResourceModel(BaseModel):
    ...
    Uuid: Optional[str]
    OidList: Optional[Sequence["_OidListDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            OidList=deserialize_list(json_data.get("OidList"), OidListDefinition),
...
@dataclass
class OidListDefinition(BaseModel):
    OidVal: Optional[str]
    UserTag: Optional[str]
    Uuid: Optional[str]
    Remote: Optional[Sequence["_RemoteDefinition"]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_OidListDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_OidListDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_OidListDefinition = OidListDefinition
