...
TYPE_NAME = "TF::Thunder::SlbCommon"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_slb_common/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'thunder_slb_common',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_slb_common/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/thunder_slb_common/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AfterDisable=None, AutoNatNoIpRefresh=None, BuffThresh=None, BuffThreshHwBuff=None, BuffThreshRelieveThresh=None, BuffThreshSysBuffHigh=None, BuffThreshSysBuffLow=None, CompressBlockSize=None, DisableAdaptiveResourceCheck=None, DisableServerAutoReselect=None, DnsCacheAge=None, DnsCacheEnable=None, DnsCacheEntrySize=None, DnsVipStateless=None, DropIcmpToVipWhenVipDown=None, DsrHealthCheckEnable=None, EnableL7ReqAcct=None, Entity=None, ExcludeDestination=None, ExtendedStats=None, FastPathDisable=None, GatewayHealthCheck=None, GracefulShutdown=None, GracefulShutdownEnable=None, HonorServerResponseTtl=None, HwCompression=None, HwSynRr=None, Id=None, Interval=None, L2l3TrunkLbDisable=None, LogForResetUnknownConn=None, LowLatency=None, MaxBuffQueuedPerConn=None, MaxHttpHeaderCount=None, MaxLocalRate=None, MaxRemoteRate=None, MslTime=None, MssTable=None, NoAutoUpOnAflex=None, OverridePort=None, PktRateForResetUnknownConn=None, PlayerIdCheckEnable=None, Range=None, RangeEnd=None, RangeStart=None, RateLimitLogging=None, ResetStaleSession=None, ResolvePortConflict=None, ResponseType=None, ScaleOut=None, SnatGwyForL3=None, SnatOnVip=None, Software=None, SortRes=None, SsliSniHashEnable=None, StatelessSgMultiBinding=None, StatsDataDisable=None, Timeout=None, TtlThreshold=None, UseMssTab=None, Uuid=None, ConnRateLimit=None, DdosProtection=None, DnsResponseRateLimiting=None)
