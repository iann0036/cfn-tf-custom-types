# TF::Thunder::SlbPop3Proxy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbpop3proxy.json`
2. Implement your resource handlers in `tf_thunder_slbpop3proxy/handlers.py`
