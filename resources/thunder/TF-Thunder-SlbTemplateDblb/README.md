...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatedblb.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatedblb/handlers.py`
