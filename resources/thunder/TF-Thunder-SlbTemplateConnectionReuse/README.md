...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateconnectionreuse.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateconnectionreuse/handlers.py`
