...
1. Write the JSON schema describing your resource, `tf-thunder-vrrppeergroup.json`
2. Implement your resource handlers in `tf_thunder_vrrppeergroup/handlers.py`
