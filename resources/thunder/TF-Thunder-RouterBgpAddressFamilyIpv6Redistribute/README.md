...
1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6redistribute.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6redistribute/handlers.py`
