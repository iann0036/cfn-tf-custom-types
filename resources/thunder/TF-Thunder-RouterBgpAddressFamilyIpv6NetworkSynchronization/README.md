...
1. Write the JSON schema describing your resource, `tf-thunder-routerbgpaddressfamilyipv6networksynchronization.json`
2. Implement your resource handlers in `tf_thunder_routerbgpaddressfamilyipv6networksynchronization/handlers.py`
