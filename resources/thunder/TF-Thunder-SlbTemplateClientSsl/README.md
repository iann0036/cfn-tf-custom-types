...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateclientssl.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateclientssl/handlers.py`
