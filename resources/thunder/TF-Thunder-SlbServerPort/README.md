...
1. Write the JSON schema describing your resource, `tf-thunder-slbserverport.json`
2. Implement your resource handlers in `tf_thunder_slbserverport/handlers.py`
