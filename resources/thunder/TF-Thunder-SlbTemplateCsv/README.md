...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatecsv.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatecsv/handlers.py`
