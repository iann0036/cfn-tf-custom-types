# TF::Thunder::SlbL7session

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-slbl7session.json`
2. Implement your resource handlers in `tf_thunder_slbl7session/handlers.py`
