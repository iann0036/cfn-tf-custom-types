...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplatehttp.json`
2. Implement your resource handlers in `tf_thunder_slbtemplatehttp/handlers.py`
