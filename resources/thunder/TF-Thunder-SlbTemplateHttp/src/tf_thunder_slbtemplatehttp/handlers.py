...
TYPE_NAME = "TF::Thunder::SlbTemplateHttp"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_slb_template_http/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'thunder_slb_template_http',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_slb_template_http/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/thunder_slb_template_http/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), 100ContWaitForReqComplete=None, BypassSg=None, ClientIpHdrReplace=None, ClientPortHdrReplace=None, CompressionAutoDisableOnHighCpu=None, CompressionEnable=None, CompressionKeepAcceptEncoding=None, CompressionKeepAcceptEncodingEnable=None, CompressionLevel=None, CompressionMinimumContentLength=None, CookieFormat=None, FailoverUrl=None, Id=None, InsertClientIp=None, InsertClientIpHeaderName=None, InsertClientPort=None, InsertClientPortHeaderName=None, KeepClientAlive=None, LogRetry=None, MaxConcurrentStreams=None, Name=None, NonHttpBypass=None, PersistOn401=None, RdPort=None, RdRespCode=None, RdSecure=None, RdSimpleLoc=None, Redirect=None, ReqHdrWaitTime=None, ReqHdrWaitTimeVal=None, RequestLineCaseInsensitive=None, RequestTimeout=None, RetryOn5xx=None, RetryOn5xxPerReq=None, RetryOn5xxPerReqVal=None, RetryOn5xxVal=None, StrictTransactionSwitch=None, Term11clientHdrConnClose=None, UrlHashFirst=None, UrlHashLast=None, UrlHashOffset=None, UrlHashPersist=None, UseServerStatus=None, UserTag=None, Uuid=None, CompressionContentType=None, CompressionExcludeContentType=None, CompressionExcludeUri=None, HostSwitching=None, RedirectRewrite=None, RequestHeaderEraseList=None, RequestHeaderInsertList=None, ResponseContentReplaceList=None, ResponseHeaderEraseList=None, ResponseHeaderInsertList=None, Template=None, UrlSwitching=None)
