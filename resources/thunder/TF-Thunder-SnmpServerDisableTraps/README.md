...
1. Write the JSON schema describing your resource, `tf-thunder-snmpserverdisabletraps.json`
2. Implement your resource handlers in `tf_thunder_snmpserverdisabletraps/handlers.py`
