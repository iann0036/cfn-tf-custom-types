...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateserverssl.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateserverssl/handlers.py`
