...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_import/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'thunder_import',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/thunder_import/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/thunder_import/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Aflex=None, AuthJwks=None, AuthPortal=None, AuthPortalImage=None, BwList=None, CaCert=None, CertificateType=None, ClassList=None, ClassListConvert=None, ClassListType=None, CloudConfig=None, CloudCreds=None, DnssecDnskey=None, DnssecDs=None, FileInspectionBwList=None, GeoLocation=None, GlmCert=None, GlmLicense=None, Id=None, IpMapList=None, LocalUriFile=None, Lw4o6=None, Overwrite=None, Password=None, PfxPassword=None, Policy=None, RemoteFile=None, Secured=None, SslCert=None, SslCertKey=None, SslCrl=None, SslKey=None, StoreName=None, Terminal=None, ThalesKmdata=None, ThalesSecworld=None, UsbLicense=None, UseMgmtPort=None, UserTag=None, WebCategoryLicense=None, Wsdl=None, XmlSchema=None, AuthSamlIdp=None, HealthExternal=None, HealthPostfile=None, Store=None, ToDevice=None)
