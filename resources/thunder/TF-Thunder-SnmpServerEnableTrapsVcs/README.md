# TF::Thunder::SnmpServerEnableTrapsVcs

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-snmpserverenabletrapsvcs.json`
2. Implement your resource handlers in `tf_thunder_snmpserverenabletrapsvcs/handlers.py`
