...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateudp.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateudp/handlers.py`
