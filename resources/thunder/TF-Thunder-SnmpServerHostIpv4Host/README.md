# TF::Thunder::SnmpServerHostIpv4Host

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-snmpserverhostipv4host.json`
2. Implement your resource handlers in `tf_thunder_snmpserverhostipv4host/handlers.py`
