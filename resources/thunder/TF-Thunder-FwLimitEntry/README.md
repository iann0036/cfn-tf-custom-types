# TF::Thunder::FwLimitEntry

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-fwlimitentry.json`
2. Implement your resource handlers in `tf_thunder_fwlimitentry/handlers.py`
