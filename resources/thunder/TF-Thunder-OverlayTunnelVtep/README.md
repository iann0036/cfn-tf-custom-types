...
1. Write the JSON schema describing your resource, `tf-thunder-overlaytunnelvtep.json`
2. Implement your resource handlers in `tf_thunder_overlaytunnelvtep/handlers.py`
