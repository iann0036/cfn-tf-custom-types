# TF::Thunder::RouterBgpNeighborIpv4Neighbor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-thunder-routerbgpneighboripv4neighbor.json`
2. Implement your resource handlers in `tf_thunder_routerbgpneighboripv4neighbor/handlers.py`
