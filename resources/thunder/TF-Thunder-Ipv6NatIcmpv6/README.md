...
1. Write the JSON schema describing your resource, `tf-thunder-ipv6naticmpv6.json`
2. Implement your resource handlers in `tf_thunder_ipv6naticmpv6/handlers.py`
