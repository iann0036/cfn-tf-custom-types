...
1. Write the JSON schema describing your resource, `tf-thunder-routerospfdefaultinformation.json`
2. Implement your resource handlers in `tf_thunder_routerospfdefaultinformation/handlers.py`
