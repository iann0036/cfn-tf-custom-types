...
1. Write the JSON schema describing your resource, `tf-thunder-slbresourceusage.json`
2. Implement your resource handlers in `tf_thunder_slbresourceusage/handlers.py`
