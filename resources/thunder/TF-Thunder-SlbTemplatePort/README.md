...
1. Write the JSON schema describing your resource, `tf-thunder-slbtemplateport.json`
2. Implement your resource handlers in `tf_thunder_slbtemplateport/handlers.py`
