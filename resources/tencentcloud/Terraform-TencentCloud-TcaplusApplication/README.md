...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-tcaplusapplication.json`
2. Implement your resource handlers in `terraform_tencentcloud_tcaplusapplication/handlers.py`
