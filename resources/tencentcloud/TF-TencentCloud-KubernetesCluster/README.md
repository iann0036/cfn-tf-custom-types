...
1. Write the JSON schema describing your resource, `tf-tencentcloud-kubernetescluster.json`
2. Implement your resource handlers in `tf_tencentcloud_kubernetescluster/handlers.py`
