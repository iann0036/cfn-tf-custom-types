...
TYPE_NAME = "TF::TencentCloud::KubernetesCluster"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/tencentcloud_kubernetes_cluster/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'tencentcloudstack/tencentcloud',
                'providerTypeName': 'tencentcloud',
                'terraformTypeName': 'tencentcloud_kubernetes_cluster',
                'returnValues': ["CertificationAuthority", "ClusterExternalEndpoint", "ClusterNodeNum", "Domain", "Id", "KubeConfig", "Password", "PgwEndpoint", "SecurityPolicy", "UserName", "WorkerInstancesList"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/tencentcloud_kubernetes_cluster/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/tencentcloud_kubernetes_cluster/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), BasePodNum=None, CertificationAuthority=None, ClaimExpiredSeconds=None, ClusterAsEnabled=None, ClusterCidr=None, ClusterDeployType=None, ClusterDesc=None, ClusterExternalEndpoint=None, ClusterInternet=None, ClusterIntranet=None, ClusterIntranetSubnetId=None, ClusterIpvs=None, ClusterMaxPodNum=None, ClusterMaxServiceNum=None, ClusterName=None, ClusterNodeNum=None, ClusterOs=None, ClusterOsType=None, ClusterVersion=None, ContainerRuntime=None, DeletionProtection=None, DockerGraphPath=None, Domain=None, EnableCustomizedPodCidr=None, EniSubnetIds=None, ExtraArgs=None, GlobeDesiredPodNum=None, Id=None, IgnoreClusterCidrConflict=None, IsNonStaticIpMode=None, KubeConfig=None, KubeProxyMode=None, Labels=None, ManagedClusterInternetSecurityPolicies=None, MountTarget=None, NetworkType=None, NodeNameType=None, Password=None, PgwEndpoint=None, ProjectId=None, SecurityPolicy=None, ServiceCidr=None, Tags=None, Unschedulable=None, UpgradeInstancesFollowCluster=None, UserName=None, VpcId=None, WorkerInstancesList=None, ClusterExtraArgs=None, ExistInstance=None, MasterConfig=None, NodePoolGlobalConfig=None, WorkerConfig=None)
