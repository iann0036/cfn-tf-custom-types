...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-asschedule.json`
2. Implement your resource handlers in `terraform_tencentcloud_asschedule/handlers.py`
