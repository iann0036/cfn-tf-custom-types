...
1. Write the JSON schema describing your resource, `tf-tencentcloud-gaaphttpdomain.json`
2. Implement your resource handlers in `tf_tencentcloud_gaaphttpdomain/handlers.py`
