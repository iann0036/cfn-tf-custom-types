...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaaprealserver.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaaprealserver/handlers.py`
