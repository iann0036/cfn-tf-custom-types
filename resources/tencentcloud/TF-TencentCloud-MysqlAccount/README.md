...
1. Write the JSON schema describing your resource, `tf-tencentcloud-mysqlaccount.json`
2. Implement your resource handlers in `tf_tencentcloud_mysqlaccount/handlers.py`
