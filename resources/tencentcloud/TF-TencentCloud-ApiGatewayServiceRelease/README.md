...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayservicerelease.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayservicerelease/handlers.py`
