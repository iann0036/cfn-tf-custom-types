...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clbtargetgroup.json`
2. Implement your resource handlers in `tf_tencentcloud_clbtargetgroup/handlers.py`
