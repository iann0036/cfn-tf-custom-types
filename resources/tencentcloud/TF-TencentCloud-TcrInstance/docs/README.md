...
<pre>
{
    "Type" : "TF::TencentCloud::TcrInstance",
    "Properties" : {
        "<a href="#deletebucket" title="DeleteBucket">DeleteBucket</a>" : <i>Boolean</i>,
        "<a href="#instancetype" title="InstanceType">InstanceType</a>" : <i>String</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#openpublicoperation" title="OpenPublicOperation">OpenPublicOperation</a>" : <i>Boolean</i>,
...
Returns the <code>PublicDomain</code> value.

#### PublicStatus

Returns the <code>PublicStatus</code> value.
