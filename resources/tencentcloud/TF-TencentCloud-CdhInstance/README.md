...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cdhinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_cdhinstance/handlers.py`
