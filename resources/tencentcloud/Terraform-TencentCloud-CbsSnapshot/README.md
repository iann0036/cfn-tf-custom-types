...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cbssnapshot.json`
2. Implement your resource handlers in `terraform_tencentcloud_cbssnapshot/handlers.py`
