...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vodadaptivedynamicstreamingtemplate.json`
2. Implement your resource handlers in `tf_tencentcloud_vodadaptivedynamicstreamingtemplate/handlers.py`
