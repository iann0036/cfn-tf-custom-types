...
<pre>
{
    "Type" : "TF::TencentCloud::VpnConnection",
    "Properties" : {
        ...
        "<a href="#securitygrouppolicy" title="SecurityGroupPolicy">SecurityGroupPolicy</a>" : <i>[ <a href="securitygrouppolicydefinition.md">SecurityGroupPolicyDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#securitygrouppolicy" title="SecurityGroupPolicy">SecurityGroupPolicy</a>: <i>
      - <a href="securitygrouppolicydefinition.md">SecurityGroupPolicyDefinition</a></i>
</pre>
...
Proto authenticate algorithm of the IKE operation specification. Valid values: `MD5`, `SHA`. Default Value is `MD5`.
...
Integrity algorithm of the IPSEC operation specification. Valid values: `SHA1`, `MD5`. Default value is `MD5`.
...
_Type_: List of <a href="securitygrouppolicydefinition.md">SecurityGroupPolicyDefinition</a>
...
Returns the <code>IsCcnType</code> value.
