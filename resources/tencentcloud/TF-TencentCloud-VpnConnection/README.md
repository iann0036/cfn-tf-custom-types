...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vpnconnection.json`
2. Implement your resource handlers in `tf_tencentcloud_vpnconnection/handlers.py`
