...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cbssnapshotpolicyattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_cbssnapshotpolicyattachment/handlers.py`
