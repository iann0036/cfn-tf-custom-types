...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ccnattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_ccnattachment/handlers.py`
