...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserverpublishsubscribe.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserverpublishsubscribe/handlers.py`
