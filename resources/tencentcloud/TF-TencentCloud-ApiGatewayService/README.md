...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayservice.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayservice/handlers.py`
