...
1. Write the JSON schema describing your resource, `tf-tencentcloud-scffunction.json`
2. Implement your resource handlers in `tf_tencentcloud_scffunction/handlers.py`
