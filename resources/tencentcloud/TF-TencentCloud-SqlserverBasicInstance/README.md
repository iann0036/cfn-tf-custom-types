...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserverbasicinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserverbasicinstance/handlers.py`
