...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-ccnbandwidthlimit.json`
2. Implement your resource handlers in `terraform_tencentcloud_ccnbandwidthlimit/handlers.py`
