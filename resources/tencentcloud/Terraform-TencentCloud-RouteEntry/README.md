...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-routeentry.json`
2. Implement your resource handlers in `terraform_tencentcloud_routeentry/handlers.py`
