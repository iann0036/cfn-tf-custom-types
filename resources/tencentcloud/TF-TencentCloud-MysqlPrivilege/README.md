...
1. Write the JSON schema describing your resource, `tf-tencentcloud-mysqlprivilege.json`
2. Implement your resource handlers in `tf_tencentcloud_mysqlprivilege/handlers.py`
