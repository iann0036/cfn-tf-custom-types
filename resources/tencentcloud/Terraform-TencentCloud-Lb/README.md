...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-lb.json`
2. Implement your resource handlers in `terraform_tencentcloud_lb/handlers.py`
