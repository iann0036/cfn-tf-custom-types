...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clbtargetgroupinstanceattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_clbtargetgroupinstanceattachment/handlers.py`
