...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-scffunction.json`
2. Implement your resource handlers in `terraform_tencentcloud_scffunction/handlers.py`
