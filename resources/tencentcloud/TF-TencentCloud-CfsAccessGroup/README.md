# TF::TencentCloud::CfsAccessGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-cfsaccessgroup.json`
2. Implement your resource handlers in `tf_tencentcloud_cfsaccessgroup/handlers.py`
