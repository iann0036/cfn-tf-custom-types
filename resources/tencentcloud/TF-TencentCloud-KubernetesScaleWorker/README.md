...
1. Write the JSON schema describing your resource, `tf-tencentcloud-kubernetesscaleworker.json`
2. Implement your resource handlers in `tf_tencentcloud_kubernetesscaleworker/handlers.py`
