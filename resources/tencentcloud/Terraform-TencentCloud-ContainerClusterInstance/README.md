...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-containerclusterinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_containerclusterinstance/handlers.py`
