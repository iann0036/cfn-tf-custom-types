...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-tcapluszone.json`
2. Implement your resource handlers in `terraform_tencentcloud_tcapluszone/handlers.py`
