...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-eipassociation.json`
2. Implement your resource handlers in `terraform_tencentcloud_eipassociation/handlers.py`
