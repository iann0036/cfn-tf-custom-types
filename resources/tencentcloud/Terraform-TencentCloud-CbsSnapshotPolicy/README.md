...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cbssnapshotpolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_cbssnapshotpolicy/handlers.py`
