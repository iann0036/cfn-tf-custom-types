...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcaplustable.json`
2. Implement your resource handlers in `tf_tencentcloud_tcaplustable/handlers.py`
