...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-routetable.json`
2. Implement your resource handlers in `terraform_tencentcloud_routetable/handlers.py`
