...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-kubernetesscaleworker.json`
2. Implement your resource handlers in `terraform_tencentcloud_kubernetesscaleworker/handlers.py`
