...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clbredirection.json`
2. Implement your resource handlers in `tf_tencentcloud_clbredirection/handlers.py`
