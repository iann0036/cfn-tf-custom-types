...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#ipv4s" title="Ipv4s">Ipv4s</a>" : <i>[ <a href="ipv4sdefinition.md">Ipv4sDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#ipv4s" title="Ipv4s">Ipv4s</a>: <i>
      - <a href="ipv4sdefinition.md">Ipv4sDefinition</a></i>
</pre>
...
_Type_: List of <a href="ipv4sdefinition.md">Ipv4sDefinition</a>
