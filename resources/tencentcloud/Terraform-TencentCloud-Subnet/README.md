...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-subnet.json`
2. Implement your resource handlers in `terraform_tencentcloud_subnet/handlers.py`
