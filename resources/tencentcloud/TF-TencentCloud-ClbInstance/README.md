...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clbinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_clbinstance/handlers.py`
