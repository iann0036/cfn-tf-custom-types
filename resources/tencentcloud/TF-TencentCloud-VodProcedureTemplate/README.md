...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vodproceduretemplate.json`
2. Implement your resource handlers in `tf_tencentcloud_vodproceduretemplate/handlers.py`
