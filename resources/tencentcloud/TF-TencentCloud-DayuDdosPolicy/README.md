...
1. Write the JSON schema describing your resource, `tf-tencentcloud-dayuddospolicy.json`
2. Implement your resource handlers in `tf_tencentcloud_dayuddospolicy/handlers.py`
