...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-eip.json`
2. Implement your resource handlers in `terraform_tencentcloud_eip/handlers.py`
