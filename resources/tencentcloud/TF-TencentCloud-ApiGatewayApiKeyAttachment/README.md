...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayapikeyattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayapikeyattachment/handlers.py`
