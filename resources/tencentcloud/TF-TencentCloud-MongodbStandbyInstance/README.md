...
1. Write the JSON schema describing your resource, `tf-tencentcloud-mongodbstandbyinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_mongodbstandbyinstance/handlers.py`
