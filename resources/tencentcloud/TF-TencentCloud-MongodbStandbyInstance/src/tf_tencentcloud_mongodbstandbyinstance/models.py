...
class ResourceModel(BaseModel):
    ...
    FatherInstanceId: Optional[str]
    FatherInstanceRegion: Optional[str]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FatherInstanceId=json_data.get("FatherInstanceId"),
            FatherInstanceRegion=json_data.get("FatherInstanceRegion"),
            Id=json_data.get("Id"),
