...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-asattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_asattachment/handlers.py`
