# TF::TencentCloud::HaVip

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-havip.json`
2. Implement your resource handlers in `tf_tencentcloud_havip/handlers.py`
