...
1. Write the JSON schema describing your resource, `tf-tencentcloud-mongodbinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_mongodbinstance/handlers.py`
