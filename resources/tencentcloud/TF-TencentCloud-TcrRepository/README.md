...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcrrepository.json`
2. Implement your resource handlers in `tf_tencentcloud_tcrrepository/handlers.py`
