...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camgrouppolicyattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_camgrouppolicyattachment/handlers.py`
