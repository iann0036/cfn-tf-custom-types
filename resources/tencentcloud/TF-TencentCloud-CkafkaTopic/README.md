...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ckafkatopic.json`
2. Implement your resource handlers in `tf_tencentcloud_ckafkatopic/handlers.py`
