...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clbattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_clbattachment/handlers.py`
