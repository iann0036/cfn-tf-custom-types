...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sslpaycertificate.json`
2. Implement your resource handlers in `tf_tencentcloud_sslpaycertificate/handlers.py`
