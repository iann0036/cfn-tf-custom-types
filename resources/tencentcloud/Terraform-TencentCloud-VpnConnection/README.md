...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-vpnconnection.json`
2. Implement your resource handlers in `terraform_tencentcloud_vpnconnection/handlers.py`
