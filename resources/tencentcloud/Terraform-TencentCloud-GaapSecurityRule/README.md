...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaapsecurityrule.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaapsecurityrule/handlers.py`
