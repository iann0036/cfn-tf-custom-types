...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camgroupmembership.json`
2. Implement your resource handlers in `terraform_tencentcloud_camgroupmembership/handlers.py`
