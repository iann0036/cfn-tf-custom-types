...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ccnbandwidthlimit.json`
2. Implement your resource handlers in `tf_tencentcloud_ccnbandwidthlimit/handlers.py`
