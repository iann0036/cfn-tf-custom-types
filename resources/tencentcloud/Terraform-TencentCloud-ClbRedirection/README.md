...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-clbredirection.json`
2. Implement your resource handlers in `terraform_tencentcloud_clbredirection/handlers.py`
