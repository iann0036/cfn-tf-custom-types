...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camuser.json`
2. Implement your resource handlers in `terraform_tencentcloud_camuser/handlers.py`
