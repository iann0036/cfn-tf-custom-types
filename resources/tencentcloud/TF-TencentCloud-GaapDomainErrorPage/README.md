# TF::TencentCloud::GaapDomainErrorPage

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-gaapdomainerrorpage.json`
2. Implement your resource handlers in `tf_tencentcloud_gaapdomainerrorpage/handlers.py`
