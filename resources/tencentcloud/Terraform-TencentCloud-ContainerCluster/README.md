...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-containercluster.json`
2. Implement your resource handlers in `terraform_tencentcloud_containercluster/handlers.py`
