...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-sslcertificate.json`
2. Implement your resource handlers in `terraform_tencentcloud_sslcertificate/handlers.py`
