# TF::TencentCloud::AsSchedule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-asschedule.json`
2. Implement your resource handlers in `tf_tencentcloud_asschedule/handlers.py`
