...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-placementgroup.json`
2. Implement your resource handlers in `terraform_tencentcloud_placementgroup/handlers.py`
