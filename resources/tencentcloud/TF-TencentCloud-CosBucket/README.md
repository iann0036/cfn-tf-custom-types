...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cosbucket.json`
2. Implement your resource handlers in `tf_tencentcloud_cosbucket/handlers.py`
