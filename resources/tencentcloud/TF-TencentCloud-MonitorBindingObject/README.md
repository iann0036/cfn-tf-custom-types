...
1. Write the JSON schema describing your resource, `tf-tencentcloud-monitorbindingobject.json`
2. Implement your resource handlers in `tf_tencentcloud_monitorbindingobject/handlers.py`
