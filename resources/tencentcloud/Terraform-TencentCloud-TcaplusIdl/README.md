...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-tcaplusidl.json`
2. Implement your resource handlers in `terraform_tencentcloud_tcaplusidl/handlers.py`
