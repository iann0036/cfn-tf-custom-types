...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-asscalinggroup.json`
2. Implement your resource handlers in `terraform_tencentcloud_asscalinggroup/handlers.py`
