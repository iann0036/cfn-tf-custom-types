...
1. Write the JSON schema describing your resource, `tf-tencentcloud-albserverattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_albserverattachment/handlers.py`
