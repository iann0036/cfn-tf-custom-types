...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserveraccount.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserveraccount/handlers.py`
