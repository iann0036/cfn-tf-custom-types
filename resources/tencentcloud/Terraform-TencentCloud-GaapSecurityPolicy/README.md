...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaapsecuritypolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaapsecuritypolicy/handlers.py`
