...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-tcaplustable.json`
2. Implement your resource handlers in `terraform_tencentcloud_tcaplustable/handlers.py`
