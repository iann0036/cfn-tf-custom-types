# Terraform::TencentCloud::VpnCustomerGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-tencentcloud-vpncustomergateway.json`
2. Implement your resource handlers in `terraform_tencentcloud_vpncustomergateway/handlers.py`
