...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcrvpcattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_tcrvpcattachment/handlers.py`
