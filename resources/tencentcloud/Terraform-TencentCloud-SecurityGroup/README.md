...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-securitygroup.json`
2. Implement your resource handlers in `terraform_tencentcloud_securitygroup/handlers.py`
