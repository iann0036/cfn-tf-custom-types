...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcrnamespace.json`
2. Implement your resource handlers in `tf_tencentcloud_tcrnamespace/handlers.py`
