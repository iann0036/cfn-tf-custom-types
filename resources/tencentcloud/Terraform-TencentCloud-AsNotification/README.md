...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-asnotification.json`
2. Implement your resource handlers in `terraform_tencentcloud_asnotification/handlers.py`
