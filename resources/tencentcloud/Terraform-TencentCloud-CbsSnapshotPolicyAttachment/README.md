# Terraform::TencentCloud::CbsSnapshotPolicyAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-tencentcloud-cbssnapshotpolicyattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_cbssnapshotpolicyattachment/handlers.py`
