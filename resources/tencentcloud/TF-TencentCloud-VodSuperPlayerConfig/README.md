...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vodsuperplayerconfig.json`
2. Implement your resource handlers in `tf_tencentcloud_vodsuperplayerconfig/handlers.py`
