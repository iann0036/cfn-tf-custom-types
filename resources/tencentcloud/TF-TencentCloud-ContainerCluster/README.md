...
1. Write the JSON schema describing your resource, `tf-tencentcloud-containercluster.json`
2. Implement your resource handlers in `tf_tencentcloud_containercluster/handlers.py`
