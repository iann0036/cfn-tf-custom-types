...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cynosdbreadonlyinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_cynosdbreadonlyinstance/handlers.py`
