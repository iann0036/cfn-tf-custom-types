...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cosbucket.json`
2. Implement your resource handlers in `terraform_tencentcloud_cosbucket/handlers.py`
