...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dcx.json`
2. Implement your resource handlers in `terraform_tencentcloud_dcx/handlers.py`
