...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-routetableentry.json`
2. Implement your resource handlers in `terraform_tencentcloud_routetableentry/handlers.py`
