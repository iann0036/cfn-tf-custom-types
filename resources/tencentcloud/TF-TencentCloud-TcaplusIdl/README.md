...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcaplusidl.json`
2. Implement your resource handlers in `tf_tencentcloud_tcaplusidl/handlers.py`
