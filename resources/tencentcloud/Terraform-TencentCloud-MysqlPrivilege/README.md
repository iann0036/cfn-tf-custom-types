...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mysqlprivilege.json`
2. Implement your resource handlers in `terraform_tencentcloud_mysqlprivilege/handlers.py`
