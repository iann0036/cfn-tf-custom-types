...
1. Write the JSON schema describing your resource, `tf-tencentcloud-kubernetesasscalinggroup.json`
2. Implement your resource handlers in `tf_tencentcloud_kubernetesasscalinggroup/handlers.py`
