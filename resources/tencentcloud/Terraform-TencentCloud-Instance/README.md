...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-instance.json`
2. Implement your resource handlers in `terraform_tencentcloud_instance/handlers.py`
