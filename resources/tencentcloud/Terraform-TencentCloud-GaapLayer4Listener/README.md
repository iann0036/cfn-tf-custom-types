...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaaplayer4listener.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaaplayer4listener/handlers.py`
