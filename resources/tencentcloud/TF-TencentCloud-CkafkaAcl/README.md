...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ckafkaacl.json`
2. Implement your resource handlers in `tf_tencentcloud_ckafkaacl/handlers.py`
