...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayipstrategy.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayipstrategy/handlers.py`
