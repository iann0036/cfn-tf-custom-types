...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayul7rule.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayul7rule/handlers.py`
