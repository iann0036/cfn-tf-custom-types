...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-campolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_campolicy/handlers.py`
