...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mysqlaccountprivilege.json`
2. Implement your resource handlers in `terraform_tencentcloud_mysqlaccountprivilege/handlers.py`
