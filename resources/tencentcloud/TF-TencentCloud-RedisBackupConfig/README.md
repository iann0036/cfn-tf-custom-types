# TF::TencentCloud::RedisBackupConfig

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-redisbackupconfig.json`
2. Implement your resource handlers in `tf_tencentcloud_redisbackupconfig/handlers.py`
