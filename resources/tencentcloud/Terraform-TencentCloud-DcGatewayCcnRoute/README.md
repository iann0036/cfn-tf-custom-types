...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dcgatewayccnroute.json`
2. Implement your resource handlers in `terraform_tencentcloud_dcgatewayccnroute/handlers.py`
