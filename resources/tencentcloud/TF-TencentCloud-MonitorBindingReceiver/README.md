...
1. Write the JSON schema describing your resource, `tf-tencentcloud-monitorbindingreceiver.json`
2. Implement your resource handlers in `tf_tencentcloud_monitorbindingreceiver/handlers.py`
