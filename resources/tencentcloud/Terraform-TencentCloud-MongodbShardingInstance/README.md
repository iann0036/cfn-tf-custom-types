...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mongodbshardinginstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_mongodbshardinginstance/handlers.py`
