...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-redisinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_redisinstance/handlers.py`
