...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cynosdbcluster.json`
2. Implement your resource handlers in `tf_tencentcloud_cynosdbcluster/handlers.py`
