...
1. Write the JSON schema describing your resource, `tf-tencentcloud-elasticsearchinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_elasticsearchinstance/handlers.py`
