# TF::TencentCloud::VpnCustomerGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-vpncustomergateway.json`
2. Implement your resource handlers in `tf_tencentcloud_vpncustomergateway/handlers.py`
