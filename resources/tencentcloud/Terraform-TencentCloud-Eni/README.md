...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-eni.json`
2. Implement your resource handlers in `terraform_tencentcloud_eni/handlers.py`
