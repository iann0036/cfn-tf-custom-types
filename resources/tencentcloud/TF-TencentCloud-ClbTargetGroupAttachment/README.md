...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clbtargetgroupattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_clbtargetgroupattachment/handlers.py`
