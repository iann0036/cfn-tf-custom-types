...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-ccn.json`
2. Implement your resource handlers in `terraform_tencentcloud_ccn/handlers.py`
