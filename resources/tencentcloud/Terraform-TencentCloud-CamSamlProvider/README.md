...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camsamlprovider.json`
2. Implement your resource handlers in `terraform_tencentcloud_camsamlprovider/handlers.py`
