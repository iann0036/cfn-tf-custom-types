...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-asscalingconfig.json`
2. Implement your resource handlers in `terraform_tencentcloud_asscalingconfig/handlers.py`
