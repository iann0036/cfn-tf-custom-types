...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mysqlreadonlyinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_mysqlreadonlyinstance/handlers.py`
