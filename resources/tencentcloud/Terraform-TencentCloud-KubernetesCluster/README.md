...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-kubernetescluster.json`
2. Implement your resource handlers in `terraform_tencentcloud_kubernetescluster/handlers.py`
