...
1. Write the JSON schema describing your resource, `tf-tencentcloud-kubernetesnodepool.json`
2. Implement your resource handlers in `tf_tencentcloud_kubernetesnodepool/handlers.py`
