...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaapcertificate.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaapcertificate/handlers.py`
