...
1. Write the JSON schema describing your resource, `tf-tencentcloud-camsamlprovider.json`
2. Implement your resource handlers in `tf_tencentcloud_camsamlprovider/handlers.py`
