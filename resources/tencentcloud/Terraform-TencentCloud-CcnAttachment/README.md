...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-ccnattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_ccnattachment/handlers.py`
