...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cbssnapshotpolicy.json`
2. Implement your resource handlers in `tf_tencentcloud_cbssnapshotpolicy/handlers.py`
