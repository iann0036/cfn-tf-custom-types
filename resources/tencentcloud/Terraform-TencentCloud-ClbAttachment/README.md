...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-clbattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_clbattachment/handlers.py`
