...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-reservedinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_reservedinstance/handlers.py`
