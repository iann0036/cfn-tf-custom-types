...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vodimagespritetemplate.json`
2. Implement your resource handlers in `tf_tencentcloud_vodimagespritetemplate/handlers.py`
