...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-scfnamespace.json`
2. Implement your resource handlers in `terraform_tencentcloud_scfnamespace/handlers.py`
