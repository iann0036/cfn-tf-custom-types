...
1. Write the JSON schema describing your resource, `tf-tencentcloud-kubernetesclusterattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_kubernetesclusterattachment/handlers.py`
