...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camuserpolicyattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_camuserpolicyattachment/handlers.py`
