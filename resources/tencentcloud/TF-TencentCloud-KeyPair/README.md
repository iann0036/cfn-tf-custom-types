# TF::TencentCloud::KeyPair

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-keypair.json`
2. Implement your resource handlers in `tf_tencentcloud_keypair/handlers.py`
