...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#gtid" title="Gtid">Gtid</a>" : <i>Double</i>,
        "<a href="#instancename" title="InstanceName">InstanceName</a>" : <i>String</i>,
        "<a href="#internethost" title="InternetHost">InternetHost</a>" : <i>String</i>,
        "<a href="#internetport" title="InternetPort">InternetPort</a>" : <i>Double</i>,
