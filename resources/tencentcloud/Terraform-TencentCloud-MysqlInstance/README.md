...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mysqlinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_mysqlinstance/handlers.py`
