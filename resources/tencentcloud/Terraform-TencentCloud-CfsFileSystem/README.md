...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cfsfilesystem.json`
2. Implement your resource handlers in `terraform_tencentcloud_cfsfilesystem/handlers.py`
