...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayuddospolicyattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayuddospolicyattachment/handlers.py`
