...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewaystrategyattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewaystrategyattachment/handlers.py`
