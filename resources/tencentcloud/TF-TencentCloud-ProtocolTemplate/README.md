...
1. Write the JSON schema describing your resource, `tf-tencentcloud-protocoltemplate.json`
2. Implement your resource handlers in `tf_tencentcloud_protocoltemplate/handlers.py`
