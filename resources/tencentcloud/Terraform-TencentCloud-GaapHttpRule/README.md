...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaaphttprule.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaaphttprule/handlers.py`
