...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-kubernetesasscalinggroup.json`
2. Implement your resource handlers in `terraform_tencentcloud_kubernetesasscalinggroup/handlers.py`
