...
1. Write the JSON schema describing your resource, `tf-tencentcloud-securitygrouprule.json`
2. Implement your resource handlers in `tf_tencentcloud_securitygrouprule/handlers.py`
