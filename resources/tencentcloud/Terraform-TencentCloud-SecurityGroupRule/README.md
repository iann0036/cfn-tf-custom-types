...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-securitygrouprule.json`
2. Implement your resource handlers in `terraform_tencentcloud_securitygrouprule/handlers.py`
