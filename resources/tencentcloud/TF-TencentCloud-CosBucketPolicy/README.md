...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cosbucketpolicy.json`
2. Implement your resource handlers in `tf_tencentcloud_cosbucketpolicy/handlers.py`
