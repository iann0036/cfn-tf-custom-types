...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-securitygroupliterule.json`
2. Implement your resource handlers in `terraform_tencentcloud_securitygroupliterule/handlers.py`
