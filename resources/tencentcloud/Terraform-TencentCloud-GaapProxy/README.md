...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaapproxy.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaapproxy/handlers.py`
