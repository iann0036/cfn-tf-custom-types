...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clblistenerrule.json`
2. Implement your resource handlers in `tf_tencentcloud_clblistenerrule/handlers.py`
