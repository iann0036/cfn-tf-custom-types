...
1. Write the JSON schema describing your resource, `tf-tencentcloud-mysqlreadonlyinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_mysqlreadonlyinstance/handlers.py`
