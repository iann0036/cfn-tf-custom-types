...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cosbucketobject.json`
2. Implement your resource handlers in `terraform_tencentcloud_cosbucketobject/handlers.py`
