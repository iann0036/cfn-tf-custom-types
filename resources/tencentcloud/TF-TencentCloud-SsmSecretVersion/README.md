...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ssmsecretversion.json`
2. Implement your resource handlers in `tf_tencentcloud_ssmsecretversion/handlers.py`
