...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cfsaccessrule.json`
2. Implement your resource handlers in `terraform_tencentcloud_cfsaccessrule/handlers.py`
