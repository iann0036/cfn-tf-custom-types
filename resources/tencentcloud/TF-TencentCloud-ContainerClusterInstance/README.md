# TF::TencentCloud::ContainerClusterInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-containerclusterinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_containerclusterinstance/handlers.py`
