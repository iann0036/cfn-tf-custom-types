# TF::TencentCloud::GaapLayer7Listener

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-gaaplayer7listener.json`
2. Implement your resource handlers in `tf_tencentcloud_gaaplayer7listener/handlers.py`
