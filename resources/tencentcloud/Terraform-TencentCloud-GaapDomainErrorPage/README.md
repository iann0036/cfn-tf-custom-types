...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaapdomainerrorpage.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaapdomainerrorpage/handlers.py`
