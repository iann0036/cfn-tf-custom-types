...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-clbinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_clbinstance/handlers.py`
