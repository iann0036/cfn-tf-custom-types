...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vpngateway.json`
2. Implement your resource handlers in `tf_tencentcloud_vpngateway/handlers.py`
