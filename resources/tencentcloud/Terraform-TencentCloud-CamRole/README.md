...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camrole.json`
2. Implement your resource handlers in `terraform_tencentcloud_camrole/handlers.py`
