...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayusageplan.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayusageplan/handlers.py`
