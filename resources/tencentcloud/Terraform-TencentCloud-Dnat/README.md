...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dnat.json`
2. Implement your resource handlers in `terraform_tencentcloud_dnat/handlers.py`
