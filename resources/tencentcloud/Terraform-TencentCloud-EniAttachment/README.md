...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-eniattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_eniattachment/handlers.py`
