...
1. Write the JSON schema describing your resource, `tf-tencentcloud-kmsexternalkey.json`
2. Implement your resource handlers in `tf_tencentcloud_kmsexternalkey/handlers.py`
