...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cbssnapshot.json`
2. Implement your resource handlers in `tf_tencentcloud_cbssnapshot/handlers.py`
