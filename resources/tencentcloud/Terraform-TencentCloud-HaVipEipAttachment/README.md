...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-havipeipattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_havipeipattachment/handlers.py`
