...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserverinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserverinstance/handlers.py`
