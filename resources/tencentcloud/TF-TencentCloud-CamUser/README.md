...
1. Write the JSON schema describing your resource, `tf-tencentcloud-camuser.json`
2. Implement your resource handlers in `tf_tencentcloud_camuser/handlers.py`
