...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayucchttpspolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayucchttpspolicy/handlers.py`
