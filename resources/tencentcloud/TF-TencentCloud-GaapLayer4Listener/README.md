# TF::TencentCloud::GaapLayer4Listener

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-gaaplayer4listener.json`
2. Implement your resource handlers in `tf_tencentcloud_gaaplayer4listener/handlers.py`
