...
1. Write the JSON schema describing your resource, `tf-tencentcloud-gaapsecuritypolicy.json`
2. Implement your resource handlers in `tf_tencentcloud_gaapsecuritypolicy/handlers.py`
