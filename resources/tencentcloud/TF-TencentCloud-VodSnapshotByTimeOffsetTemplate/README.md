...
1. Write the JSON schema describing your resource, `tf-tencentcloud-vodsnapshotbytimeoffsettemplate.json`
2. Implement your resource handlers in `tf_tencentcloud_vodsnapshotbytimeoffsettemplate/handlers.py`
