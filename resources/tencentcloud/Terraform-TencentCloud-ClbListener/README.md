...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-clblistener.json`
2. Implement your resource handlers in `terraform_tencentcloud_clblistener/handlers.py`
