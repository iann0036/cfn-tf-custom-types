...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ckafkauser.json`
2. Implement your resource handlers in `tf_tencentcloud_ckafkauser/handlers.py`
