...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayuddospolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayuddospolicy/handlers.py`
