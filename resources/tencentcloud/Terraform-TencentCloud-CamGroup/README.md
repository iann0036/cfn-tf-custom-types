...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camgroup.json`
2. Implement your resource handlers in `terraform_tencentcloud_camgroup/handlers.py`
