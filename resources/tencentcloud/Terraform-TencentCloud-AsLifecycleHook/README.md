...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-aslifecyclehook.json`
2. Implement your resource handlers in `terraform_tencentcloud_aslifecyclehook/handlers.py`
