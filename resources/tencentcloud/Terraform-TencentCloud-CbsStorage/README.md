...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cbsstorage.json`
2. Implement your resource handlers in `terraform_tencentcloud_cbsstorage/handlers.py`
