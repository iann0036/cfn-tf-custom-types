...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-havip.json`
2. Implement your resource handlers in `terraform_tencentcloud_havip/handlers.py`
