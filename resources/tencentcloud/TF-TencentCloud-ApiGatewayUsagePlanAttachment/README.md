...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayusageplanattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayusageplanattachment/handlers.py`
