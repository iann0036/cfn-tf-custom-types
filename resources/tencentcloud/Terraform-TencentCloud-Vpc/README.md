...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-vpc.json`
2. Implement your resource handlers in `terraform_tencentcloud_vpc/handlers.py`
