...
1. Write the JSON schema describing your resource, `tf-tencentcloud-placementgroup.json`
2. Implement your resource handlers in `tf_tencentcloud_placementgroup/handlers.py`
