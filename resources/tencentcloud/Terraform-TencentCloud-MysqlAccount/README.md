...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mysqlaccount.json`
2. Implement your resource handlers in `terraform_tencentcloud_mysqlaccount/handlers.py`
