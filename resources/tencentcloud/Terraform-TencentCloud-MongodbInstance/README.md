...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mongodbinstance.json`
2. Implement your resource handlers in `terraform_tencentcloud_mongodbinstance/handlers.py`
