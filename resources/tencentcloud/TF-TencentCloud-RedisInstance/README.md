...
1. Write the JSON schema describing your resource, `tf-tencentcloud-redisinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_redisinstance/handlers.py`
