...
1. Write the JSON schema describing your resource, `tf-tencentcloud-eipassociation.json`
2. Implement your resource handlers in `tf_tencentcloud_eipassociation/handlers.py`
