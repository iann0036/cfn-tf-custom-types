...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cfsaccessgroup.json`
2. Implement your resource handlers in `terraform_tencentcloud_cfsaccessgroup/handlers.py`
