...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcapluscluster.json`
2. Implement your resource handlers in `tf_tencentcloud_tcapluscluster/handlers.py`
