...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewaycustomdomain.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewaycustomdomain/handlers.py`
