...
1. Write the JSON schema describing your resource, `tf-tencentcloud-mysqlinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_mysqlinstance/handlers.py`
