...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-asscalingpolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_asscalingpolicy/handlers.py`
