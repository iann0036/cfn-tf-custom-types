...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-cbsstorageattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_cbsstorageattachment/handlers.py`
