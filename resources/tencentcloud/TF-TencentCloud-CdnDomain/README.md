...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cdndomain.json`
2. Implement your resource handlers in `tf_tencentcloud_cdndomain/handlers.py`
