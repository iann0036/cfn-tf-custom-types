...
1. Write the JSON schema describing your resource, `tf-tencentcloud-clblistener.json`
2. Implement your resource handlers in `tf_tencentcloud_clblistener/handlers.py`
