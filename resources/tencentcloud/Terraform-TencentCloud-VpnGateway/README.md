...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-vpngateway.json`
2. Implement your resource handlers in `terraform_tencentcloud_vpngateway/handlers.py`
