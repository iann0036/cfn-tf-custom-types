...
1. Write the JSON schema describing your resource, `tf-tencentcloud-monitorpolicygroup.json`
2. Implement your resource handlers in `tf_tencentcloud_monitorpolicygroup/handlers.py`
