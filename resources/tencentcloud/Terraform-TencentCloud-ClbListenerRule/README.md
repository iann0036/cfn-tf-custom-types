...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-clblistenerrule.json`
2. Implement your resource handlers in `terraform_tencentcloud_clblistenerrule/handlers.py`
