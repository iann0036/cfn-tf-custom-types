...
1. Write the JSON schema describing your resource, `tf-tencentcloud-cbsstorage.json`
2. Implement your resource handlers in `tf_tencentcloud_cbsstorage/handlers.py`
