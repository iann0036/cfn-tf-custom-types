...
1. Write the JSON schema describing your resource, `tf-tencentcloud-ssmsecret.json`
2. Implement your resource handlers in `tf_tencentcloud_ssmsecret/handlers.py`
