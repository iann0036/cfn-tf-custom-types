...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-keypair.json`
2. Implement your resource handlers in `terraform_tencentcloud_keypair/handlers.py`
