...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-gaaphttpdomain.json`
2. Implement your resource handlers in `terraform_tencentcloud_gaaphttpdomain/handlers.py`
