...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserverreadonlyinstance.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserverreadonlyinstance/handlers.py`
