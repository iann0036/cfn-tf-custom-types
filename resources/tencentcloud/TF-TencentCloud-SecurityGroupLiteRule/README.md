...
1. Write the JSON schema describing your resource, `tf-tencentcloud-securitygroupliterule.json`
2. Implement your resource handlers in `tf_tencentcloud_securitygroupliterule/handlers.py`
