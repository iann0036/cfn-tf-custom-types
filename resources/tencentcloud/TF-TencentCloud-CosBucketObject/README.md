# TF::TencentCloud::CosBucketObject

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-cosbucketobject.json`
2. Implement your resource handlers in `tf_tencentcloud_cosbucketobject/handlers.py`
