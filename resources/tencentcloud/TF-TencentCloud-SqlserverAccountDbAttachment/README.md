...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserveraccountdbattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserveraccountdbattachment/handlers.py`
