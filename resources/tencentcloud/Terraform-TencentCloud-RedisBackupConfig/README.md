...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-redisbackupconfig.json`
2. Implement your resource handlers in `terraform_tencentcloud_redisbackupconfig/handlers.py`
