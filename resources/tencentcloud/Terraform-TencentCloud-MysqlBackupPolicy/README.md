...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-mysqlbackuppolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_mysqlbackuppolicy/handlers.py`
