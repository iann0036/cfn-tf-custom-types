...
1. Write the JSON schema describing your resource, `tf-tencentcloud-apigatewayapi.json`
2. Implement your resource handlers in `tf_tencentcloud_apigatewayapi/handlers.py`
