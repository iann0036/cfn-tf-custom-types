# TF::TencentCloud::DayuL7Rule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-dayul7rule.json`
2. Implement your resource handlers in `tf_tencentcloud_dayul7rule/handlers.py`
