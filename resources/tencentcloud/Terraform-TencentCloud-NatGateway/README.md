...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-natgateway.json`
2. Implement your resource handlers in `terraform_tencentcloud_natgateway/handlers.py`
