...
1. Write the JSON schema describing your resource, `tf-tencentcloud-sqlserverdb.json`
2. Implement your resource handlers in `tf_tencentcloud_sqlserverdb/handlers.py`
