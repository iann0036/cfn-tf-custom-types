...
TYPE_NAME = "TF::TencentCloud::Instance"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/tencentcloud_instance/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/tencentcloud_instance/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/tencentcloud_instance/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AllocatePublicIp=None, AvailabilityZone=None, CamRoleName=None, CdhHostId=None, CdhInstanceType=None, CreateTime=None, DisableMonitorService=None, DisableSecurityService=None, ExpiredTime=None, ForceDelete=None, Hostname=None, Id=None, ImageId=None, InstanceChargeType=None, InstanceChargeTypePrepaidPeriod=None, InstanceChargeTypePrepaidRenewFlag=None, InstanceName=None, InstanceStatus=None, InstanceType=None, InternetChargeType=None, InternetMaxBandwidthOut=None, KeepImageLogin=None, KeyName=None, Password=None, PlacementGroupId=None, PrivateIp=None, ProjectId=None, PublicIp=None, RunningFlag=None, SecurityGroups=None, SpotInstanceType=None, SpotMaxPrice=None, SubnetId=None, SystemDiskId=None, SystemDiskSize=None, SystemDiskType=None, Tags=None, UserData=None, UserDataRaw=None, VpcId=None, DataDisks=None)
