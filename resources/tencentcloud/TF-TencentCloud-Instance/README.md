...
1. Write the JSON schema describing your resource, `tf-tencentcloud-instance.json`
2. Implement your resource handlers in `tf_tencentcloud_instance/handlers.py`
