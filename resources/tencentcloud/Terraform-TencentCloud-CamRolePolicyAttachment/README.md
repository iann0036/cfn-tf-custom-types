...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-camrolepolicyattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_camrolepolicyattachment/handlers.py`
