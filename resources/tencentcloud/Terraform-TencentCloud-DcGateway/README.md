...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dcgateway.json`
2. Implement your resource handlers in `terraform_tencentcloud_dcgateway/handlers.py`
