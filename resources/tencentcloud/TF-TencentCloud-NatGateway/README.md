# TF::TencentCloud::NatGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-natgateway.json`
2. Implement your resource handlers in `tf_tencentcloud_natgateway/handlers.py`
