...
1. Write the JSON schema describing your resource, `tf-tencentcloud-tcrtoken.json`
2. Implement your resource handlers in `tf_tencentcloud_tcrtoken/handlers.py`
