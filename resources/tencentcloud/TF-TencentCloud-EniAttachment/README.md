# TF::TencentCloud::EniAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tencentcloud-eniattachment.json`
2. Implement your resource handlers in `tf_tencentcloud_eniattachment/handlers.py`
