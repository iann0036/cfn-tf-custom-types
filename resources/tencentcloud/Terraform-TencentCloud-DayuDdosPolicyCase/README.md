...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayuddospolicycase.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayuddospolicycase/handlers.py`
