...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayucchttppolicy.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayucchttppolicy/handlers.py`
