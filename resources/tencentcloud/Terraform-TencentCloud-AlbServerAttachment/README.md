...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-albserverattachment.json`
2. Implement your resource handlers in `terraform_tencentcloud_albserverattachment/handlers.py`
