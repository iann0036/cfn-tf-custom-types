...
1. Write the JSON schema describing your resource, `terraform-tencentcloud-dayul4rule.json`
2. Implement your resource handlers in `terraform_tencentcloud_dayul4rule/handlers.py`
