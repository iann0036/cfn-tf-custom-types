...
1. Write the JSON schema describing your resource, `tf-databricks-instancepool.json`
2. Implement your resource handlers in `tf_databricks_instancepool/handlers.py`
