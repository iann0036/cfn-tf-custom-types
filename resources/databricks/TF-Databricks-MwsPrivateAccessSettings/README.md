...
1. Write the JSON schema describing your resource, `tf-databricks-mwsprivateaccesssettings.json`
2. Implement your resource handlers in `tf_databricks_mwsprivateaccesssettings/handlers.py`
