...
1. Write the JSON schema describing your resource, `tf-databricks-ipaccesslist.json`
2. Implement your resource handlers in `tf_databricks_ipaccesslist/handlers.py`
