...
1. Write the JSON schema describing your resource, `tf-databricks-azureblobmount.json`
2. Implement your resource handlers in `tf_databricks_azureblobmount/handlers.py`
