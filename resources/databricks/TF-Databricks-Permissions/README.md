...
1. Write the JSON schema describing your resource, `tf-databricks-permissions.json`
2. Implement your resource handlers in `tf_databricks_permissions/handlers.py`
