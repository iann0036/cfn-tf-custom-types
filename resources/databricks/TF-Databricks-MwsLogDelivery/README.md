...
1. Write the JSON schema describing your resource, `tf-databricks-mwslogdelivery.json`
2. Implement your resource handlers in `tf_databricks_mwslogdelivery/handlers.py`
