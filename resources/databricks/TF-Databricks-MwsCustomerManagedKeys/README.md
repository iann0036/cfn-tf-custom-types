...
1. Write the JSON schema describing your resource, `tf-databricks-mwscustomermanagedkeys.json`
2. Implement your resource handlers in `tf_databricks_mwscustomermanagedkeys/handlers.py`
