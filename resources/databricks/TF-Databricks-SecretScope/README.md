# TF::Databricks::SecretScope

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-secretscope.json`
2. Implement your resource handlers in `tf_databricks_secretscope/handlers.py`
