# TF::Databricks::SecretAcl

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-secretacl.json`
2. Implement your resource handlers in `tf_databricks_secretacl/handlers.py`
