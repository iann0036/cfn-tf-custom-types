# TF::Databricks::Notebook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-notebook.json`
2. Implement your resource handlers in `tf_databricks_notebook/handlers.py`
