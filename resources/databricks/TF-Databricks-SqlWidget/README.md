...
1. Write the JSON schema describing your resource, `tf-databricks-sqlwidget.json`
2. Implement your resource handlers in `tf_databricks_sqlwidget/handlers.py`
