...
1. Write the JSON schema describing your resource, `tf-databricks-mwsworkspaces.json`
2. Implement your resource handlers in `tf_databricks_mwsworkspaces/handlers.py`
