# TF::Databricks::AzureAdlsGen1Mount

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-azureadlsgen1mount.json`
2. Implement your resource handlers in `tf_databricks_azureadlsgen1mount/handlers.py`
