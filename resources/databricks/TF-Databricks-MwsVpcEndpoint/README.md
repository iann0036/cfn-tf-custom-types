...
1. Write the JSON schema describing your resource, `tf-databricks-mwsvpcendpoint.json`
2. Implement your resource handlers in `tf_databricks_mwsvpcendpoint/handlers.py`
