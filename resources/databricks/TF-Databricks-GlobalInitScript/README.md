# TF::Databricks::GlobalInitScript

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-globalinitscript.json`
2. Implement your resource handlers in `tf_databricks_globalinitscript/handlers.py`
