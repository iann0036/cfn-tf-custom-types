# TF::Databricks::SqlDashboard

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-sqldashboard.json`
2. Implement your resource handlers in `tf_databricks_sqldashboard/handlers.py`
