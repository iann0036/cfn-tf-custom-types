...
1. Write the JSON schema describing your resource, `tf-databricks-azureadlsgen2mount.json`
2. Implement your resource handlers in `tf_databricks_azureadlsgen2mount/handlers.py`
