...
1. Write the JSON schema describing your resource, `tf-databricks-awss3mount.json`
2. Implement your resource handlers in `tf_databricks_awss3mount/handlers.py`
