# TF::Databricks::SqlQuery

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-databricks-sqlquery.json`
2. Implement your resource handlers in `tf_databricks_sqlquery/handlers.py`
