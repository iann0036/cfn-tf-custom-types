...
1. Write the JSON schema describing your resource, `tf-databricks-sqlendpoint.json`
2. Implement your resource handlers in `tf_databricks_sqlendpoint/handlers.py`
