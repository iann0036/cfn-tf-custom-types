...
1. Write the JSON schema describing your resource, `tf-databricks-serviceprincipal.json`
2. Implement your resource handlers in `tf_databricks_serviceprincipal/handlers.py`
