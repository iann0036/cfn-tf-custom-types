...
1. Write the JSON schema describing your resource, `tf-databricks-mwsstorageconfigurations.json`
2. Implement your resource handlers in `tf_databricks_mwsstorageconfigurations/handlers.py`
