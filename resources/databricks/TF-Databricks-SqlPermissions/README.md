...
1. Write the JSON schema describing your resource, `tf-databricks-sqlpermissions.json`
2. Implement your resource handlers in `tf_databricks_sqlpermissions/handlers.py`
