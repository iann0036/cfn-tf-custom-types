...
1. Write the JSON schema describing your resource, `tf-databricks-mwsnetworks.json`
2. Implement your resource handlers in `tf_databricks_mwsnetworks/handlers.py`
