...
1. Write the JSON schema describing your resource, `tf-databricks-mwscredentials.json`
2. Implement your resource handlers in `tf_databricks_mwscredentials/handlers.py`
