...
1. Write the JSON schema describing your resource, `tf-databricks-userinstanceprofile.json`
2. Implement your resource handlers in `tf_databricks_userinstanceprofile/handlers.py`
