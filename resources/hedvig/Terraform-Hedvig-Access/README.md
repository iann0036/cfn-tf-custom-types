...
1. Write the JSON schema describing your resource, `terraform-hedvig-access.json`
2. Implement your resource handlers in `terraform_hedvig_access/handlers.py`
