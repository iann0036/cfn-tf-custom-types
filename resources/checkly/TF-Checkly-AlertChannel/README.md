...
1. Write the JSON schema describing your resource, `tf-checkly-alertchannel.json`
2. Implement your resource handlers in `tf_checkly_alertchannel/handlers.py`
