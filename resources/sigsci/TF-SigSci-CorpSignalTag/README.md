...
1. Write the JSON schema describing your resource, `tf-sigsci-corpsignaltag.json`
2. Implement your resource handlers in `tf_sigsci_corpsignaltag/handlers.py`
