...
1. Write the JSON schema describing your resource, `tf-sigsci-sitetemplatedrule.json`
2. Implement your resource handlers in `tf_sigsci_sitetemplatedrule/handlers.py`
