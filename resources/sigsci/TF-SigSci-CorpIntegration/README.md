# TF::SigSci::CorpIntegration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sigsci-corpintegration.json`
2. Implement your resource handlers in `tf_sigsci_corpintegration/handlers.py`
