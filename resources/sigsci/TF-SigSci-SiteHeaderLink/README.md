...
1. Write the JSON schema describing your resource, `tf-sigsci-siteheaderlink.json`
2. Implement your resource handlers in `tf_sigsci_siteheaderlink/handlers.py`
