...
1. Write the JSON schema describing your resource, `tf-sigsci-sitesignaltag.json`
2. Implement your resource handlers in `tf_sigsci_sitesignaltag/handlers.py`
