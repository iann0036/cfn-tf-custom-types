...
1. Write the JSON schema describing your resource, `tf-sigsci-siteblocklist.json`
2. Implement your resource handlers in `tf_sigsci_siteblocklist/handlers.py`
