# TF::SigSci::SiteAllowlist

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sigsci-siteallowlist.json`
2. Implement your resource handlers in `tf_sigsci_siteallowlist/handlers.py`
