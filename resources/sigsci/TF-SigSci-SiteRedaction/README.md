# TF::SigSci::SiteRedaction

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sigsci-siteredaction.json`
2. Implement your resource handlers in `tf_sigsci_siteredaction/handlers.py`
