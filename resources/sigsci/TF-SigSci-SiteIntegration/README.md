...
1. Write the JSON schema describing your resource, `tf-sigsci-siteintegration.json`
2. Implement your resource handlers in `tf_sigsci_siteintegration/handlers.py`
