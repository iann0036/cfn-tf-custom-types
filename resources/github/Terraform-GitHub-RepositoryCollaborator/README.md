...
1. Write the JSON schema describing your resource, `terraform-github-repositorycollaborator.json`
2. Implement your resource handlers in `terraform_github_repositorycollaborator/handlers.py`
