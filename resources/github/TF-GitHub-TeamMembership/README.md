# TF::GitHub::TeamMembership

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-github-teammembership.json`
2. Implement your resource handlers in `tf_github_teammembership/handlers.py`
