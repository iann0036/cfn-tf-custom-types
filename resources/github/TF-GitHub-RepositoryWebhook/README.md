# TF::GitHub::RepositoryWebhook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-github-repositorywebhook.json`
2. Implement your resource handlers in `tf_github_repositorywebhook/handlers.py`
