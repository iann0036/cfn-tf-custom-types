...
1. Write the JSON schema describing your resource, `tf-github-repositorydeploykey.json`
2. Implement your resource handlers in `tf_github_repositorydeploykey/handlers.py`
