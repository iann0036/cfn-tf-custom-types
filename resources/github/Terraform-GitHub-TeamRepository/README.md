...
1. Write the JSON schema describing your resource, `terraform-github-teamrepository.json`
2. Implement your resource handlers in `terraform_github_teamrepository/handlers.py`
