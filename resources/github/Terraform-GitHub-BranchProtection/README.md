...
1. Write the JSON schema describing your resource, `terraform-github-branchprotection.json`
2. Implement your resource handlers in `terraform_github_branchprotection/handlers.py`
