...
def create_handler(
    ...
    try:
        ...
        tf['resource']['github_branch_protection'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['github_branch_protection'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
