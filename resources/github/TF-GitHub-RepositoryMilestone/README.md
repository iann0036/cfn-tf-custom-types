...
1. Write the JSON schema describing your resource, `tf-github-repositorymilestone.json`
2. Implement your resource handlers in `tf_github_repositorymilestone/handlers.py`
