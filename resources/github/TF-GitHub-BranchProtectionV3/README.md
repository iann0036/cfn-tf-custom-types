...
1. Write the JSON schema describing your resource, `tf-github-branchprotectionv3.json`
2. Implement your resource handlers in `tf_github_branchprotectionv3/handlers.py`
