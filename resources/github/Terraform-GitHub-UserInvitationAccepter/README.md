...
1. Write the JSON schema describing your resource, `terraform-github-userinvitationaccepter.json`
2. Implement your resource handlers in `terraform_github_userinvitationaccepter/handlers.py`
