...
1. Write the JSON schema describing your resource, `tf-github-repositoryenvironment.json`
2. Implement your resource handlers in `tf_github_repositoryenvironment/handlers.py`
