...
1. Write the JSON schema describing your resource, `tf-github-repositoryproject.json`
2. Implement your resource handlers in `tf_github_repositoryproject/handlers.py`
