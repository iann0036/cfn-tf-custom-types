...
1. Write the JSON schema describing your resource, `tf-github-actionsenvironmentsecret.json`
2. Implement your resource handlers in `tf_github_actionsenvironmentsecret/handlers.py`
