...
1. Write the JSON schema describing your resource, `terraform-github-projectcolumn.json`
2. Implement your resource handlers in `terraform_github_projectcolumn/handlers.py`
