...
1. Write the JSON schema describing your resource, `terraform-github-organizationwebhook.json`
2. Implement your resource handlers in `terraform_github_organizationwebhook/handlers.py`
