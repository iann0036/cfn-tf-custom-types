...
1. Write the JSON schema describing your resource, `terraform-github-issuelabel.json`
2. Implement your resource handlers in `terraform_github_issuelabel/handlers.py`
