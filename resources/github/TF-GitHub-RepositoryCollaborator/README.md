...
1. Write the JSON schema describing your resource, `tf-github-repositorycollaborator.json`
2. Implement your resource handlers in `tf_github_repositorycollaborator/handlers.py`
