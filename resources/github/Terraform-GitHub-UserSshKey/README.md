...
1. Write the JSON schema describing your resource, `terraform-github-usersshkey.json`
2. Implement your resource handlers in `terraform_github_usersshkey/handlers.py`
