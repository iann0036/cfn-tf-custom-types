...
1. Write the JSON schema describing your resource, `terraform-github-organizationblock.json`
2. Implement your resource handlers in `terraform_github_organizationblock/handlers.py`
