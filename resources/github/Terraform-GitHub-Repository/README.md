...
1. Write the JSON schema describing your resource, `terraform-github-repository.json`
2. Implement your resource handlers in `terraform_github_repository/handlers.py`
