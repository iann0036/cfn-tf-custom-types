...
1. Write the JSON schema describing your resource, `terraform-github-repositoryfile.json`
2. Implement your resource handlers in `terraform_github_repositoryfile/handlers.py`
