...
1. Write the JSON schema describing your resource, `terraform-github-membership.json`
2. Implement your resource handlers in `terraform_github_membership/handlers.py`
