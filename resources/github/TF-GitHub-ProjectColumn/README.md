...
1. Write the JSON schema describing your resource, `tf-github-projectcolumn.json`
2. Implement your resource handlers in `tf_github_projectcolumn/handlers.py`
