...
1. Write the JSON schema describing your resource, `tf-github-repositorypullrequest.json`
2. Implement your resource handlers in `tf_github_repositorypullrequest/handlers.py`
