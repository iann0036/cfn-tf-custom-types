...
1. Write the JSON schema describing your resource, `tf-github-branchprotection.json`
2. Implement your resource handlers in `tf_github_branchprotection/handlers.py`
