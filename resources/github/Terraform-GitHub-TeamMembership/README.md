...
1. Write the JSON schema describing your resource, `terraform-github-teammembership.json`
2. Implement your resource handlers in `terraform_github_teammembership/handlers.py`
