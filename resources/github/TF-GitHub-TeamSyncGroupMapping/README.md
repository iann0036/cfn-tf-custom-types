...
1. Write the JSON schema describing your resource, `tf-github-teamsyncgroupmapping.json`
2. Implement your resource handlers in `tf_github_teamsyncgroupmapping/handlers.py`
