...
1. Write the JSON schema describing your resource, `terraform-github-repositorywebhook.json`
2. Implement your resource handlers in `terraform_github_repositorywebhook/handlers.py`
