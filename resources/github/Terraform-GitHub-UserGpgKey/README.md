...
1. Write the JSON schema describing your resource, `terraform-github-usergpgkey.json`
2. Implement your resource handlers in `terraform_github_usergpgkey/handlers.py`
