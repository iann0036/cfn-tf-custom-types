# TF::GitHub::OrganizationWebhook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-github-organizationwebhook.json`
2. Implement your resource handlers in `tf_github_organizationwebhook/handlers.py`
