...
1. Write the JSON schema describing your resource, `tf-github-actionsorganizationsecret.json`
2. Implement your resource handlers in `tf_github_actionsorganizationsecret/handlers.py`
