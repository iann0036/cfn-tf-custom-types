...
1. Write the JSON schema describing your resource, `terraform-github-organizationproject.json`
2. Implement your resource handlers in `terraform_github_organizationproject/handlers.py`
