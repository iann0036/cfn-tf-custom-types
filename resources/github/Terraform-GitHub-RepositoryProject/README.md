...
1. Write the JSON schema describing your resource, `terraform-github-repositoryproject.json`
2. Implement your resource handlers in `terraform_github_repositoryproject/handlers.py`
