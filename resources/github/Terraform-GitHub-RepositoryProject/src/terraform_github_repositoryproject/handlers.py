...
def create_handler(
    ...
    try:
        ...
        tf['resource']['github_repository_project'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['github_repository_project'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
