...
1. Write the JSON schema describing your resource, `terraform-statuscake-test.json`
2. Implement your resource handlers in `terraform_statuscake_test/handlers.py`
