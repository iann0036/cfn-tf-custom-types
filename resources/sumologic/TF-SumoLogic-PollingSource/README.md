# TF::SumoLogic::PollingSource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sumologic-pollingsource.json`
2. Implement your resource handlers in `tf_sumologic_pollingsource/handlers.py`
