# TF::SumoLogic::CloudtrailSource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sumologic-cloudtrailsource.json`
2. Implement your resource handlers in `tf_sumologic_cloudtrailsource/handlers.py`
