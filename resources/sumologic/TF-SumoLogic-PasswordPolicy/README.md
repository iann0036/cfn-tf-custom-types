...
1. Write the JSON schema describing your resource, `tf-sumologic-passwordpolicy.json`
2. Implement your resource handlers in `tf_sumologic_passwordpolicy/handlers.py`
