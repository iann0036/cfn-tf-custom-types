# TF::SumoLogic::AwsInventorySource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sumologic-awsinventorysource.json`
2. Implement your resource handlers in `tf_sumologic_awsinventorysource/handlers.py`
