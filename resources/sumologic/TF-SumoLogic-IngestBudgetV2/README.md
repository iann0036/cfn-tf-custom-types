...
1. Write the JSON schema describing your resource, `tf-sumologic-ingestbudgetv2.json`
2. Implement your resource handlers in `tf_sumologic_ingestbudgetv2/handlers.py`
