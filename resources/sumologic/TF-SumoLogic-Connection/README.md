...
1. Write the JSON schema describing your resource, `tf-sumologic-connection.json`
2. Implement your resource handlers in `tf_sumologic_connection/handlers.py`
