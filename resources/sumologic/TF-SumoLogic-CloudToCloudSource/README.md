...
1. Write the JSON schema describing your resource, `tf-sumologic-cloudtocloudsource.json`
2. Implement your resource handlers in `tf_sumologic_cloudtocloudsource/handlers.py`
