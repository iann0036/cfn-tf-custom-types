...
1. Write the JSON schema describing your resource, `tf-sumologic-scheduledview.json`
2. Implement your resource handlers in `tf_sumologic_scheduledview/handlers.py`
