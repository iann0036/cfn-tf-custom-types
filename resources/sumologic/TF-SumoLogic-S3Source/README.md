# TF::SumoLogic::S3Source

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sumologic-s3source.json`
2. Implement your resource handlers in `tf_sumologic_s3source/handlers.py`
