...
1. Write the JSON schema describing your resource, `tf-sumologic-s3auditsource.json`
2. Implement your resource handlers in `tf_sumologic_s3auditsource/handlers.py`
