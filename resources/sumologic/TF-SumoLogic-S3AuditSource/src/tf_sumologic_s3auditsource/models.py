...
class PathDefinition(BaseModel):
    ...
    LimitToNamespaces: Optional[Sequence[str]]
    LimitToRegions: Optional[Sequence[str]]
    PathExpression: Optional[str]
    Type: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            LimitToNamespaces=json_data.get("LimitToNamespaces"),
            LimitToRegions=json_data.get("LimitToRegions"),
            PathExpression=json_data.get("PathExpression"),
            Type=json_data.get("Type"),
