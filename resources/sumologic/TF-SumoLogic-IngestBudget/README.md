...
1. Write the JSON schema describing your resource, `tf-sumologic-ingestbudget.json`
2. Implement your resource handlers in `tf_sumologic_ingestbudget/handlers.py`
