# TF::SumoLogic::AwsXraySource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sumologic-awsxraysource.json`
2. Implement your resource handlers in `tf_sumologic_awsxraysource/handlers.py`
