...
1. Write the JSON schema describing your resource, `tf-sumologic-fieldextractionrule.json`
2. Implement your resource handlers in `tf_sumologic_fieldextractionrule/handlers.py`
