...
1. Write the JSON schema describing your resource, `tf-sumologic-samlconfiguration.json`
2. Implement your resource handlers in `tf_sumologic_samlconfiguration/handlers.py`
