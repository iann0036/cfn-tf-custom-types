...
1. Write the JSON schema describing your resource, `tf-sumologic-collectoringestbudgetassignment.json`
2. Implement your resource handlers in `tf_sumologic_collectoringestbudgetassignment/handlers.py`
