...
1. Write the JSON schema describing your resource, `tf-sumologic-monitorfolder.json`
2. Implement your resource handlers in `tf_sumologic_monitorfolder/handlers.py`
