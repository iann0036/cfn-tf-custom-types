# TF::ZeroTier::Identity

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-zerotier-identity.json`
2. Implement your resource handlers in `tf_zerotier_identity/handlers.py`
