...
1. Write the JSON schema describing your resource, `tf-alkira-credentialazurevnet.json`
2. Implement your resource handlers in `tf_alkira_credentialazurevnet/handlers.py`
