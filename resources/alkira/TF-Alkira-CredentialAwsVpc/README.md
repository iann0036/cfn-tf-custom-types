...
1. Write the JSON schema describing your resource, `tf-alkira-credentialawsvpc.json`
2. Implement your resource handlers in `tf_alkira_credentialawsvpc/handlers.py`
