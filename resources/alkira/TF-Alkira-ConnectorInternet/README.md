...
1. Write the JSON schema describing your resource, `tf-alkira-connectorinternet.json`
2. Implement your resource handlers in `tf_alkira_connectorinternet/handlers.py`
