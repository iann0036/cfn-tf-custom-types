...
1. Write the JSON schema describing your resource, `tf-alkira-connectoripsec.json`
2. Implement your resource handlers in `tf_alkira_connectoripsec/handlers.py`
