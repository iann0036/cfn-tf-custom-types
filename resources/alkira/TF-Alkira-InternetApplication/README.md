...
1. Write the JSON schema describing your resource, `tf-alkira-internetapplication.json`
2. Implement your resource handlers in `tf_alkira_internetapplication/handlers.py`
