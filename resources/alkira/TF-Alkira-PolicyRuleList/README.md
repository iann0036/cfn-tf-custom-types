# TF::Alkira::PolicyRuleList

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alkira-policyrulelist.json`
2. Implement your resource handlers in `tf_alkira_policyrulelist/handlers.py`
