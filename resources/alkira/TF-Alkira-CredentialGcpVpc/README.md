...
1. Write the JSON schema describing your resource, `tf-alkira-credentialgcpvpc.json`
2. Implement your resource handlers in `tf_alkira_credentialgcpvpc/handlers.py`
