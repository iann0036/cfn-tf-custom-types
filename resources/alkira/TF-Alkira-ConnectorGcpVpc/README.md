# TF::Alkira::ConnectorGcpVpc

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alkira-connectorgcpvpc.json`
2. Implement your resource handlers in `tf_alkira_connectorgcpvpc/handlers.py`
