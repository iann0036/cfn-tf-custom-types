...
1. Write the JSON schema describing your resource, `tf-alkira-tenantnetwork.json`
2. Implement your resource handlers in `tf_alkira_tenantnetwork/handlers.py`
