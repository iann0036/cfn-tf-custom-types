...
1. Write the JSON schema describing your resource, `tf-alkira-connectorawsvpc.json`
2. Implement your resource handlers in `tf_alkira_connectorawsvpc/handlers.py`
