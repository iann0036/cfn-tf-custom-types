...
1. Write the JSON schema describing your resource, `tf-dme-vanitynameserverrecord.json`
2. Implement your resource handlers in `tf_dme_vanitynameserverrecord/handlers.py`
