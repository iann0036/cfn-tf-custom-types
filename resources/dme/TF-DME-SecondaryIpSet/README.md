# TF::DME::SecondaryIpSet

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-dme-secondaryipset.json`
2. Implement your resource handlers in `tf_dme_secondaryipset/handlers.py`
