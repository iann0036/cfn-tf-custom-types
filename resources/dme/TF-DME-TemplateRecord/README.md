# TF::DME::TemplateRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-dme-templaterecord.json`
2. Implement your resource handlers in `tf_dme_templaterecord/handlers.py`
