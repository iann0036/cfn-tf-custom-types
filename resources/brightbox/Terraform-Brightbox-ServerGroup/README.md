...
1. Write the JSON schema describing your resource, `terraform-brightbox-servergroup.json`
2. Implement your resource handlers in `terraform_brightbox_servergroup/handlers.py`
