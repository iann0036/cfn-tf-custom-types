...
1. Write the JSON schema describing your resource, `terraform-brightbox-orbitcontainer.json`
2. Implement your resource handlers in `terraform_brightbox_orbitcontainer/handlers.py`
