...
1. Write the JSON schema describing your resource, `terraform-brightbox-databaseserver.json`
2. Implement your resource handlers in `terraform_brightbox_databaseserver/handlers.py`
