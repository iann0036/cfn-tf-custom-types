# TF::Brightbox::ServerGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-brightbox-servergroup.json`
2. Implement your resource handlers in `tf_brightbox_servergroup/handlers.py`
