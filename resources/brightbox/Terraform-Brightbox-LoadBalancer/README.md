...
1. Write the JSON schema describing your resource, `terraform-brightbox-loadbalancer.json`
2. Implement your resource handlers in `terraform_brightbox_loadbalancer/handlers.py`
