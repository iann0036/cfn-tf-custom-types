...
1. Write the JSON schema describing your resource, `terraform-brightbox-server.json`
2. Implement your resource handlers in `terraform_brightbox_server/handlers.py`
