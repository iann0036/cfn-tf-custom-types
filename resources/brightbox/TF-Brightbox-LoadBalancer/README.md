...
1. Write the JSON schema describing your resource, `tf-brightbox-loadbalancer.json`
2. Implement your resource handlers in `tf_brightbox_loadbalancer/handlers.py`
