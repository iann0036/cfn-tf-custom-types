...
1. Write the JSON schema describing your resource, `terraform-brightbox-firewallpolicy.json`
2. Implement your resource handlers in `terraform_brightbox_firewallpolicy/handlers.py`
