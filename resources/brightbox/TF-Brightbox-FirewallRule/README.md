# TF::Brightbox::FirewallRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-brightbox-firewallrule.json`
2. Implement your resource handlers in `tf_brightbox_firewallrule/handlers.py`
