...
1. Write the JSON schema describing your resource, `terraform-brightbox-firewallrule.json`
2. Implement your resource handlers in `terraform_brightbox_firewallrule/handlers.py`
