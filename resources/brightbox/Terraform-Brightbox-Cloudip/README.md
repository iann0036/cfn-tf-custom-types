...
1. Write the JSON schema describing your resource, `terraform-brightbox-cloudip.json`
2. Implement your resource handlers in `terraform_brightbox_cloudip/handlers.py`
