...
1. Write the JSON schema describing your resource, `terraform-brightbox-apiclient.json`
2. Implement your resource handlers in `terraform_brightbox_apiclient/handlers.py`
