# TF::Brightbox::DatabaseServer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-brightbox-databaseserver.json`
2. Implement your resource handlers in `tf_brightbox_databaseserver/handlers.py`
