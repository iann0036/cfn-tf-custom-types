...
TYPE_NAME = "TF::FortiOS::SwitchcontrollerManagedswitch"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_switchcontroller_managedswitch/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_switchcontroller_managedswitch',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_switchcontroller_managedswitch/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_switchcontroller_managedswitch/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccessProfile=None, DelayedRestartTrigger=None, Description=None, DirectlyConnected=None, DynamicCapability=None, DynamicSortSubtable=None, DynamicallyDiscovered=None, FirmwareProvision=None, FirmwareProvisionVersion=None, FlowIdentity=None, FswWan1Admin=None, FswWan1Peer=None, FswWan2Admin=None, FswWan2Peer=None, Id=None, L3Discovered=None, MaxAllowedTrunkMembers=None, MclagIgmpSnoopingAware=None, Name=None, OverrideSnmpCommunity=None, OverrideSnmpSysinfo=None, OverrideSnmpTrapThreshold=None, OverrideSnmpUser=None, OwnerVdom=None, PoeDetectionType=None, PoeLldpDetection=None, PoePreStandardDetection=None, PreProvisioned=None, QosDropPolicy=None, QosRedProbability=None, StagedImageVersion=None, SwitchDeviceTag=None, SwitchDhcpOpt43Key=None, SwitchId=None, SwitchProfile=None, TdrSupported=None, Type=None, Vdomparam=None, Version=None, CustomCommand=None, IgmpSnooping=None, IpSourceGuard=None, Mirror=None, N8021xSettings=None, Ports=None, RemoteLog=None, SnmpCommunity=None, SnmpSysinfo=None, SnmpTrapThreshold=None, SnmpUser=None, StaticMac=None, StormControl=None, StpInstance=None, StpSettings=None, SwitchLog=None, SwitchStpSettings=None)
