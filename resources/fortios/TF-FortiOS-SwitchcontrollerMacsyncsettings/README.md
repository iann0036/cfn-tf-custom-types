# TF::FortiOS::SwitchcontrollerMacsyncsettings

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollermacsyncsettings.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollermacsyncsettings/handlers.py`
