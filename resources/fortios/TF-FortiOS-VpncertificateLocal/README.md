...
1. Write the JSON schema describing your resource, `tf-fortios-vpncertificatelocal.json`
2. Implement your resource handlers in `tf_fortios_vpncertificatelocal/handlers.py`
