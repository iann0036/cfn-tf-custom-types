...
1. Write the JSON schema describing your resource, `tf-fortios-routermulticastflow.json`
2. Implement your resource handlers in `tf_fortios_routermulticastflow/handlers.py`
