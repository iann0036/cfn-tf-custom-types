...
1. Write the JSON schema describing your resource, `tf-fortios-fmgdevicemanagerinstallpolicypackage.json`
2. Implement your resource handlers in `tf_fortios_fmgdevicemanagerinstallpolicypackage/handlers.py`
