...
1. Write the JSON schema describing your resource, `tf-fortios-networkinginterfaceport.json`
2. Implement your resource handlers in `tf_fortios_networkinginterfaceport/handlers.py`
