...
1. Write the JSON schema describing your resource, `tf-fortios-systemautomationaction.json`
2. Implement your resource handlers in `tf_fortios_systemautomationaction/handlers.py`
