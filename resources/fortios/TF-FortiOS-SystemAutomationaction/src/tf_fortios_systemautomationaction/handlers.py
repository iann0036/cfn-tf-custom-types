...
TYPE_NAME = "TF::FortiOS::SystemAutomationaction"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_automationaction/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_system_automationaction',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_automationaction/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_system_automationaction/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Accprofile=None, ActionType=None, AlicloudAccessKeyId=None, AlicloudAccessKeySecret=None, AlicloudAccountId=None, AlicloudFunction=None, AlicloudFunctionAuthorization=None, AlicloudFunctionDomain=None, AlicloudRegion=None, AlicloudService=None, AlicloudVersion=None, AwsApiId=None, AwsApiKey=None, AwsApiPath=None, AwsApiStage=None, AwsDomain=None, AwsRegion=None, AzureApiKey=None, AzureApp=None, AzureDomain=None, AzureFunction=None, AzureFunctionAuthorization=None, Delay=None, DynamicSortSubtable=None, EmailBody=None, EmailFrom=None, EmailSubject=None, GcpFunction=None, GcpFunctionDomain=None, GcpFunctionRegion=None, GcpProject=None, HttpBody=None, Id=None, Message=None, Method=None, MinimumInterval=None, Name=None, Port=None, Protocol=None, ReplacementMessage=None, Required=None, Script=None, SecurityTag=None, TlsCertificate=None, Uri=None, Vdomparam=None, EmailTo=None, Headers=None, SdnConnector=None)
