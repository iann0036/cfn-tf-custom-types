...
1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolsettings.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolsettings/handlers.py`
