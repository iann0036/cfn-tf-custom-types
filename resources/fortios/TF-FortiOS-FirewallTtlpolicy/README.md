...
1. Write the JSON schema describing your resource, `tf-fortios-firewallttlpolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallttlpolicy/handlers.py`
