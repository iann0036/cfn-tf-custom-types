...
1. Write the JSON schema describing your resource, `tf-fortios-systemmobiletunnel.json`
2. Implement your resource handlers in `tf_fortios_systemmobiletunnel/handlers.py`
