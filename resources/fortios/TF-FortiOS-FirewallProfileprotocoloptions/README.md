...
1. Write the JSON schema describing your resource, `tf-fortios-firewallprofileprotocoloptions.json`
2. Implement your resource handlers in `tf_fortios_firewallprofileprotocoloptions/handlers.py`
