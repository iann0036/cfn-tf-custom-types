...
1. Write the JSON schema describing your resource, `tf-fortios-webproxyexplicit.json`
2. Implement your resource handlers in `tf_fortios_webproxyexplicit/handlers.py`
