...
1. Write the JSON schema describing your resource, `tf-fortios-reportsetting.json`
2. Implement your resource handlers in `tf_fortios_reportsetting/handlers.py`
