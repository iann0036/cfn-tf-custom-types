...
1. Write the JSON schema describing your resource, `tf-fortios-routerospf6ospf6interface.json`
2. Implement your resource handlers in `tf_fortios_routerospf6ospf6interface/handlers.py`
