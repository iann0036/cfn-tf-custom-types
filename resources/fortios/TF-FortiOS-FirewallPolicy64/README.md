# TF::FortiOS::FirewallPolicy64

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallpolicy64.json`
2. Implement your resource handlers in `tf_fortios_firewallpolicy64/handlers.py`
