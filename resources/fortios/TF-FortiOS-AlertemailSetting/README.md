...
1. Write the JSON schema describing your resource, `tf-fortios-alertemailsetting.json`
2. Implement your resource handlers in `tf_fortios_alertemailsetting/handlers.py`
