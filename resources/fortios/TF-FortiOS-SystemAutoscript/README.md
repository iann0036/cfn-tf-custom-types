...
1. Write the JSON schema describing your resource, `tf-fortios-systemautoscript.json`
2. Implement your resource handlers in `tf_fortios_systemautoscript/handlers.py`
