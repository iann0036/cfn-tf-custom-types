# TF::FortiOS::SystemLicenseVdom

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemlicensevdom.json`
2. Implement your resource handlers in `tf_fortios_systemlicensevdom/handlers.py`
