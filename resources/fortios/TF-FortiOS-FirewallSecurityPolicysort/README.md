...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsecuritypolicysort.json`
2. Implement your resource handlers in `tf_fortios_firewallsecuritypolicysort/handlers.py`
