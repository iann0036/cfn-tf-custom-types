# TF::FortiOS::FirewallProxyaddrgrp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallproxyaddrgrp.json`
2. Implement your resource handlers in `tf_fortios_firewallproxyaddrgrp/handlers.py`
