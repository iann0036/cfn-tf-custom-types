...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollervlan.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollervlan/handlers.py`
