# TF::FortiOS::SpamfilterIptrust

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-spamfilteriptrust.json`
2. Implement your resource handlers in `tf_fortios_spamfilteriptrust/handlers.py`
