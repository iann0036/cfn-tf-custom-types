...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollersetting.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollersetting/handlers.py`
