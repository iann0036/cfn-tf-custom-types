...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerwagprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerwagprofile/handlers.py`
