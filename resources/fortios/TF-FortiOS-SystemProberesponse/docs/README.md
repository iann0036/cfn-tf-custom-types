...
<pre>
{
    "Type" : "TF::FortiOS::SystemProberesponse",
    "Properties" : {
        "<a href="#httpprobevalue" title="HttpProbeValue">HttpProbeValue</a>" : <i>String</i>,
        "<a href="#mode" title="Mode">Mode</a>" : <i>String</i>,
        "<a href="#password" title="Password">Password</a>" : <i>String</i>,
        "<a href="#port" title="Port">Port</a>" : <i>Double</i>,
        "<a href="#securitymode" title="SecurityMode">SecurityMode</a>" : <i>String</i>,
        "<a href="#timeout" title="Timeout">Timeout</a>" : <i>Double</i>,
        "<a href="#ttlmode" title="TtlMode">TtlMode</a>" : <i>String</i>,
