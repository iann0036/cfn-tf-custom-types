...
1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetservice.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetservice/handlers.py`
