# TF::FortiOS::FirewallMulticastpolicy6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallmulticastpolicy6.json`
2. Implement your resource handlers in `tf_fortios_firewallmulticastpolicy6/handlers.py`
