# TF::FortiOS::RouterKeychain

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-routerkeychain.json`
2. Implement your resource handlers in `tf_fortios_routerkeychain/handlers.py`
