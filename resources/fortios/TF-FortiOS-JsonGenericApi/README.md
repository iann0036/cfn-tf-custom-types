...
1. Write the JSON schema describing your resource, `tf-fortios-jsongenericapi.json`
2. Implement your resource handlers in `tf_fortios_jsongenericapi/handlers.py`
