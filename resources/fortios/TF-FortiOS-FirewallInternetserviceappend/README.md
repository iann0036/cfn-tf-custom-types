# TF::FortiOS::FirewallInternetserviceappend

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetserviceappend.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetserviceappend/handlers.py`
