...
1. Write the JSON schema describing your resource, `tf-fortios-systemvdomsetting.json`
2. Implement your resource handlers in `tf_fortios_systemvdomsetting/handlers.py`
