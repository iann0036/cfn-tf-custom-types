...
1. Write the JSON schema describing your resource, `tf-fortios-fmgobjectadomrevision.json`
2. Implement your resource handlers in `tf_fortios_fmgobjectadomrevision/handlers.py`
