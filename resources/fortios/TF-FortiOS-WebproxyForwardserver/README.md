...
1. Write the JSON schema describing your resource, `tf-fortios-webproxyforwardserver.json`
2. Implement your resource handlers in `tf_fortios_webproxyforwardserver/handlers.py`
