...
1. Write the JSON schema describing your resource, `tf-fortios-fmgfirewallobjectvip.json`
2. Implement your resource handlers in `tf_fortios_fmgfirewallobjectvip/handlers.py`
