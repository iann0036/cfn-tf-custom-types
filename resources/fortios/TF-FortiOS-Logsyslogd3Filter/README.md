# TF::FortiOS::Logsyslogd3Filter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logsyslogd3filter.json`
2. Implement your resource handlers in `tf_fortios_logsyslogd3filter/handlers.py`
