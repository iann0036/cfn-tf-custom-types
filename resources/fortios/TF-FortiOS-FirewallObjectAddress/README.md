...
1. Write the JSON schema describing your resource, `tf-fortios-firewallobjectaddress.json`
2. Implement your resource handlers in `tf_fortios_firewallobjectaddress/handlers.py`
