...
1. Write the JSON schema describing your resource, `tf-fortios-firewallshapertrafficshaper.json`
2. Implement your resource handlers in `tf_fortios_firewallshapertrafficshaper/handlers.py`
