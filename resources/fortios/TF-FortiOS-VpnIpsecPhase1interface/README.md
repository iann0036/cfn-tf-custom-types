# TF::FortiOS::VpnIpsecPhase1interface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecphase1interface.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecphase1interface/handlers.py`
