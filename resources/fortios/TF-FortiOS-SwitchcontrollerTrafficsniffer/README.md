...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollertrafficsniffer.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollertrafficsniffer/handlers.py`
