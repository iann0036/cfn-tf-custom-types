...
1. Write the JSON schema describing your resource, `tf-fortios-systemresourcelimits.json`
2. Implement your resource handlers in `tf_fortios_systemresourcelimits/handlers.py`
