...
1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecphase1.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecphase1/handlers.py`
