...
1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolfctems.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolfctems/handlers.py`
