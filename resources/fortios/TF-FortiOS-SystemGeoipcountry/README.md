# TF::FortiOS::SystemGeoipcountry

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemgeoipcountry.json`
2. Implement your resource handlers in `tf_fortios_systemgeoipcountry/handlers.py`
