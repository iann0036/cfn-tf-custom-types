...
1. Write the JSON schema describing your resource, `tf-fortios-firewallregion.json`
2. Implement your resource handlers in `tf_fortios_firewallregion/handlers.py`
