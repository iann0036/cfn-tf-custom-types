...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptcacheservice.json`
2. Implement your resource handlers in `tf_fortios_wanoptcacheservice/handlers.py`
