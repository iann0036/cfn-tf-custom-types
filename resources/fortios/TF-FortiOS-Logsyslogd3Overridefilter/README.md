...
1. Write the JSON schema describing your resource, `tf-fortios-logsyslogd3overridefilter.json`
2. Implement your resource handlers in `tf_fortios_logsyslogd3overridefilter/handlers.py`
