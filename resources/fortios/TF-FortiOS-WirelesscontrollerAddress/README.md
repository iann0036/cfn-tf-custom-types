# TF::FortiOS::WirelesscontrollerAddress

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrolleraddress.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrolleraddress/handlers.py`
