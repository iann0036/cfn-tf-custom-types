...
1. Write the JSON schema describing your resource, `tf-fortios-firewallconsolidatedpolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallconsolidatedpolicy/handlers.py`
