...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerregion.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerregion/handlers.py`
