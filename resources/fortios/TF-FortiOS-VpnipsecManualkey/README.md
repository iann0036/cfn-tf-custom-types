...
1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecmanualkey.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecmanualkey/handlers.py`
