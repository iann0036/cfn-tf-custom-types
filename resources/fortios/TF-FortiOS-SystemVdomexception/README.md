...
1. Write the JSON schema describing your resource, `tf-fortios-systemvdomexception.json`
2. Implement your resource handlers in `tf_fortios_systemvdomexception/handlers.py`
