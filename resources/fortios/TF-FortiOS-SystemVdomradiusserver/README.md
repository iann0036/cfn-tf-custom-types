# TF::FortiOS::SystemVdomradiusserver

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemvdomradiusserver.json`
2. Implement your resource handlers in `tf_fortios_systemvdomradiusserver/handlers.py`
