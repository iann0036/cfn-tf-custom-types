...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollervlanpolicy.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollervlanpolicy/handlers.py`
