# TF::FortiOS::SystemAutoinstall

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemautoinstall.json`
2. Implement your resource handlers in `tf_fortios_systemautoinstall/handlers.py`
