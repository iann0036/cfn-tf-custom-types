...
1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetservicename.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetservicename/handlers.py`
