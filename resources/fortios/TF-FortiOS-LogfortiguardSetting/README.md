...
1. Write the JSON schema describing your resource, `tf-fortios-logfortiguardsetting.json`
2. Implement your resource handlers in `tf_fortios_logfortiguardsetting/handlers.py`
