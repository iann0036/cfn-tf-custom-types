...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerglobal.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerglobal/handlers.py`
