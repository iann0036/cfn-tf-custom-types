...
1. Write the JSON schema describing your resource, `tf-fortios-certificatecrl.json`
2. Implement your resource handlers in `tf_fortios_certificatecrl/handlers.py`
