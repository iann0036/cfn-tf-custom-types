...
1. Write the JSON schema describing your resource, `tf-fortios-dnsfilterprofile.json`
2. Implement your resource handlers in `tf_fortios_dnsfilterprofile/handlers.py`
