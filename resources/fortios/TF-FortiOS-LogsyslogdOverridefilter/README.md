# TF::FortiOS::LogsyslogdOverridefilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logsyslogdoverridefilter.json`
2. Implement your resource handlers in `tf_fortios_logsyslogdoverridefilter/handlers.py`
