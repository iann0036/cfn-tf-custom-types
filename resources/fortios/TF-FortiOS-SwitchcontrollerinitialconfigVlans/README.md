# TF::FortiOS::SwitchcontrollerinitialconfigVlans

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerinitialconfigvlans.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerinitialconfigvlans/handlers.py`
