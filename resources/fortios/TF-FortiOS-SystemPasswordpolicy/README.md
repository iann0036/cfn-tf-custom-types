...
1. Write the JSON schema describing your resource, `tf-fortios-systempasswordpolicy.json`
2. Implement your resource handlers in `tf_fortios_systempasswordpolicy/handlers.py`
