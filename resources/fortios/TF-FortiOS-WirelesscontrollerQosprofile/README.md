...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerqosprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerqosprofile/handlers.py`
