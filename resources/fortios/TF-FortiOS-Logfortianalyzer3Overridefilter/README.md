# TF::FortiOS::Logfortianalyzer3Overridefilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logfortianalyzer3overridefilter.json`
2. Implement your resource handlers in `tf_fortios_logfortianalyzer3overridefilter/handlers.py`
