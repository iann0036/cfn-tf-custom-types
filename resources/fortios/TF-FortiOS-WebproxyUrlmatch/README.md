...
1. Write the JSON schema describing your resource, `tf-fortios-webproxyurlmatch.json`
2. Implement your resource handlers in `tf_fortios_webproxyurlmatch/handlers.py`
