...
1. Write the JSON schema describing your resource, `tf-fortios-reportlayout.json`
2. Implement your resource handlers in `tf_fortios_reportlayout/handlers.py`
