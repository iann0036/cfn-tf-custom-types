# TF::FortiOS::Logfortianalyzer2Filter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logfortianalyzer2filter.json`
2. Implement your resource handlers in `tf_fortios_logfortianalyzer2filter/handlers.py`
