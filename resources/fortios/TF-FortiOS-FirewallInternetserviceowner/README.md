# TF::FortiOS::FirewallInternetserviceowner

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetserviceowner.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetserviceowner/handlers.py`
