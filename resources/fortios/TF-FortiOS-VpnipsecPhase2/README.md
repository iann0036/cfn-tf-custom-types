# TF::FortiOS::VpnipsecPhase2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecphase2.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecphase2/handlers.py`
