...
1. Write the JSON schema describing your resource, `tf-fortios-antivirussettings.json`
2. Implement your resource handlers in `tf_fortios_antivirussettings/handlers.py`
