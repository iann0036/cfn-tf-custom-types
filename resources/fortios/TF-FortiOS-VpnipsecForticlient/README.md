...
1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecforticlient.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecforticlient/handlers.py`
