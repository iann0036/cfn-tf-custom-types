...
1. Write the JSON schema describing your resource, `tf-fortios-fmgdevicemanagerdevice.json`
2. Implement your resource handlers in `tf_fortios_fmgdevicemanagerdevice/handlers.py`
