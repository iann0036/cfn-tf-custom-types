# TF::FortiOS::SystemSmsserver

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemsmsserver.json`
2. Implement your resource handlers in `tf_fortios_systemsmsserver/handlers.py`
