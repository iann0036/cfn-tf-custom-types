...
1. Write the JSON schema describing your resource, `tf-fortios-systemnetworkvisibility.json`
2. Implement your resource handlers in `tf_fortios_systemnetworkvisibility/handlers.py`
