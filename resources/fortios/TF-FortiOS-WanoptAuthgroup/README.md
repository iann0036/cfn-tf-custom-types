...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptauthgroup.json`
2. Implement your resource handlers in `tf_fortios_wanoptauthgroup/handlers.py`
