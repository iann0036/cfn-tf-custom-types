...
1. Write the JSON schema describing your resource, `tf-fortios-fmgdevicemanagerscriptexecute.json`
2. Implement your resource handlers in `tf_fortios_fmgdevicemanagerscriptexecute/handlers.py`
