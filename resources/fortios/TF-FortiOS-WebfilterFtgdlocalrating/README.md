# TF::FortiOS::WebfilterFtgdlocalrating

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-webfilterftgdlocalrating.json`
2. Implement your resource handlers in `tf_fortios_webfilterftgdlocalrating/handlers.py`
