# TF::FortiOS::WafSignature

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-wafsignature.json`
2. Implement your resource handlers in `tf_fortios_wafsignature/handlers.py`
