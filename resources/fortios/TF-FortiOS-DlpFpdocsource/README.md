...
1. Write the JSON schema describing your resource, `tf-fortios-dlpfpdocsource.json`
2. Implement your resource handlers in `tf_fortios_dlpfpdocsource/handlers.py`
