...
1. Write the JSON schema describing your resource, `tf-fortios-fmgfirewallobjectaddress.json`
2. Implement your resource handlers in `tf_fortios_fmgfirewallobjectaddress/handlers.py`
