# TF::FortiOS::VpnsslwebHostchecksoftware

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-vpnsslwebhostchecksoftware.json`
2. Implement your resource handlers in `tf_fortios_vpnsslwebhostchecksoftware/handlers.py`
