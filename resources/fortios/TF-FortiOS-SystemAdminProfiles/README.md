...
1. Write the JSON schema describing your resource, `tf-fortios-systemadminprofiles.json`
2. Implement your resource handlers in `tf_fortios_systemadminprofiles/handlers.py`
