...
1. Write the JSON schema describing your resource, `tf-fortios-firewallproxyaddress.json`
2. Implement your resource handlers in `tf_fortios_firewallproxyaddress/handlers.py`
