# TF::FortiOS::WafMainclass

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-wafmainclass.json`
2. Implement your resource handlers in `tf_fortios_wafmainclass/handlers.py`
