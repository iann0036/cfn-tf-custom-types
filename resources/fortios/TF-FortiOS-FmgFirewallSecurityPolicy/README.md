...
1. Write the JSON schema describing your resource, `tf-fortios-fmgfirewallsecuritypolicy.json`
2. Implement your resource handlers in `tf_fortios_fmgfirewallsecuritypolicy/handlers.py`
