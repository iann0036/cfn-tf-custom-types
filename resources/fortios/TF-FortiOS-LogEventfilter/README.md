...
1. Write the JSON schema describing your resource, `tf-fortios-logeventfilter.json`
2. Implement your resource handlers in `tf_fortios_logeventfilter/handlers.py`
