...
1. Write the JSON schema describing your resource, `tf-fortios-firewallproxypolicymove.json`
2. Implement your resource handlers in `tf_fortios_firewallproxypolicymove/handlers.py`
