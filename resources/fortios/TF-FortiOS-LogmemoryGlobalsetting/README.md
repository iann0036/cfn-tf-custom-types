...
1. Write the JSON schema describing your resource, `tf-fortios-logmemoryglobalsetting.json`
2. Implement your resource handlers in `tf_fortios_logmemoryglobalsetting/handlers.py`
