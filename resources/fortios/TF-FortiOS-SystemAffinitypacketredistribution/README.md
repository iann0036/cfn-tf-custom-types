...
1. Write the JSON schema describing your resource, `tf-fortios-systemaffinitypacketredistribution.json`
2. Implement your resource handlers in `tf_fortios_systemaffinitypacketredistribution/handlers.py`
