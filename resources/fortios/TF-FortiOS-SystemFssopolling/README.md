# TF::FortiOS::SystemFssopolling

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemfssopolling.json`
2. Implement your resource handlers in `tf_fortios_systemfssopolling/handlers.py`
