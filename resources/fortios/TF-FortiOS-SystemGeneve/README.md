...
1. Write the JSON schema describing your resource, `tf-fortios-systemgeneve.json`
2. Implement your resource handlers in `tf_fortios_systemgeneve/handlers.py`
