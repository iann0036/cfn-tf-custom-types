...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerutmprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerutmprofile/handlers.py`
