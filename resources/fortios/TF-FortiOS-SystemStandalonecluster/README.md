...
1. Write the JSON schema describing your resource, `tf-fortios-systemstandalonecluster.json`
2. Implement your resource handlers in `tf_fortios_systemstandalonecluster/handlers.py`
