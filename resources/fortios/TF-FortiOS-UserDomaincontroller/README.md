...
1. Write the JSON schema describing your resource, `tf-fortios-userdomaincontroller.json`
2. Implement your resource handlers in `tf_fortios_userdomaincontroller/handlers.py`
