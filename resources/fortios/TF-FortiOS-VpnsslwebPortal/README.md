...
1. Write the JSON schema describing your resource, `tf-fortios-vpnsslwebportal.json`
2. Implement your resource handlers in `tf_fortios_vpnsslwebportal/handlers.py`
