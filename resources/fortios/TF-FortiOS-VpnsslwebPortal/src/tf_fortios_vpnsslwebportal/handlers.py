...
TYPE_NAME = "TF::FortiOS::VpnsslwebPortal"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_vpnsslweb_portal/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_vpnsslweb_portal',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_vpnsslweb_portal/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_vpnsslweb_portal/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AllowUserAccess=None, AutoConnect=None, CustomLang=None, CustomizeForticlientDownloadUrl=None, DisplayBookmark=None, DisplayConnectionTools=None, DisplayHistory=None, DisplayStatus=None, DnsServer1=None, DnsServer2=None, DnsSuffix=None, DynamicSortSubtable=None, ExclusiveRouting=None, ForticlientDownload=None, ForticlientDownloadMethod=None, Heading=None, HideSsoCredential=None, HostCheck=None, HostCheckInterval=None, Id=None, IpMode=None, Ipv6DnsServer1=None, Ipv6DnsServer2=None, Ipv6ExclusiveRouting=None, Ipv6ServiceRestriction=None, Ipv6SplitTunneling=None, Ipv6SplitTunnelingRoutingNegate=None, Ipv6TunnelMode=None, Ipv6WinsServer1=None, Ipv6WinsServer2=None, KeepAlive=None, LimitUserLogins=None, MacAddrAction=None, MacAddrCheck=None, MacosForticlientDownloadUrl=None, Name=None, OsCheck=None, RedirUrl=None, SavePassword=None, ServiceRestriction=None, SkipCheckForBrowser=None, SkipCheckForUnsupportedOs=None, SmbMaxVersion=None, SmbMinVersion=None, SmbNtlmv1Auth=None, Smbv1=None, SplitTunneling=None, SplitTunnelingRoutingNegate=None, Theme=None, TransformBackwardSlashes=None, TunnelMode=None, UseSdwan=None, UserBookmark=None, UserGroupBookmark=None, Vdomparam=None, WebMode=None, WindowsForticlientDownloadUrl=None, WinsServer1=None, WinsServer2=None, BookmarkGroup=None, HostCheckPolicy=None, IpPools=None, Ipv6Pools=None, Ipv6SplitTunnelingRoutingAddress=None, MacAddrCheckRule=None, OsCheckList=None, SplitDns=None, SplitTunnelingRoutingAddress=None)
