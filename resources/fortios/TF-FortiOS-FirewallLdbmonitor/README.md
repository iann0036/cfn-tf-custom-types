...
1. Write the JSON schema describing your resource, `tf-fortios-firewallldbmonitor.json`
2. Implement your resource handlers in `tf_fortios_firewallldbmonitor/handlers.py`
