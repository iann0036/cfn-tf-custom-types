...
1. Write the JSON schema describing your resource, `tf-fortios-systemipiptunnel.json`
2. Implement your resource handlers in `tf_fortios_systemipiptunnel/handlers.py`
