...
1. Write the JSON schema describing your resource, `tf-fortios-routerpolicy6.json`
2. Implement your resource handlers in `tf_fortios_routerpolicy6/handlers.py`
