# TF::FortiOS::Logsyslogd2Overridefilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logsyslogd2overridefilter.json`
2. Implement your resource handlers in `tf_fortios_logsyslogd2overridefilter/handlers.py`
