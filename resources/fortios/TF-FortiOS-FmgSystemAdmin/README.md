...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemadmin.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemadmin/handlers.py`
