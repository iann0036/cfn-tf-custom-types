...
1. Write the JSON schema describing your resource, `tf-fortios-userexchange.json`
2. Implement your resource handlers in `tf_fortios_userexchange/handlers.py`
