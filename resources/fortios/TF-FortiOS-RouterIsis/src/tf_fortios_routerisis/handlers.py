...
TYPE_NAME = "TF::FortiOS::RouterIsis"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_router_isis/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_router_isis',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_router_isis/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_router_isis/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AdjacencyCheck=None, AdjacencyCheck6=None, AdvPassiveOnly=None, AdvPassiveOnly6=None, AuthKeychainL1=None, AuthKeychainL2=None, AuthModeL1=None, AuthModeL2=None, AuthPasswordL1=None, AuthPasswordL2=None, AuthSendonlyL1=None, AuthSendonlyL2=None, DefaultOriginate=None, DefaultOriginate6=None, DynamicHostname=None, DynamicSortSubtable=None, Id=None, IgnoreLspErrors=None, IsType=None, LspGenIntervalL1=None, LspGenIntervalL2=None, LspRefreshInterval=None, MaxLspLifetime=None, MetricStyle=None, OverloadBit=None, OverloadBitOnStartup=None, OverloadBitSuppress=None, Redistribute6L1=None, Redistribute6L1List=None, Redistribute6L2=None, Redistribute6L2List=None, RedistributeL1=None, RedistributeL1List=None, RedistributeL2=None, RedistributeL2List=None, SpfIntervalExpL1=None, SpfIntervalExpL2=None, Vdomparam=None, IsisInterface=None, IsisNet=None, Redistribute=None, Redistribute6=None, SummaryAddress=None, SummaryAddress6=None)
