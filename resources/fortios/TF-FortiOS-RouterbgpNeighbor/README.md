# TF::FortiOS::RouterbgpNeighbor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-routerbgpneighbor.json`
2. Implement your resource handlers in `tf_fortios_routerbgpneighbor/handlers.py`
