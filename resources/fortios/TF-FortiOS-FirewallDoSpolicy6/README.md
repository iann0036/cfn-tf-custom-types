...
1. Write the JSON schema describing your resource, `tf-fortios-firewalldospolicy6.json`
2. Implement your resource handlers in `tf_fortios_firewalldospolicy6/handlers.py`
