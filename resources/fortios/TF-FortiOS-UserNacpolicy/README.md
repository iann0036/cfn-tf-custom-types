...
1. Write the JSON schema describing your resource, `tf-fortios-usernacpolicy.json`
2. Implement your resource handlers in `tf_fortios_usernacpolicy/handlers.py`
