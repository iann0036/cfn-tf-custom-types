...
1. Write the JSON schema describing your resource, `tf-fortios-routerpolicy.json`
2. Implement your resource handlers in `tf_fortios_routerpolicy/handlers.py`
