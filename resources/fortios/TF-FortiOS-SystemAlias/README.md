# TF::FortiOS::SystemAlias

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemalias.json`
2. Implement your resource handlers in `tf_fortios_systemalias/handlers.py`
