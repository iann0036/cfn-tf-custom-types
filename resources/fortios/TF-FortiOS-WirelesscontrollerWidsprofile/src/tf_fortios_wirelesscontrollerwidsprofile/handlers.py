...
TYPE_NAME = "TF::FortiOS::WirelesscontrollerWidsprofile"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_wirelesscontroller_widsprofile/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_wirelesscontroller_widsprofile',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_wirelesscontroller_widsprofile/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_wirelesscontroller_widsprofile/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), ApAutoSuppress=None, ApBgscanDisableDay=None, ApBgscanDisableEnd=None, ApBgscanDisableStart=None, ApBgscanDuration=None, ApBgscanIdle=None, ApBgscanIntv=None, ApBgscanPeriod=None, ApBgscanReportIntv=None, ApFgscanReportIntv=None, ApScan=None, ApScanPassive=None, ApScanThreshold=None, AsleapAttack=None, AssocFloodThresh=None, AssocFloodTime=None, AssocFrameFlood=None, AuthFloodThresh=None, AuthFloodTime=None, AuthFrameFlood=None, Comment=None, DeauthBroadcast=None, DeauthUnknownSrcThresh=None, DynamicSortSubtable=None, EapolFailFlood=None, EapolFailIntv=None, EapolFailThresh=None, EapolLogoffFlood=None, EapolLogoffIntv=None, EapolLogoffThresh=None, EapolPreFailFlood=None, EapolPreFailIntv=None, EapolPreFailThresh=None, EapolPreSuccFlood=None, EapolPreSuccIntv=None, EapolPreSuccThresh=None, EapolStartFlood=None, EapolStartIntv=None, EapolStartThresh=None, EapolSuccFlood=None, EapolSuccIntv=None, EapolSuccThresh=None, Id=None, InvalidMacOui=None, LongDurationAttack=None, LongDurationThresh=None, Name=None, NullSsidProbeResp=None, SensorMode=None, SpoofedDeauth=None, Vdomparam=None, WeakWepIv=None, WirelessBridge=None, ApBgscanDisableSchedules=None)
