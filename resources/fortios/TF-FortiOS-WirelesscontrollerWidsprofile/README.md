...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerwidsprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerwidsprofile/handlers.py`
