...
class ResourceModel(BaseModel):
    ...
    Extaddr: Optional[Sequence["_ExtaddrDefinition"]]
    Mappedip: Optional[Sequence["_MappedipDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PortmappingType=json_data.get("PortmappingType"),
            ...
            Extaddr=deserialize_list(json_data.get("Extaddr"), ExtaddrDefinition),
            Mappedip=deserialize_list(json_data.get("Mappedip"), MappedipDefinition),
...
@dataclass
class ExtaddrDefinition(BaseModel):
    Name: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_ExtaddrDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ExtaddrDefinition"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
# work around possible type aliasing issues when variable has same name as a model
_ExtaddrDefinition = ExtaddrDefinition


@dataclass
class MappedipDefinition(BaseModel):
    Range: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_MappedipDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MappedipDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_MappedipDefinition = MappedipDefinition
