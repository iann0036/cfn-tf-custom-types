...
1. Write the JSON schema describing your resource, `tf-fortios-systemfederatedupgrade.json`
2. Implement your resource handlers in `tf_fortios_systemfederatedupgrade/handlers.py`
