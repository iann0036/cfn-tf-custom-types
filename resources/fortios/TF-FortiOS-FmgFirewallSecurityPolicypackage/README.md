...
1. Write the JSON schema describing your resource, `tf-fortios-fmgfirewallsecuritypolicypackage.json`
2. Implement your resource handlers in `tf_fortios_fmgfirewallsecuritypolicypackage/handlers.py`
