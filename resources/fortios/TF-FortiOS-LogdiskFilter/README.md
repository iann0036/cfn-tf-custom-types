...
1. Write the JSON schema describing your resource, `tf-fortios-logdiskfilter.json`
2. Implement your resource handlers in `tf_fortios_logdiskfilter/handlers.py`
