# TF::FortiOS::RouterRoutemap

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-routerroutemap.json`
2. Implement your resource handlers in `tf_fortios_routerroutemap/handlers.py`
