# TF::FortiOS::SystemreplacemsgFortiguardwf

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemreplacemsgfortiguardwf.json`
2. Implement your resource handlers in `tf_fortios_systemreplacemsgfortiguardwf/handlers.py`
