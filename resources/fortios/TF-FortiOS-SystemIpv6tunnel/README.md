# TF::FortiOS::SystemIpv6tunnel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemipv6tunnel.json`
2. Implement your resource handlers in `tf_fortios_systemipv6tunnel/handlers.py`
