...
1. Write the JSON schema describing your resource, `tf-fortios-firewallinterfacepolicy6.json`
2. Implement your resource handlers in `tf_fortios_firewallinterfacepolicy6/handlers.py`
