...
class ResourceModel(BaseModel):
    ...
    Service6: Optional[Sequence["_Service6Definition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Service6=deserialize_list(json_data.get("Service6"), Service6Definition),
...
@dataclass
class Service6Definition(BaseModel):
    Name: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_Service6Definition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_Service6Definition"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
# work around possible type aliasing issues when variable has same name as a model
_Service6Definition = Service6Definition
