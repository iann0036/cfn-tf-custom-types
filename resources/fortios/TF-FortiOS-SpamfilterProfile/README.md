...
1. Write the JSON schema describing your resource, `tf-fortios-spamfilterprofile.json`
2. Implement your resource handlers in `tf_fortios_spamfilterprofile/handlers.py`
