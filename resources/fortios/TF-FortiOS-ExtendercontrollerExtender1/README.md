...
1. Write the JSON schema describing your resource, `tf-fortios-extendercontrollerextender1.json`
2. Implement your resource handlers in `tf_fortios_extendercontrollerextender1/handlers.py`
