...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemnetworkinterface.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemnetworkinterface/handlers.py`
