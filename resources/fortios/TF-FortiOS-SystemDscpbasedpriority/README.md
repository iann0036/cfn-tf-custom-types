# TF::FortiOS::SystemDscpbasedpriority

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemdscpbasedpriority.json`
2. Implement your resource handlers in `tf_fortios_systemdscpbasedpriority/handlers.py`
