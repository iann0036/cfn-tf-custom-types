...
1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolprofile.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolprofile/handlers.py`
