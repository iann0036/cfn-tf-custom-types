# TF::FortiOS::FmgSystemSyslogserver

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemsyslogserver.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemsyslogserver/handlers.py`
