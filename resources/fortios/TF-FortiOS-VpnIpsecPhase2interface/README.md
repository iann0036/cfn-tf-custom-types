...
1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecphase2interface.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecphase2interface/handlers.py`
