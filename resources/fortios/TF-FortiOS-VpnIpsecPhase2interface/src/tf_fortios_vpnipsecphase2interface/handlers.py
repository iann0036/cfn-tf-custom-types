...
TYPE_NAME = "TF::FortiOS::VpnipsecPhase2interface"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_vpnipsec_phase2interface/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_vpnipsec_phase2interface',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_vpnipsec_phase2interface/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_vpnipsec_phase2interface/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AddRoute=None, AutoDiscoveryForwarder=None, AutoDiscoverySender=None, AutoNegotiate=None, Comments=None, DhcpIpsec=None, Dhgrp=None, Diffserv=None, Diffservcode=None, DstAddrType=None, DstEndIp=None, DstEndIp6=None, DstName=None, DstName6=None, DstPort=None, DstStartIp=None, DstStartIp6=None, DstSubnet=None, DstSubnet6=None, Encapsulation=None, Id=None, InitiatorTsNarrow=None, Ipv4Df=None, Keepalive=None, KeylifeType=None, Keylifekbs=None, Keylifeseconds=None, L2tp=None, Name=None, Pfs=None, Phase1name=None, Proposal=None, Protocol=None, Replay=None, RouteOverlap=None, SingleSource=None, SrcAddrType=None, SrcEndIp=None, SrcEndIp6=None, SrcName=None, SrcName6=None, SrcPort=None, SrcStartIp=None, SrcStartIp6=None, SrcSubnet=None, SrcSubnet6=None, Vdomparam=None)
