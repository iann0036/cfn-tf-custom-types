# TF::FortiOS::SpamfilterBword

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-spamfilterbword.json`
2. Implement your resource handlers in `tf_fortios_spamfilterbword/handlers.py`
