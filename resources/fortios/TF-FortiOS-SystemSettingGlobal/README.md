...
1. Write the JSON schema describing your resource, `tf-fortios-systemsettingglobal.json`
2. Implement your resource handlers in `tf_fortios_systemsettingglobal/handlers.py`
