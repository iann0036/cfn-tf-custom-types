...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollersnmp.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollersnmp/handlers.py`
