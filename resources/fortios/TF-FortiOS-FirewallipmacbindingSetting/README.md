...
1. Write the JSON schema describing your resource, `tf-fortios-firewallipmacbindingsetting.json`
2. Implement your resource handlers in `tf_fortios_firewallipmacbindingsetting/handlers.py`
