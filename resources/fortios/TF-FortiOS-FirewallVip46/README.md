# TF::FortiOS::FirewallVip46

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallvip46.json`
2. Implement your resource handlers in `tf_fortios_firewallvip46/handlers.py`
