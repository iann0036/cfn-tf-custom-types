...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsslserver.json`
2. Implement your resource handlers in `tf_fortios_firewallsslserver/handlers.py`
