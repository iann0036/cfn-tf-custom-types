...
1. Write the JSON schema describing your resource, `tf-fortios-vpnsslsettings.json`
2. Implement your resource handlers in `tf_fortios_vpnsslsettings/handlers.py`
