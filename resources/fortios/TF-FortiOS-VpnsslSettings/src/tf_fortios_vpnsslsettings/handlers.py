...
TYPE_NAME = "TF::FortiOS::VpnsslSettings"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_vpnssl_settings/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_vpnssl_settings',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_vpnssl_settings/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_vpnssl_settings/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Algorithm=None, AuthSessionCheckSourceIp=None, AuthTimeout=None, AutoTunnelStaticRoute=None, BannedCipher=None, CheckReferer=None, DefaultPortal=None, DeflateCompressionLevel=None, DeflateMinDataSize=None, DnsServer1=None, DnsServer2=None, DnsSuffix=None, DtlsHelloTimeout=None, DtlsMaxProtoVer=None, DtlsMinProtoVer=None, DtlsTunnel=None, DynamicSortSubtable=None, Encode2fSequence=None, EncryptAndStorePassword=None, ForceTwoFactorAuth=None, HeaderXForwardedFor=None, HstsIncludeSubdomains=None, HttpCompression=None, HttpOnlyCookie=None, HttpRequestBodyTimeout=None, HttpRequestHeaderTimeout=None, HttpsRedirect=None, Id=None, IdleTimeout=None, Ipv6DnsServer1=None, Ipv6DnsServer2=None, Ipv6WinsServer1=None, Ipv6WinsServer2=None, LoginAttemptLimit=None, LoginBlockTime=None, LoginTimeout=None, Port=None, PortPrecedence=None, Reqclientcert=None, RouteSourceInterface=None, Servercert=None, SourceAddress6Negate=None, SourceAddressNegate=None, SslClientRenegotiation=None, SslInsertEmptyFragment=None, SslMaxProtoVer=None, SslMinProtoVer=None, Tlsv10=None, Tlsv11=None, Tlsv12=None, Tlsv13=None, TransformBackwardSlashes=None, TunnelConnectWithoutReauth=None, TunnelUserSessionTimeout=None, UnsafeLegacyRenegotiation=None, UrlObscuration=None, UserPeer=None, Vdomparam=None, WinsServer1=None, WinsServer2=None, XContentTypeOptions=None, AuthenticationRule=None, SourceAddress=None, SourceAddress6=None, SourceInterface=None, TunnelIpPools=None, TunnelIpv6Pools=None)
