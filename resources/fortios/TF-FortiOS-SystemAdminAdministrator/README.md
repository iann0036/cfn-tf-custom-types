...
1. Write the JSON schema describing your resource, `tf-fortios-systemadminadministrator.json`
2. Implement your resource handlers in `tf_fortios_systemadminadministrator/handlers.py`
