...
1. Write the JSON schema describing your resource, `tf-fortios-ftpproxyexplicit.json`
2. Implement your resource handlers in `tf_fortios_ftpproxyexplicit/handlers.py`
