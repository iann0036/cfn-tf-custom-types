...
1. Write the JSON schema describing your resource, `tf-fortios-firewallpolicy46.json`
2. Implement your resource handlers in `tf_fortios_firewallpolicy46/handlers.py`
