...
1. Write the JSON schema describing your resource, `tf-fortios-firewallshaperperipshaper.json`
2. Implement your resource handlers in `tf_fortios_firewallshaperperipshaper/handlers.py`
