...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_ha/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_system_ha',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_ha/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_system_ha/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Arps=None, ArpsInterval=None, Authentication=None, CpuThreshold=None, DynamicSortSubtable=None, Encryption=None, FtpProxyThreshold=None, GratuitousArps=None, GroupId=None, GroupName=None, HaDirect=None, HaEthType=None, HaMgmtStatus=None, HaUptimeDiffMargin=None, HbInterval=None, HbLostThreshold=None, Hbdev=None, HcEthType=None, HelloHolddown=None, HttpProxyThreshold=None, Id=None, ImapProxyThreshold=None, InterClusterSessionSync=None, Key=None, L2epEthType=None, LinkFailedSignal=None, LoadBalanceAll=None, LogicalSn=None, MemoryCompatibleMode=None, MemoryThreshold=None, Mode=None, Monitor=None, MulticastTtl=None, NntpProxyThreshold=None, Override=None, OverrideWaitTime=None, Password=None, PingserverFailoverThreshold=None, PingserverFlipTimeout=None, PingserverMonitorInterface=None, PingserverSecondaryForceReset=None, PingserverSlaveForceReset=None, Pop3ProxyThreshold=None, Priority=None, RouteHold=None, RouteTtl=None, RouteWait=None, Schedule=None, SessionPickup=None, SessionPickupConnectionless=None, SessionPickupDelay=None, SessionPickupExpectation=None, SessionPickupNat=None, SessionSyncDev=None, SmtpProxyThreshold=None, SsdFailover=None, StandaloneConfigSync=None, StandaloneMgmtVdom=None, SyncConfig=None, SyncPacketBalance=None, UnicastHb=None, UnicastHbNetmask=None, UnicastHbPeerip=None, UninterruptibleUpgrade=None, Vcluster2=None, VclusterId=None, Vdom=None, Vdomparam=None, Weight=None, HaMgmtInterfaces=None, SecondaryVcluster=None)
