# TF::FortiOS::UserSecurityexemptlist

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-usersecurityexemptlist.json`
2. Implement your resource handlers in `tf_fortios_usersecurityexemptlist/handlers.py`
