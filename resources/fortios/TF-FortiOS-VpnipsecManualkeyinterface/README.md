...
1. Write the JSON schema describing your resource, `tf-fortios-vpnipsecmanualkeyinterface.json`
2. Implement your resource handlers in `tf_fortios_vpnipsecmanualkeyinterface/handlers.py`
