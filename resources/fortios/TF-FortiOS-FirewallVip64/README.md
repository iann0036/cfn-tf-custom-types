...
1. Write the JSON schema describing your resource, `tf-fortios-firewallvip64.json`
2. Implement your resource handlers in `tf_fortios_firewallvip64/handlers.py`
