# TF::FortiOS::EndpointcontrolClient

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolclient.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolclient/handlers.py`
