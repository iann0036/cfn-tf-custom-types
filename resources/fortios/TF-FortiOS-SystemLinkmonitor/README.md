...
1. Write the JSON schema describing your resource, `tf-fortios-systemlinkmonitor.json`
2. Implement your resource handlers in `tf_fortios_systemlinkmonitor/handlers.py`
