...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerwtpprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerwtpprofile/handlers.py`
