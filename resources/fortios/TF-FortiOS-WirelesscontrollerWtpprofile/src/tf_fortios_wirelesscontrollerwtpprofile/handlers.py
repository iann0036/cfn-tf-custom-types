...
TYPE_NAME = "TF::FortiOS::WirelesscontrollerWtpprofile"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_wirelesscontroller_wtpprofile/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_wirelesscontroller_wtpprofile',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_wirelesscontroller_wtpprofile/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_wirelesscontroller_wtpprofile/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Allowaccess=None, ApCountry=None, ApHandoff=None, ApcfgProfile=None, BleProfile=None, Comment=None, ControlMessageOffload=None, DtlsInKernel=None, DtlsPolicy=None, DynamicSortSubtable=None, EnergyEfficientEthernet=None, ExtInfoEnable=None, FrequencyHandoff=None, HandoffRoaming=None, HandoffRssi=None, HandoffStaThresh=None, Id=None, IpFragmentPreventing=None, LedState=None, Lldp=None, LoginPasswd=None, LoginPasswdChange=None, MaxClients=None, Name=None, PoeMode=None, SplitTunnelingAclLocalApSubnet=None, SplitTunnelingAclPath=None, TunMtuDownlink=None, TunMtuUplink=None, Vdomparam=None, WanPortMode=None, DenyMacList=None, Lan=None, Lbs=None, LedSchedules=None, Platform=None, Radio1=None, Radio2=None, Radio3=None, Radio4=None, SplitTunnelingAcl=None)
