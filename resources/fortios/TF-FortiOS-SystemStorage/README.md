...
1. Write the JSON schema describing your resource, `tf-fortios-systemstorage.json`
2. Implement your resource handlers in `tf_fortios_systemstorage/handlers.py`
