...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptcontentdeliverynetworkrule.json`
2. Implement your resource handlers in `tf_fortios_wanoptcontentdeliverynetworkrule/handlers.py`
