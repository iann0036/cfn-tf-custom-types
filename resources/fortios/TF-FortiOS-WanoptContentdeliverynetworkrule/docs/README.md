# TF::FortiOS::WanoptContentdeliverynetworkrule
...
<pre>
{
    "Type" : "TF::FortiOS::WanoptContentdeliverynetworkrule",
    "Properties" : {
        "<a href="#category" title="Category">Category</a>" : <i>String</i>,
        "<a href="#comment" title="Comment">Comment</a>" : <i>String</i>,
        "<a href="#dynamicsortsubtable" title="DynamicSortSubtable">DynamicSortSubtable</a>" : <i>String</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#requestcachecontrol" title="RequestCacheControl">RequestCacheControl</a>" : <i>String</i>,
        "<a href="#responsecachecontrol" title="ResponseCacheControl">ResponseCacheControl</a>" : <i>String</i>,
        "<a href="#responseexpires" title="ResponseExpires">ResponseExpires</a>" : <i>String</i>,
        "<a href="#status" title="Status">Status</a>" : <i>String</i>,
        "<a href="#textresponsevcache" title="TextResponseVcache">TextResponseVcache</a>" : <i>String</i>,
        "<a href="#updateserver" title="Updateserver">Updateserver</a>" : <i>String</i>,
        "<a href="#vdomparam" title="Vdomparam">Vdomparam</a>" : <i>String</i>,
        "<a href="#hostdomainnamesuffix" title="HostDomainNameSuffix">HostDomainNameSuffix</a>" : <i>[ <a href="hostdomainnamesuffixdefinition.md">HostDomainNameSuffixDefinition</a>, ... ]</i>,
...
Properties:
    ...
    <a href="#updateserver" title="Updateserver">Updateserver</a>: <i>String</i>
    <a href="#vdomparam" title="Vdomparam">Vdomparam</a>: <i>String</i>
    <a href="#hostdomainnamesuffix" title="HostDomainNameSuffix">HostDomainNameSuffix</a>: <i>
      - <a href="hostdomainnamesuffixdefinition.md">HostDomainNameSuffixDefinition</a></i>
...
_Type_: List of <a href="hostdomainnamesuffixdefinition.md">HostDomainNameSuffixDefinition</a>
