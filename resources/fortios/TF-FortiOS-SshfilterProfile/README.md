...
1. Write the JSON schema describing your resource, `tf-fortios-sshfilterprofile.json`
2. Implement your resource handlers in `tf_fortios_sshfilterprofile/handlers.py`
