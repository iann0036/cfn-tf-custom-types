...
1. Write the JSON schema describing your resource, `tf-fortios-routerospfneighbor.json`
2. Implement your resource handlers in `tf_fortios_routerospfneighbor/handlers.py`
