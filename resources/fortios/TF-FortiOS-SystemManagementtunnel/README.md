...
1. Write the JSON schema describing your resource, `tf-fortios-systemmanagementtunnel.json`
2. Implement your resource handlers in `tf_fortios_systemmanagementtunnel/handlers.py`
