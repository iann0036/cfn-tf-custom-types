...
1. Write the JSON schema describing your resource, `tf-fortios-authenticationrule.json`
2. Implement your resource handlers in `tf_fortios_authenticationrule/handlers.py`
