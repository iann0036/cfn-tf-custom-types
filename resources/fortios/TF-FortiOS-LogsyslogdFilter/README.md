# TF::FortiOS::LogsyslogdFilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logsyslogdfilter.json`
2. Implement your resource handlers in `tf_fortios_logsyslogdfilter/handlers.py`
