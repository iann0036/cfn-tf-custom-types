...
1. Write the JSON schema describing your resource, `tf-fortios-logguidisplay.json`
2. Implement your resource handlers in `tf_fortios_logguidisplay/handlers.py`
