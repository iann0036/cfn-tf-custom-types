...
1. Write the JSON schema describing your resource, `tf-fortios-applicationgroup.json`
2. Implement your resource handlers in `tf_fortios_applicationgroup/handlers.py`
