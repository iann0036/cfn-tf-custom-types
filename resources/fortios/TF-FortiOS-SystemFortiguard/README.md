...
1. Write the JSON schema describing your resource, `tf-fortios-systemfortiguard.json`
2. Implement your resource handlers in `tf_fortios_systemfortiguard/handlers.py`
