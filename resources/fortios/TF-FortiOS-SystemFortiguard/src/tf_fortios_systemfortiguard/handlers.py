...
TYPE_NAME = "TF::FortiOS::SystemFortiguard"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_fortiguard/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_system_fortiguard',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_fortiguard/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_system_fortiguard/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AntispamCache=None, AntispamCacheMpercent=None, AntispamCacheTtl=None, AntispamExpiration=None, AntispamForceOff=None, AntispamLicense=None, AntispamTimeout=None, AnycastSdnsServerIp=None, AnycastSdnsServerPort=None, AutoJoinForticloud=None, DdnsServerIp=None, DdnsServerPort=None, FortiguardAnycast=None, FortiguardAnycastSource=None, Id=None, Interface=None, InterfaceSelectMethod=None, LoadBalanceServers=None, OutbreakPreventionCache=None, OutbreakPreventionCacheMpercent=None, OutbreakPreventionCacheTtl=None, OutbreakPreventionExpiration=None, OutbreakPreventionForceOff=None, OutbreakPreventionLicense=None, OutbreakPreventionTimeout=None, Port=None, Protocol=None, ProxyPassword=None, ProxyServerIp=None, ProxyServerPort=None, ProxyUsername=None, SandboxRegion=None, SdnsOptions=None, SdnsServerIp=None, SdnsServerPort=None, ServiceAccountId=None, SourceIp=None, SourceIp6=None, UpdateServerLocation=None, Vdomparam=None, WebfilterCache=None, WebfilterCacheTtl=None, WebfilterExpiration=None, WebfilterForceOff=None, WebfilterLicense=None, WebfilterTimeout=None)
