...
1. Write the JSON schema describing your resource, `tf-fortios-systemfortimanager.json`
2. Implement your resource handlers in `tf_fortios_systemfortimanager/handlers.py`
