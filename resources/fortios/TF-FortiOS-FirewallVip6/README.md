...
1. Write the JSON schema describing your resource, `tf-fortios-firewallvip6.json`
2. Implement your resource handlers in `tf_fortios_firewallvip6/handlers.py`
