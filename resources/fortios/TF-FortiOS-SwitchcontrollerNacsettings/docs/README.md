...
<pre>
{
    "Type" : "TF::FortiOS::SwitchcontrollerNacsettings",
    "Properties" : {
        "<a href="#autoauth" title="AutoAuth">AutoAuth</a>" : <i>String</i>,
        "<a href="#bouncenacport" title="BounceNacPort">BounceNacPort</a>" : <i>String</i>,
        "<a href="#inactivetimer" title="InactiveTimer">InactiveTimer</a>" : <i>Double</i>,
        "<a href="#linkdownflush" title="LinkDownFlush">LinkDownFlush</a>" : <i>String</i>,
        "<a href="#mode" title="Mode">Mode</a>" : <i>String</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#onboardingvlan" title="OnboardingVlan">OnboardingVlan</a>" : <i>String</i>,
