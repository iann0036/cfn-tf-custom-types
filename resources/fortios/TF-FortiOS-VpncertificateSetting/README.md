...
1. Write the JSON schema describing your resource, `tf-fortios-vpncertificatesetting.json`
2. Implement your resource handlers in `tf_fortios_vpncertificatesetting/handlers.py`
