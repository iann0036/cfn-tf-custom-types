...
1. Write the JSON schema describing your resource, `tf-fortios-systemreplacemsggroup.json`
2. Implement your resource handlers in `tf_fortios_systemreplacemsggroup/handlers.py`
