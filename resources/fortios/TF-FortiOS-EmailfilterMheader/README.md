# TF::FortiOS::EmailfilterMheader

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-emailfiltermheader.json`
2. Implement your resource handlers in `tf_fortios_emailfiltermheader/handlers.py`
