...
1. Write the JSON schema describing your resource, `tf-fortios-antivirusprofile.json`
2. Implement your resource handlers in `tf_fortios_antivirusprofile/handlers.py`
