...
1. Write the JSON schema describing your resource, `tf-fortios-logthreatweight.json`
2. Implement your resource handlers in `tf_fortios_logthreatweight/handlers.py`
