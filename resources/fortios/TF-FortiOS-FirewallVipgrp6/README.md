# TF::FortiOS::FirewallVipgrp6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallvipgrp6.json`
2. Implement your resource handlers in `tf_fortios_firewallvipgrp6/handlers.py`
