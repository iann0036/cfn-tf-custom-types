...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollervap.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollervap/handlers.py`
