...
1. Write the JSON schema describing your resource, `tf-fortios-systemvirtualswitch.json`
2. Implement your resource handlers in `tf_fortios_systemvirtualswitch/handlers.py`
