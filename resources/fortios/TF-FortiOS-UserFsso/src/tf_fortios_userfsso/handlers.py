...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_user_fsso/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_user_fsso',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_user_fsso/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_user_fsso/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), GroupPollInterval=None, Id=None, Interface=None, InterfaceSelectMethod=None, LdapPoll=None, LdapPollFilter=None, LdapPollInterval=None, LdapServer=None, Name=None, Password=None, Password2=None, Password3=None, Password4=None, Password5=None, Port=None, Port2=None, Port3=None, Port4=None, Port5=None, Server=None, Server2=None, Server3=None, Server4=None, Server5=None, SourceIp=None, SourceIp6=None, Ssl=None, SslTrustedCert=None, Type=None, UserInfoServer=None, Vdomparam=None)
