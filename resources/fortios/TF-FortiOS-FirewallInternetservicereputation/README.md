# TF::FortiOS::FirewallInternetservicereputation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetservicereputation.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetservicereputation/handlers.py`
