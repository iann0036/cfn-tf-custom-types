...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsslsshprofile.json`
2. Implement your resource handlers in `tf_fortios_firewallsslsshprofile/handlers.py`
