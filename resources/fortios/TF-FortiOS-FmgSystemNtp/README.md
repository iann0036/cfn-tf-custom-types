...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemntp.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemntp/handlers.py`
