...
TYPE_NAME = "TF::FortiOS::FirewallPolicy6"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_policy6/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_firewall_policy6',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_policy6/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_firewall_policy6/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Action=None, AntiReplay=None, ApplicationList=None, AutoAsicOffload=None, AvProfile=None, CifsProfile=None, Comments=None, DecryptedTrafficMirror=None, DiffservForward=None, DiffservReverse=None, DiffservcodeForward=None, DiffservcodeRev=None, DlpSensor=None, DnsfilterProfile=None, Dsri=None, DstaddrNegate=None, DynamicSortSubtable=None, EmailfilterProfile=None, FirewallSessionDirty=None, Fixedport=None, GlobalLabel=None, HttpPolicyRedirect=None, IcapProfile=None, Id=None, Inbound=None, InspectionMode=None, Ippool=None, IpsSensor=None, Label=None, Logtraffic=None, LogtrafficStart=None, Name=None, Nat=None, Natinbound=None, Natoutbound=None, Outbound=None, PerIpShaper=None, Policyid=None, ProfileGroup=None, ProfileProtocolOptions=None, ProfileType=None, ReplacemsgOverrideGroup=None, Rsso=None, Schedule=None, SendDenyPacket=None, ServiceNegate=None, SessionTtl=None, SpamfilterProfile=None, SrcaddrNegate=None, SshFilterProfile=None, SshPolicyRedirect=None, SslMirror=None, SslSshProfile=None, Status=None, TcpMssReceiver=None, TcpMssSender=None, TcpSessionWithoutSyn=None, TimeoutSendRst=None, Tos=None, TosMask=None, TosNegate=None, TrafficShaper=None, TrafficShaperReverse=None, UtmStatus=None, Uuid=None, Vdomparam=None, VlanCosFwd=None, VlanCosRev=None, VlanFilter=None, VoipProfile=None, Vpntunnel=None, WafProfile=None, Webcache=None, WebcacheHttps=None, WebfilterProfile=None, WebproxyForwardServer=None, WebproxyProfile=None, AppCategory=None, AppGroup=None, Application=None, CustomLogFields=None, Devices=None, Dstaddr=None, Dstintf=None, FssoGroups=None, Groups=None, Poolname=None, Service=None, Srcaddr=None, Srcintf=None, SslMirrorIntf=None, UrlCategory=None, Users=None)
