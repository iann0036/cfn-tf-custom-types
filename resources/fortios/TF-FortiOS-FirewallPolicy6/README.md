...
1. Write the JSON schema describing your resource, `tf-fortios-firewallpolicy6.json`
2. Implement your resource handlers in `tf_fortios_firewallpolicy6/handlers.py`
