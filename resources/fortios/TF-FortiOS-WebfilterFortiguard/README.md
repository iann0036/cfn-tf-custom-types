...
1. Write the JSON schema describing your resource, `tf-fortios-webfilterfortiguard.json`
2. Implement your resource handlers in `tf_fortios_webfilterfortiguard/handlers.py`
