...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RecvBufferSize=json_data.get("RecvBufferSize"),
...
class InterfaceDefinition(BaseModel):
    AuthKeychain: Optional[str]
    AuthMode: Optional[str]
    AuthString: Optional[str]
    Flags: Optional[float]
    Name: Optional[str]
    ReceiveVersion: Optional[str]
    SendVersion: Optional[str]
    SendVersion2Broadcast: Optional[str]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            AuthKeychain=json_data.get("AuthKeychain"),
            AuthMode=json_data.get("AuthMode"),
            AuthString=json_data.get("AuthString"),
            Flags=json_data.get("Flags"),
            Name=json_data.get("Name"),
            ReceiveVersion=json_data.get("ReceiveVersion"),
            SendVersion=json_data.get("SendVersion"),
            SendVersion2Broadcast=json_data.get("SendVersion2Broadcast"),
