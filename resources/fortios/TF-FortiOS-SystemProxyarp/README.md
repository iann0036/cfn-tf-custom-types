...
1. Write the JSON schema describing your resource, `tf-fortios-systemproxyarp.json`
2. Implement your resource handlers in `tf_fortios_systemproxyarp/handlers.py`
