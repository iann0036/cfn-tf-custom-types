...
1. Write the JSON schema describing your resource, `tf-fortios-systemvdomdns.json`
2. Implement your resource handlers in `tf_fortios_systemvdomdns/handlers.py`
