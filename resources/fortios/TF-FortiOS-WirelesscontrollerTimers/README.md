...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollertimers.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollertimers/handlers.py`
