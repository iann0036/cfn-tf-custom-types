...
1. Write the JSON schema describing your resource, `tf-fortios-firewallproxypolicysort.json`
2. Implement your resource handlers in `tf_fortios_firewallproxypolicysort/handlers.py`
