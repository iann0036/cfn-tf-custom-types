...
1. Write the JSON schema describing your resource, `tf-fortios-firewallobjectservice.json`
2. Implement your resource handlers in `tf_fortios_firewallobjectservice/handlers.py`
