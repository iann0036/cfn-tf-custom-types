...
1. Write the JSON schema describing your resource, `tf-fortios-authenticationscheme.json`
2. Implement your resource handlers in `tf_fortios_authenticationscheme/handlers.py`
