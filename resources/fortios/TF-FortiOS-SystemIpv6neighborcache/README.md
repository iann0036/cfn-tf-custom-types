...
1. Write the JSON schema describing your resource, `tf-fortios-systemipv6neighborcache.json`
2. Implement your resource handlers in `tf_fortios_systemipv6neighborcache/handlers.py`
