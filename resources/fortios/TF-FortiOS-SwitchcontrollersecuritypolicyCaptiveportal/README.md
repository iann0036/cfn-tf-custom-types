# TF::FortiOS::SwitchcontrollersecuritypolicyCaptiveportal

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollersecuritypolicycaptiveportal.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollersecuritypolicycaptiveportal/handlers.py`
