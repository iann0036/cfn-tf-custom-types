# TF::FortiOS::WebfilterIpsurlfiltersetting6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-webfilteripsurlfiltersetting6.json`
2. Implement your resource handlers in `tf_fortios_webfilteripsurlfiltersetting6/handlers.py`
