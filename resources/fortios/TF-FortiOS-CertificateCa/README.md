...
1. Write the JSON schema describing your resource, `tf-fortios-certificateca.json`
2. Implement your resource handlers in `tf_fortios_certificateca/handlers.py`
