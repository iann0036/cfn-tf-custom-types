...
1. Write the JSON schema describing your resource, `tf-fortios-systemsnmpuser.json`
2. Implement your resource handlers in `tf_fortios_systemsnmpuser/handlers.py`
