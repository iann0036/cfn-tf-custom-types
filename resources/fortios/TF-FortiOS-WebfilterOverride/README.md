...
1. Write the JSON schema describing your resource, `tf-fortios-webfilteroverride.json`
2. Implement your resource handlers in `tf_fortios_webfilteroverride/handlers.py`
