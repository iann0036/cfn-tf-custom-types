...
1. Write the JSON schema describing your resource, `tf-fortios-fmgjsonrpcrequest.json`
2. Implement your resource handlers in `tf_fortios_fmgjsonrpcrequest/handlers.py`
