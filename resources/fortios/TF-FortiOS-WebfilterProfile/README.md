...
1. Write the JSON schema describing your resource, `tf-fortios-webfilterprofile.json`
2. Implement your resource handlers in `tf_fortios_webfilterprofile/handlers.py`
