...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemadminprofiles.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemadminprofiles/handlers.py`
