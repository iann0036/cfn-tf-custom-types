...
1. Write the JSON schema describing your resource, `tf-fortios-userfortitoken.json`
2. Implement your resource handlers in `tf_fortios_userfortitoken/handlers.py`
