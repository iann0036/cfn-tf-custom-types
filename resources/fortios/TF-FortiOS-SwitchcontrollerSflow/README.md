# TF::FortiOS::SwitchcontrollerSflow

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollersflow.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollersflow/handlers.py`
