...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptremotestorage.json`
2. Implement your resource handlers in `tf_fortios_wanoptremotestorage/handlers.py`
