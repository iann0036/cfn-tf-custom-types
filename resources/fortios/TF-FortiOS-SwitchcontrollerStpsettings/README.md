...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerstpsettings.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerstpsettings/handlers.py`
