...
1. Write the JSON schema describing your resource, `tf-fortios-systemfipscc.json`
2. Implement your resource handlers in `tf_fortios_systemfipscc/handlers.py`
