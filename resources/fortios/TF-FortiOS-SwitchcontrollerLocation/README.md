...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerlocation.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerlocation/handlers.py`
