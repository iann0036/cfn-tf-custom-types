...
1. Write the JSON schema describing your resource, `tf-fortios-firewallprofilegroup.json`
2. Implement your resource handlers in `tf_fortios_firewallprofilegroup/handlers.py`
