...
1. Write the JSON schema describing your resource, `tf-fortios-webproxywisp.json`
2. Implement your resource handlers in `tf_fortios_webproxywisp/handlers.py`
