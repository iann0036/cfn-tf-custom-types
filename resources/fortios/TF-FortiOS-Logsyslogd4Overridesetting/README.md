# TF::FortiOS::Logsyslogd4Overridesetting

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logsyslogd4overridesetting.json`
2. Implement your resource handlers in `tf_fortios_logsyslogd4overridesetting/handlers.py`
