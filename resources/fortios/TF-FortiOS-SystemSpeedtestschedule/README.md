...
1. Write the JSON schema describing your resource, `tf-fortios-systemspeedtestschedule.json`
2. Implement your resource handlers in `tf_fortios_systemspeedtestschedule/handlers.py`
