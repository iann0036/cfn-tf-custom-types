...
1. Write the JSON schema describing your resource, `tf-fortios-systemdhcp6server.json`
2. Implement your resource handlers in `tf_fortios_systemdhcp6server/handlers.py`
