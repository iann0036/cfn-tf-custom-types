# TF::FortiOS::FirewallDoSpolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewalldospolicy.json`
2. Implement your resource handlers in `tf_fortios_firewalldospolicy/handlers.py`
