...
1. Write the JSON schema describing your resource, `tf-fortios-systemgretunnel.json`
2. Implement your resource handlers in `tf_fortios_systemgretunnel/handlers.py`
