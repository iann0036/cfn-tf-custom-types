...
1. Write the JSON schema describing your resource, `tf-fortios-firewallobjectvip.json`
2. Implement your resource handlers in `tf_fortios_firewallobjectvip/handlers.py`
