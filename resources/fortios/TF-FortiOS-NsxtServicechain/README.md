...
1. Write the JSON schema describing your resource, `tf-fortios-nsxtservicechain.json`
2. Implement your resource handlers in `tf_fortios_nsxtservicechain/handlers.py`
