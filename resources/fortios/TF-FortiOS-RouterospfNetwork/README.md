...
1. Write the JSON schema describing your resource, `tf-fortios-routerospfnetwork.json`
2. Implement your resource handlers in `tf_fortios_routerospfnetwork/handlers.py`
