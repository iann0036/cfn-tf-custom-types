...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsshhostkey.json`
2. Implement your resource handlers in `tf_fortios_firewallsshhostkey/handlers.py`
