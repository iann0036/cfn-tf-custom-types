...
1. Write the JSON schema describing your resource, `tf-fortios-systeminterface.json`
2. Implement your resource handlers in `tf_fortios_systeminterface/handlers.py`
