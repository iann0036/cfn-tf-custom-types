...
1. Write the JSON schema describing your resource, `tf-fortios-firewallproxypolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallproxypolicy/handlers.py`
