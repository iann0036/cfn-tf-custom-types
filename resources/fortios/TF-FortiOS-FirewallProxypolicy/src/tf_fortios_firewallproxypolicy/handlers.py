...
TYPE_NAME = "TF::FortiOS::FirewallProxypolicy"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_proxypolicy/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_firewall_proxypolicy',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_proxypolicy/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_firewall_proxypolicy/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Action=None, ApplicationList=None, AvProfile=None, CifsProfile=None, Comments=None, DecryptedTrafficMirror=None, Disclaimer=None, DlpSensor=None, DstaddrNegate=None, DynamicSortSubtable=None, EmailfilterProfile=None, FileFilterProfile=None, GlobalLabel=None, HttpTunnelAuth=None, IcapProfile=None, Id=None, InternetService=None, InternetServiceNegate=None, IpsSensor=None, Label=None, Logtraffic=None, LogtrafficStart=None, Name=None, Policyid=None, ProfileGroup=None, ProfileProtocolOptions=None, ProfileType=None, Proxy=None, RedirectUrl=None, ReplacemsgOverrideGroup=None, ScanBotnetConnections=None, Schedule=None, ServiceNegate=None, SessionTtl=None, SpamfilterProfile=None, SrcaddrNegate=None, SshFilterProfile=None, SshPolicyRedirect=None, SslSshProfile=None, Status=None, Transparent=None, UtmStatus=None, Uuid=None, Vdomparam=None, WafProfile=None, Webcache=None, WebcacheHttps=None, WebfilterProfile=None, WebproxyForwardServer=None, WebproxyProfile=None, Dstaddr=None, Dstaddr6=None, Dstintf=None, Groups=None, InternetServiceCustom=None, InternetServiceCustomGroup=None, InternetServiceGroup=None, InternetServiceId=None, InternetServiceName=None, Poolname=None, Service=None, Srcaddr=None, Srcaddr6=None, Srcintf=None, Users=None)
