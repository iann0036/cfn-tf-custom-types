...
1. Write the JSON schema describing your resource, `tf-fortios-firewallshapingprofile.json`
2. Implement your resource handlers in `tf_fortios_firewallshapingprofile/handlers.py`
