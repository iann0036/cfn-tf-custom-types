...
1. Write the JSON schema describing your resource, `tf-fortios-extendercontrollerextender.json`
2. Implement your resource handlers in `tf_fortios_extendercontrollerextender/handlers.py`
