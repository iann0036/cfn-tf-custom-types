...
1. Write the JSON schema describing your resource, `tf-fortios-systemvdomproperty.json`
2. Implement your resource handlers in `tf_fortios_systemvdomproperty/handlers.py`
