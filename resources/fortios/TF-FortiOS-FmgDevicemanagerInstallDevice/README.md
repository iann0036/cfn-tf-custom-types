...
1. Write the JSON schema describing your resource, `tf-fortios-fmgdevicemanagerinstalldevice.json`
2. Implement your resource handlers in `tf_fortios_fmgdevicemanagerinstalldevice/handlers.py`
