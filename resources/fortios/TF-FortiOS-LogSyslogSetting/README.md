...
1. Write the JSON schema describing your resource, `tf-fortios-logsyslogsetting.json`
2. Implement your resource handlers in `tf_fortios_logsyslogsetting/handlers.py`
