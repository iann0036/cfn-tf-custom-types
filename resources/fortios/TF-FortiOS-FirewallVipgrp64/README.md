# TF::FortiOS::FirewallVipgrp64

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallvipgrp64.json`
2. Implement your resource handlers in `tf_fortios_firewallvipgrp64/handlers.py`
