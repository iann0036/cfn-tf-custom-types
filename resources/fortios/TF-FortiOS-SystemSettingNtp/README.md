...
1. Write the JSON schema describing your resource, `tf-fortios-systemsettingntp.json`
2. Implement your resource handlers in `tf_fortios_systemsettingntp/handlers.py`
