...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsslsetting.json`
2. Implement your resource handlers in `tf_fortios_firewallsslsetting/handlers.py`
