# TF::FortiOS::FirewallInternetservicecustom

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetservicecustom.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetservicecustom/handlers.py`
