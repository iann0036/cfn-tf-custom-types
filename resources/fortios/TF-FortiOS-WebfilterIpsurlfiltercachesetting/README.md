# TF::FortiOS::WebfilterIpsurlfiltercachesetting

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-webfilteripsurlfiltercachesetting.json`
2. Implement your resource handlers in `tf_fortios_webfilteripsurlfiltercachesetting/handlers.py`
