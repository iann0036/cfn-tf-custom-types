# TF::FortiOS::Logfortianalyzer2Setting

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logfortianalyzer2setting.json`
2. Implement your resource handlers in `tf_fortios_logfortianalyzer2setting/handlers.py`
