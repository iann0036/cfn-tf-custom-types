...
1. Write the JSON schema describing your resource, `tf-fortios-fmgfirewallobjectservice.json`
2. Implement your resource handlers in `tf_fortios_fmgfirewallobjectservice/handlers.py`
