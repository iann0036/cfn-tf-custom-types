...
1. Write the JSON schema describing your resource, `tf-fortios-firewallmulticastpolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallmulticastpolicy/handlers.py`
