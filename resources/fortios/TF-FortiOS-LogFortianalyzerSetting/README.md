...
1. Write the JSON schema describing your resource, `tf-fortios-logfortianalyzersetting.json`
2. Implement your resource handlers in `tf_fortios_logfortianalyzersetting/handlers.py`
