...
1. Write the JSON schema describing your resource, `tf-fortios-applicationcustom.json`
2. Implement your resource handlers in `tf_fortios_applicationcustom/handlers.py`
