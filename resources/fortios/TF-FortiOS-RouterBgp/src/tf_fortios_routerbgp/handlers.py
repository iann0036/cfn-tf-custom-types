...
TYPE_NAME = "TF::FortiOS::RouterBgp"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_router_bgp/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_router_bgp',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_router_bgp/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_router_bgp/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AdditionalPath=None, AdditionalPath6=None, AdditionalPathSelect=None, AdditionalPathSelect6=None, AlwaysCompareMed=None, As=None, BestpathAsPathIgnore=None, BestpathCmpConfedAspath=None, BestpathCmpRouterid=None, BestpathMedConfed=None, BestpathMedMissingAsWorst=None, ClientToClientReflection=None, ClusterId=None, ConfederationIdentifier=None, Dampening=None, DampeningMaxSuppressTime=None, DampeningReachabilityHalfLife=None, DampeningReuse=None, DampeningRouteMap=None, DampeningSuppress=None, DampeningUnreachabilityHalfLife=None, DefaultLocalPreference=None, DeterministicMed=None, DistanceExternal=None, DistanceInternal=None, DistanceLocal=None, DynamicSortSubtable=None, EbgpMultipath=None, EnforceFirstAs=None, FastExternalFailover=None, GracefulEndOnTimer=None, GracefulRestart=None, GracefulRestartTime=None, GracefulStalepathTime=None, GracefulUpdateDelay=None, HoldtimeTimer=None, IbgpMultipath=None, Id=None, IgnoreOptionalCapability=None, KeepaliveTimer=None, LogNeighbourChanges=None, MultipathRecursiveDistance=None, NetworkImportCheck=None, RecursiveNextHop=None, RouterId=None, ScanTime=None, Synchronization=None, Vdomparam=None, AdminDistance=None, AggregateAddress=None, AggregateAddress6=None, ConfederationPeers=None, Neighbor=None, NeighborGroup=None, NeighborRange=None, NeighborRange6=None, Network=None, Network6=None, Redistribute=None, Redistribute6=None, VrfLeak=None)
