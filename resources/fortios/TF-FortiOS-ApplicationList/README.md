...
1. Write the JSON schema describing your resource, `tf-fortios-applicationlist.json`
2. Implement your resource handlers in `tf_fortios_applicationlist/handlers.py`
