...
1. Write the JSON schema describing your resource, `tf-fortios-firewallinternetserviceextension.json`
2. Implement your resource handlers in `tf_fortios_firewallinternetserviceextension/handlers.py`
