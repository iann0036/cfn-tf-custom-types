...
1. Write the JSON schema describing your resource, `tf-fortios-systemsettings.json`
2. Implement your resource handlers in `tf_fortios_systemsettings/handlers.py`
