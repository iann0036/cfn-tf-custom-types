...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontroller8021xsettings.json`
2. Implement your resource handlers in `tf_fortios_switchcontroller8021xsettings/handlers.py`
