...
1. Write the JSON schema describing your resource, `tf-fortios-systemgeoipoverride.json`
2. Implement your resource handlers in `tf_fortios_systemgeoipoverride/handlers.py`
