...
1. Write the JSON schema describing your resource, `tf-fortios-firewallmulticastaddress6.json`
2. Implement your resource handlers in `tf_fortios_firewallmulticastaddress6/handlers.py`
