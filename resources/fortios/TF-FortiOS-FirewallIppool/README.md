...
1. Write the JSON schema describing your resource, `tf-fortios-firewallippool.json`
2. Implement your resource handlers in `tf_fortios_firewallippool/handlers.py`
