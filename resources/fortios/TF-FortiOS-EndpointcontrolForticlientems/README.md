...
1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolforticlientems.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolforticlientems/handlers.py`
