# TF::FortiOS::CifsProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-cifsprofile.json`
2. Implement your resource handlers in `tf_fortios_cifsprofile/handlers.py`
