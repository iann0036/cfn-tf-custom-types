...
1. Write the JSON schema describing your resource, `tf-fortios-systemvnetunnel.json`
2. Implement your resource handlers in `tf_fortios_systemvnetunnel/handlers.py`
