...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsecuritypolicyseq.json`
2. Implement your resource handlers in `tf_fortios_firewallsecuritypolicyseq/handlers.py`
