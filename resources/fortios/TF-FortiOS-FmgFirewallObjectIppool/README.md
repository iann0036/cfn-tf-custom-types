...
1. Write the JSON schema describing your resource, `tf-fortios-fmgfirewallobjectippool.json`
2. Implement your resource handlers in `tf_fortios_fmgfirewallobjectippool/handlers.py`
