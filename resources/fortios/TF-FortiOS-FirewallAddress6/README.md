...
1. Write the JSON schema describing your resource, `tf-fortios-firewalladdress6.json`
2. Implement your resource handlers in `tf_fortios_firewalladdress6/handlers.py`
