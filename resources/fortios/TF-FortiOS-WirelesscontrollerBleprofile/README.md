...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerbleprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerbleprofile/handlers.py`
