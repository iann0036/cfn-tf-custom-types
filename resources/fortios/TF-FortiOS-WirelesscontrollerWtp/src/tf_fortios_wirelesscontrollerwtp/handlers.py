...
TYPE_NAME = "TF::FortiOS::WirelesscontrollerWtp"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_wirelesscontroller_wtp/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_wirelesscontroller_wtp',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_wirelesscontroller_wtp/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_wirelesscontroller_wtp/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Admin=None, Allowaccess=None, ApcfgProfile=None, BonjourProfile=None, CoordinateLatitude=None, CoordinateLongitude=None, DynamicSortSubtable=None, FirmwareProvision=None, Id=None, ImageDownload=None, Index=None, IpFragmentPreventing=None, LedState=None, Location=None, LoginPasswd=None, LoginPasswdChange=None, MeshBridgeEnable=None, Name=None, OverrideAllowaccess=None, OverrideIpFragment=None, OverrideLan=None, OverrideLedState=None, OverrideLoginPasswdChange=None, OverrideSplitTunnel=None, OverrideWanPortMode=None, Region=None, RegionX=None, RegionY=None, SplitTunnelingAclLocalApSubnet=None, SplitTunnelingAclPath=None, TunMtuDownlink=None, TunMtuUplink=None, Uuid=None, Vdomparam=None, WanPortMode=None, WtpId=None, WtpMode=None, WtpProfile=None, Lan=None, Radio1=None, Radio2=None, Radio3=None, Radio4=None, SplitTunnelingAcl=None)
