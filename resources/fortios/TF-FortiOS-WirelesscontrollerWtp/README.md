...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerwtp.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerwtp/handlers.py`
