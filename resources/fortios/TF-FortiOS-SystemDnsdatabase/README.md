...
1. Write the JSON schema describing your resource, `tf-fortios-systemdnsdatabase.json`
2. Implement your resource handlers in `tf_fortios_systemdnsdatabase/handlers.py`
