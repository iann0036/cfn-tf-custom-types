...
1. Write the JSON schema describing your resource, `tf-fortios-extendercontrollerdataplan.json`
2. Implement your resource handlers in `tf_fortios_extendercontrollerdataplan/handlers.py`
