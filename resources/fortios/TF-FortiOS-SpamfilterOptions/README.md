# TF::FortiOS::SpamfilterOptions

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-spamfilteroptions.json`
2. Implement your resource handlers in `tf_fortios_spamfilteroptions/handlers.py`
