# TF::FortiOS::VpncertificateCa

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-vpncertificateca.json`
2. Implement your resource handlers in `tf_fortios_vpncertificateca/handlers.py`
