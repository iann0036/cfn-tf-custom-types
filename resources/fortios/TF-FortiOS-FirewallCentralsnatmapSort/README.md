# TF::FortiOS::FirewallCentralsnatmapSort

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewallcentralsnatmapsort.json`
2. Implement your resource handlers in `tf_fortios_firewallcentralsnatmapsort/handlers.py`
