# TF::FortiOS::Logfortianalyzer2Overridefilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logfortianalyzer2overridefilter.json`
2. Implement your resource handlers in `tf_fortios_logfortianalyzer2overridefilter/handlers.py`
