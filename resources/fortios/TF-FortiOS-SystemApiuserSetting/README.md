...
1. Write the JSON schema describing your resource, `tf-fortios-systemapiusersetting.json`
2. Implement your resource handlers in `tf_fortios_systemapiusersetting/handlers.py`
