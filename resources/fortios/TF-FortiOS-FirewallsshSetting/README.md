...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsshsetting.json`
2. Implement your resource handlers in `tf_fortios_firewallsshsetting/handlers.py`
