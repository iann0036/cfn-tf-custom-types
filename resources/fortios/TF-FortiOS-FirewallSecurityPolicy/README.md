...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsecuritypolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallsecuritypolicy/handlers.py`
