...
TYPE_NAME = "TF::FortiOS::FirewallSecuritypolicy"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_securitypolicy/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_firewall_securitypolicy',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_securitypolicy/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_firewall_securitypolicy/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Action=None, ApplicationList=None, AvProfile=None, CifsProfile=None, Comments=None, DlpSensor=None, DnsfilterProfile=None, DstaddrNegate=None, DynamicSortSubtable=None, EmailfilterProfile=None, EnforceDefaultAppPort=None, FileFilterProfile=None, IcapProfile=None, Id=None, InternetService=None, InternetServiceNegate=None, InternetServiceSrc=None, InternetServiceSrcNegate=None, IpsSensor=None, Logtraffic=None, LogtrafficStart=None, Name=None, Policyid=None, ProfileGroup=None, ProfileProtocolOptions=None, ProfileType=None, Schedule=None, SendDenyPacket=None, ServiceNegate=None, SrcaddrNegate=None, SshFilterProfile=None, SslSshProfile=None, Status=None, Uuid=None, Vdomparam=None, VoipProfile=None, WebfilterProfile=None, AppCategory=None, AppGroup=None, Application=None, Dstaddr=None, Dstaddr4=None, Dstaddr6=None, Dstintf=None, FssoGroups=None, Groups=None, InternetServiceCustom=None, InternetServiceCustomGroup=None, InternetServiceGroup=None, InternetServiceId=None, InternetServiceName=None, InternetServiceSrcCustom=None, InternetServiceSrcCustomGroup=None, InternetServiceSrcGroup=None, InternetServiceSrcId=None, InternetServiceSrcName=None, Service=None, Srcaddr=None, Srcaddr4=None, Srcaddr6=None, Srcintf=None, UrlCategory=None, Users=None)
