# TF::FortiOS::SwitchcontrollerSnmpuser

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollersnmpuser.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollersnmpuser/handlers.py`
