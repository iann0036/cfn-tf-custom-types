...
1. Write the JSON schema describing your resource, `tf-fortios-systemglobal.json`
2. Implement your resource handlers in `tf_fortios_systemglobal/handlers.py`
