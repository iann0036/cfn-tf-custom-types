...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrolleraccesscontrollist.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrolleraccesscontrollist/handlers.py`
