# TF::FortiOS::LogfortiguardFilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logfortiguardfilter.json`
2. Implement your resource handlers in `tf_fortios_logfortiguardfilter/handlers.py`
