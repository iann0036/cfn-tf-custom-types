...
1. Write the JSON schema describing your resource, `tf-fortios-systemsnmpcommunity.json`
2. Implement your resource handlers in `tf_fortios_systemsnmpcommunity/handlers.py`
