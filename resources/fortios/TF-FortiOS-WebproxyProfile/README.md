...
1. Write the JSON schema describing your resource, `tf-fortios-webproxyprofile.json`
2. Implement your resource handlers in `tf_fortios_webproxyprofile/handlers.py`
