# TF::FortiOS::SystemreplacemsgAutomation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemreplacemsgautomation.json`
2. Implement your resource handlers in `tf_fortios_systemreplacemsgautomation/handlers.py`
