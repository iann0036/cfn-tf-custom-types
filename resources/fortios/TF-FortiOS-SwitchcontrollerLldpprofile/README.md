...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerlldpprofile.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerlldpprofile/handlers.py`
