...
1. Write the JSON schema describing your resource, `tf-fortios-systemapiuser.json`
2. Implement your resource handlers in `tf_fortios_systemapiuser/handlers.py`
