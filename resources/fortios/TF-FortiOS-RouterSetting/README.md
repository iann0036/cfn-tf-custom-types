...
1. Write the JSON schema describing your resource, `tf-fortios-routersetting.json`
2. Implement your resource handlers in `tf_fortios_routersetting/handlers.py`
