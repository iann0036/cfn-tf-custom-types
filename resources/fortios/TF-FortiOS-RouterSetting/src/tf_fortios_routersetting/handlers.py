...
TYPE_NAME = "TF::FortiOS::RouterSetting"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_router_setting/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_router_setting',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_router_setting/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_router_setting/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), BgpDebugFlags=None, Hostname=None, Id=None, IgmpDebugFlags=None, ImiDebugFlags=None, IsisDebugFlags=None, Ospf6DebugEventsFlags=None, Ospf6DebugIfsmFlags=None, Ospf6DebugLsaFlags=None, Ospf6DebugNfsmFlags=None, Ospf6DebugNsmFlags=None, Ospf6DebugPacketFlags=None, Ospf6DebugRouteFlags=None, OspfDebugEventsFlags=None, OspfDebugIfsmFlags=None, OspfDebugLsaFlags=None, OspfDebugNfsmFlags=None, OspfDebugNsmFlags=None, OspfDebugPacketFlags=None, OspfDebugRouteFlags=None, PimdmDebugFlags=None, PimsmDebugJoinpruneFlags=None, PimsmDebugSimpleFlags=None, PimsmDebugTimerFlags=None, RipDebugFlags=None, RipngDebugFlags=None, ShowFilter=None, Vdomparam=None)
