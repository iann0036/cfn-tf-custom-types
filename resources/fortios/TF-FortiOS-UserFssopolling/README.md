...
1. Write the JSON schema describing your resource, `tf-fortios-userfssopolling.json`
2. Implement your resource handlers in `tf_fortios_userfssopolling/handlers.py`
