...
1. Write the JSON schema describing your resource, `tf-fortios-routermulticast.json`
2. Implement your resource handlers in `tf_fortios_routermulticast/handlers.py`
