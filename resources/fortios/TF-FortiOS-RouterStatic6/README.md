...
1. Write the JSON schema describing your resource, `tf-fortios-routerstatic6.json`
2. Implement your resource handlers in `tf_fortios_routerstatic6/handlers.py`
