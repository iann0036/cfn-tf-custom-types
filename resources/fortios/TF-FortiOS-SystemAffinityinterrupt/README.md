...
1. Write the JSON schema describing your resource, `tf-fortios-systemaffinityinterrupt.json`
2. Implement your resource handlers in `tf_fortios_systemaffinityinterrupt/handlers.py`
