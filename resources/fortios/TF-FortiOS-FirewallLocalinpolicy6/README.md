# TF::FortiOS::FirewallLocalinpolicy6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-firewalllocalinpolicy6.json`
2. Implement your resource handlers in `tf_fortios_firewalllocalinpolicy6/handlers.py`
