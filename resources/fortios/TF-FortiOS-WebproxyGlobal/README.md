...
1. Write the JSON schema describing your resource, `tf-fortios-webproxyglobal.json`
2. Implement your resource handlers in `tf_fortios_webproxyglobal/handlers.py`
