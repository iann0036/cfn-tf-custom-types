# TF::FortiOS::FmgSystemGlobal

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemglobal.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemglobal/handlers.py`
