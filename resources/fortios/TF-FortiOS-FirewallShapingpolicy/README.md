...
1. Write the JSON schema describing your resource, `tf-fortios-firewallshapingpolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallshapingpolicy/handlers.py`
