...
TYPE_NAME = "TF::FortiOS::FirewallShapingpolicy"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_shapingpolicy/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_firewall_shapingpolicy',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_firewall_shapingpolicy/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_firewall_shapingpolicy/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), ClassId=None, Comment=None, DiffservForward=None, DiffservReverse=None, DiffservcodeForward=None, DiffservcodeRev=None, DynamicSortSubtable=None, Fosid=None, Id=None, InternetService=None, InternetServiceSrc=None, IpVersion=None, Name=None, PerIpShaper=None, Schedule=None, Status=None, Tos=None, TosMask=None, TosNegate=None, TrafficShaper=None, TrafficShaperReverse=None, Vdomparam=None, AppCategory=None, AppGroup=None, Application=None, Dstaddr=None, Dstaddr6=None, Dstintf=None, Groups=None, InternetServiceCustom=None, InternetServiceCustomGroup=None, InternetServiceGroup=None, InternetServiceId=None, InternetServiceName=None, InternetServiceSrcCustom=None, InternetServiceSrcCustomGroup=None, InternetServiceSrcGroup=None, InternetServiceSrcId=None, InternetServiceSrcName=None, Service=None, Srcaddr=None, Srcaddr6=None, Srcintf=None, UrlCategory=None, Users=None)
