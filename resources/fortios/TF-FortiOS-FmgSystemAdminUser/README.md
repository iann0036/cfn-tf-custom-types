...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemadminuser.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemadminuser/handlers.py`
