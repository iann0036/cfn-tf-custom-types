...
1. Write the JSON schema describing your resource, `tf-fortios-firewallmulticastaddress.json`
2. Implement your resource handlers in `tf_fortios_firewallmulticastaddress/handlers.py`
