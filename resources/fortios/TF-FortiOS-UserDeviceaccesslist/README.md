# TF::FortiOS::UserDeviceaccesslist

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-userdeviceaccesslist.json`
2. Implement your resource handlers in `tf_fortios_userdeviceaccesslist/handlers.py`
