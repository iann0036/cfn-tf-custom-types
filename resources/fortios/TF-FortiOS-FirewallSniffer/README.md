...
1. Write the JSON schema describing your resource, `tf-fortios-firewallsniffer.json`
2. Implement your resource handlers in `tf_fortios_firewallsniffer/handlers.py`
