...
1. Write the JSON schema describing your resource, `tf-fortios-firewallscheduleonetime.json`
2. Implement your resource handlers in `tf_fortios_firewallscheduleonetime/handlers.py`
