...
1. Write the JSON schema describing your resource, `tf-fortios-firewallpolicy.json`
2. Implement your resource handlers in `tf_fortios_firewallpolicy/handlers.py`
