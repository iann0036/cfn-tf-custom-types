...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollersystem.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollersystem/handlers.py`
