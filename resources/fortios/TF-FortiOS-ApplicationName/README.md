# TF::FortiOS::ApplicationName

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-applicationname.json`
2. Implement your resource handlers in `tf_fortios_applicationname/handlers.py`
