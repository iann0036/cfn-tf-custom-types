...
<pre>
{
    "Type" : "TF::FortiOS::ApplicationName",
    "Properties" : {
        ...
        "<a href="#popularity" title="Popularity">Popularity</a>" : <i>Double</i>,
        "<a href="#protocol" title="Protocol">Protocol</a>" : <i>String</i>,
        "<a href="#risk" title="Risk">Risk</a>" : <i>Double</i>,
        "<a href="#subcategory" title="SubCategory">SubCategory</a>" : <i>Double</i>,
