...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemnetworkroute.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemnetworkroute/handlers.py`
