...
1. Write the JSON schema describing your resource, `tf-fortios-routerbgpnetwork6.json`
2. Implement your resource handlers in `tf_fortios_routerbgpnetwork6/handlers.py`
