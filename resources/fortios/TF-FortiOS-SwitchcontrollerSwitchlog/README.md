...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerswitchlog.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerswitchlog/handlers.py`
