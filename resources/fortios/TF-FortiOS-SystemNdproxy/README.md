# TF::FortiOS::SystemNdproxy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemndproxy.json`
2. Implement your resource handlers in `tf_fortios_systemndproxy/handlers.py`
