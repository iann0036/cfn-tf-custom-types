# TF::FortiOS::RouterBfd6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-routerbfd6.json`
2. Implement your resource handlers in `tf_fortios_routerbfd6/handlers.py`
