...
1. Write the JSON schema describing your resource, `tf-fortios-systemaccprofile.json`
2. Implement your resource handlers in `tf_fortios_systemaccprofile/handlers.py`
