...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerinitialconfigtemplate.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerinitialconfigtemplate/handlers.py`
