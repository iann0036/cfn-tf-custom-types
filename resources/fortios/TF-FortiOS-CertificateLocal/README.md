...
1. Write the JSON schema describing your resource, `tf-fortios-certificatelocal.json`
2. Implement your resource handlers in `tf_fortios_certificatelocal/handlers.py`
