...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerlldpsettings.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerlldpsettings/handlers.py`
