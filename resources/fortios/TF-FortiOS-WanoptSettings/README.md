...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptsettings.json`
2. Implement your resource handlers in `tf_fortios_wanoptsettings/handlers.py`
