# TF::FortiOS::SwitchcontrollerStpinstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerstpinstance.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerstpinstance/handlers.py`
