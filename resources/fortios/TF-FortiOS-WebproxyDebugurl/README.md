# TF::FortiOS::WebproxyDebugurl

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-webproxydebugurl.json`
2. Implement your resource handlers in `tf_fortios_webproxydebugurl/handlers.py`
