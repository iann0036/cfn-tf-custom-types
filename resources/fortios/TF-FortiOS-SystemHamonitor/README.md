...
1. Write the JSON schema describing your resource, `tf-fortios-systemhamonitor.json`
2. Implement your resource handlers in `tf_fortios_systemhamonitor/handlers.py`
