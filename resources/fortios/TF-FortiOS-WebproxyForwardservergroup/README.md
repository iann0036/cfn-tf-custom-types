...
1. Write the JSON schema describing your resource, `tf-fortios-webproxyforwardservergroup.json`
2. Implement your resource handlers in `tf_fortios_webproxyforwardservergroup/handlers.py`
