# TF::FortiOS::Logsyslogd4Overridefilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logsyslogd4overridefilter.json`
2. Implement your resource handlers in `tf_fortios_logsyslogd4overridefilter/handlers.py`
