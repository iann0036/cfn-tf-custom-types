...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollertrafficpolicy.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollertrafficpolicy/handlers.py`
