# TF::FortiOS::RouterPrefixlist6

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-routerprefixlist6.json`
2. Implement your resource handlers in `tf_fortios_routerprefixlist6/handlers.py`
