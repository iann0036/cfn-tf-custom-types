...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollermpskprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollermpskprofile/handlers.py`
