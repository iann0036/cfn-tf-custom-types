...
1. Write the JSON schema describing your resource, `tf-fortios-authenticationsetting.json`
2. Implement your resource handlers in `tf_fortios_authenticationsetting/handlers.py`
