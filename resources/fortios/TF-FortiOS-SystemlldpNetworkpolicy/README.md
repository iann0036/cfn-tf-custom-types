...
1. Write the JSON schema describing your resource, `tf-fortios-systemlldpnetworkpolicy.json`
2. Implement your resource handlers in `tf_fortios_systemlldpnetworkpolicy/handlers.py`
