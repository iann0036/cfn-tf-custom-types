...
1. Write the JSON schema describing your resource, `tf-fortios-logsyslogd2overridesetting.json`
2. Implement your resource handlers in `tf_fortios_logsyslogd2overridesetting/handlers.py`
