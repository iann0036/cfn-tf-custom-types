# TF::FortiOS::SystemreplacemsgAdmin

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemreplacemsgadmin.json`
2. Implement your resource handlers in `tf_fortios_systemreplacemsgadmin/handlers.py`
