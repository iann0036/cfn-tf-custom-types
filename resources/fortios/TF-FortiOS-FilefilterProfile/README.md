...
1. Write the JSON schema describing your resource, `tf-fortios-filefilterprofile.json`
2. Implement your resource handlers in `tf_fortios_filefilterprofile/handlers.py`
