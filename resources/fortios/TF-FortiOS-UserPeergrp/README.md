# TF::FortiOS::UserPeergrp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-userpeergrp.json`
2. Implement your resource handlers in `tf_fortios_userpeergrp/handlers.py`
