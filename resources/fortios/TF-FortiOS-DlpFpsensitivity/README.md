# TF::FortiOS::DlpFpsensitivity

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-dlpfpsensitivity.json`
2. Implement your resource handlers in `tf_fortios_dlpfpsensitivity/handlers.py`
