...
1. Write the JSON schema describing your resource, `tf-fortios-vpnsslwebrealm.json`
2. Implement your resource handlers in `tf_fortios_vpnsslwebrealm/handlers.py`
