...
1. Write the JSON schema describing your resource, `tf-fortios-systemvdomnetflow.json`
2. Implement your resource handlers in `tf_fortios_systemvdomnetflow/handlers.py`
