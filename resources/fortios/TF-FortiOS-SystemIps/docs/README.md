...
<pre>
{
    "Type" : "TF::FortiOS::SystemIps",
    "Properties" : {
        "<a href="#overridesignatureholdbyid" title="OverrideSignatureHoldById">OverrideSignatureHoldById</a>" : <i>String</i>,
        "<a href="#signatureholdtime" title="SignatureHoldTime">SignatureHoldTime</a>" : <i>String</i>,
