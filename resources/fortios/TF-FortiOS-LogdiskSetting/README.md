...
1. Write the JSON schema describing your resource, `tf-fortios-logdisksetting.json`
2. Implement your resource handlers in `tf_fortios_logdisksetting/handlers.py`
