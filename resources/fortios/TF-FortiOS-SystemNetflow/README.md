...
1. Write the JSON schema describing your resource, `tf-fortios-systemnetflow.json`
2. Implement your resource handlers in `tf_fortios_systemnetflow/handlers.py`
