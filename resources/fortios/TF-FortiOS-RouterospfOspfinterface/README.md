...
1. Write the JSON schema describing your resource, `tf-fortios-routerospfospfinterface.json`
2. Implement your resource handlers in `tf_fortios_routerospfospfinterface/handlers.py`
