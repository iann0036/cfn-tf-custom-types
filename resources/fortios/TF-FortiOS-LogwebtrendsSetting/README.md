# TF::FortiOS::LogwebtrendsSetting

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-logwebtrendssetting.json`
2. Implement your resource handlers in `tf_fortios_logwebtrendssetting/handlers.py`
