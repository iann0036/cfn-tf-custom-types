...
1. Write the JSON schema describing your resource, `tf-fortios-systemsnmpsysinfo.json`
2. Implement your resource handlers in `tf_fortios_systemsnmpsysinfo/handlers.py`
