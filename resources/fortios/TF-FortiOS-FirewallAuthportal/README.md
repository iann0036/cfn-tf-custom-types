...
1. Write the JSON schema describing your resource, `tf-fortios-firewallauthportal.json`
2. Implement your resource handlers in `tf_fortios_firewallauthportal/handlers.py`
