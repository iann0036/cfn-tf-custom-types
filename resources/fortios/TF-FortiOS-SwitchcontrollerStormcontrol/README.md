...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollerstormcontrol.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollerstormcontrol/handlers.py`
