...
1. Write the JSON schema describing your resource, `tf-fortios-antivirusquarantine.json`
2. Implement your resource handlers in `tf_fortios_antivirusquarantine/handlers.py`
