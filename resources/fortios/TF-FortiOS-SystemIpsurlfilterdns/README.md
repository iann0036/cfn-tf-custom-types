...
1. Write the JSON schema describing your resource, `tf-fortios-systemipsurlfilterdns.json`
2. Implement your resource handlers in `tf_fortios_systemipsurlfilterdns/handlers.py`
