...
1. Write the JSON schema describing your resource, `tf-fortios-systemcentralmanagement.json`
2. Implement your resource handlers in `tf_fortios_systemcentralmanagement/handlers.py`
