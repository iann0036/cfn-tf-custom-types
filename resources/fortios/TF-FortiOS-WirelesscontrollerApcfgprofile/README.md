...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerapcfgprofile.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerapcfgprofile/handlers.py`
