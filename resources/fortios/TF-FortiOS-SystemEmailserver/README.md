...
1. Write the JSON schema describing your resource, `tf-fortios-systememailserver.json`
2. Implement your resource handlers in `tf_fortios_systememailserver/handlers.py`
