...
1. Write the JSON schema describing your resource, `tf-fortios-systemautomationtrigger.json`
2. Implement your resource handlers in `tf_fortios_systemautomationtrigger/handlers.py`
