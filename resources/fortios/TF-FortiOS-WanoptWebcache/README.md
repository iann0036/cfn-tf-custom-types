...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptwebcache.json`
2. Implement your resource handlers in `tf_fortios_wanoptwebcache/handlers.py`
