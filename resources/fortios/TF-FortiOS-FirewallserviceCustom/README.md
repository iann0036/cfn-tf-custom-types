...
1. Write the JSON schema describing your resource, `tf-fortios-firewallservicecustom.json`
2. Implement your resource handlers in `tf_fortios_firewallservicecustom/handlers.py`
