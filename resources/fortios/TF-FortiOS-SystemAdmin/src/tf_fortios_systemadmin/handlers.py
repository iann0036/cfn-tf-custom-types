...
TYPE_NAME = "TF::FortiOS::SystemAdmin"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_admin/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_system_admin',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_admin/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_system_admin/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Accprofile=None, AccprofileOverride=None, AllowRemoveAdminSession=None, Comments=None, DynamicSortSubtable=None, EmailTo=None, ForcePasswordChange=None, Fortitoken=None, GuestAuth=None, GuestLang=None, Hidden=None, History0=None, History1=None, Id=None, Ip6Trusthost1=None, Ip6Trusthost10=None, Ip6Trusthost2=None, Ip6Trusthost3=None, Ip6Trusthost4=None, Ip6Trusthost5=None, Ip6Trusthost6=None, Ip6Trusthost7=None, Ip6Trusthost8=None, Ip6Trusthost9=None, Name=None, Password=None, PasswordExpire=None, PeerAuth=None, PeerGroup=None, RadiusVdomOverride=None, RemoteAuth=None, RemoteGroup=None, Schedule=None, SmsCustomServer=None, SmsPhone=None, SmsServer=None, SshCertificate=None, SshPublicKey1=None, SshPublicKey2=None, SshPublicKey3=None, Trusthost1=None, Trusthost10=None, Trusthost2=None, Trusthost3=None, Trusthost4=None, Trusthost5=None, Trusthost6=None, Trusthost7=None, Trusthost8=None, Trusthost9=None, TwoFactor=None, TwoFactorAuthentication=None, TwoFactorNotification=None, Vdomparam=None, Wildcard=None, GuestUsergroups=None, GuiDashboard=None, GuiGlobalMenuFavorites=None, GuiNewFeatureAcknowledge=None, GuiVdomMenuFavorites=None, LoginTime=None, Vdom=None)
