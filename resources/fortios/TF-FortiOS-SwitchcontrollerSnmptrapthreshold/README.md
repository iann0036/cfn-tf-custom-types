...
1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollersnmptrapthreshold.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollersnmptrapthreshold/handlers.py`
