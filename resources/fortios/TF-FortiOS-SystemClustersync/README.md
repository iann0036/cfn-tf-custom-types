...
1. Write the JSON schema describing your resource, `tf-fortios-systemclustersync.json`
2. Implement your resource handlers in `tf_fortios_systemclustersync/handlers.py`
