# TF::FortiOS::EndpointcontrolForticlientregistrationsync

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolforticlientregistrationsync.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolforticlientregistrationsync/handlers.py`
