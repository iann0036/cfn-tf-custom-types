...
1. Write the JSON schema describing your resource, `tf-fortios-logfortianalyzercloudsetting.json`
2. Implement your resource handlers in `tf_fortios_logfortianalyzercloudsetting/handlers.py`
