...
1. Write the JSON schema describing your resource, `tf-fortios-networkingroutestatic.json`
2. Implement your resource handlers in `tf_fortios_networkingroutestatic/handlers.py`
