...
1. Write the JSON schema describing your resource, `tf-fortios-firewallipv6ehfilter.json`
2. Implement your resource handlers in `tf_fortios_firewallipv6ehfilter/handlers.py`
