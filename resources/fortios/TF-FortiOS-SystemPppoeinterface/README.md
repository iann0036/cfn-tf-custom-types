...
1. Write the JSON schema describing your resource, `tf-fortios-systempppoeinterface.json`
2. Implement your resource handlers in `tf_fortios_systempppoeinterface/handlers.py`
