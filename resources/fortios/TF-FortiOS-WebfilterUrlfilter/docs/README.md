...
<pre>
{
    "Type" : "TF::FortiOS::WebfilterUrlfilter",
    "Properties" : {
        "<a href="#comment" title="Comment">Comment</a>" : <i>String</i>,
        "<a href="#dynamicsortsubtable" title="DynamicSortSubtable">DynamicSortSubtable</a>" : <i>String</i>,
        "<a href="#fosid" title="Fosid">Fosid</a>" : <i>Double</i>,
        "<a href="#ipaddrblock" title="IpAddrBlock">IpAddrBlock</a>" : <i>String</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#onearmipsurlfilter" title="OneArmIpsUrlfilter">OneArmIpsUrlfilter</a>" : <i>String</i>,
