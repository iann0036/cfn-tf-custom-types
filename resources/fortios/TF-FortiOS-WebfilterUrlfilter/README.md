...
1. Write the JSON schema describing your resource, `tf-fortios-webfilterurlfilter.json`
2. Implement your resource handlers in `tf_fortios_webfilterurlfilter/handlers.py`
