...
1. Write the JSON schema describing your resource, `tf-fortios-firewallobjectvipgroup.json`
2. Implement your resource handlers in `tf_fortios_firewallobjectvipgroup/handlers.py`
