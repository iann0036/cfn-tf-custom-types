...
1. Write the JSON schema describing your resource, `tf-fortios-wanoptprofile.json`
2. Implement your resource handlers in `tf_fortios_wanoptprofile/handlers.py`
