...
1. Write the JSON schema describing your resource, `tf-fortios-systemsdnconnector.json`
2. Implement your resource handlers in `tf_fortios_systemsdnconnector/handlers.py`
