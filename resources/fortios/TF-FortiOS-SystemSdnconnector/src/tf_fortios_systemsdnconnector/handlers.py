...
TYPE_NAME = "TF::FortiOS::SystemSdnconnector"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_sdnconnector/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_system_sdnconnector',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_system_sdnconnector/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_system_sdnconnector/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccessKey=None, ApiKey=None, AzureRegion=None, ClientId=None, ClientSecret=None, CompartmentId=None, ComputeGeneration=None, Domain=None, DynamicSortSubtable=None, GcpProject=None, GroupName=None, HaStatus=None, IbmRegion=None, Id=None, KeyPasswd=None, LoginEndpoint=None, Name=None, OciCert=None, OciFingerprint=None, OciRegion=None, OciRegionType=None, Password=None, PrivateKey=None, Region=None, ResourceGroup=None, ResourceUrl=None, SecretKey=None, SecretToken=None, Server=None, ServerPort=None, ServiceAccount=None, Status=None, SubscriptionId=None, TenantId=None, Type=None, UpdateInterval=None, UseMetadataIam=None, UserId=None, Username=None, VcenterPassword=None, VcenterServer=None, VcenterUsername=None, Vdomparam=None, VpcId=None, ExternalIp=None, Nic=None, Route=None, RouteTable=None)
