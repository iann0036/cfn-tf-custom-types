...
1. Write the JSON schema describing your resource, `tf-fortios-firewallobjectippool.json`
2. Implement your resource handlers in `tf_fortios_firewallobjectippool/handlers.py`
