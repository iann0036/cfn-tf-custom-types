...
1. Write the JSON schema describing your resource, `tf-fortios-wirelesscontrollerlog.json`
2. Implement your resource handlers in `tf_fortios_wirelesscontrollerlog/handlers.py`
