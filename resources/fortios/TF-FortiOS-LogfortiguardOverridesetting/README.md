...
1. Write the JSON schema describing your resource, `tf-fortios-logfortiguardoverridesetting.json`
2. Implement your resource handlers in `tf_fortios_logfortiguardoverridesetting/handlers.py`
