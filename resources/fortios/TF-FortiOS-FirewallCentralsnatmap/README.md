...
1. Write the JSON schema describing your resource, `tf-fortios-firewallcentralsnatmap.json`
2. Implement your resource handlers in `tf_fortios_firewallcentralsnatmap/handlers.py`
