# TF::FortiOS::SwitchcontrollerNetworkmonitorsettings

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-switchcontrollernetworkmonitorsettings.json`
2. Implement your resource handlers in `tf_fortios_switchcontrollernetworkmonitorsettings/handlers.py`
