...
1. Write the JSON schema describing your resource, `tf-fortios-firewallipmacbindingtable.json`
2. Implement your resource handlers in `tf_fortios_firewallipmacbindingtable/handlers.py`
