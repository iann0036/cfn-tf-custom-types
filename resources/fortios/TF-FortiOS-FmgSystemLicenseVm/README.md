# TF::FortiOS::FmgSystemLicenseVm

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemlicensevm.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemlicensevm/handlers.py`
