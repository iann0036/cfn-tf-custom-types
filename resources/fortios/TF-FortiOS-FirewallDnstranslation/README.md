...
1. Write the JSON schema describing your resource, `tf-fortios-firewalldnstranslation.json`
2. Implement your resource handlers in `tf_fortios_firewalldnstranslation/handlers.py`
