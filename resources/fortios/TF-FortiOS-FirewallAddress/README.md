...
1. Write the JSON schema describing your resource, `tf-fortios-firewalladdress.json`
2. Implement your resource handlers in `tf_fortios_firewalladdress/handlers.py`
