...
1. Write the JSON schema describing your resource, `tf-fortios-endpointcontrolregisteredforticlient.json`
2. Implement your resource handlers in `tf_fortios_endpointcontrolregisteredforticlient/handlers.py`
