...
1. Write the JSON schema describing your resource, `tf-fortios-systemdhcpserver.json`
2. Implement your resource handlers in `tf_fortios_systemdhcpserver/handlers.py`
