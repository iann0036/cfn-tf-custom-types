...
TYPE_NAME = "TF::FortiOS::SystemdhcpServer"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_systemdhcp_server/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'fortios_systemdhcp_server',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/fortios_systemdhcp_server/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/fortios_systemdhcp_server/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AutoConfiguration=None, AutoManagedStatus=None, ConflictedIpTimeout=None, DdnsAuth=None, DdnsKey=None, DdnsKeyname=None, DdnsServerIp=None, DdnsTtl=None, DdnsUpdate=None, DdnsUpdateOverride=None, DdnsZone=None, DefaultGateway=None, DhcpSettingsFromFortiipam=None, DnsServer1=None, DnsServer2=None, DnsServer3=None, DnsServer4=None, DnsService=None, Domain=None, DynamicSortSubtable=None, Filename=None, ForticlientOnNetStatus=None, Fosid=None, Id=None, Interface=None, IpMode=None, IpsecLeaseHold=None, LeaseTime=None, MacAclDefaultAction=None, Netmask=None, NextServer=None, NtpServer1=None, NtpServer2=None, NtpServer3=None, NtpService=None, ServerType=None, Status=None, Timezone=None, TimezoneOption=None, VciMatch=None, Vdomparam=None, WifiAc1=None, WifiAc2=None, WifiAc3=None, WifiAcService=None, WinsServer1=None, WinsServer2=None, ExcludeRange=None, IpRange=None, Options=None, ReservedAddress=None, TftpServer=None, VciString=None)
