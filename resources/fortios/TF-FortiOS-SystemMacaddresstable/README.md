# TF::FortiOS::SystemMacaddresstable

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fortios-systemmacaddresstable.json`
2. Implement your resource handlers in `tf_fortios_systemmacaddresstable/handlers.py`
