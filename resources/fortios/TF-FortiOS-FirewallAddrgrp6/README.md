...
1. Write the JSON schema describing your resource, `tf-fortios-firewalladdrgrp6.json`
2. Implement your resource handlers in `tf_fortios_firewalladdrgrp6/handlers.py`
