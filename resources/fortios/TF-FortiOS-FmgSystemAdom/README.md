...
1. Write the JSON schema describing your resource, `tf-fortios-fmgsystemadom.json`
2. Implement your resource handlers in `tf_fortios_fmgsystemadom/handlers.py`
