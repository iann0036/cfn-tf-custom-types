...
1. Write the JSON schema describing your resource, `tf-wavefront-externallink.json`
2. Implement your resource handlers in `tf_wavefront_externallink/handlers.py`
