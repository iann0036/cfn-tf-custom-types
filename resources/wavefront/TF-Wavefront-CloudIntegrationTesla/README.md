# TF::Wavefront::CloudIntegrationTesla

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationtesla.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationtesla/handlers.py`
