# TF::Wavefront::CloudIntegrationCloudtrail

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationcloudtrail.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationcloudtrail/handlers.py`
