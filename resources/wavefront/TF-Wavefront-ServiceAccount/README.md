...
1. Write the JSON schema describing your resource, `tf-wavefront-serviceaccount.json`
2. Implement your resource handlers in `tf_wavefront_serviceaccount/handlers.py`
