# TF::Wavefront::IngestionPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-wavefront-ingestionpolicy.json`
2. Implement your resource handlers in `tf_wavefront_ingestionpolicy/handlers.py`
