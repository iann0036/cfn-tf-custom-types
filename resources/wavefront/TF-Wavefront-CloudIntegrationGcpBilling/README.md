...
1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationgcpbilling.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationgcpbilling/handlers.py`
