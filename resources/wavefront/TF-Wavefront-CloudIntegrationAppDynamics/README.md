...
1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationappdynamics.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationappdynamics/handlers.py`
