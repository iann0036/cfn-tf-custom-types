...
1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationnewrelic.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationnewrelic/handlers.py`
