# TF::Wavefront::CloudIntegrationNewrelic

CloudFormation equivalent of wavefront_cloud_integration_newrelic
...
<pre>
{
    "Type" : "TF::Wavefront::CloudIntegrationNewrelic",
    "Properties" : {
        ...
        "<a href="#hostfilterregex" title="HostFilterRegex">HostFilterRegex</a>" : <i>String</i>,
