...
1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationcloudwatch.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationcloudwatch/handlers.py`
