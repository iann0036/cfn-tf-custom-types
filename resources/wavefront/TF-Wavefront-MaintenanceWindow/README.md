...
1. Write the JSON schema describing your resource, `tf-wavefront-maintenancewindow.json`
2. Implement your resource handlers in `tf_wavefront_maintenancewindow/handlers.py`
