...
1. Write the JSON schema describing your resource, `tf-wavefront-alerttarget.json`
2. Implement your resource handlers in `tf_wavefront_alerttarget/handlers.py`
