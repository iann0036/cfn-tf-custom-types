...
class ResourceModel(BaseModel):
    ...
    CategoryFilter: Optional[Sequence[str]]
    ...
    Name: Optional[str]
    ResourceGroupFilter: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CategoryFilter=json_data.get("CategoryFilter"),
            ...
            ResourceGroupFilter=json_data.get("ResourceGroupFilter"),
