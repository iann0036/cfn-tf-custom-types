...
1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationec2.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationec2/handlers.py`
