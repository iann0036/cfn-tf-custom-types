...
1. Write the JSON schema describing your resource, `tf-wavefront-cloudintegrationazureactivitylog.json`
2. Implement your resource handlers in `tf_wavefront_cloudintegrationazureactivitylog/handlers.py`
