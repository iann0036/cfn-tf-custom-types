...
def create_handler(
    ...
    try:
        ...
        tf['resource']['opentelekomcloud_vpc_v1'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['opentelekomcloud_vpc_v1'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
