# Terraform::OpenTelekomCloud::VpnaasIkePolicyV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-vpnaasikepolicyv2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_vpnaasikepolicyv2/handlers.py`
