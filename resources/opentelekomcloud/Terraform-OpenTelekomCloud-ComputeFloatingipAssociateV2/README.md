...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-computefloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_computefloatingipassociatev2/handlers.py`
