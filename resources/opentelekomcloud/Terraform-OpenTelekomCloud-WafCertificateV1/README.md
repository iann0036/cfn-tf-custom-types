...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-wafcertificatev1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_wafcertificatev1/handlers.py`
