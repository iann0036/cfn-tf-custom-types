...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-s3bucketpolicy.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_s3bucketpolicy/handlers.py`
