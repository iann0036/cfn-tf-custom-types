...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-networkingfloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_networkingfloatingipassociatev2/handlers.py`
