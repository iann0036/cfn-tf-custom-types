# Terraform::OpenTelekomCloud::DmsGroupV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-dmsgroupv1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_dmsgroupv1/handlers.py`
