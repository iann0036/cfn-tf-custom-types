...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-elblistener.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_elblistener/handlers.py`
