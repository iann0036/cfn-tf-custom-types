...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-csbsbackupv1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_csbsbackupv1/handlers.py`
