...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-elbloadbalancer.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_elbloadbalancer/handlers.py`
