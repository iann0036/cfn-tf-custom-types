...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-computefloatingipv2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_computefloatingipv2/handlers.py`
