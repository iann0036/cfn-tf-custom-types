...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-rtssoftwareconfigv1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_rtssoftwareconfigv1/handlers.py`
