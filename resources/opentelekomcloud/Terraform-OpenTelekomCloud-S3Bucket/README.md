...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-s3bucket.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_s3bucket/handlers.py`
