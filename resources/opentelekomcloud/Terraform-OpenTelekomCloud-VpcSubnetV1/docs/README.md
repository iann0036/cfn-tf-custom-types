...
CloudFormation equivalent of opentelekomcloud_vpc_subnet_v1
...
<pre>
{
    "Type" : "Terraform::OpenTelekomCloud::VpcSubnetV1",
    "Properties" : {
        ...
        "<a href="#ntpaddresses" title="NtpAddresses">NtpAddresses</a>" : <i>String</i>,
