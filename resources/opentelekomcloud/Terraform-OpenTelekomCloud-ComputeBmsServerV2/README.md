...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-computebmsserverv2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_computebmsserverv2/handlers.py`
