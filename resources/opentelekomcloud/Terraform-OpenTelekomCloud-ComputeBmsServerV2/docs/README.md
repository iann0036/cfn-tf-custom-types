...
CloudFormation equivalent of opentelekomcloud_compute_bms_server_v2
...
<pre>
{
    "Type" : "Terraform::OpenTelekomCloud::ComputeBmsServerV2",
    "Properties" : {
        ...
        "<a href="#hoststatus" title="HostStatus">HostStatus</a>" : <i>String</i>,
