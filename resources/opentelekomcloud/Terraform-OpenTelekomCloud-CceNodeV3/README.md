...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-ccenodev3.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_ccenodev3/handlers.py`
