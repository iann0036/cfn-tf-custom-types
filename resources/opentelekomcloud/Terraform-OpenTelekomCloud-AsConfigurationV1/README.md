...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-asconfigurationv1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_asconfigurationv1/handlers.py`
