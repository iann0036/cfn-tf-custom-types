...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-csbsbackuppolicyv1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_csbsbackuppolicyv1/handlers.py`
