...
CloudFormation equivalent of opentelekomcloud_fw_policy_v2
...
<pre>
{
    "Type" : "Terraform::OpenTelekomCloud::FwPolicyV2",
    "Properties" : {
        "<a href="#audited" title="Audited">Audited</a>" : <i>Boolean</i>,
