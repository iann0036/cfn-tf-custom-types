...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-natsnatrulev2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_natsnatrulev2/handlers.py`
