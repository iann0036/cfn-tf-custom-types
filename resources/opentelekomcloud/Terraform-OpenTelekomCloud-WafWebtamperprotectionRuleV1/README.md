# Terraform::OpenTelekomCloud::WafWebtamperprotectionRuleV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-wafwebtamperprotectionrulev1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_wafwebtamperprotectionrulev1/handlers.py`
