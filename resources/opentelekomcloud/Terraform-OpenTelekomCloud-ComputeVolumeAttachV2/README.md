# Terraform::OpenTelekomCloud::ComputeVolumeAttachV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-computevolumeattachv2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_computevolumeattachv2/handlers.py`
