...
1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-vpnaasservicev2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_vpnaasservicev2/handlers.py`
