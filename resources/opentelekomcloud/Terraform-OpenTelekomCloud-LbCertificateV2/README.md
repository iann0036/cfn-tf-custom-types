# Terraform::OpenTelekomCloud::LbCertificateV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-lbcertificatev2.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_lbcertificatev2/handlers.py`
