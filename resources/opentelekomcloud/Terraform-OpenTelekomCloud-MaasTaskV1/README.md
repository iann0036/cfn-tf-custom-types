# Terraform::OpenTelekomCloud::MaasTaskV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-opentelekomcloud-maastaskv1.json`
2. Implement your resource handlers in `terraform_opentelekomcloud_maastaskv1/handlers.py`
