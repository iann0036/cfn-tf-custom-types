...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-cloudrule.json`
2. Implement your resource handlers in `tf_cloudtamerio_cloudrule/handlers.py`
