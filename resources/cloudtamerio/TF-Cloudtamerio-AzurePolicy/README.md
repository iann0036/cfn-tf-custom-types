# TF::Cloudtamerio::AzurePolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudtamerio-azurepolicy.json`
2. Implement your resource handlers in `tf_cloudtamerio_azurepolicy/handlers.py`
