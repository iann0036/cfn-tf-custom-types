...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-compliancecheck.json`
2. Implement your resource handlers in `tf_cloudtamerio_compliancecheck/handlers.py`
