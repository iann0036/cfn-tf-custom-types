...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-awsiampolicy.json`
2. Implement your resource handlers in `tf_cloudtamerio_awsiampolicy/handlers.py`
