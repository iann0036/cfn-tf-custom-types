...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-awscloudformationtemplate.json`
2. Implement your resource handlers in `tf_cloudtamerio_awscloudformationtemplate/handlers.py`
