...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-compliancestandard.json`
2. Implement your resource handlers in `tf_cloudtamerio_compliancestandard/handlers.py`
