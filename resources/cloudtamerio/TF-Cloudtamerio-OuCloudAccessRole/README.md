...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-oucloudaccessrole.json`
2. Implement your resource handlers in `tf_cloudtamerio_oucloudaccessrole/handlers.py`
