...
1. Write the JSON schema describing your resource, `tf-cloudtamerio-projectcloudaccessrole.json`
2. Implement your resource handlers in `tf_cloudtamerio_projectcloudaccessrole/handlers.py`
