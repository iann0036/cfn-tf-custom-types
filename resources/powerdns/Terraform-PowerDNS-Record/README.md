...
1. Write the JSON schema describing your resource, `terraform-powerdns-record.json`
2. Implement your resource handlers in `terraform_powerdns_record/handlers.py`
