...
1. Write the JSON schema describing your resource, `terraform-powerdns-zone.json`
2. Implement your resource handlers in `terraform_powerdns_zone/handlers.py`
