...
1. Write the JSON schema describing your resource, `tf-buildkite-pipelineschedule.json`
2. Implement your resource handlers in `tf_buildkite_pipelineschedule/handlers.py`
