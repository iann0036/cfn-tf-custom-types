# TF::Buildkite::AgentToken

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-buildkite-agenttoken.json`
2. Implement your resource handlers in `tf_buildkite_agenttoken/handlers.py`
