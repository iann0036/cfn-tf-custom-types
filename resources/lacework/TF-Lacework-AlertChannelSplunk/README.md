...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelsplunk.json`
2. Implement your resource handlers in `tf_lacework_alertchannelsplunk/handlers.py`
