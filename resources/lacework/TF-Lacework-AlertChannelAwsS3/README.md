...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelawss3.json`
2. Implement your resource handlers in `tf_lacework_alertchannelawss3/handlers.py`
