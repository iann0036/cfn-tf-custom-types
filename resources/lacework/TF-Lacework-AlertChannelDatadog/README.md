...
1. Write the JSON schema describing your resource, `tf-lacework-alertchanneldatadog.json`
2. Implement your resource handlers in `tf_lacework_alertchanneldatadog/handlers.py`
