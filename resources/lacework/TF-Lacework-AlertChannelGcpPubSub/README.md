...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelgcppubsub.json`
2. Implement your resource handlers in `tf_lacework_alertchannelgcppubsub/handlers.py`
