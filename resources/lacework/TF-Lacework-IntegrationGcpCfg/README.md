...
1. Write the JSON schema describing your resource, `tf-lacework-integrationgcpcfg.json`
2. Implement your resource handlers in `tf_lacework_integrationgcpcfg/handlers.py`
