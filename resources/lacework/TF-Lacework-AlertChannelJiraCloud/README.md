# TF::Lacework::AlertChannelJiraCloud

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-lacework-alertchanneljiracloud.json`
2. Implement your resource handlers in `tf_lacework_alertchanneljiracloud/handlers.py`
