...
1. Write the JSON schema describing your resource, `tf-lacework-integrationgcpat.json`
2. Implement your resource handlers in `tf_lacework_integrationgcpat/handlers.py`
