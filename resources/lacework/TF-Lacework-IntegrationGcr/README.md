...
1. Write the JSON schema describing your resource, `tf-lacework-integrationgcr.json`
2. Implement your resource handlers in `tf_lacework_integrationgcr/handlers.py`
