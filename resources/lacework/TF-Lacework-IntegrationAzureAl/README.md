...
1. Write the JSON schema describing your resource, `tf-lacework-integrationazureal.json`
2. Implement your resource handlers in `tf_lacework_integrationazureal/handlers.py`
