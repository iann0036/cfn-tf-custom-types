# TF::Lacework::AlertChannelPagerduty

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-lacework-alertchannelpagerduty.json`
2. Implement your resource handlers in `tf_lacework_alertchannelpagerduty/handlers.py`
