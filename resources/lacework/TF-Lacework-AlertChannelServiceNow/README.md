...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelservicenow.json`
2. Implement your resource handlers in `tf_lacework_alertchannelservicenow/handlers.py`
