...
1. Write the JSON schema describing your resource, `tf-lacework-integrationdockerhub.json`
2. Implement your resource handlers in `tf_lacework_integrationdockerhub/handlers.py`
