...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelwebhook.json`
2. Implement your resource handlers in `tf_lacework_alertchannelwebhook/handlers.py`
