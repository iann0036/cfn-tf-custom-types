# TF::Lacework::IntegrationAwsCfg

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-lacework-integrationawscfg.json`
2. Implement your resource handlers in `tf_lacework_integrationawscfg/handlers.py`
