...
1. Write the JSON schema describing your resource, `tf-lacework-integrationdockerv2.json`
2. Implement your resource handlers in `tf_lacework_integrationdockerv2/handlers.py`
