...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelawscloudwatch.json`
2. Implement your resource handlers in `tf_lacework_alertchannelawscloudwatch/handlers.py`
