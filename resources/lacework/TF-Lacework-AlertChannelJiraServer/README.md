...
1. Write the JSON schema describing your resource, `tf-lacework-alertchanneljiraserver.json`
2. Implement your resource handlers in `tf_lacework_alertchanneljiraserver/handlers.py`
