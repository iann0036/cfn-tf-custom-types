...
1. Write the JSON schema describing your resource, `tf-lacework-integrationecr.json`
2. Implement your resource handlers in `tf_lacework_integrationecr/handlers.py`
