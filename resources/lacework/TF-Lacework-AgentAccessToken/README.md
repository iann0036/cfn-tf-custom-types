...
1. Write the JSON schema describing your resource, `tf-lacework-agentaccesstoken.json`
2. Implement your resource handlers in `tf_lacework_agentaccesstoken/handlers.py`
