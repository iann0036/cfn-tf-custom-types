# TF::Lacework::AlertChannelNewrelic

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-lacework-alertchannelnewrelic.json`
2. Implement your resource handlers in `tf_lacework_alertchannelnewrelic/handlers.py`
