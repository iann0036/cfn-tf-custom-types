# TF::Lacework::IntegrationAwsCt

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-lacework-integrationawsct.json`
2. Implement your resource handlers in `tf_lacework_integrationawsct/handlers.py`
