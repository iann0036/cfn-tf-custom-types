...
1. Write the JSON schema describing your resource, `tf-lacework-alertchannelqradar.json`
2. Implement your resource handlers in `tf_lacework_alertchannelqradar/handlers.py`
