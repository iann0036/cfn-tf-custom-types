...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/dcnm_interface/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'CiscoDevNet/dcnm',
                'providerTypeName': 'dcnm',
                'terraformTypeName': 'dcnm_interface',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/dcnm_interface/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/dcnm_interface/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccessVlans=None, AdminState=None, AllowedVlans=None, BpduGaurdFlag=None, Configuration=None, Deploy=None, Description=None, EthernetSpeed=None, FabricName=None, Id=None, Ipv4=None, Ipv4Prefix=None, Ipv6=None, Ipv6Prefix=None, LoopbackLsRouting=None, LoopbackReplicationMode=None, LoopbackRouterId=None, LoopbackRoutingTag=None, LoopbackTag=None, Mode=None, Mtu=None, Name=None, PcInterface=None, Policy=None, PortFastFlag=None, SerialNumber=None, SubinterfaceMtu=None, SubinterfaceVlan=None, SwitchName1=None, SwitchName2=None, Type=None, VpcPeer1AccessVlans=None, VpcPeer1AllowedVlans=None, VpcPeer1Conf=None, VpcPeer1Desc=None, VpcPeer1Id=None, VpcPeer1Interface=None, VpcPeer2AccessVlans=None, VpcPeer2AllowedVlans=None, VpcPeer2Conf=None, VpcPeer2Desc=None, VpcPeer2Id=None, VpcPeer2Interface=None, Vrf=None)
