...
1. Write the JSON schema describing your resource, `tf-avi-jwtserverprofile.json`
2. Implement your resource handlers in `tf_avi_jwtserverprofile/handlers.py`
