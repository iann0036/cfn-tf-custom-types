...
1. Write the JSON schema describing your resource, `tf-avi-backupconfiguration.json`
2. Implement your resource handlers in `tf_avi_backupconfiguration/handlers.py`
