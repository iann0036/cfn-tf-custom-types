...
1. Write the JSON schema describing your resource, `tf-avi-ipamdnsproviderprofile.json`
2. Implement your resource handlers in `tf_avi_ipamdnsproviderprofile/handlers.py`
