# TF::AVI::Testsedatastorelevel1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-testsedatastorelevel1.json`
2. Implement your resource handlers in `tf_avi_testsedatastorelevel1/handlers.py`
