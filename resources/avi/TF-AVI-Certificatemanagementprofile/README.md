...
1. Write the JSON schema describing your resource, `tf-avi-certificatemanagementprofile.json`
2. Implement your resource handlers in `tf_avi_certificatemanagementprofile/handlers.py`
