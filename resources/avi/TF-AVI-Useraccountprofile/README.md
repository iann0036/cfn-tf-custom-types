...
1. Write the JSON schema describing your resource, `tf-avi-useraccountprofile.json`
2. Implement your resource handlers in `tf_avi_useraccountprofile/handlers.py`
