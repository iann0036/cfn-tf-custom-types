...
1. Write the JSON schema describing your resource, `tf-avi-cloudconnectoruser.json`
2. Implement your resource handlers in `tf_avi_cloudconnectoruser/handlers.py`
