...
1. Write the JSON schema describing your resource, `tf-avi-actiongroupconfig.json`
2. Implement your resource handlers in `tf_avi_actiongroupconfig/handlers.py`
