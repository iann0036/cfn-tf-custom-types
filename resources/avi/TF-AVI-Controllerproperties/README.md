...
1. Write the JSON schema describing your resource, `tf-avi-controllerproperties.json`
2. Implement your resource handlers in `tf_avi_controllerproperties/handlers.py`
