...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/avi_cloud/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/avi_cloud/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/avi_cloud/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), ApicMode=None, AutoscalePollingInterval=None, DhcpEnabled=None, DnsProviderRef=None, DnsResolutionOnSe=None, EastWestDnsProviderRef=None, EastWestIpamProviderRef=None, EnableVipOnAllInterfaces=None, EnableVipStaticRoutes=None, Id=None, Ip6AutocfgEnabled=None, IpamProviderRef=None, LicenseTier=None, LicenseType=None, Mtu=None, Name=None, ObjNamePrefix=None, PreferStaticRoutes=None, SeGroupTemplateRef=None, StateBasedDnsRegistration=None, TenantRef=None, Uuid=None, VmcDeployment=None, Vtype=None, ApicConfiguration=None, AwsConfiguration=None, AzureConfiguration=None, CloudstackConfiguration=None, CustomTags=None, DnsResolvers=None, DockerConfiguration=None, GcpConfiguration=None, LinuxserverConfiguration=None, NsxConfiguration=None, NsxtConfiguration=None, OpenstackConfiguration=None, ProxyConfiguration=None, RancherConfiguration=None, VcaConfiguration=None, VcenterConfiguration=None)
