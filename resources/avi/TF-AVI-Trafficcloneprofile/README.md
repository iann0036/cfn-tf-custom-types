...
1. Write the JSON schema describing your resource, `tf-avi-trafficcloneprofile.json`
2. Implement your resource handlers in `tf_avi_trafficcloneprofile/handlers.py`
