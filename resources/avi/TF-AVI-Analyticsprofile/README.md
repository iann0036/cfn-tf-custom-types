...
1. Write the JSON schema describing your resource, `tf-avi-analyticsprofile.json`
2. Implement your resource handlers in `tf_avi_analyticsprofile/handlers.py`
