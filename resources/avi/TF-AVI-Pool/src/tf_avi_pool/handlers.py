...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/avi_pool/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/avi_pool/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/avi_pool/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AnalyticsProfileRef=None, ApicEpgName=None, ApplicationPersistenceProfileRef=None, AutoscaleLaunchConfigRef=None, AutoscaleNetworks=None, AutoscalePolicyRef=None, CapacityEstimation=None, CapacityEstimationTtfbThresh=None, CloudConfigCksum=None, CloudRef=None, ConnectionRampDuration=None, CreatedBy=None, DefaultServerPort=None, DeleteServerOnDnsRefresh=None, Description=None, DomainName=None, EastWest=None, EnableHttp2=None, Enabled=None, ExternalAutoscaleGroups=None, FewestTasksFeedbackDelay=None, GracefulDisableTimeout=None, HealthMonitorRefs=None, HostCheckEnabled=None, Id=None, IgnoreServerPort=None, IgnoreServers=None, InlineHealthMonitor=None, IpaddrgroupRef=None, LbAlgorithm=None, LbAlgorithmConsistentHashHdr=None, LbAlgorithmCoreNonaffinity=None, LbAlgorithmHash=None, LookupServerByName=None, MaxConcurrentConnectionsPerServer=None, MinHealthMonitorsUp=None, MinServersUp=None, Name=None, NsxSecuritygroup=None, PkiProfileRef=None, RequestQueueDepth=None, RequestQueueEnabled=None, ResolvePoolByDns=None, RewriteHostHeaderToServerName=None, RewriteHostHeaderToSni=None, RoutingPool=None, ServerName=None, ServerTimeout=None, ServiceMetadata=None, SniEnabled=None, SslKeyAndCertificateRef=None, SslProfileRef=None, TenantRef=None, Tier1Lr=None, UseServicePort=None, Uuid=None, VrfRef=None, AnalyticsPolicy=None, ConnPoolProperties=None, FailAction=None, Markers=None, MaxConnRatePerServer=None, Networks=None, PlacementNetworks=None, ServerReselect=None, Servers=None)
