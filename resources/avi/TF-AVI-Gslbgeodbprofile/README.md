# TF::AVI::Gslbgeodbprofile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-gslbgeodbprofile.json`
2. Implement your resource handlers in `tf_avi_gslbgeodbprofile/handlers.py`
