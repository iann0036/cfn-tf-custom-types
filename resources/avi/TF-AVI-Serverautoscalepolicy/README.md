...
1. Write the JSON schema describing your resource, `tf-avi-serverautoscalepolicy.json`
2. Implement your resource handlers in `tf_avi_serverautoscalepolicy/handlers.py`
