...
1. Write the JSON schema describing your resource, `tf-avi-upgradestatussummary.json`
2. Implement your resource handlers in `tf_avi_upgradestatussummary/handlers.py`
