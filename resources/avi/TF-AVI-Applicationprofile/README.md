...
1. Write the JSON schema describing your resource, `tf-avi-applicationprofile.json`
2. Implement your resource handlers in `tf_avi_applicationprofile/handlers.py`
