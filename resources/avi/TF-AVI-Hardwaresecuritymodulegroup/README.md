# TF::AVI::Hardwaresecuritymodulegroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-hardwaresecuritymodulegroup.json`
2. Implement your resource handlers in `tf_avi_hardwaresecuritymodulegroup/handlers.py`
