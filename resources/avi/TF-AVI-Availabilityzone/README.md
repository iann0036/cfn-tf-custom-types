# TF::AVI::Availabilityzone

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-availabilityzone.json`
2. Implement your resource handlers in `tf_avi_availabilityzone/handlers.py`
