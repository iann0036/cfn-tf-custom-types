...
1. Write the JSON schema describing your resource, `tf-avi-albservicesfileupload.json`
2. Implement your resource handlers in `tf_avi_albservicesfileupload/handlers.py`
