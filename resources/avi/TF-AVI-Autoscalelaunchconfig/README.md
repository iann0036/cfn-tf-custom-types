...
1. Write the JSON schema describing your resource, `tf-avi-autoscalelaunchconfig.json`
2. Implement your resource handlers in `tf_avi_autoscalelaunchconfig/handlers.py`
