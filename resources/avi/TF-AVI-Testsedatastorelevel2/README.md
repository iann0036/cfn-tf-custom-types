...
1. Write the JSON schema describing your resource, `tf-avi-testsedatastorelevel2.json`
2. Implement your resource handlers in `tf_avi_testsedatastorelevel2/handlers.py`
