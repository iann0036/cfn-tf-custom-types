...
1. Write the JSON schema describing your resource, `tf-avi-poolgroupdeploymentpolicy.json`
2. Implement your resource handlers in `tf_avi_poolgroupdeploymentpolicy/handlers.py`
