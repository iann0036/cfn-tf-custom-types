...
1. Write the JSON schema describing your resource, `tf-avi-dynamicdnsrecord.json`
2. Implement your resource handlers in `tf_avi_dynamicdnsrecord/handlers.py`
