...
1. Write the JSON schema describing your resource, `tf-avi-controllerportalregistration.json`
2. Implement your resource handlers in `tf_avi_controllerportalregistration/handlers.py`
