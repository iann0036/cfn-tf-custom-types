...
1. Write the JSON schema describing your resource, `tf-avi-wafpolicypsmgroup.json`
2. Implement your resource handlers in `tf_avi_wafpolicypsmgroup/handlers.py`
