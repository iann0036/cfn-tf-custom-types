...
1. Write the JSON schema describing your resource, `tf-avi-systemconfiguration.json`
2. Implement your resource handlers in `tf_avi_systemconfiguration/handlers.py`
