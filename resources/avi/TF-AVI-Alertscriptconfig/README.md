# TF::AVI::Alertscriptconfig

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-alertscriptconfig.json`
2. Implement your resource handlers in `tf_avi_alertscriptconfig/handlers.py`
