# TF::AVI::Pingaccessagent

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-pingaccessagent.json`
2. Implement your resource handlers in `tf_avi_pingaccessagent/handlers.py`
