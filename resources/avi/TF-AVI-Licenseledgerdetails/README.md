...
1. Write the JSON schema describing your resource, `tf-avi-licenseledgerdetails.json`
2. Implement your resource handlers in `tf_avi_licenseledgerdetails/handlers.py`
