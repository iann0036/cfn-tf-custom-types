...
1. Write the JSON schema describing your resource, `tf-avi-nsxtsegmentruntime.json`
2. Implement your resource handlers in `tf_avi_nsxtsegmentruntime/handlers.py`
