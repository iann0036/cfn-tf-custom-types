...
1. Write the JSON schema describing your resource, `tf-avi-albservicesconfig.json`
2. Implement your resource handlers in `tf_avi_albservicesconfig/handlers.py`
