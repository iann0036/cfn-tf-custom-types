...
1. Write the JSON schema describing your resource, `tf-avi-inventoryfaultconfig.json`
2. Implement your resource handlers in `tf_avi_inventoryfaultconfig/handlers.py`
