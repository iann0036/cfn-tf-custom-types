...
1. Write the JSON schema describing your resource, `tf-avi-sslkeyandcertificate.json`
2. Implement your resource handlers in `tf_avi_sslkeyandcertificate/handlers.py`
