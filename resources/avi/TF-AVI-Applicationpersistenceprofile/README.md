...
1. Write the JSON schema describing your resource, `tf-avi-applicationpersistenceprofile.json`
2. Implement your resource handlers in `tf_avi_applicationpersistenceprofile/handlers.py`
