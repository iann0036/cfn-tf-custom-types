...
1. Write the JSON schema describing your resource, `tf-avi-serviceenginegroup.json`
2. Implement your resource handlers in `tf_avi_serviceenginegroup/handlers.py`
