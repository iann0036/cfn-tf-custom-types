...
TYPE_NAME = "TF::AVI::Upgradestatusinfo"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/avi_upgradestatusinfo/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'avi_upgradestatusinfo',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/avi_upgradestatusinfo/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/avi_upgradestatusinfo/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AfterRebootRollbackFnc=None, AfterRebootTaskName=None, Clean=None, Duration=None, EnablePatchRollback=None, EnableRollback=None, EndTime=None, EnqueueTime=None, FipsMode=None, Id=None, ImagePath=None, ImageRef=None, Name=None, NodeType=None, ObjCloudRef=None, PatchImagePath=None, PatchImageRef=None, PatchReboot=None, PatchVersion=None, PrevImagePath=None, PrevPatchImagePath=None, PreviousImageRef=None, PreviousPatchImageRef=None, PreviousPatchVersion=None, PreviousVersion=None, Progress=None, SePatchImagePath=None, SePatchImageRef=None, StartTime=None, System=None, TasksCompleted=None, TenantRef=None, TotalTasks=None, UpgradeOps=None, Uuid=None, Version=None, History=None, Params=None, PatchList=None, PreviousPatchList=None, SeUpgradeEvents=None, SegParams=None, SegStatus=None, State=None, UpgradeEvents=None)
