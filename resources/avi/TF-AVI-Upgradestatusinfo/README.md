...
1. Write the JSON schema describing your resource, `tf-avi-upgradestatusinfo.json`
2. Implement your resource handlers in `tf_avi_upgradestatusinfo/handlers.py`
