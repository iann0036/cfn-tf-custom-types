...
1. Write the JSON schema describing your resource, `tf-avi-securitymanagerdata.json`
2. Implement your resource handlers in `tf_avi_securitymanagerdata/handlers.py`
