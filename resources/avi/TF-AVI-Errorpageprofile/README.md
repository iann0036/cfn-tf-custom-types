...
1. Write the JSON schema describing your resource, `tf-avi-errorpageprofile.json`
2. Implement your resource handlers in `tf_avi_errorpageprofile/handlers.py`
