# TF::AVI::Testsedatastorelevel3

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-avi-testsedatastorelevel3.json`
2. Implement your resource handlers in `tf_avi_testsedatastorelevel3/handlers.py`
