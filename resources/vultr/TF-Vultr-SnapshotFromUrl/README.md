...
1. Write the JSON schema describing your resource, `tf-vultr-snapshotfromurl.json`
2. Implement your resource handlers in `tf_vultr_snapshotfromurl/handlers.py`
