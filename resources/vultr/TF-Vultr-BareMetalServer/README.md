...
1. Write the JSON schema describing your resource, `tf-vultr-baremetalserver.json`
2. Implement your resource handlers in `tf_vultr_baremetalserver/handlers.py`
