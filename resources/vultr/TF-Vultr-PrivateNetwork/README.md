...
1. Write the JSON schema describing your resource, `tf-vultr-privatenetwork.json`
2. Implement your resource handlers in `tf_vultr_privatenetwork/handlers.py`
