...
1. Write the JSON schema describing your resource, `tf-azuredevops-userentitlement.json`
2. Implement your resource handlers in `tf_azuredevops_userentitlement/handlers.py`
