...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointservicefabric.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointservicefabric/handlers.py`
