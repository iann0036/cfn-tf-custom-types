...
class ResourceModel(BaseModel):
    ...
    AzurermSpnTenantid: Optional[str]
    AzurermSubscriptionId: Optional[str]
    AzurermSubscriptionName: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AzurermSpnTenantid=json_data.get("AzurermSpnTenantid"),
            AzurermSubscriptionId=json_data.get("AzurermSubscriptionId"),
            AzurermSubscriptionName=json_data.get("AzurermSubscriptionName"),
