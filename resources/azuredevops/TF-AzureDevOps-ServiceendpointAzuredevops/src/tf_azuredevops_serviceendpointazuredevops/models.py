...
class ResourceModel(BaseModel):
    ...
    PersonalAccessTokenHash: Optional[str]
    ProjectId: Optional[str]
    ReleaseApiUrl: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PersonalAccessTokenHash=json_data.get("PersonalAccessTokenHash"),
            ProjectId=json_data.get("ProjectId"),
            ReleaseApiUrl=json_data.get("ReleaseApiUrl"),
