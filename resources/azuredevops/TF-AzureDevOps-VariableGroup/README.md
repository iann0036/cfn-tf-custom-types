...
1. Write the JSON schema describing your resource, `tf-azuredevops-variablegroup.json`
2. Implement your resource handlers in `tf_azuredevops_variablegroup/handlers.py`
