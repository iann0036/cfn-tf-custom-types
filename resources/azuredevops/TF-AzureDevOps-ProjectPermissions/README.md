# TF::AzureDevOps::ProjectPermissions

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azuredevops-projectpermissions.json`
2. Implement your resource handlers in `tf_azuredevops_projectpermissions/handlers.py`
