...
class SettingsDefinition(BaseModel):
    AutoReviewerIds: Optional[Sequence[str]]
    Message: Optional[str]
    PathFilters: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            AutoReviewerIds=json_data.get("AutoReviewerIds"),
            Message=json_data.get("Message"),
            PathFilters=json_data.get("PathFilters"),
