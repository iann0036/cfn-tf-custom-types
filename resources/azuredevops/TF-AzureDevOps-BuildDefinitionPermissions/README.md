...
1. Write the JSON schema describing your resource, `tf-azuredevops-builddefinitionpermissions.json`
2. Implement your resource handlers in `tf_azuredevops_builddefinitionpermissions/handlers.py`
