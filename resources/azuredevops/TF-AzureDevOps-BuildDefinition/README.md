...
1. Write the JSON schema describing your resource, `tf-azuredevops-builddefinition.json`
2. Implement your resource handlers in `tf_azuredevops_builddefinition/handlers.py`
