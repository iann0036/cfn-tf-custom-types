...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointartifactory.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointartifactory/handlers.py`
