...
1. Write the JSON schema describing your resource, `tf-azuredevops-gitrepository.json`
2. Implement your resource handlers in `tf_azuredevops_gitrepository/handlers.py`
