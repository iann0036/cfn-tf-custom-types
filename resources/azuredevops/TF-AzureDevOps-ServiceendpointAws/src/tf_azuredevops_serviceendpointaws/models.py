...
class ResourceModel(BaseModel):
    ...
    RoleToAssume: Optional[str]
    SecretAccessKey: Optional[str]
    SecretAccessKeyHash: Optional[str]
    ServiceEndpointName: Optional[str]
    SessionToken: Optional[str]
    SessionTokenHash: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RoleToAssume=json_data.get("RoleToAssume"),
            SecretAccessKey=json_data.get("SecretAccessKey"),
            SecretAccessKeyHash=json_data.get("SecretAccessKeyHash"),
            ServiceEndpointName=json_data.get("ServiceEndpointName"),
            SessionToken=json_data.get("SessionToken"),
            SessionTokenHash=json_data.get("SessionTokenHash"),
