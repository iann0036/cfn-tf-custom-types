...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointaws.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointaws/handlers.py`
