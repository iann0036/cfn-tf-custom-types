...
1. Write the JSON schema describing your resource, `tf-azuredevops-resourceauthorization.json`
2. Implement your resource handlers in `tf_azuredevops_resourceauthorization/handlers.py`
