...
class SettingsDefinition(BaseModel):
    BuildDefinitionId: Optional[float]
    DisplayName: Optional[str]
    FilenamePatterns: Optional[Sequence[str]]
    ManualQueueOnly: Optional[bool]
    QueueOnSourceUpdateOnly: Optional[bool]
    ValidDuration: Optional[float]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            BuildDefinitionId=json_data.get("BuildDefinitionId"),
            DisplayName=json_data.get("DisplayName"),
            FilenamePatterns=json_data.get("FilenamePatterns"),
            ManualQueueOnly=json_data.get("ManualQueueOnly"),
            QueueOnSourceUpdateOnly=json_data.get("QueueOnSourceUpdateOnly"),
