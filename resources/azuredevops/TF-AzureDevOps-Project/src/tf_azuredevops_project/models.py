...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    Name: Optional[str]
    ProcessTemplateId: Optional[str]
    VersionControl: Optional[str]
    Visibility: Optional[str]
    WorkItemTemplate: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ProcessTemplateId=json_data.get("ProcessTemplateId"),
            VersionControl=json_data.get("VersionControl"),
            Visibility=json_data.get("Visibility"),
            WorkItemTemplate=json_data.get("WorkItemTemplate"),
