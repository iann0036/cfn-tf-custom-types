...
1. Write the JSON schema describing your resource, `tf-azuredevops-groupmembership.json`
2. Implement your resource handlers in `tf_azuredevops_groupmembership/handlers.py`
