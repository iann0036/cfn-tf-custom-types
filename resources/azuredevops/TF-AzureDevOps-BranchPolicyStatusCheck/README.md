# TF::AzureDevOps::BranchPolicyStatusCheck

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azuredevops-branchpolicystatuscheck.json`
2. Implement your resource handlers in `tf_azuredevops_branchpolicystatuscheck/handlers.py`
