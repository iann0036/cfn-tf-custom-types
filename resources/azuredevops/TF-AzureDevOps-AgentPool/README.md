...
1. Write the JSON schema describing your resource, `tf-azuredevops-agentpool.json`
2. Implement your resource handlers in `tf_azuredevops_agentpool/handlers.py`
