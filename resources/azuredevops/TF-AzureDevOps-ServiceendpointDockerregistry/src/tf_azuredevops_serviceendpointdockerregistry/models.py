...
class ResourceModel(BaseModel):
    ...
    DockerEmail: Optional[str]
    DockerPassword: Optional[str]
    DockerPasswordHash: Optional[str]
    DockerRegistry: Optional[str]
    DockerUsername: Optional[str]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DockerEmail=json_data.get("DockerEmail"),
            DockerPassword=json_data.get("DockerPassword"),
            DockerPasswordHash=json_data.get("DockerPasswordHash"),
            DockerRegistry=json_data.get("DockerRegistry"),
            DockerUsername=json_data.get("DockerUsername"),
            Id=json_data.get("Id"),
