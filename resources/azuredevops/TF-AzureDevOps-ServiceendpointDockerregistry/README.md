...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointdockerregistry.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointdockerregistry/handlers.py`
