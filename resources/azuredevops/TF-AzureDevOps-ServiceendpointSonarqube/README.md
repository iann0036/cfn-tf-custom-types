# TF::AzureDevOps::ServiceendpointSonarqube

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointsonarqube.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointsonarqube/handlers.py`
