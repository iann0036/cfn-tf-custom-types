...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointkubernetes.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointkubernetes/handlers.py`
