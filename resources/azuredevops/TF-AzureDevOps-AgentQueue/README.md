...
1. Write the JSON schema describing your resource, `tf-azuredevops-agentqueue.json`
2. Implement your resource handlers in `tf_azuredevops_agentqueue/handlers.py`
