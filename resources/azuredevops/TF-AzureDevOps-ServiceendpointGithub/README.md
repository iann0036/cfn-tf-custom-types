...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointgithub.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointgithub/handlers.py`
