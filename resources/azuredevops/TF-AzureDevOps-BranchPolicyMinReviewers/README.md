...
1. Write the JSON schema describing your resource, `tf-azuredevops-branchpolicyminreviewers.json`
2. Implement your resource handlers in `tf_azuredevops_branchpolicyminreviewers/handlers.py`
