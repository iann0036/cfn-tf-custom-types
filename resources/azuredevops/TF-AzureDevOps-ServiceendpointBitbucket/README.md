...
1. Write the JSON schema describing your resource, `tf-azuredevops-serviceendpointbitbucket.json`
2. Implement your resource handlers in `tf_azuredevops_serviceendpointbitbucket/handlers.py`
