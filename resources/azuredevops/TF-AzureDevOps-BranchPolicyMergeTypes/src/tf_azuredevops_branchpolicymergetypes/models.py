...
class SettingsDefinition(BaseModel):
    AllowBasicNoFastForward: Optional[bool]
    AllowRebaseAndFastForward: Optional[bool]
    AllowRebaseWithMerge: Optional[bool]
    AllowSquash: Optional[bool]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            AllowBasicNoFastForward=json_data.get("AllowBasicNoFastForward"),
            AllowRebaseAndFastForward=json_data.get("AllowRebaseAndFastForward"),
            AllowRebaseWithMerge=json_data.get("AllowRebaseWithMerge"),
            AllowSquash=json_data.get("AllowSquash"),
