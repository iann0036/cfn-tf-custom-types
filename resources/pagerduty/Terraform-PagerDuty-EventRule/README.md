...
1. Write the JSON schema describing your resource, `terraform-pagerduty-eventrule.json`
2. Implement your resource handlers in `terraform_pagerduty_eventrule/handlers.py`
