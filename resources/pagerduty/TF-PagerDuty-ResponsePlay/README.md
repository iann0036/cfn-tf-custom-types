...
1. Write the JSON schema describing your resource, `tf-pagerduty-responseplay.json`
2. Implement your resource handlers in `tf_pagerduty_responseplay/handlers.py`
