...
1. Write the JSON schema describing your resource, `tf-pagerduty-servicedependency.json`
2. Implement your resource handlers in `tf_pagerduty_servicedependency/handlers.py`
