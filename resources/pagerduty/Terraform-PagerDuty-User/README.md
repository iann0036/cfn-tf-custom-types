...
1. Write the JSON schema describing your resource, `terraform-pagerduty-user.json`
2. Implement your resource handlers in `terraform_pagerduty_user/handlers.py`
