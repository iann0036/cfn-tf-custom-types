...
1. Write the JSON schema describing your resource, `tf-pagerduty-teammembership.json`
2. Implement your resource handlers in `tf_pagerduty_teammembership/handlers.py`
