# TF::PagerDuty::UserNotificationRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-pagerduty-usernotificationrule.json`
2. Implement your resource handlers in `tf_pagerduty_usernotificationrule/handlers.py`
