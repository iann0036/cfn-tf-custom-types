...
1. Write the JSON schema describing your resource, `terraform-pagerduty-extension.json`
2. Implement your resource handlers in `terraform_pagerduty_extension/handlers.py`
