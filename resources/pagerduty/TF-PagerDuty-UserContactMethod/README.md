# TF::PagerDuty::UserContactMethod

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-pagerduty-usercontactmethod.json`
2. Implement your resource handlers in `tf_pagerduty_usercontactmethod/handlers.py`
