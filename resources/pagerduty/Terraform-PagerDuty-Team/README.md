...
1. Write the JSON schema describing your resource, `terraform-pagerduty-team.json`
2. Implement your resource handlers in `terraform_pagerduty_team/handlers.py`
