...
1. Write the JSON schema describing your resource, `terraform-pagerduty-service.json`
2. Implement your resource handlers in `terraform_pagerduty_service/handlers.py`
