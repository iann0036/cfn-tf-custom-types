# TF::PagerDuty::ServiceEventRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-pagerduty-serviceeventrule.json`
2. Implement your resource handlers in `tf_pagerduty_serviceeventrule/handlers.py`
