...
1. Write the JSON schema describing your resource, `terraform-pagerduty-usercontactmethod.json`
2. Implement your resource handlers in `terraform_pagerduty_usercontactmethod/handlers.py`
