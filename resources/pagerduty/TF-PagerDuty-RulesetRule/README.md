...
1. Write the JSON schema describing your resource, `tf-pagerduty-rulesetrule.json`
2. Implement your resource handlers in `tf_pagerduty_rulesetrule/handlers.py`
