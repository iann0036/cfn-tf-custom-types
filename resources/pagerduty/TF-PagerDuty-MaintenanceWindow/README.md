...
1. Write the JSON schema describing your resource, `tf-pagerduty-maintenancewindow.json`
2. Implement your resource handlers in `tf_pagerduty_maintenancewindow/handlers.py`
