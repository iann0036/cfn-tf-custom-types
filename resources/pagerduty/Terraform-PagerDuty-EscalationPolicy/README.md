...
1. Write the JSON schema describing your resource, `terraform-pagerduty-escalationpolicy.json`
2. Implement your resource handlers in `terraform_pagerduty_escalationpolicy/handlers.py`
