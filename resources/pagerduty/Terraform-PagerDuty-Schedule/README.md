...
1. Write the JSON schema describing your resource, `terraform-pagerduty-schedule.json`
2. Implement your resource handlers in `terraform_pagerduty_schedule/handlers.py`
