# TF::PagerDuty::EscalationPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-pagerduty-escalationpolicy.json`
2. Implement your resource handlers in `tf_pagerduty_escalationpolicy/handlers.py`
