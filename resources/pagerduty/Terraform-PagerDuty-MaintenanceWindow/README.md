...
1. Write the JSON schema describing your resource, `terraform-pagerduty-maintenancewindow.json`
2. Implement your resource handlers in `terraform_pagerduty_maintenancewindow/handlers.py`
