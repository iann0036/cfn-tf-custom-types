# TF::PagerDuty::Extension

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-pagerduty-extension.json`
2. Implement your resource handlers in `tf_pagerduty_extension/handlers.py`
