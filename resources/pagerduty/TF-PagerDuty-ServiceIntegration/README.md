# TF::PagerDuty::ServiceIntegration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-pagerduty-serviceintegration.json`
2. Implement your resource handlers in `tf_pagerduty_serviceintegration/handlers.py`
