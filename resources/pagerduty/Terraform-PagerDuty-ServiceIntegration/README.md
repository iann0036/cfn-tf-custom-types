...
1. Write the JSON schema describing your resource, `terraform-pagerduty-serviceintegration.json`
2. Implement your resource handlers in `terraform_pagerduty_serviceintegration/handlers.py`
