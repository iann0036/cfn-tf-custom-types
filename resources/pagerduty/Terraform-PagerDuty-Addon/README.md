...
1. Write the JSON schema describing your resource, `terraform-pagerduty-addon.json`
2. Implement your resource handlers in `terraform_pagerduty_addon/handlers.py`
