...
1. Write the JSON schema describing your resource, `terraform-pagerduty-teammembership.json`
2. Implement your resource handlers in `terraform_pagerduty_teammembership/handlers.py`
