...
1. Write the JSON schema describing your resource, `terraform-pagerduty-usernotificationrule.json`
2. Implement your resource handlers in `terraform_pagerduty_usernotificationrule/handlers.py`
