...
1. Write the JSON schema describing your resource, `tf-signalfx-gcpintegration.json`
2. Implement your resource handlers in `tf_signalfx_gcpintegration/handlers.py`
