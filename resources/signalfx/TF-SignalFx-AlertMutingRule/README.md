...
1. Write the JSON schema describing your resource, `tf-signalfx-alertmutingrule.json`
2. Implement your resource handlers in `tf_signalfx_alertmutingrule/handlers.py`
