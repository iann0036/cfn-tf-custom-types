...
1. Write the JSON schema describing your resource, `tf-signalfx-heatmapchart.json`
2. Implement your resource handlers in `tf_signalfx_heatmapchart/handlers.py`
