...
1. Write the JSON schema describing your resource, `tf-signalfx-singlevaluechart.json`
2. Implement your resource handlers in `tf_signalfx_singlevaluechart/handlers.py`
