...
1. Write the JSON schema describing your resource, `tf-signalfx-awsintegration.json`
2. Implement your resource handlers in `tf_signalfx_awsintegration/handlers.py`
