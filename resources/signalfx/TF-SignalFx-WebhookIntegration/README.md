...
1. Write the JSON schema describing your resource, `tf-signalfx-webhookintegration.json`
2. Implement your resource handlers in `tf_signalfx_webhookintegration/handlers.py`
