...
1. Write the JSON schema describing your resource, `tf-signalfx-slackintegration.json`
2. Implement your resource handlers in `tf_signalfx_slackintegration/handlers.py`
