# TF::SignalFx::AwsTokenIntegration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-signalfx-awstokenintegration.json`
2. Implement your resource handlers in `tf_signalfx_awstokenintegration/handlers.py`
