...
1. Write the JSON schema describing your resource, `tf-signalfx-jiraintegration.json`
2. Implement your resource handlers in `tf_signalfx_jiraintegration/handlers.py`
