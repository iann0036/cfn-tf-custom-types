...
1. Write the JSON schema describing your resource, `tf-signalfx-opsgenieintegration.json`
2. Implement your resource handlers in `tf_signalfx_opsgenieintegration/handlers.py`
