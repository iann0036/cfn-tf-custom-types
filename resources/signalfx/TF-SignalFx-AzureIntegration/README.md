...
1. Write the JSON schema describing your resource, `tf-signalfx-azureintegration.json`
2. Implement your resource handlers in `tf_signalfx_azureintegration/handlers.py`
