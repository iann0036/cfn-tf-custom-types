# TF::SignalFx::PagerdutyIntegration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-signalfx-pagerdutyintegration.json`
2. Implement your resource handlers in `tf_signalfx_pagerdutyintegration/handlers.py`
