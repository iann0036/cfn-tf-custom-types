...
1. Write the JSON schema describing your resource, `tf-signalfx-eventfeedchart.json`
2. Implement your resource handlers in `tf_signalfx_eventfeedchart/handlers.py`
