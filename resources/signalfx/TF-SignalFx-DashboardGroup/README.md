...
1. Write the JSON schema describing your resource, `tf-signalfx-dashboardgroup.json`
2. Implement your resource handlers in `tf_signalfx_dashboardgroup/handlers.py`
