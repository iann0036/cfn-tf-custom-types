...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-databaseaccessrule.json`
2. Implement your resource handlers in `terraform_oraclepaas_databaseaccessrule/handlers.py`
