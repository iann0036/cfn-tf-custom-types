...
1. Write the JSON schema describing your resource, `tf-oraclepaas-applicationcontainer.json`
2. Implement your resource handlers in `tf_oraclepaas_applicationcontainer/handlers.py`
