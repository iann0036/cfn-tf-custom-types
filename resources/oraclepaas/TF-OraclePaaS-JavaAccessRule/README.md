# TF::OraclePaaS::JavaAccessRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oraclepaas-javaaccessrule.json`
2. Implement your resource handlers in `tf_oraclepaas_javaaccessrule/handlers.py`
