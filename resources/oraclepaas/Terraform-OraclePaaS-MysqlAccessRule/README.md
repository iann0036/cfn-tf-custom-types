...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-mysqlaccessrule.json`
2. Implement your resource handlers in `terraform_oraclepaas_mysqlaccessrule/handlers.py`
