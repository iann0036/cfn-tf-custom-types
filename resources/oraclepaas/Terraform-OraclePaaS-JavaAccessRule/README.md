...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-javaaccessrule.json`
2. Implement your resource handlers in `terraform_oraclepaas_javaaccessrule/handlers.py`
