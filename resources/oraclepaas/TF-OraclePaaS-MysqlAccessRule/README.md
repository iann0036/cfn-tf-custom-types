# TF::OraclePaaS::MysqlAccessRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oraclepaas-mysqlaccessrule.json`
2. Implement your resource handlers in `tf_oraclepaas_mysqlaccessrule/handlers.py`
