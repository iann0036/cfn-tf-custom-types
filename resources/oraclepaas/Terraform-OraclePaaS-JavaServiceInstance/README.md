...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-javaserviceinstance.json`
2. Implement your resource handlers in `terraform_oraclepaas_javaserviceinstance/handlers.py`
