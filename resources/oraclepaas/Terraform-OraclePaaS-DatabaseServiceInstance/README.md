...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-databaseserviceinstance.json`
2. Implement your resource handlers in `terraform_oraclepaas_databaseserviceinstance/handlers.py`
