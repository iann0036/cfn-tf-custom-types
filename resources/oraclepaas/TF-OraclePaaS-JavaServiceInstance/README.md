...
1. Write the JSON schema describing your resource, `tf-oraclepaas-javaserviceinstance.json`
2. Implement your resource handlers in `tf_oraclepaas_javaserviceinstance/handlers.py`
