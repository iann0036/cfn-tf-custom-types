...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-mysqlserviceinstance.json`
2. Implement your resource handlers in `terraform_oraclepaas_mysqlserviceinstance/handlers.py`
