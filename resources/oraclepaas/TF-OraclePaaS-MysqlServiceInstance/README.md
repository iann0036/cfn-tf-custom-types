# TF::OraclePaaS::MysqlServiceInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oraclepaas-mysqlserviceinstance.json`
2. Implement your resource handlers in `tf_oraclepaas_mysqlserviceinstance/handlers.py`
