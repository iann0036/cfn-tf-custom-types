...
1. Write the JSON schema describing your resource, `tf-oraclepaas-databaseaccessrule.json`
2. Implement your resource handlers in `tf_oraclepaas_databaseaccessrule/handlers.py`
