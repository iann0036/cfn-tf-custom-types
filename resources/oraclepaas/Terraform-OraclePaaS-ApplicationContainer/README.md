...
1. Write the JSON schema describing your resource, `terraform-oraclepaas-applicationcontainer.json`
2. Implement your resource handlers in `terraform_oraclepaas_applicationcontainer/handlers.py`
