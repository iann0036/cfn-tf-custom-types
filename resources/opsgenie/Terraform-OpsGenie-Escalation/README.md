...
1. Write the JSON schema describing your resource, `terraform-opsgenie-escalation.json`
2. Implement your resource handlers in `terraform_opsgenie_escalation/handlers.py`
