...
1. Write the JSON schema describing your resource, `tf-opsgenie-emailintegration.json`
2. Implement your resource handlers in `tf_opsgenie_emailintegration/handlers.py`
