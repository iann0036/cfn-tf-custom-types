...
1. Write the JSON schema describing your resource, `terraform-opsgenie-notificationpolicy.json`
2. Implement your resource handlers in `terraform_opsgenie_notificationpolicy/handlers.py`
