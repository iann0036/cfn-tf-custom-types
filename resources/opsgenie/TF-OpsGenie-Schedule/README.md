# TF::OpsGenie::Schedule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opsgenie-schedule.json`
2. Implement your resource handlers in `tf_opsgenie_schedule/handlers.py`
