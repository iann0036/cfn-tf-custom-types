...
1. Write the JSON schema describing your resource, `terraform-opsgenie-team.json`
2. Implement your resource handlers in `terraform_opsgenie_team/handlers.py`
