...
def create_handler(
    ...
    try:
        ...
        tf['resource']['opsgenie_email_integration'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['opsgenie_email_integration'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
