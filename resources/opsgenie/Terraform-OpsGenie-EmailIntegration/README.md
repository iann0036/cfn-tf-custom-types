...
1. Write the JSON schema describing your resource, `terraform-opsgenie-emailintegration.json`
2. Implement your resource handlers in `terraform_opsgenie_emailintegration/handlers.py`
