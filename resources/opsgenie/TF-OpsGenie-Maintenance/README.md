...
1. Write the JSON schema describing your resource, `tf-opsgenie-maintenance.json`
2. Implement your resource handlers in `tf_opsgenie_maintenance/handlers.py`
