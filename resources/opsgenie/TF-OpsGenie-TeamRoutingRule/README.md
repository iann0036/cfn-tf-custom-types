...
1. Write the JSON schema describing your resource, `tf-opsgenie-teamroutingrule.json`
2. Implement your resource handlers in `tf_opsgenie_teamroutingrule/handlers.py`
