# TF::OpsGenie::Escalation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opsgenie-escalation.json`
2. Implement your resource handlers in `tf_opsgenie_escalation/handlers.py`
