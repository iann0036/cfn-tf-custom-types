...
1. Write the JSON schema describing your resource, `terraform-opsgenie-maintenance.json`
2. Implement your resource handlers in `terraform_opsgenie_maintenance/handlers.py`
