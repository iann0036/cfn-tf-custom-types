...
1. Write the JSON schema describing your resource, `terraform-opsgenie-heartbeat.json`
2. Implement your resource handlers in `terraform_opsgenie_heartbeat/handlers.py`
