...
1. Write the JSON schema describing your resource, `tf-opsgenie-usercontact.json`
2. Implement your resource handlers in `tf_opsgenie_usercontact/handlers.py`
