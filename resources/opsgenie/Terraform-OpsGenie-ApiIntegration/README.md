...
1. Write the JSON schema describing your resource, `terraform-opsgenie-apiintegration.json`
2. Implement your resource handlers in `terraform_opsgenie_apiintegration/handlers.py`
