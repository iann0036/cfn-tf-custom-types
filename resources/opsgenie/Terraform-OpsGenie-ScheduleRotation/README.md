...
1. Write the JSON schema describing your resource, `terraform-opsgenie-schedulerotation.json`
2. Implement your resource handlers in `terraform_opsgenie_schedulerotation/handlers.py`
