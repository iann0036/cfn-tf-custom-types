...
1. Write the JSON schema describing your resource, `terraform-opsgenie-usercontact.json`
2. Implement your resource handlers in `terraform_opsgenie_usercontact/handlers.py`
