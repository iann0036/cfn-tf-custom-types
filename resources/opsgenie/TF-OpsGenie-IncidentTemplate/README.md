...
1. Write the JSON schema describing your resource, `tf-opsgenie-incidenttemplate.json`
2. Implement your resource handlers in `tf_opsgenie_incidenttemplate/handlers.py`
