...
1. Write the JSON schema describing your resource, `terraform-opsgenie-teamroutingrule.json`
2. Implement your resource handlers in `terraform_opsgenie_teamroutingrule/handlers.py`
