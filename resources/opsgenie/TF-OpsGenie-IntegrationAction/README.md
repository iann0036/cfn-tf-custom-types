...
1. Write the JSON schema describing your resource, `tf-opsgenie-integrationaction.json`
2. Implement your resource handlers in `tf_opsgenie_integrationaction/handlers.py`
