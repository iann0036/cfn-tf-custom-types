# TF::OpsGenie::ServiceIncidentRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opsgenie-serviceincidentrule.json`
2. Implement your resource handlers in `tf_opsgenie_serviceincidentrule/handlers.py`
