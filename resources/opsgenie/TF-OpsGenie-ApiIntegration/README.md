...
1. Write the JSON schema describing your resource, `tf-opsgenie-apiintegration.json`
2. Implement your resource handlers in `tf_opsgenie_apiintegration/handlers.py`
