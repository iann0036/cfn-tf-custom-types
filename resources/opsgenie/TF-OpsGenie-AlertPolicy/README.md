...
1. Write the JSON schema describing your resource, `tf-opsgenie-alertpolicy.json`
2. Implement your resource handlers in `tf_opsgenie_alertpolicy/handlers.py`
