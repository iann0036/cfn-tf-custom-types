...
1. Write the JSON schema describing your resource, `terraform-opsgenie-user.json`
2. Implement your resource handlers in `terraform_opsgenie_user/handlers.py`
