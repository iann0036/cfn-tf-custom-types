...
1. Write the JSON schema describing your resource, `terraform-opsgenie-schedule.json`
2. Implement your resource handlers in `terraform_opsgenie_schedule/handlers.py`
