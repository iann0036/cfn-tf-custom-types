...
1. Write the JSON schema describing your resource, `tf-opsgenie-notificationrule.json`
2. Implement your resource handlers in `tf_opsgenie_notificationrule/handlers.py`
