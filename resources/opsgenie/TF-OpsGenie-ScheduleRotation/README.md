...
1. Write the JSON schema describing your resource, `tf-opsgenie-schedulerotation.json`
2. Implement your resource handlers in `tf_opsgenie_schedulerotation/handlers.py`
