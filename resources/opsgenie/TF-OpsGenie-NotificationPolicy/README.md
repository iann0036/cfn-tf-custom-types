...
1. Write the JSON schema describing your resource, `tf-opsgenie-notificationpolicy.json`
2. Implement your resource handlers in `tf_opsgenie_notificationpolicy/handlers.py`
