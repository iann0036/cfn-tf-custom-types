...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-elblistener.json`
2. Implement your resource handlers in `terraform_huaweicloud_elblistener/handlers.py`
