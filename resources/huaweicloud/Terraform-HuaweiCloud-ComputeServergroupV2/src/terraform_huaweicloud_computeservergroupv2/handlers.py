...
def create_handler(
    ...
    try:
        ...
        tf['resource']['huaweicloud_compute_servergroup_v2'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['huaweicloud_compute_servergroup_v2'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
