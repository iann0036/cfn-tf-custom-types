# Terraform::HuaweiCloud::VpnaasEndpointGroupV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-vpnaasendpointgroupv2.json`
2. Implement your resource handlers in `terraform_huaweicloud_vpnaasendpointgroupv2/handlers.py`
