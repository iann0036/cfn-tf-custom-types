...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-s3bucket.json`
2. Implement your resource handlers in `terraform_huaweicloud_s3bucket/handlers.py`
