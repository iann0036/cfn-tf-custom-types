...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-obsbucket.json`
2. Implement your resource handlers in `terraform_huaweicloud_obsbucket/handlers.py`
