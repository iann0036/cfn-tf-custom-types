...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-identityprojectv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_identityprojectv3/handlers.py`
