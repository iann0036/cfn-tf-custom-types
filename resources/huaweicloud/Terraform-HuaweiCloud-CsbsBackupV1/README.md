...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-csbsbackupv1.json`
2. Implement your resource handlers in `terraform_huaweicloud_csbsbackupv1/handlers.py`
