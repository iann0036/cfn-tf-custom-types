...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-ecsinstancev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_ecsinstancev1/handlers.py`
