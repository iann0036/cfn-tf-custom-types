...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-rdsinstancev3.json`
2. Implement your resource handlers in `terraform_huaweicloud_rdsinstancev3/handlers.py`
