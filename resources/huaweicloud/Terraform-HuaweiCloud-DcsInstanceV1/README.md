...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-dcsinstancev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_dcsinstancev1/handlers.py`
