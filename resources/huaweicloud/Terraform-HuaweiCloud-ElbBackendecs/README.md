...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-elbbackendecs.json`
2. Implement your resource handlers in `terraform_huaweicloud_elbbackendecs/handlers.py`
