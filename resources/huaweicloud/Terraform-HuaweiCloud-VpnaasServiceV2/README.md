...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-vpnaasservicev2.json`
2. Implement your resource handlers in `terraform_huaweicloud_vpnaasservicev2/handlers.py`
