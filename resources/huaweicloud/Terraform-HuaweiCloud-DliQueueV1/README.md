...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-dliqueuev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_dliqueuev1/handlers.py`
