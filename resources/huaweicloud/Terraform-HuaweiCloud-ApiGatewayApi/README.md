...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-apigatewayapi.json`
2. Implement your resource handlers in `terraform_huaweicloud_apigatewayapi/handlers.py`
