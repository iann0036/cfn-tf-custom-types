...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-apigatewaygroup.json`
2. Implement your resource handlers in `terraform_huaweicloud_apigatewaygroup/handlers.py`
