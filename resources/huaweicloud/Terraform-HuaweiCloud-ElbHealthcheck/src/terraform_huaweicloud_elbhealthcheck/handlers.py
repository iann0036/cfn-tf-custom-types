...
def create_handler(
    ...
    try:
        ...
        tf['resource']['huaweicloud_elb_healthcheck'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['huaweicloud_elb_healthcheck'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
