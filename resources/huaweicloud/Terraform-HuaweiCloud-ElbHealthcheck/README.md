...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-elbhealthcheck.json`
2. Implement your resource handlers in `terraform_huaweicloud_elbhealthcheck/handlers.py`
