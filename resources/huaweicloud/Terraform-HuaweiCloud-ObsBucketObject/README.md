...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-obsbucketobject.json`
2. Implement your resource handlers in `terraform_huaweicloud_obsbucketobject/handlers.py`
