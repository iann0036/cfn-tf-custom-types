...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-lbcertificatev2.json`
2. Implement your resource handlers in `terraform_huaweicloud_lbcertificatev2/handlers.py`
