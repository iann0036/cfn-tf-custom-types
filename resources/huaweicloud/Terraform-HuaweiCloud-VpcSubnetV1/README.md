# Terraform::HuaweiCloud::VpcSubnetV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-vpcsubnetv1.json`
2. Implement your resource handlers in `terraform_huaweicloud_vpcsubnetv1/handlers.py`
