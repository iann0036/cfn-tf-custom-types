...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-elbloadbalancer.json`
2. Implement your resource handlers in `terraform_huaweicloud_elbloadbalancer/handlers.py`
