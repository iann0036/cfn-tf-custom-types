...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-vbsbackuppolicyv2.json`
2. Implement your resource handlers in `terraform_huaweicloud_vbsbackuppolicyv2/handlers.py`
