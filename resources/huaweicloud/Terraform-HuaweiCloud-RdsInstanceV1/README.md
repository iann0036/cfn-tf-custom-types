...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-rdsinstancev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_rdsinstancev1/handlers.py`
