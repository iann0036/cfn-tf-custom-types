...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-ccenodev3.json`
2. Implement your resource handlers in `terraform_huaweicloud_ccenodev3/handlers.py`
