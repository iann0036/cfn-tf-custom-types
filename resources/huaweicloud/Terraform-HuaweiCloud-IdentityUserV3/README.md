...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-identityuserv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_identityuserv3/handlers.py`
