# Terraform::HuaweiCloud::RdsParametergroupV3

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-rdsparametergroupv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_rdsparametergroupv3/handlers.py`
