...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-dwscluster.json`
2. Implement your resource handlers in `terraform_huaweicloud_dwscluster/handlers.py`
