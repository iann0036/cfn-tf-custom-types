# Terraform::HuaweiCloud::LbPoolV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-lbpoolv2.json`
2. Implement your resource handlers in `terraform_huaweicloud_lbpoolv2/handlers.py`
