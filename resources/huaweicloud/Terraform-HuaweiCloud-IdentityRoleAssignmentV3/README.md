...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-identityroleassignmentv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_identityroleassignmentv3/handlers.py`
