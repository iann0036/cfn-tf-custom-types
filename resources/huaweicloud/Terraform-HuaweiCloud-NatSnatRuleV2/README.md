...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-natsnatrulev2.json`
2. Implement your resource handlers in `terraform_huaweicloud_natsnatrulev2/handlers.py`
