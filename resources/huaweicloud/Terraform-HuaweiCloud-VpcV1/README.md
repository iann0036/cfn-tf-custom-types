...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-vpcv1.json`
2. Implement your resource handlers in `terraform_huaweicloud_vpcv1/handlers.py`
