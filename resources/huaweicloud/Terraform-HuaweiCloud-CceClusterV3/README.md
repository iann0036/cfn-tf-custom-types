...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-cceclusterv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_cceclusterv3/handlers.py`
