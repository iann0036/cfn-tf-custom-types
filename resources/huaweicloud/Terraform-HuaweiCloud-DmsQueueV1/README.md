...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-dmsqueuev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_dmsqueuev1/handlers.py`
