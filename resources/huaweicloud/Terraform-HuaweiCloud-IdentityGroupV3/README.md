...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-identitygroupv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_identitygroupv3/handlers.py`
