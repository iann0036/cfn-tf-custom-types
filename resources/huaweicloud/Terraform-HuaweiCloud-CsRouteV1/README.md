...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-csroutev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_csroutev1/handlers.py`
