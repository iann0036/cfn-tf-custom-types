...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-mlsinstance.json`
2. Implement your resource handlers in `terraform_huaweicloud_mlsinstance/handlers.py`
