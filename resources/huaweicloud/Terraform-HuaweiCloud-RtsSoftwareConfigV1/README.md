...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-rtssoftwareconfigv1.json`
2. Implement your resource handlers in `terraform_huaweicloud_rtssoftwareconfigv1/handlers.py`
