# Terraform::HuaweiCloud::CesAlarmrule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-cesalarmrule.json`
2. Implement your resource handlers in `terraform_huaweicloud_cesalarmrule/handlers.py`
