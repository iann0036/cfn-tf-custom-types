...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-csbsbackuppolicyv1.json`
2. Implement your resource handlers in `terraform_huaweicloud_csbsbackuppolicyv1/handlers.py`
