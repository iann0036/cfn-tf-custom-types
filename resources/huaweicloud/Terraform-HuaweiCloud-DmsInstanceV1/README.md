...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-dmsinstancev1.json`
2. Implement your resource handlers in `terraform_huaweicloud_dmsinstancev1/handlers.py`
