# Terraform::HuaweiCloud::NetworkingFloatingipAssociateV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-networkingfloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_huaweicloud_networkingfloatingipassociatev2/handlers.py`
