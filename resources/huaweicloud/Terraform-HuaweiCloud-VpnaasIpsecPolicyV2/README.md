...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-vpnaasipsecpolicyv2.json`
2. Implement your resource handlers in `terraform_huaweicloud_vpnaasipsecpolicyv2/handlers.py`
