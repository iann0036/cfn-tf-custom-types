...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-iamagencyv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_iamagencyv3/handlers.py`
