...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-computefloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_huaweicloud_computefloatingipassociatev2/handlers.py`
