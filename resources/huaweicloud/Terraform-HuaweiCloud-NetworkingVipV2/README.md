# Terraform::HuaweiCloud::NetworkingVipV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-networkingvipv2.json`
2. Implement your resource handlers in `terraform_huaweicloud_networkingvipv2/handlers.py`
