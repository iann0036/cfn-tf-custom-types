# Terraform::HuaweiCloud::S3BucketPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-huaweicloud-s3bucketpolicy.json`
2. Implement your resource handlers in `terraform_huaweicloud_s3bucketpolicy/handlers.py`
