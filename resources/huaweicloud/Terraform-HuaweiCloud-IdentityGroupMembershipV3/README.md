...
1. Write the JSON schema describing your resource, `terraform-huaweicloud-identitygroupmembershipv3.json`
2. Implement your resource handlers in `terraform_huaweicloud_identitygroupmembershipv3/handlers.py`
