...
1. Write the JSON schema describing your resource, `terraform-template-file.json`
2. Implement your resource handlers in `terraform_template_file/handlers.py`
