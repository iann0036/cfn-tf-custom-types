...
1. Write the JSON schema describing your resource, `terraform-template-cloudinitconfig.json`
2. Implement your resource handlers in `terraform_template_cloudinitconfig/handlers.py`
