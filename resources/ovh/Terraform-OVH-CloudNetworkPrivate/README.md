...
1. Write the JSON schema describing your resource, `terraform-ovh-cloudnetworkprivate.json`
2. Implement your resource handlers in `terraform_ovh_cloudnetworkprivate/handlers.py`
