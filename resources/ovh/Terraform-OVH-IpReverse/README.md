...
1. Write the JSON schema describing your resource, `terraform-ovh-ipreverse.json`
2. Implement your resource handlers in `terraform_ovh_ipreverse/handlers.py`
