...
1. Write the JSON schema describing your resource, `terraform-ovh-publiccloudprivatenetworksubnet.json`
2. Implement your resource handlers in `terraform_ovh_publiccloudprivatenetworksubnet/handlers.py`
