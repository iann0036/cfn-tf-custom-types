...
1. Write the JSON schema describing your resource, `tf-ovh-iploadbalancingtcpfrontend.json`
2. Implement your resource handlers in `tf_ovh_iploadbalancingtcpfrontend/handlers.py`
