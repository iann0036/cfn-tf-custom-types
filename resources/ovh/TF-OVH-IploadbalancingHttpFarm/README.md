# TF::OVH::IploadbalancingHttpFarm

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ovh-iploadbalancinghttpfarm.json`
2. Implement your resource handlers in `tf_ovh_iploadbalancinghttpfarm/handlers.py`
