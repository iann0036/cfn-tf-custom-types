...
1. Write the JSON schema describing your resource, `tf-ovh-cloudprojectcontainerregistryuser.json`
2. Implement your resource handlers in `tf_ovh_cloudprojectcontainerregistryuser/handlers.py`
