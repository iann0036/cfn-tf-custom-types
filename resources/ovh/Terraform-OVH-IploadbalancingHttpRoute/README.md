...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancinghttproute.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancinghttproute/handlers.py`
