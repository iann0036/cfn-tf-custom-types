...
1. Write the JSON schema describing your resource, `terraform-ovh-domainzoneredirection.json`
2. Implement your resource handlers in `terraform_ovh_domainzoneredirection/handlers.py`
