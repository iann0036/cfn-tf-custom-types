...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancinghttpfarm.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancinghttpfarm/handlers.py`
