...
1. Write the JSON schema describing your resource, `tf-ovh-iploadbalancingtcpfarmserver.json`
2. Implement your resource handlers in `tf_ovh_iploadbalancingtcpfarmserver/handlers.py`
