...
1. Write the JSON schema describing your resource, `tf-ovh-meinstallationtemplatepartitionschemepartition.json`
2. Implement your resource handlers in `tf_ovh_meinstallationtemplatepartitionschemepartition/handlers.py`
