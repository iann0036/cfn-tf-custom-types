...
1. Write the JSON schema describing your resource, `tf-ovh-cloudprojectkube.json`
2. Implement your resource handlers in `tf_ovh_cloudprojectkube/handlers.py`
