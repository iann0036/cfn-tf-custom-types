...
1. Write the JSON schema describing your resource, `terraform-ovh-dedicatedserverinstalltask.json`
2. Implement your resource handlers in `terraform_ovh_dedicatedserverinstalltask/handlers.py`
