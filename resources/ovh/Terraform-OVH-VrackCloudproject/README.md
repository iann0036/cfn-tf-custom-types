...
1. Write the JSON schema describing your resource, `terraform-ovh-vrackcloudproject.json`
2. Implement your resource handlers in `terraform_ovh_vrackcloudproject/handlers.py`
