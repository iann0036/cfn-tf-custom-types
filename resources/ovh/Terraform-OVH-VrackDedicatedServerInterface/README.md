...
1. Write the JSON schema describing your resource, `terraform-ovh-vrackdedicatedserverinterface.json`
2. Implement your resource handlers in `terraform_ovh_vrackdedicatedserverinterface/handlers.py`
