...
1. Write the JSON schema describing your resource, `terraform-ovh-dedicatedserverupdate.json`
2. Implement your resource handlers in `terraform_ovh_dedicatedserverupdate/handlers.py`
