...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancingtcpfarm.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancingtcpfarm/handlers.py`
