...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancingtcpfrontend.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancingtcpfrontend/handlers.py`
