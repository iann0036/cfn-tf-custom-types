...
1. Write the JSON schema describing your resource, `tf-ovh-iploadbalancingrefresh.json`
2. Implement your resource handlers in `tf_ovh_iploadbalancingrefresh/handlers.py`
