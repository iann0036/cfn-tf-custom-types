...
1. Write the JSON schema describing your resource, `terraform-ovh-cloudnetworkprivatesubnet.json`
2. Implement your resource handlers in `terraform_ovh_cloudnetworkprivatesubnet/handlers.py`
