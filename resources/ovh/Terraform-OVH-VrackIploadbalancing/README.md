...
1. Write the JSON schema describing your resource, `terraform-ovh-vrackiploadbalancing.json`
2. Implement your resource handlers in `terraform_ovh_vrackiploadbalancing/handlers.py`
