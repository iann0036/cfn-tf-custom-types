# TF::OVH::IploadbalancingHttpFarmServer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ovh-iploadbalancinghttpfarmserver.json`
2. Implement your resource handlers in `tf_ovh_iploadbalancinghttpfarmserver/handlers.py`
