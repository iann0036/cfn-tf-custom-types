# TF::OVH::DedicatedServerRebootTask

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ovh-dedicatedserverreboottask.json`
2. Implement your resource handlers in `tf_ovh_dedicatedserverreboottask/handlers.py`
