...
1. Write the JSON schema describing your resource, `tf-ovh-iploadbalancinghttproute.json`
2. Implement your resource handlers in `tf_ovh_iploadbalancinghttproute/handlers.py`
