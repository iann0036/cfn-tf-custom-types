# Terraform::OVH::MeInstallationTemplatePartitionSchemeHardwareRaid

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-ovh-meinstallationtemplatepartitionschemehardwareraid.json`
2. Implement your resource handlers in `terraform_ovh_meinstallationtemplatepartitionschemehardwareraid/handlers.py`
