...
1. Write the JSON schema describing your resource, `tf-ovh-cloudprojectuser.json`
2. Implement your resource handlers in `tf_ovh_cloudprojectuser/handlers.py`
