# TF::OVH::CloudProjectNetworkPrivate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ovh-cloudprojectnetworkprivate.json`
2. Implement your resource handlers in `tf_ovh_cloudprojectnetworkprivate/handlers.py`
