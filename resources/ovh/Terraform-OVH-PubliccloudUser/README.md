...
1. Write the JSON schema describing your resource, `terraform-ovh-publicclouduser.json`
2. Implement your resource handlers in `terraform_ovh_publicclouduser/handlers.py`
