...
def create_handler(
    ...
    try:
        ...
        tf['resource']['ovh_me_installation_template_partition_scheme'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['ovh_me_installation_template_partition_scheme'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
