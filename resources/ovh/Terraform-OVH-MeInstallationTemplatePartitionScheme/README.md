...
1. Write the JSON schema describing your resource, `terraform-ovh-meinstallationtemplatepartitionscheme.json`
2. Implement your resource handlers in `terraform_ovh_meinstallationtemplatepartitionscheme/handlers.py`
