...
1. Write the JSON schema describing your resource, `terraform-ovh-domainzonerecord.json`
2. Implement your resource handlers in `terraform_ovh_domainzonerecord/handlers.py`
