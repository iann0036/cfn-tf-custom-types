...
1. Write the JSON schema describing your resource, `terraform-ovh-vrackpubliccloudattachment.json`
2. Implement your resource handlers in `terraform_ovh_vrackpubliccloudattachment/handlers.py`
