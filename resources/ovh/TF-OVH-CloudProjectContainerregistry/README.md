...
1. Write the JSON schema describing your resource, `tf-ovh-cloudprojectcontainerregistry.json`
2. Implement your resource handlers in `tf_ovh_cloudprojectcontainerregistry/handlers.py`
