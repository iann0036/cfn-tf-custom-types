...
1. Write the JSON schema describing your resource, `terraform-ovh-meinstallationtemplate.json`
2. Implement your resource handlers in `terraform_ovh_meinstallationtemplate/handlers.py`
