# TF::OVH::DomainZoneRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ovh-domainzonerecord.json`
2. Implement your resource handlers in `tf_ovh_domainzonerecord/handlers.py`
