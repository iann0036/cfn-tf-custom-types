# Terraform::OVH::IploadbalancingHttpFrontend

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancinghttpfrontend.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancinghttpfrontend/handlers.py`
