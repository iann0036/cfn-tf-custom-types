...
1. Write the JSON schema describing your resource, `tf-ovh-domainzoneredirection.json`
2. Implement your resource handlers in `tf_ovh_domainzoneredirection/handlers.py`
