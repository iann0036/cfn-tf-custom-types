...
1. Write the JSON schema describing your resource, `terraform-ovh-meinstallationtemplatepartitionschemepartition.json`
2. Implement your resource handlers in `terraform_ovh_meinstallationtemplatepartitionschemepartition/handlers.py`
