...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancingtcpfarmserver.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancingtcpfarmserver/handlers.py`
