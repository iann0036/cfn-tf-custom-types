...
1. Write the JSON schema describing your resource, `terraform-ovh-clouduser.json`
2. Implement your resource handlers in `terraform_ovh_clouduser/handlers.py`
