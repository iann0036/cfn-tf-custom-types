...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancingvracknetwork.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancingvracknetwork/handlers.py`
