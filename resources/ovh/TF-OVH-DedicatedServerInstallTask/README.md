...
1. Write the JSON schema describing your resource, `tf-ovh-dedicatedserverinstalltask.json`
2. Implement your resource handlers in `tf_ovh_dedicatedserverinstalltask/handlers.py`
