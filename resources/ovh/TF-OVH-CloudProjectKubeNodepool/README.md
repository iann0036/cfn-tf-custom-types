...
1. Write the JSON schema describing your resource, `tf-ovh-cloudprojectkubenodepool.json`
2. Implement your resource handlers in `tf_ovh_cloudprojectkubenodepool/handlers.py`
