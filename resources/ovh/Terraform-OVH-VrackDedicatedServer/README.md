...
1. Write the JSON schema describing your resource, `terraform-ovh-vrackdedicatedserver.json`
2. Implement your resource handlers in `terraform_ovh_vrackdedicatedserver/handlers.py`
