...
1. Write the JSON schema describing your resource, `terraform-ovh-publiccloudprivatenetwork.json`
2. Implement your resource handlers in `terraform_ovh_publiccloudprivatenetwork/handlers.py`
