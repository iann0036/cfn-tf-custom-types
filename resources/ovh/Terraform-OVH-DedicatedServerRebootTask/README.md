...
1. Write the JSON schema describing your resource, `terraform-ovh-dedicatedserverreboottask.json`
2. Implement your resource handlers in `terraform_ovh_dedicatedserverreboottask/handlers.py`
