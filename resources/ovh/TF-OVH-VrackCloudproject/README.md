...
1. Write the JSON schema describing your resource, `tf-ovh-vrackcloudproject.json`
2. Implement your resource handlers in `tf_ovh_vrackcloudproject/handlers.py`
