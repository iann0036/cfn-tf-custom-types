...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancingrefresh.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancingrefresh/handlers.py`
