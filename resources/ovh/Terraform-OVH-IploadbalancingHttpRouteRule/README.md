...
1. Write the JSON schema describing your resource, `terraform-ovh-iploadbalancinghttprouterule.json`
2. Implement your resource handlers in `terraform_ovh_iploadbalancinghttprouterule/handlers.py`
