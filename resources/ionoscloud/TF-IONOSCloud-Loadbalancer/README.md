# TF::IONOSCloud::Loadbalancer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ionoscloud-loadbalancer.json`
2. Implement your resource handlers in `tf_ionoscloud_loadbalancer/handlers.py`
