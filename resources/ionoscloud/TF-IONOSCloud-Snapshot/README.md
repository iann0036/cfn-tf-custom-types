# TF::IONOSCloud::Snapshot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ionoscloud-snapshot.json`
2. Implement your resource handlers in `tf_ionoscloud_snapshot/handlers.py`
