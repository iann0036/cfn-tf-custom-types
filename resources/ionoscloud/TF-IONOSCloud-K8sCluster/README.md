...
1. Write the JSON schema describing your resource, `tf-ionoscloud-k8scluster.json`
2. Implement your resource handlers in `tf_ionoscloud_k8scluster/handlers.py`
