# TF::IONOSCloud::K8sNodePool

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ionoscloud-k8snodepool.json`
2. Implement your resource handlers in `tf_ionoscloud_k8snodepool/handlers.py`
