...
1. Write the JSON schema describing your resource, `tf-ionoscloud-datacenter.json`
2. Implement your resource handlers in `tf_ionoscloud_datacenter/handlers.py`
