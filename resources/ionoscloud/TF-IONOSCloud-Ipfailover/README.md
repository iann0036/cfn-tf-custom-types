...
1. Write the JSON schema describing your resource, `tf-ionoscloud-ipfailover.json`
2. Implement your resource handlers in `tf_ionoscloud_ipfailover/handlers.py`
