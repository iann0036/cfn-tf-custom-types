...
1. Write the JSON schema describing your resource, `tf-ionoscloud-privatecrossconnect.json`
2. Implement your resource handlers in `tf_ionoscloud_privatecrossconnect/handlers.py`
