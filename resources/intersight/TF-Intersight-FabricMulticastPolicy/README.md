...
1. Write the JSON schema describing your resource, `tf-intersight-fabricmulticastpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricmulticastpolicy/handlers.py`
