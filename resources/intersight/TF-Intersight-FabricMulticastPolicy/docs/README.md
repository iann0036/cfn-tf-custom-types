# TF::Intersight::FabricMulticastPolicy
...
<pre>
{
    "Type" : "TF::Intersight::FabricMulticastPolicy",
    "Properties" : {
        ...
        "<a href="#querieripaddress" title="QuerierIpAddress">QuerierIpAddress</a>" : <i>String</i>,
        "<a href="#querieripaddresspeer" title="QuerierIpAddressPeer">QuerierIpAddressPeer</a>" : <i>String</i>,
        "<a href="#querierstate" title="QuerierState">QuerierState</a>" : <i>String</i>,
        "<a href="#sharedscope" title="SharedScope">SharedScope</a>" : <i>String</i>,
        "<a href="#snoopingstate" title="SnoopingState">SnoopingState</a>" : <i>String</i>,
