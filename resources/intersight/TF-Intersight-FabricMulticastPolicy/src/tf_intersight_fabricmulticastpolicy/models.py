...
class ResourceModel(BaseModel):
    ...
    QuerierIpAddress: Optional[str]
    QuerierIpAddressPeer: Optional[str]
    QuerierState: Optional[str]
    SharedScope: Optional[str]
    SnoopingState: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            QuerierIpAddress=json_data.get("QuerierIpAddress"),
            QuerierIpAddressPeer=json_data.get("QuerierIpAddressPeer"),
            QuerierState=json_data.get("QuerierState"),
            SharedScope=json_data.get("SharedScope"),
            SnoopingState=json_data.get("SnoopingState"),
