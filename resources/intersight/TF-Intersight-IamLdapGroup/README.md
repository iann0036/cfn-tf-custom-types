...
1. Write the JSON schema describing your resource, `tf-intersight-iamldapgroup.json`
2. Implement your resource handlers in `tf_intersight_iamldapgroup/handlers.py`
