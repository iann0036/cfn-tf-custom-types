...
class ResourceModel(BaseModel):
    ...
    BackupInfo: Optional[Sequence["_BackupInfoDefinition"]]
    ClassId: Optional[str]
    ConfigParams: Optional[Sequence["_ConfigParamsDefinition"]]
    ...
    Workflow: Optional[Sequence["_WorkflowDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BackupInfo=deserialize_list(json_data.get("BackupInfo"), BackupInfoDefinition),
            ClassId=json_data.get("ClassId"),
            ConfigParams=deserialize_list(json_data.get("ConfigParams"), ConfigParamsDefinition),
            ...
            Workflow=deserialize_list(json_data.get("Workflow"), WorkflowDefinition),
        )
...
@dataclass
class BackupInfoDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_BackupInfoDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BackupInfoDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_BackupInfoDefinition = BackupInfoDefinition


@dataclass
class ConfigParamsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ConfigParamsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ConfigParamsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ConfigParamsDefinition = ConfigParamsDefinition
...
class WorkflowDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_WorkflowDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_WorkflowDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
