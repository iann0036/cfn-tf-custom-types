...
1. Write the JSON schema describing your resource, `tf-intersight-recoveryrestore.json`
2. Implement your resource handlers in `tf_intersight_recoveryrestore/handlers.py`
