...
1. Write the JSON schema describing your resource, `tf-intersight-firmwarechassisupgrade.json`
2. Implement your resource handlers in `tf_intersight_firmwarechassisupgrade/handlers.py`
