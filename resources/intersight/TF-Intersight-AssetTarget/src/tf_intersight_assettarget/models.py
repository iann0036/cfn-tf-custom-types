...
class ResourceModel(BaseModel):
    ...
    ClaimedByUserName: Optional[str]
    ClassId: Optional[str]
    Connections: Optional[Sequence["_ConnectionsDefinition2"]]
    ...
    ManagementLocation: Optional[str]
    ...
    ProductId: Optional[Sequence[str]]
    ReadOnly: Optional[bool]
    RegisteredDevice: Optional[Sequence["_RegisteredDeviceDefinition"]]
    Services: Optional[Sequence["_ServicesDefinition2"]]
    SharedScope: Optional[str]
    Status: Optional[str]
    StatusErrorReason: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    TargetId: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ClaimedByUserName=json_data.get("ClaimedByUserName"),
            ClassId=json_data.get("ClassId"),
            Connections=deserialize_list(json_data.get("Connections"), ConnectionsDefinition2),
            ConnectorVersion=json_data.get("ConnectorVersion"),
            CreateTime=json_data.get("CreateTime"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            ExternalIpAddress=json_data.get("ExternalIpAddress"),
            Id=json_data.get("Id"),
            IpAddress=json_data.get("IpAddress"),
            ManagementLocation=json_data.get("ManagementLocation"),
            ...
            Services=deserialize_list(json_data.get("Services"), ServicesDefinition2),
            SharedScope=json_data.get("SharedScope"),
            Status=json_data.get("Status"),
            StatusErrorReason=json_data.get("StatusErrorReason"),
...
@dataclass
class ConnectionsDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Credential: Optional[Sequence["_ConnectionsDefinition"]]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_ConnectionsDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ConnectionsDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Credential=deserialize_list(json_data.get("Credential"), ConnectionsDefinition),
            ObjectType=json_data.get("ObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_ConnectionsDefinition2 = ConnectionsDefinition2
...
@dataclass
class ServicesDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    Options: Optional[Sequence["_ServicesDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_ServicesDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServicesDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            ObjectType=json_data.get("ObjectType"),
            Options=deserialize_list(json_data.get("Options"), ServicesDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_ServicesDefinition2 = ServicesDefinition2
