...
1. Write the JSON schema describing your resource, `tf-intersight-assettarget.json`
2. Implement your resource handlers in `tf_intersight_assettarget/handlers.py`
