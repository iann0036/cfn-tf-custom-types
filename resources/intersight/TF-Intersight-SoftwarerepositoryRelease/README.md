# TF::Intersight::SoftwarerepositoryRelease

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-softwarerepositoryrelease.json`
2. Implement your resource handlers in `tf_intersight_softwarerepositoryrelease/handlers.py`
