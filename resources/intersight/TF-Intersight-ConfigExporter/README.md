...
1. Write the JSON schema describing your resource, `tf-intersight-configexporter.json`
2. Implement your resource handlers in `tf_intersight_configexporter/handlers.py`
