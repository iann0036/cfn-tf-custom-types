...
class ResourceModel(BaseModel):
    ...
    ExportedItems: Optional[Sequence["_ExportedItemsDefinition"]]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DownloadPath=json_data.get("DownloadPath"),
            ExportedItems=deserialize_list(json_data.get("ExportedItems"), ExportedItemsDefinition),
            Id=json_data.get("Id"),
...
@dataclass
class ExportedItemsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ExportedItemsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ExportedItemsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ExportedItemsDefinition = ExportedItemsDefinition
