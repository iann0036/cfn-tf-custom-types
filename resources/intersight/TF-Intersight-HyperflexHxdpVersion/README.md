...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexhxdpversion.json`
2. Implement your resource handlers in `tf_intersight_hyperflexhxdpversion/handlers.py`
