# TF::Intersight::VmediaPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-vmediapolicy.json`
2. Implement your resource handlers in `tf_intersight_vmediapolicy/handlers.py`
