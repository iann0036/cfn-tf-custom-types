...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            LowPowerUsb=json_data.get("LowPowerUsb"),
...
class MappingsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    AuthenticationProtocol: Optional[str]
    ClassId: Optional[str]
    ...
    MountProtocol: Optional[str]
    ObjectType: Optional[str]
    Password: Optional[str]
    RemoteFile: Optional[str]
    RemotePath: Optional[str]
    SanitizedFileLocation: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            AuthenticationProtocol=json_data.get("AuthenticationProtocol"),
            ClassId=json_data.get("ClassId"),
            ...
            MountProtocol=json_data.get("MountProtocol"),
            ObjectType=json_data.get("ObjectType"),
            Password=json_data.get("Password"),
            RemoteFile=json_data.get("RemoteFile"),
            RemotePath=json_data.get("RemotePath"),
            SanitizedFileLocation=json_data.get("SanitizedFileLocation"),
