...
1. Write the JSON schema describing your resource, `tf-intersight-fabricportoperation.json`
2. Implement your resource handlers in `tf_intersight_fabricportoperation/handlers.py`
