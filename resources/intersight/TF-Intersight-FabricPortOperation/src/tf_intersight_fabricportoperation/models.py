...
class ResourceModel(BaseModel):
    ...
    Moid: Optional[str]
    NetworkElement: Optional[Sequence["_NetworkElementDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            NetworkElement=deserialize_list(json_data.get("NetworkElement"), NetworkElementDefinition),
...
@dataclass
class NetworkElementDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_NetworkElementDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_NetworkElementDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_NetworkElementDefinition = NetworkElementDefinition
