...
1. Write the JSON schema describing your resource, `tf-intersight-resourcegroup.json`
2. Implement your resource handlers in `tf_intersight_resourcegroup/handlers.py`
