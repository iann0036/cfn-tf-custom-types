...
class ResourceModel(BaseModel):
    ...
    Organizations: Optional[Sequence["_OrganizationsDefinition"]]
    Owners: Optional[Sequence[str]]
    Parent: Optional[Sequence["_ParentDefinition"]]
    PerTypeCombinedSelector: Optional[Sequence["_PerTypeCombinedSelectorDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Organizations=deserialize_list(json_data.get("Organizations"), OrganizationsDefinition),
            Owners=json_data.get("Owners"),
            Parent=deserialize_list(json_data.get("Parent"), ParentDefinition),
            PerTypeCombinedSelector=deserialize_list(json_data.get("PerTypeCombinedSelector"), PerTypeCombinedSelectorDefinition),
...
@dataclass
class OrganizationsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_OrganizationsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_OrganizationsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_OrganizationsDefinition = OrganizationsDefinition
...
@dataclass
class PerTypeCombinedSelectorDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    CombinedSelector: Optional[str]
    EmptyFilter: Optional[bool]
    ObjectType: Optional[str]
    SelectorObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_PerTypeCombinedSelectorDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PerTypeCombinedSelectorDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            CombinedSelector=json_data.get("CombinedSelector"),
            EmptyFilter=json_data.get("EmptyFilter"),
            ObjectType=json_data.get("ObjectType"),
            SelectorObjectType=json_data.get("SelectorObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_PerTypeCombinedSelectorDefinition = PerTypeCombinedSelectorDefinition
