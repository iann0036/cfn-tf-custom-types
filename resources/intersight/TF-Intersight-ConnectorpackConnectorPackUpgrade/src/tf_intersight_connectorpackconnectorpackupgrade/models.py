...
class ResourceModel(BaseModel):
    ...
    ConnectorPackOpType: Optional[str]
    ...
    UcsdInfo: Optional[Sequence["_UcsdInfoDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ConnectorPackOpType=json_data.get("ConnectorPackOpType"),
            ...
            UcsdInfo=deserialize_list(json_data.get("UcsdInfo"), UcsdInfoDefinition),
...
@dataclass
class UcsdInfoDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_UcsdInfoDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_UcsdInfoDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_UcsdInfoDefinition = UcsdInfoDefinition
