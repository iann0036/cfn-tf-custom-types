...
1. Write the JSON schema describing your resource, `tf-intersight-connectorpackconnectorpackupgrade.json`
2. Implement your resource handlers in `tf_intersight_connectorpackconnectorpackupgrade/handlers.py`
