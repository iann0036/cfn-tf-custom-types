# TF::Intersight::ApplianceDeviceClaim

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-appliancedeviceclaim.json`
2. Implement your resource handlers in `tf_intersight_appliancedeviceclaim/handlers.py`
