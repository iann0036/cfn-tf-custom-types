...
class ResourceModel(BaseModel):
    ...
    FcAdapterPolicy: Optional[Sequence["_FcAdapterPolicyDefinition"]]
    FcNetworkPolicy: Optional[Sequence["_FcNetworkPolicyDefinition"]]
    FcQosPolicy: Optional[Sequence["_FcQosPolicyDefinition"]]
    Id: Optional[str]
    ...
    PersistentBindings: Optional[bool]
    Placement: Optional[Sequence["_PlacementDefinition"]]
    Profile: Optional[Sequence["_ProfileDefinition"]]
    SanConnectivityPolicy: Optional[Sequence["_SanConnectivityPolicyDefinition"]]
    ScpVhba: Optional[Sequence["_ScpVhbaDefinition"]]
    SharedScope: Optional[str]
    SpVhbas: Optional[Sequence["_SpVhbasDefinition"]]
    StaticWwpnAddress: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    Type: Optional[str]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    VifId: Optional[float]
    Wwpn: Optional[str]
    WwpnAddressType: Optional[str]
    WwpnLease: Optional[Sequence["_WwpnLeaseDefinition"]]
    WwpnPool: Optional[Sequence["_WwpnPoolDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FcAdapterPolicy=deserialize_list(json_data.get("FcAdapterPolicy"), FcAdapterPolicyDefinition),
            FcNetworkPolicy=deserialize_list(json_data.get("FcNetworkPolicy"), FcNetworkPolicyDefinition),
            FcQosPolicy=deserialize_list(json_data.get("FcQosPolicy"), FcQosPolicyDefinition),
            Id=json_data.get("Id"),
            ...
            PersistentBindings=json_data.get("PersistentBindings"),
            ...
            SanConnectivityPolicy=deserialize_list(json_data.get("SanConnectivityPolicy"), SanConnectivityPolicyDefinition),
            ScpVhba=deserialize_list(json_data.get("ScpVhba"), ScpVhbaDefinition),
            SharedScope=json_data.get("SharedScope"),
            SpVhbas=deserialize_list(json_data.get("SpVhbas"), SpVhbasDefinition),
            StaticWwpnAddress=json_data.get("StaticWwpnAddress"),
            ...
            WwpnAddressType=json_data.get("WwpnAddressType"),
            WwpnLease=deserialize_list(json_data.get("WwpnLease"), WwpnLeaseDefinition),
            WwpnPool=deserialize_list(json_data.get("WwpnPool"), WwpnPoolDefinition),
        )
...
@dataclass
class FcAdapterPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_FcAdapterPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FcAdapterPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_FcAdapterPolicyDefinition = FcAdapterPolicyDefinition
...
@dataclass
class FcQosPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_FcQosPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FcQosPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_FcQosPolicyDefinition = FcQosPolicyDefinition
...
@dataclass
class SanConnectivityPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SanConnectivityPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SanConnectivityPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SanConnectivityPolicyDefinition = SanConnectivityPolicyDefinition


@dataclass
class ScpVhbaDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ScpVhbaDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ScpVhbaDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ScpVhbaDefinition = ScpVhbaDefinition


@dataclass
class SpVhbasDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SpVhbasDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SpVhbasDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SpVhbasDefinition = SpVhbasDefinition
...
@dataclass
class WwpnLeaseDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_WwpnLeaseDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_WwpnLeaseDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_WwpnLeaseDefinition = WwpnLeaseDefinition


@dataclass
class WwpnPoolDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_WwpnPoolDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_WwpnPoolDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_WwpnPoolDefinition = WwpnPoolDefinition
