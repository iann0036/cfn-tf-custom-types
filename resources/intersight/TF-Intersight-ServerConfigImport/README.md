...
1. Write the JSON schema describing your resource, `tf-intersight-serverconfigimport.json`
2. Implement your resource handlers in `tf_intersight_serverconfigimport/handlers.py`
