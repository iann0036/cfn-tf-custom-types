...
class ResourceModel(BaseModel):
    ...
    ServerProfile: Optional[Sequence["_ServerProfileDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ServerProfile=deserialize_list(json_data.get("ServerProfile"), ServerProfileDefinition),
...
@dataclass
class ServerProfileDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServerProfileDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerProfileDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ServerProfileDefinition = ServerProfileDefinition
