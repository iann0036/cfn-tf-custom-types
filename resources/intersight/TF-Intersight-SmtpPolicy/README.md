...
1. Write the JSON schema describing your resource, `tf-intersight-smtppolicy.json`
2. Implement your resource handlers in `tf_intersight_smtppolicy/handlers.py`
