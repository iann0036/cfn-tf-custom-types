...
class ResourceModel(BaseModel):
    ...
    SmtpPort: Optional[float]
    SmtpRecipients: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SenderEmail=json_data.get("SenderEmail"),
            SharedScope=json_data.get("SharedScope"),
            SmtpPort=json_data.get("SmtpPort"),
            SmtpRecipients=json_data.get("SmtpRecipients"),
            SmtpServer=json_data.get("SmtpServer"),
