...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#senderemail" title="SenderEmail">SenderEmail</a>" : <i>String</i>,
        "<a href="#sharedscope" title="SharedScope">SharedScope</a>" : <i>String</i>,
        "<a href="#smtpport" title="SmtpPort">SmtpPort</a>" : <i>Double</i>,
        "<a href="#smtprecipients" title="SmtpRecipients">SmtpRecipients</a>" : <i>[ String, ... ]</i>,
        "<a href="#smtpserver" title="SmtpServer">SmtpServer</a>" : <i>String</i>,
...
Properties:
    ...
    <a href="#sharedscope" title="SharedScope">SharedScope</a>: <i>String</i>
    <a href="#smtpport" title="SmtpPort">SmtpPort</a>: <i>Double</i>
    <a href="#smtprecipients" title="SmtpRecipients">SmtpRecipients</a>: <i>
      - String</i>
    <a href="#smtpserver" title="SmtpServer">SmtpServer</a>: <i>String</i>
