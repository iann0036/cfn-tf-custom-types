...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexclusterreplicationnetworkpolicydeployment.json`
2. Implement your resource handlers in `tf_intersight_hyperflexclusterreplicationnetworkpolicydeployment/handlers.py`
