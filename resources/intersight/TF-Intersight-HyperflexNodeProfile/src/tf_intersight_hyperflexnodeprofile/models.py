...
class ResourceModel(BaseModel):
    ...
    HxdpDataIp: Optional[str]
    HxdpMgmtIp: Optional[str]
    HypervisorControlIp: Optional[str]
    HypervisorDataIp: Optional[str]
    HypervisorMgmtIp: Optional[str]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            HxdpDataIp=json_data.get("HxdpDataIp"),
            HxdpMgmtIp=json_data.get("HxdpMgmtIp"),
            HypervisorControlIp=json_data.get("HypervisorControlIp"),
            HypervisorDataIp=json_data.get("HypervisorDataIp"),
            HypervisorMgmtIp=json_data.get("HypervisorMgmtIp"),
            Id=json_data.get("Id"),
