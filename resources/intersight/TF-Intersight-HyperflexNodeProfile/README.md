...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexnodeprofile.json`
2. Implement your resource handlers in `tf_intersight_hyperflexnodeprofile/handlers.py`
