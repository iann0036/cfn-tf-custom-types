...
1. Write the JSON schema describing your resource, `tf-intersight-capabilityportgroupaggregationdef.json`
2. Implement your resource handlers in `tf_intersight_capabilityportgroupaggregationdef/handlers.py`
