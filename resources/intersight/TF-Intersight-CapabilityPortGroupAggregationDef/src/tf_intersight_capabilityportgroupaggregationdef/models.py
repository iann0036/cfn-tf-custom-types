...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AggregationCap=json_data.get("AggregationCap"),
            ...
            Hw40GPortGroupCap=json_data.get("Hw40GPortGroupCap"),
            Id=json_data.get("Id"),
