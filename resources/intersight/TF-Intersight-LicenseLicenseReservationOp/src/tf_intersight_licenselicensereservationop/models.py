...
class ResourceModel(BaseModel):
    ...
    AuthCodeInstalled: Optional[bool]
    ClassId: Optional[str]
    ConfirmCode: Optional[str]
    CreateTime: Optional[str]
    DomainGroupMoid: Optional[str]
    GenerateRequestCode: Optional[bool]
    GenerateReturnCode: Optional[bool]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AuthCodeInstalled=json_data.get("AuthCodeInstalled"),
            ClassId=json_data.get("ClassId"),
            ConfirmCode=json_data.get("ConfirmCode"),
            CreateTime=json_data.get("CreateTime"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            GenerateRequestCode=json_data.get("GenerateRequestCode"),
            GenerateReturnCode=json_data.get("GenerateReturnCode"),
            Id=json_data.get("Id"),
            ...
            RequestCode=json_data.get("RequestCode"),
