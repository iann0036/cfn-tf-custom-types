...
1. Write the JSON schema describing your resource, `tf-intersight-licenselicensereservationop.json`
2. Implement your resource handlers in `tf_intersight_licenselicensereservationop/handlers.py`
