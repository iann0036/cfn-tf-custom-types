# TF::Intersight::LicenseLicenseReservationOp
...
<pre>
{
    "Type" : "TF::Intersight::LicenseLicenseReservationOp",
    "Properties" : {
        ...
        "<a href="#authcodeinstalled" title="AuthCodeInstalled">AuthCodeInstalled</a>" : <i>Boolean</i>,
        "<a href="#classid" title="ClassId">ClassId</a>" : <i>String</i>,
        "<a href="#confirmcode" title="ConfirmCode">ConfirmCode</a>" : <i>String</i>,
        "<a href="#createtime" title="CreateTime">CreateTime</a>" : <i>String</i>,
        "<a href="#domaingroupmoid" title="DomainGroupMoid">DomainGroupMoid</a>" : <i>String</i>,
        "<a href="#generaterequestcode" title="GenerateRequestCode">GenerateRequestCode</a>" : <i>Boolean</i>,
        "<a href="#generatereturncode" title="GenerateReturnCode">GenerateReturnCode</a>" : <i>Boolean</i>,
        ...
        "<a href="#requestcode" title="RequestCode">RequestCode</a>" : <i>String</i>,
        "<a href="#returncode" title="ReturnCode">ReturnCode</a>" : <i>String</i>,
