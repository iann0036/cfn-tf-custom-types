...
1. Write the JSON schema describing your resource, `tf-intersight-iamendpointuserrole.json`
2. Implement your resource handlers in `tf_intersight_iamendpointuserrole/handlers.py`
