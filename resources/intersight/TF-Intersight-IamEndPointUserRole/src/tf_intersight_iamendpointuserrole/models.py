...
class ResourceModel(BaseModel):
    ...
    EndPointRole: Optional[Sequence["_EndPointRoleDefinition"]]
    EndPointUser: Optional[Sequence["_EndPointUserDefinition"]]
    EndPointUserPolicy: Optional[Sequence["_EndPointUserPolicyDefinition"]]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ChangePassword=json_data.get("ChangePassword"),
            ClassId=json_data.get("ClassId"),
            CreateTime=json_data.get("CreateTime"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            Enabled=json_data.get("Enabled"),
            EndPointRole=deserialize_list(json_data.get("EndPointRole"), EndPointRoleDefinition),
            EndPointUser=deserialize_list(json_data.get("EndPointUser"), EndPointUserDefinition),
            EndPointUserPolicy=deserialize_list(json_data.get("EndPointUserPolicy"), EndPointUserPolicyDefinition),
            Id=json_data.get("Id"),
...
@dataclass
class EndPointRoleDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EndPointRoleDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EndPointRoleDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EndPointRoleDefinition = EndPointRoleDefinition


@dataclass
class EndPointUserDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EndPointUserDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EndPointUserDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EndPointUserDefinition = EndPointUserDefinition


@dataclass
class EndPointUserPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EndPointUserPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EndPointUserPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EndPointUserPolicyDefinition = EndPointUserPolicyDefinition
