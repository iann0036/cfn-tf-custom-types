...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    IqnSuffixBlocks: Optional[Sequence["_IqnSuffixBlocksDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            IqnSuffixBlocks=deserialize_list(json_data.get("IqnSuffixBlocks"), IqnSuffixBlocksDefinition),
...
@dataclass
class IqnSuffixBlocksDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    From: Optional[float]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IqnSuffixBlocksDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IqnSuffixBlocksDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IqnSuffixBlocksDefinition = IqnSuffixBlocksDefinition
