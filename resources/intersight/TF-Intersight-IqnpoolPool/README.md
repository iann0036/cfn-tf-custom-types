...
1. Write the JSON schema describing your resource, `tf-intersight-iqnpoolpool.json`
2. Implement your resource handlers in `tf_intersight_iqnpoolpool/handlers.py`
