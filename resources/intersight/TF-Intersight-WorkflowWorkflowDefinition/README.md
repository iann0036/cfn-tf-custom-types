...
1. Write the JSON schema describing your resource, `tf-intersight-workflowworkflowdefinition.json`
2. Implement your resource handlers in `tf_intersight_workflowworkflowdefinition/handlers.py`
