# TF::Intersight::FabricPortPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-fabricportpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricportpolicy/handlers.py`
