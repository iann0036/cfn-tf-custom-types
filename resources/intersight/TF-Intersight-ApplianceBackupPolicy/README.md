...
1. Write the JSON schema describing your resource, `tf-intersight-appliancebackuppolicy.json`
2. Implement your resource handlers in `tf_intersight_appliancebackuppolicy/handlers.py`
