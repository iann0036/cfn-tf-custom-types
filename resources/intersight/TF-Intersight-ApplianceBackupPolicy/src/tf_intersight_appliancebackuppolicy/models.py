...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ManualBackup=json_data.get("ManualBackup"),
            ...
            RemoteHost=json_data.get("RemoteHost"),
...
class ScheduleDefinition(BaseModel):
    ...
    MonthOfYear: Optional[float]
    ObjectType: Optional[str]
    RepeatInterval: Optional[float]
    TimeOfDay: Optional[float]
    TimeZone: Optional[str]
    WeekOfMonth: Optional[float]
