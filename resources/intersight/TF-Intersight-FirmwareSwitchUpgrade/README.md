...
1. Write the JSON schema describing your resource, `tf-intersight-firmwareswitchupgrade.json`
2. Implement your resource handlers in `tf_intersight_firmwareswitchupgrade/handlers.py`
