...
<pre>
{
    "Type" : "TF::Intersight::FabricPortMode",
    "Properties" : {
        ...
        "<a href="#custommode" title="CustomMode">CustomMode</a>" : <i>String</i>,
        ...
        "<a href="#portidend" title="PortIdEnd">PortIdEnd</a>" : <i>Double</i>,
        "<a href="#portidstart" title="PortIdStart">PortIdStart</a>" : <i>Double</i>,
