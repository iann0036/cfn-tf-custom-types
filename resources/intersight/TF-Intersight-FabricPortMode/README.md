...
1. Write the JSON schema describing your resource, `tf-intersight-fabricportmode.json`
2. Implement your resource handlers in `tf_intersight_fabricportmode/handlers.py`
