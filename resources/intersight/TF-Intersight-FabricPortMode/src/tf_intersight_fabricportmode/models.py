...
class ResourceModel(BaseModel):
    ...
    PortIdEnd: Optional[float]
    PortIdStart: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CustomMode=json_data.get("CustomMode"),
            ...
            PortIdEnd=json_data.get("PortIdEnd"),
            PortIdStart=json_data.get("PortIdStart"),
