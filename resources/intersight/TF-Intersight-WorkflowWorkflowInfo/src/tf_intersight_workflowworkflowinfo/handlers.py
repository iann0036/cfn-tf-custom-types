...
TYPE_NAME = "TF::Intersight::WorkflowWorkflowInfo"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/intersight_workflow_workflow_info/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'intersight_workflow_workflow_info',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/intersight_workflow_workflow_info/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/intersight_workflow_workflow_info/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Account=None, AccountMoid=None, Action=None, AdditionalProperties=None, Ancestors=None, AssociatedObject=None, ClassId=None, CleanupTime=None, CreateTime=None, DomainGroupMoid=None, Email=None, EndTime=None, FailedWorkflowCleanupDuration=None, Id=None, Input=None, InstId=None, Internal=None, LastAction=None, Message=None, MetaVersion=None, ModTime=None, Moid=None, Name=None, ObjectType=None, Organization=None, Output=None, Owners=None, Parent=None, ParentTaskInfo=None, PauseReason=None, PendingDynamicWorkflowInfo=None, Permission=None, PermissionResources=None, Progress=None, Properties=None, RetryFromTaskName=None, SharedScope=None, Src=None, StartTime=None, Status=None, SuccessWorkflowCleanupDuration=None, Tags=None, TaskInfos=None, TraceId=None, Type=None, UserActionRequired=None, UserId=None, VersionContext=None, WaitReason=None, WorkflowCtx=None, WorkflowDefinition=None, WorkflowMetaType=None, WorkflowTaskCount=None, WorkflowWorkerTaskCount=None)
