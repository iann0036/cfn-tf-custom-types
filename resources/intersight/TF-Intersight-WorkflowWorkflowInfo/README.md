...
1. Write the JSON schema describing your resource, `tf-intersight-workflowworkflowinfo.json`
2. Implement your resource handlers in `tf_intersight_workflowworkflowinfo/handlers.py`
