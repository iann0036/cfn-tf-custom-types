...
1. Write the JSON schema describing your resource, `tf-intersight-iamldapprovider.json`
2. Implement your resource handlers in `tf_intersight_iamldapprovider/handlers.py`
