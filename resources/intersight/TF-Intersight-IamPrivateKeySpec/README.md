...
1. Write the JSON schema describing your resource, `tf-intersight-iamprivatekeyspec.json`
2. Implement your resource handlers in `tf_intersight_iamprivatekeyspec/handlers.py`
