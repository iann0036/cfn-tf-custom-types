...
1. Write the JSON schema describing your resource, `tf-intersight-tamadvisoryinstance.json`
2. Implement your resource handlers in `tf_intersight_tamadvisoryinstance/handlers.py`
