# TF::Intersight::CapabilityAdapterUnitDescriptor
...
<pre>
{
    "Type" : "TF::Intersight::CapabilityAdapterUnitDescriptor",
    "Properties" : {
        ...
        "<a href="#connectivityorder" title="ConnectivityOrder">ConnectivityOrder</a>" : <i>String</i>,
        "<a href="#createtime" title="CreateTime">CreateTime</a>" : <i>String</i>,
        "<a href="#description" title="Description">Description</a>" : <i>String</i>,
        "<a href="#domaingroupmoid" title="DomainGroupMoid">DomainGroupMoid</a>" : <i>String</i>,
        "<a href="#ethernetportspeed" title="EthernetPortSpeed">EthernetPortSpeed</a>" : <i>Double</i>,
        "<a href="#fibrechannelportspeed" title="FibreChannelPortSpeed">FibreChannelPortSpeed</a>" : <i>Double</i>,
        "<a href="#fibrechannelscsiioqlimit" title="FibreChannelScsiIoqLimit">FibreChannelScsiIoqLimit</a>" : <i>Double</i>,
        ...
        "<a href="#numdceports" title="NumDcePorts">NumDcePorts</a>" : <i>Double</i>,
        ...
        "<a href="#promcardtype" title="PromCardType">PromCardType</a>" : <i>String</i>,
