...
1. Write the JSON schema describing your resource, `tf-intersight-capabilityadapterunitdescriptor.json`
2. Implement your resource handlers in `tf_intersight_capabilityadapterunitdescriptor/handlers.py`
