...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ConnectivityOrder=json_data.get("ConnectivityOrder"),
            CreateTime=json_data.get("CreateTime"),
            Description=json_data.get("Description"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            EthernetPortSpeed=json_data.get("EthernetPortSpeed"),
            FibreChannelPortSpeed=json_data.get("FibreChannelPortSpeed"),
            FibreChannelScsiIoqLimit=json_data.get("FibreChannelScsiIoqLimit"),
            Id=json_data.get("Id"),
            ModTime=json_data.get("ModTime"),
            Model=json_data.get("Model"),
            Moid=json_data.get("Moid"),
            NrVersion=json_data.get("NrVersion"),
            NumDcePorts=json_data.get("NumDcePorts"),
            ...
            PromCardType=json_data.get("PromCardType"),
