...
1. Write the JSON schema describing your resource, `tf-intersight-fabriclinkcontrolpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabriclinkcontrolpolicy/handlers.py`
