...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexfeaturelimitexternal.json`
2. Implement your resource handlers in `tf_intersight_hyperflexfeaturelimitexternal/handlers.py`
