...
1. Write the JSON schema describing your resource, `tf-intersight-recoverybackupprofile.json`
2. Implement your resource handlers in `tf_intersight_recoverybackupprofile/handlers.py`
