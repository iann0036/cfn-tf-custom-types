...
class ResourceModel(BaseModel):
    ...
    EndPointUserRoles: Optional[Sequence["_EndPointUserRolesDefinition"]]
    Id: Optional[str]
    ...
    PasswordProperties: Optional[Sequence["_PasswordPropertiesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EndPointUserRoles=deserialize_list(json_data.get("EndPointUserRoles"), EndPointUserRolesDefinition),
            Id=json_data.get("Id"),
            ...
            PasswordProperties=deserialize_list(json_data.get("PasswordProperties"), PasswordPropertiesDefinition),
...
@dataclass
class EndPointUserRolesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EndPointUserRolesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EndPointUserRolesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EndPointUserRolesDefinition = EndPointUserRolesDefinition
...
@dataclass
class PasswordPropertiesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    EnablePasswordExpiry: Optional[bool]
    EnforceStrongPassword: Optional[bool]
    ForceSendPassword: Optional[bool]
    GracePeriod: Optional[float]
    NotificationPeriod: Optional[float]
    ObjectType: Optional[str]
    PasswordExpiryDuration: Optional[float]
    PasswordHistory: Optional[float]

    @classmethod
    def _deserialize(
        cls: Type["_PasswordPropertiesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PasswordPropertiesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            EnablePasswordExpiry=json_data.get("EnablePasswordExpiry"),
            EnforceStrongPassword=json_data.get("EnforceStrongPassword"),
            ForceSendPassword=json_data.get("ForceSendPassword"),
            GracePeriod=json_data.get("GracePeriod"),
            NotificationPeriod=json_data.get("NotificationPeriod"),
            ObjectType=json_data.get("ObjectType"),
            PasswordExpiryDuration=json_data.get("PasswordExpiryDuration"),
            PasswordHistory=json_data.get("PasswordHistory"),
        )


# work around possible type aliasing issues when variable has same name as a model
_PasswordPropertiesDefinition = PasswordPropertiesDefinition
