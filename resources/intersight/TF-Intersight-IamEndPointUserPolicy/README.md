...
1. Write the JSON schema describing your resource, `tf-intersight-iamendpointuserpolicy.json`
2. Implement your resource handlers in `tf_intersight_iamendpointuserpolicy/handlers.py`
