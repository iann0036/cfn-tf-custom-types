...
class ResourceModel(BaseModel):
    ...
    EthIfs: Optional[Sequence["_EthIfsDefinition"]]
    Id: Optional[str]
    IqnAllocationType: Optional[str]
    IqnPool: Optional[Sequence["_IqnPoolDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EthIfs=deserialize_list(json_data.get("EthIfs"), EthIfsDefinition),
            Id=json_data.get("Id"),
            IqnAllocationType=json_data.get("IqnAllocationType"),
            IqnPool=deserialize_list(json_data.get("IqnPool"), IqnPoolDefinition),
            ...
            StaticIqnName=json_data.get("StaticIqnName"),
...
@dataclass
class EthIfsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EthIfsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EthIfsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EthIfsDefinition = EthIfsDefinition


@dataclass
class IqnPoolDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IqnPoolDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IqnPoolDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IqnPoolDefinition = IqnPoolDefinition
