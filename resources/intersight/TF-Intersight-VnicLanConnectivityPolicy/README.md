...
1. Write the JSON schema describing your resource, `tf-intersight-vniclanconnectivitypolicy.json`
2. Implement your resource handlers in `tf_intersight_vniclanconnectivitypolicy/handlers.py`
