...
TYPE_NAME = "TF::Intersight::FirmwareServerConfigurationUtilityDistributable"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/intersight_firmware_server_configuration_utility_distributable/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'intersight_firmware_server_configuration_utility_distributable',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/intersight_firmware_server_configuration_utility_distributable/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/intersight_firmware_server_configuration_utility_distributable/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccountMoid=None, AdditionalProperties=None, Ancestors=None, BundleType=None, Catalog=None, ClassId=None, ComponentMeta=None, CreateTime=None, Description=None, DistributableMetas=None, DomainGroupMoid=None, DownloadCount=None, Guid=None, Id=None, ImageType=None, ImportAction=None, ImportState=None, ImportedTime=None, LastAccessTime=None, Md5eTag=None, Md5sum=None, Mdfid=None, ModTime=None, Model=None, Moid=None, Name=None, NrSource=None, NrVersion=None, ObjectType=None, Owners=None, Parent=None, PermissionResources=None, PlatformType=None, RecommendedBuild=None, Release=None, ReleaseDate=None, ReleaseNotesUrl=None, Sha512sum=None, SharedScope=None, Size=None, SoftwareAdvisoryUrl=None, SoftwareTypeId=None, SupportedModels=None, Tags=None, Vendor=None, VersionContext=None)
