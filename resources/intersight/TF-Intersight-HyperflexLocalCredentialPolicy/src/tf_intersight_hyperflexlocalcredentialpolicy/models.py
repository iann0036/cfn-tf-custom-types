...
class ResourceModel(BaseModel):
    ...
    FactoryHypervisorPassword: Optional[bool]
    HxdpRootPwd: Optional[str]
    HypervisorAdmin: Optional[str]
    HypervisorAdminPwd: Optional[str]
    Id: Optional[str]
    IsHxdpRootPwdSet: Optional[bool]
    IsHypervisorAdminPwdSet: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FactoryHypervisorPassword=json_data.get("FactoryHypervisorPassword"),
            HxdpRootPwd=json_data.get("HxdpRootPwd"),
            HypervisorAdmin=json_data.get("HypervisorAdmin"),
            HypervisorAdminPwd=json_data.get("HypervisorAdminPwd"),
            Id=json_data.get("Id"),
            IsHxdpRootPwdSet=json_data.get("IsHxdpRootPwdSet"),
            IsHypervisorAdminPwdSet=json_data.get("IsHypervisorAdminPwdSet"),
