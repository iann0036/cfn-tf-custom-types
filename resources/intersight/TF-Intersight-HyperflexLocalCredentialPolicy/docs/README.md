# TF::Intersight::HyperflexLocalCredentialPolicy
...
<pre>
{
    "Type" : "TF::Intersight::HyperflexLocalCredentialPolicy",
    "Properties" : {
        ...
        "<a href="#factoryhypervisorpassword" title="FactoryHypervisorPassword">FactoryHypervisorPassword</a>" : <i>Boolean</i>,
        "<a href="#hxdprootpwd" title="HxdpRootPwd">HxdpRootPwd</a>" : <i>String</i>,
        "<a href="#hypervisoradmin" title="HypervisorAdmin">HypervisorAdmin</a>" : <i>String</i>,
        "<a href="#hypervisoradminpwd" title="HypervisorAdminPwd">HypervisorAdminPwd</a>" : <i>String</i>,
        "<a href="#ishxdprootpwdset" title="IsHxdpRootPwdSet">IsHxdpRootPwdSet</a>" : <i>Boolean</i>,
        "<a href="#ishypervisoradminpwdset" title="IsHypervisorAdminPwdSet">IsHypervisorAdminPwdSet</a>" : <i>Boolean</i>,
