...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexlocalcredentialpolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexlocalcredentialpolicy/handlers.py`
