...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexextiscsistoragepolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexextiscsistoragepolicy/handlers.py`
