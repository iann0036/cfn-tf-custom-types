...
<pre>
{
    "Type" : "TF::Intersight::TechsupportmanagementCollectionControlPolicy",
    "Properties" : {
        ...
        "<a href="#techsupportcollection" title="TechSupportCollection">TechSupportCollection</a>" : <i>String</i>,
