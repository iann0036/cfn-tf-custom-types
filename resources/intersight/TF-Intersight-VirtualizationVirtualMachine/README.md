...
1. Write the JSON schema describing your resource, `tf-intersight-virtualizationvirtualmachine.json`
2. Implement your resource handlers in `tf_intersight_virtualizationvirtualmachine/handlers.py`
