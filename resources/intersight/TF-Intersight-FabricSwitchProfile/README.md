...
1. Write the JSON schema describing your resource, `tf-intersight-fabricswitchprofile.json`
2. Implement your resource handlers in `tf_intersight_fabricswitchprofile/handlers.py`
