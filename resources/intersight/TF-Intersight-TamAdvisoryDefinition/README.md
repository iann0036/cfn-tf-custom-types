...
1. Write the JSON schema describing your resource, `tf-intersight-tamadvisorydefinition.json`
2. Implement your resource handlers in `tf_intersight_tamadvisorydefinition/handlers.py`
