...
1. Write the JSON schema describing your resource, `tf-intersight-fabricuplinkrole.json`
2. Implement your resource handlers in `tf_intersight_fabricuplinkrole/handlers.py`
