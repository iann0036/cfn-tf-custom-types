...
class ResourceModel(BaseModel):
    ...
    ClusterAddonProfile: Optional[Sequence["_ClusterAddonProfileDefinition"]]
    ...
    RegisteredDevices: Optional[Sequence["_RegisteredDevicesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ClusterAddonProfile=deserialize_list(json_data.get("ClusterAddonProfile"), ClusterAddonProfileDefinition),
            ...
            RegisteredDevices=deserialize_list(json_data.get("RegisteredDevices"), RegisteredDevicesDefinition),
...
@dataclass
class ClusterAddonProfileDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ClusterAddonProfileDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ClusterAddonProfileDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ClusterAddonProfileDefinition = ClusterAddonProfileDefinition
...
@dataclass
class RegisteredDevicesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_RegisteredDevicesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RegisteredDevicesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_RegisteredDevicesDefinition = RegisteredDevicesDefinition
