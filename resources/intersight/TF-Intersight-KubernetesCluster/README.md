...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetescluster.json`
2. Implement your resource handlers in `tf_intersight_kubernetescluster/handlers.py`
