...
class ResourceModel(BaseModel):
    ...
    DeviceMoid: Optional[Sequence["_DeviceMoidDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DeviceMoid=deserialize_list(json_data.get("DeviceMoid"), DeviceMoidDefinition),
...
@dataclass
class DeviceMoidDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DeviceMoidDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DeviceMoidDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DeviceMoidDefinition = DeviceMoidDefinition
