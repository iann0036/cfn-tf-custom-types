...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexvmimportoperation.json`
2. Implement your resource handlers in `tf_intersight_hyperflexvmimportoperation/handlers.py`
