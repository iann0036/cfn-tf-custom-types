...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexfeaturelimitinternal.json`
2. Implement your resource handlers in `tf_intersight_hyperflexfeaturelimitinternal/handlers.py`
