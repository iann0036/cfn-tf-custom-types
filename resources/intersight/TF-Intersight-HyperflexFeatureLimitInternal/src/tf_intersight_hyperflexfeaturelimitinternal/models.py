...
class ResourceModel(BaseModel):
    ...
    FeatureLimitEntries: Optional[Sequence["_FeatureLimitEntriesDefinition2"]]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FeatureLimitEntries=deserialize_list(json_data.get("FeatureLimitEntries"), FeatureLimitEntriesDefinition2),
            Id=json_data.get("Id"),
...
@dataclass
class FeatureLimitEntriesDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Constraint: Optional[Sequence["_FeatureLimitEntriesDefinition"]]
    Name: Optional[str]
    ObjectType: Optional[str]
    Value: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_FeatureLimitEntriesDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FeatureLimitEntriesDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Constraint=deserialize_list(json_data.get("Constraint"), FeatureLimitEntriesDefinition),
...
# work around possible type aliasing issues when variable has same name as a model
_FeatureLimitEntriesDefinition2 = FeatureLimitEntriesDefinition2


@dataclass
class FeatureLimitEntriesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    ObjectType: Optional[str]
    ServerModel: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_FeatureLimitEntriesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FeatureLimitEntriesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ObjectType=json_data.get("ObjectType"),
            ServerModel=json_data.get("ServerModel"),
        )


# work around possible type aliasing issues when variable has same name as a model
_FeatureLimitEntriesDefinition = FeatureLimitEntriesDefinition
