...
1. Write the JSON schema describing your resource, `tf-intersight-chassisprofile.json`
2. Implement your resource handlers in `tf_intersight_chassisprofile/handlers.py`
