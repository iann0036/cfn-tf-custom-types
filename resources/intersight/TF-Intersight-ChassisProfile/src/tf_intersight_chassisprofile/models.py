...
class ResourceModel(BaseModel):
    ...
    AssignedChassis: Optional[Sequence["_AssignedChassisDefinition"]]
    AssociatedChassis: Optional[Sequence["_AssociatedChassisDefinition"]]
    ...
    Id: Optional[str]
    IomProfiles: Optional[Sequence["_IomProfilesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AssignedChassis=deserialize_list(json_data.get("AssignedChassis"), AssignedChassisDefinition),
            AssociatedChassis=deserialize_list(json_data.get("AssociatedChassis"), AssociatedChassisDefinition),
            ...
            Id=json_data.get("Id"),
            IomProfiles=deserialize_list(json_data.get("IomProfiles"), IomProfilesDefinition),
...
@dataclass
class AssignedChassisDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AssignedChassisDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AssignedChassisDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AssignedChassisDefinition = AssignedChassisDefinition


@dataclass
class AssociatedChassisDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AssociatedChassisDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AssociatedChassisDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AssociatedChassisDefinition = AssociatedChassisDefinition
...
@dataclass
class IomProfilesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IomProfilesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IomProfilesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IomProfilesDefinition = IomProfilesDefinition
