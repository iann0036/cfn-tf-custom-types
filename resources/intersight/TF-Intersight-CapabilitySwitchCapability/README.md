...
1. Write the JSON schema describing your resource, `tf-intersight-capabilityswitchcapability.json`
2. Implement your resource handlers in `tf_intersight_capabilityswitchcapability/handlers.py`
