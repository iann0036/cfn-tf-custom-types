# TF::Intersight::TamAdvisoryInfo

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-tamadvisoryinfo.json`
2. Implement your resource handlers in `tf_intersight_tamadvisoryinfo/handlers.py`
