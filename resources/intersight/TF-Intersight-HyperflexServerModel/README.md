...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexservermodel.json`
2. Implement your resource handlers in `tf_intersight_hyperflexservermodel/handlers.py`
