...
class ResourceModel(BaseModel):
    ...
    ServerModelEntries: Optional[Sequence["_ServerModelEntriesDefinition2"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ServerModelEntries=deserialize_list(json_data.get("ServerModelEntries"), ServerModelEntriesDefinition2),
...
@dataclass
class ServerModelEntriesDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Constraint: Optional[Sequence["_ServerModelEntriesDefinition"]]
    Name: Optional[str]
    ObjectType: Optional[str]
    Value: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServerModelEntriesDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerModelEntriesDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Constraint=deserialize_list(json_data.get("Constraint"), ServerModelEntriesDefinition),
...
# work around possible type aliasing issues when variable has same name as a model
_ServerModelEntriesDefinition2 = ServerModelEntriesDefinition2


@dataclass
class ServerModelEntriesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServerModelEntriesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerModelEntriesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ServerModelEntriesDefinition = ServerModelEntriesDefinition
