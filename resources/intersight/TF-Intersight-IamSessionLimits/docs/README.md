...
<pre>
{
    "Type" : "TF::Intersight::IamSessionLimits",
    "Properties" : {
        ...
        "<a href="#maximumlimit" title="MaximumLimit">MaximumLimit</a>" : <i>Double</i>,
        ...
        "<a href="#peruserlimit" title="PerUserLimit">PerUserLimit</a>" : <i>Double</i>,
