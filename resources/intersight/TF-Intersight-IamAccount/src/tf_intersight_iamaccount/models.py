...
class ResourceModel(BaseModel):
    ...
    DomainGroups: Optional[Sequence["_DomainGroupsDefinition"]]
    EndPointRoles: Optional[Sequence["_EndPointRolesDefinition"]]
    Id: Optional[str]
    Idpreferences: Optional[Sequence["_IdpreferencesDefinition"]]
    Idps: Optional[Sequence["_IdpsDefinition"]]
    ...
    SecurityHolder: Optional[Sequence["_SecurityHolderDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DomainGroups=deserialize_list(json_data.get("DomainGroups"), DomainGroupsDefinition),
            EndPointRoles=deserialize_list(json_data.get("EndPointRoles"), EndPointRolesDefinition),
            Id=json_data.get("Id"),
            Idpreferences=deserialize_list(json_data.get("Idpreferences"), IdpreferencesDefinition),
            Idps=deserialize_list(json_data.get("Idps"), IdpsDefinition),
            ...
            SecurityHolder=deserialize_list(json_data.get("SecurityHolder"), SecurityHolderDefinition),
...
@dataclass
class DomainGroupsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DomainGroupsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DomainGroupsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DomainGroupsDefinition = DomainGroupsDefinition
...
@dataclass
class IdpreferencesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IdpreferencesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IdpreferencesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IdpreferencesDefinition = IdpreferencesDefinition


@dataclass
class IdpsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IdpsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IdpsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IdpsDefinition = IdpsDefinition
...
@dataclass
class SecurityHolderDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SecurityHolderDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SecurityHolderDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SecurityHolderDefinition = SecurityHolderDefinition
