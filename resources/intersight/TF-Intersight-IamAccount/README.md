...
1. Write the JSON schema describing your resource, `tf-intersight-iamaccount.json`
2. Implement your resource handlers in `tf_intersight_iamaccount/handlers.py`
