...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesclusteraddonprofile.json`
2. Implement your resource handlers in `tf_intersight_kubernetesclusteraddonprofile/handlers.py`
