...
class ResourceModel(BaseModel):
    ...
    Addons: Optional[Sequence["_AddonsDefinition4"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Addons=deserialize_list(json_data.get("Addons"), AddonsDefinition4),
...
@dataclass
class AddonsDefinition4(BaseModel):
    AdditionalProperties: Optional[str]
    AddonConfiguration: Optional[Sequence["_AddonsDefinition2"]]
    AddonPolicy: Optional[Sequence["_AddonsDefinition3"]]
    ClassId: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddonsDefinition4"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddonsDefinition4"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            AddonConfiguration=deserialize_list(json_data.get("AddonConfiguration"), AddonsDefinition2),
            AddonPolicy=deserialize_list(json_data.get("AddonPolicy"), AddonsDefinition3),
            ClassId=json_data.get("ClassId"),
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
        )
...
# work around possible type aliasing issues when variable has same name as a model
_AddonsDefinition4 = AddonsDefinition4


@dataclass
class AddonsDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    InstallStrategy: Optional[str]
    ObjectType: Optional[str]
    OverrideSets: Optional[Sequence["_AddonsDefinition"]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddonsDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddonsDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ObjectType=json_data.get("ObjectType"),
            OverrideSets=deserialize_list(json_data.get("OverrideSets"), AddonsDefinition),
...
# work around possible type aliasing issues when variable has same name as a model
_AddonsDefinition2 = AddonsDefinition2
...
@dataclass
class AddonsDefinition3(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddonsDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddonsDefinition3"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AddonsDefinition3 = AddonsDefinition3
