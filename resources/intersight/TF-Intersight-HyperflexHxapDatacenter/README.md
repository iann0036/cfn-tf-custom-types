...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexhxapdatacenter.json`
2. Implement your resource handlers in `tf_intersight_hyperflexhxapdatacenter/handlers.py`
