...
class ResourceModel(BaseModel):
    ...
    HypervisorManager: Optional[Sequence["_HypervisorManagerDefinition"]]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            HypervisorManager=deserialize_list(json_data.get("HypervisorManager"), HypervisorManagerDefinition),
            Id=json_data.get("Id"),
...
@dataclass
class HypervisorManagerDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_HypervisorManagerDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_HypervisorManagerDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_HypervisorManagerDefinition = HypervisorManagerDefinition
