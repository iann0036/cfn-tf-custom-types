...
class ResourceModel(BaseModel):
    ...
    PriorityFlowControlMode: Optional[str]
    ReceiveDirection: Optional[str]
    SendDirection: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PriorityFlowControlMode=json_data.get("PriorityFlowControlMode"),
            ReceiveDirection=json_data.get("ReceiveDirection"),
            SendDirection=json_data.get("SendDirection"),
