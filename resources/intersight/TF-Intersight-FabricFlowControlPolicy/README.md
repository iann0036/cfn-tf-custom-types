...
1. Write the JSON schema describing your resource, `tf-intersight-fabricflowcontrolpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricflowcontrolpolicy/handlers.py`
