...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesvirtualmachinenodeprofile.json`
2. Implement your resource handlers in `tf_intersight_kubernetesvirtualmachinenodeprofile/handlers.py`
