...
class ResourceModel(BaseModel):
    ...
    NodeIp: Optional[Sequence["_NodeIpDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            NodeIp=deserialize_list(json_data.get("NodeIp"), NodeIpDefinition),
...
@dataclass
class NodeIpDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_NodeIpDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_NodeIpDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_NodeIpDefinition = NodeIpDefinition
