...
class ResourceModel(BaseModel):
    ...
    CaCert: Optional[Sequence["_CaCertDefinition3"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CaCert=deserialize_list(json_data.get("CaCert"), CaCertDefinition3),
            ...
            IsTokenSet=json_data.get("IsTokenSet"),
...
@dataclass
class CaCertDefinition3(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Issuer: Optional[Sequence["_CaCertDefinition"]]
    ...
    Subject: Optional[Sequence["_CaCertDefinition2"]]

    @classmethod
    def _deserialize(
        cls: Type["_CaCertDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CaCertDefinition3"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Issuer=deserialize_list(json_data.get("Issuer"), CaCertDefinition),
            ...
            Subject=deserialize_list(json_data.get("Subject"), CaCertDefinition2),
        )


# work around possible type aliasing issues when variable has same name as a model
_CaCertDefinition3 = CaCertDefinition3


@dataclass
class CaCertDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CaCertDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CaCertDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CaCertDefinition = CaCertDefinition


@dataclass
class CaCertDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    CommonName: Optional[str]
    Country: Optional[Sequence[str]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CaCertDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CaCertDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CaCertDefinition2 = CaCertDefinition2
