...
class ResourceModel(BaseModel):
    ...
    BackupProfiles: Optional[Sequence["_BackupProfilesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BackupProfiles=deserialize_list(json_data.get("BackupProfiles"), BackupProfilesDefinition),
            ...
            RetentionCount=json_data.get("RetentionCount"),
...
@dataclass
class BackupProfilesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_BackupProfilesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BackupProfilesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_BackupProfilesDefinition = BackupProfilesDefinition
