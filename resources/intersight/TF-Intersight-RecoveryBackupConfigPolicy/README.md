...
1. Write the JSON schema describing your resource, `tf-intersight-recoverybackupconfigpolicy.json`
2. Implement your resource handlers in `tf_intersight_recoverybackupconfigpolicy/handlers.py`
