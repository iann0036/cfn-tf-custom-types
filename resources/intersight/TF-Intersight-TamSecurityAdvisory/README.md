# TF::Intersight::TamSecurityAdvisory

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-tamsecurityadvisory.json`
2. Implement your resource handlers in `tf_intersight_tamsecurityadvisory/handlers.py`
