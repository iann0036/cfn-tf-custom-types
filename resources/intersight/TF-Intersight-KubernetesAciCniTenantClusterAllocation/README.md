...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesacicnitenantclusterallocation.json`
2. Implement your resource handlers in `tf_intersight_kubernetesacicnitenantclusterallocation/handlers.py`
