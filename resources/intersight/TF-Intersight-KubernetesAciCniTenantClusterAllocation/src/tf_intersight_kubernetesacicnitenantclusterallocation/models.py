...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            NodeSvcIpSubnet=json_data.get("NodeSvcIpSubnet"),
            ...
            PodIpSubnet=json_data.get("PodIpSubnet"),
            ...
            VlanEnd=json_data.get("VlanEnd"),
            VlanStart=json_data.get("VlanStart"),
        )
