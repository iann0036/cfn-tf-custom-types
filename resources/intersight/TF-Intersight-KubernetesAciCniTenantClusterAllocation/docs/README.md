# TF::Intersight::KubernetesAciCniTenantClusterAllocation
...
<pre>
{
    "Type" : "TF::Intersight::KubernetesAciCniTenantClusterAllocation",
    "Properties" : {
        ...
        "<a href="#nodesvcipsubnet" title="NodeSvcIpSubnet">NodeSvcIpSubnet</a>" : <i>String</i>,
        ...
        "<a href="#podipsubnet" title="PodIpSubnet">PodIpSubnet</a>" : <i>String</i>,
        ...
        "<a href="#vlanend" title="VlanEnd">VlanEnd</a>" : <i>String</i>,
        "<a href="#vlanstart" title="VlanStart">VlanStart</a>" : <i>String</i>
    }
}
</pre>
