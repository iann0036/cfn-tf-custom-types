...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexserverfirmwareversion.json`
2. Implement your resource handlers in `tf_intersight_hyperflexserverfirmwareversion/handlers.py`
