...
class ResourceModel(BaseModel):
    ...
    ServerFirmwareVersionEntries: Optional[Sequence["_ServerFirmwareVersionEntriesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ServerFirmwareVersionEntries=deserialize_list(json_data.get("ServerFirmwareVersionEntries"), ServerFirmwareVersionEntriesDefinition),
...
@dataclass
class ServerFirmwareVersionEntriesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServerFirmwareVersionEntriesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerFirmwareVersionEntriesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ServerFirmwareVersionEntriesDefinition = ServerFirmwareVersionEntriesDefinition
