...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetestrustedregistriespolicy.json`
2. Implement your resource handlers in `tf_intersight_kubernetestrustedregistriespolicy/handlers.py`
