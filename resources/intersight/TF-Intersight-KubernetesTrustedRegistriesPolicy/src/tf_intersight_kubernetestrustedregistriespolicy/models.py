...
class ResourceModel(BaseModel):
    ...
    RootCaRegistries: Optional[Sequence[str]]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    UnsignedRegistries: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RootCaRegistries=json_data.get("RootCaRegistries"),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UnsignedRegistries=json_data.get("UnsignedRegistries"),
