...
1. Write the JSON schema describing your resource, `tf-intersight-sdwanrouterpolicy.json`
2. Implement your resource handlers in `tf_intersight_sdwanrouterpolicy/handlers.py`
