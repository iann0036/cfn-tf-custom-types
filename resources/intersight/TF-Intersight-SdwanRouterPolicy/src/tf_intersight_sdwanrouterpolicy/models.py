...
class ResourceModel(BaseModel):
    ...
    SolutionImage: Optional[Sequence["_SolutionImageDefinition"]]
    Tags: Optional[Sequence["_TagsDefinition"]]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    WanCount: Optional[float]
    WanTerminationType: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DeploymentSize=json_data.get("DeploymentSize"),
            ...
            SolutionImage=deserialize_list(json_data.get("SolutionImage"), SolutionImageDefinition),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            VersionContext=deserialize_list(json_data.get("VersionContext"), VersionContextDefinition3),
            WanCount=json_data.get("WanCount"),
            WanTerminationType=json_data.get("WanTerminationType"),
        )
...
@dataclass
class SolutionImageDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SolutionImageDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SolutionImageDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SolutionImageDefinition = SolutionImageDefinition
