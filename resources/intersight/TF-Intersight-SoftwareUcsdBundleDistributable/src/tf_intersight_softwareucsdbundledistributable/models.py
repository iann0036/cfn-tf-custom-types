...
class ResourceModel(BaseModel):
    ...
    Images: Optional[Sequence["_ImagesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Images=deserialize_list(json_data.get("Images"), ImagesDefinition),
...
@dataclass
class ImagesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ImagesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ImagesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ImagesDefinition = ImagesDefinition
