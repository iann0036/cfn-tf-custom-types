...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexhealthcheckdefinition.json`
2. Implement your resource handlers in `tf_intersight_hyperflexhealthcheckdefinition/handlers.py`
