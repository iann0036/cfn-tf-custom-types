...
1. Write the JSON schema describing your resource, `tf-intersight-sdwanrouternode.json`
2. Implement your resource handlers in `tf_intersight_sdwanrouternode/handlers.py`
