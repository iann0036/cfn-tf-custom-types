...
class ResourceModel(BaseModel):
    ...
    ServerNode: Optional[Sequence["_ServerNodeDefinition"]]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    TemplateInputs: Optional[Sequence["_TemplateInputsDefinition"]]
    Uuid: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DeviceTemplate=json_data.get("DeviceTemplate"),
            ...
            ServerNode=deserialize_list(json_data.get("ServerNode"), ServerNodeDefinition),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            TemplateInputs=deserialize_list(json_data.get("TemplateInputs"), TemplateInputsDefinition),
...
@dataclass
class ServerNodeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServerNodeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerNodeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ServerNodeDefinition = ServerNodeDefinition
...
@dataclass
class TemplateInputsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_TemplateInputsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_TemplateInputsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_TemplateInputsDefinition = TemplateInputsDefinition
