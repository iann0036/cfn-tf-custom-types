...
class ResourceModel(BaseModel):
    ...
    DefaultInstallStrategy: Optional[str]
    DefaultNamespace: Optional[str]
    DefaultUpgradeStrategy: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ChartUrl=json_data.get("ChartUrl"),
            ClassId=json_data.get("ClassId"),
            CreateTime=json_data.get("CreateTime"),
            DefaultInstallStrategy=json_data.get("DefaultInstallStrategy"),
            DefaultNamespace=json_data.get("DefaultNamespace"),
            DefaultUpgradeStrategy=json_data.get("DefaultUpgradeStrategy"),
