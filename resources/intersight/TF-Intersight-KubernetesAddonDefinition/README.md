...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesaddondefinition.json`
2. Implement your resource handlers in `tf_intersight_kubernetesaddondefinition/handlers.py`
