...
1. Write the JSON schema describing your resource, `tf-intersight-fabricserverrole.json`
2. Implement your resource handlers in `tf_intersight_fabricserverrole/handlers.py`
