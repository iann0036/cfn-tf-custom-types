...
class ResourceModel(BaseModel):
    ...
    ParentConfig: Optional[Sequence["_ParentConfigDefinition"]]
    PermissionResources: Optional[Sequence["_PermissionResourcesDefinition"]]
    SharedScope: Optional[str]
    SubConfigs: Optional[Sequence["_SubConfigsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ParentConfig=deserialize_list(json_data.get("ParentConfig"), ParentConfigDefinition),
            ...
            SubConfigs=deserialize_list(json_data.get("SubConfigs"), SubConfigsDefinition),
...
@dataclass
class ParentConfigDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ParentConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ParentConfigDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ParentConfigDefinition = ParentConfigDefinition
...
@dataclass
class SubConfigsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SubConfigsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SubConfigsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SubConfigsDefinition = SubConfigsDefinition
