...
1. Write the JSON schema describing your resource, `tf-intersight-appliancedataexportpolicy.json`
2. Implement your resource handlers in `tf_intersight_appliancedataexportpolicy/handlers.py`
