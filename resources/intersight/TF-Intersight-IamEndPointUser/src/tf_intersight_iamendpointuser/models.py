...
class ResourceModel(BaseModel):
    ...
    EndPointUserRole: Optional[Sequence["_EndPointUserRoleDefinition"]]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EndPointUserRole=deserialize_list(json_data.get("EndPointUserRole"), EndPointUserRoleDefinition),
            Id=json_data.get("Id"),
...
@dataclass
class EndPointUserRoleDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EndPointUserRoleDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EndPointUserRoleDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EndPointUserRoleDefinition = EndPointUserRoleDefinition
