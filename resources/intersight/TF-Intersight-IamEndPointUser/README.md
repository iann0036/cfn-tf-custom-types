...
1. Write the JSON schema describing your resource, `tf-intersight-iamendpointuser.json`
2. Implement your resource handlers in `tf_intersight_iamendpointuser/handlers.py`
