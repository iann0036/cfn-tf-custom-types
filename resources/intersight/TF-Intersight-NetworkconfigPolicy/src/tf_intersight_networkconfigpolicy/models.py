...
class ResourceModel(BaseModel):
    ...
    AlternateIpv4dnsServer: Optional[str]
    AlternateIpv6dnsServer: Optional[str]
    ...
    DynamicDnsDomain: Optional[str]
    EnableDynamicDns: Optional[bool]
    EnableIpv4dnsFromDhcp: Optional[bool]
    EnableIpv6: Optional[bool]
    EnableIpv6dnsFromDhcp: Optional[bool]
    Id: Optional[str]
    ...
    PreferredIpv4dnsServer: Optional[str]
    PreferredIpv6dnsServer: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AlternateIpv4dnsServer=json_data.get("AlternateIpv4dnsServer"),
            AlternateIpv6dnsServer=json_data.get("AlternateIpv6dnsServer"),
            ...
            DynamicDnsDomain=json_data.get("DynamicDnsDomain"),
            EnableDynamicDns=json_data.get("EnableDynamicDns"),
            EnableIpv4dnsFromDhcp=json_data.get("EnableIpv4dnsFromDhcp"),
            EnableIpv6=json_data.get("EnableIpv6"),
            EnableIpv6dnsFromDhcp=json_data.get("EnableIpv6dnsFromDhcp"),
            Id=json_data.get("Id"),
            ...
            PreferredIpv4dnsServer=json_data.get("PreferredIpv4dnsServer"),
            PreferredIpv6dnsServer=json_data.get("PreferredIpv6dnsServer"),
