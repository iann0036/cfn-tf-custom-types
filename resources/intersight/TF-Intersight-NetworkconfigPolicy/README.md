...
1. Write the JSON schema describing your resource, `tf-intersight-networkconfigpolicy.json`
2. Implement your resource handlers in `tf_intersight_networkconfigpolicy/handlers.py`
