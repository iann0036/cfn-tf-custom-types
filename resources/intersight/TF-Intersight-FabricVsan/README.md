...
1. Write the JSON schema describing your resource, `tf-intersight-fabricvsan.json`
2. Implement your resource handlers in `tf_intersight_fabricvsan/handlers.py`
