...
class ResourceModel(BaseModel):
    ...
    DefaultZoning: Optional[str]
    DomainGroupMoid: Optional[str]
    FcNetworkPolicy: Optional[Sequence["_FcNetworkPolicyDefinition"]]
    FcZoneSharingMode: Optional[str]
    FcoeVlan: Optional[float]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DefaultZoning=json_data.get("DefaultZoning"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            FcNetworkPolicy=deserialize_list(json_data.get("FcNetworkPolicy"), FcNetworkPolicyDefinition),
            FcZoneSharingMode=json_data.get("FcZoneSharingMode"),
            FcoeVlan=json_data.get("FcoeVlan"),
            Id=json_data.get("Id"),
...
@dataclass
class FcNetworkPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_FcNetworkPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FcNetworkPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_FcNetworkPolicyDefinition = FcNetworkPolicyDefinition
