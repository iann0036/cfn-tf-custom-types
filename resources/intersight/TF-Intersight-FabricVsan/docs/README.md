...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#defaultzoning" title="DefaultZoning">DefaultZoning</a>" : <i>String</i>,
        ...
        "<a href="#fczonesharingmode" title="FcZoneSharingMode">FcZoneSharingMode</a>" : <i>String</i>,
        "<a href="#fcoevlan" title="FcoeVlan">FcoeVlan</a>" : <i>Double</i>,
