...
1. Write the JSON schema describing your resource, `tf-intersight-recoveryscheduleconfigpolicy.json`
2. Implement your resource handlers in `tf_intersight_recoveryscheduleconfigpolicy/handlers.py`
