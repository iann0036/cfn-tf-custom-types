...
1. Write the JSON schema describing your resource, `tf-intersight-serverprofile.json`
2. Implement your resource handlers in `tf_intersight_serverprofile/handlers.py`
