...
class ResourceModel(BaseModel):
    ...
    Lun: Optional[Sequence["_LunDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Lun=deserialize_list(json_data.get("Lun"), LunDefinition),
...
@dataclass
class LunDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    Bootable: Optional[bool]
    ClassId: Optional[str]
    LunId: Optional[float]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_LunDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LunDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ClassId=json_data.get("ClassId"),
            LunId=json_data.get("LunId"),
            ObjectType=json_data.get("ObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_LunDefinition = LunDefinition
