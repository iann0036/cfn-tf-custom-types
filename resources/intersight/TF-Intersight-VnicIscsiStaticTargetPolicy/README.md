...
1. Write the JSON schema describing your resource, `tf-intersight-vniciscsistatictargetpolicy.json`
2. Implement your resource handlers in `tf_intersight_vniciscsistatictargetpolicy/handlers.py`
