# TF::Intersight::CommHttpProxyPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-commhttpproxypolicy.json`
2. Implement your resource handlers in `tf_intersight_commhttpproxypolicy/handlers.py`
