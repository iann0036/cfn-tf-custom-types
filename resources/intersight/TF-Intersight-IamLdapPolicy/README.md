...
1. Write the JSON schema describing your resource, `tf-intersight-iamldappolicy.json`
2. Implement your resource handlers in `tf_intersight_iamldappolicy/handlers.py`
