...
1. Write the JSON schema describing your resource, `tf-intersight-fabricsystemqospolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricsystemqospolicy/handlers.py`
