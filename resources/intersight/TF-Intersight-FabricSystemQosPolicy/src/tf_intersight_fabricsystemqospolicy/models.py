...
class ResourceModel(BaseModel):
    ...
    Classes: Optional[Sequence["_ClassesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Classes=deserialize_list(json_data.get("Classes"), ClassesDefinition),
...
class ClassesDefinition(BaseModel):
    ...
    BandwidthPercent: Optional[float]
    ClassId: Optional[str]
    Cos: Optional[float]
    Mtu: Optional[float]
    MulticastOptimize: Optional[bool]
    Name: Optional[str]
    ObjectType: Optional[str]
    PacketDrop: Optional[bool]
    Weight: Optional[float]

    @classmethod
    def _deserialize(
        cls: Type["_ClassesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ClassesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            AdminState=json_data.get("AdminState"),
            BandwidthPercent=json_data.get("BandwidthPercent"),
            ClassId=json_data.get("ClassId"),
            Cos=json_data.get("Cos"),
            Mtu=json_data.get("Mtu"),
            MulticastOptimize=json_data.get("MulticastOptimize"),
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
...
# work around possible type aliasing issues when variable has same name as a model
_ClassesDefinition = ClassesDefinition
