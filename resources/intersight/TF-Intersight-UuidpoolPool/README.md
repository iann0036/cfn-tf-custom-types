...
1. Write the JSON schema describing your resource, `tf-intersight-uuidpoolpool.json`
2. Implement your resource handlers in `tf_intersight_uuidpoolpool/handlers.py`
