...
class ResourceModel(BaseModel):
    ...
    UuidSuffixBlocks: Optional[Sequence["_UuidSuffixBlocksDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            UuidSuffixBlocks=deserialize_list(json_data.get("UuidSuffixBlocks"), UuidSuffixBlocksDefinition),
...
@dataclass
class UuidSuffixBlocksDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    From: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_UuidSuffixBlocksDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_UuidSuffixBlocksDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_UuidSuffixBlocksDefinition = UuidSuffixBlocksDefinition
