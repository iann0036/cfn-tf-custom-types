...
class ResourceModel(BaseModel):
    ...
    SsoSupported: Optional[bool]
    Tags: Optional[Sequence["_TagsDefinition"]]
    Tunnel: Optional[Sequence["_TunnelDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SsoSupported=json_data.get("SsoSupported"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            Tunnel=deserialize_list(json_data.get("Tunnel"), TunnelDefinition),
...
class TunnelDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_TunnelDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_TunnelDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_TunnelDefinition = TunnelDefinition
