...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexclusterprofile.json`
2. Implement your resource handlers in `tf_intersight_hyperflexclusterprofile/handlers.py`
