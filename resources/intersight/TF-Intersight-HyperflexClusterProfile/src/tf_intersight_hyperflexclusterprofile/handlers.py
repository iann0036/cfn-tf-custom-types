...
TYPE_NAME = "TF::Intersight::HyperflexClusterProfile"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/intersight_hyperflex_cluster_profile/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'intersight_hyperflex_cluster_profile',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/intersight_hyperflex_cluster_profile/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/intersight_hyperflex_cluster_profile/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccountMoid=None, Action=None, AdditionalProperties=None, Ancestors=None, AssociatedCluster=None, AssociatedComputeCluster=None, AutoSupport=None, ClassId=None, ClusterNetwork=None, ClusterStorage=None, ConfigContext=None, ConfigResult=None, CreateTime=None, DataIpAddress=None, Description=None, DomainGroupMoid=None, ExtFcStorage=None, ExtIscsiStorage=None, HostNamePrefix=None, Httpproxypolicy=None, HypervisorControlIpAddress=None, HypervisorType=None, Id=None, LocalCredential=None, MacAddressPrefix=None, MgmtIpAddress=None, MgmtPlatform=None, ModTime=None, Moid=None, Name=None, NodeConfig=None, NodeProfileConfig=None, ObjectType=None, Organization=None, Owners=None, Parent=None, PermissionResources=None, PolicyBucket=None, ProxySetting=None, Replication=None, RunningWorkflows=None, SharedScope=None, SoftwareVersion=None, SrcTemplate=None, StorageDataVlan=None, StorageType=None, SysConfig=None, Tags=None, Type=None, UcsmConfig=None, VcenterConfig=None, VersionContext=None, WaitForCompletion=None, WwxnPrefix=None)
