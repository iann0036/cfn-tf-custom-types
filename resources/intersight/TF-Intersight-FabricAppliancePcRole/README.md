...
1. Write the JSON schema describing your resource, `tf-intersight-fabricappliancepcrole.json`
2. Implement your resource handlers in `tf_intersight_fabricappliancepcrole/handlers.py`
