# TF::Intersight::CapabilityFanModuleDescriptor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-capabilityfanmoduledescriptor.json`
2. Implement your resource handlers in `tf_intersight_capabilityfanmoduledescriptor/handlers.py`
