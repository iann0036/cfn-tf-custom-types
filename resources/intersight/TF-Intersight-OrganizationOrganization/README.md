# TF::Intersight::OrganizationOrganization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-organizationorganization.json`
2. Implement your resource handlers in `tf_intersight_organizationorganization/handlers.py`
