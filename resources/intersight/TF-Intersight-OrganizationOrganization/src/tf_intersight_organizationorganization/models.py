...
class ResourceModel(BaseModel):
    ...
    ResourceGroups: Optional[Sequence["_ResourceGroupsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ResourceGroups=deserialize_list(json_data.get("ResourceGroups"), ResourceGroupsDefinition),
...
@dataclass
class ResourceGroupsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ResourceGroupsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ResourceGroupsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ResourceGroupsDefinition = ResourceGroupsDefinition
