...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesclusterprofile.json`
2. Implement your resource handlers in `tf_intersight_kubernetesclusterprofile/handlers.py`
