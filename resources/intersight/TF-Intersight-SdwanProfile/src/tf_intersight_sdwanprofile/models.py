...
class ResourceModel(BaseModel):
    ...
    RouterNodes: Optional[Sequence["_RouterNodesDefinition"]]
    RouterPolicy: Optional[Sequence["_RouterPolicyDefinition"]]
    ...
    VmanageAccount: Optional[Sequence["_VmanageAccountDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RouterNodes=deserialize_list(json_data.get("RouterNodes"), RouterNodesDefinition),
            RouterPolicy=deserialize_list(json_data.get("RouterPolicy"), RouterPolicyDefinition),
            ...
            VmanageAccount=deserialize_list(json_data.get("VmanageAccount"), VmanageAccountDefinition),
        )
...
@dataclass
class RouterNodesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_RouterNodesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RouterNodesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_RouterNodesDefinition = RouterNodesDefinition


@dataclass
class RouterPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_RouterPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RouterPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_RouterPolicyDefinition = RouterPolicyDefinition
...
@dataclass
class VmanageAccountDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VmanageAccountDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VmanageAccountDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_VmanageAccountDefinition = VmanageAccountDefinition
