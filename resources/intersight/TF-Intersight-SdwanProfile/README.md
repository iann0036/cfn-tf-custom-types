...
1. Write the JSON schema describing your resource, `tf-intersight-sdwanprofile.json`
2. Implement your resource handlers in `tf_intersight_sdwanprofile/handlers.py`
