...
1. Write the JSON schema describing your resource, `tf-intersight-fabricfcuplinkrole.json`
2. Implement your resource handlers in `tf_intersight_fabricfcuplinkrole/handlers.py`
