# TF::Intersight::FabricEthNetworkPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-fabricethnetworkpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricethnetworkpolicy/handlers.py`
