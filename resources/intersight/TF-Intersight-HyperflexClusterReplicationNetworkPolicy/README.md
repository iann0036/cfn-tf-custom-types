...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexclusterreplicationnetworkpolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexclusterreplicationnetworkpolicy/handlers.py`
