# TF::Intersight::CapabilityEquipmentPhysicalDef
...
<pre>
{
    "Type" : "TF::Intersight::CapabilityEquipmentPhysicalDef",
    "Properties" : {
        ...
        "<a href="#maxpower" title="MaxPower">MaxPower</a>" : <i>Double</i>,
        "<a href="#minpower" title="MinPower">MinPower</a>" : <i>Double</i>,
        "<a href="#modtime" title="ModTime">ModTime</a>" : <i>String</i>,
        "<a href="#moid" title="Moid">Moid</a>" : <i>String</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#nominalpower" title="NominalPower">NominalPower</a>" : <i>Double</i>,
