...
1. Write the JSON schema describing your resource, `tf-intersight-capabilityequipmentphysicaldef.json`
2. Implement your resource handlers in `tf_intersight_capabilityequipmentphysicaldef/handlers.py`
