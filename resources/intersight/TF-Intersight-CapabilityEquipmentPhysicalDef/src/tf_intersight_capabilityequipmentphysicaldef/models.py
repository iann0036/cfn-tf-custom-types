...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    MaxPower: Optional[float]
    MinPower: Optional[float]
    ModTime: Optional[str]
    Moid: Optional[str]
    Name: Optional[str]
    NominalPower: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            MaxPower=json_data.get("MaxPower"),
            MinPower=json_data.get("MinPower"),
            ModTime=json_data.get("ModTime"),
            Moid=json_data.get("Moid"),
            Name=json_data.get("Name"),
            NominalPower=json_data.get("NominalPower"),
