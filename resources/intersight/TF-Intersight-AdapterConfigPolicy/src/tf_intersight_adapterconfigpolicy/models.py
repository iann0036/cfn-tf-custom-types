...
class ResourceModel(BaseModel):
    ...
    Settings: Optional[Sequence["_SettingsDefinition5"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Settings=deserialize_list(json_data.get("Settings"), SettingsDefinition5),
...
@dataclass
class SettingsDefinition5(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    DceInterfaceSettings: Optional[Sequence["_SettingsDefinition"]]
    EthSettings: Optional[Sequence["_SettingsDefinition2"]]
    FcSettings: Optional[Sequence["_SettingsDefinition3"]]
    ObjectType: Optional[str]
    PortChannelSettings: Optional[Sequence["_SettingsDefinition4"]]
    SlotId: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_SettingsDefinition5"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SettingsDefinition5"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            DceInterfaceSettings=deserialize_list(json_data.get("DceInterfaceSettings"), SettingsDefinition),
            EthSettings=deserialize_list(json_data.get("EthSettings"), SettingsDefinition2),
            FcSettings=deserialize_list(json_data.get("FcSettings"), SettingsDefinition3),
            ObjectType=json_data.get("ObjectType"),
            PortChannelSettings=deserialize_list(json_data.get("PortChannelSettings"), SettingsDefinition4),
            SlotId=json_data.get("SlotId"),
        )


# work around possible type aliasing issues when variable has same name as a model
_SettingsDefinition5 = SettingsDefinition5
...
@dataclass
class SettingsDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SettingsDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SettingsDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SettingsDefinition2 = SettingsDefinition2


@dataclass
class SettingsDefinition3(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    FipEnabled: Optional[bool]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_SettingsDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SettingsDefinition3"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            FipEnabled=json_data.get("FipEnabled"),
            ObjectType=json_data.get("ObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_SettingsDefinition3 = SettingsDefinition3


@dataclass
class SettingsDefinition4(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SettingsDefinition4"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SettingsDefinition4"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SettingsDefinition4 = SettingsDefinition4
