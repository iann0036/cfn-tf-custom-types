# TF::Intersight::AdapterConfigPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-adapterconfigpolicy.json`
2. Implement your resource handlers in `tf_intersight_adapterconfigpolicy/handlers.py`
