...
class ResourceModel(BaseModel):
    ...
    Types: Optional[Sequence["_TypesDefinition2"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Types=deserialize_list(json_data.get("Types"), TypesDefinition2),
...
class ParametersDefinition(BaseModel):
    AcceptSingleValue: Optional[bool]
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ComplexType: Optional[str]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            AcceptSingleValue=json_data.get("AcceptSingleValue"),
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            ComplexType=json_data.get("ComplexType"),
            ItemType=json_data.get("ItemType"),
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
...
@dataclass
class TypesDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    Parameters: Optional[Sequence["_TypesDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_TypesDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_TypesDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
            Parameters=deserialize_list(json_data.get("Parameters"), TypesDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_TypesDefinition2 = TypesDefinition2
