...
1. Write the JSON schema describing your resource, `tf-intersight-vnicethnetworkpolicy.json`
2. Implement your resource handlers in `tf_intersight_vnicethnetworkpolicy/handlers.py`
