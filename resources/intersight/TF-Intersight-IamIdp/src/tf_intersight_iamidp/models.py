...
class ResourceModel(BaseModel):
    ...
    EnableSingleLogout: Optional[bool]
    Id: Optional[str]
    IdpEntityId: Optional[str]
    LdapPolicy: Optional[Sequence["_LdapPolicyDefinition"]]
    ...
    Type: Optional[str]
    UserPreferences: Optional[Sequence["_UserPreferencesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EnableSingleLogout=json_data.get("EnableSingleLogout"),
            Id=json_data.get("Id"),
            IdpEntityId=json_data.get("IdpEntityId"),
            LdapPolicy=deserialize_list(json_data.get("LdapPolicy"), LdapPolicyDefinition),
            ...
            UserPreferences=deserialize_list(json_data.get("UserPreferences"), UserPreferencesDefinition),
...
@dataclass
class LdapPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_LdapPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LdapPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_LdapPolicyDefinition = LdapPolicyDefinition
...
@dataclass
class UserPreferencesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_UserPreferencesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_UserPreferencesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_UserPreferencesDefinition = UserPreferencesDefinition
