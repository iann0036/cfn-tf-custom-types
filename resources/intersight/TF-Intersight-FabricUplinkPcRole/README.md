...
1. Write the JSON schema describing your resource, `tf-intersight-fabricuplinkpcrole.json`
2. Implement your resource handlers in `tf_intersight_fabricuplinkpcrole/handlers.py`
