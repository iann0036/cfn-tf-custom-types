...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesacicniapic.json`
2. Implement your resource handlers in `tf_intersight_kubernetesacicniapic/handlers.py`
