...
class ResourceModel(BaseModel):
    ...
    AciCniProfiles: Optional[Sequence["_AciCniProfilesDefinition"]]
    AdditionalProperties: Optional[str]
    Ancestors: Optional[Sequence["_AncestorsDefinition"]]
    AssetApicMoid: Optional[str]
    ...
    Moid: Optional[str]
    NumAciCniProfiles: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AciCniProfiles=deserialize_list(json_data.get("AciCniProfiles"), AciCniProfilesDefinition),
            ...
            AssetApicMoid=json_data.get("AssetApicMoid"),
            ...
            NumAciCniProfiles=json_data.get("NumAciCniProfiles"),
...
@dataclass
class AciCniProfilesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AciCniProfilesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AciCniProfilesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AciCniProfilesDefinition = AciCniProfilesDefinition
