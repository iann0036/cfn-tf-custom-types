...
1. Write the JSON schema describing your resource, `tf-intersight-snmppolicy.json`
2. Implement your resource handlers in `tf_intersight_snmppolicy/handlers.py`
