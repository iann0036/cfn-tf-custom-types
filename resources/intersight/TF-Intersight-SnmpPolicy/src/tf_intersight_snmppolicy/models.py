...
class ResourceModel(BaseModel):
    ...
    SnmpPort: Optional[float]
    SnmpTraps: Optional[Sequence["_SnmpTrapsDefinition"]]
    SnmpUsers: Optional[Sequence["_SnmpUsersDefinition"]]
    SysContact: Optional[str]
    SysLocation: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    TrapCommunity: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AccessCommunityString=json_data.get("AccessCommunityString"),
            ...
            CommunityAccess=json_data.get("CommunityAccess"),
            ...
            SnmpPort=json_data.get("SnmpPort"),
            SnmpTraps=deserialize_list(json_data.get("SnmpTraps"), SnmpTrapsDefinition),
            SnmpUsers=deserialize_list(json_data.get("SnmpUsers"), SnmpUsersDefinition),
            SysContact=json_data.get("SysContact"),
            SysLocation=json_data.get("SysLocation"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            TrapCommunity=json_data.get("TrapCommunity"),
...
@dataclass
class SnmpTrapsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SnmpTrapsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SnmpTrapsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SnmpTrapsDefinition = SnmpTrapsDefinition


@dataclass
class SnmpUsersDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    AuthPassword: Optional[str]
    AuthType: Optional[str]
    ClassId: Optional[str]
    IsAuthPasswordSet: Optional[bool]
    IsPrivacyPasswordSet: Optional[bool]
    Name: Optional[str]
    ObjectType: Optional[str]
    PrivacyPassword: Optional[str]
    PrivacyType: Optional[str]
    SecurityLevel: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_SnmpUsersDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SnmpUsersDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ClassId=json_data.get("ClassId"),
            IsAuthPasswordSet=json_data.get("IsAuthPasswordSet"),
            IsPrivacyPasswordSet=json_data.get("IsPrivacyPasswordSet"),
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
            PrivacyPassword=json_data.get("PrivacyPassword"),
            PrivacyType=json_data.get("PrivacyType"),
            SecurityLevel=json_data.get("SecurityLevel"),
        )


# work around possible type aliasing issues when variable has same name as a model
_SnmpUsersDefinition = SnmpUsersDefinition
