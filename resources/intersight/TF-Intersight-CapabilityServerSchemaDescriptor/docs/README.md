...
<pre>
{
    "Type" : "TF::Intersight::CapabilityServerSchemaDescriptor",
    "Properties" : {
        ...
        "<a href="#locatorledname" title="LocatorLedName">LocatorLedName</a>" : <i>String</i>,
        ...
        "<a href="#redfishschema" title="RedfishSchema">RedfishSchema</a>" : <i>String</i>,
