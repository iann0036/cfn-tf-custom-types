...
class ResourceModel(BaseModel):
    ...
    DiskGroupPolicies: Optional[Sequence["_DiskGroupPoliciesDefinition"]]
    DomainGroupMoid: Optional[str]
    GlobalHotSpares: Optional[Sequence["_GlobalHotSparesDefinition"]]
    Id: Optional[str]
    ...
    RetainPolicyVirtualDrives: Optional[bool]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    UnusedDisksState: Optional[str]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    VirtualDrives: Optional[Sequence["_VirtualDrivesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DiskGroupPolicies=deserialize_list(json_data.get("DiskGroupPolicies"), DiskGroupPoliciesDefinition),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            GlobalHotSpares=deserialize_list(json_data.get("GlobalHotSpares"), GlobalHotSparesDefinition),
            Id=json_data.get("Id"),
            ...
            RetainPolicyVirtualDrives=json_data.get("RetainPolicyVirtualDrives"),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UnusedDisksState=json_data.get("UnusedDisksState"),
            VersionContext=deserialize_list(json_data.get("VersionContext"), VersionContextDefinition3),
            VirtualDrives=deserialize_list(json_data.get("VirtualDrives"), VirtualDrivesDefinition),
        )
...
@dataclass
class DiskGroupPoliciesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DiskGroupPoliciesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DiskGroupPoliciesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DiskGroupPoliciesDefinition = DiskGroupPoliciesDefinition


@dataclass
class GlobalHotSparesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_GlobalHotSparesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_GlobalHotSparesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_GlobalHotSparesDefinition = GlobalHotSparesDefinition
...
@dataclass
class VirtualDrivesDefinition(BaseModel):
    AccessPolicy: Optional[str]
    AdditionalProperties: Optional[str]
    BootDrive: Optional[bool]
    ClassId: Optional[str]
    DiskGroupName: Optional[str]
    DiskGroupPolicy: Optional[str]
    DriveCache: Optional[str]
    ExpandToAvailable: Optional[bool]
    IoPolicy: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    ReadPolicy: Optional[str]
    Size: Optional[float]
    StripSize: Optional[str]
    Vdid: Optional[str]
    WritePolicy: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_VirtualDrivesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VirtualDrivesDefinition"]:
        if not json_data:
            return None
        return cls(
            AccessPolicy=json_data.get("AccessPolicy"),
            AdditionalProperties=json_data.get("AdditionalProperties"),
            BootDrive=json_data.get("BootDrive"),
            ClassId=json_data.get("ClassId"),
            DiskGroupName=json_data.get("DiskGroupName"),
            DiskGroupPolicy=json_data.get("DiskGroupPolicy"),
            DriveCache=json_data.get("DriveCache"),
            ExpandToAvailable=json_data.get("ExpandToAvailable"),
            IoPolicy=json_data.get("IoPolicy"),
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
            ReadPolicy=json_data.get("ReadPolicy"),
            Size=json_data.get("Size"),
            StripSize=json_data.get("StripSize"),
            Vdid=json_data.get("Vdid"),
            WritePolicy=json_data.get("WritePolicy"),
        )


# work around possible type aliasing issues when variable has same name as a model
_VirtualDrivesDefinition = VirtualDrivesDefinition
