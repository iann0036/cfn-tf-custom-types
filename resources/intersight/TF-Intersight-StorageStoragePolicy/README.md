...
1. Write the JSON schema describing your resource, `tf-intersight-storagestoragepolicy.json`
2. Implement your resource handlers in `tf_intersight_storagestoragepolicy/handlers.py`
