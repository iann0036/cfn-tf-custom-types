...
1. Write the JSON schema describing your resource, `tf-intersight-ippoolpool.json`
2. Implement your resource handlers in `tf_intersight_ippoolpool/handlers.py`
