...
class ResourceModel(BaseModel):
    ...
    DistributionVersions: Optional[Sequence["_DistributionVersionsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DistributionVersions=deserialize_list(json_data.get("DistributionVersions"), DistributionVersionsDefinition),
...
@dataclass
class DistributionVersionsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DistributionVersionsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DistributionVersionsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DistributionVersionsDefinition = DistributionVersionsDefinition
