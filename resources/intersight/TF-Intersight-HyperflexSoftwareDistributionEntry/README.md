...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexsoftwaredistributionentry.json`
2. Implement your resource handlers in `tf_intersight_hyperflexsoftwaredistributionentry/handlers.py`
