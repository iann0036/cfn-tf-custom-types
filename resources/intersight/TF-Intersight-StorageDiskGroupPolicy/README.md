...
1. Write the JSON schema describing your resource, `tf-intersight-storagediskgrouppolicy.json`
2. Implement your resource handlers in `tf_intersight_storagediskgrouppolicy/handlers.py`
