...
class ResourceModel(BaseModel):
    ...
    DedicatedHotSpares: Optional[Sequence["_DedicatedHotSparesDefinition"]]
    ...
    SpanGroups: Optional[Sequence["_SpanGroupsDefinition2"]]
    StoragePolicies: Optional[Sequence["_StoragePoliciesDefinition"]]
    Tags: Optional[Sequence["_TagsDefinition"]]
    UseJbods: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DedicatedHotSpares=deserialize_list(json_data.get("DedicatedHotSpares"), DedicatedHotSparesDefinition),
            ...
            SpanGroups=deserialize_list(json_data.get("SpanGroups"), SpanGroupsDefinition2),
            StoragePolicies=deserialize_list(json_data.get("StoragePolicies"), StoragePoliciesDefinition),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UseJbods=json_data.get("UseJbods"),
...
@dataclass
class DedicatedHotSparesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DedicatedHotSparesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DedicatedHotSparesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DedicatedHotSparesDefinition = DedicatedHotSparesDefinition
...
@dataclass
class SpanGroupsDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Disks: Optional[Sequence["_SpanGroupsDefinition"]]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_SpanGroupsDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SpanGroupsDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Disks=deserialize_list(json_data.get("Disks"), SpanGroupsDefinition),
            ObjectType=json_data.get("ObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_SpanGroupsDefinition2 = SpanGroupsDefinition2


@dataclass
class SpanGroupsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    SlotNumber: Optional[float]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SpanGroupsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SpanGroupsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SpanGroupsDefinition = SpanGroupsDefinition


@dataclass
class StoragePoliciesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_StoragePoliciesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_StoragePoliciesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_StoragePoliciesDefinition = StoragePoliciesDefinition
