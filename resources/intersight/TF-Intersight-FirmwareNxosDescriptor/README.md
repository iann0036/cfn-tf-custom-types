# TF::Intersight::FirmwareNxosDescriptor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-firmwarenxosdescriptor.json`
2. Implement your resource handlers in `tf_intersight_firmwarenxosdescriptor/handlers.py`
