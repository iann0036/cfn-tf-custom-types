...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexsoftwareversionpolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexsoftwareversionpolicy/handlers.py`
