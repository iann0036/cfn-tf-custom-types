...
class ResourceModel(BaseModel):
    ...
    HxdpVersionInfo: Optional[Sequence["_HxdpVersionInfoDefinition"]]
    HypervisorVersion: Optional[str]
    HypervisorVersionInfo: Optional[Sequence["_HypervisorVersionInfoDefinition"]]
    Id: Optional[str]
    ...
    ServerFirmwareVersionInfo: Optional[Sequence["_ServerFirmwareVersionInfoDefinition"]]
    ServerFirmwareVersions: Optional[Sequence["_ServerFirmwareVersionsDefinition"]]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    UpgradeTypes: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            HxdpVersionInfo=deserialize_list(json_data.get("HxdpVersionInfo"), HxdpVersionInfoDefinition),
            HypervisorVersion=json_data.get("HypervisorVersion"),
            HypervisorVersionInfo=deserialize_list(json_data.get("HypervisorVersionInfo"), HypervisorVersionInfoDefinition),
            Id=json_data.get("Id"),
            ...
            ServerFirmwareVersionInfo=deserialize_list(json_data.get("ServerFirmwareVersionInfo"), ServerFirmwareVersionInfoDefinition),
            ServerFirmwareVersions=deserialize_list(json_data.get("ServerFirmwareVersions"), ServerFirmwareVersionsDefinition),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UpgradeTypes=json_data.get("UpgradeTypes"),
...
@dataclass
class HxdpVersionInfoDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_HxdpVersionInfoDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_HxdpVersionInfoDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_HxdpVersionInfoDefinition = HxdpVersionInfoDefinition


@dataclass
class HypervisorVersionInfoDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_HypervisorVersionInfoDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_HypervisorVersionInfoDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_HypervisorVersionInfoDefinition = HypervisorVersionInfoDefinition
...
@dataclass
class ServerFirmwareVersionInfoDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServerFirmwareVersionInfoDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerFirmwareVersionInfoDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ServerFirmwareVersionInfoDefinition = ServerFirmwareVersionInfoDefinition


@dataclass
class ServerFirmwareVersionsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    NrVersion: Optional[str]
    ObjectType: Optional[str]
    ServerPlatform: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_ServerFirmwareVersionsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServerFirmwareVersionsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ObjectType=json_data.get("ObjectType"),
            ServerPlatform=json_data.get("ServerPlatform"),
        )


# work around possible type aliasing issues when variable has same name as a model
_ServerFirmwareVersionsDefinition = ServerFirmwareVersionsDefinition
