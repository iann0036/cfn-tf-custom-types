...
1. Write the JSON schema describing your resource, `tf-intersight-vnicsanconnectivitypolicy.json`
2. Implement your resource handlers in `tf_intersight_vnicsanconnectivitypolicy/handlers.py`
