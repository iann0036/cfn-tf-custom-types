...
class ResourceModel(BaseModel):
    ...
    FcIfs: Optional[Sequence["_FcIfsDefinition"]]
    Id: Optional[str]
    ...
    StaticWwnnAddress: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    TargetPlatform: Optional[str]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    WwnnAddressType: Optional[str]
    WwnnPool: Optional[Sequence["_WwnnPoolDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FcIfs=deserialize_list(json_data.get("FcIfs"), FcIfsDefinition),
            Id=json_data.get("Id"),
            ...
            StaticWwnnAddress=json_data.get("StaticWwnnAddress"),
            ...
            WwnnAddressType=json_data.get("WwnnAddressType"),
            WwnnPool=deserialize_list(json_data.get("WwnnPool"), WwnnPoolDefinition),
        )
...
@dataclass
class FcIfsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_FcIfsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FcIfsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_FcIfsDefinition = FcIfsDefinition
...
@dataclass
class WwnnPoolDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_WwnnPoolDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_WwnnPoolDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_WwnnPoolDefinition = WwnnPoolDefinition
