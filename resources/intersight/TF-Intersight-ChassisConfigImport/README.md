...
1. Write the JSON schema describing your resource, `tf-intersight-chassisconfigimport.json`
2. Implement your resource handlers in `tf_intersight_chassisconfigimport/handlers.py`
