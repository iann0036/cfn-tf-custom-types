...
class ResourceModel(BaseModel):
    ...
    Chassis: Optional[Sequence["_ChassisDefinition"]]
    ChassisProfile: Optional[Sequence["_ChassisProfileDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Chassis=deserialize_list(json_data.get("Chassis"), ChassisDefinition),
            ChassisProfile=deserialize_list(json_data.get("ChassisProfile"), ChassisProfileDefinition),
            ...
            PolicyPrefix=json_data.get("PolicyPrefix"),
...
@dataclass
class ChassisDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ChassisDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ChassisDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ChassisDefinition = ChassisDefinition


@dataclass
class ChassisProfileDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ChassisProfileDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ChassisProfileDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ChassisProfileDefinition = ChassisProfileDefinition
