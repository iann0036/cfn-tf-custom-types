...
class ResourceModel(BaseModel):
    ...
    Partitions: Optional[Sequence["_PartitionsDefinition2"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Partitions=deserialize_list(json_data.get("Partitions"), PartitionsDefinition2),
...
@dataclass
class PartitionsDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    Type: Optional[str]
    VirtualDrives: Optional[Sequence["_PartitionsDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_PartitionsDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PartitionsDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            VirtualDrives=deserialize_list(json_data.get("VirtualDrives"), PartitionsDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_PartitionsDefinition2 = PartitionsDefinition2
