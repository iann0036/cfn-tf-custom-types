...
1. Write the JSON schema describing your resource, `tf-intersight-sdcardpolicy.json`
2. Implement your resource handlers in `tf_intersight_sdcardpolicy/handlers.py`
