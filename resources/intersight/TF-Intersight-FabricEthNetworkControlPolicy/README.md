...
1. Write the JSON schema describing your resource, `tf-intersight-fabricethnetworkcontrolpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricethnetworkcontrolpolicy/handlers.py`
