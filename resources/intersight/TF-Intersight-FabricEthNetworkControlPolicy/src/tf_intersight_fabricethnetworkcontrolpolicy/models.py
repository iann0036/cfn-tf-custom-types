...
class ResourceModel(BaseModel):
    ...
    CdpEnabled: Optional[bool]
    ClassId: Optional[str]
    CreateTime: Optional[str]
    Description: Optional[str]
    DomainGroupMoid: Optional[str]
    ForgeMac: Optional[str]
    Id: Optional[str]
    LldpSettings: Optional[Sequence["_LldpSettingsDefinition"]]
    MacRegistrationMode: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CdpEnabled=json_data.get("CdpEnabled"),
            ClassId=json_data.get("ClassId"),
            CreateTime=json_data.get("CreateTime"),
            Description=json_data.get("Description"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            ForgeMac=json_data.get("ForgeMac"),
            Id=json_data.get("Id"),
            LldpSettings=deserialize_list(json_data.get("LldpSettings"), LldpSettingsDefinition),
            MacRegistrationMode=json_data.get("MacRegistrationMode"),
            ...
            UplinkFailAction=json_data.get("UplinkFailAction"),
...
@dataclass
class LldpSettingsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ObjectType: Optional[str]
    ReceiveEnabled: Optional[bool]
    TransmitEnabled: Optional[bool]

    @classmethod
    def _deserialize(
        cls: Type["_LldpSettingsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LldpSettingsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            ObjectType=json_data.get("ObjectType"),
            ReceiveEnabled=json_data.get("ReceiveEnabled"),
            TransmitEnabled=json_data.get("TransmitEnabled"),
        )


# work around possible type aliasing issues when variable has same name as a model
_LldpSettingsDefinition = LldpSettingsDefinition
