...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesnetworkpolicy.json`
2. Implement your resource handlers in `tf_intersight_kubernetesnetworkpolicy/handlers.py`
