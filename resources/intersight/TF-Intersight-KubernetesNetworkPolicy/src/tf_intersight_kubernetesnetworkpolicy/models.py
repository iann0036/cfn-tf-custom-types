...
class ResourceModel(BaseModel):
    ...
    CniConfig: Optional[Sequence["_CniConfigDefinition"]]
    CniType: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CniConfig=deserialize_list(json_data.get("CniConfig"), CniConfigDefinition),
            CniType=json_data.get("CniType"),
            ...
            PodNetworkCidr=json_data.get("PodNetworkCidr"),
...
@dataclass
class CniConfigDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CniConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CniConfigDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CniConfigDefinition = CniConfigDefinition
