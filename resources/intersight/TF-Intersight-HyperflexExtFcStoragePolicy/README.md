...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexextfcstoragepolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexextfcstoragepolicy/handlers.py`
