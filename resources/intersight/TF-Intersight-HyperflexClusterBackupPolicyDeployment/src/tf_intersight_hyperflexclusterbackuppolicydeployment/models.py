...
class ResourceModel(BaseModel):
    ...
    PolicyMoid: Optional[str]
    ProfileMoid: Optional[str]
    ...
    SourceCluster: Optional[Sequence["_SourceClusterDefinition"]]
    SourceDetached: Optional[bool]
    SourceRequestId: Optional[str]
    SourceUuid: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    TargetDetached: Optional[bool]
    TargetRequestId: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PolicyMoid=json_data.get("PolicyMoid"),
            ProfileMoid=json_data.get("ProfileMoid"),
            ...
            SourceCluster=deserialize_list(json_data.get("SourceCluster"), SourceClusterDefinition),
            SourceDetached=json_data.get("SourceDetached"),
            SourceRequestId=json_data.get("SourceRequestId"),
            SourceUuid=json_data.get("SourceUuid"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            TargetDetached=json_data.get("TargetDetached"),
            TargetRequestId=json_data.get("TargetRequestId"),
            TargetUuid=json_data.get("TargetUuid"),
...
@dataclass
class SourceClusterDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SourceClusterDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SourceClusterDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SourceClusterDefinition = SourceClusterDefinition
