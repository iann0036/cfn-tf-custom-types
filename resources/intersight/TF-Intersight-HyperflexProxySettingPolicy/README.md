# TF::Intersight::HyperflexProxySettingPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-hyperflexproxysettingpolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexproxysettingpolicy/handlers.py`
