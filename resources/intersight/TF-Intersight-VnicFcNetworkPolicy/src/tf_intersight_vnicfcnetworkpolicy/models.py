...
class ResourceModel(BaseModel):
    ...
    VsanSettings: Optional[Sequence["_VsanSettingsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            VsanSettings=deserialize_list(json_data.get("VsanSettings"), VsanSettingsDefinition),
        )
...
@dataclass
class VsanSettingsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    DefaultVlanId: Optional[float]
    Id: Optional[float]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_VsanSettingsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VsanSettingsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            DefaultVlanId=json_data.get("DefaultVlanId"),
            Id=json_data.get("Id"),
            ObjectType=json_data.get("ObjectType"),
        )
...
# work around possible type aliasing issues when variable has same name as a model
_VsanSettingsDefinition = VsanSettingsDefinition
