...
1. Write the JSON schema describing your resource, `tf-intersight-vnicfcnetworkpolicy.json`
2. Implement your resource handlers in `tf_intersight_vnicfcnetworkpolicy/handlers.py`
