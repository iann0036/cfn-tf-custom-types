...
class ResourceModel(BaseModel):
    ...
    Session: Optional[Sequence["_SessionDefinition"]]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    Vcenter: Optional[Sequence["_VcenterDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ClientUrl=json_data.get("ClientUrl"),
            ...
            Session=deserialize_list(json_data.get("Session"), SessionDefinition),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            Vcenter=deserialize_list(json_data.get("Vcenter"), VcenterDefinition),
...
class SessionDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SessionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SessionDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
@dataclass
class VcenterDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VcenterDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VcenterDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_VcenterDefinition = VcenterDefinition
