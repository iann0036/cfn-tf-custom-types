...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesnodegroupprofile.json`
2. Implement your resource handlers in `tf_intersight_kubernetesnodegroupprofile/handlers.py`
