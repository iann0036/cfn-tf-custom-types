...
class ResourceModel(BaseModel):
    ...
    DataIpRange: Optional[Sequence["_DataIpRangeDefinition"]]
    Description: Optional[str]
    DomainGroupMoid: Optional[str]
    HxdpIpRange: Optional[Sequence["_HxdpIpRangeDefinition"]]
    HypervisorControlIpRange: Optional[Sequence["_HypervisorControlIpRangeDefinition"]]
    Id: Optional[str]
    MgmtIpRange: Optional[Sequence["_MgmtIpRangeDefinition"]]
    ModTime: Optional[str]
    Moid: Optional[str]
    Name: Optional[str]
    NodeNamePrefix: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DataIpRange=deserialize_list(json_data.get("DataIpRange"), DataIpRangeDefinition),
            Description=json_data.get("Description"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            HxdpIpRange=deserialize_list(json_data.get("HxdpIpRange"), HxdpIpRangeDefinition),
            HypervisorControlIpRange=deserialize_list(json_data.get("HypervisorControlIpRange"), HypervisorControlIpRangeDefinition),
            Id=json_data.get("Id"),
            MgmtIpRange=deserialize_list(json_data.get("MgmtIpRange"), MgmtIpRangeDefinition),
            ModTime=json_data.get("ModTime"),
            Moid=json_data.get("Moid"),
            Name=json_data.get("Name"),
            NodeNamePrefix=json_data.get("NodeNamePrefix"),
...
@dataclass
class DataIpRangeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DataIpRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DataIpRangeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DataIpRangeDefinition = DataIpRangeDefinition


@dataclass
class HxdpIpRangeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    EndAddr: Optional[str]
    Gateway: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_HxdpIpRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_HxdpIpRangeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_HxdpIpRangeDefinition = HxdpIpRangeDefinition


@dataclass
class HypervisorControlIpRangeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    EndAddr: Optional[str]
    Gateway: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_HypervisorControlIpRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_HypervisorControlIpRangeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_HypervisorControlIpRangeDefinition = HypervisorControlIpRangeDefinition


@dataclass
class MgmtIpRangeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    EndAddr: Optional[str]
    Gateway: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MgmtIpRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MgmtIpRangeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_MgmtIpRangeDefinition = MgmtIpRangeDefinition
