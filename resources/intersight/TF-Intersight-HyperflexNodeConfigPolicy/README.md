...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexnodeconfigpolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexnodeconfigpolicy/handlers.py`
