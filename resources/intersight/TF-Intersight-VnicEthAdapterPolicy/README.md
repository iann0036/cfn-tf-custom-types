...
1. Write the JSON schema describing your resource, `tf-intersight-vnicethadapterpolicy.json`
2. Implement your resource handlers in `tf_intersight_vnicethadapterpolicy/handlers.py`
