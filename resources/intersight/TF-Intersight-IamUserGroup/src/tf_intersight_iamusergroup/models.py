...
class ResourceModel(BaseModel):
    ...
    Qualifier: Optional[Sequence["_QualifierDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Qualifier=deserialize_list(json_data.get("Qualifier"), QualifierDefinition),
...
class QualifierDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_QualifierDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_QualifierDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_QualifierDefinition = QualifierDefinition
