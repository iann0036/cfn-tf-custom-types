...
1. Write the JSON schema describing your resource, `tf-intersight-iamusergroup.json`
2. Implement your resource handlers in `tf_intersight_iamusergroup/handlers.py`
