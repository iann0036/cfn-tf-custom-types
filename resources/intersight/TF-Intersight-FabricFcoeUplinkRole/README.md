...
1. Write the JSON schema describing your resource, `tf-intersight-fabricfcoeuplinkrole.json`
2. Implement your resource handlers in `tf_intersight_fabricfcoeuplinkrole/handlers.py`
