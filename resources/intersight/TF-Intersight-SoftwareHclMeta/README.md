# TF::Intersight::SoftwareHclMeta

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-softwarehclmeta.json`
2. Implement your resource handlers in `tf_intersight_softwarehclmeta/handlers.py`
