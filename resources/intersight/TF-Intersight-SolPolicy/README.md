# TF::Intersight::SolPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-solpolicy.json`
2. Implement your resource handlers in `tf_intersight_solpolicy/handlers.py`
