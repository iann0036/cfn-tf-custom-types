...
1. Write the JSON schema describing your resource, `tf-intersight-fabricpcoperation.json`
2. Implement your resource handlers in `tf_intersight_fabricpcoperation/handlers.py`
