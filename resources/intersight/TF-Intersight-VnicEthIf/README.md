...
1. Write the JSON schema describing your resource, `tf-intersight-vnicethif.json`
2. Implement your resource handlers in `tf_intersight_vnicethif/handlers.py`
