...
1. Write the JSON schema describing your resource, `tf-intersight-memorypersistentmemorypolicy.json`
2. Implement your resource handlers in `tf_intersight_memorypersistentmemorypolicy/handlers.py`
