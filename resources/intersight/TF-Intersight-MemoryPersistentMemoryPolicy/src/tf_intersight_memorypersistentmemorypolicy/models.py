...
class ResourceModel(BaseModel):
    ...
    Goals: Optional[Sequence["_GoalsDefinition"]]
    Id: Optional[str]
    LocalSecurity: Optional[Sequence["_LocalSecurityDefinition"]]
    LogicalNamespaces: Optional[Sequence["_LogicalNamespacesDefinition"]]
    ...
    RetainNamespaces: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Goals=deserialize_list(json_data.get("Goals"), GoalsDefinition),
            Id=json_data.get("Id"),
            LocalSecurity=deserialize_list(json_data.get("LocalSecurity"), LocalSecurityDefinition),
            LogicalNamespaces=deserialize_list(json_data.get("LogicalNamespaces"), LogicalNamespacesDefinition),
            ManagementMode=json_data.get("ManagementMode"),
            ...
            RetainNamespaces=json_data.get("RetainNamespaces"),
...
@dataclass
class GoalsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    MemoryModePercentage: Optional[float]
    ObjectType: Optional[str]
    PersistentMemoryType: Optional[str]
    SocketId: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_GoalsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_GoalsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            MemoryModePercentage=json_data.get("MemoryModePercentage"),
            ObjectType=json_data.get("ObjectType"),
            PersistentMemoryType=json_data.get("PersistentMemoryType"),
            SocketId=json_data.get("SocketId"),
        )


# work around possible type aliasing issues when variable has same name as a model
_GoalsDefinition = GoalsDefinition


@dataclass
class LocalSecurityDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Enabled: Optional[bool]
    IsSecurePassphraseSet: Optional[bool]
    ObjectType: Optional[str]
    SecurePassphrase: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_LocalSecurityDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LocalSecurityDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            IsSecurePassphraseSet=json_data.get("IsSecurePassphraseSet"),
            ObjectType=json_data.get("ObjectType"),
            SecurePassphrase=json_data.get("SecurePassphrase"),
        )


# work around possible type aliasing issues when variable has same name as a model
_LocalSecurityDefinition = LocalSecurityDefinition


@dataclass
class LogicalNamespacesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ...
    Name: Optional[str]
    ObjectType: Optional[str]
    SocketId: Optional[float]
    SocketMemoryId: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_LogicalNamespacesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LogicalNamespacesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ObjectType=json_data.get("ObjectType"),
            SocketId=json_data.get("SocketId"),
            SocketMemoryId=json_data.get("SocketMemoryId"),
        )


# work around possible type aliasing issues when variable has same name as a model
_LogicalNamespacesDefinition = LogicalNamespacesDefinition
