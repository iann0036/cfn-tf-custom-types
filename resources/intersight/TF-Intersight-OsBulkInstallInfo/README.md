...
1. Write the JSON schema describing your resource, `tf-intersight-osbulkinstallinfo.json`
2. Implement your resource handlers in `tf_intersight_osbulkinstallinfo/handlers.py`
