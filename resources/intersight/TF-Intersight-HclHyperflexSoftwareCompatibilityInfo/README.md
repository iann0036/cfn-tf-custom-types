...
1. Write the JSON schema describing your resource, `tf-intersight-hclhyperflexsoftwarecompatibilityinfo.json`
2. Implement your resource handlers in `tf_intersight_hclhyperflexsoftwarecompatibilityinfo/handlers.py`
