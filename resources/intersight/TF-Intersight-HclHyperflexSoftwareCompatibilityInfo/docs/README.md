# TF::Intersight::HclHyperflexSoftwareCompatibilityInfo
...
<pre>
{
    "Type" : "TF::Intersight::HclHyperflexSoftwareCompatibilityInfo",
    "Properties" : {
        ...
        "<a href="#serverfwversion" title="ServerFwVersion">ServerFwVersion</a>" : <i>String</i>,
