...
1. Write the JSON schema describing your resource, `tf-intersight-virtualizationvirtualdisk.json`
2. Implement your resource handlers in `tf_intersight_virtualizationvirtualdisk/handlers.py`
