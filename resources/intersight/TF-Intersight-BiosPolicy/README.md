...
1. Write the JSON schema describing your resource, `tf-intersight-biospolicy.json`
2. Implement your resource handlers in `tf_intersight_biospolicy/handlers.py`
