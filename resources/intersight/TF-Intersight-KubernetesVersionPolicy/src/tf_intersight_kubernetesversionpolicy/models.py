...
class ResourceModel(BaseModel):
    ...
    Moid: Optional[str]
    Name: Optional[str]
    NrVersion: Optional[Sequence["_NrVersionDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            NrVersion=deserialize_list(json_data.get("NrVersion"), NrVersionDefinition),
...
@dataclass
class NrVersionDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_NrVersionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_NrVersionDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_NrVersionDefinition = NrVersionDefinition
