# TF::Intersight::KubernetesVersionPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-kubernetesversionpolicy.json`
2. Implement your resource handlers in `tf_intersight_kubernetesversionpolicy/handlers.py`
