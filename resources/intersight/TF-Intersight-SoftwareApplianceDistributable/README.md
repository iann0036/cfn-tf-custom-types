...
1. Write the JSON schema describing your resource, `tf-intersight-softwareappliancedistributable.json`
2. Implement your resource handlers in `tf_intersight_softwareappliancedistributable/handlers.py`
