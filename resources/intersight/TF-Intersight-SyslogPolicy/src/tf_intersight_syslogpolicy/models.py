...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    LocalClients: Optional[Sequence["_LocalClientsDefinition"]]
    ...
    RemoteClients: Optional[Sequence["_RemoteClientsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            LocalClients=deserialize_list(json_data.get("LocalClients"), LocalClientsDefinition),
            ...
            RemoteClients=deserialize_list(json_data.get("RemoteClients"), RemoteClientsDefinition),
...
@dataclass
class LocalClientsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_LocalClientsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LocalClientsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_LocalClientsDefinition = LocalClientsDefinition
...
@dataclass
class RemoteClientsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_RemoteClientsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RemoteClientsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_RemoteClientsDefinition = RemoteClientsDefinition
