...
1. Write the JSON schema describing your resource, `tf-intersight-syslogpolicy.json`
2. Implement your resource handlers in `tf_intersight_syslogpolicy/handlers.py`
