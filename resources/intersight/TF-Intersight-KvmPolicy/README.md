...
1. Write the JSON schema describing your resource, `tf-intersight-kvmpolicy.json`
2. Implement your resource handlers in `tf_intersight_kvmpolicy/handlers.py`
