...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#enablelocalservervideo" title="EnableLocalServerVideo">EnableLocalServerVideo</a>" : <i>Boolean</i>,
        "<a href="#enablevideoencryption" title="EnableVideoEncryption">EnableVideoEncryption</a>" : <i>Boolean</i>,
        "<a href="#enabled" title="Enabled">Enabled</a>" : <i>Boolean</i>,
        "<a href="#maximumsessions" title="MaximumSessions">MaximumSessions</a>" : <i>Double</i>,
