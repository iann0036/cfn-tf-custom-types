...
class ResourceModel(BaseModel):
    ...
    EnableLocalServerVideo: Optional[bool]
    EnableVideoEncryption: Optional[bool]
    Enabled: Optional[bool]
    Id: Optional[str]
    MaximumSessions: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EnableLocalServerVideo=json_data.get("EnableLocalServerVideo"),
            EnableVideoEncryption=json_data.get("EnableVideoEncryption"),
            Enabled=json_data.get("Enabled"),
            Id=json_data.get("Id"),
            MaximumSessions=json_data.get("MaximumSessions"),
