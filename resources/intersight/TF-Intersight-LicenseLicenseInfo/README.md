...
1. Write the JSON schema describing your resource, `tf-intersight-licenselicenseinfo.json`
2. Implement your resource handlers in `tf_intersight_licenselicenseinfo/handlers.py`
