...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AccountLicenseData=deserialize_list(json_data.get("AccountLicenseData"), AccountLicenseDataDefinition),
            AccountMoid=json_data.get("AccountMoid"),
            ActiveAdmin=json_data.get("ActiveAdmin"),
            ...
            DaysLeft=json_data.get("DaysLeft"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            EndTime=json_data.get("EndTime"),
            EnforceMode=json_data.get("EnforceMode"),
            ErrorDesc=json_data.get("ErrorDesc"),
            EvaluationPeriod=json_data.get("EvaluationPeriod"),
            ExtraEvaluation=json_data.get("ExtraEvaluation"),
            Id=json_data.get("Id"),
            LicenseCount=json_data.get("LicenseCount"),
            LicenseState=json_data.get("LicenseState"),
            ...
            TrialAdmin=json_data.get("TrialAdmin"),
...
@dataclass
class AccountLicenseDataDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AccountLicenseDataDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AccountLicenseDataDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AccountLicenseDataDefinition = AccountLicenseDataDefinition
