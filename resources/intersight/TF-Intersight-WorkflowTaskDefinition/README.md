...
1. Write the JSON schema describing your resource, `tf-intersight-workflowtaskdefinition.json`
2. Implement your resource handlers in `tf_intersight_workflowtaskdefinition/handlers.py`
