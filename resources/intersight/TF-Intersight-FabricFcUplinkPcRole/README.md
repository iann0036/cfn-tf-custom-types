...
1. Write the JSON schema describing your resource, `tf-intersight-fabricfcuplinkpcrole.json`
2. Implement your resource handlers in `tf_intersight_fabricfcuplinkpcrole/handlers.py`
