...
class ResourceModel(BaseModel):
    ...
    DistributionComponents: Optional[Sequence["_DistributionComponentsDefinition"]]
    ...
    SoftwareDistributionEntry: Optional[Sequence["_SoftwareDistributionEntryDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DistributionComponents=deserialize_list(json_data.get("DistributionComponents"), DistributionComponentsDefinition),
            ...
            SoftwareDistributionEntry=deserialize_list(json_data.get("SoftwareDistributionEntry"), SoftwareDistributionEntryDefinition),
...
@dataclass
class DistributionComponentsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DistributionComponentsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DistributionComponentsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DistributionComponentsDefinition = DistributionComponentsDefinition
...
@dataclass
class SoftwareDistributionEntryDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SoftwareDistributionEntryDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SoftwareDistributionEntryDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SoftwareDistributionEntryDefinition = SoftwareDistributionEntryDefinition
