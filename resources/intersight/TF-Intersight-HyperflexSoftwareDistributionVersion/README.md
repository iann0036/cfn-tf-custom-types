...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexsoftwaredistributionversion.json`
2. Implement your resource handlers in `tf_intersight_hyperflexsoftwaredistributionversion/handlers.py`
