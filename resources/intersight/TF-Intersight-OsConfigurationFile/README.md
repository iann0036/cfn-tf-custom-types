...
1. Write the JSON schema describing your resource, `tf-intersight-osconfigurationfile.json`
2. Implement your resource handlers in `tf_intersight_osconfigurationfile/handlers.py`
