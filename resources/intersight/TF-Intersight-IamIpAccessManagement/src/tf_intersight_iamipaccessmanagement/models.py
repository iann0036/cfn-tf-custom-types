...
class ResourceModel(BaseModel):
    ...
    Holder: Optional[Sequence["_HolderDefinition"]]
    Id: Optional[str]
    IpAddresses: Optional[Sequence["_IpAddressesDefinition"]]
    LastRecoveryTime: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Holder=deserialize_list(json_data.get("Holder"), HolderDefinition),
            Id=json_data.get("Id"),
            IpAddresses=deserialize_list(json_data.get("IpAddresses"), IpAddressesDefinition),
            LastRecoveryTime=json_data.get("LastRecoveryTime"),
...
@dataclass
class HolderDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_HolderDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_HolderDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_HolderDefinition = HolderDefinition
