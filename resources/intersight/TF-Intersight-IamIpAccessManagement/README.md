...
1. Write the JSON schema describing your resource, `tf-intersight-iamipaccessmanagement.json`
2. Implement your resource handlers in `tf_intersight_iamipaccessmanagement/handlers.py`
