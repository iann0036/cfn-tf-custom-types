...
class ResourceModel(BaseModel):
    ...
    FilesToDownload: Optional[Sequence[str]]
    Id: Optional[str]
    ...
    SoftwareDistributionVersion: Optional[Sequence["_SoftwareDistributionVersionDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FilesToDownload=json_data.get("FilesToDownload"),
            Id=json_data.get("Id"),
            ...
            SoftwareDistributionVersion=deserialize_list(json_data.get("SoftwareDistributionVersion"), SoftwareDistributionVersionDefinition),
...
@dataclass
class SoftwareDistributionVersionDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SoftwareDistributionVersionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SoftwareDistributionVersionDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SoftwareDistributionVersionDefinition = SoftwareDistributionVersionDefinition
