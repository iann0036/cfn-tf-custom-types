...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexsoftwaredistributioncomponent.json`
2. Implement your resource handlers in `tf_intersight_hyperflexsoftwaredistributioncomponent/handlers.py`
