...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesaddonpolicy.json`
2. Implement your resource handlers in `tf_intersight_kubernetesaddonpolicy/handlers.py`
