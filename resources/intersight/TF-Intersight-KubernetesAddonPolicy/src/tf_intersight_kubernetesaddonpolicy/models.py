...
class ResourceModel(BaseModel):
    ...
    AddonConfiguration: Optional[Sequence["_AddonConfigurationDefinition2"]]
    AddonDefinition: Optional[Sequence["_AddonDefinitionDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AddonConfiguration=deserialize_list(json_data.get("AddonConfiguration"), AddonConfigurationDefinition2),
            AddonDefinition=deserialize_list(json_data.get("AddonDefinition"), AddonDefinitionDefinition),
...
@dataclass
class AddonConfigurationDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    InstallStrategy: Optional[str]
    ObjectType: Optional[str]
    OverrideSets: Optional[Sequence["_AddonConfigurationDefinition"]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddonConfigurationDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddonConfigurationDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ObjectType=json_data.get("ObjectType"),
            OverrideSets=deserialize_list(json_data.get("OverrideSets"), AddonConfigurationDefinition),
...
# work around possible type aliasing issues when variable has same name as a model
_AddonConfigurationDefinition2 = AddonConfigurationDefinition2


@dataclass
class AddonConfigurationDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Key: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddonConfigurationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddonConfigurationDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AddonConfigurationDefinition = AddonConfigurationDefinition


@dataclass
class AddonDefinitionDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddonDefinitionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddonDefinitionDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AddonDefinitionDefinition = AddonDefinitionDefinition
