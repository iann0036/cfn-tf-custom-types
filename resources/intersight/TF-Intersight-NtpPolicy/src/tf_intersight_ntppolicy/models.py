...
class ResourceModel(BaseModel):
    ...
    AuthenticatedNtpServers: Optional[Sequence["_AuthenticatedNtpServersDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AuthenticatedNtpServers=deserialize_list(json_data.get("AuthenticatedNtpServers"), AuthenticatedNtpServersDefinition),
...
@dataclass
class AuthenticatedNtpServersDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    KeyType: Optional[str]
    ObjectType: Optional[str]
    ServerName: Optional[str]
    SymKeyId: Optional[float]
    SymKeyValue: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AuthenticatedNtpServersDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AuthenticatedNtpServersDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            SymKeyId=json_data.get("SymKeyId"),
            SymKeyValue=json_data.get("SymKeyValue"),
        )


# work around possible type aliasing issues when variable has same name as a model
_AuthenticatedNtpServersDefinition = AuthenticatedNtpServersDefinition
