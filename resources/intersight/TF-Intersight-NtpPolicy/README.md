...
1. Write the JSON schema describing your resource, `tf-intersight-ntppolicy.json`
2. Implement your resource handlers in `tf_intersight_ntppolicy/handlers.py`
