...
class ResourceModel(BaseModel):
    ...
    AutoAllowOnUplinks: Optional[bool]
    ...
    Moid: Optional[str]
    MulticastPolicy: Optional[Sequence["_MulticastPolicyDefinition"]]
    Name: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AutoAllowOnUplinks=json_data.get("AutoAllowOnUplinks"),
            ...
            MulticastPolicy=deserialize_list(json_data.get("MulticastPolicy"), MulticastPolicyDefinition),
...
@dataclass
class MulticastPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MulticastPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MulticastPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_MulticastPolicyDefinition = MulticastPolicyDefinition
