...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#autoallowonuplinks" title="AutoAllowOnUplinks">AutoAllowOnUplinks</a>" : <i>Boolean</i>,
        ...
        "<a href="#isnative" title="IsNative">IsNative</a>" : <i>Boolean</i>,
        "<a href="#modtime" title="ModTime">ModTime</a>" : <i>String</i>,
        "<a href="#moid" title="Moid">Moid</a>" : <i>String</i>,
        "<a href="#multicastpolicy" title="MulticastPolicy">MulticastPolicy</a>" : <i>[ <a href="multicastpolicydefinition.md">MulticastPolicyDefinition</a>, ... ]</i>,
...
Properties:
    ...
    <a href="#modtime" title="ModTime">ModTime</a>: <i>String</i>
    <a href="#moid" title="Moid">Moid</a>: <i>String</i>
    <a href="#multicastpolicy" title="MulticastPolicy">MulticastPolicy</a>: <i>
      - <a href="multicastpolicydefinition.md">MulticastPolicyDefinition</a></i>
    <a href="#name" title="Name">Name</a>: <i>String</i>
    <a href="#objecttype" title="ObjectType">ObjectType</a>: <i>String</i>
...
_Type_: List of <a href="multicastpolicydefinition.md">MulticastPolicyDefinition</a>
