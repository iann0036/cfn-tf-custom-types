...
1. Write the JSON schema describing your resource, `tf-intersight-fabricvlan.json`
2. Implement your resource handlers in `tf_intersight_fabricvlan/handlers.py`
