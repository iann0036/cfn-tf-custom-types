# TF::Intersight::FirmwareEula

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-firmwareeula.json`
2. Implement your resource handlers in `tf_intersight_firmwareeula/handlers.py`
