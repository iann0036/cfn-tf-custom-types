...
class ResourceModel(BaseModel):
    ...
    ImportSource: Optional[str]
    ImportedItems: Optional[Sequence["_ImportedItemsDefinition"]]
    ...
    SkipIntegrityChecks: Optional[bool]
    Status: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ImportSource=json_data.get("ImportSource"),
            ImportedItems=deserialize_list(json_data.get("ImportedItems"), ImportedItemsDefinition),
            ...
            SkipIntegrityChecks=json_data.get("SkipIntegrityChecks"),
...
@dataclass
class ImportedItemsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ImportedItemsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ImportedItemsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ImportedItemsDefinition = ImportedItemsDefinition
