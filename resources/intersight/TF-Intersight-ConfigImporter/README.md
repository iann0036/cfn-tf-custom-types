...
1. Write the JSON schema describing your resource, `tf-intersight-configimporter.json`
2. Implement your resource handlers in `tf_intersight_configimporter/handlers.py`
