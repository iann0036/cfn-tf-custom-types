...
class ResourceModel(BaseModel):
    ...
    EndPointRoles: Optional[Sequence["_EndPointRolesDefinition"]]
    Id: Optional[str]
    ...
    PrivilegeSets: Optional[Sequence["_PrivilegeSetsDefinition"]]
    ResourceRoles: Optional[Sequence["_ResourceRolesDefinition"]]
    Roles: Optional[Sequence["_RolesDefinition"]]
    SessionLimits: Optional[Sequence["_SessionLimitsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EndPointRoles=deserialize_list(json_data.get("EndPointRoles"), EndPointRolesDefinition),
            Id=json_data.get("Id"),
            ...
            PrivilegeSets=deserialize_list(json_data.get("PrivilegeSets"), PrivilegeSetsDefinition),
            ResourceRoles=deserialize_list(json_data.get("ResourceRoles"), ResourceRolesDefinition),
            Roles=deserialize_list(json_data.get("Roles"), RolesDefinition),
            SessionLimits=deserialize_list(json_data.get("SessionLimits"), SessionLimitsDefinition),
...
@dataclass
class EndPointRolesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EndPointRolesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EndPointRolesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EndPointRolesDefinition = EndPointRolesDefinition
...
@dataclass
class PrivilegeSetsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_PrivilegeSetsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PrivilegeSetsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_PrivilegeSetsDefinition = PrivilegeSetsDefinition


@dataclass
class ResourceRolesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ResourceRolesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ResourceRolesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ResourceRolesDefinition = ResourceRolesDefinition
...
@dataclass
class SessionLimitsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SessionLimitsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SessionLimitsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SessionLimitsDefinition = SessionLimitsDefinition
