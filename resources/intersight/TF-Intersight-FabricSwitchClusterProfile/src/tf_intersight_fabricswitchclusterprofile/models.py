...
class ResourceModel(BaseModel):
    ...
    SwitchProfiles: Optional[Sequence["_SwitchProfilesDefinition"]]
    SwitchProfilesCount: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SwitchProfiles=deserialize_list(json_data.get("SwitchProfiles"), SwitchProfilesDefinition),
            SwitchProfilesCount=json_data.get("SwitchProfilesCount"),
...
@dataclass
class SwitchProfilesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SwitchProfilesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SwitchProfilesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SwitchProfilesDefinition = SwitchProfilesDefinition
