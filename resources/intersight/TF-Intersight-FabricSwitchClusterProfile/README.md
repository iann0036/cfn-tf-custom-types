...
1. Write the JSON schema describing your resource, `tf-intersight-fabricswitchclusterprofile.json`
2. Implement your resource handlers in `tf_intersight_fabricswitchclusterprofile/handlers.py`
