...
class ResourceModel(BaseModel):
    ...
    ConstraintId: Optional[str]
    CreateTime: Optional[str]
    DomainGroupMoid: Optional[str]
    FilteredModels: Optional[Sequence["_FilteredModelsDefinition"]]
    Id: Optional[str]
    MdfId: Optional[str]
    ...
    ParseFromImageName: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ConstraintId=json_data.get("ConstraintId"),
            CreateTime=json_data.get("CreateTime"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            FilteredModels=deserialize_list(json_data.get("FilteredModels"), FilteredModelsDefinition),
            Id=json_data.get("Id"),
            ...
            ParseFromImageName=json_data.get("ParseFromImageName"),
...
@dataclass
class FilteredModelsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    MinVersion: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    PlatformRegex: Optional[str]
    SupportedModels: Optional[Sequence[str]]

    @classmethod
    def _deserialize(
        cls: Type["_FilteredModelsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FilteredModelsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            Name=json_data.get("Name"),
            ObjectType=json_data.get("ObjectType"),
            PlatformRegex=json_data.get("PlatformRegex"),
            SupportedModels=json_data.get("SupportedModels"),
        )


# work around possible type aliasing issues when variable has same name as a model
_FilteredModelsDefinition = FilteredModelsDefinition
