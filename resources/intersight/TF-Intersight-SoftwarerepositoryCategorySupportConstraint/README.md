# TF::Intersight::SoftwarerepositoryCategorySupportConstraint

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-softwarerepositorycategorysupportconstraint.json`
2. Implement your resource handlers in `tf_intersight_softwarerepositorycategorysupportconstraint/handlers.py`
