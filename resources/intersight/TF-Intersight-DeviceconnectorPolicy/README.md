# TF::Intersight::DeviceconnectorPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-deviceconnectorpolicy.json`
2. Implement your resource handlers in `tf_intersight_deviceconnectorpolicy/handlers.py`
