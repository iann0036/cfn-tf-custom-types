# TF::Intersight::SoftwarerepositoryCategoryMapperModel
...
<pre>
{
    "Type" : "TF::Intersight::SoftwarerepositoryCategoryMapperModel",
    "Properties" : {
        ...
        "<a href="#disttag" title="DistTag">DistTag</a>" : <i>String</i>,
        ...
        "<a href="#seriesid" title="SeriesId">SeriesId</a>" : <i>String</i>,
