...
1. Write the JSON schema describing your resource, `tf-intersight-softwarerepositorycategorymappermodel.json`
2. Implement your resource handlers in `tf_intersight_softwarerepositorycategorymappermodel/handlers.py`
