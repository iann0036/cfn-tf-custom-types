...
1. Write the JSON schema describing your resource, `tf-intersight-iamresourceroles.json`
2. Implement your resource handlers in `tf_intersight_iamresourceroles/handlers.py`
