...
class ResourceModel(BaseModel):
    ...
    Resource: Optional[Sequence["_ResourceDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Resource=deserialize_list(json_data.get("Resource"), ResourceDefinition),
...
class ResourceDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ResourceDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ResourceDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
