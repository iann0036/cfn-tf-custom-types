...
1. Write the JSON schema describing your resource, `tf-intersight-macpoolpool.json`
2. Implement your resource handlers in `tf_intersight_macpoolpool/handlers.py`
