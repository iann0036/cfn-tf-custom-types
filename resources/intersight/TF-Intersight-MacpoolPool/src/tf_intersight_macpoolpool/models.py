...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    MacBlocks: Optional[Sequence["_MacBlocksDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            MacBlocks=deserialize_list(json_data.get("MacBlocks"), MacBlocksDefinition),
...
@dataclass
class MacBlocksDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    From: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MacBlocksDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MacBlocksDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_MacBlocksDefinition = MacBlocksDefinition
