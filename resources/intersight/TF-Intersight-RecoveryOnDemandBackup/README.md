...
1. Write the JSON schema describing your resource, `tf-intersight-recoveryondemandbackup.json`
2. Implement your resource handlers in `tf_intersight_recoveryondemandbackup/handlers.py`
