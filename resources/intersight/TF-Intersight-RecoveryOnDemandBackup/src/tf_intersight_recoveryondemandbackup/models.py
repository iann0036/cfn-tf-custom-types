...
class ResourceModel(BaseModel):
    ...
    DeviceId: Optional[Sequence["_DeviceIdDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DeviceId=deserialize_list(json_data.get("DeviceId"), DeviceIdDefinition),
...
@dataclass
class DeviceIdDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DeviceIdDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DeviceIdDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DeviceIdDefinition = DeviceIdDefinition
