...
class ResourceModel(BaseModel):
    ...
    FirstIndex: Optional[float]
    Height: Optional[float]
    HorizontalStartOffset: Optional[float]
    Id: Optional[str]
    InlineGroupSeparation: Optional[float]
    InlineGroupSize: Optional[float]
    InlineOffset: Optional[float]
    Location: Optional[str]
    ModTime: Optional[str]
    Moid: Optional[str]
    Name: Optional[str]
    NumberOfSlots: Optional[float]
    ...
    Sku: Optional[str]
    SlotsPerLine: Optional[float]
    Tags: Optional[Sequence["_TagsDefinition"]]
    TransverseGroupSeparation: Optional[float]
    TransverseGroupSize: Optional[float]
    TransverseOffset: Optional[float]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    VerticalStartOffset: Optional[float]
    Vid: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            FirstIndex=json_data.get("FirstIndex"),
            Height=json_data.get("Height"),
            HorizontalStartOffset=json_data.get("HorizontalStartOffset"),
            Id=json_data.get("Id"),
            InlineGroupSeparation=json_data.get("InlineGroupSeparation"),
            InlineGroupSize=json_data.get("InlineGroupSize"),
            InlineOffset=json_data.get("InlineOffset"),
            Location=json_data.get("Location"),
            ModTime=json_data.get("ModTime"),
            Moid=json_data.get("Moid"),
            Name=json_data.get("Name"),
            NumberOfSlots=json_data.get("NumberOfSlots"),
            ...
            SlotsPerLine=json_data.get("SlotsPerLine"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            TransverseGroupSeparation=json_data.get("TransverseGroupSeparation"),
            TransverseGroupSize=json_data.get("TransverseGroupSize"),
            TransverseOffset=json_data.get("TransverseOffset"),
            VersionContext=deserialize_list(json_data.get("VersionContext"), VersionContextDefinition3),
            VerticalStartOffset=json_data.get("VerticalStartOffset"),
