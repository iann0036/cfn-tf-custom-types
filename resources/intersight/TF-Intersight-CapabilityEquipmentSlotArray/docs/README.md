...
<pre>
{
    "Type" : "TF::Intersight::CapabilityEquipmentSlotArray",
    "Properties" : {
        ...
        "<a href="#firstindex" title="FirstIndex">FirstIndex</a>" : <i>Double</i>,
        "<a href="#height" title="Height">Height</a>" : <i>Double</i>,
        "<a href="#horizontalstartoffset" title="HorizontalStartOffset">HorizontalStartOffset</a>" : <i>Double</i>,
        "<a href="#inlinegroupseparation" title="InlineGroupSeparation">InlineGroupSeparation</a>" : <i>Double</i>,
        "<a href="#inlinegroupsize" title="InlineGroupSize">InlineGroupSize</a>" : <i>Double</i>,
        "<a href="#inlineoffset" title="InlineOffset">InlineOffset</a>" : <i>Double</i>,
        "<a href="#location" title="Location">Location</a>" : <i>String</i>,
        "<a href="#modtime" title="ModTime">ModTime</a>" : <i>String</i>,
        "<a href="#moid" title="Moid">Moid</a>" : <i>String</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#numberofslots" title="NumberOfSlots">NumberOfSlots</a>" : <i>Double</i>,
        ...
        "<a href="#slotsperline" title="SlotsPerLine">SlotsPerLine</a>" : <i>Double</i>,
        "<a href="#tags" title="Tags">Tags</a>" : <i>[ <a href="tagsdefinition.md">TagsDefinition</a>, ... ]</i>,
        "<a href="#transversegroupseparation" title="TransverseGroupSeparation">TransverseGroupSeparation</a>" : <i>Double</i>,
        "<a href="#transversegroupsize" title="TransverseGroupSize">TransverseGroupSize</a>" : <i>Double</i>,
        "<a href="#transverseoffset" title="TransverseOffset">TransverseOffset</a>" : <i>Double</i>,
        ...
        "<a href="#verticalstartoffset" title="VerticalStartOffset">VerticalStartOffset</a>" : <i>Double</i>,
