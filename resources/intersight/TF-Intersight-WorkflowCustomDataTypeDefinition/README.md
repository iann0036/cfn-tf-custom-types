...
1. Write the JSON schema describing your resource, `tf-intersight-workflowcustomdatatypedefinition.json`
2. Implement your resource handlers in `tf_intersight_workflowcustomdatatypedefinition/handlers.py`
