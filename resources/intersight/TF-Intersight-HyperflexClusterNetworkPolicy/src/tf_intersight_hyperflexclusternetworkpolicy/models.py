...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    JumboFrame: Optional[bool]
    KvmIpRange: Optional[Sequence["_KvmIpRangeDefinition"]]
    MacPrefixRange: Optional[Sequence["_MacPrefixRangeDefinition"]]
    MgmtVlan: Optional[Sequence["_MgmtVlanDefinition"]]
    ...
    UplinkSpeed: Optional[str]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    VmMigrationVlan: Optional[Sequence["_VmMigrationVlanDefinition"]]
    VmNetworkVlans: Optional[Sequence["_VmNetworkVlansDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            JumboFrame=json_data.get("JumboFrame"),
            KvmIpRange=deserialize_list(json_data.get("KvmIpRange"), KvmIpRangeDefinition),
            MacPrefixRange=deserialize_list(json_data.get("MacPrefixRange"), MacPrefixRangeDefinition),
            MgmtVlan=deserialize_list(json_data.get("MgmtVlan"), MgmtVlanDefinition),
            ...
            UplinkSpeed=json_data.get("UplinkSpeed"),
            VersionContext=deserialize_list(json_data.get("VersionContext"), VersionContextDefinition3),
            VmMigrationVlan=deserialize_list(json_data.get("VmMigrationVlan"), VmMigrationVlanDefinition),
            VmNetworkVlans=deserialize_list(json_data.get("VmNetworkVlans"), VmNetworkVlansDefinition),
        )
...
@dataclass
class KvmIpRangeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_KvmIpRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_KvmIpRangeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_KvmIpRangeDefinition = KvmIpRangeDefinition


@dataclass
class MacPrefixRangeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    EndAddr: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MacPrefixRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MacPrefixRangeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_MacPrefixRangeDefinition = MacPrefixRangeDefinition


@dataclass
class MgmtVlanDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MgmtVlanDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MgmtVlanDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_MgmtVlanDefinition = MgmtVlanDefinition
...
@dataclass
class VmMigrationVlanDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VmMigrationVlanDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VmMigrationVlanDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_VmMigrationVlanDefinition = VmMigrationVlanDefinition


@dataclass
class VmNetworkVlansDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Name: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VmNetworkVlansDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VmNetworkVlansDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_VmNetworkVlansDefinition = VmNetworkVlansDefinition
