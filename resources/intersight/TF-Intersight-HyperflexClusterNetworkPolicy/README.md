...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexclusternetworkpolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexclusternetworkpolicy/handlers.py`
