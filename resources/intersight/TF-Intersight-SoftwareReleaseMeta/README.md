# TF::Intersight::SoftwareReleaseMeta

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-softwarereleasemeta.json`
2. Implement your resource handlers in `tf_intersight_softwarereleasemeta/handlers.py`
