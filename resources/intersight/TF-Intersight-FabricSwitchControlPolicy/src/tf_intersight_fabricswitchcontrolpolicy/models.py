...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    MacAgingSettings: Optional[Sequence["_MacAgingSettingsDefinition"]]
    ...
    UdldSettings: Optional[Sequence["_UdldSettingsDefinition"]]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    VlanPortOptimizationEnabled: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            MacAgingSettings=deserialize_list(json_data.get("MacAgingSettings"), MacAgingSettingsDefinition),
            ...
            UdldSettings=deserialize_list(json_data.get("UdldSettings"), UdldSettingsDefinition),
            VersionContext=deserialize_list(json_data.get("VersionContext"), VersionContextDefinition3),
            VlanPortOptimizationEnabled=json_data.get("VlanPortOptimizationEnabled"),
        )
...
@dataclass
class MacAgingSettingsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    MacAgingOption: Optional[str]
    MacAgingTime: Optional[float]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_MacAgingSettingsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MacAgingSettingsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            MacAgingOption=json_data.get("MacAgingOption"),
            MacAgingTime=json_data.get("MacAgingTime"),
            ObjectType=json_data.get("ObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_MacAgingSettingsDefinition = MacAgingSettingsDefinition
...
@dataclass
class UdldSettingsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_UdldSettingsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_UdldSettingsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_UdldSettingsDefinition = UdldSettingsDefinition
