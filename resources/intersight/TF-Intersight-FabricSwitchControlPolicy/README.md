...
1. Write the JSON schema describing your resource, `tf-intersight-fabricswitchcontrolpolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricswitchcontrolpolicy/handlers.py`
