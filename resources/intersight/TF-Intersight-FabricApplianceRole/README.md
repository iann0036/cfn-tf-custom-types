...
1. Write the JSON schema describing your resource, `tf-intersight-fabricappliancerole.json`
2. Implement your resource handlers in `tf_intersight_fabricappliancerole/handlers.py`
