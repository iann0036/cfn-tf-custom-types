...
class ResourceModel(BaseModel):
    ...
    AdminSpeed: Optional[str]
    AggregatePortId: Optional[float]
    Ancestors: Optional[Sequence["_AncestorsDefinition"]]
    ClassId: Optional[str]
    CreateTime: Optional[str]
    DomainGroupMoid: Optional[str]
    EthNetworkControlPolicy: Optional[Sequence["_EthNetworkControlPolicyDefinition"]]
    EthNetworkGroupPolicy: Optional[Sequence["_EthNetworkGroupPolicyDefinition"]]
    Fec: Optional[str]
    FlowControlPolicy: Optional[Sequence["_FlowControlPolicyDefinition"]]
    Id: Optional[str]
    LinkControlPolicy: Optional[Sequence["_LinkControlPolicyDefinition"]]
    ...
    PortId: Optional[float]
    PortPolicy: Optional[Sequence["_PortPolicyDefinition"]]
    Priority: Optional[str]
    SharedScope: Optional[str]
    SlotId: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AdminSpeed=json_data.get("AdminSpeed"),
            AggregatePortId=json_data.get("AggregatePortId"),
            ...
            EthNetworkControlPolicy=deserialize_list(json_data.get("EthNetworkControlPolicy"), EthNetworkControlPolicyDefinition),
            EthNetworkGroupPolicy=deserialize_list(json_data.get("EthNetworkGroupPolicy"), EthNetworkGroupPolicyDefinition),
            Fec=json_data.get("Fec"),
            FlowControlPolicy=deserialize_list(json_data.get("FlowControlPolicy"), FlowControlPolicyDefinition),
            Id=json_data.get("Id"),
            LinkControlPolicy=deserialize_list(json_data.get("LinkControlPolicy"), LinkControlPolicyDefinition),
            ...
            PortPolicy=deserialize_list(json_data.get("PortPolicy"), PortPolicyDefinition),
            Priority=json_data.get("Priority"),
            SharedScope=json_data.get("SharedScope"),
            SlotId=json_data.get("SlotId"),
...
@dataclass
class EthNetworkControlPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EthNetworkControlPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EthNetworkControlPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EthNetworkControlPolicyDefinition = EthNetworkControlPolicyDefinition


@dataclass
class EthNetworkGroupPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_EthNetworkGroupPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_EthNetworkGroupPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_EthNetworkGroupPolicyDefinition = EthNetworkGroupPolicyDefinition


@dataclass
class FlowControlPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_FlowControlPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_FlowControlPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_FlowControlPolicyDefinition = FlowControlPolicyDefinition


@dataclass
class LinkControlPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_LinkControlPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LinkControlPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_LinkControlPolicyDefinition = LinkControlPolicyDefinition
...
@dataclass
class PortPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_PortPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PortPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_PortPolicyDefinition = PortPolicyDefinition
