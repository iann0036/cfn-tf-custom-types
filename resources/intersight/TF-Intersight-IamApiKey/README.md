# TF::Intersight::IamApiKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-iamapikey.json`
2. Implement your resource handlers in `tf_intersight_iamapikey/handlers.py`
