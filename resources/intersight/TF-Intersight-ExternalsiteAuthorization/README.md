# TF::Intersight::ExternalsiteAuthorization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-externalsiteauthorization.json`
2. Implement your resource handlers in `tf_intersight_externalsiteauthorization/handlers.py`
