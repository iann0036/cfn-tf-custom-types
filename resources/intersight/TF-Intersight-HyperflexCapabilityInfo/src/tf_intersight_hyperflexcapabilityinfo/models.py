...
class ResourceModel(BaseModel):
    ...
    CapabilityConstraints: Optional[Sequence["_CapabilityConstraintsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CapabilityConstraints=deserialize_list(json_data.get("CapabilityConstraints"), CapabilityConstraintsDefinition),
...
@dataclass
class CapabilityConstraintsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CapabilityConstraintsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CapabilityConstraintsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CapabilityConstraintsDefinition = CapabilityConstraintsDefinition
