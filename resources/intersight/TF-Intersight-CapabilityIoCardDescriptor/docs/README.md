...
<pre>
{
    "Type" : "TF::Intersight::CapabilityIoCardDescriptor",
    "Properties" : {
        ...
        "<a href="#numhifports" title="NumHifPorts">NumHifPorts</a>" : <i>Double</i>,
        ...
        "<a href="#uifconnectivity" title="UifConnectivity">UifConnectivity</a>" : <i>String</i>,
