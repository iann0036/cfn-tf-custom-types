...
1. Write the JSON schema describing your resource, `tf-intersight-iamcertificate.json`
2. Implement your resource handlers in `tf_intersight_iamcertificate/handlers.py`
