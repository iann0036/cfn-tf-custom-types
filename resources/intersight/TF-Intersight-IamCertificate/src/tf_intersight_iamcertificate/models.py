...
class ResourceModel(BaseModel):
    ...
    Certificate: Optional[Sequence["_CertificateDefinition3"]]
    CertificateRequest: Optional[Sequence["_CertificateRequestDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Certificate=deserialize_list(json_data.get("Certificate"), CertificateDefinition3),
            CertificateRequest=deserialize_list(json_data.get("CertificateRequest"), CertificateRequestDefinition),
...
@dataclass
class CertificateDefinition3(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Issuer: Optional[Sequence["_CertificateDefinition"]]
    ...
    Subject: Optional[Sequence["_CertificateDefinition2"]]

    @classmethod
    def _deserialize(
        cls: Type["_CertificateDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificateDefinition3"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Issuer=deserialize_list(json_data.get("Issuer"), CertificateDefinition),
            ...
            Subject=deserialize_list(json_data.get("Subject"), CertificateDefinition2),
        )


# work around possible type aliasing issues when variable has same name as a model
_CertificateDefinition3 = CertificateDefinition3
...
@dataclass
class CertificateDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    CommonName: Optional[str]
    Country: Optional[Sequence[str]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CertificateDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificateDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CertificateDefinition2 = CertificateDefinition2


@dataclass
class CertificateRequestDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CertificateRequestDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificateRequestDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CertificateRequestDefinition = CertificateRequestDefinition
