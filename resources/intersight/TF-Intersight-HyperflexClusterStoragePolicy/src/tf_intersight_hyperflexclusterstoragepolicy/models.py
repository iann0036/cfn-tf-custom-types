...
class ResourceModel(BaseModel):
    ...
    DiskPartitionCleanup: Optional[bool]
    DomainGroupMoid: Optional[str]
    Id: Optional[str]
    LogicalAvalabilityZoneConfig: Optional[Sequence["_LogicalAvalabilityZoneConfigDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DiskPartitionCleanup=json_data.get("DiskPartitionCleanup"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            Id=json_data.get("Id"),
            LogicalAvalabilityZoneConfig=deserialize_list(json_data.get("LogicalAvalabilityZoneConfig"), LogicalAvalabilityZoneConfigDefinition),
            ...
            VdiOptimization=json_data.get("VdiOptimization"),
...
@dataclass
class LogicalAvalabilityZoneConfigDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_LogicalAvalabilityZoneConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LogicalAvalabilityZoneConfigDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_LogicalAvalabilityZoneConfigDefinition = LogicalAvalabilityZoneConfigDefinition
