...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexclusterstoragepolicy.json`
2. Implement your resource handlers in `tf_intersight_hyperflexclusterstoragepolicy/handlers.py`
