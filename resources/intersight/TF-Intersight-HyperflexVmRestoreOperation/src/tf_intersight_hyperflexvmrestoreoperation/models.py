...
class ResourceModel(BaseModel):
    ...
    RestoreEdgeClusterMoid: Optional[Sequence["_RestoreEdgeClusterMoidDefinition"]]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    VersionContext: Optional[Sequence["_VersionContextDefinition3"]]
    VmBackupInfoMoid: Optional[Sequence["_VmBackupInfoMoidDefinition"]]
    VmSnapshotInfoMoid: Optional[Sequence["_VmSnapshotInfoMoidDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RestoreEdgeClusterMoid=deserialize_list(json_data.get("RestoreEdgeClusterMoid"), RestoreEdgeClusterMoidDefinition),
            ...
            VmBackupInfoMoid=deserialize_list(json_data.get("VmBackupInfoMoid"), VmBackupInfoMoidDefinition),
            VmSnapshotInfoMoid=deserialize_list(json_data.get("VmSnapshotInfoMoid"), VmSnapshotInfoMoidDefinition),
        )
...
@dataclass
class RestoreEdgeClusterMoidDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_RestoreEdgeClusterMoidDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RestoreEdgeClusterMoidDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_RestoreEdgeClusterMoidDefinition = RestoreEdgeClusterMoidDefinition
...
@dataclass
class VmBackupInfoMoidDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VmBackupInfoMoidDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VmBackupInfoMoidDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_VmBackupInfoMoidDefinition = VmBackupInfoMoidDefinition


@dataclass
class VmSnapshotInfoMoidDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_VmSnapshotInfoMoidDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VmSnapshotInfoMoidDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_VmSnapshotInfoMoidDefinition = VmSnapshotInfoMoidDefinition
