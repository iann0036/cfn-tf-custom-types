...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexvmrestoreoperation.json`
2. Implement your resource handlers in `tf_intersight_hyperflexvmrestoreoperation/handlers.py`
