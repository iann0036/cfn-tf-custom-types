...
1. Write the JSON schema describing your resource, `tf-intersight-iamcertificaterequest.json`
2. Implement your resource handlers in `tf_intersight_iamcertificaterequest/handlers.py`
