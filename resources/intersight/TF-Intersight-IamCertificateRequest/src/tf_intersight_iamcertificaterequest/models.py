...
class ResourceModel(BaseModel):
    ...
    PrivateKeySpec: Optional[Sequence["_PrivateKeySpecDefinition"]]
    Request: Optional[str]
    SelfSigned: Optional[bool]
    SharedScope: Optional[str]
    Subject: Optional[Sequence["_SubjectDefinition"]]
    SubjectAlternateName: Optional[Sequence["_SubjectAlternateNameDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PrivateKeySpec=deserialize_list(json_data.get("PrivateKeySpec"), PrivateKeySpecDefinition),
            ...
            SubjectAlternateName=deserialize_list(json_data.get("SubjectAlternateName"), SubjectAlternateNameDefinition),
...
@dataclass
class PrivateKeySpecDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_PrivateKeySpecDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PrivateKeySpecDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_PrivateKeySpecDefinition = PrivateKeySpecDefinition
...
@dataclass
class SubjectAlternateNameDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    DnsName: Optional[Sequence[str]]
    EmailAddress: Optional[Sequence[str]]
    IpAddress: Optional[Sequence[str]]
    ObjectType: Optional[str]
    Uri: Optional[Sequence[str]]

    @classmethod
    def _deserialize(
        cls: Type["_SubjectAlternateNameDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SubjectAlternateNameDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SubjectAlternateNameDefinition = SubjectAlternateNameDefinition
