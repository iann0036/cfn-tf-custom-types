...
1. Write the JSON schema describing your resource, `tf-intersight-vniciscsiadapterpolicy.json`
2. Implement your resource handlers in `tf_intersight_vniciscsiadapterpolicy/handlers.py`
