...
1. Write the JSON schema describing your resource, `tf-intersight-softwarerepositoryoperatingsystemfile.json`
2. Implement your resource handlers in `tf_intersight_softwarerepositoryoperatingsystemfile/handlers.py`
