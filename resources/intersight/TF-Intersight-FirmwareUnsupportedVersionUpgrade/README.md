...
1. Write the JSON schema describing your resource, `tf-intersight-firmwareunsupportedversionupgrade.json`
2. Implement your resource handlers in `tf_intersight_firmwareunsupportedversionupgrade/handlers.py`
