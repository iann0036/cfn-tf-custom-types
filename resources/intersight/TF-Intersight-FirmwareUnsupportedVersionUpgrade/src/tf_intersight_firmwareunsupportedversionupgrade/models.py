...
class ResourceModel(BaseModel):
    ...
    DownloadError: Optional[str]
    DownloadProgress: Optional[float]
    DownloadRetries: Optional[float]
    Id: Optional[str]
    ...
    PhysicalIdentity: Optional[Sequence["_PhysicalIdentityDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DownloadError=json_data.get("DownloadError"),
            DownloadProgress=json_data.get("DownloadProgress"),
            DownloadRetries=json_data.get("DownloadRetries"),
            Id=json_data.get("Id"),
            ...
            PhysicalIdentity=deserialize_list(json_data.get("PhysicalIdentity"), PhysicalIdentityDefinition),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UpgradeStatus=json_data.get("UpgradeStatus"),
...
@dataclass
class PhysicalIdentityDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_PhysicalIdentityDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PhysicalIdentityDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_PhysicalIdentityDefinition = PhysicalIdentityDefinition
