...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesacicniprofile.json`
2. Implement your resource handlers in `tf_intersight_kubernetesacicniprofile/handlers.py`
