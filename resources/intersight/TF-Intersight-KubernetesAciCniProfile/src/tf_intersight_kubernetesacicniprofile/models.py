...
class ResourceModel(BaseModel):
    ...
    AaepName: Optional[str]
    AccountMoid: Optional[str]
    AdditionalProperties: Optional[str]
    Ancestors: Optional[Sequence["_AncestorsDefinition"]]
    ClassId: Optional[str]
    ClusterAciAllocations: Optional[Sequence["_ClusterAciAllocationsDefinition"]]
    ClusterProfiles: Optional[Sequence["_ClusterProfilesDefinition"]]
    CreateTime: Optional[str]
    Description: Optional[str]
    DomainGroupMoid: Optional[str]
    ExtSvcDynSubnetStart: Optional[str]
    ExtSvcStaticSubnetStart: Optional[str]
    Id: Optional[str]
    InfraVlanId: Optional[float]
    L3OutNetworkName: Optional[str]
    L3OutPolicyName: Optional[str]
    L3OutTenant: Optional[str]
    ModTime: Optional[str]
    Moid: Optional[str]
    Name: Optional[str]
    NestedVmmDomain: Optional[str]
    NodeSvcSubnetStart: Optional[str]
    NodeVlanRangeEnd: Optional[float]
    NodeVlanRangeStart: Optional[float]
    NumberOfKubernetesClusters: Optional[float]
    ObjectType: Optional[str]
    OpflexMulticastAddressRange: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AaepName=json_data.get("AaepName"),
            ...
            ClusterAciAllocations=deserialize_list(json_data.get("ClusterAciAllocations"), ClusterAciAllocationsDefinition),
            ...
            ExtSvcDynSubnetStart=json_data.get("ExtSvcDynSubnetStart"),
            ExtSvcStaticSubnetStart=json_data.get("ExtSvcStaticSubnetStart"),
            Id=json_data.get("Id"),
            InfraVlanId=json_data.get("InfraVlanId"),
            L3OutNetworkName=json_data.get("L3OutNetworkName"),
            L3OutPolicyName=json_data.get("L3OutPolicyName"),
            L3OutTenant=json_data.get("L3OutTenant"),
            ModTime=json_data.get("ModTime"),
            Moid=json_data.get("Moid"),
            Name=json_data.get("Name"),
            NestedVmmDomain=json_data.get("NestedVmmDomain"),
            NodeSvcSubnetStart=json_data.get("NodeSvcSubnetStart"),
            NodeVlanRangeEnd=json_data.get("NodeVlanRangeEnd"),
            NodeVlanRangeStart=json_data.get("NodeVlanRangeStart"),
            NumberOfKubernetesClusters=json_data.get("NumberOfKubernetesClusters"),
            ObjectType=json_data.get("ObjectType"),
            OpflexMulticastAddressRange=json_data.get("OpflexMulticastAddressRange"),
            ...
            PodSubnetStart=json_data.get("PodSubnetStart"),
            ...
            SvcSubnetStart=json_data.get("SvcSubnetStart"),
...
@dataclass
class ClusterAciAllocationsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ClusterAciAllocationsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ClusterAciAllocationsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ClusterAciAllocationsDefinition = ClusterAciAllocationsDefinition
