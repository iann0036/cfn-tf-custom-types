...
class ResourceModel(BaseModel):
    ...
    VlanSettings: Optional[Sequence["_VlanSettingsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            VlanSettings=deserialize_list(json_data.get("VlanSettings"), VlanSettingsDefinition),
        )
...
@dataclass
class VlanSettingsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    AllowedVlans: Optional[str]
    ClassId: Optional[str]
    NativeVlan: Optional[float]
    ObjectType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_VlanSettingsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_VlanSettingsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ...
            ClassId=json_data.get("ClassId"),
            NativeVlan=json_data.get("NativeVlan"),
            ObjectType=json_data.get("ObjectType"),
        )


# work around possible type aliasing issues when variable has same name as a model
_VlanSettingsDefinition = VlanSettingsDefinition
