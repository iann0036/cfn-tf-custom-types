...
1. Write the JSON schema describing your resource, `tf-intersight-fabricethnetworkgrouppolicy.json`
2. Implement your resource handlers in `tf_intersight_fabricethnetworkgrouppolicy/handlers.py`
