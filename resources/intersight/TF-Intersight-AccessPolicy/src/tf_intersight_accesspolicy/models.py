...
class ResourceModel(BaseModel):
    ...
    AddressType: Optional[Sequence["_AddressTypeDefinition"]]
    ...
    Id: Optional[str]
    InbandIpPool: Optional[Sequence["_InbandIpPoolDefinition"]]
    InbandVlan: Optional[float]
    InbandVrf: Optional[Sequence["_InbandVrfDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AddressType=deserialize_list(json_data.get("AddressType"), AddressTypeDefinition),
            ...
            Id=json_data.get("Id"),
            InbandIpPool=deserialize_list(json_data.get("InbandIpPool"), InbandIpPoolDefinition),
            InbandVlan=json_data.get("InbandVlan"),
            InbandVrf=deserialize_list(json_data.get("InbandVrf"), InbandVrfDefinition),
...
@dataclass
class AddressTypeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AddressTypeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AddressTypeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            EnableIpV4=json_data.get("EnableIpV4"),
...
# work around possible type aliasing issues when variable has same name as a model
_AddressTypeDefinition = AddressTypeDefinition
...
@dataclass
class InbandIpPoolDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_InbandIpPoolDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InbandIpPoolDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_InbandIpPoolDefinition = InbandIpPoolDefinition


@dataclass
class InbandVrfDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_InbandVrfDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InbandVrfDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_InbandVrfDefinition = InbandVrfDefinition
