...
1. Write the JSON schema describing your resource, `tf-intersight-accesspolicy.json`
2. Implement your resource handlers in `tf_intersight_accesspolicy/handlers.py`
