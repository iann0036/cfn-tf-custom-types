...
1. Write the JSON schema describing your resource, `tf-intersight-oprsdeployment.json`
2. Implement your resource handlers in `tf_intersight_oprsdeployment/handlers.py`
