...
<pre>
{
    "Type" : "TF::Intersight::OprsDeployment",
    "Properties" : {
        ...
        "<a href="#availablereplicas" title="AvailableReplicas">AvailableReplicas</a>" : <i>Double</i>,
        "<a href="#classid" title="ClassId">ClassId</a>" : <i>String</i>,
        "<a href="#createtime" title="CreateTime">CreateTime</a>" : <i>String</i>,
        "<a href="#desiredreplicas" title="DesiredReplicas">DesiredReplicas</a>" : <i>Double</i>,
        ...
        "<a href="#unavailablereplicas" title="UnavailableReplicas">UnavailableReplicas</a>" : <i>Double</i>,
