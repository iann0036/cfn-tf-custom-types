...
<pre>
{
    "Type" : "TF::Intersight::FabricLinkAggregationPolicy",
    "Properties" : {
        ...
        "<a href="#lacprate" title="LacpRate">LacpRate</a>" : <i>String</i>,
        ...
        "<a href="#suspendindividual" title="SuspendIndividual">SuspendIndividual</a>" : <i>Boolean</i>,
