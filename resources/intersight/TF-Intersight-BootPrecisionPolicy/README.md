...
1. Write the JSON schema describing your resource, `tf-intersight-bootprecisionpolicy.json`
2. Implement your resource handlers in `tf_intersight_bootprecisionpolicy/handlers.py`
