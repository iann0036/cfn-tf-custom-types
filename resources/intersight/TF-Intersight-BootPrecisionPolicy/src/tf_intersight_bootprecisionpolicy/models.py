...
class ResourceModel(BaseModel):
    ...
    BootDevices: Optional[Sequence["_BootDevicesDefinition"]]
    ClassId: Optional[str]
    ConfiguredBootMode: Optional[str]
    CreateTime: Optional[str]
    Description: Optional[str]
    DomainGroupMoid: Optional[str]
    EnforceUefiSecureBoot: Optional[bool]
    Id: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BootDevices=deserialize_list(json_data.get("BootDevices"), BootDevicesDefinition),
            ClassId=json_data.get("ClassId"),
            ConfiguredBootMode=json_data.get("ConfiguredBootMode"),
            CreateTime=json_data.get("CreateTime"),
            Description=json_data.get("Description"),
            DomainGroupMoid=json_data.get("DomainGroupMoid"),
            EnforceUefiSecureBoot=json_data.get("EnforceUefiSecureBoot"),
            Id=json_data.get("Id"),
...
@dataclass
class BootDevicesDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_BootDevicesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BootDevicesDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_BootDevicesDefinition = BootDevicesDefinition
