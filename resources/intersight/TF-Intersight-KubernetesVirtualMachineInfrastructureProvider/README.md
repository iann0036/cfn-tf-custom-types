...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetesvirtualmachineinfrastructureprovider.json`
2. Implement your resource handlers in `tf_intersight_kubernetesvirtualmachineinfrastructureprovider/handlers.py`
