...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    InfraConfig: Optional[Sequence["_InfraConfigDefinition"]]
    InfraConfigPolicy: Optional[Sequence["_InfraConfigPolicyDefinition"]]
    InstanceType: Optional[Sequence["_InstanceTypeDefinition"]]
    ModTime: Optional[str]
    Moid: Optional[str]
    Name: Optional[str]
    NodeGroup: Optional[Sequence["_NodeGroupDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            InfraConfig=deserialize_list(json_data.get("InfraConfig"), InfraConfigDefinition),
            InfraConfigPolicy=deserialize_list(json_data.get("InfraConfigPolicy"), InfraConfigPolicyDefinition),
            InstanceType=deserialize_list(json_data.get("InstanceType"), InstanceTypeDefinition),
            ModTime=json_data.get("ModTime"),
            Moid=json_data.get("Moid"),
            Name=json_data.get("Name"),
            NodeGroup=deserialize_list(json_data.get("NodeGroup"), NodeGroupDefinition),
...
@dataclass
class InfraConfigDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_InfraConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InfraConfigDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_InfraConfigDefinition = InfraConfigDefinition


@dataclass
class InfraConfigPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_InfraConfigPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InfraConfigPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_InfraConfigPolicyDefinition = InfraConfigPolicyDefinition


@dataclass
class InstanceTypeDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_InstanceTypeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InstanceTypeDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_InstanceTypeDefinition = InstanceTypeDefinition


@dataclass
class NodeGroupDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_NodeGroupDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_NodeGroupDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_NodeGroupDefinition = NodeGroupDefinition
