...
1. Write the JSON schema describing your resource, `tf-intersight-softwarerepositorycategorymapper.json`
2. Implement your resource handlers in `tf_intersight_softwarerepositorycategorymapper/handlers.py`
