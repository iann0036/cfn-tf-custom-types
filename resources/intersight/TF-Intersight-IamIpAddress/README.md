...
1. Write the JSON schema describing your resource, `tf-intersight-iamipaddress.json`
2. Implement your resource handlers in `tf_intersight_iamipaddress/handlers.py`
