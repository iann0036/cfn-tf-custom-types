...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    IpAccessManagement: Optional[Sequence["_IpAccessManagementDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            IpAccessManagement=deserialize_list(json_data.get("IpAccessManagement"), IpAccessManagementDefinition),
...
@dataclass
class IpAccessManagementDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IpAccessManagementDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IpAccessManagementDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IpAccessManagementDefinition = IpAccessManagementDefinition
