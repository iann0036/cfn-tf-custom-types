...
1. Write the JSON schema describing your resource, `tf-intersight-hyperflexappcatalog.json`
2. Implement your resource handlers in `tf_intersight_hyperflexappcatalog/handlers.py`
