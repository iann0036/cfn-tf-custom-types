# TF::Intersight::ApplianceRemoteFileImport

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-applianceremotefileimport.json`
2. Implement your resource handlers in `tf_intersight_applianceremotefileimport/handlers.py`
