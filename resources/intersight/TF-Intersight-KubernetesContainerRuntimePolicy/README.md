...
1. Write the JSON schema describing your resource, `tf-intersight-kubernetescontainerruntimepolicy.json`
2. Implement your resource handlers in `tf_intersight_kubernetescontainerruntimepolicy/handlers.py`
