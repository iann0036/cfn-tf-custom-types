...
class ResourceModel(BaseModel):
    ...
    DockerBridgeNetworkCidr: Optional[str]
    DockerHttpProxy: Optional[Sequence["_DockerHttpProxyDefinition"]]
    DockerHttpsProxy: Optional[Sequence["_DockerHttpsProxyDefinition"]]
    DockerNoProxy: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DockerBridgeNetworkCidr=json_data.get("DockerBridgeNetworkCidr"),
            DockerHttpProxy=deserialize_list(json_data.get("DockerHttpProxy"), DockerHttpProxyDefinition),
            DockerHttpsProxy=deserialize_list(json_data.get("DockerHttpsProxy"), DockerHttpsProxyDefinition),
            DockerNoProxy=json_data.get("DockerNoProxy"),
...
@dataclass
class DockerHttpProxyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DockerHttpProxyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DockerHttpProxyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DockerHttpProxyDefinition = DockerHttpProxyDefinition


@dataclass
class DockerHttpsProxyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Hostname: Optional[str]
    IsPasswordSet: Optional[bool]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DockerHttpsProxyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DockerHttpsProxyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_DockerHttpsProxyDefinition = DockerHttpsProxyDefinition
