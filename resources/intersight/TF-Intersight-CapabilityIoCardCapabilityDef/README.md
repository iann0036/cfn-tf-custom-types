# TF::Intersight::CapabilityIoCardCapabilityDef

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-intersight-capabilityiocardcapabilitydef.json`
2. Implement your resource handlers in `tf_intersight_capabilityiocardcapabilitydef/handlers.py`
