...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    LinkAggregationPolicy: Optional[Sequence["_LinkAggregationPolicyDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            LinkAggregationPolicy=deserialize_list(json_data.get("LinkAggregationPolicy"), LinkAggregationPolicyDefinition),
...
@dataclass
class LinkAggregationPolicyDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_LinkAggregationPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LinkAggregationPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_LinkAggregationPolicyDefinition = LinkAggregationPolicyDefinition
