...
1. Write the JSON schema describing your resource, `tf-intersight-fabricfcoeuplinkpcrole.json`
2. Implement your resource handlers in `tf_intersight_fabricfcoeuplinkpcrole/handlers.py`
