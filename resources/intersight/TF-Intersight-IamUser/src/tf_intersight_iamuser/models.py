...
class ResourceModel(BaseModel):
    ...
    ApiKeys: Optional[Sequence["_ApiKeysDefinition"]]
    AppRegistrations: Optional[Sequence["_AppRegistrationsDefinition"]]
    ...
    Idpreference: Optional[Sequence["_IdpreferenceDefinition"]]
    LastLoginTime: Optional[str]
    LastName: Optional[str]
    LastRoleModifiedTime: Optional[str]
    LocalUserPassword: Optional[Sequence["_LocalUserPasswordDefinition"]]
    ModTime: Optional[str]
    Moid: Optional[str]
    Name: Optional[str]
    OauthTokens: Optional[Sequence["_OauthTokensDefinition"]]
    ...
    Sessions: Optional[Sequence["_SessionsDefinition"]]
    SharedScope: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    UserIdOrEmail: Optional[str]
    UserType: Optional[str]
    UserUniqueIdentifier: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ApiKeys=deserialize_list(json_data.get("ApiKeys"), ApiKeysDefinition),
            AppRegistrations=deserialize_list(json_data.get("AppRegistrations"), AppRegistrationsDefinition),
            ClassId=json_data.get("ClassId"),
            ClientIpAddress=json_data.get("ClientIpAddress"),
            ...
            Idpreference=deserialize_list(json_data.get("Idpreference"), IdpreferenceDefinition),
            LastLoginTime=json_data.get("LastLoginTime"),
            LastName=json_data.get("LastName"),
            LastRoleModifiedTime=json_data.get("LastRoleModifiedTime"),
            LocalUserPassword=deserialize_list(json_data.get("LocalUserPassword"), LocalUserPasswordDefinition),
            ModTime=json_data.get("ModTime"),
            Moid=json_data.get("Moid"),
            Name=json_data.get("Name"),
            OauthTokens=deserialize_list(json_data.get("OauthTokens"), OauthTokensDefinition),
            ...
            Sessions=deserialize_list(json_data.get("Sessions"), SessionsDefinition),
            SharedScope=json_data.get("SharedScope"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UserIdOrEmail=json_data.get("UserIdOrEmail"),
            UserType=json_data.get("UserType"),
            UserUniqueIdentifier=json_data.get("UserUniqueIdentifier"),
...
@dataclass
class ApiKeysDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ApiKeysDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ApiKeysDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_ApiKeysDefinition = ApiKeysDefinition


@dataclass
class AppRegistrationsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AppRegistrationsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AppRegistrationsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_AppRegistrationsDefinition = AppRegistrationsDefinition
...
@dataclass
class IdpreferenceDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_IdpreferenceDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IdpreferenceDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_IdpreferenceDefinition = IdpreferenceDefinition


@dataclass
class LocalUserPasswordDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_LocalUserPasswordDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_LocalUserPasswordDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_LocalUserPasswordDefinition = LocalUserPasswordDefinition


@dataclass
class OauthTokensDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_OauthTokensDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_OauthTokensDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_OauthTokensDefinition = OauthTokensDefinition
...
@dataclass
class SessionsDefinition(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Moid: Optional[str]
    ObjectType: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SessionsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SessionsDefinition"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_SessionsDefinition = SessionsDefinition
