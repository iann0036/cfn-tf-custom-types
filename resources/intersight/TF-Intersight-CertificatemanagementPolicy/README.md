...
1. Write the JSON schema describing your resource, `tf-intersight-certificatemanagementpolicy.json`
2. Implement your resource handlers in `tf_intersight_certificatemanagementpolicy/handlers.py`
