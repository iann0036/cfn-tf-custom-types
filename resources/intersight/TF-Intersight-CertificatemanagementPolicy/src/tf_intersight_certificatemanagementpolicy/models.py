...
class ResourceModel(BaseModel):
    ...
    Certificates: Optional[Sequence["_CertificatesDefinition4"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Certificates=deserialize_list(json_data.get("Certificates"), CertificatesDefinition4),
...
@dataclass
class CertificatesDefinition4(BaseModel):
    AdditionalProperties: Optional[str]
    Certificate: Optional[Sequence["_CertificatesDefinition3"]]
    ClassId: Optional[str]
    Enabled: Optional[bool]
    IsPrivatekeySet: Optional[bool]
    ObjectType: Optional[str]
    Privatekey: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_CertificatesDefinition4"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificatesDefinition4"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            Certificate=deserialize_list(json_data.get("Certificate"), CertificatesDefinition3),
            ClassId=json_data.get("ClassId"),
            Enabled=json_data.get("Enabled"),
            IsPrivatekeySet=json_data.get("IsPrivatekeySet"),
            ObjectType=json_data.get("ObjectType"),
...
# work around possible type aliasing issues when variable has same name as a model
_CertificatesDefinition4 = CertificatesDefinition4


@dataclass
class CertificatesDefinition3(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    Issuer: Optional[Sequence["_CertificatesDefinition"]]
    NotAfter: Optional[str]
    NotBefore: Optional[str]
    ObjectType: Optional[str]
    PemCertificate: Optional[str]
    Sha256Fingerprint: Optional[str]
    SignatureAlgorithm: Optional[str]
    Subject: Optional[Sequence["_CertificatesDefinition2"]]

    @classmethod
    def _deserialize(
        cls: Type["_CertificatesDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificatesDefinition3"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
            ClassId=json_data.get("ClassId"),
            Issuer=deserialize_list(json_data.get("Issuer"), CertificatesDefinition),
            NotAfter=json_data.get("NotAfter"),
            NotBefore=json_data.get("NotBefore"),
            ObjectType=json_data.get("ObjectType"),
            PemCertificate=json_data.get("PemCertificate"),
            Sha256Fingerprint=json_data.get("Sha256Fingerprint"),
            SignatureAlgorithm=json_data.get("SignatureAlgorithm"),
            Subject=deserialize_list(json_data.get("Subject"), CertificatesDefinition2),
        )


# work around possible type aliasing issues when variable has same name as a model
_CertificatesDefinition3 = CertificatesDefinition3
...
class CertificatesDefinition(BaseModel):
    ...
    OrganizationalUnit: Optional[Sequence[str]]
...
@dataclass
class CertificatesDefinition2(BaseModel):
    AdditionalProperties: Optional[str]
    ClassId: Optional[str]
    CommonName: Optional[str]
    Country: Optional[Sequence[str]]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CertificatesDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CertificatesDefinition2"]:
        if not json_data:
            return None
        return cls(
            AdditionalProperties=json_data.get("AdditionalProperties"),
...
# work around possible type aliasing issues when variable has same name as a model
_CertificatesDefinition2 = CertificatesDefinition2
