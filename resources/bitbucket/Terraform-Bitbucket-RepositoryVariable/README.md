...
1. Write the JSON schema describing your resource, `terraform-bitbucket-repositoryvariable.json`
2. Implement your resource handlers in `terraform_bitbucket_repositoryvariable/handlers.py`
