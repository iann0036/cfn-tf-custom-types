...
1. Write the JSON schema describing your resource, `terraform-bitbucket-defaultreviewers.json`
2. Implement your resource handlers in `terraform_bitbucket_defaultreviewers/handlers.py`
