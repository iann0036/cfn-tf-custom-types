...
1. Write the JSON schema describing your resource, `terraform-bitbucket-branchrestriction.json`
2. Implement your resource handlers in `terraform_bitbucket_branchrestriction/handlers.py`
