...
1. Write the JSON schema describing your resource, `terraform-bitbucket-project.json`
2. Implement your resource handlers in `terraform_bitbucket_project/handlers.py`
