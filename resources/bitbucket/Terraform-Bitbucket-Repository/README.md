...
1. Write the JSON schema describing your resource, `terraform-bitbucket-repository.json`
2. Implement your resource handlers in `terraform_bitbucket_repository/handlers.py`
