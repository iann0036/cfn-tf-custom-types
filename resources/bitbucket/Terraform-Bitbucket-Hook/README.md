...
1. Write the JSON schema describing your resource, `terraform-bitbucket-hook.json`
2. Implement your resource handlers in `terraform_bitbucket_hook/handlers.py`
