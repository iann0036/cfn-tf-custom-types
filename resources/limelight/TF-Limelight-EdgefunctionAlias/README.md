...
1. Write the JSON schema describing your resource, `tf-limelight-edgefunctionalias.json`
2. Implement your resource handlers in `tf_limelight_edgefunctionalias/handlers.py`
