...
1. Write the JSON schema describing your resource, `tf-limelight-edgefunction.json`
2. Implement your resource handlers in `tf_limelight_edgefunction/handlers.py`
