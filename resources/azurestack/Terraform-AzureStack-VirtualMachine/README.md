...
1. Write the JSON schema describing your resource, `terraform-azurestack-virtualmachine.json`
2. Implement your resource handlers in `terraform_azurestack_virtualmachine/handlers.py`
