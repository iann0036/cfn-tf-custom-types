...
1. Write the JSON schema describing your resource, `terraform-azurestack-virtualnetworkgateway.json`
2. Implement your resource handlers in `terraform_azurestack_virtualnetworkgateway/handlers.py`
