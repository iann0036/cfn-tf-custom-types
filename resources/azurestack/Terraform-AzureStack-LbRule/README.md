...
1. Write the JSON schema describing your resource, `terraform-azurestack-lbrule.json`
2. Implement your resource handlers in `terraform_azurestack_lbrule/handlers.py`
