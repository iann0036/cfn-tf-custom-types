...
1. Write the JSON schema describing your resource, `tf-azurestack-virtualnetworkgateway.json`
2. Implement your resource handlers in `tf_azurestack_virtualnetworkgateway/handlers.py`
