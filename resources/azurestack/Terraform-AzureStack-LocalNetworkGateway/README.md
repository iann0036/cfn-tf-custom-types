...
1. Write the JSON schema describing your resource, `terraform-azurestack-localnetworkgateway.json`
2. Implement your resource handlers in `terraform_azurestack_localnetworkgateway/handlers.py`
