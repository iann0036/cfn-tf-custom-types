...
1. Write the JSON schema describing your resource, `terraform-azurestack-route.json`
2. Implement your resource handlers in `terraform_azurestack_route/handlers.py`
