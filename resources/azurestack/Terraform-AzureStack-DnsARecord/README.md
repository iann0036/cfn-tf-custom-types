...
1. Write the JSON schema describing your resource, `terraform-azurestack-dnsarecord.json`
2. Implement your resource handlers in `terraform_azurestack_dnsarecord/handlers.py`
