...
1. Write the JSON schema describing your resource, `terraform-azurestack-lbprobe.json`
2. Implement your resource handlers in `terraform_azurestack_lbprobe/handlers.py`
