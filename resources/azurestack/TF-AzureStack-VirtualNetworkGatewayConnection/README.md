# TF::AzureStack::VirtualNetworkGatewayConnection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-virtualnetworkgatewayconnection.json`
2. Implement your resource handlers in `tf_azurestack_virtualnetworkgatewayconnection/handlers.py`
