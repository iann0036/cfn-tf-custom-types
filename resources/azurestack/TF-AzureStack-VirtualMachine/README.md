...
1. Write the JSON schema describing your resource, `tf-azurestack-virtualmachine.json`
2. Implement your resource handlers in `tf_azurestack_virtualmachine/handlers.py`
