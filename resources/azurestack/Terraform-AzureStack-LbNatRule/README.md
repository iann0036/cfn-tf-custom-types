...
1. Write the JSON schema describing your resource, `terraform-azurestack-lbnatrule.json`
2. Implement your resource handlers in `terraform_azurestack_lbnatrule/handlers.py`
