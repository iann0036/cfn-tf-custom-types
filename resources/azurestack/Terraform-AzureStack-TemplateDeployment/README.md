...
1. Write the JSON schema describing your resource, `terraform-azurestack-templatedeployment.json`
2. Implement your resource handlers in `terraform_azurestack_templatedeployment/handlers.py`
