...
1. Write the JSON schema describing your resource, `terraform-azurestack-virtualmachinescaleset.json`
2. Implement your resource handlers in `terraform_azurestack_virtualmachinescaleset/handlers.py`
