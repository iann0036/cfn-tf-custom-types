# TF::AzureStack::DnsZone

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-dnszone.json`
2. Implement your resource handlers in `tf_azurestack_dnszone/handlers.py`
