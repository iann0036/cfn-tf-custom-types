...
1. Write the JSON schema describing your resource, `terraform-azurestack-dnszone.json`
2. Implement your resource handlers in `terraform_azurestack_dnszone/handlers.py`
