...
1. Write the JSON schema describing your resource, `tf-azurestack-networksecuritygroup.json`
2. Implement your resource handlers in `tf_azurestack_networksecuritygroup/handlers.py`
