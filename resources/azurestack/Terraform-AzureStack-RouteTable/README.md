...
1. Write the JSON schema describing your resource, `terraform-azurestack-routetable.json`
2. Implement your resource handlers in `terraform_azurestack_routetable/handlers.py`
