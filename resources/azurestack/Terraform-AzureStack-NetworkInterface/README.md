...
1. Write the JSON schema describing your resource, `terraform-azurestack-networkinterface.json`
2. Implement your resource handlers in `terraform_azurestack_networkinterface/handlers.py`
