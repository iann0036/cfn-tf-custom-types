# TF::AzureStack::StorageContainer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-storagecontainer.json`
2. Implement your resource handlers in `tf_azurestack_storagecontainer/handlers.py`
