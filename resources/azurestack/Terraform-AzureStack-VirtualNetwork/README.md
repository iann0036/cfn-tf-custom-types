...
1. Write the JSON schema describing your resource, `terraform-azurestack-virtualnetwork.json`
2. Implement your resource handlers in `terraform_azurestack_virtualnetwork/handlers.py`
