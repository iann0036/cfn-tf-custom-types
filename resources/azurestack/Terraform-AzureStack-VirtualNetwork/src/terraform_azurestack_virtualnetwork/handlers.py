...
def create_handler(
    ...
    try:
        ...
        tf['resource']['azurestack_virtual_network'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['azurestack_virtual_network'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
