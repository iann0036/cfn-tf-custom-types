# TF::AzureStack::ResourceGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-resourcegroup.json`
2. Implement your resource handlers in `tf_azurestack_resourcegroup/handlers.py`
