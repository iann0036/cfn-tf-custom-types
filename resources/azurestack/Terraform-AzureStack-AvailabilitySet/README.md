...
1. Write the JSON schema describing your resource, `terraform-azurestack-availabilityset.json`
2. Implement your resource handlers in `terraform_azurestack_availabilityset/handlers.py`
