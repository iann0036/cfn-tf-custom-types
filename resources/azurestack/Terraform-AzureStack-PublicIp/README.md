...
1. Write the JSON schema describing your resource, `terraform-azurestack-publicip.json`
2. Implement your resource handlers in `terraform_azurestack_publicip/handlers.py`
