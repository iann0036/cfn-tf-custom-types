...
1. Write the JSON schema describing your resource, `terraform-azurestack-storageblob.json`
2. Implement your resource handlers in `terraform_azurestack_storageblob/handlers.py`
