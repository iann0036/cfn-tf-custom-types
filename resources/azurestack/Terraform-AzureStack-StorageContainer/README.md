...
1. Write the JSON schema describing your resource, `terraform-azurestack-storagecontainer.json`
2. Implement your resource handlers in `terraform_azurestack_storagecontainer/handlers.py`
