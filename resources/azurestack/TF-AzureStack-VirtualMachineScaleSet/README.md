...
1. Write the JSON schema describing your resource, `tf-azurestack-virtualmachinescaleset.json`
2. Implement your resource handlers in `tf_azurestack_virtualmachinescaleset/handlers.py`
