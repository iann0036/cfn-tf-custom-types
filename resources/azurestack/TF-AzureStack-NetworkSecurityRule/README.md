# TF::AzureStack::NetworkSecurityRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-networksecurityrule.json`
2. Implement your resource handlers in `tf_azurestack_networksecurityrule/handlers.py`
