# TF::AzureStack::DnsARecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-dnsarecord.json`
2. Implement your resource handlers in `tf_azurestack_dnsarecord/handlers.py`
