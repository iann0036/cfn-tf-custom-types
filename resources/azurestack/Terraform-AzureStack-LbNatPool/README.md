...
1. Write the JSON schema describing your resource, `terraform-azurestack-lbnatpool.json`
2. Implement your resource handlers in `terraform_azurestack_lbnatpool/handlers.py`
