...
1. Write the JSON schema describing your resource, `terraform-azurestack-lb.json`
2. Implement your resource handlers in `terraform_azurestack_lb/handlers.py`
