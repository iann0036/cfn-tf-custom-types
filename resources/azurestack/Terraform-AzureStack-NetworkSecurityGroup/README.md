...
1. Write the JSON schema describing your resource, `terraform-azurestack-networksecuritygroup.json`
2. Implement your resource handlers in `terraform_azurestack_networksecuritygroup/handlers.py`
