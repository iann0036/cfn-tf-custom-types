# TF::AzureStack::LbNatRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-lbnatrule.json`
2. Implement your resource handlers in `tf_azurestack_lbnatrule/handlers.py`
