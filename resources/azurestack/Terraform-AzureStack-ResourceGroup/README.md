...
1. Write the JSON schema describing your resource, `terraform-azurestack-resourcegroup.json`
2. Implement your resource handlers in `terraform_azurestack_resourcegroup/handlers.py`
