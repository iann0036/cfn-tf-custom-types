...
1. Write the JSON schema describing your resource, `terraform-azurestack-subnet.json`
2. Implement your resource handlers in `terraform_azurestack_subnet/handlers.py`
