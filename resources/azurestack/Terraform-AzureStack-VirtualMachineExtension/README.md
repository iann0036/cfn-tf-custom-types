...
1. Write the JSON schema describing your resource, `terraform-azurestack-virtualmachineextension.json`
2. Implement your resource handlers in `terraform_azurestack_virtualmachineextension/handlers.py`
