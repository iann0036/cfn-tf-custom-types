# TF::AzureStack::NetworkInterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-networkinterface.json`
2. Implement your resource handlers in `tf_azurestack_networkinterface/handlers.py`
