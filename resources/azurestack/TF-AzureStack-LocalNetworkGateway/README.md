...
1. Write the JSON schema describing your resource, `tf-azurestack-localnetworkgateway.json`
2. Implement your resource handlers in `tf_azurestack_localnetworkgateway/handlers.py`
