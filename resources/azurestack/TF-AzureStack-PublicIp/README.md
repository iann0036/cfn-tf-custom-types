# TF::AzureStack::PublicIp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-publicip.json`
2. Implement your resource handlers in `tf_azurestack_publicip/handlers.py`
