...
1. Write the JSON schema describing your resource, `tf-azurestack-lbbackendaddresspool.json`
2. Implement your resource handlers in `tf_azurestack_lbbackendaddresspool/handlers.py`
