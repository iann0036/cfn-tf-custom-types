# TF::AzureStack::StorageBlob

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-storageblob.json`
2. Implement your resource handlers in `tf_azurestack_storageblob/handlers.py`
