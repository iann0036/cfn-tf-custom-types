...
1. Write the JSON schema describing your resource, `terraform-azurestack-manageddisk.json`
2. Implement your resource handlers in `terraform_azurestack_manageddisk/handlers.py`
