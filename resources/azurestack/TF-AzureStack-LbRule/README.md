# TF::AzureStack::LbRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurestack-lbrule.json`
2. Implement your resource handlers in `tf_azurestack_lbrule/handlers.py`
