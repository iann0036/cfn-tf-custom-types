...
1. Write the JSON schema describing your resource, `terraform-azurestack-networksecurityrule.json`
2. Implement your resource handlers in `terraform_azurestack_networksecurityrule/handlers.py`
