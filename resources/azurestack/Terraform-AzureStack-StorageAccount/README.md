...
1. Write the JSON schema describing your resource, `terraform-azurestack-storageaccount.json`
2. Implement your resource handlers in `terraform_azurestack_storageaccount/handlers.py`
