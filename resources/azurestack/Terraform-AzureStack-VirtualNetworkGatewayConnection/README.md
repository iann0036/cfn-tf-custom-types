...
1. Write the JSON schema describing your resource, `terraform-azurestack-virtualnetworkgatewayconnection.json`
2. Implement your resource handlers in `terraform_azurestack_virtualnetworkgatewayconnection/handlers.py`
