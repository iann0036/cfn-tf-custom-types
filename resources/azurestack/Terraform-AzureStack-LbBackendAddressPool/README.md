...
1. Write the JSON schema describing your resource, `terraform-azurestack-lbbackendaddresspool.json`
2. Implement your resource handlers in `terraform_azurestack_lbbackendaddresspool/handlers.py`
