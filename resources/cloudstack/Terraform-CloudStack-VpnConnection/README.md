...
1. Write the JSON schema describing your resource, `terraform-cloudstack-vpnconnection.json`
2. Implement your resource handlers in `terraform_cloudstack_vpnconnection/handlers.py`
