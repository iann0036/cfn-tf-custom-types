...
1. Write the JSON schema describing your resource, `terraform-cloudstack-firewall.json`
2. Implement your resource handlers in `terraform_cloudstack_firewall/handlers.py`
