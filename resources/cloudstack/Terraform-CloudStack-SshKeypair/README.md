...
1. Write the JSON schema describing your resource, `terraform-cloudstack-sshkeypair.json`
2. Implement your resource handlers in `terraform_cloudstack_sshkeypair/handlers.py`
