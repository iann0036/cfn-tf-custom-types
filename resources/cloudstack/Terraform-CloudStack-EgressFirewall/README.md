...
1. Write the JSON schema describing your resource, `terraform-cloudstack-egressfirewall.json`
2. Implement your resource handlers in `terraform_cloudstack_egressfirewall/handlers.py`
