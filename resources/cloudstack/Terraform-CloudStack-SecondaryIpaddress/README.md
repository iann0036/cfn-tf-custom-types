...
1. Write the JSON schema describing your resource, `terraform-cloudstack-secondaryipaddress.json`
2. Implement your resource handlers in `terraform_cloudstack_secondaryipaddress/handlers.py`
