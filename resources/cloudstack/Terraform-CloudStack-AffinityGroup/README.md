...
1. Write the JSON schema describing your resource, `terraform-cloudstack-affinitygroup.json`
2. Implement your resource handlers in `terraform_cloudstack_affinitygroup/handlers.py`
