...
1. Write the JSON schema describing your resource, `terraform-cloudstack-privategateway.json`
2. Implement your resource handlers in `terraform_cloudstack_privategateway/handlers.py`
