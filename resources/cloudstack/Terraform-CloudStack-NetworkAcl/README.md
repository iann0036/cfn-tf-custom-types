...
1. Write the JSON schema describing your resource, `terraform-cloudstack-networkacl.json`
2. Implement your resource handlers in `terraform_cloudstack_networkacl/handlers.py`
