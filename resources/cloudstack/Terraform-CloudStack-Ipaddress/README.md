...
1. Write the JSON schema describing your resource, `terraform-cloudstack-ipaddress.json`
2. Implement your resource handlers in `terraform_cloudstack_ipaddress/handlers.py`
