...
1. Write the JSON schema describing your resource, `terraform-cloudstack-loadbalancerrule.json`
2. Implement your resource handlers in `terraform_cloudstack_loadbalancerrule/handlers.py`
