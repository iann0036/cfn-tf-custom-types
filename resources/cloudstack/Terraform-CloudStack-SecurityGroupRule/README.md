...
1. Write the JSON schema describing your resource, `terraform-cloudstack-securitygrouprule.json`
2. Implement your resource handlers in `terraform_cloudstack_securitygrouprule/handlers.py`
