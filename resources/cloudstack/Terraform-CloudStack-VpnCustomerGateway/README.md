...
1. Write the JSON schema describing your resource, `terraform-cloudstack-vpncustomergateway.json`
2. Implement your resource handlers in `terraform_cloudstack_vpncustomergateway/handlers.py`
