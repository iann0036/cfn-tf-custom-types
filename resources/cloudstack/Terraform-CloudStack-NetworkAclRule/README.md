...
1. Write the JSON schema describing your resource, `terraform-cloudstack-networkaclrule.json`
2. Implement your resource handlers in `terraform_cloudstack_networkaclrule/handlers.py`
