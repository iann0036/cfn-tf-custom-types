...
1. Write the JSON schema describing your resource, `terraform-cloudstack-instance.json`
2. Implement your resource handlers in `terraform_cloudstack_instance/handlers.py`
