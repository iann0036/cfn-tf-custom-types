...
1. Write the JSON schema describing your resource, `terraform-cloudstack-template.json`
2. Implement your resource handlers in `terraform_cloudstack_template/handlers.py`
