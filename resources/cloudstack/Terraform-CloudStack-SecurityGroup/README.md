...
1. Write the JSON schema describing your resource, `terraform-cloudstack-securitygroup.json`
2. Implement your resource handlers in `terraform_cloudstack_securitygroup/handlers.py`
