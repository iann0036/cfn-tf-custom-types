...
1. Write the JSON schema describing your resource, `terraform-cloudstack-staticroute.json`
2. Implement your resource handlers in `terraform_cloudstack_staticroute/handlers.py`
