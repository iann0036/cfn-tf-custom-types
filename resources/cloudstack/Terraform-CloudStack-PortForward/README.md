...
1. Write the JSON schema describing your resource, `terraform-cloudstack-portforward.json`
2. Implement your resource handlers in `terraform_cloudstack_portforward/handlers.py`
