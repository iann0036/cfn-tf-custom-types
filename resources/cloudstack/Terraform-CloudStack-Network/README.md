...
1. Write the JSON schema describing your resource, `terraform-cloudstack-network.json`
2. Implement your resource handlers in `terraform_cloudstack_network/handlers.py`
