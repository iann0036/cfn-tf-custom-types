...
1. Write the JSON schema describing your resource, `terraform-cloudstack-disk.json`
2. Implement your resource handlers in `terraform_cloudstack_disk/handlers.py`
