...
1. Write the JSON schema describing your resource, `terraform-cloudstack-nic.json`
2. Implement your resource handlers in `terraform_cloudstack_nic/handlers.py`
