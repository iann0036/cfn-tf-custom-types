...
1. Write the JSON schema describing your resource, `terraform-cloudstack-staticnat.json`
2. Implement your resource handlers in `terraform_cloudstack_staticnat/handlers.py`
