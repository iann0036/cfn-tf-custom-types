...
1. Write the JSON schema describing your resource, `terraform-cloudstack-vpc.json`
2. Implement your resource handlers in `terraform_cloudstack_vpc/handlers.py`
