...
1. Write the JSON schema describing your resource, `terraform-cloudstack-vpngateway.json`
2. Implement your resource handlers in `terraform_cloudstack_vpngateway/handlers.py`
