...
1. Write the JSON schema describing your resource, `terraform-mysql-database.json`
2. Implement your resource handlers in `terraform_mysql_database/handlers.py`
