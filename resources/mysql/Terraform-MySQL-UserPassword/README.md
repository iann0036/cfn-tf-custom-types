...
1. Write the JSON schema describing your resource, `terraform-mysql-userpassword.json`
2. Implement your resource handlers in `terraform_mysql_userpassword/handlers.py`
