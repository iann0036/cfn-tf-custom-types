...
1. Write the JSON schema describing your resource, `tf-equinix-ecxl2connection.json`
2. Implement your resource handlers in `tf_equinix_ecxl2connection/handlers.py`
