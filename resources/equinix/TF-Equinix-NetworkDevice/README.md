...
1. Write the JSON schema describing your resource, `tf-equinix-networkdevice.json`
2. Implement your resource handlers in `tf_equinix_networkdevice/handlers.py`
