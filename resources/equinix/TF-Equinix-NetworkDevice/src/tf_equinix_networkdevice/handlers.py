...
TYPE_NAME = "TF::Equinix::NetworkDevice"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/equinix_network_device/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'equinix/equinix',
                'providerTypeName': 'equinix',
                'terraformTypeName': 'equinix_network_device',
                'returnValues': ["Asn", "Ibx", "Id", "Interface", "LicenseFileId", "LicenseStatus", "RedundancyType", "RedundantId", "Region", "SshIpAddress", "SshIpFqdn", "Status", "Uuid", "ZoneCode"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/equinix_network_device/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/equinix_network_device/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccountNumber=None, AclTemplateId=None, AdditionalBandwidth=None, Asn=None, Byol=None, CoreCount=None, Hostname=None, Ibx=None, Id=None, Interface=None, InterfaceCount=None, LicenseFile=None, LicenseFileId=None, LicenseStatus=None, LicenseToken=None, MetroCode=None, Name=None, Notifications=None, OrderReference=None, PackageCode=None, PurchaseOrderNumber=None, RedundancyType=None, RedundantId=None, Region=None, SelfManaged=None, SshIpAddress=None, SshIpFqdn=None, Status=None, TermLength=None, Throughput=None, ThroughputUnit=None, TypeCode=None, Uuid=None, VendorConfiguration=None, Version=None, ZoneCode=None, SecondaryDevice=None, SshKey=None, Timeouts=None)
