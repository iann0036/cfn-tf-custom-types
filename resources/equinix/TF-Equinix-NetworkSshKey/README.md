# TF::Equinix::NetworkSshKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-equinix-networksshkey.json`
2. Implement your resource handlers in `tf_equinix_networksshkey/handlers.py`
