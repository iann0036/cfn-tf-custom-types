...
1. Write the JSON schema describing your resource, `tf-equinix-networkdevicelink.json`
2. Implement your resource handlers in `tf_equinix_networkdevicelink/handlers.py`
