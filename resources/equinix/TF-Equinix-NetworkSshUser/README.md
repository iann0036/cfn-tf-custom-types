# TF::Equinix::NetworkSshUser

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-equinix-networksshuser.json`
2. Implement your resource handlers in `tf_equinix_networksshuser/handlers.py`
