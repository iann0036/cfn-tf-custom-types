...
1. Write the JSON schema describing your resource, `tf-equinix-ecxl2connectionaccepter.json`
2. Implement your resource handlers in `tf_equinix_ecxl2connectionaccepter/handlers.py`
