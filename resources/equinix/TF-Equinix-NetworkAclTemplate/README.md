...
1. Write the JSON schema describing your resource, `tf-equinix-networkacltemplate.json`
2. Implement your resource handlers in `tf_equinix_networkacltemplate/handlers.py`
