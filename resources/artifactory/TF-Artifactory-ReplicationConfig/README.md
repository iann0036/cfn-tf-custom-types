...
1. Write the JSON schema describing your resource, `tf-artifactory-replicationconfig.json`
2. Implement your resource handlers in `tf_artifactory_replicationconfig/handlers.py`
