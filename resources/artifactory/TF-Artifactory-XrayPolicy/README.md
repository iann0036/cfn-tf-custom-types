# TF::Artifactory::XrayPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-artifactory-xraypolicy.json`
2. Implement your resource handlers in `tf_artifactory_xraypolicy/handlers.py`
