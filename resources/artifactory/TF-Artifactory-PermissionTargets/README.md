# TF::Artifactory::PermissionTargets

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-artifactory-permissiontargets.json`
2. Implement your resource handlers in `tf_artifactory_permissiontargets/handlers.py`
