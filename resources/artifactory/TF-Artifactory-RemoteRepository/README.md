...
1. Write the JSON schema describing your resource, `tf-artifactory-remoterepository.json`
2. Implement your resource handlers in `tf_artifactory_remoterepository/handlers.py`
