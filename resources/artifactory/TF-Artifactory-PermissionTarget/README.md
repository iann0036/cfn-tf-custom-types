...
1. Write the JSON schema describing your resource, `tf-artifactory-permissiontarget.json`
2. Implement your resource handlers in `tf_artifactory_permissiontarget/handlers.py`
