...
1. Write the JSON schema describing your resource, `tf-artifactory-localrepository.json`
2. Implement your resource handlers in `tf_artifactory_localrepository/handlers.py`
