...
1. Write the JSON schema describing your resource, `tf-artifactory-singlereplicationconfig.json`
2. Implement your resource handlers in `tf_artifactory_singlereplicationconfig/handlers.py`
