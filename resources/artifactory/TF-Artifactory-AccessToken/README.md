...
1. Write the JSON schema describing your resource, `tf-artifactory-accesstoken.json`
2. Implement your resource handlers in `tf_artifactory_accesstoken/handlers.py`
