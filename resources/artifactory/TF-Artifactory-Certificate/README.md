# TF::Artifactory::Certificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-artifactory-certificate.json`
2. Implement your resource handlers in `tf_artifactory_certificate/handlers.py`
