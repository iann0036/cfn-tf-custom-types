...
1. Write the JSON schema describing your resource, `tf-artifactory-virtualrepository.json`
2. Implement your resource handlers in `tf_artifactory_virtualrepository/handlers.py`
