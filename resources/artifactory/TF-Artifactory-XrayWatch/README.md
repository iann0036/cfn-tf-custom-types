...
1. Write the JSON schema describing your resource, `tf-artifactory-xraywatch.json`
2. Implement your resource handlers in `tf_artifactory_xraywatch/handlers.py`
