...
1. Write the JSON schema describing your resource, `terraform-hcloud-sshkey.json`
2. Implement your resource handlers in `terraform_hcloud_sshkey/handlers.py`
