# TF::HCloud::FloatingIp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-hcloud-floatingip.json`
2. Implement your resource handlers in `tf_hcloud_floatingip/handlers.py`
