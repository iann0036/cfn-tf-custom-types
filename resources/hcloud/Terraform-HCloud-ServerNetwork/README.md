...
1. Write the JSON schema describing your resource, `terraform-hcloud-servernetwork.json`
2. Implement your resource handlers in `terraform_hcloud_servernetwork/handlers.py`
