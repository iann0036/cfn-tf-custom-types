...
1. Write the JSON schema describing your resource, `terraform-hcloud-networkroute.json`
2. Implement your resource handlers in `terraform_hcloud_networkroute/handlers.py`
