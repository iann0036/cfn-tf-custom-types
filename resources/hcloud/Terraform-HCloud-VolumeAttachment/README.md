...
1. Write the JSON schema describing your resource, `terraform-hcloud-volumeattachment.json`
2. Implement your resource handlers in `terraform_hcloud_volumeattachment/handlers.py`
