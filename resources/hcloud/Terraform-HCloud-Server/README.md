...
1. Write the JSON schema describing your resource, `terraform-hcloud-server.json`
2. Implement your resource handlers in `terraform_hcloud_server/handlers.py`
