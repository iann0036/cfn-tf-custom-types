...
1. Write the JSON schema describing your resource, `tf-hcloud-loadbalancerservice.json`
2. Implement your resource handlers in `tf_hcloud_loadbalancerservice/handlers.py`
