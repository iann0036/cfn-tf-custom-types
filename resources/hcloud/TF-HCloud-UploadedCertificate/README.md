...
1. Write the JSON schema describing your resource, `tf-hcloud-uploadedcertificate.json`
2. Implement your resource handlers in `tf_hcloud_uploadedcertificate/handlers.py`
