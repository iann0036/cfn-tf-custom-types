...
1. Write the JSON schema describing your resource, `terraform-hcloud-floatingip.json`
2. Implement your resource handlers in `terraform_hcloud_floatingip/handlers.py`
