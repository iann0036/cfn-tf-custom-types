...
1. Write the JSON schema describing your resource, `terraform-hcloud-floatingipassignment.json`
2. Implement your resource handlers in `terraform_hcloud_floatingipassignment/handlers.py`
