...
1. Write the JSON schema describing your resource, `terraform-hcloud-networksubnet.json`
2. Implement your resource handlers in `terraform_hcloud_networksubnet/handlers.py`
