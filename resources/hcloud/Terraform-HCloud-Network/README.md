...
1. Write the JSON schema describing your resource, `terraform-hcloud-network.json`
2. Implement your resource handlers in `terraform_hcloud_network/handlers.py`
