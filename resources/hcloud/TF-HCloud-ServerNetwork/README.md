...
1. Write the JSON schema describing your resource, `tf-hcloud-servernetwork.json`
2. Implement your resource handlers in `tf_hcloud_servernetwork/handlers.py`
