...
1. Write the JSON schema describing your resource, `terraform-hcloud-volume.json`
2. Implement your resource handlers in `terraform_hcloud_volume/handlers.py`
