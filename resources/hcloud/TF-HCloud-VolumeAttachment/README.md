...
1. Write the JSON schema describing your resource, `tf-hcloud-volumeattachment.json`
2. Implement your resource handlers in `tf_hcloud_volumeattachment/handlers.py`
