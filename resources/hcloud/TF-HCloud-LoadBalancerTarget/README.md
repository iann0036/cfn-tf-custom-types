...
1. Write the JSON schema describing your resource, `tf-hcloud-loadbalancertarget.json`
2. Implement your resource handlers in `tf_hcloud_loadbalancertarget/handlers.py`
