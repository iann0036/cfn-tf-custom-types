...
1. Write the JSON schema describing your resource, `tf-hcloud-loadbalancernetwork.json`
2. Implement your resource handlers in `tf_hcloud_loadbalancernetwork/handlers.py`
