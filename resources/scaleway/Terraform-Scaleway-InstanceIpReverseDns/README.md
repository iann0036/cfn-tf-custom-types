...
1. Write the JSON schema describing your resource, `terraform-scaleway-instanceipreversedns.json`
2. Implement your resource handlers in `terraform_scaleway_instanceipreversedns/handlers.py`
