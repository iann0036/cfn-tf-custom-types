...
1. Write the JSON schema describing your resource, `terraform-scaleway-instanceplacementgroup.json`
2. Implement your resource handlers in `terraform_scaleway_instanceplacementgroup/handlers.py`
