...
1. Write the JSON schema describing your resource, `terraform-scaleway-token.json`
2. Implement your resource handlers in `terraform_scaleway_token/handlers.py`
