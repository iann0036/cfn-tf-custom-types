# TF::Scaleway::VpcPrivateNetwork

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-scaleway-vpcprivatenetwork.json`
2. Implement your resource handlers in `tf_scaleway_vpcprivatenetwork/handlers.py`
