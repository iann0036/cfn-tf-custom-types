...
1. Write the JSON schema describing your resource, `terraform-scaleway-lbcertificatebeta.json`
2. Implement your resource handlers in `terraform_scaleway_lbcertificatebeta/handlers.py`
