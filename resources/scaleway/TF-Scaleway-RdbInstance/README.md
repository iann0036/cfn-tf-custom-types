...
1. Write the JSON schema describing your resource, `tf-scaleway-rdbinstance.json`
2. Implement your resource handlers in `tf_scaleway_rdbinstance/handlers.py`
