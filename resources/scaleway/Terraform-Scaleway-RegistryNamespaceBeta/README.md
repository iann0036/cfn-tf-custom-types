...
1. Write the JSON schema describing your resource, `terraform-scaleway-registrynamespacebeta.json`
2. Implement your resource handlers in `terraform_scaleway_registrynamespacebeta/handlers.py`
