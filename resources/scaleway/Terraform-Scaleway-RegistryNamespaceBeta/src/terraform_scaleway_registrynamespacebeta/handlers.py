...
def create_handler(
    ...
    try:
        ...
        tf['resource']['scaleway_registry_namespace_beta'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['scaleway_registry_namespace_beta'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
