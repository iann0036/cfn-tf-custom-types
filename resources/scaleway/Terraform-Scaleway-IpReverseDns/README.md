...
1. Write the JSON schema describing your resource, `terraform-scaleway-ipreversedns.json`
2. Implement your resource handlers in `terraform_scaleway_ipreversedns/handlers.py`
