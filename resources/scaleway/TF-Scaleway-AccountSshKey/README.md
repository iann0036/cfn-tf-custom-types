# TF::Scaleway::AccountSshKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-scaleway-accountsshkey.json`
2. Implement your resource handlers in `tf_scaleway_accountsshkey/handlers.py`
