...
1. Write the JSON schema describing your resource, `terraform-scaleway-objectbucket.json`
2. Implement your resource handlers in `terraform_scaleway_objectbucket/handlers.py`
