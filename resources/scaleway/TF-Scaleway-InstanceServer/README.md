...
1. Write the JSON schema describing your resource, `tf-scaleway-instanceserver.json`
2. Implement your resource handlers in `tf_scaleway_instanceserver/handlers.py`
