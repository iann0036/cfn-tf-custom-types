...
1. Write the JSON schema describing your resource, `terraform-scaleway-volume.json`
2. Implement your resource handlers in `terraform_scaleway_volume/handlers.py`
