...
1. Write the JSON schema describing your resource, `terraform-scaleway-baremetalserverbeta.json`
2. Implement your resource handlers in `terraform_scaleway_baremetalserverbeta/handlers.py`
