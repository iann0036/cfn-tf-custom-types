...
1. Write the JSON schema describing your resource, `terraform-scaleway-lbfrontendbeta.json`
2. Implement your resource handlers in `terraform_scaleway_lbfrontendbeta/handlers.py`
