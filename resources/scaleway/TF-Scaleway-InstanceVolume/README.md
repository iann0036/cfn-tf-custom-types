...
1. Write the JSON schema describing your resource, `tf-scaleway-instancevolume.json`
2. Implement your resource handlers in `tf_scaleway_instancevolume/handlers.py`
