...
1. Write the JSON schema describing your resource, `terraform-scaleway-instanceip.json`
2. Implement your resource handlers in `terraform_scaleway_instanceip/handlers.py`
