# TF::Scaleway::InstanceIpReverseDns

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-scaleway-instanceipreversedns.json`
2. Implement your resource handlers in `tf_scaleway_instanceipreversedns/handlers.py`
