...
1. Write the JSON schema describing your resource, `terraform-scaleway-bucket.json`
2. Implement your resource handlers in `terraform_scaleway_bucket/handlers.py`
