...
1. Write the JSON schema describing your resource, `terraform-scaleway-sshkey.json`
2. Implement your resource handlers in `terraform_scaleway_sshkey/handlers.py`
