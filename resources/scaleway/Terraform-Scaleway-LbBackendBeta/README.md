...
1. Write the JSON schema describing your resource, `terraform-scaleway-lbbackendbeta.json`
2. Implement your resource handlers in `terraform_scaleway_lbbackendbeta/handlers.py`
