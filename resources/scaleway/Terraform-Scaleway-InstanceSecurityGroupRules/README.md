...
1. Write the JSON schema describing your resource, `terraform-scaleway-instancesecuritygrouprules.json`
2. Implement your resource handlers in `terraform_scaleway_instancesecuritygrouprules/handlers.py`
