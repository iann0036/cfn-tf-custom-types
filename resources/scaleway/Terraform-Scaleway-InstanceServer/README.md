...
1. Write the JSON schema describing your resource, `terraform-scaleway-instanceserver.json`
2. Implement your resource handlers in `terraform_scaleway_instanceserver/handlers.py`
