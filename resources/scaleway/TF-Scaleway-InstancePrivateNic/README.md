# TF::Scaleway::InstancePrivateNic

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-scaleway-instanceprivatenic.json`
2. Implement your resource handlers in `tf_scaleway_instanceprivatenic/handlers.py`
