...
1. Write the JSON schema describing your resource, `terraform-scaleway-userdata.json`
2. Implement your resource handlers in `terraform_scaleway_userdata/handlers.py`
