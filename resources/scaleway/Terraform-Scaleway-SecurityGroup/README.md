...
1. Write the JSON schema describing your resource, `terraform-scaleway-securitygroup.json`
2. Implement your resource handlers in `terraform_scaleway_securitygroup/handlers.py`
