...
1. Write the JSON schema describing your resource, `tf-scaleway-baremetalserver.json`
2. Implement your resource handlers in `tf_scaleway_baremetalserver/handlers.py`
