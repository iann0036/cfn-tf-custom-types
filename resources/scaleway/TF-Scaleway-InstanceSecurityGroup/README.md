...
1. Write the JSON schema describing your resource, `tf-scaleway-instancesecuritygroup.json`
2. Implement your resource handlers in `tf_scaleway_instancesecuritygroup/handlers.py`
