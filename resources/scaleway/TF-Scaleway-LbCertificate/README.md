...
1. Write the JSON schema describing your resource, `tf-scaleway-lbcertificate.json`
2. Implement your resource handlers in `tf_scaleway_lbcertificate/handlers.py`
