...
1. Write the JSON schema describing your resource, `terraform-scaleway-lbbeta.json`
2. Implement your resource handlers in `terraform_scaleway_lbbeta/handlers.py`
