...
1. Write the JSON schema describing your resource, `terraform-scaleway-accountsshkey.json`
2. Implement your resource handlers in `terraform_scaleway_accountsshkey/handlers.py`
