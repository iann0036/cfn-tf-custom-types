...
1. Write the JSON schema describing your resource, `terraform-scaleway-volumeattachment.json`
2. Implement your resource handlers in `terraform_scaleway_volumeattachment/handlers.py`
