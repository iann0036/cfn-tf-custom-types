...
1. Write the JSON schema describing your resource, `terraform-scaleway-securitygrouprule.json`
2. Implement your resource handlers in `terraform_scaleway_securitygrouprule/handlers.py`
