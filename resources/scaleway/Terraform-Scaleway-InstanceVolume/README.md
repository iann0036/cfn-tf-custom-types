...
1. Write the JSON schema describing your resource, `terraform-scaleway-instancevolume.json`
2. Implement your resource handlers in `terraform_scaleway_instancevolume/handlers.py`
