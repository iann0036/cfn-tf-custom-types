...
1. Write the JSON schema describing your resource, `tf-scaleway-instancesecuritygrouprules.json`
2. Implement your resource handlers in `tf_scaleway_instancesecuritygrouprules/handlers.py`
