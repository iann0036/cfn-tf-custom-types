...
1. Write the JSON schema describing your resource, `terraform-scaleway-k8sclusterbeta.json`
2. Implement your resource handlers in `terraform_scaleway_k8sclusterbeta/handlers.py`
