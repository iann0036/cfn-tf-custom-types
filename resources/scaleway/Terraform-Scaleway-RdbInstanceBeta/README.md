...
1. Write the JSON schema describing your resource, `terraform-scaleway-rdbinstancebeta.json`
2. Implement your resource handlers in `terraform_scaleway_rdbinstancebeta/handlers.py`
