...
1. Write the JSON schema describing your resource, `tf-scaleway-objectbucket.json`
2. Implement your resource handlers in `tf_scaleway_objectbucket/handlers.py`
