...
1. Write the JSON schema describing your resource, `tf-scaleway-instanceplacementgroup.json`
2. Implement your resource handlers in `tf_scaleway_instanceplacementgroup/handlers.py`
