...
1. Write the JSON schema describing your resource, `terraform-scaleway-instancesecuritygroup.json`
2. Implement your resource handlers in `terraform_scaleway_instancesecuritygroup/handlers.py`
