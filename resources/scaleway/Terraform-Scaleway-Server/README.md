...
1. Write the JSON schema describing your resource, `terraform-scaleway-server.json`
2. Implement your resource handlers in `terraform_scaleway_server/handlers.py`
