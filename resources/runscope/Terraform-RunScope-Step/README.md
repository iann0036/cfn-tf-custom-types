...
1. Write the JSON schema describing your resource, `terraform-runscope-step.json`
2. Implement your resource handlers in `terraform_runscope_step/handlers.py`
