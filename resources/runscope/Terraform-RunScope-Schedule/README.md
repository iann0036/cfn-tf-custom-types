...
1. Write the JSON schema describing your resource, `terraform-runscope-schedule.json`
2. Implement your resource handlers in `terraform_runscope_schedule/handlers.py`
