...
1. Write the JSON schema describing your resource, `terraform-runscope-bucket.json`
2. Implement your resource handlers in `terraform_runscope_bucket/handlers.py`
