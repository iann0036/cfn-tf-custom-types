...
1. Write the JSON schema describing your resource, `terraform-runscope-test.json`
2. Implement your resource handlers in `terraform_runscope_test/handlers.py`
