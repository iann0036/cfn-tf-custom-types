...
1. Write the JSON schema describing your resource, `terraform-runscope-environment.json`
2. Implement your resource handlers in `terraform_runscope_environment/handlers.py`
