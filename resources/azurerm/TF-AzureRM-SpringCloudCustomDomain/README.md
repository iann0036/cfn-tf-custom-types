...
1. Write the JSON schema describing your resource, `tf-azurerm-springcloudcustomdomain.json`
2. Implement your resource handlers in `tf_azurerm_springcloudcustomdomain/handlers.py`
