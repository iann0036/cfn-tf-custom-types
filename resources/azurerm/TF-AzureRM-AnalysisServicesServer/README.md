...
1. Write the JSON schema describing your resource, `tf-azurerm-analysisservicesserver.json`
2. Implement your resource handlers in `tf_azurerm_analysisservicesserver/handlers.py`
