# TF::AzureRM::AppServiceCertificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-appservicecertificate.json`
2. Implement your resource handlers in `tf_azurerm_appservicecertificate/handlers.py`
