...
1. Write the JSON schema describing your resource, `tf-azurerm-keyvaultmanagedhardwaresecuritymodule.json`
2. Implement your resource handlers in `tf_azurerm_keyvaultmanagedhardwaresecuritymodule/handlers.py`
