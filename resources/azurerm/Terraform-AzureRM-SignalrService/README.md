...
1. Write the JSON schema describing your resource, `terraform-azurerm-signalrservice.json`
2. Implement your resource handlers in `terraform_azurerm_signalrservice/handlers.py`
