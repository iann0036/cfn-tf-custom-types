# Terraform::AzureRM::IothubEndpointServicebusQueue

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-iothubendpointservicebusqueue.json`
2. Implement your resource handlers in `terraform_azurerm_iothubendpointservicebusqueue/handlers.py`
