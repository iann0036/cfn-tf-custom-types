...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualnetworkgateway.json`
2. Implement your resource handlers in `terraform_azurerm_virtualnetworkgateway/handlers.py`
