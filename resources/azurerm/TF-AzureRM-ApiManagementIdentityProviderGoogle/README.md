# TF::AzureRM::ApiManagementIdentityProviderGoogle

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementidentityprovidergoogle.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementidentityprovidergoogle/handlers.py`
