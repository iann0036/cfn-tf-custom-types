...
1. Write the JSON schema describing your resource, `terraform-azurerm-sharedimage.json`
2. Implement your resource handlers in `terraform_azurerm_sharedimage/handlers.py`
