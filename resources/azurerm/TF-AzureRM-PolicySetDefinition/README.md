...
1. Write the JSON schema describing your resource, `tf-azurerm-policysetdefinition.json`
2. Implement your resource handlers in `tf_azurerm_policysetdefinition/handlers.py`
