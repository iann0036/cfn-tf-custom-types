...
1. Write the JSON schema describing your resource, `terraform-azurerm-publicip.json`
2. Implement your resource handlers in `terraform_azurerm_publicip/handlers.py`
