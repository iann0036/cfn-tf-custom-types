...
1. Write the JSON schema describing your resource, `terraform-azurerm-cosmosdbaccount.json`
2. Implement your resource handlers in `terraform_azurerm_cosmosdbaccount/handlers.py`
