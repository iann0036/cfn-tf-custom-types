...
1. Write the JSON schema describing your resource, `tf-azurerm-springcloudservice.json`
2. Implement your resource handlers in `tf_azurerm_springcloudservice/handlers.py`
