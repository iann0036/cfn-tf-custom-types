...
1. Write the JSON schema describing your resource, `tf-azurerm-kustoclusterprincipalassignment.json`
2. Implement your resource handlers in `tf_azurerm_kustoclusterprincipalassignment/handlers.py`
