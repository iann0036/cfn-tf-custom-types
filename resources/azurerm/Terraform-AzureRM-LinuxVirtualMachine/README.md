...
1. Write the JSON schema describing your resource, `terraform-azurerm-linuxvirtualmachine.json`
2. Implement your resource handlers in `terraform_azurerm_linuxvirtualmachine/handlers.py`
