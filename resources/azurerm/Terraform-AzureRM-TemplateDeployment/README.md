...
1. Write the JSON schema describing your resource, `terraform-azurerm-templatedeployment.json`
2. Implement your resource handlers in `terraform_azurerm_templatedeployment/handlers.py`
