# TF::AzureRM::DnsAaaaRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-dnsaaaarecord.json`
2. Implement your resource handlers in `tf_azurerm_dnsaaaarecord/handlers.py`
