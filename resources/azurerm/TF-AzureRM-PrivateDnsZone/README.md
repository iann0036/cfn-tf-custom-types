...
1. Write the JSON schema describing your resource, `tf-azurerm-privatednszone.json`
2. Implement your resource handlers in `tf_azurerm_privatednszone/handlers.py`
