...
1. Write the JSON schema describing your resource, `tf-azurerm-policyassignment.json`
2. Implement your resource handlers in `tf_azurerm_policyassignment/handlers.py`
