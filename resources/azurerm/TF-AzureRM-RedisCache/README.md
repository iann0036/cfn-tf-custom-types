# TF::AzureRM::RedisCache

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-rediscache.json`
2. Implement your resource handlers in `tf_azurerm_rediscache/handlers.py`
