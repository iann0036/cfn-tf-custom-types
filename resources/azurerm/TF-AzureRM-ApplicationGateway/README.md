...
1. Write the JSON schema describing your resource, `tf-azurerm-applicationgateway.json`
2. Implement your resource handlers in `tf_azurerm_applicationgateway/handlers.py`
