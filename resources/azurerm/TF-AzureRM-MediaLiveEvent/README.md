...
1. Write the JSON schema describing your resource, `tf-azurerm-medialiveevent.json`
2. Implement your resource handlers in `tf_azurerm_medialiveevent/handlers.py`
