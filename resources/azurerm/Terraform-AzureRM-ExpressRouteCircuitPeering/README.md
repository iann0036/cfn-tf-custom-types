...
1. Write the JSON schema describing your resource, `terraform-azurerm-expressroutecircuitpeering.json`
2. Implement your resource handlers in `terraform_azurerm_expressroutecircuitpeering/handlers.py`
