...
def create_handler(
    ...
    try:
        ...
        tf['resource']['azurerm_express_route_circuit_peering'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['azurerm_express_route_circuit_peering'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
