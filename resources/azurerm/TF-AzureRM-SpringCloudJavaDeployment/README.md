...
1. Write the JSON schema describing your resource, `tf-azurerm-springcloudjavadeployment.json`
2. Implement your resource handlers in `tf_azurerm_springcloudjavadeployment/handlers.py`
