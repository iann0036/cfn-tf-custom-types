...
1. Write the JSON schema describing your resource, `terraform-azurerm-logicapptriggercustom.json`
2. Implement your resource handlers in `terraform_azurerm_logicapptriggercustom/handlers.py`
