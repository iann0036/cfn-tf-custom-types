...
1. Write the JSON schema describing your resource, `tf-azurerm-networkpacketcapture.json`
2. Implement your resource handlers in `tf_azurerm_networkpacketcapture/handlers.py`
