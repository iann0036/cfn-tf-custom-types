...
1. Write the JSON schema describing your resource, `terraform-azurerm-applicationgateway.json`
2. Implement your resource handlers in `terraform_azurerm_applicationgateway/handlers.py`
