...
1. Write the JSON schema describing your resource, `tf-azurerm-servicebussubscriptionrule.json`
2. Implement your resource handlers in `tf_azurerm_servicebussubscriptionrule/handlers.py`
