...
1. Write the JSON schema describing your resource, `tf-azurerm-eventhubnamespace.json`
2. Implement your resource handlers in `tf_azurerm_eventhubnamespace/handlers.py`
