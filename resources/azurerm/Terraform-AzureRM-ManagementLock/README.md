...
1. Write the JSON schema describing your resource, `terraform-azurerm-managementlock.json`
2. Implement your resource handlers in `terraform_azurerm_managementlock/handlers.py`
