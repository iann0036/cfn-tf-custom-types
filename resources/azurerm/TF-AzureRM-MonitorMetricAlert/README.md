...
1. Write the JSON schema describing your resource, `tf-azurerm-monitormetricalert.json`
2. Implement your resource handlers in `tf_azurerm_monitormetricalert/handlers.py`
