...
1. Write the JSON schema describing your resource, `tf-azurerm-automationaccount.json`
2. Implement your resource handlers in `tf_azurerm_automationaccount/handlers.py`
