...
1. Write the JSON schema describing your resource, `terraform-azurerm-applicationinsightsanalyticsitem.json`
2. Implement your resource handlers in `terraform_azurerm_applicationinsightsanalyticsitem/handlers.py`
