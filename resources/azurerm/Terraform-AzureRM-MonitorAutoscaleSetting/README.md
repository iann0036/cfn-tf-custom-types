...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitorautoscalesetting.json`
2. Implement your resource handlers in `terraform_azurerm_monitorautoscalesetting/handlers.py`
