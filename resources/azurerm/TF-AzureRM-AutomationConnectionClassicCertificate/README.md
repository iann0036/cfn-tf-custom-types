# TF::AzureRM::AutomationConnectionClassicCertificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-automationconnectionclassiccertificate.json`
2. Implement your resource handlers in `tf_azurerm_automationconnectionclassiccertificate/handlers.py`
