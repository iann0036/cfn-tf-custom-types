...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualnetworkpeering.json`
2. Implement your resource handlers in `tf_azurerm_virtualnetworkpeering/handlers.py`
