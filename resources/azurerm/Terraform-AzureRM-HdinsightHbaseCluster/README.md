...
1. Write the JSON schema describing your resource, `terraform-azurerm-hdinsighthbasecluster.json`
2. Implement your resource handlers in `terraform_azurerm_hdinsighthbasecluster/handlers.py`
