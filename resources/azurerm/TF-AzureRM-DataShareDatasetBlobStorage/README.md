...
1. Write the JSON schema describing your resource, `tf-azurerm-datasharedatasetblobstorage.json`
2. Implement your resource handlers in `tf_azurerm_datasharedatasetblobstorage/handlers.py`
