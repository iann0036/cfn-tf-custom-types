...
1. Write the JSON schema describing your resource, `terraform-azurerm-recoveryservicesvault.json`
2. Implement your resource handlers in `terraform_azurerm_recoveryservicesvault/handlers.py`
