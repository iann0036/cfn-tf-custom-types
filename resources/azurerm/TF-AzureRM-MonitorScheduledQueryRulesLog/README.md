# TF::AzureRM::MonitorScheduledQueryRulesLog

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-monitorscheduledqueryruleslog.json`
2. Implement your resource handlers in `tf_azurerm_monitorscheduledqueryruleslog/handlers.py`
