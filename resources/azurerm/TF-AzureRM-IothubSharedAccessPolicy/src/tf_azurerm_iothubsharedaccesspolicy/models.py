...
class ResourceModel(BaseModel):
    ...
    RegistryRead: Optional[bool]
    RegistryWrite: Optional[bool]
    ResourceGroupName: Optional[str]
    SecondaryConnectionString: Optional[str]
    SecondaryKey: Optional[str]
    ServiceConnect: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RegistryRead=json_data.get("RegistryRead"),
            RegistryWrite=json_data.get("RegistryWrite"),
            ResourceGroupName=json_data.get("ResourceGroupName"),
            SecondaryConnectionString=json_data.get("SecondaryConnectionString"),
            SecondaryKey=json_data.get("SecondaryKey"),
            ServiceConnect=json_data.get("ServiceConnect"),
