...
1. Write the JSON schema describing your resource, `tf-azurerm-iothubsharedaccesspolicy.json`
2. Implement your resource handlers in `tf_azurerm_iothubsharedaccesspolicy/handlers.py`
