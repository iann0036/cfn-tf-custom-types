...
1. Write the JSON schema describing your resource, `tf-azurerm-servicebusnamespacedisasterrecoveryconfig.json`
2. Implement your resource handlers in `tf_azurerm_servicebusnamespacedisasterrecoveryconfig/handlers.py`
