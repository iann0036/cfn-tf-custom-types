...
1. Write the JSON schema describing your resource, `tf-azurerm-storageobjectreplication.json`
2. Implement your resource handlers in `tf_azurerm_storageobjectreplication/handlers.py`
