# TF::AzureRM::ApiManagementUser

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementuser.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementuser/handlers.py`
