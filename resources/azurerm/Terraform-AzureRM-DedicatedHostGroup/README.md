...
1. Write the JSON schema describing your resource, `terraform-azurerm-dedicatedhostgroup.json`
2. Implement your resource handlers in `terraform_azurerm_dedicatedhostgroup/handlers.py`
