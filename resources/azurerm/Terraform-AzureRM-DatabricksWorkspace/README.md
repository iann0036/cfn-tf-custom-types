...
1. Write the JSON schema describing your resource, `terraform-azurerm-databricksworkspace.json`
2. Implement your resource handlers in `terraform_azurerm_databricksworkspace/handlers.py`
