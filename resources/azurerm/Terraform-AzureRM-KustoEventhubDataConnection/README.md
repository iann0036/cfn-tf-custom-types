...
1. Write the JSON schema describing your resource, `terraform-azurerm-kustoeventhubdataconnection.json`
2. Implement your resource handlers in `terraform_azurerm_kustoeventhubdataconnection/handlers.py`
