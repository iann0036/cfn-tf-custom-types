# TF::AzureRM::HdinsightSparkCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-hdinsightsparkcluster.json`
2. Implement your resource handlers in `tf_azurerm_hdinsightsparkcluster/handlers.py`
