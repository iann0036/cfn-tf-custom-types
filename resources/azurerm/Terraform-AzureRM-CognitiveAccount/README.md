...
1. Write the JSON schema describing your resource, `terraform-azurerm-cognitiveaccount.json`
2. Implement your resource handlers in `terraform_azurerm_cognitiveaccount/handlers.py`
