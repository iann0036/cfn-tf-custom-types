...
1. Write the JSON schema describing your resource, `terraform-azurerm-iotcentralapplication.json`
2. Implement your resource handlers in `terraform_azurerm_iotcentralapplication/handlers.py`
