...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementapischema.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementapischema/handlers.py`
