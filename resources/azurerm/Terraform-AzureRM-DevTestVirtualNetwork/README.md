...
1. Write the JSON schema describing your resource, `terraform-azurerm-devtestvirtualnetwork.json`
2. Implement your resource handlers in `terraform_azurerm_devtestvirtualnetwork/handlers.py`
