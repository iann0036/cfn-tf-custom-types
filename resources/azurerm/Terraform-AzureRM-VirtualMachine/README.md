...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualmachine.json`
2. Implement your resource handlers in `terraform_azurerm_virtualmachine/handlers.py`
