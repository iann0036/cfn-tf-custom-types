...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkinterfacesecuritygroupassociation.json`
2. Implement your resource handlers in `terraform_azurerm_networkinterfacesecuritygroupassociation/handlers.py`
