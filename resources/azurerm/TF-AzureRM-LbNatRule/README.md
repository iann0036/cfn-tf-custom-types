# TF::AzureRM::LbNatRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-lbnatrule.json`
2. Implement your resource handlers in `tf_azurerm_lbnatrule/handlers.py`
