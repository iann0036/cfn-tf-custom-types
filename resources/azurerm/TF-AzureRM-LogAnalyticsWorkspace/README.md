...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticsworkspace.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticsworkspace/handlers.py`
