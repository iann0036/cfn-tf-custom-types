...
def create_handler(
    ...
    try:
        ...
        tf['resource']['azurerm_virtual_wan'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['azurerm_virtual_wan'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
