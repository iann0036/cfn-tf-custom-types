...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualwan.json`
2. Implement your resource handlers in `terraform_azurerm_virtualwan/handlers.py`
