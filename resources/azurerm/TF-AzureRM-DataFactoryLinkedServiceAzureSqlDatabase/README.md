...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceazuresqldatabase.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceazuresqldatabase/handlers.py`
