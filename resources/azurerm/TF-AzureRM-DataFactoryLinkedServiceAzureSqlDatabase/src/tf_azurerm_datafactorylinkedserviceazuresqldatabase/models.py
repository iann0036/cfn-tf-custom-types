...
class ResourceModel(BaseModel):
    ...
    UseManagedIdentity: Optional[bool]
    KeyVaultConnectionString: Optional[Sequence["_KeyVaultConnectionStringDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            UseManagedIdentity=json_data.get("UseManagedIdentity"),
            KeyVaultConnectionString=deserialize_list(json_data.get("KeyVaultConnectionString"), KeyVaultConnectionStringDefinition),
...
@dataclass
class KeyVaultConnectionStringDefinition(BaseModel):
    LinkedServiceName: Optional[str]
    SecretName: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_KeyVaultConnectionStringDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_KeyVaultConnectionStringDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_KeyVaultConnectionStringDefinition = KeyVaultConnectionStringDefinition
