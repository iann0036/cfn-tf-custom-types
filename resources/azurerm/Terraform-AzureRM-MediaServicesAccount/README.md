...
1. Write the JSON schema describing your resource, `terraform-azurerm-mediaservicesaccount.json`
2. Implement your resource handlers in `terraform_azurerm_mediaservicesaccount/handlers.py`
