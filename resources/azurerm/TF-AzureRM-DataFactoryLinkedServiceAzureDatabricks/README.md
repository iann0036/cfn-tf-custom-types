...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceazuredatabricks.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceazuredatabricks/handlers.py`
