...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubconsumergroup.json`
2. Implement your resource handlers in `terraform_azurerm_iothubconsumergroup/handlers.py`
