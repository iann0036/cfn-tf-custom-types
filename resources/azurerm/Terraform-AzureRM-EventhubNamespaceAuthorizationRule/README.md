...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventhubnamespaceauthorizationrule.json`
2. Implement your resource handlers in `terraform_azurerm_eventhubnamespaceauthorizationrule/handlers.py`
