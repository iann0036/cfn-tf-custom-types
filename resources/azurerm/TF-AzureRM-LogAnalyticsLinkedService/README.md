...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticslinkedservice.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticslinkedservice/handlers.py`
