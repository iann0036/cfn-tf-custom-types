...
1. Write the JSON schema describing your resource, `tf-azurerm-redisenterprisedatabase.json`
2. Implement your resource handlers in `tf_azurerm_redisenterprisedatabase/handlers.py`
