...
1. Write the JSON schema describing your resource, `tf-azurerm-searchservice.json`
2. Implement your resource handlers in `tf_azurerm_searchservice/handlers.py`
