...
<pre>
{
    "Type" : "TF::AzureRM::SearchService",
    "Properties" : {
        "<a href="#allowedips" title="AllowedIps">AllowedIps</a>" : <i>[ String, ... ]</i>,
        ...
        "<a href="#replicacount" title="ReplicaCount">ReplicaCount</a>" : <i>Double</i>,
...
Type: TF::AzureRM::SearchService
Properties:
    <a href="#allowedips" title="AllowedIps">AllowedIps</a>: <i>
      - String</i>
    <a href="#location" title="Location">Location</a>: <i>String</i>
    <a href="#name" title="Name">Name</a>: <i>String</i>
    <a href="#partitioncount" title="PartitionCount">PartitionCount</a>: <i>Double</i>
...
Returns the <code>QueryKeys</code> value.
