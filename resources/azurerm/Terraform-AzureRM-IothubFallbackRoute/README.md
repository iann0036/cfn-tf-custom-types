...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubfallbackroute.json`
2. Implement your resource handlers in `terraform_azurerm_iothubfallbackroute/handlers.py`
