...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementbackend.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementbackend/handlers.py`
