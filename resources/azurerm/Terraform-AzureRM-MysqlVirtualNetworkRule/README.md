...
1. Write the JSON schema describing your resource, `terraform-azurerm-mysqlvirtualnetworkrule.json`
2. Implement your resource handlers in `terraform_azurerm_mysqlvirtualnetworkrule/handlers.py`
