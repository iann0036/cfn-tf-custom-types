# TF::AzureRM::StorageQueue

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-storagequeue.json`
2. Implement your resource handlers in `tf_azurerm_storagequeue/handlers.py`
