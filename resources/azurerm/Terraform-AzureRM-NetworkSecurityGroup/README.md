...
1. Write the JSON schema describing your resource, `terraform-azurerm-networksecuritygroup.json`
2. Implement your resource handlers in `terraform_azurerm_networksecuritygroup/handlers.py`
