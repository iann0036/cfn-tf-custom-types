...
1. Write the JSON schema describing your resource, `tf-azurerm-resourcegrouptemplatedeployment.json`
2. Implement your resource handlers in `tf_azurerm_resourcegrouptemplatedeployment/handlers.py`
