...
1. Write the JSON schema describing your resource, `tf-azurerm-automationmodule.json`
2. Implement your resource handlers in `tf_azurerm_automationmodule/handlers.py`
