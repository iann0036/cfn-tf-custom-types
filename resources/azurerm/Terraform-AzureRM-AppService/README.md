...
1. Write the JSON schema describing your resource, `terraform-azurerm-appservice.json`
2. Implement your resource handlers in `terraform_azurerm_appservice/handlers.py`
