...
1. Write the JSON schema describing your resource, `terraform-azurerm-roledefinition.json`
2. Implement your resource handlers in `terraform_azurerm_roledefinition/handlers.py`
