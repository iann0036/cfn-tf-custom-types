...
1. Write the JSON schema describing your resource, `terraform-azurerm-vpngateway.json`
2. Implement your resource handlers in `terraform_azurerm_vpngateway/handlers.py`
