...
1. Write the JSON schema describing your resource, `terraform-azurerm-trafficmanagerendpoint.json`
2. Implement your resource handlers in `terraform_azurerm_trafficmanagerendpoint/handlers.py`
