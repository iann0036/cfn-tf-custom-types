...
1. Write the JSON schema describing your resource, `tf-azurerm-resourcegroup.json`
2. Implement your resource handlers in `tf_azurerm_resourcegroup/handlers.py`
