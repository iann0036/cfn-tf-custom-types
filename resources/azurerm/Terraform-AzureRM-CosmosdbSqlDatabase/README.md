...
1. Write the JSON schema describing your resource, `terraform-azurerm-cosmosdbsqldatabase.json`
2. Implement your resource handlers in `terraform_azurerm_cosmosdbsqldatabase/handlers.py`
