...
1. Write the JSON schema describing your resource, `terraform-azurerm-batchaccount.json`
2. Implement your resource handlers in `terraform_azurerm_batchaccount/handlers.py`
