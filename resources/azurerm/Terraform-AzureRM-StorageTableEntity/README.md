...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagetableentity.json`
2. Implement your resource handlers in `terraform_azurerm_storagetableentity/handlers.py`
