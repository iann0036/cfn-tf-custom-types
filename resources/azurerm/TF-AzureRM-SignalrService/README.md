...
1. Write the JSON schema describing your resource, `tf-azurerm-signalrservice.json`
2. Implement your resource handlers in `tf_azurerm_signalrservice/handlers.py`
