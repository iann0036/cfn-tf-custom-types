...
1. Write the JSON schema describing your resource, `terraform-azurerm-policyassignment.json`
2. Implement your resource handlers in `terraform_azurerm_policyassignment/handlers.py`
