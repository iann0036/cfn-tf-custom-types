...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagesharedirectory.json`
2. Implement your resource handlers in `terraform_azurerm_storagesharedirectory/handlers.py`
