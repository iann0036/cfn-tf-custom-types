...
1. Write the JSON schema describing your resource, `tf-azurerm-expressroutecircuitpeering.json`
2. Implement your resource handlers in `tf_azurerm_expressroutecircuitpeering/handlers.py`
