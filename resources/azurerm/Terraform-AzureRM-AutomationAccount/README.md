...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationaccount.json`
2. Implement your resource handlers in `terraform_azurerm_automationaccount/handlers.py`
