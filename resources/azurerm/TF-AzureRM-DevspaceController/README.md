...
1. Write the JSON schema describing your resource, `tf-azurerm-devspacecontroller.json`
2. Implement your resource handlers in `tf_azurerm_devspacecontroller/handlers.py`
