...
1. Write the JSON schema describing your resource, `tf-azurerm-hpccachenfstarget.json`
2. Implement your resource handlers in `tf_azurerm_hpccachenfstarget/handlers.py`
