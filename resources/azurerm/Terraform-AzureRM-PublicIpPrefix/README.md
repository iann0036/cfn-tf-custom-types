...
1. Write the JSON schema describing your resource, `terraform-azurerm-publicipprefix.json`
2. Implement your resource handlers in `terraform_azurerm_publicipprefix/handlers.py`
