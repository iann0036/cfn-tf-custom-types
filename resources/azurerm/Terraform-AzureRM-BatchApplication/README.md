...
1. Write the JSON schema describing your resource, `terraform-azurerm-batchapplication.json`
2. Implement your resource handlers in `terraform_azurerm_batchapplication/handlers.py`
