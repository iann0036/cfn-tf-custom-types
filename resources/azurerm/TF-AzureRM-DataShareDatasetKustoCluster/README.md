...
1. Write the JSON schema describing your resource, `tf-azurerm-datasharedatasetkustocluster.json`
2. Implement your resource handlers in `tf_azurerm_datasharedatasetkustocluster/handlers.py`
