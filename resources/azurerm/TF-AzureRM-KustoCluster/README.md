...
1. Write the JSON schema describing your resource, `tf-azurerm-kustocluster.json`
2. Implement your resource handlers in `tf_azurerm_kustocluster/handlers.py`
