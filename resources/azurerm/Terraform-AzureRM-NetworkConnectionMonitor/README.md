# Terraform::AzureRM::NetworkConnectionMonitor

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-networkconnectionmonitor.json`
2. Implement your resource handlers in `terraform_azurerm_networkconnectionmonitor/handlers.py`
