...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualhubconnection.json`
2. Implement your resource handlers in `terraform_azurerm_virtualhubconnection/handlers.py`
