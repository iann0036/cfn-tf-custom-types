...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebustopicauthorizationrule.json`
2. Implement your resource handlers in `terraform_azurerm_servicebustopicauthorizationrule/handlers.py`
