...
1. Write the JSON schema describing your resource, `tf-azurerm-firewallpolicy.json`
2. Implement your resource handlers in `tf_azurerm_firewallpolicy/handlers.py`
