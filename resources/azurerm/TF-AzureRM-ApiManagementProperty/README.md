# TF::AzureRM::ApiManagementProperty

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementproperty.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementproperty/handlers.py`
