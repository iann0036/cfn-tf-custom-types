...
1. Write the JSON schema describing your resource, `terraform-azurerm-appservicesourcecontroltoken.json`
2. Implement your resource handlers in `terraform_azurerm_appservicesourcecontroltoken/handlers.py`
