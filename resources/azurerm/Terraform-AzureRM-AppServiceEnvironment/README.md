...
1. Write the JSON schema describing your resource, `terraform-azurerm-appserviceenvironment.json`
2. Implement your resource handlers in `terraform_azurerm_appserviceenvironment/handlers.py`
