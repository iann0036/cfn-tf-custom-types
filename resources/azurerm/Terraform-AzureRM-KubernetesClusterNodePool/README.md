...
1. Write the JSON schema describing your resource, `terraform-azurerm-kubernetesclusternodepool.json`
2. Implement your resource handlers in `terraform_azurerm_kubernetesclusternodepool/handlers.py`
