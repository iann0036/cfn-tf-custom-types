# TF::AzureRM::CustomProvider

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-customprovider.json`
2. Implement your resource handlers in `tf_azurerm_customprovider/handlers.py`
