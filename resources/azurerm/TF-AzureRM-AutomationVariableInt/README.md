# TF::AzureRM::AutomationVariableInt

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-automationvariableint.json`
2. Implement your resource handlers in `tf_azurerm_automationvariableint/handlers.py`
