# TF::AzureRM::EventhubAuthorizationRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-eventhubauthorizationrule.json`
2. Implement your resource handlers in `tf_azurerm_eventhubauthorizationrule/handlers.py`
