...
1. Write the JSON schema describing your resource, `tf-azurerm-logicappworkflow.json`
2. Implement your resource handlers in `tf_azurerm_logicappworkflow/handlers.py`
