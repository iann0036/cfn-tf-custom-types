...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    IntegrationServiceEnvironmentId: Optional[str]
    Location: Optional[str]
    LogicAppIntegrationAccountId: Optional[str]
    Name: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            IntegrationServiceEnvironmentId=json_data.get("IntegrationServiceEnvironmentId"),
            Location=json_data.get("Location"),
            LogicAppIntegrationAccountId=json_data.get("LogicAppIntegrationAccountId"),
