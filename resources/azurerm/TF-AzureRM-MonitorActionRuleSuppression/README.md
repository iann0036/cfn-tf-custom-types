...
1. Write the JSON schema describing your resource, `tf-azurerm-monitoractionrulesuppression.json`
2. Implement your resource handlers in `tf_azurerm_monitoractionrulesuppression/handlers.py`
