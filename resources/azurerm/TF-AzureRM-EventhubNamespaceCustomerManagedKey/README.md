...
1. Write the JSON schema describing your resource, `tf-azurerm-eventhubnamespacecustomermanagedkey.json`
2. Implement your resource handlers in `tf_azurerm_eventhubnamespacecustomermanagedkey/handlers.py`
