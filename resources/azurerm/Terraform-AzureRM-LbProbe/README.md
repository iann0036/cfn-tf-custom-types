...
1. Write the JSON schema describing your resource, `terraform-azurerm-lbprobe.json`
2. Implement your resource handlers in `terraform_azurerm_lbprobe/handlers.py`
