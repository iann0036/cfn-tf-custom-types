...
1. Write the JSON schema describing your resource, `tf-azurerm-lbbackendaddresspool.json`
2. Implement your resource handlers in `tf_azurerm_lbbackendaddresspool/handlers.py`
