...
1. Write the JSON schema describing your resource, `tf-azurerm-monitordiagnosticsetting.json`
2. Implement your resource handlers in `tf_azurerm_monitordiagnosticsetting/handlers.py`
