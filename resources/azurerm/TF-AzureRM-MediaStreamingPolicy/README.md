...
1. Write the JSON schema describing your resource, `tf-azurerm-mediastreamingpolicy.json`
2. Implement your resource handlers in `tf_azurerm_mediastreamingpolicy/handlers.py`
