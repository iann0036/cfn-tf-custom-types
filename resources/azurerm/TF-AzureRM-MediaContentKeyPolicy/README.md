...
1. Write the JSON schema describing your resource, `tf-azurerm-mediacontentkeypolicy.json`
2. Implement your resource handlers in `tf_azurerm_mediacontentkeypolicy/handlers.py`
