...
1. Write the JSON schema describing your resource, `tf-azurerm-iothubdpssharedaccesspolicy.json`
2. Implement your resource handlers in `tf_azurerm_iothubdpssharedaccesspolicy/handlers.py`
