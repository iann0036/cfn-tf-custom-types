...
1. Write the JSON schema describing your resource, `terraform-azurerm-netapppool.json`
2. Implement your resource handlers in `terraform_azurerm_netapppool/handlers.py`
