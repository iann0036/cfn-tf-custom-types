...
1. Write the JSON schema describing your resource, `tf-azurerm-servicefabricmeshsecretvalue.json`
2. Implement your resource handlers in `tf_azurerm_servicefabricmeshsecretvalue/handlers.py`
