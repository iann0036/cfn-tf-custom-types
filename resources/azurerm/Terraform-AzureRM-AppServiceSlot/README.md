...
1. Write the JSON schema describing your resource, `terraform-azurerm-appserviceslot.json`
2. Implement your resource handlers in `terraform_azurerm_appserviceslot/handlers.py`
