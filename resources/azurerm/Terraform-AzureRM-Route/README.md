...
1. Write the JSON schema describing your resource, `terraform-azurerm-route.json`
2. Implement your resource handlers in `terraform_azurerm_route/handlers.py`
