...
1. Write the JSON schema describing your resource, `terraform-azurerm-mariadbdatabase.json`
2. Implement your resource handlers in `terraform_azurerm_mariadbdatabase/handlers.py`
