...
1. Write the JSON schema describing your resource, `terraform-azurerm-expressroutecircuitauthorization.json`
2. Implement your resource handlers in `terraform_azurerm_expressroutecircuitauthorization/handlers.py`
