...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagemanagementpolicy.json`
2. Implement your resource handlers in `terraform_azurerm_storagemanagementpolicy/handlers.py`
