...
1. Write the JSON schema describing your resource, `terraform-azurerm-siterecoveryprotectioncontainermapping.json`
2. Implement your resource handlers in `terraform_azurerm_siterecoveryprotectioncontainermapping/handlers.py`
