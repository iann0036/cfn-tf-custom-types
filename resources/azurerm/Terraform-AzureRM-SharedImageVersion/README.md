...
1. Write the JSON schema describing your resource, `terraform-azurerm-sharedimageversion.json`
2. Implement your resource handlers in `terraform_azurerm_sharedimageversion/handlers.py`
