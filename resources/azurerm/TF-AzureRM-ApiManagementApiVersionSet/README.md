...
1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementapiversionset.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementapiversionset/handlers.py`
