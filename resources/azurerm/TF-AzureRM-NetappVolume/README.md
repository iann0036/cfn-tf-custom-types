...
1. Write the JSON schema describing your resource, `tf-azurerm-netappvolume.json`
2. Implement your resource handlers in `tf_azurerm_netappvolume/handlers.py`
