...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactorylinkedservicesqlserver.json`
2. Implement your resource handlers in `terraform_azurerm_datafactorylinkedservicesqlserver/handlers.py`
