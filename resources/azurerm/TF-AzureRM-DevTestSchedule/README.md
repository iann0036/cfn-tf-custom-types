...
1. Write the JSON schema describing your resource, `tf-azurerm-devtestschedule.json`
2. Implement your resource handlers in `tf_azurerm_devtestschedule/handlers.py`
