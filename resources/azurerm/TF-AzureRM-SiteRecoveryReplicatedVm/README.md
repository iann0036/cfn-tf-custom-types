...
1. Write the JSON schema describing your resource, `tf-azurerm-siterecoveryreplicatedvm.json`
2. Implement your resource handlers in `tf_azurerm_siterecoveryreplicatedvm/handlers.py`
