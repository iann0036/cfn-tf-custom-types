...
1. Write the JSON schema describing your resource, `tf-azurerm-sqlfailovergroup.json`
2. Implement your resource handlers in `tf_azurerm_sqlfailovergroup/handlers.py`
