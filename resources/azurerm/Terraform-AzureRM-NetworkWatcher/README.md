...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkwatcher.json`
2. Implement your resource handlers in `terraform_azurerm_networkwatcher/handlers.py`
