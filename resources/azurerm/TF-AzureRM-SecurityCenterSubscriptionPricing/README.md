...
1. Write the JSON schema describing your resource, `tf-azurerm-securitycentersubscriptionpricing.json`
2. Implement your resource handlers in `tf_azurerm_securitycentersubscriptionpricing/handlers.py`
