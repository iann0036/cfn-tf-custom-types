...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitoractivitylogalert.json`
2. Implement your resource handlers in `terraform_azurerm_monitoractivitylogalert/handlers.py`
