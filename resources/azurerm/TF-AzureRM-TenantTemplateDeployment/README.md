...
1. Write the JSON schema describing your resource, `tf-azurerm-tenanttemplatedeployment.json`
2. Implement your resource handlers in `tf_azurerm_tenanttemplatedeployment/handlers.py`
