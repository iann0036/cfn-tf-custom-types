...
1. Write the JSON schema describing your resource, `terraform-azurerm-lbbackendaddresspool.json`
2. Implement your resource handlers in `terraform_azurerm_lbbackendaddresspool/handlers.py`
