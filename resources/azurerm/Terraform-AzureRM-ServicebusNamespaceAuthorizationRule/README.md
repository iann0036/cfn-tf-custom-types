...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebusnamespaceauthorizationrule.json`
2. Implement your resource handlers in `terraform_azurerm_servicebusnamespaceauthorizationrule/handlers.py`
