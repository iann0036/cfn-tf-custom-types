...
1. Write the JSON schema describing your resource, `terraform-azurerm-relayhybridconnection.json`
2. Implement your resource handlers in `terraform_azurerm_relayhybridconnection/handlers.py`
