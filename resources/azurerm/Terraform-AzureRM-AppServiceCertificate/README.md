...
1. Write the JSON schema describing your resource, `terraform-azurerm-appservicecertificate.json`
2. Implement your resource handlers in `terraform_azurerm_appservicecertificate/handlers.py`
