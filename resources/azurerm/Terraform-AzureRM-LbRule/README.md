...
1. Write the JSON schema describing your resource, `terraform-azurerm-lbrule.json`
2. Implement your resource handlers in `terraform_azurerm_lbrule/handlers.py`
