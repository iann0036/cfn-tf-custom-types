# TF::AzureRM::BotConnection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-botconnection.json`
2. Implement your resource handlers in `tf_azurerm_botconnection/handlers.py`
