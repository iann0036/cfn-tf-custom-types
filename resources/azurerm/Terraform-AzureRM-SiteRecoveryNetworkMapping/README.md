...
1. Write the JSON schema describing your resource, `terraform-azurerm-siterecoverynetworkmapping.json`
2. Implement your resource handlers in `terraform_azurerm_siterecoverynetworkmapping/handlers.py`
