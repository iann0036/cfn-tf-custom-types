...
1. Write the JSON schema describing your resource, `tf-azurerm-lighthousedefinition.json`
2. Implement your resource handlers in `tf_azurerm_lighthousedefinition/handlers.py`
