...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    LighthouseDefinitionId: Optional[str]
    ManagingTenantId: Optional[str]
    Name: Optional[str]
    Scope: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            LighthouseDefinitionId=json_data.get("LighthouseDefinitionId"),
            ManagingTenantId=json_data.get("ManagingTenantId"),
...
class AuthorizationDefinition(BaseModel):
    DelegatedRoleDefinitionIds: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            DelegatedRoleDefinitionIds=json_data.get("DelegatedRoleDefinitionIds"),
            PrincipalDisplayName=json_data.get("PrincipalDisplayName"),
