...
class ResourceModel(BaseModel):
    ...
    ContainerNetworkInterface: Optional[Sequence["_ContainerNetworkInterfaceDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ContainerNetworkInterface=deserialize_list(json_data.get("ContainerNetworkInterface"), ContainerNetworkInterfaceDefinition),
...
@dataclass
class ContainerNetworkInterfaceDefinition(BaseModel):
    Name: Optional[str]
    IpConfiguration: Optional[Sequence["_IpConfigurationDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_ContainerNetworkInterfaceDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ContainerNetworkInterfaceDefinition"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
# work around possible type aliasing issues when variable has same name as a model
_ContainerNetworkInterfaceDefinition = ContainerNetworkInterfaceDefinition
