...
1. Write the JSON schema describing your resource, `tf-azurerm-networkprofile.json`
2. Implement your resource handlers in `tf_azurerm_networkprofile/handlers.py`
