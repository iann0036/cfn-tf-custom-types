...
1. Write the JSON schema describing your resource, `terraform-azurerm-datalakestore.json`
2. Implement your resource handlers in `terraform_azurerm_datalakestore/handlers.py`
