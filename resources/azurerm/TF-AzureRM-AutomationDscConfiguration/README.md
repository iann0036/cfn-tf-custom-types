# TF::AzureRM::AutomationDscConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-automationdscconfiguration.json`
2. Implement your resource handlers in `tf_azurerm_automationdscconfiguration/handlers.py`
