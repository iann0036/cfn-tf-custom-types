...
1. Write the JSON schema describing your resource, `terraform-azurerm-logicapptriggerhttprequest.json`
2. Implement your resource handlers in `terraform_azurerm_logicapptriggerhttprequest/handlers.py`
