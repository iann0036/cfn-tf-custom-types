...
1. Write the JSON schema describing your resource, `terraform-azurerm-databasemigrationproject.json`
2. Implement your resource handlers in `terraform_azurerm_databasemigrationproject/handlers.py`
