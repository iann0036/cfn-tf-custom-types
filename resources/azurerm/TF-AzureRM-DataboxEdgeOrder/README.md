...
1. Write the JSON schema describing your resource, `tf-azurerm-databoxedgeorder.json`
2. Implement your resource handlers in `tf_azurerm_databoxedgeorder/handlers.py`
