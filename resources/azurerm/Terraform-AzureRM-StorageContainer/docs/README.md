...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#hasimmutabilitypolicy" title="HasImmutabilityPolicy">HasImmutabilityPolicy</a>" : <i>Boolean</i>,
        "<a href="#haslegalhold" title="HasLegalHold">HasLegalHold</a>" : <i>Boolean</i>,
