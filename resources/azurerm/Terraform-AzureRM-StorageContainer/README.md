...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagecontainer.json`
2. Implement your resource handlers in `terraform_azurerm_storagecontainer/handlers.py`
