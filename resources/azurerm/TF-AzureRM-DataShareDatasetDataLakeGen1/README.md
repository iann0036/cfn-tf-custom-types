...
1. Write the JSON schema describing your resource, `tf-azurerm-datasharedatasetdatalakegen1.json`
2. Implement your resource handlers in `tf_azurerm_datasharedatasetdatalakegen1/handlers.py`
