...
class ResourceModel(BaseModel):
    ...
    Url: Optional[str]
    BasicAuthentication: Optional[Sequence["_BasicAuthenticationDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BasicAuthentication=deserialize_list(json_data.get("BasicAuthentication"), BasicAuthenticationDefinition),
...
@dataclass
class BasicAuthenticationDefinition(BaseModel):
    Password: Optional[str]
    Username: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_BasicAuthenticationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BasicAuthenticationDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_BasicAuthenticationDefinition = BasicAuthenticationDefinition
