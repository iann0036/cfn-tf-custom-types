...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceodata.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceodata/handlers.py`
