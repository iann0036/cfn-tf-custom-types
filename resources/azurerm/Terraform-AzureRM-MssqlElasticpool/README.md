...
1. Write the JSON schema describing your resource, `terraform-azurerm-mssqlelasticpool.json`
2. Implement your resource handlers in `terraform_azurerm_mssqlelasticpool/handlers.py`
