...
1. Write the JSON schema describing your resource, `tf-azurerm-sentineldataconnectormicrosoftcloudappsecurity.json`
2. Implement your resource handlers in `tf_azurerm_sentineldataconnectormicrosoftcloudappsecurity/handlers.py`
