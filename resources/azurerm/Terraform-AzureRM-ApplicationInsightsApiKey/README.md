...
1. Write the JSON schema describing your resource, `terraform-azurerm-applicationinsightsapikey.json`
2. Implement your resource handlers in `terraform_azurerm_applicationinsightsapikey/handlers.py`
