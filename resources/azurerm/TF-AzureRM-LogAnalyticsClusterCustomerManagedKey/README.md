...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticsclustercustomermanagedkey.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticsclustercustomermanagedkey/handlers.py`
