...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualmachinescalesetextension.json`
2. Implement your resource handlers in `tf_azurerm_virtualmachinescalesetextension/handlers.py`
