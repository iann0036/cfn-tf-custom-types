...
1. Write the JSON schema describing your resource, `terraform-azurerm-lbnatrule.json`
2. Implement your resource handlers in `terraform_azurerm_lbnatrule/handlers.py`
