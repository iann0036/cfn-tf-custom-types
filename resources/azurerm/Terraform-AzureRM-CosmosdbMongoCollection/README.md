...
1. Write the JSON schema describing your resource, `terraform-azurerm-cosmosdbmongocollection.json`
2. Implement your resource handlers in `terraform_azurerm_cosmosdbmongocollection/handlers.py`
