...
def create_handler(
    ...
    try:
        ...
        tf['resource']['azurerm_cosmosdb_mongo_collection'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['azurerm_cosmosdb_mongo_collection'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
