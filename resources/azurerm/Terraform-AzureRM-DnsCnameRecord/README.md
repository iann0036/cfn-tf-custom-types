...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnscnamerecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnscnamerecord/handlers.py`
