...
1. Write the JSON schema describing your resource, `terraform-azurerm-dashboard.json`
2. Implement your resource handlers in `terraform_azurerm_dashboard/handlers.py`
