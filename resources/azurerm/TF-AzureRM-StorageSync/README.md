# TF::AzureRM::StorageSync

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-storagesync.json`
2. Implement your resource handlers in `tf_azurerm_storagesync/handlers.py`
