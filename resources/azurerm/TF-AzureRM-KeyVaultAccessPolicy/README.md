...
1. Write the JSON schema describing your resource, `tf-azurerm-keyvaultaccesspolicy.json`
2. Implement your resource handlers in `tf_azurerm_keyvaultaccesspolicy/handlers.py`
