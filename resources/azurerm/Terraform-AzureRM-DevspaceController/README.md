...
1. Write the JSON schema describing your resource, `terraform-azurerm-devspacecontroller.json`
2. Implement your resource handlers in `terraform_azurerm_devspacecontroller/handlers.py`
