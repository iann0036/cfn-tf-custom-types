# TF::AzureRM::PrivateDnsPtrRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-privatednsptrrecord.json`
2. Implement your resource handlers in `tf_azurerm_privatednsptrrecord/handlers.py`
