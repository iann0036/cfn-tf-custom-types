...
1. Write the JSON schema describing your resource, `tf-azurerm-devtestglobalvmshutdownschedule.json`
2. Implement your resource handlers in `tf_azurerm_devtestglobalvmshutdownschedule/handlers.py`
