...
1. Write the JSON schema describing your resource, `tf-azurerm-windowsvirtualmachine.json`
2. Implement your resource handlers in `tf_azurerm_windowsvirtualmachine/handlers.py`
