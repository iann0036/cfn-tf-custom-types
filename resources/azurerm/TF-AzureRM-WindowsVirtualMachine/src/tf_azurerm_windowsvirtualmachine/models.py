...
class ResourceModel(BaseModel):
    ...
    AdditionalUnattendContent: Optional[Sequence["_AdditionalUnattendContentDefinition"]]
    ...
    WinrmListener: Optional[Sequence["_WinrmListenerDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PatchMode=json_data.get("PatchMode"),
            ...
            AdditionalUnattendContent=deserialize_list(json_data.get("AdditionalUnattendContent"), AdditionalUnattendContentDefinition),
            ...
            WinrmListener=deserialize_list(json_data.get("WinrmListener"), WinrmListenerDefinition),
        )
...
@dataclass
class AdditionalUnattendContentDefinition(BaseModel):
    Content: Optional[str]
    Setting: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AdditionalUnattendContentDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AdditionalUnattendContentDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AdditionalUnattendContentDefinition = AdditionalUnattendContentDefinition
...
@dataclass
class WinrmListenerDefinition(BaseModel):
    CertificateUrl: Optional[str]
    Protocol: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_WinrmListenerDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_WinrmListenerDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_WinrmListenerDefinition = WinrmListenerDefinition
