...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationvariableint.json`
2. Implement your resource handlers in `terraform_azurerm_automationvariableint/handlers.py`
