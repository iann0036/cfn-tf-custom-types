...
1. Write the JSON schema describing your resource, `terraform-azurerm-logicappactionhttp.json`
2. Implement your resource handlers in `terraform_azurerm_logicappactionhttp/handlers.py`
