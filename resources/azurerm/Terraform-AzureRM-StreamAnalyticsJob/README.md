...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsjob.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsjob/handlers.py`
