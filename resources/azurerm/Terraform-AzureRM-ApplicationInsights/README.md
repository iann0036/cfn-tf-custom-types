...
1. Write the JSON schema describing your resource, `terraform-azurerm-applicationinsights.json`
2. Implement your resource handlers in `terraform_azurerm_applicationinsights/handlers.py`
