# TF::AzureRM::ServiceFabricMeshApplication

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-servicefabricmeshapplication.json`
2. Implement your resource handlers in `tf_azurerm_servicefabricmeshapplication/handlers.py`
