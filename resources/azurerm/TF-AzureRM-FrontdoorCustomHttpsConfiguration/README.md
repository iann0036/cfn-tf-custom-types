...
1. Write the JSON schema describing your resource, `tf-azurerm-frontdoorcustomhttpsconfiguration.json`
2. Implement your resource handlers in `tf_azurerm_frontdoorcustomhttpsconfiguration/handlers.py`
