...
1. Write the JSON schema describing your resource, `terraform-azurerm-packetcapture.json`
2. Implement your resource handlers in `terraform_azurerm_packetcapture/handlers.py`
