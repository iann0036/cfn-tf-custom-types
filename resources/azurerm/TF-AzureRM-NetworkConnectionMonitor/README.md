...
1. Write the JSON schema describing your resource, `tf-azurerm-networkconnectionmonitor.json`
2. Implement your resource handlers in `tf_azurerm_networkconnectionmonitor/handlers.py`
