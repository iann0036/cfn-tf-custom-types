...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedservicecosmosdb.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedservicecosmosdb/handlers.py`
