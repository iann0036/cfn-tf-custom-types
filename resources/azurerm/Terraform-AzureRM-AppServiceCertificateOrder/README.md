...
1. Write the JSON schema describing your resource, `terraform-azurerm-appservicecertificateorder.json`
2. Implement your resource handlers in `terraform_azurerm_appservicecertificateorder/handlers.py`
