# TF::AzureRM::AutomationCertificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-automationcertificate.json`
2. Implement your resource handlers in `tf_azurerm_automationcertificate/handlers.py`
