...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagedatalakegen2filesystem.json`
2. Implement your resource handlers in `terraform_azurerm_storagedatalakegen2filesystem/handlers.py`
