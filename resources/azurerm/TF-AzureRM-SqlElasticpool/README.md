...
1. Write the JSON schema describing your resource, `tf-azurerm-sqlelasticpool.json`
2. Implement your resource handlers in `tf_azurerm_sqlelasticpool/handlers.py`
