...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventgriddomain.json`
2. Implement your resource handlers in `terraform_azurerm_eventgriddomain/handlers.py`
