...
1. Write the JSON schema describing your resource, `terraform-azurerm-kustodatabase.json`
2. Implement your resource handlers in `terraform_azurerm_kustodatabase/handlers.py`
