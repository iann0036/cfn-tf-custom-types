...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactorypipeline.json`
2. Implement your resource handlers in `terraform_azurerm_datafactorypipeline/handlers.py`
