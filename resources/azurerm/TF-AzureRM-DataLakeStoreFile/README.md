# TF::AzureRM::DataLakeStoreFile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datalakestorefile.json`
2. Implement your resource handlers in `tf_azurerm_datalakestorefile/handlers.py`
