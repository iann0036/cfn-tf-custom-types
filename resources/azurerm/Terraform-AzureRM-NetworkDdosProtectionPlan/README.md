...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkddosprotectionplan.json`
2. Implement your resource handlers in `terraform_azurerm_networkddosprotectionplan/handlers.py`
