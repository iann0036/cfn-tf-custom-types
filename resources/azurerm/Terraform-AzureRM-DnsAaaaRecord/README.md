...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnsaaaarecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnsaaaarecord/handlers.py`
