# TF::AzureRM::StorageSyncGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-storagesyncgroup.json`
2. Implement your resource handlers in `tf_azurerm_storagesyncgroup/handlers.py`
