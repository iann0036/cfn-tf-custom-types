...
1. Write the JSON schema describing your resource, `terraform-azurerm-subnetroutetableassociation.json`
2. Implement your resource handlers in `terraform_azurerm_subnetroutetableassociation/handlers.py`
