# TF::AzureRM::FirewallNetworkRuleCollection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-firewallnetworkrulecollection.json`
2. Implement your resource handlers in `tf_azurerm_firewallnetworkrulecollection/handlers.py`
