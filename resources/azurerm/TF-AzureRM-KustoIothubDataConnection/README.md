...
1. Write the JSON schema describing your resource, `tf-azurerm-kustoiothubdataconnection.json`
2. Implement your resource handlers in `tf_azurerm_kustoiothubdataconnection/handlers.py`
