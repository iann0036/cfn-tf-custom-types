...
1. Write the JSON schema describing your resource, `terraform-azurerm-privatednszone.json`
2. Implement your resource handlers in `terraform_azurerm_privatednszone/handlers.py`
