...
1. Write the JSON schema describing your resource, `terraform-azurerm-linuxvirtualmachinescaleset.json`
2. Implement your resource handlers in `terraform_azurerm_linuxvirtualmachinescaleset/handlers.py`
