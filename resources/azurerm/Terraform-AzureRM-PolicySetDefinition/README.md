...
1. Write the JSON schema describing your resource, `terraform-azurerm-policysetdefinition.json`
2. Implement your resource handlers in `terraform_azurerm_policysetdefinition/handlers.py`
