...
1. Write the JSON schema describing your resource, `tf-azurerm-monitoraaddiagnosticsetting.json`
2. Implement your resource handlers in `tf_azurerm_monitoraaddiagnosticsetting/handlers.py`
