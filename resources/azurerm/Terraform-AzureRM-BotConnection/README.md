...
1. Write the JSON schema describing your resource, `terraform-azurerm-botconnection.json`
2. Implement your resource handlers in `terraform_azurerm_botconnection/handlers.py`
