...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqlelasticpool.json`
2. Implement your resource handlers in `terraform_azurerm_sqlelasticpool/handlers.py`
