...
1. Write the JSON schema describing your resource, `terraform-azurerm-backuppolicyvm.json`
2. Implement your resource handlers in `terraform_azurerm_backuppolicyvm/handlers.py`
