...
1. Write the JSON schema describing your resource, `terraform-azurerm-analysisservicesserver.json`
2. Implement your resource handlers in `terraform_azurerm_analysisservicesserver/handlers.py`
