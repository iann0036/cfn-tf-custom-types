...
1. Write the JSON schema describing your resource, `terraform-azurerm-postgresqlserver.json`
2. Implement your resource handlers in `terraform_azurerm_postgresqlserver/handlers.py`
