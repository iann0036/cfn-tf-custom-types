...
1. Write the JSON schema describing your resource, `tf-azurerm-appservicevirtualnetworkswiftconnection.json`
2. Implement your resource handlers in `tf_azurerm_appservicevirtualnetworkswiftconnection/handlers.py`
