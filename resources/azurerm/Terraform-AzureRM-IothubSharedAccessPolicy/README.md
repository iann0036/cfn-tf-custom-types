...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubsharedaccesspolicy.json`
2. Implement your resource handlers in `terraform_azurerm_iothubsharedaccesspolicy/handlers.py`
