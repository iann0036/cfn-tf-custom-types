...
1. Write the JSON schema describing your resource, `terraform-azurerm-botwebapp.json`
2. Implement your resource handlers in `terraform_azurerm_botwebapp/handlers.py`
