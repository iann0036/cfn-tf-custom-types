...
1. Write the JSON schema describing your resource, `tf-azurerm-machinelearninginferencecluster.json`
2. Implement your resource handlers in `tf_azurerm_machinelearninginferencecluster/handlers.py`
