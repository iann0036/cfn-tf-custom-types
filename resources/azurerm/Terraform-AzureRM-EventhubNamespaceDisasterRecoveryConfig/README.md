...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventhubnamespacedisasterrecoveryconfig.json`
2. Implement your resource handlers in `terraform_azurerm_eventhubnamespacedisasterrecoveryconfig/handlers.py`
