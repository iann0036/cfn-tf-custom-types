...
1. Write the JSON schema describing your resource, `terraform-azurerm-keyvaultkey.json`
2. Implement your resource handlers in `terraform_azurerm_keyvaultkey/handlers.py`
