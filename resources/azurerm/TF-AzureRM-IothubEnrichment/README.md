...
1. Write the JSON schema describing your resource, `tf-azurerm-iothubenrichment.json`
2. Implement your resource handlers in `tf_azurerm_iothubenrichment/handlers.py`
