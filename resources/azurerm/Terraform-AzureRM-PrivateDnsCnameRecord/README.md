...
1. Write the JSON schema describing your resource, `terraform-azurerm-privatednscnamerecord.json`
2. Implement your resource handlers in `terraform_azurerm_privatednscnamerecord/handlers.py`
