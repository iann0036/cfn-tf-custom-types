...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkinterfacenatruleassociation.json`
2. Implement your resource handlers in `terraform_azurerm_networkinterfacenatruleassociation/handlers.py`
