...
1. Write the JSON schema describing your resource, `tf-azurerm-machinelearningcomputecluster.json`
2. Implement your resource handlers in `tf_azurerm_machinelearningcomputecluster/handlers.py`
