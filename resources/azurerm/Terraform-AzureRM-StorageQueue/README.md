...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagequeue.json`
2. Implement your resource handlers in `terraform_azurerm_storagequeue/handlers.py`
