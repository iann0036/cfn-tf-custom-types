...
1. Write the JSON schema describing your resource, `tf-azurerm-sentinelalertrulemssecurityincident.json`
2. Implement your resource handlers in `tf_azurerm_sentinelalertrulemssecurityincident/handlers.py`
