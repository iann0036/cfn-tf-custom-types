...
class ResourceModel(BaseModel):
    ...
    EncryptionInTransitEnabled: Optional[bool]
    HttpsEndpoint: Optional[str]
    Id: Optional[str]
    KafkaRestProxyEndpoint: Optional[str]
    ...
    RestProxy: Optional[Sequence["_RestProxyDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EncryptionInTransitEnabled=json_data.get("EncryptionInTransitEnabled"),
            HttpsEndpoint=json_data.get("HttpsEndpoint"),
            Id=json_data.get("Id"),
            KafkaRestProxyEndpoint=json_data.get("KafkaRestProxyEndpoint"),
            ...
            RestProxy=deserialize_list(json_data.get("RestProxy"), RestProxyDefinition),
...
@dataclass
class RestProxyDefinition(BaseModel):
    SecurityGroupId: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_RestProxyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RestProxyDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_RestProxyDefinition = RestProxyDefinition


@dataclass
class RolesDefinition(BaseModel):
    HeadNode: Optional[Sequence["_HeadNodeDefinition"]]
    KafkaManagementNode: Optional[Sequence["_KafkaManagementNodeDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            KafkaManagementNode=deserialize_list(json_data.get("KafkaManagementNode"), KafkaManagementNodeDefinition),
...
@dataclass
class KafkaManagementNodeDefinition(BaseModel):
    Password: Optional[str]
    SshKeys: Optional[Sequence[str]]
    SubnetId: Optional[str]
    Username: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_KafkaManagementNodeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_KafkaManagementNodeDefinition"]:
        if not json_data:
            return None
        return cls(
            Password=json_data.get("Password"),
...
# work around possible type aliasing issues when variable has same name as a model
_KafkaManagementNodeDefinition = KafkaManagementNodeDefinition
