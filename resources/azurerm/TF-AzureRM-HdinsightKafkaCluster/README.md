...
1. Write the JSON schema describing your resource, `tf-azurerm-hdinsightkafkacluster.json`
2. Implement your resource handlers in `tf_azurerm_hdinsightkafkacluster/handlers.py`
