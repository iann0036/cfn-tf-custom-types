...
1. Write the JSON schema describing your resource, `tf-azurerm-mariadbserver.json`
2. Implement your resource handlers in `tf_azurerm_mariadbserver/handlers.py`
