...
1. Write the JSON schema describing your resource, `terraform-azurerm-keyvaultaccesspolicy.json`
2. Implement your resource handlers in `terraform_azurerm_keyvaultaccesspolicy/handlers.py`
