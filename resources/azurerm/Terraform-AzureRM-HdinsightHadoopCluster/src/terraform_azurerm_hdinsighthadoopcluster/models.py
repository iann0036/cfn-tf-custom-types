...
class ResourceModel(BaseResourceModel):
    ...
    InstallScriptAction: Optional[Sequence["_InstallScriptAction"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            InstallScriptAction=json_data.get("InstallScriptAction"),
        )
...
@dataclass
class InstallScriptAction:
    Name: Optional[str]
    Uri: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_InstallScriptAction"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_InstallScriptAction"]:
        if not json_data:
            return None
        return cls(
            Name=json_data.get("Name"),
...
# work around possible type aliasing issues when variable has same name as a model
_InstallScriptAction = InstallScriptAction
