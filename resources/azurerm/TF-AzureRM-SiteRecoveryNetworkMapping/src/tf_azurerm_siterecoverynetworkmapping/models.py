...
class ResourceModel(BaseModel):
    ...
    SourceNetworkId: Optional[str]
    SourceRecoveryFabricName: Optional[str]
    TargetNetworkId: Optional[str]
    TargetRecoveryFabricName: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SourceNetworkId=json_data.get("SourceNetworkId"),
            SourceRecoveryFabricName=json_data.get("SourceRecoveryFabricName"),
            TargetNetworkId=json_data.get("TargetNetworkId"),
            TargetRecoveryFabricName=json_data.get("TargetRecoveryFabricName"),
