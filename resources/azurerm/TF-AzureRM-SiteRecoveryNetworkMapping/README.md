...
1. Write the JSON schema describing your resource, `tf-azurerm-siterecoverynetworkmapping.json`
2. Implement your resource handlers in `tf_azurerm_siterecoverynetworkmapping/handlers.py`
