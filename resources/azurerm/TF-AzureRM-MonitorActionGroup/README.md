...
1. Write the JSON schema describing your resource, `tf-azurerm-monitoractiongroup.json`
2. Implement your resource handlers in `tf_azurerm_monitoractiongroup/handlers.py`
