...
1. Write the JSON schema describing your resource, `terraform-azurerm-mysqldatabase.json`
2. Implement your resource handlers in `terraform_azurerm_mysqldatabase/handlers.py`
