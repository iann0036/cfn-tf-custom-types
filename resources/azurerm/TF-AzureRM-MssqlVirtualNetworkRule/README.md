...
1. Write the JSON schema describing your resource, `tf-azurerm-mssqlvirtualnetworkrule.json`
2. Implement your resource handlers in `tf_azurerm_mssqlvirtualnetworkrule/handlers.py`
