# TF::AzureRM::DevTestWindowsVirtualMachine

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-devtestwindowsvirtualmachine.json`
2. Implement your resource handlers in `tf_azurerm_devtestwindowsvirtualmachine/handlers.py`
