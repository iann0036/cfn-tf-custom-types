...
1. Write the JSON schema describing your resource, `tf-azurerm-managementgrouptemplatedeployment.json`
2. Implement your resource handlers in `tf_azurerm_managementgrouptemplatedeployment/handlers.py`
