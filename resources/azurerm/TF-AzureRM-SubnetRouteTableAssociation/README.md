# TF::AzureRM::SubnetRouteTableAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-subnetroutetableassociation.json`
2. Implement your resource handlers in `tf_azurerm_subnetroutetableassociation/handlers.py`
