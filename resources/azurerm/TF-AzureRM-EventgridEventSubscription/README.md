# TF::AzureRM::EventgridEventSubscription

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-eventgrideventsubscription.json`
2. Implement your resource handlers in `tf_azurerm_eventgrideventsubscription/handlers.py`
