...
1. Write the JSON schema describing your resource, `tf-azurerm-mssqlvirtualmachine.json`
2. Implement your resource handlers in `tf_azurerm_mssqlvirtualmachine/handlers.py`
