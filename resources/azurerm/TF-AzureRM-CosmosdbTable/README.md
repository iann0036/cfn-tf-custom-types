...
1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbtable.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbtable/handlers.py`
