...
1. Write the JSON schema describing your resource, `tf-azurerm-kubernetescluster.json`
2. Implement your resource handlers in `tf_azurerm_kubernetescluster/handlers.py`
