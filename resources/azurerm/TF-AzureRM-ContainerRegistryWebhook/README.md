...
1. Write the JSON schema describing your resource, `tf-azurerm-containerregistrywebhook.json`
2. Implement your resource handlers in `tf_azurerm_containerregistrywebhook/handlers.py`
