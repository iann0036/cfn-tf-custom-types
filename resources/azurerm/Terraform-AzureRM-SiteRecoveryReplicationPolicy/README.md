...
1. Write the JSON schema describing your resource, `terraform-azurerm-siterecoveryreplicationpolicy.json`
2. Implement your resource handlers in `terraform_azurerm_siterecoveryreplicationpolicy/handlers.py`
