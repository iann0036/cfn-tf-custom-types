...
1. Write the JSON schema describing your resource, `terraform-azurerm-kustodatabaseprincipal.json`
2. Implement your resource handlers in `terraform_azurerm_kustodatabaseprincipal/handlers.py`
