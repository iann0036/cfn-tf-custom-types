...
1. Write the JSON schema describing your resource, `tf-azurerm-kubernetesclusternodepool.json`
2. Implement your resource handlers in `tf_azurerm_kubernetesclusternodepool/handlers.py`
