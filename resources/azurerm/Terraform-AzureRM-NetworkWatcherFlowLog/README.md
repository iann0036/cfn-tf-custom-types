...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkwatcherflowlog.json`
2. Implement your resource handlers in `terraform_azurerm_networkwatcherflowlog/handlers.py`
