# TF::AzureRM::VirtualMachineDataDiskAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-virtualmachinedatadiskattachment.json`
2. Implement your resource handlers in `tf_azurerm_virtualmachinedatadiskattachment/handlers.py`
