...
class ScheduleDefinition(BaseModel):
    AtTheseHours: Optional[Sequence[float]]
    AtTheseMinutes: Optional[Sequence[float]]
    OnTheseDays: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            AtTheseHours=json_data.get("AtTheseHours"),
            AtTheseMinutes=json_data.get("AtTheseMinutes"),
            OnTheseDays=json_data.get("OnTheseDays"),
        )
