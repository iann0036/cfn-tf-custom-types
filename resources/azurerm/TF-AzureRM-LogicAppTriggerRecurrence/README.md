...
1. Write the JSON schema describing your resource, `tf-azurerm-logicapptriggerrecurrence.json`
2. Implement your resource handlers in `tf_azurerm_logicapptriggerrecurrence/handlers.py`
