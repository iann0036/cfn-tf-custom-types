...
1. Write the JSON schema describing your resource, `terraform-azurerm-roleassignment.json`
2. Implement your resource handlers in `terraform_azurerm_roleassignment/handlers.py`
