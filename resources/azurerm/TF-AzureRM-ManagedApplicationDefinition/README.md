# TF::AzureRM::ManagedApplicationDefinition

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-managedapplicationdefinition.json`
2. Implement your resource handlers in `tf_azurerm_managedapplicationdefinition/handlers.py`
