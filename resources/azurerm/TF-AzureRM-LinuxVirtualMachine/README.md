...
1. Write the JSON schema describing your resource, `tf-azurerm-linuxvirtualmachine.json`
2. Implement your resource handlers in `tf_azurerm_linuxvirtualmachine/handlers.py`
