...
1. Write the JSON schema describing your resource, `terraform-azurerm-mariadbconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_mariadbconfiguration/handlers.py`
