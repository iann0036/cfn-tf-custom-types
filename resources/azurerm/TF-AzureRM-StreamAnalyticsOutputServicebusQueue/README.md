...
1. Write the JSON schema describing your resource, `tf-azurerm-streamanalyticsoutputservicebusqueue.json`
2. Implement your resource handlers in `tf_azurerm_streamanalyticsoutputservicebusqueue/handlers.py`
