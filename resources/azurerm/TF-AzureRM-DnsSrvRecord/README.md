...
1. Write the JSON schema describing your resource, `tf-azurerm-dnssrvrecord.json`
2. Implement your resource handlers in `tf_azurerm_dnssrvrecord/handlers.py`
