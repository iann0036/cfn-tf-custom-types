...
1. Write the JSON schema describing your resource, `terraform-azurerm-hdinsightmlservicescluster.json`
2. Implement your resource handlers in `terraform_azurerm_hdinsightmlservicescluster/handlers.py`
