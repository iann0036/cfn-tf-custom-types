...
1. Write the JSON schema describing your resource, `terraform-azurerm-notificationhubnamespace.json`
2. Implement your resource handlers in `terraform_azurerm_notificationhubnamespace/handlers.py`
