...
<pre>
{
    "Type" : "Terraform::AzureRM::NotificationHubNamespace",
    "Properties" : {
        ...
        "<a href="#servicebusendpoint" title="ServicebusEndpoint">ServicebusEndpoint</a>" : <i>String</i>,
...
Returns the &lt;code&gt;ServicebusEndpoint&lt;/code&gt; value.
