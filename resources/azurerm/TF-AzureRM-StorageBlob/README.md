# TF::AzureRM::StorageBlob

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-storageblob.json`
2. Implement your resource handlers in `tf_azurerm_storageblob/handlers.py`
