...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubendpointstoragecontainer.json`
2. Implement your resource handlers in `terraform_azurerm_iothubendpointstoragecontainer/handlers.py`
