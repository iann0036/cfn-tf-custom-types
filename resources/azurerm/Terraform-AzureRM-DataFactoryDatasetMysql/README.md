...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactorydatasetmysql.json`
2. Implement your resource handlers in `terraform_azurerm_datafactorydatasetmysql/handlers.py`
