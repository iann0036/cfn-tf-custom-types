...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsstreaminputiothub.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsstreaminputiothub/handlers.py`
