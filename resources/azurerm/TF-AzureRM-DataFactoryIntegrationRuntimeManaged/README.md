# TF::AzureRM::DataFactoryIntegrationRuntimeManaged

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactoryintegrationruntimemanaged.json`
2. Implement your resource handlers in `tf_azurerm_datafactoryintegrationruntimemanaged/handlers.py`
