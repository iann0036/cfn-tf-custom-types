...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualmachinescaleset.json`
2. Implement your resource handlers in `tf_azurerm_virtualmachinescaleset/handlers.py`
