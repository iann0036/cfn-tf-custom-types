...
1. Write the JSON schema describing your resource, `terraform-azurerm-applicationinsightswebtest.json`
2. Implement your resource handlers in `terraform_azurerm_applicationinsightswebtest/handlers.py`
