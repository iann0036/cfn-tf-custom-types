# TF::AzureRM::SecurityCenterAssessmentPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-securitycenterassessmentpolicy.json`
2. Implement your resource handlers in `tf_azurerm_securitycenterassessmentpolicy/handlers.py`
