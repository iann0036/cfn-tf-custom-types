...
1. Write the JSON schema describing your resource, `tf-azurerm-containergroup.json`
2. Implement your resource handlers in `tf_azurerm_containergroup/handlers.py`
