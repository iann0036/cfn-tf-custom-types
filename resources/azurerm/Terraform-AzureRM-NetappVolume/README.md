...
1. Write the JSON schema describing your resource, `terraform-azurerm-netappvolume.json`
2. Implement your resource handlers in `terraform_azurerm_netappvolume/handlers.py`
