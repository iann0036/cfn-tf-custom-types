...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitorlogprofile.json`
2. Implement your resource handlers in `terraform_azurerm_monitorlogprofile/handlers.py`
