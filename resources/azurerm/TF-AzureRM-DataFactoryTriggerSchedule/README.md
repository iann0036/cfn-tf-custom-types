...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorytriggerschedule.json`
2. Implement your resource handlers in `tf_azurerm_datafactorytriggerschedule/handlers.py`
