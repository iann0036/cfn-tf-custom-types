# TF::AzureRM::DataShareDatasetDataLakeGen2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datasharedatasetdatalakegen2.json`
2. Implement your resource handlers in `tf_azurerm_datasharedatasetdatalakegen2/handlers.py`
