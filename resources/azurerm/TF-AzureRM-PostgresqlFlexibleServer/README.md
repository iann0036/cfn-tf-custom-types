...
1. Write the JSON schema describing your resource, `tf-azurerm-postgresqlflexibleserver.json`
2. Implement your resource handlers in `tf_azurerm_postgresqlflexibleserver/handlers.py`
