# TF::AzureRM::ApplicationInsightsAnalyticsItem

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-applicationinsightsanalyticsitem.json`
2. Implement your resource handlers in `tf_azurerm_applicationinsightsanalyticsitem/handlers.py`
