# TF::AzureRM::ConsumptionBudgetResourceGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-consumptionbudgetresourcegroup.json`
2. Implement your resource handlers in `tf_azurerm_consumptionbudgetresourcegroup/handlers.py`
