...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementcertificate.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementcertificate/handlers.py`
