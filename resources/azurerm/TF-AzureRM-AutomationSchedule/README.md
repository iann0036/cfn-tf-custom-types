...
1. Write the JSON schema describing your resource, `tf-azurerm-automationschedule.json`
2. Implement your resource handlers in `tf_azurerm_automationschedule/handlers.py`
