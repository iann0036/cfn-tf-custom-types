...
1. Write the JSON schema describing your resource, `tf-azurerm-sentinelalertrulescheduled.json`
2. Implement your resource handlers in `tf_azurerm_sentinelalertrulescheduled/handlers.py`
