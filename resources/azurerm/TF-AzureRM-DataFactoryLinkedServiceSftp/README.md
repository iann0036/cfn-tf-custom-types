# TF::AzureRM::DataFactoryLinkedServiceSftp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedservicesftp.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedservicesftp/handlers.py`
