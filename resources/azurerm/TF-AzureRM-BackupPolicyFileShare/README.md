...
1. Write the JSON schema describing your resource, `tf-azurerm-backuppolicyfileshare.json`
2. Implement your resource handlers in `tf_azurerm_backuppolicyfileshare/handlers.py`
