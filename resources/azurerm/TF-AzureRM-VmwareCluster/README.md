...
1. Write the JSON schema describing your resource, `tf-azurerm-vmwarecluster.json`
2. Implement your resource handlers in `tf_azurerm_vmwarecluster/handlers.py`
