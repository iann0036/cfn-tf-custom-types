...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqlactivedirectoryadministrator.json`
2. Implement your resource handlers in `terraform_azurerm_sqlactivedirectoryadministrator/handlers.py`
