...
1. Write the JSON schema describing your resource, `tf-azurerm-servicebussubscription.json`
2. Implement your resource handlers in `tf_azurerm_servicebussubscription/handlers.py`
