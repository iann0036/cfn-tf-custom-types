# TF::AzureRM::ServicebusSubscription
...
<pre>
{
    "Type" : "TF::AzureRM::ServicebusSubscription",
    "Properties" : {
        "<a href="#autodeleteonidle" title="AutoDeleteOnIdle">AutoDeleteOnIdle</a>" : <i>String</i>,
        "<a href="#deadletteringonfilterevaluationerror" title="DeadLetteringOnFilterEvaluationError">DeadLetteringOnFilterEvaluationError</a>" : <i>Boolean</i>,
