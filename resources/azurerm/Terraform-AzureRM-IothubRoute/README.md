...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubroute.json`
2. Implement your resource handlers in `terraform_azurerm_iothubroute/handlers.py`
