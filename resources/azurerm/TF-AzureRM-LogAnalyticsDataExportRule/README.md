...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticsdataexportrule.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticsdataexportrule/handlers.py`
