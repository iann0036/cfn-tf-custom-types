...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkinterfaceapplicationgatewaybackendaddresspoolassociation.json`
2. Implement your resource handlers in `terraform_azurerm_networkinterfaceapplicationgatewaybackendaddresspoolassociation/handlers.py`
