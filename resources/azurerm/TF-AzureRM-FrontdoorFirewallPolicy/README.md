...
1. Write the JSON schema describing your resource, `tf-azurerm-frontdoorfirewallpolicy.json`
2. Implement your resource handlers in `tf_azurerm_frontdoorfirewallpolicy/handlers.py`
