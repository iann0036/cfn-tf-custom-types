...
1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementlogger.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementlogger/handlers.py`
