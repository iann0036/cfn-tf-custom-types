...
1. Write the JSON schema describing your resource, `tf-azurerm-healthcareservice.json`
2. Implement your resource handlers in `tf_azurerm_healthcareservice/handlers.py`
