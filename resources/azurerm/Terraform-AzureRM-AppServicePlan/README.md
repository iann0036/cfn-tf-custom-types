...
1. Write the JSON schema describing your resource, `terraform-azurerm-appserviceplan.json`
2. Implement your resource handlers in `terraform_azurerm_appserviceplan/handlers.py`
