# TF::AzureRM::RelayNamespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-relaynamespace.json`
2. Implement your resource handlers in `tf_azurerm_relaynamespace/handlers.py`
