...
1. Write the JSON schema describing your resource, `terraform-azurerm-logicappactioncustom.json`
2. Implement your resource handlers in `terraform_azurerm_logicappactioncustom/handlers.py`
