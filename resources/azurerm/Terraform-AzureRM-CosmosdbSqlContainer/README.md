...
1. Write the JSON schema describing your resource, `terraform-azurerm-cosmosdbsqlcontainer.json`
2. Implement your resource handlers in `terraform_azurerm_cosmosdbsqlcontainer/handlers.py`
