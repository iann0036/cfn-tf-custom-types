...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualmachineextension.json`
2. Implement your resource handlers in `tf_azurerm_virtualmachineextension/handlers.py`
