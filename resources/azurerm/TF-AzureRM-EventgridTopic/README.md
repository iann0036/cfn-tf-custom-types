...
1. Write the JSON schema describing your resource, `tf-azurerm-eventgridtopic.json`
2. Implement your resource handlers in `tf_azurerm_eventgridtopic/handlers.py`
