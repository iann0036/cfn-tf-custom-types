# TF::AzureRM::MaintenanceConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-maintenanceconfiguration.json`
2. Implement your resource handlers in `tf_azurerm_maintenanceconfiguration/handlers.py`
