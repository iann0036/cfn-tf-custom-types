...
1. Write the JSON schema describing your resource, `terraform-azurerm-rediscache.json`
2. Implement your resource handlers in `terraform_azurerm_rediscache/handlers.py`
