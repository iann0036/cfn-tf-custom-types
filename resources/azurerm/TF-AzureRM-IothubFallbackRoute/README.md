# TF::AzureRM::IothubFallbackRoute

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-iothubfallbackroute.json`
2. Implement your resource handlers in `tf_azurerm_iothubfallbackroute/handlers.py`
