# Terraform::AzureRM::ApiManagementIdentityProviderGoogle

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementidentityprovidergoogle.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementidentityprovidergoogle/handlers.py`
