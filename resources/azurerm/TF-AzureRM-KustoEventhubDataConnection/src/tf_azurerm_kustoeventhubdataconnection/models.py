...
class ResourceModel(BaseModel):
    ...
    ConsumerGroup: Optional[str]
    DataFormat: Optional[str]
    DatabaseName: Optional[str]
    EventSystemProperties: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ConsumerGroup=json_data.get("ConsumerGroup"),
            DataFormat=json_data.get("DataFormat"),
            DatabaseName=json_data.get("DatabaseName"),
            EventSystemProperties=json_data.get("EventSystemProperties"),
