...
1. Write the JSON schema describing your resource, `tf-azurerm-kustoeventhubdataconnection.json`
2. Implement your resource handlers in `tf_azurerm_kustoeventhubdataconnection/handlers.py`
