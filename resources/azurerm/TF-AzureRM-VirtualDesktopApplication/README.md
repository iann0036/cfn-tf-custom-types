...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualdesktopapplication.json`
2. Implement your resource handlers in `tf_azurerm_virtualdesktopapplication/handlers.py`
