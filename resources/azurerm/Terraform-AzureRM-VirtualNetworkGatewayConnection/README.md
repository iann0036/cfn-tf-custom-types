...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualnetworkgatewayconnection.json`
2. Implement your resource handlers in `terraform_azurerm_virtualnetworkgatewayconnection/handlers.py`
