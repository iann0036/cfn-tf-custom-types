...
1. Write the JSON schema describing your resource, `tf-azurerm-applicationinsightssmartdetectionrule.json`
2. Implement your resource handlers in `tf_azurerm_applicationinsightssmartdetectionrule/handlers.py`
