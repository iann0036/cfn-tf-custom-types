...
class ResourceModel(BaseResourceModel):
    ...
    DdosProtectionPlan: Optional[Sequence["_DdosProtectionPlan"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DdosProtectionPlan=json_data.get("DdosProtectionPlan"),
...
class DdosProtectionPlan:
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DdosProtectionPlan"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DdosProtectionPlan"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DdosProtectionPlan = DdosProtectionPlan
