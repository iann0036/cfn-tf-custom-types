...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualnetwork.json`
2. Implement your resource handlers in `terraform_azurerm_virtualnetwork/handlers.py`
