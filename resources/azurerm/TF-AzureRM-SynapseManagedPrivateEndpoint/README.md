...
1. Write the JSON schema describing your resource, `tf-azurerm-synapsemanagedprivateendpoint.json`
2. Implement your resource handlers in `tf_azurerm_synapsemanagedprivateendpoint/handlers.py`
