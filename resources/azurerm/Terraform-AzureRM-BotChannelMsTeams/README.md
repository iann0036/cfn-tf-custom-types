...
1. Write the JSON schema describing your resource, `terraform-azurerm-botchannelmsteams.json`
2. Implement your resource handlers in `terraform_azurerm_botchannelmsteams/handlers.py`
