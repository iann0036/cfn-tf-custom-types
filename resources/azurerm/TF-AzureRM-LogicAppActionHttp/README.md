...
1. Write the JSON schema describing your resource, `tf-azurerm-logicappactionhttp.json`
2. Implement your resource handlers in `tf_azurerm_logicappactionhttp/handlers.py`
