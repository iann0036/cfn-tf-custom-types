...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementapioperation.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementapioperation/handlers.py`
