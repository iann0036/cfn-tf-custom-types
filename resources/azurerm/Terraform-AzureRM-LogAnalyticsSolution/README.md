...
1. Write the JSON schema describing your resource, `terraform-azurerm-loganalyticssolution.json`
2. Implement your resource handlers in `terraform_azurerm_loganalyticssolution/handlers.py`
