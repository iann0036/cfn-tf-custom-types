...
1. Write the JSON schema describing your resource, `tf-azurerm-synapseroleassignment.json`
2. Implement your resource handlers in `tf_azurerm_synapseroleassignment/handlers.py`
