...
1. Write the JSON schema describing your resource, `tf-azurerm-redislinkedserver.json`
2. Implement your resource handlers in `tf_azurerm_redislinkedserver/handlers.py`
