...
class NetworkProfileDefinition(BaseModel):
    NetworkInterfacePrivateIpAddresses: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            NetworkInterfacePrivateIpAddresses=json_data.get("NetworkInterfacePrivateIpAddresses"),
