...
1. Write the JSON schema describing your resource, `tf-azurerm-templatedeployment.json`
2. Implement your resource handlers in `tf_azurerm_templatedeployment/handlers.py`
