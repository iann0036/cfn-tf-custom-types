...
1. Write the JSON schema describing your resource, `terraform-azurerm-lboutboundrule.json`
2. Implement your resource handlers in `terraform_azurerm_lboutboundrule/handlers.py`
