...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqlfailovergroup.json`
2. Implement your resource handlers in `terraform_azurerm_sqlfailovergroup/handlers.py`
