...
def create_handler(
    ...
    try:
        ...
        tf['resource']['azurerm_data_factory_linked_service_data_lake_storage_gen2'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['azurerm_data_factory_linked_service_data_lake_storage_gen2'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
