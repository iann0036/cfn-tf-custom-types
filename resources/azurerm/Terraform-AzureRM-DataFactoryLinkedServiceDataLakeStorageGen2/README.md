...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactorylinkedservicedatalakestoragegen2.json`
2. Implement your resource handlers in `terraform_azurerm_datafactorylinkedservicedatalakestoragegen2/handlers.py`
