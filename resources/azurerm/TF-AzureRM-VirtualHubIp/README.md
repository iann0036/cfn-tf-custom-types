...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualhubip.json`
2. Implement your resource handlers in `tf_azurerm_virtualhubip/handlers.py`
