...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementlogger.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementlogger/handlers.py`
