# TF::AzureRM::DataFactoryLinkedServiceAzureTableStorage

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceazuretablestorage.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceazuretablestorage/handlers.py`
