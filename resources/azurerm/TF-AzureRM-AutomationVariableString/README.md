# TF::AzureRM::AutomationVariableString

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-automationvariablestring.json`
2. Implement your resource handlers in `tf_azurerm_automationvariablestring/handlers.py`
