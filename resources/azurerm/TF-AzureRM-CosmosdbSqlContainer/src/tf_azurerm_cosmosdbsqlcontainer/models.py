...
class ResourceModel(BaseModel):
    ...
    IndexingPolicy: Optional[Sequence["_IndexingPolicyDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            IndexingPolicy=deserialize_list(json_data.get("IndexingPolicy"), IndexingPolicyDefinition),
...
@dataclass
class IndexingPolicyDefinition(BaseModel):
    IndexingMode: Optional[str]
    CompositeIndex: Optional[Sequence["_CompositeIndexDefinition"]]
    ExcludedPath: Optional[Sequence["_ExcludedPathDefinition"]]
    IncludedPath: Optional[Sequence["_IncludedPathDefinition"]]
    SpatialIndex: Optional[Sequence["_SpatialIndexDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_IndexingPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IndexingPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
            ...
            ExcludedPath=deserialize_list(json_data.get("ExcludedPath"), ExcludedPathDefinition),
            IncludedPath=deserialize_list(json_data.get("IncludedPath"), IncludedPathDefinition),
            SpatialIndex=deserialize_list(json_data.get("SpatialIndex"), SpatialIndexDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_IndexingPolicyDefinition = IndexingPolicyDefinition
...
@dataclass
class ExcludedPathDefinition(BaseModel):
    Path: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_ExcludedPathDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ExcludedPathDefinition"]:
        if not json_data:
            return None
        return cls(
            Path=json_data.get("Path"),
...
# work around possible type aliasing issues when variable has same name as a model
_ExcludedPathDefinition = ExcludedPathDefinition


@dataclass
class IncludedPathDefinition(BaseModel):
    Path: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_IncludedPathDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_IncludedPathDefinition"]:
        if not json_data:
            return None
        return cls(
            Path=json_data.get("Path"),
...
# work around possible type aliasing issues when variable has same name as a model
_IncludedPathDefinition = IncludedPathDefinition
