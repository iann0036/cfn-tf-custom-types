...
1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbsqlcontainer.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbsqlcontainer/handlers.py`
