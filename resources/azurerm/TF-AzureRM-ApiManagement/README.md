...
1. Write the JSON schema describing your resource, `tf-azurerm-apimanagement.json`
2. Implement your resource handlers in `tf_azurerm_apimanagement/handlers.py`
