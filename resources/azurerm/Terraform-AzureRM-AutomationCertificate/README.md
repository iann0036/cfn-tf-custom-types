...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationcertificate.json`
2. Implement your resource handlers in `terraform_azurerm_automationcertificate/handlers.py`
