...
1. Write the JSON schema describing your resource, `tf-azurerm-mediastreaminglocator.json`
2. Implement your resource handlers in `tf_azurerm_mediastreaminglocator/handlers.py`
