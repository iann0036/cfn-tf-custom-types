...
1. Write the JSON schema describing your resource, `terraform-azurerm-postgresqldatabase.json`
2. Implement your resource handlers in `terraform_azurerm_postgresqldatabase/handlers.py`
