...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualmachinedatadiskattachment.json`
2. Implement your resource handlers in `terraform_azurerm_virtualmachinedatadiskattachment/handlers.py`
