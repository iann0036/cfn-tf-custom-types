...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventgrideventsubscription.json`
2. Implement your resource handlers in `terraform_azurerm_eventgrideventsubscription/handlers.py`
