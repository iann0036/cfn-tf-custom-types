...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebusqueue.json`
2. Implement your resource handlers in `terraform_azurerm_servicebusqueue/handlers.py`
