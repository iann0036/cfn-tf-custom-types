...
1. Write the JSON schema describing your resource, `tf-azurerm-policydefinition.json`
2. Implement your resource handlers in `tf_azurerm_policydefinition/handlers.py`
