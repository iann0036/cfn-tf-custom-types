...
1. Write the JSON schema describing your resource, `terraform-azurerm-containerregistry.json`
2. Implement your resource handlers in `terraform_azurerm_containerregistry/handlers.py`
