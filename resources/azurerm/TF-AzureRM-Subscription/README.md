...
1. Write the JSON schema describing your resource, `tf-azurerm-subscription.json`
2. Implement your resource handlers in `tf_azurerm_subscription/handlers.py`
