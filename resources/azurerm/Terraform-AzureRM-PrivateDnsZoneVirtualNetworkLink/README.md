...
1. Write the JSON schema describing your resource, `terraform-azurerm-privatednszonevirtualnetworklink.json`
2. Implement your resource handlers in `terraform_azurerm_privatednszonevirtualnetworklink/handlers.py`
