...
1. Write the JSON schema describing your resource, `tf-azurerm-synapsesparkpool.json`
2. Implement your resource handlers in `tf_azurerm_synapsesparkpool/handlers.py`
