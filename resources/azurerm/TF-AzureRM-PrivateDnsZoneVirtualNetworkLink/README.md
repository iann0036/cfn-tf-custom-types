...
1. Write the JSON schema describing your resource, `tf-azurerm-privatednszonevirtualnetworklink.json`
2. Implement your resource handlers in `tf_azurerm_privatednszonevirtualnetworklink/handlers.py`
