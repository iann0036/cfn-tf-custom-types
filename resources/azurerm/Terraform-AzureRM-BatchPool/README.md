...
1. Write the JSON schema describing your resource, `terraform-azurerm-batchpool.json`
2. Implement your resource handlers in `terraform_azurerm_batchpool/handlers.py`
