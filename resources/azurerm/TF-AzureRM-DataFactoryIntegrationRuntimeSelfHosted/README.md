# TF::AzureRM::DataFactoryIntegrationRuntimeSelfHosted

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactoryintegrationruntimeselfhosted.json`
2. Implement your resource handlers in `tf_azurerm_datafactoryintegrationruntimeselfhosted/handlers.py`
