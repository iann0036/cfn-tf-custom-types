...
1. Write the JSON schema describing your resource, `terraform-azurerm-natgateway.json`
2. Implement your resource handlers in `terraform_azurerm_natgateway/handlers.py`
