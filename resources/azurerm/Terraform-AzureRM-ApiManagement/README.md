...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagement.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagement/handlers.py`
