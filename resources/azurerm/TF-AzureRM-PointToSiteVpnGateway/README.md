...
1. Write the JSON schema describing your resource, `tf-azurerm-pointtositevpngateway.json`
2. Implement your resource handlers in `tf_azurerm_pointtositevpngateway/handlers.py`
