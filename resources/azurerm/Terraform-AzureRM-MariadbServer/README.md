...
1. Write the JSON schema describing your resource, `terraform-azurerm-mariadbserver.json`
2. Implement your resource handlers in `terraform_azurerm_mariadbserver/handlers.py`
