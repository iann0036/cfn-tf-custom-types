...
1. Write the JSON schema describing your resource, `terraform-azurerm-redisfirewallrule.json`
2. Implement your resource handlers in `terraform_azurerm_redisfirewallrule/handlers.py`
