...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementopenidconnectprovider.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementopenidconnectprovider/handlers.py`
