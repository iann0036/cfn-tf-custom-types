...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqlserver.json`
2. Implement your resource handlers in `terraform_azurerm_sqlserver/handlers.py`
