...
1. Write the JSON schema describing your resource, `tf-azurerm-privatednssrvrecord.json`
2. Implement your resource handlers in `tf_azurerm_privatednssrvrecord/handlers.py`
