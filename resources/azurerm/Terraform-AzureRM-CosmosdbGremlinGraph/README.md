...
1. Write the JSON schema describing your resource, `terraform-azurerm-cosmosdbgremlingraph.json`
2. Implement your resource handlers in `terraform_azurerm_cosmosdbgremlingraph/handlers.py`
