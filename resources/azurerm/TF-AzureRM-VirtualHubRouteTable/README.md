...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualhubroutetable.json`
2. Implement your resource handlers in `tf_azurerm_virtualhubroutetable/handlers.py`
