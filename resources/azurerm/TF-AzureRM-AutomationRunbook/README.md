...
1. Write the JSON schema describing your resource, `tf-azurerm-automationrunbook.json`
2. Implement your resource handlers in `tf_azurerm_automationrunbook/handlers.py`
