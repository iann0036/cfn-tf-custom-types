...
1. Write the JSON schema describing your resource, `tf-azurerm-storagesharefile.json`
2. Implement your resource handlers in `tf_azurerm_storagesharefile/handlers.py`
