...
1. Write the JSON schema describing your resource, `tf-azurerm-vpngatewayconnection.json`
2. Implement your resource handlers in `tf_azurerm_vpngatewayconnection/handlers.py`
