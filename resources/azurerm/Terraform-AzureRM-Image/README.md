...
1. Write the JSON schema describing your resource, `terraform-azurerm-image.json`
2. Implement your resource handlers in `terraform_azurerm_image/handlers.py`
