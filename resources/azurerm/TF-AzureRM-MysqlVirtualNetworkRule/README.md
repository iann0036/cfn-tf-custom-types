# TF::AzureRM::MysqlVirtualNetworkRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-mysqlvirtualnetworkrule.json`
2. Implement your resource handlers in `tf_azurerm_mysqlvirtualnetworkrule/handlers.py`
