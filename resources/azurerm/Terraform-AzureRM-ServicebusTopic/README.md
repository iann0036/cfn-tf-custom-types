...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebustopic.json`
2. Implement your resource handlers in `terraform_azurerm_servicebustopic/handlers.py`
