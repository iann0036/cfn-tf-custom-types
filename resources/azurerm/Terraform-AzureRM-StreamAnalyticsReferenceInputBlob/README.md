...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsreferenceinputblob.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsreferenceinputblob/handlers.py`
