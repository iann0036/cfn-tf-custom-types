...
1. Write the JSON schema describing your resource, `terraform-azurerm-networksecurityrule.json`
2. Implement your resource handlers in `terraform_azurerm_networksecurityrule/handlers.py`
