...
1. Write the JSON schema describing your resource, `terraform-azurerm-privatednssrvrecord.json`
2. Implement your resource handlers in `terraform_azurerm_privatednssrvrecord/handlers.py`
