...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubdps.json`
2. Implement your resource handlers in `terraform_azurerm_iothubdps/handlers.py`
