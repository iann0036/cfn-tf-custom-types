# TF::AzureRM::HdinsightHbaseCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-hdinsighthbasecluster.json`
2. Implement your resource handlers in `tf_azurerm_hdinsighthbasecluster/handlers.py`
