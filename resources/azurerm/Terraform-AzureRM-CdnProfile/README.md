...
1. Write the JSON schema describing your resource, `terraform-azurerm-cdnprofile.json`
2. Implement your resource handlers in `terraform_azurerm_cdnprofile/handlers.py`
