...
1. Write the JSON schema describing your resource, `terraform-azurerm-availabilityset.json`
2. Implement your resource handlers in `terraform_azurerm_availabilityset/handlers.py`
