...
1. Write the JSON schema describing your resource, `tf-azurerm-roledefinition.json`
2. Implement your resource handlers in `tf_azurerm_roledefinition/handlers.py`
