...
1. Write the JSON schema describing your resource, `terraform-azurerm-datalakeanalyticsaccount.json`
2. Implement your resource handlers in `terraform_azurerm_datalakeanalyticsaccount/handlers.py`
