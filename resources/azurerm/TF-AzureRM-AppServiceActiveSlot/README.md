# TF::AzureRM::AppServiceActiveSlot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-appserviceactiveslot.json`
2. Implement your resource handlers in `tf_azurerm_appserviceactiveslot/handlers.py`
