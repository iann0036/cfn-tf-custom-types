...
1. Write the JSON schema describing your resource, `tf-azurerm-subscriptiontemplatedeployment.json`
2. Implement your resource handlers in `tf_azurerm_subscriptiontemplatedeployment/handlers.py`
