...
1. Write the JSON schema describing your resource, `tf-azurerm-kustoattacheddatabaseconfiguration.json`
2. Implement your resource handlers in `tf_azurerm_kustoattacheddatabaseconfiguration/handlers.py`
