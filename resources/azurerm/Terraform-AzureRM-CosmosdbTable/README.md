...
1. Write the JSON schema describing your resource, `terraform-azurerm-cosmosdbtable.json`
2. Implement your resource handlers in `terraform_azurerm_cosmosdbtable/handlers.py`
