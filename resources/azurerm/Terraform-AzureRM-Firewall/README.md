...
1. Write the JSON schema describing your resource, `terraform-azurerm-firewall.json`
2. Implement your resource handlers in `terraform_azurerm_firewall/handlers.py`
