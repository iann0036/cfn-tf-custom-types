...
1. Write the JSON schema describing your resource, `terraform-azurerm-subnet.json`
2. Implement your resource handlers in `terraform_azurerm_subnet/handlers.py`
