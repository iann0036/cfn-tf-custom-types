...
<pre>
{
    "Type" : "TF::AzureRM::VpnSite",
    "Properties" : {
        "<a href="#addresscidrs" title="AddressCidrs">AddressCidrs</a>" : <i>[ String, ... ]</i>,
        "<a href="#devicemodel" title="DeviceModel">DeviceModel</a>" : <i>String</i>,
        "<a href="#devicevendor" title="DeviceVendor">DeviceVendor</a>" : <i>String</i>,
...
Type: TF::AzureRM::VpnSite
Properties:
    <a href="#addresscidrs" title="AddressCidrs">AddressCidrs</a>: <i>
      - String</i>
    <a href="#devicemodel" title="DeviceModel">DeviceModel</a>: <i>String</i>
    <a href="#devicevendor" title="DeviceVendor">DeviceVendor</a>: <i>String</i>
    <a href="#location" title="Location">Location</a>: <i>String</i>
