...
1. Write the JSON schema describing your resource, `terraform-azurerm-mysqlconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_mysqlconfiguration/handlers.py`
