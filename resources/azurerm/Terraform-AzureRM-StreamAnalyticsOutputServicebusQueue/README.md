...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsoutputservicebusqueue.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsoutputservicebusqueue/handlers.py`
