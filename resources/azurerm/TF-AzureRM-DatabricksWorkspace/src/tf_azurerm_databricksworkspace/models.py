...
class ResourceModel(BaseModel):
    ...
    CustomParameters: Optional[Sequence["_CustomParametersDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CustomParameters=deserialize_list(json_data.get("CustomParameters"), CustomParametersDefinition),
...
@dataclass
class CustomParametersDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_CustomParametersDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_CustomParametersDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_CustomParametersDefinition = CustomParametersDefinition
