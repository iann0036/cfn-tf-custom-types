...
1. Write the JSON schema describing your resource, `tf-azurerm-databricksworkspace.json`
2. Implement your resource handlers in `tf_azurerm_databricksworkspace/handlers.py`
