...
1. Write the JSON schema describing your resource, `tf-azurerm-vpnserverconfiguration.json`
2. Implement your resource handlers in `tf_azurerm_vpnserverconfiguration/handlers.py`
