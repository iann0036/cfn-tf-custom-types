# TF::AzureRM::AppServiceEnvironmentV3

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-appserviceenvironmentv3.json`
2. Implement your resource handlers in `tf_azurerm_appserviceenvironmentv3/handlers.py`
