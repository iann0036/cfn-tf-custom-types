...
1. Write the JSON schema describing your resource, `terraform-azurerm-storageshare.json`
2. Implement your resource handlers in `terraform_azurerm_storageshare/handlers.py`
