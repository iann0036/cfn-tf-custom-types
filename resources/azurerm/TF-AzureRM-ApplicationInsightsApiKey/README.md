...
1. Write the JSON schema describing your resource, `tf-azurerm-applicationinsightsapikey.json`
2. Implement your resource handlers in `tf_azurerm_applicationinsightsapikey/handlers.py`
