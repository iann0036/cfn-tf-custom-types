...
1. Write the JSON schema describing your resource, `tf-azurerm-blueprintassignment.json`
2. Implement your resource handlers in `tf_azurerm_blueprintassignment/handlers.py`
