...
class ResourceModel(BaseModel):
    ...
    BlueprintName: Optional[str]
    Description: Optional[str]
    DisplayName: Optional[str]
    Id: Optional[str]
    Location: Optional[str]
    LockExcludePrincipals: Optional[Sequence[str]]
    LockMode: Optional[str]
    Name: Optional[str]
    ParameterValues: Optional[str]
    ResourceGroups: Optional[str]
    TargetSubscriptionId: Optional[str]
    Type: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BlueprintName=json_data.get("BlueprintName"),
            Description=json_data.get("Description"),
            DisplayName=json_data.get("DisplayName"),
            Id=json_data.get("Id"),
            Location=json_data.get("Location"),
            LockExcludePrincipals=json_data.get("LockExcludePrincipals"),
            LockMode=json_data.get("LockMode"),
            Name=json_data.get("Name"),
            ParameterValues=json_data.get("ParameterValues"),
            ResourceGroups=json_data.get("ResourceGroups"),
            TargetSubscriptionId=json_data.get("TargetSubscriptionId"),
