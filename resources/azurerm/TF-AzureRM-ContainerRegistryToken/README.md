...
1. Write the JSON schema describing your resource, `tf-azurerm-containerregistrytoken.json`
2. Implement your resource handlers in `tf_azurerm_containerregistrytoken/handlers.py`
