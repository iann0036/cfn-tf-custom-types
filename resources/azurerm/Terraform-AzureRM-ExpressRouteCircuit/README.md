...
1. Write the JSON schema describing your resource, `terraform-azurerm-expressroutecircuit.json`
2. Implement your resource handlers in `terraform_azurerm_expressroutecircuit/handlers.py`
