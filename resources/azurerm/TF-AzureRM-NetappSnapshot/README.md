# TF::AzureRM::NetappSnapshot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-netappsnapshot.json`
2. Implement your resource handlers in `tf_azurerm_netappsnapshot/handlers.py`
