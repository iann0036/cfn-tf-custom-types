...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitordiagnosticsetting.json`
2. Implement your resource handlers in `terraform_azurerm_monitordiagnosticsetting/handlers.py`
