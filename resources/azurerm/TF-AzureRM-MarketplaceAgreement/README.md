# TF::AzureRM::MarketplaceAgreement

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-marketplaceagreement.json`
2. Implement your resource handlers in `tf_azurerm_marketplaceagreement/handlers.py`
