# TF::AzureRM::DedicatedHostGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-dedicatedhostgroup.json`
2. Implement your resource handlers in `tf_azurerm_dedicatedhostgroup/handlers.py`
