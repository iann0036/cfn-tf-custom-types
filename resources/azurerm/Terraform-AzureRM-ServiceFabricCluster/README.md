...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicefabriccluster.json`
2. Implement your resource handlers in `terraform_azurerm_servicefabriccluster/handlers.py`
