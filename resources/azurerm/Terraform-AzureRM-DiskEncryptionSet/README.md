...
1. Write the JSON schema describing your resource, `terraform-azurerm-diskencryptionset.json`
2. Implement your resource handlers in `terraform_azurerm_diskencryptionset/handlers.py`
