...
1. Write the JSON schema describing your resource, `tf-azurerm-mediaservicesaccount.json`
2. Implement your resource handlers in `tf_azurerm_mediaservicesaccount/handlers.py`
