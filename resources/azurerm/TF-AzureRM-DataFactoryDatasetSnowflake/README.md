# TF::AzureRM::DataFactoryDatasetSnowflake

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorydatasetsnowflake.json`
2. Implement your resource handlers in `tf_azurerm_datafactorydatasetsnowflake/handlers.py`
