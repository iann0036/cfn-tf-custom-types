...
1. Write the JSON schema describing your resource, `terraform-azurerm-firewallnetworkrulecollection.json`
2. Implement your resource handlers in `terraform_azurerm_firewallnetworkrulecollection/handlers.py`
