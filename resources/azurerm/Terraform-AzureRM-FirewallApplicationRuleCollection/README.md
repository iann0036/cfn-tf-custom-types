...
1. Write the JSON schema describing your resource, `terraform-azurerm-firewallapplicationrulecollection.json`
2. Implement your resource handlers in `terraform_azurerm_firewallapplicationrulecollection/handlers.py`
