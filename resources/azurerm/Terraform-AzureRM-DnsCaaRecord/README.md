...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnscaarecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnscaarecord/handlers.py`
