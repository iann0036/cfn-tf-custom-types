...
1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbmongocollection.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbmongocollection/handlers.py`
