...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothub.json`
2. Implement your resource handlers in `terraform_azurerm_iothub/handlers.py`
