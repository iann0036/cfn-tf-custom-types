...
1. Write the JSON schema describing your resource, `terraform-azurerm-subnetnetworksecuritygroupassociation.json`
2. Implement your resource handlers in `terraform_azurerm_subnetnetworksecuritygroupassociation/handlers.py`
