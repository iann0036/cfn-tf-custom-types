# TF::AzureRM::HpcCacheAccessPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-hpccacheaccesspolicy.json`
2. Implement your resource handlers in `tf_azurerm_hpccacheaccesspolicy/handlers.py`
