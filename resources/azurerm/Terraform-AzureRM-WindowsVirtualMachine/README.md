...
1. Write the JSON schema describing your resource, `terraform-azurerm-windowsvirtualmachine.json`
2. Implement your resource handlers in `terraform_azurerm_windowsvirtualmachine/handlers.py`
