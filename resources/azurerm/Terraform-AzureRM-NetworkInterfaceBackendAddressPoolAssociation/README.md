...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkinterfacebackendaddresspoolassociation.json`
2. Implement your resource handlers in `terraform_azurerm_networkinterfacebackendaddresspoolassociation/handlers.py`
