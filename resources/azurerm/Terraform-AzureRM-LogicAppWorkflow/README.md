...
1. Write the JSON schema describing your resource, `terraform-azurerm-logicappworkflow.json`
2. Implement your resource handlers in `terraform_azurerm_logicappworkflow/handlers.py`
