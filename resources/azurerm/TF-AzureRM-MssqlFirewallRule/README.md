...
1. Write the JSON schema describing your resource, `tf-azurerm-mssqlfirewallrule.json`
2. Implement your resource handlers in `tf_azurerm_mssqlfirewallrule/handlers.py`
