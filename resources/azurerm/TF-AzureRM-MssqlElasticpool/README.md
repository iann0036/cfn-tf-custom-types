...
1. Write the JSON schema describing your resource, `tf-azurerm-mssqlelasticpool.json`
2. Implement your resource handlers in `tf_azurerm_mssqlelasticpool/handlers.py`
