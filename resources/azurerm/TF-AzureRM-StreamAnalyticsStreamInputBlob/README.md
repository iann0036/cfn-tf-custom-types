# TF::AzureRM::StreamAnalyticsStreamInputBlob

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-streamanalyticsstreaminputblob.json`
2. Implement your resource handlers in `tf_azurerm_streamanalyticsstreaminputblob/handlers.py`
