# TF::AzureRM::SqlActiveDirectoryAdministrator

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-sqlactivedirectoryadministrator.json`
2. Implement your resource handlers in `tf_azurerm_sqlactivedirectoryadministrator/handlers.py`
