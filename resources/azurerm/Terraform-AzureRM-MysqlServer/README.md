...
1. Write the JSON schema describing your resource, `terraform-azurerm-mysqlserver.json`
2. Implement your resource handlers in `terraform_azurerm_mysqlserver/handlers.py`
