...
1. Write the JSON schema describing your resource, `terraform-azurerm-privateendpoint.json`
2. Implement your resource handlers in `terraform_azurerm_privateendpoint/handlers.py`
