...
1. Write the JSON schema describing your resource, `tf-azurerm-privatednsmxrecord.json`
2. Implement your resource handlers in `tf_azurerm_privatednsmxrecord/handlers.py`
