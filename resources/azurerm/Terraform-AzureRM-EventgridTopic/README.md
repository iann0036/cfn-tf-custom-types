...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventgridtopic.json`
2. Implement your resource handlers in `terraform_azurerm_eventgridtopic/handlers.py`
