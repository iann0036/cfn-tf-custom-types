...
1. Write the JSON schema describing your resource, `terraform-azurerm-vpnserverconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_vpnserverconfiguration/handlers.py`
