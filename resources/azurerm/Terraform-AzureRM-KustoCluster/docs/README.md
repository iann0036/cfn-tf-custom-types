...
CloudFormation equivalent of azurerm_kusto_cluster
...
<pre>
{
    "Type" : "Terraform::AzureRM::KustoCluster",
    "Properties" : {
        "<a href="#tfcfnid" title="tfcfnid">tfcfnid</a>" : <i>String</i>,
        "<a href="#dataingestionuri" title="DataIngestionUri">DataIngestionUri</a>" : <i>String</i>,
