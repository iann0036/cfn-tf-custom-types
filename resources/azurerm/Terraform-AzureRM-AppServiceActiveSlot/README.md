...
1. Write the JSON schema describing your resource, `terraform-azurerm-appserviceactiveslot.json`
2. Implement your resource handlers in `terraform_azurerm_appserviceactiveslot/handlers.py`
