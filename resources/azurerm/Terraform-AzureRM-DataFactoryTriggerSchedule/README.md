...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactorytriggerschedule.json`
2. Implement your resource handlers in `terraform_azurerm_datafactorytriggerschedule/handlers.py`
