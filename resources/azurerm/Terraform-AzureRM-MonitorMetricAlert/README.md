...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitormetricalert.json`
2. Implement your resource handlers in `terraform_azurerm_monitormetricalert/handlers.py`
