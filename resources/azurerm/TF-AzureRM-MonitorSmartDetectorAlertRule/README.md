...
1. Write the JSON schema describing your resource, `tf-azurerm-monitorsmartdetectoralertrule.json`
2. Implement your resource handlers in `tf_azurerm_monitorsmartdetectoralertrule/handlers.py`
