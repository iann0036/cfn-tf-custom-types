...
1. Write the JSON schema describing your resource, `terraform-azurerm-mapsaccount.json`
2. Implement your resource handlers in `terraform_azurerm_mapsaccount/handlers.py`
