# TF::AzureRM::AppServiceSourceControlToken

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-appservicesourcecontroltoken.json`
2. Implement your resource handlers in `tf_azurerm_appservicesourcecontroltoken/handlers.py`
