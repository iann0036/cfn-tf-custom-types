...
1. Write the JSON schema describing your resource, `tf-azurerm-monitorscheduledqueryrulesalert.json`
2. Implement your resource handlers in `tf_azurerm_monitorscheduledqueryrulesalert/handlers.py`
