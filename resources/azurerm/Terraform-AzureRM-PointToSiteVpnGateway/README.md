...
1. Write the JSON schema describing your resource, `terraform-azurerm-pointtositevpngateway.json`
2. Implement your resource handlers in `terraform_azurerm_pointtositevpngateway/handlers.py`
