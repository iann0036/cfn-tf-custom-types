...
1. Write the JSON schema describing your resource, `terraform-azurerm-devtestwindowsvirtualmachine.json`
2. Implement your resource handlers in `terraform_azurerm_devtestwindowsvirtualmachine/handlers.py`
