...
1. Write the JSON schema describing your resource, `terraform-azurerm-healthcareservice.json`
2. Implement your resource handlers in `terraform_azurerm_healthcareservice/handlers.py`
