...
1. Write the JSON schema describing your resource, `tf-azurerm-postgresqlserver.json`
2. Implement your resource handlers in `tf_azurerm_postgresqlserver/handlers.py`
