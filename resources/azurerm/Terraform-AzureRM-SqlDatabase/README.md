...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqldatabase.json`
2. Implement your resource handlers in `terraform_azurerm_sqldatabase/handlers.py`
