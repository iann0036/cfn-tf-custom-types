...
1. Write the JSON schema describing your resource, `terraform-azurerm-notificationhub.json`
2. Implement your resource handlers in `terraform_azurerm_notificationhub/handlers.py`
