# TF::AzureRM::DataFactoryDatasetCosmosdbSqlapi

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorydatasetcosmosdbsqlapi.json`
2. Implement your resource handlers in `tf_azurerm_datafactorydatasetcosmosdbsqlapi/handlers.py`
