...
1. Write the JSON schema describing your resource, `tf-azurerm-iottimeseriesinsightseventsourceiothub.json`
2. Implement your resource handlers in `tf_azurerm_iottimeseriesinsightseventsourceiothub/handlers.py`
