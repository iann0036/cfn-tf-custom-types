...
1. Write the JSON schema describing your resource, `tf-azurerm-mysqlactivedirectoryadministrator.json`
2. Implement your resource handlers in `tf_azurerm_mysqlactivedirectoryadministrator/handlers.py`
