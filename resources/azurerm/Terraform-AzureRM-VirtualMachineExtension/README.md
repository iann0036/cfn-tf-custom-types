...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualmachineextension.json`
2. Implement your resource handlers in `terraform_azurerm_virtualmachineextension/handlers.py`
