...
1. Write the JSON schema describing your resource, `tf-azurerm-eventgridsystemtopic.json`
2. Implement your resource handlers in `tf_azurerm_eventgridsystemtopic/handlers.py`
