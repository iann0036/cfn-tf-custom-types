...
1. Write the JSON schema describing your resource, `tf-azurerm-storagetable.json`
2. Implement your resource handlers in `tf_azurerm_storagetable/handlers.py`
