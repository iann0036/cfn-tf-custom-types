...
1. Write the JSON schema describing your resource, `tf-azurerm-relayhybridconnection.json`
2. Implement your resource handlers in `tf_azurerm_relayhybridconnection/handlers.py`
