...
1. Write the JSON schema describing your resource, `tf-azurerm-natgatewaypublicipassociation.json`
2. Implement your resource handlers in `tf_azurerm_natgatewaypublicipassociation/handlers.py`
