...
1. Write the JSON schema describing your resource, `tf-azurerm-siterecoveryreplicationpolicy.json`
2. Implement your resource handlers in `tf_azurerm_siterecoveryreplicationpolicy/handlers.py`
