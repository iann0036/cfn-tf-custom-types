...
1. Write the JSON schema describing your resource, `terraform-azurerm-sharedimagegallery.json`
2. Implement your resource handlers in `terraform_azurerm_sharedimagegallery/handlers.py`
