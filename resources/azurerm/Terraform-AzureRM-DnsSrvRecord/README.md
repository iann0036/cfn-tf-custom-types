...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnssrvrecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnssrvrecord/handlers.py`
