...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationrunbook.json`
2. Implement your resource handlers in `terraform_azurerm_automationrunbook/handlers.py`
