...
class ResourceModel(BaseModel):
    ...
    VmProtectionEnabled: Optional[bool]
    DdosProtectionPlan: Optional[Sequence["_DdosProtectionPlanDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BgpCommunity=json_data.get("BgpCommunity"),
            ...
            VmProtectionEnabled=json_data.get("VmProtectionEnabled"),
            DdosProtectionPlan=deserialize_list(json_data.get("DdosProtectionPlan"), DdosProtectionPlanDefinition),
...
@dataclass
class DdosProtectionPlanDefinition(BaseModel):
    Enable: Optional[bool]
    Id: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_DdosProtectionPlanDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DdosProtectionPlanDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DdosProtectionPlanDefinition = DdosProtectionPlanDefinition
