...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualnetwork.json`
2. Implement your resource handlers in `tf_azurerm_virtualnetwork/handlers.py`
