...
1. Write the JSON schema describing your resource, `tf-azurerm-mediaassetfilter.json`
2. Implement your resource handlers in `tf_azurerm_mediaassetfilter/handlers.py`
