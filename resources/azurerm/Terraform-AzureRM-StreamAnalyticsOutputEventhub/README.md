...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsoutputeventhub.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsoutputeventhub/handlers.py`
