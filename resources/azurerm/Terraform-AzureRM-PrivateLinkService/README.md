...
1. Write the JSON schema describing your resource, `terraform-azurerm-privatelinkservice.json`
2. Implement your resource handlers in `terraform_azurerm_privatelinkservice/handlers.py`
