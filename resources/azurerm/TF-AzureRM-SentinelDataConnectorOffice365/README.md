...
1. Write the JSON schema describing your resource, `tf-azurerm-sentineldataconnectoroffice365.json`
2. Implement your resource handlers in `tf_azurerm_sentineldataconnectoroffice365/handlers.py`
