...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticsdatasourcewindowsperformancecounter.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticsdatasourcewindowsperformancecounter/handlers.py`
