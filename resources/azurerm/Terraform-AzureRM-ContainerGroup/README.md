...
1. Write the JSON schema describing your resource, `terraform-azurerm-containergroup.json`
2. Implement your resource handlers in `terraform_azurerm_containergroup/handlers.py`
