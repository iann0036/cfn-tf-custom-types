...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventhubnamespace.json`
2. Implement your resource handlers in `terraform_azurerm_eventhubnamespace/handlers.py`
