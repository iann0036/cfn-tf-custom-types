...
1. Write the JSON schema describing your resource, `terraform-azurerm-backupprotectedfileshare.json`
2. Implement your resource handlers in `terraform_azurerm_backupprotectedfileshare/handlers.py`
