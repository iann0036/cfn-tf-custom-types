...
1. Write the JSON schema describing your resource, `terraform-azurerm-marketplaceagreement.json`
2. Implement your resource handlers in `terraform_azurerm_marketplaceagreement/handlers.py`
