# TF::AzureRM::VirtualDesktopWorkspace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-virtualdesktopworkspace.json`
2. Implement your resource handlers in `tf_azurerm_virtualdesktopworkspace/handlers.py`
