...
1. Write the JSON schema describing your resource, `terraform-azurerm-relaynamespace.json`
2. Implement your resource handlers in `terraform_azurerm_relaynamespace/handlers.py`
