...
1. Write the JSON schema describing your resource, `terraform-azurerm-datalakeanalyticsfirewallrule.json`
2. Implement your resource handlers in `terraform_azurerm_datalakeanalyticsfirewallrule/handlers.py`
