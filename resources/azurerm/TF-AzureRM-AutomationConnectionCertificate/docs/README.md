...
<pre>
{
    "Type" : "TF::AzureRM::AutomationConnectionCertificate",
    "Properties" : {
        "<a href="#automationaccountname" title="AutomationAccountName">AutomationAccountName</a>" : <i>String</i>,
        "<a href="#automationcertificatename" title="AutomationCertificateName">AutomationCertificateName</a>" : <i>String</i>,
