...
1. Write the JSON schema describing your resource, `tf-azurerm-backupprotectedfileshare.json`
2. Implement your resource handlers in `tf_azurerm_backupprotectedfileshare/handlers.py`
