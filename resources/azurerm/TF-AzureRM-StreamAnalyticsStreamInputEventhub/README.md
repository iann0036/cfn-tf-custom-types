...
1. Write the JSON schema describing your resource, `tf-azurerm-streamanalyticsstreaminputeventhub.json`
2. Implement your resource handlers in `tf_azurerm_streamanalyticsstreaminputeventhub/handlers.py`
