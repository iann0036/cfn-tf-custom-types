...
1. Write the JSON schema describing your resource, `terraform-azurerm-applicationsecuritygroup.json`
2. Implement your resource handlers in `terraform_azurerm_applicationsecuritygroup/handlers.py`
