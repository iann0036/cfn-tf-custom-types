# TF::AzureRM::LogicAppTriggerHttpRequest

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-logicapptriggerhttprequest.json`
2. Implement your resource handlers in `tf_azurerm_logicapptriggerhttprequest/handlers.py`
