...
1. Write the JSON schema describing your resource, `terraform-azurerm-securitycentercontact.json`
2. Implement your resource handlers in `terraform_azurerm_securitycentercontact/handlers.py`
