...
1. Write the JSON schema describing your resource, `terraform-azurerm-trafficmanagerprofile.json`
2. Implement your resource handlers in `terraform_azurerm_trafficmanagerprofile/handlers.py`
