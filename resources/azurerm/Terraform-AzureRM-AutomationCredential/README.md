...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationcredential.json`
2. Implement your resource handlers in `terraform_azurerm_automationcredential/handlers.py`
