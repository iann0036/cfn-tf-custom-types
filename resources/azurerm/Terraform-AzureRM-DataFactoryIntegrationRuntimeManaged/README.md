...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactoryintegrationruntimemanaged.json`
2. Implement your resource handlers in `terraform_azurerm_datafactoryintegrationruntimemanaged/handlers.py`
