...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventhub.json`
2. Implement your resource handlers in `terraform_azurerm_eventhub/handlers.py`
