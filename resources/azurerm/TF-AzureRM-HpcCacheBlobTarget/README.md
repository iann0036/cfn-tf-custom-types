...
1. Write the JSON schema describing your resource, `tf-azurerm-hpccacheblobtarget.json`
2. Implement your resource handlers in `tf_azurerm_hpccacheblobtarget/handlers.py`
