...
1. Write the JSON schema describing your resource, `terraform-azurerm-devtestpolicy.json`
2. Implement your resource handlers in `terraform_azurerm_devtestpolicy/handlers.py`
