...
1. Write the JSON schema describing your resource, `tf-azurerm-storageshare.json`
2. Implement your resource handlers in `tf_azurerm_storageshare/handlers.py`
