...
1. Write the JSON schema describing your resource, `terraform-azurerm-backuppolicyfileshare.json`
2. Implement your resource handlers in `terraform_azurerm_backuppolicyfileshare/handlers.py`
