...
1. Write the JSON schema describing your resource, `terraform-azurerm-datalakestorefirewallrule.json`
2. Implement your resource handlers in `terraform_azurerm_datalakestorefirewallrule/handlers.py`
