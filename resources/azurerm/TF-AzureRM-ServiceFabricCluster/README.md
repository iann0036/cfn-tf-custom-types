...
1. Write the JSON schema describing your resource, `tf-azurerm-servicefabriccluster.json`
2. Implement your resource handlers in `tf_azurerm_servicefabriccluster/handlers.py`
