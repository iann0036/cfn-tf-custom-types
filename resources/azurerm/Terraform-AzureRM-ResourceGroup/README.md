...
1. Write the JSON schema describing your resource, `terraform-azurerm-resourcegroup.json`
2. Implement your resource handlers in `terraform_azurerm_resourcegroup/handlers.py`
