...
1. Write the JSON schema describing your resource, `tf-azurerm-securitycenterautomation.json`
2. Implement your resource handlers in `tf_azurerm_securitycenterautomation/handlers.py`
