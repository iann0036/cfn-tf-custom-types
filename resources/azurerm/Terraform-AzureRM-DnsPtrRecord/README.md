...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnsptrrecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnsptrrecord/handlers.py`
