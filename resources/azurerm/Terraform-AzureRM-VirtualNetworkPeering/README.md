...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualnetworkpeering.json`
2. Implement your resource handlers in `terraform_azurerm_virtualnetworkpeering/handlers.py`
