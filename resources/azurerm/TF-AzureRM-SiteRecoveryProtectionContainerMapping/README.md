...
1. Write the JSON schema describing your resource, `tf-azurerm-siterecoveryprotectioncontainermapping.json`
2. Implement your resource handlers in `tf_azurerm_siterecoveryprotectioncontainermapping/handlers.py`
