...
1. Write the JSON schema describing your resource, `terraform-azurerm-notificationhubauthorizationrule.json`
2. Implement your resource handlers in `terraform_azurerm_notificationhubauthorizationrule/handlers.py`
