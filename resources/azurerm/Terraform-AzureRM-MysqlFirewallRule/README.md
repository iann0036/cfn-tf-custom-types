...
1. Write the JSON schema describing your resource, `terraform-azurerm-mysqlfirewallrule.json`
2. Implement your resource handlers in `terraform_azurerm_mysqlfirewallrule/handlers.py`
