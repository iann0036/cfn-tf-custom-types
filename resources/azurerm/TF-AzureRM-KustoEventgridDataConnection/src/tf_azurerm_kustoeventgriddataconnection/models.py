...
class ResourceModel(BaseModel):
    ...
    BlobStorageEventType: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BlobStorageEventType=json_data.get("BlobStorageEventType"),
            ...
            SkipFirstRecord=json_data.get("SkipFirstRecord"),
