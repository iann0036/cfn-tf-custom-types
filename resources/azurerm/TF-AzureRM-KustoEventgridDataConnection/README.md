...
1. Write the JSON schema describing your resource, `tf-azurerm-kustoeventgriddataconnection.json`
2. Implement your resource handlers in `tf_azurerm_kustoeventgriddataconnection/handlers.py`
