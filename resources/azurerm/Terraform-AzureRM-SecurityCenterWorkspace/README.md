...
1. Write the JSON schema describing your resource, `terraform-azurerm-securitycenterworkspace.json`
2. Implement your resource handlers in `terraform_azurerm_securitycenterworkspace/handlers.py`
