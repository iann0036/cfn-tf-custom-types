...
1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbgremlingraph.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbgremlingraph/handlers.py`
