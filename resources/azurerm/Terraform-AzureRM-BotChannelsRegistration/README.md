...
1. Write the JSON schema describing your resource, `terraform-azurerm-botchannelsregistration.json`
2. Implement your resource handlers in `terraform_azurerm_botchannelsregistration/handlers.py`
