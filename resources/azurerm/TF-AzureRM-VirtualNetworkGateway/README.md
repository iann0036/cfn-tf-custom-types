...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualnetworkgateway.json`
2. Implement your resource handlers in `tf_azurerm_virtualnetworkgateway/handlers.py`
