...
class FilterDefinition(BaseModel):
    ...
    IncludeBlobVersions: Optional[bool]
    IncludeSnapshots: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            IncludeBlobVersions=json_data.get("IncludeBlobVersions"),
            IncludeSnapshots=json_data.get("IncludeSnapshots"),
