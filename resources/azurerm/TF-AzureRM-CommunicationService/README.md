# TF::AzureRM::CommunicationService

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-communicationservice.json`
2. Implement your resource handlers in `tf_azurerm_communicationservice/handlers.py`
