...
1. Write the JSON schema describing your resource, `terraform-azurerm-loganalyticsworkspace.json`
2. Implement your resource handlers in `terraform_azurerm_loganalyticsworkspace/handlers.py`
