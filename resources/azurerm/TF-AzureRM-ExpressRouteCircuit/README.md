...
1. Write the JSON schema describing your resource, `tf-azurerm-expressroutecircuit.json`
2. Implement your resource handlers in `tf_azurerm_expressroutecircuit/handlers.py`
