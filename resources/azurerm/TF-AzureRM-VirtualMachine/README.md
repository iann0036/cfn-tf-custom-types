...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualmachine.json`
2. Implement your resource handlers in `tf_azurerm_virtualmachine/handlers.py`
