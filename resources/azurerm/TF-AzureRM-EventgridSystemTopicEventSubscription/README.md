...
1. Write the JSON schema describing your resource, `tf-azurerm-eventgridsystemtopiceventsubscription.json`
2. Implement your resource handlers in `tf_azurerm_eventgridsystemtopiceventsubscription/handlers.py`
