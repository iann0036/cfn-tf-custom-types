...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventhubconsumergroup.json`
2. Implement your resource handlers in `terraform_azurerm_eventhubconsumergroup/handlers.py`
