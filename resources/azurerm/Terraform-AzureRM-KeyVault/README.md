...
1. Write the JSON schema describing your resource, `terraform-azurerm-keyvault.json`
2. Implement your resource handlers in `terraform_azurerm_keyvault/handlers.py`
