...
1. Write the JSON schema describing your resource, `terraform-azurerm-hdinsightsparkcluster.json`
2. Implement your resource handlers in `terraform_azurerm_hdinsightsparkcluster/handlers.py`
