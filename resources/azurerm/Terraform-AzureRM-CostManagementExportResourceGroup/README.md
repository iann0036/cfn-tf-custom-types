...
1. Write the JSON schema describing your resource, `terraform-azurerm-costmanagementexportresourcegroup.json`
2. Implement your resource handlers in `terraform_azurerm_costmanagementexportresourcegroup/handlers.py`
