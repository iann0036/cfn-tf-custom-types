...
1. Write the JSON schema describing your resource, `terraform-azurerm-devtestschedule.json`
2. Implement your resource handlers in `terraform_azurerm_devtestschedule/handlers.py`
