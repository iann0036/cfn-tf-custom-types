...
1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbaccount.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbaccount/handlers.py`
