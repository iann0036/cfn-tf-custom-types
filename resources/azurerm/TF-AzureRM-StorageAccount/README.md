...
1. Write the JSON schema describing your resource, `tf-azurerm-storageaccount.json`
2. Implement your resource handlers in `tf_azurerm_storageaccount/handlers.py`
