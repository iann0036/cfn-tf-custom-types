...
TYPE_NAME = "TF::AzureRM::StorageAccount"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/azurerm_storage_account/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'hashicorp/azurerm',
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/azurerm_storage_account/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/azurerm_storage_account/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccessTier=None, AccountKind=None, AccountReplicationType=None, AccountTier=None, AllowBlobPublicAccess=None, EnableHttpsTrafficOnly=None, Id=None, IsHnsEnabled=None, LargeFileShareEnabled=None, Location=None, MinTlsVersion=None, Name=None, Nfsv3Enabled=None, PrimaryAccessKey=None, PrimaryBlobConnectionString=None, PrimaryBlobEndpoint=None, PrimaryBlobHost=None, PrimaryConnectionString=None, PrimaryDfsEndpoint=None, PrimaryDfsHost=None, PrimaryFileEndpoint=None, PrimaryFileHost=None, PrimaryLocation=None, PrimaryQueueEndpoint=None, PrimaryQueueHost=None, PrimaryTableEndpoint=None, PrimaryTableHost=None, PrimaryWebEndpoint=None, PrimaryWebHost=None, ResourceGroupName=None, SecondaryAccessKey=None, SecondaryBlobConnectionString=None, SecondaryBlobEndpoint=None, SecondaryBlobHost=None, SecondaryConnectionString=None, SecondaryDfsEndpoint=None, SecondaryDfsHost=None, SecondaryFileEndpoint=None, SecondaryFileHost=None, SecondaryLocation=None, SecondaryQueueEndpoint=None, SecondaryQueueHost=None, SecondaryTableEndpoint=None, SecondaryTableHost=None, SecondaryWebEndpoint=None, SecondaryWebHost=None, Tags=None, AzureFilesAuthentication=None, BlobProperties=None, CustomDomain=None, Identity=None, NetworkRules=None, QueueProperties=None, Routing=None, ShareProperties=None, StaticWebsite=None, Timeouts=None)
