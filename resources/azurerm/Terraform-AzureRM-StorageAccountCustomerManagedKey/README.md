...
1. Write the JSON schema describing your resource, `terraform-azurerm-storageaccountcustomermanagedkey.json`
2. Implement your resource handlers in `terraform_azurerm_storageaccountcustomermanagedkey/handlers.py`
