...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceazuresearch.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceazuresearch/handlers.py`
