...
class ResourceModel(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EncryptedCredential=json_data.get("EncryptedCredential"),
            Id=json_data.get("Id"),
            ...
            SearchServiceKey=json_data.get("SearchServiceKey"),
