...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationjobschedule.json`
2. Implement your resource handlers in `terraform_azurerm_automationjobschedule/handlers.py`
