...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkprofile.json`
2. Implement your resource handlers in `terraform_azurerm_networkprofile/handlers.py`
