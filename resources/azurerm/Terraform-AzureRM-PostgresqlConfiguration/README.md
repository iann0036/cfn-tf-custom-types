...
1. Write the JSON schema describing your resource, `terraform-azurerm-postgresqlconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_postgresqlconfiguration/handlers.py`
