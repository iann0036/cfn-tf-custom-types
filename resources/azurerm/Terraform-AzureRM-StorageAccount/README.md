...
1. Write the JSON schema describing your resource, `terraform-azurerm-storageaccount.json`
2. Implement your resource handlers in `terraform_azurerm_storageaccount/handlers.py`
