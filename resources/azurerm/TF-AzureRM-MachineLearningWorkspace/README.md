# TF::AzureRM::MachineLearningWorkspace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-machinelearningworkspace.json`
2. Implement your resource handlers in `tf_azurerm_machinelearningworkspace/handlers.py`
