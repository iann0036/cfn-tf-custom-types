# TF::AzureRM::DigitalTwinsEndpointEventhub

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-digitaltwinsendpointeventhub.json`
2. Implement your resource handlers in `tf_azurerm_digitaltwinsendpointeventhub/handlers.py`
