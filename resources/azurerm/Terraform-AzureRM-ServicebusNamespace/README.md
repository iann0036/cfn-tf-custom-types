...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebusnamespace.json`
2. Implement your resource handlers in `terraform_azurerm_servicebusnamespace/handlers.py`
