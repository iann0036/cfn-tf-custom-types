...
<pre>
{
    "Type" : "TF::AzureRM::StorageEncryptionScope",
    "Properties" : {
        "<a href="#infrastructureencryptionrequired" title="InfrastructureEncryptionRequired">InfrastructureEncryptionRequired</a>" : <i>Boolean</i>,
