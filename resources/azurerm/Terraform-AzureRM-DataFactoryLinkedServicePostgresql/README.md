...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactorylinkedservicepostgresql.json`
2. Implement your resource handlers in `terraform_azurerm_datafactorylinkedservicepostgresql/handlers.py`
