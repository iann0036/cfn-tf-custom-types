...
1. Write the JSON schema describing your resource, `terraform-azurerm-routetable.json`
2. Implement your resource handlers in `terraform_azurerm_routetable/handlers.py`
