# TF::AzureRM::NetworkInterfaceNatRuleAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-networkinterfacenatruleassociation.json`
2. Implement your resource handlers in `tf_azurerm_networkinterfacenatruleassociation/handlers.py`
