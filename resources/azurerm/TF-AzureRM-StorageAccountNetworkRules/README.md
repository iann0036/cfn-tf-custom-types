...
1. Write the JSON schema describing your resource, `tf-azurerm-storageaccountnetworkrules.json`
2. Implement your resource handlers in `tf_azurerm_storageaccountnetworkrules/handlers.py`
