...
1. Write the JSON schema describing your resource, `terraform-azurerm-cdnendpoint.json`
2. Implement your resource handlers in `terraform_azurerm_cdnendpoint/handlers.py`
