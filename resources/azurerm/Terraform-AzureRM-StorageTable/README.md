...
1. Write the JSON schema describing your resource, `terraform-azurerm-storagetable.json`
2. Implement your resource handlers in `terraform_azurerm_storagetable/handlers.py`
