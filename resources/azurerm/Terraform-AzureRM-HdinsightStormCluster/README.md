...
1. Write the JSON schema describing your resource, `terraform-azurerm-hdinsightstormcluster.json`
2. Implement your resource handlers in `terraform_azurerm_hdinsightstormcluster/handlers.py`
