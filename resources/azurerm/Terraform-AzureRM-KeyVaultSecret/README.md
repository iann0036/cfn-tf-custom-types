...
1. Write the JSON schema describing your resource, `terraform-azurerm-keyvaultsecret.json`
2. Implement your resource handlers in `terraform_azurerm_keyvaultsecret/handlers.py`
