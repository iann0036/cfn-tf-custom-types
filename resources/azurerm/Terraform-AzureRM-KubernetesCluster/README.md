...
1. Write the JSON schema describing your resource, `terraform-azurerm-kubernetescluster.json`
2. Implement your resource handlers in `terraform_azurerm_kubernetescluster/handlers.py`
