...
1. Write the JSON schema describing your resource, `terraform-azurerm-batchcertificate.json`
2. Implement your resource handlers in `terraform_azurerm_batchcertificate/handlers.py`
