...
1. Write the JSON schema describing your resource, `terraform-azurerm-devtestlinuxvirtualmachine.json`
2. Implement your resource handlers in `terraform_azurerm_devtestlinuxvirtualmachine/handlers.py`
