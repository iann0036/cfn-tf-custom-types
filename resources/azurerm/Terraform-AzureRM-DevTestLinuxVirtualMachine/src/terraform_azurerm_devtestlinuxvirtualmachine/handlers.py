...
def create_handler(
    ...
    try:
        ...
        tf['resource']['azurerm_dev_test_linux_virtual_machine'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['azurerm_dev_test_linux_virtual_machine'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
