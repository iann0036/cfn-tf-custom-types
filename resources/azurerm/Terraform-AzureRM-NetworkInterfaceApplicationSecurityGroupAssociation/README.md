...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkinterfaceapplicationsecuritygroupassociation.json`
2. Implement your resource handlers in `terraform_azurerm_networkinterfaceapplicationsecuritygroupassociation/handlers.py`
