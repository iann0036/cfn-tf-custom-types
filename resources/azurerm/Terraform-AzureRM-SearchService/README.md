...
1. Write the JSON schema describing your resource, `terraform-azurerm-searchservice.json`
2. Implement your resource handlers in `terraform_azurerm_searchservice/handlers.py`
