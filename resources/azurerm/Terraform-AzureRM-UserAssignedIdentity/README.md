...
1. Write the JSON schema describing your resource, `terraform-azurerm-userassignedidentity.json`
2. Implement your resource handlers in `terraform_azurerm_userassignedidentity/handlers.py`
