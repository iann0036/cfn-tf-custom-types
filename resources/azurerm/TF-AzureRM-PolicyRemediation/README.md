...
1. Write the JSON schema describing your resource, `tf-azurerm-policyremediation.json`
2. Implement your resource handlers in `tf_azurerm_policyremediation/handlers.py`
