...
1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementcertificate.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementcertificate/handlers.py`
