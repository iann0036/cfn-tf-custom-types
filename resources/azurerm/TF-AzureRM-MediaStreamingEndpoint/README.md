...
1. Write the JSON schema describing your resource, `tf-azurerm-mediastreamingendpoint.json`
2. Implement your resource handlers in `tf_azurerm_mediastreamingendpoint/handlers.py`
