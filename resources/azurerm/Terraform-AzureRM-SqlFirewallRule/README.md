...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqlfirewallrule.json`
2. Implement your resource handlers in `terraform_azurerm_sqlfirewallrule/handlers.py`
