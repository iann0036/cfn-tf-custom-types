...
1. Write the JSON schema describing your resource, `tf-azurerm-synapseworkspace.json`
2. Implement your resource handlers in `tf_azurerm_synapseworkspace/handlers.py`
