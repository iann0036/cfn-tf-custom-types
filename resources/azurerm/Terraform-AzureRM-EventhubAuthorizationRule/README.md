...
1. Write the JSON schema describing your resource, `terraform-azurerm-eventhubauthorizationrule.json`
2. Implement your resource handlers in `terraform_azurerm_eventhubauthorizationrule/handlers.py`
