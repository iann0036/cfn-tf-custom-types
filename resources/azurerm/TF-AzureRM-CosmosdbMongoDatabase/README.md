# TF::AzureRM::CosmosdbMongoDatabase

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbmongodatabase.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbmongodatabase/handlers.py`
