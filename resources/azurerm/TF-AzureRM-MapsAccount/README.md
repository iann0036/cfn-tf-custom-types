# TF::AzureRM::MapsAccount

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-mapsaccount.json`
2. Implement your resource handlers in `tf_azurerm_mapsaccount/handlers.py`
