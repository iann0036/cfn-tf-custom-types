...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubdpssharedaccesspolicy.json`
2. Implement your resource handlers in `terraform_azurerm_iothubdpssharedaccesspolicy/handlers.py`
