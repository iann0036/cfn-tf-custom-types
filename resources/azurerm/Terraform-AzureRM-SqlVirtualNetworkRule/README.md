...
1. Write the JSON schema describing your resource, `terraform-azurerm-sqlvirtualnetworkrule.json`
2. Implement your resource handlers in `terraform_azurerm_sqlvirtualnetworkrule/handlers.py`
