...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticsstorageinsights.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticsstorageinsights/handlers.py`
