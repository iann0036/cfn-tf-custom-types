...
1. Write the JSON schema describing your resource, `tf-azurerm-cognitiveaccount.json`
2. Implement your resource handlers in `tf_azurerm_cognitiveaccount/handlers.py`
