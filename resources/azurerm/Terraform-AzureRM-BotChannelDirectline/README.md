...
1. Write the JSON schema describing your resource, `terraform-azurerm-botchanneldirectline.json`
2. Implement your resource handlers in `terraform_azurerm_botchanneldirectline/handlers.py`
