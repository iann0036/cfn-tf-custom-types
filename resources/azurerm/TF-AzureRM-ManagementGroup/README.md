...
1. Write the JSON schema describing your resource, `tf-azurerm-managementgroup.json`
2. Implement your resource handlers in `tf_azurerm_managementgroup/handlers.py`
