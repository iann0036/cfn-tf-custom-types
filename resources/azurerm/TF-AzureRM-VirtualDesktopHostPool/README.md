...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualdesktophostpool.json`
2. Implement your resource handlers in `tf_azurerm_virtualdesktophostpool/handlers.py`
