# TF::AzureRM::SentinelAlertRuleMachineLearningBehaviorAnalytics

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-sentinelalertrulemachinelearningbehavioranalytics.json`
2. Implement your resource handlers in `tf_azurerm_sentinelalertrulemachinelearningbehavioranalytics/handlers.py`
