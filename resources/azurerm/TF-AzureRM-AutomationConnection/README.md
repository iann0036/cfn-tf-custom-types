# TF::AzureRM::AutomationConnection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-automationconnection.json`
2. Implement your resource handlers in `tf_azurerm_automationconnection/handlers.py`
