...
1. Write the JSON schema describing your resource, `terraform-azurerm-backupcontainerstorageaccount.json`
2. Implement your resource handlers in `terraform_azurerm_backupcontainerstorageaccount/handlers.py`
