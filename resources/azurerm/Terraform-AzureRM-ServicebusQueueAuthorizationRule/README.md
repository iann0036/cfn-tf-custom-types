...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebusqueueauthorizationrule.json`
2. Implement your resource handlers in `terraform_azurerm_servicebusqueueauthorizationrule/handlers.py`
