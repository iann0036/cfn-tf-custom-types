...
1. Write the JSON schema describing your resource, `tf-azurerm-virtualhubconnection.json`
2. Implement your resource handlers in `tf_azurerm_virtualhubconnection/handlers.py`
