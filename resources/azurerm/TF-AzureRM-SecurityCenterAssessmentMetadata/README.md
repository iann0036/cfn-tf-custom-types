...
1. Write the JSON schema describing your resource, `tf-azurerm-securitycenterassessmentmetadata.json`
2. Implement your resource handlers in `tf_azurerm_securitycenterassessmentmetadata/handlers.py`
