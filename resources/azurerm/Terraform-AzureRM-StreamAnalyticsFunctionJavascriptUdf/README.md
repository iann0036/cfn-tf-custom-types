...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsfunctionjavascriptudf.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsfunctionjavascriptudf/handlers.py`
