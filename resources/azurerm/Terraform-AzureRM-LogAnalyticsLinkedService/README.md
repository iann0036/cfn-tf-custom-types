# Terraform::AzureRM::LogAnalyticsLinkedService

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-loganalyticslinkedservice.json`
2. Implement your resource handlers in `terraform_azurerm_loganalyticslinkedservice/handlers.py`
