...
1. Write the JSON schema describing your resource, `tf-azurerm-containerregistry.json`
2. Implement your resource handlers in `tf_azurerm_containerregistry/handlers.py`
