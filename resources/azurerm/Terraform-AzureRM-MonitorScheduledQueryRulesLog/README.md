...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitorscheduledqueryruleslog.json`
2. Implement your resource handlers in `terraform_azurerm_monitorscheduledqueryruleslog/handlers.py`
