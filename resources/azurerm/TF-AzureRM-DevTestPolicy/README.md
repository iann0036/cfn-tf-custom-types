...
1. Write the JSON schema describing your resource, `tf-azurerm-devtestpolicy.json`
2. Implement your resource handlers in `tf_azurerm_devtestpolicy/handlers.py`
