...
1. Write the JSON schema describing your resource, `terraform-azurerm-postgresqlvirtualnetworkrule.json`
2. Implement your resource handlers in `terraform_azurerm_postgresqlvirtualnetworkrule/handlers.py`
