...
1. Write the JSON schema describing your resource, `tf-azurerm-dnscaarecord.json`
2. Implement your resource handlers in `tf_azurerm_dnscaarecord/handlers.py`
