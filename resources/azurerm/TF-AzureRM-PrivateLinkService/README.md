...
1. Write the JSON schema describing your resource, `tf-azurerm-privatelinkservice.json`
2. Implement your resource handlers in `tf_azurerm_privatelinkservice/handlers.py`
