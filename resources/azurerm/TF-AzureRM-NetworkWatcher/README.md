# TF::AzureRM::NetworkWatcher

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-networkwatcher.json`
2. Implement your resource handlers in `tf_azurerm_networkwatcher/handlers.py`
