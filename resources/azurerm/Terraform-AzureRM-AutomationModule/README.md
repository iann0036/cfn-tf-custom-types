...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationmodule.json`
2. Implement your resource handlers in `terraform_azurerm_automationmodule/handlers.py`
