# TF::AzureRM::DataFactoryLinkedServiceAzureFunction

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceazurefunction.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceazurefunction/handlers.py`
