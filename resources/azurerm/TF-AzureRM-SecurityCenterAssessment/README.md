...
1. Write the JSON schema describing your resource, `tf-azurerm-securitycenterassessment.json`
2. Implement your resource handlers in `tf_azurerm_securitycenterassessment/handlers.py`
