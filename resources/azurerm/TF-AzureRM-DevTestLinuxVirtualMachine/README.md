...
1. Write the JSON schema describing your resource, `tf-azurerm-devtestlinuxvirtualmachine.json`
2. Implement your resource handlers in `tf_azurerm_devtestlinuxvirtualmachine/handlers.py`
