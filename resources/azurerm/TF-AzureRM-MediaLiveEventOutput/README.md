...
1. Write the JSON schema describing your resource, `tf-azurerm-medialiveeventoutput.json`
2. Implement your resource handlers in `tf_azurerm_medialiveeventoutput/handlers.py`
