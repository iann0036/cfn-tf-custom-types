...
1. Write the JSON schema describing your resource, `tf-azurerm-storagedatalakegen2path.json`
2. Implement your resource handlers in `tf_azurerm_storagedatalakegen2path/handlers.py`
