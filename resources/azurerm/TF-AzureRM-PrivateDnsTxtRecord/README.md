# TF::AzureRM::PrivateDnsTxtRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-privatednstxtrecord.json`
2. Implement your resource handlers in `tf_azurerm_privatednstxtrecord/handlers.py`
