# TF::AzureRM::StorageDataLakeGen2Filesystem

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-storagedatalakegen2filesystem.json`
2. Implement your resource handlers in `tf_azurerm_storagedatalakegen2filesystem/handlers.py`
