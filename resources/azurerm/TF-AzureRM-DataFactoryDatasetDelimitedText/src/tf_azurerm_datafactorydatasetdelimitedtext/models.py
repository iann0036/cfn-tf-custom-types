...
class ResourceModel(BaseModel):
    ...
    ColumnDelimiter: Optional[str]
    CompressionCodec: Optional[str]
    CompressionLevel: Optional[str]
    ...
    AzureBlobFsLocation: Optional[Sequence["_AzureBlobFsLocationDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ColumnDelimiter=json_data.get("ColumnDelimiter"),
            ...
            FirstRowAsHeader=json_data.get("FirstRowAsHeader"),
            Folder=json_data.get("Folder"),
            Id=json_data.get("Id"),
            LinkedServiceName=json_data.get("LinkedServiceName"),
            Name=json_data.get("Name"),
            NullValue=json_data.get("NullValue"),
            Parameters=deserialize_list(json_data.get("Parameters"), ParametersDefinition),
            QuoteCharacter=json_data.get("QuoteCharacter"),
            ResourceGroupName=json_data.get("ResourceGroupName"),
            RowDelimiter=json_data.get("RowDelimiter"),
            AzureBlobFsLocation=deserialize_list(json_data.get("AzureBlobFsLocation"), AzureBlobFsLocationDefinition),
...
@dataclass
class AzureBlobFsLocationDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AzureBlobFsLocationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AzureBlobFsLocationDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AzureBlobFsLocationDefinition = AzureBlobFsLocationDefinition
