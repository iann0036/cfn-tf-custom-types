...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorydatasetdelimitedtext.json`
2. Implement your resource handlers in `tf_azurerm_datafactorydatasetdelimitedtext/handlers.py`
