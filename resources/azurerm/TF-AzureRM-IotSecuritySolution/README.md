...
1. Write the JSON schema describing your resource, `tf-azurerm-iotsecuritysolution.json`
2. Implement your resource handlers in `tf_azurerm_iotsecuritysolution/handlers.py`
