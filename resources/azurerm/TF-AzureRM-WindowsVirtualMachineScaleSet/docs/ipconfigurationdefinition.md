# TF::AzureRM::WindowsVirtualMachineScaleSet IpConfigurationDefinition
...
<pre>
{
    ...
    "<a href="#publicipaddress" title="PublicIpAddress">PublicIpAddress</a>" : <i>[ <a href="publicipaddressdefinition.md">PublicIpAddressDefinition</a>, ... ]</i>
}
</pre>
...
<a href="#publicipaddress" title="PublicIpAddress">PublicIpAddress</a>: <i>
      - <a href="publicipaddressdefinition.md">PublicIpAddressDefinition</a></i>
</pre>
...
_Type_: List of <a href="publicipaddressdefinition.md">PublicIpAddressDefinition</a>
