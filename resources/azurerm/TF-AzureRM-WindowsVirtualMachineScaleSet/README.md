...
1. Write the JSON schema describing your resource, `tf-azurerm-windowsvirtualmachinescaleset.json`
2. Implement your resource handlers in `tf_azurerm_windowsvirtualmachinescaleset/handlers.py`
