# TF::AzureRM::SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-sentineldataconnectormicrosoftdefenderadvancedthreatprotection.json`
2. Implement your resource handlers in `tf_azurerm_sentineldataconnectormicrosoftdefenderadvancedthreatprotection/handlers.py`
