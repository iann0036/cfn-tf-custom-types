# TF::AzureRM::MariadbDatabase

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-mariadbdatabase.json`
2. Implement your resource handlers in `tf_azurerm_mariadbdatabase/handlers.py`
