...
1. Write the JSON schema describing your resource, `tf-azurerm-packetcapture.json`
2. Implement your resource handlers in `tf_azurerm_packetcapture/handlers.py`
