...
1. Write the JSON schema describing your resource, `tf-azurerm-trafficmanagerprofile.json`
2. Implement your resource handlers in `tf_azurerm_trafficmanagerprofile/handlers.py`
