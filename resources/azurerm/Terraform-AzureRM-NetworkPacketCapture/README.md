...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkpacketcapture.json`
2. Implement your resource handlers in `terraform_azurerm_networkpacketcapture/handlers.py`
