...
1. Write the JSON schema describing your resource, `terraform-azurerm-securitycentersubscriptionpricing.json`
2. Implement your resource handlers in `terraform_azurerm_securitycentersubscriptionpricing/handlers.py`
