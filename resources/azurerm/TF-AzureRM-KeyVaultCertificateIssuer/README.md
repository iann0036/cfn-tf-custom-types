...
1. Write the JSON schema describing your resource, `tf-azurerm-keyvaultcertificateissuer.json`
2. Implement your resource handlers in `tf_azurerm_keyvaultcertificateissuer/handlers.py`
