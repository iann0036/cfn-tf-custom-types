...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitorscheduledqueryrulesalert.json`
2. Implement your resource handlers in `terraform_azurerm_monitorscheduledqueryrulesalert/handlers.py`
