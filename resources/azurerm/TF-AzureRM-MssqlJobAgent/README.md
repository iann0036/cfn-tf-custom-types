# TF::AzureRM::MssqlJobAgent

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-mssqljobagent.json`
2. Implement your resource handlers in `tf_azurerm_mssqljobagent/handlers.py`
