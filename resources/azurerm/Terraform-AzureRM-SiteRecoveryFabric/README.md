...
1. Write the JSON schema describing your resource, `terraform-azurerm-siterecoveryfabric.json`
2. Implement your resource handlers in `terraform_azurerm_siterecoveryfabric/handlers.py`
