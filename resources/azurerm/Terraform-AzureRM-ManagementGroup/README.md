...
1. Write the JSON schema describing your resource, `terraform-azurerm-managementgroup.json`
2. Implement your resource handlers in `terraform_azurerm_managementgroup/handlers.py`
