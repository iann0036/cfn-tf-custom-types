...
1. Write the JSON schema describing your resource, `tf-azurerm-iottimeseriesinsightsaccesspolicy.json`
2. Implement your resource handlers in `tf_azurerm_iottimeseriesinsightsaccesspolicy/handlers.py`
