...
class ResourceModel(BaseModel):
    ...
    DataAccessFqdn: Optional[str]
    Id: Optional[str]
    IdProperties: Optional[Sequence[str]]
    Location: Optional[str]
    Name: Optional[str]
    ResourceGroupName: Optional[str]
    SkuName: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    WarmStoreDataRetentionTime: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DataAccessFqdn=json_data.get("DataAccessFqdn"),
            Id=json_data.get("Id"),
            IdProperties=json_data.get("IdProperties"),
            Location=json_data.get("Location"),
            Name=json_data.get("Name"),
            ResourceGroupName=json_data.get("ResourceGroupName"),
            SkuName=json_data.get("SkuName"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            WarmStoreDataRetentionTime=json_data.get("WarmStoreDataRetentionTime"),
