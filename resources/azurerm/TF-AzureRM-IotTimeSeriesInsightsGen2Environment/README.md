...
1. Write the JSON schema describing your resource, `tf-azurerm-iottimeseriesinsightsgen2environment.json`
2. Implement your resource handlers in `tf_azurerm_iottimeseriesinsightsgen2environment/handlers.py`
