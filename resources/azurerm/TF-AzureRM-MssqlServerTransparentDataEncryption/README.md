...
1. Write the JSON schema describing your resource, `tf-azurerm-mssqlservertransparentdataencryption.json`
2. Implement your resource handlers in `tf_azurerm_mssqlservertransparentdataencryption/handlers.py`
