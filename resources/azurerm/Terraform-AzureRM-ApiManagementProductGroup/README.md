# Terraform::AzureRM::ApiManagementProductGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementproductgroup.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementproductgroup/handlers.py`
