...
1. Write the JSON schema describing your resource, `terraform-azurerm-iothubendpointeventhub.json`
2. Implement your resource handlers in `terraform_azurerm_iothubendpointeventhub/handlers.py`
