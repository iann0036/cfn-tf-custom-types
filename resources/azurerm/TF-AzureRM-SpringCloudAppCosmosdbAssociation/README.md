...
1. Write the JSON schema describing your resource, `tf-azurerm-springcloudappcosmosdbassociation.json`
2. Implement your resource handlers in `tf_azurerm_springcloudappcosmosdbassociation/handlers.py`
