...
1. Write the JSON schema describing your resource, `terraform-azurerm-webapplicationfirewallpolicy.json`
2. Implement your resource handlers in `terraform_azurerm_webapplicationfirewallpolicy/handlers.py`
