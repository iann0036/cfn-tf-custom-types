...
1. Write the JSON schema describing your resource, `terraform-azurerm-postgresqlfirewallrule.json`
2. Implement your resource handlers in `terraform_azurerm_postgresqlfirewallrule/handlers.py`
