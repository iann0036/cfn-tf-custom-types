...
1. Write the JSON schema describing your resource, `terraform-azurerm-appservicevirtualnetworkswiftconnection.json`
2. Implement your resource handlers in `terraform_azurerm_appservicevirtualnetworkswiftconnection/handlers.py`
