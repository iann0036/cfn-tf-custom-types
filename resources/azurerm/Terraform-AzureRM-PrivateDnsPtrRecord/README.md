# Terraform::AzureRM::PrivateDnsPtrRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-privatednsptrrecord.json`
2. Implement your resource handlers in `terraform_azurerm_privatednsptrrecord/handlers.py`
