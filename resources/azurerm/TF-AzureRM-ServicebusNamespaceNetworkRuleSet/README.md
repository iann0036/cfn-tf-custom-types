...
1. Write the JSON schema describing your resource, `tf-azurerm-servicebusnamespacenetworkruleset.json`
2. Implement your resource handlers in `tf_azurerm_servicebusnamespacenetworkruleset/handlers.py`
