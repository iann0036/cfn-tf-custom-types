# TF::AzureRM::DataFactoryLinkedServiceSnowflake

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedservicesnowflake.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedservicesnowflake/handlers.py`
