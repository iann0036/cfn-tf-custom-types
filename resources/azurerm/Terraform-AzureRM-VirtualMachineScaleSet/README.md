...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualmachinescaleset.json`
2. Implement your resource handlers in `terraform_azurerm_virtualmachinescaleset/handlers.py`
