# TF::AzureRM::VmwareExpressRouteAuthorization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-vmwareexpressrouteauthorization.json`
2. Implement your resource handlers in `tf_azurerm_vmwareexpressrouteauthorization/handlers.py`
