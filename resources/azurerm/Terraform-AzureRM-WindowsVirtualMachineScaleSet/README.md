...
1. Write the JSON schema describing your resource, `terraform-azurerm-windowsvirtualmachinescaleset.json`
2. Implement your resource handlers in `terraform_azurerm_windowsvirtualmachinescaleset/handlers.py`
