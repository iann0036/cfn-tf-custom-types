...
1. Write the JSON schema describing your resource, `terraform-azurerm-virtualmachinescalesetextension.json`
2. Implement your resource handlers in `terraform_azurerm_virtualmachinescalesetextension/handlers.py`
