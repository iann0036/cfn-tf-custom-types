...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebussubscriptionrule.json`
2. Implement your resource handlers in `terraform_azurerm_servicebussubscriptionrule/handlers.py`
