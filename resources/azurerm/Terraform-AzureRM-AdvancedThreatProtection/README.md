...
1. Write the JSON schema describing your resource, `terraform-azurerm-advancedthreatprotection.json`
2. Implement your resource handlers in `terraform_azurerm_advancedthreatprotection/handlers.py`
