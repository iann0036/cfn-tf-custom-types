...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationdscconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_automationdscconfiguration/handlers.py`
