# TF::AzureRM::DataFactoryLinkedServiceDataLakeStorageGen2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedservicedatalakestoragegen2.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedservicedatalakestoragegen2/handlers.py`
