...
1. Write the JSON schema describing your resource, `terraform-azurerm-logicapptriggerrecurrence.json`
2. Implement your resource handlers in `terraform_azurerm_logicapptriggerrecurrence/handlers.py`
