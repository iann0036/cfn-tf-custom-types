...
1. Write the JSON schema describing your resource, `terraform-azurerm-datafactory.json`
2. Implement your resource handlers in `terraform_azurerm_datafactory/handlers.py`
