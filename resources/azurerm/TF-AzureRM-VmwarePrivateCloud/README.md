...
1. Write the JSON schema describing your resource, `tf-azurerm-vmwareprivatecloud.json`
2. Implement your resource handlers in `tf_azurerm_vmwareprivatecloud/handlers.py`
