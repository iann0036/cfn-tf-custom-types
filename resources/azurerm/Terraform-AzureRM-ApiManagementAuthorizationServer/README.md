...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementauthorizationserver.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementauthorizationserver/handlers.py`
