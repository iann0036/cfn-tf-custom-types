...
1. Write the JSON schema describing your resource, `tf-azurerm-loganalyticslinkedstorageaccount.json`
2. Implement your resource handlers in `tf_azurerm_loganalyticslinkedstorageaccount/handlers.py`
