# TF::AzureRM::StackHciCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-stackhcicluster.json`
2. Implement your resource handlers in `tf_azurerm_stackhcicluster/handlers.py`
