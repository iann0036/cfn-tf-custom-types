...
1. Write the JSON schema describing your resource, `terraform-azurerm-hpccache.json`
2. Implement your resource handlers in `terraform_azurerm_hpccache/handlers.py`
