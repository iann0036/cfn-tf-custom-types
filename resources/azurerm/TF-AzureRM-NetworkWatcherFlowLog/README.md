...
1. Write the JSON schema describing your resource, `tf-azurerm-networkwatcherflowlog.json`
2. Implement your resource handlers in `tf_azurerm_networkwatcherflowlog/handlers.py`
