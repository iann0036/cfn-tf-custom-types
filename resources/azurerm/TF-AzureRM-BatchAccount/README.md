...
1. Write the JSON schema describing your resource, `tf-azurerm-batchaccount.json`
2. Implement your resource handlers in `tf_azurerm_batchaccount/handlers.py`
