...
class ResourceModel(BaseModel):
    ...
    KeyVaultReference: Optional[Sequence["_KeyVaultReferenceDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            KeyVaultReference=deserialize_list(json_data.get("KeyVaultReference"), KeyVaultReferenceDefinition),
...
@dataclass
class KeyVaultReferenceDefinition(BaseModel):
    Id: Optional[str]
    Url: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_KeyVaultReferenceDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_KeyVaultReferenceDefinition"]:
        if not json_data:
            return None
        return cls(
            Id=json_data.get("Id"),
...
# work around possible type aliasing issues when variable has same name as a model
_KeyVaultReferenceDefinition = KeyVaultReferenceDefinition
