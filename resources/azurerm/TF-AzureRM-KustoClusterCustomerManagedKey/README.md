...
1. Write the JSON schema describing your resource, `tf-azurerm-kustoclustercustomermanagedkey.json`
2. Implement your resource handlers in `tf_azurerm_kustoclustercustomermanagedkey/handlers.py`
