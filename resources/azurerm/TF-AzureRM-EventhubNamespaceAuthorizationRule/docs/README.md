...
<pre>
{
    "Type" : "TF::AzureRM::EventhubNamespaceAuthorizationRule",
    "Properties" : {
...
Returns the <code>PrimaryConnectionStringAlias</code> value.
...
Returns the <code>SecondaryConnectionStringAlias</code> value.
