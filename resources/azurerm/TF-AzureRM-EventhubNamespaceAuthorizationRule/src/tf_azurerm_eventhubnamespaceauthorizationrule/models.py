...
class ResourceModel(BaseModel):
    ...
    PrimaryConnectionStringAlias: Optional[str]
    PrimaryKey: Optional[str]
    ResourceGroupName: Optional[str]
    SecondaryConnectionString: Optional[str]
    SecondaryConnectionStringAlias: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PrimaryConnectionStringAlias=json_data.get("PrimaryConnectionStringAlias"),
            PrimaryKey=json_data.get("PrimaryKey"),
            ResourceGroupName=json_data.get("ResourceGroupName"),
            SecondaryConnectionString=json_data.get("SecondaryConnectionString"),
            SecondaryConnectionStringAlias=json_data.get("SecondaryConnectionStringAlias"),
