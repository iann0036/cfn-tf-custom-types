...
1. Write the JSON schema describing your resource, `tf-azurerm-iottimeseriesinsightsstandardenvironment.json`
2. Implement your resource handlers in `tf_azurerm_iottimeseriesinsightsstandardenvironment/handlers.py`
