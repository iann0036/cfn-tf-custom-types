# TF::AzureRM::DataFactoryLinkedServiceWeb

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedserviceweb.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedserviceweb/handlers.py`
