...
1. Write the JSON schema describing your resource, `terraform-azurerm-appconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_appconfiguration/handlers.py`
