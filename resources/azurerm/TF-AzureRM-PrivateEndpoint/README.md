# TF::AzureRM::PrivateEndpoint

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-privateendpoint.json`
2. Implement your resource handlers in `tf_azurerm_privateendpoint/handlers.py`
