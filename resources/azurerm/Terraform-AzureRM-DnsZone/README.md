...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnszone.json`
2. Implement your resource handlers in `terraform_azurerm_dnszone/handlers.py`
