...
<pre>
{
    "Type" : "TF::AzureRM::DataFactoryLinkedServiceAzureBlobStorage",
    "Properties" : {
        ...
        "<a href="#sasuri" title="SasUri">SasUri</a>" : <i>String</i>,
        "<a href="#serviceendpoint" title="ServiceEndpoint">ServiceEndpoint</a>" : <i>String</i>,
