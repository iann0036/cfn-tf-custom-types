...
1. Write the JSON schema describing your resource, `tf-azurerm-applicationinsightswebtest.json`
2. Implement your resource handlers in `tf_azurerm_applicationinsightswebtest/handlers.py`
