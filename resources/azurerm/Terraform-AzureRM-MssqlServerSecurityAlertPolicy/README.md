...
1. Write the JSON schema describing your resource, `terraform-azurerm-mssqlserversecurityalertpolicy.json`
2. Implement your resource handlers in `terraform_azurerm_mssqlserversecurityalertpolicy/handlers.py`
