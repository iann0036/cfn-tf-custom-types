...
1. Write the JSON schema describing your resource, `tf-azurerm-appserviceenvironment.json`
2. Implement your resource handlers in `tf_azurerm_appserviceenvironment/handlers.py`
