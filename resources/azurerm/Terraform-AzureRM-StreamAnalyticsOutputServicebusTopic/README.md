...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsoutputservicebustopic.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsoutputservicebustopic/handlers.py`
