...
1. Write the JSON schema describing your resource, `tf-azurerm-storagesynccloudendpoint.json`
2. Implement your resource handlers in `tf_azurerm_storagesynccloudendpoint/handlers.py`
