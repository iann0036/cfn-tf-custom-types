# TF::AzureRM::StorageSyncCloudEndpoint
...
<pre>
{
    "Type" : "TF::AzureRM::StorageSyncCloudEndpoint",
    "Properties" : {
        ...
        "<a href="#storageaccounttenantid" title="StorageAccountTenantId">StorageAccountTenantId</a>" : <i>String</i>,
        "<a href="#storagesyncgroupid" title="StorageSyncGroupId">StorageSyncGroupId</a>" : <i>String</i>,
