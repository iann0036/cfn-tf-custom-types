...
1. Write the JSON schema describing your resource, `tf-azurerm-springcloudappredisassociation.json`
2. Implement your resource handlers in `tf_azurerm_springcloudappredisassociation/handlers.py`
