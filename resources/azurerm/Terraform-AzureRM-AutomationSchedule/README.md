...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationschedule.json`
2. Implement your resource handlers in `terraform_azurerm_automationschedule/handlers.py`
