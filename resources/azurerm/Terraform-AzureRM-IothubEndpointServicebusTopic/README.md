# Terraform::AzureRM::IothubEndpointServicebusTopic

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-iothubendpointservicebustopic.json`
2. Implement your resource handlers in `terraform_azurerm_iothubendpointservicebustopic/handlers.py`
