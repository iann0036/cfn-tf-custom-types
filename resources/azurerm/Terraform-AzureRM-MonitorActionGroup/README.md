...
1. Write the JSON schema describing your resource, `terraform-azurerm-monitoractiongroup.json`
2. Implement your resource handlers in `terraform_azurerm_monitoractiongroup/handlers.py`
