# TF::AzureRM::SiteRecoveryFabric

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-siterecoveryfabric.json`
2. Implement your resource handlers in `tf_azurerm_siterecoveryfabric/handlers.py`
