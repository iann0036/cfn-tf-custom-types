...
1. Write the JSON schema describing your resource, `terraform-azurerm-frontdoor.json`
2. Implement your resource handlers in `terraform_azurerm_frontdoor/handlers.py`
