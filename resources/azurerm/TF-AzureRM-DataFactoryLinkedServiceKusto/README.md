...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorylinkedservicekusto.json`
2. Implement your resource handlers in `tf_azurerm_datafactorylinkedservicekusto/handlers.py`
