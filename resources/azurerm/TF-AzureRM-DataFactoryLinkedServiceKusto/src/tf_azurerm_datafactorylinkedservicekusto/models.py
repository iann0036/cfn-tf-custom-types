...
class ResourceModel(BaseModel):
    ...
    DataFactoryId: Optional[str]
    Description: Optional[str]
    Id: Optional[str]
    IntegrationRuntimeName: Optional[str]
    KustoDatabaseName: Optional[str]
    KustoEndpoint: Optional[str]
    Name: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DataFactoryId=json_data.get("DataFactoryId"),
            Description=json_data.get("Description"),
            Id=json_data.get("Id"),
            IntegrationRuntimeName=json_data.get("IntegrationRuntimeName"),
            KustoDatabaseName=json_data.get("KustoDatabaseName"),
            KustoEndpoint=json_data.get("KustoEndpoint"),
