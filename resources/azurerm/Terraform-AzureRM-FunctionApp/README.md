...
1. Write the JSON schema describing your resource, `terraform-azurerm-functionapp.json`
2. Implement your resource handlers in `terraform_azurerm_functionapp/handlers.py`
