...
1. Write the JSON schema describing your resource, `tf-azurerm-apimanagementcustomdomain.json`
2. Implement your resource handlers in `tf_azurerm_apimanagementcustomdomain/handlers.py`
