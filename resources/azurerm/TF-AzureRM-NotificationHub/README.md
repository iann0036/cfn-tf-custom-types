...
1. Write the JSON schema describing your resource, `tf-azurerm-notificationhub.json`
2. Implement your resource handlers in `tf_azurerm_notificationhub/handlers.py`
