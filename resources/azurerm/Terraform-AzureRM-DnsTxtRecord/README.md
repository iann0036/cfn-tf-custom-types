...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnstxtrecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnstxtrecord/handlers.py`
