...
1. Write the JSON schema describing your resource, `tf-azurerm-botchanneldirectline.json`
2. Implement your resource handlers in `tf_azurerm_botchanneldirectline/handlers.py`
