...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnsmxrecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnsmxrecord/handlers.py`
