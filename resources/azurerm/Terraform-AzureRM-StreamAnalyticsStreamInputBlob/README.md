...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsstreaminputblob.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsstreaminputblob/handlers.py`
