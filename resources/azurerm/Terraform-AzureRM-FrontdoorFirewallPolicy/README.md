...
1. Write the JSON schema describing your resource, `terraform-azurerm-frontdoorfirewallpolicy.json`
2. Implement your resource handlers in `terraform_azurerm_frontdoorfirewallpolicy/handlers.py`
