...
1. Write the JSON schema describing your resource, `terraform-azurerm-hdinsightrservercluster.json`
2. Implement your resource handlers in `terraform_azurerm_hdinsightrservercluster/handlers.py`
