...
1. Write the JSON schema describing your resource, `tf-azurerm-cosmosdbcassandratable.json`
2. Implement your resource handlers in `tf_azurerm_cosmosdbcassandratable/handlers.py`
