# Terraform::AzureRM::PrivateDnsMxRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-azurerm-privatednsmxrecord.json`
2. Implement your resource handlers in `terraform_azurerm_privatednsmxrecord/handlers.py`
