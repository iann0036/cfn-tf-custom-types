...
1. Write the JSON schema describing your resource, `tf-azurerm-networksecuritygroup.json`
2. Implement your resource handlers in `tf_azurerm_networksecuritygroup/handlers.py`
