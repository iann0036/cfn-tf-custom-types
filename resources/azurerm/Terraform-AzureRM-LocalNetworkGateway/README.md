...
1. Write the JSON schema describing your resource, `terraform-azurerm-localnetworkgateway.json`
2. Implement your resource handlers in `terraform_azurerm_localnetworkgateway/handlers.py`
