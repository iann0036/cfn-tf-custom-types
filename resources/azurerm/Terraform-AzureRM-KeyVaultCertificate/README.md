...
1. Write the JSON schema describing your resource, `terraform-azurerm-keyvaultcertificate.json`
2. Implement your resource handlers in `terraform_azurerm_keyvaultcertificate/handlers.py`
