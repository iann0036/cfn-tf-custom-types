...
1. Write the JSON schema describing your resource, `tf-azurerm-publicipprefix.json`
2. Implement your resource handlers in `tf_azurerm_publicipprefix/handlers.py`
