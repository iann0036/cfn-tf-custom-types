...
1. Write the JSON schema describing your resource, `terraform-azurerm-appservicecustomhostnamebinding.json`
2. Implement your resource handlers in `terraform_azurerm_appservicecustomhostnamebinding/handlers.py`
