...
1. Write the JSON schema describing your resource, `terraform-azurerm-automationdscnodeconfiguration.json`
2. Implement your resource handlers in `terraform_azurerm_automationdscnodeconfiguration/handlers.py`
