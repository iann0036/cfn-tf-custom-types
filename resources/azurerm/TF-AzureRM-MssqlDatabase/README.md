...
1. Write the JSON schema describing your resource, `tf-azurerm-mssqldatabase.json`
2. Implement your resource handlers in `tf_azurerm_mssqldatabase/handlers.py`
