...
1. Write the JSON schema describing your resource, `tf-azurerm-subnetnatgatewayassociation.json`
2. Implement your resource handlers in `tf_azurerm_subnetnatgatewayassociation/handlers.py`
