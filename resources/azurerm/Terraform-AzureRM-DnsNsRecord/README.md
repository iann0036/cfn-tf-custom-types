...
1. Write the JSON schema describing your resource, `terraform-azurerm-dnsnsrecord.json`
2. Implement your resource handlers in `terraform_azurerm_dnsnsrecord/handlers.py`
