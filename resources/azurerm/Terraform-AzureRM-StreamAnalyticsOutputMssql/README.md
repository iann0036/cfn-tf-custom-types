...
1. Write the JSON schema describing your resource, `terraform-azurerm-streamanalyticsoutputmssql.json`
2. Implement your resource handlers in `terraform_azurerm_streamanalyticsoutputmssql/handlers.py`
