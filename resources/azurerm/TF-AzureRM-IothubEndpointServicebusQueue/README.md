# TF::AzureRM::IothubEndpointServicebusQueue

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-iothubendpointservicebusqueue.json`
2. Implement your resource handlers in `tf_azurerm_iothubendpointservicebusqueue/handlers.py`
