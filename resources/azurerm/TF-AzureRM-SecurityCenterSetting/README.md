...
1. Write the JSON schema describing your resource, `tf-azurerm-securitycentersetting.json`
2. Implement your resource handlers in `tf_azurerm_securitycentersetting/handlers.py`
