...
1. Write the JSON schema describing your resource, `tf-azurerm-hdinsightstormcluster.json`
2. Implement your resource handlers in `tf_azurerm_hdinsightstormcluster/handlers.py`
