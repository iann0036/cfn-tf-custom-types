...
1. Write the JSON schema describing your resource, `tf-azurerm-appservicehybridconnection.json`
2. Implement your resource handlers in `tf_azurerm_appservicehybridconnection/handlers.py`
