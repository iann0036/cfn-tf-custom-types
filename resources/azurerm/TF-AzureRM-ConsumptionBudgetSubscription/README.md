# TF::AzureRM::ConsumptionBudgetSubscription

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-consumptionbudgetsubscription.json`
2. Implement your resource handlers in `tf_azurerm_consumptionbudgetsubscription/handlers.py`
