...
1. Write the JSON schema describing your resource, `tf-azurerm-roleassignment.json`
2. Implement your resource handlers in `tf_azurerm_roleassignment/handlers.py`
