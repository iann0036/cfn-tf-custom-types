# TF::AzureRM::DataFactoryDatasetJson

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datafactorydatasetjson.json`
2. Implement your resource handlers in `tf_azurerm_datafactorydatasetjson/handlers.py`
