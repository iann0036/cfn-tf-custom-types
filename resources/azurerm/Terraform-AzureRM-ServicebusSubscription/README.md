...
1. Write the JSON schema describing your resource, `terraform-azurerm-servicebussubscription.json`
2. Implement your resource handlers in `terraform_azurerm_servicebussubscription/handlers.py`
