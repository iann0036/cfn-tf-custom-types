...
1. Write the JSON schema describing your resource, `terraform-azurerm-devtestlab.json`
2. Implement your resource handlers in `terraform_azurerm_devtestlab/handlers.py`
