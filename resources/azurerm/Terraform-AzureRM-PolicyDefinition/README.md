...
1. Write the JSON schema describing your resource, `terraform-azurerm-policydefinition.json`
2. Implement your resource handlers in `terraform_azurerm_policydefinition/handlers.py`
