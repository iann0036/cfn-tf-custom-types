...
1. Write the JSON schema describing your resource, `terraform-azurerm-networkinterface.json`
2. Implement your resource handlers in `terraform_azurerm_networkinterface/handlers.py`
