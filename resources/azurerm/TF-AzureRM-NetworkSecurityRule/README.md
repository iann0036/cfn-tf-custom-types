...
1. Write the JSON schema describing your resource, `tf-azurerm-networksecurityrule.json`
2. Implement your resource handlers in `tf_azurerm_networksecurityrule/handlers.py`
