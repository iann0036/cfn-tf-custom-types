...
1. Write the JSON schema describing your resource, `terraform-azurerm-apimanagementapiversionset.json`
2. Implement your resource handlers in `terraform_azurerm_apimanagementapiversionset/handlers.py`
