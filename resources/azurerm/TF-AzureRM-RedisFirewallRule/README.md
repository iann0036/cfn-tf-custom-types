...
1. Write the JSON schema describing your resource, `tf-azurerm-redisfirewallrule.json`
2. Implement your resource handlers in `tf_azurerm_redisfirewallrule/handlers.py`
