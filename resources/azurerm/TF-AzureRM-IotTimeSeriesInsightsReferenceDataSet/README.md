...
1. Write the JSON schema describing your resource, `tf-azurerm-iottimeseriesinsightsreferencedataset.json`
2. Implement your resource handlers in `tf_azurerm_iottimeseriesinsightsreferencedataset/handlers.py`
