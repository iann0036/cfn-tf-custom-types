...
1. Write the JSON schema describing your resource, `terraform-azurerm-siterecoveryreplicatedvm.json`
2. Implement your resource handlers in `terraform_azurerm_siterecoveryreplicatedvm/handlers.py`
