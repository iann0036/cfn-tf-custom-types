...
1. Write the JSON schema describing your resource, `tf-azurerm-webapplicationfirewallpolicy.json`
2. Implement your resource handlers in `tf_azurerm_webapplicationfirewallpolicy/handlers.py`
