...
class ResourceModel(BaseModel):
    ...
    DynamicFilenameEnabled: Optional[bool]
    DynamicPathEnabled: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DynamicFilenameEnabled=json_data.get("DynamicFilenameEnabled"),
            DynamicPathEnabled=json_data.get("DynamicPathEnabled"),
