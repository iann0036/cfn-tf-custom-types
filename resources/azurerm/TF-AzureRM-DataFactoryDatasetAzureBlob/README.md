...
1. Write the JSON schema describing your resource, `tf-azurerm-datafactorydatasetazureblob.json`
2. Implement your resource handlers in `tf_azurerm_datafactorydatasetazureblob/handlers.py`
