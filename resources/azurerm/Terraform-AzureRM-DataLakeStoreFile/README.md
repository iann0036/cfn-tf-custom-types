...
1. Write the JSON schema describing your resource, `terraform-azurerm-datalakestorefile.json`
2. Implement your resource handlers in `terraform_azurerm_datalakestorefile/handlers.py`
