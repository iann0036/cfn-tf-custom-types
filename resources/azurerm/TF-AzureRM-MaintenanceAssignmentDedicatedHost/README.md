...
1. Write the JSON schema describing your resource, `tf-azurerm-maintenanceassignmentdedicatedhost.json`
2. Implement your resource handlers in `tf_azurerm_maintenanceassignmentdedicatedhost/handlers.py`
