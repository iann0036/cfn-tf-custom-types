# TF::AzureRM::DataLakeAnalyticsFirewallRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-azurerm-datalakeanalyticsfirewallrule.json`
2. Implement your resource handlers in `tf_azurerm_datalakeanalyticsfirewallrule/handlers.py`
