...
1. Write the JSON schema describing your resource, `terraform-azurerm-storageblob.json`
2. Implement your resource handlers in `terraform_azurerm_storageblob/handlers.py`
