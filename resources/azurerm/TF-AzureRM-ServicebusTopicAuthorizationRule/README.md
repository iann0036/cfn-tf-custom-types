...
1. Write the JSON schema describing your resource, `tf-azurerm-servicebustopicauthorizationrule.json`
2. Implement your resource handlers in `tf_azurerm_servicebustopicauthorizationrule/handlers.py`
