...
1. Write the JSON schema describing your resource, `terraform-azurerm-snapshot.json`
2. Implement your resource handlers in `terraform_azurerm_snapshot/handlers.py`
