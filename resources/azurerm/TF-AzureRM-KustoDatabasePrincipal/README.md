...
1. Write the JSON schema describing your resource, `tf-azurerm-kustodatabaseprincipal.json`
2. Implement your resource handlers in `tf_azurerm_kustodatabaseprincipal/handlers.py`
