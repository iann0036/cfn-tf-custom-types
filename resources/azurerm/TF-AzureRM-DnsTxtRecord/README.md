...
1. Write the JSON schema describing your resource, `tf-azurerm-dnstxtrecord.json`
2. Implement your resource handlers in `tf_azurerm_dnstxtrecord/handlers.py`
