...
1. Write the JSON schema describing your resource, `tf-azurerm-dedicatedhost.json`
2. Implement your resource handlers in `tf_azurerm_dedicatedhost/handlers.py`
