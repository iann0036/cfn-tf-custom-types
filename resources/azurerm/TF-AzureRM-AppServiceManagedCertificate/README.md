...
1. Write the JSON schema describing your resource, `tf-azurerm-appservicemanagedcertificate.json`
2. Implement your resource handlers in `tf_azurerm_appservicemanagedcertificate/handlers.py`
