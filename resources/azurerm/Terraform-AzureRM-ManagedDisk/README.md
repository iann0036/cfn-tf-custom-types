...
1. Write the JSON schema describing your resource, `terraform-azurerm-manageddisk.json`
2. Implement your resource handlers in `terraform_azurerm_manageddisk/handlers.py`
