...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/rke_cluster/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'rancher/rke',
                'providerTypeName': 'rke',
                'terraformTypeName': 'rke_cluster',
                'returnValues': ["ApiServerUrl", "CaCrt", "Certificates", "ClientCert", "ClientKey", "ClusterCidr", "ClusterDnsServer", "ClusterDomain", "ControlPlaneHosts", "EtcdHosts", "Id", "InactiveHosts", "InternalKubeConfigYaml", "KubeAdminUser", "KubeConfigYaml", "RkeClusterYaml", "RkeState", "RunningSystemImages", "WorkerHosts"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/rke_cluster/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/rke_cluster/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AddonJobTimeout=None, Addons=None, AddonsInclude=None, ApiServerUrl=None, CaCrt=None, CertDir=None, Certificates=None, ClientCert=None, ClientKey=None, ClusterCidr=None, ClusterDnsServer=None, ClusterDomain=None, ClusterName=None, ClusterYaml=None, ControlPlaneHosts=None, CustomCerts=None, DelayOnCreation=None, Dind=None, DindDnsServer=None, DindStorageDriver=None, DisablePortCheck=None, EtcdHosts=None, Id=None, IgnoreDockerVersion=None, InactiveHosts=None, InternalKubeConfigYaml=None, KubeAdminUser=None, KubeConfigYaml=None, KubernetesVersion=None, NodesConf=None, PrefixPath=None, RkeClusterYaml=None, RkeState=None, RunningSystemImages=None, SshAgentAuth=None, SshCertPath=None, SshKeyPath=None, UpdateOnly=None, WorkerHosts=None, Authentication=None, Authorization=None, BastionHost=None, CloudProvider=None, Dns=None, Ingress=None, Monitoring=None, Network=None, Nodes=None, PrivateRegistries=None, Restore=None, RotateCertificates=None, Services=None, ServicesEtcd=None, ServicesKubeApi=None, ServicesKubeController=None, ServicesKubelet=None, ServicesKubeproxy=None, ServicesScheduler=None, SystemImages=None, Timeouts=None, UpgradeStrategy=None)
