...
1. Write the JSON schema describing your resource, `terraform-vsphere-computeclusterhostgroup.json`
2. Implement your resource handlers in `terraform_vsphere_computeclusterhostgroup/handlers.py`
