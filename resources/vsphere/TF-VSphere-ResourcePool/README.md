...
1. Write the JSON schema describing your resource, `tf-vsphere-resourcepool.json`
2. Implement your resource handlers in `tf_vsphere_resourcepool/handlers.py`
