...
1. Write the JSON schema describing your resource, `terraform-vsphere-computeclustervmaffinityrule.json`
2. Implement your resource handlers in `terraform_vsphere_computeclustervmaffinityrule/handlers.py`
