...
1. Write the JSON schema describing your resource, `tf-vsphere-virtualmachine.json`
2. Implement your resource handlers in `tf_vsphere_virtualmachine/handlers.py`
