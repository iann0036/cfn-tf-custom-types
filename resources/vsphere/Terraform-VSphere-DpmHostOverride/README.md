...
1. Write the JSON schema describing your resource, `terraform-vsphere-dpmhostoverride.json`
2. Implement your resource handlers in `terraform_vsphere_dpmhostoverride/handlers.py`
