...
1. Write the JSON schema describing your resource, `terraform-vsphere-havmoverride.json`
2. Implement your resource handlers in `terraform_vsphere_havmoverride/handlers.py`
