...
1. Write the JSON schema describing your resource, `terraform-vsphere-datacenter.json`
2. Implement your resource handlers in `terraform_vsphere_datacenter/handlers.py`
