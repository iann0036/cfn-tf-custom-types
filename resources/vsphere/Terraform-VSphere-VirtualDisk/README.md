...
1. Write the JSON schema describing your resource, `terraform-vsphere-virtualdisk.json`
2. Implement your resource handlers in `terraform_vsphere_virtualdisk/handlers.py`
