...
1. Write the JSON schema describing your resource, `terraform-vsphere-hostvirtualswitch.json`
2. Implement your resource handlers in `terraform_vsphere_hostvirtualswitch/handlers.py`
