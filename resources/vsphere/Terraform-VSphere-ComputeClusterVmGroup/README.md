...
1. Write the JSON schema describing your resource, `terraform-vsphere-computeclustervmgroup.json`
2. Implement your resource handlers in `terraform_vsphere_computeclustervmgroup/handlers.py`
