...
1. Write the JSON schema describing your resource, `tf-vsphere-contentlibraryitem.json`
2. Implement your resource handlers in `tf_vsphere_contentlibraryitem/handlers.py`
