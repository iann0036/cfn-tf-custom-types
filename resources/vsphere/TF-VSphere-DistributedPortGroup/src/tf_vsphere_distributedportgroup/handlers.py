...
TYPE_NAME = "TF::VSphere::DistributedPortGroup"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/vsphere_distributed_port_group/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/vsphere_distributed_port_group/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/vsphere_distributed_port_group/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), ActiveUplinks=None, AllowForgedTransmits=None, AllowMacChanges=None, AllowPromiscuous=None, AutoExpand=None, BlockAllPorts=None, BlockOverrideAllowed=None, CheckBeacon=None, ConfigVersion=None, CustomAttributes=None, Description=None, DirectpathGen2Allowed=None, DistributedVirtualSwitchUuid=None, EgressShapingAverageBandwidth=None, EgressShapingBurstSize=None, EgressShapingEnabled=None, EgressShapingPeakBandwidth=None, Failback=None, Id=None, IngressShapingAverageBandwidth=None, IngressShapingBurstSize=None, IngressShapingEnabled=None, IngressShapingPeakBandwidth=None, Key=None, LacpEnabled=None, LacpMode=None, LivePortMovingAllowed=None, Name=None, NetflowEnabled=None, NetflowOverrideAllowed=None, NetworkResourcePoolKey=None, NetworkResourcePoolOverrideAllowed=None, NotifySwitches=None, NumberOfPorts=None, PortConfigResetAtDisconnect=None, PortNameFormat=None, PortPrivateSecondaryVlanId=None, SecurityPolicyOverrideAllowed=None, ShapingOverrideAllowed=None, StandbyUplinks=None, Tags=None, TeamingPolicy=None, TrafficFilterOverrideAllowed=None, TxUplink=None, Type=None, UplinkTeamingOverrideAllowed=None, VlanId=None, VlanOverrideAllowed=None, VlanRange=None)
