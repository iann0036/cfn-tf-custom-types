...
1. Write the JSON schema describing your resource, `terraform-vsphere-computeclustervmhostrule.json`
2. Implement your resource handlers in `terraform_vsphere_computeclustervmhostrule/handlers.py`
