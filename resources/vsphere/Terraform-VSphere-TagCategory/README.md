...
1. Write the JSON schema describing your resource, `terraform-vsphere-tagcategory.json`
2. Implement your resource handlers in `terraform_vsphere_tagcategory/handlers.py`
