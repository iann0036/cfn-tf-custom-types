...
1. Write the JSON schema describing your resource, `terraform-vsphere-distributedportgroup.json`
2. Implement your resource handlers in `terraform_vsphere_distributedportgroup/handlers.py`
