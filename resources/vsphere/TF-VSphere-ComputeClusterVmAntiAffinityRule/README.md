...
1. Write the JSON schema describing your resource, `tf-vsphere-computeclustervmantiaffinityrule.json`
2. Implement your resource handlers in `tf_vsphere_computeclustervmantiaffinityrule/handlers.py`
