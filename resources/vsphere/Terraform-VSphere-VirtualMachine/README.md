...
1. Write the JSON schema describing your resource, `terraform-vsphere-virtualmachine.json`
2. Implement your resource handlers in `terraform_vsphere_virtualmachine/handlers.py`
