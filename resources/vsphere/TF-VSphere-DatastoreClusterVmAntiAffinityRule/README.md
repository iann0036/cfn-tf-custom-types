...
1. Write the JSON schema describing your resource, `tf-vsphere-datastoreclustervmantiaffinityrule.json`
2. Implement your resource handlers in `tf_vsphere_datastoreclustervmantiaffinityrule/handlers.py`
