...
1. Write the JSON schema describing your resource, `terraform-vsphere-nasdatastore.json`
2. Implement your resource handlers in `terraform_vsphere_nasdatastore/handlers.py`
