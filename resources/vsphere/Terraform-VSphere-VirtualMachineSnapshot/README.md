...
1. Write the JSON schema describing your resource, `terraform-vsphere-virtualmachinesnapshot.json`
2. Implement your resource handlers in `terraform_vsphere_virtualmachinesnapshot/handlers.py`
