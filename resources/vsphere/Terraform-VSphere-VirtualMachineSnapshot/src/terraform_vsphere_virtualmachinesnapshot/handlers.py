...
def create_handler(
    ...
    try:
        ...
        tf['resource']['vsphere_virtual_machine_snapshot'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['vsphere_virtual_machine_snapshot'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
