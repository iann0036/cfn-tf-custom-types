...
1. Write the JSON schema describing your resource, `terraform-vsphere-storagedrsvmoverride.json`
2. Implement your resource handlers in `terraform_vsphere_storagedrsvmoverride/handlers.py`
