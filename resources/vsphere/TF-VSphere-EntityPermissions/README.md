...
1. Write the JSON schema describing your resource, `tf-vsphere-entitypermissions.json`
2. Implement your resource handlers in `tf_vsphere_entitypermissions/handlers.py`
