...
1. Write the JSON schema describing your resource, `terraform-vsphere-computecluster.json`
2. Implement your resource handlers in `terraform_vsphere_computecluster/handlers.py`
