...
1. Write the JSON schema describing your resource, `terraform-vsphere-distributedvirtualswitch.json`
2. Implement your resource handlers in `terraform_vsphere_distributedvirtualswitch/handlers.py`
