...
1. Write the JSON schema describing your resource, `terraform-vsphere-datastorecluster.json`
2. Implement your resource handlers in `terraform_vsphere_datastorecluster/handlers.py`
