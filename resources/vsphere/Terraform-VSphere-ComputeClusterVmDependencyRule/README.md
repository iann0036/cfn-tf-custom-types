...
1. Write the JSON schema describing your resource, `terraform-vsphere-computeclustervmdependencyrule.json`
2. Implement your resource handlers in `terraform_vsphere_computeclustervmdependencyrule/handlers.py`
