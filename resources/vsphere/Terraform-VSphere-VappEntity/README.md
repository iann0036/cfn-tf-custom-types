...
1. Write the JSON schema describing your resource, `terraform-vsphere-vappentity.json`
2. Implement your resource handlers in `terraform_vsphere_vappentity/handlers.py`
