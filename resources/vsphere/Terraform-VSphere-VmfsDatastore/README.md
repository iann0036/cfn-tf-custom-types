...
1. Write the JSON schema describing your resource, `terraform-vsphere-vmfsdatastore.json`
2. Implement your resource handlers in `terraform_vsphere_vmfsdatastore/handlers.py`
