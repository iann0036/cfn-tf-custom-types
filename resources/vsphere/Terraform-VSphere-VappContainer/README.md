...
1. Write the JSON schema describing your resource, `terraform-vsphere-vappcontainer.json`
2. Implement your resource handlers in `terraform_vsphere_vappcontainer/handlers.py`
