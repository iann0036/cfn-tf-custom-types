...
1. Write the JSON schema describing your resource, `terraform-vsphere-datastoreclustervmantiaffinityrule.json`
2. Implement your resource handlers in `terraform_vsphere_datastoreclustervmantiaffinityrule/handlers.py`
