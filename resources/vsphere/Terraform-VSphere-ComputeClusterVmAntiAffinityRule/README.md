...
1. Write the JSON schema describing your resource, `terraform-vsphere-computeclustervmantiaffinityrule.json`
2. Implement your resource handlers in `terraform_vsphere_computeclustervmantiaffinityrule/handlers.py`
