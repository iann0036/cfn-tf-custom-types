...
1. Write the JSON schema describing your resource, `terraform-vsphere-folder.json`
2. Implement your resource handlers in `terraform_vsphere_folder/handlers.py`
