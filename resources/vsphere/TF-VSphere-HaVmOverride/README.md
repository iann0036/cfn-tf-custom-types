...
1. Write the JSON schema describing your resource, `tf-vsphere-havmoverride.json`
2. Implement your resource handlers in `tf_vsphere_havmoverride/handlers.py`
