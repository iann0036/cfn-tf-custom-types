...
1. Write the JSON schema describing your resource, `tf-vsphere-hostportgroup.json`
2. Implement your resource handlers in `tf_vsphere_hostportgroup/handlers.py`
