...
1. Write the JSON schema describing your resource, `tf-vsphere-computeclustervmhostrule.json`
2. Implement your resource handlers in `tf_vsphere_computeclustervmhostrule/handlers.py`
