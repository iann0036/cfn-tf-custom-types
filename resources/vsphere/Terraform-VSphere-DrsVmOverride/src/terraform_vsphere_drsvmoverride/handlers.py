...
def create_handler(
    ...
    try:
        ...
        tf['resource']['vsphere_drs_vm_override'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['vsphere_drs_vm_override'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
