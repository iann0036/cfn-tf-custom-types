...
1. Write the JSON schema describing your resource, `terraform-vsphere-drsvmoverride.json`
2. Implement your resource handlers in `terraform_vsphere_drsvmoverride/handlers.py`
