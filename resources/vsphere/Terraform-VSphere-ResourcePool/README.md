...
1. Write the JSON schema describing your resource, `terraform-vsphere-resourcepool.json`
2. Implement your resource handlers in `terraform_vsphere_resourcepool/handlers.py`
