# TF::VSphere::ComputeClusterVmGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vsphere-computeclustervmgroup.json`
2. Implement your resource handlers in `tf_vsphere_computeclustervmgroup/handlers.py`
