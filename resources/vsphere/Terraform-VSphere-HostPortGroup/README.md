...
1. Write the JSON schema describing your resource, `terraform-vsphere-hostportgroup.json`
2. Implement your resource handlers in `terraform_vsphere_hostportgroup/handlers.py`
