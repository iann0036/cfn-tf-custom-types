...
1. Write the JSON schema describing your resource, `tf-vsphere-contentlibrary.json`
2. Implement your resource handlers in `tf_vsphere_contentlibrary/handlers.py`
