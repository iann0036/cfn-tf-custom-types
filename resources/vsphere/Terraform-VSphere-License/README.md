...
1. Write the JSON schema describing your resource, `terraform-vsphere-license.json`
2. Implement your resource handlers in `terraform_vsphere_license/handlers.py`
