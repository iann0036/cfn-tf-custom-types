...
1. Write the JSON schema describing your resource, `terraform-vsphere-customattribute.json`
2. Implement your resource handlers in `terraform_vsphere_customattribute/handlers.py`
