...
1. Write the JSON schema describing your resource, `terraform-influxdb-user.json`
2. Implement your resource handlers in `terraform_influxdb_user/handlers.py`
