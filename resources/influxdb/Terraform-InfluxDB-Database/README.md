...
1. Write the JSON schema describing your resource, `terraform-influxdb-database.json`
2. Implement your resource handlers in `terraform_influxdb_database/handlers.py`
