...
1. Write the JSON schema describing your resource, `terraform-influxdb-continuousquery.json`
2. Implement your resource handlers in `terraform_influxdb_continuousquery/handlers.py`
