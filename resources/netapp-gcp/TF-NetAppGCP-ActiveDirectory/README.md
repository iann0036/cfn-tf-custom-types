...
1. Write the JSON schema describing your resource, `tf-netappgcp-activedirectory.json`
2. Implement your resource handlers in `tf_netappgcp_activedirectory/handlers.py`
