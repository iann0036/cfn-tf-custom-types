# TF::NetAppGCP::VolumeBackup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-netappgcp-volumebackup.json`
2. Implement your resource handlers in `tf_netappgcp_volumebackup/handlers.py`
