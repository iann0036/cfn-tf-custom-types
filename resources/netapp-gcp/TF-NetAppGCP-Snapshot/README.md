# TF::NetAppGCP::Snapshot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-netappgcp-snapshot.json`
2. Implement your resource handlers in `tf_netappgcp_snapshot/handlers.py`
