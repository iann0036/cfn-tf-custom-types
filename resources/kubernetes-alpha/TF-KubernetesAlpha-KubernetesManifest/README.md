...
1. Write the JSON schema describing your resource, `tf-kubernetesalpha-kubernetesmanifest.json`
2. Implement your resource handlers in `tf_kubernetesalpha_kubernetesmanifest/handlers.py`
