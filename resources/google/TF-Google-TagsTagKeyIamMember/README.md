...
1. Write the JSON schema describing your resource, `tf-google-tagstagkeyiammember.json`
2. Implement your resource handlers in `tf_google_tagstagkeyiammember/handlers.py`
