...
1. Write the JSON schema describing your resource, `tf-google-datalosspreventiondeidentifytemplate.json`
2. Implement your resource handlers in `tf_google_datalosspreventiondeidentifytemplate/handlers.py`
