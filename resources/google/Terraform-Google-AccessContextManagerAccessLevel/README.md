...
1. Write the JSON schema describing your resource, `terraform-google-accesscontextmanageraccesslevel.json`
2. Implement your resource handlers in `terraform_google_accesscontextmanageraccesslevel/handlers.py`
