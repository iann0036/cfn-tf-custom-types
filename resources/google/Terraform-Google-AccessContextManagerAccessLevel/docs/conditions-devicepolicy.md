# Terraform::Google::AccessContextManagerAccessLevel Conditions DevicePolicy
...
<pre>
{
    ...
    "<a href="#osconstraints" title="OsConstraints">OsConstraints</a>" : <i>[ <a href="conditions-devicepolicy-osconstraints.md">OsConstraints</a>, ... ]</i>
}
</pre>
...
<a href="#osconstraints" title="OsConstraints">OsConstraints</a>: <i>
      - <a href="conditions-devicepolicy-osconstraints.md">OsConstraints</a></i>
</pre>
...
_Type_: List of <a href="conditions-devicepolicy-osconstraints.md">OsConstraints</a>
