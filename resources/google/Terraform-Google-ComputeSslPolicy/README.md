...
1. Write the JSON schema describing your resource, `terraform-google-computesslpolicy.json`
2. Implement your resource handlers in `terraform_google_computesslpolicy/handlers.py`
