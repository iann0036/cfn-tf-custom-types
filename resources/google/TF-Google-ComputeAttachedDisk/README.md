...
1. Write the JSON schema describing your resource, `tf-google-computeattacheddisk.json`
2. Implement your resource handlers in `tf_google_computeattacheddisk/handlers.py`
