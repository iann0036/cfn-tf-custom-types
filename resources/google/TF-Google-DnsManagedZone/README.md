...
1. Write the JSON schema describing your resource, `tf-google-dnsmanagedzone.json`
2. Implement your resource handlers in `tf_google_dnsmanagedzone/handlers.py`
