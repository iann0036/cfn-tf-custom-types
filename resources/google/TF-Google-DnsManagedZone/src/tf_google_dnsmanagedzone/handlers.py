...
TYPE_NAME = "TF::Google::DnsManagedZone"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Description=None, DnsName=None, ForceDestroy=None, Id=None, Labels=None, Name=None, NameServers=None, Project=None, Visibility=None, DnssecConfig=None, ForwardingConfig=None, PeeringConfig=None, PrivateVisibilityConfig=None, Timeouts=None)
