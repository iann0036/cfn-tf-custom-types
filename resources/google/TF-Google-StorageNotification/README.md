# TF::Google::StorageNotification

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-storagenotification.json`
2. Implement your resource handlers in `tf_google_storagenotification/handlers.py`
