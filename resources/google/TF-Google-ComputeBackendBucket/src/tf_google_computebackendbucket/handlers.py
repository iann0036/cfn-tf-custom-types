...
TYPE_NAME = "TF::Google::ComputeBackendBucket"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), BucketName=None, CreationTimestamp=None, Description=None, EnableCdn=None, Id=None, Name=None, Project=None, SelfLink=None, CdnPolicy=None, Timeouts=None)
