...
1. Write the JSON schema describing your resource, `tf-google-computebackendbucket.json`
2. Implement your resource handlers in `tf_google_computebackendbucket/handlers.py`
