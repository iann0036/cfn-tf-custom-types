...
1. Write the JSON schema describing your resource, `terraform-google-folderiambinding.json`
2. Implement your resource handlers in `terraform_google_folderiambinding/handlers.py`
