...
1. Write the JSON schema describing your resource, `tf-google-sourcereporepository.json`
2. Implement your resource handlers in `tf_google_sourcereporepository/handlers.py`
