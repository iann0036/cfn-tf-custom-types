...
1. Write the JSON schema describing your resource, `terraform-google-runtimeconfigconfigiammember.json`
2. Implement your resource handlers in `terraform_google_runtimeconfigconfigiammember/handlers.py`
