...
1. Write the JSON schema describing your resource, `terraform-google-computetargetpool.json`
2. Implement your resource handlers in `terraform_google_computetargetpool/handlers.py`
