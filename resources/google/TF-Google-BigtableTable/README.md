...
1. Write the JSON schema describing your resource, `tf-google-bigtabletable.json`
2. Implement your resource handlers in `tf_google_bigtabletable/handlers.py`
