...
1. Write the JSON schema describing your resource, `terraform-google-sqldatabase.json`
2. Implement your resource handlers in `terraform_google_sqldatabase/handlers.py`
