...
1. Write the JSON schema describing your resource, `terraform-google-billingaccountiampolicy.json`
2. Implement your resource handlers in `terraform_google_billingaccountiampolicy/handlers.py`
