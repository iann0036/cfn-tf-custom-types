...
1. Write the JSON schema describing your resource, `terraform-google-cloudiotregistry.json`
2. Implement your resource handlers in `terraform_google_cloudiotregistry/handlers.py`
