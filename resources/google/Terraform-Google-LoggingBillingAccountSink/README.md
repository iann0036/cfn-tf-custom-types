...
1. Write the JSON schema describing your resource, `terraform-google-loggingbillingaccountsink.json`
2. Implement your resource handlers in `terraform_google_loggingbillingaccountsink/handlers.py`
