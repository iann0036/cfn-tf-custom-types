...
1. Write the JSON schema describing your resource, `terraform-google-binaryauthorizationattestor.json`
2. Implement your resource handlers in `terraform_google_binaryauthorizationattestor/handlers.py`
