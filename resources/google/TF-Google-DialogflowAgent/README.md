...
1. Write the JSON schema describing your resource, `tf-google-dialogflowagent.json`
2. Implement your resource handlers in `tf_google_dialogflowagent/handlers.py`
