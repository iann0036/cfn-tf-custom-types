...
1. Write the JSON schema describing your resource, `tf-google-accesscontextmanageraccesslevel.json`
2. Implement your resource handlers in `tf_google_accesscontextmanageraccesslevel/handlers.py`
