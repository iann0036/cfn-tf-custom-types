...
1. Write the JSON schema describing your resource, `terraform-google-storagebucketobject.json`
2. Implement your resource handlers in `terraform_google_storagebucketobject/handlers.py`
