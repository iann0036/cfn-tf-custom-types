...
1. Write the JSON schema describing your resource, `terraform-google-computehttphealthcheck.json`
2. Implement your resource handlers in `terraform_google_computehttphealthcheck/handlers.py`
