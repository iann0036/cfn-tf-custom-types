...
1. Write the JSON schema describing your resource, `terraform-google-computeprojectdefaultnetworktier.json`
2. Implement your resource handlers in `terraform_google_computeprojectdefaultnetworktier/handlers.py`
