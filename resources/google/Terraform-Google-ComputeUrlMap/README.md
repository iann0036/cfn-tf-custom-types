...
1. Write the JSON schema describing your resource, `terraform-google-computeurlmap.json`
2. Implement your resource handlers in `terraform_google_computeurlmap/handlers.py`
