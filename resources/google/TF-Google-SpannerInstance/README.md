...
1. Write the JSON schema describing your resource, `tf-google-spannerinstance.json`
2. Implement your resource handlers in `tf_google_spannerinstance/handlers.py`
