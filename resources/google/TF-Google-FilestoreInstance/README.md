...
1. Write the JSON schema describing your resource, `tf-google-filestoreinstance.json`
2. Implement your resource handlers in `tf_google_filestoreinstance/handlers.py`
