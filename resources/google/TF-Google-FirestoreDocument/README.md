...
1. Write the JSON schema describing your resource, `tf-google-firestoredocument.json`
2. Implement your resource handlers in `tf_google_firestoredocument/handlers.py`
