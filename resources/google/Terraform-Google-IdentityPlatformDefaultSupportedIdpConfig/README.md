...
1. Write the JSON schema describing your resource, `terraform-google-identityplatformdefaultsupportedidpconfig.json`
2. Implement your resource handlers in `terraform_google_identityplatformdefaultsupportedidpconfig/handlers.py`
