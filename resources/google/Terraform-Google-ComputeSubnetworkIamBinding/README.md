# Terraform::Google::ComputeSubnetworkIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-computesubnetworkiambinding.json`
2. Implement your resource handlers in `terraform_google_computesubnetworkiambinding/handlers.py`
