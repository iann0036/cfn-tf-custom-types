...
1. Write the JSON schema describing your resource, `terraform-google-computeattacheddisk.json`
2. Implement your resource handlers in `terraform_google_computeattacheddisk/handlers.py`
