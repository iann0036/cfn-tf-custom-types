...
1. Write the JSON schema describing your resource, `terraform-google-monitoringuptimecheckconfig.json`
2. Implement your resource handlers in `terraform_google_monitoringuptimecheckconfig/handlers.py`
