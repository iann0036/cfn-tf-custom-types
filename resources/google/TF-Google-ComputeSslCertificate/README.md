...
1. Write the JSON schema describing your resource, `tf-google-computesslcertificate.json`
2. Implement your resource handlers in `tf_google_computesslcertificate/handlers.py`
