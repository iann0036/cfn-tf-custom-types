...
1. Write the JSON schema describing your resource, `terraform-google-deploymentmanagerdeployment.json`
2. Implement your resource handlers in `terraform_google_deploymentmanagerdeployment/handlers.py`
