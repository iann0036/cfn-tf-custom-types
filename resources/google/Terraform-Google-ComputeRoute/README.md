...
1. Write the JSON schema describing your resource, `terraform-google-computeroute.json`
2. Implement your resource handlers in `terraform_google_computeroute/handlers.py`
