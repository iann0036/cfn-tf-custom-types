...
1. Write the JSON schema describing your resource, `tf-google-computeregionsslcertificate.json`
2. Implement your resource handlers in `tf_google_computeregionsslcertificate/handlers.py`
