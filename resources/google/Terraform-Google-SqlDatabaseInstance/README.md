...
1. Write the JSON schema describing your resource, `terraform-google-sqldatabaseinstance.json`
2. Implement your resource handlers in `terraform_google_sqldatabaseinstance/handlers.py`
