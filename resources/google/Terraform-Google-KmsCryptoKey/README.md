...
1. Write the JSON schema describing your resource, `terraform-google-kmscryptokey.json`
2. Implement your resource handlers in `terraform_google_kmscryptokey/handlers.py`
