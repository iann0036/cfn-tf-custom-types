...
1. Write the JSON schema describing your resource, `terraform-google-sccsource.json`
2. Implement your resource handlers in `terraform_google_sccsource/handlers.py`
