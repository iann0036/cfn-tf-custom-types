...
1. Write the JSON schema describing your resource, `terraform-google-loggingprojectsink.json`
2. Implement your resource handlers in `terraform_google_loggingprojectsink/handlers.py`
