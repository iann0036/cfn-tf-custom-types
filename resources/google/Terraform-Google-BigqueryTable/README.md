...
1. Write the JSON schema describing your resource, `terraform-google-bigquerytable.json`
2. Implement your resource handlers in `terraform_google_bigquerytable/handlers.py`
