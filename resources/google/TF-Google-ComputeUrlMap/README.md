...
1. Write the JSON schema describing your resource, `tf-google-computeurlmap.json`
2. Implement your resource handlers in `tf_google_computeurlmap/handlers.py`
