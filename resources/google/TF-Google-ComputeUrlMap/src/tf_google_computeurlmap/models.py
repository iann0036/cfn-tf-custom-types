...
class ResourceModel(BaseModel):
    ...
    DefaultRouteAction: Optional[Sequence["_DefaultRouteActionDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DefaultRouteAction=deserialize_list(json_data.get("DefaultRouteAction"), DefaultRouteActionDefinition),
...
@dataclass
class DefaultRouteActionDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DefaultRouteActionDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DefaultRouteActionDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DefaultRouteActionDefinition = DefaultRouteActionDefinition
