...
1. Write the JSON schema describing your resource, `terraform-google-computenodegroup.json`
2. Implement your resource handlers in `terraform_google_computenodegroup/handlers.py`
