...
1. Write the JSON schema describing your resource, `terraform-google-kmscryptokeyiammember.json`
2. Implement your resource handlers in `terraform_google_kmscryptokeyiammember/handlers.py`
