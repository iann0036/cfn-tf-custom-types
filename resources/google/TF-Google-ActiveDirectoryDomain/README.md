...
1. Write the JSON schema describing your resource, `tf-google-activedirectorydomain.json`
2. Implement your resource handlers in `tf_google_activedirectorydomain/handlers.py`
