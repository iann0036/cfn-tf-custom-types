...
1. Write the JSON schema describing your resource, `tf-google-pubsublitesubscription.json`
2. Implement your resource handlers in `tf_google_pubsublitesubscription/handlers.py`
