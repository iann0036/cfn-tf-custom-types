# TF::Google::ComputeNetworkEndpoint

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-computenetworkendpoint.json`
2. Implement your resource handlers in `tf_google_computenetworkendpoint/handlers.py`
