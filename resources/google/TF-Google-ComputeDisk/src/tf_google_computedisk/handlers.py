...
TYPE_NAME = "TF::Google::ComputeDisk"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreationTimestamp=None, Description=None, Id=None, Image=None, LabelFingerprint=None, Labels=None, LastAttachTimestamp=None, LastDetachTimestamp=None, Name=None, PhysicalBlockSizeBytes=None, Project=None, ProvisionedIops=None, SelfLink=None, Size=None, Snapshot=None, SourceImageId=None, SourceSnapshotId=None, Type=None, Users=None, Zone=None, DiskEncryptionKey=None, SourceImageEncryptionKey=None, SourceSnapshotEncryptionKey=None, Timeouts=None)
