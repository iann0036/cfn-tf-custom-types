...
1. Write the JSON schema describing your resource, `terraform-google-computebackendservicesignedurlkey.json`
2. Implement your resource handlers in `terraform_google_computebackendservicesignedurlkey/handlers.py`
