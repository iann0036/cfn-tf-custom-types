...
1. Write the JSON schema describing your resource, `terraform-google-organizationiamcustomrole.json`
2. Implement your resource handlers in `terraform_google_organizationiamcustomrole/handlers.py`
