...
1. Write the JSON schema describing your resource, `tf-google-computetargethttpproxy.json`
2. Implement your resource handlers in `tf_google_computetargethttpproxy/handlers.py`
