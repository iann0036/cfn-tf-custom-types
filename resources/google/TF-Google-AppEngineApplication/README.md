...
1. Write the JSON schema describing your resource, `tf-google-appengineapplication.json`
2. Implement your resource handlers in `tf_google_appengineapplication/handlers.py`
