...
1. Write the JSON schema describing your resource, `tf-google-computehttpshealthcheck.json`
2. Implement your resource handlers in `tf_google_computehttpshealthcheck/handlers.py`
