...
1. Write the JSON schema describing your resource, `terraform-google-monitoringalertpolicy.json`
2. Implement your resource handlers in `terraform_google_monitoringalertpolicy/handlers.py`
