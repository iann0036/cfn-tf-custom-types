# TF::Google::IapWebBackendServiceIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-iapwebbackendserviceiammember.json`
2. Implement your resource handlers in `tf_google_iapwebbackendserviceiammember/handlers.py`
