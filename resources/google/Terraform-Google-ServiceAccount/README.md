...
1. Write the JSON schema describing your resource, `terraform-google-serviceaccount.json`
2. Implement your resource handlers in `terraform_google_serviceaccount/handlers.py`
