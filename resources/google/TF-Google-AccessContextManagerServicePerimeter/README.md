...
1. Write the JSON schema describing your resource, `tf-google-accesscontextmanagerserviceperimeter.json`
2. Implement your resource handlers in `tf_google_accesscontextmanagerserviceperimeter/handlers.py`
