...
1. Write the JSON schema describing your resource, `terraform-google-firestoreindex.json`
2. Implement your resource handlers in `terraform_google_firestoreindex/handlers.py`
