...
1. Write the JSON schema describing your resource, `terraform-google-spannerinstanceiambinding.json`
2. Implement your resource handlers in `terraform_google_spannerinstanceiambinding/handlers.py`
