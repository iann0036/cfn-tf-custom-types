# TF::Google::StorageObjectAcl

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-storageobjectacl.json`
2. Implement your resource handlers in `tf_google_storageobjectacl/handlers.py`
