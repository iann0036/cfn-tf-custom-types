...
1. Write the JSON schema describing your resource, `terraform-google-computedisk.json`
2. Implement your resource handlers in `terraform_google_computedisk/handlers.py`
