...
1. Write the JSON schema describing your resource, `tf-google-folderaccessapprovalsettings.json`
2. Implement your resource handlers in `tf_google_folderaccessapprovalsettings/handlers.py`
