...
1. Write the JSON schema describing your resource, `terraform-google-computeregiondisk.json`
2. Implement your resource handlers in `terraform_google_computeregiondisk/handlers.py`
