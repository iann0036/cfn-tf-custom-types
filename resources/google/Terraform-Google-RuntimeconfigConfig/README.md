...
1. Write the JSON schema describing your resource, `terraform-google-runtimeconfigconfig.json`
2. Implement your resource handlers in `terraform_google_runtimeconfigconfig/handlers.py`
