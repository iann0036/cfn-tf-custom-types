...
1. Write the JSON schema describing your resource, `terraform-google-computenetworkendpoint.json`
2. Implement your resource handlers in `terraform_google_computenetworkendpoint/handlers.py`
