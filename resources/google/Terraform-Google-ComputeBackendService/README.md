...
1. Write the JSON schema describing your resource, `terraform-google-computebackendservice.json`
2. Implement your resource handlers in `terraform_google_computebackendservice/handlers.py`
