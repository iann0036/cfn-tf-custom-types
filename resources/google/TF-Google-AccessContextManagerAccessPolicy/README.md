...
1. Write the JSON schema describing your resource, `tf-google-accesscontextmanageraccesspolicy.json`
2. Implement your resource handlers in `tf_google_accesscontextmanageraccesspolicy/handlers.py`
