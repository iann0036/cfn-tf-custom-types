...
1. Write the JSON schema describing your resource, `terraform-google-computeinstancegroup.json`
2. Implement your resource handlers in `terraform_google_computeinstancegroup/handlers.py`
