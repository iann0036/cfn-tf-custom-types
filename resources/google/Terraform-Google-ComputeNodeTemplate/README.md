...
1. Write the JSON schema describing your resource, `terraform-google-computenodetemplate.json`
2. Implement your resource handlers in `terraform_google_computenodetemplate/handlers.py`
