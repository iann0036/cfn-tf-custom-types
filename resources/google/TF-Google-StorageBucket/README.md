...
1. Write the JSON schema describing your resource, `tf-google-storagebucket.json`
2. Implement your resource handlers in `tf_google_storagebucket/handlers.py`
