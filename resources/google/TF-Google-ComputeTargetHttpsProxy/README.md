...
1. Write the JSON schema describing your resource, `tf-google-computetargethttpsproxy.json`
2. Implement your resource handlers in `tf_google_computetargethttpsproxy/handlers.py`
