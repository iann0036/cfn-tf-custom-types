...
1. Write the JSON schema describing your resource, `tf-google-computeregionhealthcheck.json`
2. Implement your resource handlers in `tf_google_computeregionhealthcheck/handlers.py`
