...
1. Write the JSON schema describing your resource, `tf-google-bigquerytableiambinding.json`
2. Implement your resource handlers in `tf_google_bigquerytableiambinding/handlers.py`
