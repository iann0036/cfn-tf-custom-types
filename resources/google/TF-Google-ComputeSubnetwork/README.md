...
1. Write the JSON schema describing your resource, `tf-google-computesubnetwork.json`
2. Implement your resource handlers in `tf_google_computesubnetwork/handlers.py`
