...
1. Write the JSON schema describing your resource, `tf-google-datalosspreventioninspecttemplate.json`
2. Implement your resource handlers in `tf_google_datalosspreventioninspecttemplate/handlers.py`
