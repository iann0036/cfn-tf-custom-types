...
1. Write the JSON schema describing your resource, `terraform-google-storageobjectaccesscontrol.json`
2. Implement your resource handlers in `terraform_google_storageobjectaccesscontrol/handlers.py`
