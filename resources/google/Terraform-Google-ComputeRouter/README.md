...
1. Write the JSON schema describing your resource, `terraform-google-computerouter.json`
2. Implement your resource handlers in `terraform_google_computerouter/handlers.py`
