# TF::Google::OrganizationIamCustomRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-organizationiamcustomrole.json`
2. Implement your resource handlers in `tf_google_organizationiamcustomrole/handlers.py`
