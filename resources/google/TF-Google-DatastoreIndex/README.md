...
1. Write the JSON schema describing your resource, `tf-google-datastoreindex.json`
2. Implement your resource handlers in `tf_google_datastoreindex/handlers.py`
