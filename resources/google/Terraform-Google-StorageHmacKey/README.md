...
1. Write the JSON schema describing your resource, `terraform-google-storagehmackey.json`
2. Implement your resource handlers in `terraform_google_storagehmackey/handlers.py`
