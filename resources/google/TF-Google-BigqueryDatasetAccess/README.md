...
1. Write the JSON schema describing your resource, `tf-google-bigquerydatasetaccess.json`
2. Implement your resource handlers in `tf_google_bigquerydatasetaccess/handlers.py`
