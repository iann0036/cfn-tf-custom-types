...
1. Write the JSON schema describing your resource, `terraform-google-bigtablegcpolicy.json`
2. Implement your resource handlers in `terraform_google_bigtablegcpolicy/handlers.py`
