...
1. Write the JSON schema describing your resource, `terraform-google-organizationpolicy.json`
2. Implement your resource handlers in `terraform_google_organizationpolicy/handlers.py`
