# TF::Google::DataCatalogEntryGroupIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-datacatalogentrygroupiambinding.json`
2. Implement your resource handlers in `tf_google_datacatalogentrygroupiambinding/handlers.py`
