...
1. Write the JSON schema describing your resource, `terraform-google-computeforwardingrule.json`
2. Implement your resource handlers in `terraform_google_computeforwardingrule/handlers.py`
