...
1. Write the JSON schema describing your resource, `terraform-google-runtimeconfigvariable.json`
2. Implement your resource handlers in `terraform_google_runtimeconfigvariable/handlers.py`
