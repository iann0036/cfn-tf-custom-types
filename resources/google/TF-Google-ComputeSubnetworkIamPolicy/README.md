...
1. Write the JSON schema describing your resource, `tf-google-computesubnetworkiampolicy.json`
2. Implement your resource handlers in `tf_google_computesubnetworkiampolicy/handlers.py`
