...
1. Write the JSON schema describing your resource, `terraform-google-computenetworkpeeringroutesconfig.json`
2. Implement your resource handlers in `terraform_google_computenetworkpeeringroutesconfig/handlers.py`
