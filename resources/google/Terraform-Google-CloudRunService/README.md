...
1. Write the JSON schema describing your resource, `terraform-google-cloudrunservice.json`
2. Implement your resource handlers in `terraform_google_cloudrunservice/handlers.py`
