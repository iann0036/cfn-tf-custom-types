...
1. Write the JSON schema describing your resource, `terraform-google-cloudbuildtrigger.json`
2. Implement your resource handlers in `terraform_google_cloudbuildtrigger/handlers.py`
