...
1. Write the JSON schema describing your resource, `tf-google-organizationpolicy.json`
2. Implement your resource handlers in `tf_google_organizationpolicy/handlers.py`
