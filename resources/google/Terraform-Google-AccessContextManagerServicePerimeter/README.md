...
1. Write the JSON schema describing your resource, `terraform-google-accesscontextmanagerserviceperimeter.json`
2. Implement your resource handlers in `terraform_google_accesscontextmanagerserviceperimeter/handlers.py`
