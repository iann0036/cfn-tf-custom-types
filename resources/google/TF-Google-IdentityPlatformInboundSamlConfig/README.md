...
1. Write the JSON schema describing your resource, `tf-google-identityplatforminboundsamlconfig.json`
2. Implement your resource handlers in `tf_google_identityplatforminboundsamlconfig/handlers.py`
