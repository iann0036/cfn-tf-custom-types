...
1. Write the JSON schema describing your resource, `tf-google-monitoringalertpolicy.json`
2. Implement your resource handlers in `tf_google_monitoringalertpolicy/handlers.py`
