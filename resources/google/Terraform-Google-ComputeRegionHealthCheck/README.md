...
1. Write the JSON schema describing your resource, `terraform-google-computeregionhealthcheck.json`
2. Implement your resource handlers in `terraform_google_computeregionhealthcheck/handlers.py`
