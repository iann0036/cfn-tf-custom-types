...
1. Write the JSON schema describing your resource, `terraform-google-appengineapplication.json`
2. Implement your resource handlers in `terraform_google_appengineapplication/handlers.py`
