...
1. Write the JSON schema describing your resource, `terraform-google-servicenetworkingconnection.json`
2. Implement your resource handlers in `terraform_google_servicenetworkingconnection/handlers.py`
