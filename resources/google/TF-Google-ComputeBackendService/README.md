...
1. Write the JSON schema describing your resource, `tf-google-computebackendservice.json`
2. Implement your resource handlers in `tf_google_computebackendservice/handlers.py`
