# Terraform::Google::EndpointsServiceIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-endpointsserviceiambinding.json`
2. Implement your resource handlers in `terraform_google_endpointsserviceiambinding/handlers.py`
