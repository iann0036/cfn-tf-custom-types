...
1. Write the JSON schema describing your resource, `terraform-google-bigtabletable.json`
2. Implement your resource handlers in `terraform_google_bigtabletable/handlers.py`
