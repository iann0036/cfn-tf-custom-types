...
1. Write the JSON schema describing your resource, `terraform-google-pubsubtopiciambinding.json`
2. Implement your resource handlers in `terraform_google_pubsubtopiciambinding/handlers.py`
