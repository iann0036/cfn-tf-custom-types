...
1. Write the JSON schema describing your resource, `terraform-google-loggingorganizationexclusion.json`
2. Implement your resource handlers in `terraform_google_loggingorganizationexclusion/handlers.py`
