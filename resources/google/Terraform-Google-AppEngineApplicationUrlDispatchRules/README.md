...
1. Write the JSON schema describing your resource, `terraform-google-appengineapplicationurldispatchrules.json`
2. Implement your resource handlers in `terraform_google_appengineapplicationurldispatchrules/handlers.py`
