...
1. Write the JSON schema describing your resource, `tf-google-bigtableappprofile.json`
2. Implement your resource handlers in `tf_google_bigtableappprofile/handlers.py`
