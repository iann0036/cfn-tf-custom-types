...
1. Write the JSON schema describing your resource, `terraform-google-filestoreinstance.json`
2. Implement your resource handlers in `terraform_google_filestoreinstance/handlers.py`
