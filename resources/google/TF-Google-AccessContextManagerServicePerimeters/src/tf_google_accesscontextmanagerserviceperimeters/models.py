...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    Parent: Optional[str]
    ServicePerimeters: Optional[Sequence["_ServicePerimetersDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ServicePerimeters=deserialize_list(json_data.get("ServicePerimeters"), ServicePerimetersDefinition),
...
@dataclass
class ServicePerimetersDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ServicePerimetersDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServicePerimetersDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ServicePerimetersDefinition = ServicePerimetersDefinition
