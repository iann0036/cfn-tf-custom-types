...
1. Write the JSON schema describing your resource, `tf-google-accesscontextmanagerserviceperimeters.json`
2. Implement your resource handlers in `tf_google_accesscontextmanagerserviceperimeters/handlers.py`
