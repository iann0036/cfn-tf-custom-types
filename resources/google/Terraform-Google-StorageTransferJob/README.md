...
1. Write the JSON schema describing your resource, `terraform-google-storagetransferjob.json`
2. Implement your resource handlers in `terraform_google_storagetransferjob/handlers.py`
