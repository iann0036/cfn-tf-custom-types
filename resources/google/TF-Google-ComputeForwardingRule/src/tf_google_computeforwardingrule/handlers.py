...
TYPE_NAME = "TF::Google::ComputeForwardingRule"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AllPorts=None, AllowGlobalAccess=None, BackendService=None, CreationTimestamp=None, Description=None, Id=None, IpAddress=None, IpProtocol=None, IsMirroringCollector=None, LoadBalancingScheme=None, Name=None, Network=None, NetworkTier=None, PortRange=None, Ports=None, Project=None, Region=None, SelfLink=None, ServiceLabel=None, ServiceName=None, Subnetwork=None, Target=None, Timeouts=None)
