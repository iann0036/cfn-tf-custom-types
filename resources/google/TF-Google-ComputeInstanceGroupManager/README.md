# TF::Google::ComputeInstanceGroupManager

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-computeinstancegroupmanager.json`
2. Implement your resource handlers in `tf_google_computeinstancegroupmanager/handlers.py`
