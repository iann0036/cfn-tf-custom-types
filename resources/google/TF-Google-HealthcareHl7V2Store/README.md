...
1. Write the JSON schema describing your resource, `tf-google-healthcarehl7v2store.json`
2. Implement your resource handlers in `tf_google_healthcarehl7v2store/handlers.py`
