...
1. Write the JSON schema describing your resource, `terraform-google-loggingmetric.json`
2. Implement your resource handlers in `terraform_google_loggingmetric/handlers.py`
