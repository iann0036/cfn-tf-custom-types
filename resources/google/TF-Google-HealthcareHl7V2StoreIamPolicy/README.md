# TF::Google::HealthcareHl7V2StoreIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-healthcarehl7v2storeiampolicy.json`
2. Implement your resource handlers in `tf_google_healthcarehl7v2storeiampolicy/handlers.py`
