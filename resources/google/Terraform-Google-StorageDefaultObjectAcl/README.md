...
1. Write the JSON schema describing your resource, `terraform-google-storagedefaultobjectacl.json`
2. Implement your resource handlers in `terraform_google_storagedefaultobjectacl/handlers.py`
