...
1. Write the JSON schema describing your resource, `terraform-google-binaryauthorizationattestoriampolicy.json`
2. Implement your resource handlers in `terraform_google_binaryauthorizationattestoriampolicy/handlers.py`
