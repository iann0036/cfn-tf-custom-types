...
TYPE_NAME = "TF::Google::DataprocWorkflowTemplate"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreateTime=None, Id=None, Labels=None, Location=None, Name=None, Project=None, UpdateTime=None, Version=None, Jobs=None, Parameters=None, Placement=None, Timeouts=None)
