...
1. Write the JSON schema describing your resource, `terraform-google-accesscontextmanagerserviceperimeterresource.json`
2. Implement your resource handlers in `terraform_google_accesscontextmanagerserviceperimeterresource/handlers.py`
