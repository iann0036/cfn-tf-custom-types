# TF::Google::ComputeImageIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-computeimageiambinding.json`
2. Implement your resource handlers in `tf_google_computeimageiambinding/handlers.py`
