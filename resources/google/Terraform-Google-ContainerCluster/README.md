...
1. Write the JSON schema describing your resource, `terraform-google-containercluster.json`
2. Implement your resource handlers in `terraform_google_containercluster/handlers.py`
