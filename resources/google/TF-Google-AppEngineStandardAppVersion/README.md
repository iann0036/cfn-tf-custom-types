...
1. Write the JSON schema describing your resource, `tf-google-appenginestandardappversion.json`
2. Implement your resource handlers in `tf_google_appenginestandardappversion/handlers.py`
