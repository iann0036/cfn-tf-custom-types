...
1. Write the JSON schema describing your resource, `terraform-google-folder.json`
2. Implement your resource handlers in `terraform_google_folder/handlers.py`
