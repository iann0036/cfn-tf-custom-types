...
1. Write the JSON schema describing your resource, `terraform-google-bigtableappprofile.json`
2. Implement your resource handlers in `terraform_google_bigtableappprofile/handlers.py`
