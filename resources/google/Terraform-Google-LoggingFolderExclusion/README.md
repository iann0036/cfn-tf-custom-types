...
1. Write the JSON schema describing your resource, `terraform-google-loggingfolderexclusion.json`
2. Implement your resource handlers in `terraform_google_loggingfolderexclusion/handlers.py`
