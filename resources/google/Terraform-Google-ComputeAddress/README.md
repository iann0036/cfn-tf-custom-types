...
1. Write the JSON schema describing your resource, `terraform-google-computeaddress.json`
2. Implement your resource handlers in `terraform_google_computeaddress/handlers.py`
