...
1. Write the JSON schema describing your resource, `tf-google-serviceaccountkey.json`
2. Implement your resource handlers in `tf_google_serviceaccountkey/handlers.py`
