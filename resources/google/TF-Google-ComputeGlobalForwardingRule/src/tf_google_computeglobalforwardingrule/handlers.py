...
TYPE_NAME = "TF::Google::ComputeGlobalForwardingRule"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Description=None, Id=None, IpAddress=None, IpProtocol=None, IpVersion=None, LoadBalancingScheme=None, Name=None, PortRange=None, Project=None, SelfLink=None, Target=None, MetadataFilters=None, Timeouts=None)
