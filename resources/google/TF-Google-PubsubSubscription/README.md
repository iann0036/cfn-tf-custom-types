...
1. Write the JSON schema describing your resource, `tf-google-pubsubsubscription.json`
2. Implement your resource handlers in `tf_google_pubsubsubscription/handlers.py`
