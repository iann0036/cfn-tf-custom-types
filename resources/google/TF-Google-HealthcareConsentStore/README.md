...
1. Write the JSON schema describing your resource, `tf-google-healthcareconsentstore.json`
2. Implement your resource handlers in `tf_google_healthcareconsentstore/handlers.py`
