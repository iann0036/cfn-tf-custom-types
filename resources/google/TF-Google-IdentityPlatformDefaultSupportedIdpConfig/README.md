...
1. Write the JSON schema describing your resource, `tf-google-identityplatformdefaultsupportedidpconfig.json`
2. Implement your resource handlers in `tf_google_identityplatformdefaultsupportedidpconfig/handlers.py`
