...
1. Write the JSON schema describing your resource, `tf-google-identityplatformtenantinboundsamlconfig.json`
2. Implement your resource handlers in `tf_google_identityplatformtenantinboundsamlconfig/handlers.py`
