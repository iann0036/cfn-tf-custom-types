...
1. Write the JSON schema describing your resource, `tf-google-computemanagedsslcertificate.json`
2. Implement your resource handlers in `tf_google_computemanagedsslcertificate/handlers.py`
