# TF::Google::DataprocAutoscalingPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-dataprocautoscalingpolicy.json`
2. Implement your resource handlers in `tf_google_dataprocautoscalingpolicy/handlers.py`
