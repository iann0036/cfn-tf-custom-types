...
1. Write the JSON schema describing your resource, `tf-google-computerouterpeer.json`
2. Implement your resource handlers in `tf_google_computerouterpeer/handlers.py`
