...
1. Write the JSON schema describing your resource, `terraform-google-computerouternat.json`
2. Implement your resource handlers in `terraform_google_computerouternat/handlers.py`
