...
1. Write the JSON schema describing your resource, `tf-google-computeinstance.json`
2. Implement your resource handlers in `tf_google_computeinstance/handlers.py`
