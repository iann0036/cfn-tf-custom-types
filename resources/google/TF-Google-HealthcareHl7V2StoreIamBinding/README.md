# TF::Google::HealthcareHl7V2StoreIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-healthcarehl7v2storeiambinding.json`
2. Implement your resource handlers in `tf_google_healthcarehl7v2storeiambinding/handlers.py`
