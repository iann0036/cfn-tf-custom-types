...
1. Write the JSON schema describing your resource, `tf-google-tagstagbinding.json`
2. Implement your resource handlers in `tf_google_tagstagbinding/handlers.py`
