...
1. Write the JSON schema describing your resource, `tf-google-computeregioninstancegroupmanager.json`
2. Implement your resource handlers in `tf_google_computeregioninstancegroupmanager/handlers.py`
