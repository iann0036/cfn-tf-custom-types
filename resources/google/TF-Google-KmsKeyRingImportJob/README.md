...
1. Write the JSON schema describing your resource, `tf-google-kmskeyringimportjob.json`
2. Implement your resource handlers in `tf_google_kmskeyringimportjob/handlers.py`
