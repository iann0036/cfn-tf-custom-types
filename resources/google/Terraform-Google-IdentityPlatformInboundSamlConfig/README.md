...
1. Write the JSON schema describing your resource, `terraform-google-identityplatforminboundsamlconfig.json`
2. Implement your resource handlers in `terraform_google_identityplatforminboundsamlconfig/handlers.py`
