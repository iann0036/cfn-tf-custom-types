# TF::Google::LoggingFolderSink

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-loggingfoldersink.json`
2. Implement your resource handlers in `tf_google_loggingfoldersink/handlers.py`
