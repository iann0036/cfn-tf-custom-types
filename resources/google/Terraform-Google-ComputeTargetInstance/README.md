...
1. Write the JSON schema describing your resource, `terraform-google-computetargetinstance.json`
2. Implement your resource handlers in `terraform_google_computetargetinstance/handlers.py`
