...
1. Write the JSON schema describing your resource, `terraform-google-cloudschedulerjob.json`
2. Implement your resource handlers in `terraform_google_cloudschedulerjob/handlers.py`
