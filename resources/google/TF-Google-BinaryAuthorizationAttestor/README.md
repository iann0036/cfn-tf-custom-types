...
1. Write the JSON schema describing your resource, `tf-google-binaryauthorizationattestor.json`
2. Implement your resource handlers in `tf_google_binaryauthorizationattestor/handlers.py`
