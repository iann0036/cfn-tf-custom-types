...
1. Write the JSON schema describing your resource, `terraform-google-pubsubsubscriptioniammember.json`
2. Implement your resource handlers in `terraform_google_pubsubsubscriptioniammember/handlers.py`
