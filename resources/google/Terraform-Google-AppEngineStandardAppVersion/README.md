...
1. Write the JSON schema describing your resource, `terraform-google-appenginestandardappversion.json`
2. Implement your resource handlers in `terraform_google_appenginestandardappversion/handlers.py`
