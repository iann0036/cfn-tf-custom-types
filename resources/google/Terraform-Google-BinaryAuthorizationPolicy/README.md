...
1. Write the JSON schema describing your resource, `terraform-google-binaryauthorizationpolicy.json`
2. Implement your resource handlers in `terraform_google_binaryauthorizationpolicy/handlers.py`
