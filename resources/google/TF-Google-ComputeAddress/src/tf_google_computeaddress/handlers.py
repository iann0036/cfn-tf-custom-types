...
TYPE_NAME = "TF::Google::ComputeAddress"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Address=None, AddressType=None, CreationTimestamp=None, Description=None, Id=None, Name=None, Network=None, NetworkTier=None, PrefixLength=None, Project=None, Purpose=None, Region=None, SelfLink=None, Subnetwork=None, Users=None, Timeouts=None)
