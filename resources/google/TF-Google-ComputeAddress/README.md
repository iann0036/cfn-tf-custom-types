...
1. Write the JSON schema describing your resource, `tf-google-computeaddress.json`
2. Implement your resource handlers in `tf_google_computeaddress/handlers.py`
