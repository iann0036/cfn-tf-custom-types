...
TYPE_NAME = "TF::Google::ComputeGlobalAddress"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Address=None, AddressType=None, CreationTimestamp=None, Description=None, Id=None, IpVersion=None, Name=None, Network=None, PrefixLength=None, Project=None, Purpose=None, SelfLink=None, Timeouts=None)
