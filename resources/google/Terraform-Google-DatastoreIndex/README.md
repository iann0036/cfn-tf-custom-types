...
1. Write the JSON schema describing your resource, `terraform-google-datastoreindex.json`
2. Implement your resource handlers in `terraform_google_datastoreindex/handlers.py`
