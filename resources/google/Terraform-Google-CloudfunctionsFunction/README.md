...
1. Write the JSON schema describing your resource, `terraform-google-cloudfunctionsfunction.json`
2. Implement your resource handlers in `terraform_google_cloudfunctionsfunction/handlers.py`
