...
1. Write the JSON schema describing your resource, `terraform-google-appenginefirewallrule.json`
2. Implement your resource handlers in `terraform_google_appenginefirewallrule/handlers.py`
