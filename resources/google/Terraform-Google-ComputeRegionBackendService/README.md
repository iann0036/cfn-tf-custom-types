...
1. Write the JSON schema describing your resource, `terraform-google-computeregionbackendservice.json`
2. Implement your resource handlers in `terraform_google_computeregionbackendservice/handlers.py`
