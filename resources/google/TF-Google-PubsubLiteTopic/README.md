# TF::Google::PubsubLiteTopic

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-pubsublitetopic.json`
2. Implement your resource handlers in `tf_google_pubsublitetopic/handlers.py`
