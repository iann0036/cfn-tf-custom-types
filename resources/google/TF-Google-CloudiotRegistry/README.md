...
1. Write the JSON schema describing your resource, `tf-google-cloudiotregistry.json`
2. Implement your resource handlers in `tf_google_cloudiotregistry/handlers.py`
