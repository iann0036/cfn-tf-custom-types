...
1. Write the JSON schema describing your resource, `tf-google-monitoringcustomservice.json`
2. Implement your resource handlers in `tf_google_monitoringcustomservice/handlers.py`
