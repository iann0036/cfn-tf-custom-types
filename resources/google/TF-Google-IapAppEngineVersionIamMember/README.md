# TF::Google::IapAppEngineVersionIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-iapappengineversioniammember.json`
2. Implement your resource handlers in `tf_google_iapappengineversioniammember/handlers.py`
