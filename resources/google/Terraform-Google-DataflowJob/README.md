...
1. Write the JSON schema describing your resource, `terraform-google-dataflowjob.json`
2. Implement your resource handlers in `terraform_google_dataflowjob/handlers.py`
