...
1. Write the JSON schema describing your resource, `tf-google-memcacheinstance.json`
2. Implement your resource handlers in `tf_google_memcacheinstance/handlers.py`
