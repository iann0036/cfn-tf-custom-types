# Terraform::Google::ComputeNetworkEndpointGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-computenetworkendpointgroup.json`
2. Implement your resource handlers in `terraform_google_computenetworkendpointgroup/handlers.py`
