...
1. Write the JSON schema describing your resource, `terraform-google-computetargetsslproxy.json`
2. Implement your resource handlers in `terraform_google_computetargetsslproxy/handlers.py`
