...
1. Write the JSON schema describing your resource, `terraform-google-composerenvironment.json`
2. Implement your resource handlers in `terraform_google_composerenvironment/handlers.py`
