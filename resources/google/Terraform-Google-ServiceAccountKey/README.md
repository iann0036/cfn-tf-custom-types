...
1. Write the JSON schema describing your resource, `terraform-google-serviceaccountkey.json`
2. Implement your resource handlers in `terraform_google_serviceaccountkey/handlers.py`
