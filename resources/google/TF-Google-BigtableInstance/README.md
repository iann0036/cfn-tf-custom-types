...
1. Write the JSON schema describing your resource, `tf-google-bigtableinstance.json`
2. Implement your resource handlers in `tf_google_bigtableinstance/handlers.py`
