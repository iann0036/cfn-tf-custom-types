...
1. Write the JSON schema describing your resource, `tf-google-bigqueryroutine.json`
2. Implement your resource handlers in `tf_google_bigqueryroutine/handlers.py`
