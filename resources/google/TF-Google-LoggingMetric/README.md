...
1. Write the JSON schema describing your resource, `tf-google-loggingmetric.json`
2. Implement your resource handlers in `tf_google_loggingmetric/handlers.py`
