...
1. Write the JSON schema describing your resource, `terraform-google-dnsrecordset.json`
2. Implement your resource handlers in `terraform_google_dnsrecordset/handlers.py`
