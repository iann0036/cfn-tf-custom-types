...
1. Write the JSON schema describing your resource, `terraform-google-project.json`
2. Implement your resource handlers in `terraform_google_project/handlers.py`
