...
1. Write the JSON schema describing your resource, `terraform-google-identityplatformtenantinboundsamlconfig.json`
2. Implement your resource handlers in `terraform_google_identityplatformtenantinboundsamlconfig/handlers.py`
