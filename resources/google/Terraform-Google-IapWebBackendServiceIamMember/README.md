# Terraform::Google::IapWebBackendServiceIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-iapwebbackendserviceiammember.json`
2. Implement your resource handlers in `terraform_google_iapwebbackendserviceiammember/handlers.py`
