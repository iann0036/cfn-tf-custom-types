...
1. Write the JSON schema describing your resource, `tf-google-computeregionnetworkendpointgroup.json`
2. Implement your resource handlers in `tf_google_computeregionnetworkendpointgroup/handlers.py`
