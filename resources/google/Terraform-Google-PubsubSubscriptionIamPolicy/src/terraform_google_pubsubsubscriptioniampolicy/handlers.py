...
def create_handler(
    ...
    try:
        ...
        tf['resource']['google_pubsub_subscription_iam_policy'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['google_pubsub_subscription_iam_policy'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
