# TF::Google::HealthcareHl7V2StoreIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-healthcarehl7v2storeiammember.json`
2. Implement your resource handlers in `tf_google_healthcarehl7v2storeiammember/handlers.py`
