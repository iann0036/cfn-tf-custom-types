...
1. Write the JSON schema describing your resource, `terraform-google-computeinstancetemplate.json`
2. Implement your resource handlers in `terraform_google_computeinstancetemplate/handlers.py`
