...
1. Write the JSON schema describing your resource, `tf-google-monitoringdashboard.json`
2. Implement your resource handlers in `tf_google_monitoringdashboard/handlers.py`
