...
1. Write the JSON schema describing your resource, `terraform-google-computevpngateway.json`
2. Implement your resource handlers in `terraform_google_computevpngateway/handlers.py`
