# TF::Google::KmsKeyRingIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-kmskeyringiampolicy.json`
2. Implement your resource handlers in `tf_google_kmskeyringiampolicy/handlers.py`
