# TF::Google::LoggingBillingAccountExclusion

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-loggingbillingaccountexclusion.json`
2. Implement your resource handlers in `tf_google_loggingbillingaccountexclusion/handlers.py`
