...
1. Write the JSON schema describing your resource, `terraform-google-kmscryptokeyiambinding.json`
2. Implement your resource handlers in `terraform_google_kmscryptokeyiambinding/handlers.py`
