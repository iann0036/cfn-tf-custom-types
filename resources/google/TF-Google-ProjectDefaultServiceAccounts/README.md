...
1. Write the JSON schema describing your resource, `tf-google-projectdefaultserviceaccounts.json`
2. Implement your resource handlers in `tf_google_projectdefaultserviceaccounts/handlers.py`
