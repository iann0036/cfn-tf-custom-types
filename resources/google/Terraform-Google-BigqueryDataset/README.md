...
1. Write the JSON schema describing your resource, `terraform-google-bigquerydataset.json`
2. Implement your resource handlers in `terraform_google_bigquerydataset/handlers.py`
