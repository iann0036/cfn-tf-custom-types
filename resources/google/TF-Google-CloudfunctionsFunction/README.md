...
1. Write the JSON schema describing your resource, `tf-google-cloudfunctionsfunction.json`
2. Implement your resource handlers in `tf_google_cloudfunctionsfunction/handlers.py`
