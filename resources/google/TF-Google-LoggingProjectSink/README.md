...
1. Write the JSON schema describing your resource, `tf-google-loggingprojectsink.json`
2. Implement your resource handlers in `tf_google_loggingprojectsink/handlers.py`
