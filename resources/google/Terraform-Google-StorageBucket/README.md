...
1. Write the JSON schema describing your resource, `terraform-google-storagebucket.json`
2. Implement your resource handlers in `terraform_google_storagebucket/handlers.py`
