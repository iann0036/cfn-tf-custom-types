...
1. Write the JSON schema describing your resource, `terraform-google-computeglobalforwardingrule.json`
2. Implement your resource handlers in `terraform_google_computeglobalforwardingrule/handlers.py`
