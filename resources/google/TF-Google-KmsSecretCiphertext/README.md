...
1. Write the JSON schema describing your resource, `tf-google-kmssecretciphertext.json`
2. Implement your resource handlers in `tf_google_kmssecretciphertext/handlers.py`
