...
TYPE_NAME = "TF::Google::ComputeVpnTunnel"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreationTimestamp=None, Description=None, DetailedStatus=None, Id=None, IkeVersion=None, LocalTrafficSelector=None, Name=None, PeerExternalGateway=None, PeerExternalGatewayInterface=None, PeerGcpGateway=None, PeerIp=None, Project=None, Region=None, RemoteTrafficSelector=None, Router=None, SelfLink=None, SharedSecret=None, SharedSecretHash=None, TargetVpnGateway=None, TunnelId=None, VpnGateway=None, VpnGatewayInterface=None, Timeouts=None)
