...
1. Write the JSON schema describing your resource, `terraform-google-dnsmanagedzone.json`
2. Implement your resource handlers in `terraform_google_dnsmanagedzone/handlers.py`
