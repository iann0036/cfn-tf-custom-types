...
def create_handler(
    ...
    try:
        ...
        tf['resource']['google_cloudfunctions_function_iam_binding'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['google_cloudfunctions_function_iam_binding'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
