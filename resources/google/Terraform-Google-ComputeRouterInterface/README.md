...
1. Write the JSON schema describing your resource, `terraform-google-computerouterinterface.json`
2. Implement your resource handlers in `terraform_google_computerouterinterface/handlers.py`
