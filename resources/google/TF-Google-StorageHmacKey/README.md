...
1. Write the JSON schema describing your resource, `tf-google-storagehmackey.json`
2. Implement your resource handlers in `tf_google_storagehmackey/handlers.py`
