# TF::Google::TagsTagValue

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-tagstagvalue.json`
2. Implement your resource handlers in `tf_google_tagstagvalue/handlers.py`
