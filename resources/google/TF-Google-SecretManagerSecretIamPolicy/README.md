# TF::Google::SecretManagerSecretIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-secretmanagersecretiampolicy.json`
2. Implement your resource handlers in `tf_google_secretmanagersecretiampolicy/handlers.py`
