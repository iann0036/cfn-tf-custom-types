...
1. Write the JSON schema describing your resource, `terraform-google-endpointsservice.json`
2. Implement your resource handlers in `terraform_google_endpointsservice/handlers.py`
