...
1. Write the JSON schema describing your resource, `tf-google-notebooksinstance.json`
2. Implement your resource handlers in `tf_google_notebooksinstance/handlers.py`
