...
1. Write the JSON schema describing your resource, `terraform-google-folderorganizationpolicy.json`
2. Implement your resource handlers in `terraform_google_folderorganizationpolicy/handlers.py`
