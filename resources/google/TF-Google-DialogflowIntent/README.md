...
1. Write the JSON schema describing your resource, `tf-google-dialogflowintent.json`
2. Implement your resource handlers in `tf_google_dialogflowintent/handlers.py`
