...
1. Write the JSON schema describing your resource, `tf-google-spannerdatabase.json`
2. Implement your resource handlers in `tf_google_spannerdatabase/handlers.py`
