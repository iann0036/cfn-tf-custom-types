...
1. Write the JSON schema describing your resource, `tf-google-computeinstancetemplate.json`
2. Implement your resource handlers in `tf_google_computeinstancetemplate/handlers.py`
