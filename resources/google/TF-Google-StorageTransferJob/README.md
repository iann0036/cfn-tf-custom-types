...
1. Write the JSON schema describing your resource, `tf-google-storagetransferjob.json`
2. Implement your resource handlers in `tf_google_storagetransferjob/handlers.py`
