...
1. Write the JSON schema describing your resource, `tf-google-appengineflexibleappversion.json`
2. Implement your resource handlers in `tf_google_appengineflexibleappversion/handlers.py`
