...
1. Write the JSON schema describing your resource, `tf-google-apigeeinstance.json`
2. Implement your resource handlers in `tf_google_apigeeinstance/handlers.py`
