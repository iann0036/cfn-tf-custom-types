# TF::Google::WorkflowsWorkflow

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-workflowsworkflow.json`
2. Implement your resource handlers in `tf_google_workflowsworkflow/handlers.py`
