...
1. Write the JSON schema describing your resource, `terraform-google-folderiammember.json`
2. Implement your resource handlers in `terraform_google_folderiammember/handlers.py`
