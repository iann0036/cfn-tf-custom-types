...
1. Write the JSON schema describing your resource, `tf-google-firestoreindex.json`
2. Implement your resource handlers in `tf_google_firestoreindex/handlers.py`
