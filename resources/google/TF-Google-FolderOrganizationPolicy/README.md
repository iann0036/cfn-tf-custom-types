# TF::Google::FolderOrganizationPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-folderorganizationpolicy.json`
2. Implement your resource handlers in `tf_google_folderorganizationpolicy/handlers.py`
