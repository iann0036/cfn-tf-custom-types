...
1. Write the JSON schema describing your resource, `terraform-google-computeprojectmetadata.json`
2. Implement your resource handlers in `terraform_google_computeprojectmetadata/handlers.py`
