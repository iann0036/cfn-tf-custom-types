# Terraform::Google::PubsubTopicIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-pubsubtopiciampolicy.json`
2. Implement your resource handlers in `terraform_google_pubsubtopiciampolicy/handlers.py`
