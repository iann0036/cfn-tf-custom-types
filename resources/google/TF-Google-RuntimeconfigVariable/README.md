...
1. Write the JSON schema describing your resource, `tf-google-runtimeconfigvariable.json`
2. Implement your resource handlers in `tf_google_runtimeconfigvariable/handlers.py`
