...
1. Write the JSON schema describing your resource, `tf-google-projectiamauditconfig.json`
2. Implement your resource handlers in `tf_google_projectiamauditconfig/handlers.py`
