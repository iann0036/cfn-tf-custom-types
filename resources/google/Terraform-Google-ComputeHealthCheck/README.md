...
1. Write the JSON schema describing your resource, `terraform-google-computehealthcheck.json`
2. Implement your resource handlers in `terraform_google_computehealthcheck/handlers.py`
