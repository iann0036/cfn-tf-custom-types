...
1. Write the JSON schema describing your resource, `tf-google-computetargettcpproxy.json`
2. Implement your resource handlers in `tf_google_computetargettcpproxy/handlers.py`
