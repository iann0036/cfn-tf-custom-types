...
1. Write the JSON schema describing your resource, `terraform-google-computeglobaladdress.json`
2. Implement your resource handlers in `terraform_google_computeglobaladdress/handlers.py`
