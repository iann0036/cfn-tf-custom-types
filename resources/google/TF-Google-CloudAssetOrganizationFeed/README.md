...
1. Write the JSON schema describing your resource, `tf-google-cloudassetorganizationfeed.json`
2. Implement your resource handlers in `tf_google_cloudassetorganizationfeed/handlers.py`
