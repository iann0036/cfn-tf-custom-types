...
1. Write the JSON schema describing your resource, `tf-google-loggingorganizationsink.json`
2. Implement your resource handlers in `tf_google_loggingorganizationsink/handlers.py`
