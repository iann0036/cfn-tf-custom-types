...
1. Write the JSON schema describing your resource, `tf-google-healthcarefhirstore.json`
2. Implement your resource handlers in `tf_google_healthcarefhirstore/handlers.py`
