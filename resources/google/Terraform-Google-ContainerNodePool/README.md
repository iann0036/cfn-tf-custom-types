...
1. Write the JSON schema describing your resource, `terraform-google-containernodepool.json`
2. Implement your resource handlers in `terraform_google_containernodepool/handlers.py`
