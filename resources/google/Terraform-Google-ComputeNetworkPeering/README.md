...
1. Write the JSON schema describing your resource, `terraform-google-computenetworkpeering.json`
2. Implement your resource handlers in `terraform_google_computenetworkpeering/handlers.py`
