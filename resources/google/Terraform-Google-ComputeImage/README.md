...
1. Write the JSON schema describing your resource, `terraform-google-computeimage.json`
2. Implement your resource handlers in `terraform_google_computeimage/handlers.py`
