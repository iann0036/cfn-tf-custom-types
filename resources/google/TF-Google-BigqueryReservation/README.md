...
1. Write the JSON schema describing your resource, `tf-google-bigqueryreservation.json`
2. Implement your resource handlers in `tf_google_bigqueryreservation/handlers.py`
