...
1. Write the JSON schema describing your resource, `terraform-google-computesharedvpcserviceproject.json`
2. Implement your resource handlers in `terraform_google_computesharedvpcserviceproject/handlers.py`
