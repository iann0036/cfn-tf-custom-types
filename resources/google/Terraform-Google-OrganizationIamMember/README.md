...
1. Write the JSON schema describing your resource, `terraform-google-organizationiammember.json`
2. Implement your resource handlers in `terraform_google_organizationiammember/handlers.py`
