...
1. Write the JSON schema describing your resource, `terraform-google-billingaccountiammember.json`
2. Implement your resource handlers in `terraform_google_billingaccountiammember/handlers.py`
