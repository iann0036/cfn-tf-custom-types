...
1. Write the JSON schema describing your resource, `terraform-google-computesnapshot.json`
2. Implement your resource handlers in `terraform_google_computesnapshot/handlers.py`
