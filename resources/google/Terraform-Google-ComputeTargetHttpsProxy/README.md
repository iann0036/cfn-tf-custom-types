...
1. Write the JSON schema describing your resource, `terraform-google-computetargethttpsproxy.json`
2. Implement your resource handlers in `terraform_google_computetargethttpsproxy/handlers.py`
