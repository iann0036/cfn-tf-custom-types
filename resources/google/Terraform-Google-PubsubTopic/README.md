...
1. Write the JSON schema describing your resource, `terraform-google-pubsubtopic.json`
2. Implement your resource handlers in `terraform_google_pubsubtopic/handlers.py`
