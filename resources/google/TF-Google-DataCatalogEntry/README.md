...
1. Write the JSON schema describing your resource, `tf-google-datacatalogentry.json`
2. Implement your resource handlers in `tf_google_datacatalogentry/handlers.py`
