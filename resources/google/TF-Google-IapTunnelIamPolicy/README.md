# TF::Google::IapTunnelIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-iaptunneliampolicy.json`
2. Implement your resource handlers in `tf_google_iaptunneliampolicy/handlers.py`
