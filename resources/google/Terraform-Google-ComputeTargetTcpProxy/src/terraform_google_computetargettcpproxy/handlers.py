...
def create_handler(
    ...
    try:
        ...
        tf['resource']['google_compute_target_tcp_proxy'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['google_compute_target_tcp_proxy'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
