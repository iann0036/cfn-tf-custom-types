...
1. Write the JSON schema describing your resource, `terraform-google-computetargettcpproxy.json`
2. Implement your resource handlers in `terraform_google_computetargettcpproxy/handlers.py`
