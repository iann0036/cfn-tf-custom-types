...
1. Write the JSON schema describing your resource, `tf-google-apigeeenvgroup.json`
2. Implement your resource handlers in `tf_google_apigeeenvgroup/handlers.py`
