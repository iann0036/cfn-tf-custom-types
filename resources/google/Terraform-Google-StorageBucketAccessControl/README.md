...
1. Write the JSON schema describing your resource, `terraform-google-storagebucketaccesscontrol.json`
2. Implement your resource handlers in `terraform_google_storagebucketaccesscontrol/handlers.py`
