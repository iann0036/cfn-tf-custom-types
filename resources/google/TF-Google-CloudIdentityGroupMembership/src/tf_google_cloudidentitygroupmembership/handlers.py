...
TYPE_NAME = "TF::Google::CloudIdentityGroupMembership"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreateTime=None, Group=None, Id=None, Name=None, Type=None, UpdateTime=None, PreferredMemberKey=None, Roles=None, Timeouts=None)
