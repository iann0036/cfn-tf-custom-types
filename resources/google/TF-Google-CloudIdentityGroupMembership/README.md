...
1. Write the JSON schema describing your resource, `tf-google-cloudidentitygroupmembership.json`
2. Implement your resource handlers in `tf_google_cloudidentitygroupmembership/handlers.py`
