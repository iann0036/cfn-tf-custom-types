...
1. Write the JSON schema describing your resource, `terraform-google-computerouterpeer.json`
2. Implement your resource handlers in `terraform_google_computerouterpeer/handlers.py`
