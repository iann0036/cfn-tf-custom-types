...
1. Write the JSON schema describing your resource, `tf-google-computeinterconnectattachment.json`
2. Implement your resource handlers in `tf_google_computeinterconnectattachment/handlers.py`
