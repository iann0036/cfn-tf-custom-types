...
1. Write the JSON schema describing your resource, `terraform-google-computetargethttpproxy.json`
2. Implement your resource handlers in `terraform_google_computetargethttpproxy/handlers.py`
