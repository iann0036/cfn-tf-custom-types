...
1. Write the JSON schema describing your resource, `terraform-google-computeinstance.json`
2. Implement your resource handlers in `terraform_google_computeinstance/handlers.py`
