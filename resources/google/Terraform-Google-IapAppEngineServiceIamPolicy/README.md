# Terraform::Google::IapAppEngineServiceIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-iapappengineserviceiampolicy.json`
2. Implement your resource handlers in `terraform_google_iapappengineserviceiampolicy/handlers.py`
