...
1. Write the JSON schema describing your resource, `tf-google-computereservation.json`
2. Implement your resource handlers in `tf_google_computereservation/handlers.py`
