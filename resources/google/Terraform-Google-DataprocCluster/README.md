...
1. Write the JSON schema describing your resource, `terraform-google-dataproccluster.json`
2. Implement your resource handlers in `terraform_google_dataproccluster/handlers.py`
