...
1. Write the JSON schema describing your resource, `terraform-google-computereservation.json`
2. Implement your resource handlers in `terraform_google_computereservation/handlers.py`
