...
1. Write the JSON schema describing your resource, `tf-google-cloudschedulerjob.json`
2. Implement your resource handlers in `tf_google_cloudschedulerjob/handlers.py`
