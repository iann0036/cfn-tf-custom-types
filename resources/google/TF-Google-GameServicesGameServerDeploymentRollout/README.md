...
1. Write the JSON schema describing your resource, `tf-google-gameservicesgameserverdeploymentrollout.json`
2. Implement your resource handlers in `tf_google_gameservicesgameserverdeploymentrollout/handlers.py`
