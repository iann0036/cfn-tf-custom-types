...
1. Write the JSON schema describing your resource, `tf-google-computefirewall.json`
2. Implement your resource handlers in `tf_google_computefirewall/handlers.py`
