...
1. Write the JSON schema describing your resource, `tf-google-accesscontextmanageraccesslevelcondition.json`
2. Implement your resource handlers in `tf_google_accesscontextmanageraccesslevelcondition/handlers.py`
