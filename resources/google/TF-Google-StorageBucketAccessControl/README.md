...
1. Write the JSON schema describing your resource, `tf-google-storagebucketaccesscontrol.json`
2. Implement your resource handlers in `tf_google_storagebucketaccesscontrol/handlers.py`
