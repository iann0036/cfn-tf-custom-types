...
1. Write the JSON schema describing your resource, `terraform-google-identityplatformtenant.json`
2. Implement your resource handlers in `terraform_google_identityplatformtenant/handlers.py`
