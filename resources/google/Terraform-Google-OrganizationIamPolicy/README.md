...
1. Write the JSON schema describing your resource, `terraform-google-organizationiampolicy.json`
2. Implement your resource handlers in `terraform_google_organizationiampolicy/handlers.py`
