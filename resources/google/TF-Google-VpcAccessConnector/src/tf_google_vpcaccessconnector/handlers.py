...
TYPE_NAME = "TF::Google::VpcAccessConnector"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Id=None, IpCidrRange=None, MaxThroughput=None, MinThroughput=None, Name=None, Network=None, Project=None, Region=None, SelfLink=None, State=None, Timeouts=None)
