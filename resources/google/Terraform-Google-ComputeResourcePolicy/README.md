...
1. Write the JSON schema describing your resource, `terraform-google-computeresourcepolicy.json`
2. Implement your resource handlers in `terraform_google_computeresourcepolicy/handlers.py`
