...
1. Write the JSON schema describing your resource, `terraform-google-loggingbillingaccountexclusion.json`
2. Implement your resource handlers in `terraform_google_loggingbillingaccountexclusion/handlers.py`
