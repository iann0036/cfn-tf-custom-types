...
1. Write the JSON schema describing your resource, `terraform-google-sqlsslcert.json`
2. Implement your resource handlers in `terraform_google_sqlsslcert/handlers.py`
