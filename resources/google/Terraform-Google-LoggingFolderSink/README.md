...
1. Write the JSON schema describing your resource, `terraform-google-loggingfoldersink.json`
2. Implement your resource handlers in `terraform_google_loggingfoldersink/handlers.py`
