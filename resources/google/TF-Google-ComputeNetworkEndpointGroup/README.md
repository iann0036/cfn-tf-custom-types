...
1. Write the JSON schema describing your resource, `tf-google-computenetworkendpointgroup.json`
2. Implement your resource handlers in `tf_google_computenetworkendpointgroup/handlers.py`
