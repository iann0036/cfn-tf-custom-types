...
1. Write the JSON schema describing your resource, `tf-google-deploymentmanagerdeployment.json`
2. Implement your resource handlers in `tf_google_deploymentmanagerdeployment/handlers.py`
