# Terraform::Google::IapAppEngineVersionIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-iapappengineversioniammember.json`
2. Implement your resource handlers in `terraform_google_iapappengineversioniammember/handlers.py`
