...
1. Write the JSON schema describing your resource, `tf-google-containercluster.json`
2. Implement your resource handlers in `tf_google_containercluster/handlers.py`
