...
1. Write the JSON schema describing your resource, `terraform-google-tpunode.json`
2. Implement your resource handlers in `terraform_google_tpunode/handlers.py`
