...
1. Write the JSON schema describing your resource, `terraform-google-serviceaccountiampolicy.json`
2. Implement your resource handlers in `terraform_google_serviceaccountiampolicy/handlers.py`
