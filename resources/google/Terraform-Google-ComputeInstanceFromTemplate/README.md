...
1. Write the JSON schema describing your resource, `terraform-google-computeinstancefromtemplate.json`
2. Implement your resource handlers in `terraform_google_computeinstancefromtemplate/handlers.py`
