...
1. Write the JSON schema describing your resource, `tf-google-loggingbillingaccountbucketconfig.json`
2. Implement your resource handlers in `tf_google_loggingbillingaccountbucketconfig/handlers.py`
