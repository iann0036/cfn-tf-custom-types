...
1. Write the JSON schema describing your resource, `tf-google-monitoringuptimecheckconfig.json`
2. Implement your resource handlers in `tf_google_monitoringuptimecheckconfig/handlers.py`
