# TF::Google::SqlSourceRepresentationInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-sqlsourcerepresentationinstance.json`
2. Implement your resource handlers in `tf_google_sqlsourcerepresentationinstance/handlers.py`
