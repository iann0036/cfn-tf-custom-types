...
1. Write the JSON schema describing your resource, `tf-google-storageobjectaccesscontrol.json`
2. Implement your resource handlers in `tf_google_storageobjectaccesscontrol/handlers.py`
