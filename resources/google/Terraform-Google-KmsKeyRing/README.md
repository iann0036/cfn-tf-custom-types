...
1. Write the JSON schema describing your resource, `terraform-google-kmskeyring.json`
2. Implement your resource handlers in `terraform_google_kmskeyring/handlers.py`
