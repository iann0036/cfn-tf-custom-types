...
1. Write the JSON schema describing your resource, `tf-google-computenodetemplate.json`
2. Implement your resource handlers in `tf_google_computenodetemplate/handlers.py`
