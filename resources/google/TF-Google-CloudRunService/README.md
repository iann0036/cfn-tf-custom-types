...
1. Write the JSON schema describing your resource, `tf-google-cloudrunservice.json`
2. Implement your resource handlers in `tf_google_cloudrunservice/handlers.py`
