...
1. Write the JSON schema describing your resource, `terraform-google-computesslcertificate.json`
2. Implement your resource handlers in `terraform_google_computesslcertificate/handlers.py`
