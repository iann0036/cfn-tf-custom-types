...
1. Write the JSON schema describing your resource, `terraform-google-projectorganizationpolicy.json`
2. Implement your resource handlers in `terraform_google_projectorganizationpolicy/handlers.py`
