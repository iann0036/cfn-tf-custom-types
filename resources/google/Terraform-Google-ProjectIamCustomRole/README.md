...
1. Write the JSON schema describing your resource, `terraform-google-projectiamcustomrole.json`
2. Implement your resource handlers in `terraform_google_projectiamcustomrole/handlers.py`
