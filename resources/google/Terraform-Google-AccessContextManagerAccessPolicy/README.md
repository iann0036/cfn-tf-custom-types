...
1. Write the JSON schema describing your resource, `terraform-google-accesscontextmanageraccesspolicy.json`
2. Implement your resource handlers in `terraform_google_accesscontextmanageraccesspolicy/handlers.py`
