...
1. Write the JSON schema describing your resource, `tf-google-containernodepool.json`
2. Implement your resource handlers in `tf_google_containernodepool/handlers.py`
