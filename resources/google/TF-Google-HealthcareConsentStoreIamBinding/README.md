...
1. Write the JSON schema describing your resource, `tf-google-healthcareconsentstoreiambinding.json`
2. Implement your resource handlers in `tf_google_healthcareconsentstoreiambinding/handlers.py`
