...
1. Write the JSON schema describing your resource, `tf-google-storagedefaultobjectacl.json`
2. Implement your resource handlers in `tf_google_storagedefaultobjectacl/handlers.py`
