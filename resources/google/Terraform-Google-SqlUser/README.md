...
1. Write the JSON schema describing your resource, `terraform-google-sqluser.json`
2. Implement your resource handlers in `terraform_google_sqluser/handlers.py`
