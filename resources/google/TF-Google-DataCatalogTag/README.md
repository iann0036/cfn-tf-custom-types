...
1. Write the JSON schema describing your resource, `tf-google-datacatalogtag.json`
2. Implement your resource handlers in `tf_google_datacatalogtag/handlers.py`
