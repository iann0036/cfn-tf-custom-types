...
TYPE_NAME = "TF::Google::HealthcareDicomStore"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Dataset=None, Id=None, Labels=None, Name=None, SelfLink=None, NotificationConfig=None, Timeouts=None)
