# TF::Google::OsLoginSshPublicKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-osloginsshpublickey.json`
2. Implement your resource handlers in `tf_google_osloginsshpublickey/handlers.py`
