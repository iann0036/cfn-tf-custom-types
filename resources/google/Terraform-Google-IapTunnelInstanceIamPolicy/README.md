# Terraform::Google::IapTunnelInstanceIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-iaptunnelinstanceiampolicy.json`
2. Implement your resource handlers in `terraform_google_iaptunnelinstanceiampolicy/handlers.py`
