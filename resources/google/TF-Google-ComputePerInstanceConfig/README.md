...
1. Write the JSON schema describing your resource, `tf-google-computeperinstanceconfig.json`
2. Implement your resource handlers in `tf_google_computeperinstanceconfig/handlers.py`
