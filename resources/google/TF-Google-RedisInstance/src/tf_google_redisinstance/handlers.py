...
TYPE_NAME = "TF::Google::RedisInstance"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["AuthString", "CreateTime", "CurrentLocationId", "Host", "Id", "PersistenceIamIdentity", "Port"],
            }).encode(),
        )
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AlternativeLocationId=None, AuthEnabled=None, AuthString=None, AuthorizedNetwork=None, ConnectMode=None, CreateTime=None, CurrentLocationId=None, DisplayName=None, Host=None, Id=None, Labels=None, LocationId=None, MemorySizeGb=None, Name=None, PersistenceIamIdentity=None, Port=None, Project=None, RedisConfigs=None, RedisVersion=None, Region=None, ReservedIpRange=None, Tier=None, Timeouts=None)
