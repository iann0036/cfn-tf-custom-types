# Terraform::Google::SpannerDatabaseIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-spannerdatabaseiampolicy.json`
2. Implement your resource handlers in `terraform_google_spannerdatabaseiampolicy/handlers.py`
