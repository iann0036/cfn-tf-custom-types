# TF::Google::IapTunnelInstanceIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-iaptunnelinstanceiampolicy.json`
2. Implement your resource handlers in `tf_google_iaptunnelinstanceiampolicy/handlers.py`
