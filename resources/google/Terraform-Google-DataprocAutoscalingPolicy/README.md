...
1. Write the JSON schema describing your resource, `terraform-google-dataprocautoscalingpolicy.json`
2. Implement your resource handlers in `terraform_google_dataprocautoscalingpolicy/handlers.py`
