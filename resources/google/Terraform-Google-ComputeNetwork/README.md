...
1. Write the JSON schema describing your resource, `terraform-google-computenetwork.json`
2. Implement your resource handlers in `terraform_google_computenetwork/handlers.py`
