...
TYPE_NAME = "TF::Google::ComputeRouter"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreationTimestamp=None, Description=None, Id=None, Name=None, Network=None, Project=None, Region=None, SelfLink=None, Bgp=None, Timeouts=None)
