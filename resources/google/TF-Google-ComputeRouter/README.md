# TF::Google::ComputeRouter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-computerouter.json`
2. Implement your resource handlers in `tf_google_computerouter/handlers.py`
