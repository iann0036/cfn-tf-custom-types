# Terraform::Google::SpannerInstanceIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-spannerinstanceiammember.json`
2. Implement your resource handlers in `terraform_google_spannerinstanceiammember/handlers.py`
