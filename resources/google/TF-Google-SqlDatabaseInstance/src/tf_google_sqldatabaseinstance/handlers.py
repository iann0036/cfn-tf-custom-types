...
TYPE_NAME = "TF::Google::SqlDatabaseInstance"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), ConnectionName=None, DatabaseVersion=None, DeletionProtection=None, FirstIpAddress=None, Id=None, IpAddress=None, MasterInstanceName=None, Name=None, PrivateIpAddress=None, Project=None, PublicIpAddress=None, Region=None, RootPassword=None, SelfLink=None, ServerCaCert=None, ServiceAccountEmailAddress=None, Clone=None, ReplicaConfiguration=None, RestoreBackupContext=None, Settings=None, Timeouts=None)
