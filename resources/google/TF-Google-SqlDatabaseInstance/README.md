...
1. Write the JSON schema describing your resource, `tf-google-sqldatabaseinstance.json`
2. Implement your resource handlers in `tf_google_sqldatabaseinstance/handlers.py`
