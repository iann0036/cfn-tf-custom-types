...
1. Write the JSON schema describing your resource, `terraform-google-dialogflowagent.json`
2. Implement your resource handlers in `terraform_google_dialogflowagent/handlers.py`
