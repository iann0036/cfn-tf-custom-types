...
1. Write the JSON schema describing your resource, `terraform-google-computeprojectmetadataitem.json`
2. Implement your resource handlers in `terraform_google_computeprojectmetadataitem/handlers.py`
