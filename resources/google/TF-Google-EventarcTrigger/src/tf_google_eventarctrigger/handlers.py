...
TYPE_NAME = "TF::Google::EventarcTrigger"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["CreateTime", "Etag", "Id", "Uid", "UpdateTime"],
            }).encode(),
        )
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreateTime=None, Etag=None, Id=None, Labels=None, Location=None, Name=None, Project=None, ServiceAccount=None, Uid=None, UpdateTime=None, Destination=None, MatchingCriteria=None, Timeouts=None, Transport=None)
