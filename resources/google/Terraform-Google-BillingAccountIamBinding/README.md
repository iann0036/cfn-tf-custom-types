...
1. Write the JSON schema describing your resource, `terraform-google-billingaccountiambinding.json`
2. Implement your resource handlers in `terraform_google_billingaccountiambinding/handlers.py`
