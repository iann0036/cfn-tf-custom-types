...
1. Write the JSON schema describing your resource, `tf-google-bigquerydataset.json`
2. Implement your resource handlers in `tf_google_bigquerydataset/handlers.py`
