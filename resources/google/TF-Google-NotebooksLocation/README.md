# TF::Google::NotebooksLocation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-google-notebookslocation.json`
2. Implement your resource handlers in `tf_google_notebookslocation/handlers.py`
