...
class ResourceModel(BaseModel):
    ...
    GenericWebService: Optional[Sequence["_GenericWebServiceDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            GenericWebService=deserialize_list(json_data.get("GenericWebService"), GenericWebServiceDefinition),
...
@dataclass
class GenericWebServiceDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_GenericWebServiceDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_GenericWebServiceDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_GenericWebServiceDefinition = GenericWebServiceDefinition
