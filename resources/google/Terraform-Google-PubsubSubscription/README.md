...
1. Write the JSON schema describing your resource, `terraform-google-pubsubsubscription.json`
2. Implement your resource handlers in `terraform_google_pubsubsubscription/handlers.py`
