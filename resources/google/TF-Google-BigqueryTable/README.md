...
1. Write the JSON schema describing your resource, `tf-google-bigquerytable.json`
2. Implement your resource handlers in `tf_google_bigquerytable/handlers.py`
