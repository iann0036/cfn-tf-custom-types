# Terraform::Google::IapWebTypeComputeIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-iapwebtypecomputeiambinding.json`
2. Implement your resource handlers in `terraform_google_iapwebtypecomputeiambinding/handlers.py`
