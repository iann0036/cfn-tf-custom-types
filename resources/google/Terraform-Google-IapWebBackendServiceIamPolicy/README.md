...
1. Write the JSON schema describing your resource, `terraform-google-iapwebbackendserviceiampolicy.json`
2. Implement your resource handlers in `terraform_google_iapwebbackendserviceiampolicy/handlers.py`
