...
1. Write the JSON schema describing your resource, `terraform-google-loggingorganizationsink.json`
2. Implement your resource handlers in `terraform_google_loggingorganizationsink/handlers.py`
