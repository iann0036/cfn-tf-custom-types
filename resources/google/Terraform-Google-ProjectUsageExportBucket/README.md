...
1. Write the JSON schema describing your resource, `terraform-google-projectusageexportbucket.json`
2. Implement your resource handlers in `terraform_google_projectusageexportbucket/handlers.py`
