# Terraform::Google::ServiceAccountIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-serviceaccountiammember.json`
2. Implement your resource handlers in `terraform_google_serviceaccountiammember/handlers.py`
