...
1. Write the JSON schema describing your resource, `tf-google-appenginedomainmapping.json`
2. Implement your resource handlers in `tf_google_appenginedomainmapping/handlers.py`
