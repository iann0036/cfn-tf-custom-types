...
1. Write the JSON schema describing your resource, `terraform-google-storagebucketacl.json`
2. Implement your resource handlers in `terraform_google_storagebucketacl/handlers.py`
