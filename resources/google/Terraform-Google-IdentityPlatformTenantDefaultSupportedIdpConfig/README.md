# Terraform::Google::IdentityPlatformTenantDefaultSupportedIdpConfig

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-google-identityplatformtenantdefaultsupportedidpconfig.json`
2. Implement your resource handlers in `terraform_google_identityplatformtenantdefaultsupportedidpconfig/handlers.py`
