...
1. Write the JSON schema describing your resource, `terraform-google-organizationiamauditconfig.json`
2. Implement your resource handlers in `terraform_google_organizationiamauditconfig/handlers.py`
