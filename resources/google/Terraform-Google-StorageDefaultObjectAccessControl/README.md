...
1. Write the JSON schema describing your resource, `terraform-google-storagedefaultobjectaccesscontrol.json`
2. Implement your resource handlers in `terraform_google_storagedefaultobjectaccesscontrol/handlers.py`
