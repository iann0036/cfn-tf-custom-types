...
1. Write the JSON schema describing your resource, `tf-google-dialogflowentitytype.json`
2. Implement your resource handlers in `tf_google_dialogflowentitytype/handlers.py`
