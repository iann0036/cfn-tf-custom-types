...
1. Write the JSON schema describing your resource, `terraform-google-computesecuritypolicy.json`
2. Implement your resource handlers in `terraform_google_computesecuritypolicy/handlers.py`
