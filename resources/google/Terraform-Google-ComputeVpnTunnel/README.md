...
1. Write the JSON schema describing your resource, `terraform-google-computevpntunnel.json`
2. Implement your resource handlers in `terraform_google_computevpntunnel/handlers.py`
