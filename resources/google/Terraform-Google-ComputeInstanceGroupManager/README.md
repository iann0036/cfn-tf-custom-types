...
1. Write the JSON schema describing your resource, `terraform-google-computeinstancegroupmanager.json`
2. Implement your resource handlers in `terraform_google_computeinstancegroupmanager/handlers.py`
