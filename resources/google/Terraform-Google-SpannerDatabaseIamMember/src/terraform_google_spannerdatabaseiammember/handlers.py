...
def create_handler(
    ...
    try:
        ...
        tf['resource']['google_spanner_database_iam_member'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['google_spanner_database_iam_member'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
