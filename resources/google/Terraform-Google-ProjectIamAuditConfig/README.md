...
1. Write the JSON schema describing your resource, `terraform-google-projectiamauditconfig.json`
2. Implement your resource handlers in `terraform_google_projectiamauditconfig/handlers.py`
