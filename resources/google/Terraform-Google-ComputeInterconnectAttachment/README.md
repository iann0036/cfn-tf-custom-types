...
1. Write the JSON schema describing your resource, `terraform-google-computeinterconnectattachment.json`
2. Implement your resource handlers in `terraform_google_computeinterconnectattachment/handlers.py`
