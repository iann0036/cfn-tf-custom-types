...
TYPE_NAME = "TF::Google::ComputeTargetInstance"
    ...
    try:
        ...
        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), CreationTimestamp=None, Description=None, Id=None, Instance=None, Name=None, NatPolicy=None, Project=None, SelfLink=None, Zone=None, Timeouts=None)
