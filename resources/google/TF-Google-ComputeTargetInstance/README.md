...
1. Write the JSON schema describing your resource, `tf-google-computetargetinstance.json`
2. Implement your resource handlers in `tf_google_computetargetinstance/handlers.py`
