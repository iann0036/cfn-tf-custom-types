...
1. Write the JSON schema describing your resource, `terraform-google-projectservice.json`
2. Implement your resource handlers in `terraform_google_projectservice/handlers.py`
