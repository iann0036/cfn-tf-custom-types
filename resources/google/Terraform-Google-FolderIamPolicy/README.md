...
1. Write the JSON schema describing your resource, `terraform-google-folderiampolicy.json`
2. Implement your resource handlers in `terraform_google_folderiampolicy/handlers.py`
