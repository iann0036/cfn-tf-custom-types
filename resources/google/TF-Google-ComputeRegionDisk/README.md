...
1. Write the JSON schema describing your resource, `tf-google-computeregiondisk.json`
2. Implement your resource handlers in `tf_google_computeregiondisk/handlers.py`
