...
1. Write the JSON schema describing your resource, `tf-google-cloudbuildtrigger.json`
2. Implement your resource handlers in `tf_google_cloudbuildtrigger/handlers.py`
