...
1. Write the JSON schema describing your resource, `terraform-google-appengineservicesplittraffic.json`
2. Implement your resource handlers in `terraform_google_appengineservicesplittraffic/handlers.py`
