...
1. Write the JSON schema describing your resource, `tf-google-computehttphealthcheck.json`
2. Implement your resource handlers in `tf_google_computehttphealthcheck/handlers.py`
