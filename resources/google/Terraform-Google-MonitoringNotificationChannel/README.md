...
1. Write the JSON schema describing your resource, `terraform-google-monitoringnotificationchannel.json`
2. Implement your resource handlers in `terraform_google_monitoringnotificationchannel/handlers.py`
