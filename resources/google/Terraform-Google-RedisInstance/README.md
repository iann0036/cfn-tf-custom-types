...
1. Write the JSON schema describing your resource, `terraform-google-redisinstance.json`
2. Implement your resource handlers in `terraform_google_redisinstance/handlers.py`
