...
1. Write the JSON schema describing your resource, `tf-google-monitoringslo.json`
2. Implement your resource handlers in `tf_google_monitoringslo/handlers.py`
