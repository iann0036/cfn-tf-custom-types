...
1. Write the JSON schema describing your resource, `terraform-google-computeregioninstancegroupmanager.json`
2. Implement your resource handlers in `terraform_google_computeregioninstancegroupmanager/handlers.py`
