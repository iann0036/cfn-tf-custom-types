...
1. Write the JSON schema describing your resource, `terraform-google-storagenotification.json`
2. Implement your resource handlers in `terraform_google_storagenotification/handlers.py`
