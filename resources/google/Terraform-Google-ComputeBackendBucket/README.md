...
1. Write the JSON schema describing your resource, `terraform-google-computebackendbucket.json`
2. Implement your resource handlers in `terraform_google_computebackendbucket/handlers.py`
