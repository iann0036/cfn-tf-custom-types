...
1. Write the JSON schema describing your resource, `terraform-google-computesubnetwork.json`
2. Implement your resource handlers in `terraform_google_computesubnetwork/handlers.py`
