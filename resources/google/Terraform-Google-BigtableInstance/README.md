...
1. Write the JSON schema describing your resource, `terraform-google-bigtableinstance.json`
2. Implement your resource handlers in `terraform_google_bigtableinstance/handlers.py`
