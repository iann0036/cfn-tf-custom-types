...
1. Write the JSON schema describing your resource, `terraform-google-loggingprojectexclusion.json`
2. Implement your resource handlers in `terraform_google_loggingprojectexclusion/handlers.py`
