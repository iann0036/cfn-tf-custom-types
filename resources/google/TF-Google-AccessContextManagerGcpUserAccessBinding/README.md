...
1. Write the JSON schema describing your resource, `tf-google-accesscontextmanagergcpuseraccessbinding.json`
2. Implement your resource handlers in `tf_google_accesscontextmanagergcpuseraccessbinding/handlers.py`
