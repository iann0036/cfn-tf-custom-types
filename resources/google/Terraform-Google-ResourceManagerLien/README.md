...
1. Write the JSON schema describing your resource, `terraform-google-resourcemanagerlien.json`
2. Implement your resource handlers in `terraform_google_resourcemanagerlien/handlers.py`
