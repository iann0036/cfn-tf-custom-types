...
1. Write the JSON schema describing your resource, `terraform-google-computehttpshealthcheck.json`
2. Implement your resource handlers in `terraform_google_computehttpshealthcheck/handlers.py`
