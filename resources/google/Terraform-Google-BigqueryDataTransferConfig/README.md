...
1. Write the JSON schema describing your resource, `terraform-google-bigquerydatatransferconfig.json`
2. Implement your resource handlers in `terraform_google_bigquerydatatransferconfig/handlers.py`
