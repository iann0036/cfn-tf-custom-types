...
1. Write the JSON schema describing your resource, `terraform-google-appenginedomainmapping.json`
2. Implement your resource handlers in `terraform_google_appenginedomainmapping/handlers.py`
