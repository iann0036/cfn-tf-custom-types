...
1. Write the JSON schema describing your resource, `tf-google-computehavpngateway.json`
2. Implement your resource handlers in `tf_google_computehavpngateway/handlers.py`
