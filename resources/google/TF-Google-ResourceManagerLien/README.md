...
1. Write the JSON schema describing your resource, `tf-google-resourcemanagerlien.json`
2. Implement your resource handlers in `tf_google_resourcemanagerlien/handlers.py`
