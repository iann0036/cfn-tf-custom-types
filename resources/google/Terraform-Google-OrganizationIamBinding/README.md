...
1. Write the JSON schema describing your resource, `terraform-google-organizationiambinding.json`
2. Implement your resource handlers in `terraform_google_organizationiambinding/handlers.py`
