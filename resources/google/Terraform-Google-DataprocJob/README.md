...
1. Write the JSON schema describing your resource, `terraform-google-dataprocjob.json`
2. Implement your resource handlers in `terraform_google_dataprocjob/handlers.py`
