...
1. Write the JSON schema describing your resource, `terraform-google-sourcereporepository.json`
2. Implement your resource handlers in `terraform_google_sourcereporepository/handlers.py`
