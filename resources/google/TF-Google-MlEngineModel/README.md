...
1. Write the JSON schema describing your resource, `tf-google-mlenginemodel.json`
2. Implement your resource handlers in `tf_google_mlenginemodel/handlers.py`
