...
1. Write the JSON schema describing your resource, `terraform-google-computesharedvpchostproject.json`
2. Implement your resource handlers in `terraform_google_computesharedvpchostproject/handlers.py`
