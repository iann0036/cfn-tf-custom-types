...
1. Write the JSON schema describing your resource, `tf-google-containeranalysisnote.json`
2. Implement your resource handlers in `tf_google_containeranalysisnote/handlers.py`
