...
1. Write the JSON schema describing your resource, `terraform-google-computefirewall.json`
2. Implement your resource handlers in `terraform_google_computefirewall/handlers.py`
