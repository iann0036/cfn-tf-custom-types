...
1. Write the JSON schema describing your resource, `terraform-google-spannerinstance.json`
2. Implement your resource handlers in `terraform_google_spannerinstance/handlers.py`
