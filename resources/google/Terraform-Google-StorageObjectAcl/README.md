...
1. Write the JSON schema describing your resource, `terraform-google-storageobjectacl.json`
2. Implement your resource handlers in `terraform_google_storageobjectacl/handlers.py`
