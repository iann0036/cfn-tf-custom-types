...
1. Write the JSON schema describing your resource, `tf-google-billingsubaccount.json`
2. Implement your resource handlers in `tf_google_billingsubaccount/handlers.py`
