...
1. Write the JSON schema describing your resource, `tf-google-monitoringnotificationchannel.json`
2. Implement your resource handlers in `tf_google_monitoringnotificationchannel/handlers.py`
