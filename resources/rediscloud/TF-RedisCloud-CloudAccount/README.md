...
1. Write the JSON schema describing your resource, `tf-rediscloud-cloudaccount.json`
2. Implement your resource handlers in `tf_rediscloud_cloudaccount/handlers.py`
