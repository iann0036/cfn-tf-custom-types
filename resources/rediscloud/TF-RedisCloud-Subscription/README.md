...
1. Write the JSON schema describing your resource, `tf-rediscloud-subscription.json`
2. Implement your resource handlers in `tf_rediscloud_subscription/handlers.py`
