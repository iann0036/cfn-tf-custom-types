...
1. Write the JSON schema describing your resource, `tf-rediscloud-subscriptionpeering.json`
2. Implement your resource handlers in `tf_rediscloud_subscriptionpeering/handlers.py`
