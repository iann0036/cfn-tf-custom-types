...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-policy.json`
2. Implement your resource handlers in `terraform_rabbitmq_policy/handlers.py`
