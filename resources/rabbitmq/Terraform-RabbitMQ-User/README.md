...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-user.json`
2. Implement your resource handlers in `terraform_rabbitmq_user/handlers.py`
