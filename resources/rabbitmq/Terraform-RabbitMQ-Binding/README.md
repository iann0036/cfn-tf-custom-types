...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-binding.json`
2. Implement your resource handlers in `terraform_rabbitmq_binding/handlers.py`
