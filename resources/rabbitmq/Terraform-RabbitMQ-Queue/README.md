...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-queue.json`
2. Implement your resource handlers in `terraform_rabbitmq_queue/handlers.py`
