...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-permissions.json`
2. Implement your resource handlers in `terraform_rabbitmq_permissions/handlers.py`
