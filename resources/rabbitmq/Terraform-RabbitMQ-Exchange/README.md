...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-exchange.json`
2. Implement your resource handlers in `terraform_rabbitmq_exchange/handlers.py`
