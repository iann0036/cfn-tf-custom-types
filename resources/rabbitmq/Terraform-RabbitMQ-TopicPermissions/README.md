# Terraform::RabbitMQ::TopicPermissions

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-rabbitmq-topicpermissions.json`
2. Implement your resource handlers in `terraform_rabbitmq_topicpermissions/handlers.py`
