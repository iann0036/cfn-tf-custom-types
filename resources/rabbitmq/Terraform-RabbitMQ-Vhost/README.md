...
1. Write the JSON schema describing your resource, `terraform-rabbitmq-vhost.json`
2. Implement your resource handlers in `terraform_rabbitmq_vhost/handlers.py`
