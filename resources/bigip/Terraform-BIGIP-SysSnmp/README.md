...
1. Write the JSON schema describing your resource, `terraform-bigip-syssnmp.json`
2. Implement your resource handlers in `terraform_bigip_syssnmp/handlers.py`
