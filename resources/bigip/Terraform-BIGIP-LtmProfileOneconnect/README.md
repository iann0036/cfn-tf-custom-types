...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofileoneconnect.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofileoneconnect/handlers.py`
