...
1. Write the JSON schema describing your resource, `terraform-bigip-netroute.json`
2. Implement your resource handlers in `terraform_bigip_netroute/handlers.py`
