# TF::BIGIP::LtmPersistenceProfileDstaddr

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-bigip-ltmpersistenceprofiledstaddr.json`
2. Implement your resource handlers in `tf_bigip_ltmpersistenceprofiledstaddr/handlers.py`
