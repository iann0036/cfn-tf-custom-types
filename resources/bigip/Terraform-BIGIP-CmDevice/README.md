...
1. Write the JSON schema describing your resource, `terraform-bigip-cmdevice.json`
2. Implement your resource handlers in `terraform_bigip_cmdevice/handlers.py`
