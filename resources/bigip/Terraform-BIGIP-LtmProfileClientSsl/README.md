...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofileclientssl.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofileclientssl/handlers.py`
