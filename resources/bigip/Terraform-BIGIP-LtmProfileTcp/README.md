...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofiletcp.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofiletcp/handlers.py`
