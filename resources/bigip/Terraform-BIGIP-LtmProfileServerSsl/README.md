...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofileserverssl.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofileserverssl/handlers.py`
