...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmvirtualserver.json`
2. Implement your resource handlers in `terraform_bigip_ltmvirtualserver/handlers.py`
