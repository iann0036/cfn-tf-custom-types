...
1. Write the JSON schema describing your resource, `terraform-bigip-netselfip.json`
2. Implement your resource handlers in `terraform_bigip_netselfip/handlers.py`
