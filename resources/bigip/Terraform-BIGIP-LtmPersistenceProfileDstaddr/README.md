...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpersistenceprofiledstaddr.json`
2. Implement your resource handlers in `terraform_bigip_ltmpersistenceprofiledstaddr/handlers.py`
