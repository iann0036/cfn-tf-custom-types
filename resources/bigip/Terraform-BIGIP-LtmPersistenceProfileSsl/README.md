...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpersistenceprofilessl.json`
2. Implement your resource handlers in `terraform_bigip_ltmpersistenceprofilessl/handlers.py`
