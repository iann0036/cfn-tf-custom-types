...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmnode.json`
2. Implement your resource handlers in `terraform_bigip_ltmnode/handlers.py`
