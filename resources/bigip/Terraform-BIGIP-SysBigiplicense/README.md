# Terraform::BIGIP::SysBigiplicense

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-bigip-sysbigiplicense.json`
2. Implement your resource handlers in `terraform_bigip_sysbigiplicense/handlers.py`
