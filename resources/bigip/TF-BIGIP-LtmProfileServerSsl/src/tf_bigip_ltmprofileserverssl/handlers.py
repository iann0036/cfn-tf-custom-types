...
TYPE_NAME = "TF::BIGIP::LtmProfileServerSsl"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/bigip_ltm_profile_server_ssl/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/bigip_ltm_profile_server_ssl/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/bigip_ltm_profile_server_ssl/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AlertTimeout=None, Authenticate=None, AuthenticateDepth=None, C3dCaCert=None, C3dCaKey=None, C3dCaPassphrase=None, C3dCertExtensionCustomOids=None, C3dCertExtensionIncludes=None, C3dCertLifespan=None, C3dCertificateExtensions=None, CaFile=None, CacheSize=None, CacheTimeout=None, Cert=None, Chain=None, Ciphers=None, DefaultsFrom=None, ExpireCertResponseControl=None, FullPath=None, Generation=None, GenericAlert=None, HandshakeTimeout=None, Id=None, Key=None, ModSslMethods=None, Mode=None, Name=None, Partition=None, Passphrase=None, PeerCertMode=None, ProxyCaCert=None, ProxyCaKey=None, ProxySsl=None, RenegotiatePeriod=None, RenegotiateSize=None, Renegotiation=None, RetainCertificate=None, SecureRenegotiation=None, ServerName=None, SessionMirroring=None, SessionTicket=None, SniDefault=None, SniRequire=None, SslC3d=None, SslForwardProxy=None, SslForwardProxyBypass=None, SslSignHash=None, StrictResume=None, TmOptions=None, UncleanShutdown=None, UntrustedCertResponseControl=None)
