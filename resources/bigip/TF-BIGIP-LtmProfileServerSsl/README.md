...
1. Write the JSON schema describing your resource, `tf-bigip-ltmprofileserverssl.json`
2. Implement your resource handlers in `tf_bigip_ltmprofileserverssl/handlers.py`
