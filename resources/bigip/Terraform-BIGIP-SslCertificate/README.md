...
1. Write the JSON schema describing your resource, `terraform-bigip-sslcertificate.json`
2. Implement your resource handlers in `terraform_bigip_sslcertificate/handlers.py`
