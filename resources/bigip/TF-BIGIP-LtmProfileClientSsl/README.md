...
1. Write the JSON schema describing your resource, `tf-bigip-ltmprofileclientssl.json`
2. Implement your resource handlers in `tf_bigip_ltmprofileclientssl/handlers.py`
