...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpool.json`
2. Implement your resource handlers in `terraform_bigip_ltmpool/handlers.py`
