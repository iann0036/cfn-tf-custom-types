...
1. Write the JSON schema describing your resource, `terraform-bigip-cmdevicegroup.json`
2. Implement your resource handlers in `terraform_bigip_cmdevicegroup/handlers.py`
