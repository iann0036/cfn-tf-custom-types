...
1. Write the JSON schema describing your resource, `terraform-bigip-netvlan.json`
2. Implement your resource handlers in `terraform_bigip_netvlan/handlers.py`
