...
1. Write the JSON schema describing your resource, `tf-bigip-ltmpoolattachment.json`
2. Implement your resource handlers in `tf_bigip_ltmpoolattachment/handlers.py`
