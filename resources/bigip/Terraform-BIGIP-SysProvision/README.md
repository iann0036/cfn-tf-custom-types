...
1. Write the JSON schema describing your resource, `terraform-bigip-sysprovision.json`
2. Implement your resource handlers in `terraform_bigip_sysprovision/handlers.py`
