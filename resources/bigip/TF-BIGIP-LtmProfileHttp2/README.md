...
1. Write the JSON schema describing your resource, `tf-bigip-ltmprofilehttp2.json`
2. Implement your resource handlers in `tf_bigip_ltmprofilehttp2/handlers.py`
