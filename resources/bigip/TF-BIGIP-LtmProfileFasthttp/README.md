...
1. Write the JSON schema describing your resource, `tf-bigip-ltmprofilefasthttp.json`
2. Implement your resource handlers in `tf_bigip_ltmprofilefasthttp/handlers.py`
