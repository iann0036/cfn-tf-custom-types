...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpersistenceprofilesrcaddr.json`
2. Implement your resource handlers in `terraform_bigip_ltmpersistenceprofilesrcaddr/handlers.py`
