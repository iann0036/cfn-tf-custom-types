...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpolicy.json`
2. Implement your resource handlers in `terraform_bigip_ltmpolicy/handlers.py`
