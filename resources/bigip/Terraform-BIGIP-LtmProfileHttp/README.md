...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofilehttp.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofilehttp/handlers.py`
