...
1. Write the JSON schema describing your resource, `tf-bigip-eventservicediscovery.json`
2. Implement your resource handlers in `tf_bigip_eventservicediscovery/handlers.py`
