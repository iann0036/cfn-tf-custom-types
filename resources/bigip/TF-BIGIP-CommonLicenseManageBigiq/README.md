...
1. Write the JSON schema describing your resource, `tf-bigip-commonlicensemanagebigiq.json`
2. Implement your resource handlers in `tf_bigip_commonlicensemanagebigiq/handlers.py`
