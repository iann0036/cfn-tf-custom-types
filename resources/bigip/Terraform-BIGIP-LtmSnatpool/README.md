...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmsnatpool.json`
2. Implement your resource handlers in `terraform_bigip_ltmsnatpool/handlers.py`
