...
1. Write the JSON schema describing your resource, `tf-bigip-trafficselector.json`
2. Implement your resource handlers in `tf_bigip_trafficselector/handlers.py`
