...
1. Write the JSON schema describing your resource, `tf-bigip-ltmvirtualaddress.json`
2. Implement your resource handlers in `tf_bigip_ltmvirtualaddress/handlers.py`
