...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofilefasthttp.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofilefasthttp/handlers.py`
