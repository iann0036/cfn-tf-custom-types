...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmvirtualaddress.json`
2. Implement your resource handlers in `terraform_bigip_ltmvirtualaddress/handlers.py`
