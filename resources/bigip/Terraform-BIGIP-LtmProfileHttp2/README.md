...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofilehttp2.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofilehttp2/handlers.py`
