...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofilefastl4.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofilefastl4/handlers.py`
