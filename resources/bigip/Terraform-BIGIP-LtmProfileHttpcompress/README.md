...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmprofilehttpcompress.json`
2. Implement your resource handlers in `terraform_bigip_ltmprofilehttpcompress/handlers.py`
