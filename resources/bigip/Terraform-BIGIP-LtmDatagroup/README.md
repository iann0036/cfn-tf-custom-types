...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmdatagroup.json`
2. Implement your resource handlers in `terraform_bigip_ltmdatagroup/handlers.py`
