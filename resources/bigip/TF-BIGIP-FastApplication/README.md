...
1. Write the JSON schema describing your resource, `tf-bigip-fastapplication.json`
2. Implement your resource handlers in `tf_bigip_fastapplication/handlers.py`
