...
1. Write the JSON schema describing your resource, `terraform-bigip-syssnmptraps.json`
2. Implement your resource handlers in `terraform_bigip_syssnmptraps/handlers.py`
