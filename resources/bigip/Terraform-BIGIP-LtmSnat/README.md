...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmsnat.json`
2. Implement your resource handlers in `terraform_bigip_ltmsnat/handlers.py`
