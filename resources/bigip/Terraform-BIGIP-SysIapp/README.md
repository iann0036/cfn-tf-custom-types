...
1. Write the JSON schema describing your resource, `terraform-bigip-sysiapp.json`
2. Implement your resource handlers in `terraform_bigip_sysiapp/handlers.py`
