...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpoolattachment.json`
2. Implement your resource handlers in `terraform_bigip_ltmpoolattachment/handlers.py`
