...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmmonitor.json`
2. Implement your resource handlers in `terraform_bigip_ltmmonitor/handlers.py`
