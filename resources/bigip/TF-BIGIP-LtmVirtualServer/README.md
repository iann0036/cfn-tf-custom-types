# TF::BIGIP::LtmVirtualServer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-bigip-ltmvirtualserver.json`
2. Implement your resource handlers in `tf_bigip_ltmvirtualserver/handlers.py`
