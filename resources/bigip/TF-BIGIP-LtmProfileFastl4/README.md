# TF::BIGIP::LtmProfileFastl4

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-bigip-ltmprofilefastl4.json`
2. Implement your resource handlers in `tf_bigip_ltmprofilefastl4/handlers.py`
