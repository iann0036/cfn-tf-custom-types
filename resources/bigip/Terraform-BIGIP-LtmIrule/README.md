...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmirule.json`
2. Implement your resource handlers in `terraform_bigip_ltmirule/handlers.py`
