...
1. Write the JSON schema describing your resource, `terraform-bigip-ltmpersistenceprofilecookie.json`
2. Implement your resource handlers in `terraform_bigip_ltmpersistenceprofilecookie/handlers.py`
