# TF::BIGIP::LtmProfileOneconnect

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-bigip-ltmprofileoneconnect.json`
2. Implement your resource handlers in `tf_bigip_ltmprofileoneconnect/handlers.py`
