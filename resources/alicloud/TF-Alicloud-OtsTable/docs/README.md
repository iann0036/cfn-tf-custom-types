...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#primarykey" title="PrimaryKey">PrimaryKey</a>" : <i>[ <a href="primarykeydefinition.md">PrimaryKeyDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#primarykey" title="PrimaryKey">PrimaryKey</a>: <i>
      - <a href="primarykeydefinition.md">PrimaryKeyDefinition</a></i>
</pre>
...
_Type_: List of <a href="primarykeydefinition.md">PrimaryKeyDefinition</a>
