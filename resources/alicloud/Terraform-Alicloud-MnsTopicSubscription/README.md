...
1. Write the JSON schema describing your resource, `terraform-alicloud-mnstopicsubscription.json`
2. Implement your resource handlers in `terraform_alicloud_mnstopicsubscription/handlers.py`
