...
1. Write the JSON schema describing your resource, `tf-alicloud-kvstoreinstance.json`
2. Implement your resource handlers in `tf_alicloud_kvstoreinstance/handlers.py`
