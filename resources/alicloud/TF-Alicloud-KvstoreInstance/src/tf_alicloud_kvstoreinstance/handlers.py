...
TYPE_NAME = "TF::Alicloud::KvstoreInstance"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/alicloud_kvstore_instance/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Bandwidth", "ConnectionDomain", "ConnectionString", "EndTime", "Id", "Qps", "Status"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/alicloud_kvstore_instance/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/alicloud_kvstore_instance/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AutoRenew=None, AutoRenewPeriod=None, AutoUseCoupon=None, AvailabilityZone=None, BackupId=None, BackupPeriod=None, BackupTime=None, Bandwidth=None, BusinessInfo=None, Capacity=None, Config=None, ConnectionDomain=None, ConnectionString=None, ConnectionStringPrefix=None, CouponNo=None, DbInstanceName=None, DedicatedHostGroupId=None, EnableBackupLog=None, EnablePublic=None, EndTime=None, EngineVersion=None, ForceUpgrade=None, GlobalInstance=None, GlobalInstanceId=None, Id=None, InstanceChargeType=None, InstanceClass=None, InstanceName=None, InstanceReleaseProtection=None, InstanceType=None, KmsEncryptedPassword=None, KmsEncryptionContext=None, MaintainEndTime=None, MaintainStartTime=None, ModifyMode=None, NodeType=None, OrderType=None, Password=None, PaymentType=None, Period=None, Port=None, PrivateConnectionPort=None, PrivateConnectionPrefix=None, PrivateIp=None, Qps=None, ResourceGroupId=None, RestoreTime=None, SecurityGroupId=None, SecurityIpGroupAttribute=None, SecurityIpGroupName=None, SecurityIps=None, SrcdbInstanceId=None, SslEnable=None, Status=None, Tags=None, VpcAuthMode=None, VswitchId=None, ZoneId=None, Parameters=None, Timeouts=None)
