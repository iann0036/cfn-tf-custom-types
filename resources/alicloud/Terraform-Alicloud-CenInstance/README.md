...
1. Write the JSON schema describing your resource, `terraform-alicloud-ceninstance.json`
2. Implement your resource handlers in `terraform_alicloud_ceninstance/handlers.py`
