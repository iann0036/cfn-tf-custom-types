...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagclientuser.json`
2. Implement your resource handlers in `terraform_alicloud_sagclientuser/handlers.py`
