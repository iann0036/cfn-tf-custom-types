# TF::Alicloud::AlikafkaInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-alikafkainstance.json`
2. Implement your resource handlers in `tf_alicloud_alikafkainstance/handlers.py`
