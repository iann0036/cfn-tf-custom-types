...
1. Write the JSON schema describing your resource, `terraform-alicloud-cloudconnectnetworkgrant.json`
2. Implement your resource handlers in `terraform_alicloud_cloudconnectnetworkgrant/handlers.py`
