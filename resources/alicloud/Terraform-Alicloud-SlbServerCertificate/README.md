...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbservercertificate.json`
2. Implement your resource handlers in `terraform_alicloud_slbservercertificate/handlers.py`
