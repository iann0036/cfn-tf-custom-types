...
1. Write the JSON schema describing your resource, `terraform-alicloud-logtailconfig.json`
2. Implement your resource handlers in `terraform_alicloud_logtailconfig/handlers.py`
