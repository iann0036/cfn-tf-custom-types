...
1. Write the JSON schema describing your resource, `terraform-alicloud-commonbandwidthpackageattachment.json`
2. Implement your resource handlers in `terraform_alicloud_commonbandwidthpackageattachment/handlers.py`
