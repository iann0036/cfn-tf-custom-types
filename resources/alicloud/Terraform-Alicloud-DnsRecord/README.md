...
1. Write the JSON schema describing your resource, `terraform-alicloud-dnsrecord.json`
2. Implement your resource handlers in `terraform_alicloud_dnsrecord/handlers.py`
