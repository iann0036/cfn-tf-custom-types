...
1. Write the JSON schema describing your resource, `tf-alicloud-gaendpointgroup.json`
2. Implement your resource handlers in `tf_alicloud_gaendpointgroup/handlers.py`
