...
1. Write the JSON schema describing your resource, `terraform-alicloud-kvstoreinstance.json`
2. Implement your resource handlers in `terraform_alicloud_kvstoreinstance/handlers.py`
