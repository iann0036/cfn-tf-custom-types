...
def create_handler(
    ...
    try:
        ...
        tf['resource']['alicloud_slb_server_group'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['alicloud_slb_server_group'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
