...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbservergroup.json`
2. Implement your resource handlers in `terraform_alicloud_slbservergroup/handlers.py`
