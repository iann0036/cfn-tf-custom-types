...
1. Write the JSON schema describing your resource, `terraform-alicloud-networkaclentries.json`
2. Implement your resource handlers in `terraform_alicloud_networkaclentries/handlers.py`
