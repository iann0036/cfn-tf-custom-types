# TF::Alicloud::KvstoreConnection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-kvstoreconnection.json`
2. Implement your resource handlers in `tf_alicloud_kvstoreconnection/handlers.py`
