...
1. Write the JSON schema describing your resource, `tf-alicloud-dmsenterpriseuser.json`
2. Implement your resource handlers in `tf_alicloud_dmsenterpriseuser/handlers.py`
