...
1. Write the JSON schema describing your resource, `tf-alicloud-slbcacertificate.json`
2. Implement your resource handlers in `tf_alicloud_slbcacertificate/handlers.py`
