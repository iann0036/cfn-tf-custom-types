...
1. Write the JSON schema describing your resource, `tf-alicloud-routerinterfaceconnection.json`
2. Implement your resource handlers in `tf_alicloud_routerinterfaceconnection/handlers.py`
