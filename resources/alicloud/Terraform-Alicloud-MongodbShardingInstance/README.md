...
1. Write the JSON schema describing your resource, `terraform-alicloud-mongodbshardinginstance.json`
2. Implement your resource handlers in `terraform_alicloud_mongodbshardinginstance/handlers.py`
