...
1. Write the JSON schema describing your resource, `tf-alicloud-apigatewayappattachment.json`
2. Implement your resource handlers in `tf_alicloud_apigatewayappattachment/handlers.py`
