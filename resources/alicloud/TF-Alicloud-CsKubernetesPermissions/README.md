...
1. Write the JSON schema describing your resource, `tf-alicloud-cskubernetespermissions.json`
2. Implement your resource handlers in `tf_alicloud_cskubernetespermissions/handlers.py`
