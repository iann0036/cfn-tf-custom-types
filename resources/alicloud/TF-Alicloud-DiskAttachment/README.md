...
1. Write the JSON schema describing your resource, `tf-alicloud-diskattachment.json`
2. Implement your resource handlers in `tf_alicloud_diskattachment/handlers.py`
