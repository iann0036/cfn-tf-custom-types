...
1. Write the JSON schema describing your resource, `terraform-alicloud-cskubernetesautoscaler.json`
2. Implement your resource handlers in `terraform_alicloud_cskubernetesautoscaler/handlers.py`
