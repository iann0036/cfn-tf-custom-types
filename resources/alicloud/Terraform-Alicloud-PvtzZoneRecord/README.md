...
1. Write the JSON schema describing your resource, `terraform-alicloud-pvtzzonerecord.json`
2. Implement your resource handlers in `terraform_alicloud_pvtzzonerecord/handlers.py`
