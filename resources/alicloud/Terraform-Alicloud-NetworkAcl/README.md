...
1. Write the JSON schema describing your resource, `terraform-alicloud-networkacl.json`
2. Implement your resource handlers in `terraform_alicloud_networkacl/handlers.py`
