...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramaccountalias.json`
2. Implement your resource handlers in `terraform_alicloud_ramaccountalias/handlers.py`
