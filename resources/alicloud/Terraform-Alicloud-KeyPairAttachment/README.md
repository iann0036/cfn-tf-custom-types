...
1. Write the JSON schema describing your resource, `terraform-alicloud-keypairattachment.json`
2. Implement your resource handlers in `terraform_alicloud_keypairattachment/handlers.py`
