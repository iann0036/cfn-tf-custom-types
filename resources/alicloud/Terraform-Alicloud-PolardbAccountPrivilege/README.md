...
1. Write the JSON schema describing your resource, `terraform-alicloud-polardbaccountprivilege.json`
2. Implement your resource handlers in `terraform_alicloud_polardbaccountprivilege/handlers.py`
