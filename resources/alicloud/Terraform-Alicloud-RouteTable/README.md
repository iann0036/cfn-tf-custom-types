...
1. Write the JSON schema describing your resource, `terraform-alicloud-routetable.json`
2. Implement your resource handlers in `terraform_alicloud_routetable/handlers.py`
