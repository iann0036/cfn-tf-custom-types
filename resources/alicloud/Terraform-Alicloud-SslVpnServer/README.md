...
1. Write the JSON schema describing your resource, `terraform-alicloud-sslvpnserver.json`
2. Implement your resource handlers in `terraform_alicloud_sslvpnserver/handlers.py`
