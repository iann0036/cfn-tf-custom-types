...
1. Write the JSON schema describing your resource, `terraform-alicloud-rampolicy.json`
2. Implement your resource handlers in `terraform_alicloud_rampolicy/handlers.py`
