...
1. Write the JSON schema describing your resource, `terraform-alicloud-onstopic.json`
2. Implement your resource handlers in `terraform_alicloud_onstopic/handlers.py`
