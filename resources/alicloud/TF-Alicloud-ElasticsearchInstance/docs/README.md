# TF::Alicloud::ElasticsearchInstance
...
<pre>
{
    "Type" : "TF::Alicloud::ElasticsearchInstance",
    "Properties" : {
        "<a href="#clientnodeamount" title="ClientNodeAmount">ClientNodeAmount</a>" : <i>Double</i>,
        "<a href="#clientnodespec" title="ClientNodeSpec">ClientNodeSpec</a>" : <i>String</i>,
        "<a href="#datanodeamount" title="DataNodeAmount">DataNodeAmount</a>" : <i>Double</i>,
        "<a href="#datanodediskencrypted" title="DataNodeDiskEncrypted">DataNodeDiskEncrypted</a>" : <i>Boolean</i>,
        ...
        "<a href="#enablekibanaprivatenetwork" title="EnableKibanaPrivateNetwork">EnableKibanaPrivateNetwork</a>" : <i>Boolean</i>,
        "<a href="#enablekibanapublicnetwork" title="EnableKibanaPublicNetwork">EnableKibanaPublicNetwork</a>" : <i>Boolean</i>,
        ...
        "<a href="#kibanaprivatewhitelist" title="KibanaPrivateWhitelist">KibanaPrivateWhitelist</a>" : <i>[ String, ... ]</i>,
...
Properties:
    ...
    <a href="#enablepublic" title="EnablePublic">EnablePublic</a>: <i>Boolean</i>
    <a href="#instancechargetype" title="InstanceChargeType">InstanceChargeType</a>: <i>String</i>
    <a href="#kibanaprivatewhitelist" title="KibanaPrivateWhitelist">KibanaPrivateWhitelist</a>: <i>
      - String</i>
