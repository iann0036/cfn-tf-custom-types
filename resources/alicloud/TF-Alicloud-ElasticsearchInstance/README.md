...
1. Write the JSON schema describing your resource, `tf-alicloud-elasticsearchinstance.json`
2. Implement your resource handlers in `tf_alicloud_elasticsearchinstance/handlers.py`
