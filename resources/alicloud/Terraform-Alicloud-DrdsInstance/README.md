...
1. Write the JSON schema describing your resource, `terraform-alicloud-drdsinstance.json`
2. Implement your resource handlers in `terraform_alicloud_drdsinstance/handlers.py`
