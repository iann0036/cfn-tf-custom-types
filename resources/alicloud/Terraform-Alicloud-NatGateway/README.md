...
1. Write the JSON schema describing your resource, `terraform-alicloud-natgateway.json`
2. Implement your resource handlers in `terraform_alicloud_natgateway/handlers.py`
