...
1. Write the JSON schema describing your resource, `terraform-alicloud-yundunbastionhostinstance.json`
2. Implement your resource handlers in `terraform_alicloud_yundunbastionhostinstance/handlers.py`
