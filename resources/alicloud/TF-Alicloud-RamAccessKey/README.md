# TF::Alicloud::RamAccessKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-ramaccesskey.json`
2. Implement your resource handlers in `tf_alicloud_ramaccesskey/handlers.py`
