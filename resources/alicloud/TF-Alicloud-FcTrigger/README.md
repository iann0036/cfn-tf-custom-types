# TF::Alicloud::FcTrigger

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-fctrigger.json`
2. Implement your resource handlers in `tf_alicloud_fctrigger/handlers.py`
