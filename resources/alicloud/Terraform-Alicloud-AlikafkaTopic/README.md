...
1. Write the JSON schema describing your resource, `terraform-alicloud-alikafkatopic.json`
2. Implement your resource handlers in `terraform_alicloud_alikafkatopic/handlers.py`
