# TF::Alicloud::OnsInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-onsinstance.json`
2. Implement your resource handlers in `tf_alicloud_onsinstance/handlers.py`
