...
1. Write the JSON schema describing your resource, `terraform-alicloud-logproject.json`
2. Implement your resource handlers in `terraform_alicloud_logproject/handlers.py`
