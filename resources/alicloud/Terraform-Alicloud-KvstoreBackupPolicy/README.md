...
1. Write the JSON schema describing your resource, `terraform-alicloud-kvstorebackuppolicy.json`
2. Implement your resource handlers in `terraform_alicloud_kvstorebackuppolicy/handlers.py`
