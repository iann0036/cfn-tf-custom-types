...
1. Write the JSON schema describing your resource, `tf-alicloud-cmsmonitorgroupinstances.json`
2. Implement your resource handlers in `tf_alicloud_cmsmonitorgroupinstances/handlers.py`
