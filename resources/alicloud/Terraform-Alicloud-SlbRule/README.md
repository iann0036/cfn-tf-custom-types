...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbrule.json`
2. Implement your resource handlers in `terraform_alicloud_slbrule/handlers.py`
