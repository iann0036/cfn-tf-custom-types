...
1. Write the JSON schema describing your resource, `terraform-alicloud-alikafkainstance.json`
2. Implement your resource handlers in `terraform_alicloud_alikafkainstance/handlers.py`
