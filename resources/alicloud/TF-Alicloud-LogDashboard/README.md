...
1. Write the JSON schema describing your resource, `tf-alicloud-logdashboard.json`
2. Implement your resource handlers in `tf_alicloud_logdashboard/handlers.py`
