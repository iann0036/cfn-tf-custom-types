...
1. Write the JSON schema describing your resource, `terraform-alicloud-vpnconnection.json`
2. Implement your resource handlers in `terraform_alicloud_vpnconnection/handlers.py`
