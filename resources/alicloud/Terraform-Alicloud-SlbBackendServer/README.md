...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbbackendserver.json`
2. Implement your resource handlers in `terraform_alicloud_slbbackendserver/handlers.py`
