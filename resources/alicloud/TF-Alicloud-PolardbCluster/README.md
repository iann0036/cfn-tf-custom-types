...
1. Write the JSON schema describing your resource, `tf-alicloud-polardbcluster.json`
2. Implement your resource handlers in `tf_alicloud_polardbcluster/handlers.py`
