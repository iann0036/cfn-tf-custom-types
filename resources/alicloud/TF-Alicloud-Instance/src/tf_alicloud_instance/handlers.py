...
TYPE_NAME = "TF::Alicloud::Instance"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/alicloud_instance/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/alicloud_instance/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/alicloud_instance/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AllocatePublicIp=None, AutoReleaseTime=None, AutoRenewPeriod=None, AvailabilityZone=None, CreditSpecification=None, DeletionProtection=None, Description=None, DryRun=None, ForceDelete=None, HostName=None, Id=None, ImageId=None, IncludeDataDisks=None, InstanceChargeType=None, InstanceName=None, InstanceType=None, InternetChargeType=None, InternetMaxBandwidthIn=None, InternetMaxBandwidthOut=None, IoOptimized=None, IsOutdated=None, KeyName=None, KmsEncryptedPassword=None, KmsEncryptionContext=None, Password=None, Period=None, PeriodUnit=None, PrivateIp=None, PublicIp=None, RenewalStatus=None, ResourceGroupId=None, RoleName=None, SecurityEnhancementStrategy=None, SecurityGroups=None, SpotPriceLimit=None, SpotStrategy=None, Status=None, SubnetId=None, SystemDiskAutoSnapshotPolicyId=None, SystemDiskCategory=None, SystemDiskDescription=None, SystemDiskName=None, SystemDiskPerformanceLevel=None, SystemDiskSize=None, Tags=None, UserData=None, VolumeTags=None, VswitchId=None, DataDisks=None, Timeouts=None)
