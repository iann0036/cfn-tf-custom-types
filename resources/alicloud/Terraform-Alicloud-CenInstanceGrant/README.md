...
1. Write the JSON schema describing your resource, `terraform-alicloud-ceninstancegrant.json`
2. Implement your resource handlers in `terraform_alicloud_ceninstancegrant/handlers.py`
