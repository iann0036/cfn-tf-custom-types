...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerrole.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerrole/handlers.py`
