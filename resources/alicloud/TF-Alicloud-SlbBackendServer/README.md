...
1. Write the JSON schema describing your resource, `tf-alicloud-slbbackendserver.json`
2. Implement your resource handlers in `tf_alicloud_slbbackendserver/handlers.py`
