...
1. Write the JSON schema describing your resource, `terraform-alicloud-commonbandwidthpackage.json`
2. Implement your resource handlers in `terraform_alicloud_commonbandwidthpackage/handlers.py`
