...
1. Write the JSON schema describing your resource, `tf-alicloud-ecsnetworkinterface.json`
2. Implement your resource handlers in `tf_alicloud_ecsnetworkinterface/handlers.py`
