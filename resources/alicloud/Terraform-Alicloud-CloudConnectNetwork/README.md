# Terraform::Alicloud::CloudConnectNetwork

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-alicloud-cloudconnectnetwork.json`
2. Implement your resource handlers in `terraform_alicloud_cloudconnectnetwork/handlers.py`
