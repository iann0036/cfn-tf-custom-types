...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramrole.json`
2. Implement your resource handlers in `terraform_alicloud_ramrole/handlers.py`
