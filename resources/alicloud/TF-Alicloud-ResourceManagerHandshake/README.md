...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerhandshake.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerhandshake/handlers.py`
