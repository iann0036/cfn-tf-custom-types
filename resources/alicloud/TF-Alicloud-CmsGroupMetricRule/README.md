...
1. Write the JSON schema describing your resource, `tf-alicloud-cmsgroupmetricrule.json`
2. Implement your resource handlers in `tf_alicloud_cmsgroupmetricrule/handlers.py`
