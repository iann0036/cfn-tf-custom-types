...
1. Write the JSON schema describing your resource, `terraform-alicloud-polardbaccount.json`
2. Implement your resource handlers in `terraform_alicloud_polardbaccount/handlers.py`
