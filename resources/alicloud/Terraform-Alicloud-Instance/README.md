...
1. Write the JSON schema describing your resource, `terraform-alicloud-instance.json`
2. Implement your resource handlers in `terraform_alicloud_instance/handlers.py`
