...
1. Write the JSON schema describing your resource, `terraform-alicloud-essscalingrule.json`
2. Implement your resource handlers in `terraform_alicloud_essscalingrule/handlers.py`
