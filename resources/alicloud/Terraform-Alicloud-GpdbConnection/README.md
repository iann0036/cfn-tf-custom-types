...
1. Write the JSON schema describing your resource, `terraform-alicloud-gpdbconnection.json`
2. Implement your resource handlers in `terraform_alicloud_gpdbconnection/handlers.py`
