...
1. Write the JSON schema describing your resource, `tf-alicloud-ddoscooschedulerrule.json`
2. Implement your resource handlers in `tf_alicloud_ddoscooschedulerrule/handlers.py`
