...
1. Write the JSON schema describing your resource, `tf-alicloud-ecsautosnapshotpolicy.json`
2. Implement your resource handlers in `tf_alicloud_ecsautosnapshotpolicy/handlers.py`
