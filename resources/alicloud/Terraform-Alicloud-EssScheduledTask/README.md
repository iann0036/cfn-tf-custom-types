...
1. Write the JSON schema describing your resource, `terraform-alicloud-essscheduledtask.json`
2. Implement your resource handlers in `terraform_alicloud_essscheduledtask/handlers.py`
