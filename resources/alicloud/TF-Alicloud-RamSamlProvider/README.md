...
1. Write the JSON schema describing your resource, `tf-alicloud-ramsamlprovider.json`
2. Implement your resource handlers in `tf_alicloud_ramsamlprovider/handlers.py`
