...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbacl.json`
2. Implement your resource handlers in `terraform_alicloud_slbacl/handlers.py`
