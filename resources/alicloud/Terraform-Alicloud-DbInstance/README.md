...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbinstance.json`
2. Implement your resource handlers in `terraform_alicloud_dbinstance/handlers.py`
