...
1. Write the JSON schema describing your resource, `tf-alicloud-fnfschedule.json`
2. Implement your resource handlers in `tf_alicloud_fnfschedule/handlers.py`
