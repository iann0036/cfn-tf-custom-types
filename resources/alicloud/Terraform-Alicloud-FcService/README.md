...
1. Write the JSON schema describing your resource, `terraform-alicloud-fcservice.json`
2. Implement your resource handlers in `terraform_alicloud_fcservice/handlers.py`
