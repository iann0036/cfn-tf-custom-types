...
1. Write the JSON schema describing your resource, `terraform-alicloud-routerinterface.json`
2. Implement your resource handlers in `terraform_alicloud_routerinterface/handlers.py`
