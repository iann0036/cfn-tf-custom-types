...
1. Write the JSON schema describing your resource, `terraform-alicloud-dnsgroup.json`
2. Implement your resource handlers in `terraform_alicloud_dnsgroup/handlers.py`
