...
1. Write the JSON schema describing your resource, `terraform-alicloud-apigatewaygroup.json`
2. Implement your resource handlers in `terraform_alicloud_apigatewaygroup/handlers.py`
