...
1. Write the JSON schema describing your resource, `terraform-alicloud-marketorder.json`
2. Implement your resource handlers in `terraform_alicloud_marketorder/handlers.py`
