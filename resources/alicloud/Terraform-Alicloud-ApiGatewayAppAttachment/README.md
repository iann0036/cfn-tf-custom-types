...
1. Write the JSON schema describing your resource, `terraform-alicloud-apigatewayappattachment.json`
2. Implement your resource handlers in `terraform_alicloud_apigatewayappattachment/handlers.py`
