...
1. Write the JSON schema describing your resource, `terraform-alicloud-nasaccessrule.json`
2. Implement your resource handlers in `terraform_alicloud_nasaccessrule/handlers.py`
