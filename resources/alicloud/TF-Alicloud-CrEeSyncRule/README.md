...
1. Write the JSON schema describing your resource, `tf-alicloud-creesyncrule.json`
2. Implement your resource handlers in `tf_alicloud_creesyncrule/handlers.py`
