...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramgroupmembership.json`
2. Implement your resource handlers in `terraform_alicloud_ramgroupmembership/handlers.py`
