...
1. Write the JSON schema describing your resource, `tf-alicloud-essscheduledtask.json`
2. Implement your resource handlers in `tf_alicloud_essscheduledtask/handlers.py`
