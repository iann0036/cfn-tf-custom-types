...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramroleattachment.json`
2. Implement your resource handlers in `terraform_alicloud_ramroleattachment/handlers.py`
