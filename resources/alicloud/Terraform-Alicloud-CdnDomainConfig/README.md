...
1. Write the JSON schema describing your resource, `terraform-alicloud-cdndomainconfig.json`
2. Implement your resource handlers in `terraform_alicloud_cdndomainconfig/handlers.py`
