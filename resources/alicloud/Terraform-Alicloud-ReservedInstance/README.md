...
1. Write the JSON schema describing your resource, `terraform-alicloud-reservedinstance.json`
2. Implement your resource handlers in `terraform_alicloud_reservedinstance/handlers.py`
