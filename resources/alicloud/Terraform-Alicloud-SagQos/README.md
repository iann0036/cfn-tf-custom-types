...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagqos.json`
2. Implement your resource handlers in `terraform_alicloud_sagqos/handlers.py`
