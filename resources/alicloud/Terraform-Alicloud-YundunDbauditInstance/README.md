...
1. Write the JSON schema describing your resource, `terraform-alicloud-yundundbauditinstance.json`
2. Implement your resource handlers in `terraform_alicloud_yundundbauditinstance/handlers.py`
