# TF::Alicloud::QuotasQuotaApplication

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-quotasquotaapplication.json`
2. Implement your resource handlers in `tf_alicloud_quotasquotaapplication/handlers.py`
