...
1. Write the JSON schema describing your resource, `tf-alicloud-cenvbrhealthcheck.json`
2. Implement your resource handlers in `tf_alicloud_cenvbrhealthcheck/handlers.py`
