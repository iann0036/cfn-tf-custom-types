...
1. Write the JSON schema describing your resource, `tf-alicloud-ceninstanceattachment.json`
2. Implement your resource handlers in `tf_alicloud_ceninstanceattachment/handlers.py`
