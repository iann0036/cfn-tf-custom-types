...
1. Write the JSON schema describing your resource, `terraform-alicloud-disk.json`
2. Implement your resource handlers in `terraform_alicloud_disk/handlers.py`
