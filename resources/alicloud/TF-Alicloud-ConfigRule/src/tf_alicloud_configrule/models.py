...
class ResourceModel(BaseModel):
    ...
    MemberId: Optional[float]
    MultiAccount: Optional[bool]
    ...
    ScopeComplianceResourceId: Optional[str]
    ScopeComplianceResourceTypes: Optional[Sequence[str]]
    SourceDetailMessageType: Optional[str]
    SourceIdentifier: Optional[str]
    SourceMaximumExecutionFrequency: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ScopeComplianceResourceId=json_data.get("ScopeComplianceResourceId"),
            ScopeComplianceResourceTypes=json_data.get("ScopeComplianceResourceTypes"),
            SourceDetailMessageType=json_data.get("SourceDetailMessageType"),
            SourceIdentifier=json_data.get("SourceIdentifier"),
            SourceMaximumExecutionFrequency=json_data.get("SourceMaximumExecutionFrequency"),
