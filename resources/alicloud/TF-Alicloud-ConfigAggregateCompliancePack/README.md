...
1. Write the JSON schema describing your resource, `tf-alicloud-configaggregatecompliancepack.json`
2. Implement your resource handlers in `tf_alicloud_configaggregatecompliancepack/handlers.py`
