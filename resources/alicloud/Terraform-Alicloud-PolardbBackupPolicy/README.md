...
1. Write the JSON schema describing your resource, `terraform-alicloud-polardbbackuppolicy.json`
2. Implement your resource handlers in `terraform_alicloud_polardbbackuppolicy/handlers.py`
