...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagdnatentry.json`
2. Implement your resource handlers in `terraform_alicloud_sagdnatentry/handlers.py`
