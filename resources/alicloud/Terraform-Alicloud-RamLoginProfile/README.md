...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramloginprofile.json`
2. Implement your resource handlers in `terraform_alicloud_ramloginprofile/handlers.py`
