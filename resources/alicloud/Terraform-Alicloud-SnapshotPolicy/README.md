...
1. Write the JSON schema describing your resource, `terraform-alicloud-snapshotpolicy.json`
2. Implement your resource handlers in `terraform_alicloud_snapshotpolicy/handlers.py`
