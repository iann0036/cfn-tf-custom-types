...
1. Write the JSON schema describing your resource, `tf-alicloud-brainindustrialpidloop.json`
2. Implement your resource handlers in `tf_alicloud_brainindustrialpidloop/handlers.py`
