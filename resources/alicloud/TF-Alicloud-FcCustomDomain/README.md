...
1. Write the JSON schema describing your resource, `tf-alicloud-fccustomdomain.json`
2. Implement your resource handlers in `tf_alicloud_fccustomdomain/handlers.py`
