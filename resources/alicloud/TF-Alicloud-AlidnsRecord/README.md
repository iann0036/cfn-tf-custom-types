...
1. Write the JSON schema describing your resource, `tf-alicloud-alidnsrecord.json`
2. Implement your resource handlers in `tf_alicloud_alidnsrecord/handlers.py`
