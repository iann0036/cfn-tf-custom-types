...
1. Write the JSON schema describing your resource, `terraform-alicloud-crnamespace.json`
2. Implement your resource handlers in `terraform_alicloud_crnamespace/handlers.py`
