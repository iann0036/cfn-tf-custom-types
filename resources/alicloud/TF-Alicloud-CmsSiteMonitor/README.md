...
1. Write the JSON schema describing your resource, `tf-alicloud-cmssitemonitor.json`
2. Implement your resource handlers in `tf_alicloud_cmssitemonitor/handlers.py`
