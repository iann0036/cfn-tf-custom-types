...
1. Write the JSON schema describing your resource, `terraform-alicloud-vpnrouteentry.json`
2. Implement your resource handlers in `terraform_alicloud_vpnrouteentry/handlers.py`
