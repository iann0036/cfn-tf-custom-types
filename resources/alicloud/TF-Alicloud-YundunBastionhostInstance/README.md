...
1. Write the JSON schema describing your resource, `tf-alicloud-yundunbastionhostinstance.json`
2. Implement your resource handlers in `tf_alicloud_yundunbastionhostinstance/handlers.py`
