...
1. Write the JSON schema describing your resource, `tf-alicloud-actiontrailtrail.json`
2. Implement your resource handlers in `tf_alicloud_actiontrailtrail/handlers.py`
