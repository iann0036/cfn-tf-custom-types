...
1. Write the JSON schema describing your resource, `terraform-alicloud-csswarm.json`
2. Implement your resource handlers in `terraform_alicloud_csswarm/handlers.py`
