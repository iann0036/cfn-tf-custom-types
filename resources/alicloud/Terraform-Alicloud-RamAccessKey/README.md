...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramaccesskey.json`
2. Implement your resource handlers in `terraform_alicloud_ramaccesskey/handlers.py`
