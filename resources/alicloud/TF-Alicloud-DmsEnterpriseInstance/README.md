...
1. Write the JSON schema describing your resource, `tf-alicloud-dmsenterpriseinstance.json`
2. Implement your resource handlers in `tf_alicloud_dmsenterpriseinstance/handlers.py`
