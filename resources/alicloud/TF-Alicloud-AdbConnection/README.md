...
1. Write the JSON schema describing your resource, `tf-alicloud-adbconnection.json`
2. Implement your resource handlers in `tf_alicloud_adbconnection/handlers.py`
