...
1. Write the JSON schema describing your resource, `terraform-alicloud-routerinterfaceconnection.json`
2. Implement your resource handlers in `terraform_alicloud_routerinterfaceconnection/handlers.py`
