...
1. Write the JSON schema describing your resource, `tf-alicloud-apigatewayapi.json`
2. Implement your resource handlers in `tf_alicloud_apigatewayapi/handlers.py`
