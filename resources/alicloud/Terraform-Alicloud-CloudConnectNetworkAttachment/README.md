...
1. Write the JSON schema describing your resource, `terraform-alicloud-cloudconnectnetworkattachment.json`
2. Implement your resource handlers in `terraform_alicloud_cloudconnectnetworkattachment/handlers.py`
