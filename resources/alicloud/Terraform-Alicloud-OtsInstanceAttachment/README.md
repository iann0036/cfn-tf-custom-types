...
1. Write the JSON schema describing your resource, `terraform-alicloud-otsinstanceattachment.json`
2. Implement your resource handlers in `terraform_alicloud_otsinstanceattachment/handlers.py`
