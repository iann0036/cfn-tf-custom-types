...
class ResourceModel(BaseModel):
    ...
    Force: Optional[bool]
    Id: Optional[str]
    InstantAccess: Optional[bool]
    InstantAccessRetentionDays: Optional[float]
    Name: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            InstantAccess=json_data.get("InstantAccess"),
            InstantAccessRetentionDays=json_data.get("InstantAccessRetentionDays"),
