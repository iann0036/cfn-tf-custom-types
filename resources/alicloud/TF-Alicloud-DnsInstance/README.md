...
1. Write the JSON schema describing your resource, `tf-alicloud-dnsinstance.json`
2. Implement your resource handlers in `tf_alicloud_dnsinstance/handlers.py`
