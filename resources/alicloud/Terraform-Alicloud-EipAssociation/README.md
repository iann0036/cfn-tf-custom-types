...
1. Write the JSON schema describing your resource, `terraform-alicloud-eipassociation.json`
2. Implement your resource handlers in `terraform_alicloud_eipassociation/handlers.py`
