...
1. Write the JSON schema describing your resource, `tf-alicloud-rdsparametergroup.json`
2. Implement your resource handlers in `tf_alicloud_rdsparametergroup/handlers.py`
