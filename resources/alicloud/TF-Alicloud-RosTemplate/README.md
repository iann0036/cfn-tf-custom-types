...
1. Write the JSON schema describing your resource, `tf-alicloud-rostemplate.json`
2. Implement your resource handlers in `tf_alicloud_rostemplate/handlers.py`
