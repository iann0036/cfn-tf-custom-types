...
1. Write the JSON schema describing your resource, `terraform-alicloud-diskattachment.json`
2. Implement your resource handlers in `terraform_alicloud_diskattachment/handlers.py`
