...
1. Write the JSON schema describing your resource, `tf-alicloud-edasslbattachment.json`
2. Implement your resource handlers in `tf_alicloud_edasslbattachment/handlers.py`
