...
1. Write the JSON schema describing your resource, `tf-alicloud-polardbendpoint.json`
2. Implement your resource handlers in `tf_alicloud_polardbendpoint/handlers.py`
