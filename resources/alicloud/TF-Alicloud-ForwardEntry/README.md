...
1. Write the JSON schema describing your resource, `tf-alicloud-forwardentry.json`
2. Implement your resource handlers in `tf_alicloud_forwardentry/handlers.py`
