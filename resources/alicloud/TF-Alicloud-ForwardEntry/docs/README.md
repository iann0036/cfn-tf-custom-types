...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#forwardentryname" title="ForwardEntryName">ForwardEntryName</a>" : <i>String</i>,
        ...
        "<a href="#portbreak" title="PortBreak">PortBreak</a>" : <i>Boolean</i>,
