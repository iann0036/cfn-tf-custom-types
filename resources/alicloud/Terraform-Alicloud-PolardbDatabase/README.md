...
1. Write the JSON schema describing your resource, `terraform-alicloud-polardbdatabase.json`
2. Implement your resource handlers in `terraform_alicloud_polardbdatabase/handlers.py`
