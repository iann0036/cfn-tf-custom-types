...
1. Write the JSON schema describing your resource, `terraform-alicloud-onsinstance.json`
2. Implement your resource handlers in `terraform_alicloud_onsinstance/handlers.py`
