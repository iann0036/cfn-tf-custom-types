...
1. Write the JSON schema describing your resource, `terraform-alicloud-csserverlesskubernetes.json`
2. Implement your resource handlers in `terraform_alicloud_csserverlesskubernetes/handlers.py`
