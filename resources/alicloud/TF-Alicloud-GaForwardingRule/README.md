...
1. Write the JSON schema describing your resource, `tf-alicloud-gaforwardingrule.json`
2. Implement your resource handlers in `tf_alicloud_gaforwardingrule/handlers.py`
