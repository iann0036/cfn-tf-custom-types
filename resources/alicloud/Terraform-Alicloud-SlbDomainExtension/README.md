...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbdomainextension.json`
2. Implement your resource handlers in `terraform_alicloud_slbdomainextension/handlers.py`
