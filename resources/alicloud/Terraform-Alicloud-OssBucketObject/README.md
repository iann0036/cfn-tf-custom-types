...
1. Write the JSON schema describing your resource, `terraform-alicloud-ossbucketobject.json`
2. Implement your resource handlers in `terraform_alicloud_ossbucketobject/handlers.py`
