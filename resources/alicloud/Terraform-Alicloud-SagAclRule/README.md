...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagaclrule.json`
2. Implement your resource handlers in `terraform_alicloud_sagaclrule/handlers.py`
