...
1. Write the JSON schema describing your resource, `tf-alicloud-mongodbshardinginstance.json`
2. Implement your resource handlers in `tf_alicloud_mongodbshardinginstance/handlers.py`
