...
1. Write the JSON schema describing your resource, `tf-alicloud-csedgekubernetes.json`
2. Implement your resource handlers in `tf_alicloud_csedgekubernetes/handlers.py`
