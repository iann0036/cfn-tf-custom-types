...
1. Write the JSON schema describing your resource, `tf-alicloud-pvtzzonerecord.json`
2. Implement your resource handlers in `tf_alicloud_pvtzzonerecord/handlers.py`
