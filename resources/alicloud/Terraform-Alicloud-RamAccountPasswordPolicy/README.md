...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramaccountpasswordpolicy.json`
2. Implement your resource handlers in `terraform_alicloud_ramaccountpasswordpolicy/handlers.py`
