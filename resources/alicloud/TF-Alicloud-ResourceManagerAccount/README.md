...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanageraccount.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanageraccount/handlers.py`
