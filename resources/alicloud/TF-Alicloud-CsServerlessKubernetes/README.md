...
1. Write the JSON schema describing your resource, `tf-alicloud-csserverlesskubernetes.json`
2. Implement your resource handlers in `tf_alicloud_csserverlesskubernetes/handlers.py`
