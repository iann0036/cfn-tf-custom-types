...
1. Write the JSON schema describing your resource, `terraform-alicloud-securitygroup.json`
2. Implement your resource handlers in `terraform_alicloud_securitygroup/handlers.py`
