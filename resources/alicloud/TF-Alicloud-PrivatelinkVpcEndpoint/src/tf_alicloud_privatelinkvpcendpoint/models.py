...
class ResourceModel(BaseModel):
    ...
    EndpointBusinessStatus: Optional[str]
    EndpointDescription: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            EndpointBusinessStatus=json_data.get("EndpointBusinessStatus"),
            EndpointDescription=json_data.get("EndpointDescription"),
