...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbreadonlyinstance.json`
2. Implement your resource handlers in `terraform_alicloud_dbreadonlyinstance/handlers.py`
