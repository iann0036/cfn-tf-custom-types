...
1. Write the JSON schema describing your resource, `terraform-alicloud-nasfilesystem.json`
2. Implement your resource handlers in `terraform_alicloud_nasfilesystem/handlers.py`
