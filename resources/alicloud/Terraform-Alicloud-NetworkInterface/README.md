...
1. Write the JSON schema describing your resource, `terraform-alicloud-networkinterface.json`
2. Implement your resource handlers in `terraform_alicloud_networkinterface/handlers.py`
