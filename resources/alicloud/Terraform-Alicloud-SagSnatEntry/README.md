...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagsnatentry.json`
2. Implement your resource handlers in `terraform_alicloud_sagsnatentry/handlers.py`
