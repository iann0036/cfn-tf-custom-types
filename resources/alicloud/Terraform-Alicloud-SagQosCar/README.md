...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagqoscar.json`
2. Implement your resource handlers in `terraform_alicloud_sagqoscar/handlers.py`
