...
1. Write the JSON schema describing your resource, `tf-alicloud-imageexport.json`
2. Implement your resource handlers in `tf_alicloud_imageexport/handlers.py`
