...
1. Write the JSON schema describing your resource, `tf-alicloud-slbservergroup.json`
2. Implement your resource handlers in `tf_alicloud_slbservergroup/handlers.py`
