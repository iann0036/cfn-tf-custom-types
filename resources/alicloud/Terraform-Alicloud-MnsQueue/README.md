...
1. Write the JSON schema describing your resource, `terraform-alicloud-mnsqueue.json`
2. Implement your resource handlers in `terraform_alicloud_mnsqueue/handlers.py`
