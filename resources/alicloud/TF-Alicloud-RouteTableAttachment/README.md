...
1. Write the JSON schema describing your resource, `tf-alicloud-routetableattachment.json`
2. Implement your resource handlers in `tf_alicloud_routetableattachment/handlers.py`
