...
1. Write the JSON schema describing your resource, `terraform-alicloud-ddosbgpinstance.json`
2. Implement your resource handlers in `terraform_alicloud_ddosbgpinstance/handlers.py`
