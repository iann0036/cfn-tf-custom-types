...
1. Write the JSON schema describing your resource, `tf-alicloud-configconfigurationrecorder.json`
2. Implement your resource handlers in `tf_alicloud_configconfigurationrecorder/handlers.py`
