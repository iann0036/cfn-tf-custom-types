...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbreadwritesplittingconnection.json`
2. Implement your resource handlers in `terraform_alicloud_dbreadwritesplittingconnection/handlers.py`
