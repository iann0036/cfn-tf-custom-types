...
1. Write the JSON schema describing your resource, `terraform-alicloud-vpncustomergateway.json`
2. Implement your resource handlers in `terraform_alicloud_vpncustomergateway/handlers.py`
