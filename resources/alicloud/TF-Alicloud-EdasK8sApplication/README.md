...
1. Write the JSON schema describing your resource, `tf-alicloud-edask8sapplication.json`
2. Implement your resource handlers in `tf_alicloud_edask8sapplication/handlers.py`
