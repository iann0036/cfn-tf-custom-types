...
1. Write the JSON schema describing your resource, `terraform-alicloud-cdndomainnew.json`
2. Implement your resource handlers in `terraform_alicloud_cdndomainnew/handlers.py`
