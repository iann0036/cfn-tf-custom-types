...
1. Write the JSON schema describing your resource, `terraform-alicloud-keypair.json`
2. Implement your resource handlers in `terraform_alicloud_keypair/handlers.py`
