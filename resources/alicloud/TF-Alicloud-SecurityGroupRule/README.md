# TF::Alicloud::SecurityGroupRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-securitygrouprule.json`
2. Implement your resource handlers in `tf_alicloud_securitygrouprule/handlers.py`
