...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramgroup.json`
2. Implement your resource handlers in `terraform_alicloud_ramgroup/handlers.py`
