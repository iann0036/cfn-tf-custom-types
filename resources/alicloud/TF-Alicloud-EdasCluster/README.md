...
1. Write the JSON schema describing your resource, `tf-alicloud-edascluster.json`
2. Implement your resource handlers in `tf_alicloud_edascluster/handlers.py`
