...
1. Write the JSON schema describing your resource, `terraform-alicloud-image.json`
2. Implement your resource handlers in `terraform_alicloud_image/handlers.py`
