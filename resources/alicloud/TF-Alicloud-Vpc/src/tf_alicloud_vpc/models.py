...
class ResourceModel(BaseModel):
    ...
    RouterTableId: Optional[str]
    SecondaryCidrBlocks: Optional[Sequence[str]]
    Status: Optional[str]
    Tags: Optional[Sequence["_TagsDefinition"]]
    UserCidrs: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RouterTableId=json_data.get("RouterTableId"),
            SecondaryCidrBlocks=json_data.get("SecondaryCidrBlocks"),
            Status=json_data.get("Status"),
            Tags=deserialize_list(json_data.get("Tags"), TagsDefinition),
            UserCidrs=json_data.get("UserCidrs"),
