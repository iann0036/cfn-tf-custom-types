...
1. Write the JSON schema describing your resource, `terraform-alicloud-apigatewayapi.json`
2. Implement your resource handlers in `terraform_alicloud_apigatewayapi/handlers.py`
