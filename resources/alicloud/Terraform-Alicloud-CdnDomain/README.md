...
1. Write the JSON schema describing your resource, `terraform-alicloud-cdndomain.json`
2. Implement your resource handlers in `terraform_alicloud_cdndomain/handlers.py`
