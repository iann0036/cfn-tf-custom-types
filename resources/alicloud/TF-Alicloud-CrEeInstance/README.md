...
1. Write the JSON schema describing your resource, `tf-alicloud-creeinstance.json`
2. Implement your resource handlers in `tf_alicloud_creeinstance/handlers.py`
