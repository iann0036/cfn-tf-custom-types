...
1. Write the JSON schema describing your resource, `tf-alicloud-cenbandwidthpackage.json`
2. Implement your resource handlers in `tf_alicloud_cenbandwidthpackage/handlers.py`
