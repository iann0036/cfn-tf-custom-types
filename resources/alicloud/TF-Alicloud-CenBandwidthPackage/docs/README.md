# TF::Alicloud::CenBandwidthPackage
...
<pre>
{
    "Type" : "TF::Alicloud::CenBandwidthPackage",
    "Properties" : {
        "<a href="#bandwidth" title="Bandwidth">Bandwidth</a>" : <i>Double</i>,
        "<a href="#cenbandwidthpackagename" title="CenBandwidthPackageName">CenBandwidthPackageName</a>" : <i>String</i>,
        "<a href="#chargetype" title="ChargeType">ChargeType</a>" : <i>String</i>,
        "<a href="#description" title="Description">Description</a>" : <i>String</i>,
        "<a href="#geographicregionaid" title="GeographicRegionAId">GeographicRegionAId</a>" : <i>String</i>,
        "<a href="#geographicregionbid" title="GeographicRegionBId">GeographicRegionBId</a>" : <i>String</i>,
