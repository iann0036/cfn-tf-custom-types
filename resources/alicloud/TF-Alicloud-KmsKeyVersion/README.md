...
1. Write the JSON schema describing your resource, `tf-alicloud-kmskeyversion.json`
2. Implement your resource handlers in `tf_alicloud_kmskeyversion/handlers.py`
