...
1. Write the JSON schema describing your resource, `tf-alicloud-edasapplicationscale.json`
2. Implement your resource handlers in `tf_alicloud_edasapplicationscale/handlers.py`
