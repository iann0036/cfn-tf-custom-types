...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagacl.json`
2. Implement your resource handlers in `terraform_alicloud_sagacl/handlers.py`
