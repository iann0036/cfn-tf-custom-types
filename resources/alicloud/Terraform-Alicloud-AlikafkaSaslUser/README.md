...
1. Write the JSON schema describing your resource, `terraform-alicloud-alikafkasasluser.json`
2. Implement your resource handlers in `terraform_alicloud_alikafkasasluser/handlers.py`
