...
1. Write the JSON schema describing your resource, `tf-alicloud-cmsalarmcontact.json`
2. Implement your resource handlers in `tf_alicloud_cmsalarmcontact/handlers.py`
