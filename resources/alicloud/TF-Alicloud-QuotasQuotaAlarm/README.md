...
1. Write the JSON schema describing your resource, `tf-alicloud-quotasquotaalarm.json`
2. Implement your resource handlers in `tf_alicloud_quotasquotaalarm/handlers.py`
