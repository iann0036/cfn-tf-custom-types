...
1. Write the JSON schema describing your resource, `terraform-alicloud-mnstopic.json`
2. Implement your resource handlers in `terraform_alicloud_mnstopic/handlers.py`
