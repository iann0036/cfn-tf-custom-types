...
1. Write the JSON schema describing your resource, `terraform-alicloud-containercluster.json`
2. Implement your resource handlers in `terraform_alicloud_containercluster/handlers.py`
