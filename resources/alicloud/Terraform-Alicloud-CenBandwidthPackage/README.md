...
1. Write the JSON schema describing your resource, `terraform-alicloud-cenbandwidthpackage.json`
2. Implement your resource handlers in `terraform_alicloud_cenbandwidthpackage/handlers.py`
