...
1. Write the JSON schema describing your resource, `terraform-alicloud-pvtzzone.json`
2. Implement your resource handlers in `terraform_alicloud_pvtzzone/handlers.py`
