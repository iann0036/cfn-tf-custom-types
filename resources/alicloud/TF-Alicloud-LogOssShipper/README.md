...
1. Write the JSON schema describing your resource, `tf-alicloud-logossshipper.json`
2. Implement your resource handlers in `tf_alicloud_logossshipper/handlers.py`
