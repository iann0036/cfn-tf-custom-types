...
1. Write the JSON schema describing your resource, `terraform-alicloud-essscalinggroupvservergroups.json`
2. Implement your resource handlers in `terraform_alicloud_essscalinggroupvservergroups/handlers.py`
