...
1. Write the JSON schema describing your resource, `terraform-alicloud-adbcluster.json`
2. Implement your resource handlers in `terraform_alicloud_adbcluster/handlers.py`
