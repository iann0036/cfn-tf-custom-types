...
1. Write the JSON schema describing your resource, `terraform-alicloud-ossbucket.json`
2. Implement your resource handlers in `terraform_alicloud_ossbucket/handlers.py`
