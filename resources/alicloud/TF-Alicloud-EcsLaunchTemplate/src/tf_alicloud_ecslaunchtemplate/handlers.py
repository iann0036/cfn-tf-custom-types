...
TYPE_NAME = "TF::Alicloud::EcsLaunchTemplate"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/alicloud_ecs_launch_template/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'alicloud_ecs_launch_template',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/alicloud_ecs_launch_template/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/alicloud_ecs_launch_template/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AutoReleaseTime=None, DeploymentSetId=None, Description=None, EnableVmOsConfig=None, HostName=None, Id=None, ImageId=None, ImageOwnerAlias=None, InstanceChargeType=None, InstanceName=None, InstanceType=None, InternetChargeType=None, InternetMaxBandwidthIn=None, InternetMaxBandwidthOut=None, IoOptimized=None, KeyPairName=None, LaunchTemplateName=None, Name=None, NetworkType=None, PasswordInherit=None, Period=None, PrivateIpAddress=None, RamRoleName=None, ResourceGroupId=None, SecurityEnhancementStrategy=None, SecurityGroupId=None, SecurityGroupIds=None, SpotDuration=None, SpotPriceLimit=None, SpotStrategy=None, SystemDiskCategory=None, SystemDiskDescription=None, SystemDiskName=None, SystemDiskSize=None, Tags=None, TemplateResourceGroupId=None, TemplateTags=None, UserData=None, Userdata=None, VersionDescription=None, VpcId=None, VswitchId=None, ZoneId=None, DataDisks=None, NetworkInterfaces=None, SystemDisk=None)
