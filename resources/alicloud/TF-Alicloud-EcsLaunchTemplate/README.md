...
1. Write the JSON schema describing your resource, `tf-alicloud-ecslaunchtemplate.json`
2. Implement your resource handlers in `tf_alicloud_ecslaunchtemplate/handlers.py`
