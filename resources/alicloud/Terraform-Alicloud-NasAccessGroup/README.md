...
1. Write the JSON schema describing your resource, `terraform-alicloud-nasaccessgroup.json`
2. Implement your resource handlers in `terraform_alicloud_nasaccessgroup/handlers.py`
