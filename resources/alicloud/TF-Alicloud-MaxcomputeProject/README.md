...
1. Write the JSON schema describing your resource, `tf-alicloud-maxcomputeproject.json`
2. Implement your resource handlers in `tf_alicloud_maxcomputeproject/handlers.py`
