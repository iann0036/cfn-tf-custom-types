...
1. Write the JSON schema describing your resource, `tf-alicloud-reservedinstance.json`
2. Implement your resource handlers in `tf_alicloud_reservedinstance/handlers.py`
