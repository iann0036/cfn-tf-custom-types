...
1. Write the JSON schema describing your resource, `tf-alicloud-gpdbconnection.json`
2. Implement your resource handlers in `tf_alicloud_gpdbconnection/handlers.py`
