...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramalias.json`
2. Implement your resource handlers in `terraform_alicloud_ramalias/handlers.py`
