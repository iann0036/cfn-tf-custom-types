...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagercontrolpolicyattachment.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagercontrolpolicyattachment/handlers.py`
