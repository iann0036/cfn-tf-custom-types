...
1. Write the JSON schema describing your resource, `tf-alicloud-slblistener.json`
2. Implement your resource handlers in `tf_alicloud_slblistener/handlers.py`
