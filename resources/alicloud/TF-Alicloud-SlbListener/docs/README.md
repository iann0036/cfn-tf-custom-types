...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#cacertificateid" title="CaCertificateId">CaCertificateId</a>" : <i>String</i>,
        ...
        "<a href="#xforwardedfor" title="XForwardedFor">XForwardedFor</a>" : <i>[ <a href="xforwardedfordefinition.md">XForwardedForDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#xforwardedfor" title="XForwardedFor">XForwardedFor</a>: <i>
      - <a href="xforwardedfordefinition.md">XForwardedForDefinition</a></i>
</pre>
...
_Type_: List of <a href="xforwardedfordefinition.md">XForwardedForDefinition</a>
