...
1. Write the JSON schema describing your resource, `terraform-alicloud-imagesharepermission.json`
2. Implement your resource handlers in `terraform_alicloud_imagesharepermission/handlers.py`
