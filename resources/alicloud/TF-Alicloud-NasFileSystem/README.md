...
1. Write the JSON schema describing your resource, `tf-alicloud-nasfilesystem.json`
2. Implement your resource handlers in `tf_alicloud_nasfilesystem/handlers.py`
