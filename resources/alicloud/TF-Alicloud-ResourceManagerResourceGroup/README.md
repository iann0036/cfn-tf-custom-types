...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerresourcegroup.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerresourcegroup/handlers.py`
