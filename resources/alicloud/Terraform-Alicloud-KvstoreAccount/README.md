...
1. Write the JSON schema describing your resource, `terraform-alicloud-kvstoreaccount.json`
2. Implement your resource handlers in `terraform_alicloud_kvstoreaccount/handlers.py`
