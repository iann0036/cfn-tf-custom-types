...
1. Write the JSON schema describing your resource, `terraform-alicloud-datahubproject.json`
2. Implement your resource handlers in `terraform_alicloud_datahubproject/handlers.py`
