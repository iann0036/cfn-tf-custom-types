...
1. Write the JSON schema describing your resource, `tf-alicloud-dbconnection.json`
2. Implement your resource handlers in `tf_alicloud_dbconnection/handlers.py`
