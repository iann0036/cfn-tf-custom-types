...
1. Write the JSON schema describing your resource, `terraform-alicloud-datahubsubscription.json`
2. Implement your resource handlers in `terraform_alicloud_datahubsubscription/handlers.py`
