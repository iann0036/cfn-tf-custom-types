...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbattachment.json`
2. Implement your resource handlers in `terraform_alicloud_slbattachment/handlers.py`
