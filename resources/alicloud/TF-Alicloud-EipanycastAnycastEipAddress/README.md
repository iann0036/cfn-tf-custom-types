...
1. Write the JSON schema describing your resource, `tf-alicloud-eipanycastanycasteipaddress.json`
2. Implement your resource handlers in `tf_alicloud_eipanycastanycasteipaddress/handlers.py`
