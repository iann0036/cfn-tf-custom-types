...
1. Write the JSON schema describing your resource, `tf-alicloud-privatelinkvpcendpointservice.json`
2. Implement your resource handlers in `tf_alicloud_privatelinkvpcendpointservice/handlers.py`
