...
1. Write the JSON schema describing your resource, `tf-alicloud-configaggregateconfigrule.json`
2. Implement your resource handlers in `tf_alicloud_configaggregateconfigrule/handlers.py`
