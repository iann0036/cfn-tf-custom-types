...
1. Write the JSON schema describing your resource, `terraform-alicloud-csapplication.json`
2. Implement your resource handlers in `terraform_alicloud_csapplication/handlers.py`
