...
1. Write the JSON schema describing your resource, `tf-alicloud-edasapplicationdeployment.json`
2. Implement your resource handlers in `tf_alicloud_edasapplicationdeployment/handlers.py`
