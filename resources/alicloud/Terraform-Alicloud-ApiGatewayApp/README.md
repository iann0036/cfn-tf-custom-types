...
1. Write the JSON schema describing your resource, `terraform-alicloud-apigatewayapp.json`
2. Implement your resource handlers in `terraform_alicloud_apigatewayapp/handlers.py`
