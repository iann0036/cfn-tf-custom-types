...
1. Write the JSON schema describing your resource, `terraform-alicloud-sagqospolicy.json`
2. Implement your resource handlers in `terraform_alicloud_sagqospolicy/handlers.py`
