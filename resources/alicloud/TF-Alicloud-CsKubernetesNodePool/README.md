...
1. Write the JSON schema describing your resource, `tf-alicloud-cskubernetesnodepool.json`
2. Implement your resource handlers in `tf_alicloud_cskubernetesnodepool/handlers.py`
