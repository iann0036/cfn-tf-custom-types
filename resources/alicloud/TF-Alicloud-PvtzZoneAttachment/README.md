...
1. Write the JSON schema describing your resource, `tf-alicloud-pvtzzoneattachment.json`
2. Implement your resource handlers in `tf_alicloud_pvtzzoneattachment/handlers.py`
