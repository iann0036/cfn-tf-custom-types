...
1. Write the JSON schema describing your resource, `tf-alicloud-gabandwidthpackage.json`
2. Implement your resource handlers in `tf_alicloud_gabandwidthpackage/handlers.py`
