...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerfolder.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerfolder/handlers.py`
