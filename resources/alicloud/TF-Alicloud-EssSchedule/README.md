...
1. Write the JSON schema describing your resource, `tf-alicloud-essschedule.json`
2. Implement your resource handlers in `tf_alicloud_essschedule/handlers.py`
