...
1. Write the JSON schema describing your resource, `tf-alicloud-adbdbcluster.json`
2. Implement your resource handlers in `tf_alicloud_adbdbcluster/handlers.py`
