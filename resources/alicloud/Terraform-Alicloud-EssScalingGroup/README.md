...
1. Write the JSON schema describing your resource, `terraform-alicloud-essscalinggroup.json`
2. Implement your resource handlers in `terraform_alicloud_essscalinggroup/handlers.py`
