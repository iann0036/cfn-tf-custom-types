...
1. Write the JSON schema describing your resource, `terraform-alicloud-onsgroup.json`
2. Implement your resource handlers in `terraform_alicloud_onsgroup/handlers.py`
