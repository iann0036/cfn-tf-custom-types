...
1. Write the JSON schema describing your resource, `terraform-alicloud-ceninstanceattachment.json`
2. Implement your resource handlers in `terraform_alicloud_ceninstanceattachment/handlers.py`
