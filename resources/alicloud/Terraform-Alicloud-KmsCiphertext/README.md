...
1. Write the JSON schema describing your resource, `terraform-alicloud-kmsciphertext.json`
2. Implement your resource handlers in `terraform_alicloud_kmsciphertext/handlers.py`
