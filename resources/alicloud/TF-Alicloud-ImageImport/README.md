...
1. Write the JSON schema describing your resource, `tf-alicloud-imageimport.json`
2. Implement your resource handlers in `tf_alicloud_imageimport/handlers.py`
