...
1. Write the JSON schema describing your resource, `terraform-alicloud-hbaseinstance.json`
2. Implement your resource handlers in `terraform_alicloud_hbaseinstance/handlers.py`
