...
1. Write the JSON schema describing your resource, `terraform-alicloud-pvtzzoneattachment.json`
2. Implement your resource handlers in `terraform_alicloud_pvtzzoneattachment/handlers.py`
