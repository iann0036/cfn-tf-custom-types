...
1. Write the JSON schema describing your resource, `terraform-alicloud-crrepo.json`
2. Implement your resource handlers in `terraform_alicloud_crrepo/handlers.py`
