...
1. Write the JSON schema describing your resource, `tf-alicloud-launchtemplate.json`
2. Implement your resource handlers in `tf_alicloud_launchtemplate/handlers.py`
