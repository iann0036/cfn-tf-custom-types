...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbaccountprivilege.json`
2. Implement your resource handlers in `terraform_alicloud_dbaccountprivilege/handlers.py`
