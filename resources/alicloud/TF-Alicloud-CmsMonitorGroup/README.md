...
1. Write the JSON schema describing your resource, `tf-alicloud-cmsmonitorgroup.json`
2. Implement your resource handlers in `tf_alicloud_cmsmonitorgroup/handlers.py`
