...
1. Write the JSON schema describing your resource, `terraform-alicloud-logstore.json`
2. Implement your resource handlers in `terraform_alicloud_logstore/handlers.py`
