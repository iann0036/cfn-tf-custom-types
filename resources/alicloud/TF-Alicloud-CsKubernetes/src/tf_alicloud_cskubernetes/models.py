...
class ResourceModel(BaseModel):
    ...
    MasterAutoRenew: Optional[bool]
    MasterAutoRenewPeriod: Optional[float]
    MasterDiskCategory: Optional[str]
    MasterDiskPerformanceLevel: Optional[str]
    MasterDiskSize: Optional[float]
    MasterDiskSnapshotPolicyId: Optional[str]
    MasterInstanceChargeType: Optional[str]
    MasterInstanceType: Optional[str]
    MasterInstanceTypes: Optional[Sequence[str]]
    MasterNodes: Optional[Sequence["_MasterNodesDefinition"]]
    MasterPeriod: Optional[float]
    MasterPeriodUnit: Optional[str]
    MasterVswitchIds: Optional[Sequence[str]]
    Name: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            MasterAutoRenew=json_data.get("MasterAutoRenew"),
            MasterAutoRenewPeriod=json_data.get("MasterAutoRenewPeriod"),
            MasterDiskCategory=json_data.get("MasterDiskCategory"),
            MasterDiskPerformanceLevel=json_data.get("MasterDiskPerformanceLevel"),
            MasterDiskSize=json_data.get("MasterDiskSize"),
            MasterDiskSnapshotPolicyId=json_data.get("MasterDiskSnapshotPolicyId"),
            MasterInstanceChargeType=json_data.get("MasterInstanceChargeType"),
            MasterInstanceType=json_data.get("MasterInstanceType"),
            MasterInstanceTypes=json_data.get("MasterInstanceTypes"),
            MasterNodes=deserialize_list(json_data.get("MasterNodes"), MasterNodesDefinition),
            MasterPeriod=json_data.get("MasterPeriod"),
            MasterPeriodUnit=json_data.get("MasterPeriodUnit"),
            MasterVswitchIds=json_data.get("MasterVswitchIds"),
...
@dataclass
class MasterNodesDefinition(BaseModel):
    Id: Optional[str]
    Name: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MasterNodesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MasterNodesDefinition"]:
        if not json_data:
            return None
        return cls(
            Id=json_data.get("Id"),
...
# work around possible type aliasing issues when variable has same name as a model
_MasterNodesDefinition = MasterNodesDefinition
