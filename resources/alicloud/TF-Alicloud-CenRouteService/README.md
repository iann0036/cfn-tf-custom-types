...
1. Write the JSON schema describing your resource, `tf-alicloud-cenrouteservice.json`
2. Implement your resource handlers in `tf_alicloud_cenrouteservice/handlers.py`
