...
1. Write the JSON schema describing your resource, `tf-alicloud-logstoreindex.json`
2. Implement your resource handlers in `tf_alicloud_logstoreindex/handlers.py`
