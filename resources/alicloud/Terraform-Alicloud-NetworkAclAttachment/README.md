...
1. Write the JSON schema describing your resource, `terraform-alicloud-networkaclattachment.json`
2. Implement your resource handlers in `terraform_alicloud_networkaclattachment/handlers.py`
