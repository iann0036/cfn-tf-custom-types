...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramrolepolicyattachment.json`
2. Implement your resource handlers in `terraform_alicloud_ramrolepolicyattachment/handlers.py`
