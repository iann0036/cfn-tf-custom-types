...
1. Write the JSON schema describing your resource, `terraform-alicloud-cenflowlog.json`
2. Implement your resource handlers in `terraform_alicloud_cenflowlog/handlers.py`
