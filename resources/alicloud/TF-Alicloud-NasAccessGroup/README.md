...
1. Write the JSON schema describing your resource, `tf-alicloud-nasaccessgroup.json`
2. Implement your resource handlers in `tf_alicloud_nasaccessgroup/handlers.py`
