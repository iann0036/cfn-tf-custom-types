...
1. Write the JSON schema describing your resource, `tf-alicloud-esslifecyclehook.json`
2. Implement your resource handlers in `tf_alicloud_esslifecyclehook/handlers.py`
