...
1. Write the JSON schema describing your resource, `terraform-alicloud-imageimport.json`
2. Implement your resource handlers in `terraform_alicloud_imageimport/handlers.py`
