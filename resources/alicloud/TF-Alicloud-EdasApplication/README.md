...
1. Write the JSON schema describing your resource, `tf-alicloud-edasapplication.json`
2. Implement your resource handlers in `tf_alicloud_edasapplication/handlers.py`
