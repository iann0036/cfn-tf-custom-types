...
1. Write the JSON schema describing your resource, `terraform-alicloud-nasmounttarget.json`
2. Implement your resource handlers in `terraform_alicloud_nasmounttarget/handlers.py`
