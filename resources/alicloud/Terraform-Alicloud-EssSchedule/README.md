...
1. Write the JSON schema describing your resource, `terraform-alicloud-essschedule.json`
2. Implement your resource handlers in `terraform_alicloud_essschedule/handlers.py`
