...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramuserpolicyattachment.json`
2. Implement your resource handlers in `terraform_alicloud_ramuserpolicyattachment/handlers.py`
