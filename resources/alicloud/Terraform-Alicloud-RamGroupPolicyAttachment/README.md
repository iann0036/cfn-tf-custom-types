# Terraform::Alicloud::RamGroupPolicyAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-alicloud-ramgrouppolicyattachment.json`
2. Implement your resource handlers in `terraform_alicloud_ramgrouppolicyattachment/handlers.py`
