...
1. Write the JSON schema describing your resource, `terraform-alicloud-launchtemplate.json`
2. Implement your resource handlers in `terraform_alicloud_launchtemplate/handlers.py`
