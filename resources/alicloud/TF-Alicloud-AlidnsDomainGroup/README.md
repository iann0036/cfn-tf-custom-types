...
1. Write the JSON schema describing your resource, `tf-alicloud-alidnsdomaingroup.json`
2. Implement your resource handlers in `tf_alicloud_alidnsdomaingroup/handlers.py`
