...
1. Write the JSON schema describing your resource, `tf-alicloud-cenprivatezone.json`
2. Implement your resource handlers in `tf_alicloud_cenprivatezone/handlers.py`
