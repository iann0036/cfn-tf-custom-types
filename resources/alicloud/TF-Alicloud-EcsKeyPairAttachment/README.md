...
1. Write the JSON schema describing your resource, `tf-alicloud-ecskeypairattachment.json`
2. Implement your resource handlers in `tf_alicloud_ecskeypairattachment/handlers.py`
