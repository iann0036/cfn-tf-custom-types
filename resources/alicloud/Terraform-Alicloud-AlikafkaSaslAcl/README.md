...
1. Write the JSON schema describing your resource, `terraform-alicloud-alikafkasaslacl.json`
2. Implement your resource handlers in `terraform_alicloud_alikafkasaslacl/handlers.py`
