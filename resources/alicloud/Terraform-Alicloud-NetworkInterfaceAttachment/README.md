...
1. Write the JSON schema describing your resource, `terraform-alicloud-networkinterfaceattachment.json`
2. Implement your resource handlers in `terraform_alicloud_networkinterfaceattachment/handlers.py`
