...
1. Write the JSON schema describing your resource, `terraform-alicloud-emrcluster.json`
2. Implement your resource handlers in `terraform_alicloud_emrcluster/handlers.py`
