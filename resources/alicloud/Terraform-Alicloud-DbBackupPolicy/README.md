...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbbackuppolicy.json`
2. Implement your resource handlers in `terraform_alicloud_dbbackuppolicy/handlers.py`
