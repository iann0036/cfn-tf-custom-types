...
1. Write the JSON schema describing your resource, `terraform-alicloud-imagecopy.json`
2. Implement your resource handlers in `terraform_alicloud_imagecopy/handlers.py`
