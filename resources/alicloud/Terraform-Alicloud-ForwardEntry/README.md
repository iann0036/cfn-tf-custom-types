...
1. Write the JSON schema describing your resource, `terraform-alicloud-forwardentry.json`
2. Implement your resource handlers in `terraform_alicloud_forwardentry/handlers.py`
