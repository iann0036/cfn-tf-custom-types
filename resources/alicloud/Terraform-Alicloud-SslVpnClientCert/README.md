...
1. Write the JSON schema describing your resource, `terraform-alicloud-sslvpnclientcert.json`
2. Implement your resource handlers in `terraform_alicloud_sslvpnclientcert/handlers.py`
