...
1. Write the JSON schema describing your resource, `terraform-alicloud-routeentry.json`
2. Implement your resource handlers in `terraform_alicloud_routeentry/handlers.py`
