...
1. Write the JSON schema describing your resource, `terraform-alicloud-slblistener.json`
2. Implement your resource handlers in `terraform_alicloud_slblistener/handlers.py`
