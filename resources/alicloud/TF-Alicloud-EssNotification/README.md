...
1. Write the JSON schema describing your resource, `tf-alicloud-essnotification.json`
2. Implement your resource handlers in `tf_alicloud_essnotification/handlers.py`
