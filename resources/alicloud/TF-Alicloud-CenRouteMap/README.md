...
1. Write the JSON schema describing your resource, `tf-alicloud-cenroutemap.json`
2. Implement your resource handlers in `tf_alicloud_cenroutemap/handlers.py`
