...
1. Write the JSON schema describing your resource, `terraform-alicloud-otsinstance.json`
2. Implement your resource handlers in `terraform_alicloud_otsinstance/handlers.py`
