...
1. Write the JSON schema describing your resource, `terraform-alicloud-imageexport.json`
2. Implement your resource handlers in `terraform_alicloud_imageexport/handlers.py`
