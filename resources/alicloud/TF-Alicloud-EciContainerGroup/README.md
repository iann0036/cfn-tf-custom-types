...
1. Write the JSON schema describing your resource, `tf-alicloud-ecicontainergroup.json`
2. Implement your resource handlers in `tf_alicloud_ecicontainergroup/handlers.py`
