...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbmasterslaveservergroup.json`
2. Implement your resource handlers in `terraform_alicloud_slbmasterslaveservergroup/handlers.py`
