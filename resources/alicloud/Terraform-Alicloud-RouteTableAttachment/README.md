...
1. Write the JSON schema describing your resource, `terraform-alicloud-routetableattachment.json`
2. Implement your resource handlers in `terraform_alicloud_routetableattachment/handlers.py`
