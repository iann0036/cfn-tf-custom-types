...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbdatabase.json`
2. Implement your resource handlers in `terraform_alicloud_dbdatabase/handlers.py`
