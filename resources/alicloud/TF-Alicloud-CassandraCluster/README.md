...
1. Write the JSON schema describing your resource, `tf-alicloud-cassandracluster.json`
2. Implement your resource handlers in `tf_alicloud_cassandracluster/handlers.py`
