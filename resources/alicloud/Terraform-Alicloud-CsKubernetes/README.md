...
1. Write the JSON schema describing your resource, `terraform-alicloud-cskubernetes.json`
2. Implement your resource handlers in `terraform_alicloud_cskubernetes/handlers.py`
