...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbaccount.json`
2. Implement your resource handlers in `terraform_alicloud_dbaccount/handlers.py`
