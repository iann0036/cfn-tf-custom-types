...
1. Write the JSON schema describing your resource, `tf-alicloud-oosexecution.json`
2. Implement your resource handlers in `tf_alicloud_oosexecution/handlers.py`
