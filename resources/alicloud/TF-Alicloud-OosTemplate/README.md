...
1. Write the JSON schema describing your resource, `tf-alicloud-oostemplate.json`
2. Implement your resource handlers in `tf_alicloud_oostemplate/handlers.py`
