...
1. Write the JSON schema describing your resource, `terraform-alicloud-dbconnection.json`
2. Implement your resource handlers in `terraform_alicloud_dbconnection/handlers.py`
