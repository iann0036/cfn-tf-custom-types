...
1. Write the JSON schema describing your resource, `terraform-alicloud-actiontrail.json`
2. Implement your resource handlers in `terraform_alicloud_actiontrail/handlers.py`
