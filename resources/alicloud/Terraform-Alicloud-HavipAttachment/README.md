...
1. Write the JSON schema describing your resource, `terraform-alicloud-havipattachment.json`
2. Implement your resource handlers in `terraform_alicloud_havipattachment/handlers.py`
