...
1. Write the JSON schema describing your resource, `tf-alicloud-slbloadbalancer.json`
2. Implement your resource handlers in `tf_alicloud_slbloadbalancer/handlers.py`
