...
1. Write the JSON schema describing your resource, `terraform-alicloud-fctrigger.json`
2. Implement your resource handlers in `terraform_alicloud_fctrigger/handlers.py`
