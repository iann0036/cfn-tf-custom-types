...
1. Write the JSON schema describing your resource, `terraform-alicloud-ddoscooinstance.json`
2. Implement your resource handlers in `terraform_alicloud_ddoscooinstance/handlers.py`
