...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerresourceshare.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerresourceshare/handlers.py`
