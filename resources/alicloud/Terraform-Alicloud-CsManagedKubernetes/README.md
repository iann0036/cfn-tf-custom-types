...
1. Write the JSON schema describing your resource, `terraform-alicloud-csmanagedkubernetes.json`
2. Implement your resource handlers in `terraform_alicloud_csmanagedkubernetes/handlers.py`
