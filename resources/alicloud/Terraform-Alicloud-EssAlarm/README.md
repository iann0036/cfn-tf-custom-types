...
1. Write the JSON schema describing your resource, `terraform-alicloud-essalarm.json`
2. Implement your resource handlers in `terraform_alicloud_essalarm/handlers.py`
