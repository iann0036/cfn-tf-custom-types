...
1. Write the JSON schema describing your resource, `tf-alicloud-dnsdomainattachment.json`
2. Implement your resource handlers in `tf_alicloud_dnsdomainattachment/handlers.py`
