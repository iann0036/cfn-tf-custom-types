...
1. Write the JSON schema describing your resource, `terraform-alicloud-cenrouteentry.json`
2. Implement your resource handlers in `terraform_alicloud_cenrouteentry/handlers.py`
