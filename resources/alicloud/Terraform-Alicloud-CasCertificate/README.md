...
1. Write the JSON schema describing your resource, `terraform-alicloud-cascertificate.json`
2. Implement your resource handlers in `terraform_alicloud_cascertificate/handlers.py`
