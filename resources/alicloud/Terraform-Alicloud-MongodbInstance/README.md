...
1. Write the JSON schema describing your resource, `terraform-alicloud-mongodbinstance.json`
2. Implement your resource handlers in `terraform_alicloud_mongodbinstance/handlers.py`
