...
1. Write the JSON schema describing your resource, `tf-alicloud-cenbandwidthpackageattachment.json`
2. Implement your resource handlers in `tf_alicloud_cenbandwidthpackageattachment/handlers.py`
