...
1. Write the JSON schema describing your resource, `terraform-alicloud-cenbandwidthlimit.json`
2. Implement your resource handlers in `terraform_alicloud_cenbandwidthlimit/handlers.py`
