...
1. Write the JSON schema describing your resource, `terraform-alicloud-logtailattachment.json`
2. Implement your resource handlers in `terraform_alicloud_logtailattachment/handlers.py`
