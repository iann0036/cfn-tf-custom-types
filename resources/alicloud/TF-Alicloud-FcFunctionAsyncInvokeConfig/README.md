...
1. Write the JSON schema describing your resource, `tf-alicloud-fcfunctionasyncinvokeconfig.json`
2. Implement your resource handlers in `tf_alicloud_fcfunctionasyncinvokeconfig/handlers.py`
