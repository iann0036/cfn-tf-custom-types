...
1. Write the JSON schema describing your resource, `terraform-alicloud-datahubtopic.json`
2. Implement your resource handlers in `terraform_alicloud_datahubtopic/handlers.py`
