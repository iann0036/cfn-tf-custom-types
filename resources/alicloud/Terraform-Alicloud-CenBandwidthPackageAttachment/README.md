...
1. Write the JSON schema describing your resource, `terraform-alicloud-cenbandwidthpackageattachment.json`
2. Implement your resource handlers in `terraform_alicloud_cenbandwidthpackageattachment/handlers.py`
