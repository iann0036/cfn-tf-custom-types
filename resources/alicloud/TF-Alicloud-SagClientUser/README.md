...
1. Write the JSON schema describing your resource, `tf-alicloud-sagclientuser.json`
2. Implement your resource handlers in `tf_alicloud_sagclientuser/handlers.py`
