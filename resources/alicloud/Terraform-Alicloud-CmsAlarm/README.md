...
1. Write the JSON schema describing your resource, `terraform-alicloud-cmsalarm.json`
2. Implement your resource handlers in `terraform_alicloud_cmsalarm/handlers.py`
