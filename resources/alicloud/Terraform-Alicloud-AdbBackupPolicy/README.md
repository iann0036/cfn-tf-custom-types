...
1. Write the JSON schema describing your resource, `terraform-alicloud-adbbackuppolicy.json`
2. Implement your resource handlers in `terraform_alicloud_adbbackuppolicy/handlers.py`
