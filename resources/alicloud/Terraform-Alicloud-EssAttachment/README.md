...
1. Write the JSON schema describing your resource, `terraform-alicloud-essattachment.json`
2. Implement your resource handlers in `terraform_alicloud_essattachment/handlers.py`
