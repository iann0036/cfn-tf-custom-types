...
1. Write the JSON schema describing your resource, `tf-alicloud-quotasapplicationinfo.json`
2. Implement your resource handlers in `tf_alicloud_quotasapplicationinfo/handlers.py`
