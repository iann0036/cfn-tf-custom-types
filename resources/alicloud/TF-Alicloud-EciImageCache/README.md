...
1. Write the JSON schema describing your resource, `tf-alicloud-eciimagecache.json`
2. Implement your resource handlers in `tf_alicloud_eciimagecache/handlers.py`
