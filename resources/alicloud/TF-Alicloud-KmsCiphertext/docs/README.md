...
<pre>
{
    "Type" : "TF::Alicloud::KmsCiphertext",
    "Properties" : {
        "<a href="#encryptioncontext" title="EncryptionContext">EncryptionContext</a>" : <i>[ <a href="encryptioncontextdefinition.md">EncryptionContextDefinition</a>, ... ]</i>,
...
Properties:
    <a href="#encryptioncontext" title="EncryptionContext">EncryptionContext</a>: <i>
      - <a href="encryptioncontextdefinition.md">EncryptionContextDefinition</a></i>
    <a href="#keyid" title="KeyId">KeyId</a>: <i>String</i>
    <a href="#plaintext" title="Plaintext">Plaintext</a>: <i>String</i>
</pre>
...
_Type_: List of <a href="encryptioncontextdefinition.md">EncryptionContextDefinition</a>
