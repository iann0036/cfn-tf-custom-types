...
1. Write the JSON schema describing your resource, `tf-alicloud-kmsciphertext.json`
2. Implement your resource handlers in `tf_alicloud_kmsciphertext/handlers.py`
