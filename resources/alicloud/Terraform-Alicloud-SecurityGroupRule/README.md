...
1. Write the JSON schema describing your resource, `terraform-alicloud-securitygrouprule.json`
2. Implement your resource handlers in `terraform_alicloud_securitygrouprule/handlers.py`
