...
1. Write the JSON schema describing your resource, `terraform-alicloud-essnotification.json`
2. Implement your resource handlers in `terraform_alicloud_essnotification/handlers.py`
