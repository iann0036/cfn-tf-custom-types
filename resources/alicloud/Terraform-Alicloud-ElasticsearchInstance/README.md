...
1. Write the JSON schema describing your resource, `terraform-alicloud-elasticsearchinstance.json`
2. Implement your resource handlers in `terraform_alicloud_elasticsearchinstance/handlers.py`
