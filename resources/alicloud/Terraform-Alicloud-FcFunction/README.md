...
1. Write the JSON schema describing your resource, `terraform-alicloud-fcfunction.json`
2. Implement your resource handlers in `terraform_alicloud_fcfunction/handlers.py`
