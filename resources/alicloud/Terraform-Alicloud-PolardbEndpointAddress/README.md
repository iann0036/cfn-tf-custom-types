...
1. Write the JSON schema describing your resource, `terraform-alicloud-polardbendpointaddress.json`
2. Implement your resource handlers in `terraform_alicloud_polardbendpointaddress/handlers.py`
