...
1. Write the JSON schema describing your resource, `terraform-alicloud-kmskey.json`
2. Implement your resource handlers in `terraform_alicloud_kmskey/handlers.py`
