...
1. Write the JSON schema describing your resource, `tf-alicloud-networkinterfaceattachment.json`
2. Implement your resource handlers in `tf_alicloud_networkinterfaceattachment/handlers.py`
