...
1. Write the JSON schema describing your resource, `terraform-alicloud-vswitch.json`
2. Implement your resource handlers in `terraform_alicloud_vswitch/handlers.py`
