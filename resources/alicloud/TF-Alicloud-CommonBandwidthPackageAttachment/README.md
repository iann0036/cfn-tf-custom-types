...
1. Write the JSON schema describing your resource, `tf-alicloud-commonbandwidthpackageattachment.json`
2. Implement your resource handlers in `tf_alicloud_commonbandwidthpackageattachment/handlers.py`
