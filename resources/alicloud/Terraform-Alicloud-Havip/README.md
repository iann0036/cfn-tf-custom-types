...
1. Write the JSON schema describing your resource, `terraform-alicloud-havip.json`
2. Implement your resource handlers in `terraform_alicloud_havip/handlers.py`
