...
1. Write the JSON schema describing your resource, `terraform-alicloud-logmachinegroup.json`
2. Implement your resource handlers in `terraform_alicloud_logmachinegroup/handlers.py`
