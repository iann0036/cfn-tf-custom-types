# TF::Alicloud::DrdsInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-drdsinstance.json`
2. Implement your resource handlers in `tf_alicloud_drdsinstance/handlers.py`
