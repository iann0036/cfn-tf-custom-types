...
1. Write the JSON schema describing your resource, `terraform-alicloud-ramuser.json`
2. Implement your resource handlers in `terraform_alicloud_ramuser/handlers.py`
