...
1. Write the JSON schema describing your resource, `terraform-alicloud-vpngateway.json`
2. Implement your resource handlers in `terraform_alicloud_vpngateway/handlers.py`
