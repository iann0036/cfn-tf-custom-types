...
1. Write the JSON schema describing your resource, `tf-alicloud-csmanagedkubernetes.json`
2. Implement your resource handlers in `tf_alicloud_csmanagedkubernetes/handlers.py`
