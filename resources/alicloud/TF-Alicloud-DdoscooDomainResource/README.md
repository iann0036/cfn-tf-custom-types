...
1. Write the JSON schema describing your resource, `tf-alicloud-ddoscoodomainresource.json`
2. Implement your resource handlers in `tf_alicloud_ddoscoodomainresource/handlers.py`
