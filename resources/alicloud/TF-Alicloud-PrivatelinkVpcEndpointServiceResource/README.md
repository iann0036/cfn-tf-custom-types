# TF::Alicloud::PrivatelinkVpcEndpointServiceResource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-privatelinkvpcendpointserviceresource.json`
2. Implement your resource handlers in `tf_alicloud_privatelinkvpcendpointserviceresource/handlers.py`
