...
1. Write the JSON schema describing your resource, `tf-alicloud-eciopenapiimagecache.json`
2. Implement your resource handlers in `tf_alicloud_eciopenapiimagecache/handlers.py`
