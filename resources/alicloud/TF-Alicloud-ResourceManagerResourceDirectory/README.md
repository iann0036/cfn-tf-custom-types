...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerresourcedirectory.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerresourcedirectory/handlers.py`
