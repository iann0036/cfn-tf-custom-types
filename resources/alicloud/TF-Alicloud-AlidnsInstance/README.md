...
1. Write the JSON schema describing your resource, `tf-alicloud-alidnsinstance.json`
2. Implement your resource handlers in `tf_alicloud_alidnsinstance/handlers.py`
