...
1. Write the JSON schema describing your resource, `terraform-alicloud-cmssitemonitor.json`
2. Implement your resource handlers in `terraform_alicloud_cmssitemonitor/handlers.py`
