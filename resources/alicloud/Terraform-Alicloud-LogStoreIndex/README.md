...
1. Write the JSON schema describing your resource, `terraform-alicloud-logstoreindex.json`
2. Implement your resource handlers in `terraform_alicloud_logstoreindex/handlers.py`
