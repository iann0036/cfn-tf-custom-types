...
1. Write the JSON schema describing your resource, `tf-alicloud-tsdbinstance.json`
2. Implement your resource handlers in `tf_alicloud_tsdbinstance/handlers.py`
