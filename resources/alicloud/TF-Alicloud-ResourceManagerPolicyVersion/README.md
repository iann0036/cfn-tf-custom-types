...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerpolicyversion.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerpolicyversion/handlers.py`
