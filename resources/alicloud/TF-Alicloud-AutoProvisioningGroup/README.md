...
1. Write the JSON schema describing your resource, `tf-alicloud-autoprovisioninggroup.json`
2. Implement your resource handlers in `tf_alicloud_autoprovisioninggroup/handlers.py`
