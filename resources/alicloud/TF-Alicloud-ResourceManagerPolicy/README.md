...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerpolicy.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerpolicy/handlers.py`
