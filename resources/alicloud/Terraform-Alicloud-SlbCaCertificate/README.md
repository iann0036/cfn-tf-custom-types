...
1. Write the JSON schema describing your resource, `terraform-alicloud-slbcacertificate.json`
2. Implement your resource handlers in `terraform_alicloud_slbcacertificate/handlers.py`
