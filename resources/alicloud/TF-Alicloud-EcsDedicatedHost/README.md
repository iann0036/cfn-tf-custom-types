...
1. Write the JSON schema describing your resource, `tf-alicloud-ecsdedicatedhost.json`
2. Implement your resource handlers in `tf_alicloud_ecsdedicatedhost/handlers.py`
