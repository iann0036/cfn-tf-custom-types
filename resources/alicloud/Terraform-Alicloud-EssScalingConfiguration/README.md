...
1. Write the JSON schema describing your resource, `terraform-alicloud-essscalingconfiguration.json`
2. Implement your resource handlers in `terraform_alicloud_essscalingconfiguration/handlers.py`
