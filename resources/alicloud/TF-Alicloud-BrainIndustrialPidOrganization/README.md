# TF::Alicloud::BrainIndustrialPidOrganization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-alicloud-brainindustrialpidorganization.json`
2. Implement your resource handlers in `tf_alicloud_brainindustrialpidorganization/handlers.py`
