...
1. Write the JSON schema describing your resource, `terraform-alicloud-otstable.json`
2. Implement your resource handlers in `terraform_alicloud_otstable/handlers.py`
