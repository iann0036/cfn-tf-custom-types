...
1. Write the JSON schema describing your resource, `terraform-alicloud-alikafkaconsumergroup.json`
2. Implement your resource handlers in `terraform_alicloud_alikafkaconsumergroup/handlers.py`
