...
1. Write the JSON schema describing your resource, `tf-alicloud-resourcemanagerpolicyattachment.json`
2. Implement your resource handlers in `tf_alicloud_resourcemanagerpolicyattachment/handlers.py`
