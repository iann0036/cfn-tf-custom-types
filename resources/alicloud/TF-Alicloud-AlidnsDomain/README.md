...
1. Write the JSON schema describing your resource, `tf-alicloud-alidnsdomain.json`
2. Implement your resource handlers in `tf_alicloud_alidnsdomain/handlers.py`
