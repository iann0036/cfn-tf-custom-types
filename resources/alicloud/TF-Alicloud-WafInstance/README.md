...
1. Write the JSON schema describing your resource, `tf-alicloud-wafinstance.json`
2. Implement your resource handlers in `tf_alicloud_wafinstance/handlers.py`
