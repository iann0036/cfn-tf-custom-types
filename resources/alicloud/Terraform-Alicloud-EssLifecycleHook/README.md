...
1. Write the JSON schema describing your resource, `terraform-alicloud-esslifecyclehook.json`
2. Implement your resource handlers in `terraform_alicloud_esslifecyclehook/handlers.py`
