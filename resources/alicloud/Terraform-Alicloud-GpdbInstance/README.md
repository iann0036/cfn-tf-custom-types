...
1. Write the JSON schema describing your resource, `terraform-alicloud-gpdbinstance.json`
2. Implement your resource handlers in `terraform_alicloud_gpdbinstance/handlers.py`
