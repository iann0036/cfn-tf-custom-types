...
1. Write the JSON schema describing your resource, `terraform-alicloud-snatentry.json`
2. Implement your resource handlers in `terraform_alicloud_snatentry/handlers.py`
