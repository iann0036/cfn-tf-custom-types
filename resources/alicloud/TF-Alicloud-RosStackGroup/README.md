...
1. Write the JSON schema describing your resource, `tf-alicloud-rosstackgroup.json`
2. Implement your resource handlers in `tf_alicloud_rosstackgroup/handlers.py`
