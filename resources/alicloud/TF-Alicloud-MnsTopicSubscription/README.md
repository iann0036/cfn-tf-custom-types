...
1. Write the JSON schema describing your resource, `tf-alicloud-mnstopicsubscription.json`
2. Implement your resource handlers in `tf_alicloud_mnstopicsubscription/handlers.py`
