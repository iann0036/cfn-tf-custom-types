...
1. Write the JSON schema describing your resource, `tf-nutanix-virtualmachine.json`
2. Implement your resource handlers in `tf_nutanix_virtualmachine/handlers.py`
