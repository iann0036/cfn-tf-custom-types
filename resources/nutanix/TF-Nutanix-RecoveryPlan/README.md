...
1. Write the JSON schema describing your resource, `tf-nutanix-recoveryplan.json`
2. Implement your resource handlers in `tf_nutanix_recoveryplan/handlers.py`
