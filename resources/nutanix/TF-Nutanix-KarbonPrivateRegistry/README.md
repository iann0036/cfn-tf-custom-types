# TF::Nutanix::KarbonPrivateRegistry

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nutanix-karbonprivateregistry.json`
2. Implement your resource handlers in `tf_nutanix_karbonprivateregistry/handlers.py`
