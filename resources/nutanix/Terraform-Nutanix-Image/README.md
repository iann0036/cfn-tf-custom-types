...
1. Write the JSON schema describing your resource, `terraform-nutanix-image.json`
2. Implement your resource handlers in `terraform_nutanix_image/handlers.py`
