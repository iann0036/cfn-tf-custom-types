...
1. Write the JSON schema describing your resource, `terraform-nutanix-subnet.json`
2. Implement your resource handlers in `terraform_nutanix_subnet/handlers.py`
