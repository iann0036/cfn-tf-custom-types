...
1. Write the JSON schema describing your resource, `tf-nutanix-accesscontrolpolicy.json`
2. Implement your resource handlers in `tf_nutanix_accesscontrolpolicy/handlers.py`
