...
1. Write the JSON schema describing your resource, `tf-nutanix-protectionrule.json`
2. Implement your resource handlers in `tf_nutanix_protectionrule/handlers.py`
