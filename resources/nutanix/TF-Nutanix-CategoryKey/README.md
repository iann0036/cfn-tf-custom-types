# TF::Nutanix::CategoryKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nutanix-categorykey.json`
2. Implement your resource handlers in `tf_nutanix_categorykey/handlers.py`
