...
1. Write the JSON schema describing your resource, `terraform-nutanix-networksecurityrule.json`
2. Implement your resource handlers in `terraform_nutanix_networksecurityrule/handlers.py`
