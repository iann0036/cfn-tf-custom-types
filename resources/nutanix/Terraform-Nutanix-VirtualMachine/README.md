...
1. Write the JSON schema describing your resource, `terraform-nutanix-virtualmachine.json`
2. Implement your resource handlers in `terraform_nutanix_virtualmachine/handlers.py`
