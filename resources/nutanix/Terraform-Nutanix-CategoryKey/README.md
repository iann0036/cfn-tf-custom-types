...
1. Write the JSON schema describing your resource, `terraform-nutanix-categorykey.json`
2. Implement your resource handlers in `terraform_nutanix_categorykey/handlers.py`
