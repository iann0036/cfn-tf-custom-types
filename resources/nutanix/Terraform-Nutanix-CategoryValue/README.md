...
1. Write the JSON schema describing your resource, `terraform-nutanix-categoryvalue.json`
2. Implement your resource handlers in `terraform_nutanix_categoryvalue/handlers.py`
