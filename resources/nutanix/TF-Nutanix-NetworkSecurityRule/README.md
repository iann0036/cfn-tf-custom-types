...
1. Write the JSON schema describing your resource, `tf-nutanix-networksecurityrule.json`
2. Implement your resource handlers in `tf_nutanix_networksecurityrule/handlers.py`
