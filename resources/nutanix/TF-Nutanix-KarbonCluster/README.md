# TF::Nutanix::KarbonCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nutanix-karboncluster.json`
2. Implement your resource handlers in `tf_nutanix_karboncluster/handlers.py`
