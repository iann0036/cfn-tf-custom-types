...
1. Write the JSON schema describing your resource, `terraform-postgresql-defaultprivileges.json`
2. Implement your resource handlers in `terraform_postgresql_defaultprivileges/handlers.py`
