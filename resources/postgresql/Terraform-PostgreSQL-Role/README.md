...
1. Write the JSON schema describing your resource, `terraform-postgresql-role.json`
2. Implement your resource handlers in `terraform_postgresql_role/handlers.py`
