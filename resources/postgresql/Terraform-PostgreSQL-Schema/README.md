...
1. Write the JSON schema describing your resource, `terraform-postgresql-schema.json`
2. Implement your resource handlers in `terraform_postgresql_schema/handlers.py`
