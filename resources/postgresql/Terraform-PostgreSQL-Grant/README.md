...
1. Write the JSON schema describing your resource, `terraform-postgresql-grant.json`
2. Implement your resource handlers in `terraform_postgresql_grant/handlers.py`
