...
1. Write the JSON schema describing your resource, `terraform-postgresql-database.json`
2. Implement your resource handlers in `terraform_postgresql_database/handlers.py`
