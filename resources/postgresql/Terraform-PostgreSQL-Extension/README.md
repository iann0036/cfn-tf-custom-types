...
1. Write the JSON schema describing your resource, `terraform-postgresql-extension.json`
2. Implement your resource handlers in `terraform_postgresql_extension/handlers.py`
