# TF::CloudSigma::FirewallPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudsigma-firewallpolicy.json`
2. Implement your resource handlers in `tf_cloudsigma_firewallpolicy/handlers.py`
