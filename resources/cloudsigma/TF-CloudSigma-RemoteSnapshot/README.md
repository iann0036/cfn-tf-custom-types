# TF::CloudSigma::RemoteSnapshot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudsigma-remotesnapshot.json`
2. Implement your resource handlers in `tf_cloudsigma_remotesnapshot/handlers.py`
