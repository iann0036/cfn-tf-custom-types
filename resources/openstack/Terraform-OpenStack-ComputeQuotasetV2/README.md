...
1. Write the JSON schema describing your resource, `terraform-openstack-computequotasetv2.json`
2. Implement your resource handlers in `terraform_openstack_computequotasetv2/handlers.py`
