...
1. Write the JSON schema describing your resource, `terraform-openstack-computeinstancev2.json`
2. Implement your resource handlers in `terraform_openstack_computeinstancev2/handlers.py`
