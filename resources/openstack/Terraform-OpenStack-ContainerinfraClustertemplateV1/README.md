...
1. Write the JSON schema describing your resource, `terraform-openstack-containerinfraclustertemplatev1.json`
2. Implement your resource handlers in `terraform_openstack_containerinfraclustertemplatev1/handlers.py`
