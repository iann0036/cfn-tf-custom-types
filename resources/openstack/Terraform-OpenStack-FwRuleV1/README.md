...
1. Write the JSON schema describing your resource, `terraform-openstack-fwrulev1.json`
2. Implement your resource handlers in `terraform_openstack_fwrulev1/handlers.py`
