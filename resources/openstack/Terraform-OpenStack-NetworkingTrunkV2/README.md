...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingtrunkv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingtrunkv2/handlers.py`
