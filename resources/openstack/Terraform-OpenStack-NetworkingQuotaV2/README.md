...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingquotav2.json`
2. Implement your resource handlers in `terraform_openstack_networkingquotav2/handlers.py`
