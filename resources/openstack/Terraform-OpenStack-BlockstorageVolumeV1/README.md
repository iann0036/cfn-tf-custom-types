...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragevolumev1.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragevolumev1/handlers.py`
