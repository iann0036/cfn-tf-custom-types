...
1. Write the JSON schema describing your resource, `terraform-openstack-dbuserv1.json`
2. Implement your resource handlers in `terraform_openstack_dbuserv1/handlers.py`
