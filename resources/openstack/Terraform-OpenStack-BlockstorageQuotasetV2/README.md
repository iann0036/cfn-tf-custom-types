...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragequotasetv2.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragequotasetv2/handlers.py`
