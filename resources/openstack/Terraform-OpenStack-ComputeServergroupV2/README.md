...
1. Write the JSON schema describing your resource, `terraform-openstack-computeservergroupv2.json`
2. Implement your resource handlers in `terraform_openstack_computeservergroupv2/handlers.py`
