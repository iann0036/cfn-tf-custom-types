...
1. Write the JSON schema describing your resource, `terraform-openstack-lbvipv1.json`
2. Implement your resource handlers in `terraform_openstack_lbvipv1/handlers.py`
