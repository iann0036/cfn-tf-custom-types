...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingsubnetpoolv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingsubnetpoolv2/handlers.py`
