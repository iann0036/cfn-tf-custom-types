...
1. Write the JSON schema describing your resource, `terraform-openstack-dbinstancev1.json`
2. Implement your resource handlers in `terraform_openstack_dbinstancev1/handlers.py`
