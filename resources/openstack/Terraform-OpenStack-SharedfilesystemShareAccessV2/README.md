...
1. Write the JSON schema describing your resource, `terraform-openstack-sharedfilesystemshareaccessv2.json`
2. Implement your resource handlers in `terraform_openstack_sharedfilesystemshareaccessv2/handlers.py`
