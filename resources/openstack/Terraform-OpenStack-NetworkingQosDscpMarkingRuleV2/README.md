...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingqosdscpmarkingrulev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingqosdscpmarkingrulev2/handlers.py`
