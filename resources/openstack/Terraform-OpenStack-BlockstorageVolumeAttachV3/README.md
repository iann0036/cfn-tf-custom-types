...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragevolumeattachv3.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragevolumeattachv3/handlers.py`
