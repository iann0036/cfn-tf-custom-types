...
1. Write the JSON schema describing your resource, `terraform-openstack-identityapplicationcredentialv3.json`
2. Implement your resource handlers in `terraform_openstack_identityapplicationcredentialv3/handlers.py`
