...
1. Write the JSON schema describing your resource, `terraform-openstack-identityuserv3.json`
2. Implement your resource handlers in `terraform_openstack_identityuserv3/handlers.py`
