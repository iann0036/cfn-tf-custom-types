...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragevolumeattachv2.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragevolumeattachv2/handlers.py`
