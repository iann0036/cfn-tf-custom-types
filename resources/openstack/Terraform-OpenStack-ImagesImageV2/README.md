...
1. Write the JSON schema describing your resource, `terraform-openstack-imagesimagev2.json`
2. Implement your resource handlers in `terraform_openstack_imagesimagev2/handlers.py`
