...
1. Write the JSON schema describing your resource, `terraform-openstack-lbmonitorv1.json`
2. Implement your resource handlers in `terraform_openstack_lbmonitorv1/handlers.py`
