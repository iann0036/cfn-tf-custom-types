...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingrouterinterfacev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingrouterinterfacev2/handlers.py`
