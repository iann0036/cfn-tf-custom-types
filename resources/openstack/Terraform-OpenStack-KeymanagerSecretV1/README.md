...
1. Write the JSON schema describing your resource, `terraform-openstack-keymanagersecretv1.json`
2. Implement your resource handlers in `terraform_openstack_keymanagersecretv1/handlers.py`
