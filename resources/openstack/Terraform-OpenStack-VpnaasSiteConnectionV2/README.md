...
1. Write the JSON schema describing your resource, `terraform-openstack-vpnaassiteconnectionv2.json`
2. Implement your resource handlers in `terraform_openstack_vpnaassiteconnectionv2/handlers.py`
