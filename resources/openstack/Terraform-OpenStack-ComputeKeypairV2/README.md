...
1. Write the JSON schema describing your resource, `terraform-openstack-computekeypairv2.json`
2. Implement your resource handlers in `terraform_openstack_computekeypairv2/handlers.py`
