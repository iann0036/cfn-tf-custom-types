...
1. Write the JSON schema describing your resource, `terraform-openstack-sharedfilesystemsharev2.json`
2. Implement your resource handlers in `terraform_openstack_sharedfilesystemsharev2/handlers.py`
