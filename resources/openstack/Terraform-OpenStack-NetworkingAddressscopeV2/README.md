...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingaddressscopev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingaddressscopev2/handlers.py`
