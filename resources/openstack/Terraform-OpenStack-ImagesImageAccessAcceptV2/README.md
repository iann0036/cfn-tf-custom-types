...
1. Write the JSON schema describing your resource, `terraform-openstack-imagesimageaccessacceptv2.json`
2. Implement your resource handlers in `terraform_openstack_imagesimageaccessacceptv2/handlers.py`
