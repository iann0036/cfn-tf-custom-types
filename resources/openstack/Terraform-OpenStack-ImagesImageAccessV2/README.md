...
1. Write the JSON schema describing your resource, `terraform-openstack-imagesimageaccessv2.json`
2. Implement your resource handlers in `terraform_openstack_imagesimageaccessv2/handlers.py`
