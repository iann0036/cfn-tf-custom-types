...
1. Write the JSON schema describing your resource, `terraform-openstack-lbl7rulev2.json`
2. Implement your resource handlers in `terraform_openstack_lbl7rulev2/handlers.py`
