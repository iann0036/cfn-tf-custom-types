...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingfloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingfloatingipassociatev2/handlers.py`
