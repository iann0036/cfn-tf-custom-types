...
1. Write the JSON schema describing your resource, `terraform-openstack-identityroleassignmentv3.json`
2. Implement your resource handlers in `terraform_openstack_identityroleassignmentv3/handlers.py`
