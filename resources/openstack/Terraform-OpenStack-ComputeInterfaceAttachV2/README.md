...
1. Write the JSON schema describing your resource, `terraform-openstack-computeinterfaceattachv2.json`
2. Implement your resource handlers in `terraform_openstack_computeinterfaceattachv2/handlers.py`
