...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingqosminimumbandwidthrulev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingqosminimumbandwidthrulev2/handlers.py`
