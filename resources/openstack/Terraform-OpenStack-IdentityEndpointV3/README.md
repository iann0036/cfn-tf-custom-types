...
1. Write the JSON schema describing your resource, `terraform-openstack-identityendpointv3.json`
2. Implement your resource handlers in `terraform_openstack_identityendpointv3/handlers.py`
