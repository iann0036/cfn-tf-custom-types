...
1. Write the JSON schema describing your resource, `terraform-openstack-identityprojectv3.json`
2. Implement your resource handlers in `terraform_openstack_identityprojectv3/handlers.py`
