...
1. Write the JSON schema describing your resource, `terraform-openstack-lblistenerv2.json`
2. Implement your resource handlers in `terraform_openstack_lblistenerv2/handlers.py`
