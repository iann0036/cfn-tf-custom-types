...
1. Write the JSON schema describing your resource, `terraform-openstack-identityservicev3.json`
2. Implement your resource handlers in `terraform_openstack_identityservicev3/handlers.py`
