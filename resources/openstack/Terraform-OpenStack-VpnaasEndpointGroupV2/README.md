...
1. Write the JSON schema describing your resource, `terraform-openstack-vpnaasendpointgroupv2.json`
2. Implement your resource handlers in `terraform_openstack_vpnaasendpointgroupv2/handlers.py`
