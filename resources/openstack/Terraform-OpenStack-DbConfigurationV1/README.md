...
1. Write the JSON schema describing your resource, `terraform-openstack-dbconfigurationv1.json`
2. Implement your resource handlers in `terraform_openstack_dbconfigurationv1/handlers.py`
