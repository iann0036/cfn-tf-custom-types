...
1. Write the JSON schema describing your resource, `terraform-openstack-lbmonitorv2.json`
2. Implement your resource handlers in `terraform_openstack_lbmonitorv2/handlers.py`
