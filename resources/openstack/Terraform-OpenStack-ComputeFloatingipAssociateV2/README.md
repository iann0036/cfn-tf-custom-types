...
1. Write the JSON schema describing your resource, `terraform-openstack-computefloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_openstack_computefloatingipassociatev2/handlers.py`
