...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingqosbandwidthlimitrulev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingqosbandwidthlimitrulev2/handlers.py`
