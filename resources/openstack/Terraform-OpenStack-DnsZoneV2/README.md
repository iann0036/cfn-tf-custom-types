...
1. Write the JSON schema describing your resource, `terraform-openstack-dnszonev2.json`
2. Implement your resource handlers in `terraform_openstack_dnszonev2/handlers.py`
