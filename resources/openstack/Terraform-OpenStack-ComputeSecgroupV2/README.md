...
1. Write the JSON schema describing your resource, `terraform-openstack-computesecgroupv2.json`
2. Implement your resource handlers in `terraform_openstack_computesecgroupv2/handlers.py`
