...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingnetworkv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingnetworkv2/handlers.py`
