...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingsubnetv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingsubnetv2/handlers.py`
