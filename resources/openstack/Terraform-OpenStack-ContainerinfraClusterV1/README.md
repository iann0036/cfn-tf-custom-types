...
1. Write the JSON schema describing your resource, `terraform-openstack-containerinfraclusterv1.json`
2. Implement your resource handlers in `terraform_openstack_containerinfraclusterv1/handlers.py`
