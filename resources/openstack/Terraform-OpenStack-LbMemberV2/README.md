...
1. Write the JSON schema describing your resource, `terraform-openstack-lbmemberv2.json`
2. Implement your resource handlers in `terraform_openstack_lbmemberv2/handlers.py`
