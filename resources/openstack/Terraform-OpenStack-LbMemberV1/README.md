...
1. Write the JSON schema describing your resource, `terraform-openstack-lbmemberv1.json`
2. Implement your resource handlers in `terraform_openstack_lbmemberv1/handlers.py`
