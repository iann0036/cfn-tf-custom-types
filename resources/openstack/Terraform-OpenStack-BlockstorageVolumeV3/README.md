...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragevolumev3.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragevolumev3/handlers.py`
