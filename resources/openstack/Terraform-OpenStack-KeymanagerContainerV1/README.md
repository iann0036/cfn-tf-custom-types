...
1. Write the JSON schema describing your resource, `terraform-openstack-keymanagercontainerv1.json`
2. Implement your resource handlers in `terraform_openstack_keymanagercontainerv1/handlers.py`
