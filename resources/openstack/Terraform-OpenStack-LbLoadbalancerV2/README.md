...
1. Write the JSON schema describing your resource, `terraform-openstack-lbloadbalancerv2.json`
2. Implement your resource handlers in `terraform_openstack_lbloadbalancerv2/handlers.py`
