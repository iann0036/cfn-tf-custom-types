...
1. Write the JSON schema describing your resource, `terraform-openstack-dnsrecordsetv2.json`
2. Implement your resource handlers in `terraform_openstack_dnsrecordsetv2/handlers.py`
