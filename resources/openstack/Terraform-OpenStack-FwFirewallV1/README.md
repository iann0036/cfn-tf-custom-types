...
1. Write the JSON schema describing your resource, `terraform-openstack-fwfirewallv1.json`
2. Implement your resource handlers in `terraform_openstack_fwfirewallv1/handlers.py`
