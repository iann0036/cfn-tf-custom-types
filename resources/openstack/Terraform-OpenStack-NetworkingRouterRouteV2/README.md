# Terraform::OpenStack::NetworkingRouterRouteV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-openstack-networkingrouterroutev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingrouterroutev2/handlers.py`
