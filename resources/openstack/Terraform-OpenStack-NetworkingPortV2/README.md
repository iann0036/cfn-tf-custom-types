...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingportv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingportv2/handlers.py`
