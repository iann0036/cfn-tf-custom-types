...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingqospolicyv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingqospolicyv2/handlers.py`
