...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragevolumev2.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragevolumev2/handlers.py`
