...
1. Write the JSON schema describing your resource, `terraform-openstack-computefloatingipv2.json`
2. Implement your resource handlers in `terraform_openstack_computefloatingipv2/handlers.py`
