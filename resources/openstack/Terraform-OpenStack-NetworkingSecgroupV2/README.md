...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingsecgroupv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingsecgroupv2/handlers.py`
