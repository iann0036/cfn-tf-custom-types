...
1. Write the JSON schema describing your resource, `terraform-openstack-orchestrationstackv1.json`
2. Implement your resource handlers in `terraform_openstack_orchestrationstackv1/handlers.py`
