...
1. Write the JSON schema describing your resource, `terraform-openstack-objectstorageobjectv1.json`
2. Implement your resource handlers in `terraform_openstack_objectstorageobjectv1/handlers.py`
