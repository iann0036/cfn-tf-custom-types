...
1. Write the JSON schema describing your resource, `terraform-openstack-objectstoragetempurlv1.json`
2. Implement your resource handlers in `terraform_openstack_objectstoragetempurlv1/handlers.py`
