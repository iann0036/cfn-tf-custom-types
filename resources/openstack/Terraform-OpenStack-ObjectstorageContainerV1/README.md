...
1. Write the JSON schema describing your resource, `terraform-openstack-objectstoragecontainerv1.json`
2. Implement your resource handlers in `terraform_openstack_objectstoragecontainerv1/handlers.py`
