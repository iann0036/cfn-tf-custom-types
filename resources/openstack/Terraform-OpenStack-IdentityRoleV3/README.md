...
1. Write the JSON schema describing your resource, `terraform-openstack-identityrolev3.json`
2. Implement your resource handlers in `terraform_openstack_identityrolev3/handlers.py`
