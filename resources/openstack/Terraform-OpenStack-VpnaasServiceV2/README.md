...
1. Write the JSON schema describing your resource, `terraform-openstack-vpnaasservicev2.json`
2. Implement your resource handlers in `terraform_openstack_vpnaasservicev2/handlers.py`
