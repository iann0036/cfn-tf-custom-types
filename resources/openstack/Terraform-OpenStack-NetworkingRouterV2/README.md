...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingrouterv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingrouterv2/handlers.py`
