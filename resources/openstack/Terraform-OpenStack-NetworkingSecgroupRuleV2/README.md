...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingsecgrouprulev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingsecgrouprulev2/handlers.py`
