...
1. Write the JSON schema describing your resource, `terraform-openstack-vpnaasipsecpolicyv2.json`
2. Implement your resource handlers in `terraform_openstack_vpnaasipsecpolicyv2/handlers.py`
