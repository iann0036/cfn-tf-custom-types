...
1. Write the JSON schema describing your resource, `terraform-openstack-dbdatabasev1.json`
2. Implement your resource handlers in `terraform_openstack_dbdatabasev1/handlers.py`
