...
1. Write the JSON schema describing your resource, `terraform-openstack-lbpoolv1.json`
2. Implement your resource handlers in `terraform_openstack_lbpoolv1/handlers.py`
