...
1. Write the JSON schema describing your resource, `terraform-openstack-fwpolicyv1.json`
2. Implement your resource handlers in `terraform_openstack_fwpolicyv1/handlers.py`
