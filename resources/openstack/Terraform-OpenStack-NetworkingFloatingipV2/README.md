...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingfloatingipv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingfloatingipv2/handlers.py`
