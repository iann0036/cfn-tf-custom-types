# Terraform::OpenStack::ComputeVolumeAttachV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-openstack-computevolumeattachv2.json`
2. Implement your resource handlers in `terraform_openstack_computevolumeattachv2/handlers.py`
