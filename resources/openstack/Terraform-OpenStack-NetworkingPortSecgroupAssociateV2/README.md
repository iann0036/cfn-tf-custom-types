...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingportsecgroupassociatev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingportsecgroupassociatev2/handlers.py`
