...
1. Write the JSON schema describing your resource, `terraform-openstack-sharedfilesystemsecurityservicev2.json`
2. Implement your resource handlers in `terraform_openstack_sharedfilesystemsecurityservicev2/handlers.py`
