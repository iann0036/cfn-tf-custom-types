...
1. Write the JSON schema describing your resource, `terraform-openstack-lbl7policyv2.json`
2. Implement your resource handlers in `terraform_openstack_lbl7policyv2/handlers.py`
