...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingsubnetroutev2.json`
2. Implement your resource handlers in `terraform_openstack_networkingsubnetroutev2/handlers.py`
