...
1. Write the JSON schema describing your resource, `terraform-openstack-sharedfilesystemsharenetworkv2.json`
2. Implement your resource handlers in `terraform_openstack_sharedfilesystemsharenetworkv2/handlers.py`
