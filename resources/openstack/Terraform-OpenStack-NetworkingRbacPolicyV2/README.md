...
1. Write the JSON schema describing your resource, `terraform-openstack-networkingrbacpolicyv2.json`
2. Implement your resource handlers in `terraform_openstack_networkingrbacpolicyv2/handlers.py`
