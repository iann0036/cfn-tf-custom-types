...
1. Write the JSON schema describing your resource, `terraform-openstack-vpnaasikepolicyv2.json`
2. Implement your resource handlers in `terraform_openstack_vpnaasikepolicyv2/handlers.py`
