...
1. Write the JSON schema describing your resource, `terraform-openstack-computeflavoraccessv2.json`
2. Implement your resource handlers in `terraform_openstack_computeflavoraccessv2/handlers.py`
