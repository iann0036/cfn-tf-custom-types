...
1. Write the JSON schema describing your resource, `terraform-openstack-blockstoragequotasetv3.json`
2. Implement your resource handlers in `terraform_openstack_blockstoragequotasetv3/handlers.py`
