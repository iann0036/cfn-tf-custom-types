...
1. Write the JSON schema describing your resource, `terraform-openstack-computeflavorv2.json`
2. Implement your resource handlers in `terraform_openstack_computeflavorv2/handlers.py`
