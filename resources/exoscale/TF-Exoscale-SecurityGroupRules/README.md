...
1. Write the JSON schema describing your resource, `tf-exoscale-securitygrouprules.json`
2. Implement your resource handlers in `tf_exoscale_securitygrouprules/handlers.py`
