# TF::Exoscale::Affinity

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-exoscale-affinity.json`
2. Implement your resource handlers in `tf_exoscale_affinity/handlers.py`
