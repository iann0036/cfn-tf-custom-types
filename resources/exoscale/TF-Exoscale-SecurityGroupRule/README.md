...
1. Write the JSON schema describing your resource, `tf-exoscale-securitygrouprule.json`
2. Implement your resource handlers in `tf_exoscale_securitygrouprule/handlers.py`
