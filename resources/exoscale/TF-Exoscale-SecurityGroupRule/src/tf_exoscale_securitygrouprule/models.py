...
class ResourceModel(BaseModel):
    ...
    Type: Optional[str]
    UserSecurityGroup: Optional[str]
    UserSecurityGroupId: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            UserSecurityGroup=json_data.get("UserSecurityGroup"),
            UserSecurityGroupId=json_data.get("UserSecurityGroupId"),
