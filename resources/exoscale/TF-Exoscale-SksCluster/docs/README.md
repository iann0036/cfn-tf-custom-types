...
<pre>
{
    "Type" : "TF::Exoscale::SksCluster",
    "Properties" : {
        "<a href="#addons" title="Addons">Addons</a>" : <i>[ String, ... ]</i>,
        "<a href="#cni" title="Cni">Cni</a>" : <i>String</i>,
        "<a href="#description" title="Description">Description</a>" : <i>String</i>,
        "<a href="#exoscaleccm" title="ExoscaleCcm">ExoscaleCcm</a>" : <i>Boolean</i>,
        "<a href="#metricsserver" title="MetricsServer">MetricsServer</a>" : <i>Boolean</i>,
...
Returns the <code>Nodepools</code> value.
