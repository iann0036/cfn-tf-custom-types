...
1. Write the JSON schema describing your resource, `tf-exoscale-instancepool.json`
2. Implement your resource handlers in `tf_exoscale_instancepool/handlers.py`
