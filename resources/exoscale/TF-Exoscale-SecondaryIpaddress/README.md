...
1. Write the JSON schema describing your resource, `tf-exoscale-secondaryipaddress.json`
2. Implement your resource handlers in `tf_exoscale_secondaryipaddress/handlers.py`
