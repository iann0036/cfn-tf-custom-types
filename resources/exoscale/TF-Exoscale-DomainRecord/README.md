...
1. Write the JSON schema describing your resource, `tf-exoscale-domainrecord.json`
2. Implement your resource handlers in `tf_exoscale_domainrecord/handlers.py`
