# TF::Exoscale::SecurityGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-exoscale-securitygroup.json`
2. Implement your resource handlers in `tf_exoscale_securitygroup/handlers.py`
