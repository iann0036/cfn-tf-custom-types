...
1. Write the JSON schema describing your resource, `tf-exoscale-sksnodepool.json`
2. Implement your resource handlers in `tf_exoscale_sksnodepool/handlers.py`
