# TF::Exoscale::SshKeypair

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-exoscale-sshkeypair.json`
2. Implement your resource handlers in `tf_exoscale_sshkeypair/handlers.py`
