# TF::Tfe::RegistryModule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tfe-registrymodule.json`
2. Implement your resource handlers in `tf_tfe_registrymodule/handlers.py`
