...
1. Write the JSON schema describing your resource, `terraform-tfe-workspace.json`
2. Implement your resource handlers in `terraform_tfe_workspace/handlers.py`
