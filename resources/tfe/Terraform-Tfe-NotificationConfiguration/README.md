...
1. Write the JSON schema describing your resource, `terraform-tfe-notificationconfiguration.json`
2. Implement your resource handlers in `terraform_tfe_notificationconfiguration/handlers.py`
