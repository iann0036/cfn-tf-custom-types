...
1. Write the JSON schema describing your resource, `terraform-tfe-teammembers.json`
2. Implement your resource handlers in `terraform_tfe_teammembers/handlers.py`
