...
1. Write the JSON schema describing your resource, `tf-tfe-notificationconfiguration.json`
2. Implement your resource handlers in `tf_tfe_notificationconfiguration/handlers.py`
