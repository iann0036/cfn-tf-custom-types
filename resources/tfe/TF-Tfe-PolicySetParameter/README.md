...
1. Write the JSON schema describing your resource, `tf-tfe-policysetparameter.json`
2. Implement your resource handlers in `tf_tfe_policysetparameter/handlers.py`
