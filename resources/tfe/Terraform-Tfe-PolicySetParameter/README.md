...
1. Write the JSON schema describing your resource, `terraform-tfe-policysetparameter.json`
2. Implement your resource handlers in `terraform_tfe_policysetparameter/handlers.py`
