...
1. Write the JSON schema describing your resource, `terraform-tfe-teamtoken.json`
2. Implement your resource handlers in `terraform_tfe_teamtoken/handlers.py`
