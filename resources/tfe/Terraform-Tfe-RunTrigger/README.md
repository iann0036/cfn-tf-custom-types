...
1. Write the JSON schema describing your resource, `terraform-tfe-runtrigger.json`
2. Implement your resource handlers in `terraform_tfe_runtrigger/handlers.py`
