# TF::Tfe::SentinelPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tfe-sentinelpolicy.json`
2. Implement your resource handlers in `tf_tfe_sentinelpolicy/handlers.py`
