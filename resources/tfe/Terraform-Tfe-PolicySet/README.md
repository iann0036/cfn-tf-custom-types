...
1. Write the JSON schema describing your resource, `terraform-tfe-policyset.json`
2. Implement your resource handlers in `terraform_tfe_policyset/handlers.py`
