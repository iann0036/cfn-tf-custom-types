...
1. Write the JSON schema describing your resource, `tf-tfe-teamorganizationmember.json`
2. Implement your resource handlers in `tf_tfe_teamorganizationmember/handlers.py`
