...
1. Write the JSON schema describing your resource, `terraform-tfe-teammember.json`
2. Implement your resource handlers in `terraform_tfe_teammember/handlers.py`
