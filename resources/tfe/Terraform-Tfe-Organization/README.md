...
1. Write the JSON schema describing your resource, `terraform-tfe-organization.json`
2. Implement your resource handlers in `terraform_tfe_organization/handlers.py`
