...
1. Write the JSON schema describing your resource, `terraform-tfe-teamaccess.json`
2. Implement your resource handlers in `terraform_tfe_teamaccess/handlers.py`
