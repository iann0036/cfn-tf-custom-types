...
1. Write the JSON schema describing your resource, `terraform-tfe-organizationtoken.json`
2. Implement your resource handlers in `terraform_tfe_organizationtoken/handlers.py`
