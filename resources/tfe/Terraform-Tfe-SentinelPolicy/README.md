...
1. Write the JSON schema describing your resource, `terraform-tfe-sentinelpolicy.json`
2. Implement your resource handlers in `terraform_tfe_sentinelpolicy/handlers.py`
