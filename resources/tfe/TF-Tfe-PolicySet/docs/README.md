...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#workspaceids" title="WorkspaceIds">WorkspaceIds</a>" : <i>[ String, ... ]</i>,
...
Properties:
    ...
    <a href="#policyids" title="PolicyIds">PolicyIds</a>: <i>
      - String</i>
    <a href="#workspaceids" title="WorkspaceIds">WorkspaceIds</a>: <i>
      - String</i>
...
A list of Sentinel policy IDs. This value _must not_ be provided
...
A list of workspace IDs. This value _must not_ be provided
