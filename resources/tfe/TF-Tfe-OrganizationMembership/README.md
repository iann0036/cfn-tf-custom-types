...
1. Write the JSON schema describing your resource, `tf-tfe-organizationmembership.json`
2. Implement your resource handlers in `tf_tfe_organizationmembership/handlers.py`
