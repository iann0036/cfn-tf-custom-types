...
1. Write the JSON schema describing your resource, `terraform-tfe-oauthclient.json`
2. Implement your resource handlers in `terraform_tfe_oauthclient/handlers.py`
