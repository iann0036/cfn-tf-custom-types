...
1. Write the JSON schema describing your resource, `tf-anxcloud-networkprefix.json`
2. Implement your resource handlers in `tf_anxcloud_networkprefix/handlers.py`
