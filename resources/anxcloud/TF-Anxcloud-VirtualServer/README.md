...
1. Write the JSON schema describing your resource, `tf-anxcloud-virtualserver.json`
2. Implement your resource handlers in `tf_anxcloud_virtualserver/handlers.py`
