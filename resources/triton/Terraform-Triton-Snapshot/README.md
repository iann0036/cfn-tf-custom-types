...
1. Write the JSON schema describing your resource, `terraform-triton-snapshot.json`
2. Implement your resource handlers in `terraform_triton_snapshot/handlers.py`
