...
1. Write the JSON schema describing your resource, `terraform-triton-instancetemplate.json`
2. Implement your resource handlers in `terraform_triton_instancetemplate/handlers.py`
