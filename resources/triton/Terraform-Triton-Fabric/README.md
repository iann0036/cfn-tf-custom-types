...
1. Write the JSON schema describing your resource, `terraform-triton-fabric.json`
2. Implement your resource handlers in `terraform_triton_fabric/handlers.py`
