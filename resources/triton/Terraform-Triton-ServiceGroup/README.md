...
1. Write the JSON schema describing your resource, `terraform-triton-servicegroup.json`
2. Implement your resource handlers in `terraform_triton_servicegroup/handlers.py`
