...
1. Write the JSON schema describing your resource, `terraform-triton-firewallrule.json`
2. Implement your resource handlers in `terraform_triton_firewallrule/handlers.py`
