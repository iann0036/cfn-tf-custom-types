...
1. Write the JSON schema describing your resource, `terraform-triton-machine.json`
2. Implement your resource handlers in `terraform_triton_machine/handlers.py`
