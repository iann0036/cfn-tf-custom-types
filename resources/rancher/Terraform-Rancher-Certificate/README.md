...
1. Write the JSON schema describing your resource, `terraform-rancher-certificate.json`
2. Implement your resource handlers in `terraform_rancher_certificate/handlers.py`
