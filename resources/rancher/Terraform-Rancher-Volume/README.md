# Terraform::Rancher::Volume

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-rancher-volume.json`
2. Implement your resource handlers in `terraform_rancher_volume/handlers.py`
