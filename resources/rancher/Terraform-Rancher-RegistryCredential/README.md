...
1. Write the JSON schema describing your resource, `terraform-rancher-registrycredential.json`
2. Implement your resource handlers in `terraform_rancher_registrycredential/handlers.py`
