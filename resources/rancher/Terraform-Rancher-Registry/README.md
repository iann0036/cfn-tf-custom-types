...
1. Write the JSON schema describing your resource, `terraform-rancher-registry.json`
2. Implement your resource handlers in `terraform_rancher_registry/handlers.py`
