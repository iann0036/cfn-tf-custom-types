# Terraform::Rancher::Secret

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-rancher-secret.json`
2. Implement your resource handlers in `terraform_rancher_secret/handlers.py`
