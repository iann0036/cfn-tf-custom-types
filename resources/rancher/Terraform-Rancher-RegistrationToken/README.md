...
1. Write the JSON schema describing your resource, `terraform-rancher-registrationtoken.json`
2. Implement your resource handlers in `terraform_rancher_registrationtoken/handlers.py`
