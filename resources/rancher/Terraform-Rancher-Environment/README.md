...
1. Write the JSON schema describing your resource, `terraform-rancher-environment.json`
2. Implement your resource handlers in `terraform_rancher_environment/handlers.py`
