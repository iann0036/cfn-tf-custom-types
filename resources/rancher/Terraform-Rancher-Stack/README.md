...
1. Write the JSON schema describing your resource, `terraform-rancher-stack.json`
2. Implement your resource handlers in `terraform_rancher_stack/handlers.py`
