...
1. Write the JSON schema describing your resource, `tf-ecl-sssapprovalrequestv1.json`
2. Implement your resource handlers in `tf_ecl_sssapprovalrequestv1/handlers.py`
