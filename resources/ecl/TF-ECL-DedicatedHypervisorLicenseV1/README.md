...
1. Write the JSON schema describing your resource, `tf-ecl-dedicatedhypervisorlicensev1.json`
2. Implement your resource handlers in `tf_ecl_dedicatedhypervisorlicensev1/handlers.py`
