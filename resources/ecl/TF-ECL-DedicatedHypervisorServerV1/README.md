...
1. Write the JSON schema describing your resource, `tf-ecl-dedicatedhypervisorserverv1.json`
2. Implement your resource handlers in `tf_ecl_dedicatedhypervisorserverv1/handlers.py`
