...
1. Write the JSON schema describing your resource, `tf-ecl-imagestoragesimagev2.json`
2. Implement your resource handlers in `tf_ecl_imagestoragesimagev2/handlers.py`
