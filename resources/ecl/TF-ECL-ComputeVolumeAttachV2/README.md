# TF::ECL::ComputeVolumeAttachV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ecl-computevolumeattachv2.json`
2. Implement your resource handlers in `tf_ecl_computevolumeattachv2/handlers.py`
