...
1. Write the JSON schema describing your resource, `tf-ecl-computekeypairv2.json`
2. Implement your resource handlers in `tf_ecl_computekeypairv2/handlers.py`
