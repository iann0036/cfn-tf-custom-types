# TF::ECL::NetworkInternetGatewayV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ecl-networkinternetgatewayv2.json`
2. Implement your resource handlers in `tf_ecl_networkinternetgatewayv2/handlers.py`
