...
1. Write the JSON schema describing your resource, `tf-ecl-securitynetworkbasedwafsinglev2.json`
2. Implement your resource handlers in `tf_ecl_securitynetworkbasedwafsinglev2/handlers.py`
