...
1. Write the JSON schema describing your resource, `tf-ecl-baremetalserverv2.json`
2. Implement your resource handlers in `tf_ecl_baremetalserverv2/handlers.py`
