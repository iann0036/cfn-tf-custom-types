...
1. Write the JSON schema describing your resource, `tf-ecl-imagestoragesmemberv2.json`
2. Implement your resource handlers in `tf_ecl_imagestoragesmemberv2/handlers.py`
