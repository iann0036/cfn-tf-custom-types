...
1. Write the JSON schema describing your resource, `tf-ecl-networkstaticroutev2.json`
2. Implement your resource handlers in `tf_ecl_networkstaticroutev2/handlers.py`
