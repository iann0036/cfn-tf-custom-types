...
1. Write the JSON schema describing your resource, `tf-ecl-imagestoragesmemberaccepterv2.json`
2. Implement your resource handlers in `tf_ecl_imagestoragesmemberaccepterv2/handlers.py`
