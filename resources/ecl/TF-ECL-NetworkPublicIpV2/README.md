# TF::ECL::NetworkPublicIpV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ecl-networkpublicipv2.json`
2. Implement your resource handlers in `tf_ecl_networkpublicipv2/handlers.py`
