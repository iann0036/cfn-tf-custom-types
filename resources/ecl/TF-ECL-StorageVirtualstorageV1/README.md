...
1. Write the JSON schema describing your resource, `tf-ecl-storagevirtualstoragev1.json`
2. Implement your resource handlers in `tf_ecl_storagevirtualstoragev1/handlers.py`
