...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    InitiatorIqns: Optional[Sequence[str]]
    IopsPerGb: Optional[str]
    Name: Optional[str]
    Size: Optional[float]
    Throughput: Optional[str]
    VirtualStorageId: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            InitiatorIqns=json_data.get("InitiatorIqns"),
            IopsPerGb=json_data.get("IopsPerGb"),
            Name=json_data.get("Name"),
            Size=json_data.get("Size"),
            Throughput=json_data.get("Throughput"),
            VirtualStorageId=json_data.get("VirtualStorageId"),
