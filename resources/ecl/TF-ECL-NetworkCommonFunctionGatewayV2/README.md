# TF::ECL::NetworkCommonFunctionGatewayV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ecl-networkcommonfunctiongatewayv2.json`
2. Implement your resource handlers in `tf_ecl_networkcommonfunctiongatewayv2/handlers.py`
