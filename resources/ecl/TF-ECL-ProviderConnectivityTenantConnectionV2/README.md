...
1. Write the JSON schema describing your resource, `tf-ecl-providerconnectivitytenantconnectionv2.json`
2. Implement your resource handlers in `tf_ecl_providerconnectivitytenantconnectionv2/handlers.py`
