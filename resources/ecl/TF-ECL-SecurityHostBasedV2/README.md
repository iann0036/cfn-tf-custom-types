...
1. Write the JSON schema describing your resource, `tf-ecl-securityhostbasedv2.json`
2. Implement your resource handlers in `tf_ecl_securityhostbasedv2/handlers.py`
