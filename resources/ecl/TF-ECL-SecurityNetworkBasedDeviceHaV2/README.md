...
1. Write the JSON schema describing your resource, `tf-ecl-securitynetworkbaseddevicehav2.json`
2. Implement your resource handlers in `tf_ecl_securitynetworkbaseddevicehav2/handlers.py`
