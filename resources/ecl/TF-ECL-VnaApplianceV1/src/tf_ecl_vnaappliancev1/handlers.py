...
TYPE_NAME = "TF::ECL::VnaApplianceV1"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/ecl_vna_appliance_v1/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'nttcom/ecl',
                'providerTypeName': 'ecl',
                'terraformTypeName': 'ecl_vna_appliance_v1',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/ecl_vna_appliance_v1/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/ecl_vna_appliance_v1/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AvailabilityZone=None, DefaultGateway=None, Description=None, Id=None, Interface1NoAllowedAddressPairs=None, Interface1NoFixedIps=None, Interface2NoAllowedAddressPairs=None, Interface2NoFixedIps=None, Interface3NoAllowedAddressPairs=None, Interface3NoFixedIps=None, Interface4NoAllowedAddressPairs=None, Interface4NoFixedIps=None, Interface5NoAllowedAddressPairs=None, Interface5NoFixedIps=None, Interface6NoAllowedAddressPairs=None, Interface6NoFixedIps=None, Interface7NoAllowedAddressPairs=None, Interface7NoFixedIps=None, Interface8NoAllowedAddressPairs=None, Interface8NoFixedIps=None, Name=None, Tags=None, TenantId=None, VirtualNetworkAppliancePlanId=None, Interface1AllowedAddressPairs=None, Interface1FixedIps=None, Interface1Info=None, Interface2AllowedAddressPairs=None, Interface2FixedIps=None, Interface2Info=None, Interface3AllowedAddressPairs=None, Interface3FixedIps=None, Interface3Info=None, Interface4AllowedAddressPairs=None, Interface4FixedIps=None, Interface4Info=None, Interface5AllowedAddressPairs=None, Interface5FixedIps=None, Interface5Info=None, Interface6AllowedAddressPairs=None, Interface6FixedIps=None, Interface6Info=None, Interface7AllowedAddressPairs=None, Interface7FixedIps=None, Interface7Info=None, Interface8AllowedAddressPairs=None, Interface8FixedIps=None, Interface8Info=None, Timeouts=None)
