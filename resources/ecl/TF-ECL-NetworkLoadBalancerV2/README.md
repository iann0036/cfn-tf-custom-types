...
1. Write the JSON schema describing your resource, `tf-ecl-networkloadbalancerv2.json`
2. Implement your resource handlers in `tf_ecl_networkloadbalancerv2/handlers.py`
