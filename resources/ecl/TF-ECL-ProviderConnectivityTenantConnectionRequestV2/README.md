# TF::ECL::ProviderConnectivityTenantConnectionRequestV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ecl-providerconnectivitytenantconnectionrequestv2.json`
2. Implement your resource handlers in `tf_ecl_providerconnectivitytenantconnectionrequestv2/handlers.py`
