...
1. Write the JSON schema describing your resource, `tf-ecl-computeinstancev2.json`
2. Implement your resource handlers in `tf_ecl_computeinstancev2/handlers.py`
