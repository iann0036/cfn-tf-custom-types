...
1. Write the JSON schema describing your resource, `tf-ecl-networkgatewayinterfacev2.json`
2. Implement your resource handlers in `tf_ecl_networkgatewayinterfacev2/handlers.py`
