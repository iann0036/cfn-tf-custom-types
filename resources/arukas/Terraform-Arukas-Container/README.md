...
1. Write the JSON schema describing your resource, `terraform-arukas-container.json`
2. Implement your resource handlers in `terraform_arukas_container/handlers.py`
