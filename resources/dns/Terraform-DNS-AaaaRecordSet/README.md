...
1. Write the JSON schema describing your resource, `terraform-dns-aaaarecordset.json`
2. Implement your resource handlers in `terraform_dns_aaaarecordset/handlers.py`
