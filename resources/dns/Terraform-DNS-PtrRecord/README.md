...
1. Write the JSON schema describing your resource, `terraform-dns-ptrrecord.json`
2. Implement your resource handlers in `terraform_dns_ptrrecord/handlers.py`
