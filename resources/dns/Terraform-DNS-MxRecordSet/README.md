...
1. Write the JSON schema describing your resource, `terraform-dns-mxrecordset.json`
2. Implement your resource handlers in `terraform_dns_mxrecordset/handlers.py`
