...
1. Write the JSON schema describing your resource, `terraform-dns-txtrecordset.json`
2. Implement your resource handlers in `terraform_dns_txtrecordset/handlers.py`
