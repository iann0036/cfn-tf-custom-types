...
1. Write the JSON schema describing your resource, `terraform-dns-cnamerecord.json`
2. Implement your resource handlers in `terraform_dns_cnamerecord/handlers.py`
