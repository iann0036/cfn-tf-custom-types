...
1. Write the JSON schema describing your resource, `terraform-dns-arecordset.json`
2. Implement your resource handlers in `terraform_dns_arecordset/handlers.py`
