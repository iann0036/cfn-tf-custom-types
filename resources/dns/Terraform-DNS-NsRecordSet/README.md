...
1. Write the JSON schema describing your resource, `terraform-dns-nsrecordset.json`
2. Implement your resource handlers in `terraform_dns_nsrecordset/handlers.py`
