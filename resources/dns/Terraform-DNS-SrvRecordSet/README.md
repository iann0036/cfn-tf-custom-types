...
1. Write the JSON schema describing your resource, `terraform-dns-srvrecordset.json`
2. Implement your resource handlers in `terraform_dns_srvrecordset/handlers.py`
