...
1. Write the JSON schema describing your resource, `terraform-netlify-buildhook.json`
2. Implement your resource handlers in `terraform_netlify_buildhook/handlers.py`
