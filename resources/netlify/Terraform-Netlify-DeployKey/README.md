...
1. Write the JSON schema describing your resource, `terraform-netlify-deploykey.json`
2. Implement your resource handlers in `terraform_netlify_deploykey/handlers.py`
