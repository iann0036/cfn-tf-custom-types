...
1. Write the JSON schema describing your resource, `tf-volterra-virtualnetwork.json`
2. Implement your resource handlers in `tf_volterra_virtualnetwork/handlers.py`
