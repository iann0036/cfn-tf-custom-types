...
1. Write the JSON schema describing your resource, `tf-volterra-azurevnetsite.json`
2. Implement your resource handlers in `tf_volterra_azurevnetsite/handlers.py`
