...
1. Write the JSON schema describing your resource, `tf-volterra-tfparamsaction.json`
2. Implement your resource handlers in `tf_volterra_tfparamsaction/handlers.py`
