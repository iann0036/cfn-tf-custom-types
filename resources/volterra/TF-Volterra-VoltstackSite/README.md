# TF::Volterra::VoltstackSite

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-voltstacksite.json`
2. Implement your resource handlers in `tf_volterra_voltstacksite/handlers.py`
