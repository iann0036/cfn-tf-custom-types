...
1. Write the JSON schema describing your resource, `tf-volterra-networkpolicyrule.json`
2. Implement your resource handlers in `tf_volterra_networkpolicyrule/handlers.py`
