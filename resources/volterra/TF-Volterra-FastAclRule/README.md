...
1. Write the JSON schema describing your resource, `tf-volterra-fastaclrule.json`
2. Implement your resource handlers in `tf_volterra_fastaclrule/handlers.py`
