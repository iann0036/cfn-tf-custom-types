...
1. Write the JSON schema describing your resource, `tf-volterra-secretpolicyrule.json`
2. Implement your resource handlers in `tf_volterra_secretpolicyrule/handlers.py`
