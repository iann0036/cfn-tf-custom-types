...
1. Write the JSON schema describing your resource, `tf-volterra-forwardproxypolicy.json`
2. Implement your resource handlers in `tf_volterra_forwardproxypolicy/handlers.py`
