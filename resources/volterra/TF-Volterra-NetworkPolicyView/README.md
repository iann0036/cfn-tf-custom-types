# TF::Volterra::NetworkPolicyView

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-networkpolicyview.json`
2. Implement your resource handlers in `tf_volterra_networkpolicyview/handlers.py`
