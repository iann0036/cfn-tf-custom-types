...
1. Write the JSON schema describing your resource, `tf-volterra-sitesetvipinfo.json`
2. Implement your resource handlers in `tf_volterra_sitesetvipinfo/handlers.py`
