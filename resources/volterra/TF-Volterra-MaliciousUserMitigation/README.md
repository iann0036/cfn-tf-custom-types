...
1. Write the JSON schema describing your resource, `tf-volterra-malicioususermitigation.json`
2. Implement your resource handlers in `tf_volterra_malicioususermitigation/handlers.py`
