# TF::Volterra::ActiveServicePolicies

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-activeservicepolicies.json`
2. Implement your resource handlers in `tf_volterra_activeservicepolicies/handlers.py`
