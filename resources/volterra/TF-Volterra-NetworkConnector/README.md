...
1. Write the JSON schema describing your resource, `tf-volterra-networkconnector.json`
2. Implement your resource handlers in `tf_volterra_networkconnector/handlers.py`
