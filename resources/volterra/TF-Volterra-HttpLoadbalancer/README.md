...
1. Write the JSON schema describing your resource, `tf-volterra-httploadbalancer.json`
2. Implement your resource handlers in `tf_volterra_httploadbalancer/handlers.py`
