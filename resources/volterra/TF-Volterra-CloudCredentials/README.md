...
1. Write the JSON schema describing your resource, `tf-volterra-cloudcredentials.json`
2. Implement your resource handlers in `tf_volterra_cloudcredentials/handlers.py`
