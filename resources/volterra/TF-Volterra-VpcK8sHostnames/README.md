# TF::Volterra::VpcK8sHostnames

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-vpck8shostnames.json`
2. Implement your resource handlers in `tf_volterra_vpck8shostnames/handlers.py`
