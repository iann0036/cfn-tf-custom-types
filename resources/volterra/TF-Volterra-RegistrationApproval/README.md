...
1. Write the JSON schema describing your resource, `tf-volterra-registrationapproval.json`
2. Implement your resource handlers in `tf_volterra_registrationapproval/handlers.py`
