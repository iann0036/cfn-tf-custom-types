# TF::Volterra::DcClusterGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-dcclustergroup.json`
2. Implement your resource handlers in `tf_volterra_dcclustergroup/handlers.py`
