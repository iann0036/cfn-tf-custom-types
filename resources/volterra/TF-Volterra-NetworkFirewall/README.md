...
1. Write the JSON schema describing your resource, `tf-volterra-networkfirewall.json`
2. Implement your resource handlers in `tf_volterra_networkfirewall/handlers.py`
