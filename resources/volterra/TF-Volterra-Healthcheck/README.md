...
1. Write the JSON schema describing your resource, `tf-volterra-healthcheck.json`
2. Implement your resource handlers in `tf_volterra_healthcheck/handlers.py`
