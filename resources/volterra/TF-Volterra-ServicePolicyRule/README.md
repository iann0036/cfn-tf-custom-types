...
1. Write the JSON schema describing your resource, `tf-volterra-servicepolicyrule.json`
2. Implement your resource handlers in `tf_volterra_servicepolicyrule/handlers.py`
