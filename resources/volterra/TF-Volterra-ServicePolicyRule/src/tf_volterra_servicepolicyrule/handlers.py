...
TYPE_NAME = "TF::Volterra::ServicePolicyRule"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/volterra_service_policy_rule/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'volterraedge/volterra',
                'providerTypeName': 'volterra',
                'terraformTypeName': 'volterra_service_policy_rule',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/volterra_service_policy_rule/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/volterra_service_policy_rule/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Action=None, Annotations=None, AnyAsn=None, AnyClient=None, AnyDstAsn=None, AnyDstIp=None, AnyIp=None, ChallengeAction=None, ClientName=None, Description=None, Disable=None, ExpirationTimestamp=None, Id=None, Labels=None, MaliciousUserMitigationBypass=None, Name=None, Namespace=None, Scheme=None, ApiGroupMatcher=None, ArgMatchers=None, AsnList=None, AsnMatcher=None, BodyMatcher=None, ClientNameMatcher=None, ClientRole=None, ClientSelector=None, CookieMatchers=None, DomainMatcher=None, DstAsnList=None, DstAsnMatcher=None, DstIpMatcher=None, DstIpPrefixList=None, GotoPolicy=None, Headers=None, HttpMethod=None, IpMatcher=None, IpPrefixList=None, L4DestMatcher=None, LabelMatcher=None, Path=None, PortMatcher=None, QueryParams=None, RateLimiter=None, ServerSelector=None, TlsFingerprintMatcher=None, UrlMatcher=None, VirtualHostMatcher=None, WafAction=None)
