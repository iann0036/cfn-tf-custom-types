...
1. Write the JSON schema describing your resource, `tf-volterra-activenetworkpolicies.json`
2. Implement your resource handlers in `tf_volterra_activenetworkpolicies/handlers.py`
