...
1. Write the JSON schema describing your resource, `tf-volterra-virtualhost.json`
2. Implement your resource handlers in `tf_volterra_virtualhost/handlers.py`
