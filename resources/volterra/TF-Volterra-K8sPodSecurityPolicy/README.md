...
1. Write the JSON schema describing your resource, `tf-volterra-k8spodsecuritypolicy.json`
2. Implement your resource handlers in `tf_volterra_k8spodsecuritypolicy/handlers.py`
