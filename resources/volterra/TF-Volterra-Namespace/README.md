# TF::Volterra::Namespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-namespace.json`
2. Implement your resource handlers in `tf_volterra_namespace/handlers.py`
