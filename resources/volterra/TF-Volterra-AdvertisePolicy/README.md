# TF::Volterra::AdvertisePolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-advertisepolicy.json`
2. Implement your resource handlers in `tf_volterra_advertisepolicy/handlers.py`
