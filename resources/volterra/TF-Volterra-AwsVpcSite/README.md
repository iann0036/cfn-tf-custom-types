# TF::Volterra::AwsVpcSite

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-awsvpcsite.json`
2. Implement your resource handlers in `tf_volterra_awsvpcsite/handlers.py`
