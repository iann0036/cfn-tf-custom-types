# TF::Volterra::ActiveAlertPolicies

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-activealertpolicies.json`
2. Implement your resource handlers in `tf_volterra_activealertpolicies/handlers.py`
