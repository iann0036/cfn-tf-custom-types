...
1. Write the JSON schema describing your resource, `tf-volterra-alertreceiver.json`
2. Implement your resource handlers in `tf_volterra_alertreceiver/handlers.py`
