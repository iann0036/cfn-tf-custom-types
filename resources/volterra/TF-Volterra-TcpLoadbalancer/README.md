...
1. Write the JSON schema describing your resource, `tf-volterra-tcploadbalancer.json`
2. Implement your resource handlers in `tf_volterra_tcploadbalancer/handlers.py`
