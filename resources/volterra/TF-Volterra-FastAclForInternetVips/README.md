# TF::Volterra::FastAclForInternetVips

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-volterra-fastaclforinternetvips.json`
2. Implement your resource handlers in `tf_volterra_fastaclforinternetvips/handlers.py`
