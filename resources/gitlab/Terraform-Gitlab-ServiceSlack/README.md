...
1. Write the JSON schema describing your resource, `terraform-gitlab-serviceslack.json`
2. Implement your resource handlers in `terraform_gitlab_serviceslack/handlers.py`
