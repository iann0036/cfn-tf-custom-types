...
1. Write the JSON schema describing your resource, `terraform-gitlab-tagprotection.json`
2. Implement your resource handlers in `terraform_gitlab_tagprotection/handlers.py`
