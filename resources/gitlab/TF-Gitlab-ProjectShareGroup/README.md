...
1. Write the JSON schema describing your resource, `tf-gitlab-projectsharegroup.json`
2. Implement your resource handlers in `tf_gitlab_projectsharegroup/handlers.py`
