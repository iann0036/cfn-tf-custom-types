...
1. Write the JSON schema describing your resource, `tf-gitlab-groupvariable.json`
2. Implement your resource handlers in `tf_gitlab_groupvariable/handlers.py`
