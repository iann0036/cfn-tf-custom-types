...
1. Write the JSON schema describing your resource, `tf-gitlab-servicepipelinesemail.json`
2. Implement your resource handlers in `tf_gitlab_servicepipelinesemail/handlers.py`
