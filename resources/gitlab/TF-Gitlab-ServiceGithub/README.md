...
1. Write the JSON schema describing your resource, `tf-gitlab-servicegithub.json`
2. Implement your resource handlers in `tf_gitlab_servicegithub/handlers.py`
