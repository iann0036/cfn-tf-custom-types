...
1. Write the JSON schema describing your resource, `terraform-gitlab-projectmembership.json`
2. Implement your resource handlers in `terraform_gitlab_projectmembership/handlers.py`
