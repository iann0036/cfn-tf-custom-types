...
1. Write the JSON schema describing your resource, `terraform-gitlab-pipelineschedule.json`
2. Implement your resource handlers in `terraform_gitlab_pipelineschedule/handlers.py`
