...
1. Write the JSON schema describing your resource, `terraform-gitlab-projecthook.json`
2. Implement your resource handlers in `terraform_gitlab_projecthook/handlers.py`
