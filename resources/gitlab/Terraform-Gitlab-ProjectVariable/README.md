...
1. Write the JSON schema describing your resource, `terraform-gitlab-projectvariable.json`
2. Implement your resource handlers in `terraform_gitlab_projectvariable/handlers.py`
