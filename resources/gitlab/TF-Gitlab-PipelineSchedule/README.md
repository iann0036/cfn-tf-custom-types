...
1. Write the JSON schema describing your resource, `tf-gitlab-pipelineschedule.json`
2. Implement your resource handlers in `tf_gitlab_pipelineschedule/handlers.py`
