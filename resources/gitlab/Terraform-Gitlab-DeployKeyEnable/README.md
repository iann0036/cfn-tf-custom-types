...
1. Write the JSON schema describing your resource, `terraform-gitlab-deploykeyenable.json`
2. Implement your resource handlers in `terraform_gitlab_deploykeyenable/handlers.py`
