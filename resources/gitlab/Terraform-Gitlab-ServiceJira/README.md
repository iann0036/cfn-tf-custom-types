...
1. Write the JSON schema describing your resource, `terraform-gitlab-servicejira.json`
2. Implement your resource handlers in `terraform_gitlab_servicejira/handlers.py`
