...
1. Write the JSON schema describing your resource, `terraform-gitlab-deploykey.json`
2. Implement your resource handlers in `terraform_gitlab_deploykey/handlers.py`
