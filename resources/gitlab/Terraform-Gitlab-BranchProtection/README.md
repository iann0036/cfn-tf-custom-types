...
1. Write the JSON schema describing your resource, `terraform-gitlab-branchprotection.json`
2. Implement your resource handlers in `terraform_gitlab_branchprotection/handlers.py`
