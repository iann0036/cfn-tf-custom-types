...
1. Write the JSON schema describing your resource, `terraform-gitlab-project.json`
2. Implement your resource handlers in `terraform_gitlab_project/handlers.py`
