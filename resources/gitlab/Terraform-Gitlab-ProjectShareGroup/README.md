...
1. Write the JSON schema describing your resource, `terraform-gitlab-projectsharegroup.json`
2. Implement your resource handlers in `terraform_gitlab_projectsharegroup/handlers.py`
