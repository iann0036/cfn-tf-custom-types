...
1. Write the JSON schema describing your resource, `tf-gitlab-groupldaplink.json`
2. Implement your resource handlers in `tf_gitlab_groupldaplink/handlers.py`
