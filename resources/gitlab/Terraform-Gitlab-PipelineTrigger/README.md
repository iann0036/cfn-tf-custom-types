...
1. Write the JSON schema describing your resource, `terraform-gitlab-pipelinetrigger.json`
2. Implement your resource handlers in `terraform_gitlab_pipelinetrigger/handlers.py`
