...
1. Write the JSON schema describing your resource, `tf-gitlab-groupmembership.json`
2. Implement your resource handlers in `tf_gitlab_groupmembership/handlers.py`
