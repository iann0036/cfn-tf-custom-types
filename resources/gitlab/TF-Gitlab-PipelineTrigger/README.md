...
1. Write the JSON schema describing your resource, `tf-gitlab-pipelinetrigger.json`
2. Implement your resource handlers in `tf_gitlab_pipelinetrigger/handlers.py`
