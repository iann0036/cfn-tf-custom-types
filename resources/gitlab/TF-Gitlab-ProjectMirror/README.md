...
1. Write the JSON schema describing your resource, `tf-gitlab-projectmirror.json`
2. Implement your resource handlers in `tf_gitlab_projectmirror/handlers.py`
