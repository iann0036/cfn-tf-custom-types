...
1. Write the JSON schema describing your resource, `tf-gitlab-projectapprovalrule.json`
2. Implement your resource handlers in `tf_gitlab_projectapprovalrule/handlers.py`
