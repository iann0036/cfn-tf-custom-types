...
1. Write the JSON schema describing your resource, `terraform-gitlab-pipelineschedulevariable.json`
2. Implement your resource handlers in `terraform_gitlab_pipelineschedulevariable/handlers.py`
