...
1. Write the JSON schema describing your resource, `tf-gitlab-projectfreezeperiod.json`
2. Implement your resource handlers in `tf_gitlab_projectfreezeperiod/handlers.py`
