# TF::Gitlab::ProjectMembership

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gitlab-projectmembership.json`
2. Implement your resource handlers in `tf_gitlab_projectmembership/handlers.py`
