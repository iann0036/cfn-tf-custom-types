...
1. Write the JSON schema describing your resource, `tf-gitlab-projectlevelmrapprovals.json`
2. Implement your resource handlers in `tf_gitlab_projectlevelmrapprovals/handlers.py`
