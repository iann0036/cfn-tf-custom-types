# Terraform::Gitlab::GroupLabel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-gitlab-grouplabel.json`
2. Implement your resource handlers in `terraform_gitlab_grouplabel/handlers.py`
