...
1. Write the JSON schema describing your resource, `tf-gitlab-groupsharegroup.json`
2. Implement your resource handlers in `tf_gitlab_groupsharegroup/handlers.py`
