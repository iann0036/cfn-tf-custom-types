...
1. Write the JSON schema describing your resource, `terraform-gitlab-groupcluster.json`
2. Implement your resource handlers in `terraform_gitlab_groupcluster/handlers.py`
