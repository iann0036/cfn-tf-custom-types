# TF::Gitlab::InstanceCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gitlab-instancecluster.json`
2. Implement your resource handlers in `tf_gitlab_instancecluster/handlers.py`
