...
1. Write the JSON schema describing your resource, `terraform-gitlab-projectpushrules.json`
2. Implement your resource handlers in `terraform_gitlab_projectpushrules/handlers.py`
