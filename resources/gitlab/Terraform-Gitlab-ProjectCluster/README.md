...
1. Write the JSON schema describing your resource, `terraform-gitlab-projectcluster.json`
2. Implement your resource handlers in `terraform_gitlab_projectcluster/handlers.py`
