...
1. Write the JSON schema describing your resource, `terraform-gitlab-groupmembership.json`
2. Implement your resource handlers in `terraform_gitlab_groupmembership/handlers.py`
