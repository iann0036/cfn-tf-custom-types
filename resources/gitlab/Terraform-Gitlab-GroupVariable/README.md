...
1. Write the JSON schema describing your resource, `terraform-gitlab-groupvariable.json`
2. Implement your resource handlers in `terraform_gitlab_groupvariable/handlers.py`
