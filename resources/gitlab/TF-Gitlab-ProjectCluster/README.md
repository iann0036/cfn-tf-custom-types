# TF::Gitlab::ProjectCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gitlab-projectcluster.json`
2. Implement your resource handlers in `tf_gitlab_projectcluster/handlers.py`
