...
1. Write the JSON schema describing your resource, `tf-heroku-appconfigassociation.json`
2. Implement your resource handlers in `tf_heroku_appconfigassociation/handlers.py`
