...
1. Write the JSON schema describing your resource, `terraform-heroku-appfeature.json`
2. Implement your resource handlers in `terraform_heroku_appfeature/handlers.py`
