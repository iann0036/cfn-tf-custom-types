...
1. Write the JSON schema describing your resource, `tf-heroku-spacevpnconnection.json`
2. Implement your resource handlers in `tf_heroku_spacevpnconnection/handlers.py`
