...
1. Write the JSON schema describing your resource, `terraform-heroku-addonattachment.json`
2. Implement your resource handlers in `terraform_heroku_addonattachment/handlers.py`
