...
1. Write the JSON schema describing your resource, `terraform-heroku-appwebhook.json`
2. Implement your resource handlers in `terraform_heroku_appwebhook/handlers.py`
