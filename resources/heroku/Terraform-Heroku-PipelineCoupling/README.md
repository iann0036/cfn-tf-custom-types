...
1. Write the JSON schema describing your resource, `terraform-heroku-pipelinecoupling.json`
2. Implement your resource handlers in `terraform_heroku_pipelinecoupling/handlers.py`
