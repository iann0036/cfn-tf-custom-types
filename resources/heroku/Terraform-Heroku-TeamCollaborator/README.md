...
1. Write the JSON schema describing your resource, `terraform-heroku-teamcollaborator.json`
2. Implement your resource handlers in `terraform_heroku_teamcollaborator/handlers.py`
