...
1. Write the JSON schema describing your resource, `terraform-heroku-spaceappaccess.json`
2. Implement your resource handlers in `terraform_heroku_spaceappaccess/handlers.py`
