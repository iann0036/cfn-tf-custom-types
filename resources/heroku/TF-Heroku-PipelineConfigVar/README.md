...
1. Write the JSON schema describing your resource, `tf-heroku-pipelineconfigvar.json`
2. Implement your resource handlers in `tf_heroku_pipelineconfigvar/handlers.py`
