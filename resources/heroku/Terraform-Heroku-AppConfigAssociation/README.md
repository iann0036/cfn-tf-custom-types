...
1. Write the JSON schema describing your resource, `terraform-heroku-appconfigassociation.json`
2. Implement your resource handlers in `terraform_heroku_appconfigassociation/handlers.py`
