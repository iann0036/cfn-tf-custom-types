# TF::Heroku::TeamCollaborator

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-heroku-teamcollaborator.json`
2. Implement your resource handlers in `tf_heroku_teamcollaborator/handlers.py`
