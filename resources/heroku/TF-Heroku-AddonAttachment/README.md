...
1. Write the JSON schema describing your resource, `tf-heroku-addonattachment.json`
2. Implement your resource handlers in `tf_heroku_addonattachment/handlers.py`
