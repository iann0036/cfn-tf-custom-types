# TF::Heroku::AppFeature

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-heroku-appfeature.json`
2. Implement your resource handlers in `tf_heroku_appfeature/handlers.py`
