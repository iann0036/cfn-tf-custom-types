...
1. Write the JSON schema describing your resource, `terraform-heroku-spacepeeringconnectionaccepter.json`
2. Implement your resource handlers in `terraform_heroku_spacepeeringconnectionaccepter/handlers.py`
