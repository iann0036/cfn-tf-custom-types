...
1. Write the JSON schema describing your resource, `terraform-heroku-apprelease.json`
2. Implement your resource handlers in `terraform_heroku_apprelease/handlers.py`
