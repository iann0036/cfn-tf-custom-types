...
1. Write the JSON schema describing your resource, `terraform-heroku-spacevpnconnection.json`
2. Implement your resource handlers in `terraform_heroku_spacevpnconnection/handlers.py`
