...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#configvars" title="ConfigVars">ConfigVars</a>" : <i>[ <a href="configvarsdefinition.md">ConfigVarsDefinition</a>, ... ]</i>,
        "<a href="#internalrouting" title="InternalRouting">InternalRouting</a>" : <i>Boolean</i>,
        "<a href="#name" title="Name">Name</a>" : <i>String</i>,
        "<a href="#region" title="Region">Region</a>" : <i>String</i>,
        "<a href="#sensitiveconfigvars" title="SensitiveConfigVars">SensitiveConfigVars</a>" : <i>[ <a href="sensitiveconfigvarsdefinition.md">SensitiveConfigVarsDefinition</a>, ... ]</i>,
...
Properties:
    ...
    <a href="#configvars" title="ConfigVars">ConfigVars</a>: <i>
      - <a href="configvarsdefinition.md">ConfigVarsDefinition</a></i>
    <a href="#internalrouting" title="InternalRouting">InternalRouting</a>: <i>Boolean</i>
    <a href="#name" title="Name">Name</a>: <i>String</i>
    <a href="#region" title="Region">Region</a>: <i>String</i>
    <a href="#sensitiveconfigvars" title="SensitiveConfigVars">SensitiveConfigVars</a>: <i>
      - <a href="sensitiveconfigvarsdefinition.md">SensitiveConfigVarsDefinition</a></i>
    <a href="#space" title="Space">Space</a>: <i>String</i>
    <a href="#stack" title="Stack">Stack</a>: <i>String</i>
...
_Type_: List of <a href="configvarsdefinition.md">ConfigVarsDefinition</a>
...
_Type_: List of <a href="sensitiveconfigvarsdefinition.md">SensitiveConfigVarsDefinition</a>
