...
1. Write the JSON schema describing your resource, `terraform-heroku-accountfeature.json`
2. Implement your resource handlers in `terraform_heroku_accountfeature/handlers.py`
