...
1. Write the JSON schema describing your resource, `tf-heroku-reviewappconfig.json`
2. Implement your resource handlers in `tf_heroku_reviewappconfig/handlers.py`
