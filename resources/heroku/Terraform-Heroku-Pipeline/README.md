...
1. Write the JSON schema describing your resource, `terraform-heroku-pipeline.json`
2. Implement your resource handlers in `terraform_heroku_pipeline/handlers.py`
