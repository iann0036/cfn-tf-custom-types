...
1. Write the JSON schema describing your resource, `terraform-heroku-domain.json`
2. Implement your resource handlers in `terraform_heroku_domain/handlers.py`
