...
1. Write the JSON schema describing your resource, `terraform-heroku-teammember.json`
2. Implement your resource handlers in `terraform_heroku_teammember/handlers.py`
