...
1. Write the JSON schema describing your resource, `terraform-heroku-config.json`
2. Implement your resource handlers in `terraform_heroku_config/handlers.py`
