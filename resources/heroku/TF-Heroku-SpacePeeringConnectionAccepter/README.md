# TF::Heroku::SpacePeeringConnectionAccepter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-heroku-spacepeeringconnectionaccepter.json`
2. Implement your resource handlers in `tf_heroku_spacepeeringconnectionaccepter/handlers.py`
