# TF::Heroku::PipelineCoupling

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-heroku-pipelinecoupling.json`
2. Implement your resource handlers in `tf_heroku_pipelinecoupling/handlers.py`
