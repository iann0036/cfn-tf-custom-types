# TF::Heroku::AppWebhook

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-heroku-appwebhook.json`
2. Implement your resource handlers in `tf_heroku_appwebhook/handlers.py`
