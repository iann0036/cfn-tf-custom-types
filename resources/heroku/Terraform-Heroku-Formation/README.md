...
1. Write the JSON schema describing your resource, `terraform-heroku-formation.json`
2. Implement your resource handlers in `terraform_heroku_formation/handlers.py`
