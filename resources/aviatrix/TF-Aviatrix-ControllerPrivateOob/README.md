# TF::Aviatrix::ControllerPrivateOob

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-controllerprivateoob.json`
2. Implement your resource handlers in `tf_aviatrix_controllerprivateoob/handlers.py`
