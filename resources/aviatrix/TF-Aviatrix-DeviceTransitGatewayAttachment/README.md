...
1. Write the JSON schema describing your resource, `tf-aviatrix-devicetransitgatewayattachment.json`
2. Implement your resource handlers in `tf_aviatrix_devicetransitgatewayattachment/handlers.py`
