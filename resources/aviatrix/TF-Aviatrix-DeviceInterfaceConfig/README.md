...
1. Write the JSON schema describing your resource, `tf-aviatrix-deviceinterfaceconfig.json`
2. Implement your resource handlers in `tf_aviatrix_deviceinterfaceconfig/handlers.py`
