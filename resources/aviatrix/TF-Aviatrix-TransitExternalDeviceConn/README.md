...
1. Write the JSON schema describing your resource, `tf-aviatrix-transitexternaldeviceconn.json`
2. Implement your resource handlers in `tf_aviatrix_transitexternaldeviceconn/handlers.py`
