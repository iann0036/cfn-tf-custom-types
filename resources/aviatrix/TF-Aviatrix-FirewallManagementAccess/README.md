...
1. Write the JSON schema describing your resource, `tf-aviatrix-firewallmanagementaccess.json`
2. Implement your resource handlers in `tf_aviatrix_firewallmanagementaccess/handlers.py`
