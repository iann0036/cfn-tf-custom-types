...
1. Write the JSON schema describing your resource, `tf-aviatrix-firewalltag.json`
2. Implement your resource handlers in `tf_aviatrix_firewalltag/handlers.py`
