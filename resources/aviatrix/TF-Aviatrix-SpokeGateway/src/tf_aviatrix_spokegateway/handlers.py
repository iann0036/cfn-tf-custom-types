...
TYPE_NAME = "TF::Aviatrix::SpokeGateway"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/aviatrix_spoke_gateway/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aviatrix_spoke_gateway',
                'returnValues': ["CloudInstanceId", "HaCloudInstanceId", "HaGwName", "HaPrivateIp", "Id", "PrivateIp", "SecurityGroupId"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/aviatrix_spoke_gateway/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/aviatrix_spoke_gateway/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccountName=None, AllocateNewEip=None, AvailabilityDomain=None, CloudInstanceId=None, CloudType=None, CustomerManagedKeys=None, CustomizedSpokeVpcRoutes=None, Eip=None, EnableActiveMesh=None, EnableAutoAdvertiseS2cCidrs=None, EnableEncryptVolume=None, EnableJumboFrame=None, EnableMonitorGatewaySubnets=None, EnablePrivateOob=None, EnablePrivateVpcDefaultRoute=None, EnableSkipPublicRouteTableUpdate=None, EnableVpcDnsServer=None, FaultDomain=None, FilteredSpokeVpcRoutes=None, GwName=None, GwSize=None, HaAvailabilityDomain=None, HaCloudInstanceId=None, HaEip=None, HaFaultDomain=None, HaGwName=None, HaGwSize=None, HaInsaneModeAz=None, HaOobAvailabilityZone=None, HaOobManagementSubnet=None, HaPrivateIp=None, HaSubnet=None, HaZone=None, Id=None, IncludedAdvertisedSpokeRoutes=None, InsaneMode=None, InsaneModeAz=None, ManageTransitGatewayAttachment=None, MonitorExcludeList=None, OobAvailabilityZone=None, OobManagementSubnet=None, PrivateIp=None, SecurityGroupId=None, SingleAzHa=None, SingleIpSnat=None, StorageName=None, Subnet=None, TagList=None, Tags=None, TransitGw=None, TunnelDetectionTime=None, VpcId=None, VpcReg=None, Zone=None)
