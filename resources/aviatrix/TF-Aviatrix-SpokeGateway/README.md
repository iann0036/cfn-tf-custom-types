...
1. Write the JSON schema describing your resource, `tf-aviatrix-spokegateway.json`
2. Implement your resource handlers in `tf_aviatrix_spokegateway/handlers.py`
