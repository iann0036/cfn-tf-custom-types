...
1. Write the JSON schema describing your resource, `tf-aviatrix-controlleremailexceptionnotificationconfig.json`
2. Implement your resource handlers in `tf_aviatrix_controlleremailexceptionnotificationconfig/handlers.py`
