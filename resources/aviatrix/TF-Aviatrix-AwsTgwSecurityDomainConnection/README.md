# TF::Aviatrix::AwsTgwSecurityDomainConnection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwsecuritydomainconnection.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwsecuritydomainconnection/handlers.py`
