...
1. Write the JSON schema describing your resource, `tf-aviatrix-samlendpoint.json`
2. Implement your resource handlers in `tf_aviatrix_samlendpoint/handlers.py`
