...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwvpcattachment.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwvpcattachment/handlers.py`
