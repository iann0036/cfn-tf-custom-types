...
1. Write the JSON schema describing your resource, `tf-aviatrix-gatewaysnat.json`
2. Implement your resource handlers in `tf_aviatrix_gatewaysnat/handlers.py`
