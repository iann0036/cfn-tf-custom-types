...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwconnect.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwconnect/handlers.py`
