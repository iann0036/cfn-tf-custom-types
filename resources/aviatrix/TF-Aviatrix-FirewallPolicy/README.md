...
1. Write the JSON schema describing your resource, `tf-aviatrix-firewallpolicy.json`
2. Implement your resource handlers in `tf_aviatrix_firewallpolicy/handlers.py`
