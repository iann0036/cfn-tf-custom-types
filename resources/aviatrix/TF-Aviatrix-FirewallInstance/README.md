...
1. Write the JSON schema describing your resource, `tf-aviatrix-firewallinstance.json`
2. Implement your resource handlers in `tf_aviatrix_firewallinstance/handlers.py`
