...
1. Write the JSON schema describing your resource, `tf-aviatrix-firewallinstanceassociation.json`
2. Implement your resource handlers in `tf_aviatrix_firewallinstanceassociation/handlers.py`
