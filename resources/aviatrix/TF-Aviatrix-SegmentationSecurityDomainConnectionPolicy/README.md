...
1. Write the JSON schema describing your resource, `tf-aviatrix-segmentationsecuritydomainconnectionpolicy.json`
2. Implement your resource handlers in `tf_aviatrix_segmentationsecuritydomainconnectionpolicy/handlers.py`
