...
1. Write the JSON schema describing your resource, `tf-aviatrix-accountuser.json`
2. Implement your resource handlers in `tf_aviatrix_accountuser/handlers.py`
