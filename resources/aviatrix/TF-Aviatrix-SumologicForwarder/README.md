...
1. Write the JSON schema describing your resource, `tf-aviatrix-sumologicforwarder.json`
2. Implement your resource handlers in `tf_aviatrix_sumologicforwarder/handlers.py`
