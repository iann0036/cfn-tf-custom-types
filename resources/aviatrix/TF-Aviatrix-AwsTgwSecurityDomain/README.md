...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwsecuritydomain.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwsecuritydomain/handlers.py`
