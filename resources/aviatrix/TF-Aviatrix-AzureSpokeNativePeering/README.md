# TF::Aviatrix::AzureSpokeNativePeering

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-azurespokenativepeering.json`
2. Implement your resource handlers in `tf_aviatrix_azurespokenativepeering/handlers.py`
