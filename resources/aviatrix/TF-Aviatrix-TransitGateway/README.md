...
1. Write the JSON schema describing your resource, `tf-aviatrix-transitgateway.json`
2. Implement your resource handlers in `tf_aviatrix_transitgateway/handlers.py`
