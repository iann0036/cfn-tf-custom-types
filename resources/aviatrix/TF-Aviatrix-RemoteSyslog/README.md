...
1. Write the JSON schema describing your resource, `tf-aviatrix-remotesyslog.json`
2. Implement your resource handlers in `tf_aviatrix_remotesyslog/handlers.py`
