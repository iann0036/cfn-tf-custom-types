# TF::Aviatrix::VpnUserAccelerator

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-vpnuseraccelerator.json`
2. Implement your resource handlers in `tf_aviatrix_vpnuseraccelerator/handlers.py`
