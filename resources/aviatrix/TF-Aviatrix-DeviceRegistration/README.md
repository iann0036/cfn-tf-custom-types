...
1. Write the JSON schema describing your resource, `tf-aviatrix-deviceregistration.json`
2. Implement your resource handlers in `tf_aviatrix_deviceregistration/handlers.py`
