...
1. Write the JSON schema describing your resource, `tf-aviatrix-cloudntransitgatewayattachment.json`
2. Implement your resource handlers in `tf_aviatrix_cloudntransitgatewayattachment/handlers.py`
