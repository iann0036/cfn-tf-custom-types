...
1. Write the JSON schema describing your resource, `tf-aviatrix-gatewaycertificateconfig.json`
2. Implement your resource handlers in `tf_aviatrix_gatewaycertificateconfig/handlers.py`
