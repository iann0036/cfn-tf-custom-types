...
1. Write the JSON schema describing your resource, `tf-aviatrix-deviceawstgwattachment.json`
2. Implement your resource handlers in `tf_aviatrix_deviceawstgwattachment/handlers.py`
