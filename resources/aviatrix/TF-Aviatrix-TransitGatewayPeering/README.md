...
1. Write the JSON schema describing your resource, `tf-aviatrix-transitgatewaypeering.json`
2. Implement your resource handlers in `tf_aviatrix_transitgatewaypeering/handlers.py`
