...
1. Write the JSON schema describing your resource, `tf-aviatrix-gatewaydnat.json`
2. Implement your resource handlers in `tf_aviatrix_gatewaydnat/handlers.py`
