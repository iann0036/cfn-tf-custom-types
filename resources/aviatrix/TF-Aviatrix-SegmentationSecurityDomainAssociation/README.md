...
1. Write the JSON schema describing your resource, `tf-aviatrix-segmentationsecuritydomainassociation.json`
2. Implement your resource handlers in `tf_aviatrix_segmentationsecuritydomainassociation/handlers.py`
