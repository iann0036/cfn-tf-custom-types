...
1. Write the JSON schema describing your resource, `tf-aviatrix-cloudwatchagent.json`
2. Implement your resource handlers in `tf_aviatrix_cloudwatchagent/handlers.py`
