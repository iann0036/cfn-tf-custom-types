...
1. Write the JSON schema describing your resource, `tf-aviatrix-controllerbgpmaxaslimitconfig.json`
2. Implement your resource handlers in `tf_aviatrix_controllerbgpmaxaslimitconfig/handlers.py`
