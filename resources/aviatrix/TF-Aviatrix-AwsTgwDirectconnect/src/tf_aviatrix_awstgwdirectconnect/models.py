...
class ResourceModel(BaseModel):
    ...
    AllowedPrefix: Optional[str]
    DirectconnectAccountName: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AllowedPrefix=json_data.get("AllowedPrefix"),
            DirectconnectAccountName=json_data.get("DirectconnectAccountName"),
