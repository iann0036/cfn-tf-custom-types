...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwdirectconnect.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwdirectconnect/handlers.py`
