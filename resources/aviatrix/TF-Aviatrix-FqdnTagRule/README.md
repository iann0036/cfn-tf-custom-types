...
1. Write the JSON schema describing your resource, `tf-aviatrix-fqdntagrule.json`
2. Implement your resource handlers in `tf_aviatrix_fqdntagrule/handlers.py`
