...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/aviatrix_account/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aviatrix_account',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/aviatrix_account/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/aviatrix_account/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AccountName=None, AlicloudAccessKey=None, AlicloudAccountId=None, AlicloudSecretKey=None, ArmApplicationId=None, ArmApplicationKey=None, ArmDirectoryId=None, ArmSubscriptionId=None, AuditAccount=None, AwsAccessKey=None, AwsAccountNumber=None, AwsGatewayRoleApp=None, AwsGatewayRoleEc2=None, AwsIam=None, AwsRoleApp=None, AwsRoleEc2=None, AwsSecretKey=None, AwschinaAccessKey=None, AwschinaAccountNumber=None, AwschinaIam=None, AwschinaRoleApp=None, AwschinaRoleEc2=None, AwschinaSecretKey=None, AwsgovAccessKey=None, AwsgovAccountNumber=None, AwsgovIam=None, AwsgovRoleApp=None, AwsgovRoleEc2=None, AwsgovSecretKey=None, AzurechinaApplicationId=None, AzurechinaApplicationKey=None, AzurechinaDirectoryId=None, AzurechinaSubscriptionId=None, AzuregovApplicationId=None, AzuregovApplicationKey=None, AzuregovDirectoryId=None, AzuregovSubscriptionId=None, CloudType=None, GcloudProjectCredentialsFilepath=None, GcloudProjectId=None, Id=None, OciApiPrivateKeyFilepath=None, OciCompartmentId=None, OciTenancyId=None, OciUserId=None)
