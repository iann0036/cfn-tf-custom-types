...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwtransitgatewayattachment.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwtransitgatewayattachment/handlers.py`
