...
1. Write the JSON schema describing your resource, `tf-aviatrix-devicevirtualwanattachment.json`
2. Implement your resource handlers in `tf_aviatrix_devicevirtualwanattachment/handlers.py`
