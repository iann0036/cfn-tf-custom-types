...
1. Write the JSON schema describing your resource, `tf-aviatrix-spoketransitattachment.json`
2. Implement your resource handlers in `tf_aviatrix_spoketransitattachment/handlers.py`
