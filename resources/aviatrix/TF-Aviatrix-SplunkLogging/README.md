...
1. Write the JSON schema describing your resource, `tf-aviatrix-splunklogging.json`
2. Implement your resource handlers in `tf_aviatrix_splunklogging/handlers.py`
