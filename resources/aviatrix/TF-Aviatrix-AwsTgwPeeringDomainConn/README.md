...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwpeeringdomainconn.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwpeeringdomainconn/handlers.py`
