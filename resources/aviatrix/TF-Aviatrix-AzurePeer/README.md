# TF::Aviatrix::AzurePeer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-azurepeer.json`
2. Implement your resource handlers in `tf_aviatrix_azurepeer/handlers.py`
