...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwconnectpeer.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwconnectpeer/handlers.py`
