...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwvpnconn.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwvpnconn/handlers.py`
