# TF::Aviatrix::DatadogAgent

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-datadogagent.json`
2. Implement your resource handlers in `tf_aviatrix_datadogagent/handlers.py`
