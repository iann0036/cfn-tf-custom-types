...
1. Write the JSON schema describing your resource, `tf-aviatrix-proxyconfig.json`
2. Implement your resource handlers in `tf_aviatrix_proxyconfig/handlers.py`
