...
1. Write the JSON schema describing your resource, `tf-aviatrix-fqdnpassthrough.json`
2. Implement your resource handlers in `tf_aviatrix_fqdnpassthrough/handlers.py`
