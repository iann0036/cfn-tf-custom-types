...
1. Write the JSON schema describing your resource, `tf-aviatrix-awstgwpeering.json`
2. Implement your resource handlers in `tf_aviatrix_awstgwpeering/handlers.py`
