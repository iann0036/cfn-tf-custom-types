...
1. Write the JSON schema describing your resource, `tf-aviatrix-controllerconfig.json`
2. Implement your resource handlers in `tf_aviatrix_controllerconfig/handlers.py`
