...
1. Write the JSON schema describing your resource, `tf-aviatrix-azurevngconn.json`
2. Implement your resource handlers in `tf_aviatrix_azurevngconn/handlers.py`
