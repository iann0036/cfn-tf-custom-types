...
1. Write the JSON schema describing your resource, `tf-aviatrix-rbacgroupuserattachment.json`
2. Implement your resource handlers in `tf_aviatrix_rbacgroupuserattachment/handlers.py`
