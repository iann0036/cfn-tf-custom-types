# TF::Aviatrix::SegmentationSecurityDomain

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aviatrix-segmentationsecuritydomain.json`
2. Implement your resource handlers in `tf_aviatrix_segmentationsecuritydomain/handlers.py`
