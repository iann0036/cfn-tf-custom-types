...
1. Write the JSON schema describing your resource, `tf-rollbar-projectaccesstoken.json`
2. Implement your resource handlers in `tf_rollbar_projectaccesstoken/handlers.py`
