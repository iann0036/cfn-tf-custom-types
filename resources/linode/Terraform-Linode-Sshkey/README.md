...
1. Write the JSON schema describing your resource, `terraform-linode-sshkey.json`
2. Implement your resource handlers in `terraform_linode_sshkey/handlers.py`
