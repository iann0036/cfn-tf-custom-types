...
1. Write the JSON schema describing your resource, `terraform-linode-objectstoragebucket.json`
2. Implement your resource handlers in `terraform_linode_objectstoragebucket/handlers.py`
