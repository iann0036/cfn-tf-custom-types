# TF::Linode::Nodebalancer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-linode-nodebalancer.json`
2. Implement your resource handlers in `tf_linode_nodebalancer/handlers.py`
