...
1. Write the JSON schema describing your resource, `tf-linode-objectstorageobject.json`
2. Implement your resource handlers in `tf_linode_objectstorageobject/handlers.py`
