...
1. Write the JSON schema describing your resource, `terraform-linode-nodebalancer.json`
2. Implement your resource handlers in `terraform_linode_nodebalancer/handlers.py`
