...
1. Write the JSON schema describing your resource, `tf-linode-objectstoragekey.json`
2. Implement your resource handlers in `tf_linode_objectstoragekey/handlers.py`
