...
1. Write the JSON schema describing your resource, `terraform-linode-domainrecord.json`
2. Implement your resource handlers in `terraform_linode_domainrecord/handlers.py`
