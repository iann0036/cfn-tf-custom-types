# TF::Linode::Stackscript

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-linode-stackscript.json`
2. Implement your resource handlers in `tf_linode_stackscript/handlers.py`
