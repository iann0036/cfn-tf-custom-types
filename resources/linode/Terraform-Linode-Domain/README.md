...
1. Write the JSON schema describing your resource, `terraform-linode-domain.json`
2. Implement your resource handlers in `terraform_linode_domain/handlers.py`
