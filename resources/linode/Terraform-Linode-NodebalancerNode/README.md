...
1. Write the JSON schema describing your resource, `terraform-linode-nodebalancernode.json`
2. Implement your resource handlers in `terraform_linode_nodebalancernode/handlers.py`
