...
1. Write the JSON schema describing your resource, `tf-linode-nodebalancerconfig.json`
2. Implement your resource handlers in `tf_linode_nodebalancerconfig/handlers.py`
