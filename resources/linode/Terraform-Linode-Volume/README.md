...
1. Write the JSON schema describing your resource, `terraform-linode-volume.json`
2. Implement your resource handlers in `terraform_linode_volume/handlers.py`
