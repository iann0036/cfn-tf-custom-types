...
1. Write the JSON schema describing your resource, `terraform-linode-stackscript.json`
2. Implement your resource handlers in `terraform_linode_stackscript/handlers.py`
