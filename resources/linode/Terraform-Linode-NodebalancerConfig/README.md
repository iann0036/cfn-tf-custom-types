...
1. Write the JSON schema describing your resource, `terraform-linode-nodebalancerconfig.json`
2. Implement your resource handlers in `terraform_linode_nodebalancerconfig/handlers.py`
