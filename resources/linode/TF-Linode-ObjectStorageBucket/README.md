...
1. Write the JSON schema describing your resource, `tf-linode-objectstoragebucket.json`
2. Implement your resource handlers in `tf_linode_objectstoragebucket/handlers.py`
