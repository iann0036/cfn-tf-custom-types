# TF::Linode::NodebalancerNode

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-linode-nodebalancernode.json`
2. Implement your resource handlers in `tf_linode_nodebalancernode/handlers.py`
