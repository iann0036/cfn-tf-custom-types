...
1. Write the JSON schema describing your resource, `terraform-linode-objectstoragekey.json`
2. Implement your resource handlers in `terraform_linode_objectstoragekey/handlers.py`
