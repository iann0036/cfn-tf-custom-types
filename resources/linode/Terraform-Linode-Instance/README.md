...
1. Write the JSON schema describing your resource, `terraform-linode-instance.json`
2. Implement your resource handlers in `terraform_linode_instance/handlers.py`
