# TF::Metal::SpotMarketRequest

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-metal-spotmarketrequest.json`
2. Implement your resource handlers in `tf_metal_spotmarketrequest/handlers.py`
