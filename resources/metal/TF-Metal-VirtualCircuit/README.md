...
1. Write the JSON schema describing your resource, `tf-metal-virtualcircuit.json`
2. Implement your resource handlers in `tf_metal_virtualcircuit/handlers.py`
