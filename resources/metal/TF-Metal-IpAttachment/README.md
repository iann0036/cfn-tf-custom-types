# TF::Metal::IpAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-metal-ipattachment.json`
2. Implement your resource handlers in `tf_metal_ipattachment/handlers.py`
