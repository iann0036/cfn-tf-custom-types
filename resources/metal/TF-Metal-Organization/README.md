# TF::Metal::Organization

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-metal-organization.json`
2. Implement your resource handlers in `tf_metal_organization/handlers.py`
