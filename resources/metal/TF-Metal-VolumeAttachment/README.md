# TF::Metal::VolumeAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-metal-volumeattachment.json`
2. Implement your resource handlers in `tf_metal_volumeattachment/handlers.py`
