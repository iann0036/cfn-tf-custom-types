...
1. Write the JSON schema describing your resource, `tf-cloudscale-objectsuser.json`
2. Implement your resource handlers in `tf_cloudscale_objectsuser/handlers.py`
