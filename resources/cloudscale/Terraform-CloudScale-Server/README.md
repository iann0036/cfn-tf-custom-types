...
1. Write the JSON schema describing your resource, `terraform-cloudscale-server.json`
2. Implement your resource handlers in `terraform_cloudscale_server/handlers.py`
