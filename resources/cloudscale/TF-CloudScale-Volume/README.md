# TF::CloudScale::Volume

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudscale-volume.json`
2. Implement your resource handlers in `tf_cloudscale_volume/handlers.py`
