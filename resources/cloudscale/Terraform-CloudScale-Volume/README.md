...
1. Write the JSON schema describing your resource, `terraform-cloudscale-volume.json`
2. Implement your resource handlers in `terraform_cloudscale_volume/handlers.py`
