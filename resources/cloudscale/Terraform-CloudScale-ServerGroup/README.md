...
1. Write the JSON schema describing your resource, `terraform-cloudscale-servergroup.json`
2. Implement your resource handlers in `terraform_cloudscale_servergroup/handlers.py`
