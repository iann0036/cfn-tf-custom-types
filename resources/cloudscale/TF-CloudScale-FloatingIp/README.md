...
1. Write the JSON schema describing your resource, `tf-cloudscale-floatingip.json`
2. Implement your resource handlers in `tf_cloudscale_floatingip/handlers.py`
