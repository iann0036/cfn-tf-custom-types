...
1. Write the JSON schema describing your resource, `terraform-cloudscale-network.json`
2. Implement your resource handlers in `terraform_cloudscale_network/handlers.py`
