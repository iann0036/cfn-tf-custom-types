...
1. Write the JSON schema describing your resource, `terraform-cloudscale-floatingip.json`
2. Implement your resource handlers in `terraform_cloudscale_floatingip/handlers.py`
