...
1. Write the JSON schema describing your resource, `tf-azurecaf-namingconvention.json`
2. Implement your resource handlers in `tf_azurecaf_namingconvention/handlers.py`
