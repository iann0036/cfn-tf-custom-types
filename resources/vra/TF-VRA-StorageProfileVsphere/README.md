...
1. Write the JSON schema describing your resource, `tf-vra-storageprofilevsphere.json`
2. Implement your resource handlers in `tf_vra_storageprofilevsphere/handlers.py`
