# TF::VRA::CloudAccountAzure

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vra-cloudaccountazure.json`
2. Implement your resource handlers in `tf_vra_cloudaccountazure/handlers.py`
