...
1. Write the JSON schema describing your resource, `tf-vra-cloudaccountvsphere.json`
2. Implement your resource handlers in `tf_vra_cloudaccountvsphere/handlers.py`
