...
1. Write the JSON schema describing your resource, `tf-vra-fabricnetworkvsphere.json`
2. Implement your resource handlers in `tf_vra_fabricnetworkvsphere/handlers.py`
