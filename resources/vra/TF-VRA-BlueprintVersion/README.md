...
1. Write the JSON schema describing your resource, `tf-vra-blueprintversion.json`
2. Implement your resource handlers in `tf_vra_blueprintversion/handlers.py`
