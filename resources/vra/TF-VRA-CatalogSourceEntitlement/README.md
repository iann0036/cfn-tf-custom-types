...
1. Write the JSON schema describing your resource, `tf-vra-catalogsourceentitlement.json`
2. Implement your resource handlers in `tf_vra_catalogsourceentitlement/handlers.py`
