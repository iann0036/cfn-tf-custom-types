# TF::VRA::CloudAccountGcp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vra-cloudaccountgcp.json`
2. Implement your resource handlers in `tf_vra_cloudaccountgcp/handlers.py`
