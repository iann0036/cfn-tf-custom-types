...
1. Write the JSON schema describing your resource, `tf-vra-catalogsourceblueprint.json`
2. Implement your resource handlers in `tf_vra_catalogsourceblueprint/handlers.py`
