# TF::VRA::CloudAccountVmc

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vra-cloudaccountvmc.json`
2. Implement your resource handlers in `tf_vra_cloudaccountvmc/handlers.py`
