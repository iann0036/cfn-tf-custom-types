# TF::VRA::NetworkIpRange

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vra-networkiprange.json`
2. Implement your resource handlers in `tf_vra_networkiprange/handlers.py`
