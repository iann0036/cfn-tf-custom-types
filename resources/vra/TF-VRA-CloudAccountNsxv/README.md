...
1. Write the JSON schema describing your resource, `tf-vra-cloudaccountnsxv.json`
2. Implement your resource handlers in `tf_vra_cloudaccountnsxv/handlers.py`
