# TF::VRA::CloudAccountNsxt

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vra-cloudaccountnsxt.json`
2. Implement your resource handlers in `tf_vra_cloudaccountnsxt/handlers.py`
