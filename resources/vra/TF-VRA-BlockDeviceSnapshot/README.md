...
1. Write the JSON schema describing your resource, `tf-vra-blockdevicesnapshot.json`
2. Implement your resource handlers in `tf_vra_blockdevicesnapshot/handlers.py`
