...
1. Write the JSON schema describing your resource, `tf-vra-storageprofileazure.json`
2. Implement your resource handlers in `tf_vra_storageprofileazure/handlers.py`
