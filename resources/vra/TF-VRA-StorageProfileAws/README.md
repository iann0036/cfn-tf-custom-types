...
1. Write the JSON schema describing your resource, `tf-vra-storageprofileaws.json`
2. Implement your resource handlers in `tf_vra_storageprofileaws/handlers.py`
