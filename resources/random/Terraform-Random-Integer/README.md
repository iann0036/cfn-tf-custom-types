...
1. Write the JSON schema describing your resource, `terraform-random-integer.json`
2. Implement your resource handlers in `terraform_random_integer/handlers.py`
