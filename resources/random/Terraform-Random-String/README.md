...
1. Write the JSON schema describing your resource, `terraform-random-string.json`
2. Implement your resource handlers in `terraform_random_string/handlers.py`
