...
1. Write the JSON schema describing your resource, `terraform-random-password.json`
2. Implement your resource handlers in `terraform_random_password/handlers.py`
