...
1. Write the JSON schema describing your resource, `terraform-random-shuffle.json`
2. Implement your resource handlers in `terraform_random_shuffle/handlers.py`
