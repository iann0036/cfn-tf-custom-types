# TF::HCP::VaultClusterAdminToken

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-hcp-vaultclusteradmintoken.json`
2. Implement your resource handlers in `tf_hcp_vaultclusteradmintoken/handlers.py`
