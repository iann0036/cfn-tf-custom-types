...
1. Write the JSON schema describing your resource, `tf-hcp-awsnetworkpeering.json`
2. Implement your resource handlers in `tf_hcp_awsnetworkpeering/handlers.py`
