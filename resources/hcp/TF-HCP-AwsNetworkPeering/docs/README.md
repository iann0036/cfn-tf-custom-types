# TF::HCP::AwsNetworkPeering

CloudFormation equivalent of hcp_aws_network_peering
...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#peervpcregion" title="PeerVpcRegion">PeerVpcRegion</a>" : <i>String</i>,
...
Returns the <code>ProviderPeeringId</code> value.
