# TF::HCP::ConsulClusterRootToken

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-hcp-consulclusterroottoken.json`
2. Implement your resource handlers in `tf_hcp_consulclusterroottoken/handlers.py`
