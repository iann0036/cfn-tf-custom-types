...
1. Write the JSON schema describing your resource, `tf-hcp-awstransitgatewayattachment.json`
2. Implement your resource handlers in `tf_hcp_awstransitgatewayattachment/handlers.py`
