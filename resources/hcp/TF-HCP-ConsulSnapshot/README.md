# TF::HCP::ConsulSnapshot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-hcp-consulsnapshot.json`
2. Implement your resource handlers in `tf_hcp_consulsnapshot/handlers.py`
