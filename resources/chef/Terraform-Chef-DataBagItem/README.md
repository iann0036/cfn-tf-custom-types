...
1. Write the JSON schema describing your resource, `terraform-chef-databagitem.json`
2. Implement your resource handlers in `terraform_chef_databagitem/handlers.py`
