...
1. Write the JSON schema describing your resource, `terraform-chef-environment.json`
2. Implement your resource handlers in `terraform_chef_environment/handlers.py`
