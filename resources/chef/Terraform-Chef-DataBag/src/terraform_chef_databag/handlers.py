...
def create_handler(
    ...
    try:
        ...
        tf['resource']['chef_data_bag'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['chef_data_bag'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
