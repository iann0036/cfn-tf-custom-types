...
1. Write the JSON schema describing your resource, `tf-victorops-teammembership.json`
2. Implement your resource handlers in `tf_victorops_teammembership/handlers.py`
