...
1. Write the JSON schema describing your resource, `tf-victorops-escalationpolicy.json`
2. Implement your resource handlers in `tf_victorops_escalationpolicy/handlers.py`
