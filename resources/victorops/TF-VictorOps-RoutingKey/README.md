...
1. Write the JSON schema describing your resource, `tf-victorops-routingkey.json`
2. Implement your resource handlers in `tf_victorops_routingkey/handlers.py`
