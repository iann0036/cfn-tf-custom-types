...
1. Write the JSON schema describing your resource, `terraform-ns1-notifylist.json`
2. Implement your resource handlers in `terraform_ns1_notifylist/handlers.py`
