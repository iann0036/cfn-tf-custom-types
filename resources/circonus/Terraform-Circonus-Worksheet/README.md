...
1. Write the JSON schema describing your resource, `terraform-circonus-worksheet.json`
2. Implement your resource handlers in `terraform_circonus_worksheet/handlers.py`
