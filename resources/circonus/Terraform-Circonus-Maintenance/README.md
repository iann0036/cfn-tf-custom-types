...
1. Write the JSON schema describing your resource, `terraform-circonus-maintenance.json`
2. Implement your resource handlers in `terraform_circonus_maintenance/handlers.py`
