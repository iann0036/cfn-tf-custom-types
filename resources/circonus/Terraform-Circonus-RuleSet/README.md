...
1. Write the JSON schema describing your resource, `terraform-circonus-ruleset.json`
2. Implement your resource handlers in `terraform_circonus_ruleset/handlers.py`
