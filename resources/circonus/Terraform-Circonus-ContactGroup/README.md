...
1. Write the JSON schema describing your resource, `terraform-circonus-contactgroup.json`
2. Implement your resource handlers in `terraform_circonus_contactgroup/handlers.py`
