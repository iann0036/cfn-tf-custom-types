...
1. Write the JSON schema describing your resource, `terraform-circonus-metric.json`
2. Implement your resource handlers in `terraform_circonus_metric/handlers.py`
