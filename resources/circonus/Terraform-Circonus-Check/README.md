...
1. Write the JSON schema describing your resource, `terraform-circonus-check.json`
2. Implement your resource handlers in `terraform_circonus_check/handlers.py`
