...
1. Write the JSON schema describing your resource, `tf-circonus-contactgroup.json`
2. Implement your resource handlers in `tf_circonus_contactgroup/handlers.py`
