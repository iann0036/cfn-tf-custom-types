...
1. Write the JSON schema describing your resource, `terraform-circonus-overlayset.json`
2. Implement your resource handlers in `terraform_circonus_overlayset/handlers.py`
