...
1. Write the JSON schema describing your resource, `tf-circonus-maintenance.json`
2. Implement your resource handlers in `tf_circonus_maintenance/handlers.py`
