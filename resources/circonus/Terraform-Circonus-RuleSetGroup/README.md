...
1. Write the JSON schema describing your resource, `terraform-circonus-rulesetgroup.json`
2. Implement your resource handlers in `terraform_circonus_rulesetgroup/handlers.py`
