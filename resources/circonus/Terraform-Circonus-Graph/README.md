...
1. Write the JSON schema describing your resource, `terraform-circonus-graph.json`
2. Implement your resource handlers in `terraform_circonus_graph/handlers.py`
