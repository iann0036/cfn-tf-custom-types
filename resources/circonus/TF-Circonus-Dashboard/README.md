# TF::Circonus::Dashboard

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-circonus-dashboard.json`
2. Implement your resource handlers in `tf_circonus_dashboard/handlers.py`
