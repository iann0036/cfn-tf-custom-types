...
1. Write the JSON schema describing your resource, `terraform-circonus-metriccluster.json`
2. Implement your resource handlers in `terraform_circonus_metriccluster/handlers.py`
