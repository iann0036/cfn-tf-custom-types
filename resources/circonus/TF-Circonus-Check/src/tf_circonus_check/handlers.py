...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/circonus_check/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'circonus-labs/circonus',
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/circonus_check/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/circonus_check/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Active=None, CheckByCollector=None, CheckId=None, Checks=None, Created=None, Id=None, LastModified=None, LastModifiedBy=None, MetricLimit=None, Name=None, Notes=None, Period=None, ReverseConnectUrls=None, Tags=None, Target=None, Timeout=None, Type=None, Uuids=None, Caql=None, Cloudwatch=None, Collector=None, Consul=None, Dns=None, External=None, Http=None, Httptrap=None, IcmpPing=None, Jmx=None, Json=None, Memcached=None, Metric=None, MetricFilter=None, Mysql=None, Ntp=None, Postgresql=None, Promtext=None, Redis=None, Smtp=None, Snmp=None, Statsd=None, Tcp=None)
