# Terraform::Circonus::Dashboard

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-circonus-dashboard.json`
2. Implement your resource handlers in `terraform_circonus_dashboard/handlers.py`
