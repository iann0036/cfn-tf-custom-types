# TF::Circonus::Worksheet

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-circonus-worksheet.json`
2. Implement your resource handlers in `tf_circonus_worksheet/handlers.py`
