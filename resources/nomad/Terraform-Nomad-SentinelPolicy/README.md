...
1. Write the JSON schema describing your resource, `terraform-nomad-sentinelpolicy.json`
2. Implement your resource handlers in `terraform_nomad_sentinelpolicy/handlers.py`
