...
1. Write the JSON schema describing your resource, `tf-nomad-externalvolume.json`
2. Implement your resource handlers in `tf_nomad_externalvolume/handlers.py`
