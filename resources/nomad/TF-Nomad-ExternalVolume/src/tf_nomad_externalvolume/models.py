...
class ResourceModel(BaseModel):
    ...
    CapacityMax: Optional[str]
    CapacityMin: Optional[str]
    CloneId: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            CapacityMax=json_data.get("CapacityMax"),
            CapacityMin=json_data.get("CapacityMin"),
            CloneId=json_data.get("CloneId"),
