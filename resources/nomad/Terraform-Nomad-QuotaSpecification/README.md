...
1. Write the JSON schema describing your resource, `terraform-nomad-quotaspecification.json`
2. Implement your resource handlers in `terraform_nomad_quotaspecification/handlers.py`
