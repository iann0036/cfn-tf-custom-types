...
1. Write the JSON schema describing your resource, `terraform-nomad-aclpolicy.json`
2. Implement your resource handlers in `terraform_nomad_aclpolicy/handlers.py`
