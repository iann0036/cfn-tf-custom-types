# TF::Nomad::QuotaSpecification

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nomad-quotaspecification.json`
2. Implement your resource handlers in `tf_nomad_quotaspecification/handlers.py`
