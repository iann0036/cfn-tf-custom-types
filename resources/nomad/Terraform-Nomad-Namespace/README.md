# Terraform::Nomad::Namespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-nomad-namespace.json`
2. Implement your resource handlers in `terraform_nomad_namespace/handlers.py`
