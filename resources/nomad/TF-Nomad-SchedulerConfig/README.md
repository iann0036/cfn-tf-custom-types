...
1. Write the JSON schema describing your resource, `tf-nomad-schedulerconfig.json`
2. Implement your resource handlers in `tf_nomad_schedulerconfig/handlers.py`
