# TF::Nomad::SentinelPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nomad-sentinelpolicy.json`
2. Implement your resource handlers in `tf_nomad_sentinelpolicy/handlers.py`
