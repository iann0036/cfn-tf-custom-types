...
1. Write the JSON schema describing your resource, `terraform-nomad-acltoken.json`
2. Implement your resource handlers in `terraform_nomad_acltoken/handlers.py`
