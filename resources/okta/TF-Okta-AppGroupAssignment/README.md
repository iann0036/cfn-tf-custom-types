...
1. Write the JSON schema describing your resource, `tf-okta-appgroupassignment.json`
2. Implement your resource handlers in `tf_okta_appgroupassignment/handlers.py`
