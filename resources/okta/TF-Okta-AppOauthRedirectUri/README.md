# TF::Okta::AppOauthRedirectUri

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-okta-appoauthredirecturi.json`
2. Implement your resource handlers in `tf_okta_appoauthredirecturi/handlers.py`
