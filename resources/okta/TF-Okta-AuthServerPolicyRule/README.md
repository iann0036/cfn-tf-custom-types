...
1. Write the JSON schema describing your resource, `tf-okta-authserverpolicyrule.json`
2. Implement your resource handlers in `tf_okta_authserverpolicyrule/handlers.py`
