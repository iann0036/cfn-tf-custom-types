# TF::Okta::SignonPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-okta-signonpolicy.json`
2. Implement your resource handlers in `tf_okta_signonpolicy/handlers.py`
