...
1. Write the JSON schema describing your resource, `tf-okta-adminroletargets.json`
2. Implement your resource handlers in `tf_okta_adminroletargets/handlers.py`
