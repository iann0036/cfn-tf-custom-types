# TF::Okta::AppUserBaseSchema

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-okta-appuserbaseschema.json`
2. Implement your resource handlers in `tf_okta_appuserbaseschema/handlers.py`
