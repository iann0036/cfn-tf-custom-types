...
1. Write the JSON schema describing your resource, `tf-okta-policymfadefault.json`
2. Implement your resource handlers in `tf_okta_policymfadefault/handlers.py`
