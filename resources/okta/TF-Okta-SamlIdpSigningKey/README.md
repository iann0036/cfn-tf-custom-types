...
1. Write the JSON schema describing your resource, `tf-okta-samlidpsigningkey.json`
2. Implement your resource handlers in `tf_okta_samlidpsigningkey/handlers.py`
