# TF::Okta::OauthAppRedirectUri

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-okta-oauthappredirecturi.json`
2. Implement your resource handlers in `tf_okta_oauthappredirecturi/handlers.py`
