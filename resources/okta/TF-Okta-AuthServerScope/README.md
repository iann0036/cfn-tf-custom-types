...
1. Write the JSON schema describing your resource, `tf-okta-authserverscope.json`
2. Implement your resource handlers in `tf_okta_authserverscope/handlers.py`
