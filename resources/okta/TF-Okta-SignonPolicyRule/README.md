...
1. Write the JSON schema describing your resource, `tf-okta-signonpolicyrule.json`
2. Implement your resource handlers in `tf_okta_signonpolicyrule/handlers.py`
