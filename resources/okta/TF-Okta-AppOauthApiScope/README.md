...
1. Write the JSON schema describing your resource, `tf-okta-appoauthapiscope.json`
2. Implement your resource handlers in `tf_okta_appoauthapiscope/handlers.py`
