...
1. Write the JSON schema describing your resource, `tf-okta-appsecurepasswordstore.json`
2. Implement your resource handlers in `tf_okta_appsecurepasswordstore/handlers.py`
