...
1. Write the JSON schema describing your resource, `tf-okta-authserverdefault.json`
2. Implement your resource handlers in `tf_okta_authserverdefault/handlers.py`
