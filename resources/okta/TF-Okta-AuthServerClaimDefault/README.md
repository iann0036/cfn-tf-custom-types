...
1. Write the JSON schema describing your resource, `tf-okta-authserverclaimdefault.json`
2. Implement your resource handlers in `tf_okta_authserverclaimdefault/handlers.py`
