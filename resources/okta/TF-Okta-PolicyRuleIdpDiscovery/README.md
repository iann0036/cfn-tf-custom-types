...
1. Write the JSON schema describing your resource, `tf-okta-policyruleidpdiscovery.json`
2. Implement your resource handlers in `tf_okta_policyruleidpdiscovery/handlers.py`
