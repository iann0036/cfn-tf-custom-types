...
1. Write the JSON schema describing your resource, `tf-okta-policyrulesignon.json`
2. Implement your resource handlers in `tf_okta_policyrulesignon/handlers.py`
