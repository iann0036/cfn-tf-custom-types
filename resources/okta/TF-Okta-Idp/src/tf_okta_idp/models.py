...
class ResourceModel(BaseModel):
    ...
    Type: Optional[str]
    UserInfoBinding: Optional[str]
    UserInfoUrl: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            JwksBinding=json_data.get("JwksBinding"),
            ...
            UserInfoBinding=json_data.get("UserInfoBinding"),
            UserInfoUrl=json_data.get("UserInfoUrl"),
