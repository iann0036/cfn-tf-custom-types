...
1. Write the JSON schema describing your resource, `tf-okta-policyrulepassword.json`
2. Implement your resource handlers in `tf_okta_policyrulepassword/handlers.py`
