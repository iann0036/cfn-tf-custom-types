...
1. Write the JSON schema describing your resource, `tf-okta-groupmembership.json`
2. Implement your resource handlers in `tf_okta_groupmembership/handlers.py`
