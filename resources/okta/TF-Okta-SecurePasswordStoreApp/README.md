...
1. Write the JSON schema describing your resource, `tf-okta-securepasswordstoreapp.json`
2. Implement your resource handlers in `tf_okta_securepasswordstoreapp/handlers.py`
