...
1. Write the JSON schema describing your resource, `tf-okta-policypassworddefault.json`
2. Implement your resource handlers in `tf_okta_policypassworddefault/handlers.py`
