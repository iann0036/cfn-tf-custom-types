...
1. Write the JSON schema describing your resource, `tf-okta-authserverclaim.json`
2. Implement your resource handlers in `tf_okta_authserverclaim/handlers.py`
