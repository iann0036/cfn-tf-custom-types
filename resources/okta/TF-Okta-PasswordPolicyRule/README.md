...
1. Write the JSON schema describing your resource, `tf-okta-passwordpolicyrule.json`
2. Implement your resource handlers in `tf_okta_passwordpolicyrule/handlers.py`
