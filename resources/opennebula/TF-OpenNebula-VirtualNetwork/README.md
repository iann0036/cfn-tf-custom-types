...
1. Write the JSON schema describing your resource, `tf-opennebula-virtualnetwork.json`
2. Implement your resource handlers in `tf_opennebula_virtualnetwork/handlers.py`
