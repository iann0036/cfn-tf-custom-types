...
1. Write the JSON schema describing your resource, `tf-opennebula-virtualmachinegroup.json`
2. Implement your resource handlers in `tf_opennebula_virtualmachinegroup/handlers.py`
