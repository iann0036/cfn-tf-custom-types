...
1. Write the JSON schema describing your resource, `tf-opennebula-virtualdatacenter.json`
2. Implement your resource handlers in `tf_opennebula_virtualdatacenter/handlers.py`
