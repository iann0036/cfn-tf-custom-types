...
class ResourceModel(BaseModel):
    ...
    AuthDriver: Optional[str]
    Groups: Optional[Sequence[float]]
    Id: Optional[str]
    Name: Optional[str]
    Password: Optional[str]
    PrimaryGroup: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AuthDriver=json_data.get("AuthDriver"),
            Groups=json_data.get("Groups"),
            Id=json_data.get("Id"),
            Name=json_data.get("Name"),
            Password=json_data.get("Password"),
            PrimaryGroup=json_data.get("PrimaryGroup"),
