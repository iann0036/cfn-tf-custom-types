...
1. Write the JSON schema describing your resource, `tf-opennebula-securitygroup.json`
2. Implement your resource handlers in `tf_opennebula_securitygroup/handlers.py`
