...
1. Write the JSON schema describing your resource, `tf-opennebula-servicetemplate.json`
2. Implement your resource handlers in `tf_opennebula_servicetemplate/handlers.py`
