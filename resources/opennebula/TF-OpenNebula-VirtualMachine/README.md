...
1. Write the JSON schema describing your resource, `tf-opennebula-virtualmachine.json`
2. Implement your resource handlers in `tf_opennebula_virtualmachine/handlers.py`
