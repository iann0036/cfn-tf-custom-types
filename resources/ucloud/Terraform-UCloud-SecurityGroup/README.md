...
1. Write the JSON schema describing your resource, `terraform-ucloud-securitygroup.json`
2. Implement your resource handlers in `terraform_ucloud_securitygroup/handlers.py`
