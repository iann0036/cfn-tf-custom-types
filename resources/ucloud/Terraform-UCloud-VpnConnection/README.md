...
1. Write the JSON schema describing your resource, `terraform-ucloud-vpnconnection.json`
2. Implement your resource handlers in `terraform_ucloud_vpnconnection/handlers.py`
