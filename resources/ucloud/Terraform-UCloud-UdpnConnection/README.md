...
1. Write the JSON schema describing your resource, `terraform-ucloud-udpnconnection.json`
2. Implement your resource handlers in `terraform_ucloud_udpnconnection/handlers.py`
