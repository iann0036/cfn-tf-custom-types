...
1. Write the JSON schema describing your resource, `terraform-ucloud-lbattachment.json`
2. Implement your resource handlers in `terraform_ucloud_lbattachment/handlers.py`
