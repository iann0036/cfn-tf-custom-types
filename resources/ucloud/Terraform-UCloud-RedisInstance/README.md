...
1. Write the JSON schema describing your resource, `terraform-ucloud-redisinstance.json`
2. Implement your resource handlers in `terraform_ucloud_redisinstance/handlers.py`
