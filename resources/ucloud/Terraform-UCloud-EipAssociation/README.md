...
1. Write the JSON schema describing your resource, `terraform-ucloud-eipassociation.json`
2. Implement your resource handlers in `terraform_ucloud_eipassociation/handlers.py`
