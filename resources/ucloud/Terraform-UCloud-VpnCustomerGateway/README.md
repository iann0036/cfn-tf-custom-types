# Terraform::UCloud::VpnCustomerGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-ucloud-vpncustomergateway.json`
2. Implement your resource handlers in `terraform_ucloud_vpncustomergateway/handlers.py`
