...
1. Write the JSON schema describing your resource, `terraform-ucloud-natgatewayrule.json`
2. Implement your resource handlers in `terraform_ucloud_natgatewayrule/handlers.py`
