...
1. Write the JSON schema describing your resource, `terraform-ucloud-vpngateway.json`
2. Implement your resource handlers in `terraform_ucloud_vpngateway/handlers.py`
