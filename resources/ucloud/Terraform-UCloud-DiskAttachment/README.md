...
1. Write the JSON schema describing your resource, `terraform-ucloud-diskattachment.json`
2. Implement your resource handlers in `terraform_ucloud_diskattachment/handlers.py`
