...
1. Write the JSON schema describing your resource, `terraform-ucloud-memcacheinstance.json`
2. Implement your resource handlers in `terraform_ucloud_memcacheinstance/handlers.py`
