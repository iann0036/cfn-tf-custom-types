...
1. Write the JSON schema describing your resource, `terraform-ucloud-lbrule.json`
2. Implement your resource handlers in `terraform_ucloud_lbrule/handlers.py`
