...
1. Write the JSON schema describing your resource, `terraform-ucloud-natgateway.json`
2. Implement your resource handlers in `terraform_ucloud_natgateway/handlers.py`
