...
1. Write the JSON schema describing your resource, `terraform-ucloud-lbsslattachment.json`
2. Implement your resource handlers in `terraform_ucloud_lbsslattachment/handlers.py`
