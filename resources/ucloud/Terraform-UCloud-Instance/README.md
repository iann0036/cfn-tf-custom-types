...
1. Write the JSON schema describing your resource, `terraform-ucloud-instance.json`
2. Implement your resource handlers in `terraform_ucloud_instance/handlers.py`
