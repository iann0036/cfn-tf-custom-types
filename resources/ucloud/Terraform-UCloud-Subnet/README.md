...
1. Write the JSON schema describing your resource, `terraform-ucloud-subnet.json`
2. Implement your resource handlers in `terraform_ucloud_subnet/handlers.py`
