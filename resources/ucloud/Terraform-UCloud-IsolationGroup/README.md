...
1. Write the JSON schema describing your resource, `terraform-ucloud-isolationgroup.json`
2. Implement your resource handlers in `terraform_ucloud_isolationgroup/handlers.py`
