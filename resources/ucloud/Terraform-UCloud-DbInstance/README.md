...
1. Write the JSON schema describing your resource, `terraform-ucloud-dbinstance.json`
2. Implement your resource handlers in `terraform_ucloud_dbinstance/handlers.py`
