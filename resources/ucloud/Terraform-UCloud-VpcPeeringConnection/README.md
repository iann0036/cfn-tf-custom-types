...
1. Write the JSON schema describing your resource, `terraform-ucloud-vpcpeeringconnection.json`
2. Implement your resource handlers in `terraform_ucloud_vpcpeeringconnection/handlers.py`
