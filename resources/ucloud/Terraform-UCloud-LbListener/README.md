...
1. Write the JSON schema describing your resource, `terraform-ucloud-lblistener.json`
2. Implement your resource handlers in `terraform_ucloud_lblistener/handlers.py`
