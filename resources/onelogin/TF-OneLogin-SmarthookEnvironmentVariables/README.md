# TF::OneLogin::SmarthookEnvironmentVariables

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-onelogin-smarthookenvironmentvariables.json`
2. Implement your resource handlers in `tf_onelogin_smarthookenvironmentvariables/handlers.py`
