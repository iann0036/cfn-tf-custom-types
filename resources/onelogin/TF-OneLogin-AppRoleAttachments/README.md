...
1. Write the JSON schema describing your resource, `tf-onelogin-approleattachments.json`
2. Implement your resource handlers in `tf_onelogin_approleattachments/handlers.py`
