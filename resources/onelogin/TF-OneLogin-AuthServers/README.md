# TF::OneLogin::AuthServers

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-onelogin-authservers.json`
2. Implement your resource handlers in `tf_onelogin_authservers/handlers.py`
