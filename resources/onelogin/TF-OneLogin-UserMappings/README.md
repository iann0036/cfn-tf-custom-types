...
1. Write the JSON schema describing your resource, `tf-onelogin-usermappings.json`
2. Implement your resource handlers in `tf_onelogin_usermappings/handlers.py`
