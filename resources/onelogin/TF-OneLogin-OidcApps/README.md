# TF::OneLogin::OidcApps

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-onelogin-oidcapps.json`
2. Implement your resource handlers in `tf_onelogin_oidcapps/handlers.py`
