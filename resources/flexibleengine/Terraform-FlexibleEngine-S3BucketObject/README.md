...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-s3bucketobject.json`
2. Implement your resource handlers in `terraform_flexibleengine_s3bucketobject/handlers.py`
