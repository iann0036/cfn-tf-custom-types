# Terraform::FlexibleEngine::AsGroupV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-asgroupv1.json`
2. Implement your resource handlers in `terraform_flexibleengine_asgroupv1/handlers.py`
