...
def create_handler(
    ...
    try:
        ...
        tf['resource']['flexibleengine_elb_health'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['flexibleengine_elb_health'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
