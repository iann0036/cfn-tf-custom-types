...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-elbhealth.json`
2. Implement your resource handlers in `terraform_flexibleengine_elbhealth/handlers.py`
