...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-computebmsserverv2.json`
2. Implement your resource handlers in `terraform_flexibleengine_computebmsserverv2/handlers.py`
