...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-rdsparametergroupv3.json`
2. Implement your resource handlers in `terraform_flexibleengine_rdsparametergroupv3/handlers.py`
