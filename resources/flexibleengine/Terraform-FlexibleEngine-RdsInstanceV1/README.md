...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-rdsinstancev1.json`
2. Implement your resource handlers in `terraform_flexibleengine_rdsinstancev1/handlers.py`
