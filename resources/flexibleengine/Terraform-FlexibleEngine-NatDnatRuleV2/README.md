...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-natdnatrulev2.json`
2. Implement your resource handlers in `terraform_flexibleengine_natdnatrulev2/handlers.py`
