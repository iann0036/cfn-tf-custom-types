...
def create_handler(
    ...
    try:
        ...
        tf['resource']['flexibleengine_networking_router_route_v2'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['flexibleengine_networking_router_route_v2'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
