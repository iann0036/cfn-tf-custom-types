# Terraform::FlexibleEngine::LbWhitelistV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-lbwhitelistv2.json`
2. Implement your resource handlers in `terraform_flexibleengine_lbwhitelistv2/handlers.py`
