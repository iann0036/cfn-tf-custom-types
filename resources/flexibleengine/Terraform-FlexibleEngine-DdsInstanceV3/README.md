...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-ddsinstancev3.json`
2. Implement your resource handlers in `terraform_flexibleengine_ddsinstancev3/handlers.py`
