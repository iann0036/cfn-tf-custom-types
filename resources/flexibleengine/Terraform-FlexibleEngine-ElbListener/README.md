# Terraform::FlexibleEngine::ElbListener

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-elblistener.json`
2. Implement your resource handlers in `terraform_flexibleengine_elblistener/handlers.py`
