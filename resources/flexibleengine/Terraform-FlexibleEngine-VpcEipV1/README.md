# Terraform::FlexibleEngine::VpcEipV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-vpceipv1.json`
2. Implement your resource handlers in `terraform_flexibleengine_vpceipv1/handlers.py`
