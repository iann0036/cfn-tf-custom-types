...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-dcsinstancev1.json`
2. Implement your resource handlers in `terraform_flexibleengine_dcsinstancev1/handlers.py`
