...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-sdrsprotectedinstancev1.json`
2. Implement your resource handlers in `terraform_flexibleengine_sdrsprotectedinstancev1/handlers.py`
