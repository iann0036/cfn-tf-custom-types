...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-s3bucket.json`
2. Implement your resource handlers in `terraform_flexibleengine_s3bucket/handlers.py`
