# Terraform::FlexibleEngine::RtsSoftwareConfigV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-rtssoftwareconfigv1.json`
2. Implement your resource handlers in `terraform_flexibleengine_rtssoftwareconfigv1/handlers.py`
