...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-elbbackend.json`
2. Implement your resource handlers in `terraform_flexibleengine_elbbackend/handlers.py`
