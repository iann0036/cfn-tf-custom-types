# Terraform::FlexibleEngine::LbL7ruleV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-lbl7rulev2.json`
2. Implement your resource handlers in `terraform_flexibleengine_lbl7rulev2/handlers.py`
