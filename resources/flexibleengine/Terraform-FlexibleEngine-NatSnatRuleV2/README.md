...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-natsnatrulev2.json`
2. Implement your resource handlers in `terraform_flexibleengine_natsnatrulev2/handlers.py`
