...
class ResourceModel(BaseResourceModel):
    ...
    DeleteTargetVolume: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DeleteTargetVolume=json_data.get("DeleteTargetVolume"),
            ...
            TargetVolumeId=json_data.get("TargetVolumeId"),
