# Terraform::FlexibleEngine::VpcPeeringConnectionAccepterV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-vpcpeeringconnectionaccepterv2.json`
2. Implement your resource handlers in `terraform_flexibleengine_vpcpeeringconnectionaccepterv2/handlers.py`
