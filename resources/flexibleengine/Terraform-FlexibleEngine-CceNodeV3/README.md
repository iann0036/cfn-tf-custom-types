# Terraform::FlexibleEngine::CceNodeV3

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-ccenodev3.json`
2. Implement your resource handlers in `terraform_flexibleengine_ccenodev3/handlers.py`
