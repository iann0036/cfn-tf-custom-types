...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-computefloatingipv2.json`
2. Implement your resource handlers in `terraform_flexibleengine_computefloatingipv2/handlers.py`
