...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-networkingfloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_flexibleengine_networkingfloatingipassociatev2/handlers.py`
