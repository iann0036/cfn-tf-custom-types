...
CloudFormation equivalent of flexibleengine_lb_listener_v2
...
<pre>
{
    "Type" : "Terraform::FlexibleEngine::LbListenerV2",
    "Properties" : {
        ...
        "<a href="#tlscipherspolicy" title="TlsCiphersPolicy">TlsCiphersPolicy</a>" : <i>String</i>,
