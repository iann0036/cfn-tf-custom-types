...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-networkingsecgroupv2.json`
2. Implement your resource handlers in `terraform_flexibleengine_networkingsecgroupv2/handlers.py`
