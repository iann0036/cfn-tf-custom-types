# Terraform::FlexibleEngine::ComputeFloatingipAssociateV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-computefloatingipassociatev2.json`
2. Implement your resource handlers in `terraform_flexibleengine_computefloatingipassociatev2/handlers.py`
