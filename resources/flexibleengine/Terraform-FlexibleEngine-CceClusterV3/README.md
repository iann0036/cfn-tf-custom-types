...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-cceclusterv3.json`
2. Implement your resource handlers in `terraform_flexibleengine_cceclusterv3/handlers.py`
