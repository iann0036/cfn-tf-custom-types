...
def create_handler(
    ...
    try:
        ...
        tf['resource']['flexibleengine_mls_instance_v1'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['flexibleengine_mls_instance_v1'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
