...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-mlsinstancev1.json`
2. Implement your resource handlers in `terraform_flexibleengine_mlsinstancev1/handlers.py`
