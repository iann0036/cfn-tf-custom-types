...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-cesalarmrule.json`
2. Implement your resource handlers in `terraform_flexibleengine_cesalarmrule/handlers.py`
