# Terraform::FlexibleEngine::FwRuleV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-flexibleengine-fwrulev2.json`
2. Implement your resource handlers in `terraform_flexibleengine_fwrulev2/handlers.py`
