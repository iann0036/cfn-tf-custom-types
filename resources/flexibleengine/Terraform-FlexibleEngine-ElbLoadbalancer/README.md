...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-elbloadbalancer.json`
2. Implement your resource handlers in `terraform_flexibleengine_elbloadbalancer/handlers.py`
