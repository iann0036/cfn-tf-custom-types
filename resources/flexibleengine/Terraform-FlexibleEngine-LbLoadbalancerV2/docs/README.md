...
CloudFormation equivalent of flexibleengine_lb_loadbalancer_v2
...
<pre>
{
    "Type" : "Terraform::FlexibleEngine::LbLoadbalancerV2",
    "Properties" : {
        ...
        "<a href="#vipportid" title="VipPortId">VipPortId</a>" : <i>String</i>,
