...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-vpcsubnetv1.json`
2. Implement your resource handlers in `terraform_flexibleengine_vpcsubnetv1/handlers.py`
