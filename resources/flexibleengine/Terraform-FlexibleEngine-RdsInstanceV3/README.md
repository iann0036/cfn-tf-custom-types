...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-rdsinstancev3.json`
2. Implement your resource handlers in `terraform_flexibleengine_rdsinstancev3/handlers.py`
