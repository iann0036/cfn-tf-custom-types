...
1. Write the JSON schema describing your resource, `terraform-flexibleengine-csbsbackuppolicyv1.json`
2. Implement your resource handlers in `terraform_flexibleengine_csbsbackuppolicyv1/handlers.py`
