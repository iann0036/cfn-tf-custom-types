...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-auditing.json`
2. Implement your resource handlers in `tf_mongodbatlas_auditing/handlers.py`
