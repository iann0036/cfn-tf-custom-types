...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-privatelinkendpoint.json`
2. Implement your resource handlers in `tf_mongodbatlas_privatelinkendpoint/handlers.py`
