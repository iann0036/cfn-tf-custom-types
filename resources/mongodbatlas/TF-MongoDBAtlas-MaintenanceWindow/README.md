...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-maintenancewindow.json`
2. Implement your resource handlers in `tf_mongodbatlas_maintenancewindow/handlers.py`
