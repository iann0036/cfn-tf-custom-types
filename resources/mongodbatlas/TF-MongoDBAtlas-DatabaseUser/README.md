...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-databaseuser.json`
2. Implement your resource handlers in `tf_mongodbatlas_databaseuser/handlers.py`
