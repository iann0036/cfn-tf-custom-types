...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-privateipmode.json`
2. Implement your resource handlers in `tf_mongodbatlas_privateipmode/handlers.py`
