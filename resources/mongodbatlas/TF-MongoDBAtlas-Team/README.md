# TF::MongoDBAtlas::Team

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mongodbatlas-team.json`
2. Implement your resource handlers in `tf_mongodbatlas_team/handlers.py`
