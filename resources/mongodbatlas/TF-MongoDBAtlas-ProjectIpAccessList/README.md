...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-projectipaccesslist.json`
2. Implement your resource handlers in `tf_mongodbatlas_projectipaccesslist/handlers.py`
