...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-customdnsconfigurationclusteraws.json`
2. Implement your resource handlers in `tf_mongodbatlas_customdnsconfigurationclusteraws/handlers.py`
