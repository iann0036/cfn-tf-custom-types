...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-networkcontainer.json`
2. Implement your resource handlers in `tf_mongodbatlas_networkcontainer/handlers.py`
