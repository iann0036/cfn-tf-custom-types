...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-alertconfiguration.json`
2. Implement your resource handlers in `tf_mongodbatlas_alertconfiguration/handlers.py`
