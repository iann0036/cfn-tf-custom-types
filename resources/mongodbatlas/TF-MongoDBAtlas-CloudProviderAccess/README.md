# TF::MongoDBAtlas::CloudProviderAccess

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mongodbatlas-cloudprovideraccess.json`
2. Implement your resource handlers in `tf_mongodbatlas_cloudprovideraccess/handlers.py`
