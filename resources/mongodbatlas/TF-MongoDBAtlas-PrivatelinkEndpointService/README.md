...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-privatelinkendpointservice.json`
2. Implement your resource handlers in `tf_mongodbatlas_privatelinkendpointservice/handlers.py`
