...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-globalclusterconfig.json`
2. Implement your resource handlers in `tf_mongodbatlas_globalclusterconfig/handlers.py`
