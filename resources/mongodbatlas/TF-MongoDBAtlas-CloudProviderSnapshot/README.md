...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-cloudprovidersnapshot.json`
2. Implement your resource handlers in `tf_mongodbatlas_cloudprovidersnapshot/handlers.py`
