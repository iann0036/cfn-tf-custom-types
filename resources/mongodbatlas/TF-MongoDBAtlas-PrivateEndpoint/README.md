...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-privateendpoint.json`
2. Implement your resource handlers in `tf_mongodbatlas_privateendpoint/handlers.py`
