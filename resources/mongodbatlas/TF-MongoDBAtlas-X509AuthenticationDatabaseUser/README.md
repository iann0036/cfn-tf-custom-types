...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-x509authenticationdatabaseuser.json`
2. Implement your resource handlers in `tf_mongodbatlas_x509authenticationdatabaseuser/handlers.py`
