...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-cloudprovidersnapshotrestorejob.json`
2. Implement your resource handlers in `tf_mongodbatlas_cloudprovidersnapshotrestorejob/handlers.py`
