...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-cloudprovideraccessauthorization.json`
2. Implement your resource handlers in `tf_mongodbatlas_cloudprovideraccessauthorization/handlers.py`
