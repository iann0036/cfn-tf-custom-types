...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-networkpeering.json`
2. Implement your resource handlers in `tf_mongodbatlas_networkpeering/handlers.py`
