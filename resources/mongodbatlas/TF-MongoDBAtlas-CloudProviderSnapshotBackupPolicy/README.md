...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-cloudprovidersnapshotbackuppolicy.json`
2. Implement your resource handlers in `tf_mongodbatlas_cloudprovidersnapshotbackuppolicy/handlers.py`
