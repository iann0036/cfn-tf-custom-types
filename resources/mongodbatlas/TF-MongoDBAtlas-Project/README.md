...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-project.json`
2. Implement your resource handlers in `tf_mongodbatlas_project/handlers.py`
