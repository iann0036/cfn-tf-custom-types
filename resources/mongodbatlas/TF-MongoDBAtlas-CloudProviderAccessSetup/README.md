# TF::MongoDBAtlas::CloudProviderAccessSetup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-mongodbatlas-cloudprovideraccesssetup.json`
2. Implement your resource handlers in `tf_mongodbatlas_cloudprovideraccesssetup/handlers.py`
