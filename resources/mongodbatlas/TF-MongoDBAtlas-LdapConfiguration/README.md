...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-ldapconfiguration.json`
2. Implement your resource handlers in `tf_mongodbatlas_ldapconfiguration/handlers.py`
