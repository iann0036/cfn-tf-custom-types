...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-cluster.json`
2. Implement your resource handlers in `tf_mongodbatlas_cluster/handlers.py`
