...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-privateendpointinterfacelink.json`
2. Implement your resource handlers in `tf_mongodbatlas_privateendpointinterfacelink/handlers.py`
