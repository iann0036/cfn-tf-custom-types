...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-encryptionatrest.json`
2. Implement your resource handlers in `tf_mongodbatlas_encryptionatrest/handlers.py`
