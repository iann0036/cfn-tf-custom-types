...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-projectipwhitelist.json`
2. Implement your resource handlers in `tf_mongodbatlas_projectipwhitelist/handlers.py`
