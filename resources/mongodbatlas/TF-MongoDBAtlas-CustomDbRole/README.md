...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-customdbrole.json`
2. Implement your resource handlers in `tf_mongodbatlas_customdbrole/handlers.py`
