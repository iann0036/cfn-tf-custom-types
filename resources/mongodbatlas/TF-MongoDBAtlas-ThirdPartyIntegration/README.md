...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-thirdpartyintegration.json`
2. Implement your resource handlers in `tf_mongodbatlas_thirdpartyintegration/handlers.py`
