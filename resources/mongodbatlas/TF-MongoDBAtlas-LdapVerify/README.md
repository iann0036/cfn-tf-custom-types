...
1. Write the JSON schema describing your resource, `tf-mongodbatlas-ldapverify.json`
2. Implement your resource handlers in `tf_mongodbatlas_ldapverify/handlers.py`
