...
1. Write the JSON schema describing your resource, `terraform-spotinst-multaideployment.json`
2. Implement your resource handlers in `terraform_spotinst_multaideployment/handlers.py`
