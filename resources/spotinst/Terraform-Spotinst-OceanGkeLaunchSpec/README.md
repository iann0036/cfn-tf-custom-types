...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceangkelaunchspec.json`
2. Implement your resource handlers in `terraform_spotinst_oceangkelaunchspec/handlers.py`
