...
1. Write the JSON schema describing your resource, `terraform-spotinst-elastigroupazure.json`
2. Implement your resource handlers in `terraform_spotinst_elastigroupazure/handlers.py`
