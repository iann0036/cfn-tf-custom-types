...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupazure.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupazure/handlers.py`
