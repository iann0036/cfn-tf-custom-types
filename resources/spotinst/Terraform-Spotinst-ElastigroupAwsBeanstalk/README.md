...
1. Write the JSON schema describing your resource, `terraform-spotinst-elastigroupawsbeanstalk.json`
2. Implement your resource handlers in `terraform_spotinst_elastigroupawsbeanstalk/handlers.py`
