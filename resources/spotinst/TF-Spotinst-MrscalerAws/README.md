...
1. Write the JSON schema describing your resource, `tf-spotinst-mrscaleraws.json`
2. Implement your resource handlers in `tf_spotinst_mrscaleraws/handlers.py`
