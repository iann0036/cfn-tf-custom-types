...
TYPE_NAME = "TF::Spotinst::MrscalerAws"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/spotinst_mrscaler_aws/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/spotinst_mrscaler_aws/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/spotinst_mrscaler_aws/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AdditionalInfo=None, AdditionalPrimarySecurityGroups=None, AdditionalReplicaSecurityGroups=None, AvailabilityZones=None, ClusterId=None, CoreDesiredCapacity=None, CoreEbsOptimized=None, CoreInstanceTypes=None, CoreLifecycle=None, CoreMaxSize=None, CoreMinSize=None, CoreUnit=None, CustomAmiId=None, Description=None, EbsRootVolumeSize=None, Ec2KeyName=None, ExposeClusterId=None, Id=None, JobFlowRole=None, KeepJobFlowAlive=None, LogUri=None, ManagedPrimarySecurityGroup=None, ManagedReplicaSecurityGroup=None, MasterEbsOptimized=None, MasterInstanceTypes=None, MasterLifecycle=None, Name=None, OutputClusterId=None, Region=None, ReleaseLabel=None, RepoUpgradeOnBoot=None, Retries=None, SecurityConfig=None, ServiceAccessSecurityGroup=None, ServiceRole=None, Strategy=None, TaskDesiredCapacity=None, TaskEbsOptimized=None, TaskInstanceTypes=None, TaskLifecycle=None, TaskMaxSize=None, TaskMinSize=None, TaskUnit=None, TerminationProtected=None, VisibleToAllUsers=None, Applications=None, BootstrapActionsFile=None, ConfigurationsFile=None, CoreEbsBlockDevice=None, CoreScalingDownPolicy=None, CoreScalingUpPolicy=None, InstanceWeights=None, MasterEbsBlockDevice=None, ProvisioningTimeout=None, ScheduledTask=None, StepsFile=None, Tags=None, TaskEbsBlockDevice=None, TaskScalingDownPolicy=None, TaskScalingUpPolicy=None, TerminationPolicies=None)
