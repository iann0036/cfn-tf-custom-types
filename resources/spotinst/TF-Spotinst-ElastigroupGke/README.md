...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupgke.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupgke/handlers.py`
