...
1. Write the JSON schema describing your resource, `terraform-spotinst-elastigroupgke.json`
2. Implement your resource handlers in `terraform_spotinst_elastigroupgke/handlers.py`
