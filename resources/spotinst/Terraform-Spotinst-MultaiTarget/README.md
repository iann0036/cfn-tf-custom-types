...
1. Write the JSON schema describing your resource, `terraform-spotinst-multaitarget.json`
2. Implement your resource handlers in `terraform_spotinst_multaitarget/handlers.py`
