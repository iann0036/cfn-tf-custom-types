...
def create_handler(
    ...
    try:
        ...
        tf['resource']['spotinst_ocean_aws_launch_spec'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['spotinst_ocean_aws_launch_spec'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
