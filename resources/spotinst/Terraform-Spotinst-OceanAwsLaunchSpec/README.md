...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceanawslaunchspec.json`
2. Implement your resource handlers in `terraform_spotinst_oceanawslaunchspec/handlers.py`
