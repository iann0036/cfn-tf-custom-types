...
1. Write the JSON schema describing your resource, `terraform-spotinst-multairoutingrule.json`
2. Implement your resource handlers in `terraform_spotinst_multairoutingrule/handlers.py`
