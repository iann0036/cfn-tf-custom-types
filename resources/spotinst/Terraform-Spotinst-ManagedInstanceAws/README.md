...
1. Write the JSON schema describing your resource, `terraform-spotinst-managedinstanceaws.json`
2. Implement your resource handlers in `terraform_spotinst_managedinstanceaws/handlers.py`
