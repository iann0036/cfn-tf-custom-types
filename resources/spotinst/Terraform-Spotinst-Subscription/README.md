...
1. Write the JSON schema describing your resource, `terraform-spotinst-subscription.json`
2. Implement your resource handlers in `terraform_spotinst_subscription/handlers.py`
