...
1. Write the JSON schema describing your resource, `tf-spotinst-multairoutingrule.json`
2. Implement your resource handlers in `tf_spotinst_multairoutingrule/handlers.py`
