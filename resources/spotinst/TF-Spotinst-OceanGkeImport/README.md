...
1. Write the JSON schema describing your resource, `tf-spotinst-oceangkeimport.json`
2. Implement your resource handlers in `tf_spotinst_oceangkeimport/handlers.py`
