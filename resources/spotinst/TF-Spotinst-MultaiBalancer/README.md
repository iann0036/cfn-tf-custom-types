...
1. Write the JSON schema describing your resource, `tf-spotinst-multaibalancer.json`
2. Implement your resource handlers in `tf_spotinst_multaibalancer/handlers.py`
