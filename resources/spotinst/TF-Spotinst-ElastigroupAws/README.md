...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupaws.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupaws/handlers.py`
