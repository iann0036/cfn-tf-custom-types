...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupawsbeanstalk.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupawsbeanstalk/handlers.py`
