# TF::Spotinst::MultaiDeployment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-spotinst-multaideployment.json`
2. Implement your resource handlers in `tf_spotinst_multaideployment/handlers.py`
