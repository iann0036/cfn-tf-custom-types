...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceanecs.json`
2. Implement your resource handlers in `terraform_spotinst_oceanecs/handlers.py`
