...
1. Write the JSON schema describing your resource, `terraform-spotinst-mrscaleraws.json`
2. Implement your resource handlers in `terraform_spotinst_mrscaleraws/handlers.py`
