...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupawssuspension.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupawssuspension/handlers.py`
