...
1. Write the JSON schema describing your resource, `terraform-spotinst-elastigroupaws.json`
2. Implement your resource handlers in `terraform_spotinst_elastigroupaws/handlers.py`
