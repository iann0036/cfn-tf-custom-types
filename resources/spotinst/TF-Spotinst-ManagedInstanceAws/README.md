...
1. Write the JSON schema describing your resource, `tf-spotinst-managedinstanceaws.json`
2. Implement your resource handlers in `tf_spotinst_managedinstanceaws/handlers.py`
