...
1. Write the JSON schema describing your resource, `tf-spotinst-oceangkelaunchspec.json`
2. Implement your resource handlers in `tf_spotinst_oceangkelaunchspec/handlers.py`
