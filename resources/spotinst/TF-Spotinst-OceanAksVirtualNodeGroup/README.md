...
1. Write the JSON schema describing your resource, `tf-spotinst-oceanaksvirtualnodegroup.json`
2. Implement your resource handlers in `tf_spotinst_oceanaksvirtualnodegroup/handlers.py`
