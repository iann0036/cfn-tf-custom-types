...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceangkeimport.json`
2. Implement your resource handlers in `terraform_spotinst_oceangkeimport/handlers.py`
