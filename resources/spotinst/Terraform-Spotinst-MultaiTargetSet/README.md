...
1. Write the JSON schema describing your resource, `terraform-spotinst-multaitargetset.json`
2. Implement your resource handlers in `terraform_spotinst_multaitargetset/handlers.py`
