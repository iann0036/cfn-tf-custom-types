...
1. Write the JSON schema describing your resource, `terraform-spotinst-multaibalancer.json`
2. Implement your resource handlers in `terraform_spotinst_multaibalancer/handlers.py`
