...
1. Write the JSON schema describing your resource, `terraform-spotinst-multailistener.json`
2. Implement your resource handlers in `terraform_spotinst_multailistener/handlers.py`
