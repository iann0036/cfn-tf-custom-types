...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceanaws.json`
2. Implement your resource handlers in `terraform_spotinst_oceanaws/handlers.py`
