...
1. Write the JSON schema describing your resource, `terraform-spotinst-elastigroupgcp.json`
2. Implement your resource handlers in `terraform_spotinst_elastigroupgcp/handlers.py`
