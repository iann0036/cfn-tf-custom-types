...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupgcp.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupgcp/handlers.py`
