...
1. Write the JSON schema describing your resource, `tf-spotinst-subscription.json`
2. Implement your resource handlers in `tf_spotinst_subscription/handlers.py`
