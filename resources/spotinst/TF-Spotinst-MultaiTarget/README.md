...
1. Write the JSON schema describing your resource, `tf-spotinst-multaitarget.json`
2. Implement your resource handlers in `tf_spotinst_multaitarget/handlers.py`
