...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceanecslaunchspec.json`
2. Implement your resource handlers in `terraform_spotinst_oceanecslaunchspec/handlers.py`
