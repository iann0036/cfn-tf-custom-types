...
1. Write the JSON schema describing your resource, `tf-spotinst-elastigroupazurev3.json`
2. Implement your resource handlers in `tf_spotinst_elastigroupazurev3/handlers.py`
