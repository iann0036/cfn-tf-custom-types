# TF::Spotinst::MultaiListener

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-spotinst-multailistener.json`
2. Implement your resource handlers in `tf_spotinst_multailistener/handlers.py`
