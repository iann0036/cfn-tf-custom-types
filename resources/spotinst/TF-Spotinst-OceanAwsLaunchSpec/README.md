...
1. Write the JSON schema describing your resource, `tf-spotinst-oceanawslaunchspec.json`
2. Implement your resource handlers in `tf_spotinst_oceanawslaunchspec/handlers.py`
