...
1. Write the JSON schema describing your resource, `terraform-spotinst-oceangkelaunchspecimport.json`
2. Implement your resource handlers in `terraform_spotinst_oceangkelaunchspecimport/handlers.py`
