...
def create_handler(
    ...
    try:
        ...
        tf['resource']['spotinst_ocean_gke_launch_spec_import'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['spotinst_ocean_gke_launch_spec_import'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
