...
1. Write the JSON schema describing your resource, `tf-spotinst-oceanecslaunchspec.json`
2. Implement your resource handlers in `tf_spotinst_oceanecslaunchspec/handlers.py`
