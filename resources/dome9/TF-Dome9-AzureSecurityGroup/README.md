...
1. Write the JSON schema describing your resource, `tf-dome9-azuresecuritygroup.json`
2. Implement your resource handlers in `tf_dome9_azuresecuritygroup/handlers.py`
