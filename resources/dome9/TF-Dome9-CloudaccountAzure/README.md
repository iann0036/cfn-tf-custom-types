...
1. Write the JSON schema describing your resource, `tf-dome9-cloudaccountazure.json`
2. Implement your resource handlers in `tf_dome9_cloudaccountazure/handlers.py`
