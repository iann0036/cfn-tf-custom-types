...
1. Write the JSON schema describing your resource, `terraform-vault-jwtauthbackend.json`
2. Implement your resource handlers in `terraform_vault_jwtauthbackend/handlers.py`
