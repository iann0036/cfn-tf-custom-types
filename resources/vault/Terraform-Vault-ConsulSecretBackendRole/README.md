...
1. Write the JSON schema describing your resource, `terraform-vault-consulsecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_consulsecretbackendrole/handlers.py`
