# TF::Vault::PkiSecretBackendRootCert

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-pkisecretbackendrootcert.json`
2. Implement your resource handlers in `tf_vault_pkisecretbackendrootcert/handlers.py`
