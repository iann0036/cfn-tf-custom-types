...
1. Write the JSON schema describing your resource, `tf-vault-awsauthbackendidentitywhitelist.json`
2. Implement your resource handlers in `tf_vault_awsauthbackendidentitywhitelist/handlers.py`
