...
1. Write the JSON schema describing your resource, `terraform-vault-alicloudauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_alicloudauthbackendrole/handlers.py`
