...
def create_handler(
    ...
    try:
        ...
        tf['resource']['vault_alicloud_auth_backend_role'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['vault_alicloud_auth_backend_role'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
