...
1. Write the JSON schema describing your resource, `tf-vault-identitygroupmemberentityids.json`
2. Implement your resource handlers in `tf_vault_identitygroupmemberentityids/handlers.py`
