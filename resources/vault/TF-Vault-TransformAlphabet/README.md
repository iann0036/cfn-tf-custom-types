...
1. Write the JSON schema describing your resource, `tf-vault-transformalphabet.json`
2. Implement your resource handlers in `tf_vault_transformalphabet/handlers.py`
