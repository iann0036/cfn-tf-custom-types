...
1. Write the JSON schema describing your resource, `terraform-vault-authbackend.json`
2. Implement your resource handlers in `terraform_vault_authbackend/handlers.py`
