...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendrootsignintermediate.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendrootsignintermediate/handlers.py`
