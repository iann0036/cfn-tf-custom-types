...
1. Write the JSON schema describing your resource, `tf-vault-terraformcloudsecretrole.json`
2. Implement your resource handlers in `tf_vault_terraformcloudsecretrole/handlers.py`
