...
1. Write the JSON schema describing your resource, `terraform-vault-ldapauthbackenduser.json`
2. Implement your resource handlers in `terraform_vault_ldapauthbackenduser/handlers.py`
