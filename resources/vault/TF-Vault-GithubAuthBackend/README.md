...
1. Write the JSON schema describing your resource, `tf-vault-githubauthbackend.json`
2. Implement your resource handlers in `tf_vault_githubauthbackend/handlers.py`
