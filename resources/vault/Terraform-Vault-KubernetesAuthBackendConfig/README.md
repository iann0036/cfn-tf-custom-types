...
1. Write the JSON schema describing your resource, `terraform-vault-kubernetesauthbackendconfig.json`
2. Implement your resource handlers in `terraform_vault_kubernetesauthbackendconfig/handlers.py`
