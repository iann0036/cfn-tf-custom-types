...
1. Write the JSON schema describing your resource, `terraform-vault-sshsecretbackendca.json`
2. Implement your resource handlers in `terraform_vault_sshsecretbackendca/handlers.py`
