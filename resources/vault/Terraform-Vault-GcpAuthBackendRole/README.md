...
1. Write the JSON schema describing your resource, `terraform-vault-gcpauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_gcpauthbackendrole/handlers.py`
