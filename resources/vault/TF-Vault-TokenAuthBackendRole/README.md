# TF::Vault::TokenAuthBackendRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-tokenauthbackendrole.json`
2. Implement your resource handlers in `tf_vault_tokenauthbackendrole/handlers.py`
