...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendsign.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendsign/handlers.py`
