...
1. Write the JSON schema describing your resource, `tf-vault-awssecretbackend.json`
2. Implement your resource handlers in `tf_vault_awssecretbackend/handlers.py`
