# TF::Vault::PkiSecretBackendRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-pkisecretbackendrole.json`
2. Implement your resource handlers in `tf_vault_pkisecretbackendrole/handlers.py`
