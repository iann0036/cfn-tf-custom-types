...
1. Write the JSON schema describing your resource, `tf-vault-transformtransformation.json`
2. Implement your resource handlers in `tf_vault_transformtransformation/handlers.py`
