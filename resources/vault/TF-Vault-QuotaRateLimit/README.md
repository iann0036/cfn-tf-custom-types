...
1. Write the JSON schema describing your resource, `tf-vault-quotaratelimit.json`
2. Implement your resource handlers in `tf_vault_quotaratelimit/handlers.py`
