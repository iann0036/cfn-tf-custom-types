...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendcert.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendcert/handlers.py`
