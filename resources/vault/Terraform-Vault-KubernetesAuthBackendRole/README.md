...
1. Write the JSON schema describing your resource, `terraform-vault-kubernetesauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_kubernetesauthbackendrole/handlers.py`
