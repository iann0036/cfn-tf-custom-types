...
<pre>
{
    "Type" : "Terraform::Vault::KubernetesAuthBackendRole",
    "Properties" : {
        "<a href="#audience" title="Audience">Audience</a>" : <i>String</i>,
        "<a href="#backend" title="Backend">Backend</a>" : <i>String</i>,
        "<a href="#boundcidrs" title="BoundCidrs">BoundCidrs</a>" : <i>[ String, ... ]</i>,
        "<a href="#boundserviceaccountnames" title="BoundServiceAccountNames">BoundServiceAccountNames</a>" : <i>[ String, ... ]</i>,
        "<a href="#boundserviceaccountnamespaces" title="BoundServiceAccountNamespaces">BoundServiceAccountNamespaces</a>" : <i>[ String, ... ]</i>,
...
Properties:
    ...
    <a href="#boundcidrs" title="BoundCidrs">BoundCidrs</a>: <i>
      - String</i>
    <a href="#boundserviceaccountnames" title="BoundServiceAccountNames">BoundServiceAccountNames</a>: <i>
      - String</i>
    <a href="#boundserviceaccountnamespaces" title="BoundServiceAccountNamespaces">BoundServiceAccountNamespaces</a>: <i>
      - String</i>
    <a href="#maxttl" title="MaxTtl">MaxTtl</a>: <i>Double</i>
    <a href="#numuses" title="NumUses">NumUses</a>: <i>Double</i>
    <a href="#period" title="Period">Period</a>: <i>Double</i>
