...
1. Write the JSON schema describing your resource, `tf-vault-adsecretbackend.json`
2. Implement your resource handlers in `tf_vault_adsecretbackend/handlers.py`
