# TF::Vault::ApproleAuthBackendLogin

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-approleauthbackendlogin.json`
2. Implement your resource handlers in `tf_vault_approleauthbackendlogin/handlers.py`
