# TF::Vault::PkiSecretBackendCrlConfig

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-pkisecretbackendcrlconfig.json`
2. Implement your resource handlers in `tf_vault_pkisecretbackendcrlconfig/handlers.py`
