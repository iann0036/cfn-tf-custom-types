...
1. Write the JSON schema describing your resource, `terraform-vault-rabbitmqsecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_rabbitmqsecretbackendrole/handlers.py`
