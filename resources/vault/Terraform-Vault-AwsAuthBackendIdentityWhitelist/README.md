...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendidentitywhitelist.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendidentitywhitelist/handlers.py`
