...
1. Write the JSON schema describing your resource, `terraform-vault-identityentitypolicies.json`
2. Implement your resource handlers in `terraform_vault_identityentitypolicies/handlers.py`
