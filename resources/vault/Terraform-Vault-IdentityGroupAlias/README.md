...
1. Write the JSON schema describing your resource, `terraform-vault-identitygroupalias.json`
2. Implement your resource handlers in `terraform_vault_identitygroupalias/handlers.py`
