# TF::Vault::GcpAuthBackend

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-gcpauthbackend.json`
2. Implement your resource handlers in `tf_vault_gcpauthbackend/handlers.py`
