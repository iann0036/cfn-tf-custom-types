...
1. Write the JSON schema describing your resource, `tf-vault-nomadsecretrole.json`
2. Implement your resource handlers in `tf_vault_nomadsecretrole/handlers.py`
