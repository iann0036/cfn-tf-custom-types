...
1. Write the JSON schema describing your resource, `terraform-vault-databasesecretbackendconnection.json`
2. Implement your resource handlers in `terraform_vault_databasesecretbackendconnection/handlers.py`
