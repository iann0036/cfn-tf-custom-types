...
1. Write the JSON schema describing your resource, `terraform-vault-transitsecretcacheconfig.json`
2. Implement your resource handlers in `terraform_vault_transitsecretcacheconfig/handlers.py`
