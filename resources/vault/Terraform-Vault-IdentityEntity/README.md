...
1. Write the JSON schema describing your resource, `terraform-vault-identityentity.json`
2. Implement your resource handlers in `terraform_vault_identityentity/handlers.py`
