# TF::Vault::TerraformCloudSecretBackend

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-terraformcloudsecretbackend.json`
2. Implement your resource handlers in `tf_vault_terraformcloudsecretbackend/handlers.py`
