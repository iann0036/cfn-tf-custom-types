...
1. Write the JSON schema describing your resource, `terraform-vault-rgppolicy.json`
2. Implement your resource handlers in `terraform_vault_rgppolicy/handlers.py`
