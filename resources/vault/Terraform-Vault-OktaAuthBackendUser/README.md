...
1. Write the JSON schema describing your resource, `terraform-vault-oktaauthbackenduser.json`
2. Implement your resource handlers in `terraform_vault_oktaauthbackenduser/handlers.py`
