...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendcert.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendcert/handlers.py`
