...
1. Write the JSON schema describing your resource, `terraform-vault-githubauthbackend.json`
2. Implement your resource handlers in `terraform_vault_githubauthbackend/handlers.py`
