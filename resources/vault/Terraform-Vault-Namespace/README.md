...
1. Write the JSON schema describing your resource, `terraform-vault-namespace.json`
2. Implement your resource handlers in `terraform_vault_namespace/handlers.py`
