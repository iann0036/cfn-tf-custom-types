...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendconfigca.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendconfigca/handlers.py`
