...
1. Write the JSON schema describing your resource, `terraform-vault-tokenauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_tokenauthbackendrole/handlers.py`
