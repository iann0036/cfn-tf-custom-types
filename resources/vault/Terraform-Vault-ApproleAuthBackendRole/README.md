...
1. Write the JSON schema describing your resource, `terraform-vault-approleauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_approleauthbackendrole/handlers.py`
