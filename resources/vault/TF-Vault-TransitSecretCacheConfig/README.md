...
1. Write the JSON schema describing your resource, `tf-vault-transitsecretcacheconfig.json`
2. Implement your resource handlers in `tf_vault_transitsecretcacheconfig/handlers.py`
