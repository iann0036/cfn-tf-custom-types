...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendroletagblacklist.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendroletagblacklist/handlers.py`
