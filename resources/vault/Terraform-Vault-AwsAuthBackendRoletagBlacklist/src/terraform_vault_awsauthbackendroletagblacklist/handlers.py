...
def create_handler(
    ...
    try:
        ...
        tf['resource']['vault_aws_auth_backend_roletag_blacklist'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['vault_aws_auth_backend_roletag_blacklist'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
