...
1. Write the JSON schema describing your resource, `terraform-vault-azureauthbackendconfig.json`
2. Implement your resource handlers in `terraform_vault_azureauthbackendconfig/handlers.py`
