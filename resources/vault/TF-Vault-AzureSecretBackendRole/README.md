...
1. Write the JSON schema describing your resource, `tf-vault-azuresecretbackendrole.json`
2. Implement your resource handlers in `tf_vault_azuresecretbackendrole/handlers.py`
