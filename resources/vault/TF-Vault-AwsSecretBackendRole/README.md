...
1. Write the JSON schema describing your resource, `tf-vault-awssecretbackendrole.json`
2. Implement your resource handlers in `tf_vault_awssecretbackendrole/handlers.py`
