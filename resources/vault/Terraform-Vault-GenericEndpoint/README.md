...
1. Write the JSON schema describing your resource, `terraform-vault-genericendpoint.json`
2. Implement your resource handlers in `terraform_vault_genericendpoint/handlers.py`
