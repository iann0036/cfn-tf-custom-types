...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendintermediatesetsigned.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendintermediatesetsigned/handlers.py`
