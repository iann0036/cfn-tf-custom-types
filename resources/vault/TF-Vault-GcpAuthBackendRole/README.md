# TF::Vault::GcpAuthBackendRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-gcpauthbackendrole.json`
2. Implement your resource handlers in `tf_vault_gcpauthbackendrole/handlers.py`
