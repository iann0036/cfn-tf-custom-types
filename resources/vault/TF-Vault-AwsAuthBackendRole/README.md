...
1. Write the JSON schema describing your resource, `tf-vault-awsauthbackendrole.json`
2. Implement your resource handlers in `tf_vault_awsauthbackendrole/handlers.py`
