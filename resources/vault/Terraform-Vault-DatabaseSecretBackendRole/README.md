...
1. Write the JSON schema describing your resource, `terraform-vault-databasesecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_databasesecretbackendrole/handlers.py`
