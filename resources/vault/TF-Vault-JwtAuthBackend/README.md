...
1. Write the JSON schema describing your resource, `tf-vault-jwtauthbackend.json`
2. Implement your resource handlers in `tf_vault_jwtauthbackend/handlers.py`
