...
1. Write the JSON schema describing your resource, `terraform-vault-consulsecretbackend.json`
2. Implement your resource handlers in `terraform_vault_consulsecretbackend/handlers.py`
