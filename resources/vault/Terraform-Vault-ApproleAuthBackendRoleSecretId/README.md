...
1. Write the JSON schema describing your resource, `terraform-vault-approleauthbackendrolesecretid.json`
2. Implement your resource handlers in `terraform_vault_approleauthbackendrolesecretid/handlers.py`
