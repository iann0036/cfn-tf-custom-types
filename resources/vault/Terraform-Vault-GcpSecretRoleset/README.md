...
1. Write the JSON schema describing your resource, `terraform-vault-gcpsecretroleset.json`
2. Implement your resource handlers in `terraform_vault_gcpsecretroleset/handlers.py`
