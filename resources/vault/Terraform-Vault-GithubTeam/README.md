...
1. Write the JSON schema describing your resource, `terraform-vault-githubteam.json`
2. Implement your resource handlers in `terraform_vault_githubteam/handlers.py`
