...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendconfigurls.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendconfigurls/handlers.py`
