...
1. Write the JSON schema describing your resource, `tf-vault-jwtauthbackendrole.json`
2. Implement your resource handlers in `tf_vault_jwtauthbackendrole/handlers.py`
