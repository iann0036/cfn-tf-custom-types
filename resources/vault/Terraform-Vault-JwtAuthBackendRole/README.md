...
1. Write the JSON schema describing your resource, `terraform-vault-jwtauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_jwtauthbackendrole/handlers.py`
