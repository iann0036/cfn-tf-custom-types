# Terraform::Vault::MfaDuo

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-vault-mfaduo.json`
2. Implement your resource handlers in `terraform_vault_mfaduo/handlers.py`
