...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendrole/handlers.py`
