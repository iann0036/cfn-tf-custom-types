...
1. Write the JSON schema describing your resource, `terraform-vault-ldapauthbackendgroup.json`
2. Implement your resource handlers in `terraform_vault_ldapauthbackendgroup/handlers.py`
