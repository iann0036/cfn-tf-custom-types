...
1. Write the JSON schema describing your resource, `terraform-vault-certauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_certauthbackendrole/handlers.py`
