...
1. Write the JSON schema describing your resource, `terraform-vault-egppolicy.json`
2. Implement your resource handlers in `terraform_vault_egppolicy/handlers.py`
