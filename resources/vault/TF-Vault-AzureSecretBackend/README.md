# TF::Vault::AzureSecretBackend

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-azuresecretbackend.json`
2. Implement your resource handlers in `tf_vault_azuresecretbackend/handlers.py`
