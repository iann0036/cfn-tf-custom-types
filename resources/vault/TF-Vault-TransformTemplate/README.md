# TF::Vault::TransformTemplate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-transformtemplate.json`
2. Implement your resource handlers in `tf_vault_transformtemplate/handlers.py`
