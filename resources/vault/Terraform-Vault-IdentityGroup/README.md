...
1. Write the JSON schema describing your resource, `terraform-vault-identitygroup.json`
2. Implement your resource handlers in `terraform_vault_identitygroup/handlers.py`
