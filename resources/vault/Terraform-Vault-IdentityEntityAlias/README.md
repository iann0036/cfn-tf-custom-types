...
1. Write the JSON schema describing your resource, `terraform-vault-identityentityalias.json`
2. Implement your resource handlers in `terraform_vault_identityentityalias/handlers.py`
