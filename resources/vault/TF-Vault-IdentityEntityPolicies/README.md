# TF::Vault::IdentityEntityPolicies

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-identityentitypolicies.json`
2. Implement your resource handlers in `tf_vault_identityentitypolicies/handlers.py`
