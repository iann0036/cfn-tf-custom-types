...
1. Write the JSON schema describing your resource, `terraform-vault-identityoidc.json`
2. Implement your resource handlers in `terraform_vault_identityoidc/handlers.py`
