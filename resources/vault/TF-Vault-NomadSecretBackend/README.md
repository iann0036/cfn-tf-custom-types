...
1. Write the JSON schema describing your resource, `tf-vault-nomadsecretbackend.json`
2. Implement your resource handlers in `tf_vault_nomadsecretbackend/handlers.py`
