...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendclient.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendclient/handlers.py`
