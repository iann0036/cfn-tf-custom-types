...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackend.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackend/handlers.py`
