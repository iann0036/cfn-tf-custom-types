...
1. Write the JSON schema describing your resource, `terraform-vault-azureauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_azureauthbackendrole/handlers.py`
