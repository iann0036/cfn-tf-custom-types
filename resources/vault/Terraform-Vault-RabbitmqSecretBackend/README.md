...
1. Write the JSON schema describing your resource, `terraform-vault-rabbitmqsecretbackend.json`
2. Implement your resource handlers in `terraform_vault_rabbitmqsecretbackend/handlers.py`
