...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendrole.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendrole/handlers.py`
