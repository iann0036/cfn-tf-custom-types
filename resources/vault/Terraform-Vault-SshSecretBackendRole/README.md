...
1. Write the JSON schema describing your resource, `terraform-vault-sshsecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_sshsecretbackendrole/handlers.py`
