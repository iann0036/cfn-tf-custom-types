...
1. Write the JSON schema describing your resource, `terraform-vault-gcpauthbackend.json`
2. Implement your resource handlers in `terraform_vault_gcpauthbackend/handlers.py`
