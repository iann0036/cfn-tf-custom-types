...
1. Write the JSON schema describing your resource, `terraform-vault-identitygrouppolicies.json`
2. Implement your resource handlers in `terraform_vault_identitygrouppolicies/handlers.py`
