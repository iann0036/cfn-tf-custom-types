...
1. Write the JSON schema describing your resource, `terraform-vault-azuresecretbackend.json`
2. Implement your resource handlers in `terraform_vault_azuresecretbackend/handlers.py`
