...
1. Write the JSON schema describing your resource, `tf-vault-ldapauthbackenduser.json`
2. Implement your resource handlers in `tf_vault_ldapauthbackenduser/handlers.py`
