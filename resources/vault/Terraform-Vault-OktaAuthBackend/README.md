...
1. Write the JSON schema describing your resource, `terraform-vault-oktaauthbackend.json`
2. Implement your resource handlers in `terraform_vault_oktaauthbackend/handlers.py`
