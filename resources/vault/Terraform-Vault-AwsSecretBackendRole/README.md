...
1. Write the JSON schema describing your resource, `terraform-vault-awssecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_awssecretbackendrole/handlers.py`
