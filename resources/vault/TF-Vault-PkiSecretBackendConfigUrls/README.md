# TF::Vault::PkiSecretBackendConfigUrls

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-pkisecretbackendconfigurls.json`
2. Implement your resource handlers in `tf_vault_pkisecretbackendconfigurls/handlers.py`
