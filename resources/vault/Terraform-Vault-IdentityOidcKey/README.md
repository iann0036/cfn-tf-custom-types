...
1. Write the JSON schema describing your resource, `terraform-vault-identityoidckey.json`
2. Implement your resource handlers in `terraform_vault_identityoidckey/handlers.py`
