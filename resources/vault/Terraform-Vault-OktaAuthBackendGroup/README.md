...
1. Write the JSON schema describing your resource, `terraform-vault-oktaauthbackendgroup.json`
2. Implement your resource handlers in `terraform_vault_oktaauthbackendgroup/handlers.py`
