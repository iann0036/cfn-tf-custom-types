...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendintermediatecertrequest.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendintermediatecertrequest/handlers.py`
