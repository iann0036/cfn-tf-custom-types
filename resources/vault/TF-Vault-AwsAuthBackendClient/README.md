# TF::Vault::AwsAuthBackendClient

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-awsauthbackendclient.json`
2. Implement your resource handlers in `tf_vault_awsauthbackendclient/handlers.py`
