...
1. Write the JSON schema describing your resource, `terraform-vault-approleauthbackendlogin.json`
2. Implement your resource handlers in `terraform_vault_approleauthbackendlogin/handlers.py`
