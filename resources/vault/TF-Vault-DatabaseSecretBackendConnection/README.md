...
1. Write the JSON schema describing your resource, `tf-vault-databasesecretbackendconnection.json`
2. Implement your resource handlers in `tf_vault_databasesecretbackendconnection/handlers.py`
