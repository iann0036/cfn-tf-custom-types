...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendcrlconfig.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendcrlconfig/handlers.py`
