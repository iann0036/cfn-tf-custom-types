# TF::Vault::GcpSecretBackend

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-gcpsecretbackend.json`
2. Implement your resource handlers in `tf_vault_gcpsecretbackend/handlers.py`
