...
1. Write the JSON schema describing your resource, `terraform-vault-transitsecretbackendkey.json`
2. Implement your resource handlers in `terraform_vault_transitsecretbackendkey/handlers.py`
