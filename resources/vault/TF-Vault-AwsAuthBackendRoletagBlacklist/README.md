...
1. Write the JSON schema describing your resource, `tf-vault-awsauthbackendroletagblacklist.json`
2. Implement your resource handlers in `tf_vault_awsauthbackendroletagblacklist/handlers.py`
