...
1. Write the JSON schema describing your resource, `tf-vault-identitygrouppolicies.json`
2. Implement your resource handlers in `tf_vault_identitygrouppolicies/handlers.py`
