...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendroletag.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendroletag/handlers.py`
