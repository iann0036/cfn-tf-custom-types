...
1. Write the JSON schema describing your resource, `terraform-vault-databasesecretbackendstaticrole.json`
2. Implement your resource handlers in `terraform_vault_databasesecretbackendstaticrole/handlers.py`
