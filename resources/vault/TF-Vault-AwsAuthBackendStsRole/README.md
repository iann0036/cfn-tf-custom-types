# TF::Vault::AwsAuthBackendStsRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-awsauthbackendstsrole.json`
2. Implement your resource handlers in `tf_vault_awsauthbackendstsrole/handlers.py`
