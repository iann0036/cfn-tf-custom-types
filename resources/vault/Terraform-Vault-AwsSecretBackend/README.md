...
1. Write the JSON schema describing your resource, `terraform-vault-awssecretbackend.json`
2. Implement your resource handlers in `terraform_vault_awssecretbackend/handlers.py`
