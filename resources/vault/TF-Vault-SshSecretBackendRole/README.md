...
1. Write the JSON schema describing your resource, `tf-vault-sshsecretbackendrole.json`
2. Implement your resource handlers in `tf_vault_sshsecretbackendrole/handlers.py`
