...
1. Write the JSON schema describing your resource, `terraform-vault-pkisecretbackendrootcert.json`
2. Implement your resource handlers in `terraform_vault_pkisecretbackendrootcert/handlers.py`
