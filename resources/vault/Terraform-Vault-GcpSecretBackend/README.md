...
1. Write the JSON schema describing your resource, `terraform-vault-gcpsecretbackend.json`
2. Implement your resource handlers in `terraform_vault_gcpsecretbackend/handlers.py`
