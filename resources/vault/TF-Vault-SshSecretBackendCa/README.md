# TF::Vault::SshSecretBackendCa

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-sshsecretbackendca.json`
2. Implement your resource handlers in `tf_vault_sshsecretbackendca/handlers.py`
