...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendstsrole.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendstsrole/handlers.py`
