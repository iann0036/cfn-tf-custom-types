...
1. Write the JSON schema describing your resource, `terraform-vault-githubuser.json`
2. Implement your resource handlers in `terraform_vault_githubuser/handlers.py`
