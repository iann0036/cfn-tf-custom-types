...
1. Write the JSON schema describing your resource, `terraform-vault-awsauthbackendlogin.json`
2. Implement your resource handlers in `terraform_vault_awsauthbackendlogin/handlers.py`
