...
def create_handler(
    ...
    try:
        ...
        tf['resource']['vault_aws_auth_backend_login'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['vault_aws_auth_backend_login'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
