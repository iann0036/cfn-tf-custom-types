...
1. Write the JSON schema describing your resource, `terraform-vault-identityoidckeyallowedclientid.json`
2. Implement your resource handlers in `terraform_vault_identityoidckeyallowedclientid/handlers.py`
