...
1. Write the JSON schema describing your resource, `terraform-vault-ldapauthbackend.json`
2. Implement your resource handlers in `terraform_vault_ldapauthbackend/handlers.py`
