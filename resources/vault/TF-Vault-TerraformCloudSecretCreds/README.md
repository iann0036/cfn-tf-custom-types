...
1. Write the JSON schema describing your resource, `tf-vault-terraformcloudsecretcreds.json`
2. Implement your resource handlers in `tf_vault_terraformcloudsecretcreds/handlers.py`
