...
1. Write the JSON schema describing your resource, `tf-vault-azureauthbackendrole.json`
2. Implement your resource handlers in `tf_vault_azureauthbackendrole/handlers.py`
