...
1. Write the JSON schema describing your resource, `terraform-vault-genericsecret.json`
2. Implement your resource handlers in `terraform_vault_genericsecret/handlers.py`
