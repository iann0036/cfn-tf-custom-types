...
1. Write the JSON schema describing your resource, `tf-vault-adsecretlibrary.json`
2. Implement your resource handlers in `tf_vault_adsecretlibrary/handlers.py`
