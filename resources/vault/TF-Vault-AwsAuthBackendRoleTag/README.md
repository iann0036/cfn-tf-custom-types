# TF::Vault::AwsAuthBackendRoleTag

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-awsauthbackendroletag.json`
2. Implement your resource handlers in `tf_vault_awsauthbackendroletag/handlers.py`
