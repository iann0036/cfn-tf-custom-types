...
1. Write the JSON schema describing your resource, `terraform-vault-identityoidcrole.json`
2. Implement your resource handlers in `terraform_vault_identityoidcrole/handlers.py`
