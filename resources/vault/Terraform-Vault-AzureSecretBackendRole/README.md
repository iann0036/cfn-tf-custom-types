...
1. Write the JSON schema describing your resource, `terraform-vault-azuresecretbackendrole.json`
2. Implement your resource handlers in `terraform_vault_azuresecretbackendrole/handlers.py`
