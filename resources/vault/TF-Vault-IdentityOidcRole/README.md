# TF::Vault::IdentityOidcRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vault-identityoidcrole.json`
2. Implement your resource handlers in `tf_vault_identityoidcrole/handlers.py`
