...
1. Write the JSON schema describing your resource, `terraform-mailgun-domain.json`
2. Implement your resource handlers in `terraform_mailgun_domain/handlers.py`
