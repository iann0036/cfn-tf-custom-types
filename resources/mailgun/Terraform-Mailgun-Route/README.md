...
1. Write the JSON schema describing your resource, `terraform-mailgun-route.json`
2. Implement your resource handlers in `terraform_mailgun_route/handlers.py`
