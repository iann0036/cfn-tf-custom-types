...
1. Write the JSON schema describing your resource, `tf-vcd-vappfirewallrules.json`
2. Implement your resource handlers in `tf_vcd_vappfirewallrules/handlers.py`
