# TF::VCD::IndependentDisk

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vcd-independentdisk.json`
2. Implement your resource handlers in `tf_vcd_independentdisk/handlers.py`
