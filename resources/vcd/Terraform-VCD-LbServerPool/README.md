...
1. Write the JSON schema describing your resource, `terraform-vcd-lbserverpool.json`
2. Implement your resource handlers in `terraform_vcd_lbserverpool/handlers.py`
