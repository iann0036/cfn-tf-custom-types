...
1. Write the JSON schema describing your resource, `terraform-vcd-lbservicemonitor.json`
2. Implement your resource handlers in `terraform_vcd_lbservicemonitor/handlers.py`
