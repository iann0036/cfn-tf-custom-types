...
1. Write the JSON schema describing your resource, `terraform-vcd-catalogmedia.json`
2. Implement your resource handlers in `terraform_vcd_catalogmedia/handlers.py`
