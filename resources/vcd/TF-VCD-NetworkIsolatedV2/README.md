...
1. Write the JSON schema describing your resource, `tf-vcd-networkisolatedv2.json`
2. Implement your resource handlers in `tf_vcd_networkisolatedv2/handlers.py`
