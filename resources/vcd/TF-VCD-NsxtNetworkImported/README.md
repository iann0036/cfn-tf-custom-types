...
1. Write the JSON schema describing your resource, `tf-vcd-nsxtnetworkimported.json`
2. Implement your resource handlers in `tf_vcd_nsxtnetworkimported/handlers.py`
