...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    Name: Optional[str]
    NsxtLogicalSwitchId: Optional[str]
    NsxtLogicalSwitchName: Optional[str]
    Org: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            NsxtLogicalSwitchId=json_data.get("NsxtLogicalSwitchId"),
            NsxtLogicalSwitchName=json_data.get("NsxtLogicalSwitchName"),
