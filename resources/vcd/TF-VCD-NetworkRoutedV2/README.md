# TF::VCD::NetworkRoutedV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vcd-networkroutedv2.json`
2. Implement your resource handlers in `tf_vcd_networkroutedv2/handlers.py`
