...
1. Write the JSON schema describing your resource, `terraform-vcd-lbappprofile.json`
2. Implement your resource handlers in `terraform_vcd_lbappprofile/handlers.py`
