...
1. Write the JSON schema describing your resource, `terraform-vcd-lbvirtualserver.json`
2. Implement your resource handlers in `terraform_vcd_lbvirtualserver/handlers.py`
