...
1. Write the JSON schema describing your resource, `terraform-vcd-lbapprule.json`
2. Implement your resource handlers in `terraform_vcd_lbapprule/handlers.py`
