...
1. Write the JSON schema describing your resource, `tf-vcd-edgegatewaysettings.json`
2. Implement your resource handlers in `tf_vcd_edgegatewaysettings/handlers.py`
