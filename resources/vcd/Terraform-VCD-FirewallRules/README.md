...
1. Write the JSON schema describing your resource, `terraform-vcd-firewallrules.json`
2. Implement your resource handlers in `terraform_vcd_firewallrules/handlers.py`
