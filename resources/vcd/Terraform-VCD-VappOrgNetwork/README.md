...
1. Write the JSON schema describing your resource, `terraform-vcd-vapporgnetwork.json`
2. Implement your resource handlers in `terraform_vcd_vapporgnetwork/handlers.py`
