...
1. Write the JSON schema describing your resource, `terraform-vcd-vappnetwork.json`
2. Implement your resource handlers in `terraform_vcd_vappnetwork/handlers.py`
