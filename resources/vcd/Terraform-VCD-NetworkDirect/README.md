...
1. Write the JSON schema describing your resource, `terraform-vcd-networkdirect.json`
2. Implement your resource handlers in `terraform_vcd_networkdirect/handlers.py`
