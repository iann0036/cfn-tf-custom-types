# TF::VCD::InsertedMedia

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-vcd-insertedmedia.json`
2. Implement your resource handlers in `tf_vcd_insertedmedia/handlers.py`
