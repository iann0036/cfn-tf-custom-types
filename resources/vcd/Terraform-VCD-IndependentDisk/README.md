...
1. Write the JSON schema describing your resource, `terraform-vcd-independentdisk.json`
2. Implement your resource handlers in `terraform_vcd_independentdisk/handlers.py`
