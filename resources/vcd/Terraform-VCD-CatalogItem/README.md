...
1. Write the JSON schema describing your resource, `terraform-vcd-catalogitem.json`
2. Implement your resource handlers in `terraform_vcd_catalogitem/handlers.py`
