...
1. Write the JSON schema describing your resource, `terraform-vcd-edgegateway.json`
2. Implement your resource handlers in `terraform_vcd_edgegateway/handlers.py`
