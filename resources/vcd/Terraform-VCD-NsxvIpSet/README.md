...
1. Write the JSON schema describing your resource, `terraform-vcd-nsxvipset.json`
2. Implement your resource handlers in `terraform_vcd_nsxvipset/handlers.py`
