...
def create_handler(
    ...
    try:
        ...
        tf['resource']['vcd_nsxv_ip_set'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['vcd_nsxv_ip_set'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
