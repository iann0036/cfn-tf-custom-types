...
1. Write the JSON schema describing your resource, `terraform-vcd-insertedmedia.json`
2. Implement your resource handlers in `terraform_vcd_insertedmedia/handlers.py`
