...
1. Write the JSON schema describing your resource, `tf-vcd-externalnetworkv2.json`
2. Implement your resource handlers in `tf_vcd_externalnetworkv2/handlers.py`
