...
1. Write the JSON schema describing your resource, `terraform-vcd-networkrouted.json`
2. Implement your resource handlers in `terraform_vcd_networkrouted/handlers.py`
