...
1. Write the JSON schema describing your resource, `tf-vcd-lbservicemonitor.json`
2. Implement your resource handlers in `tf_vcd_lbservicemonitor/handlers.py`
