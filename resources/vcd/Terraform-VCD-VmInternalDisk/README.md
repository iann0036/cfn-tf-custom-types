...
1. Write the JSON schema describing your resource, `terraform-vcd-vminternaldisk.json`
2. Implement your resource handlers in `terraform_vcd_vminternaldisk/handlers.py`
