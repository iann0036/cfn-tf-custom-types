...
1. Write the JSON schema describing your resource, `terraform-vcd-edgegatewayvpn.json`
2. Implement your resource handlers in `terraform_vcd_edgegatewayvpn/handlers.py`
