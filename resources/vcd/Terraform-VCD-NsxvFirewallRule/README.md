...
1. Write the JSON schema describing your resource, `terraform-vcd-nsxvfirewallrule.json`
2. Implement your resource handlers in `terraform_vcd_nsxvfirewallrule/handlers.py`
