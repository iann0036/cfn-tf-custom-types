...
1. Write the JSON schema describing your resource, `terraform-vcd-nsxvdhcprelay.json`
2. Implement your resource handlers in `terraform_vcd_nsxvdhcprelay/handlers.py`
