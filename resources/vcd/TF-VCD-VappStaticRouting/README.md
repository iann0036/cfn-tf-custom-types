...
1. Write the JSON schema describing your resource, `tf-vcd-vappstaticrouting.json`
2. Implement your resource handlers in `tf_vcd_vappstaticrouting/handlers.py`
