...
1. Write the JSON schema describing your resource, `terraform-vcd-networkisolated.json`
2. Implement your resource handlers in `terraform_vcd_networkisolated/handlers.py`
