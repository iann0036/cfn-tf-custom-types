...
1. Write the JSON schema describing your resource, `terraform-vcd-externalnetwork.json`
2. Implement your resource handlers in `terraform_vcd_externalnetwork/handlers.py`
