...
1. Write the JSON schema describing your resource, `tf-vcd-vappaccesscontrol.json`
2. Implement your resource handlers in `tf_vcd_vappaccesscontrol/handlers.py`
