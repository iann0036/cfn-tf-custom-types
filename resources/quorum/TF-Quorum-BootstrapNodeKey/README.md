...
1. Write the JSON schema describing your resource, `tf-quorum-bootstrapnodekey.json`
2. Implement your resource handlers in `tf_quorum_bootstrapnodekey/handlers.py`
