...
1. Write the JSON schema describing your resource, `tf-quorum-transactionmanagerkeypair.json`
2. Implement your resource handlers in `tf_quorum_transactionmanagerkeypair/handlers.py`
