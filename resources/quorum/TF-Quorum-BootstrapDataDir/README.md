...
1. Write the JSON schema describing your resource, `tf-quorum-bootstrapdatadir.json`
2. Implement your resource handlers in `tf_quorum_bootstrapdatadir/handlers.py`
