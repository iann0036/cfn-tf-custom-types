...
1. Write the JSON schema describing your resource, `tf-quorum-bootstrapistanbulextradata.json`
2. Implement your resource handlers in `tf_quorum_bootstrapistanbulextradata/handlers.py`
