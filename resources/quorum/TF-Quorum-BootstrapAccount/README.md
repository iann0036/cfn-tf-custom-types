...
1. Write the JSON schema describing your resource, `tf-quorum-bootstrapaccount.json`
2. Implement your resource handlers in `tf_quorum_bootstrapaccount/handlers.py`
