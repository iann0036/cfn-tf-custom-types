...
1. Write the JSON schema describing your resource, `tf-quorum-bootstrapnetwork.json`
2. Implement your resource handlers in `tf_quorum_bootstrapnetwork/handlers.py`
