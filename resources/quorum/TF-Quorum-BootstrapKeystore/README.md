...
1. Write the JSON schema describing your resource, `tf-quorum-bootstrapkeystore.json`
2. Implement your resource handlers in `tf_quorum_bootstrapkeystore/handlers.py`
