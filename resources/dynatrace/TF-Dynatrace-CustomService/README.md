# TF::Dynatrace::CustomService

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-dynatrace-customservice.json`
2. Implement your resource handlers in `tf_dynatrace_customservice/handlers.py`
