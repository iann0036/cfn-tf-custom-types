...
1. Write the JSON schema describing your resource, `tf-dynatrace-calculatedservicemetric.json`
2. Implement your resource handlers in `tf_dynatrace_calculatedservicemetric/handlers.py`
