...
1. Write the JSON schema describing your resource, `tf-dynatrace-customanomalies.json`
2. Implement your resource handlers in `tf_dynatrace_customanomalies/handlers.py`
