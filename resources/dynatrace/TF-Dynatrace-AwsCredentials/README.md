...
1. Write the JSON schema describing your resource, `tf-dynatrace-awscredentials.json`
2. Implement your resource handlers in `tf_dynatrace_awscredentials/handlers.py`
