...
1. Write the JSON schema describing your resource, `tf-dynatrace-managementzone.json`
2. Implement your resource handlers in `tf_dynatrace_managementzone/handlers.py`
