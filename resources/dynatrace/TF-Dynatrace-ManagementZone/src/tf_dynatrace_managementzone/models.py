...
class ResourceModel(BaseModel):
    ...
    DimensionalRule: Optional[Sequence["_DimensionalRuleDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DimensionalRule=deserialize_list(json_data.get("DimensionalRule"), DimensionalRuleDefinition),
...
@dataclass
class DimensionalRuleDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_DimensionalRuleDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DimensionalRuleDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DimensionalRuleDefinition = DimensionalRuleDefinition
