...
1. Write the JSON schema describing your resource, `tf-dynatrace-applicationanomalies.json`
2. Implement your resource handlers in `tf_dynatrace_applicationanomalies/handlers.py`
