# TF::Dynatrace::Autotag

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-dynatrace-autotag.json`
2. Implement your resource handlers in `tf_dynatrace_autotag/handlers.py`
