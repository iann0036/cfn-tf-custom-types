...
1. Write the JSON schema describing your resource, `tf-dynatrace-databaseanomalies.json`
2. Implement your resource handlers in `tf_dynatrace_databaseanomalies/handlers.py`
