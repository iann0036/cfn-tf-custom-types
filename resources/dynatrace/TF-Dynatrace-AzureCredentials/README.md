...
1. Write the JSON schema describing your resource, `tf-dynatrace-azurecredentials.json`
2. Implement your resource handlers in `tf_dynatrace_azurecredentials/handlers.py`
