...
1. Write the JSON schema describing your resource, `tf-dynatrace-alertingprofile.json`
2. Implement your resource handlers in `tf_dynatrace_alertingprofile/handlers.py`
