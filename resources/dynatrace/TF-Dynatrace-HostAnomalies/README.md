...
1. Write the JSON schema describing your resource, `tf-dynatrace-hostanomalies.json`
2. Implement your resource handlers in `tf_dynatrace_hostanomalies/handlers.py`
