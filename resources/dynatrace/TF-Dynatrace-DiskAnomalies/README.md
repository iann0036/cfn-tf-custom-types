...
1. Write the JSON schema describing your resource, `tf-dynatrace-diskanomalies.json`
2. Implement your resource handlers in `tf_dynatrace_diskanomalies/handlers.py`
