...
1. Write the JSON schema describing your resource, `tf-dynatrace-k8scredentials.json`
2. Implement your resource handlers in `tf_dynatrace_k8scredentials/handlers.py`
