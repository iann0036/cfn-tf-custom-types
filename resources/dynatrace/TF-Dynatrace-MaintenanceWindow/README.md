# TF::Dynatrace::MaintenanceWindow

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-dynatrace-maintenancewindow.json`
2. Implement your resource handlers in `tf_dynatrace_maintenancewindow/handlers.py`
