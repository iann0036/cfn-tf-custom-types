...
1. Write the JSON schema describing your resource, `tf-dynatrace-serviceanomalies.json`
2. Implement your resource handlers in `tf_dynatrace_serviceanomalies/handlers.py`
