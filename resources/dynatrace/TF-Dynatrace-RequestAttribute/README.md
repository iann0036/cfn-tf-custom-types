...
1. Write the JSON schema describing your resource, `tf-dynatrace-requestattribute.json`
2. Implement your resource handlers in `tf_dynatrace_requestattribute/handlers.py`
