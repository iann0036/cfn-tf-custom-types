...
1. Write the JSON schema describing your resource, `tf-dynatrace-notification.json`
2. Implement your resource handlers in `tf_dynatrace_notification/handlers.py`
