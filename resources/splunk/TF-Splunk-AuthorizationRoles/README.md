...
1. Write the JSON schema describing your resource, `tf-splunk-authorizationroles.json`
2. Implement your resource handlers in `tf_splunk_authorizationroles/handlers.py`
