...
1. Write the JSON schema describing your resource, `tf-splunk-globalhttpeventcollector.json`
2. Implement your resource handlers in `tf_splunk_globalhttpeventcollector/handlers.py`
