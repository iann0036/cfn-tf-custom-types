...
1. Write the JSON schema describing your resource, `tf-splunk-shindexesmanager.json`
2. Implement your resource handlers in `tf_splunk_shindexesmanager/handlers.py`
