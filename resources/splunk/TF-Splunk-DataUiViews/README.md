# TF::Splunk::DataUiViews

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-splunk-datauiviews.json`
2. Implement your resource handlers in `tf_splunk_datauiviews/handlers.py`
