...
1. Write the JSON schema describing your resource, `tf-splunk-inputsmonitor.json`
2. Implement your resource handlers in `tf_splunk_inputsmonitor/handlers.py`
