...
1. Write the JSON schema describing your resource, `tf-splunk-outputstcpsyslog.json`
2. Implement your resource handlers in `tf_splunk_outputstcpsyslog/handlers.py`
