...
1. Write the JSON schema describing your resource, `tf-splunk-adminsamlgroups.json`
2. Implement your resource handlers in `tf_splunk_adminsamlgroups/handlers.py`
