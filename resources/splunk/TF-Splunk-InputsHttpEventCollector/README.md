...
1. Write the JSON schema describing your resource, `tf-splunk-inputshttpeventcollector.json`
2. Implement your resource handlers in `tf_splunk_inputshttpeventcollector/handlers.py`
