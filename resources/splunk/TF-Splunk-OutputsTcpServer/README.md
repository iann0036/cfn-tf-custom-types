...
1. Write the JSON schema describing your resource, `tf-splunk-outputstcpserver.json`
2. Implement your resource handlers in `tf_splunk_outputstcpserver/handlers.py`
