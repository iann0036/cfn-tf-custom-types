...
1. Write the JSON schema describing your resource, `tf-splunk-outputstcpgroup.json`
2. Implement your resource handlers in `tf_splunk_outputstcpgroup/handlers.py`
