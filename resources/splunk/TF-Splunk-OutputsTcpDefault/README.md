...
1. Write the JSON schema describing your resource, `tf-splunk-outputstcpdefault.json`
2. Implement your resource handlers in `tf_splunk_outputstcpdefault/handlers.py`
