...
1. Write the JSON schema describing your resource, `tf-splunk-inputstcpcooked.json`
2. Implement your resource handlers in `tf_splunk_inputstcpcooked/handlers.py`
