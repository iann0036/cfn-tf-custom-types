# TF::Splunk::InputsTcpSplunkTcpToken

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-splunk-inputstcpsplunktcptoken.json`
2. Implement your resource handlers in `tf_splunk_inputstcpsplunktcptoken/handlers.py`
