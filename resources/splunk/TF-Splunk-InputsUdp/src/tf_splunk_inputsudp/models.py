...
class ResourceModel(BaseModel):
    ...
    ConnectionHost: Optional[str]
    Disabled: Optional[bool]
    Host: Optional[str]
    Id: Optional[str]
    Index: Optional[str]
    Name: Optional[str]
    NoAppendingTimestamp: Optional[bool]
    NoPriorityStripping: Optional[bool]
    Queue: Optional[str]
    RestrictToHost: Optional[str]
    Source: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ConnectionHost=json_data.get("ConnectionHost"),
            Disabled=json_data.get("Disabled"),
            Host=json_data.get("Host"),
            Id=json_data.get("Id"),
            Index=json_data.get("Index"),
            Name=json_data.get("Name"),
            NoAppendingTimestamp=json_data.get("NoAppendingTimestamp"),
            NoPriorityStripping=json_data.get("NoPriorityStripping"),
            Queue=json_data.get("Queue"),
            RestrictToHost=json_data.get("RestrictToHost"),
