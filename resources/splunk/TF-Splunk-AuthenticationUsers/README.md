...
1. Write the JSON schema describing your resource, `tf-splunk-authenticationusers.json`
2. Implement your resource handlers in `tf_splunk_authenticationusers/handlers.py`
