# TF::Splunk::ConfigsConf

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-splunk-configsconf.json`
2. Implement your resource handlers in `tf_splunk_configsconf/handlers.py`
