...
1. Write the JSON schema describing your resource, `tf-splunk-savedsearches.json`
2. Implement your resource handlers in `tf_splunk_savedsearches/handlers.py`
