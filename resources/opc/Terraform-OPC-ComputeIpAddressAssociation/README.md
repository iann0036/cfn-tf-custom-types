...
1. Write the JSON schema describing your resource, `terraform-opc-computeipaddressassociation.json`
2. Implement your resource handlers in `terraform_opc_computeipaddressassociation/handlers.py`
