...
1. Write the JSON schema describing your resource, `terraform-opc-computestoragevolumesnapshot.json`
2. Implement your resource handlers in `terraform_opc_computestoragevolumesnapshot/handlers.py`
