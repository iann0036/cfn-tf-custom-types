# TF::OPC::LbaasLoadBalancer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-lbaasloadbalancer.json`
2. Implement your resource handlers in `tf_opc_lbaasloadbalancer/handlers.py`
