...
1. Write the JSON schema describing your resource, `terraform-opc-computesecrule.json`
2. Implement your resource handlers in `terraform_opc_computesecrule/handlers.py`
