...
1. Write the JSON schema describing your resource, `terraform-opc-computeipreservation.json`
2. Implement your resource handlers in `terraform_opc_computeipreservation/handlers.py`
