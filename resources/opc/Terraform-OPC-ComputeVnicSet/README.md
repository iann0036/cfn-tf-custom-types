...
1. Write the JSON schema describing your resource, `terraform-opc-computevnicset.json`
2. Implement your resource handlers in `terraform_opc_computevnicset/handlers.py`
