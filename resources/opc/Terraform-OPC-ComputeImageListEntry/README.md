...
1. Write the JSON schema describing your resource, `terraform-opc-computeimagelistentry.json`
2. Implement your resource handlers in `terraform_opc_computeimagelistentry/handlers.py`
