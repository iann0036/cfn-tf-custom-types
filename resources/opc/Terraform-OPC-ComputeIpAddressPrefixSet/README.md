...
1. Write the JSON schema describing your resource, `terraform-opc-computeipaddressprefixset.json`
2. Implement your resource handlers in `terraform_opc_computeipaddressprefixset/handlers.py`
