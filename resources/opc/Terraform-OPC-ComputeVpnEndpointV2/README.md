...
1. Write the JSON schema describing your resource, `terraform-opc-computevpnendpointv2.json`
2. Implement your resource handlers in `terraform_opc_computevpnendpointv2/handlers.py`
