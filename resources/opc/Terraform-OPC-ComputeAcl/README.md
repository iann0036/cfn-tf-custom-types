...
1. Write the JSON schema describing your resource, `terraform-opc-computeacl.json`
2. Implement your resource handlers in `terraform_opc_computeacl/handlers.py`
