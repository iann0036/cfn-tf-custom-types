# TF::OPC::ComputeSecurityApplication

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-computesecurityapplication.json`
2. Implement your resource handlers in `tf_opc_computesecurityapplication/handlers.py`
