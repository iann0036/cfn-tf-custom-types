...
1. Write the JSON schema describing your resource, `terraform-opc-lbaascertificate.json`
2. Implement your resource handlers in `terraform_opc_lbaascertificate/handlers.py`
