...
1. Write the JSON schema describing your resource, `terraform-opc-computemachineimage.json`
2. Implement your resource handlers in `terraform_opc_computemachineimage/handlers.py`
