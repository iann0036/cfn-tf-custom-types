# TF::OPC::ComputeIpReservation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-computeipreservation.json`
2. Implement your resource handlers in `tf_opc_computeipreservation/handlers.py`
