...
1. Write the JSON schema describing your resource, `terraform-opc-storagecontainer.json`
2. Implement your resource handlers in `terraform_opc_storagecontainer/handlers.py`
