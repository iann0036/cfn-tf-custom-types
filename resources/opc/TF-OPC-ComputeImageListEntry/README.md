# TF::OPC::ComputeImageListEntry

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-computeimagelistentry.json`
2. Implement your resource handlers in `tf_opc_computeimagelistentry/handlers.py`
