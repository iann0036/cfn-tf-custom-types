...
1. Write the JSON schema describing your resource, `terraform-opc-computesecurityapplication.json`
2. Implement your resource handlers in `terraform_opc_computesecurityapplication/handlers.py`
