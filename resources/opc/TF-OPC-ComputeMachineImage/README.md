# TF::OPC::ComputeMachineImage

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-computemachineimage.json`
2. Implement your resource handlers in `tf_opc_computemachineimage/handlers.py`
