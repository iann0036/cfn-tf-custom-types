...
1. Write the JSON schema describing your resource, `tf-opc-computesecurityiplist.json`
2. Implement your resource handlers in `tf_opc_computesecurityiplist/handlers.py`
