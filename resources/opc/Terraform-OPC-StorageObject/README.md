...
1. Write the JSON schema describing your resource, `terraform-opc-storageobject.json`
2. Implement your resource handlers in `terraform_opc_storageobject/handlers.py`
