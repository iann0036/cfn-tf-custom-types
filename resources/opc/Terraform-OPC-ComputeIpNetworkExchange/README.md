...
1. Write the JSON schema describing your resource, `terraform-opc-computeipnetworkexchange.json`
2. Implement your resource handlers in `terraform_opc_computeipnetworkexchange/handlers.py`
