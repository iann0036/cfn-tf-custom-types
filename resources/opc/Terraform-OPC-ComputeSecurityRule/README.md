...
1. Write the JSON schema describing your resource, `terraform-opc-computesecurityrule.json`
2. Implement your resource handlers in `terraform_opc_computesecurityrule/handlers.py`
