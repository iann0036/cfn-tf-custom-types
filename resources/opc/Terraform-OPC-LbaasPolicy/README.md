...
1. Write the JSON schema describing your resource, `terraform-opc-lbaaspolicy.json`
2. Implement your resource handlers in `terraform_opc_lbaaspolicy/handlers.py`
