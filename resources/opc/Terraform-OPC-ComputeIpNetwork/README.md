...
1. Write the JSON schema describing your resource, `terraform-opc-computeipnetwork.json`
2. Implement your resource handlers in `terraform_opc_computeipnetwork/handlers.py`
