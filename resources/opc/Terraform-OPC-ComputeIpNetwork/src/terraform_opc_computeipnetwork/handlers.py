...
def create_handler(
    ...
    try:
        ...
        tf['resource']['opc_compute_ip_network'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['opc_compute_ip_network'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
