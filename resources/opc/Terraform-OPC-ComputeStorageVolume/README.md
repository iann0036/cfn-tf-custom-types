...
1. Write the JSON schema describing your resource, `terraform-opc-computestoragevolume.json`
2. Implement your resource handlers in `terraform_opc_computestoragevolume/handlers.py`
