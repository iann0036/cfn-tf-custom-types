# TF::OPC::ComputeIpAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-computeipassociation.json`
2. Implement your resource handlers in `tf_opc_computeipassociation/handlers.py`
