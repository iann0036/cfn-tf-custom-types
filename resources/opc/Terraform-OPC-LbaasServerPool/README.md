...
1. Write the JSON schema describing your resource, `terraform-opc-lbaasserverpool.json`
2. Implement your resource handlers in `terraform_opc_lbaasserverpool/handlers.py`
