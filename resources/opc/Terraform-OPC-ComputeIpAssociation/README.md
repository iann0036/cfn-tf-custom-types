...
1. Write the JSON schema describing your resource, `terraform-opc-computeipassociation.json`
2. Implement your resource handlers in `terraform_opc_computeipassociation/handlers.py`
