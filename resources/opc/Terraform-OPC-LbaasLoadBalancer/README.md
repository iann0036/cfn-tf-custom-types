...
1. Write the JSON schema describing your resource, `terraform-opc-lbaasloadbalancer.json`
2. Implement your resource handlers in `terraform_opc_lbaasloadbalancer/handlers.py`
