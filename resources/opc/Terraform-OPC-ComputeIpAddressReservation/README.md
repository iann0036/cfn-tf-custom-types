...
1. Write the JSON schema describing your resource, `terraform-opc-computeipaddressreservation.json`
2. Implement your resource handlers in `terraform_opc_computeipaddressreservation/handlers.py`
