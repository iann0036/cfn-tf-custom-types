...
1. Write the JSON schema describing your resource, `terraform-opc-computeimagelist.json`
2. Implement your resource handlers in `terraform_opc_computeimagelist/handlers.py`
