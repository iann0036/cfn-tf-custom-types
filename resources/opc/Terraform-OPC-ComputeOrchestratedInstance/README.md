...
1. Write the JSON schema describing your resource, `terraform-opc-computeorchestratedinstance.json`
2. Implement your resource handlers in `terraform_opc_computeorchestratedinstance/handlers.py`
