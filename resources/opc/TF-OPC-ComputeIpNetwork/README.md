...
1. Write the JSON schema describing your resource, `tf-opc-computeipnetwork.json`
2. Implement your resource handlers in `tf_opc_computeipnetwork/handlers.py`
