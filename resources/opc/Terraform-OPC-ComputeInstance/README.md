...
1. Write the JSON schema describing your resource, `terraform-opc-computeinstance.json`
2. Implement your resource handlers in `terraform_opc_computeinstance/handlers.py`
