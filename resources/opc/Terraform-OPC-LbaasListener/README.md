...
1. Write the JSON schema describing your resource, `terraform-opc-lbaaslistener.json`
2. Implement your resource handlers in `terraform_opc_lbaaslistener/handlers.py`
