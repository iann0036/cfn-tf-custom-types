...
1. Write the JSON schema describing your resource, `terraform-opc-computesshkey.json`
2. Implement your resource handlers in `terraform_opc_computesshkey/handlers.py`
