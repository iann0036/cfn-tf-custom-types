...
def create_handler(
    ...
    try:
        ...
        tf['resource']['opc_compute_security_ip_list'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['opc_compute_security_ip_list'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
