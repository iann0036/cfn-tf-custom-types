...
1. Write the JSON schema describing your resource, `terraform-opc-computesecurityiplist.json`
2. Implement your resource handlers in `terraform_opc_computesecurityiplist/handlers.py`
