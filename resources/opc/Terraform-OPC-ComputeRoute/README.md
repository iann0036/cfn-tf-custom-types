...
1. Write the JSON schema describing your resource, `terraform-opc-computeroute.json`
2. Implement your resource handlers in `terraform_opc_computeroute/handlers.py`
