...
1. Write the JSON schema describing your resource, `tf-opc-computevpnendpointv2.json`
2. Implement your resource handlers in `tf_opc_computevpnendpointv2/handlers.py`
