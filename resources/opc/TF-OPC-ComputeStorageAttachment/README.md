# TF::OPC::ComputeStorageAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-opc-computestorageattachment.json`
2. Implement your resource handlers in `tf_opc_computestorageattachment/handlers.py`
