...
1. Write the JSON schema describing your resource, `tf-opc-computestoragevolume.json`
2. Implement your resource handlers in `tf_opc_computestoragevolume/handlers.py`
