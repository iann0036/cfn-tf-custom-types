...
1. Write the JSON schema describing your resource, `terraform-opc-computesecurityassociation.json`
2. Implement your resource handlers in `terraform_opc_computesecurityassociation/handlers.py`
