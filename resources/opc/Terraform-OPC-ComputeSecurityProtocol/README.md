...
1. Write the JSON schema describing your resource, `terraform-opc-computesecurityprotocol.json`
2. Implement your resource handlers in `terraform_opc_computesecurityprotocol/handlers.py`
