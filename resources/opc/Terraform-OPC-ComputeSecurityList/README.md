...
1. Write the JSON schema describing your resource, `terraform-opc-computesecuritylist.json`
2. Implement your resource handlers in `terraform_opc_computesecuritylist/handlers.py`
