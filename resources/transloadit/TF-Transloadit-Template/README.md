...
1. Write the JSON schema describing your resource, `tf-transloadit-template.json`
2. Implement your resource handlers in `tf_transloadit_template/handlers.py`
