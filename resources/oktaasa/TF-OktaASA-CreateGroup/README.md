# TF::OktaASA::CreateGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-oktaasa-creategroup.json`
2. Implement your resource handlers in `tf_oktaasa_creategroup/handlers.py`
