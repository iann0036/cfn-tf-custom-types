# TF::Boundary::AccountOidc

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-boundary-accountoidc.json`
2. Implement your resource handlers in `tf_boundary_accountoidc/handlers.py`
