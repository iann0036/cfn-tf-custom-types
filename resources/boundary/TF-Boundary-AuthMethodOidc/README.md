...
1. Write the JSON schema describing your resource, `tf-boundary-authmethodoidc.json`
2. Implement your resource handlers in `tf_boundary_authmethodoidc/handlers.py`
