# TF::Boundary::HostCatalog

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-boundary-hostcatalog.json`
2. Implement your resource handlers in `tf_boundary_hostcatalog/handlers.py`
