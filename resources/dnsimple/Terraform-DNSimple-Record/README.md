...
1. Write the JSON schema describing your resource, `terraform-dnsimple-record.json`
2. Implement your resource handlers in `terraform_dnsimple_record/handlers.py`
