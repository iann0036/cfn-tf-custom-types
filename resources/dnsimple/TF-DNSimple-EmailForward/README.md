...
1. Write the JSON schema describing your resource, `tf-dnsimple-emailforward.json`
2. Implement your resource handlers in `tf_dnsimple_emailforward/handlers.py`
