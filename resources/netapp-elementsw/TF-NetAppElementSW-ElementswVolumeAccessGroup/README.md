# TF::NetAppElementSW::ElementswVolumeAccessGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-netappelementsw-elementswvolumeaccessgroup.json`
2. Implement your resource handlers in `tf_netappelementsw_elementswvolumeaccessgroup/handlers.py`
