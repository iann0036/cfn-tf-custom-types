...
1. Write the JSON schema describing your resource, `tf-netappelementsw-elementswinitiator.json`
2. Implement your resource handlers in `tf_netappelementsw_elementswinitiator/handlers.py`
