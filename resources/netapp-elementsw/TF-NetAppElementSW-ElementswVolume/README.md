...
1. Write the JSON schema describing your resource, `tf-netappelementsw-elementswvolume.json`
2. Implement your resource handlers in `tf_netappelementsw_elementswvolume/handlers.py`
