...
1. Write the JSON schema describing your resource, `tf-cloudeos-routerstatus.json`
2. Implement your resource handlers in `tf_cloudeos_routerstatus/handlers.py`
