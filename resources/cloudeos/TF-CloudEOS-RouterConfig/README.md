...
1. Write the JSON schema describing your resource, `tf-cloudeos-routerconfig.json`
2. Implement your resource handlers in `tf_cloudeos_routerconfig/handlers.py`
