...
1. Write the JSON schema describing your resource, `tf-configcat-settingvalue.json`
2. Implement your resource handlers in `tf_configcat_settingvalue/handlers.py`
