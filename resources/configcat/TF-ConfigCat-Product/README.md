# TF::ConfigCat::Product

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-configcat-product.json`
2. Implement your resource handlers in `tf_configcat_product/handlers.py`
