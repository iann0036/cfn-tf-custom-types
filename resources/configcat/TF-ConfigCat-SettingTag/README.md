# TF::ConfigCat::SettingTag

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-configcat-settingtag.json`
2. Implement your resource handlers in `tf_configcat_settingtag/handlers.py`
