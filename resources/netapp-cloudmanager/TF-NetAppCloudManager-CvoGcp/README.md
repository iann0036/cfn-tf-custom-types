...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-cvogcp.json`
2. Implement your resource handlers in `tf_netappcloudmanager_cvogcp/handlers.py`
