...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-snapmirror.json`
2. Implement your resource handlers in `tf_netappcloudmanager_snapmirror/handlers.py`
