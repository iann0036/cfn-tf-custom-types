...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-volume.json`
2. Implement your resource handlers in `tf_netappcloudmanager_volume/handlers.py`
