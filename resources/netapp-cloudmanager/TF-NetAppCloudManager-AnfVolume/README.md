...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-anfvolume.json`
2. Implement your resource handlers in `tf_netappcloudmanager_anfvolume/handlers.py`
