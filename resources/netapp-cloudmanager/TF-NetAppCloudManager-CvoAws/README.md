...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-cvoaws.json`
2. Implement your resource handlers in `tf_netappcloudmanager_cvoaws/handlers.py`
