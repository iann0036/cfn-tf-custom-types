...
TYPE_NAME = "TF::NetAppCloudManager::CvoAws"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/netapp-cloudmanager_cvo_aws/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'netapp-cloudmanager_cvo_aws',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/netapp-cloudmanager_cvo_aws/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/netapp-cloudmanager_cvo_aws/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), BackupVolumesToCbs=None, CapacityTier=None, ClientId=None, CloudProviderAccount=None, ClusterFloatingIp=None, DataEncryptionType=None, DataFloatingIp=None, DataFloatingIp2=None, EbsVolumeSize=None, EbsVolumeSizeUnit=None, EbsVolumeType=None, EnableCompliance=None, EnableMonitoring=None, FailoverMode=None, Id=None, InstanceProfileName=None, InstanceTenancy=None, InstanceType=None, Iops=None, IsHa=None, KmsKeyId=None, LicenseType=None, MediatorAssignPublicIp=None, MediatorKeyPairName=None, MediatorSubnetId=None, Name=None, Node1SubnetId=None, Node2SubnetId=None, NssAccount=None, OntapVersion=None, OptimizedNetworkUtilization=None, PlatformSerialNumber=None, PlatformSerialNumberNode1=None, PlatformSerialNumberNode2=None, Region=None, RouteTableIds=None, SecurityGroupId=None, SubnetId=None, SvmFloatingIp=None, SvmPassword=None, Throughput=None, TierLevel=None, UseLatestVersion=None, VpcId=None, WorkspaceId=None, WritingSpeedState=None, AwsTag=None)
