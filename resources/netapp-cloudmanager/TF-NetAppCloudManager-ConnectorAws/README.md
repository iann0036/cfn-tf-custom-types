...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-connectoraws.json`
2. Implement your resource handlers in `tf_netappcloudmanager_connectoraws/handlers.py`
