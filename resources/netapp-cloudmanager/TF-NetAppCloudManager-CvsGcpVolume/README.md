...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-cvsgcpvolume.json`
2. Implement your resource handlers in `tf_netappcloudmanager_cvsgcpvolume/handlers.py`
