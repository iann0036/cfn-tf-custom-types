...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-connectorazure.json`
2. Implement your resource handlers in `tf_netappcloudmanager_connectorazure/handlers.py`
