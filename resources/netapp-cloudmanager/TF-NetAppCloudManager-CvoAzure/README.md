...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-cvoazure.json`
2. Implement your resource handlers in `tf_netappcloudmanager_cvoazure/handlers.py`
