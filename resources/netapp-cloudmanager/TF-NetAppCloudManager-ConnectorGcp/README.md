...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-connectorgcp.json`
2. Implement your resource handlers in `tf_netappcloudmanager_connectorgcp/handlers.py`
