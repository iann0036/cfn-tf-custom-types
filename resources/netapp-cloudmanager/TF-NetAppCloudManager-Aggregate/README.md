...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-aggregate.json`
2. Implement your resource handlers in `tf_netappcloudmanager_aggregate/handlers.py`
