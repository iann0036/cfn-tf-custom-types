...
1. Write the JSON schema describing your resource, `tf-netappcloudmanager-cifsserver.json`
2. Implement your resource handlers in `tf_netappcloudmanager_cifsserver/handlers.py`
