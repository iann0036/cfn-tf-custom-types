...
1. Write the JSON schema describing your resource, `tf-fastly-tlscertificate.json`
2. Implement your resource handlers in `tf_fastly_tlscertificate/handlers.py`
