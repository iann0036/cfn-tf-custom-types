...
1. Write the JSON schema describing your resource, `tf-fastly-tlssubscription.json`
2. Implement your resource handlers in `tf_fastly_tlssubscription/handlers.py`
