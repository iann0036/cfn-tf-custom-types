...
1. Write the JSON schema describing your resource, `tf-fastly-servicecompute.json`
2. Implement your resource handlers in `tf_fastly_servicecompute/handlers.py`
