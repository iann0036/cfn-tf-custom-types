...
1. Write the JSON schema describing your resource, `tf-fastly-tlsactivation.json`
2. Implement your resource handlers in `tf_fastly_tlsactivation/handlers.py`
