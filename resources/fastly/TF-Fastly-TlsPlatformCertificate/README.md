...
1. Write the JSON schema describing your resource, `tf-fastly-tlsplatformcertificate.json`
2. Implement your resource handlers in `tf_fastly_tlsplatformcertificate/handlers.py`
