# TF::Fastly::ServiceDictionaryItemsV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fastly-servicedictionaryitemsv1.json`
2. Implement your resource handlers in `tf_fastly_servicedictionaryitemsv1/handlers.py`
