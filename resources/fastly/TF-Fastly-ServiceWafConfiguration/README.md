...
1. Write the JSON schema describing your resource, `tf-fastly-servicewafconfiguration.json`
2. Implement your resource handlers in `tf_fastly_servicewafconfiguration/handlers.py`
