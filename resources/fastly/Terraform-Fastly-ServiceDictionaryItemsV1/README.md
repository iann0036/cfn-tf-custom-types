...
1. Write the JSON schema describing your resource, `terraform-fastly-servicedictionaryitemsv1.json`
2. Implement your resource handlers in `terraform_fastly_servicedictionaryitemsv1/handlers.py`
