...
1. Write the JSON schema describing your resource, `tf-fastly-tlsprivatekey.json`
2. Implement your resource handlers in `tf_fastly_tlsprivatekey/handlers.py`
