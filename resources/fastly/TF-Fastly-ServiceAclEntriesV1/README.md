...
1. Write the JSON schema describing your resource, `tf-fastly-serviceaclentriesv1.json`
2. Implement your resource handlers in `tf_fastly_serviceaclentriesv1/handlers.py`
