...
1. Write the JSON schema describing your resource, `terraform-fastly-servicedynamicsnippetcontentv1.json`
2. Implement your resource handlers in `terraform_fastly_servicedynamicsnippetcontentv1/handlers.py`
