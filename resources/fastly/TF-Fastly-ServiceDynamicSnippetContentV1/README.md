# TF::Fastly::ServiceDynamicSnippetContentV1

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-fastly-servicedynamicsnippetcontentv1.json`
2. Implement your resource handlers in `tf_fastly_servicedynamicsnippetcontentv1/handlers.py`
