...
1. Write the JSON schema describing your resource, `tf-fastly-tlssubscriptionvalidation.json`
2. Implement your resource handlers in `tf_fastly_tlssubscriptionvalidation/handlers.py`
