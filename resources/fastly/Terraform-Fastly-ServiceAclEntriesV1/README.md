...
1. Write the JSON schema describing your resource, `terraform-fastly-serviceaclentriesv1.json`
2. Implement your resource handlers in `terraform_fastly_serviceaclentriesv1/handlers.py`
