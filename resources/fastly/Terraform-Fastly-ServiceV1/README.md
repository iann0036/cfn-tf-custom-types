...
1. Write the JSON schema describing your resource, `terraform-fastly-servicev1.json`
2. Implement your resource handlers in `terraform_fastly_servicev1/handlers.py`
