# TF::Constellix::TcpCheck

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-constellix-tcpcheck.json`
2. Implement your resource handlers in `tf_constellix_tcpcheck/handlers.py`
