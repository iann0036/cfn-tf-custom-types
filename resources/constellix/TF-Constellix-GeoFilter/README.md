...
1. Write the JSON schema describing your resource, `tf-constellix-geofilter.json`
2. Implement your resource handlers in `tf_constellix_geofilter/handlers.py`
