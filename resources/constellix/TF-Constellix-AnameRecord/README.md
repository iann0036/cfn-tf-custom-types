...
1. Write the JSON schema describing your resource, `tf-constellix-anamerecord.json`
2. Implement your resource handlers in `tf_constellix_anamerecord/handlers.py`
