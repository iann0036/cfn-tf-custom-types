# TF::Constellix::AnameRecord

CloudFormation equivalent of constellix_aname_record
...
<pre>
{
    "Type" : "TF::Constellix::AnameRecord",
    "Properties" : {
        ...
        "<a href="#recordfailoverfailovertype" title="RecordFailoverFailoverType">RecordFailoverFailoverType</a>" : <i>Double</i>,
