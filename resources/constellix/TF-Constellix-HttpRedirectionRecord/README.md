...
1. Write the JSON schema describing your resource, `tf-constellix-httpredirectionrecord.json`
2. Implement your resource handlers in `tf_constellix_httpredirectionrecord/handlers.py`
