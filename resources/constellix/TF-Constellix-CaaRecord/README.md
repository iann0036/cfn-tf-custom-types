...
1. Write the JSON schema describing your resource, `tf-constellix-caarecord.json`
2. Implement your resource handlers in `tf_constellix_caarecord/handlers.py`
