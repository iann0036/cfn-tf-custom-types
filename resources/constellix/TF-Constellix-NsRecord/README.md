# TF::Constellix::NsRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-constellix-nsrecord.json`
2. Implement your resource handlers in `tf_constellix_nsrecord/handlers.py`
