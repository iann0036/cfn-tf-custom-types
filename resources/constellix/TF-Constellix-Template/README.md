# TF::Constellix::Template

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-constellix-template.json`
2. Implement your resource handlers in `tf_constellix_template/handlers.py`
