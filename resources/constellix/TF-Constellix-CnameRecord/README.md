# TF::Constellix::CnameRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-constellix-cnamerecord.json`
2. Implement your resource handlers in `tf_constellix_cnamerecord/handlers.py`
