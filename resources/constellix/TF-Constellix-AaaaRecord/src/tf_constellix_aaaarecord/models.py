...
class ResourceModel(BaseModel):
    ...
    RoundrobinFailover: Optional[Sequence["_RoundrobinFailoverDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RoundrobinFailover=deserialize_list(json_data.get("RoundrobinFailover"), RoundrobinFailoverDefinition),
        )
...
@dataclass
class RoundrobinFailoverDefinition(BaseModel):
    DisableFlag: Optional[str]
    SortOrder: Optional[str]
    Value: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_RoundrobinFailoverDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_RoundrobinFailoverDefinition"]:
        if not json_data:
            return None
        return cls(
            DisableFlag=json_data.get("DisableFlag"),
...
# work around possible type aliasing issues when variable has same name as a model
_RoundrobinFailoverDefinition = RoundrobinFailoverDefinition
