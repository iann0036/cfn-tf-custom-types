# TF::Constellix::AaaaRecord

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-constellix-aaaarecord.json`
2. Implement your resource handlers in `tf_constellix_aaaarecord/handlers.py`
