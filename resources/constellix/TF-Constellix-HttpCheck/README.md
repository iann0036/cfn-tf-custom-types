...
1. Write the JSON schema describing your resource, `tf-constellix-httpcheck.json`
2. Implement your resource handlers in `tf_constellix_httpcheck/handlers.py`
