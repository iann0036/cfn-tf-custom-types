...
1. Write the JSON schema describing your resource, `tf-constellix-cnamerecordpool.json`
2. Implement your resource handlers in `tf_constellix_cnamerecordpool/handlers.py`
