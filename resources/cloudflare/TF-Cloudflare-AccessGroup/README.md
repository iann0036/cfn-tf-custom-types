...
1. Write the JSON schema describing your resource, `tf-cloudflare-accessgroup.json`
2. Implement your resource handlers in `tf_cloudflare_accessgroup/handlers.py`
