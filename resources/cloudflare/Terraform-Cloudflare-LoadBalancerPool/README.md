...
1. Write the JSON schema describing your resource, `terraform-cloudflare-loadbalancerpool.json`
2. Implement your resource handlers in `terraform_cloudflare_loadbalancerpool/handlers.py`
