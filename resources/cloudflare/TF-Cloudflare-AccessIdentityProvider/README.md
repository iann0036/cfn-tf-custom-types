# TF::Cloudflare::AccessIdentityProvider

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudflare-accessidentityprovider.json`
2. Implement your resource handlers in `tf_cloudflare_accessidentityprovider/handlers.py`
