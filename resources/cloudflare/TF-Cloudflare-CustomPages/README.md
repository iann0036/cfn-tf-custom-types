# TF::Cloudflare::CustomPages

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudflare-custompages.json`
2. Implement your resource handlers in `tf_cloudflare_custompages/handlers.py`
