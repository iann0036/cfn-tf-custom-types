...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accessidentityprovider.json`
2. Implement your resource handlers in `terraform_cloudflare_accessidentityprovider/handlers.py`
