...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accessrule.json`
2. Implement your resource handlers in `terraform_cloudflare_accessrule/handlers.py`
