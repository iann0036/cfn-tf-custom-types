...
1. Write the JSON schema describing your resource, `tf-cloudflare-customssl.json`
2. Implement your resource handlers in `tf_cloudflare_customssl/handlers.py`
