...
1. Write the JSON schema describing your resource, `terraform-cloudflare-workerskvnamespace.json`
2. Implement your resource handlers in `terraform_cloudflare_workerskvnamespace/handlers.py`
