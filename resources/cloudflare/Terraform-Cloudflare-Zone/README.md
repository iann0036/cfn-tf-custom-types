...
1. Write the JSON schema describing your resource, `terraform-cloudflare-zone.json`
2. Implement your resource handlers in `terraform_cloudflare_zone/handlers.py`
