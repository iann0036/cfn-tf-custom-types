...
1. Write the JSON schema describing your resource, `terraform-cloudflare-argo.json`
2. Implement your resource handlers in `terraform_cloudflare_argo/handlers.py`
