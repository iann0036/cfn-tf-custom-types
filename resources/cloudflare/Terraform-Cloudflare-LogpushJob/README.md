...
1. Write the JSON schema describing your resource, `terraform-cloudflare-logpushjob.json`
2. Implement your resource handlers in `terraform_cloudflare_logpushjob/handlers.py`
