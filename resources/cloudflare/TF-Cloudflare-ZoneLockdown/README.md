# TF::Cloudflare::ZoneLockdown

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudflare-zonelockdown.json`
2. Implement your resource handlers in `tf_cloudflare_zonelockdown/handlers.py`
