...
1. Write the JSON schema describing your resource, `tf-cloudflare-healthcheck.json`
2. Implement your resource handlers in `tf_cloudflare_healthcheck/handlers.py`
