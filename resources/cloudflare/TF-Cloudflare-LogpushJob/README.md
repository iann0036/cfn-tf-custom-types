...
1. Write the JSON schema describing your resource, `tf-cloudflare-logpushjob.json`
2. Implement your resource handlers in `tf_cloudflare_logpushjob/handlers.py`
