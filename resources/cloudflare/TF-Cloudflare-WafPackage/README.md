...
1. Write the JSON schema describing your resource, `tf-cloudflare-wafpackage.json`
2. Implement your resource handlers in `tf_cloudflare_wafpackage/handlers.py`
