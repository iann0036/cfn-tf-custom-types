...
1. Write the JSON schema describing your resource, `tf-cloudflare-zonesettingsoverride.json`
2. Implement your resource handlers in `tf_cloudflare_zonesettingsoverride/handlers.py`
