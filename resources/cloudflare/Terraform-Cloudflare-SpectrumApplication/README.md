...
1. Write the JSON schema describing your resource, `terraform-cloudflare-spectrumapplication.json`
2. Implement your resource handlers in `terraform_cloudflare_spectrumapplication/handlers.py`
