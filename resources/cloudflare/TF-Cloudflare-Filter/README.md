# TF::Cloudflare::Filter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudflare-filter.json`
2. Implement your resource handlers in `tf_cloudflare_filter/handlers.py`
