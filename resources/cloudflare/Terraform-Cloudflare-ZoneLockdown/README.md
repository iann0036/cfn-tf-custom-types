...
1. Write the JSON schema describing your resource, `terraform-cloudflare-zonelockdown.json`
2. Implement your resource handlers in `terraform_cloudflare_zonelockdown/handlers.py`
