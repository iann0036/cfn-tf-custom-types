...
1. Write the JSON schema describing your resource, `tf-cloudflare-byoipprefix.json`
2. Implement your resource handlers in `tf_cloudflare_byoipprefix/handlers.py`
