...
1. Write the JSON schema describing your resource, `tf-cloudflare-magicfirewallruleset.json`
2. Implement your resource handlers in `tf_cloudflare_magicfirewallruleset/handlers.py`
