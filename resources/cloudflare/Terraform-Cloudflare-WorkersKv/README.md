...
1. Write the JSON schema describing your resource, `terraform-cloudflare-workerskv.json`
2. Implement your resource handlers in `terraform_cloudflare_workerskv/handlers.py`
