...
1. Write the JSON schema describing your resource, `terraform-cloudflare-record.json`
2. Implement your resource handlers in `terraform_cloudflare_record/handlers.py`
