...
1. Write the JSON schema describing your resource, `terraform-cloudflare-origincacertificate.json`
2. Implement your resource handlers in `terraform_cloudflare_origincacertificate/handlers.py`
