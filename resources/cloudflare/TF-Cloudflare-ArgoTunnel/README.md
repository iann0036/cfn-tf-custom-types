...
1. Write the JSON schema describing your resource, `tf-cloudflare-argotunnel.json`
2. Implement your resource handlers in `tf_cloudflare_argotunnel/handlers.py`
