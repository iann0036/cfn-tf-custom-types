...
1. Write the JSON schema describing your resource, `tf-cloudflare-logpushownershipchallenge.json`
2. Implement your resource handlers in `tf_cloudflare_logpushownershipchallenge/handlers.py`
