...
1. Write the JSON schema describing your resource, `tf-cloudflare-zonednssec.json`
2. Implement your resource handlers in `tf_cloudflare_zonednssec/handlers.py`
