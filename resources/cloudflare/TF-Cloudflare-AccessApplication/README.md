...
1. Write the JSON schema describing your resource, `tf-cloudflare-accessapplication.json`
2. Implement your resource handlers in `tf_cloudflare_accessapplication/handlers.py`
