...
1. Write the JSON schema describing your resource, `tf-cloudflare-workerroute.json`
2. Implement your resource handlers in `tf_cloudflare_workerroute/handlers.py`
