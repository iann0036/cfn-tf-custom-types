...
1. Write the JSON schema describing your resource, `tf-cloudflare-authenticatedoriginpulls.json`
2. Implement your resource handlers in `tf_cloudflare_authenticatedoriginpulls/handlers.py`
