...
1. Write the JSON schema describing your resource, `terraform-cloudflare-workerscript.json`
2. Implement your resource handlers in `terraform_cloudflare_workerscript/handlers.py`
