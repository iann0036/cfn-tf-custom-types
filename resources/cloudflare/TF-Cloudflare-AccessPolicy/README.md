...
1. Write the JSON schema describing your resource, `tf-cloudflare-accesspolicy.json`
2. Implement your resource handlers in `tf_cloudflare_accesspolicy/handlers.py`
