...
1. Write the JSON schema describing your resource, `terraform-cloudflare-wafgroup.json`
2. Implement your resource handlers in `terraform_cloudflare_wafgroup/handlers.py`
