...
1. Write the JSON schema describing your resource, `tf-cloudflare-deviceposturerule.json`
2. Implement your resource handlers in `tf_cloudflare_deviceposturerule/handlers.py`
