...
1. Write the JSON schema describing your resource, `terraform-cloudflare-ratelimit.json`
2. Implement your resource handlers in `terraform_cloudflare_ratelimit/handlers.py`
