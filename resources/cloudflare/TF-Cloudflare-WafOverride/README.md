...
1. Write the JSON schema describing your resource, `tf-cloudflare-wafoverride.json`
2. Implement your resource handlers in `tf_cloudflare_wafoverride/handlers.py`
