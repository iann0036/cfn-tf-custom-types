...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accountmember.json`
2. Implement your resource handlers in `terraform_cloudflare_accountmember/handlers.py`
