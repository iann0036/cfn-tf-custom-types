...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accessgroup.json`
2. Implement your resource handlers in `terraform_cloudflare_accessgroup/handlers.py`
