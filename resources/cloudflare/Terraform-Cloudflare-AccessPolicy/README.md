...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accesspolicy.json`
2. Implement your resource handlers in `terraform_cloudflare_accesspolicy/handlers.py`
