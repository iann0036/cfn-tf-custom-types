...
1. Write the JSON schema describing your resource, `tf-cloudflare-logpullretention.json`
2. Implement your resource handlers in `tf_cloudflare_logpullretention/handlers.py`
