...
1. Write the JSON schema describing your resource, `terraform-cloudflare-loadbalancermonitor.json`
2. Implement your resource handlers in `terraform_cloudflare_loadbalancermonitor/handlers.py`
