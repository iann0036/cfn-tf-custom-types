...
1. Write the JSON schema describing your resource, `terraform-cloudflare-pagerule.json`
2. Implement your resource handlers in `terraform_cloudflare_pagerule/handlers.py`
