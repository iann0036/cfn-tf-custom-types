...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accessservicetoken.json`
2. Implement your resource handlers in `terraform_cloudflare_accessservicetoken/handlers.py`
