...
1. Write the JSON schema describing your resource, `tf-cloudflare-customhostname.json`
2. Implement your resource handlers in `tf_cloudflare_customhostname/handlers.py`
