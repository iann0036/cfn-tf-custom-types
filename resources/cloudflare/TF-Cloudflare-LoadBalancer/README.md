...
1. Write the JSON schema describing your resource, `tf-cloudflare-loadbalancer.json`
2. Implement your resource handlers in `tf_cloudflare_loadbalancer/handlers.py`
