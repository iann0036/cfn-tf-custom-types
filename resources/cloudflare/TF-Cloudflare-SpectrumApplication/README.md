...
1. Write the JSON schema describing your resource, `tf-cloudflare-spectrumapplication.json`
2. Implement your resource handlers in `tf_cloudflare_spectrumapplication/handlers.py`
