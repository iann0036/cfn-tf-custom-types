...
1. Write the JSON schema describing your resource, `tf-cloudflare-ratelimit.json`
2. Implement your resource handlers in `tf_cloudflare_ratelimit/handlers.py`
