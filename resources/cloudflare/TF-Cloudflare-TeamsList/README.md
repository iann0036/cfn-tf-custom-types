...
1. Write the JSON schema describing your resource, `tf-cloudflare-teamslist.json`
2. Implement your resource handlers in `tf_cloudflare_teamslist/handlers.py`
