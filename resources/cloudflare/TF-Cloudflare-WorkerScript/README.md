...
1. Write the JSON schema describing your resource, `tf-cloudflare-workerscript.json`
2. Implement your resource handlers in `tf_cloudflare_workerscript/handlers.py`
