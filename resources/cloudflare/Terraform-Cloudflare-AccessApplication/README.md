...
1. Write the JSON schema describing your resource, `terraform-cloudflare-accessapplication.json`
2. Implement your resource handlers in `terraform_cloudflare_accessapplication/handlers.py`
