...
1. Write the JSON schema describing your resource, `tf-cloudflare-accesscacertificate.json`
2. Implement your resource handlers in `tf_cloudflare_accesscacertificate/handlers.py`
