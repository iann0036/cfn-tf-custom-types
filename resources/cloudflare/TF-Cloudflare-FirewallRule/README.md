# TF::Cloudflare::FirewallRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudflare-firewallrule.json`
2. Implement your resource handlers in `tf_cloudflare_firewallrule/handlers.py`
