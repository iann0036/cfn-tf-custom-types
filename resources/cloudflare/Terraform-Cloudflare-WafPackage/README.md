...
1. Write the JSON schema describing your resource, `terraform-cloudflare-wafpackage.json`
2. Implement your resource handlers in `terraform_cloudflare_wafpackage/handlers.py`
