...
1. Write the JSON schema describing your resource, `terraform-cloudflare-firewallrule.json`
2. Implement your resource handlers in `terraform_cloudflare_firewallrule/handlers.py`
