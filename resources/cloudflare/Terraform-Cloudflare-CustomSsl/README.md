...
1. Write the JSON schema describing your resource, `terraform-cloudflare-customssl.json`
2. Implement your resource handlers in `terraform_cloudflare_customssl/handlers.py`
