...
def create_handler(
    ...
    try:
        ...
        tf['resource']['cloudflare_custom_ssl'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['cloudflare_custom_ssl'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
