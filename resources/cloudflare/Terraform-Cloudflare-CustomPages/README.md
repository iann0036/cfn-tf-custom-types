...
1. Write the JSON schema describing your resource, `terraform-cloudflare-custompages.json`
2. Implement your resource handlers in `terraform_cloudflare_custompages/handlers.py`
