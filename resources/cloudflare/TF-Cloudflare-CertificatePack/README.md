...
1. Write the JSON schema describing your resource, `tf-cloudflare-certificatepack.json`
2. Implement your resource handlers in `tf_cloudflare_certificatepack/handlers.py`
