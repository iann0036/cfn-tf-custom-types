...
1. Write the JSON schema describing your resource, `terraform-cloudflare-filter.json`
2. Implement your resource handlers in `terraform_cloudflare_filter/handlers.py`
