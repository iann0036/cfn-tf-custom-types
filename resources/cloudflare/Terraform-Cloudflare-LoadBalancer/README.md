...
1. Write the JSON schema describing your resource, `terraform-cloudflare-loadbalancer.json`
2. Implement your resource handlers in `terraform_cloudflare_loadbalancer/handlers.py`
