...
1. Write the JSON schema describing your resource, `terraform-cloudflare-zonesettingsoverride.json`
2. Implement your resource handlers in `terraform_cloudflare_zonesettingsoverride/handlers.py`
