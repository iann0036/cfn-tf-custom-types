...
1. Write the JSON schema describing your resource, `tf-cloudflare-accessmutualtlscertificate.json`
2. Implement your resource handlers in `tf_cloudflare_accessmutualtlscertificate/handlers.py`
