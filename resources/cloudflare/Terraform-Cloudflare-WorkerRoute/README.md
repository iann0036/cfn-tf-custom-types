...
1. Write the JSON schema describing your resource, `terraform-cloudflare-workerroute.json`
2. Implement your resource handlers in `terraform_cloudflare_workerroute/handlers.py`
