...
1. Write the JSON schema describing your resource, `tf-cloudflare-authenticatedoriginpullscertificate.json`
2. Implement your resource handlers in `tf_cloudflare_authenticatedoriginpullscertificate/handlers.py`
