...
1. Write the JSON schema describing your resource, `tf-cloudflare-origincacertificate.json`
2. Implement your resource handlers in `tf_cloudflare_origincacertificate/handlers.py`
