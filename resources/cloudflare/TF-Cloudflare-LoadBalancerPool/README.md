# TF::Cloudflare::LoadBalancerPool

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-cloudflare-loadbalancerpool.json`
2. Implement your resource handlers in `tf_cloudflare_loadbalancerpool/handlers.py`
