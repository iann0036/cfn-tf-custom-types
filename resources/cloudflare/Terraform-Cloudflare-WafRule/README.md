...
1. Write the JSON schema describing your resource, `terraform-cloudflare-wafrule.json`
2. Implement your resource handlers in `terraform_cloudflare_wafrule/handlers.py`
