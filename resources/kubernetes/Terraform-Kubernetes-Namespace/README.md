...
1. Write the JSON schema describing your resource, `terraform-kubernetes-namespace.json`
2. Implement your resource handlers in `terraform_kubernetes_namespace/handlers.py`
