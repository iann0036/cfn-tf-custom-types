...
class MetadataDefinition(BaseModel):
    Annotations: Optional[Sequence["_AnnotationsDefinition3"]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            Annotations=deserialize_list(json_data.get("Annotations"), AnnotationsDefinition3),
...
@dataclass
class AnnotationsDefinition3(BaseModel):
    MapKey: Optional[str]
    MapValue: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AnnotationsDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AnnotationsDefinition3"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AnnotationsDefinition3 = AnnotationsDefinition3
