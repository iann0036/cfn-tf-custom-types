...
1. Write the JSON schema describing your resource, `terraform-kubernetes-clusterrolebinding.json`
2. Implement your resource handlers in `terraform_kubernetes_clusterrolebinding/handlers.py`
