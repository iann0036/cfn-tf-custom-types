# TF::Kubernetes::ValidatingWebhookConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-validatingwebhookconfiguration.json`
2. Implement your resource handlers in `tf_kubernetes_validatingwebhookconfiguration/handlers.py`
