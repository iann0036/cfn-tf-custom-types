# TF::Kubernetes::Namespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-namespace.json`
2. Implement your resource handlers in `tf_kubernetes_namespace/handlers.py`
