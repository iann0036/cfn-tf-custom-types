...
1. Write the JSON schema describing your resource, `terraform-kubernetes-limitrange.json`
2. Implement your resource handlers in `terraform_kubernetes_limitrange/handlers.py`
