...
1. Write the JSON schema describing your resource, `tf-kubernetes-clusterrole.json`
2. Implement your resource handlers in `tf_kubernetes_clusterrole/handlers.py`
