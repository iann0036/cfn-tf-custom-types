...
1. Write the JSON schema describing your resource, `terraform-kubernetes-role.json`
2. Implement your resource handlers in `terraform_kubernetes_role/handlers.py`
