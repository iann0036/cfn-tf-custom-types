...
1. Write the JSON schema describing your resource, `tf-kubernetes-daemonset.json`
2. Implement your resource handlers in `tf_kubernetes_daemonset/handlers.py`
