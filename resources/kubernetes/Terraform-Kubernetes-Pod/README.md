...
1. Write the JSON schema describing your resource, `terraform-kubernetes-pod.json`
2. Implement your resource handlers in `terraform_kubernetes_pod/handlers.py`
