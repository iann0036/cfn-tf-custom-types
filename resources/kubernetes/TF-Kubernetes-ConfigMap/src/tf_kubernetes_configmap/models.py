...
class ResourceModel(BaseModel):
    ...
    BinaryData: Optional[Sequence["_BinaryDataDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BinaryData=deserialize_list(json_data.get("BinaryData"), BinaryDataDefinition),
...
@dataclass
class BinaryDataDefinition(BaseModel):
    MapKey: Optional[str]
    MapValue: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_BinaryDataDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BinaryDataDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_BinaryDataDefinition = BinaryDataDefinition
