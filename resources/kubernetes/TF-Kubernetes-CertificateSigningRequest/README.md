...
1. Write the JSON schema describing your resource, `tf-kubernetes-certificatesigningrequest.json`
2. Implement your resource handlers in `tf_kubernetes_certificatesigningrequest/handlers.py`
