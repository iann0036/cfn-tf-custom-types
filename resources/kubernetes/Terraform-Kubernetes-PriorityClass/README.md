...
1. Write the JSON schema describing your resource, `terraform-kubernetes-priorityclass.json`
2. Implement your resource handlers in `terraform_kubernetes_priorityclass/handlers.py`
