...
1. Write the JSON schema describing your resource, `terraform-kubernetes-poddisruptionbudget.json`
2. Implement your resource handlers in `terraform_kubernetes_poddisruptionbudget/handlers.py`
