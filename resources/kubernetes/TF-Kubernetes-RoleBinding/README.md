...
1. Write the JSON schema describing your resource, `tf-kubernetes-rolebinding.json`
2. Implement your resource handlers in `tf_kubernetes_rolebinding/handlers.py`
