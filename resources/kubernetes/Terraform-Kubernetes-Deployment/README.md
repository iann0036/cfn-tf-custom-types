...
1. Write the JSON schema describing your resource, `terraform-kubernetes-deployment.json`
2. Implement your resource handlers in `terraform_kubernetes_deployment/handlers.py`
