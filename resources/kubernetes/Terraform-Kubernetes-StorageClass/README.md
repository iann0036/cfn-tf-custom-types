...
1. Write the JSON schema describing your resource, `terraform-kubernetes-storageclass.json`
2. Implement your resource handlers in `terraform_kubernetes_storageclass/handlers.py`
