...
1. Write the JSON schema describing your resource, `tf-kubernetes-limitrange.json`
2. Implement your resource handlers in `tf_kubernetes_limitrange/handlers.py`
