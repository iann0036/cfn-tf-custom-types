...
1. Write the JSON schema describing your resource, `terraform-kubernetes-serviceaccount.json`
2. Implement your resource handlers in `terraform_kubernetes_serviceaccount/handlers.py`
