...
1. Write the JSON schema describing your resource, `terraform-kubernetes-rolebinding.json`
2. Implement your resource handlers in `terraform_kubernetes_rolebinding/handlers.py`
