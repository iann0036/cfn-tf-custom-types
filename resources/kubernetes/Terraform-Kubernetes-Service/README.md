...
1. Write the JSON schema describing your resource, `terraform-kubernetes-service.json`
2. Implement your resource handlers in `terraform_kubernetes_service/handlers.py`
