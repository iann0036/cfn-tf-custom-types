...
1. Write the JSON schema describing your resource, `terraform-kubernetes-cronjob.json`
2. Implement your resource handlers in `terraform_kubernetes_cronjob/handlers.py`
