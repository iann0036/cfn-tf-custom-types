# TF::Kubernetes::ResourceQuota

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-resourcequota.json`
2. Implement your resource handlers in `tf_kubernetes_resourcequota/handlers.py`
