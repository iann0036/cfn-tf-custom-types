...
1. Write the JSON schema describing your resource, `terraform-kubernetes-job.json`
2. Implement your resource handlers in `terraform_kubernetes_job/handlers.py`
