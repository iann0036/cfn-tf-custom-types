...
1. Write the JSON schema describing your resource, `terraform-kubernetes-configmap.json`
2. Implement your resource handlers in `terraform_kubernetes_configmap/handlers.py`
