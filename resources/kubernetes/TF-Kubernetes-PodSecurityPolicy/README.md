# TF::Kubernetes::PodSecurityPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-podsecuritypolicy.json`
2. Implement your resource handlers in `tf_kubernetes_podsecuritypolicy/handlers.py`
