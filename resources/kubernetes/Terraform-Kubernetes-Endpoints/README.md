...
1. Write the JSON schema describing your resource, `terraform-kubernetes-endpoints.json`
2. Implement your resource handlers in `terraform_kubernetes_endpoints/handlers.py`
