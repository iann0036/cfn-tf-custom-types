...
1. Write the JSON schema describing your resource, `tf-kubernetes-serviceaccount.json`
2. Implement your resource handlers in `tf_kubernetes_serviceaccount/handlers.py`
