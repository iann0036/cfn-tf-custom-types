...
1. Write the JSON schema describing your resource, `terraform-kubernetes-networkpolicy.json`
2. Implement your resource handlers in `terraform_kubernetes_networkpolicy/handlers.py`
