...
1. Write the JSON schema describing your resource, `terraform-kubernetes-statefulset.json`
2. Implement your resource handlers in `terraform_kubernetes_statefulset/handlers.py`
