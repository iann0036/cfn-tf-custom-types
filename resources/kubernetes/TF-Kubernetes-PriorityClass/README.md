# TF::Kubernetes::PriorityClass

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-priorityclass.json`
2. Implement your resource handlers in `tf_kubernetes_priorityclass/handlers.py`
