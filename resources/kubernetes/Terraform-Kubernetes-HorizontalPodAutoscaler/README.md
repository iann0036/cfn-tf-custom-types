...
1. Write the JSON schema describing your resource, `terraform-kubernetes-horizontalpodautoscaler.json`
2. Implement your resource handlers in `terraform_kubernetes_horizontalpodautoscaler/handlers.py`
