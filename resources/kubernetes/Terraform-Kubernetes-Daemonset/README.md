...
1. Write the JSON schema describing your resource, `terraform-kubernetes-daemonset.json`
2. Implement your resource handlers in `terraform_kubernetes_daemonset/handlers.py`
