...
1. Write the JSON schema describing your resource, `terraform-kubernetes-persistentvolume.json`
2. Implement your resource handlers in `terraform_kubernetes_persistentvolume/handlers.py`
