...
1. Write the JSON schema describing your resource, `terraform-kubernetes-replicationcontroller.json`
2. Implement your resource handlers in `terraform_kubernetes_replicationcontroller/handlers.py`
