# Terraform::Kubernetes::ReplicationController Template Spec Volume Rbd
...
<pre>
{
    ...
    "<a href="#secretref" title="SecretRef">SecretRef</a>" : <i>[ <a href="template-spec-volume-rbd-secretref.md">SecretRef</a>, ... ]</i>
}
</pre>
...
<a href="#secretref" title="SecretRef">SecretRef</a>: <i>
      - <a href="template-spec-volume-rbd-secretref.md">SecretRef</a></i>
</pre>
...
_Type_: List of <a href="template-spec-volume-rbd-secretref.md">SecretRef</a>
