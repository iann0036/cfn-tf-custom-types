# TF::Kubernetes::PersistentVolumeClaim

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-persistentvolumeclaim.json`
2. Implement your resource handlers in `tf_kubernetes_persistentvolumeclaim/handlers.py`
