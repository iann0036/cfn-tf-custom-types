# TF::Kubernetes::DefaultServiceAccount

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-defaultserviceaccount.json`
2. Implement your resource handlers in `tf_kubernetes_defaultserviceaccount/handlers.py`
