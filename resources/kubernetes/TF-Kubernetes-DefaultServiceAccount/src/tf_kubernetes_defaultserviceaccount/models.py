...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    ImagePullSecret: Optional[Sequence["_ImagePullSecretDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            ImagePullSecret=deserialize_list(json_data.get("ImagePullSecret"), ImagePullSecretDefinition),
...
@dataclass
class ImagePullSecretDefinition(BaseModel):
    Name: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_ImagePullSecretDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ImagePullSecretDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ImagePullSecretDefinition = ImagePullSecretDefinition
