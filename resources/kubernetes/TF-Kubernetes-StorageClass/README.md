...
1. Write the JSON schema describing your resource, `tf-kubernetes-storageclass.json`
2. Implement your resource handlers in `tf_kubernetes_storageclass/handlers.py`
