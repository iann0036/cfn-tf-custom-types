# TF::Kubernetes::PersistentVolume

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-kubernetes-persistentvolume.json`
2. Implement your resource handlers in `tf_kubernetes_persistentvolume/handlers.py`
