...
1. Write the JSON schema describing your resource, `tf-kubernetes-deployment.json`
2. Implement your resource handlers in `tf_kubernetes_deployment/handlers.py`
