...
1. Write the JSON schema describing your resource, `terraform-kubernetes-apiservice.json`
2. Implement your resource handlers in `terraform_kubernetes_apiservice/handlers.py`
