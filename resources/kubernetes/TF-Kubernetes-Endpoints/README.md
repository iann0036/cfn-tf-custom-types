...
1. Write the JSON schema describing your resource, `tf-kubernetes-endpoints.json`
2. Implement your resource handlers in `tf_kubernetes_endpoints/handlers.py`
