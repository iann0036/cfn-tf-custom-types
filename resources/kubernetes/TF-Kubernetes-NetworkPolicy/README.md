...
1. Write the JSON schema describing your resource, `tf-kubernetes-networkpolicy.json`
2. Implement your resource handlers in `tf_kubernetes_networkpolicy/handlers.py`
