...
1. Write the JSON schema describing your resource, `terraform-kubernetes-resourcequota.json`
2. Implement your resource handlers in `terraform_kubernetes_resourcequota/handlers.py`
