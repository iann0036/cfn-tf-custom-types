...
1. Write the JSON schema describing your resource, `terraform-kubernetes-secret.json`
2. Implement your resource handlers in `terraform_kubernetes_secret/handlers.py`
