...
1. Write the JSON schema describing your resource, `terraform-kubernetes-clusterrole.json`
2. Implement your resource handlers in `terraform_kubernetes_clusterrole/handlers.py`
