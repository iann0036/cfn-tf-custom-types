...
1. Write the JSON schema describing your resource, `terraform-kubernetes-persistentvolumeclaim.json`
2. Implement your resource handlers in `terraform_kubernetes_persistentvolumeclaim/handlers.py`
