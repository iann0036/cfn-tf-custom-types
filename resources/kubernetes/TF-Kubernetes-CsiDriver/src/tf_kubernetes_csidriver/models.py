...
class SpecDefinition(BaseModel):
    ...
    VolumeLifecycleModes: Optional[Sequence[str]]
    ...
    def _deserialize(
        ...
        if not json_data:
            return None
        return cls(
            AttachRequired=json_data.get("AttachRequired"),
            PodInfoOnMount=json_data.get("PodInfoOnMount"),
            VolumeLifecycleModes=json_data.get("VolumeLifecycleModes"),
        )
