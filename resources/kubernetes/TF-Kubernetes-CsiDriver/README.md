...
1. Write the JSON schema describing your resource, `tf-kubernetes-csidriver.json`
2. Implement your resource handlers in `tf_kubernetes_csidriver/handlers.py`
