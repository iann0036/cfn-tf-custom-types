...
1. Write the JSON schema describing your resource, `terraform-kubernetes-ingress.json`
2. Implement your resource handlers in `terraform_kubernetes_ingress/handlers.py`
