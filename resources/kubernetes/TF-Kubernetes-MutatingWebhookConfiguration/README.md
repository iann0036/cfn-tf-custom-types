...
1. Write the JSON schema describing your resource, `tf-kubernetes-mutatingwebhookconfiguration.json`
2. Implement your resource handlers in `tf_kubernetes_mutatingwebhookconfiguration/handlers.py`
