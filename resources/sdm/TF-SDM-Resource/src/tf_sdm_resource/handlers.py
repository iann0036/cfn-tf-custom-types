...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/sdm_resource/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'providerFullName': 'strongdm/sdm',
                'providerTypeName': 'sdm',
                'terraformTypeName': 'sdm_resource',
                'returnValues': ["Id"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/sdm_resource/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/sdm_resource/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Id=None, Aks=None, AksBasicAuth=None, AksServiceAccount=None, AksServiceAccountUserImpersonation=None, AksUserImpersonation=None, AmazonEks=None, AmazonEksUserImpersonation=None, AmazonEs=None, AmazonmqAmqp091=None, Athena=None, AuroraMysql=None, AuroraPostgres=None, Aws=None, BigQuery=None, Cassandra=None, Citus=None, Clustrix=None, Cockroach=None, Db2I=None, Db2Luw=None, Druid=None, DynamoDb=None, Elastic=None, ElasticacheRedis=None, GoogleGke=None, GoogleGkeUserImpersonation=None, Greenplum=None, HttpAuth=None, HttpBasicAuth=None, HttpNoAuth=None, Kubernetes=None, KubernetesBasicAuth=None, KubernetesServiceAccount=None, KubernetesServiceAccountUserImpersonation=None, KubernetesUserImpersonation=None, Maria=None, Memcached=None, Memsql=None, MongoHost=None, MongoLegacyHost=None, MongoLegacyReplicaset=None, MongoReplicaSet=None, Mysql=None, Oracle=None, Postgres=None, Presto=None, RabbitmqAmqp091=None, Rdp=None, Redis=None, Redshift=None, Snowflake=None, SqlServer=None, Ssh=None, SshCert=None, SshCustomerKey=None, Sybase=None, SybaseIq=None, Teradata=None, Timeouts=None)
