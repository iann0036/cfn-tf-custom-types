# TF::SDM::Resource MongoLegacyReplicasetDefinition
...
<pre>
{
    "<a href="#authdatabase" title="AuthDatabase">AuthDatabase</a>" : <i>String</i>,
    "<a href="#connecttoreplica" title="ConnectToReplica">ConnectToReplica</a>" : <i>Boolean</i>,
    "<a href="#egressfilter" title="EgressFilter">EgressFilter</a>" : <i>String</i>,
    "<a href="#hostname" title="Hostname">Hostname</a>" : <i>String</i>,
    "<a href="#name" title="Name">Name</a>" : <i>String</i>,
    "<a href="#password" title="Password">Password</a>" : <i>String</i>,
    "<a href="#port" title="Port">Port</a>" : <i>Double</i>,
    "<a href="#replicaset" title="ReplicaSet">ReplicaSet</a>" : <i>String</i>,
