# TF::SDM::RoleAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-sdm-roleattachment.json`
2. Implement your resource handlers in `tf_sdm_roleattachment/handlers.py`
