# TF::Civo::KubernetesNodePool

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-civo-kubernetesnodepool.json`
2. Implement your resource handlers in `tf_civo_kubernetesnodepool/handlers.py`
