...
1. Write the JSON schema describing your resource, `tf-civo-dnsdomainrecord.json`
2. Implement your resource handlers in `tf_civo_dnsdomainrecord/handlers.py`
