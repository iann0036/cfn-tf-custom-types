...
1. Write the JSON schema describing your resource, `tf-civo-kubernetescluster.json`
2. Implement your resource handlers in `tf_civo_kubernetescluster/handlers.py`
