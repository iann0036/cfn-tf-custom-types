# TF::Civo::VolumeAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-civo-volumeattachment.json`
2. Implement your resource handlers in `tf_civo_volumeattachment/handlers.py`
