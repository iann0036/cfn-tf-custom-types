...
1. Write the JSON schema describing your resource, `tf-launchdarkly-destination.json`
2. Implement your resource handlers in `tf_launchdarkly_destination/handlers.py`
