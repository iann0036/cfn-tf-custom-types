...
1. Write the JSON schema describing your resource, `tf-launchdarkly-webhook.json`
2. Implement your resource handlers in `tf_launchdarkly_webhook/handlers.py`
