...
1. Write the JSON schema describing your resource, `tf-launchdarkly-featureflag.json`
2. Implement your resource handlers in `tf_launchdarkly_featureflag/handlers.py`
