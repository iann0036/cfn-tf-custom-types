...
1. Write the JSON schema describing your resource, `tf-launchdarkly-accesstoken.json`
2. Implement your resource handlers in `tf_launchdarkly_accesstoken/handlers.py`
