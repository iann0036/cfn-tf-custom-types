...
1. Write the JSON schema describing your resource, `tf-launchdarkly-featureflagenvironment.json`
2. Implement your resource handlers in `tf_launchdarkly_featureflagenvironment/handlers.py`
