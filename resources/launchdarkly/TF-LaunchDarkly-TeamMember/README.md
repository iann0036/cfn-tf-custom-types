...
1. Write the JSON schema describing your resource, `tf-launchdarkly-teammember.json`
2. Implement your resource handlers in `tf_launchdarkly_teammember/handlers.py`
