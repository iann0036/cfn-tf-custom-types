...
1. Write the JSON schema describing your resource, `tf-launchdarkly-customrole.json`
2. Implement your resource handlers in `tf_launchdarkly_customrole/handlers.py`
