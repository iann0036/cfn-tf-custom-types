...
1. Write the JSON schema describing your resource, `tf-launchdarkly-project.json`
2. Implement your resource handlers in `tf_launchdarkly_project/handlers.py`
