...
1. Write the JSON schema describing your resource, `tf-launchdarkly-environment.json`
2. Implement your resource handlers in `tf_launchdarkly_environment/handlers.py`
