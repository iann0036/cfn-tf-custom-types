...
1. Write the JSON schema describing your resource, `tf-launchdarkly-segment.json`
2. Implement your resource handlers in `tf_launchdarkly_segment/handlers.py`
