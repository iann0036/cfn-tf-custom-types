...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogorganizationsaccess.json`
2. Implement your resource handlers in `tf_aws_servicecatalogorganizationsaccess/handlers.py`
