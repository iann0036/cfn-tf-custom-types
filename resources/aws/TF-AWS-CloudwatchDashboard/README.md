...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchdashboard.json`
2. Implement your resource handlers in `tf_aws_cloudwatchdashboard/handlers.py`
