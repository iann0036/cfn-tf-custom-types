...
1. Write the JSON schema describing your resource, `terraform-aws-guarddutythreatintelset.json`
2. Implement your resource handlers in `terraform_aws_guarddutythreatintelset/handlers.py`
