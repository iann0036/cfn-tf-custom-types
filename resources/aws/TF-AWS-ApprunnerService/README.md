...
1. Write the JSON schema describing your resource, `tf-aws-apprunnerservice.json`
2. Implement your resource handlers in `tf_aws_apprunnerservice/handlers.py`
