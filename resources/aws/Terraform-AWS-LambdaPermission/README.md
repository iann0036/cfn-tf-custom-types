...
1. Write the JSON schema describing your resource, `terraform-aws-lambdapermission.json`
2. Implement your resource handlers in `terraform_aws_lambdapermission/handlers.py`
