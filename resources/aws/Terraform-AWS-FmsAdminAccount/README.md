...
1. Write the JSON schema describing your resource, `terraform-aws-fmsadminaccount.json`
2. Implement your resource handlers in `terraform_aws_fmsadminaccount/handlers.py`
