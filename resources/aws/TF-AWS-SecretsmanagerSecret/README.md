...
1. Write the JSON schema describing your resource, `tf-aws-secretsmanagersecret.json`
2. Implement your resource handlers in `tf_aws_secretsmanagersecret/handlers.py`
