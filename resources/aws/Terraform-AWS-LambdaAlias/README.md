...
1. Write the JSON schema describing your resource, `terraform-aws-lambdaalias.json`
2. Implement your resource handlers in `terraform_aws_lambdaalias/handlers.py`
