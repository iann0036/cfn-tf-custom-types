...
1. Write the JSON schema describing your resource, `terraform-aws-vpcendpointroutetableassociation.json`
2. Implement your resource handlers in `terraform_aws_vpcendpointroutetableassociation/handlers.py`
