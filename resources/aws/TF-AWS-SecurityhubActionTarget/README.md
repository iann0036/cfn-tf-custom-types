...
1. Write the JSON schema describing your resource, `tf-aws-securityhubactiontarget.json`
2. Implement your resource handlers in `tf_aws_securityhubactiontarget/handlers.py`
