...
1. Write the JSON schema describing your resource, `tf-aws-lakeformationpermissions.json`
2. Implement your resource handlers in `tf_aws_lakeformationpermissions/handlers.py`
