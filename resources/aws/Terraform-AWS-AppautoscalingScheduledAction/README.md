...
1. Write the JSON schema describing your resource, `terraform-aws-appautoscalingscheduledaction.json`
2. Implement your resource handlers in `terraform_aws_appautoscalingscheduledaction/handlers.py`
