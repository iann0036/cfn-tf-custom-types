# TF::AWS::Ec2ClientVpnEndpoint

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ec2clientvpnendpoint.json`
2. Implement your resource handlers in `tf_aws_ec2clientvpnendpoint/handlers.py`
