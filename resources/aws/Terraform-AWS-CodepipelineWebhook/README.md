...
1. Write the JSON schema describing your resource, `terraform-aws-codepipelinewebhook.json`
2. Implement your resource handlers in `terraform_aws_codepipelinewebhook/handlers.py`
