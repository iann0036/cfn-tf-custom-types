...
1. Write the JSON schema describing your resource, `tf-aws-wafv2webaclassociation.json`
2. Implement your resource handlers in `tf_aws_wafv2webaclassociation/handlers.py`
