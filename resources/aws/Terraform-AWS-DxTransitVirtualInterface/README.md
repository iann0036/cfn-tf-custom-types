...
1. Write the JSON schema describing your resource, `terraform-aws-dxtransitvirtualinterface.json`
2. Implement your resource handlers in `terraform_aws_dxtransitvirtualinterface/handlers.py`
