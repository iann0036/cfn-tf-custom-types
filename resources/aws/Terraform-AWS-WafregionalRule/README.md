...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalrule.json`
2. Implement your resource handlers in `terraform_aws_wafregionalrule/handlers.py`
