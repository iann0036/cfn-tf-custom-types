# TF::AWS::DatapipelinePipeline

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-datapipelinepipeline.json`
2. Implement your resource handlers in `tf_aws_datapipelinepipeline/handlers.py`
