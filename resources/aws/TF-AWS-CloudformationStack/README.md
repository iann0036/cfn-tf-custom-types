...
1. Write the JSON schema describing your resource, `tf-aws-cloudformationstack.json`
2. Implement your resource handlers in `tf_aws_cloudformationstack/handlers.py`
