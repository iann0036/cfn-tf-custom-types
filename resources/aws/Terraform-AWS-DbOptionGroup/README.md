...
1. Write the JSON schema describing your resource, `terraform-aws-dboptiongroup.json`
2. Implement your resource handlers in `terraform_aws_dboptiongroup/handlers.py`
