# TF::AWS::PinpointApnsChannel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-pinpointapnschannel.json`
2. Implement your resource handlers in `tf_aws_pinpointapnschannel/handlers.py`
