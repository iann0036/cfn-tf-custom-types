...
1. Write the JSON schema describing your resource, `terraform-aws-gameliftgamesessionqueue.json`
2. Implement your resource handlers in `terraform_aws_gameliftgamesessionqueue/handlers.py`
