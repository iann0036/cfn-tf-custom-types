...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaymethodsettings.json`
2. Implement your resource handlers in `terraform_aws_apigatewaymethodsettings/handlers.py`
