...
1. Write the JSON schema describing your resource, `terraform-aws-ramprincipalassociation.json`
2. Implement your resource handlers in `terraform_aws_ramprincipalassociation/handlers.py`
