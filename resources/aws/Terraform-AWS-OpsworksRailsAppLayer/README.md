...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksrailsapplayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksrailsapplayer/handlers.py`
