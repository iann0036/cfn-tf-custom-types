...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksinstance.json`
2. Implement your resource handlers in `terraform_aws_opsworksinstance/handlers.py`
