...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_s3_object_copy/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'terraformTypeName': 'aws_s3_object_copy',
                'returnValues': ["Etag", "Expiration", "Id", "LastModified", "RequestCharged", "SourceVersionId", "VersionId"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_s3_object_copy/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/aws_s3_object_copy/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Acl=None, Bucket=None, BucketKeyEnabled=None, CacheControl=None, ContentDisposition=None, ContentEncoding=None, ContentLanguage=None, ContentType=None, CopyIfMatch=None, CopyIfModifiedSince=None, CopyIfNoneMatch=None, CopyIfUnmodifiedSince=None, CustomerAlgorithm=None, CustomerKey=None, CustomerKeyMd5=None, Etag=None, ExpectedBucketOwner=None, ExpectedSourceBucketOwner=None, Expiration=None, Expires=None, ForceDestroy=None, Id=None, Key=None, KmsEncryptionContext=None, KmsKeyId=None, LastModified=None, Metadata=None, MetadataDirective=None, ObjectLockLegalHoldStatus=None, ObjectLockMode=None, ObjectLockRetainUntilDate=None, RequestCharged=None, RequestPayer=None, ServerSideEncryption=None, Source=None, SourceCustomerAlgorithm=None, SourceCustomerKey=None, SourceCustomerKeyMd5=None, SourceVersionId=None, StorageClass=None, TaggingDirective=None, Tags=None, TagsAll=None, VersionId=None, WebsiteRedirect=None, Grant=None)
