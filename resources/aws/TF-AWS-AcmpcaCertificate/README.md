...
1. Write the JSON schema describing your resource, `tf-aws-acmpcacertificate.json`
2. Implement your resource handlers in `tf_aws_acmpcacertificate/handlers.py`
