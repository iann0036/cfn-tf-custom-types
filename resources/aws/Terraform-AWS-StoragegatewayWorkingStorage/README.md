...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewayworkingstorage.json`
2. Implement your resource handlers in `terraform_aws_storagegatewayworkingstorage/handlers.py`
