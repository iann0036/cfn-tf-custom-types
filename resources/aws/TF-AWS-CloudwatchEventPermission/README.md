...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatcheventpermission.json`
2. Implement your resource handlers in `tf_aws_cloudwatcheventpermission/handlers.py`
