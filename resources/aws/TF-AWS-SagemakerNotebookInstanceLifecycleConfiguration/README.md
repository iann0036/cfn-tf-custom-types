# TF::AWS::SagemakerNotebookInstanceLifecycleConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-sagemakernotebookinstancelifecycleconfiguration.json`
2. Implement your resource handlers in `tf_aws_sagemakernotebookinstancelifecycleconfiguration/handlers.py`
