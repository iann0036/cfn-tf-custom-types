...
1. Write the JSON schema describing your resource, `tf-aws-networkfirewallfirewall.json`
2. Implement your resource handlers in `tf_aws_networkfirewallfirewall/handlers.py`
