...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayaccount.json`
2. Implement your resource handlers in `tf_aws_apigatewayaccount/handlers.py`
