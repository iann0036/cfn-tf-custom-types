...
1. Write the JSON schema describing your resource, `terraform-aws-iamgrouppolicyattachment.json`
2. Implement your resource handlers in `terraform_aws_iamgrouppolicyattachment/handlers.py`
