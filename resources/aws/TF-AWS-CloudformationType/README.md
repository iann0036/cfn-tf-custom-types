...
1. Write the JSON schema describing your resource, `tf-aws-cloudformationtype.json`
2. Implement your resource handlers in `tf_aws_cloudformationtype/handlers.py`
