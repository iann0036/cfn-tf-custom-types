...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    Name: Optional[str]
    XssMatchTuples: Optional[Sequence["_XssMatchTuplesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            XssMatchTuples=deserialize_list(json_data.get("XssMatchTuples"), XssMatchTuplesDefinition),
        )
...
@dataclass
class XssMatchTuplesDefinition(BaseModel):
    TextTransformation: Optional[str]
    FieldToMatch: Optional[Sequence["_FieldToMatchDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_XssMatchTuplesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_XssMatchTuplesDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_XssMatchTuplesDefinition = XssMatchTuplesDefinition
