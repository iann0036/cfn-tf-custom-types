# TF::AWS::WafXssMatchSet

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-wafxssmatchset.json`
2. Implement your resource handlers in `tf_aws_wafxssmatchset/handlers.py`
