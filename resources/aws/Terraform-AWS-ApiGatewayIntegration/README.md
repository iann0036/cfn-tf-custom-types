...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayintegration.json`
2. Implement your resource handlers in `terraform_aws_apigatewayintegration/handlers.py`
