...
1. Write the JSON schema describing your resource, `terraform-aws-vpcendpointservice.json`
2. Implement your resource handlers in `terraform_aws_vpcendpointservice/handlers.py`
