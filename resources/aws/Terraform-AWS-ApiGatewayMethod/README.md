...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaymethod.json`
2. Implement your resource handlers in `terraform_aws_apigatewaymethod/handlers.py`
