# TF::AWS::SecurityhubProductSubscription

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-securityhubproductsubscription.json`
2. Implement your resource handlers in `tf_aws_securityhubproductsubscription/handlers.py`
