...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayrequestvalidator.json`
2. Implement your resource handlers in `tf_aws_apigatewayrequestvalidator/handlers.py`
