...
1. Write the JSON schema describing your resource, `tf-aws-sesdomainmailfrom.json`
2. Implement your resource handlers in `tf_aws_sesdomainmailfrom/handlers.py`
