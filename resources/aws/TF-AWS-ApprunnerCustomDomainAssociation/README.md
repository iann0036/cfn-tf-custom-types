...
1. Write the JSON schema describing your resource, `tf-aws-apprunnercustomdomainassociation.json`
2. Implement your resource handlers in `tf_aws_apprunnercustomdomainassociation/handlers.py`
