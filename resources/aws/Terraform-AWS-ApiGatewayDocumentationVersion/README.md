...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaydocumentationversion.json`
2. Implement your resource handlers in `terraform_aws_apigatewaydocumentationversion/handlers.py`
