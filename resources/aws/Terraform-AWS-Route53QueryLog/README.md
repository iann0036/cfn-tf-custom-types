...
1. Write the JSON schema describing your resource, `terraform-aws-route53querylog.json`
2. Implement your resource handlers in `terraform_aws_route53querylog/handlers.py`
