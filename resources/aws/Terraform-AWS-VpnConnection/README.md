...
1. Write the JSON schema describing your resource, `terraform-aws-vpnconnection.json`
2. Implement your resource handlers in `terraform_aws_vpnconnection/handlers.py`
