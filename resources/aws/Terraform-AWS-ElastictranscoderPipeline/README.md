...
1. Write the JSON schema describing your resource, `terraform-aws-elastictranscoderpipeline.json`
2. Implement your resource handlers in `terraform_aws_elastictranscoderpipeline/handlers.py`
