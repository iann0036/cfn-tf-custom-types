...
1. Write the JSON schema describing your resource, `terraform-aws-dxgateway.json`
2. Implement your resource handlers in `terraform_aws_dxgateway/handlers.py`
