...
1. Write the JSON schema describing your resource, `terraform-aws-ssmmaintenancewindowtask.json`
2. Implement your resource handlers in `terraform_aws_ssmmaintenancewindowtask/handlers.py`
