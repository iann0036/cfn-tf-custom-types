...
1. Write the JSON schema describing your resource, `terraform-aws-ssmpatchbaseline.json`
2. Implement your resource handlers in `terraform_aws_ssmpatchbaseline/handlers.py`
