...
1. Write the JSON schema describing your resource, `terraform-aws-launchtemplate.json`
2. Implement your resource handlers in `terraform_aws_launchtemplate/handlers.py`
