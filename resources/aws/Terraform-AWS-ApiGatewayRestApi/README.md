...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayrestapi.json`
2. Implement your resource handlers in `terraform_aws_apigatewayrestapi/handlers.py`
