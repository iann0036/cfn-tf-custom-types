...
1. Write the JSON schema describing your resource, `tf-aws-networkinterface.json`
2. Implement your resource handlers in `tf_aws_networkinterface/handlers.py`
