...
1. Write the JSON schema describing your resource, `terraform-aws-inspectorassessmenttemplate.json`
2. Implement your resource handlers in `terraform_aws_inspectorassessmenttemplate/handlers.py`
