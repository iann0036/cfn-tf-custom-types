...
1. Write the JSON schema describing your resource, `tf-aws-appautoscalingscheduledaction.json`
2. Implement your resource handlers in `tf_aws_appautoscalingscheduledaction/handlers.py`
