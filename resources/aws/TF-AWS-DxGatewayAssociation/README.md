...
1. Write the JSON schema describing your resource, `tf-aws-dxgatewayassociation.json`
2. Implement your resource handlers in `tf_aws_dxgatewayassociation/handlers.py`
