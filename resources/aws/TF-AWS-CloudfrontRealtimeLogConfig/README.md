...
1. Write the JSON schema describing your resource, `tf-aws-cloudfrontrealtimelogconfig.json`
2. Implement your resource handlers in `tf_aws_cloudfrontrealtimelogconfig/handlers.py`
