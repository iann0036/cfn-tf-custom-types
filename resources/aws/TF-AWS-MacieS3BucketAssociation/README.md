# TF::AWS::MacieS3BucketAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-macies3bucketassociation.json`
2. Implement your resource handlers in `tf_aws_macies3bucketassociation/handlers.py`
