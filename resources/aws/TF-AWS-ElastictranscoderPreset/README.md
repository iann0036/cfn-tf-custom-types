...
1. Write the JSON schema describing your resource, `tf-aws-elastictranscoderpreset.json`
2. Implement your resource handlers in `tf_aws_elastictranscoderpreset/handlers.py`
