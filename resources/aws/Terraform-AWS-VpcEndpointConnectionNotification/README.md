...
1. Write the JSON schema describing your resource, `terraform-aws-vpcendpointconnectionnotification.json`
2. Implement your resource handlers in `terraform_aws_vpcendpointconnectionnotification/handlers.py`
