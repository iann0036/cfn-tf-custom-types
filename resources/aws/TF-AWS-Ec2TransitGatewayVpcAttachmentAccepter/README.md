# TF::AWS::Ec2TransitGatewayVpcAttachmentAccepter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ec2transitgatewayvpcattachmentaccepter.json`
2. Implement your resource handlers in `tf_aws_ec2transitgatewayvpcattachmentaccepter/handlers.py`
