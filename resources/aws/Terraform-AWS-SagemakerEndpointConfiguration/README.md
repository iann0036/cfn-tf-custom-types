...
1. Write the JSON schema describing your resource, `terraform-aws-sagemakerendpointconfiguration.json`
2. Implement your resource handlers in `terraform_aws_sagemakerendpointconfiguration/handlers.py`
