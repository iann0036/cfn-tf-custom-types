...
1. Write the JSON schema describing your resource, `terraform-aws-fsxwindowsfilesystem.json`
2. Implement your resource handlers in `terraform_aws_fsxwindowsfilesystem/handlers.py`
