...
1. Write the JSON schema describing your resource, `terraform-aws-vpcipv4cidrblockassociation.json`
2. Implement your resource handlers in `terraform_aws_vpcipv4cidrblockassociation/handlers.py`
