# TF::AWS::CodedeployApp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-codedeployapp.json`
2. Implement your resource handlers in `tf_aws_codedeployapp/handlers.py`
