...
1. Write the JSON schema describing your resource, `terraform-aws-spotdatafeedsubscription.json`
2. Implement your resource handlers in `terraform_aws_spotdatafeedsubscription/handlers.py`
