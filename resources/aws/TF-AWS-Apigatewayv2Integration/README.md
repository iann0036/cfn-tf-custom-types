...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayv2integration.json`
2. Implement your resource handlers in `tf_aws_apigatewayv2integration/handlers.py`
