...
1. Write the JSON schema describing your resource, `terraform-aws-inspectorassessmenttarget.json`
2. Implement your resource handlers in `terraform_aws_inspectorassessmenttarget/handlers.py`
