# TF::AWS::Macie2CustomDataIdentifier

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-macie2customdataidentifier.json`
2. Implement your resource handlers in `tf_aws_macie2customdataidentifier/handlers.py`
