...
<pre>
{
    "Type" : "TF::AWS::Macie2CustomDataIdentifier",
    "Properties" : {
        "<a href="#description" title="Description">Description</a>" : <i>String</i>,
        "<a href="#ignorewords" title="IgnoreWords">IgnoreWords</a>" : <i>[ String, ... ]</i>,
        "<a href="#keywords" title="Keywords">Keywords</a>" : <i>[ String, ... ]</i>,
        "<a href="#maximummatchdistance" title="MaximumMatchDistance">MaximumMatchDistance</a>" : <i>Double</i>,
...
Properties:
    <a href="#description" title="Description">Description</a>: <i>String</i>
    <a href="#ignorewords" title="IgnoreWords">IgnoreWords</a>: <i>
      - String</i>
    <a href="#keywords" title="Keywords">Keywords</a>: <i>
      - String</i>
    <a href="#maximummatchdistance" title="MaximumMatchDistance">MaximumMatchDistance</a>: <i>Double</i>
    <a href="#name" title="Name">Name</a>: <i>String</i>
    <a href="#nameprefix" title="NamePrefix">NamePrefix</a>: <i>String</i>
...
A custom name for the custom data identifier. The name can contain as many as 128 characters. If omitted, Terraform will assign a random, unique name. Conflicts with `name_prefix`.
