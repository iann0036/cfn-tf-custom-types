...
1. Write the JSON schema describing your resource, `tf-aws-securitygrouprule.json`
2. Implement your resource handlers in `tf_aws_securitygrouprule/handlers.py`
