...
1. Write the JSON schema describing your resource, `terraform-aws-amilaunchpermission.json`
2. Implement your resource handlers in `terraform_aws_amilaunchpermission/handlers.py`
