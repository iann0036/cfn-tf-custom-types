...
1. Write the JSON schema describing your resource, `tf-aws-vpcpeeringconnectionoptions.json`
2. Implement your resource handlers in `tf_aws_vpcpeeringconnectionoptions/handlers.py`
