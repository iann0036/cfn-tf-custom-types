...
1. Write the JSON schema describing your resource, `terraform-aws-globalacceleratoraccelerator.json`
2. Implement your resource handlers in `terraform_aws_globalacceleratoraccelerator/handlers.py`
