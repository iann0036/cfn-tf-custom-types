...
1. Write the JSON schema describing your resource, `tf-aws-configorganizationmanagedrule.json`
2. Implement your resource handlers in `tf_aws_configorganizationmanagedrule/handlers.py`
