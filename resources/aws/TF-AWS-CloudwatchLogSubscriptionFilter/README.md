...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchlogsubscriptionfilter.json`
2. Implement your resource handlers in `tf_aws_cloudwatchlogsubscriptionfilter/handlers.py`
