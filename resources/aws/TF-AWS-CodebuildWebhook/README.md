...
1. Write the JSON schema describing your resource, `tf-aws-codebuildwebhook.json`
2. Implement your resource handlers in `tf_aws_codebuildwebhook/handlers.py`
