...
1. Write the JSON schema describing your resource, `tf-aws-storagegatewaysmbfileshare.json`
2. Implement your resource handlers in `tf_aws_storagegatewaysmbfileshare/handlers.py`
