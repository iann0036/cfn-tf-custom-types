...
1. Write the JSON schema describing your resource, `tf-aws-proxyprotocolpolicy.json`
2. Implement your resource handlers in `tf_aws_proxyprotocolpolicy/handlers.py`
