...
1. Write the JSON schema describing your resource, `terraform-aws-ecscluster.json`
2. Implement your resource handlers in `terraform_aws_ecscluster/handlers.py`
