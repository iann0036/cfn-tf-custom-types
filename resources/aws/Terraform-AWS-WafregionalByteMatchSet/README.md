...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalbytematchset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalbytematchset/handlers.py`
