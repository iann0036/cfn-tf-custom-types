...
1. Write the JSON schema describing your resource, `terraform-aws-workspacesdirectory.json`
2. Implement your resource handlers in `terraform_aws_workspacesdirectory/handlers.py`
