...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalregexmatchset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalregexmatchset/handlers.py`
