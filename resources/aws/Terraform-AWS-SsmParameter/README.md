...
1. Write the JSON schema describing your resource, `terraform-aws-ssmparameter.json`
2. Implement your resource handlers in `terraform_aws_ssmparameter/handlers.py`
