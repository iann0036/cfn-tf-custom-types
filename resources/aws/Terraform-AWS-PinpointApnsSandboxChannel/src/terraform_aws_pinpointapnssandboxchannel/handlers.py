...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_pinpoint_apns_sandbox_channel'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_pinpoint_apns_sandbox_channel'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
