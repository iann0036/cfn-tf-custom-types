...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointapnssandboxchannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointapnssandboxchannel/handlers.py`
