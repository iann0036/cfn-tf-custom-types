...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalregexpatternset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalregexpatternset/handlers.py`
