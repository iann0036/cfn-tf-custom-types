...
1. Write the JSON schema describing your resource, `terraform-aws-dxpublicvirtualinterface.json`
2. Implement your resource handlers in `terraform_aws_dxpublicvirtualinterface/handlers.py`
