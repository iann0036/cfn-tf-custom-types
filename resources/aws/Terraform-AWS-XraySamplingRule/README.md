...
1. Write the JSON schema describing your resource, `terraform-aws-xraysamplingrule.json`
2. Implement your resource handlers in `terraform_aws_xraysamplingrule/handlers.py`
