...
1. Write the JSON schema describing your resource, `tf-aws-dxconnectionassociation.json`
2. Implement your resource handlers in `tf_aws_dxconnectionassociation/handlers.py`
