...
1. Write the JSON schema describing your resource, `terraform-aws-elasticachesubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_elasticachesubnetgroup/handlers.py`
