...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogtagoption.json`
2. Implement your resource handlers in `tf_aws_servicecatalogtagoption/handlers.py`
