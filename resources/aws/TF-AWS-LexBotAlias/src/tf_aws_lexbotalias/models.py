...
class ResourceModel(BaseModel):
    ...
    Name: Optional[str]
    ConversationLogs: Optional[Sequence["_ConversationLogsDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ConversationLogs=deserialize_list(json_data.get("ConversationLogs"), ConversationLogsDefinition),
...
@dataclass
class ConversationLogsDefinition(BaseModel):
    IamRoleArn: Optional[str]
    LogSettings: Optional[Sequence["_LogSettingsDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_ConversationLogsDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ConversationLogsDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ConversationLogsDefinition = ConversationLogsDefinition
