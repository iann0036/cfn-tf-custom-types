...
1. Write the JSON schema describing your resource, `terraform-aws-dynamodbtable.json`
2. Implement your resource handlers in `terraform_aws_dynamodbtable/handlers.py`
