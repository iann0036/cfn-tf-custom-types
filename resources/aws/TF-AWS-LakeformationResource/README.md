# TF::AWS::LakeformationResource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-lakeformationresource.json`
2. Implement your resource handlers in `tf_aws_lakeformationresource/handlers.py`
