...
1. Write the JSON schema describing your resource, `tf-aws-cloudfrontfunction.json`
2. Implement your resource handlers in `tf_aws_cloudfrontfunction/handlers.py`
