...
1. Write the JSON schema describing your resource, `terraform-aws-iotthingtype.json`
2. Implement your resource handlers in `terraform_aws_iotthingtype/handlers.py`
