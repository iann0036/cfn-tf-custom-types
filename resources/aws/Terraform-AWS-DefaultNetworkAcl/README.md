...
1. Write the JSON schema describing your resource, `terraform-aws-defaultnetworkacl.json`
2. Implement your resource handlers in `terraform_aws_defaultnetworkacl/handlers.py`
