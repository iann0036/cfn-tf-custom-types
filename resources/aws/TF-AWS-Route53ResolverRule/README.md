# TF::AWS::Route53ResolverRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53resolverrule.json`
2. Implement your resource handlers in `tf_aws_route53resolverrule/handlers.py`
