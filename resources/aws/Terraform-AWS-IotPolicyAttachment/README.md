...
1. Write the JSON schema describing your resource, `terraform-aws-iotpolicyattachment.json`
2. Implement your resource handlers in `terraform_aws_iotpolicyattachment/handlers.py`
