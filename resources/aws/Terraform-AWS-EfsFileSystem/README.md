...
1. Write the JSON schema describing your resource, `terraform-aws-efsfilesystem.json`
2. Implement your resource handlers in `terraform_aws_efsfilesystem/handlers.py`
