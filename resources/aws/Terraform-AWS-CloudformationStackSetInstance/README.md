...
1. Write the JSON schema describing your resource, `terraform-aws-cloudformationstacksetinstance.json`
2. Implement your resource handlers in `terraform_aws_cloudformationstacksetinstance/handlers.py`
