...
1. Write the JSON schema describing your resource, `terraform-aws-dxconnection.json`
2. Implement your resource handlers in `terraform_aws_dxconnection/handlers.py`
