...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayapikey.json`
2. Implement your resource handlers in `tf_aws_apigatewayapikey/handlers.py`
