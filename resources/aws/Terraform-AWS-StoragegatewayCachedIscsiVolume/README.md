...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewaycachediscsivolume.json`
2. Implement your resource handlers in `terraform_aws_storagegatewaycachediscsivolume/handlers.py`
