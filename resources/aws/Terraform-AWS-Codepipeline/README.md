...
1. Write the JSON schema describing your resource, `terraform-aws-codepipeline.json`
2. Implement your resource handlers in `terraform_aws_codepipeline/handlers.py`
