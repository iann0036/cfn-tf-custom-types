...
1. Write the JSON schema describing your resource, `terraform-aws-glaciervault.json`
2. Implement your resource handlers in `terraform_aws_glaciervault/handlers.py`
