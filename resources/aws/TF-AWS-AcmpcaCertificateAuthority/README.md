...
1. Write the JSON schema describing your resource, `tf-aws-acmpcacertificateauthority.json`
2. Implement your resource handlers in `tf_aws_acmpcacertificateauthority/handlers.py`
