...
1. Write the JSON schema describing your resource, `tf-aws-sagemakerimageversion.json`
2. Implement your resource handlers in `tf_aws_sagemakerimageversion/handlers.py`
