...
1. Write the JSON schema describing your resource, `tf-aws-backupvaultpolicy.json`
2. Implement your resource handlers in `tf_aws_backupvaultpolicy/handlers.py`
