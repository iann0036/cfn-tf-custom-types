...
1. Write the JSON schema describing your resource, `tf-aws-ecrlifecyclepolicy.json`
2. Implement your resource handlers in `tf_aws_ecrlifecyclepolicy/handlers.py`
