...
1. Write the JSON schema describing your resource, `terraform-aws-vpcpeeringconnection.json`
2. Implement your resource handlers in `terraform_aws_vpcpeeringconnection/handlers.py`
