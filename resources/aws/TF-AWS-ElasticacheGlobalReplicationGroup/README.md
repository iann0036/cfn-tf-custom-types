...
1. Write the JSON schema describing your resource, `tf-aws-elasticacheglobalreplicationgroup.json`
2. Implement your resource handlers in `tf_aws_elasticacheglobalreplicationgroup/handlers.py`
