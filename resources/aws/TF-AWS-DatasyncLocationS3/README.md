...
1. Write the JSON schema describing your resource, `tf-aws-datasynclocations3.json`
2. Implement your resource handlers in `tf_aws_datasynclocations3/handlers.py`
