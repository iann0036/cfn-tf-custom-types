...
1. Write the JSON schema describing your resource, `terraform-aws-appsyncdatasource.json`
2. Implement your resource handlers in `terraform_aws_appsyncdatasource/handlers.py`
