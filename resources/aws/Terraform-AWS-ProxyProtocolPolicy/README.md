...
1. Write the JSON schema describing your resource, `terraform-aws-proxyprotocolpolicy.json`
2. Implement your resource handlers in `terraform_aws_proxyprotocolpolicy/handlers.py`
