...
1. Write the JSON schema describing your resource, `terraform-aws-cloudfrontoriginaccessidentity.json`
2. Implement your resource handlers in `terraform_aws_cloudfrontoriginaccessidentity/handlers.py`
