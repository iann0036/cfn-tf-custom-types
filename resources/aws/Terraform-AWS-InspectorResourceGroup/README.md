# Terraform::AWS::InspectorResourceGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-inspectorresourcegroup.json`
2. Implement your resource handlers in `terraform_aws_inspectorresourcegroup/handlers.py`
