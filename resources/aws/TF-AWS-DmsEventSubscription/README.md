...
1. Write the JSON schema describing your resource, `tf-aws-dmseventsubscription.json`
2. Implement your resource handlers in `tf_aws_dmseventsubscription/handlers.py`
