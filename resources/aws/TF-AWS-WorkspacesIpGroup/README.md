# TF::AWS::WorkspacesIpGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-workspacesipgroup.json`
2. Implement your resource handlers in `tf_aws_workspacesipgroup/handlers.py`
