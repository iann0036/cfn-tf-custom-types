...
1. Write the JSON schema describing your resource, `tf-aws-amplifybackendenvironment.json`
2. Implement your resource handlers in `tf_aws_amplifybackendenvironment/handlers.py`
