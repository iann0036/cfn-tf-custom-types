...
1. Write the JSON schema describing your resource, `tf-aws-configremediationconfiguration.json`
2. Implement your resource handlers in `tf_aws_configremediationconfiguration/handlers.py`
