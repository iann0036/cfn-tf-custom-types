...
1. Write the JSON schema describing your resource, `terraform-aws-licensemanagerlicenseconfiguration.json`
2. Implement your resource handlers in `terraform_aws_licensemanagerlicenseconfiguration/handlers.py`
