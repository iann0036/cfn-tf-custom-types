...
1. Write the JSON schema describing your resource, `tf-aws-elasticachecluster.json`
2. Implement your resource handlers in `tf_aws_elasticachecluster/handlers.py`
