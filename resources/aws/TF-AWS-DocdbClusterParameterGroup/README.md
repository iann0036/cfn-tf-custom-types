# TF::AWS::DocdbClusterParameterGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-docdbclusterparametergroup.json`
2. Implement your resource handlers in `tf_aws_docdbclusterparametergroup/handlers.py`
