...
1. Write the JSON schema describing your resource, `tf-aws-sagemakerfeaturegroup.json`
2. Implement your resource handlers in `tf_aws_sagemakerfeaturegroup/handlers.py`
