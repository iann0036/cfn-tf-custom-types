...
1. Write the JSON schema describing your resource, `tf-aws-configconfigurationaggregator.json`
2. Implement your resource handlers in `tf_aws_configconfigurationaggregator/handlers.py`
