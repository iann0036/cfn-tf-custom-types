...
1. Write the JSON schema describing your resource, `terraform-aws-appautoscalingpolicy.json`
2. Implement your resource handlers in `terraform_aws_appautoscalingpolicy/handlers.py`
