...
1. Write the JSON schema describing your resource, `terraform-aws-worklinkwebsitecertificateauthorityassociation.json`
2. Implement your resource handlers in `terraform_aws_worklinkwebsitecertificateauthorityassociation/handlers.py`
