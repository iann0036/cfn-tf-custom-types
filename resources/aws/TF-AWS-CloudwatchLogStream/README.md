...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchlogstream.json`
2. Implement your resource handlers in `tf_aws_cloudwatchlogstream/handlers.py`
