...
1. Write the JSON schema describing your resource, `terraform-aws-sagemakerendpoint.json`
2. Implement your resource handlers in `terraform_aws_sagemakerendpoint/handlers.py`
