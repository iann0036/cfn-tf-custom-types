...
1. Write the JSON schema describing your resource, `tf-aws-codebuildsourcecredential.json`
2. Implement your resource handlers in `tf_aws_codebuildsourcecredential/handlers.py`
