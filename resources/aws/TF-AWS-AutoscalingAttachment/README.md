...
1. Write the JSON schema describing your resource, `tf-aws-autoscalingattachment.json`
2. Implement your resource handlers in `tf_aws_autoscalingattachment/handlers.py`
