# TF::AWS::ElasticBeanstalkApplication

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-elasticbeanstalkapplication.json`
2. Implement your resource handlers in `tf_aws_elasticbeanstalkapplication/handlers.py`
