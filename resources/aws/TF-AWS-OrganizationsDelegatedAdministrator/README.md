...
1. Write the JSON schema describing your resource, `tf-aws-organizationsdelegatedadministrator.json`
2. Implement your resource handlers in `tf_aws_organizationsdelegatedadministrator/handlers.py`
