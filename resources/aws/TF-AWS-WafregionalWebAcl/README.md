...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalwebacl.json`
2. Implement your resource handlers in `tf_aws_wafregionalwebacl/handlers.py`
