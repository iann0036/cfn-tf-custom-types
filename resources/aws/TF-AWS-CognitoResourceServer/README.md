...
1. Write the JSON schema describing your resource, `tf-aws-cognitoresourceserver.json`
2. Implement your resource handlers in `tf_aws_cognitoresourceserver/handlers.py`
