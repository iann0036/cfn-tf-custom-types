...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewaysmbfileshare.json`
2. Implement your resource handlers in `terraform_aws_storagegatewaysmbfileshare/handlers.py`
