...
1. Write the JSON schema describing your resource, `terraform-aws-organizationspolicy.json`
2. Implement your resource handlers in `terraform_aws_organizationspolicy/handlers.py`
