...
1. Write the JSON schema describing your resource, `terraform-aws-glaciervaultlock.json`
2. Implement your resource handlers in `terraform_aws_glaciervaultlock/handlers.py`
