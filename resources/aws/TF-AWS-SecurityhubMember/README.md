...
1. Write the JSON schema describing your resource, `tf-aws-securityhubmember.json`
2. Implement your resource handlers in `tf_aws_securityhubmember/handlers.py`
