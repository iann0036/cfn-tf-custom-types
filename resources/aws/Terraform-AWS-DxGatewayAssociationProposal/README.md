...
1. Write the JSON schema describing your resource, `terraform-aws-dxgatewayassociationproposal.json`
2. Implement your resource handlers in `terraform_aws_dxgatewayassociationproposal/handlers.py`
