...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchmetricalarm.json`
2. Implement your resource handlers in `tf_aws_cloudwatchmetricalarm/handlers.py`
