...
CloudFormation equivalent of aws_secretsmanager_secret
...
<pre>
{
    "Type" : "Terraform::AWS::SecretsmanagerSecret",
    "Properties" : {
        ...
        "<a href="#rotationenabled" title="RotationEnabled">RotationEnabled</a>" : <i>Boolean</i>,
