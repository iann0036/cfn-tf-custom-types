...
1. Write the JSON schema describing your resource, `terraform-aws-secretsmanagersecret.json`
2. Implement your resource handlers in `terraform_aws_secretsmanagersecret/handlers.py`
