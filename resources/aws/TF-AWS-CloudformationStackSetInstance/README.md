...
1. Write the JSON schema describing your resource, `tf-aws-cloudformationstacksetinstance.json`
2. Implement your resource handlers in `tf_aws_cloudformationstacksetinstance/handlers.py`
