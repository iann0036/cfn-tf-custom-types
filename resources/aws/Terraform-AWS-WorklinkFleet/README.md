...
1. Write the JSON schema describing your resource, `terraform-aws-worklinkfleet.json`
2. Implement your resource handlers in `terraform_aws_worklinkfleet/handlers.py`
