...
1. Write the JSON schema describing your resource, `tf-aws-elasticsearchdomain.json`
2. Implement your resource handlers in `tf_aws_elasticsearchdomain/handlers.py`
