...
1. Write the JSON schema describing your resource, `terraform-aws-globalacceleratorlistener.json`
2. Implement your resource handlers in `terraform_aws_globalacceleratorlistener/handlers.py`
