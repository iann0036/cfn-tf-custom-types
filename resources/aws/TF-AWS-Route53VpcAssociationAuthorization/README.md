...
1. Write the JSON schema describing your resource, `tf-aws-route53vpcassociationauthorization.json`
2. Implement your resource handlers in `tf_aws_route53vpcassociationauthorization/handlers.py`
