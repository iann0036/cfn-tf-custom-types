...
1. Write the JSON schema describing your resource, `tf-aws-servicediscoverypublicdnsnamespace.json`
2. Implement your resource handlers in `tf_aws_servicediscoverypublicdnsnamespace/handlers.py`
