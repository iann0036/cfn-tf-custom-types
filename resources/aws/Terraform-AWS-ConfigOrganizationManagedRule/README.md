...
1. Write the JSON schema describing your resource, `terraform-aws-configorganizationmanagedrule.json`
2. Implement your resource handlers in `terraform_aws_configorganizationmanagedrule/handlers.py`
