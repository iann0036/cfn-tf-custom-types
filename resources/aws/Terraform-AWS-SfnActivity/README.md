...
1. Write the JSON schema describing your resource, `terraform-aws-sfnactivity.json`
2. Implement your resource handlers in `terraform_aws_sfnactivity/handlers.py`
