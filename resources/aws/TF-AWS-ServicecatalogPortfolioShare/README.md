...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogportfolioshare.json`
2. Implement your resource handlers in `tf_aws_servicecatalogportfolioshare/handlers.py`
