...
1. Write the JSON schema describing your resource, `tf-aws-opsworksrailsapplayer.json`
2. Implement your resource handlers in `tf_aws_opsworksrailsapplayer/handlers.py`
