...
1. Write the JSON schema describing your resource, `tf-aws-sesidentitynotificationtopic.json`
2. Implement your resource handlers in `tf_aws_sesidentitynotificationtopic/handlers.py`
