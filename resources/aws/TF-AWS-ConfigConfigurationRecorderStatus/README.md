...
1. Write the JSON schema describing your resource, `tf-aws-configconfigurationrecorderstatus.json`
2. Implement your resource handlers in `tf_aws_configconfigurationrecorderstatus/handlers.py`
