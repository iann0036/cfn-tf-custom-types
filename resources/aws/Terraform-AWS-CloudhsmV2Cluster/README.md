...
1. Write the JSON schema describing your resource, `terraform-aws-cloudhsmv2cluster.json`
2. Implement your resource handlers in `terraform_aws_cloudhsmv2cluster/handlers.py`
