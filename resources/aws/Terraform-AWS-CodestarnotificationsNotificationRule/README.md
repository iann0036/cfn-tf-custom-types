...
1. Write the JSON schema describing your resource, `terraform-aws-codestarnotificationsnotificationrule.json`
2. Implement your resource handlers in `terraform_aws_codestarnotificationsnotificationrule/handlers.py`
