...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksganglialayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksganglialayer/handlers.py`
