...
1. Write the JSON schema describing your resource, `terraform-aws-snstopicsubscription.json`
2. Implement your resource handlers in `terraform_aws_snstopicsubscription/handlers.py`
