...
1. Write the JSON schema describing your resource, `terraform-aws-autoscalingnotification.json`
2. Implement your resource handlers in `terraform_aws_autoscalingnotification/handlers.py`
