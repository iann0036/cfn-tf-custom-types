...
1. Write the JSON schema describing your resource, `terraform-aws-loadbalancerpolicy.json`
2. Implement your resource handlers in `terraform_aws_loadbalancerpolicy/handlers.py`
