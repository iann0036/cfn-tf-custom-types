...
1. Write the JSON schema describing your resource, `terraform-aws-autoscalinglifecyclehook.json`
2. Implement your resource handlers in `terraform_aws_autoscalinglifecyclehook/handlers.py`
