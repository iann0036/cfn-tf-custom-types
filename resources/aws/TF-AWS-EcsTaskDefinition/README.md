...
1. Write the JSON schema describing your resource, `tf-aws-ecstaskdefinition.json`
2. Implement your resource handlers in `tf_aws_ecstaskdefinition/handlers.py`
