...
1. Write the JSON schema describing your resource, `tf-aws-rdsglobalcluster.json`
2. Implement your resource handlers in `tf_aws_rdsglobalcluster/handlers.py`
