...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalwebaclassociation.json`
2. Implement your resource handlers in `terraform_aws_wafregionalwebaclassociation/handlers.py`
