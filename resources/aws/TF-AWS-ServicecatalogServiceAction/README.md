...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogserviceaction.json`
2. Implement your resource handlers in `tf_aws_servicecatalogserviceaction/handlers.py`
