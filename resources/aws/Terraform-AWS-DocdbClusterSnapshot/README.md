...
1. Write the JSON schema describing your resource, `terraform-aws-docdbclustersnapshot.json`
2. Implement your resource handlers in `terraform_aws_docdbclustersnapshot/handlers.py`
