...
1. Write the JSON schema describing your resource, `tf-aws-appmeshvirtualnode.json`
2. Implement your resource handlers in `tf_aws_appmeshvirtualnode/handlers.py`
