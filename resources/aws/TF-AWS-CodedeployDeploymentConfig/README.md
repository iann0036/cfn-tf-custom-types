...
1. Write the JSON schema describing your resource, `tf-aws-codedeploydeploymentconfig.json`
2. Implement your resource handlers in `tf_aws_codedeploydeploymentconfig/handlers.py`
