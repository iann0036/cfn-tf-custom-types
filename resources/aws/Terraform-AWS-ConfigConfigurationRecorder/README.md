...
1. Write the JSON schema describing your resource, `terraform-aws-configconfigurationrecorder.json`
2. Implement your resource handlers in `terraform_aws_configconfigurationrecorder/handlers.py`
