...
1. Write the JSON schema describing your resource, `tf-aws-redshifteventsubscription.json`
2. Implement your resource handlers in `tf_aws_redshifteventsubscription/handlers.py`
