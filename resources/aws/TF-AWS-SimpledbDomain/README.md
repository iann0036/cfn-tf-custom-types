# TF::AWS::SimpledbDomain

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-simpledbdomain.json`
2. Implement your resource handlers in `tf_aws_simpledbdomain/handlers.py`
