...
1. Write the JSON schema describing your resource, `terraform-aws-mskconfiguration.json`
2. Implement your resource handlers in `terraform_aws_mskconfiguration/handlers.py`
