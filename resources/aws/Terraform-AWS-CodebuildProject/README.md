...
1. Write the JSON schema describing your resource, `terraform-aws-codebuildproject.json`
2. Implement your resource handlers in `terraform_aws_codebuildproject/handlers.py`
