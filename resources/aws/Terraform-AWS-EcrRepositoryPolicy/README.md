...
1. Write the JSON schema describing your resource, `terraform-aws-ecrrepositorypolicy.json`
2. Implement your resource handlers in `terraform_aws_ecrrepositorypolicy/handlers.py`
