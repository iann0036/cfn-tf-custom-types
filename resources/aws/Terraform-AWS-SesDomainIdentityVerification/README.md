...
1. Write the JSON schema describing your resource, `terraform-aws-sesdomainidentityverification.json`
2. Implement your resource handlers in `terraform_aws_sesdomainidentityverification/handlers.py`
