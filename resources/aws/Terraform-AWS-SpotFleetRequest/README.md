...
1. Write the JSON schema describing your resource, `terraform-aws-spotfleetrequest.json`
2. Implement your resource handlers in `terraform_aws_spotfleetrequest/handlers.py`
