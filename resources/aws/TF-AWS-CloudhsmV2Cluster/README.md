# TF::AWS::CloudhsmV2Cluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-cloudhsmv2cluster.json`
2. Implement your resource handlers in `tf_aws_cloudhsmv2cluster/handlers.py`
