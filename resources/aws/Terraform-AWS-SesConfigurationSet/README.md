...
1. Write the JSON schema describing your resource, `terraform-aws-sesconfigurationset.json`
2. Implement your resource handlers in `terraform_aws_sesconfigurationset/handlers.py`
