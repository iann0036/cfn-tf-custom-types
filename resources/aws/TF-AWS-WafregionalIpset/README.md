# TF::AWS::WafregionalIpset

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-wafregionalipset.json`
2. Implement your resource handlers in `tf_aws_wafregionalipset/handlers.py`
