...
1. Write the JSON schema describing your resource, `terraform-aws-athenanamedquery.json`
2. Implement your resource handlers in `terraform_aws_athenanamedquery/handlers.py`
