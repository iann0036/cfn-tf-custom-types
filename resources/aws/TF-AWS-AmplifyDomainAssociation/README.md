...
1. Write the JSON schema describing your resource, `tf-aws-amplifydomainassociation.json`
2. Implement your resource handlers in `tf_aws_amplifydomainassociation/handlers.py`
