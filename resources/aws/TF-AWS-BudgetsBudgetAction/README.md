...
1. Write the JSON schema describing your resource, `tf-aws-budgetsbudgetaction.json`
2. Implement your resource handlers in `tf_aws_budgetsbudgetaction/handlers.py`
