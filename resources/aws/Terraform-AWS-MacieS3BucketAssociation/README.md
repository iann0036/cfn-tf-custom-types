...
1. Write the JSON schema describing your resource, `terraform-aws-macies3bucketassociation.json`
2. Implement your resource handlers in `terraform_aws_macies3bucketassociation/handlers.py`
