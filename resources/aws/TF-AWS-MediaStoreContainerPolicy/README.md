# TF::AWS::MediaStoreContainerPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-mediastorecontainerpolicy.json`
2. Implement your resource handlers in `tf_aws_mediastorecontainerpolicy/handlers.py`
