...
1. Write the JSON schema describing your resource, `tf-aws-lambdapermission.json`
2. Implement your resource handlers in `tf_aws_lambdapermission/handlers.py`
