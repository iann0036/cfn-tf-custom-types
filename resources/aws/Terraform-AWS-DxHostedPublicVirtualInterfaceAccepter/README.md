...
1. Write the JSON schema describing your resource, `terraform-aws-dxhostedpublicvirtualinterfaceaccepter.json`
2. Implement your resource handlers in `terraform_aws_dxhostedpublicvirtualinterfaceaccepter/handlers.py`
