...
1. Write the JSON schema describing your resource, `terraform-aws-dxhostedtransitvirtualinterfaceaccepter.json`
2. Implement your resource handlers in `terraform_aws_dxhostedtransitvirtualinterfaceaccepter/handlers.py`
