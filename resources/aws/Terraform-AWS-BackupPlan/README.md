...
1. Write the JSON schema describing your resource, `terraform-aws-backupplan.json`
2. Implement your resource handlers in `terraform_aws_backupplan/handlers.py`
