...
1. Write the JSON schema describing your resource, `tf-aws-sesdomainidentity.json`
2. Implement your resource handlers in `tf_aws_sesdomainidentity/handlers.py`
