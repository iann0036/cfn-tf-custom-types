...
1. Write the JSON schema describing your resource, `terraform-aws-devicefarmproject.json`
2. Implement your resource handlers in `terraform_aws_devicefarmproject/handlers.py`
