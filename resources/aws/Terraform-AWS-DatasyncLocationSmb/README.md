...
1. Write the JSON schema describing your resource, `terraform-aws-datasynclocationsmb.json`
2. Implement your resource handlers in `terraform_aws_datasynclocationsmb/handlers.py`
