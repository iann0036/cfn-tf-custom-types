# TF::AWS::IamRolePolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-iamrolepolicy.json`
2. Implement your resource handlers in `tf_aws_iamrolepolicy/handlers.py`
