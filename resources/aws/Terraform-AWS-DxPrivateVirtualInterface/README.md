...
1. Write the JSON schema describing your resource, `terraform-aws-dxprivatevirtualinterface.json`
2. Implement your resource handlers in `terraform_aws_dxprivatevirtualinterface/handlers.py`
