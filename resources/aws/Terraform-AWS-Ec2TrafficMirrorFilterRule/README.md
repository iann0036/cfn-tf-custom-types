...
1. Write the JSON schema describing your resource, `terraform-aws-ec2trafficmirrorfilterrule.json`
2. Implement your resource handlers in `terraform_aws_ec2trafficmirrorfilterrule/handlers.py`
