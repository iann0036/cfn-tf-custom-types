...
1. Write the JSON schema describing your resource, `terraform-aws-iamuserpolicyattachment.json`
2. Implement your resource handlers in `terraform_aws_iamuserpolicyattachment/handlers.py`
