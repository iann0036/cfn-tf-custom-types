...
1. Write the JSON schema describing your resource, `terraform-aws-servicediscoverypublicdnsnamespace.json`
2. Implement your resource handlers in `terraform_aws_servicediscoverypublicdnsnamespace/handlers.py`
