...
1. Write the JSON schema describing your resource, `tf-aws-ramresourceshare.json`
2. Implement your resource handlers in `tf_aws_ramresourceshare/handlers.py`
