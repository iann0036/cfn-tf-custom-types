# TF::AWS::Route53ResolverRuleAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53resolverruleassociation.json`
2. Implement your resource handlers in `tf_aws_route53resolverruleassociation/handlers.py`
