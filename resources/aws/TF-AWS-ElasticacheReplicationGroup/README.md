...
1. Write the JSON schema describing your resource, `tf-aws-elasticachereplicationgroup.json`
2. Implement your resource handlers in `tf_aws_elasticachereplicationgroup/handlers.py`
