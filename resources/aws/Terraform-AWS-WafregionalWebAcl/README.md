...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalwebacl.json`
2. Implement your resource handlers in `terraform_aws_wafregionalwebacl/handlers.py`
