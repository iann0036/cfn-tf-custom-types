...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayintegrationresponse.json`
2. Implement your resource handlers in `tf_aws_apigatewayintegrationresponse/handlers.py`
