...
1. Write the JSON schema describing your resource, `terraform-aws-dxconnectionassociation.json`
2. Implement your resource handlers in `terraform_aws_dxconnectionassociation/handlers.py`
