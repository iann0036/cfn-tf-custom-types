...
1. Write the JSON schema describing your resource, `tf-aws-ecrreplicationconfiguration.json`
2. Implement your resource handlers in `tf_aws_ecrreplicationconfiguration/handlers.py`
