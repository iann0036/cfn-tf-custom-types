...
<pre>
{
    "Type" : "Terraform::AWS::EcrRepository",
    "Properties" : {
...
Properties:
    ...
    <a href="#imagescanningconfiguration" title="ImageScanningConfiguration">ImageScanningConfiguration</a>: <i>
      - <a href="imagescanningconfiguration.md">ImageScanningConfiguration</a></i>
    <a href="#timeouts" title="Timeouts">Timeouts</a>: <i><a href="timeouts.md">Timeouts</a></i>
</pre>
...
_Type_: List of <a href="imagescanningconfiguration.md">ImageScanningConfiguration</a>
...
Returns the <code>RepositoryUrl</code> value.
