...
1. Write the JSON schema describing your resource, `terraform-aws-ecrrepository.json`
2. Implement your resource handlers in `terraform_aws_ecrrepository/handlers.py`
