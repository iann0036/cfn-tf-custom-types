...
1. Write the JSON schema describing your resource, `terraform-aws-vpcendpoint.json`
2. Implement your resource handlers in `terraform_aws_vpcendpoint/handlers.py`
