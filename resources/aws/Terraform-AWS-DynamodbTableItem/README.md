...
1. Write the JSON schema describing your resource, `terraform-aws-dynamodbtableitem.json`
2. Implement your resource handlers in `terraform_aws_dynamodbtableitem/handlers.py`
