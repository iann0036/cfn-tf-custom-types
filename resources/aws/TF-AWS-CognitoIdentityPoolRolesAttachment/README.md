...
1. Write the JSON schema describing your resource, `tf-aws-cognitoidentitypoolrolesattachment.json`
2. Implement your resource handlers in `tf_aws_cognitoidentitypoolrolesattachment/handlers.py`
