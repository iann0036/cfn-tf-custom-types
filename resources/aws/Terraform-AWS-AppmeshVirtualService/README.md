...
1. Write the JSON schema describing your resource, `terraform-aws-appmeshvirtualservice.json`
2. Implement your resource handlers in `terraform_aws_appmeshvirtualservice/handlers.py`
