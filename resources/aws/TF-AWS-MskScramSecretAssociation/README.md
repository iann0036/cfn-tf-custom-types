...
1. Write the JSON schema describing your resource, `tf-aws-mskscramsecretassociation.json`
2. Implement your resource handlers in `tf_aws_mskscramsecretassociation/handlers.py`
