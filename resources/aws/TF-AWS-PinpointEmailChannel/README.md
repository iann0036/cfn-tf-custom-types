...
1. Write the JSON schema describing your resource, `tf-aws-pinpointemailchannel.json`
2. Implement your resource handlers in `tf_aws_pinpointemailchannel/handlers.py`
