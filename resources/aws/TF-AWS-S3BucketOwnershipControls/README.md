# TF::AWS::S3BucketOwnershipControls

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-s3bucketownershipcontrols.json`
2. Implement your resource handlers in `tf_aws_s3bucketownershipcontrols/handlers.py`
