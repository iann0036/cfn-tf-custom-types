...
1. Write the JSON schema describing your resource, `tf-aws-iotpolicyattachment.json`
2. Implement your resource handlers in `tf_aws_iotpolicyattachment/handlers.py`
