...
1. Write the JSON schema describing your resource, `terraform-aws-accessanalyzeranalyzer.json`
2. Implement your resource handlers in `terraform_aws_accessanalyzeranalyzer/handlers.py`
