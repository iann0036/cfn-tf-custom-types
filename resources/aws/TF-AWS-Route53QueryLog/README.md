# TF::AWS::Route53QueryLog

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53querylog.json`
2. Implement your resource handlers in `tf_aws_route53querylog/handlers.py`
