...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalsqlinjectionmatchset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalsqlinjectionmatchset/handlers.py`
