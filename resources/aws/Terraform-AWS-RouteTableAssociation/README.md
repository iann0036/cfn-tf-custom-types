...
1. Write the JSON schema describing your resource, `terraform-aws-routetableassociation.json`
2. Implement your resource handlers in `terraform_aws_routetableassociation/handlers.py`
