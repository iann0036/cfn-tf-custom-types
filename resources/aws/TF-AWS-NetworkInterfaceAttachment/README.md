...
1. Write the JSON schema describing your resource, `tf-aws-networkinterfaceattachment.json`
2. Implement your resource handlers in `tf_aws_networkinterfaceattachment/handlers.py`
