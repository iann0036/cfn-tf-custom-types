...
1. Write the JSON schema describing your resource, `tf-aws-docdbclusterinstance.json`
2. Implement your resource handlers in `tf_aws_docdbclusterinstance/handlers.py`
