...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchdashboard.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchdashboard/handlers.py`
