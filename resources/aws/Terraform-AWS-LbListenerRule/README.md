...
1. Write the JSON schema describing your resource, `terraform-aws-lblistenerrule.json`
2. Implement your resource handlers in `terraform_aws_lblistenerrule/handlers.py`
