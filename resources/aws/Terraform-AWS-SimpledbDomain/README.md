...
1. Write the JSON schema describing your resource, `terraform-aws-simpledbdomain.json`
2. Implement your resource handlers in `terraform_aws_simpledbdomain/handlers.py`
