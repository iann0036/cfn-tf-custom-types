...
1. Write the JSON schema describing your resource, `tf-aws-securityhubaccount.json`
2. Implement your resource handlers in `tf_aws_securityhubaccount/handlers.py`
