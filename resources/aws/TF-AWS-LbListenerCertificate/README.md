...
1. Write the JSON schema describing your resource, `tf-aws-lblistenercertificate.json`
2. Implement your resource handlers in `tf_aws_lblistenercertificate/handlers.py`
