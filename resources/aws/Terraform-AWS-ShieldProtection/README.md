...
1. Write the JSON schema describing your resource, `terraform-aws-shieldprotection.json`
2. Implement your resource handlers in `terraform_aws_shieldprotection/handlers.py`
