...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogproduct.json`
2. Implement your resource handlers in `tf_aws_servicecatalogproduct/handlers.py`
