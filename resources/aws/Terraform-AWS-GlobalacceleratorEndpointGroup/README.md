...
1. Write the JSON schema describing your resource, `terraform-aws-globalacceleratorendpointgroup.json`
2. Implement your resource handlers in `terraform_aws_globalacceleratorendpointgroup/handlers.py`
