...
1. Write the JSON schema describing your resource, `terraform-aws-launchconfiguration.json`
2. Implement your resource handlers in `terraform_aws_launchconfiguration/handlers.py`
