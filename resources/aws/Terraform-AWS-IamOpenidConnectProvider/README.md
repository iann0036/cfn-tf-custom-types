...
1. Write the JSON schema describing your resource, `terraform-aws-iamopenidconnectprovider.json`
2. Implement your resource handlers in `terraform_aws_iamopenidconnectprovider/handlers.py`
