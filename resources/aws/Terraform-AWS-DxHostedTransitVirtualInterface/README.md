# Terraform::AWS::DxHostedTransitVirtualInterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-dxhostedtransitvirtualinterface.json`
2. Implement your resource handlers in `terraform_aws_dxhostedtransitvirtualinterface/handlers.py`
