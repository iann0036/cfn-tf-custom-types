...
1. Write the JSON schema describing your resource, `tf-aws-dbinstanceroleassociation.json`
2. Implement your resource handlers in `tf_aws_dbinstanceroleassociation/handlers.py`
