...
1. Write the JSON schema describing your resource, `terraform-aws-sagemakermodel.json`
2. Implement your resource handlers in `terraform_aws_sagemakermodel/handlers.py`
