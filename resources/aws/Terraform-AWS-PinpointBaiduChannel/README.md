...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointbaiduchannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointbaiduchannel/handlers.py`
