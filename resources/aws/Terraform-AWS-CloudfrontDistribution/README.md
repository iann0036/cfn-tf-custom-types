...
1. Write the JSON schema describing your resource, `terraform-aws-cloudfrontdistribution.json`
2. Implement your resource handlers in `terraform_aws_cloudfrontdistribution/handlers.py`
