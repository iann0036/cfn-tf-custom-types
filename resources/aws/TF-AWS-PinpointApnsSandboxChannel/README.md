# TF::AWS::PinpointApnsSandboxChannel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-pinpointapnssandboxchannel.json`
2. Implement your resource handlers in `tf_aws_pinpointapnssandboxchannel/handlers.py`
