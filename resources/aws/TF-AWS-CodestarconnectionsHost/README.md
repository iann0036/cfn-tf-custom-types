...
1. Write the JSON schema describing your resource, `tf-aws-codestarconnectionshost.json`
2. Implement your resource handlers in `tf_aws_codestarconnectionshost/handlers.py`
