...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksnodejsapplayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksnodejsapplayer/handlers.py`
