...
1. Write the JSON schema describing your resource, `tf-aws-secretsmanagersecretpolicy.json`
2. Implement your resource handlers in `tf_aws_secretsmanagersecretpolicy/handlers.py`
