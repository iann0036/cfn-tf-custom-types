...
1. Write the JSON schema describing your resource, `terraform-aws-elasticbeanstalkapplication.json`
2. Implement your resource handlers in `terraform_aws_elasticbeanstalkapplication/handlers.py`
