...
1. Write the JSON schema describing your resource, `terraform-aws-iamuserloginprofile.json`
2. Implement your resource handlers in `terraform_aws_iamuserloginprofile/handlers.py`
