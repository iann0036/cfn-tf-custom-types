...
1. Write the JSON schema describing your resource, `tf-aws-defaultroutetable.json`
2. Implement your resource handlers in `tf_aws_defaultroutetable/handlers.py`
