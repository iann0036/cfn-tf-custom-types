...
1. Write the JSON schema describing your resource, `terraform-aws-mediaconvertqueue.json`
2. Implement your resource handlers in `terraform_aws_mediaconvertqueue/handlers.py`
