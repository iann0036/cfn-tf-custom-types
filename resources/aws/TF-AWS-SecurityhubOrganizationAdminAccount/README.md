...
1. Write the JSON schema describing your resource, `tf-aws-securityhuborganizationadminaccount.json`
2. Implement your resource handlers in `tf_aws_securityhuborganizationadminaccount/handlers.py`
