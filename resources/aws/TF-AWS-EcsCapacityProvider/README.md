# TF::AWS::EcsCapacityProvider

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ecscapacityprovider.json`
2. Implement your resource handlers in `tf_aws_ecscapacityprovider/handlers.py`
