...
1. Write the JSON schema describing your resource, `tf-aws-elasticachesecuritygroup.json`
2. Implement your resource handlers in `tf_aws_elasticachesecuritygroup/handlers.py`
