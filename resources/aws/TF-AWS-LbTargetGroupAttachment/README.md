...
1. Write the JSON schema describing your resource, `tf-aws-lbtargetgroupattachment.json`
2. Implement your resource handlers in `tf_aws_lbtargetgroupattachment/handlers.py`
