...
1. Write the JSON schema describing your resource, `terraform-aws-vpcpeeringconnectionoptions.json`
2. Implement your resource handlers in `terraform_aws_vpcpeeringconnectionoptions/handlers.py`
