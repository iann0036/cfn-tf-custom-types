...
1. Write the JSON schema describing your resource, `tf-aws-cognitousergroup.json`
2. Implement your resource handlers in `tf_aws_cognitousergroup/handlers.py`
