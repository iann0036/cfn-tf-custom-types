...
1. Write the JSON schema describing your resource, `tf-aws-syntheticscanary.json`
2. Implement your resource handlers in `tf_aws_syntheticscanary/handlers.py`
