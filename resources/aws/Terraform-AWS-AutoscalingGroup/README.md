...
1. Write the JSON schema describing your resource, `terraform-aws-autoscalinggroup.json`
2. Implement your resource handlers in `terraform_aws_autoscalinggroup/handlers.py`
