...
1. Write the JSON schema describing your resource, `terraform-aws-eipassociation.json`
2. Implement your resource handlers in `terraform_aws_eipassociation/handlers.py`
