...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayclientcertificate.json`
2. Implement your resource handlers in `terraform_aws_apigatewayclientcertificate/handlers.py`
