...
class ResourceModel(BaseModel):
    ...
    Uri: Optional[str]
    Ec2Config: Optional[Sequence["_Ec2ConfigDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Ec2Config=deserialize_list(json_data.get("Ec2Config"), Ec2ConfigDefinition),
        )
...
@dataclass
class Ec2ConfigDefinition(BaseModel):
    SecurityGroupArns: Optional[Sequence[str]]
    SubnetArn: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_Ec2ConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_Ec2ConfigDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_Ec2ConfigDefinition = Ec2ConfigDefinition
