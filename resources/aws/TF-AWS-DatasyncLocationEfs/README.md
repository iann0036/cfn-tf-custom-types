...
1. Write the JSON schema describing your resource, `tf-aws-datasynclocationefs.json`
2. Implement your resource handlers in `tf_aws_datasynclocationefs/handlers.py`
