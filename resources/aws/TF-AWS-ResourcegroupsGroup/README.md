# TF::AWS::ResourcegroupsGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-resourcegroupsgroup.json`
2. Implement your resource handlers in `tf_aws_resourcegroupsgroup/handlers.py`
