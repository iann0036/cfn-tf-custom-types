...
1. Write the JSON schema describing your resource, `terraform-aws-iamusersshkey.json`
2. Implement your resource handlers in `terraform_aws_iamusersshkey/handlers.py`
