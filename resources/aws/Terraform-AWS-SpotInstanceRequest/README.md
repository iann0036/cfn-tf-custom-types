...
1. Write the JSON schema describing your resource, `terraform-aws-spotinstancerequest.json`
2. Implement your resource handlers in `terraform_aws_spotinstancerequest/handlers.py`
