...
1. Write the JSON schema describing your resource, `terraform-aws-eksfargateprofile.json`
2. Implement your resource handlers in `terraform_aws_eksfargateprofile/handlers.py`
