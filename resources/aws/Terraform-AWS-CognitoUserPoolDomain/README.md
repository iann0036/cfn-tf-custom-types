...
1. Write the JSON schema describing your resource, `terraform-aws-cognitouserpooldomain.json`
2. Implement your resource handlers in `terraform_aws_cognitouserpooldomain/handlers.py`
