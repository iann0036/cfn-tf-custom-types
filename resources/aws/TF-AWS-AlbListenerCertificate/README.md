# TF::AWS::AlbListenerCertificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-alblistenercertificate.json`
2. Implement your resource handlers in `tf_aws_alblistenercertificate/handlers.py`
