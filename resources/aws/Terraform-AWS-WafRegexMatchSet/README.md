...
1. Write the JSON schema describing your resource, `terraform-aws-wafregexmatchset.json`
2. Implement your resource handlers in `terraform_aws_wafregexmatchset/handlers.py`
