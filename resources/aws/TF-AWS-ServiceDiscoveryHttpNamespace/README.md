...
1. Write the JSON schema describing your resource, `tf-aws-servicediscoveryhttpnamespace.json`
2. Implement your resource handlers in `tf_aws_servicediscoveryhttpnamespace/handlers.py`
