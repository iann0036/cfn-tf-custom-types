...
1. Write the JSON schema describing your resource, `tf-aws-fsxwindowsfilesystem.json`
2. Implement your resource handlers in `tf_aws_fsxwindowsfilesystem/handlers.py`
