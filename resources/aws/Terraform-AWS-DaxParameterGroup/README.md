...
1. Write the JSON schema describing your resource, `terraform-aws-daxparametergroup.json`
2. Implement your resource handlers in `terraform_aws_daxparametergroup/handlers.py`
