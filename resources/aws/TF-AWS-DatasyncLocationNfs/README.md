...
1. Write the JSON schema describing your resource, `tf-aws-datasynclocationnfs.json`
2. Implement your resource handlers in `tf_aws_datasynclocationnfs/handlers.py`
