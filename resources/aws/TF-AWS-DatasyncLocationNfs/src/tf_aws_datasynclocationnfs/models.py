...
class ResourceModel(BaseModel):
    ...
    OnPremConfig: Optional[Sequence["_OnPremConfigDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            OnPremConfig=deserialize_list(json_data.get("OnPremConfig"), OnPremConfigDefinition),
        )
...
@dataclass
class OnPremConfigDefinition(BaseModel):
    AgentArns: Optional[Sequence[str]]

    @classmethod
    def _deserialize(
        cls: Type["_OnPremConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_OnPremConfigDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_OnPremConfigDefinition = OnPremConfigDefinition
