...
1. Write the JSON schema describing your resource, `terraform-aws-appcookiestickinesspolicy.json`
2. Implement your resource handlers in `terraform_aws_appcookiestickinesspolicy/handlers.py`
