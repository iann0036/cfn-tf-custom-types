...
1. Write the JSON schema describing your resource, `tf-aws-iampolicyattachment.json`
2. Implement your resource handlers in `tf_aws_iampolicyattachment/handlers.py`
