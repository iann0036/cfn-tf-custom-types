...
1. Write the JSON schema describing your resource, `tf-aws-kinesisanalyticsv2applicationsnapshot.json`
2. Implement your resource handlers in `tf_aws_kinesisanalyticsv2applicationsnapshot/handlers.py`
