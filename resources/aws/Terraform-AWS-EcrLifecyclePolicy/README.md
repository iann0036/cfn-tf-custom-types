...
1. Write the JSON schema describing your resource, `terraform-aws-ecrlifecyclepolicy.json`
2. Implement your resource handlers in `terraform_aws_ecrlifecyclepolicy/handlers.py`
