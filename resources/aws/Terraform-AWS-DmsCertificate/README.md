...
1. Write the JSON schema describing your resource, `terraform-aws-dmscertificate.json`
2. Implement your resource handlers in `terraform_aws_dmscertificate/handlers.py`
