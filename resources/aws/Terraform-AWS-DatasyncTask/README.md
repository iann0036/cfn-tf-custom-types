...
1. Write the JSON schema describing your resource, `terraform-aws-datasynctask.json`
2. Implement your resource handlers in `terraform_aws_datasynctask/handlers.py`
