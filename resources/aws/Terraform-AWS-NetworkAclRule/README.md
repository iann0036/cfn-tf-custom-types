...
1. Write the JSON schema describing your resource, `terraform-aws-networkaclrule.json`
2. Implement your resource handlers in `terraform_aws_networkaclrule/handlers.py`
