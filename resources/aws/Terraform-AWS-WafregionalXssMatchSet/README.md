...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalxssmatchset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalxssmatchset/handlers.py`
