...
1. Write the JSON schema describing your resource, `tf-aws-imagebuilderdistributionconfiguration.json`
2. Implement your resource handlers in `tf_aws_imagebuilderdistributionconfiguration/handlers.py`
