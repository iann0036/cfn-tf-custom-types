...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaydomainname.json`
2. Implement your resource handlers in `terraform_aws_apigatewaydomainname/handlers.py`
