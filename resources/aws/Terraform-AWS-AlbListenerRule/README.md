...
1. Write the JSON schema describing your resource, `terraform-aws-alblistenerrule.json`
2. Implement your resource handlers in `terraform_aws_alblistenerrule/handlers.py`
