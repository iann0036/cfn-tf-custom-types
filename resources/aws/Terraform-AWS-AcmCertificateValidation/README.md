...
1. Write the JSON schema describing your resource, `terraform-aws-acmcertificatevalidation.json`
2. Implement your resource handlers in `terraform_aws_acmcertificatevalidation/handlers.py`
