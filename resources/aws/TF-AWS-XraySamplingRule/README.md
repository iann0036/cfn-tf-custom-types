...
1. Write the JSON schema describing your resource, `tf-aws-xraysamplingrule.json`
2. Implement your resource handlers in `tf_aws_xraysamplingrule/handlers.py`
