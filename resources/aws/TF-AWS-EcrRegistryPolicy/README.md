# TF::AWS::EcrRegistryPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ecrregistrypolicy.json`
2. Implement your resource handlers in `tf_aws_ecrregistrypolicy/handlers.py`
