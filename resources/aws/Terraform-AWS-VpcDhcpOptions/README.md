...
1. Write the JSON schema describing your resource, `terraform-aws-vpcdhcpoptions.json`
2. Implement your resource handlers in `terraform_aws_vpcdhcpoptions/handlers.py`
