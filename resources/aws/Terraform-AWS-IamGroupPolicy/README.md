...
1. Write the JSON schema describing your resource, `terraform-aws-iamgrouppolicy.json`
2. Implement your resource handlers in `terraform_aws_iamgrouppolicy/handlers.py`
