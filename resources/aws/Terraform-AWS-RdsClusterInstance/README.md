...
1. Write the JSON schema describing your resource, `terraform-aws-rdsclusterinstance.json`
2. Implement your resource handlers in `terraform_aws_rdsclusterinstance/handlers.py`
