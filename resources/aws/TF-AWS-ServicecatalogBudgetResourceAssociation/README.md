...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogbudgetresourceassociation.json`
2. Implement your resource handlers in `tf_aws_servicecatalogbudgetresourceassociation/handlers.py`
