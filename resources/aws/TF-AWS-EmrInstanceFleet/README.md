...
1. Write the JSON schema describing your resource, `tf-aws-emrinstancefleet.json`
2. Implement your resource handlers in `tf_aws_emrinstancefleet/handlers.py`
