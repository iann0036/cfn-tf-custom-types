...
1. Write the JSON schema describing your resource, `terraform-aws-ebsencryptionbydefault.json`
2. Implement your resource handlers in `terraform_aws_ebsencryptionbydefault/handlers.py`
