...
1. Write the JSON schema describing your resource, `terraform-aws-organizationsorganizationalunit.json`
2. Implement your resource handlers in `terraform_aws_organizationsorganizationalunit/handlers.py`
