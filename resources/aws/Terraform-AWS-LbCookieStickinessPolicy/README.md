...
1. Write the JSON schema describing your resource, `terraform-aws-lbcookiestickinesspolicy.json`
2. Implement your resource handlers in `terraform_aws_lbcookiestickinesspolicy/handlers.py`
