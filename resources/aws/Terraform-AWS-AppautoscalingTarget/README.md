...
1. Write the JSON schema describing your resource, `terraform-aws-appautoscalingtarget.json`
2. Implement your resource handlers in `terraform_aws_appautoscalingtarget/handlers.py`
