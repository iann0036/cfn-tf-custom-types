...
1. Write the JSON schema describing your resource, `tf-aws-guarddutypublishingdestination.json`
2. Implement your resource handlers in `tf_aws_guarddutypublishingdestination/handlers.py`
