...
1. Write the JSON schema describing your resource, `terraform-aws-dmsendpoint.json`
2. Implement your resource handlers in `terraform_aws_dmsendpoint/handlers.py`
