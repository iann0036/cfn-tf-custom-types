# TF::AWS::Route53ResolverQueryLogConfig

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53resolverquerylogconfig.json`
2. Implement your resource handlers in `tf_aws_route53resolverquerylogconfig/handlers.py`
