...
1. Write the JSON schema describing your resource, `terraform-aws-docdbcluster.json`
2. Implement your resource handlers in `terraform_aws_docdbcluster/handlers.py`
