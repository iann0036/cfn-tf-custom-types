...
1. Write the JSON schema describing your resource, `terraform-aws-directoryservicedirectory.json`
2. Implement your resource handlers in `terraform_aws_directoryservicedirectory/handlers.py`
