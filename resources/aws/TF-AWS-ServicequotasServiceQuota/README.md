...
1. Write the JSON schema describing your resource, `tf-aws-servicequotasservicequota.json`
2. Implement your resource handlers in `tf_aws_servicequotasservicequota/handlers.py`
