# TF::AWS::SpotDatafeedSubscription

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-spotdatafeedsubscription.json`
2. Implement your resource handlers in `tf_aws_spotdatafeedsubscription/handlers.py`
