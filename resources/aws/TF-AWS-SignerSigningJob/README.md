...
1. Write the JSON schema describing your resource, `tf-aws-signersigningjob.json`
2. Implement your resource handlers in `tf_aws_signersigningjob/handlers.py`
