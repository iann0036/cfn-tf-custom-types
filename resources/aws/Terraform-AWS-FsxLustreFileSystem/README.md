...
1. Write the JSON schema describing your resource, `terraform-aws-fsxlustrefilesystem.json`
2. Implement your resource handlers in `terraform_aws_fsxlustrefilesystem/handlers.py`
