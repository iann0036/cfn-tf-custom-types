...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksapplication.json`
2. Implement your resource handlers in `terraform_aws_opsworksapplication/handlers.py`
