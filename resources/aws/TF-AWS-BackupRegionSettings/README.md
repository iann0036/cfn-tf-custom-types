...
1. Write the JSON schema describing your resource, `tf-aws-backupregionsettings.json`
2. Implement your resource handlers in `tf_aws_backupregionsettings/handlers.py`
