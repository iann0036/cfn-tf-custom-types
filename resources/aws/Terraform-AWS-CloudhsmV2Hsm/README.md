...
1. Write the JSON schema describing your resource, `terraform-aws-cloudhsmv2hsm.json`
2. Implement your resource handlers in `terraform_aws_cloudhsmv2hsm/handlers.py`
