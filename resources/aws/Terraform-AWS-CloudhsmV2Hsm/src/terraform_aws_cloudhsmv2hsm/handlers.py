...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_cloudhsm_v2_hsm'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_cloudhsm_v2_hsm'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
