...
1. Write the JSON schema describing your resource, `tf-aws-autoscalingpolicy.json`
2. Implement your resource handlers in `tf_aws_autoscalingpolicy/handlers.py`
