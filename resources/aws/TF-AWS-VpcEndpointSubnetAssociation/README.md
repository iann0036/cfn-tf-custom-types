...
1. Write the JSON schema describing your resource, `tf-aws-vpcendpointsubnetassociation.json`
2. Implement your resource handlers in `tf_aws_vpcendpointsubnetassociation/handlers.py`
