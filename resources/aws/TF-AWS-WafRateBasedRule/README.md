...
1. Write the JSON schema describing your resource, `tf-aws-wafratebasedrule.json`
2. Implement your resource handlers in `tf_aws_wafratebasedrule/handlers.py`
