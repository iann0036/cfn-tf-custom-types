...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#predicates" title="Predicates">Predicates</a>" : <i>[ <a href="predicatesdefinition.md">PredicatesDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#predicates" title="Predicates">Predicates</a>: <i>
      - <a href="predicatesdefinition.md">PredicatesDefinition</a></i>
</pre>
...
_Type_: List of <a href="predicatesdefinition.md">PredicatesDefinition</a>
