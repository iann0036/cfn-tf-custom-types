...
1. Write the JSON schema describing your resource, `terraform-aws-elasticachereplicationgroup.json`
2. Implement your resource handlers in `terraform_aws_elasticachereplicationgroup/handlers.py`
