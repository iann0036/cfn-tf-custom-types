# TF::AWS::StoragegatewayCache

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-storagegatewaycache.json`
2. Implement your resource handlers in `tf_aws_storagegatewaycache/handlers.py`
