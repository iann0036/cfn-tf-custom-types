...
1. Write the JSON schema describing your resource, `terraform-aws-organizationspolicyattachment.json`
2. Implement your resource handlers in `terraform_aws_organizationspolicyattachment/handlers.py`
