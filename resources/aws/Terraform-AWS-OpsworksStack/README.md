...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksstack.json`
2. Implement your resource handlers in `terraform_aws_opsworksstack/handlers.py`
