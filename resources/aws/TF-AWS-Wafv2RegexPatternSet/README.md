# TF::AWS::Wafv2RegexPatternSet

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-wafv2regexpatternset.json`
2. Implement your resource handlers in `tf_aws_wafv2regexpatternset/handlers.py`
