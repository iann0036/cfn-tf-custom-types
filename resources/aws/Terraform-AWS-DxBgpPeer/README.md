...
1. Write the JSON schema describing your resource, `terraform-aws-dxbgppeer.json`
2. Implement your resource handlers in `terraform_aws_dxbgppeer/handlers.py`
