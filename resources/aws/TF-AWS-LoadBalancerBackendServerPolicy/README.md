...
1. Write the JSON schema describing your resource, `tf-aws-loadbalancerbackendserverpolicy.json`
2. Implement your resource handlers in `tf_aws_loadbalancerbackendserverpolicy/handlers.py`
