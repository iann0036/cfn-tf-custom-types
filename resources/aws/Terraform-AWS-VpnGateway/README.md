...
1. Write the JSON schema describing your resource, `terraform-aws-vpngateway.json`
2. Implement your resource handlers in `terraform_aws_vpngateway/handlers.py`
