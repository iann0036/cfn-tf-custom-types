...
1. Write the JSON schema describing your resource, `tf-aws-cognitouserpoolclient.json`
2. Implement your resource handlers in `tf_aws_cognitouserpoolclient/handlers.py`
