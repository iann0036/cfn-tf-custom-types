...
1. Write the JSON schema describing your resource, `terraform-aws-iamaccesskey.json`
2. Implement your resource handlers in `terraform_aws_iamaccesskey/handlers.py`
