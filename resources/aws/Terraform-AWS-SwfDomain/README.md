...
1. Write the JSON schema describing your resource, `terraform-aws-swfdomain.json`
2. Implement your resource handlers in `terraform_aws_swfdomain/handlers.py`
