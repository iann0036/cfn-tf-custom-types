...
1. Write the JSON schema describing your resource, `terraform-aws-lbtargetgroupattachment.json`
2. Implement your resource handlers in `terraform_aws_lbtargetgroupattachment/handlers.py`
