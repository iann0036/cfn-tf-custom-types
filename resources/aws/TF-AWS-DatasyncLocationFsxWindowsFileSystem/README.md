...
1. Write the JSON schema describing your resource, `tf-aws-datasynclocationfsxwindowsfilesystem.json`
2. Implement your resource handlers in `tf_aws_datasynclocationfsxwindowsfilesystem/handlers.py`
