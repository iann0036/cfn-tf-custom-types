...
1. Write the JSON schema describing your resource, `tf-aws-signersigningprofilepermission.json`
2. Implement your resource handlers in `tf_aws_signersigningprofilepermission/handlers.py`
