...
1. Write the JSON schema describing your resource, `tf-aws-lightsailinstancepublicports.json`
2. Implement your resource handlers in `tf_aws_lightsailinstancepublicports/handlers.py`
