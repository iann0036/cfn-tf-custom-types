...
1. Write the JSON schema describing your resource, `terraform-aws-vpnconnectionroute.json`
2. Implement your resource handlers in `terraform_aws_vpnconnectionroute/handlers.py`
