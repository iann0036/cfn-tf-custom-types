...
1. Write the JSON schema describing your resource, `tf-aws-batchcomputeenvironment.json`
2. Implement your resource handlers in `tf_aws_batchcomputeenvironment/handlers.py`
