...
1. Write the JSON schema describing your resource, `terraform-aws-sesreceiptfilter.json`
2. Implement your resource handlers in `terraform_aws_sesreceiptfilter/handlers.py`
