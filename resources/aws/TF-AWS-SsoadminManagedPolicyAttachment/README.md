...
1. Write the JSON schema describing your resource, `tf-aws-ssoadminmanagedpolicyattachment.json`
2. Implement your resource handlers in `tf_aws_ssoadminmanagedpolicyattachment/handlers.py`
