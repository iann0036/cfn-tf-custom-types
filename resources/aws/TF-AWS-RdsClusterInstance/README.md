...
1. Write the JSON schema describing your resource, `tf-aws-rdsclusterinstance.json`
2. Implement your resource handlers in `tf_aws_rdsclusterinstance/handlers.py`
