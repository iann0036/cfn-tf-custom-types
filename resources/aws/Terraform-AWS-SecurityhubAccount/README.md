...
1. Write the JSON schema describing your resource, `terraform-aws-securityhubaccount.json`
2. Implement your resource handlers in `terraform_aws_securityhubaccount/handlers.py`
