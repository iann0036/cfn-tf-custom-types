...
1. Write the JSON schema describing your resource, `terraform-aws-codedeploydeploymentgroup.json`
2. Implement your resource handlers in `terraform_aws_codedeploydeploymentgroup/handlers.py`
