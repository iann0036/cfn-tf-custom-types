...
1. Write the JSON schema describing your resource, `terraform-aws-rdsclusterparametergroup.json`
2. Implement your resource handlers in `terraform_aws_rdsclusterparametergroup/handlers.py`
