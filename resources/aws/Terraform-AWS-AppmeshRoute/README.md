...
1. Write the JSON schema describing your resource, `terraform-aws-appmeshroute.json`
2. Implement your resource handlers in `terraform_aws_appmeshroute/handlers.py`
