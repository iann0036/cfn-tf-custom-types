...
1. Write the JSON schema describing your resource, `terraform-aws-lblistener.json`
2. Implement your resource handlers in `terraform_aws_lblistener/handlers.py`
