...
1. Write the JSON schema describing your resource, `tf-aws-directoryserviceconditionalforwarder.json`
2. Implement your resource handlers in `tf_aws_directoryserviceconditionalforwarder/handlers.py`
