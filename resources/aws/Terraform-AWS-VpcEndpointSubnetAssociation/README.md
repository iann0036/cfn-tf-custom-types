...
1. Write the JSON schema describing your resource, `terraform-aws-vpcendpointsubnetassociation.json`
2. Implement your resource handlers in `terraform_aws_vpcendpointsubnetassociation/handlers.py`
