...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogconstraint.json`
2. Implement your resource handlers in `tf_aws_servicecatalogconstraint/handlers.py`
