...
1. Write the JSON schema describing your resource, `tf-aws-curreportdefinition.json`
2. Implement your resource handlers in `tf_aws_curreportdefinition/handlers.py`
