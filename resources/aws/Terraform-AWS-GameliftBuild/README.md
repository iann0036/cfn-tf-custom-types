...
1. Write the JSON schema describing your resource, `terraform-aws-gameliftbuild.json`
2. Implement your resource handlers in `terraform_aws_gameliftbuild/handlers.py`
