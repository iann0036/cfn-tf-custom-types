...
1. Write the JSON schema describing your resource, `tf-aws-apigatewaydocumentationversion.json`
2. Implement your resource handlers in `tf_aws_apigatewaydocumentationversion/handlers.py`
