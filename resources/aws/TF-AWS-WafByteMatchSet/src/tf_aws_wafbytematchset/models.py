...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    Name: Optional[str]
    ByteMatchTuples: Optional[Sequence["_ByteMatchTuplesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ByteMatchTuples=deserialize_list(json_data.get("ByteMatchTuples"), ByteMatchTuplesDefinition),
        )
...
@dataclass
class ByteMatchTuplesDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_ByteMatchTuplesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ByteMatchTuplesDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_ByteMatchTuplesDefinition = ByteMatchTuplesDefinition
