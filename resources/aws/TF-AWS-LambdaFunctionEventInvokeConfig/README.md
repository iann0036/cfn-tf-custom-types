...
1. Write the JSON schema describing your resource, `tf-aws-lambdafunctioneventinvokeconfig.json`
2. Implement your resource handlers in `tf_aws_lambdafunctioneventinvokeconfig/handlers.py`
