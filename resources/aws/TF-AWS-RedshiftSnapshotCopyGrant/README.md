# TF::AWS::RedshiftSnapshotCopyGrant

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-redshiftsnapshotcopygrant.json`
2. Implement your resource handlers in `tf_aws_redshiftsnapshotcopygrant/handlers.py`
