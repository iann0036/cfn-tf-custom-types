...
1. Write the JSON schema describing your resource, `terraform-aws-mediastorecontainer.json`
2. Implement your resource handlers in `terraform_aws_mediastorecontainer/handlers.py`
