...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaystage.json`
2. Implement your resource handlers in `terraform_aws_apigatewaystage/handlers.py`
