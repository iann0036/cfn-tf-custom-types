...
1. Write the JSON schema describing your resource, `terraform-aws-athenaworkgroup.json`
2. Implement your resource handlers in `terraform_aws_athenaworkgroup/handlers.py`
