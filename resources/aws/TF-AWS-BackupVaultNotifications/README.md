...
1. Write the JSON schema describing your resource, `tf-aws-backupvaultnotifications.json`
2. Implement your resource handlers in `tf_aws_backupvaultnotifications/handlers.py`
