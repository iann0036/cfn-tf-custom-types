# TF::AWS::Macie2OrganizationAdminAccount

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-macie2organizationadminaccount.json`
2. Implement your resource handlers in `tf_aws_macie2organizationadminaccount/handlers.py`
