...
1. Write the JSON schema describing your resource, `terraform-aws-networkinterfaceattachment.json`
2. Implement your resource handlers in `terraform_aws_networkinterfaceattachment/handlers.py`
