...
1. Write the JSON schema describing your resource, `terraform-aws-vpcpeeringconnectionaccepter.json`
2. Implement your resource handlers in `terraform_aws_vpcpeeringconnectionaccepter/handlers.py`
