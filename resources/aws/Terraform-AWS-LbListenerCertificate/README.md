...
1. Write the JSON schema describing your resource, `terraform-aws-lblistenercertificate.json`
2. Implement your resource handlers in `terraform_aws_lblistenercertificate/handlers.py`
