...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchmetricalarm.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchmetricalarm/handlers.py`
