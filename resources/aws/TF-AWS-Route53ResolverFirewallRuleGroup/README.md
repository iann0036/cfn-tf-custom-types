# TF::AWS::Route53ResolverFirewallRuleGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53resolverfirewallrulegroup.json`
2. Implement your resource handlers in `tf_aws_route53resolverfirewallrulegroup/handlers.py`
