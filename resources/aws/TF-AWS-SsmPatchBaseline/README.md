...
1. Write the JSON schema describing your resource, `tf-aws-ssmpatchbaseline.json`
2. Implement your resource handlers in `tf_aws_ssmpatchbaseline/handlers.py`
