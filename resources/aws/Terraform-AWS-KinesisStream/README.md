...
1. Write the JSON schema describing your resource, `terraform-aws-kinesisstream.json`
2. Implement your resource handlers in `terraform_aws_kinesisstream/handlers.py`
