...
1. Write the JSON schema describing your resource, `terraform-aws-ecscapacityprovider.json`
2. Implement your resource handlers in `terraform_aws_ecscapacityprovider/handlers.py`
