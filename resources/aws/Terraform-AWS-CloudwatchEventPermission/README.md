...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatcheventpermission.json`
2. Implement your resource handlers in `terraform_aws_cloudwatcheventpermission/handlers.py`
