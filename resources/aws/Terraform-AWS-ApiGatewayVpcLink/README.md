...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayvpclink.json`
2. Implement your resource handlers in `terraform_aws_apigatewayvpclink/handlers.py`
