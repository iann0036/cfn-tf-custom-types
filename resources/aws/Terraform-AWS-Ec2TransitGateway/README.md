...
1. Write the JSON schema describing your resource, `terraform-aws-ec2transitgateway.json`
2. Implement your resource handlers in `terraform_aws_ec2transitgateway/handlers.py`
