...
1. Write the JSON schema describing your resource, `tf-aws-maciememberaccountassociation.json`
2. Implement your resource handlers in `tf_aws_maciememberaccountassociation/handlers.py`
