...
1. Write the JSON schema describing your resource, `tf-aws-codepipelinewebhook.json`
2. Implement your resource handlers in `tf_aws_codepipelinewebhook/handlers.py`
