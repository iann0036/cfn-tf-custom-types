...
1. Write the JSON schema describing your resource, `terraform-aws-lightsailstaticipattachment.json`
2. Implement your resource handlers in `terraform_aws_lightsailstaticipattachment/handlers.py`
