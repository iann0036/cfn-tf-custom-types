...
1. Write the JSON schema describing your resource, `terraform-aws-defaultroutetable.json`
2. Implement your resource handlers in `terraform_aws_defaultroutetable/handlers.py`
