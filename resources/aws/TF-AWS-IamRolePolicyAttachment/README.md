...
1. Write the JSON schema describing your resource, `tf-aws-iamrolepolicyattachment.json`
2. Implement your resource handlers in `tf_aws_iamrolepolicyattachment/handlers.py`
