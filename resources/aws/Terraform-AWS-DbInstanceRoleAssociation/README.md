...
1. Write the JSON schema describing your resource, `terraform-aws-dbinstanceroleassociation.json`
2. Implement your resource handlers in `terraform_aws_dbinstanceroleassociation/handlers.py`
