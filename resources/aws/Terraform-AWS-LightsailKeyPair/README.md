...
1. Write the JSON schema describing your resource, `terraform-aws-lightsailkeypair.json`
2. Implement your resource handlers in `terraform_aws_lightsailkeypair/handlers.py`
