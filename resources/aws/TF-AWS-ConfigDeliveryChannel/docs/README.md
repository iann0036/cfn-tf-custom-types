...
<pre>
{
    "Type" : "TF::AWS::ConfigDeliveryChannel",
    "Properties" : {
        ...
        "<a href="#snapshotdeliveryproperties" title="SnapshotDeliveryProperties">SnapshotDeliveryProperties</a>" : <i>[ <a href="snapshotdeliverypropertiesdefinition.md">SnapshotDeliveryPropertiesDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#snapshotdeliveryproperties" title="SnapshotDeliveryProperties">SnapshotDeliveryProperties</a>: <i>
      - <a href="snapshotdeliverypropertiesdefinition.md">SnapshotDeliveryPropertiesDefinition</a></i>
</pre>
...
_Type_: List of <a href="snapshotdeliverypropertiesdefinition.md">SnapshotDeliveryPropertiesDefinition</a>
