...
1. Write the JSON schema describing your resource, `tf-aws-configdeliverychannel.json`
2. Implement your resource handlers in `tf_aws_configdeliverychannel/handlers.py`
