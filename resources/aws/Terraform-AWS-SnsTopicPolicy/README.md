...
1. Write the JSON schema describing your resource, `terraform-aws-snstopicpolicy.json`
2. Implement your resource handlers in `terraform_aws_snstopicpolicy/handlers.py`
