...
1. Write the JSON schema describing your resource, `tf-aws-elasticbeanstalkenvironment.json`
2. Implement your resource handlers in `tf_aws_elasticbeanstalkenvironment/handlers.py`
