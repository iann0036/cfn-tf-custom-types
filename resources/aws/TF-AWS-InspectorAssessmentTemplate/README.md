...
1. Write the JSON schema describing your resource, `tf-aws-inspectorassessmenttemplate.json`
2. Implement your resource handlers in `tf_aws_inspectorassessmenttemplate/handlers.py`
