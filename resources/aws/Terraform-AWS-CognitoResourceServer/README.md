...
1. Write the JSON schema describing your resource, `terraform-aws-cognitoresourceserver.json`
2. Implement your resource handlers in `terraform_aws_cognitoresourceserver/handlers.py`
