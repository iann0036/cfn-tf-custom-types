...
1. Write the JSON schema describing your resource, `terraform-aws-gluesecurityconfiguration.json`
2. Implement your resource handlers in `terraform_aws_gluesecurityconfiguration/handlers.py`
