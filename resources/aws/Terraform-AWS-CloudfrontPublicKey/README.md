...
1. Write the JSON schema describing your resource, `terraform-aws-cloudfrontpublickey.json`
2. Implement your resource handlers in `terraform_aws_cloudfrontpublickey/handlers.py`
