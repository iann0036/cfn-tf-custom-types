...
1. Write the JSON schema describing your resource, `tf-aws-imagebuilderimagerecipe.json`
2. Implement your resource handlers in `tf_aws_imagebuilderimagerecipe/handlers.py`
