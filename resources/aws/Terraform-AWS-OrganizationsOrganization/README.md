...
1. Write the JSON schema describing your resource, `terraform-aws-organizationsorganization.json`
2. Implement your resource handlers in `terraform_aws_organizationsorganization/handlers.py`
