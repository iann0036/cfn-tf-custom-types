...
1. Write the JSON schema describing your resource, `terraform-aws-mediapackagechannel.json`
2. Implement your resource handlers in `terraform_aws_mediapackagechannel/handlers.py`
