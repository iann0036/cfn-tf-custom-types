# TF::AWS::Route53ResolverFirewallRuleGroupAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53resolverfirewallrulegroupassociation.json`
2. Implement your resource handlers in `tf_aws_route53resolverfirewallrulegroupassociation/handlers.py`
