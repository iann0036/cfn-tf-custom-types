...
1. Write the JSON schema describing your resource, `terraform-aws-mskcluster.json`
2. Implement your resource handlers in `terraform_aws_mskcluster/handlers.py`
