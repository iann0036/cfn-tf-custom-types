...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogprincipalportfolioassociation.json`
2. Implement your resource handlers in `tf_aws_servicecatalogprincipalportfolioassociation/handlers.py`
