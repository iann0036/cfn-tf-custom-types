...
1. Write the JSON schema describing your resource, `terraform-aws-networkinterfacesgattachment.json`
2. Implement your resource handlers in `terraform_aws_networkinterfacesgattachment/handlers.py`
