...
1. Write the JSON schema describing your resource, `tf-aws-fsxlustrefilesystem.json`
2. Implement your resource handlers in `tf_aws_fsxlustrefilesystem/handlers.py`
