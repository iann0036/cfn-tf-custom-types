...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewayuploadbuffer.json`
2. Implement your resource handlers in `terraform_aws_storagegatewayuploadbuffer/handlers.py`
