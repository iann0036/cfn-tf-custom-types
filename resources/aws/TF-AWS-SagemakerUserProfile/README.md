...
1. Write the JSON schema describing your resource, `tf-aws-sagemakeruserprofile.json`
2. Implement your resource handlers in `tf_aws_sagemakeruserprofile/handlers.py`
