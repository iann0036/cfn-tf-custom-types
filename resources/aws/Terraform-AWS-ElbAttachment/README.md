...
1. Write the JSON schema describing your resource, `terraform-aws-elbattachment.json`
2. Implement your resource handlers in `terraform_aws_elbattachment/handlers.py`
