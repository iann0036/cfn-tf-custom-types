...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointapnsvoipsandboxchannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointapnsvoipsandboxchannel/handlers.py`
