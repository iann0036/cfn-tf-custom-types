...
1. Write the JSON schema describing your resource, `tf-aws-elasticbeanstalkconfigurationtemplate.json`
2. Implement your resource handlers in `tf_aws_elasticbeanstalkconfigurationtemplate/handlers.py`
