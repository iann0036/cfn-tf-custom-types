...
1. Write the JSON schema describing your resource, `terraform-aws-guarddutydetector.json`
2. Implement your resource handlers in `terraform_aws_guarddutydetector/handlers.py`
