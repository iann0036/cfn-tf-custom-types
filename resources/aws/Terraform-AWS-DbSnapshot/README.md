...
1. Write the JSON schema describing your resource, `terraform-aws-dbsnapshot.json`
2. Implement your resource handlers in `terraform_aws_dbsnapshot/handlers.py`
