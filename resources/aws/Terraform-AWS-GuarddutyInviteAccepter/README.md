...
1. Write the JSON schema describing your resource, `terraform-aws-guarddutyinviteaccepter.json`
2. Implement your resource handlers in `terraform_aws_guarddutyinviteaccepter/handlers.py`
