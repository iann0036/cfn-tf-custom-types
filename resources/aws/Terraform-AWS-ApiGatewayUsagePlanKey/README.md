...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayusageplankey.json`
2. Implement your resource handlers in `terraform_aws_apigatewayusageplankey/handlers.py`
