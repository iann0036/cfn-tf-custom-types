...
1. Write the JSON schema describing your resource, `terraform-aws-snssmspreferences.json`
2. Implement your resource handlers in `terraform_aws_snssmspreferences/handlers.py`
