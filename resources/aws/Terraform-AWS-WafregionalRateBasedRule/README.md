...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalratebasedrule.json`
2. Implement your resource handlers in `terraform_aws_wafregionalratebasedrule/handlers.py`
