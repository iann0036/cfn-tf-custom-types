...
1. Write the JSON schema describing your resource, `tf-aws-amilaunchpermission.json`
2. Implement your resource handlers in `tf_aws_amilaunchpermission/handlers.py`
