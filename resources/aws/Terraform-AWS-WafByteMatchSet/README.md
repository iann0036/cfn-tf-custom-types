...
1. Write the JSON schema describing your resource, `terraform-aws-wafbytematchset.json`
2. Implement your resource handlers in `terraform_aws_wafbytematchset/handlers.py`
