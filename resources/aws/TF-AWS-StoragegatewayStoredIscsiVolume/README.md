...
1. Write the JSON schema describing your resource, `tf-aws-storagegatewaystorediscsivolume.json`
2. Implement your resource handlers in `tf_aws_storagegatewaystorediscsivolume/handlers.py`
