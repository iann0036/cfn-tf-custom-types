# TF::AWS::Wafv2RuleGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-wafv2rulegroup.json`
2. Implement your resource handlers in `tf_aws_wafv2rulegroup/handlers.py`
