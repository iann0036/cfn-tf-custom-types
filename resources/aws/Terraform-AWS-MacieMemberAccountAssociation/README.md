...
1. Write the JSON schema describing your resource, `terraform-aws-maciememberaccountassociation.json`
2. Implement your resource handlers in `terraform_aws_maciememberaccountassociation/handlers.py`
