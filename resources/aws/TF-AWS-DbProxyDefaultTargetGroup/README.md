...
1. Write the JSON schema describing your resource, `tf-aws-dbproxydefaulttargetgroup.json`
2. Implement your resource handlers in `tf_aws_dbproxydefaulttargetgroup/handlers.py`
