...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksjavaapplayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksjavaapplayer/handlers.py`
