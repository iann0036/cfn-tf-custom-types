...
1. Write the JSON schema describing your resource, `terraform-aws-s3bucketpublicaccessblock.json`
2. Implement your resource handlers in `terraform_aws_s3bucketpublicaccessblock/handlers.py`
