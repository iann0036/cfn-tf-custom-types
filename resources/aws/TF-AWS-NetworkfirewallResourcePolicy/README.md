...
1. Write the JSON schema describing your resource, `tf-aws-networkfirewallresourcepolicy.json`
2. Implement your resource handlers in `tf_aws_networkfirewallresourcepolicy/handlers.py`
