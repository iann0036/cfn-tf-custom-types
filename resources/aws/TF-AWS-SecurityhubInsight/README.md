...
1. Write the JSON schema describing your resource, `tf-aws-securityhubinsight.json`
2. Implement your resource handlers in `tf_aws_securityhubinsight/handlers.py`
