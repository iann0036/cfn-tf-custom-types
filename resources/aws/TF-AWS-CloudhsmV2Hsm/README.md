# TF::AWS::CloudhsmV2Hsm

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-cloudhsmv2hsm.json`
2. Implement your resource handlers in `tf_aws_cloudhsmv2hsm/handlers.py`
