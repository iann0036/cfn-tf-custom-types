...
1. Write the JSON schema describing your resource, `tf-aws-guarddutyorganizationconfiguration.json`
2. Implement your resource handlers in `tf_aws_guarddutyorganizationconfiguration/handlers.py`
