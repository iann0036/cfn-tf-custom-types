...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalsizeconstraintset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalsizeconstraintset/handlers.py`
