...
1. Write the JSON schema describing your resource, `terraform-aws-codecommitrepository.json`
2. Implement your resource handlers in `terraform_aws_codecommitrepository/handlers.py`
