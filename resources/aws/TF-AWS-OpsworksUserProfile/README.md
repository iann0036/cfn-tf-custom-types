...
1. Write the JSON schema describing your resource, `tf-aws-opsworksuserprofile.json`
2. Implement your resource handlers in `tf_aws_opsworksuserprofile/handlers.py`
