...
1. Write the JSON schema describing your resource, `terraform-aws-redshiftsecuritygroup.json`
2. Implement your resource handlers in `terraform_aws_redshiftsecuritygroup/handlers.py`
