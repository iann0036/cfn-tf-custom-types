...
1. Write the JSON schema describing your resource, `terraform-aws-eksnodegroup.json`
2. Implement your resource handlers in `terraform_aws_eksnodegroup/handlers.py`
