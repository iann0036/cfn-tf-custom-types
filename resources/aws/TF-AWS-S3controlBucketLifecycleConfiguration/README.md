...
1. Write the JSON schema describing your resource, `tf-aws-s3controlbucketlifecycleconfiguration.json`
2. Implement your resource handlers in `tf_aws_s3controlbucketlifecycleconfiguration/handlers.py`
