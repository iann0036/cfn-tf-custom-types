...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayv2routeresponse.json`
2. Implement your resource handlers in `tf_aws_apigatewayv2routeresponse/handlers.py`
