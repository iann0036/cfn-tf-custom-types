...
1. Write the JSON schema describing your resource, `terraform-aws-iamservicelinkedrole.json`
2. Implement your resource handlers in `terraform_aws_iamservicelinkedrole/handlers.py`
