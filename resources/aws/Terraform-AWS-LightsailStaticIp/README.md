...
1. Write the JSON schema describing your resource, `terraform-aws-lightsailstaticip.json`
2. Implement your resource handlers in `terraform_aws_lightsailstaticip/handlers.py`
