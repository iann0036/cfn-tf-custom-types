...
1. Write the JSON schema describing your resource, `terraform-aws-servicecatalogportfolio.json`
2. Implement your resource handlers in `terraform_aws_servicecatalogportfolio/handlers.py`
