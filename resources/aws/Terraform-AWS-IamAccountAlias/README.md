...
1. Write the JSON schema describing your resource, `terraform-aws-iamaccountalias.json`
2. Implement your resource handlers in `terraform_aws_iamaccountalias/handlers.py`
