...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalxssmatchset.json`
2. Implement your resource handlers in `tf_aws_wafregionalxssmatchset/handlers.py`
