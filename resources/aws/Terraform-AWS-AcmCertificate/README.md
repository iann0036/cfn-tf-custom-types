...
1. Write the JSON schema describing your resource, `terraform-aws-acmcertificate.json`
2. Implement your resource handlers in `terraform_aws_acmcertificate/handlers.py`
