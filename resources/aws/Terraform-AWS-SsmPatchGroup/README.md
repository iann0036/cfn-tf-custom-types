...
1. Write the JSON schema describing your resource, `terraform-aws-ssmpatchgroup.json`
2. Implement your resource handlers in `terraform_aws_ssmpatchgroup/handlers.py`
