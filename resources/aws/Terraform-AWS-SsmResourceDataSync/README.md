...
1. Write the JSON schema describing your resource, `terraform-aws-ssmresourcedatasync.json`
2. Implement your resource handlers in `terraform_aws_ssmresourcedatasync/handlers.py`
