...
1. Write the JSON schema describing your resource, `tf-aws-appmeshgatewayroute.json`
2. Implement your resource handlers in `tf_aws_appmeshgatewayroute/handlers.py`
