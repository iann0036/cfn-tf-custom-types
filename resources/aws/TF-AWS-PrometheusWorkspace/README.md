...
1. Write the JSON schema describing your resource, `tf-aws-prometheusworkspace.json`
2. Implement your resource handlers in `tf_aws_prometheusworkspace/handlers.py`
