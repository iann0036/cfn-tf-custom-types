...
1. Write the JSON schema describing your resource, `terraform-aws-configconfigurationrecorderstatus.json`
2. Implement your resource handlers in `terraform_aws_configconfigurationrecorderstatus/handlers.py`
