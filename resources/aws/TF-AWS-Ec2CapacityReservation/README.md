# TF::AWS::Ec2CapacityReservation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ec2capacityreservation.json`
2. Implement your resource handlers in `tf_aws_ec2capacityreservation/handlers.py`
