...
<pre>
{
    "Type" : "TF::AWS::LbListener",
    "Properties" : {
        "<a href="#alpnpolicy" title="AlpnPolicy">AlpnPolicy</a>" : <i>String</i>,
...
ARN of the default SSL server certificate. Exactly one certificate is required if the protocol is HTTPS. For adding additional SSL certificates, see the [`aws_lb_listener_certificate` resource](/docs/providers/aws/r/lb_listener_certificate.html).
