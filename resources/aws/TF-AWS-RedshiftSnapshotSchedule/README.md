# TF::AWS::RedshiftSnapshotSchedule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-redshiftsnapshotschedule.json`
2. Implement your resource handlers in `tf_aws_redshiftsnapshotschedule/handlers.py`
