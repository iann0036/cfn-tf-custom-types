...
1. Write the JSON schema describing your resource, `tf-aws-cognitouserpooldomain.json`
2. Implement your resource handlers in `tf_aws_cognitouserpooldomain/handlers.py`
