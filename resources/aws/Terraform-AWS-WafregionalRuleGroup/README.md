...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalrulegroup.json`
2. Implement your resource handlers in `terraform_aws_wafregionalrulegroup/handlers.py`
