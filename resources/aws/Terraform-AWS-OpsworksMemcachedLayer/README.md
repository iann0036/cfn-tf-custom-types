...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksmemcachedlayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksmemcachedlayer/handlers.py`
