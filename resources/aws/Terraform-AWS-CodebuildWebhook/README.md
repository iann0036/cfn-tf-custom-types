...
1. Write the JSON schema describing your resource, `terraform-aws-codebuildwebhook.json`
2. Implement your resource handlers in `terraform_aws_codebuildwebhook/handlers.py`
