...
1. Write the JSON schema describing your resource, `terraform-aws-route53resolverrule.json`
2. Implement your resource handlers in `terraform_aws_route53resolverrule/handlers.py`
