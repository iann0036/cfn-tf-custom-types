...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_iam_account_password_policy'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_iam_account_password_policy'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
