...
1. Write the JSON schema describing your resource, `terraform-aws-iamaccountpasswordpolicy.json`
2. Implement your resource handlers in `terraform_aws_iamaccountpasswordpolicy/handlers.py`
