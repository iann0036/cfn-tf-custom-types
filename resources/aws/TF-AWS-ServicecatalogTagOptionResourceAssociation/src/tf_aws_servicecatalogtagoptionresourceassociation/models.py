...
class ResourceModel(BaseModel):
    ...
    ResourceCreatedTime: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ResourceCreatedTime=json_data.get("ResourceCreatedTime"),
            ResourceDescription=json_data.get("ResourceDescription"),
            ResourceId=json_data.get("ResourceId"),
            ResourceName=json_data.get("ResourceName"),
            TagOptionId=json_data.get("TagOptionId"),
        )
