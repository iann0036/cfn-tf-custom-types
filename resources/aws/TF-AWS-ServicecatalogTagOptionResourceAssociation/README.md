...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogtagoptionresourceassociation.json`
2. Implement your resource handlers in `tf_aws_servicecatalogtagoptionresourceassociation/handlers.py`
