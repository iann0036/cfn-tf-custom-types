...
1. Write the JSON schema describing your resource, `tf-aws-cloudfrontcachepolicy.json`
2. Implement your resource handlers in `tf_aws_cloudfrontcachepolicy/handlers.py`
