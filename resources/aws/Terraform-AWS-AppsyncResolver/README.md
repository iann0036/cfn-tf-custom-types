...
1. Write the JSON schema describing your resource, `terraform-aws-appsyncresolver.json`
2. Implement your resource handlers in `terraform_aws_appsyncresolver/handlers.py`
