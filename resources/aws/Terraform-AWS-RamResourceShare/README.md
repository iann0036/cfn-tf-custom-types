...
1. Write the JSON schema describing your resource, `terraform-aws-ramresourceshare.json`
2. Implement your resource handlers in `terraform_aws_ramresourceshare/handlers.py`
