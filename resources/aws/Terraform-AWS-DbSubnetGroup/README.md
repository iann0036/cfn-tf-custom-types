...
1. Write the JSON schema describing your resource, `terraform-aws-dbsubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_dbsubnetgroup/handlers.py`
