...
1. Write the JSON schema describing your resource, `terraform-aws-snsplatformapplication.json`
2. Implement your resource handlers in `terraform_aws_snsplatformapplication/handlers.py`
