...
1. Write the JSON schema describing your resource, `terraform-aws-sesdomaindkim.json`
2. Implement your resource handlers in `terraform_aws_sesdomaindkim/handlers.py`
