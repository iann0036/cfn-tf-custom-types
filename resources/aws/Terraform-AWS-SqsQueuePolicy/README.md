...
1. Write the JSON schema describing your resource, `terraform-aws-sqsqueuepolicy.json`
2. Implement your resource handlers in `terraform_aws_sqsqueuepolicy/handlers.py`
