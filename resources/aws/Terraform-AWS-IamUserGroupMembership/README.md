...
1. Write the JSON schema describing your resource, `terraform-aws-iamusergroupmembership.json`
2. Implement your resource handlers in `terraform_aws_iamusergroupmembership/handlers.py`
