...
1. Write the JSON schema describing your resource, `terraform-aws-iamsamlprovider.json`
2. Implement your resource handlers in `terraform_aws_iamsamlprovider/handlers.py`
