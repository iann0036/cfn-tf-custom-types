...
1. Write the JSON schema describing your resource, `terraform-aws-iamgroupmembership.json`
2. Implement your resource handlers in `terraform_aws_iamgroupmembership/handlers.py`
