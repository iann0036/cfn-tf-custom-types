...
1. Write the JSON schema describing your resource, `terraform-aws-transferuser.json`
2. Implement your resource handlers in `terraform_aws_transferuser/handlers.py`
