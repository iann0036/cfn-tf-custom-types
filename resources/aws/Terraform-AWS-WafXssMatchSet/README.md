...
1. Write the JSON schema describing your resource, `terraform-aws-wafxssmatchset.json`
2. Implement your resource handlers in `terraform_aws_wafxssmatchset/handlers.py`
