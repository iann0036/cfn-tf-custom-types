...
1. Write the JSON schema describing your resource, `terraform-aws-glueclassifier.json`
2. Implement your resource handlers in `terraform_aws_glueclassifier/handlers.py`
