...
1. Write the JSON schema describing your resource, `terraform-aws-dbeventsubscription.json`
2. Implement your resource handlers in `terraform_aws_dbeventsubscription/handlers.py`
