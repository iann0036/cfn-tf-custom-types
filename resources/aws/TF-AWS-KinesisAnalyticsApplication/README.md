...
1. Write the JSON schema describing your resource, `tf-aws-kinesisanalyticsapplication.json`
2. Implement your resource handlers in `tf_aws_kinesisanalyticsapplication/handlers.py`
