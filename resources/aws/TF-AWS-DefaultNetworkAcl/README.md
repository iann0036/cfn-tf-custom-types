...
1. Write the JSON schema describing your resource, `tf-aws-defaultnetworkacl.json`
2. Implement your resource handlers in `tf_aws_defaultnetworkacl/handlers.py`
