...
1. Write the JSON schema describing your resource, `tf-aws-networkfirewallfirewallpolicy.json`
2. Implement your resource handlers in `tf_aws_networkfirewallfirewallpolicy/handlers.py`
