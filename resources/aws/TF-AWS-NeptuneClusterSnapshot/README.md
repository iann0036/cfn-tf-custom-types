...
1. Write the JSON schema describing your resource, `tf-aws-neptuneclustersnapshot.json`
2. Implement your resource handlers in `tf_aws_neptuneclustersnapshot/handlers.py`
