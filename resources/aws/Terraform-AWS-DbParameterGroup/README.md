...
1. Write the JSON schema describing your resource, `terraform-aws-dbparametergroup.json`
2. Implement your resource handlers in `terraform_aws_dbparametergroup/handlers.py`
