...
1. Write the JSON schema describing your resource, `terraform-aws-autoscalingattachment.json`
2. Implement your resource handlers in `terraform_aws_autoscalingattachment/handlers.py`
