...
1. Write the JSON schema describing your resource, `tf-aws-ssmmaintenancewindow.json`
2. Implement your resource handlers in `tf_aws_ssmmaintenancewindow/handlers.py`
