...
1. Write the JSON schema describing your resource, `tf-aws-mainroutetableassociation.json`
2. Implement your resource handlers in `tf_aws_mainroutetableassociation/handlers.py`
