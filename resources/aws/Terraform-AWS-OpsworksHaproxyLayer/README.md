...
1. Write the JSON schema describing your resource, `terraform-aws-opsworkshaproxylayer.json`
2. Implement your resource handlers in `terraform_aws_opsworkshaproxylayer/handlers.py`
