...
class ResourceModel(BaseResourceModel):
    ...
    StatsEnabled: Optional[bool]
    StatsPassword: Optional[str]
    StatsUrl: Optional[str]
    StatsUser: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            StatsEnabled=json_data.get("StatsEnabled"),
            StatsPassword=json_data.get("StatsPassword"),
            StatsUrl=json_data.get("StatsUrl"),
            StatsUser=json_data.get("StatsUser"),
