...
class ResourceModel(BaseModel):
    ...
    ResponseTemplates: Optional[Sequence["_ResponseTemplatesDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ResponseTemplates=deserialize_list(json_data.get("ResponseTemplates"), ResponseTemplatesDefinition),
...
@dataclass
class ResponseTemplatesDefinition(BaseModel):
    MapKey: Optional[str]
    MapValue: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_ResponseTemplatesDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ResponseTemplatesDefinition"]:
        if not json_data:
            return None
        return cls(
            MapKey=json_data.get("MapKey"),
...
# work around possible type aliasing issues when variable has same name as a model
_ResponseTemplatesDefinition = ResponseTemplatesDefinition
