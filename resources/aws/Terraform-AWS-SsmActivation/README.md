...
1. Write the JSON schema describing your resource, `terraform-aws-ssmactivation.json`
2. Implement your resource handlers in `terraform_aws_ssmactivation/handlers.py`
