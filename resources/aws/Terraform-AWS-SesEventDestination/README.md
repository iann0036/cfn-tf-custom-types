...
1. Write the JSON schema describing your resource, `terraform-aws-seseventdestination.json`
2. Implement your resource handlers in `terraform_aws_seseventdestination/handlers.py`
