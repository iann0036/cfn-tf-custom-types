...
1. Write the JSON schema describing your resource, `tf-aws-ssoadminpermissionsetinlinepolicy.json`
2. Implement your resource handlers in `tf_aws_ssoadminpermissionsetinlinepolicy/handlers.py`
