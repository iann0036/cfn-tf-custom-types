...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaydeployment.json`
2. Implement your resource handlers in `terraform_aws_apigatewaydeployment/handlers.py`
