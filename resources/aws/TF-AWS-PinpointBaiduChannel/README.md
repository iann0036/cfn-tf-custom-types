# TF::AWS::PinpointBaiduChannel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-pinpointbaiduchannel.json`
2. Implement your resource handlers in `tf_aws_pinpointbaiduchannel/handlers.py`
