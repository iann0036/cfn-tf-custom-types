...
1. Write the JSON schema describing your resource, `terraform-aws-route53resolverendpoint.json`
2. Implement your resource handlers in `terraform_aws_route53resolverendpoint/handlers.py`
