...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointapnschannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointapnschannel/handlers.py`
