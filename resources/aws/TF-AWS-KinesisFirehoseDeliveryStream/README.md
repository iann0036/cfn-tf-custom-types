...
1. Write the JSON schema describing your resource, `tf-aws-kinesisfirehosedeliverystream.json`
2. Implement your resource handlers in `tf_aws_kinesisfirehosedeliverystream/handlers.py`
