...
1. Write the JSON schema describing your resource, `terraform-aws-directoryservicelogsubscription.json`
2. Implement your resource handlers in `terraform_aws_directoryservicelogsubscription/handlers.py`
