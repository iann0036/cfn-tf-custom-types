...
1. Write the JSON schema describing your resource, `terraform-aws-emrinstancegroup.json`
2. Implement your resource handlers in `terraform_aws_emrinstancegroup/handlers.py`
