...
1. Write the JSON schema describing your resource, `terraform-aws-athenadatabase.json`
2. Implement your resource handlers in `terraform_aws_athenadatabase/handlers.py`
