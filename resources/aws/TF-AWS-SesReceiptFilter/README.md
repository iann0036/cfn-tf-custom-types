...
1. Write the JSON schema describing your resource, `tf-aws-sesreceiptfilter.json`
2. Implement your resource handlers in `tf_aws_sesreceiptfilter/handlers.py`
