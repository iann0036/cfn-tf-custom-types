...
1. Write the JSON schema describing your resource, `tf-aws-iamusergroupmembership.json`
2. Implement your resource handlers in `tf_aws_iamusergroupmembership/handlers.py`
