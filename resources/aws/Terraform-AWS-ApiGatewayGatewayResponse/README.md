...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaygatewayresponse.json`
2. Implement your resource handlers in `terraform_aws_apigatewaygatewayresponse/handlers.py`
