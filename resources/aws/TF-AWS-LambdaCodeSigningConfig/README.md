...
1. Write the JSON schema describing your resource, `tf-aws-lambdacodesigningconfig.json`
2. Implement your resource handlers in `tf_aws_lambdacodesigningconfig/handlers.py`
