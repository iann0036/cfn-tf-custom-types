# TF::AWS::DocdbSubnetGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-docdbsubnetgroup.json`
2. Implement your resource handlers in `tf_aws_docdbsubnetgroup/handlers.py`
