# TF::AWS::SsoadminPermissionSet

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ssoadminpermissionset.json`
2. Implement your resource handlers in `tf_aws_ssoadminpermissionset/handlers.py`
