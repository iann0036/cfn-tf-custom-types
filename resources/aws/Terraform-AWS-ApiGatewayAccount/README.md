...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayaccount.json`
2. Implement your resource handlers in `terraform_aws_apigatewayaccount/handlers.py`
