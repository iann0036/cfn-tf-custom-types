...
1. Write the JSON schema describing your resource, `tf-aws-workspacesdirectory.json`
2. Implement your resource handlers in `tf_aws_workspacesdirectory/handlers.py`
