...
1. Write the JSON schema describing your resource, `tf-aws-sesdomainidentityverification.json`
2. Implement your resource handlers in `tf_aws_sesdomainidentityverification/handlers.py`
