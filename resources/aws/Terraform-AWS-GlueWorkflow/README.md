...
1. Write the JSON schema describing your resource, `terraform-aws-glueworkflow.json`
2. Implement your resource handlers in `terraform_aws_glueworkflow/handlers.py`
