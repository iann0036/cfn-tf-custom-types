...
1. Write the JSON schema describing your resource, `terraform-aws-codedeploydeploymentconfig.json`
2. Implement your resource handlers in `terraform_aws_codedeploydeploymentconfig/handlers.py`
