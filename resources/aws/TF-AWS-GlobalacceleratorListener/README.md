...
1. Write the JSON schema describing your resource, `tf-aws-globalacceleratorlistener.json`
2. Implement your resource handlers in `tf_aws_globalacceleratorlistener/handlers.py`
