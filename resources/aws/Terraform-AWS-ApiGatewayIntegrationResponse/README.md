...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayintegrationresponse.json`
2. Implement your resource handlers in `terraform_aws_apigatewayintegrationresponse/handlers.py`
