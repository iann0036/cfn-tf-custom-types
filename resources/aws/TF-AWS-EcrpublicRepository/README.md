...
1. Write the JSON schema describing your resource, `tf-aws-ecrpublicrepository.json`
2. Implement your resource handlers in `tf_aws_ecrpublicrepository/handlers.py`
