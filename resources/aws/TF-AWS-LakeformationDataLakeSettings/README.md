...
1. Write the JSON schema describing your resource, `tf-aws-lakeformationdatalakesettings.json`
2. Implement your resource handlers in `tf_aws_lakeformationdatalakesettings/handlers.py`
