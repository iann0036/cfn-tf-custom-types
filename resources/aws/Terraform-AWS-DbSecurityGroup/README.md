...
1. Write the JSON schema describing your resource, `terraform-aws-dbsecuritygroup.json`
2. Implement your resource handlers in `terraform_aws_dbsecuritygroup/handlers.py`
