...
1. Write the JSON schema describing your resource, `terraform-aws-wafgeomatchset.json`
2. Implement your resource handlers in `terraform_aws_wafgeomatchset/handlers.py`
