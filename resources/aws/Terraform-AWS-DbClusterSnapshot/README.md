...
1. Write the JSON schema describing your resource, `terraform-aws-dbclustersnapshot.json`
2. Implement your resource handlers in `terraform_aws_dbclustersnapshot/handlers.py`
