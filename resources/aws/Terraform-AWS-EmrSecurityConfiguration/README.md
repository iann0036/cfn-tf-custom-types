...
1. Write the JSON schema describing your resource, `terraform-aws-emrsecurityconfiguration.json`
2. Implement your resource handlers in `terraform_aws_emrsecurityconfiguration/handlers.py`
