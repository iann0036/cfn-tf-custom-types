...
1. Write the JSON schema describing your resource, `tf-aws-opsworksrdsdbinstance.json`
2. Implement your resource handlers in `tf_aws_opsworksrdsdbinstance/handlers.py`
