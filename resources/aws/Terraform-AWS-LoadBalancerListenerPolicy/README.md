...
1. Write the JSON schema describing your resource, `terraform-aws-loadbalancerlistenerpolicy.json`
2. Implement your resource handlers in `terraform_aws_loadbalancerlistenerpolicy/handlers.py`
