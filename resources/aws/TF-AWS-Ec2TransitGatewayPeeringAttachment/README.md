...
1. Write the JSON schema describing your resource, `tf-aws-ec2transitgatewaypeeringattachment.json`
2. Implement your resource handlers in `tf_aws_ec2transitgatewaypeeringattachment/handlers.py`
