...
1. Write the JSON schema describing your resource, `tf-aws-vpcendpointservice.json`
2. Implement your resource handlers in `tf_aws_vpcendpointservice/handlers.py`
