...
1. Write the JSON schema describing your resource, `terraform-aws-sesdomainmailfrom.json`
2. Implement your resource handlers in `terraform_aws_sesdomainmailfrom/handlers.py`
