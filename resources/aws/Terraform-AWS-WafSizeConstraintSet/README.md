...
1. Write the JSON schema describing your resource, `terraform-aws-wafsizeconstraintset.json`
2. Implement your resource handlers in `terraform_aws_wafsizeconstraintset/handlers.py`
