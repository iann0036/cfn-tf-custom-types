...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchlogresourcepolicy.json`
2. Implement your resource handlers in `tf_aws_cloudwatchlogresourcepolicy/handlers.py`
