...
1. Write the JSON schema describing your resource, `terraform-aws-networkinterface.json`
2. Implement your resource handlers in `terraform_aws_networkinterface/handlers.py`
