...
1. Write the JSON schema describing your resource, `tf-aws-appmeshvirtualservice.json`
2. Implement your resource handlers in `tf_aws_appmeshvirtualservice/handlers.py`
