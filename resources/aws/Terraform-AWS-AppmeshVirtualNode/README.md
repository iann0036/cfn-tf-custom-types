...
1. Write the JSON schema describing your resource, `terraform-aws-appmeshvirtualnode.json`
2. Implement your resource handlers in `terraform_aws_appmeshvirtualnode/handlers.py`
