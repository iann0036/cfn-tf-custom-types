...
1. Write the JSON schema describing your resource, `terraform-aws-quicksightgroup.json`
2. Implement your resource handlers in `terraform_aws_quicksightgroup/handlers.py`
