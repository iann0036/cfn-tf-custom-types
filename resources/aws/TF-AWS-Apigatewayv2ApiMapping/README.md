...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayv2apimapping.json`
2. Implement your resource handlers in `tf_aws_apigatewayv2apimapping/handlers.py`
