...
1. Write the JSON schema describing your resource, `terraform-aws-snapshotcreatevolumepermission.json`
2. Implement your resource handlers in `terraform_aws_snapshotcreatevolumepermission/handlers.py`
