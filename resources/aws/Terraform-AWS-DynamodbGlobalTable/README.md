...
1. Write the JSON schema describing your resource, `terraform-aws-dynamodbglobaltable.json`
2. Implement your resource handlers in `terraform_aws_dynamodbglobaltable/handlers.py`
