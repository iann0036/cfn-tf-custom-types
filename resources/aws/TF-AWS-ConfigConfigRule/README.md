...
1. Write the JSON schema describing your resource, `tf-aws-configconfigrule.json`
2. Implement your resource handlers in `tf_aws_configconfigrule/handlers.py`
