...
class SourceDefinition(BaseModel):
    ...
    SourceDetail: Optional[Sequence["_SourceDetailDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            SourceDetail=deserialize_list(json_data.get("SourceDetail"), SourceDetailDefinition),
        )
...
@dataclass
class SourceDetailDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_SourceDetailDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_SourceDetailDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_SourceDetailDefinition = SourceDetailDefinition
