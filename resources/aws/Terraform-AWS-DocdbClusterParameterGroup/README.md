...
1. Write the JSON schema describing your resource, `terraform-aws-docdbclusterparametergroup.json`
2. Implement your resource handlers in `terraform_aws_docdbclusterparametergroup/handlers.py`
