...
1. Write the JSON schema describing your resource, `terraform-aws-elasticbeanstalkenvironment.json`
2. Implement your resource handlers in `terraform_aws_elasticbeanstalkenvironment/handlers.py`
