...
1. Write the JSON schema describing your resource, `terraform-aws-cognitoidentitypool.json`
2. Implement your resource handlers in `terraform_aws_cognitoidentitypool/handlers.py`
