...
1. Write the JSON schema describing your resource, `terraform-aws-rdsclusterendpoint.json`
2. Implement your resource handlers in `terraform_aws_rdsclusterendpoint/handlers.py`
