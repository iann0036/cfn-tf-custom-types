...
1. Write the JSON schema describing your resource, `terraform-aws-gluecatalogtable.json`
2. Implement your resource handlers in `terraform_aws_gluecatalogtable/handlers.py`
