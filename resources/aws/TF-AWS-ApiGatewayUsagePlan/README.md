...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayusageplan.json`
2. Implement your resource handlers in `tf_aws_apigatewayusageplan/handlers.py`
