...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatcheventtarget.json`
2. Implement your resource handlers in `tf_aws_cloudwatcheventtarget/handlers.py`
