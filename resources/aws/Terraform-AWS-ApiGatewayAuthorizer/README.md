...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayauthorizer.json`
2. Implement your resource handlers in `terraform_aws_apigatewayauthorizer/handlers.py`
