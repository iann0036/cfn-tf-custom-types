...
1. Write the JSON schema describing your resource, `terraform-aws-securitygroup.json`
2. Implement your resource handlers in `terraform_aws_securitygroup/handlers.py`
