...
1. Write the JSON schema describing your resource, `terraform-aws-cloudtrail.json`
2. Implement your resource handlers in `terraform_aws_cloudtrail/handlers.py`
