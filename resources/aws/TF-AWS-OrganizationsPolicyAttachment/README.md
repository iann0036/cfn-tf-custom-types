...
1. Write the JSON schema describing your resource, `tf-aws-organizationspolicyattachment.json`
2. Implement your resource handlers in `tf_aws_organizationspolicyattachment/handlers.py`
