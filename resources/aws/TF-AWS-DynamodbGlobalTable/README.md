...
1. Write the JSON schema describing your resource, `tf-aws-dynamodbglobaltable.json`
2. Implement your resource handlers in `tf_aws_dynamodbglobaltable/handlers.py`
