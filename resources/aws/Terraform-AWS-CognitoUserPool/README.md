...
1. Write the JSON schema describing your resource, `terraform-aws-cognitouserpool.json`
2. Implement your resource handlers in `terraform_aws_cognitouserpool/handlers.py`
