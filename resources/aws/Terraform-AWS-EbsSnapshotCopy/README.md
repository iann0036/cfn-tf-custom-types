...
1. Write the JSON schema describing your resource, `terraform-aws-ebssnapshotcopy.json`
2. Implement your resource handlers in `terraform_aws_ebssnapshotcopy/handlers.py`
