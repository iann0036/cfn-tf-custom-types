...
1. Write the JSON schema describing your resource, `tf-aws-route53resolverfirewallrule.json`
2. Implement your resource handlers in `tf_aws_route53resolverfirewallrule/handlers.py`
