...
1. Write the JSON schema describing your resource, `terraform-aws-vpngatewayattachment.json`
2. Implement your resource handlers in `terraform_aws_vpngatewayattachment/handlers.py`
