...
1. Write the JSON schema describing your resource, `tf-aws-worklinkwebsitecertificateauthorityassociation.json`
2. Implement your resource handlers in `tf_aws_worklinkwebsitecertificateauthorityassociation/handlers.py`
