...
1. Write the JSON schema describing your resource, `tf-aws-vpngatewayroutepropagation.json`
2. Implement your resource handlers in `tf_aws_vpngatewayroutepropagation/handlers.py`
