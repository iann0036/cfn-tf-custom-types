...
1. Write the JSON schema describing your resource, `terraform-aws-iamuserpolicy.json`
2. Implement your resource handlers in `terraform_aws_iamuserpolicy/handlers.py`
