...
1. Write the JSON schema describing your resource, `terraform-aws-lbtargetgroup.json`
2. Implement your resource handlers in `terraform_aws_lbtargetgroup/handlers.py`
