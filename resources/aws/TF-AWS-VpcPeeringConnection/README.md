...
1. Write the JSON schema describing your resource, `tf-aws-vpcpeeringconnection.json`
2. Implement your resource handlers in `tf_aws_vpcpeeringconnection/handlers.py`
