...
1. Write the JSON schema describing your resource, `terraform-aws-guarddutyipset.json`
2. Implement your resource handlers in `terraform_aws_guarddutyipset/handlers.py`
