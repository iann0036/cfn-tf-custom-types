...
1. Write the JSON schema describing your resource, `terraform-aws-neptuneparametergroup.json`
2. Implement your resource handlers in `terraform_aws_neptuneparametergroup/handlers.py`
