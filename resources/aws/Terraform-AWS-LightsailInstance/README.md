...
1. Write the JSON schema describing your resource, `terraform-aws-lightsailinstance.json`
2. Implement your resource handlers in `terraform_aws_lightsailinstance/handlers.py`
