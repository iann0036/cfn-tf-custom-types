...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaybasepathmapping.json`
2. Implement your resource handlers in `terraform_aws_apigatewaybasepathmapping/handlers.py`
