...
1. Write the JSON schema describing your resource, `tf-aws-codestarnotificationsnotificationrule.json`
2. Implement your resource handlers in `tf_aws_codestarnotificationsnotificationrule/handlers.py`
