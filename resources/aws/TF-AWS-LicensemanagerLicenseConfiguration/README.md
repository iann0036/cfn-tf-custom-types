...
1. Write the JSON schema describing your resource, `tf-aws-licensemanagerlicenseconfiguration.json`
2. Implement your resource handlers in `tf_aws_licensemanagerlicenseconfiguration/handlers.py`
