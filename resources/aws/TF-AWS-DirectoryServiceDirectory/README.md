...
1. Write the JSON schema describing your resource, `tf-aws-directoryservicedirectory.json`
2. Implement your resource handlers in `tf_aws_directoryservicedirectory/handlers.py`
