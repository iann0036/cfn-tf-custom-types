...
1. Write the JSON schema describing your resource, `terraform-aws-appsyncgraphqlapi.json`
2. Implement your resource handlers in `terraform_aws_appsyncgraphqlapi/handlers.py`
