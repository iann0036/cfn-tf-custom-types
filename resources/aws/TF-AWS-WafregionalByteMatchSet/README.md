...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalbytematchset.json`
2. Implement your resource handlers in `tf_aws_wafregionalbytematchset/handlers.py`
