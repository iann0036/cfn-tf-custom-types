...
1. Write the JSON schema describing your resource, `tf-aws-cognitouserpooluicustomization.json`
2. Implement your resource handlers in `tf_aws_cognitouserpooluicustomization/handlers.py`
