...
1. Write the JSON schema describing your resource, `terraform-aws-appmeshvirtualrouter.json`
2. Implement your resource handlers in `terraform_aws_appmeshvirtualrouter/handlers.py`
