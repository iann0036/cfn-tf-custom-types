...
1. Write the JSON schema describing your resource, `terraform-aws-ecstaskdefinition.json`
2. Implement your resource handlers in `terraform_aws_ecstaskdefinition/handlers.py`
