...
1. Write the JSON schema describing your resource, `terraform-aws-iaminstanceprofile.json`
2. Implement your resource handlers in `terraform_aws_iaminstanceprofile/handlers.py`
