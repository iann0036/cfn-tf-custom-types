...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchlogsubscriptionfilter.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchlogsubscriptionfilter/handlers.py`
