...
1. Write the JSON schema describing your resource, `terraform-aws-cloudformationstack.json`
2. Implement your resource handlers in `terraform_aws_cloudformationstack/handlers.py`
