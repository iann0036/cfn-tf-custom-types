...
1. Write the JSON schema describing your resource, `terraform-aws-efsmounttarget.json`
2. Implement your resource handlers in `terraform_aws_efsmounttarget/handlers.py`
