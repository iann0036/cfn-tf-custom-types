...
1. Write the JSON schema describing your resource, `terraform-aws-ssmassociation.json`
2. Implement your resource handlers in `terraform_aws_ssmassociation/handlers.py`
