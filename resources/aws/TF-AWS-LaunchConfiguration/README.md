# TF::AWS::LaunchConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-launchconfiguration.json`
2. Implement your resource handlers in `tf_aws_launchconfiguration/handlers.py`
