# TF::AWS::CloudfrontOriginAccessIdentity

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-cloudfrontoriginaccessidentity.json`
2. Implement your resource handlers in `tf_aws_cloudfrontoriginaccessidentity/handlers.py`
