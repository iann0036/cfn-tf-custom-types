...
1. Write the JSON schema describing your resource, `terraform-aws-customergateway.json`
2. Implement your resource handlers in `terraform_aws_customergateway/handlers.py`
