...
1. Write the JSON schema describing your resource, `terraform-aws-ssmdocument.json`
2. Implement your resource handlers in `terraform_aws_ssmdocument/handlers.py`
