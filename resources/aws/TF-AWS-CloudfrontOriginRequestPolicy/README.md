...
1. Write the JSON schema describing your resource, `tf-aws-cloudfrontoriginrequestpolicy.json`
2. Implement your resource handlers in `tf_aws_cloudfrontoriginrequestpolicy/handlers.py`
