...
1. Write the JSON schema describing your resource, `terraform-aws-dmsreplicationinstance.json`
2. Implement your resource handlers in `terraform_aws_dmsreplicationinstance/handlers.py`
