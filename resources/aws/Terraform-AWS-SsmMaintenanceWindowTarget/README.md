...
1. Write the JSON schema describing your resource, `terraform-aws-ssmmaintenancewindowtarget.json`
2. Implement your resource handlers in `terraform_aws_ssmmaintenancewindowtarget/handlers.py`
