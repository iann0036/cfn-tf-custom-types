...
1. Write the JSON schema describing your resource, `terraform-aws-mqconfiguration.json`
2. Implement your resource handlers in `terraform_aws_mqconfiguration/handlers.py`
