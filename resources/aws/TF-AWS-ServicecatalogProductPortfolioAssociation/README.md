...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogproductportfolioassociation.json`
2. Implement your resource handlers in `tf_aws_servicecatalogproductportfolioassociation/handlers.py`
