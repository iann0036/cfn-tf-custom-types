...
class ResourceModel(BaseModel):
    ...
    TargetDatabase: Optional[Sequence["_TargetDatabaseDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            TargetDatabase=deserialize_list(json_data.get("TargetDatabase"), TargetDatabaseDefinition),
        )
...
@dataclass
class TargetDatabaseDefinition(BaseModel):
    CatalogId: Optional[str]
    DatabaseName: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_TargetDatabaseDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_TargetDatabaseDefinition"]:
        if not json_data:
            return None
        return cls(
            CatalogId=json_data.get("CatalogId"),
...
# work around possible type aliasing issues when variable has same name as a model
_TargetDatabaseDefinition = TargetDatabaseDefinition
