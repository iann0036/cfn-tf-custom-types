...
1. Write the JSON schema describing your resource, `tf-aws-gluecatalogdatabase.json`
2. Implement your resource handlers in `tf_aws_gluecatalogdatabase/handlers.py`
