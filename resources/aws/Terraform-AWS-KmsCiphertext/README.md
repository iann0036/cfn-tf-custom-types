...
1. Write the JSON schema describing your resource, `terraform-aws-kmsciphertext.json`
2. Implement your resource handlers in `terraform_aws_kmsciphertext/handlers.py`
