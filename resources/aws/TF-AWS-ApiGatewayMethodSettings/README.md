...
1. Write the JSON schema describing your resource, `tf-aws-apigatewaymethodsettings.json`
2. Implement your resource handlers in `tf_aws_apigatewaymethodsettings/handlers.py`
