...
1. Write the JSON schema describing your resource, `terraform-aws-elasticacheparametergroup.json`
2. Implement your resource handlers in `terraform_aws_elasticacheparametergroup/handlers.py`
