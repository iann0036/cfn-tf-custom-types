...
1. Write the JSON schema describing your resource, `terraform-aws-elasticsearchdomainpolicy.json`
2. Implement your resource handlers in `terraform_aws_elasticsearchdomainpolicy/handlers.py`
