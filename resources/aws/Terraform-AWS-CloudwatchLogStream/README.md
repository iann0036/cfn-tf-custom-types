...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchlogstream.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchlogstream/handlers.py`
