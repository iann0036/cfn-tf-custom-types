# Terraform::AWS::Ec2TransitGatewayRouteTableAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-ec2transitgatewayroutetableassociation.json`
2. Implement your resource handlers in `terraform_aws_ec2transitgatewayroutetableassociation/handlers.py`
