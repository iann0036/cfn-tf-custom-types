...
1. Write the JSON schema describing your resource, `terraform-aws-configorganizationcustomrule.json`
2. Implement your resource handlers in `terraform_aws_configorganizationcustomrule/handlers.py`
