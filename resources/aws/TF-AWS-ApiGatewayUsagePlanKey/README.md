...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayusageplankey.json`
2. Implement your resource handlers in `tf_aws_apigatewayusageplankey/handlers.py`
