...
1. Write the JSON schema describing your resource, `terraform-aws-datasynclocationnfs.json`
2. Implement your resource handlers in `terraform_aws_datasynclocationnfs/handlers.py`
