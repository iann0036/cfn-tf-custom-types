...
1. Write the JSON schema describing your resource, `terraform-aws-redshiftparametergroup.json`
2. Implement your resource handlers in `terraform_aws_redshiftparametergroup/handlers.py`
