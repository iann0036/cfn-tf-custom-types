...
1. Write the JSON schema describing your resource, `tf-aws-autoscalingschedule.json`
2. Implement your resource handlers in `tf_aws_autoscalingschedule/handlers.py`
