...
1. Write the JSON schema describing your resource, `tf-aws-efsfilesystempolicy.json`
2. Implement your resource handlers in `tf_aws_efsfilesystempolicy/handlers.py`
