# TF::AWS::InternetGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-internetgateway.json`
2. Implement your resource handlers in `tf_aws_internetgateway/handlers.py`
