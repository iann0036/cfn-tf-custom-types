...
1. Write the JSON schema describing your resource, `terraform-aws-elasticachecluster.json`
2. Implement your resource handlers in `terraform_aws_elasticachecluster/handlers.py`
