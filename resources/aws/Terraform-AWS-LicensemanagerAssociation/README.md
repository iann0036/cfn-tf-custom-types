...
1. Write the JSON schema describing your resource, `terraform-aws-licensemanagerassociation.json`
2. Implement your resource handlers in `terraform_aws_licensemanagerassociation/handlers.py`
