...
1. Write the JSON schema describing your resource, `tf-aws-route53resolverfirewallconfig.json`
2. Implement your resource handlers in `tf_aws_route53resolverfirewallconfig/handlers.py`
