...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchlogresourcepolicy.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchlogresourcepolicy/handlers.py`
