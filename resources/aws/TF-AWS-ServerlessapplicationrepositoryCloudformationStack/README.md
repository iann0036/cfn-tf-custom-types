...
1. Write the JSON schema describing your resource, `tf-aws-serverlessapplicationrepositorycloudformationstack.json`
2. Implement your resource handlers in `tf_aws_serverlessapplicationrepositorycloudformationstack/handlers.py`
