...
1. Write the JSON schema describing your resource, `terraform-aws-ebsdefaultkmskey.json`
2. Implement your resource handlers in `terraform_aws_ebsdefaultkmskey/handlers.py`
