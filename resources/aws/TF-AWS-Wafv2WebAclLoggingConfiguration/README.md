# TF::AWS::Wafv2WebAclLoggingConfiguration

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-wafv2webaclloggingconfiguration.json`
2. Implement your resource handlers in `tf_aws_wafv2webaclloggingconfiguration/handlers.py`
