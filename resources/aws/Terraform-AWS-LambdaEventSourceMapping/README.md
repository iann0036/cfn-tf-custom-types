...
1. Write the JSON schema describing your resource, `terraform-aws-lambdaeventsourcemapping.json`
2. Implement your resource handlers in `terraform_aws_lambdaeventsourcemapping/handlers.py`
