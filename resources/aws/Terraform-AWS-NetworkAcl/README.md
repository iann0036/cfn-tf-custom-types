...
1. Write the JSON schema describing your resource, `terraform-aws-networkacl.json`
2. Implement your resource handlers in `terraform_aws_networkacl/handlers.py`
