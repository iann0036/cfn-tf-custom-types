...
1. Write the JSON schema describing your resource, `tf-aws-sagemakercoderepository.json`
2. Implement your resource handlers in `tf_aws_sagemakercoderepository/handlers.py`
