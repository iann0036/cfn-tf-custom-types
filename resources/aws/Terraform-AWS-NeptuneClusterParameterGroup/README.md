...
1. Write the JSON schema describing your resource, `terraform-aws-neptuneclusterparametergroup.json`
2. Implement your resource handlers in `terraform_aws_neptuneclusterparametergroup/handlers.py`
