...
1. Write the JSON schema describing your resource, `terraform-aws-gluetrigger.json`
2. Implement your resource handlers in `terraform_aws_gluetrigger/handlers.py`
