...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchlogmetricfilter.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchlogmetricfilter/handlers.py`
