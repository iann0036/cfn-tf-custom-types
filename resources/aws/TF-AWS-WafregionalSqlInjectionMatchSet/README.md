...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalsqlinjectionmatchset.json`
2. Implement your resource handlers in `tf_aws_wafregionalsqlinjectionmatchset/handlers.py`
