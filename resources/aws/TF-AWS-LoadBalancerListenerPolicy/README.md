...
1. Write the JSON schema describing your resource, `tf-aws-loadbalancerlistenerpolicy.json`
2. Implement your resource handlers in `tf_aws_loadbalancerlistenerpolicy/handlers.py`
