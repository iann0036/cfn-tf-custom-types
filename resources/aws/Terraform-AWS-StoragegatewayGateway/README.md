...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewaygateway.json`
2. Implement your resource handlers in `terraform_aws_storagegatewaygateway/handlers.py`
