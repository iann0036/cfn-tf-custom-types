...
1. Write the JSON schema describing your resource, `terraform-aws-dxgatewayassociation.json`
2. Implement your resource handlers in `terraform_aws_dxgatewayassociation/handlers.py`
