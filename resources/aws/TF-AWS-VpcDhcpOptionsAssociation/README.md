# TF::AWS::VpcDhcpOptionsAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-vpcdhcpoptionsassociation.json`
2. Implement your resource handlers in `tf_aws_vpcdhcpoptionsassociation/handlers.py`
