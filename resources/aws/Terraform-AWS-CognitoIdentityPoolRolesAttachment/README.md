...
1. Write the JSON schema describing your resource, `terraform-aws-cognitoidentitypoolrolesattachment.json`
2. Implement your resource handlers in `terraform_aws_cognitoidentitypoolrolesattachment/handlers.py`
