...
1. Write the JSON schema describing your resource, `tf-aws-lambdaeventsourcemapping.json`
2. Implement your resource handlers in `tf_aws_lambdaeventsourcemapping/handlers.py`
