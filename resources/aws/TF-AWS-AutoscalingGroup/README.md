...
1. Write the JSON schema describing your resource, `tf-aws-autoscalinggroup.json`
2. Implement your resource handlers in `tf_aws_autoscalinggroup/handlers.py`
