...
1. Write the JSON schema describing your resource, `tf-aws-signersigningprofile.json`
2. Implement your resource handlers in `tf_aws_signersigningprofile/handlers.py`
