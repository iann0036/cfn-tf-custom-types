...
1. Write the JSON schema describing your resource, `terraform-aws-mediastorecontainerpolicy.json`
2. Implement your resource handlers in `terraform_aws_mediastorecontainerpolicy/handlers.py`
