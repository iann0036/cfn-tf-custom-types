...
1. Write the JSON schema describing your resource, `terraform-aws-dxhostedprivatevirtualinterface.json`
2. Implement your resource handlers in `terraform_aws_dxhostedprivatevirtualinterface/handlers.py`
