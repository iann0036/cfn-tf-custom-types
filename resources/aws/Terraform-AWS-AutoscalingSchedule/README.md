...
1. Write the JSON schema describing your resource, `terraform-aws-autoscalingschedule.json`
2. Implement your resource handlers in `terraform_aws_autoscalingschedule/handlers.py`
