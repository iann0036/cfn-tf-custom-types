...
1. Write the JSON schema describing your resource, `tf-aws-appmeshvirtualgateway.json`
2. Implement your resource handlers in `tf_aws_appmeshvirtualgateway/handlers.py`
