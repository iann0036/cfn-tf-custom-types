...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatcheventrule.json`
2. Implement your resource handlers in `terraform_aws_cloudwatcheventrule/handlers.py`
