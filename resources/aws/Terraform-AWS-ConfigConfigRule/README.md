...
1. Write the JSON schema describing your resource, `terraform-aws-configconfigrule.json`
2. Implement your resource handlers in `terraform_aws_configconfigrule/handlers.py`
