...
1. Write the JSON schema describing your resource, `terraform-aws-backupselection.json`
2. Implement your resource handlers in `terraform_aws_backupselection/handlers.py`
