...
1. Write the JSON schema describing your resource, `terraform-aws-autoscalingpolicy.json`
2. Implement your resource handlers in `terraform_aws_autoscalingpolicy/handlers.py`
