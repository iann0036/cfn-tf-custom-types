...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_batch_compute_environment'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_batch_compute_environment'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
