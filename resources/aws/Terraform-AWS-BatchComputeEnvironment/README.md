...
1. Write the JSON schema describing your resource, `terraform-aws-batchcomputeenvironment.json`
2. Implement your resource handlers in `terraform_aws_batchcomputeenvironment/handlers.py`
