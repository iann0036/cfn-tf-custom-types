...
1. Write the JSON schema describing your resource, `terraform-aws-alblistener.json`
2. Implement your resource handlers in `terraform_aws_alblistener/handlers.py`
