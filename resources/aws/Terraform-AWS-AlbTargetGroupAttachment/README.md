# Terraform::AWS::AlbTargetGroupAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-albtargetgroupattachment.json`
2. Implement your resource handlers in `terraform_aws_albtargetgroupattachment/handlers.py`
