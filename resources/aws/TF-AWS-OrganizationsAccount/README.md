...
1. Write the JSON schema describing your resource, `tf-aws-organizationsaccount.json`
2. Implement your resource handlers in `tf_aws_organizationsaccount/handlers.py`
