...
1. Write the JSON schema describing your resource, `terraform-aws-iotrolealias.json`
2. Implement your resource handlers in `terraform_aws_iotrolealias/handlers.py`
