...
1. Write the JSON schema describing your resource, `tf-aws-pinpointsmschannel.json`
2. Implement your resource handlers in `tf_aws_pinpointsmschannel/handlers.py`
