...
1. Write the JSON schema describing your resource, `terraform-aws-iotpolicy.json`
2. Implement your resource handlers in `terraform_aws_iotpolicy/handlers.py`
