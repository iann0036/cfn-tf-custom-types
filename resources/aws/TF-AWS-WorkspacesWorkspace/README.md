...
1. Write the JSON schema describing your resource, `tf-aws-workspacesworkspace.json`
2. Implement your resource handlers in `tf_aws_workspacesworkspace/handlers.py`
