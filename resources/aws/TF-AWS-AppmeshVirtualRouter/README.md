...
1. Write the JSON schema describing your resource, `tf-aws-appmeshvirtualrouter.json`
2. Implement your resource handlers in `tf_aws_appmeshvirtualrouter/handlers.py`
