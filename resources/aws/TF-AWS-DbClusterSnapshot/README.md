...
1. Write the JSON schema describing your resource, `tf-aws-dbclustersnapshot.json`
2. Implement your resource handlers in `tf_aws_dbclustersnapshot/handlers.py`
