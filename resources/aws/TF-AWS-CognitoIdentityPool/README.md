...
1. Write the JSON schema describing your resource, `tf-aws-cognitoidentitypool.json`
2. Implement your resource handlers in `tf_aws_cognitoidentitypool/handlers.py`
