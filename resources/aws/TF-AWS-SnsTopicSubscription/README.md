...
1. Write the JSON schema describing your resource, `tf-aws-snstopicsubscription.json`
2. Implement your resource handlers in `tf_aws_snstopicsubscription/handlers.py`
