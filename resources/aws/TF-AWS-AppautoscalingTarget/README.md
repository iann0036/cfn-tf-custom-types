...
1. Write the JSON schema describing your resource, `tf-aws-appautoscalingtarget.json`
2. Implement your resource handlers in `tf_aws_appautoscalingtarget/handlers.py`
