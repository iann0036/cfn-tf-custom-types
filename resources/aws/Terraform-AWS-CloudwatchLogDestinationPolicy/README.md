...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchlogdestinationpolicy.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchlogdestinationpolicy/handlers.py`
