...
1. Write the JSON schema describing your resource, `terraform-aws-configdeliverychannel.json`
2. Implement your resource handlers in `terraform_aws_configdeliverychannel/handlers.py`
