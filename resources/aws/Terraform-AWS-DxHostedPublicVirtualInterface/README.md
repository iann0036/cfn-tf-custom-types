...
1. Write the JSON schema describing your resource, `terraform-aws-dxhostedpublicvirtualinterface.json`
2. Implement your resource handlers in `terraform_aws_dxhostedpublicvirtualinterface/handlers.py`
