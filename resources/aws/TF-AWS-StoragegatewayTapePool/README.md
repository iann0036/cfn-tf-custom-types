...
1. Write the JSON schema describing your resource, `tf-aws-storagegatewaytapepool.json`
2. Implement your resource handlers in `tf_aws_storagegatewaytapepool/handlers.py`
