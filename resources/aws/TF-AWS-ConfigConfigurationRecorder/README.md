...
1. Write the JSON schema describing your resource, `tf-aws-configconfigurationrecorder.json`
2. Implement your resource handlers in `tf_aws_configconfigurationrecorder/handlers.py`
