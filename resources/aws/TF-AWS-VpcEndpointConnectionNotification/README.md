...
1. Write the JSON schema describing your resource, `tf-aws-vpcendpointconnectionnotification.json`
2. Implement your resource handlers in `tf_aws_vpcendpointconnectionnotification/handlers.py`
