...
1. Write the JSON schema describing your resource, `terraform-aws-egressonlyinternetgateway.json`
2. Implement your resource handlers in `terraform_aws_egressonlyinternetgateway/handlers.py`
