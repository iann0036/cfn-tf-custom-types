...
1. Write the JSON schema describing your resource, `terraform-aws-lightsaildomain.json`
2. Implement your resource handlers in `terraform_aws_lightsaildomain/handlers.py`
