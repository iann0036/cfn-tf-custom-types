...
1. Write the JSON schema describing your resource, `terraform-aws-dmsreplicationtask.json`
2. Implement your resource handlers in `terraform_aws_dmsreplicationtask/handlers.py`
