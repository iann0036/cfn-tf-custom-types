...
1. Write the JSON schema describing your resource, `terraform-aws-organizationsaccount.json`
2. Implement your resource handlers in `terraform_aws_organizationsaccount/handlers.py`
