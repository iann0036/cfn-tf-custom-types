# TF::AWS::ConfigOrganizationCustomRule
...
~> **NOTE:** The proper Lambda permission to allow the AWS Config service invoke the Lambda Function must be in place before the rule will successfully create or update. See also the [`aws_lambda_permission` resource](/docs/p...
...
<pre>
{
    "Type" : "TF::AWS::ConfigOrganizationCustomRule",
    "Properties" : {
