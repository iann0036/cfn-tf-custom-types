...
1. Write the JSON schema describing your resource, `tf-aws-configorganizationcustomrule.json`
2. Implement your resource handlers in `tf_aws_configorganizationcustomrule/handlers.py`
