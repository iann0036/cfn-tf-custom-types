...
1. Write the JSON schema describing your resource, `terraform-aws-configconfigurationaggregator.json`
2. Implement your resource handlers in `terraform_aws_configconfigurationaggregator/handlers.py`
