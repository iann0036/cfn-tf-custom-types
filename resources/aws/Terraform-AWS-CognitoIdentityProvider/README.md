...
1. Write the JSON schema describing your resource, `terraform-aws-cognitoidentityprovider.json`
2. Implement your resource handlers in `terraform_aws_cognitoidentityprovider/handlers.py`
