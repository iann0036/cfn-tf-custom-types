...
1. Write the JSON schema describing your resource, `terraform-aws-elasticachesecuritygroup.json`
2. Implement your resource handlers in `terraform_aws_elasticachesecuritygroup/handlers.py`
