...
1. Write the JSON schema describing your resource, `terraform-aws-wafwebacl.json`
2. Implement your resource handlers in `terraform_aws_wafwebacl/handlers.py`
