...
1. Write the JSON schema describing your resource, `terraform-aws-lambdafunctioneventinvokeconfig.json`
2. Implement your resource handlers in `terraform_aws_lambdafunctioneventinvokeconfig/handlers.py`
