...
1. Write the JSON schema describing your resource, `terraform-aws-sagemakernotebookinstancelifecycleconfiguration.json`
2. Implement your resource handlers in `terraform_aws_sagemakernotebookinstancelifecycleconfiguration/handlers.py`
