...
1. Write the JSON schema describing your resource, `tf-aws-rdsclusterendpoint.json`
2. Implement your resource handlers in `tf_aws_rdsclusterendpoint/handlers.py`
