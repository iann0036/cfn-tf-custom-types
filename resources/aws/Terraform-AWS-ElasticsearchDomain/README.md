...
1. Write the JSON schema describing your resource, `terraform-aws-elasticsearchdomain.json`
2. Implement your resource handlers in `terraform_aws_elasticsearchdomain/handlers.py`
