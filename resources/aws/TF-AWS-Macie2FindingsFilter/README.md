...
1. Write the JSON schema describing your resource, `tf-aws-macie2findingsfilter.json`
2. Implement your resource handlers in `tf_aws_macie2findingsfilter/handlers.py`
