...
1. Write the JSON schema describing your resource, `terraform-aws-resourcegroupsgroup.json`
2. Implement your resource handlers in `terraform_aws_resourcegroupsgroup/handlers.py`
