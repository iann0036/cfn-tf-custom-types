...
1. Write the JSON schema describing your resource, `terraform-aws-gluecrawler.json`
2. Implement your resource handlers in `terraform_aws_gluecrawler/handlers.py`
