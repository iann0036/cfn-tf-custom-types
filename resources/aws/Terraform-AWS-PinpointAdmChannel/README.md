...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointadmchannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointadmchannel/handlers.py`
