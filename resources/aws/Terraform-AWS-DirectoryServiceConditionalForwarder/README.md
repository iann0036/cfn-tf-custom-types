...
1. Write the JSON schema describing your resource, `terraform-aws-directoryserviceconditionalforwarder.json`
2. Implement your resource handlers in `terraform_aws_directoryserviceconditionalforwarder/handlers.py`
