...
1. Write the JSON schema describing your resource, `terraform-aws-wafsqlinjectionmatchset.json`
2. Implement your resource handlers in `terraform_aws_wafsqlinjectionmatchset/handlers.py`
