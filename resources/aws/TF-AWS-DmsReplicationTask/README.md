...
1. Write the JSON schema describing your resource, `tf-aws-dmsreplicationtask.json`
2. Implement your resource handlers in `tf_aws_dmsreplicationtask/handlers.py`
