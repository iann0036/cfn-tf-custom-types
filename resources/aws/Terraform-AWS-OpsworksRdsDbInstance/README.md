...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksrdsdbinstance.json`
2. Implement your resource handlers in `terraform_aws_opsworksrdsdbinstance/handlers.py`
