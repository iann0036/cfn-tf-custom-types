# Terraform::AWS::ServiceDiscoveryHttpNamespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-servicediscoveryhttpnamespace.json`
2. Implement your resource handlers in `terraform_aws_servicediscoveryhttpnamespace/handlers.py`
