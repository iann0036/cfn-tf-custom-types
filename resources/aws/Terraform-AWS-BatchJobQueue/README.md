...
1. Write the JSON schema describing your resource, `terraform-aws-batchjobqueue.json`
2. Implement your resource handlers in `terraform_aws_batchjobqueue/handlers.py`
