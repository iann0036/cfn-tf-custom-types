...
1. Write the JSON schema describing your resource, `tf-aws-autoscalingnotification.json`
2. Implement your resource handlers in `tf_aws_autoscalingnotification/handlers.py`
