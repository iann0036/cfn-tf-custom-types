...
1. Write the JSON schema describing your resource, `terraform-aws-acmpcacertificateauthority.json`
2. Implement your resource handlers in `terraform_aws_acmpcacertificateauthority/handlers.py`
