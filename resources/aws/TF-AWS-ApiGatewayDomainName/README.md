...
1. Write the JSON schema describing your resource, `tf-aws-apigatewaydomainname.json`
2. Implement your resource handlers in `tf_aws_apigatewaydomainname/handlers.py`
