...
1. Write the JSON schema describing your resource, `tf-aws-autoscalingplansscalingplan.json`
2. Implement your resource handlers in `tf_aws_autoscalingplansscalingplan/handlers.py`
