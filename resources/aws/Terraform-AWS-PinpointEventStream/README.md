...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointeventstream.json`
2. Implement your resource handlers in `terraform_aws_pinpointeventstream/handlers.py`
