...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchquerydefinition.json`
2. Implement your resource handlers in `tf_aws_cloudwatchquerydefinition/handlers.py`
