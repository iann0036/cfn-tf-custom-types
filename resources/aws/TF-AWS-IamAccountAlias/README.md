# TF::AWS::IamAccountAlias

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-iamaccountalias.json`
2. Implement your resource handlers in `tf_aws_iamaccountalias/handlers.py`
