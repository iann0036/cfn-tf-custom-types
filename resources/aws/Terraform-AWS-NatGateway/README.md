...
1. Write the JSON schema describing your resource, `terraform-aws-natgateway.json`
2. Implement your resource handlers in `terraform_aws_natgateway/handlers.py`
