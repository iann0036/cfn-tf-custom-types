...
1. Write the JSON schema describing your resource, `terraform-aws-gameliftfleet.json`
2. Implement your resource handlers in `terraform_aws_gameliftfleet/handlers.py`
