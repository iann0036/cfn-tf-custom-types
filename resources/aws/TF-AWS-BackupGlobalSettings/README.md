# TF::AWS::BackupGlobalSettings

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-backupglobalsettings.json`
2. Implement your resource handlers in `tf_aws_backupglobalsettings/handlers.py`
