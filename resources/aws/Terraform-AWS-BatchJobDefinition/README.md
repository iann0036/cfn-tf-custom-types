...
1. Write the JSON schema describing your resource, `terraform-aws-batchjobdefinition.json`
2. Implement your resource handlers in `terraform_aws_batchjobdefinition/handlers.py`
