...
1. Write the JSON schema describing your resource, `terraform-aws-ebsvolume.json`
2. Implement your resource handlers in `terraform_aws_ebsvolume/handlers.py`
