...
1. Write the JSON schema describing your resource, `tf-aws-batchjobdefinition.json`
2. Implement your resource handlers in `tf_aws_batchjobdefinition/handlers.py`
