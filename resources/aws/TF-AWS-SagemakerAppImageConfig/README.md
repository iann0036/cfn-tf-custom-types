...
1. Write the JSON schema describing your resource, `tf-aws-sagemakerappimageconfig.json`
2. Implement your resource handlers in `tf_aws_sagemakerappimageconfig/handlers.py`
