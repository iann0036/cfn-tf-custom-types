...
1. Write the JSON schema describing your resource, `terraform-aws-servicediscoveryprivatednsnamespace.json`
2. Implement your resource handlers in `terraform_aws_servicediscoveryprivatednsnamespace/handlers.py`
