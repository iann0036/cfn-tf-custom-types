# TF::AWS::Ec2TrafficMirrorFilter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-ec2trafficmirrorfilter.json`
2. Implement your resource handlers in `tf_aws_ec2trafficmirrorfilter/handlers.py`
