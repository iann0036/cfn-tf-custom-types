...
1. Write the JSON schema describing your resource, `terraform-aws-redshiftcluster.json`
2. Implement your resource handlers in `terraform_aws_redshiftcluster/handlers.py`
