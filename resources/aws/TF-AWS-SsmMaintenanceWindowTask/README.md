...
1. Write the JSON schema describing your resource, `tf-aws-ssmmaintenancewindowtask.json`
2. Implement your resource handlers in `tf_aws_ssmmaintenancewindowtask/handlers.py`
