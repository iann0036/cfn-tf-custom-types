...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayv2api.json`
2. Implement your resource handlers in `terraform_aws_apigatewayv2api/handlers.py`
