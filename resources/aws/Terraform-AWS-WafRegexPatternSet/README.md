...
1. Write the JSON schema describing your resource, `terraform-aws-wafregexpatternset.json`
2. Implement your resource handlers in `terraform_aws_wafregexpatternset/handlers.py`
