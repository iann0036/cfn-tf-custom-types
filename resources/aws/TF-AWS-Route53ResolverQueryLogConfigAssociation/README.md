# TF::AWS::Route53ResolverQueryLogConfigAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-route53resolverquerylogconfigassociation.json`
2. Implement your resource handlers in `tf_aws_route53resolverquerylogconfigassociation/handlers.py`
