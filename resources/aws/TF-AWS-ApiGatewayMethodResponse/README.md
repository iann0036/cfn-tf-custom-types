...
1. Write the JSON schema describing your resource, `tf-aws-apigatewaymethodresponse.json`
2. Implement your resource handlers in `tf_aws_apigatewaymethodresponse/handlers.py`
