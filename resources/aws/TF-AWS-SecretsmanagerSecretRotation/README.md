...
1. Write the JSON schema describing your resource, `tf-aws-secretsmanagersecretrotation.json`
2. Implement your resource handlers in `tf_aws_secretsmanagersecretrotation/handlers.py`
