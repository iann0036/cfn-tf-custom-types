...
1. Write the JSON schema describing your resource, `tf-aws-storagegatewaynfsfileshare.json`
2. Implement your resource handlers in `tf_aws_storagegatewaynfsfileshare/handlers.py`
