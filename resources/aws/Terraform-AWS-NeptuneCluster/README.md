...
1. Write the JSON schema describing your resource, `terraform-aws-neptunecluster.json`
2. Implement your resource handlers in `terraform_aws_neptunecluster/handlers.py`
