...
1. Write the JSON schema describing your resource, `tf-aws-sagemakernotebookinstance.json`
2. Implement your resource handlers in `tf_aws_sagemakernotebookinstance/handlers.py`
