...
1. Write the JSON schema describing your resource, `tf-aws-mediaconvertqueue.json`
2. Implement your resource handlers in `tf_aws_mediaconvertqueue/handlers.py`
