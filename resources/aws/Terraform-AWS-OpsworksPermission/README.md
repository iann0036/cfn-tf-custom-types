...
1. Write the JSON schema describing your resource, `terraform-aws-opsworkspermission.json`
2. Implement your resource handlers in `terraform_aws_opsworkspermission/handlers.py`
