...
1. Write the JSON schema describing your resource, `terraform-aws-sesactivereceiptruleset.json`
2. Implement your resource handlers in `terraform_aws_sesactivereceiptruleset/handlers.py`
