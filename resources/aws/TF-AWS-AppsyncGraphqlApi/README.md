...
1. Write the JSON schema describing your resource, `tf-aws-appsyncgraphqlapi.json`
2. Implement your resource handlers in `tf_aws_appsyncgraphqlapi/handlers.py`
