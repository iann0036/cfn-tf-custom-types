...
1. Write the JSON schema describing your resource, `terraform-aws-kmsexternalkey.json`
2. Implement your resource handlers in `terraform_aws_kmsexternalkey/handlers.py`
