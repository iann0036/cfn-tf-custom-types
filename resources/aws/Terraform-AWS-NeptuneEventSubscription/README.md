...
1. Write the JSON schema describing your resource, `terraform-aws-neptuneeventsubscription.json`
2. Implement your resource handlers in `terraform_aws_neptuneeventsubscription/handlers.py`
