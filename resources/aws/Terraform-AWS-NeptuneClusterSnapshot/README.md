...
1. Write the JSON schema describing your resource, `terraform-aws-neptuneclustersnapshot.json`
2. Implement your resource handlers in `terraform_aws_neptuneclustersnapshot/handlers.py`
