...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_db_instance/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Address", "Arn", "Endpoint", "HostedZoneId", "Id", "LatestRestorableTime", "Replicas", "ResourceId", "Status"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_db_instance/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/aws_db_instance/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Address=None, AllocatedStorage=None, AllowMajorVersionUpgrade=None, ApplyImmediately=None, Arn=None, AutoMinorVersionUpgrade=None, AvailabilityZone=None, BackupRetentionPeriod=None, BackupWindow=None, CaCertIdentifier=None, CharacterSetName=None, CopyTagsToSnapshot=None, DbSubnetGroupName=None, DeleteAutomatedBackups=None, DeletionProtection=None, Domain=None, DomainIamRoleName=None, EnabledCloudwatchLogsExports=None, Endpoint=None, Engine=None, EngineVersion=None, FinalSnapshotIdentifier=None, HostedZoneId=None, IamDatabaseAuthenticationEnabled=None, Id=None, Identifier=None, IdentifierPrefix=None, InstanceClass=None, Iops=None, KmsKeyId=None, LatestRestorableTime=None, LicenseModel=None, MaintenanceWindow=None, MaxAllocatedStorage=None, MonitoringInterval=None, MonitoringRoleArn=None, MultiAz=None, Name=None, OptionGroupName=None, ParameterGroupName=None, Password=None, PerformanceInsightsEnabled=None, PerformanceInsightsKmsKeyId=None, PerformanceInsightsRetentionPeriod=None, Port=None, PubliclyAccessible=None, Replicas=None, ReplicateSourceDb=None, ResourceId=None, SecurityGroupNames=None, SkipFinalSnapshot=None, SnapshotIdentifier=None, Status=None, StorageEncrypted=None, StorageType=None, Tags=None, TagsAll=None, Timezone=None, Username=None, VpcSecurityGroupIds=None, RestoreToPointInTime=None, S3Import=None, Timeouts=None)
