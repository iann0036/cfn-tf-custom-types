...
1. Write the JSON schema describing your resource, `tf-aws-loadbalancerpolicy.json`
2. Implement your resource handlers in `tf_aws_loadbalancerpolicy/handlers.py`
