...
1. Write the JSON schema describing your resource, `terraform-aws-iotcertificate.json`
2. Implement your resource handlers in `terraform_aws_iotcertificate/handlers.py`
