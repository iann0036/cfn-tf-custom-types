...
1. Write the JSON schema describing your resource, `terraform-aws-kinesisanalyticsapplication.json`
2. Implement your resource handlers in `terraform_aws_kinesisanalyticsapplication/handlers.py`
