...
1. Write the JSON schema describing your resource, `tf-aws-acmpcacertificateauthoritycertificate.json`
2. Implement your resource handlers in `tf_aws_acmpcacertificateauthoritycertificate/handlers.py`
