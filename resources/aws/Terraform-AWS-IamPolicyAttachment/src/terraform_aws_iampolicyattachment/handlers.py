...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_iam_policy_attachment'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_iam_policy_attachment'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
