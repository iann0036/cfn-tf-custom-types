...
1. Write the JSON schema describing your resource, `terraform-aws-iampolicyattachment.json`
2. Implement your resource handlers in `terraform_aws_iampolicyattachment/handlers.py`
