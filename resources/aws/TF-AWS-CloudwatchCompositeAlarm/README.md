...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchcompositealarm.json`
2. Implement your resource handlers in `tf_aws_cloudwatchcompositealarm/handlers.py`
