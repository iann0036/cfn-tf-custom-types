...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayresource.json`
2. Implement your resource handlers in `terraform_aws_apigatewayresource/handlers.py`
