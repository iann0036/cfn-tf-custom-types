...
1. Write the JSON schema describing your resource, `terraform-aws-sesemailidentity.json`
2. Implement your resource handlers in `terraform_aws_sesemailidentity/handlers.py`
