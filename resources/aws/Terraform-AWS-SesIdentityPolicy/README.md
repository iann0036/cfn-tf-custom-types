...
1. Write the JSON schema describing your resource, `terraform-aws-sesidentitypolicy.json`
2. Implement your resource handlers in `terraform_aws_sesidentitypolicy/handlers.py`
