...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewaynfsfileshare.json`
2. Implement your resource handlers in `terraform_aws_storagegatewaynfsfileshare/handlers.py`
