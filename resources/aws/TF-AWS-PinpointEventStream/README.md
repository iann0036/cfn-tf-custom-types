...
1. Write the JSON schema describing your resource, `tf-aws-pinpointeventstream.json`
2. Implement your resource handlers in `tf_aws_pinpointeventstream/handlers.py`
