...
1. Write the JSON schema describing your resource, `tf-aws-configconformancepack.json`
2. Implement your resource handlers in `tf_aws_configconformancepack/handlers.py`
