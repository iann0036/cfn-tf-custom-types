...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalgeomatchset.json`
2. Implement your resource handlers in `tf_aws_wafregionalgeomatchset/handlers.py`
