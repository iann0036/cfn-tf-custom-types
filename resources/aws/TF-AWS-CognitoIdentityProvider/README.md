...
1. Write the JSON schema describing your resource, `tf-aws-cognitoidentityprovider.json`
2. Implement your resource handlers in `tf_aws_cognitoidentityprovider/handlers.py`
