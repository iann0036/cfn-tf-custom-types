...
1. Write the JSON schema describing your resource, `tf-aws-cloudfrontdistribution.json`
2. Implement your resource handlers in `tf_aws_cloudfrontdistribution/handlers.py`
