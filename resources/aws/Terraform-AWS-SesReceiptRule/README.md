...
1. Write the JSON schema describing your resource, `terraform-aws-sesreceiptrule.json`
2. Implement your resource handlers in `terraform_aws_sesreceiptrule/handlers.py`
