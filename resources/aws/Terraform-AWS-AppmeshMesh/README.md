...
1. Write the JSON schema describing your resource, `terraform-aws-appmeshmesh.json`
2. Implement your resource handlers in `terraform_aws_appmeshmesh/handlers.py`
