...
1. Write the JSON schema describing your resource, `tf-aws-guarddutyorganizationadminaccount.json`
2. Implement your resource handlers in `tf_aws_guarddutyorganizationadminaccount/handlers.py`
