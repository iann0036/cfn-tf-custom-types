...
1. Write the JSON schema describing your resource, `terraform-aws-ekscluster.json`
2. Implement your resource handlers in `terraform_aws_ekscluster/handlers.py`
