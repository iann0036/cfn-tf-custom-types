...
1. Write the JSON schema describing your resource, `tf-aws-autoscalinglifecyclehook.json`
2. Implement your resource handlers in `tf_aws_autoscalinglifecyclehook/handlers.py`
