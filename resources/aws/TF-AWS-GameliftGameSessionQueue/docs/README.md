# TF::AWS::GameliftGameSessionQueue
...
<pre>
{
    "Type" : "TF::AWS::GameliftGameSessionQueue",
    "Properties" : {
        ...
        "<a href="#playerlatencypolicy" title="PlayerLatencyPolicy">PlayerLatencyPolicy</a>" : <i>[ <a href="playerlatencypolicydefinition.md">PlayerLatencyPolicyDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#playerlatencypolicy" title="PlayerLatencyPolicy">PlayerLatencyPolicy</a>: <i>
      - <a href="playerlatencypolicydefinition.md">PlayerLatencyPolicyDefinition</a></i>
</pre>
...
_Type_: List of <a href="playerlatencypolicydefinition.md">PlayerLatencyPolicyDefinition</a>
