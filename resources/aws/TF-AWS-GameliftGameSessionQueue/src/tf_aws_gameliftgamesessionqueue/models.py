...
class ResourceModel(BaseModel):
    ...
    PlayerLatencyPolicy: Optional[Sequence["_PlayerLatencyPolicyDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PlayerLatencyPolicy=deserialize_list(json_data.get("PlayerLatencyPolicy"), PlayerLatencyPolicyDefinition),
        )
...
@dataclass
class PlayerLatencyPolicyDefinition(BaseModel):
    MaximumIndividualPlayerLatencyMilliseconds: Optional[float]
    PolicyDurationSeconds: Optional[float]

    @classmethod
    def _deserialize(
        cls: Type["_PlayerLatencyPolicyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_PlayerLatencyPolicyDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_PlayerLatencyPolicyDefinition = PlayerLatencyPolicyDefinition
