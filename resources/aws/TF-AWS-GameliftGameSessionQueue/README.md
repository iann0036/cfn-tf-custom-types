...
1. Write the JSON schema describing your resource, `tf-aws-gameliftgamesessionqueue.json`
2. Implement your resource handlers in `tf_aws_gameliftgamesessionqueue/handlers.py`
