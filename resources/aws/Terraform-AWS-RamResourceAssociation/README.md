...
1. Write the JSON schema describing your resource, `terraform-aws-ramresourceassociation.json`
2. Implement your resource handlers in `terraform_aws_ramresourceassociation/handlers.py`
