...
1. Write the JSON schema describing your resource, `terraform-aws-appsyncapikey.json`
2. Implement your resource handlers in `terraform_aws_appsyncapikey/handlers.py`
