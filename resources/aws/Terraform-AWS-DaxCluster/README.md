...
1. Write the JSON schema describing your resource, `terraform-aws-daxcluster.json`
2. Implement your resource handlers in `terraform_aws_daxcluster/handlers.py`
