...
1. Write the JSON schema describing your resource, `tf-aws-iamaccountpasswordpolicy.json`
2. Implement your resource handlers in `tf_aws_iamaccountpasswordpolicy/handlers.py`
