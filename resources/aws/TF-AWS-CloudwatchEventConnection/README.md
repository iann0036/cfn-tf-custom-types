...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatcheventconnection.json`
2. Implement your resource handlers in `tf_aws_cloudwatcheventconnection/handlers.py`
