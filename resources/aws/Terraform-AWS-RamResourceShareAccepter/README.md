...
1. Write the JSON schema describing your resource, `terraform-aws-ramresourceshareaccepter.json`
2. Implement your resource handlers in `terraform_aws_ramresourceshareaccepter/handlers.py`
