...
1. Write the JSON schema describing your resource, `terraform-aws-securityhubstandardssubscription.json`
2. Implement your resource handlers in `terraform_aws_securityhubstandardssubscription/handlers.py`
