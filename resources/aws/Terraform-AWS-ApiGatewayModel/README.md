...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaymodel.json`
2. Implement your resource handlers in `terraform_aws_apigatewaymodel/handlers.py`
