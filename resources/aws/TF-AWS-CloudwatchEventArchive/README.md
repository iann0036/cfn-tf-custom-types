...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatcheventarchive.json`
2. Implement your resource handlers in `tf_aws_cloudwatcheventarchive/handlers.py`
