...
1. Write the JSON schema describing your resource, `tf-aws-macie2classificationjob.json`
2. Implement your resource handlers in `tf_aws_macie2classificationjob/handlers.py`
