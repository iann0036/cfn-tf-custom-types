...
1. Write the JSON schema describing your resource, `terraform-aws-dxhostedprivatevirtualinterfaceaccepter.json`
2. Implement your resource handlers in `terraform_aws_dxhostedprivatevirtualinterfaceaccepter/handlers.py`
