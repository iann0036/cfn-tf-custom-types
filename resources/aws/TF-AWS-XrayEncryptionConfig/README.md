...
1. Write the JSON schema describing your resource, `tf-aws-xrayencryptionconfig.json`
2. Implement your resource handlers in `tf_aws_xrayencryptionconfig/handlers.py`
