...
TYPE_NAME = "TF::AWS::SpotInstanceRequest"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_spot_instance_request/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
    ...
    try:
        ...
        lambdaclient.invoke(
            ...
            Payload=json.dumps({
                ...
                'returnValues': ["Arn", "Id", "InstanceState", "OutpostArn", "PasswordData", "PrimaryNetworkInterfaceId", "PrivateDns", "PublicDns", "PublicIp", "SpotBidStatus", "SpotInstanceId", "SpotRequestState"],
            }).encode(),
        )
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_spot_instance_request/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/aws_spot_instance_request/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), Ami=None, Arn=None, AssociatePublicIpAddress=None, AvailabilityZone=None, BlockDurationMinutes=None, CpuCoreCount=None, CpuThreadsPerCore=None, DisableApiTermination=None, EbsOptimized=None, GetPasswordData=None, Hibernation=None, HostId=None, IamInstanceProfile=None, Id=None, InstanceInitiatedShutdownBehavior=None, InstanceInterruptionBehaviour=None, InstanceState=None, InstanceType=None, Ipv6AddressCount=None, Ipv6Addresses=None, KeyName=None, LaunchGroup=None, Monitoring=None, OutpostArn=None, PasswordData=None, PlacementGroup=None, PrimaryNetworkInterfaceId=None, PrivateDns=None, PrivateIp=None, PublicDns=None, PublicIp=None, SecondaryPrivateIps=None, SecurityGroups=None, SourceDestCheck=None, SpotBidStatus=None, SpotInstanceId=None, SpotPrice=None, SpotRequestState=None, SpotType=None, SubnetId=None, Tags=None, TagsAll=None, Tenancy=None, UserData=None, UserDataBase64=None, ValidFrom=None, ValidUntil=None, VolumeTags=None, VpcSecurityGroupIds=None, WaitForFulfillment=None, CapacityReservationSpecification=None, CreditSpecification=None, EbsBlockDevice=None, EnclaveOptions=None, EphemeralBlockDevice=None, MetadataOptions=None, NetworkInterface=None, RootBlockDevice=None, Timeouts=None)
