# Terraform::AWS::QldbLedger

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-qldbledger.json`
2. Implement your resource handlers in `terraform_aws_qldbledger/handlers.py`
