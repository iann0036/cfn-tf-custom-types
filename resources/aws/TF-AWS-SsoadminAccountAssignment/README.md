...
1. Write the JSON schema describing your resource, `tf-aws-ssoadminaccountassignment.json`
2. Implement your resource handlers in `tf_aws_ssoadminaccountassignment/handlers.py`
