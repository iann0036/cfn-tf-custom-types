...
1. Write the JSON schema describing your resource, `terraform-aws-iamrolepolicyattachment.json`
2. Implement your resource handlers in `terraform_aws_iamrolepolicyattachment/handlers.py`
