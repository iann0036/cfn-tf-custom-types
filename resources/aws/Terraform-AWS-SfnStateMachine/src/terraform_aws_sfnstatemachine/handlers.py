...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_sfn_state_machine'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_sfn_state_machine'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
