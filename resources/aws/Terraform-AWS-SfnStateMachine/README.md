...
1. Write the JSON schema describing your resource, `terraform-aws-sfnstatemachine.json`
2. Implement your resource handlers in `terraform_aws_sfnstatemachine/handlers.py`
