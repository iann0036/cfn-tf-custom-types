...
1. Write the JSON schema describing your resource, `terraform-aws-sesdomainidentity.json`
2. Implement your resource handlers in `terraform_aws_sesdomainidentity/handlers.py`
