...
1. Write the JSON schema describing your resource, `terraform-aws-iottopicrule.json`
2. Implement your resource handlers in `terraform_aws_iottopicrule/handlers.py`
