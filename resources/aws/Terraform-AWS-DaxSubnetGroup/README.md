...
1. Write the JSON schema describing your resource, `terraform-aws-daxsubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_daxsubnetgroup/handlers.py`
