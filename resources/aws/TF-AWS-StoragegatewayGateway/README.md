...
1. Write the JSON schema describing your resource, `tf-aws-storagegatewaygateway.json`
2. Implement your resource handlers in `tf_aws_storagegatewaygateway/handlers.py`
