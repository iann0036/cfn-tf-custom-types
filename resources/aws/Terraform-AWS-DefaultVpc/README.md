...
1. Write the JSON schema describing your resource, `terraform-aws-defaultvpc.json`
2. Implement your resource handlers in `terraform_aws_defaultvpc/handlers.py`
