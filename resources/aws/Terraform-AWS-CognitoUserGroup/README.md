...
1. Write the JSON schema describing your resource, `terraform-aws-cognitousergroup.json`
2. Implement your resource handlers in `terraform_aws_cognitousergroup/handlers.py`
