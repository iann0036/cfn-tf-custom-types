...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointapp.json`
2. Implement your resource handlers in `terraform_aws_pinpointapp/handlers.py`
