...
1. Write the JSON schema describing your resource, `terraform-aws-transferserver.json`
2. Implement your resource handlers in `terraform_aws_transferserver/handlers.py`
