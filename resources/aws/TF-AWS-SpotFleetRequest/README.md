...
1. Write the JSON schema describing your resource, `tf-aws-spotfleetrequest.json`
2. Implement your resource handlers in `tf_aws_spotfleetrequest/handlers.py`
