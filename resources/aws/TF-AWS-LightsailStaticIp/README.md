...
1. Write the JSON schema describing your resource, `tf-aws-lightsailstaticip.json`
2. Implement your resource handlers in `tf_aws_lightsailstaticip/handlers.py`
