...
1. Write the JSON schema describing your resource, `terraform-aws-quicksightuser.json`
2. Implement your resource handlers in `terraform_aws_quicksightuser/handlers.py`
