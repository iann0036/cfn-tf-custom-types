# TF::AWS::VpcIpv4CidrBlockAssociation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-vpcipv4cidrblockassociation.json`
2. Implement your resource handlers in `tf_aws_vpcipv4cidrblockassociation/handlers.py`
