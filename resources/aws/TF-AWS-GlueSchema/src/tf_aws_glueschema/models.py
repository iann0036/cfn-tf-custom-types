...
class ResourceModel(BaseModel):
    ...
    Id: Optional[str]
    LatestSchemaVersion: Optional[float]
    NextSchemaVersion: Optional[float]
    RegistryArn: Optional[str]
    RegistryName: Optional[str]
    SchemaCheckpoint: Optional[float]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Id=json_data.get("Id"),
            LatestSchemaVersion=json_data.get("LatestSchemaVersion"),
            NextSchemaVersion=json_data.get("NextSchemaVersion"),
            RegistryArn=json_data.get("RegistryArn"),
            RegistryName=json_data.get("RegistryName"),
            SchemaCheckpoint=json_data.get("SchemaCheckpoint"),
