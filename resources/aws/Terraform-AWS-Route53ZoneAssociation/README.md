...
1. Write the JSON schema describing your resource, `terraform-aws-route53zoneassociation.json`
2. Implement your resource handlers in `terraform_aws_route53zoneassociation/handlers.py`
