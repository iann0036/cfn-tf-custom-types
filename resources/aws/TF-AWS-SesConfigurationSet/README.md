...
1. Write the JSON schema describing your resource, `tf-aws-sesconfigurationset.json`
2. Implement your resource handlers in `tf_aws_sesconfigurationset/handlers.py`
