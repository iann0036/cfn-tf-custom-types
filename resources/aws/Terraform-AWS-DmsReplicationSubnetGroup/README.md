...
1. Write the JSON schema describing your resource, `terraform-aws-dmsreplicationsubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_dmsreplicationsubnetgroup/handlers.py`
