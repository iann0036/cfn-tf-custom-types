...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayrestapipolicy.json`
2. Implement your resource handlers in `tf_aws_apigatewayrestapipolicy/handlers.py`
