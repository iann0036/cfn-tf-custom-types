...
1. Write the JSON schema describing your resource, `terraform-aws-backupvault.json`
2. Implement your resource handlers in `terraform_aws_backupvault/handlers.py`
