...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatcheventtarget.json`
2. Implement your resource handlers in `terraform_aws_cloudwatcheventtarget/handlers.py`
