...
1. Write the JSON schema describing your resource, `terraform-aws-iamrolepolicy.json`
2. Implement your resource handlers in `terraform_aws_iamrolepolicy/handlers.py`
