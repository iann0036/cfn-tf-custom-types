...
1. Write the JSON schema describing your resource, `terraform-aws-curreportdefinition.json`
2. Implement your resource handlers in `terraform_aws_curreportdefinition/handlers.py`
