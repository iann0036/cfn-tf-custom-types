...
1. Write the JSON schema describing your resource, `tf-aws-servicediscoveryservice.json`
2. Implement your resource handlers in `tf_aws_servicediscoveryservice/handlers.py`
