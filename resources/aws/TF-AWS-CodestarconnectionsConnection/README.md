...
1. Write the JSON schema describing your resource, `tf-aws-codestarconnectionsconnection.json`
2. Implement your resource handlers in `tf_aws_codestarconnectionsconnection/handlers.py`
