...
1. Write the JSON schema describing your resource, `terraform-aws-datasynclocationefs.json`
2. Implement your resource handlers in `terraform_aws_datasynclocationefs/handlers.py`
