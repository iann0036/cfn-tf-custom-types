...
1. Write the JSON schema describing your resource, `terraform-aws-s3bucketmetric.json`
2. Implement your resource handlers in `terraform_aws_s3bucketmetric/handlers.py`
