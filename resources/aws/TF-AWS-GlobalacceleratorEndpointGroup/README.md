...
1. Write the JSON schema describing your resource, `tf-aws-globalacceleratorendpointgroup.json`
2. Implement your resource handlers in `tf_aws_globalacceleratorendpointgroup/handlers.py`
