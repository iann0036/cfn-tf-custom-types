...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalsizeconstraintset.json`
2. Implement your resource handlers in `tf_aws_wafregionalsizeconstraintset/handlers.py`
