...
1. Write the JSON schema describing your resource, `tf-aws-defaultsecuritygroup.json`
2. Implement your resource handlers in `tf_aws_defaultsecuritygroup/handlers.py`
