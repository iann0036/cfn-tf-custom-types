...
1. Write the JSON schema describing your resource, `tf-aws-codedeploydeploymentgroup.json`
2. Implement your resource handlers in `tf_aws_codedeploydeploymentgroup/handlers.py`
