...
1. Write the JSON schema describing your resource, `terraform-aws-servicediscoveryservice.json`
2. Implement your resource handlers in `terraform_aws_servicediscoveryservice/handlers.py`
