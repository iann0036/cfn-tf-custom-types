...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointemailchannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointemailchannel/handlers.py`
