...
class ResourceModel(BaseModel):
    ...
    AutoDeployment: Optional[Sequence["_AutoDeploymentDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            AutoDeployment=deserialize_list(json_data.get("AutoDeployment"), AutoDeploymentDefinition),
...
@dataclass
class AutoDeploymentDefinition(BaseModel):
    Enabled: Optional[bool]
    RetainStacksOnAccountRemoval: Optional[bool]

    @classmethod
    def _deserialize(
        cls: Type["_AutoDeploymentDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AutoDeploymentDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AutoDeploymentDefinition = AutoDeploymentDefinition
