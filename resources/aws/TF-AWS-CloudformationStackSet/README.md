...
1. Write the JSON schema describing your resource, `tf-aws-cloudformationstackset.json`
2. Implement your resource handlers in `tf_aws_cloudformationstackset/handlers.py`
