# TF::AWS::RedshiftSubnetGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-redshiftsubnetgroup.json`
2. Implement your resource handlers in `tf_aws_redshiftsubnetgroup/handlers.py`
