...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointsmschannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointsmschannel/handlers.py`
