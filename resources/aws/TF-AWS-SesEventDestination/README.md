...
1. Write the JSON schema describing your resource, `tf-aws-seseventdestination.json`
2. Implement your resource handlers in `tf_aws_seseventdestination/handlers.py`
