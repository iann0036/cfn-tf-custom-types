# TF::AWS::LightsailInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-lightsailinstance.json`
2. Implement your resource handlers in `tf_aws_lightsailinstance/handlers.py`
