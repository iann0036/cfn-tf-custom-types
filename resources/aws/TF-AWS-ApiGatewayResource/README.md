...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayresource.json`
2. Implement your resource handlers in `tf_aws_apigatewayresource/handlers.py`
