...
1. Write the JSON schema describing your resource, `tf-aws-organizationsorganization.json`
2. Implement your resource handlers in `tf_aws_organizationsorganization/handlers.py`
