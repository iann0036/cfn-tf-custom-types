...
1. Write the JSON schema describing your resource, `tf-aws-opsworksjavaapplayer.json`
2. Implement your resource handlers in `tf_aws_opsworksjavaapplayer/handlers.py`
