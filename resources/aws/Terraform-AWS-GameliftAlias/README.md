...
1. Write the JSON schema describing your resource, `terraform-aws-gameliftalias.json`
2. Implement your resource handlers in `terraform_aws_gameliftalias/handlers.py`
