...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksmysqllayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksmysqllayer/handlers.py`
