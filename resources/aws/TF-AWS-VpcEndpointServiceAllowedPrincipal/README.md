...
1. Write the JSON schema describing your resource, `tf-aws-vpcendpointserviceallowedprincipal.json`
2. Implement your resource handlers in `tf_aws_vpcendpointserviceallowedprincipal/handlers.py`
