...
1. Write the JSON schema describing your resource, `terraform-aws-docdbsubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_docdbsubnetgroup/handlers.py`
