...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksphpapplayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksphpapplayer/handlers.py`
