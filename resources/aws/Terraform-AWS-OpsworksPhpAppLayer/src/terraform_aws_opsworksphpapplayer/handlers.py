...
def create_handler(
    ...
    try:
        ...
        tf['resource']['aws_opsworks_php_app_layer'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['aws_opsworks_php_app_layer'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
