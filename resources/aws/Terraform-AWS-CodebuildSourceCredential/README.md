...
1. Write the JSON schema describing your resource, `terraform-aws-codebuildsourcecredential.json`
2. Implement your resource handlers in `terraform_aws_codebuildsourcecredential/handlers.py`
