# TF::AWS::DefaultVpcDhcpOptions

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-defaultvpcdhcpoptions.json`
2. Implement your resource handlers in `tf_aws_defaultvpcdhcpoptions/handlers.py`
