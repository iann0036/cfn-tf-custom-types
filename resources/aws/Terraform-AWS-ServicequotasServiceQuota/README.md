...
1. Write the JSON schema describing your resource, `terraform-aws-servicequotasservicequota.json`
2. Implement your resource handlers in `terraform_aws_servicequotasservicequota/handlers.py`
