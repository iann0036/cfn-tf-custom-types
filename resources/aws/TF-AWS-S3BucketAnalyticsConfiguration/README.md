...
1. Write the JSON schema describing your resource, `tf-aws-s3bucketanalyticsconfiguration.json`
2. Implement your resource handlers in `tf_aws_s3bucketanalyticsconfiguration/handlers.py`
