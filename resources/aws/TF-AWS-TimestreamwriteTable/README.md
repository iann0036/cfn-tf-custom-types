...
1. Write the JSON schema describing your resource, `tf-aws-timestreamwritetable.json`
2. Implement your resource handlers in `tf_aws_timestreamwritetable/handlers.py`
