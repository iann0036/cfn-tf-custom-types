...
1. Write the JSON schema describing your resource, `terraform-aws-datasyncagent.json`
2. Implement your resource handlers in `terraform_aws_datasyncagent/handlers.py`
