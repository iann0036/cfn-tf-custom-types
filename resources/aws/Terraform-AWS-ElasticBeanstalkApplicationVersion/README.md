...
1. Write the JSON schema describing your resource, `terraform-aws-elasticbeanstalkapplicationversion.json`
2. Implement your resource handlers in `terraform_aws_elasticbeanstalkapplicationversion/handlers.py`
