...
1. Write the JSON schema describing your resource, `terraform-aws-routetable.json`
2. Implement your resource handlers in `terraform_aws_routetable/handlers.py`
