...
1. Write the JSON schema describing your resource, `terraform-aws-emrcluster.json`
2. Implement your resource handlers in `terraform_aws_emrcluster/handlers.py`
