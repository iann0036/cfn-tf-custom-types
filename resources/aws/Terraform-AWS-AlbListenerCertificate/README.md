...
1. Write the JSON schema describing your resource, `terraform-aws-alblistenercertificate.json`
2. Implement your resource handlers in `terraform_aws_alblistenercertificate/handlers.py`
