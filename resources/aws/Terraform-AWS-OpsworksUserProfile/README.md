...
1. Write the JSON schema describing your resource, `terraform-aws-opsworksuserprofile.json`
2. Implement your resource handlers in `terraform_aws_opsworksuserprofile/handlers.py`
