...
1. Write the JSON schema describing your resource, `terraform-aws-guarddutymember.json`
2. Implement your resource handlers in `terraform_aws_guarddutymember/handlers.py`
