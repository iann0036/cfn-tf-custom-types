...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalgeomatchset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalgeomatchset/handlers.py`
