...
1. Write the JSON schema describing your resource, `terraform-aws-docdbclusterinstance.json`
2. Implement your resource handlers in `terraform_aws_docdbclusterinstance/handlers.py`
