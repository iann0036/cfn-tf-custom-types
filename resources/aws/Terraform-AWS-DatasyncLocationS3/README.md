...
1. Write the JSON schema describing your resource, `terraform-aws-datasynclocations3.json`
2. Implement your resource handlers in `terraform_aws_datasynclocations3/handlers.py`
