...
1. Write the JSON schema describing your resource, `terraform-aws-defaultsecuritygroup.json`
2. Implement your resource handlers in `terraform_aws_defaultsecuritygroup/handlers.py`
