...
1. Write the JSON schema describing your resource, `terraform-aws-elastictranscoderpreset.json`
2. Implement your resource handlers in `terraform_aws_elastictranscoderpreset/handlers.py`
