# TF::AWS::ApiGatewayModel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-apigatewaymodel.json`
2. Implement your resource handlers in `tf_aws_apigatewaymodel/handlers.py`
