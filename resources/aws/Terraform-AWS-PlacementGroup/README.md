...
1. Write the JSON schema describing your resource, `terraform-aws-placementgroup.json`
2. Implement your resource handlers in `terraform_aws_placementgroup/handlers.py`
