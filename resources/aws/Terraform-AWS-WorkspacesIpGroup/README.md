...
1. Write the JSON schema describing your resource, `terraform-aws-workspacesipgroup.json`
2. Implement your resource handlers in `terraform_aws_workspacesipgroup/handlers.py`
