# TF::AWS::WafregionalRateBasedRule
...
<pre>
{
    "Type" : "TF::AWS::WafregionalRateBasedRule",
    "Properties" : {
        ...
        "<a href="#predicate" title="Predicate">Predicate</a>" : <i>[ <a href="predicatedefinition.md">PredicateDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#predicate" title="Predicate">Predicate</a>: <i>
      - <a href="predicatedefinition.md">PredicateDefinition</a></i>
</pre>
...
_Type_: List of <a href="predicatedefinition.md">PredicateDefinition</a>
