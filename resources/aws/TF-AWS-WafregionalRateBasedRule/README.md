...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalratebasedrule.json`
2. Implement your resource handlers in `tf_aws_wafregionalratebasedrule/handlers.py`
