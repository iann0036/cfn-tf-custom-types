...
1. Write the JSON schema describing your resource, `terraform-aws-defaultsubnet.json`
2. Implement your resource handlers in `terraform_aws_defaultsubnet/handlers.py`
