...
1. Write the JSON schema describing your resource, `terraform-aws-kinesisfirehosedeliverystream.json`
2. Implement your resource handlers in `terraform_aws_kinesisfirehosedeliverystream/handlers.py`
