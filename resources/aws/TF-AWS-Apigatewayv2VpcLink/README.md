...
1. Write the JSON schema describing your resource, `tf-aws-apigatewayv2vpclink.json`
2. Implement your resource handlers in `tf_aws_apigatewayv2vpclink/handlers.py`
