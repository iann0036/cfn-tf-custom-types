...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayrequestvalidator.json`
2. Implement your resource handlers in `terraform_aws_apigatewayrequestvalidator/handlers.py`
