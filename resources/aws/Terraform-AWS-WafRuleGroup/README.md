...
1. Write the JSON schema describing your resource, `terraform-aws-wafrulegroup.json`
2. Implement your resource handlers in `terraform_aws_wafrulegroup/handlers.py`
