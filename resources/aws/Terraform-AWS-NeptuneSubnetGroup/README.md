...
1. Write the JSON schema describing your resource, `terraform-aws-neptunesubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_neptunesubnetgroup/handlers.py`
