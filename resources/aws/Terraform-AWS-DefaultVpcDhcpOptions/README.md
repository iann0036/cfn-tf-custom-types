...
1. Write the JSON schema describing your resource, `terraform-aws-defaultvpcdhcpoptions.json`
2. Implement your resource handlers in `terraform_aws_defaultvpcdhcpoptions/handlers.py`
