...
1. Write the JSON schema describing your resource, `terraform-aws-elasticbeanstalkconfigurationtemplate.json`
2. Implement your resource handlers in `terraform_aws_elasticbeanstalkconfigurationtemplate/handlers.py`
