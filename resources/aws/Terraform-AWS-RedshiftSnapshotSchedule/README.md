...
1. Write the JSON schema describing your resource, `terraform-aws-redshiftsnapshotschedule.json`
2. Implement your resource handlers in `terraform_aws_redshiftsnapshotschedule/handlers.py`
