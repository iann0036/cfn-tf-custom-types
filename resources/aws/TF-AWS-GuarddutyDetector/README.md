...
1. Write the JSON schema describing your resource, `tf-aws-guarddutydetector.json`
2. Implement your resource handlers in `tf_aws_guarddutydetector/handlers.py`
