...
1. Write the JSON schema describing your resource, `tf-aws-dlmlifecyclepolicy.json`
2. Implement your resource handlers in `tf_aws_dlmlifecyclepolicy/handlers.py`
