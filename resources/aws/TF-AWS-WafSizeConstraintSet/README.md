# TF::AWS::WafSizeConstraintSet

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-wafsizeconstraintset.json`
2. Implement your resource handlers in `tf_aws_wafsizeconstraintset/handlers.py`
