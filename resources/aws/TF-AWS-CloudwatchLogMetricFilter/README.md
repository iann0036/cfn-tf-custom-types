...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatchlogmetricfilter.json`
2. Implement your resource handlers in `tf_aws_cloudwatchlogmetricfilter/handlers.py`
