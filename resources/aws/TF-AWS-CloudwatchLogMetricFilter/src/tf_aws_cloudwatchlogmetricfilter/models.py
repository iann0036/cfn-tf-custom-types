...
class ResourceModel(BaseModel):
    ...
    MetricTransformation: Optional[Sequence["_MetricTransformationDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            MetricTransformation=deserialize_list(json_data.get("MetricTransformation"), MetricTransformationDefinition),
        )
...
@dataclass
class MetricTransformationDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_MetricTransformationDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MetricTransformationDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_MetricTransformationDefinition = MetricTransformationDefinition
