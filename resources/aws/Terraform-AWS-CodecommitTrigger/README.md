...
1. Write the JSON schema describing your resource, `terraform-aws-codecommittrigger.json`
2. Implement your resource handlers in `terraform_aws_codecommittrigger/handlers.py`
