...
1. Write the JSON schema describing your resource, `terraform-aws-vpngatewayroutepropagation.json`
2. Implement your resource handlers in `terraform_aws_vpngatewayroutepropagation/handlers.py`
