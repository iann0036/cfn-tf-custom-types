...
1. Write the JSON schema describing your resource, `terraform-aws-internetgateway.json`
2. Implement your resource handlers in `terraform_aws_internetgateway/handlers.py`
