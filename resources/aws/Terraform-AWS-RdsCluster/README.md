...
1. Write the JSON schema describing your resource, `terraform-aws-rdscluster.json`
2. Implement your resource handlers in `terraform_aws_rdscluster/handlers.py`
