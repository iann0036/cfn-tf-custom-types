...
1. Write the JSON schema describing your resource, `tf-aws-codebuildreportgroup.json`
2. Implement your resource handlers in `tf_aws_codebuildreportgroup/handlers.py`
