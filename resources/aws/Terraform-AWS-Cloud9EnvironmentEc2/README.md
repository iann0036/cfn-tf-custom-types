...
1. Write the JSON schema describing your resource, `terraform-aws-cloud9environmentec2.json`
2. Implement your resource handlers in `terraform_aws_cloud9environmentec2/handlers.py`
