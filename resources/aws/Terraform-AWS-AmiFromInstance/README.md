...
1. Write the JSON schema describing your resource, `terraform-aws-amifrominstance.json`
2. Implement your resource handlers in `terraform_aws_amifrominstance/handlers.py`
