...
1. Write the JSON schema describing your resource, `terraform-aws-storagegatewaycache.json`
2. Implement your resource handlers in `terraform_aws_storagegatewaycache/handlers.py`
