...
1. Write the JSON schema describing your resource, `tf-aws-apprunnerautoscalingconfigurationversion.json`
2. Implement your resource handlers in `tf_aws_apprunnerautoscalingconfigurationversion/handlers.py`
