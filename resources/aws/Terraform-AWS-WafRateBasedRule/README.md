...
1. Write the JSON schema describing your resource, `terraform-aws-wafratebasedrule.json`
2. Implement your resource handlers in `terraform_aws_wafratebasedrule/handlers.py`
