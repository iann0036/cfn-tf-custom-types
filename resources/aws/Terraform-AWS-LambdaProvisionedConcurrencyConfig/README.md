...
1. Write the JSON schema describing your resource, `terraform-aws-lambdaprovisionedconcurrencyconfig.json`
2. Implement your resource handlers in `terraform_aws_lambdaprovisionedconcurrencyconfig/handlers.py`
