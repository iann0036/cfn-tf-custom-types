...
1. Write the JSON schema describing your resource, `terraform-aws-iampolicy.json`
2. Implement your resource handlers in `terraform_aws_iampolicy/handlers.py`
