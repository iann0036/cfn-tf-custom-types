...
1. Write the JSON schema describing your resource, `terraform-aws-ebssnapshot.json`
2. Implement your resource handlers in `terraform_aws_ebssnapshot/handlers.py`
