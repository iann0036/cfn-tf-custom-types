...
1. Write the JSON schema describing your resource, `tf-aws-servicecatalogprovisioningartifact.json`
2. Implement your resource handlers in `tf_aws_servicecatalogprovisioningartifact/handlers.py`
