...
1. Write the JSON schema describing your resource, `terraform-aws-vpcdhcpoptionsassociation.json`
2. Implement your resource handlers in `terraform_aws_vpcdhcpoptionsassociation/handlers.py`
