...
1. Write the JSON schema describing your resource, `terraform-aws-redshifteventsubscription.json`
2. Implement your resource handlers in `terraform_aws_redshifteventsubscription/handlers.py`
