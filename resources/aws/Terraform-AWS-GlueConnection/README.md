...
1. Write the JSON schema describing your resource, `terraform-aws-glueconnection.json`
2. Implement your resource handlers in `terraform_aws_glueconnection/handlers.py`
