...
1. Write the JSON schema describing your resource, `tf-aws-dmsreplicationsubnetgroup.json`
2. Implement your resource handlers in `tf_aws_dmsreplicationsubnetgroup/handlers.py`
