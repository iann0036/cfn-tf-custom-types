...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchlogdestination.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchlogdestination/handlers.py`
