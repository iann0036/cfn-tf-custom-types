...
1. Write the JSON schema describing your resource, `terraform-aws-vpcendpointserviceallowedprincipal.json`
2. Implement your resource handlers in `terraform_aws_vpcendpointserviceallowedprincipal/handlers.py`
