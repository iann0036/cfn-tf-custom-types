...
1. Write the JSON schema describing your resource, `terraform-aws-volumeattachment.json`
2. Implement your resource handlers in `terraform_aws_volumeattachment/handlers.py`
