...
1. Write the JSON schema describing your resource, `tf-aws-secretsmanagersecretversion.json`
2. Implement your resource handlers in `tf_aws_secretsmanagersecretversion/handlers.py`
