...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaymethodresponse.json`
2. Implement your resource handlers in `terraform_aws_apigatewaymethodresponse/handlers.py`
