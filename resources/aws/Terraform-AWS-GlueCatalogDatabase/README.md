...
1. Write the JSON schema describing your resource, `terraform-aws-gluecatalogdatabase.json`
2. Implement your resource handlers in `terraform_aws_gluecatalogdatabase/handlers.py`
