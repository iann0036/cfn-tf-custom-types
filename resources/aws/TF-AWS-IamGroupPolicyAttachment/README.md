# TF::AWS::IamGroupPolicyAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-iamgrouppolicyattachment.json`
2. Implement your resource handlers in `tf_aws_iamgrouppolicyattachment/handlers.py`
