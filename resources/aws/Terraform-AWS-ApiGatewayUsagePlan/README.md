...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayusageplan.json`
2. Implement your resource handlers in `terraform_aws_apigatewayusageplan/handlers.py`
