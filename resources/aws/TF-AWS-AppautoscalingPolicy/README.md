...
1. Write the JSON schema describing your resource, `tf-aws-appautoscalingpolicy.json`
2. Implement your resource handlers in `tf_aws_appautoscalingpolicy/handlers.py`
