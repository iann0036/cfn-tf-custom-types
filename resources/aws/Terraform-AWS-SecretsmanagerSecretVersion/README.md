...
1. Write the JSON schema describing your resource, `terraform-aws-secretsmanagersecretversion.json`
2. Implement your resource handlers in `terraform_aws_secretsmanagersecretversion/handlers.py`
