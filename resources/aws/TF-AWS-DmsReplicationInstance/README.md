...
1. Write the JSON schema describing your resource, `tf-aws-dmsreplicationinstance.json`
2. Implement your resource handlers in `tf_aws_dmsreplicationinstance/handlers.py`
