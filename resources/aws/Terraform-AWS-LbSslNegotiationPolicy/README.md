...
1. Write the JSON schema describing your resource, `terraform-aws-lbsslnegotiationpolicy.json`
2. Implement your resource handlers in `terraform_aws_lbsslnegotiationpolicy/handlers.py`
