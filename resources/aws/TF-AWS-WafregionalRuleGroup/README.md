...
1. Write the JSON schema describing your resource, `tf-aws-wafregionalrulegroup.json`
2. Implement your resource handlers in `tf_aws_wafregionalrulegroup/handlers.py`
