...
1. Write the JSON schema describing your resource, `terraform-aws-kinesisvideostream.json`
2. Implement your resource handlers in `terraform_aws_kinesisvideostream/handlers.py`
