...
1. Write the JSON schema describing your resource, `terraform-aws-dbinstance.json`
2. Implement your resource handlers in `terraform_aws_dbinstance/handlers.py`
