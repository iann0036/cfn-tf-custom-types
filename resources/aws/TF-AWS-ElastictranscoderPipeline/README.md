...
1. Write the JSON schema describing your resource, `tf-aws-elastictranscoderpipeline.json`
2. Implement your resource handlers in `tf_aws_elastictranscoderpipeline/handlers.py`
