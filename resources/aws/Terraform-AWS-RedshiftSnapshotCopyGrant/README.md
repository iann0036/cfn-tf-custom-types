...
1. Write the JSON schema describing your resource, `terraform-aws-redshiftsnapshotcopygrant.json`
2. Implement your resource handlers in `terraform_aws_redshiftsnapshotcopygrant/handlers.py`
