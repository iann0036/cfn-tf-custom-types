...
1. Write the JSON schema describing your resource, `tf-aws-ramresourceassociation.json`
2. Implement your resource handlers in `tf_aws_ramresourceassociation/handlers.py`
