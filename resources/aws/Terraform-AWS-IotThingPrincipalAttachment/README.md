...
1. Write the JSON schema describing your resource, `terraform-aws-iotthingprincipalattachment.json`
2. Implement your resource handlers in `terraform_aws_iotthingprincipalattachment/handlers.py`
