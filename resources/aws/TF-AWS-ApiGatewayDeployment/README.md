...
1. Write the JSON schema describing your resource, `tf-aws-apigatewaydeployment.json`
2. Implement your resource handlers in `tf_aws_apigatewaydeployment/handlers.py`
