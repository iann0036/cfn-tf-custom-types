# Terraform::AWS::OpsworksStaticWebLayer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-aws-opsworksstaticweblayer.json`
2. Implement your resource handlers in `terraform_aws_opsworksstaticweblayer/handlers.py`
