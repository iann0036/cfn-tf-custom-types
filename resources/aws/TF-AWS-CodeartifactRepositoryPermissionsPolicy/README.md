...
1. Write the JSON schema describing your resource, `tf-aws-codeartifactrepositorypermissionspolicy.json`
2. Implement your resource handlers in `tf_aws_codeartifactrepositorypermissionspolicy/handlers.py`
