...
TYPE_NAME = "TF::AWS::OpsworksInstance"
...
def check_progress(operationid, trackingid, progress, session):
    ...
    try:
        ...
        if result['status'] == 'completed':
            ...
            # retrieve model
            try:
                state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_opsworks_instance/{}.model.json".format(trackingid))['Body'].read()
                if state_str == "":
                    state_str = "{}"
...
def update_handler(
    ...
    try:
        state_str = s3client.get_object(Bucket=statebucketname, Key="state/aws_opsworks_instance/{}.model.json".format(model.tfcfnid))['Body'].read()
        if state_str == "":
            state_str = "{}"
        model_state = json.loads(state_str)
...
def list_handler(
    ...
    try:
        ...
        state_objects = s3client.list_objects_v2(
            ...
            MaxKeys=1000,
            Prefix='state/aws_opsworks_instance/'
        )['Contents']

        for state_object in state_objects:
            if state_object['Key'].endswith(".model.json"):
                model = ResourceModel(tfcfnid=state_object['Key'].replace(".model.json", ""), AgentVersion=None, AmiId=None, Architecture=None, AutoScalingType=None, AvailabilityZone=None, CreatedAt=None, DeleteEbs=None, DeleteEip=None, EbsOptimized=None, Ec2InstanceId=None, EcsClusterArn=None, ElasticIp=None, Hostname=None, Id=None, InfrastructureClass=None, InstallUpdatesOnBoot=None, InstanceProfileArn=None, InstanceType=None, LastServiceErrorId=None, LayerIds=None, Os=None, Platform=None, PrivateDns=None, PrivateIp=None, PublicDns=None, PublicIp=None, RegisteredBy=None, ReportedAgentVersion=None, ReportedOsFamily=None, ReportedOsName=None, ReportedOsVersion=None, RootDeviceType=None, RootDeviceVolumeId=None, SecurityGroupIds=None, SshHostDsaKeyFingerprint=None, SshHostRsaKeyFingerprint=None, SshKeyName=None, StackId=None, State=None, Status=None, SubnetId=None, Tenancy=None, VirtualizationType=None, EbsBlockDevice=None, EphemeralBlockDevice=None, RootBlockDevice=None, Timeouts=None)
