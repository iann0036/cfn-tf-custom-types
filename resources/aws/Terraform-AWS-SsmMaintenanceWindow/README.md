...
1. Write the JSON schema describing your resource, `terraform-aws-ssmmaintenancewindow.json`
2. Implement your resource handlers in `terraform_aws_ssmmaintenancewindow/handlers.py`
