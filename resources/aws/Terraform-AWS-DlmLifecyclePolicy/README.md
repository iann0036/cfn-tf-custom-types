...
1. Write the JSON schema describing your resource, `terraform-aws-dlmlifecyclepolicy.json`
2. Implement your resource handlers in `terraform_aws_dlmlifecyclepolicy/handlers.py`
