...
1. Write the JSON schema describing your resource, `tf-aws-emrmanagedscalingpolicy.json`
2. Implement your resource handlers in `tf_aws_emrmanagedscalingpolicy/handlers.py`
