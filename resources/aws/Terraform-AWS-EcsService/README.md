...
1. Write the JSON schema describing your resource, `terraform-aws-ecsservice.json`
2. Implement your resource handlers in `terraform_aws_ecsservice/handlers.py`
