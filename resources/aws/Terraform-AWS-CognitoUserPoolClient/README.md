...
1. Write the JSON schema describing your resource, `terraform-aws-cognitouserpoolclient.json`
2. Implement your resource handlers in `terraform_aws_cognitouserpoolclient/handlers.py`
