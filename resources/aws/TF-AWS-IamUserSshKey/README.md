# TF::AWS::IamUserSshKey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-aws-iamusersshkey.json`
2. Implement your resource handlers in `tf_aws_iamusersshkey/handlers.py`
