...
1. Write the JSON schema describing your resource, `terraform-aws-rdsglobalcluster.json`
2. Implement your resource handlers in `terraform_aws_rdsglobalcluster/handlers.py`
