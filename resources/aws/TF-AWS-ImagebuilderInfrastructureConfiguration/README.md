...
1. Write the JSON schema describing your resource, `tf-aws-imagebuilderinfrastructureconfiguration.json`
2. Implement your resource handlers in `tf_aws_imagebuilderinfrastructureconfiguration/handlers.py`
