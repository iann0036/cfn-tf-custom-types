...
1. Write the JSON schema describing your resource, `tf-aws-gluecatalogtable.json`
2. Implement your resource handlers in `tf_aws_gluecatalogtable/handlers.py`
