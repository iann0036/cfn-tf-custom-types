...
1. Write the JSON schema describing your resource, `tf-aws-lambdaprovisionedconcurrencyconfig.json`
2. Implement your resource handlers in `tf_aws_lambdaprovisionedconcurrencyconfig/handlers.py`
