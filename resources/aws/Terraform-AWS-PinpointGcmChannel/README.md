...
1. Write the JSON schema describing your resource, `terraform-aws-pinpointgcmchannel.json`
2. Implement your resource handlers in `terraform_aws_pinpointgcmchannel/handlers.py`
