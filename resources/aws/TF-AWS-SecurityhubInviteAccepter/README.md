...
1. Write the JSON schema describing your resource, `tf-aws-securityhubinviteaccepter.json`
2. Implement your resource handlers in `tf_aws_securityhubinviteaccepter/handlers.py`
