...
1. Write the JSON schema describing your resource, `terraform-aws-loadbalancerbackendserverpolicy.json`
2. Implement your resource handlers in `terraform_aws_loadbalancerbackendserverpolicy/handlers.py`
