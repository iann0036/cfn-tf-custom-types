...
1. Write the JSON schema describing your resource, `tf-aws-emrinstancegroup.json`
2. Implement your resource handlers in `tf_aws_emrinstancegroup/handlers.py`
