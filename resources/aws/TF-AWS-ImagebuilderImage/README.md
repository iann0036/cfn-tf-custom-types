...
1. Write the JSON schema describing your resource, `tf-aws-imagebuilderimage.json`
2. Implement your resource handlers in `tf_aws_imagebuilderimage/handlers.py`
