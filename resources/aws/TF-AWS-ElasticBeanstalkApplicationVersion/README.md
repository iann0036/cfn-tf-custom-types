...
1. Write the JSON schema describing your resource, `tf-aws-elasticbeanstalkapplicationversion.json`
2. Implement your resource handlers in `tf_aws_elasticbeanstalkapplicationversion/handlers.py`
