...
1. Write the JSON schema describing your resource, `terraform-aws-wafregionalipset.json`
2. Implement your resource handlers in `terraform_aws_wafregionalipset/handlers.py`
