...
1. Write the JSON schema describing your resource, `terraform-aws-redshiftsubnetgroup.json`
2. Implement your resource handlers in `terraform_aws_redshiftsubnetgroup/handlers.py`
