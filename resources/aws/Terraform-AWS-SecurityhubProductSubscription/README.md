...
1. Write the JSON schema describing your resource, `terraform-aws-securityhubproductsubscription.json`
2. Implement your resource handlers in `terraform_aws_securityhubproductsubscription/handlers.py`
