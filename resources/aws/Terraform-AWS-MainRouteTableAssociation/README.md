...
1. Write the JSON schema describing your resource, `terraform-aws-mainroutetableassociation.json`
2. Implement your resource handlers in `terraform_aws_mainroutetableassociation/handlers.py`
