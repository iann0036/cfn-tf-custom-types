...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatcheventapidestination.json`
2. Implement your resource handlers in `tf_aws_cloudwatcheventapidestination/handlers.py`
