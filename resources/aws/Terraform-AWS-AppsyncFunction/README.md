...
1. Write the JSON schema describing your resource, `terraform-aws-appsyncfunction.json`
2. Implement your resource handlers in `terraform_aws_appsyncfunction/handlers.py`
