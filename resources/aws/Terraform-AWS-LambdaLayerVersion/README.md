...
1. Write the JSON schema describing your resource, `terraform-aws-lambdalayerversion.json`
2. Implement your resource handlers in `terraform_aws_lambdalayerversion/handlers.py`
