...
1. Write the JSON schema describing your resource, `tf-aws-glueuserdefinedfunction.json`
2. Implement your resource handlers in `tf_aws_glueuserdefinedfunction/handlers.py`
