...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewaydocumentationpart.json`
2. Implement your resource handlers in `terraform_aws_apigatewaydocumentationpart/handlers.py`
