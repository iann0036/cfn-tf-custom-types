...
1. Write the JSON schema describing your resource, `terraform-aws-lambdafunction.json`
2. Implement your resource handlers in `terraform_aws_lambdafunction/handlers.py`
