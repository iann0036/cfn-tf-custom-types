...
1. Write the JSON schema describing your resource, `terraform-aws-sagemakernotebookinstance.json`
2. Implement your resource handlers in `terraform_aws_sagemakernotebookinstance/handlers.py`
