...
1. Write the JSON schema describing your resource, `terraform-aws-codedeployapp.json`
2. Implement your resource handlers in `terraform_aws_codedeployapp/handlers.py`
