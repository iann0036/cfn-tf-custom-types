...
1. Write the JSON schema describing your resource, `tf-aws-codebuildproject.json`
2. Implement your resource handlers in `tf_aws_codebuildproject/handlers.py`
