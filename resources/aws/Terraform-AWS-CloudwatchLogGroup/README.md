...
1. Write the JSON schema describing your resource, `terraform-aws-cloudwatchloggroup.json`
2. Implement your resource handlers in `terraform_aws_cloudwatchloggroup/handlers.py`
