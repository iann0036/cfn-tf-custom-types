...
1. Write the JSON schema describing your resource, `terraform-aws-neptuneclusterinstance.json`
2. Implement your resource handlers in `terraform_aws_neptuneclusterinstance/handlers.py`
