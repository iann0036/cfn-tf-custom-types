...
1. Write the JSON schema describing your resource, `terraform-aws-budgetsbudget.json`
2. Implement your resource handlers in `terraform_aws_budgetsbudget/handlers.py`
