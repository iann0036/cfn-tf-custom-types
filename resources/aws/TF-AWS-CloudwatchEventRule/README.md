...
1. Write the JSON schema describing your resource, `tf-aws-cloudwatcheventrule.json`
2. Implement your resource handlers in `tf_aws_cloudwatcheventrule/handlers.py`
