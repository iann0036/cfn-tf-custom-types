...
1. Write the JSON schema describing your resource, `terraform-aws-apigatewayapikey.json`
2. Implement your resource handlers in `terraform_aws_apigatewayapikey/handlers.py`
