...
1. Write the JSON schema describing your resource, `terraform-aws-securityhubmember.json`
2. Implement your resource handlers in `terraform_aws_securityhubmember/handlers.py`
