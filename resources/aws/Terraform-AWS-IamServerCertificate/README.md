...
1. Write the JSON schema describing your resource, `terraform-aws-iamservercertificate.json`
2. Implement your resource handlers in `terraform_aws_iamservercertificate/handlers.py`
