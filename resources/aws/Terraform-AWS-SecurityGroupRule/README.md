...
1. Write the JSON schema describing your resource, `terraform-aws-securitygrouprule.json`
2. Implement your resource handlers in `terraform_aws_securitygrouprule/handlers.py`
