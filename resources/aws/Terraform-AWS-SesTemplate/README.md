...
1. Write the JSON schema describing your resource, `terraform-aws-sestemplate.json`
2. Implement your resource handlers in `terraform_aws_sestemplate/handlers.py`
