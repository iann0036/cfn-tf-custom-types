# TF::CiscoASA::AccessOutRules

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-ciscoasa-accessoutrules.json`
2. Implement your resource handlers in `tf_ciscoasa_accessoutrules/handlers.py`
