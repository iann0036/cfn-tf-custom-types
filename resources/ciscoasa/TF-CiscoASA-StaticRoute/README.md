...
1. Write the JSON schema describing your resource, `tf-ciscoasa-staticroute.json`
2. Implement your resource handlers in `tf_ciscoasa_staticroute/handlers.py`
