...
1. Write the JSON schema describing your resource, `tf-ciscoasa-networkobject.json`
2. Implement your resource handlers in `tf_ciscoasa_networkobject/handlers.py`
