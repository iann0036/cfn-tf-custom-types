...
1. Write the JSON schema describing your resource, `tf-cloudsmith-repository.json`
2. Implement your resource handlers in `tf_cloudsmith_repository/handlers.py`
