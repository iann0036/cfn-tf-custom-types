...
1. Write the JSON schema describing your resource, `tf-cloudsmith-entitlement.json`
2. Implement your resource handlers in `tf_cloudsmith_entitlement/handlers.py`
