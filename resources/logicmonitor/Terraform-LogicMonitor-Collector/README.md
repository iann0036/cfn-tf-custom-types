...
1. Write the JSON schema describing your resource, `terraform-logicmonitor-collector.json`
2. Implement your resource handlers in `terraform_logicmonitor_collector/handlers.py`
