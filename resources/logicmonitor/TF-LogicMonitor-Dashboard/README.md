# TF::LogicMonitor::Dashboard

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-logicmonitor-dashboard.json`
2. Implement your resource handlers in `tf_logicmonitor_dashboard/handlers.py`
