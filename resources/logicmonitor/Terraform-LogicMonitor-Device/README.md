...
1. Write the JSON schema describing your resource, `terraform-logicmonitor-device.json`
2. Implement your resource handlers in `terraform_logicmonitor_device/handlers.py`
