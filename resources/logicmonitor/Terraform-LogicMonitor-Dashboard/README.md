...
1. Write the JSON schema describing your resource, `terraform-logicmonitor-dashboard.json`
2. Implement your resource handlers in `terraform_logicmonitor_dashboard/handlers.py`
