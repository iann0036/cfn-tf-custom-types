# TF::LogicMonitor::Device

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-logicmonitor-device.json`
2. Implement your resource handlers in `tf_logicmonitor_device/handlers.py`
