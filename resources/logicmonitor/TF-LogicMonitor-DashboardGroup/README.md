...
1. Write the JSON schema describing your resource, `tf-logicmonitor-dashboardgroup.json`
2. Implement your resource handlers in `tf_logicmonitor_dashboardgroup/handlers.py`
