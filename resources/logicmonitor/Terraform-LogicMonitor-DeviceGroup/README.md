...
1. Write the JSON schema describing your resource, `terraform-logicmonitor-devicegroup.json`
2. Implement your resource handlers in `terraform_logicmonitor_devicegroup/handlers.py`
