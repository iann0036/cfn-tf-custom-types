...
1. Write the JSON schema describing your resource, `tf-logicmonitor-devicegroup.json`
2. Implement your resource handlers in `tf_logicmonitor_devicegroup/handlers.py`
