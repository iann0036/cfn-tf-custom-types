...
1. Write the JSON schema describing your resource, `terraform-logicmonitor-collectorgroup.json`
2. Implement your resource handlers in `terraform_logicmonitor_collectorgroup/handlers.py`
