...
1. Write the JSON schema describing your resource, `tf-logicmonitor-collectorgroup.json`
2. Implement your resource handlers in `tf_logicmonitor_collectorgroup/handlers.py`
