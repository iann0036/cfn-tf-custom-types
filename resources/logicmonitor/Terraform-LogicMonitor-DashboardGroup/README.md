...
1. Write the JSON schema describing your resource, `terraform-logicmonitor-dashboardgroup.json`
2. Implement your resource handlers in `terraform_logicmonitor_dashboardgroup/handlers.py`
