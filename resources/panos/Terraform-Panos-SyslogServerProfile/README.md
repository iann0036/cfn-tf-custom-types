...
1. Write the JSON schema describing your resource, `terraform-panos-syslogserverprofile.json`
2. Implement your resource handlers in `terraform_panos_syslogserverprofile/handlers.py`
