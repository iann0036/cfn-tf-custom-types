...
1. Write the JSON schema describing your resource, `terraform-panos-bgpexportrulegroup.json`
2. Implement your resource handlers in `terraform_panos_bgpexportrulegroup/handlers.py`
