...
1. Write the JSON schema describing your resource, `tf-panos-tunnelinterface.json`
2. Implement your resource handlers in `tf_panos_tunnelinterface/handlers.py`
