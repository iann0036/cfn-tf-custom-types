...
1. Write the JSON schema describing your resource, `terraform-panos-securitypolicy.json`
2. Implement your resource handlers in `terraform_panos_securitypolicy/handlers.py`
