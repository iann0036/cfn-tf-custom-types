...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaservicegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramaservicegroup/handlers.py`
