...
1. Write the JSON schema describing your resource, `terraform-panos-bgpconditionaladvadvertisefilter.json`
2. Implement your resource handlers in `terraform_panos_bgpconditionaladvadvertisefilter/handlers.py`
