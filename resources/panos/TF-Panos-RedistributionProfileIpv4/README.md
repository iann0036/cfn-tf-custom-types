# TF::Panos::RedistributionProfileIpv4

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-redistributionprofileipv4.json`
2. Implement your resource handlers in `tf_panos_redistributionprofileipv4/handlers.py`
