...
1. Write the JSON schema describing your resource, `terraform-panos-panoramatemplatestack.json`
2. Implement your resource handlers in `terraform_panos_panoramatemplatestack/handlers.py`
