# TF::Panos::PanoramaLogForwardingProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramalogforwardingprofile.json`
2. Implement your resource handlers in `tf_panos_panoramalogforwardingprofile/handlers.py`
