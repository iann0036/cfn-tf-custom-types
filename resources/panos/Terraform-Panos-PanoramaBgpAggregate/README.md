...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpaggregate.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpaggregate/handlers.py`
