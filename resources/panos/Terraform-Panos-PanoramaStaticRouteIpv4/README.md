...
1. Write the JSON schema describing your resource, `terraform-panos-panoramastaticrouteipv4.json`
2. Implement your resource handlers in `terraform_panos_panoramastaticrouteipv4/handlers.py`
