...
1. Write the JSON schema describing your resource, `terraform-panos-panoramamanagementprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramamanagementprofile/handlers.py`
