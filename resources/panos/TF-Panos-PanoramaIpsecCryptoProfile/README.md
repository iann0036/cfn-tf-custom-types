# TF::Panos::PanoramaIpsecCryptoProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramaipseccryptoprofile.json`
2. Implement your resource handlers in `tf_panos_panoramaipseccryptoprofile/handlers.py`
