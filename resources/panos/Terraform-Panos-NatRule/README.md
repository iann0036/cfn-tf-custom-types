...
1. Write the JSON schema describing your resource, `terraform-panos-natrule.json`
2. Implement your resource handlers in `terraform_panos_natrule/handlers.py`
