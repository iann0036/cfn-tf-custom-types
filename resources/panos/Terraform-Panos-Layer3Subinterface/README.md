# Terraform::Panos::Layer3Subinterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-panos-layer3subinterface.json`
2. Implement your resource handlers in `terraform_panos_layer3subinterface/handlers.py`
