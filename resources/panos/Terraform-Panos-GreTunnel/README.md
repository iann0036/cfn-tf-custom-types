...
1. Write the JSON schema describing your resource, `terraform-panos-gretunnel.json`
2. Implement your resource handlers in `terraform_panos_gretunnel/handlers.py`
