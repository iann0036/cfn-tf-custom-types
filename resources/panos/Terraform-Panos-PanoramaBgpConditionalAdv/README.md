...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpconditionaladv.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpconditionaladv/handlers.py`
