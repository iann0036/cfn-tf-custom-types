...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgp.json`
2. Implement your resource handlers in `terraform_panos_panoramabgp/handlers.py`
