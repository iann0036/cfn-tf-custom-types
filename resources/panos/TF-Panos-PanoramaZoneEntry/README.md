# TF::Panos::PanoramaZoneEntry

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramazoneentry.json`
2. Implement your resource handlers in `tf_panos_panoramazoneentry/handlers.py`
