# Terraform::Panos::EthernetInterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-panos-ethernetinterface.json`
2. Implement your resource handlers in `terraform_panos_ethernetinterface/handlers.py`
