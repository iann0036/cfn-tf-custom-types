...
def create_handler(
    ...
    try:
        ...
        tf['resource']['panos_panorama_bgp_conditional_adv_advertise_filter'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['panos_panorama_bgp_conditional_adv_advertise_filter'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
