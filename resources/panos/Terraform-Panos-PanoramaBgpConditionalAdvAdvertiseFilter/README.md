...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpconditionaladvadvertisefilter.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpconditionaladvadvertisefilter/handlers.py`
