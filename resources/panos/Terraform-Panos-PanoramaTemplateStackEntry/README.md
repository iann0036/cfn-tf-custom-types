...
1. Write the JSON schema describing your resource, `terraform-panos-panoramatemplatestackentry.json`
2. Implement your resource handlers in `terraform_panos_panoramatemplatestackentry/handlers.py`
