...
1. Write the JSON schema describing your resource, `tf-panos-antispywaresecurityprofile.json`
2. Implement your resource handlers in `tf_panos_antispywaresecurityprofile/handlers.py`
