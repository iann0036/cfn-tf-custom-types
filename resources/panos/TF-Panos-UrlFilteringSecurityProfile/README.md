...
1. Write the JSON schema describing your resource, `tf-panos-urlfilteringsecurityprofile.json`
2. Implement your resource handlers in `tf_panos_urlfilteringsecurityprofile/handlers.py`
