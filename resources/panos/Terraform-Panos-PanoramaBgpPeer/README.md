...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgppeer.json`
2. Implement your resource handlers in `terraform_panos_panoramabgppeer/handlers.py`
