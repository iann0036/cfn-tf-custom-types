...
1. Write the JSON schema describing your resource, `terraform-panos-panoramamonitorprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramamonitorprofile/handlers.py`
