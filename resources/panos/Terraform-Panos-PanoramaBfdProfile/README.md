...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabfdprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramabfdprofile/handlers.py`
