...
1. Write the JSON schema describing your resource, `terraform-panos-servicegroup.json`
2. Implement your resource handlers in `terraform_panos_servicegroup/handlers.py`
