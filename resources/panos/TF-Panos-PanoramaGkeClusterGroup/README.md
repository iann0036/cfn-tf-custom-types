# TF::Panos::PanoramaGkeClusterGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramagkeclustergroup.json`
2. Implement your resource handlers in `tf_panos_panoramagkeclustergroup/handlers.py`
