...
1. Write the JSON schema describing your resource, `terraform-panos-bfdprofile.json`
2. Implement your resource handlers in `terraform_panos_bfdprofile/handlers.py`
