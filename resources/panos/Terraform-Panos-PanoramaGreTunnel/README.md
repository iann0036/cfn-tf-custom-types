...
1. Write the JSON schema describing your resource, `terraform-panos-panoramagretunnel.json`
2. Implement your resource handlers in `terraform_panos_panoramagretunnel/handlers.py`
