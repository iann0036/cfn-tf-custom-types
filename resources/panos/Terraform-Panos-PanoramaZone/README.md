...
1. Write the JSON schema describing your resource, `terraform-panos-panoramazone.json`
2. Implement your resource handlers in `terraform_panos_panoramazone/handlers.py`
