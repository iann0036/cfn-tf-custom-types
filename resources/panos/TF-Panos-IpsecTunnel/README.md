# TF::Panos::IpsecTunnel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-ipsectunnel.json`
2. Implement your resource handlers in `tf_panos_ipsectunnel/handlers.py`
