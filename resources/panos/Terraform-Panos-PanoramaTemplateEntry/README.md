...
1. Write the JSON schema describing your resource, `terraform-panos-panoramatemplateentry.json`
2. Implement your resource handlers in `terraform_panos_panoramatemplateentry/handlers.py`
