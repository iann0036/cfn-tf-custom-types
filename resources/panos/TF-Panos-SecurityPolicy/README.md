...
1. Write the JSON schema describing your resource, `tf-panos-securitypolicy.json`
2. Implement your resource handlers in `tf_panos_securitypolicy/handlers.py`
