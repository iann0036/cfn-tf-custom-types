# TF::Panos::PanoramaIpsecTunnelProxyIdIpv4

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramaipsectunnelproxyidipv4.json`
2. Implement your resource handlers in `tf_panos_panoramaipsectunnelproxyidipv4/handlers.py`
