...
1. Write the JSON schema describing your resource, `terraform-panos-panoramavirtualrouter.json`
2. Implement your resource handlers in `terraform_panos_panoramavirtualrouter/handlers.py`
