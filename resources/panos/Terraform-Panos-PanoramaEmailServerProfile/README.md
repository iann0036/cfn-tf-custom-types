...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaemailserverprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramaemailserverprofile/handlers.py`
