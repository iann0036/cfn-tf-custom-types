...
1. Write the JSON schema describing your resource, `terraform-panos-redistributionprofileipv4.json`
2. Implement your resource handlers in `terraform_panos_redistributionprofileipv4/handlers.py`
