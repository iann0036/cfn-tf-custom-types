...
1. Write the JSON schema describing your resource, `tf-panos-devicegroupparent.json`
2. Implement your resource handlers in `tf_panos_devicegroupparent/handlers.py`
