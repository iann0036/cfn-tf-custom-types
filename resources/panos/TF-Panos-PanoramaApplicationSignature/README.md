...
1. Write the JSON schema describing your resource, `tf-panos-panoramaapplicationsignature.json`
2. Implement your resource handlers in `tf_panos_panoramaapplicationsignature/handlers.py`
