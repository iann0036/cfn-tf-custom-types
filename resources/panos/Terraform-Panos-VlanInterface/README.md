...
1. Write the JSON schema describing your resource, `terraform-panos-vlaninterface.json`
2. Implement your resource handlers in `terraform_panos_vlaninterface/handlers.py`
