# TF::Panos::NatRuleGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-natrulegroup.json`
2. Implement your resource handlers in `tf_panos_natrulegroup/handlers.py`
