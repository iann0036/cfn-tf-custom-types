...
1. Write the JSON schema describing your resource, `terraform-panos-loopbackinterface.json`
2. Implement your resource handlers in `terraform_panos_loopbackinterface/handlers.py`
