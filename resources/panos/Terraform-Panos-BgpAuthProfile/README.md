...
1. Write the JSON schema describing your resource, `terraform-panos-bgpauthprofile.json`
2. Implement your resource handlers in `terraform_panos_bgpauthprofile/handlers.py`
