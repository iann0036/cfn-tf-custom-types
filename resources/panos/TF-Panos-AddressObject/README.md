# TF::Panos::AddressObject

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-addressobject.json`
2. Implement your resource handlers in `tf_panos_addressobject/handlers.py`
