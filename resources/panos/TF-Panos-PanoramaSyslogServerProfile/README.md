...
1. Write the JSON schema describing your resource, `tf-panos-panoramasyslogserverprofile.json`
2. Implement your resource handlers in `tf_panos_panoramasyslogserverprofile/handlers.py`
