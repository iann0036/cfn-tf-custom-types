# TF::Panos::PanoramaSyslogServerProfile
...
<pre>
{
    "Type" : "TF::Panos::PanoramaSyslogServerProfile",
    "Properties" : {
        ...
        "<a href="#syslogserver" title="SyslogServer">SyslogServer</a>" : <i>[ <a href="syslogserverdefinition.md">SyslogServerDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#syslogserver" title="SyslogServer">SyslogServer</a>: <i>
      - <a href="syslogserverdefinition.md">SyslogServerDefinition</a></i>
</pre>
...
_Type_: List of <a href="syslogserverdefinition.md">SyslogServerDefinition</a>
