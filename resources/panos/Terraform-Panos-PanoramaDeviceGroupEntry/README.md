...
1. Write the JSON schema describing your resource, `terraform-panos-panoramadevicegroupentry.json`
2. Implement your resource handlers in `terraform_panos_panoramadevicegroupentry/handlers.py`
