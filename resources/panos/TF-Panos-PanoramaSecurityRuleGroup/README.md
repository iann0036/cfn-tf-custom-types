...
1. Write the JSON schema describing your resource, `tf-panos-panoramasecurityrulegroup.json`
2. Implement your resource handlers in `tf_panos_panoramasecurityrulegroup/handlers.py`
