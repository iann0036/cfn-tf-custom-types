...
1. Write the JSON schema describing your resource, `tf-panos-panoramaaddressobject.json`
2. Implement your resource handlers in `tf_panos_panoramaaddressobject/handlers.py`
