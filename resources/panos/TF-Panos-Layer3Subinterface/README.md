...
1. Write the JSON schema describing your resource, `tf-panos-layer3subinterface.json`
2. Implement your resource handlers in `tf_panos_layer3subinterface/handlers.py`
