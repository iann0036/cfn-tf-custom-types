...
1. Write the JSON schema describing your resource, `terraform-panos-aggregateinterface.json`
2. Implement your resource handlers in `terraform_panos_aggregateinterface/handlers.py`
