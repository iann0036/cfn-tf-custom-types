...
1. Write the JSON schema describing your resource, `terraform-panos-dagtags.json`
2. Implement your resource handlers in `terraform_panos_dagtags/handlers.py`
