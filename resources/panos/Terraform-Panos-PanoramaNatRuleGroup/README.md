...
1. Write the JSON schema describing your resource, `terraform-panos-panoramanatrulegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramanatrulegroup/handlers.py`
