# TF::Panos::PanoramaTemplateEntry

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramatemplateentry.json`
2. Implement your resource handlers in `tf_panos_panoramatemplateentry/handlers.py`
