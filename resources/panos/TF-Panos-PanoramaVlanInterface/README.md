...
1. Write the JSON schema describing your resource, `tf-panos-panoramavlaninterface.json`
2. Implement your resource handlers in `tf_panos_panoramavlaninterface/handlers.py`
