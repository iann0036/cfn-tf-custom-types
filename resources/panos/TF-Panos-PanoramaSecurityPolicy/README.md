...
1. Write the JSON schema describing your resource, `tf-panos-panoramasecuritypolicy.json`
2. Implement your resource handlers in `tf_panos_panoramasecuritypolicy/handlers.py`
