# TF::Panos::BgpConditionalAdv

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-bgpconditionaladv.json`
2. Implement your resource handlers in `tf_panos_bgpconditionaladv/handlers.py`
