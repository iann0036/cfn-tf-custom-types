...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpdampeningprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpdampeningprofile/handlers.py`
