...
1. Write the JSON schema describing your resource, `terraform-panos-panoramasyslogserverprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramasyslogserverprofile/handlers.py`
