...
1. Write the JSON schema describing your resource, `tf-panos-panoramaemailserverprofile.json`
2. Implement your resource handlers in `tf_panos_panoramaemailserverprofile/handlers.py`
