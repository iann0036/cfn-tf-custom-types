# TF::Panos::PanoramaEmailServerProfile
...
<pre>
{
    "Type" : "TF::Panos::PanoramaEmailServerProfile",
    "Properties" : {
        ...
        "<a href="#emailserver" title="EmailServer">EmailServer</a>" : <i>[ <a href="emailserverdefinition.md">EmailServerDefinition</a>, ... ]</i>
    }
}
</pre>
...
Properties:
    ...
    <a href="#emailserver" title="EmailServer">EmailServer</a>: <i>
      - <a href="emailserverdefinition.md">EmailServerDefinition</a></i>
</pre>
...
_Type_: List of <a href="emailserverdefinition.md">EmailServerDefinition</a>
