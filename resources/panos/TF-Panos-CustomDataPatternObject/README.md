...
1. Write the JSON schema describing your resource, `tf-panos-customdatapatternobject.json`
2. Implement your resource handlers in `tf_panos_customdatapatternobject/handlers.py`
