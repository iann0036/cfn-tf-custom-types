...
1. Write the JSON schema describing your resource, `tf-panos-panoramabgpauthprofile.json`
2. Implement your resource handlers in `tf_panos_panoramabgpauthprofile/handlers.py`
