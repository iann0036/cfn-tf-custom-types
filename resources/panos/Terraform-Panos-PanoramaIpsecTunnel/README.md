...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaipsectunnel.json`
2. Implement your resource handlers in `terraform_panos_panoramaipsectunnel/handlers.py`
