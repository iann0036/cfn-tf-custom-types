...
1. Write the JSON schema describing your resource, `terraform-panos-panoramazoneentry.json`
2. Implement your resource handlers in `terraform_panos_panoramazoneentry/handlers.py`
