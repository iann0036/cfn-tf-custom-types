# TF::Panos::StaticRouteIpv4

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-staticrouteipv4.json`
2. Implement your resource handlers in `tf_panos_staticrouteipv4/handlers.py`
