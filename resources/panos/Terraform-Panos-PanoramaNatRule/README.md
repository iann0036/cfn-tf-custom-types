...
1. Write the JSON schema describing your resource, `terraform-panos-panoramanatrule.json`
2. Implement your resource handlers in `terraform_panos_panoramanatrule/handlers.py`
