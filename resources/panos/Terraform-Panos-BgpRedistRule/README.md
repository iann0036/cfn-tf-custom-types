...
1. Write the JSON schema describing your resource, `terraform-panos-bgpredistrule.json`
2. Implement your resource handlers in `terraform_panos_bgpredistrule/handlers.py`
