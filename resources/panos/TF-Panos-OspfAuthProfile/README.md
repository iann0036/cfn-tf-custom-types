...
1. Write the JSON schema describing your resource, `tf-panos-ospfauthprofile.json`
2. Implement your resource handlers in `tf_panos_ospfauthprofile/handlers.py`
