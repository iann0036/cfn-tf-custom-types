...
1. Write the JSON schema describing your resource, `terraform-panos-virtualrouter.json`
2. Implement your resource handlers in `terraform_panos_virtualrouter/handlers.py`
