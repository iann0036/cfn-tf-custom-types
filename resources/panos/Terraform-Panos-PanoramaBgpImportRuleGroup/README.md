...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpimportrulegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpimportrulegroup/handlers.py`
