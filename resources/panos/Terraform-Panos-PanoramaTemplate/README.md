...
1. Write the JSON schema describing your resource, `terraform-panos-panoramatemplate.json`
2. Implement your resource handlers in `terraform_panos_panoramatemplate/handlers.py`
