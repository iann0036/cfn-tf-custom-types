...
1. Write the JSON schema describing your resource, `terraform-panos-panoramadevicegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramadevicegroup/handlers.py`
