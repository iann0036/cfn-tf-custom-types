...
1. Write the JSON schema describing your resource, `terraform-panos-administrativetag.json`
2. Implement your resource handlers in `terraform_panos_administrativetag/handlers.py`
