# Terraform::Panos::PanoramaAggregateInterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-panos-panoramaaggregateinterface.json`
2. Implement your resource handlers in `terraform_panos_panoramaaggregateinterface/handlers.py`
