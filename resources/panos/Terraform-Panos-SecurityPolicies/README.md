...
1. Write the JSON schema describing your resource, `terraform-panos-securitypolicies.json`
2. Implement your resource handlers in `terraform_panos_securitypolicies/handlers.py`
