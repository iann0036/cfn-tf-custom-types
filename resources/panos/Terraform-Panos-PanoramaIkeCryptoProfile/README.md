...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaikecryptoprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramaikecryptoprofile/handlers.py`
