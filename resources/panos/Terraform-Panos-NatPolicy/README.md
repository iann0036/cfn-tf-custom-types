# Terraform::Panos::NatPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-panos-natpolicy.json`
2. Implement your resource handlers in `terraform_panos_natpolicy/handlers.py`
