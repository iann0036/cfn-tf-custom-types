...
1. Write the JSON schema describing your resource, `terraform-panos-addressobject.json`
2. Implement your resource handlers in `terraform_panos_addressobject/handlers.py`
