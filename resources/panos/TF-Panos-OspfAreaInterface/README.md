...
1. Write the JSON schema describing your resource, `tf-panos-ospfareainterface.json`
2. Implement your resource handlers in `tf_panos_ospfareainterface/handlers.py`
