...
1. Write the JSON schema describing your resource, `terraform-panos-licensing.json`
2. Implement your resource handlers in `terraform_panos_licensing/handlers.py`
