...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaloopbackinterface.json`
2. Implement your resource handlers in `terraform_panos_panoramaloopbackinterface/handlers.py`
