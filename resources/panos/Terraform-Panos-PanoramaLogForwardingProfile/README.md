...
1. Write the JSON schema describing your resource, `terraform-panos-panoramalogforwardingprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramalogforwardingprofile/handlers.py`
