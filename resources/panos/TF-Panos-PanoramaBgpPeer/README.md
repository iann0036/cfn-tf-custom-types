...
1. Write the JSON schema describing your resource, `tf-panos-panoramabgppeer.json`
2. Implement your resource handlers in `tf_panos_panoramabgppeer/handlers.py`
