...
1. Write the JSON schema describing your resource, `terraform-panos-panoramasnmptrapserverprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramasnmptrapserverprofile/handlers.py`
