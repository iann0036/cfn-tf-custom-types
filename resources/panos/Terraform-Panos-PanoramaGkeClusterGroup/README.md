...
1. Write the JSON schema describing your resource, `terraform-panos-panoramagkeclustergroup.json`
2. Implement your resource handlers in `terraform_panos_panoramagkeclustergroup/handlers.py`
