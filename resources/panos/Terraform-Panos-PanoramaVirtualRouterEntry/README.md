...
1. Write the JSON schema describing your resource, `terraform-panos-panoramavirtualrouterentry.json`
2. Implement your resource handlers in `terraform_panos_panoramavirtualrouterentry/handlers.py`
