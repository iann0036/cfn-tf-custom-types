...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaikegateway.json`
2. Implement your resource handlers in `terraform_panos_panoramaikegateway/handlers.py`
