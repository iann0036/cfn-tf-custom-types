...
1. Write the JSON schema describing your resource, `terraform-panos-ikecryptoprofile.json`
2. Implement your resource handlers in `terraform_panos_ikecryptoprofile/handlers.py`
