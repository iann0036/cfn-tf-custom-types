...
1. Write the JSON schema describing your resource, `terraform-panos-bgpconditionaladv.json`
2. Implement your resource handlers in `terraform_panos_bgpconditionaladv/handlers.py`
