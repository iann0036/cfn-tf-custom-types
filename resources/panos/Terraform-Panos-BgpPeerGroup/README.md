...
1. Write the JSON schema describing your resource, `terraform-panos-bgppeergroup.json`
2. Implement your resource handlers in `terraform_panos_bgppeergroup/handlers.py`
