...
1. Write the JSON schema describing your resource, `terraform-panos-panoramahttpserverprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramahttpserverprofile/handlers.py`
