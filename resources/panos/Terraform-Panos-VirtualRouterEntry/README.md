...
1. Write the JSON schema describing your resource, `terraform-panos-virtualrouterentry.json`
2. Implement your resource handlers in `terraform_panos_virtualrouterentry/handlers.py`
