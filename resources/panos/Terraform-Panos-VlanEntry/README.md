...
1. Write the JSON schema describing your resource, `terraform-panos-vlanentry.json`
2. Implement your resource handlers in `terraform_panos_vlanentry/handlers.py`
