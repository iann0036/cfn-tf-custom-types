...
1. Write the JSON schema describing your resource, `terraform-panos-layer2subinterface.json`
2. Implement your resource handlers in `terraform_panos_layer2subinterface/handlers.py`
