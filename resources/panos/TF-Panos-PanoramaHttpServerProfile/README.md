...
1. Write the JSON schema describing your resource, `tf-panos-panoramahttpserverprofile.json`
2. Implement your resource handlers in `tf_panos_panoramahttpserverprofile/handlers.py`
