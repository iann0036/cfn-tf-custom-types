...
1. Write the JSON schema describing your resource, `tf-panos-emailserverprofile.json`
2. Implement your resource handlers in `tf_panos_emailserverprofile/handlers.py`
