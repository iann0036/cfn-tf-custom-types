...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpredistrule.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpredistrule/handlers.py`
