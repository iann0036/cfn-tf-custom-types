...
1. Write the JSON schema describing your resource, `tf-panos-aggregateinterface.json`
2. Implement your resource handlers in `tf_panos_aggregateinterface/handlers.py`
