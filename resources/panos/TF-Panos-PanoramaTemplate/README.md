...
1. Write the JSON schema describing your resource, `tf-panos-panoramatemplate.json`
2. Implement your resource handlers in `tf_panos_panoramatemplate/handlers.py`
