...
1. Write the JSON schema describing your resource, `tf-panos-securitypolicygroup.json`
2. Implement your resource handlers in `tf_panos_securitypolicygroup/handlers.py`
