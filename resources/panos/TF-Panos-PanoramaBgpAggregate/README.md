# TF::Panos::PanoramaBgpAggregate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramabgpaggregate.json`
2. Implement your resource handlers in `tf_panos_panoramabgpaggregate/handlers.py`
