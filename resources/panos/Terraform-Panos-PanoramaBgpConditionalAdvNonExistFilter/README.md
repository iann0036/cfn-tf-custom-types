...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpconditionaladvnonexistfilter.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpconditionaladvnonexistfilter/handlers.py`
