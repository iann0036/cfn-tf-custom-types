...
1. Write the JSON schema describing your resource, `terraform-panos-bgppeer.json`
2. Implement your resource handlers in `terraform_panos_bgppeer/handlers.py`
