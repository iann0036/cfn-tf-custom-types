...
1. Write the JSON schema describing your resource, `terraform-panos-panoramagkecluster.json`
2. Implement your resource handlers in `terraform_panos_panoramagkecluster/handlers.py`
