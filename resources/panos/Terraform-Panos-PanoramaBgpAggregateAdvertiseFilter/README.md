...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpaggregateadvertisefilter.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpaggregateadvertisefilter/handlers.py`
