...
1. Write the JSON schema describing your resource, `terraform-panos-ikegateway.json`
2. Implement your resource handlers in `terraform_panos_ikegateway/handlers.py`
