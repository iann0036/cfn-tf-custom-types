# TF::Panos::PanoramaIpsecTunnel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramaipsectunnel.json`
2. Implement your resource handlers in `tf_panos_panoramaipsectunnel/handlers.py`
