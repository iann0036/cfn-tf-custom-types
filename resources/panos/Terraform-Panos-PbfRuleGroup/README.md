...
1. Write the JSON schema describing your resource, `terraform-panos-pbfrulegroup.json`
2. Implement your resource handlers in `terraform_panos_pbfrulegroup/handlers.py`
