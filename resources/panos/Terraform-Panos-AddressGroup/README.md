...
1. Write the JSON schema describing your resource, `terraform-panos-addressgroup.json`
2. Implement your resource handlers in `terraform_panos_addressgroup/handlers.py`
