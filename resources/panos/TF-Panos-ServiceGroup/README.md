# TF::Panos::ServiceGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-servicegroup.json`
2. Implement your resource handlers in `tf_panos_servicegroup/handlers.py`
