...
1. Write the JSON schema describing your resource, `terraform-panos-tunnelinterface.json`
2. Implement your resource handlers in `terraform_panos_tunnelinterface/handlers.py`
