# TF::Panos::PbfRuleGroup

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-pbfrulegroup.json`
2. Implement your resource handlers in `tf_panos_pbfrulegroup/handlers.py`
