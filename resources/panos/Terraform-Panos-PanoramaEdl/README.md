...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaedl.json`
2. Implement your resource handlers in `terraform_panos_panoramaedl/handlers.py`
