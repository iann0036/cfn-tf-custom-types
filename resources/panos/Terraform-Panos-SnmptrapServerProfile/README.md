...
1. Write the JSON schema describing your resource, `terraform-panos-snmptrapserverprofile.json`
2. Implement your resource handlers in `terraform_panos_snmptrapserverprofile/handlers.py`
