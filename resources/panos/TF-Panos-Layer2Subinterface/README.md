# TF::Panos::Layer2Subinterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-layer2subinterface.json`
2. Implement your resource handlers in `tf_panos_layer2subinterface/handlers.py`
