...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaipsectunnelproxyidipv4.json`
2. Implement your resource handlers in `terraform_panos_panoramaipsectunnelproxyidipv4/handlers.py`
