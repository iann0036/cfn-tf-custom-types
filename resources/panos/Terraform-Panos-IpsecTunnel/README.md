...
1. Write the JSON schema describing your resource, `terraform-panos-ipsectunnel.json`
2. Implement your resource handlers in `terraform_panos_ipsectunnel/handlers.py`
