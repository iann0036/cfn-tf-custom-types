...
1. Write the JSON schema describing your resource, `terraform-panos-serviceobject.json`
2. Implement your resource handlers in `terraform_panos_serviceobject/handlers.py`
