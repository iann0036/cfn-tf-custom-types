...
1. Write the JSON schema describing your resource, `tf-panos-virtualrouterentry.json`
2. Implement your resource handlers in `tf_panos_virtualrouterentry/handlers.py`
