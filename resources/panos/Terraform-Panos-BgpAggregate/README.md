...
1. Write the JSON schema describing your resource, `terraform-panos-bgpaggregate.json`
2. Implement your resource handlers in `terraform_panos_bgpaggregate/handlers.py`
