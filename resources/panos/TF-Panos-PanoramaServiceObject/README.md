...
1. Write the JSON schema describing your resource, `tf-panos-panoramaserviceobject.json`
2. Implement your resource handlers in `tf_panos_panoramaserviceobject/handlers.py`
