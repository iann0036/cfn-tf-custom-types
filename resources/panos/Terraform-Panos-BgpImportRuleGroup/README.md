...
1. Write the JSON schema describing your resource, `terraform-panos-bgpimportrulegroup.json`
2. Implement your resource handlers in `terraform_panos_bgpimportrulegroup/handlers.py`
