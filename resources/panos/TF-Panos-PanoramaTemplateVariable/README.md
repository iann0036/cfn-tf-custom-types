# TF::Panos::PanoramaTemplateVariable

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramatemplatevariable.json`
2. Implement your resource handlers in `tf_panos_panoramatemplatevariable/handlers.py`
