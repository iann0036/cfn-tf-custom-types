...
1. Write the JSON schema describing your resource, `terraform-panos-panoramatemplatevariable.json`
2. Implement your resource handlers in `terraform_panos_panoramatemplatevariable/handlers.py`
