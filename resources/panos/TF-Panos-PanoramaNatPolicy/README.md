# TF::Panos::PanoramaNatPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramanatpolicy.json`
2. Implement your resource handlers in `tf_panos_panoramanatpolicy/handlers.py`
