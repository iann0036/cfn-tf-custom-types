...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaaddressgroup.json`
2. Implement your resource handlers in `terraform_panos_panoramaaddressgroup/handlers.py`
