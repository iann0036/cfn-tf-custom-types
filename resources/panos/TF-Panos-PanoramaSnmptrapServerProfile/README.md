...
1. Write the JSON schema describing your resource, `tf-panos-panoramasnmptrapserverprofile.json`
2. Implement your resource handlers in `tf_panos_panoramasnmptrapserverprofile/handlers.py`
