# TF::Panos::PanoramaIkeGateway

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramaikegateway.json`
2. Implement your resource handlers in `tf_panos_panoramaikegateway/handlers.py`
