...
1. Write the JSON schema describing your resource, `terraform-panos-managementprofile.json`
2. Implement your resource handlers in `terraform_panos_managementprofile/handlers.py`
