...
1. Write the JSON schema describing your resource, `tf-panos-panoramadevicegroup.json`
2. Implement your resource handlers in `tf_panos_panoramadevicegroup/handlers.py`
