...
1. Write the JSON schema describing your resource, `terraform-panos-generalsettings.json`
2. Implement your resource handlers in `terraform_panos_generalsettings/handlers.py`
