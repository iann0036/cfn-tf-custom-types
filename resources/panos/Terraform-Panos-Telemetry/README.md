...
1. Write the JSON schema describing your resource, `terraform-panos-telemetry.json`
2. Implement your resource handlers in `terraform_panos_telemetry/handlers.py`
