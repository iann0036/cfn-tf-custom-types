...
1. Write the JSON schema describing your resource, `terraform-panos-monitorprofile.json`
2. Implement your resource handlers in `terraform_panos_monitorprofile/handlers.py`
