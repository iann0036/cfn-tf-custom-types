...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaadministrativetag.json`
2. Implement your resource handlers in `terraform_panos_panoramaadministrativetag/handlers.py`
