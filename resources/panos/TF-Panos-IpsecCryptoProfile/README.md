# TF::Panos::IpsecCryptoProfile

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-ipseccryptoprofile.json`
2. Implement your resource handlers in `tf_panos_ipseccryptoprofile/handlers.py`
