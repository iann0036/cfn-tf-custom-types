...
1. Write the JSON schema describing your resource, `terraform-panos-licenseapikey.json`
2. Implement your resource handlers in `terraform_panos_licenseapikey/handlers.py`
