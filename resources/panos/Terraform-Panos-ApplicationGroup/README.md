...
1. Write the JSON schema describing your resource, `terraform-panos-applicationgroup.json`
2. Implement your resource handlers in `terraform_panos_applicationgroup/handlers.py`
