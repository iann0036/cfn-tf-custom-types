...
1. Write the JSON schema describing your resource, `terraform-panos-bgpdampeningprofile.json`
2. Implement your resource handlers in `terraform_panos_bgpdampeningprofile/handlers.py`
