...
1. Write the JSON schema describing your resource, `terraform-panos-ipseccryptoprofile.json`
2. Implement your resource handlers in `terraform_panos_ipseccryptoprofile/handlers.py`
