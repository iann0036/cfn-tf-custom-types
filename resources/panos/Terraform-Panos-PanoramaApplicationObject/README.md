...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaapplicationobject.json`
2. Implement your resource handlers in `terraform_panos_panoramaapplicationobject/handlers.py`
