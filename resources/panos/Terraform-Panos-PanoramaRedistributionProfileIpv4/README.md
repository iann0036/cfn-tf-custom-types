# Terraform::Panos::PanoramaRedistributionProfileIpv4

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `terraform-panos-panoramaredistributionprofileipv4.json`
2. Implement your resource handlers in `terraform_panos_panoramaredistributionprofileipv4/handlers.py`
