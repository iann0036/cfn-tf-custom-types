...
1. Write the JSON schema describing your resource, `tf-panos-panoramavirtualrouter.json`
2. Implement your resource handlers in `tf_panos_panoramavirtualrouter/handlers.py`
