...
1. Write the JSON schema describing your resource, `tf-panos-antivirussecurityprofile.json`
2. Implement your resource handlers in `tf_panos_antivirussecurityprofile/handlers.py`
