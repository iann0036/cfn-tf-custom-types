...
1. Write the JSON schema describing your resource, `tf-panos-panoramadevicegroupentry.json`
2. Implement your resource handlers in `tf_panos_panoramadevicegroupentry/handlers.py`
