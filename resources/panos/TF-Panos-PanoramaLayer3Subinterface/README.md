# TF::Panos::PanoramaLayer3Subinterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramalayer3subinterface.json`
2. Implement your resource handlers in `tf_panos_panoramalayer3subinterface/handlers.py`
