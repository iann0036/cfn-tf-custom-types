...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaethernetinterface.json`
2. Implement your resource handlers in `terraform_panos_panoramaethernetinterface/handlers.py`
