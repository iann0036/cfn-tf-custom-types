...
1. Write the JSON schema describing your resource, `terraform-panos-panoramavlaninterface.json`
2. Implement your resource handlers in `terraform_panos_panoramavlaninterface/handlers.py`
