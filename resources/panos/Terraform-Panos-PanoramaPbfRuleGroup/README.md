...
1. Write the JSON schema describing your resource, `terraform-panos-panoramapbfrulegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramapbfrulegroup/handlers.py`
