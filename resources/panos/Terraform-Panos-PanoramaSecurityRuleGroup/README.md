...
1. Write the JSON schema describing your resource, `terraform-panos-panoramasecurityrulegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramasecurityrulegroup/handlers.py`
