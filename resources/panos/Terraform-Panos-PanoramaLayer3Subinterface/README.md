...
1. Write the JSON schema describing your resource, `terraform-panos-panoramalayer3subinterface.json`
2. Implement your resource handlers in `terraform_panos_panoramalayer3subinterface/handlers.py`
