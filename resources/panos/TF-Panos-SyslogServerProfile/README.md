...
1. Write the JSON schema describing your resource, `tf-panos-syslogserverprofile.json`
2. Implement your resource handlers in `tf_panos_syslogserverprofile/handlers.py`
