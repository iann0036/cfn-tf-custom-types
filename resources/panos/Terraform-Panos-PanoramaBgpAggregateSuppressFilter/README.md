...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpaggregatesuppressfilter.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpaggregatesuppressfilter/handlers.py`
