...
1. Write the JSON schema describing your resource, `terraform-panos-zoneentry.json`
2. Implement your resource handlers in `terraform_panos_zoneentry/handlers.py`
