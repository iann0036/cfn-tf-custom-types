# TF::Panos::EthernetInterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-ethernetinterface.json`
2. Implement your resource handlers in `tf_panos_ethernetinterface/handlers.py`
