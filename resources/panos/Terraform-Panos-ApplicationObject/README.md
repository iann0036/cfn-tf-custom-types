...
1. Write the JSON schema describing your resource, `terraform-panos-applicationobject.json`
2. Implement your resource handlers in `terraform_panos_applicationobject/handlers.py`
