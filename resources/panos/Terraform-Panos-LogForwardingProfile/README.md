...
1. Write the JSON schema describing your resource, `terraform-panos-logforwardingprofile.json`
2. Implement your resource handlers in `terraform_panos_logforwardingprofile/handlers.py`
