...
1. Write the JSON schema describing your resource, `terraform-panos-panoramatunnelinterface.json`
2. Implement your resource handlers in `terraform_panos_panoramatunnelinterface/handlers.py`
