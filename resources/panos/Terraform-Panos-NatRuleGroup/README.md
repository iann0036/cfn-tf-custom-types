...
1. Write the JSON schema describing your resource, `terraform-panos-natrulegroup.json`
2. Implement your resource handlers in `terraform_panos_natrulegroup/handlers.py`
