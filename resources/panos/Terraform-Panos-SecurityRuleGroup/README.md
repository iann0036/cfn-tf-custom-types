...
1. Write the JSON schema describing your resource, `terraform-panos-securityrulegroup.json`
2. Implement your resource handlers in `terraform_panos_securityrulegroup/handlers.py`
