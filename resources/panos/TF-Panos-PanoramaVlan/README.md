# TF::Panos::PanoramaVlan

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramavlan.json`
2. Implement your resource handlers in `tf_panos_panoramavlan/handlers.py`
