...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpauthprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpauthprofile/handlers.py`
