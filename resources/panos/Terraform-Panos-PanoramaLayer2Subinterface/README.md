...
1. Write the JSON schema describing your resource, `terraform-panos-panoramalayer2subinterface.json`
2. Implement your resource handlers in `terraform_panos_panoramalayer2subinterface/handlers.py`
