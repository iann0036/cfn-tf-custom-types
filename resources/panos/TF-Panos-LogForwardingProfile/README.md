...
1. Write the JSON schema describing your resource, `tf-panos-logforwardingprofile.json`
2. Implement your resource handlers in `tf_panos_logforwardingprofile/handlers.py`
