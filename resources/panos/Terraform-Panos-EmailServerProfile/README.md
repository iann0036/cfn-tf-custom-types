...
1. Write the JSON schema describing your resource, `terraform-panos-emailserverprofile.json`
2. Implement your resource handlers in `terraform_panos_emailserverprofile/handlers.py`
