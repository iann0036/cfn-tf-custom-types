...
1. Write the JSON schema describing your resource, `tf-panos-dosprotectionprofile.json`
2. Implement your resource handlers in `tf_panos_dosprotectionprofile/handlers.py`
