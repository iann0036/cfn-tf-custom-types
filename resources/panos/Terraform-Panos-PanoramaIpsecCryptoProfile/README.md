...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaipseccryptoprofile.json`
2. Implement your resource handlers in `terraform_panos_panoramaipseccryptoprofile/handlers.py`
