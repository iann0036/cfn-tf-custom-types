# TF::Panos::PanoramaLayer2Subinterface

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramalayer2subinterface.json`
2. Implement your resource handlers in `tf_panos_panoramalayer2subinterface/handlers.py`
