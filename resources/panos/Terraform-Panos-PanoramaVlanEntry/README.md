...
1. Write the JSON schema describing your resource, `terraform-panos-panoramavlanentry.json`
2. Implement your resource handlers in `terraform_panos_panoramavlanentry/handlers.py`
