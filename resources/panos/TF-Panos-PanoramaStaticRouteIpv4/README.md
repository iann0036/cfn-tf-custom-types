# TF::Panos::PanoramaStaticRouteIpv4

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-panos-panoramastaticrouteipv4.json`
2. Implement your resource handlers in `tf_panos_panoramastaticrouteipv4/handlers.py`
