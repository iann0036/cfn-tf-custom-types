...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaapplicationsignature.json`
2. Implement your resource handlers in `terraform_panos_panoramaapplicationsignature/handlers.py`
