...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgppeergroup.json`
2. Implement your resource handlers in `terraform_panos_panoramabgppeergroup/handlers.py`
