...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaserviceobject.json`
2. Implement your resource handlers in `terraform_panos_panoramaserviceobject/handlers.py`
