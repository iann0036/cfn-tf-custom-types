...
1. Write the JSON schema describing your resource, `terraform-panos-panoramasecuritypolicy.json`
2. Implement your resource handlers in `terraform_panos_panoramasecuritypolicy/handlers.py`
