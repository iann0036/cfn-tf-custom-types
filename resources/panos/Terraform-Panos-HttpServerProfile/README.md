...
1. Write the JSON schema describing your resource, `terraform-panos-httpserverprofile.json`
2. Implement your resource handlers in `terraform_panos_httpserverprofile/handlers.py`
