...
1. Write the JSON schema describing your resource, `terraform-panos-panoramaaddressobject.json`
2. Implement your resource handlers in `terraform_panos_panoramaaddressobject/handlers.py`
