...
1. Write the JSON schema describing your resource, `terraform-panos-applicationsignature.json`
2. Implement your resource handlers in `terraform_panos_applicationsignature/handlers.py`
