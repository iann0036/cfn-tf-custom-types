...
1. Write the JSON schema describing your resource, `tf-panos-panoramaapplicationobject.json`
2. Implement your resource handlers in `tf_panos_panoramaapplicationobject/handlers.py`
