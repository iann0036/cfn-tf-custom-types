...
1. Write the JSON schema describing your resource, `terraform-panos-staticrouteipv4.json`
2. Implement your resource handlers in `terraform_panos_staticrouteipv4/handlers.py`
