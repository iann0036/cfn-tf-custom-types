...
1. Write the JSON schema describing your resource, `tf-panos-panoramanatrulegroup.json`
2. Implement your resource handlers in `tf_panos_panoramanatrulegroup/handlers.py`
