...
1. Write the JSON schema describing your resource, `terraform-panos-panoramagcpaccount.json`
2. Implement your resource handlers in `terraform_panos_panoramagcpaccount/handlers.py`
