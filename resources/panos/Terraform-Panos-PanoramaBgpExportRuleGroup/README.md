...
1. Write the JSON schema describing your resource, `terraform-panos-panoramabgpexportrulegroup.json`
2. Implement your resource handlers in `terraform_panos_panoramabgpexportrulegroup/handlers.py`
