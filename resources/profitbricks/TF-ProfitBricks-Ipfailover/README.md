# TF::ProfitBricks::Ipfailover

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-ipfailover.json`
2. Implement your resource handlers in `tf_profitbricks_ipfailover/handlers.py`
