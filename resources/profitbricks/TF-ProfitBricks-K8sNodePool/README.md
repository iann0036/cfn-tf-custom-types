...
1. Write the JSON schema describing your resource, `tf-profitbricks-k8snodepool.json`
2. Implement your resource handlers in `tf_profitbricks_k8snodepool/handlers.py`
