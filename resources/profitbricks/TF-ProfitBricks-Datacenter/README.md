# TF::ProfitBricks::Datacenter

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-datacenter.json`
2. Implement your resource handlers in `tf_profitbricks_datacenter/handlers.py`
