# TF::ProfitBricks::Snapshot

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-snapshot.json`
2. Implement your resource handlers in `tf_profitbricks_snapshot/handlers.py`
