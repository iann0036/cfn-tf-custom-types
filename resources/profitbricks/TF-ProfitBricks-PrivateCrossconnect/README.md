...
1. Write the JSON schema describing your resource, `tf-profitbricks-privatecrossconnect.json`
2. Implement your resource handlers in `tf_profitbricks_privatecrossconnect/handlers.py`
