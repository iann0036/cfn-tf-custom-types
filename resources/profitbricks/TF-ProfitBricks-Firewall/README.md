...
1. Write the JSON schema describing your resource, `tf-profitbricks-firewall.json`
2. Implement your resource handlers in `tf_profitbricks_firewall/handlers.py`
