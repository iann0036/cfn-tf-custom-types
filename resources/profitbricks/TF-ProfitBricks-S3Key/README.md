# TF::ProfitBricks::S3Key

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-s3key.json`
2. Implement your resource handlers in `tf_profitbricks_s3key/handlers.py`
