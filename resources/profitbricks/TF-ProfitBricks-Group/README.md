# TF::ProfitBricks::Group

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-group.json`
2. Implement your resource handlers in `tf_profitbricks_group/handlers.py`
