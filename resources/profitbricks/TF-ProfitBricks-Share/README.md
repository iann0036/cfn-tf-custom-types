# TF::ProfitBricks::Share

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-share.json`
2. Implement your resource handlers in `tf_profitbricks_share/handlers.py`
