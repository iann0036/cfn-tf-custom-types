# TF::ProfitBricks::K8sCluster

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-profitbricks-k8scluster.json`
2. Implement your resource handlers in `tf_profitbricks_k8scluster/handlers.py`
