...
1. Write the JSON schema describing your resource, `tf-b2-bucketfileversion.json`
2. Implement your resource handlers in `tf_b2_bucketfileversion/handlers.py`
