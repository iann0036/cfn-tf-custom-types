# TF::Gridscale::PaasSecurityzone

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gridscale-paassecurityzone.json`
2. Implement your resource handlers in `tf_gridscale_paassecurityzone/handlers.py`
