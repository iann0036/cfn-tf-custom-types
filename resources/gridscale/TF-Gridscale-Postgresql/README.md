# TF::Gridscale::Postgresql

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gridscale-postgresql.json`
2. Implement your resource handlers in `tf_gridscale_postgresql/handlers.py`
