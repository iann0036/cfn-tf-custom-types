...
1. Write the JSON schema describing your resource, `tf-gridscale-backupschedule.json`
2. Implement your resource handlers in `tf_gridscale_backupschedule/handlers.py`
