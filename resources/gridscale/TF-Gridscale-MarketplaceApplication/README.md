...
1. Write the JSON schema describing your resource, `tf-gridscale-marketplaceapplication.json`
2. Implement your resource handlers in `tf_gridscale_marketplaceapplication/handlers.py`
