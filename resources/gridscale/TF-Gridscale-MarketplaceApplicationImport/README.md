...
1. Write the JSON schema describing your resource, `tf-gridscale-marketplaceapplicationimport.json`
2. Implement your resource handlers in `tf_gridscale_marketplaceapplicationimport/handlers.py`
