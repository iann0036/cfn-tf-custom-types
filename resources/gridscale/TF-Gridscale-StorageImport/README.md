# TF::Gridscale::StorageImport

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gridscale-storageimport.json`
2. Implement your resource handlers in `tf_gridscale_storageimport/handlers.py`
