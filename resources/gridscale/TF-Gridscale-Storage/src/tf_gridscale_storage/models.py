...
class ResourceModel(BaseModel):
    ...
    RollbackFromBackupUuid: Optional[str]
    Status: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            LastUsedTemplate=json_data.get("LastUsedTemplate"),
            ...
            ParentUuid=json_data.get("ParentUuid"),
            RollbackFromBackupUuid=json_data.get("RollbackFromBackupUuid"),
...
class TemplateDefinition(BaseModel):
    ...
    def _deserialize(
        ...
        return cls(
            ...
            PasswordType=json_data.get("PasswordType"),
