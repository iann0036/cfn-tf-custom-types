# TF::Gridscale::ObjectStorageAccesskey

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gridscale-objectstorageaccesskey.json`
2. Implement your resource handlers in `tf_gridscale_objectstorageaccesskey/handlers.py`
