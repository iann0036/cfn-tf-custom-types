...
1. Write the JSON schema describing your resource, `tf-gridscale-loadbalancer.json`
2. Implement your resource handlers in `tf_gridscale_loadbalancer/handlers.py`
