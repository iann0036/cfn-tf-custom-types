...
1. Write the JSON schema describing your resource, `tf-gridscale-storageclone.json`
2. Implement your resource handlers in `tf_gridscale_storageclone/handlers.py`
