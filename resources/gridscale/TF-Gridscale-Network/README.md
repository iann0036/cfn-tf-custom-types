# TF::Gridscale::Network

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-gridscale-network.json`
2. Implement your resource handlers in `tf_gridscale_network/handlers.py`
