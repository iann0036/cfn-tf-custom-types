...
1. Write the JSON schema describing your resource, `tf-gridscale-snapshotschedule.json`
2. Implement your resource handlers in `tf_gridscale_snapshotschedule/handlers.py`
