...
1. Write the JSON schema describing your resource, `tf-gridscale-sslcertificate.json`
2. Implement your resource handlers in `tf_gridscale_sslcertificate/handlers.py`
