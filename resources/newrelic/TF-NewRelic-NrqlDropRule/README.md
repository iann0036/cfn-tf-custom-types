...
1. Write the JSON schema describing your resource, `tf-newrelic-nrqldroprule.json`
2. Implement your resource handlers in `tf_newrelic_nrqldroprule/handlers.py`
