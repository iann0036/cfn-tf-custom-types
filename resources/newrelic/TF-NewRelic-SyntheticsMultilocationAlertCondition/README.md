...
1. Write the JSON schema describing your resource, `tf-newrelic-syntheticsmultilocationalertcondition.json`
2. Implement your resource handlers in `tf_newrelic_syntheticsmultilocationalertcondition/handlers.py`
