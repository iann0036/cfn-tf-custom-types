...
1. Write the JSON schema describing your resource, `tf-newrelic-alertcondition.json`
2. Implement your resource handlers in `tf_newrelic_alertcondition/handlers.py`
