...
1. Write the JSON schema describing your resource, `terraform-newrelic-syntheticslabel.json`
2. Implement your resource handlers in `terraform_newrelic_syntheticslabel/handlers.py`
