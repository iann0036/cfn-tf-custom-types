...
1. Write the JSON schema describing your resource, `terraform-newrelic-syntheticsmonitorscript.json`
2. Implement your resource handlers in `terraform_newrelic_syntheticsmonitorscript/handlers.py`
