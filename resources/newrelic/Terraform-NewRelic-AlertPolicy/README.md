...
1. Write the JSON schema describing your resource, `terraform-newrelic-alertpolicy.json`
2. Implement your resource handlers in `terraform_newrelic_alertpolicy/handlers.py`
