...
1. Write the JSON schema describing your resource, `tf-newrelic-onedashboard.json`
2. Implement your resource handlers in `tf_newrelic_onedashboard/handlers.py`
