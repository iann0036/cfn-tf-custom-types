...
1. Write the JSON schema describing your resource, `terraform-newrelic-applicationlabel.json`
2. Implement your resource handlers in `terraform_newrelic_applicationlabel/handlers.py`
