...
1. Write the JSON schema describing your resource, `terraform-newrelic-insightsevent.json`
2. Implement your resource handlers in `terraform_newrelic_insightsevent/handlers.py`
