...
1. Write the JSON schema describing your resource, `terraform-newrelic-alertcondition.json`
2. Implement your resource handlers in `terraform_newrelic_alertcondition/handlers.py`
