...
1. Write the JSON schema describing your resource, `tf-newrelic-syntheticsalertcondition.json`
2. Implement your resource handlers in `tf_newrelic_syntheticsalertcondition/handlers.py`
