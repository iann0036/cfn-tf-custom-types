...
1. Write the JSON schema describing your resource, `tf-newrelic-applicationsettings.json`
2. Implement your resource handlers in `tf_newrelic_applicationsettings/handlers.py`
