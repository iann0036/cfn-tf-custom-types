...
1. Write the JSON schema describing your resource, `tf-newrelic-insightsevent.json`
2. Implement your resource handlers in `tf_newrelic_insightsevent/handlers.py`
