...
1. Write the JSON schema describing your resource, `tf-newrelic-infraalertcondition.json`
2. Implement your resource handlers in `tf_newrelic_infraalertcondition/handlers.py`
