...
1. Write the JSON schema describing your resource, `terraform-newrelic-nrqlalertcondition.json`
2. Implement your resource handlers in `terraform_newrelic_nrqlalertcondition/handlers.py`
