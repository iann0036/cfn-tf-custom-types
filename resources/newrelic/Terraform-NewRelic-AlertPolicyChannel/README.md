...
1. Write the JSON schema describing your resource, `terraform-newrelic-alertpolicychannel.json`
2. Implement your resource handlers in `terraform_newrelic_alertpolicychannel/handlers.py`
