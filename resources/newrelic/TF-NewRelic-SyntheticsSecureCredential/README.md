...
1. Write the JSON schema describing your resource, `tf-newrelic-syntheticssecurecredential.json`
2. Implement your resource handlers in `tf_newrelic_syntheticssecurecredential/handlers.py`
