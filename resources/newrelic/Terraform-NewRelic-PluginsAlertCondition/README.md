...
1. Write the JSON schema describing your resource, `terraform-newrelic-pluginsalertcondition.json`
2. Implement your resource handlers in `terraform_newrelic_pluginsalertcondition/handlers.py`
