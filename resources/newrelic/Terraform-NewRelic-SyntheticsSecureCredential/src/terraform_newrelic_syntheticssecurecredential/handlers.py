...
def create_handler(
    ...
    try:
        ...
        tf['resource']['newrelic_synthetics_secure_credential'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['newrelic_synthetics_secure_credential'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
