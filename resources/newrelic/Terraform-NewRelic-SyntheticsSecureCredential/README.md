...
1. Write the JSON schema describing your resource, `terraform-newrelic-syntheticssecurecredential.json`
2. Implement your resource handlers in `terraform_newrelic_syntheticssecurecredential/handlers.py`
