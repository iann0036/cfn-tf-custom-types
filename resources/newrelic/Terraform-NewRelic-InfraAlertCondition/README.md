...
1. Write the JSON schema describing your resource, `terraform-newrelic-infraalertcondition.json`
2. Implement your resource handlers in `terraform_newrelic_infraalertcondition/handlers.py`
