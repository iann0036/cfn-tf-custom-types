...
1. Write the JSON schema describing your resource, `terraform-newrelic-syntheticsalertcondition.json`
2. Implement your resource handlers in `terraform_newrelic_syntheticsalertcondition/handlers.py`
