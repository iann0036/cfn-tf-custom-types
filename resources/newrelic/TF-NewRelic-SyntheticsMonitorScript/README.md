# TF::NewRelic::SyntheticsMonitorScript

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-newrelic-syntheticsmonitorscript.json`
2. Implement your resource handlers in `tf_newrelic_syntheticsmonitorscript/handlers.py`
