...
1. Write the JSON schema describing your resource, `tf-newrelic-nrqlalertcondition.json`
2. Implement your resource handlers in `tf_newrelic_nrqlalertcondition/handlers.py`
