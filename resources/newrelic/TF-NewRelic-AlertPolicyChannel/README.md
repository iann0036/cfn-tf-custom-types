...
1. Write the JSON schema describing your resource, `tf-newrelic-alertpolicychannel.json`
2. Implement your resource handlers in `tf_newrelic_alertpolicychannel/handlers.py`
