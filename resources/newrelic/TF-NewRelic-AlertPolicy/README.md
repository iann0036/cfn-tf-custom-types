...
1. Write the JSON schema describing your resource, `tf-newrelic-alertpolicy.json`
2. Implement your resource handlers in `tf_newrelic_alertpolicy/handlers.py`
