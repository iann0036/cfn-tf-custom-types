...
1. Write the JSON schema describing your resource, `terraform-newrelic-alertchannel.json`
2. Implement your resource handlers in `terraform_newrelic_alertchannel/handlers.py`
