...
1. Write the JSON schema describing your resource, `terraform-newrelic-syntheticsmonitor.json`
2. Implement your resource handlers in `terraform_newrelic_syntheticsmonitor/handlers.py`
