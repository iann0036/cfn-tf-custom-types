...
1. Write the JSON schema describing your resource, `tf-newrelic-alertmutingrule.json`
2. Implement your resource handlers in `tf_newrelic_alertmutingrule/handlers.py`
