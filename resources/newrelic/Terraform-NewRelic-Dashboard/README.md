...
1. Write the JSON schema describing your resource, `terraform-newrelic-dashboard.json`
2. Implement your resource handlers in `terraform_newrelic_dashboard/handlers.py`
