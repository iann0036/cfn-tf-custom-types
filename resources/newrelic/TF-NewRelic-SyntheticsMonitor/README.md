...
1. Write the JSON schema describing your resource, `tf-newrelic-syntheticsmonitor.json`
2. Implement your resource handlers in `tf_newrelic_syntheticsmonitor/handlers.py`
