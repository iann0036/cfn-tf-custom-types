...
1. Write the JSON schema describing your resource, `tf-newrelic-pluginsalertcondition.json`
2. Implement your resource handlers in `tf_newrelic_pluginsalertcondition/handlers.py`
