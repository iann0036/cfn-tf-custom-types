...
1. Write the JSON schema describing your resource, `tf-newrelic-apiaccesskey.json`
2. Implement your resource handlers in `tf_newrelic_apiaccesskey/handlers.py`
