# TF::NewRelic::AlertChannel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-newrelic-alertchannel.json`
2. Implement your resource handlers in `tf_newrelic_alertchannel/handlers.py`
