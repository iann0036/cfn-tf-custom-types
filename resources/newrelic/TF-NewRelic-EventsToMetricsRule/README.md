...
1. Write the JSON schema describing your resource, `tf-newrelic-eventstometricsrule.json`
2. Implement your resource handlers in `tf_newrelic_eventstometricsrule/handlers.py`
