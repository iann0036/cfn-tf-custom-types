...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleactivedirectorydomaintrust.json`
2. Implement your resource handlers in `tf_googlebeta_googleactivedirectorydomaintrust/handlers.py`
