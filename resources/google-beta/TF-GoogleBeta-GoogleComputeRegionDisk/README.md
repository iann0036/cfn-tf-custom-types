...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeregiondisk.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeregiondisk/handlers.py`
