...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleserviceusageconsumerquotaoverride.json`
2. Implement your resource handlers in `tf_googlebeta_googleserviceusageconsumerquotaoverride/handlers.py`
