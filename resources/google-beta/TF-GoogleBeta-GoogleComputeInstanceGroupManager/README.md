...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeinstancegroupmanager.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeinstancegroupmanager/handlers.py`
