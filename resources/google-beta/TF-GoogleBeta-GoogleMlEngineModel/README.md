...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlemlenginemodel.json`
2. Implement your resource handlers in `tf_googlebeta_googlemlenginemodel/handlers.py`
