...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleiapbrand.json`
2. Implement your resource handlers in `tf_googlebeta_googleiapbrand/handlers.py`
