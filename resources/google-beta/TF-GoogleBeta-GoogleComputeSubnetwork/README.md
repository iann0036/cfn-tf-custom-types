...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputesubnetwork.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputesubnetwork/handlers.py`
