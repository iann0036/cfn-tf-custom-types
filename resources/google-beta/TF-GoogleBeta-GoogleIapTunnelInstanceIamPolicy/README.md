# TF::GoogleBeta::GoogleIapTunnelInstanceIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleiaptunnelinstanceiampolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googleiaptunnelinstanceiampolicy/handlers.py`
