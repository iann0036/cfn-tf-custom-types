# TF::GoogleBeta::GoogleDeploymentManagerDeployment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googledeploymentmanagerdeployment.json`
2. Implement your resource handlers in `tf_googlebeta_googledeploymentmanagerdeployment/handlers.py`
