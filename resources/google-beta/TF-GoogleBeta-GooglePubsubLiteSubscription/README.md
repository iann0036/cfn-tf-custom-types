...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlepubsublitesubscription.json`
2. Implement your resource handlers in `tf_googlebeta_googlepubsublitesubscription/handlers.py`
