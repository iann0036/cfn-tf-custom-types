# TF::GoogleBeta::GoogleHealthcareDatasetIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlehealthcaredatasetiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googlehealthcaredatasetiammember/handlers.py`
