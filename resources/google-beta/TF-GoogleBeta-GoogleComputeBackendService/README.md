...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputebackendservice.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputebackendservice/handlers.py`
