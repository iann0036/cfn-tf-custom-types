# TF::GoogleBeta::GoogleComputeBackendService
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleComputeBackendService",
    "Properties" : {
        ...
        "<a href="#customresponseheaders" title="CustomResponseHeaders">CustomResponseHeaders</a>" : <i>[ String, ... ]</i>,
...
Properties:
    ...
    <a href="#customrequestheaders" title="CustomRequestHeaders">CustomRequestHeaders</a>: <i>
      - String</i>
    <a href="#customresponseheaders" title="CustomResponseHeaders">CustomResponseHeaders</a>: <i>
      - String</i>
    <a href="#description" title="Description">Description</a>: <i>String</i>
    <a href="#enablecdn" title="EnableCdn">EnableCdn</a>: <i>Boolean</i>
