...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleappengineflexibleappversion.json`
2. Implement your resource handlers in `tf_googlebeta_googleappengineflexibleappversion/handlers.py`
