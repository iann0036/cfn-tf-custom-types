...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatacatalogpolicytag.json`
2. Implement your resource handlers in `tf_googlebeta_googledatacatalogpolicytag/handlers.py`
