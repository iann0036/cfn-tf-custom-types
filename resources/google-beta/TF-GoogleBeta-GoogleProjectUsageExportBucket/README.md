# TF::GoogleBeta::GoogleProjectUsageExportBucket

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleprojectusageexportbucket.json`
2. Implement your resource handlers in `tf_googlebeta_googleprojectusageexportbucket/handlers.py`
