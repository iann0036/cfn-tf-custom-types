# TF::GoogleBeta::GoogleSourcerepoRepositoryIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlesourcereporepositoryiampolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googlesourcereporepositoryiampolicy/handlers.py`
