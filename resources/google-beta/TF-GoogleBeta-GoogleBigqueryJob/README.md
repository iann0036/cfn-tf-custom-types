...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigqueryjob.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigqueryjob/handlers.py`
