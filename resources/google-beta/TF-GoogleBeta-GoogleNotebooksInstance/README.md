# TF::GoogleBeta::GoogleNotebooksInstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlenotebooksinstance.json`
2. Implement your resource handlers in `tf_googlebeta_googlenotebooksinstance/handlers.py`
