...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlehealthcarehl7v2store.json`
2. Implement your resource handlers in `tf_googlebeta_googlehealthcarehl7v2store/handlers.py`
