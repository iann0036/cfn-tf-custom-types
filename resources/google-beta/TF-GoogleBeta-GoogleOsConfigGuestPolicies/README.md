...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleosconfigguestpolicies.json`
2. Implement your resource handlers in `tf_googlebeta_googleosconfigguestpolicies/handlers.py`
