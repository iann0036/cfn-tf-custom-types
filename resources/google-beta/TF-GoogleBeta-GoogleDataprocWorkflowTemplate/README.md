...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledataprocworkflowtemplate.json`
2. Implement your resource handlers in `tf_googlebeta_googledataprocworkflowtemplate/handlers.py`
