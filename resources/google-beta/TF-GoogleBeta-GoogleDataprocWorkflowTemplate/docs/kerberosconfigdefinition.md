# TF::GoogleBeta::GoogleDataprocWorkflowTemplate KerberosConfigDefinition
...
<pre>
{
    ...
    "<a href="#crossrealmtrustsharedpassword" title="CrossRealmTrustSharedPassword">CrossRealmTrustSharedPassword</a>" : <i>String</i>,
    "<a href="#enablekerberos" title="EnableKerberos">EnableKerberos</a>" : <i>Boolean</i>,
    "<a href="#kdcdbkey" title="KdcDbKey">KdcDbKey</a>" : <i>String</i>,
    "<a href="#keypassword" title="KeyPassword">KeyPassword</a>" : <i>String</i>,
    "<a href="#keystore" title="Keystore">Keystore</a>" : <i>String</i>,
    "<a href="#keystorepassword" title="KeystorePassword">KeystorePassword</a>" : <i>String</i>,
    "<a href="#kmskey" title="KmsKey">KmsKey</a>" : <i>String</i>,
    "<a href="#realm" title="Realm">Realm</a>" : <i>String</i>,
    "<a href="#rootprincipalpassword" title="RootPrincipalPassword">RootPrincipalPassword</a>" : <i>String</i>,
    "<a href="#tgtlifetimehours" title="TgtLifetimeHours">TgtLifetimeHours</a>" : <i>Double</i>,
    "<a href="#truststore" title="Truststore">Truststore</a>" : <i>String</i>,
    "<a href="#truststorepassword" title="TruststorePassword">TruststorePassword</a>" : <i>String</i>
}
</pre>
