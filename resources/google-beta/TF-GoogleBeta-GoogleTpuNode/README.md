...
1. Write the JSON schema describing your resource, `tf-googlebeta-googletpunode.json`
2. Implement your resource handlers in `tf_googlebeta_googletpunode/handlers.py`
