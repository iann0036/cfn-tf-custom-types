...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleloggingorganizationsink.json`
2. Implement your resource handlers in `tf_googlebeta_googleloggingorganizationsink/handlers.py`
