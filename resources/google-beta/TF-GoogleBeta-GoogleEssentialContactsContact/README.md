...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleessentialcontactscontact.json`
2. Implement your resource handlers in `tf_googlebeta_googleessentialcontactscontact/handlers.py`
