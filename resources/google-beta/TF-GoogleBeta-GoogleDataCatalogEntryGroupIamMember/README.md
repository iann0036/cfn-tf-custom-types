# TF::GoogleBeta::GoogleDataCatalogEntryGroupIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googledatacatalogentrygroupiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googledatacatalogentrygroupiammember/handlers.py`
