...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlefirestoreindex.json`
2. Implement your resource handlers in `tf_googlebeta_googlefirestoreindex/handlers.py`
