...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleosconfigpatchdeployment.json`
2. Implement your resource handlers in `tf_googlebeta_googleosconfigpatchdeployment/handlers.py`
