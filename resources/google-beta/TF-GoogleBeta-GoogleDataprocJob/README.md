...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledataprocjob.json`
2. Implement your resource handlers in `tf_googlebeta_googledataprocjob/handlers.py`
