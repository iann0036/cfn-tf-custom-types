...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlesqldatabaseinstance.json`
2. Implement your resource handlers in `tf_googlebeta_googlesqldatabaseinstance/handlers.py`
