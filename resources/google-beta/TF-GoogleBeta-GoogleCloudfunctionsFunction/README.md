...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudfunctionsfunction.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudfunctionsfunction/handlers.py`
