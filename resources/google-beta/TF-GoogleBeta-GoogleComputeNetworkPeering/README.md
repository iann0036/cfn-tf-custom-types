...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputenetworkpeering.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputenetworkpeering/handlers.py`
