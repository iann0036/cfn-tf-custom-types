...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatalosspreventionstoredinfotype.json`
2. Implement your resource handlers in `tf_googlebeta_googledatalosspreventionstoredinfotype/handlers.py`
