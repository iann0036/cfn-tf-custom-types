...
CloudFormation equivalent of google_data_catalog_tag_template
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleDataCatalogTagTemplate",
    "Properties" : {
        "<a href="#displayname" title="DisplayName">DisplayName</a>" : <i>String</i>,
        "<a href="#forcedelete" title="ForceDelete">ForceDelete</a>" : <i>Boolean</i>,
        "<a href="#project" title="Project">Project</a>" : <i>String</i>,
        "<a href="#region" title="Region">Region</a>" : <i>String</i>,
        "<a href="#tagtemplateid" title="TagTemplateId">TagTemplateId</a>" : <i>String</i>,
