...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledataflowflextemplatejob.json`
2. Implement your resource handlers in `tf_googlebeta_googledataflowflextemplatejob/handlers.py`
