# TF::GoogleBeta::GoogleDataflowFlexTemplateJob

CloudFormation equivalent of google_dataflow_flex_template_job
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleDataflowFlexTemplateJob",
    "Properties" : {
        "<a href="#containerspecgcspath" title="ContainerSpecGcsPath">ContainerSpecGcsPath</a>" : <i>String</i>,
