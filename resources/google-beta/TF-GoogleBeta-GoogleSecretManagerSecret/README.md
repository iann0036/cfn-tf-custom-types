...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlesecretmanagersecret.json`
2. Implement your resource handlers in `tf_googlebeta_googlesecretmanagersecret/handlers.py`
