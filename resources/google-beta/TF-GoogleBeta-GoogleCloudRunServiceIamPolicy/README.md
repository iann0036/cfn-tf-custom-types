# TF::GoogleBeta::GoogleCloudRunServiceIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudrunserviceiampolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudrunserviceiampolicy/handlers.py`
