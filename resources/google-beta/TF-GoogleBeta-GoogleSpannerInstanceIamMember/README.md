# TF::GoogleBeta::GoogleSpannerInstanceIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlespannerinstanceiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googlespannerinstanceiammember/handlers.py`
