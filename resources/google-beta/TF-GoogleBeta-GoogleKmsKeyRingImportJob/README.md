...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlekmskeyringimportjob.json`
2. Implement your resource handlers in `tf_googlebeta_googlekmskeyringimportjob/handlers.py`
