...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeinstancefromtemplate.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeinstancefromtemplate/handlers.py`
