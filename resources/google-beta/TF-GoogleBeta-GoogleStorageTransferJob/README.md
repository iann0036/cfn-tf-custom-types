...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlestoragetransferjob.json`
2. Implement your resource handlers in `tf_googlebeta_googlestoragetransferjob/handlers.py`
