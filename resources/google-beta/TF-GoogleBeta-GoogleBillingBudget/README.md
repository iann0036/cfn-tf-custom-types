...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebillingbudget.json`
2. Implement your resource handlers in `tf_googlebeta_googlebillingbudget/handlers.py`
