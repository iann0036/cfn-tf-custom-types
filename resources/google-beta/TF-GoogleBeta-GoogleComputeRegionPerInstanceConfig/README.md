...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeregionperinstanceconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeregionperinstanceconfig/handlers.py`
