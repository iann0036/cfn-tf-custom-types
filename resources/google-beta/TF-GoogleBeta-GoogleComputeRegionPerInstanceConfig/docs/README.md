# TF::GoogleBeta::GoogleComputeRegionPerInstanceConfig

CloudFormation equivalent of google_compute_region_per_instance_config
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleComputeRegionPerInstanceConfig",
    "Properties" : {
        ...
        "<a href="#regioninstancegroupmanager" title="RegionInstanceGroupManager">RegionInstanceGroupManager</a>" : <i>String</i>,
