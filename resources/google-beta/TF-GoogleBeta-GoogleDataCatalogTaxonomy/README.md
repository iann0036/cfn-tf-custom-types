...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatacatalogtaxonomy.json`
2. Implement your resource handlers in `tf_googlebeta_googledatacatalogtaxonomy/handlers.py`
