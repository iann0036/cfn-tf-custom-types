...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleiamworkloadidentitypoolprovider.json`
2. Implement your resource handlers in `tf_googlebeta_googleiamworkloadidentitypoolprovider/handlers.py`
