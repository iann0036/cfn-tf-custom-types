...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeregiontargethttpsproxy.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeregiontargethttpsproxy/handlers.py`
