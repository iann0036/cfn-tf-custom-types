...
CloudFormation equivalent of google_data_catalog_tag_template_iam_binding
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleDataCatalogTagTemplateIamBinding",
    "Properties" : {
        "<a href="#members" title="Members">Members</a>" : <i>[ String, ... ]</i>,
        "<a href="#project" title="Project">Project</a>" : <i>String</i>,
        "<a href="#region" title="Region">Region</a>" : <i>String</i>,
        "<a href="#role" title="Role">Role</a>" : <i>String</i>,
        "<a href="#tagtemplate" title="TagTemplate">TagTemplate</a>" : <i>String</i>,
