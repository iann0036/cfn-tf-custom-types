...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudbuildtrigger.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudbuildtrigger/handlers.py`
