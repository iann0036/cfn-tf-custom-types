...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigqueryreservation.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigqueryreservation/handlers.py`
