# TF::GoogleBeta::GoogleHealthcareDataset

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlehealthcaredataset.json`
2. Implement your resource handlers in `tf_googlebeta_googlehealthcaredataset/handlers.py`
