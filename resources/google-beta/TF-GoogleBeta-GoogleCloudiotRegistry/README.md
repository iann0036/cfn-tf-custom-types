...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudiotregistry.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudiotregistry/handlers.py`
