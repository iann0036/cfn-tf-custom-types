# TF::GoogleBeta::GoogleMonitoringDashboard

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlemonitoringdashboard.json`
2. Implement your resource handlers in `tf_googlebeta_googlemonitoringdashboard/handlers.py`
