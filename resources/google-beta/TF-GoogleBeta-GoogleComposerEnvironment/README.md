# TF::GoogleBeta::GoogleComposerEnvironment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomposerenvironment.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomposerenvironment/handlers.py`
