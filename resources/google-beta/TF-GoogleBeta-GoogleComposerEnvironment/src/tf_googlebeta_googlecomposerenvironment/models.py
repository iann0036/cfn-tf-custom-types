...
class ConfigDefinition(BaseModel):
    ...
    DatabaseConfig: Optional[Sequence["_DatabaseConfigDefinition"]]
    ...
    WebServerNetworkAccessControl: Optional[Sequence["_WebServerNetworkAccessControlDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            DatabaseConfig=deserialize_list(json_data.get("DatabaseConfig"), DatabaseConfigDefinition),
            ...
            WebServerNetworkAccessControl=deserialize_list(json_data.get("WebServerNetworkAccessControl"), WebServerNetworkAccessControlDefinition),
        )
...
@dataclass
class DatabaseConfigDefinition(BaseModel):
    MachineType: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_DatabaseConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_DatabaseConfigDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_DatabaseConfigDefinition = DatabaseConfigDefinition
...
@dataclass
class WebServerNetworkAccessControlDefinition(BaseModel):
    AllowedIpRange: Optional[Sequence["_AllowedIpRangeDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_WebServerNetworkAccessControlDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_WebServerNetworkAccessControlDefinition"]:
        if not json_data:
            return None
        return cls(
            AllowedIpRange=deserialize_list(json_data.get("AllowedIpRange"), AllowedIpRangeDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_WebServerNetworkAccessControlDefinition = WebServerNetworkAccessControlDefinition


@dataclass
class AllowedIpRangeDefinition(BaseModel):
    Description: Optional[str]
    Value: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AllowedIpRangeDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AllowedIpRangeDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_AllowedIpRangeDefinition = AllowedIpRangeDefinition
