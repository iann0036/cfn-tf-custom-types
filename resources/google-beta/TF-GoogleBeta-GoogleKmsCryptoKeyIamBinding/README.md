# TF::GoogleBeta::GoogleKmsCryptoKeyIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlekmscryptokeyiambinding.json`
2. Implement your resource handlers in `tf_googlebeta_googlekmscryptokeyiambinding/handlers.py`
