...
class AutoscalingPolicyDefinition(BaseModel):
    ...
    ScaleDownControl: Optional[Sequence["_ScaleDownControlDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ScaleDownControl=deserialize_list(json_data.get("ScaleDownControl"), ScaleDownControlDefinition),
...
class MetricDefinition(BaseModel):
    Filter: Optional[str]
    Name: Optional[str]
    SingleInstanceAssignment: Optional[float]
    Target: Optional[float]
    Type: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            Name=json_data.get("Name"),
            SingleInstanceAssignment=json_data.get("SingleInstanceAssignment"),
            Target=json_data.get("Target"),
...
@dataclass
class ScaleDownControlDefinition(BaseModel):
    TimeWindowSec: Optional[float]
    MaxScaledDownReplicas: Optional[Sequence["_MaxScaledDownReplicasDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_ScaleDownControlDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ScaleDownControlDefinition"]:
        if not json_data:
            return None
        return cls(
            TimeWindowSec=json_data.get("TimeWindowSec"),
            MaxScaledDownReplicas=deserialize_list(json_data.get("MaxScaledDownReplicas"), MaxScaledDownReplicasDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_ScaleDownControlDefinition = ScaleDownControlDefinition


@dataclass
class MaxScaledDownReplicasDefinition(BaseModel):
    Fixed: Optional[float]
    Percent: Optional[float]

    @classmethod
    def _deserialize(
        cls: Type["_MaxScaledDownReplicasDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MaxScaledDownReplicasDefinition"]:
        if not json_data:
            return None
        return cls(
...
# work around possible type aliasing issues when variable has same name as a model
_MaxScaledDownReplicasDefinition = MaxScaledDownReplicasDefinition
