...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlekmssecretciphertext.json`
2. Implement your resource handlers in `tf_googlebeta_googlekmssecretciphertext/handlers.py`
