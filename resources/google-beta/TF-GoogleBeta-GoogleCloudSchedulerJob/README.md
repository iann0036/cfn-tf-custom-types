...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudschedulerjob.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudschedulerjob/handlers.py`
