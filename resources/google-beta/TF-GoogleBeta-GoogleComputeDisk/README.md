...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputedisk.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputedisk/handlers.py`
