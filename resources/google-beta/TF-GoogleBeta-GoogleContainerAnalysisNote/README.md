...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecontaineranalysisnote.json`
2. Implement your resource handlers in `tf_googlebeta_googlecontaineranalysisnote/handlers.py`
