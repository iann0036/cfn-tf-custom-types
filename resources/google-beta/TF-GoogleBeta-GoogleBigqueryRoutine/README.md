...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigqueryroutine.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigqueryroutine/handlers.py`
