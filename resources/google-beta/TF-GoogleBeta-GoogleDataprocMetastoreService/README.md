...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledataprocmetastoreservice.json`
2. Implement your resource handlers in `tf_googlebeta_googledataprocmetastoreservice/handlers.py`
