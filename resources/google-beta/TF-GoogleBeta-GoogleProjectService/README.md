...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleprojectservice.json`
2. Implement your resource handlers in `tf_googlebeta_googleprojectservice/handlers.py`
