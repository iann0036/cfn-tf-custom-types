...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlepubsubsubscription.json`
2. Implement your resource handlers in `tf_googlebeta_googlepubsubsubscription/handlers.py`
