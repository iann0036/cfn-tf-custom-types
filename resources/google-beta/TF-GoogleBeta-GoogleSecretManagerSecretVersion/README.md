...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlesecretmanagersecretversion.json`
2. Implement your resource handlers in `tf_googlebeta_googlesecretmanagersecretversion/handlers.py`
