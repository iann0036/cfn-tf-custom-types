...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlesqlsslcert.json`
2. Implement your resource handlers in `tf_googlebeta_googlesqlsslcert/handlers.py`
