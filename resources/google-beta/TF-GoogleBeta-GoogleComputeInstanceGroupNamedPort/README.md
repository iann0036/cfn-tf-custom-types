# TF::GoogleBeta::GoogleComputeInstanceGroupNamedPort

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeinstancegroupnamedport.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeinstancegroupnamedport/handlers.py`
