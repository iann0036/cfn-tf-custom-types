...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleapigatewayapiconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googleapigatewayapiconfig/handlers.py`
