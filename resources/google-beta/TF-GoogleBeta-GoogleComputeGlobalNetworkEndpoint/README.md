...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeglobalnetworkendpoint.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeglobalnetworkendpoint/handlers.py`
