...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebinaryauthorizationattestor.json`
2. Implement your resource handlers in `tf_googlebeta_googlebinaryauthorizationattestor/handlers.py`
