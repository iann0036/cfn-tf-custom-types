...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudiotdevice.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudiotdevice/handlers.py`
