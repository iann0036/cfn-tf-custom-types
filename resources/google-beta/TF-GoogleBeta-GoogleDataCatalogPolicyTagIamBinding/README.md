# TF::GoogleBeta::GoogleDataCatalogPolicyTagIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googledatacatalogpolicytagiambinding.json`
2. Implement your resource handlers in `tf_googlebeta_googledatacatalogpolicytagiambinding/handlers.py`
