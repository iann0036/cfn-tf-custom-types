...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecontaineranalysisoccurrence.json`
2. Implement your resource handlers in `tf_googlebeta_googlecontaineranalysisoccurrence/handlers.py`
