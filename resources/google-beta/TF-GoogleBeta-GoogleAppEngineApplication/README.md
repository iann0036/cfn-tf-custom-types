...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleappengineapplication.json`
2. Implement your resource handlers in `tf_googlebeta_googleappengineapplication/handlers.py`
