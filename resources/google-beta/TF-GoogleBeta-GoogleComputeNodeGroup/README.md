...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputenodegroup.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputenodegroup/handlers.py`
