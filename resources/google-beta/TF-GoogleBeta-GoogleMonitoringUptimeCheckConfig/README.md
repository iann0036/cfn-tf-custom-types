...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlemonitoringuptimecheckconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googlemonitoringuptimecheckconfig/handlers.py`
