# TF::GoogleBeta::GoogleLoggingProjectExclusion

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleloggingprojectexclusion.json`
2. Implement your resource handlers in `tf_googlebeta_googleloggingprojectexclusion/handlers.py`
