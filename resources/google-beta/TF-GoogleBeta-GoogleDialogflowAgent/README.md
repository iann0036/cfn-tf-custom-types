...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledialogflowagent.json`
2. Implement your resource handlers in `tf_googlebeta_googledialogflowagent/handlers.py`
