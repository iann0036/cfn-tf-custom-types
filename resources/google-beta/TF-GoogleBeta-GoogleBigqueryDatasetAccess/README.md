...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigquerydatasetaccess.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigquerydatasetaccess/handlers.py`
