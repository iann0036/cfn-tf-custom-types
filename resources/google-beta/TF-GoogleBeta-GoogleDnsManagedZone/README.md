...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlednsmanagedzone.json`
2. Implement your resource handlers in `tf_googlebeta_googlednsmanagedzone/handlers.py`
