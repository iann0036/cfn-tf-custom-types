...
class ResourceModel(BaseModel):
    ...
    ServiceDirectoryConfig: Optional[Sequence["_ServiceDirectoryConfigDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ReverseLookup=json_data.get("ReverseLookup"),
            ...
            ServiceDirectoryConfig=deserialize_list(json_data.get("ServiceDirectoryConfig"), ServiceDirectoryConfigDefinition),
...
@dataclass
class ServiceDirectoryConfigDefinition(BaseModel):
    Namespace: Optional[Sequence["_NamespaceDefinition"]]

    @classmethod
    def _deserialize(
        cls: Type["_ServiceDirectoryConfigDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_ServiceDirectoryConfigDefinition"]:
        if not json_data:
            return None
        return cls(
            Namespace=deserialize_list(json_data.get("Namespace"), NamespaceDefinition),
        )


# work around possible type aliasing issues when variable has same name as a model
_ServiceDirectoryConfigDefinition = ServiceDirectoryConfigDefinition
...
class NamespaceDefinition(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_NamespaceDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_NamespaceDefinition"]:
        if not json_data:
            return None
        return cls(
