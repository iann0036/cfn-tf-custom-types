...
CloudFormation equivalent of google_network_management_connectivity_test
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleNetworkManagementConnectivityTest",
    "Properties" : {
        ...
        "<a href="#relatedprojects" title="RelatedProjects">RelatedProjects</a>" : <i>[ String, ... ]</i>,
...
Properties:
    ...
    <a href="#project" title="Project">Project</a>: <i>String</i>
    <a href="#protocol" title="Protocol">Protocol</a>: <i>String</i>
    <a href="#relatedprojects" title="RelatedProjects">RelatedProjects</a>: <i>
      - String</i>
