...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleprojectaccessapprovalsettings.json`
2. Implement your resource handlers in `tf_googlebeta_googleprojectaccessapprovalsettings/handlers.py`
