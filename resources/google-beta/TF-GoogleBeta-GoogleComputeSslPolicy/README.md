...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputesslpolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputesslpolicy/handlers.py`
