# TF::GoogleBeta::GoogleRuntimeconfigConfigIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleruntimeconfigconfigiambinding.json`
2. Implement your resource handlers in `tf_googlebeta_googleruntimeconfigconfigiambinding/handlers.py`
