...
class ResourceModel(BaseModel):
    ...
    BootDisk: Optional[Sequence["_BootDiskDefinition3"]]
    ...
    SourceMachineImage: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            BootDisk=deserialize_list(json_data.get("BootDisk"), BootDiskDefinition3),
            ...
            SourceMachineImage=json_data.get("SourceMachineImage"),
...
@dataclass
class BootDiskDefinition3(BaseModel):
    AutoDelete: Optional[bool]
    DeviceName: Optional[str]
    DiskEncryptionKeyRaw: Optional[str]
    DiskEncryptionKeySha256: Optional[str]
    InitializeParams: Optional[Sequence["_BootDiskDefinition2"]]
    KmsKeySelfLink: Optional[str]
    Mode: Optional[str]
    Source: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_BootDiskDefinition3"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BootDiskDefinition3"]:
        if not json_data:
            return None
        return cls(
            ...
            DiskEncryptionKeyRaw=json_data.get("DiskEncryptionKeyRaw"),
            DiskEncryptionKeySha256=json_data.get("DiskEncryptionKeySha256"),
            InitializeParams=deserialize_list(json_data.get("InitializeParams"), BootDiskDefinition2),
            KmsKeySelfLink=json_data.get("KmsKeySelfLink"),
            Mode=json_data.get("Mode"),
            Source=json_data.get("Source"),
        )
...
# work around possible type aliasing issues when variable has same name as a model
_BootDiskDefinition3 = BootDiskDefinition3


@dataclass
class BootDiskDefinition2(BaseModel):
    Image: Optional[str]
    Labels: Optional[Sequence["_BootDiskDefinition"]]
    Size: Optional[float]
    Type: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_BootDiskDefinition2"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_BootDiskDefinition2"]:
        if not json_data:
            return None
        return cls(
            Image=json_data.get("Image"),
            Labels=deserialize_list(json_data.get("Labels"), BootDiskDefinition),
...
# work around possible type aliasing issues when variable has same name as a model
_BootDiskDefinition2 = BootDiskDefinition2
