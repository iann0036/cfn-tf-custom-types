# TF::GoogleBeta::GoogleComputeInstanceFromMachineImage

CloudFormation equivalent of google_compute_instance_from_machine_image
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleComputeInstanceFromMachineImage",
    "Properties" : {
        ...
        "<a href="#labels" title="Labels">Labels</a>" : <i>[ <a href="bootdiskdefinition.md">BootDiskDefinition</a>, ... ]</i>,
        ...
        "<a href="#sourcemachineimage" title="SourceMachineImage">SourceMachineImage</a>" : <i>String</i>,
...
Returns the <code>AttachedDisk</code> value.

#### BootDisk

Returns the <code>BootDisk</code> value.
...
Returns the <code>ScratchDisk</code> value.
