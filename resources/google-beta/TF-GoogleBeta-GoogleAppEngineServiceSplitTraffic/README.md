...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleappengineservicesplittraffic.json`
2. Implement your resource handlers in `tf_googlebeta_googleappengineservicesplittraffic/handlers.py`
