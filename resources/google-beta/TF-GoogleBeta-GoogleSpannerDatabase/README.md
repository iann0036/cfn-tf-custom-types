...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlespannerdatabase.json`
2. Implement your resource handlers in `tf_googlebeta_googlespannerdatabase/handlers.py`
