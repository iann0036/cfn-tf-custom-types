...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlesecurityscannerscanconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googlesecurityscannerscanconfig/handlers.py`
