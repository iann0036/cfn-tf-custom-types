...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeregionbackendservice.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeregionbackendservice/handlers.py`
