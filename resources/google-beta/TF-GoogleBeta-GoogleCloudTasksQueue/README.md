...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudtasksqueue.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudtasksqueue/handlers.py`
