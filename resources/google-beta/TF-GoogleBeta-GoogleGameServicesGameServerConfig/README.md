...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlegameservicesgameserverconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googlegameservicesgameserverconfig/handlers.py`
