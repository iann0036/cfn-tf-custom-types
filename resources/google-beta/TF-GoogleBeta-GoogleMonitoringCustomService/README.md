...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlemonitoringcustomservice.json`
2. Implement your resource handlers in `tf_googlebeta_googlemonitoringcustomservice/handlers.py`
