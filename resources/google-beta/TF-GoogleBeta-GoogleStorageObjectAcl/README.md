...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlestorageobjectacl.json`
2. Implement your resource handlers in `tf_googlebeta_googlestorageobjectacl/handlers.py`
