...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlegkehubmembership.json`
2. Implement your resource handlers in `tf_googlebeta_googlegkehubmembership/handlers.py`
