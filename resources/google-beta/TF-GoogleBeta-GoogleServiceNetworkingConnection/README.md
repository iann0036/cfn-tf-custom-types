...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleservicenetworkingconnection.json`
2. Implement your resource handlers in `tf_googlebeta_googleservicenetworkingconnection/handlers.py`
