...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecontainercluster.json`
2. Implement your resource handlers in `tf_googlebeta_googlecontainercluster/handlers.py`
