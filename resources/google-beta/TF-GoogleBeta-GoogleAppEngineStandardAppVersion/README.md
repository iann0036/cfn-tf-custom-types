...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleappenginestandardappversion.json`
2. Implement your resource handlers in `tf_googlebeta_googleappenginestandardappversion/handlers.py`
