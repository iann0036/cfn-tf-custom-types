...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatacatalogentry.json`
2. Implement your resource handlers in `tf_googlebeta_googledatacatalogentry/handlers.py`
