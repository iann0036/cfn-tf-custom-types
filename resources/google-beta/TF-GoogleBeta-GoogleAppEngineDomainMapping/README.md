...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleappenginedomainmapping.json`
2. Implement your resource handlers in `tf_googlebeta_googleappenginedomainmapping/handlers.py`
