...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigquerydatatransferconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigquerydatatransferconfig/handlers.py`
