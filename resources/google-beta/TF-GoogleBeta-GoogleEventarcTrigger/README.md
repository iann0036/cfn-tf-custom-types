...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleeventarctrigger.json`
2. Implement your resource handlers in `tf_googlebeta_googleeventarctrigger/handlers.py`
