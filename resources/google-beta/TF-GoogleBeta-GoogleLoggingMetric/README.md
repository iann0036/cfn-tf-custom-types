...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleloggingmetric.json`
2. Implement your resource handlers in `tf_googlebeta_googleloggingmetric/handlers.py`
