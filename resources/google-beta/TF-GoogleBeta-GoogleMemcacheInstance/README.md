...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlememcacheinstance.json`
2. Implement your resource handlers in `tf_googlebeta_googlememcacheinstance/handlers.py`
