...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlemonitoringslo.json`
2. Implement your resource handlers in `tf_googlebeta_googlemonitoringslo/handlers.py`
