# TF::GoogleBeta::GoogleComputeRegionDiskResourcePolicyAttachment

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeregiondiskresourcepolicyattachment.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeregiondiskresourcepolicyattachment/handlers.py`
