# TF::GoogleBeta::GoogleApiGatewayApiIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleapigatewayapiiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googleapigatewayapiiammember/handlers.py`
