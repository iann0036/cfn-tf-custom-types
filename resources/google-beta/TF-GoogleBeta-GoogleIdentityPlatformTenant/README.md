...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleidentityplatformtenant.json`
2. Implement your resource handlers in `tf_googlebeta_googleidentityplatformtenant/handlers.py`
