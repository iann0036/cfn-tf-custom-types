...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleosloginsshpublickey.json`
2. Implement your resource handlers in `tf_googlebeta_googleosloginsshpublickey/handlers.py`
