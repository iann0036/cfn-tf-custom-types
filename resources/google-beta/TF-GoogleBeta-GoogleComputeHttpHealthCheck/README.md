...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputehttphealthcheck.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputehttphealthcheck/handlers.py`
