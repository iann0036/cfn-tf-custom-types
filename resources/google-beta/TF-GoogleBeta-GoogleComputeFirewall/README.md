...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputefirewall.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputefirewall/handlers.py`
