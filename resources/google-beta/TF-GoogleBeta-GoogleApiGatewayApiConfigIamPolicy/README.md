# TF::GoogleBeta::GoogleApiGatewayApiConfigIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleapigatewayapiconfigiampolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googleapigatewayapiconfigiampolicy/handlers.py`
