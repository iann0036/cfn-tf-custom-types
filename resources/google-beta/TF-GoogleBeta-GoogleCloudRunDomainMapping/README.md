# TF::GoogleBeta::GoogleCloudRunDomainMapping

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudrundomainmapping.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudrundomainmapping/handlers.py`
