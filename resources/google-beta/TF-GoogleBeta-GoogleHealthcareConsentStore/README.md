...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlehealthcareconsentstore.json`
2. Implement your resource handlers in `tf_googlebeta_googlehealthcareconsentstore/handlers.py`
