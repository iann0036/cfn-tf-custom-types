# TF::GoogleBeta::GoogleHealthcareHl7V2StoreIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlehealthcarehl7v2storeiambinding.json`
2. Implement your resource handlers in `tf_googlebeta_googlehealthcarehl7v2storeiambinding/handlers.py`
