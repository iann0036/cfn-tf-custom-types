...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatastoreindex.json`
2. Implement your resource handlers in `tf_googlebeta_googledatastoreindex/handlers.py`
