...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigquerydataset.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigquerydataset/handlers.py`
