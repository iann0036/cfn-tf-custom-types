...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleapigeeorganization.json`
2. Implement your resource handlers in `tf_googlebeta_googleapigeeorganization/handlers.py`
