...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleidentityplatformoauthidpconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googleidentityplatformoauthidpconfig/handlers.py`
