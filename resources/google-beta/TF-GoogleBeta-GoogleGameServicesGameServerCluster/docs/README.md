...
CloudFormation equivalent of google_game_services_game_server_cluster
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleGameServicesGameServerCluster",
    "Properties" : {
        ...
        "<a href="#realmid" title="RealmId">RealmId</a>" : <i>String</i>,
