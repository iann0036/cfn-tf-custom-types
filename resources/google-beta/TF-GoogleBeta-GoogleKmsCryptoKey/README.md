...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlekmscryptokey.json`
2. Implement your resource handlers in `tf_googlebeta_googlekmscryptokey/handlers.py`
