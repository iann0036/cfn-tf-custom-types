...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlednspolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googlednspolicy/handlers.py`
