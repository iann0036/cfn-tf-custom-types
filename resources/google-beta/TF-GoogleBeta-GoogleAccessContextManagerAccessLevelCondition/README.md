...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleaccesscontextmanageraccesslevelcondition.json`
2. Implement your resource handlers in `tf_googlebeta_googleaccesscontextmanageraccesslevelcondition/handlers.py`
