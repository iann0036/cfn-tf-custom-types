...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatalosspreventioninspecttemplate.json`
2. Implement your resource handlers in `tf_googlebeta_googledatalosspreventioninspecttemplate/handlers.py`
