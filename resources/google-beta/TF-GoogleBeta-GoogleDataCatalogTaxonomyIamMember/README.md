# TF::GoogleBeta::GoogleDataCatalogTaxonomyIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googledatacatalogtaxonomyiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googledatacatalogtaxonomyiammember/handlers.py`
