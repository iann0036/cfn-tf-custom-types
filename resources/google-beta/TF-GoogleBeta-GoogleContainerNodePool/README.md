...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecontainernodepool.json`
2. Implement your resource handlers in `tf_googlebeta_googlecontainernodepool/handlers.py`
