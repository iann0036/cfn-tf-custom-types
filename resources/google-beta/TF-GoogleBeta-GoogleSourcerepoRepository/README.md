...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlesourcereporepository.json`
2. Implement your resource handlers in `tf_googlebeta_googlesourcereporepository/handlers.py`
