# TF::GoogleBeta::GoogleComputeInstanceIamMember

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeinstanceiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeinstanceiammember/handlers.py`
