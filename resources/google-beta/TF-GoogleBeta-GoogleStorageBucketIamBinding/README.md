# TF::GoogleBeta::GoogleStorageBucketIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlestoragebucketiambinding.json`
2. Implement your resource handlers in `tf_googlebeta_googlestoragebucketiambinding/handlers.py`
