...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleapigeeinstance.json`
2. Implement your resource handlers in `tf_googlebeta_googleapigeeinstance/handlers.py`
