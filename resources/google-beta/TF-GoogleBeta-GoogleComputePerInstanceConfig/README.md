...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeperinstanceconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeperinstanceconfig/handlers.py`
