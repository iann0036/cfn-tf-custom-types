...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatafusioninstance.json`
2. Implement your resource handlers in `tf_googlebeta_googledatafusioninstance/handlers.py`
