...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleredisinstance.json`
2. Implement your resource handlers in `tf_googlebeta_googleredisinstance/handlers.py`
