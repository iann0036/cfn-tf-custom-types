...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudassetfolderfeed.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudassetfolderfeed/handlers.py`
