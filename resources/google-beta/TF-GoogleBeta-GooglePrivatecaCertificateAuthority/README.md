...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleprivatecacertificateauthority.json`
2. Implement your resource handlers in `tf_googlebeta_googleprivatecacertificateauthority/handlers.py`
