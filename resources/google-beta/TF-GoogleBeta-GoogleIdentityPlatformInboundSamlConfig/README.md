...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleidentityplatforminboundsamlconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googleidentityplatforminboundsamlconfig/handlers.py`
