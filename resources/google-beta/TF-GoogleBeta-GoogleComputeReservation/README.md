# TF::GoogleBeta::GoogleComputeReservation

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputereservation.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputereservation/handlers.py`
