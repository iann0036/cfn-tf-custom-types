# TF::GoogleBeta::GoogleCloudfunctionsFunctionIamBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudfunctionsfunctioniambinding.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudfunctionsfunctioniambinding/handlers.py`
