...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlednsrecordset.json`
2. Implement your resource handlers in `tf_googlebeta_googlednsrecordset/handlers.py`
