...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeforwardingrule.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeforwardingrule/handlers.py`
