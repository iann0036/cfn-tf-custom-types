# TF::GoogleBeta::GoogleProjectIamPolicy

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-googlebeta-googleprojectiampolicy.json`
2. Implement your resource handlers in `tf_googlebeta_googleprojectiampolicy/handlers.py`
