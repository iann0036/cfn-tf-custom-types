...
1. Write the JSON schema describing your resource, `tf-googlebeta-googledatalosspreventiondeidentifytemplate.json`
2. Implement your resource handlers in `tf_googlebeta_googledatalosspreventiondeidentifytemplate/handlers.py`
