...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecomputeregionnetworkendpointgroup.json`
2. Implement your resource handlers in `tf_googlebeta_googlecomputeregionnetworkendpointgroup/handlers.py`
