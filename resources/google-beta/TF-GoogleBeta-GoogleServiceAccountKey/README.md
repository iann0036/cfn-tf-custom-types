...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleserviceaccountkey.json`
2. Implement your resource handlers in `tf_googlebeta_googleserviceaccountkey/handlers.py`
