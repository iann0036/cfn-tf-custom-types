...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleapigatewayapiconfigiammember.json`
2. Implement your resource handlers in `tf_googlebeta_googleapigatewayapiconfigiammember/handlers.py`
