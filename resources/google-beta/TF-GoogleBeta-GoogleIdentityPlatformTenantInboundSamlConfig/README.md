...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleidentityplatformtenantinboundsamlconfig.json`
2. Implement your resource handlers in `tf_googlebeta_googleidentityplatformtenantinboundsamlconfig/handlers.py`
