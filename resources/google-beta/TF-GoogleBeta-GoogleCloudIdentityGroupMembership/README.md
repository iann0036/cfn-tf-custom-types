...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlecloudidentitygroupmembership.json`
2. Implement your resource handlers in `tf_googlebeta_googlecloudidentitygroupmembership/handlers.py`
