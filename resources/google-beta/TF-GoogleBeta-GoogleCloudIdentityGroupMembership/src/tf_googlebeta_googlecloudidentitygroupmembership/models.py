...
class ResourceModel(BaseModel):
    ...
    MemberKey: Optional[Sequence["_MemberKeyDefinition"]]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            MemberKey=deserialize_list(json_data.get("MemberKey"), MemberKeyDefinition),
...
@dataclass
class MemberKeyDefinition(BaseModel):
    Id: Optional[str]
    Namespace: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_MemberKeyDefinition"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_MemberKeyDefinition"]:
        if not json_data:
            return None
        return cls(
            Id=json_data.get("Id"),
...
# work around possible type aliasing issues when variable has same name as a model
_MemberKeyDefinition = MemberKeyDefinition
