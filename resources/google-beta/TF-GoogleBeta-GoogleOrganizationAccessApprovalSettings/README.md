...
1. Write the JSON schema describing your resource, `tf-googlebeta-googleorganizationaccessapprovalsettings.json`
2. Implement your resource handlers in `tf_googlebeta_googleorganizationaccessapprovalsettings/handlers.py`
