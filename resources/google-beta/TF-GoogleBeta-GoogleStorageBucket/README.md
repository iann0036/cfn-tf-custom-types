...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlestoragebucket.json`
2. Implement your resource handlers in `tf_googlebeta_googlestoragebucket/handlers.py`
