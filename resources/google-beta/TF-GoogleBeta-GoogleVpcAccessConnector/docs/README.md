...
CloudFormation equivalent of google_vpc_access_connector
...
<pre>
{
    "Type" : "TF::GoogleBeta::GoogleVpcAccessConnector",
    "Properties" : {
        ...
        "<a href="#minthroughput" title="MinThroughput">MinThroughput</a>" : <i>Double</i>,
