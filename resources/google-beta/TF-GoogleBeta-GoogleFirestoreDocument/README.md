...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlefirestoredocument.json`
2. Implement your resource handlers in `tf_googlebeta_googlefirestoredocument/handlers.py`
