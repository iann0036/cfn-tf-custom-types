...
1. Write the JSON schema describing your resource, `tf-googlebeta-googlebigquerytable.json`
2. Implement your resource handlers in `tf_googlebeta_googlebigquerytable/handlers.py`
