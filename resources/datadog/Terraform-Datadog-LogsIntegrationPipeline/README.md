...
1. Write the JSON schema describing your resource, `terraform-datadog-logsintegrationpipeline.json`
2. Implement your resource handlers in `terraform_datadog_logsintegrationpipeline/handlers.py`
