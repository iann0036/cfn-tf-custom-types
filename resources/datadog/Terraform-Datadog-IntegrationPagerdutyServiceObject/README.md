...
1. Write the JSON schema describing your resource, `terraform-datadog-integrationpagerdutyserviceobject.json`
2. Implement your resource handlers in `terraform_datadog_integrationpagerdutyserviceobject/handlers.py`
