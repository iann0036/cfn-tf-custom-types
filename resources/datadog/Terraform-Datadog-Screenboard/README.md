...
1. Write the JSON schema describing your resource, `terraform-datadog-screenboard.json`
2. Implement your resource handlers in `terraform_datadog_screenboard/handlers.py`
