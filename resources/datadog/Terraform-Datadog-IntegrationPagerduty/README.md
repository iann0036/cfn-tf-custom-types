...
1. Write the JSON schema describing your resource, `terraform-datadog-integrationpagerduty.json`
2. Implement your resource handlers in `terraform_datadog_integrationpagerduty/handlers.py`
