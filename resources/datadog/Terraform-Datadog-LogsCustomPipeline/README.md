...
1. Write the JSON schema describing your resource, `terraform-datadog-logscustompipeline.json`
2. Implement your resource handlers in `terraform_datadog_logscustompipeline/handlers.py`
