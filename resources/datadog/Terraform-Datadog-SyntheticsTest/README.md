...
1. Write the JSON schema describing your resource, `terraform-datadog-syntheticstest.json`
2. Implement your resource handlers in `terraform_datadog_syntheticstest/handlers.py`
