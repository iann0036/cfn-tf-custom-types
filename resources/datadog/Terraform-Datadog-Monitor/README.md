...
1. Write the JSON schema describing your resource, `terraform-datadog-monitor.json`
2. Implement your resource handlers in `terraform_datadog_monitor/handlers.py`
