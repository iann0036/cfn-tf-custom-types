...
1. Write the JSON schema describing your resource, `tf-datadog-integrationpagerduty.json`
2. Implement your resource handlers in `tf_datadog_integrationpagerduty/handlers.py`
