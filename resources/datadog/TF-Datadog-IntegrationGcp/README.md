# TF::Datadog::IntegrationGcp

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-integrationgcp.json`
2. Implement your resource handlers in `tf_datadog_integrationgcp/handlers.py`
