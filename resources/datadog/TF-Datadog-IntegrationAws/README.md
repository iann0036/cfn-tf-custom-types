...
1. Write the JSON schema describing your resource, `tf-datadog-integrationaws.json`
2. Implement your resource handlers in `tf_datadog_integrationaws/handlers.py`
