# TF::Datadog::LogsArchiveOrder

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-logsarchiveorder.json`
2. Implement your resource handlers in `tf_datadog_logsarchiveorder/handlers.py`
