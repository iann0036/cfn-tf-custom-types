...
1. Write the JSON schema describing your resource, `terraform-datadog-logsindex.json`
2. Implement your resource handlers in `terraform_datadog_logsindex/handlers.py`
