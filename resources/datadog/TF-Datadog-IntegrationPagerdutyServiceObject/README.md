# TF::Datadog::IntegrationPagerdutyServiceObject

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-integrationpagerdutyserviceobject.json`
2. Implement your resource handlers in `tf_datadog_integrationpagerdutyserviceobject/handlers.py`
