...
1. Write the JSON schema describing your resource, `tf-datadog-securitymonitoringdefaultrule.json`
2. Implement your resource handlers in `tf_datadog_securitymonitoringdefaultrule/handlers.py`
