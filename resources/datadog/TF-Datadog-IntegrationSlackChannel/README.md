# TF::Datadog::IntegrationSlackChannel

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-integrationslackchannel.json`
2. Implement your resource handlers in `tf_datadog_integrationslackchannel/handlers.py`
