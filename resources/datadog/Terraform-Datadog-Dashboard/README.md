...
1. Write the JSON schema describing your resource, `terraform-datadog-dashboard.json`
2. Implement your resource handlers in `terraform_datadog_dashboard/handlers.py`
