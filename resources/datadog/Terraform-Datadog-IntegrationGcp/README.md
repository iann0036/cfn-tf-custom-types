...
1. Write the JSON schema describing your resource, `terraform-datadog-integrationgcp.json`
2. Implement your resource handlers in `terraform_datadog_integrationgcp/handlers.py`
