...
1. Write the JSON schema describing your resource, `tf-datadog-metricmetadata.json`
2. Implement your resource handlers in `tf_datadog_metricmetadata/handlers.py`
