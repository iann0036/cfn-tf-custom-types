# TF::Datadog::LogsMetric

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-logsmetric.json`
2. Implement your resource handlers in `tf_datadog_logsmetric/handlers.py`
