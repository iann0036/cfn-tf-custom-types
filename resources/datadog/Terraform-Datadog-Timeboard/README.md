...
1. Write the JSON schema describing your resource, `terraform-datadog-timeboard.json`
2. Implement your resource handlers in `terraform_datadog_timeboard/handlers.py`
