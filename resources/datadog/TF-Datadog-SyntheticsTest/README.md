...
1. Write the JSON schema describing your resource, `tf-datadog-syntheticstest.json`
2. Implement your resource handlers in `tf_datadog_syntheticstest/handlers.py`
