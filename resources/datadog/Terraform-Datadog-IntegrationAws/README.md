...
1. Write the JSON schema describing your resource, `terraform-datadog-integrationaws.json`
2. Implement your resource handlers in `terraform_datadog_integrationaws/handlers.py`
