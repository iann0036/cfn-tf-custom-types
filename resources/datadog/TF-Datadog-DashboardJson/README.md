...
1. Write the JSON schema describing your resource, `tf-datadog-dashboardjson.json`
2. Implement your resource handlers in `tf_datadog_dashboardjson/handlers.py`
