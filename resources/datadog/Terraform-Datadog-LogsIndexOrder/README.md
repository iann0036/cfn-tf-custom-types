...
1. Write the JSON schema describing your resource, `terraform-datadog-logsindexorder.json`
2. Implement your resource handlers in `terraform_datadog_logsindexorder/handlers.py`
