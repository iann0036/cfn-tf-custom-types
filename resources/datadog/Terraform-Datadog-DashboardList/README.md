...
1. Write the JSON schema describing your resource, `terraform-datadog-dashboardlist.json`
2. Implement your resource handlers in `terraform_datadog_dashboardlist/handlers.py`
