...
1. Write the JSON schema describing your resource, `tf-datadog-integrationawstagfilter.json`
2. Implement your resource handlers in `tf_datadog_integrationawstagfilter/handlers.py`
