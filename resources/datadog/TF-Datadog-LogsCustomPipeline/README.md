...
1. Write the JSON schema describing your resource, `tf-datadog-logscustompipeline.json`
2. Implement your resource handlers in `tf_datadog_logscustompipeline/handlers.py`
