...
1. Write the JSON schema describing your resource, `terraform-datadog-downtime.json`
2. Implement your resource handlers in `terraform_datadog_downtime/handlers.py`
