...
1. Write the JSON schema describing your resource, `tf-datadog-slocorrection.json`
2. Implement your resource handlers in `tf_datadog_slocorrection/handlers.py`
