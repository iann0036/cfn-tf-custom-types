...
1. Write the JSON schema describing your resource, `terraform-datadog-logspipelineorder.json`
2. Implement your resource handlers in `terraform_datadog_logspipelineorder/handlers.py`
