...
1. Write the JSON schema describing your resource, `tf-datadog-securitymonitoringrule.json`
2. Implement your resource handlers in `tf_datadog_securitymonitoringrule/handlers.py`
