# TF::Datadog::LogsIntegrationPipeline

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-logsintegrationpipeline.json`
2. Implement your resource handlers in `tf_datadog_logsintegrationpipeline/handlers.py`
