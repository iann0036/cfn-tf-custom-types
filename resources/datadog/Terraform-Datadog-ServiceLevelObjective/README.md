...
1. Write the JSON schema describing your resource, `terraform-datadog-servicelevelobjective.json`
2. Implement your resource handlers in `terraform_datadog_servicelevelobjective/handlers.py`
