# TF::Datadog::IntegrationAwsLogCollection

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-datadog-integrationawslogcollection.json`
2. Implement your resource handlers in `tf_datadog_integrationawslogcollection/handlers.py`
