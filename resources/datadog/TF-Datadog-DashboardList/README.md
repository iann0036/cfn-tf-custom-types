...
1. Write the JSON schema describing your resource, `tf-datadog-dashboardlist.json`
2. Implement your resource handlers in `tf_datadog_dashboardlist/handlers.py`
