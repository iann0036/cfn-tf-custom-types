...
1. Write the JSON schema describing your resource, `tf-datadog-syntheticsglobalvariable.json`
2. Implement your resource handlers in `tf_datadog_syntheticsglobalvariable/handlers.py`
