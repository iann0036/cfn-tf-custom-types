...
1. Write the JSON schema describing your resource, `tf-datadog-servicelevelobjective.json`
2. Implement your resource handlers in `tf_datadog_servicelevelobjective/handlers.py`
