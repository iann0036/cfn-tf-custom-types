...
1. Write the JSON schema describing your resource, `terraform-datadog-metricmetadata.json`
2. Implement your resource handlers in `terraform_datadog_metricmetadata/handlers.py`
