# TF::NutanixKPS::VmCloudConfig

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nutanixkps-vmcloudconfig.json`
2. Implement your resource handlers in `tf_nutanixkps_vmcloudconfig/handlers.py`
