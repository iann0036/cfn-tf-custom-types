# TF::NutanixKPS::Serviceinstance

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nutanixkps-serviceinstance.json`
2. Implement your resource handlers in `tf_nutanixkps_serviceinstance/handlers.py`
