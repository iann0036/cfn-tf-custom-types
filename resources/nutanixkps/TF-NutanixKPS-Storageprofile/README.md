...
1. Write the JSON schema describing your resource, `tf-nutanixkps-storageprofile.json`
2. Implement your resource handlers in `tf_nutanixkps_storageprofile/handlers.py`
