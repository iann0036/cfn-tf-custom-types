...
1. Write the JSON schema describing your resource, `tf-nutanixkps-application.json`
2. Implement your resource handlers in `tf_nutanixkps_application/handlers.py`
