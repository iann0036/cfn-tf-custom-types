# TF::NutanixKPS::Servicedomain

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-nutanixkps-servicedomain.json`
2. Implement your resource handlers in `tf_nutanixkps_servicedomain/handlers.py`
