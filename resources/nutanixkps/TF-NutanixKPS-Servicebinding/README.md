...
1. Write the JSON schema describing your resource, `tf-nutanixkps-servicebinding.json`
2. Implement your resource handlers in `tf_nutanixkps_servicebinding/handlers.py`
