# TF::Rancher2::Certificate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-certificate.json`
2. Implement your resource handlers in `tf_rancher2_certificate/handlers.py`
