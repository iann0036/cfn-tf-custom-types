...
CloudFormation equivalent of rancher2_catalog_v2
...
<pre>
{
    ...
    "Properties" : {
        ...
        "<a href="#gitrepo" title="GitRepo">GitRepo</a>" : <i>String</i>,
        ...
        "<a href="#serviceaccountnamespace" title="ServiceAccountNamespace">ServiceAccountNamespace</a>" : <i>String</i>,
