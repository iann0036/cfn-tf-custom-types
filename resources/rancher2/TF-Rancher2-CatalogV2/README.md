# TF::Rancher2::CatalogV2

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-catalogv2.json`
2. Implement your resource handlers in `tf_rancher2_catalogv2/handlers.py`
