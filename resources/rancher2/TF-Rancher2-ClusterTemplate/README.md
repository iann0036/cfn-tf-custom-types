...
1. Write the JSON schema describing your resource, `tf-rancher2-clustertemplate.json`
2. Implement your resource handlers in `tf_rancher2_clustertemplate/handlers.py`
