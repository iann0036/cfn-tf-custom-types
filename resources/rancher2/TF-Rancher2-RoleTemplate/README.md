# TF::Rancher2::RoleTemplate

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-roletemplate.json`
2. Implement your resource handlers in `tf_rancher2_roletemplate/handlers.py`
