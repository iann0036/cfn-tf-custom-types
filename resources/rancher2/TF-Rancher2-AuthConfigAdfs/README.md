# TF::Rancher2::AuthConfigAdfs

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-authconfigadfs.json`
2. Implement your resource handlers in `tf_rancher2_authconfigadfs/handlers.py`
