...
1. Write the JSON schema describing your resource, `tf-rancher2-projectlogging.json`
2. Implement your resource handlers in `tf_rancher2_projectlogging/handlers.py`
