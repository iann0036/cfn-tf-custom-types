# TF::Rancher2::ProjectAlertRule

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-projectalertrule.json`
2. Implement your resource handlers in `tf_rancher2_projectalertrule/handlers.py`
