# TF::Rancher2::ProjectRoleTemplateBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-projectroletemplatebinding.json`
2. Implement your resource handlers in `tf_rancher2_projectroletemplatebinding/handlers.py`
