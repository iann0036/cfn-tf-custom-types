...
class ResourceModel(BaseModel):
    ...
    ServiceAccountDistinguishedName: Optional[str]
    ...
    UserMemberAttribute: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ServiceAccountDistinguishedName=json_data.get("ServiceAccountDistinguishedName"),
            ...
            UserMemberAttribute=json_data.get("UserMemberAttribute"),
