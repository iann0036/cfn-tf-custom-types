# TF::Rancher2::AuthConfigOpenldap

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-authconfigopenldap.json`
2. Implement your resource handlers in `tf_rancher2_authconfigopenldap/handlers.py`
