# TF::Rancher2::NodePool

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-nodepool.json`
2. Implement your resource handlers in `tf_rancher2_nodepool/handlers.py`
