# TF::Rancher2::AuthConfigOkta

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-authconfigokta.json`
2. Implement your resource handlers in `tf_rancher2_authconfigokta/handlers.py`
