...
1. Write the JSON schema describing your resource, `tf-rancher2-clusteralertgroup.json`
2. Implement your resource handlers in `tf_rancher2_clusteralertgroup/handlers.py`
