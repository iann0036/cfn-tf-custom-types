...
1. Write the JSON schema describing your resource, `tf-rancher2-authconfigazuread.json`
2. Implement your resource handlers in `tf_rancher2_authconfigazuread/handlers.py`
