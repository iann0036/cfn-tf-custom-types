# TF::Rancher2::AuthConfigPing

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-authconfigping.json`
2. Implement your resource handlers in `tf_rancher2_authconfigping/handlers.py`
