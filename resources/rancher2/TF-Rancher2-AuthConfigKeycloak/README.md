...
1. Write the JSON schema describing your resource, `tf-rancher2-authconfigkeycloak.json`
2. Implement your resource handlers in `tf_rancher2_authconfigkeycloak/handlers.py`
