# TF::Rancher2::GlobalRole

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-globalrole.json`
2. Implement your resource handlers in `tf_rancher2_globalrole/handlers.py`
