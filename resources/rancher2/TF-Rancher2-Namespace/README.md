# TF::Rancher2::Namespace

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-namespace.json`
2. Implement your resource handlers in `tf_rancher2_namespace/handlers.py`
