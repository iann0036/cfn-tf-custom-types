# TF::Rancher2::GlobalRoleBinding

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-globalrolebinding.json`
2. Implement your resource handlers in `tf_rancher2_globalrolebinding/handlers.py`
