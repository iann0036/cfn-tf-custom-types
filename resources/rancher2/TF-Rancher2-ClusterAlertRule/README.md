...
1. Write the JSON schema describing your resource, `tf-rancher2-clusteralertrule.json`
2. Implement your resource handlers in `tf_rancher2_clusteralertrule/handlers.py`
