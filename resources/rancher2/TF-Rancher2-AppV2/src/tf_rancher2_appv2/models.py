...
class ResourceModel(BaseModel):
    ...
    SystemDefaultRegistry: Optional[str]
    Values: Optional[str]
    Wait: Optional[bool]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            ChartVersion=json_data.get("ChartVersion"),
            CleanupOnFail=json_data.get("CleanupOnFail"),
            ClusterId=json_data.get("ClusterId"),
            ClusterName=json_data.get("ClusterName"),
            DisableHooks=json_data.get("DisableHooks"),
            ...
            SystemDefaultRegistry=json_data.get("SystemDefaultRegistry"),
