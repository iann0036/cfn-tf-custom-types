# TF::Rancher2::NodeDriver

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-nodedriver.json`
2. Implement your resource handlers in `tf_rancher2_nodedriver/handlers.py`
