# TF::Rancher2::AuthConfigActivedirectory

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-rancher2-authconfigactivedirectory.json`
2. Implement your resource handlers in `tf_rancher2_authconfigactivedirectory/handlers.py`
