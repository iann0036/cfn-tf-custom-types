...
1. Write the JSON schema describing your resource, `tf-rancher2-nodetemplate.json`
2. Implement your resource handlers in `tf_rancher2_nodetemplate/handlers.py`
