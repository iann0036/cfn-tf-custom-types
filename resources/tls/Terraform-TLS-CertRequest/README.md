...
1. Write the JSON schema describing your resource, `terraform-tls-certrequest.json`
2. Implement your resource handlers in `terraform_tls_certrequest/handlers.py`
