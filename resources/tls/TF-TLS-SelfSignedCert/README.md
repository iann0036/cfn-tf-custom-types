# TF::TLS::SelfSignedCert

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-tls-selfsignedcert.json`
2. Implement your resource handlers in `tf_tls_selfsignedcert/handlers.py`
