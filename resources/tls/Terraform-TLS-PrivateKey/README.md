...
1. Write the JSON schema describing your resource, `terraform-tls-privatekey.json`
2. Implement your resource handlers in `terraform_tls_privatekey/handlers.py`
