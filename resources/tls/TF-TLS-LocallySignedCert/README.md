...
1. Write the JSON schema describing your resource, `tf-tls-locallysignedcert.json`
2. Implement your resource handlers in `tf_tls_locallysignedcert/handlers.py`
