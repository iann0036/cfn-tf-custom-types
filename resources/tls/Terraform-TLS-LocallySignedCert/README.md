...
1. Write the JSON schema describing your resource, `terraform-tls-locallysignedcert.json`
2. Implement your resource handlers in `terraform_tls_locallysignedcert/handlers.py`
