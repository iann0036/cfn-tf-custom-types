...
def create_handler(
    ...
    try:
        ...
        tf['resource']['tls_self_signed_cert'][request.logicalResourceIdentifier] = {}
        ...
        for prop, value in vars(model).items():
            if value is not None and prop != "tfcfnid":
                tf['resource']['tls_self_signed_cert'][request.logicalResourceIdentifier][cfn_to_tf_str(prop)] = parse_obj(value)
