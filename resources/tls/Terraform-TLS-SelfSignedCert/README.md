...
1. Write the JSON schema describing your resource, `terraform-tls-selfsignedcert.json`
2. Implement your resource handlers in `terraform_tls_selfsignedcert/handlers.py`
