...
1. Write the JSON schema describing your resource, `tf-upcloud-firewallrules.json`
2. Implement your resource handlers in `tf_upcloud_firewallrules/handlers.py`
