...
1. Write the JSON schema describing your resource, `tf-upcloud-objectstorage.json`
2. Implement your resource handlers in `tf_upcloud_objectstorage/handlers.py`
