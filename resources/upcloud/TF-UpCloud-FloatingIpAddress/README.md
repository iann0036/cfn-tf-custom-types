# TF::UpCloud::FloatingIpAddress

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `tf-upcloud-floatingipaddress.json`
2. Implement your resource handlers in `tf_upcloud_floatingipaddress/handlers.py`
